...
def _VarintSize(arg_1_0):
	...
	if arg_1_0 <= 34359738367:
		return 5

	if arg_1_0 <= 4398046511103:
		return 6

	if arg_1_0 <= 562949953421311:
		return 7

	if arg_1_0 <= 7.205759403792794e+16:
		return 8

	if arg_1_0 <= 9.223372036854776e+18:
		return 9

	return 10

def _SignedVarintSize(arg_2_0):
	if arg_2_0 < 0:
		return 10
	...
	if arg_2_0 <= 268435455:
		return 4

	if arg_2_0 <= 34359738367:
		return 5

	if arg_2_0 <= 4398046511103:
		return 6

	if arg_2_0 <= 562949953421311:
		return 7

	if arg_2_0 <= 7.205759403792794e+16:
		return 8

	if arg_2_0 <= 9.223372036854776e+18:
		return 9

	return 10

def _TagSize(arg_3_0):
	return _VarintSize(var_0_5.PackTag(arg_3_0, 0))

def _SimpleSizer(arg_4_0):
	return function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_2:
			...
			return function(arg_6_0)
				...
				for iter_6_0, iter_6_1 in var_0_2(arg_6_0):
			...
			return function(arg_7_0)
				...
				for iter_7_0, iter_7_1 in var_0_2(arg_7_0):
...
def _ModifiedSizer(arg_9_0, arg_9_1):
	return function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_2:
			...
			return function(arg_11_0)
				...
				for iter_11_0, iter_11_1 in var_0_2(arg_11_0):
			...
			return function(arg_12_0)
				...
				for iter_12_0, iter_12_1 in var_0_2(arg_12_0):
...
def StringSizer(arg_19_0, arg_19_1, arg_19_2):
	...
	if arg_19_1:
		return function(arg_20_0)
			...
			for iter_20_0, iter_20_1 in var_0_2(arg_20_0):
...
def BytesSizer(arg_22_0, arg_22_1, arg_22_2):
	...
	if arg_22_1:
		return function(arg_23_0)
			...
			for iter_23_0, iter_23_1 in var_0_2(arg_23_0):
...
def MessageSizer(arg_25_0, arg_25_1, arg_25_2):
	...
	if arg_25_1:
		return function(arg_26_0)
			...
			for iter_26_0, iter_26_1 in var_0_2(arg_26_0):
...
def TagBytes(arg_30_0, arg_30_1):
	return _VarintBytes(var_0_5.PackTag(arg_30_0, arg_30_1))

def _SimpleEncoder(arg_31_0, arg_31_1, arg_31_2):
...
def _ModifiedEncoder(arg_36_0, arg_36_1, arg_36_2, arg_36_3):
...
def _StructPackEncoder(arg_41_0, arg_41_1, arg_41_2):
...
def BoolEncoder(arg_46_0, arg_46_1, arg_46_2):
	local var_46_0 = "\x00"
	local var_46_1 = "\x01"
	...
	if arg_46_2:
		...
		return function(arg_47_0, arg_47_1)
			...
			for iter_47_0, iter_47_1 in var_0_2(arg_47_1):
				if iter_47_1:
					arg_47_0(var_46_1)
				else
					arg_47_0(var_46_0)
		...
		return function(arg_48_0, arg_48_1)
			for iter_48_0, iter_48_1 in var_0_2(arg_48_1):
				arg_48_0(var_46_4)
...
def StringEncoder(arg_50_0, arg_50_1, arg_50_2):
	...
	if arg_50_1:
		return function(arg_51_0, arg_51_1)
			for iter_51_0, iter_51_1 in var_0_2(arg_51_1):
				arg_51_0(var_50_0)
...
def BytesEncoder(arg_53_0, arg_53_1, arg_53_2):
	...
	if arg_53_1:
		return function(arg_54_0, arg_54_1)
			for iter_54_0, iter_54_1 in var_0_2(arg_54_1):
				arg_54_0(var_53_0)
...
def MessageEncoder(arg_56_0, arg_56_1, arg_56_2):
	...
	if arg_56_1:
		return function(arg_57_0, arg_57_1)
			for iter_57_0, iter_57_1 in var_0_2(arg_57_1):
				arg_57_0(var_56_0)
