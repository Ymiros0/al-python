...
def var_0_1.getStates(arg_3_0):
	if arg_3_0.stateList == None:
		arg_3_0.stateList = {}
...
def var_0_1.createState(arg_4_0, arg_4_1):
	...
	for iter_4_0, iter_4_1 in ipairs(var_4_5):
		var_4_4.defineTrans(iter_4_1["@action"], iter_4_1["@target"])

	return var_4_4

def var_0_1.isInitial(arg_5_0, arg_5_1):
