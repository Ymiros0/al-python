...
local var_0_15 = setmetatable({
	...
	def __index:(arg_1_0, arg_1_1)
		...
		if var_1_1 == 0 and var_1_2 == 31 - var_1_0:
			return "slwiRR~A."
		elif var_1_2 == 31 and var_1_1 == 32 - var_1_0:
			return "srwiRR~-A."
		else
			return "rlwinmRR~AAA."
})
...
local function var_0_29(arg_6_0)
	...
	for iter_6_0 in var_0_4(var_6_11, "."):
		local var_6_14
		...
		if iter_6_0 == "R":
		...
		elif iter_6_0 >= "2" and iter_6_0 <= "8":
			...
			if var_0_8(var_6_17, 4) == 0:
				var_6_19 = var_0_8(var_6_17, 2) == 0 and "dnz" or "dz"

				if var_0_8(var_6_17, 16) == 0:
			...
			if var_0_8(var_6_5, 1) == 1:
				var_6_10 = var_6_10 .. "."
		elif iter_6_0 == "N":
			if var_6_5 == 1610612736:
				var_6_10 = "nop"
			...
			if var_6_7 == var_6_6[var_6_21 - 1]:
				var_6_6[var_6_21] = None
				var_6_10 = var_6_12
		elif iter_6_0 == "%":
			local var_6_22 = #var_6_6

			if var_6_7 == var_6_6[var_6_22 - 1] and var_6_7 == var_6_6[var_6_22 - 2]:
				var_6_6[var_6_22] = None
				var_6_6[var_6_22 - 1] = None
				var_6_10 = var_6_12
		elif iter_6_0 == "-":
			var_6_8 = var_6_8 - 5
		else
