local var_0_0 = {
	def next_raw:(arg_1_0, arg_1_1)
		...
		if var_1_0 >= 0 and var_1_0 <= 127:
			arg_1_1 = arg_1_1 + 1
		elif var_1_0 >= 194 and var_1_0 <= 223:
			arg_1_1 = arg_1_1 + 2
		elif var_1_0 >= 224 and var_1_0 <= 239:
			arg_1_1 = arg_1_1 + 3
		elif var_1_0 >= 240 and var_1_0 <= 244:
			arg_1_1 = arg_1_1 + 4
		else
...
def var_0_0.byte_indices(arg_2_0, arg_2_1):
	return var_0_0.next, arg_2_0, arg_2_1

def var_0_0.len(arg_3_0):
	assert(arg_3_0, "bad argument #1 to 'len' (string expected, got None)")

	local var_3_0 = 0

	for iter_3_0 in var_0_0.byte_indices(arg_3_0):
		var_3_0 = var_3_0 + 1

	return var_3_0

def var_0_0.byte_index(arg_4_0, arg_4_1):
	if arg_4_1 < 1:
		return

	local var_4_0 = 0

	for iter_4_0 in var_0_0.byte_indices(arg_4_0):
		var_4_0 = var_4_0 + 1
...
def var_0_0.char_index(arg_5_0, arg_5_1):
	if arg_5_1 < 1 or arg_5_1 > #arg_5_0:
		return

	local var_5_0 = 0

	for iter_5_0 in var_0_0.byte_indices(arg_5_0):
		var_5_0 = var_5_0 + 1
...
def var_0_0.prev(arg_6_0, arg_6_1):
	arg_6_1 = arg_6_1 or #arg_6_0 + 1

	if arg_6_1 <= 1 or arg_6_1 > #arg_6_0 + 1:
		return

	local var_6_0, var_6_1 = var_0_0.next(arg_6_0)

	for iter_6_0, iter_6_1 in var_0_0.byte_indices(arg_6_0):
		if iter_6_0 == arg_6_1:
			return var_6_0, var_6_1

		var_6_0, var_6_1 = iter_6_0, iter_6_1

	if arg_6_1 == #arg_6_0 + 1:
		return var_6_0, var_6_1

	error("invalid index")

def var_0_0.byte_indices_reverse(arg_7_0, arg_7_1):
	if #arg_7_0 < 200:
		return var_0_0.prev, arg_7_0, arg_7_1
	else
		local var_7_0 = {}

		for iter_7_0 in var_0_0.byte_indices(arg_7_0):
			if arg_7_1 and arg_7_1 <= iter_7_0:
				break
...
def var_0_0.sub(arg_9_0, arg_9_1, arg_9_2):
	assert(arg_9_1 >= 1)
	...
	for iter_9_0 in var_0_0.byte_indices(arg_9_0):
		var_9_0 = var_9_0 + 1
...
def var_0_0.contains(arg_10_0, arg_10_1, arg_10_2):
	if arg_10_1 < 1 or arg_10_1 > #arg_10_0:
		return None

	for iter_10_0 = 1, #arg_10_2:
		if arg_10_0.byte(arg_10_1 + iter_10_0 - 1) != arg_10_2.byte(iter_10_0):
			return False

	return True

def var_0_0.count(arg_11_0, arg_11_1):
	assert(#arg_11_1 > 0)
	...
	while var_11_1:
		if var_0_0.contains(arg_11_0, var_11_1, arg_11_1):
			var_11_0 = var_11_0 + 1
			var_11_1 = var_11_1 + #arg_11_1

			if var_11_1 > #arg_11_0:
				break
		else
...
def var_0_0.isvalid(arg_12_0, arg_12_1):
	local var_12_0 = arg_12_0.byte(arg_12_1)

	if not var_12_0:
		return False
	elif var_12_0 >= 0 and var_12_0 <= 127:
		return True
	elif var_12_0 >= 194 and var_12_0 <= 223:
		local var_12_1 = arg_12_0.byte(arg_12_1 + 1)

		return var_12_1 and var_12_1 >= 128 and var_12_1 <= 191
	elif var_12_0 >= 224 and var_12_0 <= 239:
		...
		elif var_12_0 >= 225 and var_12_0 <= 236:
		...
		elif var_12_0 >= 238 and var_12_0 <= 239:
			if var_12_0 == 239 and var_12_2 == 191 and (var_12_3 == 190 or var_12_3 == 191):
				return False

			return var_12_2 and var_12_3 and var_12_2 >= 128 and var_12_2 <= 191 and var_12_3 >= 128 and var_12_3 <= 191
	elif var_12_0 >= 240 and var_12_0 <= 244:
		...
		elif var_12_0 >= 241 and var_12_0 <= 243:
...
def var_0_0.next_valid(arg_13_0, arg_13_1):
	local var_13_0
	local var_13_1

	arg_13_1, var_13_1 = var_0_0.next_raw(arg_13_0, arg_13_1)

	while arg_13_1 and (not var_13_1 or not var_0_0.isvalid(arg_13_0, arg_13_1)):
		arg_13_1, var_13_1 = var_0_0.next(arg_13_0, arg_13_1)

	return arg_13_1

def var_0_0.valid_byte_indices(arg_14_0):
	return var_0_0.next_valid, arg_14_0

def var_0_0.validate(arg_15_0):
	for iter_15_0, iter_15_1 in var_0_0.byte_indices(arg_15_0):
		if not iter_15_1 or not var_0_0.isvalid(arg_15_0, iter_15_0):
...
def var_0_0.replace(arg_17_0, arg_17_1, ...):
	if type(arg_17_1) == "table":
	...
	for iter_17_0 in var_0_0.byte_indices(arg_17_0):
...
local function var_0_2(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	if not var_0_0.isvalid(arg_18_0, arg_18_1):
		return arg_18_3

def var_0_0.sanitize(arg_19_0, arg_19_1):
