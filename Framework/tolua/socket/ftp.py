...
def var_0_8.open(arg_1_0, arg_1_1, arg_1_2):
...
def var_0_10.__index.portconnect(arg_3_0):
...
def var_0_10.__index.pasvconnect(arg_4_0):
...
def var_0_10.__index.login(arg_5_0, arg_5_1, arg_5_2):
...
def var_0_10.__index.pasv(arg_6_0):
...
def var_0_10.__index.epsv(arg_7_0):
...
def var_0_10.__index.port(arg_8_0, arg_8_1, arg_8_2):
	arg_8_0.pasvt = None
...
def var_0_10.__index.eprt(arg_9_0, arg_9_1, arg_9_2, arg_9_3):
	arg_9_0.pasvt = None
...
def var_0_10.__index.send(arg_10_0, arg_10_1):
	...
	local function var_10_6(arg_11_0, arg_11_1)
		if var_0_4.select(var_10_5, None, 0)[var_0_6]:
...
def var_0_10.__index.receive(arg_12_0, arg_12_1):
	...
	if var_12_2 >= 200 and var_12_2 <= 299:
		arg_12_1.sink(var_12_3)

		return 1

	if not arg_12_0.pasvt:
...
local function var_0_11(arg_18_0)
	if arg_18_0.url:
		...
		for iter_18_0, iter_18_1 in var_0_0.pairs(arg_18_0):
...
var_0_8.put = var_0_4.protect(function(arg_22_0, arg_22_1)
	if var_0_0.type(arg_22_0) == "string":
...
var_0_8.get = var_0_4.protect(function(arg_26_0)
	if var_0_0.type(arg_26_0) == "string":
