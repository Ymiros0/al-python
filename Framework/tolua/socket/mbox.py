...
def var_0_0.split_message(arg_1_0):
	local var_1_0 = {}
	...
	if not var_1_0.headers and not var_1_0.body:
		var_1_0.headers = arg_1_0

	return var_1_0.headers or "", var_1_0.body or ""

def var_0_0.split_headers(arg_5_0):
	local var_5_0 = {}
...
def var_0_0.parse_header(arg_7_0):
...
def var_0_0.parse_headers(arg_8_0):
...
def var_0_0.parse_from(arg_9_0):
...
def var_0_0.split_mbox(arg_10_0):
	local var_10_0 = {}
...
def var_0_0.parse_message(arg_12_0):
	local var_12_0 = {}
