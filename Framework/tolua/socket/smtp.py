...
def var_0_11.__index.greet(arg_1_0, arg_1_1):
...
def var_0_11.__index.quit(arg_5_0):
	arg_5_0.try(arg_5_0.tp.command("QUIT"))

	return arg_5_0.try(arg_5_0.tp.check("2.."))

def var_0_11.__index.close(arg_6_0):
	return arg_6_0.tp.close()

def var_0_11.__index.login(arg_7_0, arg_7_1, arg_7_2):
...
def var_0_11.__index.plain(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_11.__index.auth(arg_9_0, arg_9_1, arg_9_2, arg_9_3):
	if not arg_9_1 or not arg_9_2:
		return 1

	if var_0_2.find(arg_9_3, "AUTH[^\n]+LOGIN"):
		return arg_9_0.login(arg_9_1, arg_9_2)
	elif var_0_2.find(arg_9_3, "AUTH[^\n]+PLAIN"):
		return arg_9_0.plain(arg_9_1, arg_9_2)
	else
		arg_9_0.try(None, "authentication not supported")

def var_0_11.__index.send(arg_10_0, arg_10_1):
	arg_10_0.mail(arg_10_1.from)

	if var_0_0.type(arg_10_1.rcpt) == "table":
		for iter_10_0, iter_10_1 in var_0_0.ipairs(arg_10_1.rcpt):
...
def var_0_10.open(arg_11_0, arg_11_1, arg_11_2):
...
local function var_0_12(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_0_0.pairs(arg_13_0 or var_13_0):
...
local function var_0_16(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_0_0.pairs(arg_15_0):
...
local function var_0_17(arg_16_0)
	...
	if arg_16_0.body.preamble:
		var_0_1.yield(arg_16_0.body.preamble)
		var_0_1.yield("\r\n")

	for iter_16_0, iter_16_1 in var_0_0.ipairs(arg_16_0.body):
		var_0_1.yield("\r\n--" .. var_16_0 .. "\r\n")
		var_0_15(iter_16_1)

	var_0_1.yield("\r\n--" .. var_16_0 .. "--\r\n\r\n")

	if arg_16_0.body.epilogue:
...
def var_0_15(arg_19_0):
	if var_0_0.type(arg_19_0.body) == "table":
		var_0_17(arg_19_0)
	elif var_0_0.type(arg_19_0.body) == "function":
		var_0_18(arg_19_0)
	else
		var_0_19(arg_19_0)
