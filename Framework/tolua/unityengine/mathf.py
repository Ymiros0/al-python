...
def var_0_3.Approximately(arg_1_0, arg_1_1):
	return var_0_2(arg_1_1 - arg_1_0) < var_0_0.max(1e-06 * var_0_0.max(var_0_2(arg_1_0), var_0_2(arg_1_1)), 1.121039e-44)

def var_0_3.Clamp(arg_2_0, arg_2_1, arg_2_2):
	if arg_2_0 < arg_2_1:
		arg_2_0 = arg_2_1
	elif arg_2_2 < arg_2_0:
		arg_2_0 = arg_2_2

	return arg_2_0

def var_0_3.Clamp01(arg_3_0):
	if arg_3_0 < 0:
		return 0
	elif arg_3_0 > 1:
		return 1
...
def var_0_3.DeltaAngle(arg_4_0, arg_4_1):
...
def var_0_3.Gamma(arg_5_0, arg_5_1, arg_5_2):
	local var_5_0 = False
...
def var_0_3.InverseLerp(arg_6_0, arg_6_1, arg_6_2):
	if arg_6_0 < arg_6_1:
		if arg_6_2 < arg_6_0:
			return 0
...
def var_0_3.Lerp(arg_7_0, arg_7_1, arg_7_2):
	return arg_7_0 + (arg_7_1 - arg_7_0) * var_0_3.Clamp01(arg_7_2)

def var_0_3.LerpAngle(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_3.SmoothDamp(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4, arg_16_5):
	...
	if arg_16_0 < var_16_4 == (var_16_4 < var_16_8):
		var_16_8 = var_16_4
		arg_16_2 = (var_16_8 - var_16_4) / arg_16_5

	return var_16_8, arg_16_2

def var_0_3.SmoothDampAngle(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5):
...
def var_0_3.SmoothStep(arg_18_0, arg_18_1, arg_18_2):
...
def var_0_3.HorizontalAngle(arg_19_0):
	return var_0_0.deg(var_0_0.atan2(arg_19_0.x, arg_19_0.z))

def var_0_3.IsNan(arg_20_0):
	return arg_20_0 != arg_20_0

def var_0_3.MultiRandom(arg_21_0, arg_21_1):
	local var_21_0 = {}
	local var_21_1 = {}
...
def var_0_3.RandomFloat(arg_22_0, arg_22_1, arg_22_2):
