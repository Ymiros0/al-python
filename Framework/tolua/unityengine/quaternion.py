...
def var_0_22.__index(arg_1_0, arg_1_1):
...
def var_0_22.__newindex(arg_2_0, arg_2_1, arg_2_2):
	if arg_2_1 == "eulerAngles":
		arg_2_0.SetEuler(arg_2_2)
	else
		var_0_15(arg_2_0, arg_2_1, arg_2_2)

def var_0_22.New(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	local var_3_0 = {
		x = arg_3_0 or 0,
		y = arg_3_1 or 0,
		z = arg_3_2 or 0,
...
def var_0_22.__call(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4):
	local var_4_0 = {
		x = arg_4_1 or 0,
		y = arg_4_2 or 0,
		z = arg_4_3 or 0,
...
def var_0_22.AngleAxis(arg_10_0, arg_10_1):
...
def var_0_22.SetEuler(arg_13_0, arg_13_1, arg_13_2, arg_13_3):
	if arg_13_2 == None and arg_13_3 == None:
		arg_13_2 = arg_13_1.y
		arg_13_3 = arg_13_1.z
		arg_13_1 = arg_13_1.x
...
def var_0_22.Normalize(arg_14_0):
...
def var_0_22.FromToRotation(arg_16_0, arg_16_1):
...
local function var_0_25(arg_18_0, arg_18_1)
	...
	if var_18_0 > 0:
		...
		if arg_18_0[2][2] > arg_18_0[1][1]:
			var_18_3 = 2

		if arg_18_0[3][3] > arg_18_0[var_18_3][var_18_3]:
			var_18_3 = 3
...
def var_0_22.Lerp(arg_21_0, arg_21_1, arg_21_2):
	...
	if var_0_22.Dot(arg_21_0, arg_21_1) < 0:
...
def var_0_22.LookRotation(arg_22_0, arg_22_1):
	...
	if var_22_3 > 0:
		...
		if arg_22_1.y > var_22_2.x:
			var_22_17 = 2

		if arg_22_0.z > var_22_15[var_22_17][var_22_17]:
			var_22_17 = 3
...
def var_0_22.SetIdentity(arg_23_0):
	arg_23_0.x = 0
	arg_23_0.y = 0
	arg_23_0.z = 0
	arg_23_0.w = 1
...
def var_0_22.Slerp(arg_25_0, arg_25_1, arg_25_2):
	if arg_25_2 < 0:
		arg_25_2 = 0
	elif arg_25_2 > 1:
		arg_25_2 = 1
...
def var_0_22.RotateTowards(arg_26_0, arg_26_1, arg_26_2):
...
def var_0_22.ToAngleAxis(arg_28_0):
	local var_28_0 = 2 * var_0_3(arg_28_0.w)

	if var_0_27(var_28_0, 0):
...
local function var_0_33(arg_29_0)
	if arg_29_0.x < var_0_31:
		arg_29_0.x = arg_29_0.x + var_0_30
	elif arg_29_0.x > var_0_32:
		arg_29_0.x = arg_29_0.x - var_0_30

	if arg_29_0.y < var_0_31:
		arg_29_0.y = arg_29_0.y + var_0_30
	elif arg_29_0.y > var_0_32:
		arg_29_0.y = arg_29_0.y - var_0_30

	if arg_29_0.z < var_0_31:
		arg_29_0.z = arg_29_0.z + var_0_30
	elif arg_29_0.z > var_0_32:
		arg_29_0.z = arg_29_0.z + var_0_30

def var_0_22.ToEulerAngles(arg_30_0):
...
def var_0_22.Forward(arg_31_0):
	return arg_31_0.MulVec3(var_0_19)

def var_0_22.MulVec3(arg_32_0, arg_32_1):
...
def var_0_22.__mul(arg_33_0, arg_33_1):
	if var_0_22 == var_0_13(arg_33_1):
