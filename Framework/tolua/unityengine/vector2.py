...
def var_0_6.__index(arg_1_0, arg_1_1):
...
def var_0_6.__call(arg_2_0, arg_2_1, arg_2_2):
	return var_0_1({
		x = arg_2_1 or 0,
		y = arg_2_2 or 0
	}, var_0_6)

def var_0_6.New(arg_3_0, arg_3_1):
	return var_0_1({
		x = arg_3_0 or 0,
		y = arg_3_1 or 0
	}, var_0_6)

def var_0_6.Set(arg_4_0, arg_4_1, arg_4_2):
	arg_4_0.x = arg_4_1 or 0
	arg_4_0.y = arg_4_2 or 0

def var_0_6.Get(arg_5_0):
	return arg_5_0.x, arg_5_0.y

def var_0_6.SqrMagnitude(arg_6_0):
	return arg_6_0.x * arg_6_0.x + arg_6_0.y * arg_6_0.y

def var_0_6.Clone(arg_7_0):
	return var_0_1({
		x = arg_7_0.x,
		y = arg_7_0.y
	}, var_0_6)

def var_0_6.Normalize(arg_8_0):
...
def var_0_6.SetNormalize(arg_9_0):
...
def var_0_6.Dot(arg_10_0, arg_10_1):
	return arg_10_0.x * arg_10_1.x + arg_10_0.y * arg_10_1.y

def var_0_6.Angle(arg_11_0, arg_11_1):
...
def var_0_6.Magnitude(arg_12_0):
	return var_0_0(arg_12_0.x * arg_12_0.x + arg_12_0.y * arg_12_0.y)

def var_0_6.Reflect(arg_13_0, arg_13_1):
...
def var_0_6.Distance(arg_14_0, arg_14_1):
	return var_0_0((arg_14_0.x - arg_14_1.x)^2 + (arg_14_0.y - arg_14_1.y)^2)

def var_0_6.Lerp(arg_15_0, arg_15_1, arg_15_2):
	if arg_15_2 < 0:
		arg_15_2 = 0
	elif arg_15_2 > 1:
		arg_15_2 = 1
...
def var_0_6.LerpUnclamped(arg_16_0, arg_16_1, arg_16_2):
	return var_0_1({
		x = arg_16_0.x + (arg_16_1.x - arg_16_0.x) * arg_16_2,
		y = arg_16_0.y + (arg_16_1.y - arg_16_0.y) * arg_16_2
	}, var_0_6)

def var_0_6.MoveTowards(arg_17_0, arg_17_1, arg_17_2):
	...
	if var_17_4 > arg_17_2 * arg_17_2 and var_17_4 != 0:
...
def var_0_6.SmoothDamp(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4, arg_19_5):
	...
	if var_19_9 > var_19_10 * var_19_10:
	...
	if (var_19_3 - var_19_5) * (var_19_16 - var_19_3) + (var_19_4 - var_19_6) * (var_19_17 - var_19_4) > 0:
		var_19_16 = var_19_3
		var_19_17 = var_19_4
		arg_19_2.x = 0
		arg_19_2.y = 0
...
def var_0_6.__add(arg_30_0, arg_30_1):
	return var_0_1({
		x = arg_30_0.x + arg_30_1.x,
		y = arg_30_0.y + arg_30_1.y
	}, var_0_6)

def var_0_6.__sub(arg_31_0, arg_31_1):
	return var_0_1({
		x = arg_31_0.x - arg_31_1.x,
		y = arg_31_0.y - arg_31_1.y
	}, var_0_6)

def var_0_6.__unm(arg_32_0):
	return var_0_1({
		x = -arg_32_0.x,
		y = -arg_32_0.y
	}, var_0_6)

def var_0_6.__eq(arg_33_0, arg_33_1):
