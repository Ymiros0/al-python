...
def var_0_16.__index(arg_1_0, arg_1_1):
...
def var_0_16.New(arg_2_0, arg_2_1, arg_2_2):
	local var_2_0 = {
		x = arg_2_0 or 0,
		y = arg_2_1 or 0,
		z = arg_2_2 or 0
...
def var_0_16.__call(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	local var_3_0 = {
		x = arg_3_1 or 0,
		y = arg_3_2 or 0,
		z = arg_3_3 or 0
...
def var_0_16.Copy(arg_7_0, arg_7_1):
	arg_7_0.x = arg_7_1.x
	arg_7_0.y = arg_7_1.y
	arg_7_0.z = arg_7_1.z
...
def var_0_16.Copy2(arg_8_0, arg_8_1):
	if arg_8_1:
		arg_8_1.x = arg_8_0.x
		arg_8_1.y = arg_8_0.y
		arg_8_1.z = arg_8_0.z
...
def var_0_16.SetNormalize(arg_18_0):
...
def var_0_16.MoveTowards(arg_23_0, arg_23_1, arg_23_2):
	local var_23_0 = arg_23_1 - arg_23_0
	local var_23_1 = var_23_0.SqrMagnitude()

	if var_23_1 > arg_23_2 * arg_23_2:
...
def ClampedMove(arg_24_0, arg_24_1, arg_24_2):
...
local function var_0_21(arg_25_0)
	...
	if var_0_8(arg_25_0.z) > var_0_20:
...
def var_0_16.SmoothDamp(arg_27_0, arg_27_1, arg_27_2, arg_27_3):
	...
	if var_0_16.Dot(var_27_5 - arg_27_0, var_27_9 - var_27_5) > 0:
		var_27_9 = var_27_5
...
def var_0_16.Scale(arg_28_0, arg_28_1):
...
def var_0_16.Cross2(arg_29_0, arg_29_1):
...
def var_0_16.Cross(arg_30_0, arg_30_1):
...
def var_0_16.Project(arg_34_0, arg_34_1):
	local var_34_0 = arg_34_1.SqrMagnitude()

	if var_34_0 < 1.175494e-38:
...
def var_0_16.ProjectOnPlane(arg_35_0, arg_35_1):
...
def var_0_16.Slerp(arg_36_0, arg_36_1, arg_36_2):
	local var_36_0
	local var_36_1
	local var_36_2
	local var_36_3
	...
	if var_36_9 > 0.999999:
		var_36_2 = 1 - arg_36_2
		var_36_3 = arg_36_2
	elif var_36_9 < -0.999999:
...
def var_0_16.Mul(arg_37_0, arg_37_1):
	if var_0_13(arg_37_1) == "number":
...
def var_0_16.Div(arg_38_0, arg_38_1):
...
def var_0_16.Add(arg_39_0, arg_39_1):
...
def var_0_16.Sub(arg_40_0, arg_40_1):
...
def var_0_16.MulQuat(arg_41_0, arg_41_1):
...
def var_0_16.AngleAroundAxis(arg_42_0, arg_42_1, arg_42_2):
...
def var_0_16.__tostring(arg_43_0):
	return "[" .. arg_43_0.x .. "," .. arg_43_0.y .. "," .. arg_43_0.z .. "]"

def var_0_16.__div(arg_44_0, arg_44_1):
	return var_0_18(arg_44_0.x / arg_44_1, arg_44_0.y / arg_44_1, arg_44_0.z / arg_44_1)

def var_0_16.__mul(arg_45_0, arg_45_1):
	if var_0_13(arg_45_1) == "number":
