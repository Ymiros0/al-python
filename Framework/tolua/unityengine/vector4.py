...
def var_0_6.__call(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4):
	return var_0_4({
		x = arg_2_1 or 0,
		y = arg_2_2 or 0,
		z = arg_2_3 or 0,
...
def var_0_6.New(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	return var_0_4({
		x = arg_3_0 or 0,
		y = arg_3_1 or 0,
		z = arg_3_2 or 0,
...
def var_0_6.Set(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4):
...
def var_0_6.Lerp(arg_6_0, arg_6_1, arg_6_2):
...
def var_0_6.MoveTowards(arg_7_0, arg_7_1, arg_7_2):
	local var_7_0 = arg_7_1 - arg_7_0
	local var_7_1 = var_7_0.Magnitude()

	if arg_7_2 < var_7_1 and var_7_1 != 0:
...
def var_0_6.Div(arg_12_0, arg_12_1):
...
def var_0_6.Mul(arg_13_0, arg_13_1):
...
def var_0_6.Add(arg_14_0, arg_14_1):
...
def var_0_6.Sub(arg_15_0, arg_15_1):
...
def var_0_6.Max(arg_22_0, arg_22_1):
