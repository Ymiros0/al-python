...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	pg.ConnectionMgr.GetInstance().Send(11202, {
		...
		if arg_2_0.result == 0:
			...
			getProxy(ActivityProxy).GetBossRushRuntime(var_2_0.id).settlementData = None

			if var_2_4.win:
				var_2_0.AddPassSeries(var_2_4.seriesId)
				var_2_0.AddUsedBonus(var_2_4.seriesId)

			for iter_2_0, iter_2_1 in ipairs(var_2_4):
...
def var_0_0.ConcludeEXP(arg_5_0, arg_5_1, arg_5_2):
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_0.re40004):
		var_5_3[iter_5_0] = {}
		...
		if pg.battle_cost_template[var_5_0].oil_cost > 0:
			local var_5_13 = {
				{
					0,
					0
...
def var_0_0.addShipsExp(arg_7_0, arg_7_1):
	local var_7_0 = {}
	local var_7_1 = {}
...
def var_0_0.GenerateCommanderExp(arg_8_0):
	local var_8_0 = {}
	local var_8_1 = {}
...
def var_0_0.GeneralLoot(arg_9_0):
	local var_9_0 = {
	...
	for iter_9_0, iter_9_1 in pairs(var_9_0):
		...
		underscore.each(var_9_0[iter_9_0], function(arg_10_0)
			if arg_10_0.type == DROP_TYPE_SHIP:
				local var_10_0 = pg.ship_data_template[arg_10_0.id].group_type
				local var_10_1 = getProxy(CollectionProxy)

				arg_10_0.virgin = var_10_1 and var_10_1.shipGroups[var_10_0] == None)

	return var_9_0.drops, var_9_0.extraDrops

def var_0_0.GeneralPlayerCosume(arg_11_0, arg_11_1, arg_11_2, arg_11_3):
	...
	if var_11_3.oil_cost > 0 and arg_11_1:
		var_11_1.consume({
			gold = 0,
			oil = arg_11_2
		})

	if var_11_3.attack_count > 0:
		if var_11_3.attack_count == 1:
			var_11_1.increaseAttackCount()

			if arg_11_1:
				var_11_1.increaseAttackWinCount()
		elif var_11_3.attack_count == 2:
