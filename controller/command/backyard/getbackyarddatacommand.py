...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_1.ship_id_list):
	...
	for iter_1_2, iter_1_3 in ipairs(var_1_1.furniture_id_list):
	...
	for iter_1_4 = 1, BackYardConst.MAX_FLOOR_CNT:
		var_1_3.SetTheme(iter_1_4, BackYardSelfThemeTemplate.New({
			id = -1,
			furniture_put_list = {}
		}, iter_1_4))

	for iter_1_5, iter_1_6 in ipairs(var_1_1.furniture_put_list):
		local var_1_7 = {}

		for iter_1_7, iter_1_8 in ipairs(iter_1_6.furniture_put_list):
			local var_1_8 = {}

			for iter_1_9, iter_1_10 in ipairs(iter_1_8.child):
