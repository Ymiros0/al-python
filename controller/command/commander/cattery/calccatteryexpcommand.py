...
def var_0_0.CalcExp(arg_2_0, arg_2_1, arg_2_2, arg_2_3):
	...
	if var_2_2 > 0:
		...
		if not getProxy(CommanderProxy).InCommanderScene():
			arg_2_1.UpdateCacheExp(var_2_4)

def var_0_0.AddCommanderExp(arg_3_0, arg_3_1, arg_3_2):
	...
	if not var_3_3 and var_3_2.isMaxLevel():
