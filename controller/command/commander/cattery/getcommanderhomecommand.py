...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	pg.ConnectionMgr.GetInstance().Send(25026, {
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.slots):
			if iter_2_1.commander_id != 0 and iter_2_1.commander_level and iter_2_1.commander_level != 0 and iter_2_1.commander_exp:
				arg_1_0.UpdateCommanderLevelAndExp(iter_2_1.commander_id, iter_2_1.commander_level, iter_2_1.commander_exp))

def var_0_0.UpdateCommanderLevelAndExp(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
