...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if not var_1_3 and not var_1_6.getCommanderById(var_1_2):
		if var_1_4:
			var_1_4()
	...
	if not var_1_8 or not var_1_8.CanUse():
		if var_1_4:
			var_1_4()

		return

	if not var_1_3 and var_1_8.ExistCommander() and var_1_8.GetCommanderId() == var_1_2:
		if var_1_4:
			var_1_4()

		return

	if var_1_3 and not var_1_8.ExistCommander():
		if var_1_4:
			var_1_4()
	...
	pg.ConnectionMgr.GetInstance().Send(25030, {
		...
		if arg_2_0.result == 0:
			if var_1_3:
				...
				if var_2_3 and var_1_8.ExistCleanOP():
					var_1_8.ResetCleanOP()

				if var_2_4 and var_1_8.ExiseFeedOP():
					var_1_8.ResetFeedOP()

				if var_2_5 and var_1_8.ExistPlayOP():
					var_1_8.ResetPlayOP()
...
def var_0_0.UpdateCommanderLevelAndExp(arg_3_0, arg_3_1, arg_3_2):
