...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if var_1_5.isMaxLevel() and var_1_6.isMaxLevel():
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_2):
		...
		if not var_1_12 or var_1_1 == iter_1_1:
			return
...
def var_0_0.clearHardChapterCommanders(arg_6_0, arg_6_1):
	...
	for iter_6_0, iter_6_1 in pairs(var_6_1):
		...
		for iter_6_2, iter_6_3 in pairs(var_6_2):
			for iter_6_4, iter_6_5 in pairs(iter_6_3):
				if iter_6_5 == arg_6_1:
					iter_6_1.updateCommander(iter_6_2, iter_6_4, None)
					var_6_0.updateChapter(iter_6_1)

def var_0_0.clearActivityCommanders(arg_7_0, arg_7_1):
