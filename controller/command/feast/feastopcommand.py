...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if var_1_2 == FeastDorm.OP_RANDOM_SHIPS:
		pg.ConnectionMgr.GetInstance().Send(26158, {
			...
			if arg_2_0.ret == 0:
				...
				for iter_2_0, iter_2_1 in ipairs(arg_2_0.party_roles):
				...
				for iter_2_2, iter_2_3 in pairs(var_2_1.GetFeastShipList()):
					if var_2_2[iter_2_2] != True:
		...
		if not arg_1_0.CheckRes(var_1_2, var_1_3):
...
def var_0_0.CheckRes(arg_4_0, arg_4_1, arg_4_2):
...
def var_0_0.HandleInteraction(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4):
...
def var_0_0.HandleMakeTicket(arg_6_0, arg_6_1):
...
def var_0_0.HandleGiveTicket(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
...
def var_0_0.HandleGiveGift(arg_8_0, arg_8_1, arg_8_2):
