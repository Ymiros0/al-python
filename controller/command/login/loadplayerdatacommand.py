...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	pg.ConnectionMgr.GetInstance().Send(11001, {
		...
		getProxy(MetaCharacterProxy).requestMetaTacticsInfo(None, True)
		...
		if MainCheckShipNumSequence.New().Check(arg_2_0.ship_count):
			arg_1_0.sendNotification(GAME.LOAD_PLAYER_DATA_DONE), None, 60)
