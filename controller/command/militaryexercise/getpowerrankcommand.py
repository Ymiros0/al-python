...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	assert(var_1_1, "type can not be None")
	...
	if var_1_1 == PowerRank.TYPE_MILITARY_RANK:
		pg.ConnectionMgr.GetInstance().Send(18006, {
			type = 0
		}, 18007, function(arg_3_0)
			local var_3_0 = {}

			for iter_3_0, iter_3_1 in ipairs(arg_3_0.arena_rank_lsit):
		...
		local function var_1_6(arg_4_0, arg_4_1)
			if #var_1_5 < (arg_4_0 - 1) * (var_0_1 / var_0_2):
				arg_4_1()
		...
		local function var_1_8(arg_6_0)
			pg.ConnectionMgr.GetInstance().Send(18203, {
				...
				elif var_1_1 == PowerRank.TYPE_EXTRA_CHAPTER:
				...
				elif var_1_1 == PowerRank.TYPE_BOSSRUSH:
		...
		seriesAsync(var_1_9, function()
			if #var_1_5 > 0 and var_1_7:
				...
				for iter_10_0, iter_10_1 in ipairs(var_1_5):
					local var_10_3 = iter_10_1.power

					if not table.contains(var_10_0, var_10_3):
				...
				for iter_10_2, iter_10_3 in ipairs(var_1_5):
