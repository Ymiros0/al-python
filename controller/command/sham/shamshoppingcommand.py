...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if var_1_7.getOwnedCount() < var_1_6.resource_num * var_1_2:
		pg.TipsMgr.GetInstance().ShowTips(i18n("common_no_x", var_1_7.getName()))

		return

	if var_1_6.commodity_type == 1:
		if var_1_6.commodity_id == 1 and var_1_4.GoldMax(var_1_6.num * var_1_2):
			pg.TipsMgr.GetInstance().ShowTips(i18n("gold_max_tip_title") .. i18n("resource_max_tip_shop"))

			return

		if var_1_6.commodity_id == 2 and var_1_4.OilMax(var_1_6.num * var_1_2):
