...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if not (function()
		...
		if var_1_7.GetSpWeapon() and getProxy(EquipmentProxy).GetSpWeaponCapacity() <= getProxy(EquipmentProxy).GetSpWeaponCount():
		...
		if not var_1_6 or var_1_6.GetUID() != var_1_3:
