...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	table.insert(var_1_7, function(arg_3_0)
		pg.ConnectionMgr.GetInstance().Send(12043, {
			...
			for iter_4_0, iter_4_1 in ipairs(arg_4_0.infoList):
	...
	seriesAsync(var_1_7, function()
		...
		pg.ConnectionMgr.GetInstance().Send(12025, {
			...
			for iter_8_0, iter_8_1 in ipairs(arg_8_0.ship_list):
				...
				if var_8_1.isMetaShip() and not var_8_1.virgin and Player.isMetaShipNeedToTrans(var_8_1.configId):
