...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in pairs(var_1_1.equipments):
		if iter_1_1:
			var_1_3 = var_1_3 + 1
	...
	if var_1_4.getMaxEquipmentBag() < var_1_5 + var_1_3:
	...
	if var_1_6 and var_1_7 <= var_1_8:
...
def var_0_0.fun(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4):
	if arg_3_3 < arg_3_2:
	...
	pg.ConnectionMgr.GetInstance().Send(12006, {
		...
		if arg_4_0.result == 0:
			...
			arg_3_1.updateEquip(arg_3_2, None)
