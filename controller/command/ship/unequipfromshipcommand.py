...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if getProxy(EquipmentProxy).getCapacity() >= var_1_6.getMaxEquipmentBag():
	...
	pg.ConnectionMgr.GetInstance().Send(12006, {
		...
		if arg_2_0.result == 0:
			...
			var_1_5.updateEquip(var_1_2, None)
			...
			if var_1_5.getEquipSkin(var_1_2) > 0 and not var_1_5.checkCanEquipSkin(var_1_2, var_1_5.getEquipSkin(var_1_2)):
