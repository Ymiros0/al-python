...
def var_0_0.GetMilitaryShop(arg_13_0, arg_13_1):
	local var_13_0 = {}
...
def var_0_0.GetStressShop(arg_17_0, arg_17_1):
	local var_17_0 = {}
...
def var_0_0.GetGuildShop(arg_21_0, arg_21_1):
	if LOCK_GUILD_SHOP:
		arg_21_1()
...
def var_0_0.GetShamShop(arg_25_0, arg_25_1):
	local var_25_0 = {}
	local var_25_1 = arg_25_0.shopsProxy.getShamShop()

	if not LOCK_SHAM_CHAPTER and var_25_1 and var_25_1.isOpen():
...
def var_0_0.GetFragmentShop(arg_27_0, arg_27_1):
	local var_27_0 = {}
	local var_27_1 = arg_27_0.shopsProxy.getFragmentShop()

	if not LOCK_FRAGMENT_SHOP and var_27_1 and var_27_1.isOpen():
...
def var_0_0.GetActivityShops(arg_29_0, arg_29_1):
	local var_29_0 = {}
	local var_29_1 = arg_29_0.shopsProxy.getActivityShops()

	if not var_29_1 or #var_29_1 == 0:
	...
	table.insert(var_29_0, function(arg_32_0, arg_32_1)
		if arg_32_1 and table.getCount(arg_32_1) > 0:
			arg_29_0.shopList[NewShopsScene.TYPE_ACTIVITY] = {}

			for iter_32_0, iter_32_1 in pairs(arg_32_1):
...
def var_0_0.GetMetaShops(arg_34_0, arg_34_1):
	local var_34_0 = {}
	...
	if not var_34_1:
		table.insert(var_34_0, function(arg_35_0)
			...
			for iter_35_0, iter_35_1 in ipairs(var_35_0):
				if iter_35_1 and not iter_35_1.isEnd() and iter_35_1.getConfig("config_id") == 1:
...
def var_0_0.GetMedalShops(arg_38_0, arg_38_1):
	local var_38_0 = {}
...
def var_0_0.GetMiniShops(arg_42_0, arg_42_1):
	if LOCK_MINIGAME_HALL:
		if arg_42_1:
			arg_42_1()
...
def var_0_0.GetQuotaShop(arg_46_0, arg_46_1):
	if LOCK_QUOTA_SHOP:
		arg_46_1()
