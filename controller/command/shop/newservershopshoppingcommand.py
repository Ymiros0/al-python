...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if var_1_11 < var_1_12 * var_1_6:
		pg.TipsMgr.GetInstance().ShowTips(i18n("common_no_resource"))

		return

	if not var_1_9.CanPurchaseMulTimes(var_1_6):
	...
	for iter_1_2, iter_1_3 in pairs(var_1_13):
	...
	if var_1_15 == 1:
		if var_1_16 == 1 and var_1_8.GoldMax(var_1_17 * var_1_6):
			pg.TipsMgr.GetInstance().ShowTips(i18n("gold_max_tip_title") .. i18n("resource_max_tip_shop"))

			return

		if var_1_16 == 2 and var_1_8.OilMax(var_1_17 * var_1_6):
	...
	if DROP_TYPE_ITEM == var_1_15 and var_1_18.type == Item.EXP_BOOK_TYPE and getProxy(BagProxy).getItemCountById(var_1_16) + var_1_17 * var_1_6 > var_1_18.max_num:
	...
	pg.ConnectionMgr.GetInstance().Send(26043, {
		...
		if arg_2_0.result == 0:
			...
			if var_1_9.LimitPurchaseSubGoods():
