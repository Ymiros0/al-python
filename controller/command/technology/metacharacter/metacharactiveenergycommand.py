...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if var_1_6 > var_1_2.level or var_1_7 > var_1_3.getCurRepairExp():
	...
	pg.ConnectionMgr.GetInstance().Send(63303, {
		...
		if arg_3_0.result == 0:
			...
			for iter_3_0, iter_3_1 in pairs(var_1_9):
...
def var_0_0.updateStar(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
	arg_4_1.configId = arg_4_3

	local var_4_0 = pg.ship_data_template[arg_4_1.configId]

	for iter_4_0, iter_4_1 in ipairs(var_4_0.buff_list):
		if not arg_4_1.skills[iter_4_1]:
	...
	for iter_4_2, iter_4_3 in ipairs(var_4_1):
		if not table.contains(var_4_0.buff_list, iter_4_3):
			arg_4_1.skills[iter_4_3] = None
