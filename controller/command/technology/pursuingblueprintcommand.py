...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	if var_1_10.getShipById(var_1_4.shipId).level < var_1_9.need_lv:
	...
	pg.ConnectionMgr.GetInstance().Send(63212, {
		...
		if arg_2_0.result == 0:
			...
			if var_1_4.level > var_2_2.level:
				for iter_2_0 = var_2_2.level + 1, var_1_4.level:
					local var_2_4 = var_1_4.getStrengthenConfig(iter_2_0)

					if var_2_4.special == 1 and type(var_2_4.special_effect) == "table":
						local var_2_5 = var_2_4.special_effect

						for iter_2_1, iter_2_2 in ipairs(var_2_5):
							local var_2_6 = iter_2_2[1]

							if var_2_6 == ShipBluePrint.STRENGTHEN_TYPE_SKILL:
								local var_2_7 = iter_2_2[2]
								local var_2_8 = getProxy(BayProxy)
								local var_2_9 = var_2_8.getShipById(var_1_4.shipId)

								for iter_2_3, iter_2_4 in ipairs(var_2_7):
							...
							elif var_2_6 == ShipBluePrint.STRENGTHEN_TYPE_SKIN:
								...
								pg.TipsMgr.GetInstance().ShowTips(iter_2_2[3])
							elif var_2_6 == ShipBluePrint.STRENGTHEN_TYPE_BREAKOUT:
								local var_2_11 = getProxy(BayProxy).getShipById(var_1_4.shipId)

								arg_1_0.upgradeStar(var_2_11)
			elif var_1_4.fateLevel > var_2_2.fateLevel:
				for iter_2_5 = var_2_2.fateLevel + 1, var_1_4.fateLevel:
					local var_2_12 = var_1_4.getFateStrengthenConfig(iter_2_5)

					if var_2_12.special == 1 and type(var_2_12.special_effect) == "table":
						local var_2_13 = var_2_12.special_effect

						for iter_2_6, iter_2_7 in ipairs(var_2_13):
							if iter_2_7[1] == ShipBluePrint.STRENGTHEN_TYPE_CHANGE_SKILL:
								...
								if var_2_20 and var_2_20.skillId == var_2_16:
