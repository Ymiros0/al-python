...
def var_0_0.execute(arg_1_0, arg_1_1):
	...
	pg.ConnectionMgr.GetInstance().Send(33103, {
		...
		if arg_2_0.result == 0:
			...
			if var_1_0.op == WorldConst.OpReqMoveFleet:
				arg_1_0.BuildFleetMove(arg_2_0.move_path, var_1_0)
			elif var_1_0.op == WorldConst.OpReqRetreat:
				var_1_0.childOps = arg_1_0.BuildAIAction(arg_2_0)
			elif var_1_0.op == WorldConst.OpReqEvent:
				local var_2_2 = var_1_0.effect
				local var_2_3 = var_2_2.effect_type
				local var_2_4 = var_2_2.effect_paramater

				if var_2_3 == WorldMapAttachment.EffectEventTeleport or var_2_3 == WorldMapAttachment.EffectEventTeleportBack:
					arg_1_0.BuildTransfer(arg_2_0, var_1_0)
				elif var_2_3 == WorldMapAttachment.EffectEventProgress:
					var_1_0.childOps = arg_1_0.BuildProgressAction(var_2_4[1])
				elif var_2_3 == WorldMapAttachment.EffectEventBlink1 or var_2_3 == WorldMapAttachment.EffectEventBlink2:
					var_1_0.childOps = arg_1_0.BuildBlinkAction(var_1_0.attachment, var_1_0.updateAttachmentCells)
			elif var_1_0.op == WorldConst.OpReqTransport:
				arg_1_0.BuildTransfer(arg_2_0, var_1_0)
			elif var_1_0.op == WorldConst.OpReqJumpOut:
				arg_1_0.BuildTransfer(arg_2_0, var_1_0)
			elif var_1_0.op == WorldConst.OpReqRound:
				var_1_0.childOps = arg_1_0.BuildAIAction(arg_2_0)
			elif var_1_0.op == WorldConst.OpReqBox:
				-- block empty
		else
			if arg_2_0.result == 130:
			...
			if var_1_0.op == WorldConst.OpReqEvent:
...
def var_0_0.BuildAIAction(arg_3_0, arg_3_1):
	local var_3_0 = {}
	local var_3_1 = getProxy(WorldProxy)

	for iter_3_0, iter_3_1 in ipairs(arg_3_1.ai_act_list):
		local var_3_2 = {}

		if iter_3_1.type == WorldMapAttachment.TypeFleet:
			var_3_2 = arg_3_0.BuildFleetAction(iter_3_1)
		elif iter_3_1.type == WorldMapAttachment.TypeTrap:
...
def var_0_0.BuildTransfer(arg_4_0, arg_4_1, arg_4_2):
...
def var_0_0.BuildFleetMove(arg_5_0, arg_5_1, arg_5_2):
	local var_5_0 = {}
	...
	elif arg_5_2.trap == WorldBuff.TrapVortex:
...
def var_0_0.BuildFleetPath(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4):
	...
	_.each(arg_6_1, function(arg_9_0)
		...
		if #var_6_5 > 0:
			...
			for iter_9_0, iter_9_1 in ipairs(var_6_5):
		...
		for iter_9_2 = arg_9_0.row - var_9_4, arg_9_0.row + var_9_4:
			for iter_9_3 = arg_9_0.column - var_9_4, arg_9_0.column + var_9_4:
				local var_9_5 = var_6_0.GetCell(iter_9_2, iter_9_3)
				local var_9_6 = iter_9_2 .. "_" .. iter_9_3

				if var_9_5 and not var_9_5.discovered and WorldConst.InFOVRange(arg_9_0.row, arg_9_0.column, iter_9_2, iter_9_3, var_9_4) and not var_6_3[var_9_6]:
...
def var_0_0.BuildFleetAction(arg_12_0, arg_12_1):
...
def var_0_0.BuildFleetMoveAction(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4, arg_13_5, arg_13_6, arg_13_7):
	local var_13_0 = {}
	...
	for iter_13_0, iter_13_1 in ipairs(arg_13_1):
		...
		if var_13_1 == WorldMapCell.TerrainWind and var_13_4 + var_13_2 > #var_13_5:
			var_13_8 = True
		elif var_13_1 != var_13_7:
			var_13_9 = True
		elif var_13_7 == WorldMapCell.TerrainWind:
			var_13_10 = True

		if iter_13_0 == #arg_13_1 or var_13_9:
			var_13_4 = 0
...
def var_0_0.BuildAttachmentAction(arg_14_0, arg_14_1):
...
def var_0_0.BuildAttachmentActionPath(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.BuildTrapAction(arg_17_0, arg_17_1):
...
def var_0_0.BuildBlinkAction(arg_18_0, arg_18_1, arg_18_2):
	...
	if var_18_1 == WorldMapAttachment.SpEventHaibao:
		...
		arg_18_2[WorldMapCell.GetName(var_18_2.pos.row, var_18_2.pos.column)] = None
		arg_18_2[WorldMapCell.GetName(var_18_3.pos.row, var_18_3.pos.column)] = None
	...
	elif var_18_1 == WorldMapAttachment.SpEventFufen:
		...
		if var_18_6 < PathFinding.PrioObstacle:
