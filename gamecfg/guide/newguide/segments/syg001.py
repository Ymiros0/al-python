local var_0_0 = {
	...
	"The:rm is where your girls can <color=#ff7d36>get some rest</color>, <color=#ff7d36>have their moods restored</color>, and earn <color=#ff7d36>EXP</color>. You'll need to have the required <color=#ff7d36>supplies</color>, however!",
	"Decorations will <color=#ff7d36>increase the comfort level</color> of your:rm.",
	"You may <color=#ff7d36>purchase decorations with Decor Tokens</color> in the furniture shop.",
	"<color=#ff7d36>Use manage to rearrange decorations and furniture within the:rm.</color>",
	...
	"Now we need to find someone that needs some rest. <color=#ff7d36>Moods usually improve in the:rm</color>!",
	"Tap <color=#ff7d36>an empty slot to begin adding a character</color>,: select someone to put in the:rm.",
	"Select someone that needs rest.",
	"Tap confirm.",
	"Don't try anything funny in the:rm, Commander!"
}
