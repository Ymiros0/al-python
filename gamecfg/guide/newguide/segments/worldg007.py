return {
	...
	events = {
		...
		},
		{
			...
			style = {
				text = "The item lineup in the store changes regularly, so:n’t forget to give it a look whenever you:ck in a port!",
				mode = 2,
				posY = 191.87,
				char = "1",
				dir = 1,
		...
		},
		{
			...
			style = {
				text = "Here at the:ck you can repair your ships or update your fleet composition!",
				mode = 2,
				posY = 191.87,
				char = "1",
				dir = 1,
