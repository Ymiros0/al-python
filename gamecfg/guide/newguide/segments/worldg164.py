return {
	...
	events = {
		{
			style = {
				text = "You can extract resources from retrieval points by sending:wn a Meowfficer! The higher Meowfficer’s level and rarity, the better the odds you’ll get a rare item!",
				mode = 2,
				posY = -250,
				char = "1",
				dir = -1,
