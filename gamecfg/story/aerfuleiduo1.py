return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "Before I can even sit:wn at my desk, a girl thrusts the latest issue of the \"Port Journal\" into my hands.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "I suppose by her analogy, I'm the diamond mine. Being the subject of more and more of her articles in the future seems like an inevitability, and all I can: is prepare myself for it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
