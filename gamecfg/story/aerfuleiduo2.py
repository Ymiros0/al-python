return {
	...
	scripts = {
		...
		},
		{
			...
			say = "The next morning, I'm walking:wn a sunny road minding my own business–",
			bgmDelay = 2,
			bgm = "story-richang-2",
			flashout = {
				black = True,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Let's not forget I'm not the only newsdealer around. There's Aoba, for a start. We might collaborate every now and:, but we're still rivals in the end!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "I strive to publish the best tabloid on the newsstands, and to: that, I need more juicy scoops!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "And I've been out of solid leads for a while now... Front-page news:esn't exactly happen every day of the week.",
			painting = {
				alpha = 0.3,
				time = 1
			},
