return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "Alfredo returns to her:rmitory, feeling dejected about her lackluster findings.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Well... If you:n't want 'em,: I'll help myself to the cookies!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "When you're:wn in the dumps, you need a hearty helping of sugar to pick you up.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Sit:wn, have a muffin, and tell us what's wrong. We'll work something out.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "You haven't heard? They're organizing a huge ball soon. All the factions are gonna be there, no:ubt bringing juicy rumors with them and whatnot.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "*sigh*... If this isn't proof that I've fallen off as a journalist, I:n't know what is...",
			painting = {
				alpha = 0.3,
				time = 1
			},
