return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "Alfredo throws open the:or and steps into the office. Judging by her elated attitude, she must be expecting to report some big news today.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"I:n't think that's a real saying.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "People will raise their guard once they know a journalist is around, and: there's no way I'll land a good scoop...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "No, nothing like that! I'm gonna: an undercover coverage! Under-coverage, if you will.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "But to: that, I'll need a partner who can back me up...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "Remember to rehearse and be ready for anything at the ball! I'll see you:, partner.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			optionFlag = 2,
			say = "\"But I'll also be keeping an eye on you. I:n't fully trust you not to cause a stir if left unsupervised.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
