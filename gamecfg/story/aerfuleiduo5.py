return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Voila! What: you think, Commander? Looks pretty good, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "Stick close to me, Commander. I need you to cover me while I take notes and photos, so:n't raise any suspicion!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "A chance to dance with you comes only once in a blue moon! Being a little tired won't stop me from:ing something I like.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "I may burn through physical energy while:ing stuff I like, but there's no shortage of mental energy left in my tank~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "If you were to ask me how I can just keep going seemingly forever,: that's my answer, I suppose.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "So what: you say, Commander? May I have this dance?",
			painting = {
				alpha = 0.3,
				time = 1
			},
