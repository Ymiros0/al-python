return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "I've come up with a ton of good ideas, and if I:n't put pen to paper now, I'll have forgotten them by tomorrow.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "All that is to say, I:n't have time to change outfits!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_night",
			say = "\"Working all day gathering scoops,: sorting through them well into the night... Being a journalist sounds exhausting.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601081,
			say = "Hey, it's not like I: this EVERY day.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_night",
			optionFlag = 2,
			say = "\"I:n't think I like getting praised for coming up with that...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
