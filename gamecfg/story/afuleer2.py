return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "In the end, I didn't really: much. The others were the ones who charged forward and seized victory...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But maybe that's not a very satisfactory explanation? Hmm... how should I explain this:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This story might take a while, so why:n't we have a drink first?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "If it really is \"that,\": I should...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				...
				{
					content = "Slam it:wn like a True proletariat",
					flag = 2
				}
			}
		},
