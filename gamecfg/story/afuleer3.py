return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The:or:esn't seem to be locked. Ahem, I'm coming in...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Sure, sure... Tashkent is only:ing this for a friend.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, since Commander is here, why:n't we all have another toast?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
