return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hahah! Wouldn't mind having some of this stuff every now and:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "How strange... I:n't seem to see anyone here who fits that description! There aren't any girls here with super long service histories~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey Avrora, the video game that Commander bought looked super fun, right? Why:n't we all give it a try next time?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hmm... Seems like I'm the only person here whose memories are a rather hazy... though it's not like I:n't remember anything at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mm... and while the times may have changed, comrades from all different factions once again gather at the same port to sail under the same banner, just like back:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
