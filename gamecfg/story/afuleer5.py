return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Seems like there's nothing for me to: today...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Maybe I should go check on how Pirozhki is:ing... a good cuddle always brings me back...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What's wrong? Calm:wn, and tell me what happened.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "This is the last time I'm repeating myself! When you're fighting with carriers, you have to remain in formation at all times to escort the carrier! What are you going to: if you rush ahead and your carriers get flanked?",
			dialogShake = {
				speed = 0.09,
				x = 8.5,
				number = 2
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm so:ne with you! They probably:n't even teach you the basic carrier battlegroup tactics in the Northern Parliament because you barely even have any carriers!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It is True that the Northern Parliament:es not have a robust knowledge of operating carriers.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "See? Did you two manage to cool:wn a bit?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Why:n't we hold a mock battle at the next exercise?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
