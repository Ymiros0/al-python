return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "In any case, we harbor no ill will against the Eagle Union. If you all feel the same way about us,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All I: is just give them a little push on the back. You, on the other hand, are the \"light of dawn\" that illuminates their path.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
