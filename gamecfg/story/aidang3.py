return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It seems like it's been forever since we've been able to shop like this. Commander, how are you:ing back there? Can you carry any more?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*giggles* Sorry~ I:n't mind carrying stuff, but you know, people will give us weird looks if I'm hauling all those bags around.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "By the way, Atago, I heard that a new buffet opened around here not too long ago. After we're all:ne, we should go check it out together!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "In any case, we'll be headed this way... Jeez, Maya,:n't just sit there, we've got to head to the next store!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That may be the case, but... I:n't know why I'm like this either...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
