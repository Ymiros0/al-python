return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Cleaning is one of every maid's fundamentals! I'll make sure it's:ne flawlessly!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ack! I knocked over the bucket! I:n't even remember putting it over there! ...Where's the rag, where's the rag? ...Ahh!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "At least now that things have calmed:wn, I have an opportunity to savor Edinburgh's black tea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
