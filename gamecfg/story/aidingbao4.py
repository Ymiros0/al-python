return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mmh... I still:n't know what is supposed to make me uniquely me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I arrive at the office at the usual time, but to my surprise, Edinburgh is already waiting for me when I open the:or.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: you think? I made all the floors, windows, bookshelves, and desks sparkly clean!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
