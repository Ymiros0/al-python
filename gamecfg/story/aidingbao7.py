return {
	...
	scripts = {
		...
		{
			say = "After Edinburgh left the office for the day, I suddenly remember something that I need her to:.",
			side = 2,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh? I:n't see you come to the kitchen often, Commander!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...By the way, Commander. Edinburgh has been the secretary ship for a pretty long time now. Is she:ing well?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...I suppose that's something only Edinburgh can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "Right after leaving the Royal Navy:rms, I just happen to bump into Edinburgh, who was returning from her shopping trip.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh my, what brings you to the:rms, Commander? Wait, huh?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Thank you, Commander! I hope I'll be able to: more to prove my worth to you in the future!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
