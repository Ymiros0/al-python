return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I see, I see! This must be that \"lovey:vey mode\" I've read all about!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now that everyone has had a chance to calm:wn, let's resupply and head towards the next zone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
