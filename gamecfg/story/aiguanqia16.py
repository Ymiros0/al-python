	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't see anything out of the ordinary here. Just where are the enemies hiding...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Woah~! What should we:? AI turned into a titan!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we: that,: we can win. Wait for us, Kizuna AI.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
