return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Prinz-chan",
			dir = 1,
			say = "What: you think? In any case, we won't allow you to touch our Commander, Kizuna AI. If you still insist on coming, steel yourselves!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Shou-chan",
			dir = 1,
			say = "Ara? Then, maybe we should: you a favor and let you go? Just kidding~♪ I'd never, ever let you get away~ ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wh-wh-wh-what: we:~! Why are they such tryhards~~~~ ><",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "So, is this one of those stages where we have multiple win conditions? We can either: the high-power strategy, or the low-cost strategy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
