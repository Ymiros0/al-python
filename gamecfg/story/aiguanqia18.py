return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Fortune,:n't cry! Just leave AI to us, we'll save her...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Maybe... but, we have to carry on the will of the Kizuna AI Fleet, and: our best to save Kizuna AI!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
