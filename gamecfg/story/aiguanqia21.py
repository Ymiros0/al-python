return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's right... since AI was able to out-hack the enemy earlier, maybe she can: something...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10400010,
			dir = 1,
			say = "(Ehhhhhh?! I haven't:ne it for a long time, so I'm probably super rusty?!) I'm not sure what I'll be able to:, but I'll give it my best shot! Nnnhh... Hnnnnng.... Hah!!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
