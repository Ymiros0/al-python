return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If I knew this would have happened... I never would have turned her:wn when she wanted to make a video together... *sniffles* I'll help you as many times as you'd like, so... please come back...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll give you the TL;DR! I'm originally an A.I., so I was a virtual existence to begin with. Therefore, it:esn't make any difference if I'm swallowed up by virtual space. Does that sound about right?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Well, they probably wouldn't understand if I told them the truth, so I guess this will have to:)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Looks like we're getting a sequel! Everyone, let's: our best once more!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Well, things aren't quite:ne here but, I'm relieved...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
