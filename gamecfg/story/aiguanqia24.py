return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's right! Miss AI, because your random word generator was infected by a virus, you were sucked into our world, and: all kinds of things happened...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Conquer the world?! I mean, is it really possible to: something like that no matter how much you manipulate me? No way, no way, that's impossible!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Even though we: usually say \"the Sirens caused all this...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "R-right... Even the Sirens wouldn't: something this pointless...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
