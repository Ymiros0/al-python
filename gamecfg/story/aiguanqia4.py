return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oooohh, I was just about to ask how you were able to keep up with us. So this is the reason, huh? It:esn't stick out at all - I didn't even notice it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heh heh! There's nothing that a Super AI cannot:, as long as you install the plug-in for it! If you're having trouble with anything, just let me know!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"Plug-in...?\" I:n't quite get, but I'm glad you're confident in yourself. As expected of a Super AI.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, th-that's right! I actually have a variety of different outfits! Since I:n't get to use them very often, I'll let you see my cute wardrobe!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No way...!? What should I:? I really liked those outfits too~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We might be able to recover the lost data by exploring around. Let's see what we can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yes, you're right! Okay, let's: it~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
