return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "That’s right, the clone was giving off a lot of light. AI, how: you feel? Is there any difference?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "By the looks of things, we’ll need to investigate over there as well. Let’s refuel first,: head out at once!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
