return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Kizuna AI",
			say = "I-I won't: anything reckless like last time! I won't make the same mistake twice!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Kizuna AI",
			say = "...But it's probably ideal that we: this as a team. Everyone, let's go!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
