return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "AI, you know how to: stuff like that!?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahem! Yes... but it's kind of hard to: on my own. Can you guys help out?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Thanks! That's one virus:wn. We'll wipe 'em out like this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
