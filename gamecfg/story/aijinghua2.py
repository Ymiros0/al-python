	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "Uhh... I have a lot to: today actually...",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just chill. Today's viruses ain't nothin', a walk in the damned park, easiest viruses of your life, hands:wn. Just knock 'em out and: we'll kick back!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ughhh! I'm so ti~red~! It:esn't make any sense! I'm trying so hard!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heyooo! Is that Boss Lady Kizuna AI!? What are you:ing? You can't take a nap here, you'll catch a cold. Don't you know anything?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Uh huh! No clue if I can: it or not, but I'm gonna try!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Uhhh... so like I: this? And: that one I just... Oh. Now this one's gone too?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wha? It's all over? But I'm not:ne playing~!!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Don't ask me. Even I:n't understand how it works....",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
