return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "You serious?! You'll reward me if I: a good job?",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_113",
			say = "It wasn't something I'd expect Allen to want, but if it would help her concentrate on her work,: it was all good.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Before you ask,:n't worry, it won't cost you anything! It's not something you can just walk into a store and buy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "All righty, we're:ne here! Let's head on back and get to work!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
