return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wonder what Cooper's:ing ri– Wait, I'm supposed to be working. Save it for later, Allen...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Two hours to go until the commander's:ne for the day! Just gotta hang in there!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"Keep it up. We're almost:ne.\"",
					flag = 1
				}
			}
		},
