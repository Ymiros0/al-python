return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "A'ight, we'll head:wn the street and look for the stuff the R&D girls wanted. Leaving the office supplies to you all~",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sweet! Let's meet up here after we're:ne!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Welp. What: we: now, Commander? Go home?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_105",
			say = "Allen sounded let:wn by this turn of events.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Don't get me wrong, I'm so happy you'd: that with me, but you:n't HAVE to go that far just for me, you know...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Well, if you say it's fine,: I'm not gonna argue with that. Let's go!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
