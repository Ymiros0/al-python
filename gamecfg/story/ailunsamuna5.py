return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_104",
			say = "Allen wolfed:wn the appetizers and decided to spend the time checking off items on the shopping list.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Aren't you kinda spoiling me for no real reason? I barely: any work around the office and I:n't exactly make your job any easier.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...What I'm trying to say is, it's literally my job as your secretary to help out around the office. Isn't it weird to reward me for just, you know,:ing my job?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "\"I:n't think it's weird at all.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_104",
			say = "\"You always: your best, Allen. I know you:. It would be weird NOT to reward you for it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That explains it! If that's how it is,: it's about time I started giving it one-hundo percent!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Or at the very least, work as hard as you:, hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
