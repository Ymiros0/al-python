return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The:cuments you handed me? Already:ne! C'mon, Commander, keep it together.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Remember to: your own work too instead of focusing on making sure I: mine. Just saying.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
