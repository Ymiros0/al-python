return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Knowing you, you could get it:ne in a minute~ Believe it or not, I'm quite a good judge of character!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "You mean Belfast? Good heavens, no~ I:n't hold a candle to her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "And I:n't expect you to understand the complicated feeling that is having a little sister who's so good at everything!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Okay,: let's ask the Commander to assign us on the team next time there's a mission in the Sakura Empire's territory! Oh, just hearing the rumors about the Sakura Empire, the Land of Gold, makes me giddy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
