return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "D-do they...? I'll always help a friend in need, that's all it is. I:n't: it so that they'll feel indebted to me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Nya?! Where the heck did you come from, nya?! If you came to try to steal Émile from me: get lost, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Please, I'm not THAT amazing! Still, if you think my contributions matter so much,: how about I watch both of your stores for a while? Would that be okay, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
