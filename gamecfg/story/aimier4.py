return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "... It seems Dunkerque:es this every day. She makes mouth-watering sweets which she just gives to people...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, you're here as well, Émile? Why:n't you come here and we can eat them together?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Is that so...? Ah, my apologies; today must be a no-sweets day for you. Please,: tell me the next time you'd like some.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll leave these here,:. Take your time, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Dunkerque left her confections on the desk and: exited the office. Now, what to: with these...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Commander,:n't mind me, I can manage...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you:n't take care of your figure, you'll undoubtedly regret it in the future!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
