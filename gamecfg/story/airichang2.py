return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Everybody calm:wn. There's some weapons over there we can take. This is how we survive...!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She got the hang of it pretty quick. And if she can: it, anyone can.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This is gonna be tough. I'm thinking just wailing on it with basic attacks won't: the trick!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We'll create a diversion. AI,: it! Pull the trigger!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
