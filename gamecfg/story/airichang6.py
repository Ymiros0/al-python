return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmmm. Now we have one of York's \"Special Drinks\" right here. Why:n't you take a swig and see if that answers some questions?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "York, I really:n't think you should- aaand she's already drinking it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "York!? Ms. Vestal! Can you: anything for her!?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I thought she was guilty at first, but: she went ahead and chugged that stuff:wn all by herself. I gotta give props for that. I think the Commander'll forgive her too!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, maybe someday somebody will drink something again, and: somebody will come along to make the magic happen one more time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "*shudder* I just got the strangest feeling that somebody somewhere was:ing something really stupid but... I'm just gonna let it go....",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
