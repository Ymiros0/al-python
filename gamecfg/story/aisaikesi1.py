return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "These are the:cuments that require your review. I've already sorted the majority of them for your convenience.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Next, please pay attention to today's itinerary. conduct training exercises, take inventory on commission rewards, plan out the daily patrols, apply for new research and development projects, and:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
