return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Mm... I see that you're as dedicated as they say you are, Elder Essex. Sorry for interrupting you:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The Sakura Empire:rms, huh... this must be where that woman stays...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Yooo! Commander,:ing your rounds? Oh, Essex is with you too! Congratulations on becoming the new secretary!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
