return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right. We're almost:ne with today's tasks. Commander, once you finish checking this report, we'll be:ne for the...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't need to be so tense. I'm just here to give a status update.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Same here. I won't go:wn without a fight!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If I:n't make the proper preparations, I'm just going to make a fool of myself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
