return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I would congratulate you too, but you:n't seem to have broken a sweat.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm not like the others though. I'm about to show you what I'm made of, so:n't take me lightly!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's nice to see them go all out every now and:, hehe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
