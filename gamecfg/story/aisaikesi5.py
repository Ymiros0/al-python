return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Perhaps it was time to: something about this...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm just:ing my job as secretary... there's no need to go out of the way to thank me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This:esn't feel much different from our usual patrols, just in a different location.",
			bgm = "story-1",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			options = {
				{
					content = "\"How: you feel about Enterprise?\"",
					flag = 1
				}
			}
		},
