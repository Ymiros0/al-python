return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "When you have these kinds of thoughts, you've already let your:ubts get the better of you.",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Commander... is this your:ing?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I already know. Remember, True strength:es not come from the recognition of others, nor is it a marker on the side of the road for you to pass. True strength is in its pursuit, for your own sake.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"I'm not gonna lose to you again!\" ... and I'll prove it before that lucky crane:es!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
