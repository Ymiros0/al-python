return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... Ah, someone's at the:or! Come on in, it's unlocked!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			actor = 107090,
			nameColor = "#a9f548",
			say = "Essex's expression was a strange mix of embarrassment and anger. Enterprise, who was in the process of pushing open the:or, awkwardly stopped mid-way.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
