return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...I see. Essex, you'll be in charge of leading the blue group:. I'll explain the key points to be aware of later--",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Although my original responsibilities were to oversee and record this exercise, Enterprise told me that I could lend you my aid if you needed it. Essex, are you sure you:n't want my help?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Sorry, but I'm:ing this alone. I need to find out how far I can push myself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
