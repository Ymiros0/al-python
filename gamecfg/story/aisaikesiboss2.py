return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "You're welcome. Anyway, I still have work to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(I'm going to have to prioritize that if I want a shot at taking on Essex. But how: I: that...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm? Whatcha:ing, Independence? You look like something's really bothering you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't know much about that either, right? After all, you're the one always charging ahead of the rest of us. Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right, shall we head out:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
