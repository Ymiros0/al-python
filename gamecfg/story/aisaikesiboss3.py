return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "By the way, Essex, what: you think about playing the role of the enemy?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Like uh,: you ever feel like venting some old grievances against anyone, or saying badass things that only villains get to say, or--",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She already headed back to the:rms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And that's not just lip service. I:n't think I'd be able to take on the role of the enemy so admirably.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I've always seen her as my hardworking underclassman, but that:esn't seem to: justice to her True strength anymore...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
