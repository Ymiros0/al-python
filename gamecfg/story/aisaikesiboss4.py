return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Um, Essex... What: you think it means to \"become stronger?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "As long as you:n't get impatient, Independence, I'm sure you'll see great results.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
