return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I actually: have a plan in mind... Well more accurately, I should say that I've been working on a little surprise.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Think you could: me a favor, Commander? Pretty please?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "The indoor pool, huh... Since it's the middle of summer, everyone just goes:wn to the beach anyway so the pool is pretty deserted.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
