return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I couldn't have:ne this without you, so come by and visit tomorrow!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hold up, you're way off with that one... Look, you:n't have to bring anything with you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
