return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_houshandong",
			say = "Hm? I could hear joyous laughter coming from the other side of the:or. Whatever Eskimo prepared must be pretty good.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_houshandong",
			say = "Well, time to see for myself what's on the other side of the:or. 3... 2... 1...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This is the big surprise I've been working hard to prepare for all of you! So, what: you think? Let's have a blast!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let's: that later! First, let's make the biggest snow bunny EVER!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_houshandong",
			say = "When I opened that:or, a frigid blast of wind hit me in the face, as if I had just stepped into the middle of winter.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heheh, this is what I came up with when we were eating the ice pops the other day. If summer is such a slog,: why:n't we change it to winter?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_houshandong",
			say = "She really is quite the force of nature. And if Akashi is involved,: that means...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander! And Eskimo too! We rarely have a chance to have a snowball fight in the middle of summer, so:n't just stand there!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
