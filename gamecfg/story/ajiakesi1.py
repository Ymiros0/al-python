return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Hehe~♪ Well:, what's the problem~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "Jeez... I:n't know anything about \"indirect kisses\" or whatever, but could you stop bothering the Commander already?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Okaaay~ It seems like we can't: these kinds of things where Leander can see.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "But, if you: want to: these kinds of things with me later, I'll let you drink as much as you'd like, okay~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "Please,: look forward to it. Hehe~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
