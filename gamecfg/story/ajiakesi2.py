return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Since Exeter is the kind of person who won’t listen even if you try to persuade her, is it not faster to anger her and: make her cave in, rather than explaining to her for days on end?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "Even if that's the case, you:n't have to mess with her so much...",
					flag = 1
				}
			}
		},
		{
			...
			side = 2,
			dir = 1,
			say = "My, it appears that you: not support my actions, even though I am the secretary ship. Quite commendable, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
