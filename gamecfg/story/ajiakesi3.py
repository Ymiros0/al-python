return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Hehe~ I am merely:ing the work of a Secretary Ship. Feel free to sit back and relax, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "And that was - she was unable to properly: anything that remotely fell under the category of \"chores.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Or, could it be that you intend to make me: these chores, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Hehe~ I'm alright with:ing just a liiittle bit, but... my evaluation of you will drop, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "You'd happily: something like that, wouldn't you? Little piggy~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
