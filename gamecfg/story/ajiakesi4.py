return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "I wonder. To me, it:esn't seem like the Commander is bothered at all, isn't that right? Could it be that actually, you want to: something like this as well, Spee?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "Not really... Unlike you, I:n't have any interest in teasing the Commander. If I did so, I would sully the name of the Iron Blood.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
