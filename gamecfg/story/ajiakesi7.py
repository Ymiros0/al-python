return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "*Sniffle*... *cry*... Why: I have no choice but to be treated like this by little piggy...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_room",
			say = "When I got closer to check on how Ajax was:ing, she suddenly pulled me under the sheets.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
