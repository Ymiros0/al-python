	...
	scripts = {
		{
			...
			side = 2,
			dir = -1,
			say = "That {namecode.20} is such an idiot, she:esn’t trust what {namecode.98} says, nya...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = -1,
			say = "That’s impossible! All inventory has been:uble checked by {namecode.98}...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
