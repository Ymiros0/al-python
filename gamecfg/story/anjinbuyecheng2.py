return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 705061,
			nameColor = "#A9F548FF",
			say = "Nobody but you could bring:wn Valiant, the master of the Manjuu Tower.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_130",
			say = "But she suddenly whips out a key and opens the cell:or for me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
