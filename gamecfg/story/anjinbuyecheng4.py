return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = "home",
			say = "Tallinn, I'm at the target area... But I:n't see anything unusual.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 703012,
			nameColor = "#FF9B93",
			say = "The famous city-wide blackout was your:ing, wasn't it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 703012,
			nameColor = "#FF9B93",
			say = "I thought you were gone for good, but it seems you've reared your ugly head again. How: you plan to hurt our fair city this time?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = True,
			say = "Empty words. From my perspective, all you're:ing is interrupting our pursuit of a dangerous criminal.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 703012,
			nameColor = "#FF9B93",
			say = "I:n't believe it...! Our security force lost its Commander long ago!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = "main2",
			say = "Tallinn... You:n't seriously believe her,: you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
