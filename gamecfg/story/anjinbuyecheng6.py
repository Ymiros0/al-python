return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_146",
			say = "As soon as I open the:or, I make eye contact with her. My heart skips a beat.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 705081,
			nameColor = "#FEF15E",
			say = "But:n't worry. You're my guest, and I'm not the type of queen to be rude to guests.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 705081,
			nameColor = "#FEF15E",
			say = "In exchange, when you connect to the city's main server, I need you to: some... fiddling for me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 705081,
			nameColor = "#FEF15E",
			say = "Once that is:ne, a new contract will be bound. The order of this city can be rebuilt.",
			painting = {
				alpha = 0.3,
				time = 1
			},
