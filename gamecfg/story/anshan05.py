return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "It took some time... but it's finally:ne!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "And we couldn't have:ne it without everyone's help! Ahh...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "She's... cute... when she:es that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Well, there's no need to rush it. First, why:n't we enjoy some food I brought with me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = -1,
			say = "Okay,: after that, I'll take my time and draw something... Hehehe...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
