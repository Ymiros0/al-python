return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_outdoor",
			say = "... Just:, I saw someone peeking her head out from behind the wall...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "Oh, I'm here:ing... perfectly normal... ordinary things! You know...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "I:n't suppose you could help me, Commander...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Come:! Let's test your mettle in a duel!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
