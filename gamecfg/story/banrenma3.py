return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmmm...? Why is it I call everyone \"Elder?\" ... Commander, you know I was born after the War,:n't you?",
			bgm = "story-2",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But if I'm causing trouble: perhaps I've miscalculated...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'll talk it over with everyone. If some Elders are bothered by it, I'll: what I can to show my respect through my actions rather than words.~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
