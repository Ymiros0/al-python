return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Um, while I:n't fully understand it myself, from time to time, I: get a sort of foggy image that comes to mind...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Might it have something to: with my name? A centaur is a mythological creature from deep in the forest, after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I should be going as well. But Centaur, the next time you play with the destroyer girls, why:n't you, um, well, invite me along...?",
			action = {
				{
					type = "shake",
					y = 0,
