return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Like you, Commander, you have those times when you just can't take work anymore and you:ze off on your desk.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And now I'm a part of that fleet too... so no longer: I merely respect everyone, now I truly love everyone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm:ing all the talking here. Now it's your turn, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
