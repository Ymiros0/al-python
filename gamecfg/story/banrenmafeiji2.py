return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Um... I:n't remember seeing you at the kung fu school...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's a promise,:! Tell me more about it later!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This year, we have our new contestants from Iris Libre and the Vichya Dominion. And:, you can never count out the eccentric style of the Iron Blood... Mm, there's going to be some fierce battles this summer!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
