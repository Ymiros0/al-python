return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't sweat it! For now, why:n't we sit:wn over there? I'll teach you just how important these summer battles are!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But what is she:ing sitting over there...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*cough* Ahem! Centaur?! Javelin as well? I:n't usually see the two of you together.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All righty, we'll be heading off:!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
