return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hehe, that's when the real fun begins! It has something to: with you, so make sure to be there!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Right~? I'd love to dig in, but... I:n't have the courage to look at the scales afterwards...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Ah,:n't worry! Just let me know and I'll be glad to make more.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
