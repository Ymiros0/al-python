return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I dunno... I:n't think anyone was really thinking hard about how to spend their time off. Sometimes, we just want to kick back and have some fun! I'm the same way!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
