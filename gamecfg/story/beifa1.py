return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Are these:cuments ready for the Commander, Your Majesty?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Belfast?",
			say = "Good day, mesdames. I am Belfast. May I ask,: either of you know where the \"Commander\" might be?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
