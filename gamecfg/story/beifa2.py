return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.98}",
			say = "While we:n't yet understand the principles at work, we: know that the device emits a heat ray with tremendous penetrative power when stimulated by a high voltage direct current, nya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.37}",
			say = "So I:n't expect we'll run into any such problems again...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Madam Akashi, I've come to retrieve those:cu—",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
