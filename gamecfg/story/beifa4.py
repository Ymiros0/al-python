return {
	...
	scripts = {
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "But I still:n't know how Little Bel came to be in the first place, nya...",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Yuubari,: you have an idea, nya?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Sounds like we've got more experiments to:, nya...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Right:, how shall we conduct Test #257...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
