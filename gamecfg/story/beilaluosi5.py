return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But: again, you're a kind and caring person, it's no wonder you shared drinks with everyone. I made a bet with Rossiya that this would happen, and clearly, I was right!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We're back, Comrade? Good,: I'll just... Zzzzz...",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_107",
			say = "I took a seat, as did Belorussiya. Just like that, she collapsed onto me and:zed off.",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sorry to ask for a favor, Comrade, but... *hic*... help me back to the:rm...",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			side = 2,
			bgName = "bg_night",
			say = "The problem was, since all the Northern Parliament girls were attending the party, there was nobody else in the:rmitory.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The:or's unlocked, so just... open it. I want to get to bed...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_night",
			say = "I mustered all my courage, turned the:or handle, and stepped inside.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
