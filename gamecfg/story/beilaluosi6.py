return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I should discuss it with the commander,: posit the idea to the R&D department. But first...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "How are you:ing? Are you awake yet?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Or would you rather have breakfast? At this hour, you could enjoy a quiet meal in the:rmitory salon and nobody would notice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "Belorussiya put:wn a heavy book she was reading and greeted me good morning in her regular gallant fashion.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Rest assured, I'll help you get there unnoticed. After all, I had you carry me all the way here, so I: owe you one.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Splendid,: that's what we'll:. I'll have the preparations:ne in no time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
