return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I was just about to enter my office and resume another day of fleet management. Right as I put my hand on the:orknob, though, I sensed something was off.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I know who's behind that:or. It's a very certain Northern Parliament battleship who, despite her:mineering character, I knew I could trust.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then how about a bet? I think I know the exact reason why you:n't want to come in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I could've sworn I locked the:or the night before...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Though I hesitated for a moment, I entered the office. Inside, I found Belorussiya, sat at my desk and looking ardently through some:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Of course, I still left some work for you to:. You are the commander, after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "She led me by the hand, taking me to my same old chair located behind the desk. I sat:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
