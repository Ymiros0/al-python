return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "...although Bailey’s appearance:esn’t scream confidence in her ability to handle things, she is full of enthusiasm…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I just received a telepathic wave from the Rabbit Alien, they want me to help with the Commander’s work. So Commander,:n’t be afraid to call on me for help~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
