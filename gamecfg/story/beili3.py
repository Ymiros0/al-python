return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Don’t pretend that we’re close by calling me chan, I:n’t plan on being your close friend...",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "...forget it, since we’re teammates on the battlefield,:: what you must.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I must say you really: put in the work,: you always practice after work?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Nachi-chan,:n’t you always secretly come here as well to practice your dialogue and the likes?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "...cough cough. Anyways,:n’t tire yourself too much,:n’t you have secretary duty during the day?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
