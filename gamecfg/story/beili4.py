return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Good morning, Commander~ So, the super cute Benson will take her leave, and will not bother you while you’re working:~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "...so you were influenced by Benson:.",
			dialogShake = {
				speed = 0.15,
				x = 22.5,
				number = 2
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, let Bailey tell you something in secret, please:n’t laugh ok...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
