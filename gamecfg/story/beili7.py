return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Bailey did it. So even if the Rabbit Aliens: not exist,: Bailey will be the first Rabbit Alien.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And and, just now Akashi said that perhaps they: exist in another g-galaxy? ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So, perhaps the Rabbit Alien Planet really:es exist, only that we haven’t discovered it yet~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "At the very least, even if the Rabbit Planet:esn’t exist, it will exist within the hearts and minds of this fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
