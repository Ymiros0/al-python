return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 101271,
			nameColor = "#a9f548",
			say = "If Miss Ghost can't find her way home,: that's so pitiful...",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Although, \"three virtuous witches\"... If one counts Bailey as one of them,: who are the other two...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
