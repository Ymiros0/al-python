return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sigh... Rodney is such a troublemaker... Half the time I:n't know what goes on in that mind of hers.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(Even though it'll surely be a prank, it's not good to leave these kids alone without help... I'll follow them:)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
