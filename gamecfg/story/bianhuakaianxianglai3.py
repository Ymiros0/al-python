return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "They:n't seem to be new models of Sirens, but they clearly work in unison.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "They:n't just evade battle. When forced to fight, they act in entirely different ways from before.",
			painting = {
				alpha = 0.3,
				time = 1
			},
