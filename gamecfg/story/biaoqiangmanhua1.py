	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=60>\"This is a work of fiction. Names, characters, events, and incidents are products of the author's imagination, and maybe a World War II:cumentary. Any resemblance to actual persons, living or dead, or actual events... well, might actually be somewhat intended but that's not really what's important...\"</size>",
					0
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:, Javelin's gonna give it her all today... eek?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
