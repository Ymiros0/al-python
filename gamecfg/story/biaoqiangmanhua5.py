return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I only got to write half of it when I was in the Manga Club! The ending was:ne by someone else!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "W-well, so much was going on that I didn't know how to continue... and: I left my sketchbook in the classroom...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And: everyone took turns drawing in it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, everyone has their slumps. Next time, let's: our best to see things through to the end!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "But what if they:n't see this message on time? You never know with extended maintenance...",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
