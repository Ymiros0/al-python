return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_590",
			hidePaintObj = True,
			say = "A proud queen dressed in black stood inside a lavishly decorated train wagon, admiring every detail of her:main.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Fascinating, isn't it? The things you can: with spatial distortions. Did you base this technology on that found in Mirror Seas?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9705040,
			say = "What's more, they: not require a central control device somewhere within their space like a Mirror Sea:es.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9705040,
			say = "Indeed it:es. Aren't we brilliant?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9705040,
			say = "Supposing that a single Rail costs as much as your gate of Camelot, that cost:ubles with each additional Rail you add.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9705040,
			say = "Telling us to hurry up won't: anything. Or what, will you reimburse us when something breaks if we depart unprepared?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "Say, why:n't we travel to your branch? Your Camelot can surely accommodate one single train.",
			painting = {
				alpha = 0.3,
				time = 1
			},
