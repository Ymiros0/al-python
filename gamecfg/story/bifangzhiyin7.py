return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "But please, DO eat dinner. I:n't want to hear excuses about how eating is a chore.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I'll just find something nice to eat after everything's:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_545",
			hidePaintObj = True,
			say = "I see Memphis off,: I leave the conference room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			say = "I walk through the:or and start taking my first step out into the evening sunlight... when all of sudden, it's all gone.",
			bgm = "story-darkplan",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			hidePaintObj = True,
			say = "As the noise intensifies, the projection of Helena becomes increasingly distorted, eventually collapsing altogether into a blue:t before disappearing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "If the group behind Antarctica was responsible for jamming the line Helena set up for me back:, it stands to reason that they could also hack this virtual space.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			hidePaintObj = True,
			say = "I look around, waiting for the view of the stars to change, but it:esn't.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Dammit. I never did ask Helena what you: to \"hang up\" in here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 3,
			say = "It has something to: with the lack of pain and realizing you're dreaming. Maybe if I fall from a height, the impact will send me back to reality?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 4,
			say = "(No, what am I thinking? This isn't a dream, and even merely convincing myself that I've died is a risk I:n't want to take.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			hidePaintObj = True,
			say = "The next thing I know, a:or has appeared in front of me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "And there's that:or again. The same one I saw when I delved into Anchorage's data and when I spoke to Soyuz.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			hidePaintObj = True,
			say = "There is no answer. The:or just stands there, silently.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "It:esn't look like there's any other way out...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
