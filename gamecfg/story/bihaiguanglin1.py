return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then what: you suggest? It's not like we could send Lady Nagato...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Anyone come to mind, Kaga? While I:ubt the Iron Blood will show us anything too spectacular... you never know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Surely you:n't think they'd concern themselves with such trivial matters.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You have a point. They have more important things to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Mikasa is completely off the table. She's too prone to sticking her nose into places it absolutely:es not belong.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If what you need is someone with an esteemed name who'll mind only her own business,: I can think of none better suited than Lady Shinano.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"\"Mhm. Sounds good to me. Well:ne, Thiele.\"",
					3
				},
				{
					"\"Please,:n't pat me on the head. It's infantilizing. Now,: you need anything else?\"",
					4
				},
				{
