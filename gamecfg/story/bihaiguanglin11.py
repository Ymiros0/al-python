return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "So: there was this... and that... and some more of that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Wait,:esn't this mean that Shimakaze's going to show us up? Wouldn't that make me the dumb one:?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right:, let's keep moving forward and keep our eyes peeled for any other mechanisms!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "(I:n't want to: this, but I:n't really have a choice...!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
