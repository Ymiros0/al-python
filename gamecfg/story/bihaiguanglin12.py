	...
	scripts = {
		{
			...
			actor = 302070,
			nameColor = "#a9f548",
			say = "You know, this place really:es look just like the Dragon Palace from our legends...",
			flashin = {
				delay = 1,
				dur = 1,
				black = True,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I can't really see Akagi or Nagato:ing something like this though. The Yamatos though... It might be more:wn their alley.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We still:n't have enough information, I suppose. Considering how we only just jumped in, we:n't have much to work with.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Now:, let's get through this little puzzle~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
