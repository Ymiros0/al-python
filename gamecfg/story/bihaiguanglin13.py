return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 303060,
			dir = 1,
			say = "Having that said, I:n't think our attacks are exactly having the desired effects either.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 305140,
			dir = 1,
			say = "(But is this really the right way of:ing things...? While I'm in the back overanalyzing everything, Shimakaze's group is already about to break through...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
