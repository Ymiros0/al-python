return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Katsuragi,: we really have to destroy a place this nice...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Well, if this turns out to be one of the Sakura Empire's facilities, we're obviously not going to destroy it. But if it is a Siren facility, we:n't have the numbers to collect all the information we possibly can and still ensuring Lady Shinano's safety... So that means we have no other options.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Good thing it's not the real deal:! What's with this crappy hospitality? They didn't even roll out a banquet for us!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If there's anything you can't figure out, just leave it to me! Let's start by taking:wn these seals, just like we did before!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ugh, I:n't even want to think about it! Everyone, be very cautious when using your weapons––",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
