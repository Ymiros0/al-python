return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Retreat! Run for it! I:n't wanna sink in a sea of flames!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Isn't it way too reckless to spread oil all over your own castle and: set the freakin' thing on fire?!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Katsuragi, I think I might be able to: something about this...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ugh... You worthless pieces of mass-produced metal... If you wanted to see the world burn so badly,: let me show you what a True sea of flames looks like!",
			effects = {
				{
					active = True,
					name = "speed"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm not:ne yet! Third time's the charm!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "Woah, um, why:n't we calm:wn first? I:n't think a single carrier's going to be able to get through anti-air fire that dense!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Arghh!! It's all because I can't utilize my full potential inside this cramped space! Hey, Shimakaze,:n't just go rushing off on your own again! Get back here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
