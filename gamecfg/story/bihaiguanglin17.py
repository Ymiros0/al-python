return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...I:n't know how much Shinano has seen about the Commander, but let me tell you something important first.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Just as we: not fully understand the True nature of the Wisdom Cubes, we also: not know about how exactly this \"resonance\" works.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
