return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Well, I'm just so excited to be here that I want to make:ubly, triply, and quintuply sure! It's not that I:ubt your eye, not at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Understandable, but you:n't have to repeat yourself five times...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "If I may interject... Even as fellow fully-fledged aircraft carriers, I: believe you and Lady Shinano differ in significant ways.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh, and please let her know that we'll: our utmost to ensure her safety.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sure. Would it be possible for us to stay here until:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ah, I see! That'll: just fine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "But: I got distracted by a beautiful bird which flew past me. It led me off course, and now I have no idea where I am!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "???",
			say = "A person...? What: you: amongst the bushes...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "Lady Shinano? No, but I'm thrilled to: so soon! I've heard only a select few have seen her in person!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I've no:ubt you'll reconcile, and be close friends one day...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "Mhm! I hope we:! By the way, Ma'am, would you mind telling me your name?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
