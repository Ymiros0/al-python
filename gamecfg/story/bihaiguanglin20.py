return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "I won't say no, since it's not like I had anything better to: other than to think about how to break out while trapped in here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "You know what they say. show,:n't tell.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
