return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_daofeng_5",
			dir = 1,
			say = "The seal crumbled before her unparalleled destructive might, the mechanism sitting atop a pedestal soon following suit,: followed by the rest of the building.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "The target has been completely annihilated. Well:ne, Odin.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "Now:, girls, let's get moving~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "That's only something we can: once, and it's only made possible by taking advantage of our surroundings.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
