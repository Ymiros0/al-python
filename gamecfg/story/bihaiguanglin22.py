return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Pedestal? Oh, I: remember seeing something like that, but... Self, mind giving me a hand?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait,:n't just go around touching things! It might be dangerous!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "If I: it like this... Oh yeah... How about right here... And look, it's:ne~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
