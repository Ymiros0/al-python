return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "There's no need to feel:wn about it. I'll be waiting for you by the gate right outside the entrance into the tower.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 303060,
			nameColor = "#a9f548",
			say = "It might be. Let me: a quick analysis of the enemies we've defeated so far...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 305140,
			nameColor = "#a9f548",
			say = "Why:n't we just drag them all over to that burning sea?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
