return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "Maybe it's just a Siren noisemaker:? ...Hehe, you'd prefer that over some strong enemy or devious puzzle, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 305140,
			nameColor = "#a9f548",
			say = "(I:n't even want to think about how annoying this is going to be...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 303060,
			nameColor = "#a9f548",
			say = "All right:, let's group up in front of the gate and head into the Heart together.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
