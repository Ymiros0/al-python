return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Really? Then I've got no idea what they're:ing here... Time to find out, aircraft carrier-style! I'll send out some recon planes!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Shimakaze, go give it a quick look, would you? And:n't get lost this time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Wait, there is?! All right:! I'll be back before you know it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
