	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What's this? ...My wounds are all healing up?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307120,
			dir = 1,
			say = "...But why would she be attacking us:?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Who you might be means nothing to me! I'm the guardian of this castle, and I challenge all those who trespass!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
