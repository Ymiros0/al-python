return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What good:es it: for you to wait for prey to fall into your lap here in the Dragon Palace? Hakuryuu, why not test your mettle in the outside world?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 399050,
			dir = 1,
			say = "...You speak the truth. But that has nothing to: with our current battle!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "You shall see that I am the sole master of this:main! By thunder is sky rent, by flame shall you be cleansed!",
