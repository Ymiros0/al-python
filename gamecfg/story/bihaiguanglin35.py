return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "...And that's a valid reason to slow:wn to a crawl?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "My, my, Thiele. I thought Lebe was supposed to be the impatient one. It's not like we're:ing anything wrong~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "Assuming she:esn't have the entire leadership under her thumb–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "Besides, if the Sakura Empire:esn't want even more things to regret... they'll have the sense to not lay a finger on us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "...So, how: you explain that fleet in front of us?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "And I assume... I:n't have the option of refusing your offer?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
