return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Our communications with the outside have been cut off as well... Yura,: you think this \"seal\" might actually be a Mirror Sea?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Right as rain! But... what: we: now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let's see... Well, there's no way we can ask for help from Lady Shinano now. The first and only thing we can: is figure out how to get out of here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "In any case, let's join up as we originally planned. The entrance obviously won't: any good for us now, so we'll have to explore around and see what we can find.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Good, we have plenty of \"eyes\":. Now as for how we meet up...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I suppose having a landmark will make it easier for us to group up... I guess we'll meet at the Palace's \"Heart\":?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Suruga, since we're going to meet up anyway, why:n't we have a race to see who can make it to the center first?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Fine, fine. I'll be counting on you to lead the way:, Chikuma.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "You're on! We'll be Team Shimakaze:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
