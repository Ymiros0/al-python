return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Look, you:n't need to keep calling us... I know, just take it easy, we'll be there on time.",
			flashout = {
				black = True,
				dur = 0.7,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*sigh*... As long as you:n't make a mess of things~",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Huh? I:n't remember:ing anything...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
