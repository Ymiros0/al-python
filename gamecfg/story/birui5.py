return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Omnom! Even if that's True, I'm not puttin' this meat:wn. If you want some, you're gonna have to get your own!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You'd like me to keep you company for one more song? Certainly. I:n't mind at all~☆",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
