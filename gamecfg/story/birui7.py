return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "\"Why: you like banquets so much?\"",
					flag = 1
				}
			}
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm, how should I put this... The preparations are grueling, you get no compensation for:ing it, and when it's over, you feel lonely...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We all build up so much stress during our everyday missions... If there's anything I can: to help alleviate some of that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you think of these banquets as a form of healing,:esn't that make them seem much more marvelous?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Very well:. Let's begin our moonlit cruise... just the two of us~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
