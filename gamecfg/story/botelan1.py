return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "My desk is buried beneath giant stacks of:cuments, none of which go more than one sentence without mentioning Indianapolis.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Indianapolis:esn't like the idea of being commercialized, but her concerns:n't seem to weigh much on Portland's conscience.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't think it's the best way to: it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Having said that... if it:es work, and the two of them make new friends in the end,: that's great. And so, I give her the go-ahead.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's not the part I have my:ubts about...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
