return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You're asking me to become a fan of *your* little sister. Now why would I: that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_school",
			say = "Deutschland:esn't seem to be joking. I order her to calm:wn and lower her cannons.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, I guess so... If anyone tried to: the same to my little Indy, they would regret it big-time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No, wait,:n't leave! I'm not:ne preaching yet! Come baaaack!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
