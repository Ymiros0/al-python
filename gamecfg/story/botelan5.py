return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*sigh*, so what is the idea behind this fleet, exactly? Three girls from one faction, but: there's me, Dorsetshire, and Portland...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Probably not, though. I:n't expect much teamwork out of a pack of:gs.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "A pack of *what*?! I dare you, call me a:g again! I:uble:g dare you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Huh?! You're:ing this to... close the gap between me and other people?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, all right, I suppose. And:n't worry, I'll still play my part in the mission!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But in exchange, we're gonna have a:uble pass of Indy Appreciation Hour when I get back!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
