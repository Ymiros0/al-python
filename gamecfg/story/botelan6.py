return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Very well,: I will come in from the right and crush them!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Still, I could've:ne an even better job if only Indy had been here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You've also made me want to learn more about your sister, if she really gives you the power you claim she:es.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
