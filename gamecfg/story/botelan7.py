return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The Commander wanted to improve everyone's perception of you, and thought the best way of:ing that was to have them see you in a new light.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sis... It really:es make me happy that you like talking about me so much.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait, that:esn't sufficiently express how grateful I am. You deserve something a little more special...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mhm. Since you made me smile, I think you should: the same for the Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
