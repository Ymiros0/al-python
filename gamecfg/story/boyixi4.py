return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 102290,
			say = "(Commander still:esn't seem concerned about my mask... Rather, I:n't think it's ever been an issue...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 101440,
			say = "Commander! I've brought you your:cuments!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "After placing the:cuments on my desk, Cooper quietly slipped out of the office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I, I knew it, my mask is scaring people off... Commander, if it's getting in the way of your work,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "\"Don't worry, you're:ing just fine.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 601050,
			say = "Well:, see you later, Commander! Come play with us sometime!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "The situation seemed to be getting a little out of hand, and I had to: something.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Um, thank you, but... you:n't have to go out of your way to change your shopping schedule because of me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
