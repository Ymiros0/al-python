return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Now:, I'll be the moderator to make sure Boise keeps her promise.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Boise, I just thought up another challenge for you! You:wn?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Uh, there wasn't any agreement on that, but what: you think, St. Louis?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
