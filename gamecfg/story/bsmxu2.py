return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll be an ace in no time. And: they'll have to give me the Knight's Cross, maybe even with oak leaves! And: Lord Bismarck will notice me~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And: to be an ace among the aces you'd need something like two hundred thousand...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
