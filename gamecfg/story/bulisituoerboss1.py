return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 101480,
			say = "So what's this about:? I hope you're not here just to mess with me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "Ingraham unrolled the sheet of paper and began reading it with a:ubtful look.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "At any rate, the job was:ne. I hurried back to my office to prepare for my meeting.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 101480,
			say = "Just relaying orders for you. The Commander was in a big rush, so I'm:ing it instead.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 101480,
			say = "Crap. The line must've cut right as she answered. Oh well, I've:ne my job. Back to enjoying my time off.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Did... Did something happen back at base? Is that why the comms went:wn?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Oh goodness, I'm starting to hyperventilate... Need to calm:wn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			oldPhoto = True,
			say = "If the port is under attack, the enemy is without a:ubt monitoring our radio channels!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			oldPhoto = True,
			say = "Whew... The glow of my lantern's helping me calm:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Wait, I get it now! The idea is to gather everyone there,: launch an organized counterattack on the enemy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
