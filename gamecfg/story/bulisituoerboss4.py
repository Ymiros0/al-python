return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "All I have to: now is lie and wait...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 101450,
			say = "Almost makes me think this place is haunted. Maybe that's got something to: with why Bristol was acting strange when I saw her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All righty:. Now if you'll excuse me, I've gotta run an errand! Have a good rest-of-the-day off!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
