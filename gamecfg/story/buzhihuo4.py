return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Uuuughh... that was cruel, Nyaa.... Why did you have to:dge away from Akashi?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Despite her grumbling, Shiranui picked up the pen and started making corrections on the:cument dutifully.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
