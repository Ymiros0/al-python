return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Commander, you:n't need to blame yourself Nyaa. This is just Shiranui's personality, she:es everything meticulously and never asks for help from anyone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm used to having to: things all alone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
