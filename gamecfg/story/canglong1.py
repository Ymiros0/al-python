return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "My name is Souryuu. Commander, from now on, please request my permission in writing before:ing anything weird.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Good morning, Commander. I have already sorted all your:cuments, so please begin reviewing them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, surely you aren't daydreaming about weird things while pretending to read your:cuments?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
