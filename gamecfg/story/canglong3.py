return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahaha... I wouldn't say \"always.\" Even I need some time for myself now and:.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You have a point. I imagine it can be hard to deal with Ayanami and Laffey since they like to: things at their own pace.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't have to pull your punches. *sigh*... We definitely: have a handful of oddballs...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You know what they say, \"you:n't get to choose your own family.\" But, looking back, I:n't think I'd want it any other way.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
