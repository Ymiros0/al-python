return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, though you're free to spend your day off however you please, I'd recommend you: something more worthwhile.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "As she spoke, she was still working on:cuments that she had brought back from the office yesterday. Truly a model secretary.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Listen, Hiryuu. This is simply what is expected of every member of the fleet. My relationship with the Commander has nothing to: with this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This has nothing to: with a \"woman's allure\" or that \"girlishness\" thing that you're always talking about, understood?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, isn't there something that you'd want to: to improve your girlishness?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What are you... why in the world would I want to: something like that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
