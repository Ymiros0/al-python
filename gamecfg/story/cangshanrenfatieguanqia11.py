return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "I'm detecting wakes at two o'clock. Looks like Iron Blood, Eagle Union... and some girls with riggings who the database:esn't recognise.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "God's sake, Asuka. Do you always get shocked by transformation ninjutsu, too? Actually, you probably:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000010,
			say = "She was, but: there was this blinding light, and all of a sudden she was gone.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000040,
			say = "So that's what happened... The ball of light: traveled towards the castle over there, yes?",
			painting = {
				alpha = 0.3,
				time = 1
			},
