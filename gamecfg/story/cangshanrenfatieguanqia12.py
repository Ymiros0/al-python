return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000010,
			say = "I:n't have the faintest idea. It's not like we have magic powers or anything like that...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000040,
			say = "Looking at it that way, magic proficiency may have something to: with Fubuki's kidnapping. They must have had a reason to take her.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "The power to create:ors between worlds... Yes, that would be a very attractive ability to the Sirens.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "The Sirens would without a:ubt want to get their hands on her if she really:es have that power.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404040,
			say = "So, basically, if we rescue this Fubuki girl, this whole thing'll more or less be:ne and dusted, yeah?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000010,
			say = "Then we know what to:! Before anything else, we've gotta rescue Fubuki! And to: that...",
			painting = {
				alpha = 0.3,
				time = 1
			},
