return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103240,
			say = "You can't think like that. The Sirens:n't operate on common sense.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What's this? It looks like there are three:ors. There is also a sign of some kind.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "\"Past these:ors, complete all trials three. Succeed and the path will open for thee.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "Uh, yeah. Odd time for it, but I assume we:n't have a choice...",
			painting = {
				alpha = 0.3,
				time = 1
			},
