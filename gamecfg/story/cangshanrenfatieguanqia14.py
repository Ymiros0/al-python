return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404040,
			say = "The sign says \"trials,\" so I bet there'll be tons of trap:ors and pressure plates and stuff past this point.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404040,
			say = "What: you all think? Should we just pick a:or and bullrush it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "It said to, \"Complete all trials three.\" Don't we need to reach the end or destroy what's past each:or?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103240,
			say = "There's no rhyme or reason to what they:... 'Least, I can't find any.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000040,
			say = "Considering the circumstances, we:n't have the time to go through each:or as one big group.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Splitting into three groups and:ing all the challenges at once seems to be the only choice.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "Judging by the castle's design, I expect what we'll find beyond these:ors are traps and the so-called Pawns made in our image.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
