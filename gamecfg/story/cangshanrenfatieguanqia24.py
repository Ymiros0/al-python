return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "You: that. I desperately need to rest back at the port.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103240,
			say = "Can't see a thing... Huh? Is that a:or?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "I... guess this is your literal:orway back home, girls. If nothing else, the Sirens: tie everything up in a nice bow at the end...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000010,
			say = "Wait, we can go back if we go through the:or?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000050,
			say = "It:es resemble a world gateway... Yet something's different about it. It feels a little nostalgic.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103240,
			say = "If our past experiences are any indication, it's probably broken. One of our interdimensional:orway experts should be on the way.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Please,: allow me to invite you to a tea party after that. I'm not bad at brewing tea, as a matter of fact. You're going to love it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
