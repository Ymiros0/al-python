return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "L-let's all calm:wn and discuss what we know...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "No! What we need to: is figure out what's going on and gather more information before anything else!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hey, hang on, that's not what we were:ing...",
			painting = {
				alpha = 0.3,
				time = 1
			},
