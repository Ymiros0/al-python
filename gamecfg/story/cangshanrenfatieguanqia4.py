return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "The question is, where? We:n't even know where WE are at the moment.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000030,
			say = "You're saying there won't be any problems with us:ing the same thing? Then the answer's pretty clear to me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "This situation should be resolved very quickly if we can group up with the search party,:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
