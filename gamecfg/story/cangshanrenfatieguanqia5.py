return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ugh, unrelenting little bastards! One hit is all it takes to knock you out anyway, so stop:dging, god dammit!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Humans, puppets,:esn't frickin' matter when it's taking all I've got to hold 'em back. We're gonna get bent at this rate...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Alright, I think that's the last of them. You there, are you okay? You:n't have riggings, so I'm assuming you're not shipgirls.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404040,
			say = "So, like, can you: cool ninja stuff? Like transform or create clones of yourselves?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You must have:g companions who follow your orders, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Some of us: keep:ggies as pets, yes...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
