return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "No, but this is the direction the light that took Fubuki came from. All we can: is keep moving forward.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000010,
			say = "Sure, if basic capture ninjutsu will:. Give me your hand for a sec. Okay, now, let's take this rope aaand...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Someone has to save her... But if it comes to a fight, I:ubt I can fend the attackers off by myself...",
			painting = {
				alpha = 0.3,
				time = 1
			},
