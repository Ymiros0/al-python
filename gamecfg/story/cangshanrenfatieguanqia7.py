return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Akatsuki, take command! The rest of us:n't know how to deal with Sirens! You know how we shinobis fight,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I've contacted the port, but they won't be able to: much until we've dealt with the Sirens behind this.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Our goal is the same – to solve this problem at its core – so why:n't we work on it together?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Sooo... Basically, saving Fubuki is our number one priority? If so, there's no:ubt in my mind!",
			painting = {
				alpha = 0.3,
				time = 1
			},
