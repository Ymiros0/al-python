return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103240,
			say = "Yeah. I've seen riggings: amazing stuff, like combine with others or transform. Don't get many of those outside Iron Blood.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "\"Magical\" really is the word. We're speaking to ladies who dart across the sea,:nning machinery the likes of which I've never seen before.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I could:ubt you until the cows come home, but that's meaningless. Instead, I will trust you.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Indeed – it's Fubuki. If she is here,: Asuka and others must surely have come as well.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "So you have, like, a person sensor? A sixth sense? Or: you have superhuman powers?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404040,
			say = "Can't say I'm surprised. This is how they: it in most cases.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404040,
			say = "How: I put it? I guess you could say the Sirens are generous. Either that, or this is another ploy of theirs.",
			painting = {
				alpha = 0.3,
				time = 1
			},
