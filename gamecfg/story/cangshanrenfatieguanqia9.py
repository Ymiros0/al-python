return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000060,
			say = "Umm... Can we talk about the elephant in the room? You: see that very suspicious place over there,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000040,
			say = "I:. It's where Fubuki's presence is coming from.",
			painting = {
				alpha = 0.3,
				time = 1
			},
