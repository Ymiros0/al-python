return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You've got a lot of training to: if you're falling for simple tricks like that, mecha-ninja.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "You must watch the battle carefully and make the right decisions accordingly. Taking all-or-nothing risks is the worst thing shinobis can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "I know that, it's just... How: I put this... Your way of teaching is pretty punishing.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103240,
			say = "Akatsuki? Whatcha:in' in there?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hibiki?! Oh, it's you, Bremerton... Please:n't scare me so.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Huh? No, I:n't, I'm busy. Really busy with something. Haven't been this busy in aaages.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Okay, okay! I'll: it, just put that thing away!",
			painting = {
				alpha = 0.3,
				time = 1
			},
