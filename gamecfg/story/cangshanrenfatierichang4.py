return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Which is to say... Well, it's not much different from the training we: on a daily basis here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000070,
			say = "If nothing else, it:es present itself as being ordinary.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There are lectures, combat training, and tests, of course. The only we:n't really have is a uniform.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "As long as it's cute, I:n't mind what people wear!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh, I'm not saying we:n't like the uniforms we wear every day. It is an essential part of blending in with society.",
			painting = {
				alpha = 0.3,
				time = 1
			},
