return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000070,
			say = "I:n't think journeys thousands of kilometers from home can be called \"trips\"...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 11000040,
			say = "Please:n't tell me you play catch with depth charges, or shoot clay pigeons out of the air...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Obviously, we:n't: anything THAT dangerous.",
			painting = {
				alpha = 0.3,
				time = 1
			},
