return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900218,
			say = "Wasn't I reading:cuments aboard the train just a moment ago?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900218,
			say = "What a peculiar sun. I:n't feel its warmth on my face.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Sovetsky Soyuz put away the:cuments she was perusing, and prepared to get off the train.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Comrade Sovetsky Soyuz, we have arrived at your destination. Please ensure you have all your:cuments and personal belongings with you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
