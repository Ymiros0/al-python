return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Days had passed since the Crown of the Holy See was lost. Richelieu was reviewing:cuments at her desk when she heard a knock at the:or.",
			bgmDelay = 0.5,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I: hope I'm not interrupting you, Cardinal.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 801070,
			say = "I'm only:ing my duty. Incidentally, you look much more alive now, Cardinal. Did that dubious Tribunal medicine actually work?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "You, on the other hand,:n't look so well. Is there something I should know?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh,:n't worry about me. I just haven't been getting enough rest.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "With her gone, the Tribunal's the most vulnerable it's ever gonna be. So, now's the time to act if you wanna spring that Gali:uble agent plan into action!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You:n't really need me around here lifting boxes, right? Then, put me to good use and let me go: what I: best!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "They developed a device that is capable of tracking:wn the Crown's location, and hid it somewhere on this island.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 801070,
			say = "This device will be key to our ability to retrieve the Crown. Or... so the:cument I read says.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 807010,
			say = "Cardinal Richelieu, the Eagle Union's fleet has:cked at Saint Helena Island.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Say, La Galissonnière, why:n't you have a few training sessions with her? You did say you had nothing better to:, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 801070,
			say = "By the way,: you still have some medicine left? I could use another phial.",
			painting = {
				alpha = 0.3,
				time = 1
			},
