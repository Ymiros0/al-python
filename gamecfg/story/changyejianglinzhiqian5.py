return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_unnamearea_1",
			hidePaintObj = True,
			say = "Since the:wnfall of Compiler, the waters of the NA Ocean had become considerably safer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "Commander, how: you feel abo– Hey! Put those away!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You:n't have to work all the time, Commander. Can't you set your job aside for at least a few days?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "\"But, the new work:esn't care if I'm on vacation or not. It's not going to stop coming in.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 105170,
			say = "They used to be everywhere when Compiler was still around. Now that she's gone, it really feels like they went the way of the:do!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "Isn't peace what we're all fighting for? We should look forward to the day we:n't have to fight anymore.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Besides, it's not like there's NOTHING to:. There are still pockets of Siren activity in the NA Ocean.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "In any case, we:n't want a repeat of that. That's why I'm out here, patrolling.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_unnamearea_1",
			hidePaintObj = True,
			say = "\"You:n't need to hype this vacation up so much. Still, thank you.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "So, just to be safe, why:n't I escort you all the way to the Expo?",
			painting = {
				alpha = 0.3,
				time = 1
			},
