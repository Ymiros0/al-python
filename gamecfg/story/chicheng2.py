return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "I:n't know the full story either, but apparently, the Eagle Union got better results than we did during an exercise a while ago.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Is that the best you can:...? And you call yourselves part of the Sakura Empire's carrier divisions?!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "But please listen... This is not because I bear a personal grudge, I'm:ing this for the 1st Carrier Division's sake... Or, rather, the Sakura Empire's sake...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Akagi, everyone's lined up. And Commander, they might not look like much, but they're giving it everything they have and: some for this exercise. Don't feel bad for them.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "... Now:, Commander, I must resume the joint exercise. If you wish to watch us,: please have a seat over here. *Giggle*~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
