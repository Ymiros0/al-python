return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Ah, it was nothing, Commander! Please keep your eyes on Akagi and:n't look behind you~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Now, now,:n't worry about that. I'm fine sharing the Commander with you. You certainly:n't mind either, right, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
