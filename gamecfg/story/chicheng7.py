	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				...
				{
					"\"And to: that, I would: anything, even if it meant asking God for help...\"",
					6
				},
				{
		...
		},
		{
			...
			bgName = "bg_night",
			dir = 1,
			say = "I felt a kiss on my cheek,: woke up. Apparently, I had fallen asleep in Akagi's lap.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "I didn't: anything while you were asleep. As long as you accept me, I am happy...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "If you say you:n't wish to look at me,: that is fine... If you say you won't be mine...: that, too, is fine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
