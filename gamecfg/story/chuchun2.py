return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#92fc63",
			dir = 1,
			say = "I gave the report on your behalf, so:n't fret over it. If you were so scared of giving the report, you should've just asked me to: it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			dir = 1,
			say = "*Whimper*... I-I can't: thiiiiis!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
