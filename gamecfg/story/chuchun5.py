return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey, you:n't have to be so modest~ And Hatsuharu, you did great too~ Good luck with your secretary work! See ya~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... I really didn't: all that great...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(I can give it my all in a real battle, but when I'm training with Fubuki and the rest, I can't maneuver as well as they:...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Practicing with the Commander has really improved my sociability, and I've slowly gotten better at:ing secretary work, yet I still can't: well in combat with people I:n't know...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Maybe all my hard work has been in vain... If so, I probably:n't need to force myself to be the Commander's secretary anymore...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't want all your efforts up to this point to have been for nothing,: you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
