return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 506010,
			say = "Happy Lunar New Year to you too. May I ask what you're:ing with this entire set, Miss U-73?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I did add in some herbs, but this formula:esn't include any artificial additives.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "After we're:ne with our photoshoot, everyone should give this special tea a try!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 502080,
			say = "Miss U-73, we're:ne setting up the equipment! Ready whenever you are!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "I'll be:ne in a sec! Now:, let's: that photoshoot~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
