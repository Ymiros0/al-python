return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_176",
			say = "We upgraded our gear and stocked up on supplies,: read up on the Demon King Army as much as we could.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "So it's not that purification:esn't work, it's that those bases undo its effects.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "What? The Commander can: that?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
