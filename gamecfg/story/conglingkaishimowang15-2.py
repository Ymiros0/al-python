return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I'm curious, what are you:ing out here? Did you leave the safety of your castle to go on an adventure?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I: not take kindly to insults directed at the soldiers of the Royal Army!",
			painting = {
				alpha = 0.3,
				time = 1
			},
