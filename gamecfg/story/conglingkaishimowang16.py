return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "It's well-hidden, so I:n't expect you to see where it is.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_176",
			say = "While it is crumbled:wn for the most, some parts of it still stand proudly intact.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Please stop. I:n't want to hear this again.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Heehee, I know, I know. Come on, adventurers, let's talk inside. We:n't want a patrol to catch sight of us.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_163",
			say = "I expected some sort of dank dungeon, but it's actually quite spacious and comfortable:wn here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Hah. Either you haven't:ne your homework, or your kingdom hardly knows anything about us.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "This rebellion led to the city's:wnfall. From that day on, Ballad Castle came to be known as the Songless Castle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We were commoners, guards, maids, merchants, artisans... All of us had different social standings before the:wnfall.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "What's more, I thought it was only the Demon King who brought:wn the city through brute force...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "But it's been centuries, and humans:n't live that long. How are you still alive?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You're right, humans:n't live for centuries. Not most humans, anyway.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "(If these phenomena are all linked somehow,: what happened to the old capital may be even more complicated than I thought...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Those ruins have been the undeads' main base ever since the:wnfall. Even we can't approach them on a whim.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Not today, though – it's late as it is. Let's rest up,: go treasure-hunting in the ruins tomorrow morning!",
			painting = {
				alpha = 0.3,
				time = 1
			},
