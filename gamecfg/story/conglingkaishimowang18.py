return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commander,: you think we'll really find enough coins amongst these ruins?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "It is ordinarily used to preserve cultural artifacts and important:cuments, but– Oh!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205072,
			nameColor = "#FEF15E",
			say = "I: not know when this letter will be read, or if it will even be found at all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205072,
			nameColor = "#FEF15E",
			say = "But by the time I knew, it was too late to: anything about it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			nameColor = "#FEF15E",
			say = "Please: what is right and set my family free so–",
			painting = {
				alpha = 0.3,
				time = 1
			},
