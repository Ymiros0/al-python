return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:n't just think – I KNOW we can!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Thought I'd check it out, and what: I find? You lot, starting the party without me!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600010,
			nameColor = "#A9F548FF",
			say = "So, what are we:ing? Fighting the Dragonlord?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Fine by me! Let's take her:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
