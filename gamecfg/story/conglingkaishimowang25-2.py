return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_mmorpg_cg3",
			say = "In terms of strength, our party:es have what it takes to defeat this great dragon.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yes, but this battle is going nowhere. The Great Fire Dragon has so much mana it'll slowly wear us:wn if we:n't: something.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "It knows exactly what it's:ing. This dragon is a clever bastard.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_mmorpg_cg3",
			say = "In a fit of panic, it:dges out of the way, missing its chance to heal itself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "I knew I had to hold on to at least one skill to defend myself, even if I:n't personally fight in battles.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Oh, I've been wondering – why:esn't your party have a healer? It can't be easy to adventure without one.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You:n't need a healer if you can defeat all the enemies before they defeat you!",
			painting = {
				alpha = 0.3,
				time = 1
			},
