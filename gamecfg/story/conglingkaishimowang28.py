	...
	scripts = {
		{
			...
			say = "After closing the game, I head to the Iron Blood:rm to speak to Friedrich Carl.",
			bgm = "story-richang-5",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Come in! The:or is unlocked.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_185",
			say = "Stepping inside her room, I see her lying:wn on the carpet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
