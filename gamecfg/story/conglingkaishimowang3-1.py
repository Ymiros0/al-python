return {
	...
	scripts = {
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "It:esn't get much more immersive than this. It really feels like I've gone to another world.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_520",
			optionFlag = 2,
			say = "If this place is able to perfectly simulate touch, smell, hearing, and so on,: simulating pain should be child's play.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "It's like my sense of pain is dulled. I assume that was:ne for safety reasons.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Let's see... What stats: I have this time around?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Doesn't sound like they have anything to: with charming or enamoring people this time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_520",
			say = "Just:, I hear a loud drumming noise coming from inside the forest.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Aha, so this thing automatically gives me data on the enemy. That must be one of my Info skills:ing their work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "While I:n't have any weapons, there are heaps of sticks and stones lying around.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_520",
			optionFlag = 1,
			say = "But:, it swells up with fury and starts making a beeline straight for me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "star_level_bg_520",
			optionFlag = 2,
			say = "I start running, but:... snap. A fallen branch cracks loudly under my foot.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "No, what am I saying? This isn't a game of dice rolls. Being lucky or not has nothing to: with it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
