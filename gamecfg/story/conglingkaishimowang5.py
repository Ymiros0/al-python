return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:n't hear any objections, so let's go to the marketplace and... Huh?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_502",
			say = "Eventually, the light disappears from the hall, as:es the Demon King and the sphere.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "What did you:? Did you use your Info Analysis skill? Crap, that's not good...",
			painting = {
				alpha = 0.3,
				time = 1
			},
