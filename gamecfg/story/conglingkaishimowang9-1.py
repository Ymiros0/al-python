return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_unnamearea_1",
			say = "With a smug expression, Nubian walks up to a clearing. She bows to a dead tree and: clears her throat.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "My teacher just likes black and red. Relax, it's got nothing to: with the Demon King!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			say = "Hmm... Studying under an extremely wise witch:esn't sound so bad.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FEF15E",
			say = "She's not. Training under my watch is:ne in increments of a hundred years. Don't you know that?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FEF15E",
			say = "That's what I'd usually:, yes.",
			painting = {
				alpha = 0.3,
				time = 1
			},
