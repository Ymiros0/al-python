return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hot as heck today,:n'tcha think... We oughta get in the shade of that tree, else we might be riskin' a heatstroke.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "We decided to stand in the shade of the tree together. The pleasant sea breeze blew against our bodies and cooled them:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander,:n'tcha think hardworkin' girls are mighty cute? Hehehe♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, I:n't mean I get a kick outta watchin' people hurt! I'm just sayin' I love cute girls, that's all~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_outdoor",
			say = "As I was making sure everyone was heading back to the:rmitory, Ooshio proposed we \"take a short walk together.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
