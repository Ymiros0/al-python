return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Though it was now late into the night, I still had a big pile of work to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, the deadline for these:cs is tomorrow mornin', so ya can't rest till ya gone through 'em...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:ne prepared ya some food. Once yer ready, gimme a call 'n I'll heat it up for ya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Thanks to yer hard work, ya almost:ne achieved yer goal~ Reckon ya can manage the final stretch?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "It felt like I got:ne with the remaining work in the blink of an eye.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
