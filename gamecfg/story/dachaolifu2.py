return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What's the big deal? I'd also rather have as much as I want than be tied:wn by some arbitrary code of conduct and not even be able to enjoy a glass.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
