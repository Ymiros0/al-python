return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_115",
			say = "It:esn't seem this quarrel will end on its own... I suppose it's time to send off the night.",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If only I could make the battlefield \"light up\" as beautifully as these fireworks:~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yuudachi, please...:n't talk with your mouth full.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
