return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 301641,
			nameColor = "#a9f548",
			say = "Hold yer horses, Urakaze~! I'm not:ne yet!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:ne told you, I got a lotta people to give to! 'sides, weren't you the one who talked 'bout givin' presents to everyone?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "No, please:n't say the word! Ooshio's not even:ne picking presents for her own friends!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "In that case, we'll leave you to it. But if you:n't mind my asking... Are those outfits you're wearing this year's Christmas costumes?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "It is. This is my handmade Warring States-style yuletide uniform. Hohoh, no need to tell me it looks good. I know it:es~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "W-we:n't have time to make enough Christmas costumes for everybody!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "B-but: it won't be a surprise when they open their present...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ask someone else, eh? Well, we:n't have any better ideas at the moment, so let's try it... Ladies, if you'll excuse us. Have a Merry Christmas!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
