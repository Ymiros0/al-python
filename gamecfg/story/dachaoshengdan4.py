return {
	...
	scripts = {
		...
		{
			say = "Saratoga led the two before the:or to a room.",
			side = 2,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's not what you think! Th-this is a... you know, that thing people:... A cosplay! That's the word!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You couldn't be more wrong if you think I was going to hide in a box wearing this reindeer outfit: pop out and say \"I'll be your present!\" when the Commander opens it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You'd better! And:n't speak a word of this to anyone!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Personally, I also think it'd be a little... weird if you: that, Warspite.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, I see... Then we still:n't have any good ideas. Hmm, we're running short on time...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
