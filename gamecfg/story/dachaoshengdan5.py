return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And it takes quite some time to pick out presents for that many people. Unfortunately, time is a luxury we:n't have...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It takes you hardly any time?! Do you plan out what to buy before you even leave the:rm?! Please, tell me your secret!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then how: you find the present that's just right for someone?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "You:n't need to fuss over finding the right present. They'll probably be happy just to receive a present in the first place, because it's the thought that counts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I can't turn:wn an offer like that. Thank you, Cygnet! I feel the thought behind your offer loud and clear!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "P-please,:n't put it that way... You're making it sound weird...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
