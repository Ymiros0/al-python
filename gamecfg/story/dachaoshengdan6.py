return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Didn't Enterprise say we:n't need to fuss over giving people the \"perfect present\"...?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well...: I'm sure Her Majesty will adore it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "Blast it... Our Christmas is:omed...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Thank you so much! Please take us to the Royal Navy:rmitory!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
