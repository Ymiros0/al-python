return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Whew, almost:ne. Now just to deliver this stuffed toy to Her Majesty...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "If that is so,: I shall see to it that it is immediately disposed of, Your Majesty!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No puns first thing after I wake up, please... I think I fell into the box when you got on the sleigh...: fell asleep cause it's so comfy in here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Huhhh? I'm a present now...? I guess that's fine... I:n't mind being Enterprise's present...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
