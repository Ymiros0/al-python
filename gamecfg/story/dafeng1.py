return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Was it this:cument my Commander needed? I know it was, naturally.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If there's anything you'd ever like to:, my Commander, you're free to: it. Leave the busywork to Taihou~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
