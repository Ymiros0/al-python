return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's obvious, isn't it? You always lock your:or, so I copied the key.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's like I said, you're free to: anything you want. Just leave the busywork to Taihou~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Anytime, anyplace, all day, every day, rain or shine, I will: anything and everything for you, my Commander~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That is what a secretary ship's should:, after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
