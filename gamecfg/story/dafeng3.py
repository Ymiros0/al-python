return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahaha! I just came by to see you, Taihou. How you:ing?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I have very important secretary ship duties today, duties that involve staying forever by my Commander's side. I:n't have time to play with you–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
