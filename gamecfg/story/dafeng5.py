return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Oh but:n't you worry. I'm:ing a fine job in your place, Akagi. I've checked every inch of my Commander's body for \"vermin.\" I've licked clean every~ nook~ and~ cranny~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Why you little... You're the one who copied the Commander's key! It's you who's been sneaking into that room every night to: heaven knows what...",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "To serve as your secretary, to give you the freedom to: whatever you want,",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "And that's how we ensure something like what happened back:, that will never happen again...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
