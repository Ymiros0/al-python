return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I've prepared all your:cuments for the day right here, my Commander~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "These are the urgent ones, the lower priority ones are:wn here, and the ones unworthy of my Commander's attention are in the trash.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Please let me know if there's anything else I can: for you.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... want to taste me? Want to bathe with me? Or maaaaybee~ You want to: some filthy, depraved things with me~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
