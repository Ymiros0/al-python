return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "Since:, da Vinci has been working hard every day as my secretary, just as she said she would.",
			bgmDelay = 2,
			bgm = "story-richang-6",
			flashout = {
				black = True,
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "After she finishes the day's work, she sits:wn and looks through her paperwork with a fine comb, searching for inspiration.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "\"The snacks would be fine, but cola is a volatile substance and:esn't react well to being shaken.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "M'kay... This'll: as a rough outline.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "By adding a buckle, you can ensure the cola:esn't roll around during transport without any complicated systems.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Pretty smart, if I say so myself! What: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Bah! I'll just: it on my own!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "She gives up on her new invention and goes back to drawing her designs by hand, like she normally:es.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
