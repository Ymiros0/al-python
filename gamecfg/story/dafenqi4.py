return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "And that's something I refuse to compromise on. What use is an invention that fails at what it was meant to:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "So she deems any invention that:esn't live up to her original vision as a failure.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Don't worry, it's still in one piece. Just because it's a failure:esn't mean I scrapped it or anything.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Look, Commander! It's the Self-Propelled Swooshy Piano I made ages ago! You can play it while making your way:wntown!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_148",
			hidePaintObj = True,
			say = "\"You could just travel short distances with it, like indoors. You could: that with it right now, without changing anything.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_148",
			hidePaintObj = True,
			say = "\"As for the safety issue, you could lay:wn a track. That way you can drive safely while still putting on a theatric performance.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "I'm telling you, it's a failure. Why: you want to keep it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
