return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#92fc63",
			say = "Hahaha, I've already learned how to: a secretary's duties, so feel free to rely on me for just about everything~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "...Just as she said, Hornet went about:ing tasks with just as much vigor as her greeting from earlier.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "At this rate, we should be:ne with today's work in no time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
