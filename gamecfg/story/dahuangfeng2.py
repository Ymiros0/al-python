return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, I'm just thinking about what to: next...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "By the way Commander, since we're just about:ne with work, want to play a game together?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehe~ So you thought pretty hard, didn't you. Well,: it's my turn! Let me move this here... and this piece over there... Done~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hornet is a bright and free soul. I:n't know how accurate it is, but my mental image of her is that of a cowboy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But I wonder if she's really fine. Isn't she concerned with her place among her sisters? ...I:n't really know how to phrase this properly, but it might be related to her pride, or be some kind of complex...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Here, have a sip~ and: it's right back to the game!",
			effects = {
				{
					active = False,
					name = "speed"
