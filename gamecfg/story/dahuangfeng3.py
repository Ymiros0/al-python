return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Once we finish putting this together, we'll be:ne... Mm~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Commander, I'm:ne on this side! How are you:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm... but it's a bit early to be excited... and it's no good for a secretary ship to be wandering about outside on a weekday... I wonder what I should:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Having an aura that radiates strength, but not haughty. Always willing to: her best, and respected not only by the other ships in the Union but also by her rivals...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "Well, she:es push herself too hard at times... Do something about that side of her first, and: we can talk!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, they're my dear sisters who I respect, but from time to time, I: get jealous of them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
