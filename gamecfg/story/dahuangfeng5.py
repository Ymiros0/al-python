return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The Commander's advice to you was \"special training.\" Well, let's get on with it:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That should be it for now. I'll be in the:rmitory, waiting to hear good news from you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_main_twilight",
			dir = 1,
			say = "With a bitter smile on her face, Hornet lowered her head and pulled her hat:wn to hide her face.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "It looked as if there was nothing to: but to tell her directly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
