return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"Pretend to copy Enty's tricks, and: mix things up.\"",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I might have been a bit:wn earlier, but pretend you didn't see anything! You didn't, right? Ugh... This is so embarrassing!",
			dialogShake = {
				speed = 0.08,
				x = 15,
				number = 2
