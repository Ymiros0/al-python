return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Don't you see that I've got two movie tickets in my hand? Let's get going! We weren't able to hang out yesterday, so we're going for:uble today!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:, let's head to the next place on our list~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Commander, are you tired? Let's take a break:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_night",
			dir = 1,
			say = "Taking my hand, Hornet and I sat:wn at a bench.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"Copying your sister isn't bad, but:n't just copy her. Use her power as a basis for your own skills and show off your own strength.\" ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That was nicely said, but I wanted to add one thing. ...There are times when I:n't want to rely on my sisters' powers,:n't want to copy their tricks, and just want to fight with what I have.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "For example... Like, I'm not as much of a trouble to deal with as my sisters are. I speak the truth about what I like and what I:n't like.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
