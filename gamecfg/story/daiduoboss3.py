return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All right, enough of that~♪ Dido and the others aren't fighting to the death, so why:n't we conserve our strength?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I: apologize for suddenly pushing such an important role upon you.",
			flashout = {
				dur = 0.25,
				alpha = {
					0,
