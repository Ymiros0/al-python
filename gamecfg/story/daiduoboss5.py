return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Dido lifted the hand of a stuffed:ll and pressed it against my hand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 3,
			nameColor = "#a9f548",
			say = "Umm, is there something that I can: to help...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 3,
			nameColor = "#a9f548",
			say = "Waaah... Master! Please:n't throw me away... Please let me stay by your side...! ！ ！ ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 3,
			say = "I calmed Dido:wn and consoled her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Is there any work that I can help you with? Just ask, and I'll: it for you! I'll handle anything for you, no matter the request!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
