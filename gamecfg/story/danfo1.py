return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And this is what I came up with. What: you think, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "As per Denver's suggestion, we established a sort of quest board for people to request others' assistance with whatever they need:ing.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's Cleveland for ya. I gotta take a leaf out of her book and: the same, as a fellow Knight of the Sea!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Look, she's even:ne the jobs involving moving stuff to that newly-built club building!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Denver always strives to: the best she can, but on this day she sounded especially fired up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
