return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Answering the call of those who need help, now that's what real heroes:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Charles produced a key and opened the:or to the storehouse. The interior was lined with tons of rations and food.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We're up against sneaky little buggers, eh? I:ubt it'll be easy luring them out of... Hey! There!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Whew! That's one, but we should expect to find:zens more, based on the look of things.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "She looked at me with gleaming eyes and thanked me,: promptly picked the flowers and got to work on concocting a simple pesticide.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
