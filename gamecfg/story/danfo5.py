return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You'd: that? It's nothin' important anyway, but if you wanna.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So, what: you say? Heard your sisters are into basketball. They could spectate if they want.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, I'm sure as heck not one to back:wn when my rep's at stake!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right,: we'll play in two hours. Get yourself warmed up and bring your A-game.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
