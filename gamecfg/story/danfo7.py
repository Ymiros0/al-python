return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't waste time thinking about that! Focus! It all comes:wn to whoever scores now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_112",
			say = "Cleveland went and gave Denver her congratulations and a fist bump,: Denver jogged over to me.",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Without you, I:n't know if I could've clutched the win like that! Thank you, Commander!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
