	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "Hunker:wn and get comfortable",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Before we could neutralize the enemy, we had to locate them first. What's more, we had to: it quick, before they could cause any significant damage.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Stupid, stupid mass-produced ships! Get back here! I have a very important meeting today, and I:n't wanna miss it because of you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "???",
			hidePaintObj = True,
			say = "Owwie! You... You can't target my ears! That's cheating! Hmph... Fine, if that's how you want it,: I won't pull my punches either!",
			flashN = {
				color = {
					1,
					1,
