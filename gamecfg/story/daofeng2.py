return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "Right... I'll take out the trash while going to check on the laundry, and: return this folder to its storage cabinet in the archives!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"In fact, I:. Did you: the task I gave to you first thing in the morning today?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
