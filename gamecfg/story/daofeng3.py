return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Shimakaze finished her last task for the day, sat:wn, and yawned.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_main_day",
			dir = 1,
			say = "That wasn't to say I was:ne with her for today. I just wanted to see Shimakaze in her \"natural habitat,\" so to speak.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "I didn't think you'd know that! Though, I'm not sure what those \"dev notes\" are... In any case, it started with me collecting them, but: I got really into making them myself!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All:ne! I drew a cute little picture of you and stuck it to the kite.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "That's me? Oh my god! I really: have a face only a mother could love,:n't I...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't put yourself:wn like that. It's a caricature. It's supposed to be exaggerated.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "Commander, I'm, uh, with Inazuma and Ikazuchi, and we want to fly a kite. We're going:wn to the coast, just letting you know. I promise I'll be back on time, though!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
