return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"Don't be sorry. I gave you permission to: so, after all.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"There isn't much work to: today either, so you're free to spend the day however you'd like again.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "She looked around the museum while hopping around like an excited:g. Or rather, an excited rabbit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
