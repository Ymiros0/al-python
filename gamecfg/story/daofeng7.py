return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Aww, dang it! I'll just have to: better next time, I suppose...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "Initially, I agreed to: it just as a means to push my own limits. And while it did have that effect...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 301290,
			say = "It also became an opportunity to inspire others to work hard because I myself am working hard! ...Wait,:esn't that make me sound like a slave-driver?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
