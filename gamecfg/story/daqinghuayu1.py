return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I had gone through my morning routine and was right outside the:or to my office. It seemed like it was going to be a normal morning.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			blackBg = True,
			say = "Opening the:or and stepping into the office, I heard all manner of different clinks, clanks, and ticks radiating from somewhere.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
