return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Five, six! Fingers, toes, that:es the trick!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "It seemed that they were:ing warmup stretches before going underwater.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "That should: it for warmups! Everyone ready?",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 0.7,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I:ubt... that's going to work...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I can make anything work! If I can't convince her to come,: my name isn't Albacore!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "Albacore was brimming with confidence. She really did seem like she could: anything.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
