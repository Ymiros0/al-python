return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "I'm gonna go to the beach tomorrow, and I thought it'd be nice if you'd play with me:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Guess we have the beach all to ourselves! Hehehe~ So, what \"stimulating\" activity should we: first, Com-man-der♡",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_106",
			say = "Albacore:ve into the water and swam off again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
