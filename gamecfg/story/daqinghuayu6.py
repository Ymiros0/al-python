return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_106",
			say = "I was resting in the soft sand where the beach and the water meet. Albacore did the same and sat:wn next to me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You know, Commander, I had a ton of fun today! Consider the second favor all:ne!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_106",
			say = "Albacore suddenly stood up and went into the sea,: she started splashing seawater at me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
