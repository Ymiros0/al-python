return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "First of all. thank you. I know I basically forced you into:ing those favors for me, but still. And hearing you say you had a lot of fun made me really, really happy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What:es \"sleeping in the same room\" mean exactly, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
