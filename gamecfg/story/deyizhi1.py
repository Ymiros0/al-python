return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I accepted the secretary position expecting it to be interesting, but all I: is sit locked up in this tiny office of yours.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And you, lowly slave, dare ignore your master and process those:cuments without speaking a word to me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"Help me get this work:ne.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Plead all you want, it won't: you any good!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... Hmph! What a helpless:g you are, begging your own master for help!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "N-now:, if you:n't have any new orders for me, I will take my leave...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If it means I get to feast upon that sight every day,: fine! I'll remain your secretary!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "But I think someone has to: something about that mindset of hers...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
