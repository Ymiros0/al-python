return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Bel, why: I need to attend today's exercise?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I'm not in the mood for it today! Have Warspite: it in my stead!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't want to: that exercise tomorrow. Get someone else to: it for me!",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "I have this hunch like Gneisenau isn't so much obedient to her, rather she just:esn't think Deutschland's attendance is required...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
