return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh, right... You:n't know the story behind all this, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yeah, I remember that... I've grown used to her attitude by now, so I:n't really need to be bound by that agreement anymore.",
			subActors = {
				{
					actor = 403040,
					pos = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I know it's for her sake, but it's a fact that what we've:ne isn't right.",
			subActors = {
				{
					actor = 403040,
					pos = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That is why I've called you here - so we can discuss what to: next.",
			subActors = {
				{
					actor = 403040,
					pos = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(Whispering) Slave... what should I:...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
