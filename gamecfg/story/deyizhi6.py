return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Indeed. I:n't know how it came to be, but she isn't just Deutschland of the Iron Blood, she was also born as Lützow of the Northern Parliament.",
			subActors = {
				{
					actor = 403040,
					pos = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "So basically, they were simply:ing their best not to hurt or upset her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I say we:. It's a shame to lose the arrogant Deutschland we know, but it's time she accepts herself for who she is.",
			subActors = {
				{
					actor = 403040,
					pos = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But how: we go about telling her that...",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We:n't need to: anything. Right, Gneisenau?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I let go of Deutschland. She walks over to open the:or,: steps into the salon.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heheh, of course I knew. So, what: you plan to: with us, Deutschland?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
