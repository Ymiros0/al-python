	...
	scripts = {
		{
			...
			dir = 1,
			bgmDelay = 1,
			say = "Damn it... Is this the best we can:...?!",
			bgm = "xinnong-4",
			flashin = {
				delay = 1,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Judging from our current situation, I hope it'll be enough... All we can: is continue to stall for time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*cough*... Now you've:ne it... I'll have to use this!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
