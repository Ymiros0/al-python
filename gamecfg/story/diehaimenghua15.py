return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah,:n't worry 'bout it! Things will turn around after this battle, so let's give it one last push!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That's the way it is. We're out of materials, so there's nothing we can: about it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I've given it some elbow grease, but I'll just have to make:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
