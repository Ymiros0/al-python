return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...We'll have to request permission to change our deployment formation. I:n't think there's going to be enough time for that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Just:... I felt my consciousness slipping... Ugh...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
