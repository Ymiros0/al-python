return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sorry, this was the best we could: due to how urgent this trip was. Once we return to Kure, we'll be able to finish your outfitting and equip you with some planes...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
