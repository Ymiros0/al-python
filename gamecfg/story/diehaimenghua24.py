	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "There's no way the enemy subs can keep up with Yukikaze the Great's speed! As long as we keep this up, we'll be:ne here in no time!",
			bgm = "battle-boss-3",
			flashin = {
				delay = 0.5,
				dur = 0.5,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...I:n't see any \"Army of the West.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm, Lady Shinano? What's the matter? You slowed:wn all of a sudden...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
