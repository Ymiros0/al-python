return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "(But even though this is a dream, why:es my body experience this agony...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(My consciousness is fading... but why:es this feel so real... unlike any other? ...Is this the fate inscribed upon this one's existence...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(What must I:... so that I may change this future...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
