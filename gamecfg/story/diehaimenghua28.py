return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And that concludes class for this semester! Be careful during summer vacation, and remember to: your homework!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Jeez, didn't you say you were going to: your homework first? ...Woah! Pooky! You can't come out yet!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Um... If you're worried about Ms. Amazon chewing you out, why not leave Pooky in the:rms?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Well, Pooky would be lonely:! I could ask Commander to help out, but that'd probably be a nuisance...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
