return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you're here for repairs,:n't just stand there! Come on in, Chitose and I both came for the same reason!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "My aircraft elevator isn't working quite right. I have an exercise soon, so I'd like to get it taken care of before:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't really feel like taking on such uninteresting jobs, but... guess somebody's gotta: it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hm? Why are you looking at me like that, nya? I let the Manjuus take over back there. They:n't need sophisticated orders to sell things for me, nya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't see anything wrong at all, nya. Purrfect condition, nya.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
