return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yes... However, the dream that I saw is different from the reality that I know... If this is only a \"fragment\" for me to collect,: the destination of this dream is also...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
