return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Damn it, Suruga's just flat out better at the strategizing... Guess I'll have to: things the same way as always.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Everyone, you're all:ing great.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehe~ That sounds fun,:esn't it, Shinano?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307080,
			nameColor = "#a9f548",
			say = "(I hope that this last dream... continues forever. It is so beautiful, this fleeting happiness, that I: not wish for it to end...)",
			flashout = {
				dur = 1,
				alpha = {
					0,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(If you are with me,: surely, this memory...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
