return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yes... Apologies, I:zed off slightly... What is the combat situation...?",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Is it just me, or:es Shinano seem a bit different?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Is it just me, or: you seem a lot more at peace, Lady Shinano?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.27}",
			dir = 1,
			say = "No matter what happens, allow Suzutsuki to lay:wn her life for you! Just kidding~♪",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
