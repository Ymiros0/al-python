return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Tester",
			say = "I have no desire to ape Purifier, but as the one who will pave the way for the Arbiters, I: wish to acquire data that can facilitate the Terminal's demise.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(...I:n't have time to think about that right now though...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
