return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(...Very well. I shall find the answers myself:...)",
			soundeffect = "event./battle/boom2",
			flashN = {
				color = {
					1,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I wasn't even able to: much because Lady Shinano was so strong...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(If the goal of the Sirens extends beyond me and the cargo Kashino carries, and the dream of ruination that I saw...: what must be changed is not a dream, but rather reality itself...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
