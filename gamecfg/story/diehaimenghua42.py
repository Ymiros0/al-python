return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Omitter",
			say = "Woahh, why:n't we put that menacing aura away? Real dangerous fella we've got here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Observer",
			say = "(Why:es Zero prohibit observers from exchanging information across multiple timelines? ...After all, I'm sure Zero is investing a lot of resources here.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Observer",
			say = "(More and more uncertainties appear in this timeline. And:, there is the \"Commander.\")",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
