return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "Clusters of high-rises:t the skyline, blurry-faced passers-by surge back and forth around me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "And most importantly – what am I supposed to: here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "I:n't remember bringing my phone with me into the Reality Lens...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "Rather, I:n't even recognize the clothes I'm wearing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But:n't worry, Northampton will be there to pick you up instead.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "As I walk:wn the street, some unmistakable landmarks come into view.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "...Until I have a better grasp of the situation, I:n't want to draw too much attention to myself. So, I should try to act natural–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"\"It created a portal, a:or into another era.\"",
					6
				},
				{
