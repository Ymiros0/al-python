return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_3",
			say = "If she regroups outside our recon range,: launches a focused assault on us, we'll be in serious trouble.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Memphis has yet to make a clear move. What shall we:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_3",
			say = "I've read all the materials about the Type II that I could get my hands on, and I'm still not sure if my proposal is actually:able...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
