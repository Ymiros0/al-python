return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_3",
			say = "The girls are:ing a good job holding back the reserve fleet, but there are so many enemies to deal with that they can't focus on anything else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "Huh? I guess. I just wish I was:ing something to help. I'm not mad at you or anything...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "They're handling themselves well, but that:esn't change the fact...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			hidePaintObj = True,
			say = "That's why I resurfaced from a distance – to lure her away from you while I:... THIS!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_3",
			say = "It lands just nearby on the deck,: burst open to reveal Memphis, rigging at the ready.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900332,
			say = "...I mean, what: you think? The test went perfectly.",
			painting = {
				alpha = 0.3,
				time = 1
			},
