return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you're gonna camouflage your secret research facility,: go all the way! That's basically Aoste's motto.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Poultry is, actually. But they: serve fish.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "So you'd see squids in the exhibits, and: you'd have to eat their relatives...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Unfortunately, the:ctor is currently preoccupied with work. You cannot meet him quite yet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_4",
			say = "Then, the floor ahead of us splits in two, forming a set of staircases that lead:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
