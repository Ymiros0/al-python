return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "Thought I'd explore this place, but I:n't wanna get lost. How many: you reckon, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I: not endorse moving through the facility without a Navigator.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "I:n't like it... I wanna go back to where we were before...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Basically, there's a laundry list of reasons why the facility looks the way it:es. Try not to take it out on the staff, alright?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Having that said, we're not some formal government delegation either. Just follow me and:n't go running around, and we shouldn't have any problems.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We're almost there. Please stand behind the yellow line while the:ors open.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I: so as instructed, and the massive:ors shielding the research division part for us, revealing a lab that seems to:uble as a manufacturing facility.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "The hologram of \"Zero,\" the girl who looks uncanNoney like TB, disappears after finishing her words.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "If none of this is actually real, why aren't I:ing something to get back to reality?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "She:esn't seem to be acting maliciously, but why isn't she telling me anything?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "(Then: me a favor. Wake Devil up and tell it to draw the:ctor's attention.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
