return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "In other words, we: some target practice first,: we shoot at each other?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "Are there any other Antiochus coming? Surely you:n't mean it's all of us against you alone...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Guess we'll have to hold back. We:n't wanna damage Dr. Aoste's beloved vessel.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "The Devil XV",
			side = 2,
			say = "Oh,:n't worry; nobody wants you to take it easy on me. This is a test of my combat abilities, so give me everything you've got.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107270,
			say = "I only glanced at the data headers, but it:es indeed seem to be a detailed specification of Devil's vessel.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "Huh, wonder what the problem is:. Maybe I:wnloaded too many of those movies Shangri-La recommended to me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "Well, uh, I sure feel strong enough to: just about anything!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "D-don't be so:wn. I listened the whole time!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_4",
			say = "\"Any more talk of data won't help much if they:n't actually learn anything from it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
