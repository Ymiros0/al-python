return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "I get out of the car and look around. It seems that these institutions of higher learning:n't change much – rugged and functional as ever.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Maybe people just:n't feel like leaving home on a weekend. The latest model of virtual entertainment devices just came out too, you know?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_highschool_future",
			say = "...She:es not seem to be providing the entire picture.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107270,
			say = "You shouldn't enable her like that. Her time management skills will only become worse and worse if you:n't call her out.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107270,
			say = "The Professor is Dr. Anzeel's assistant, Hammann, not yours. How: you refer to all your other teachers?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "We should call you \"Teacher\" too,:. You teach, and you assist the:ctor, too.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_highschool_future",
			say = "I:n't want to alarm her. I'm just a bit tired from the journey after all, in more ways than one.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Anzeel",
			side = 2,
			say = "Okay, that's enough pleasantries. Let's get:wn to business.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "Anzeel",
			side = 2,
			say = "Namely, sightseeing. I've delayed our meeting with the general until tomorrow, so my schedule is totally free until:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "Anzeel",
			side = 2,
			say = "We can go wherever and: whatever. We're the masters of our own destinies! For today, anyway.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "Anzeel",
			side = 2,
			say = "After that, we could: some window shopping,: go to the movie theater.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "Hammann, remember to stay close to us. We:n't want you to get lost.",
			painting = {
				alpha = 0.3,
				time = 1
			},
