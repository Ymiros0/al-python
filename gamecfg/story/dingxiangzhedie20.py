return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "The Devil XV",
			side = 2,
			say = "Once it was:ne, I transferred the ship here through my rigging, allowing me to deploy it in a place of my choosing.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "Even though this technology is amazing, I:n't think people will ever stop exploring new ideas.",
			painting = {
				alpha = 0.3,
				time = 1
			},
