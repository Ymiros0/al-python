return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "I wanted to thank you again for all you've:ne for me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "It might just be my own:ubts and insecurities speaking.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_7",
			say = "After all, I:n't remember what kind of memories the \"me\" of this world might have shared with this Yorktown.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "Once we're:ne here, I'm gonna get a good night's sleep. I'm sure everything will be fine when I wake up.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_7",
			say = "Without a:ubt, she knows that this whole world is a temporary dream. ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_7",
			say = "But, who exactly is she? She:esn't seem to be the same \"Memphis\" I know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
