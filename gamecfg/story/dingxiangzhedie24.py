return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "That:esn't make any sense. The module should've automatically shut:wn after the dummy warheads hit... Is something wrong with my sensors?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_7",
			say = "\"Hammann,:n't let them hit Yorktown.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "On it! I'll shoot every last one of them:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "Commander, what should we: now?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_7",
			say = "\"Devil:esn't seem to be coming for us for the time being. She is an AI, so we can't exclude the possibility that she's gone rogue due to an error.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_7",
			say = "\"You're right. I:n't want to risk any damage if it can be avoided. Let's radio Devil.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
