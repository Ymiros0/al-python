return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I've:wned another Enforcer!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I can't reach Samos Island... The:ctors aren't picking up, either!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commander,: you know what these enemies are?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oof! These enemies:n't mess around!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If they look like Sirens and come attacking us,: as far as I'm concerned, they might as well be Sirens!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Well said! Either way, there's but one thing for us to:. dispatch them!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_zhedie_8",
			nameColor = "#a020f0",
			say = "Or:es the Tower? Or the Natural Calculation System itself?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_zhedie_8",
			nameColor = "#a020f0",
			say = "I've:omed... the Commander... *sob*...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_zhedie_10",
			nameColor = "#ffa500",
			say = "Sorry to keep this introduction so brief, but we're going to: everything in our power to save the Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_11",
			say = "\"But there's one question you haven't answered. What:es the Tower have to: with all of this?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "The other Helena and I can regain control of this virtual space and extract you from the Reality Lens. To: that though, you'll have to boot out the other intruder.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "You know what to:, right? You said it yourself – \"Please fight until...\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
