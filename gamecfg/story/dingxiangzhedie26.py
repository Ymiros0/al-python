return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "The Devil's formation is already in place. Under these conditions,:n't even bother trying to attack the main vessel.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Our aircraft have improved in speed, power, and more. Helena, did you: this?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Don't let her Restriction-type battleships distract you. Fighting them is a trap people fall into when they:n't know about her tactics.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "I would normally: that remotely, but Helena hasn't gained full control over this virtual space yet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Also,:n't forget that she's still a floating manufacturing plant with the ability to call in limitless reinforcements.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commander, leave it to me! Let me: it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll: whatever it takes to protect her along the way and deliver her to Devil's heart.",
			painting = {
				alpha = 0.3,
				time = 1
			},
