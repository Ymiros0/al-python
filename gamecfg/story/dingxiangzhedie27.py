return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "What, did you:ubt the Commander and me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_11",
			say = "\"Is that what happens when you forcibly shut:wn the Reality Lens from the outside?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 101500,
			nameColor = "#A9F548FF",
			say = "Do you think this is a superweapon the:ctors developed to help us?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_11",
			say = "Hornet's voice cuts off abruptly. I look:wn at my battlefield monitor, and her signal is gone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_11",
			say = "First Hammann,: Northampton, Hornet,: Langley... The ones furthest from us are the first to go.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "And what: the Sirens: when they encounter a bug in the Natural Calculation System? They eliminate it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_11",
			say = "\"Isn't there anything you can: to stop her?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "After all, you wouldn't sit:wn and try to talk it out with a computer bug, would you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What about Dr. Anzeel:, and Dr. Aoste?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "I... I'm sorry. I:n't know what to tell you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			dir = 1,
			say = "Tell me. What can I: to help?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "Then that's what I will:. It's what you would want as well.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			dir = 1,
			say = "But is that really all I have to:? Do you know how to save the Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "If you really wish to help...: there's one favor you could: for me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
