return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_zhedie_13",
			nameColor = "#A9F548FF",
			say = "So anyway, how: you like this?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			actorName = "Aoste",
			say = "This is the latest vessel for the brand-new Antiochus model. What: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_aostelab_2",
			say = "\"Come to think of it, all the first-generation Sirens: have white hair.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
