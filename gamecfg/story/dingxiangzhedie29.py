return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_starsea_core_1",
			say = "(Things:n't feel off like they: inside the Reality Lens. I must be back in the Sea of Stars.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "She's fine. She woke up before you, and is:ing perfectly fine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "TB",
			side = 2,
			say = "5,320,000,000 results found. I suggest narrowing:wn your search.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_starsea_core_1",
			say = "\"Can you narrow it:wn to individuals you personally know?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_starsea_core_1",
			say = "\"TB,: you have any logs or data concerning my time in the Reality Lens?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
