return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "Before I know it, we'd already crossed over from the campus into the bustling:wntown area.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "The:ctor is quite the busy bee, isn't she?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"Let's check out the:wntown area.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107270,
			say = "I'm going to veto that. The:ctor's going to have our heads if we max out her credit card.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "C'mon! I might've thought about it, but I wasn't gonna: it for real.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "What are we going to::wntown?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The:ctor let me borrow it. Said it ought to give us a better view of the city.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There's a neat souvenir place just:wn that way. Whaddya say we go there first?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103260,
			say = "Wow, they have a lot of stuff you:n't see every day.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What: you have there, Yorktown? A shopping list?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Let's: that. We can't spend too much money after all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_zhedie_1",
			nameColor = "#A9F548FF",
			say = "Imagine having to choose your every word carefully. I really:n't think any of us are cut out for that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_zhedie_1",
			nameColor = "#A9F548FF",
			say = "Wait, first, let's take a group selfie! Northampton, you: the honor with your drone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "How:es that sound, Professor? Over here, you can stand in the middle. Hammann, Langley, scoot over a bit. Yorktown, you can stand right beside the Professor.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "Oh, I just got an idea. Why:n't we go watch that movie she's in? She did tell us to check it out.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_ny_future",
			say = "\"Sounds like a plan. Let's: it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
