return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103260,
			say = "Hey, it's not a crime if you:n't fully deploy it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101500,
			say = "There... Hey, Yorktown,: you want some:nut holes? Say \"ahh!\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "No, but the Professor's totally raring to: it as well!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hammann, Hornet,:n't you try to hide anything. Bags and hands where I can see 'em!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "When you're someone of his rank, the problems of everyday people stop fazing you. But having that said, the impact of said problems always has a way of trickling:wn to us.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "In other words, we:n't know a damn thing. Nothing about what enemies we're going to be up against, what equipment they're going to have, what \"unexpected situations\" we'll need to prepare for, nada.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "I see! Thanks, Dr. Anzeel, that works out perfectly:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Heheh. You can repay me by putting on a stunning performance,:. Who knows, maybe you'll get to participate in more projects in the future as well!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Agreed. I've never had a reason to:ubt the Professor's knowledge or experience.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Alright:. Since we're all on the same page, I guess we'll be calling you Commander from now on~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What: you say to that, my assistant?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "Darn. Oh well, that:esn't sound too bad.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "Just with one tiny caveat. All their bedrooms are:uble rooms.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You:n't wanna? 'Kay, we can exclude Hammann~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107100,
			say = "Well... If the Commander:esn't mind, I'd–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "You KNOW I can't: that! Fiiine. We'll discuss room sharing among ourselves.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Thought so. You have one hour before it's time to go. Decide before:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ooh, look! Street food! I used to visit the stands here all the time, and it looks like they've only gotten better since:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
