return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I:n't say this very often, but what the hell is going on? Their equipment is all cutting-edge stuff.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107270,
			say = "They have frigates with anti-air weaponry capable of shooting:wn entire waves of aircraft, and corvettes providing formidable close-range defenses...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103260,
			say = "They're trying to gauge how we'd: in case of an alien invasion?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "I can handle being the underdog, but this is ridiculous! What: they expect from us?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It makes sense to over-tune the enemy as well, considering what we: know about the trajectory of the Revolutionary Front's E-Cube research.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_3",
			say = "\"However, that:es not mean that we:n't have options.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			hidePaintObj = True,
			say = "While this is my first field exercise, I've:ne hundreds and hundreds of simulated ones before.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107120,
			say = "Woah, is that what you're:ing all day in your room? And here I thought you were...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 103260,
			say = "Don't worry. Just keep your wits about you, and:n't let the enemy get into your head.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900332,
			say = "What: you think? Over at HQ, looking for a first-row seat and popcorn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
