return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No,:n't add \"heheh\" at the end! Greetings are serious business!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So the greeting itself was fine,:! Alright, let's head out to play some games!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm not letting you sneak away when nobody's looking! ...Tai Yuan, keep an eye on Fu Shun and make sure she:esn't go anywhere.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now:, Fu Shun, should we go get the lanterns?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Why:n't you come with me? I just thought of something SUPER fun we could:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What's a Lunar New Year without firecrackers? Come on,: as your big sister says and let's go for a quick lookie. It'll be fun!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
