return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We can ask, but if they:n't know either,:... Hey, who's that over there?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "This is Yuugure. I:n't believe you've met before.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We're:ing something special for Lunar New Year and we're looking for some gunpowder to make firecrackers. Do you know where we could find some?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
