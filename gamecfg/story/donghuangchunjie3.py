return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Huh? Laffey, what are you:ing here? And what the hell was that noise?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Since Kimberly and Mullany just came here to learn how to cook, and you're here now too... why:n't you stay and enjoy some of the food we made, as an apology of sorts...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Uh, I:n't think it warrants an apology. But... I'm curious what your cuisine is like, and it would be rude to refuse. What about you, Lexington?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "I wouldn't mind either. We've never tried your cuisine before, so if anything you'll have to pardon us if we unknowingly: anything impolite.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
