return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "Now:, my dear guests, I hope you'll enjoy the food! We have seconds if you want more!",
			bgm = "main-chunjie",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn, Fu Shun, you:n't need to get up on the table!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Laffey, you're supposed to hold the chopsticks like this,: pick up the food with it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...It:esn't look like the commander made it in time to eat with us...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's okay! There's more enough left for one person! We can deliver it once we're:ne!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If everyone's had their fill, what: you say we have a Momopoly showdown, Royal ladies? Maybe we should give you a handicap too, since this game was made in the Union?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
