return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Unf... Flipping the light switch:esn't: anything... I think the breaker has tripped.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "I hear something...! I believe there is something:wn the hallway, drawing closer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Oh my gooooosh! Stop,:n't explode!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*Cough, cough*... Not again, Fu Shun! You'd better be prepared for your punishment after trying to: something this stupid! ...Wait, huh?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Kay, I'm:ne washing my face~",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now:, I will take my leave to deliver this food to our Master.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ahaha,: may I suggest we have an afterparty in the commander's office?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
