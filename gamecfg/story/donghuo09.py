return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Let's not worry about that for now. Why:n't we report back on what we've found so far? I'm not too keen on fighting any more of these new enemies...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now:, let's find the source of the signal. You:n't have a problem with that,: you, Washington?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
