return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "These must be Akashi's coins. They:n't seem particularly special, though.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702050,
			say = "Supposedly, I can find the fairies' treasure once I have enough. And:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But: not lose hope. This is the final prophecy.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You must take the fairies' final gift and: battle with the chosen Little Witch.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702050,
			say = "If that message was correct,: these should be the last ones I need.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702050,
			say = "I still have no idea what's going on, but if the others are involved,: it's up to me to help them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702050,
			say = "As for:ing battle with the Little Witch...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_161",
			say = "\"It took some:ing, but it looks like we've succeeded in drawing our new allies to the final stage.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 702050,
			actorName = "Kuybyshev",
			say = "I hear you've nearly won this little coin-collecting contest. Well:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
