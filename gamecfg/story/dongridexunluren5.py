return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705010,
			say = "Comrade Kuybyshev, beautifully:ne! You've given them a real taste of the Northern Parliament's power!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It may not be the best way to show my gratitude, but why:n't I go back to the:rm and make some piping-hot borscht—",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "There were two:cuments on my desk. One concerned the Fairy Magic event. As for the other...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "After giving me a token scolding, Kuybyshev placed a certain ticket on my desk. And:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
