return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But if you really:n't want us pulling pranks on people, I'll be sure to tell them not to: that.",
			icon = {
				scale = 8,
				image = "Props/story_shimengmo",
				pos = {
		...
		},
		{
			...
			actor = 307080,
			nameColor = "#A9F548FF",
			say = "No, what I really meant was... why: you wear those outfits?",
			painting = {
				alpha = 0.3,
				time = 1
			},
