return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Snacks and refreshments're lookin' good, and I just got:ne setting up my stall. This is gonna be one profitable vacay for me♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But it:esn't explain THAT! See? Something about that torii gate feels mighty eerie to me!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "It:esn't matter. It's nearly dinnertime, so let's head back or we'll be late.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We'll miss dinner if we:n't... Hey! Wait, Shimakaze!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We:n't stand a chance, wearing these costumes...",
			icon = {
				scale = 8,
				image = "Props/story_hetong",
				pos = {
