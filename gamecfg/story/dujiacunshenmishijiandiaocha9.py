return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_516",
			hidePaintObj = True,
			say = "I'm still on vacation now, and this morning, I received a report on the so-called \"Spirited-Away Incident\" slid in under my:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "\"...I should not have:ve deeper. I should have turned back. Yet, I keep moving deeper and deeper even now, searching for more...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
