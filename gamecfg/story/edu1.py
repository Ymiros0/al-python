return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commander, is there anything that needs fixing from the last batch of:cuments I handed over?",
			bgm = "story-richang-2",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Understood. I'll handle the rest of the work, so go: what you need to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Yaaaawn... Ugh, so sleepy... Can't: this anymore...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "If I:n't take a nap while the Commander is away, I'm not gonna be able to make it through the afternoon...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Great, perfect. If you didn't see anything,: there's no problem at all–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Isn't it perfectly normal for everyone to have a side that they:n't want to show others?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "I was just grumbling, that's all... Since this is the task I was given, I'm not gonna back:wn halfway!",
			painting = {
				alpha = 0.3,
				time = 1
			},
