return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "While Le Malin did continue to get her work:ne, she no longer made any attempts to hide her inner thoughts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Alright, ten minutes of work:ne. Time to treat myself to a little reward!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Phew, I actually managed to get everything:ne for the day. Now that's what I call a job well:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Huh? You're gonna say, \"why didn't you just: that from the very beginning,\" aren't you? I see it written all over your face.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Perfectly reasonable of you to think that, but nope, can't: it. Literally impossible.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "I can't get any work:ne unless I'm rewarded!!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Otherwise, nope! No way! Not gonna: anything!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "*gulp*... You scoundrel... There's no way any sane person could turn:wn her mouth-watering desserts...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "How about I also give you extra time to laze around:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
