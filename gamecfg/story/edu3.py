return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Huh? Le Malin? What are you:ing here?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Th-there's nothing wrong with taking a break every now and:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "But, what should I:? If I walk all the way back right now, I'm sure my legs are going to turn into jello when I wake up tomorrow morning...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_main_day",
			hidePaintObj = True,
			say = "Le Malin spread her arms as if expecting me to: something about it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#A9F548FF",
			say = "O-of course, I:n't mind if you hold onto me tightly...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "(Urrrrrk... I seriously hope nobody sees me like this! Please, I:n't want anyone to see this at all!)",
			painting = {
				alpha = 0.3,
				time = 1
			},
