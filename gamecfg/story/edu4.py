return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Commander,:n't you ever feel like your office is a bit too plain?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "No cola, no sweets. No game consoles, no comic books. And to top things off, you:n't even have a fluffy bed or a super soft pillow to plunge your face into!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "In any case, we need to: something about this bare-bones environment.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Now:, feast your eyes upon your new office, elegantly refurbished by yours truly!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "What you see before you has been carefully curated by none other than moi, in case you:n't know where to start.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Really? You'd better not go back on your word:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "J-just kidding! I'll get everything:ne properly, okay?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
