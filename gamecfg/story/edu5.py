return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "In other words, I can't get up at all right now, so:n't even try giving me any more work...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ermm, I:n't think I should be imposing on you like this...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Now:, to get some more work:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
