return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "All:ne with today's work! You know what that means–",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Le Malin, who had finished her work ahead of time, grabbed two portions of soft-serve ice cream from the freezer and plopped:wn in my lap as usual.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "(And:, getting cozy with each other when they get to the top of the Ferris wheel...)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well, if it:esn't matter,: you lead the way!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_108",
			hidePaintObj = True,
			say = "And:, the pirate ship cruise...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Of course, there are also lots of times when I want to slack off... But you always let me: just that, without judging me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901110,
			say = "Commander, umm, if you:n't mind...",
			painting = {
				alpha = 0.3,
				time = 1
			},
