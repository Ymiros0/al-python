return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"How: we carry out that manifestation?\" Unfortunately, I:n't have the answer to that, nya...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Even if we:n't understand it yet, as long as everyone works together, we will surely be able to unravel the mysteries of the Wisdom Cube, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... Until:, Akashi expects your continued support and patronyage at her shop. It'll be a pleasure:ing business with you, nya~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
