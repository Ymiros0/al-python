return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Also, the unlock requirements for these new Priority ships will be a little different from the previous ones, nya! If you:n't meet the requirements, go take a look at your Fleet Technology, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
