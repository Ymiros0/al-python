return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh,:n't get me wrong! It's just... I'm better at working with my hands than my brain...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Seeing Repulse's dejected face, Renown sits:wn at the desk and looks at the stack of files.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just a bit. You'll still have to: the cleaning and sorting on your own, Repulse.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But I did find some inaccuracies in the equipment maintenance:cuments... Like these here—",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Repulse, why:n't we have you: at least a little clerical work, like a proper secretary ship?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'd certainly like to... But I'm not sure I could: it like you:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So I'll just stay out of your way. Wouldn't want to bother you:ing such great work together! Enjoy yourselves! Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Right:, best focus on your work~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
