return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "A secretary's work is never:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Repulse carefully pushes the:or open to find the two going over:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Renown, to make it easier to point out issues in the:cuments, is seated right next to the Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
