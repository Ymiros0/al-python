return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "That's for sure. Things will get tight around here, but what else can we:—",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "But even if we didn't, we could still get it:ne. So why would Repulse, my designated secretary, come up with this plan?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I wonder if she's:ing this for Renown...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
