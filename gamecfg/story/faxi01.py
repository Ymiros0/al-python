	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=51>And thus, I lay:wn my life...</size>",
					10.5
				},
				{
		...
		},
		{
			dir = 1,
			side = 2,
			say = "On the calm sea, three battleships and an aircraft carrier can be seen, accompanied by over a:zen escorts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "You:n't need to have such a grave expression. We're not going to sink them, you know? Let's just say, we'll be giving them a chance to elect a new government.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
