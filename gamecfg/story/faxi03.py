return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = -1,
			say = "I: hope that you understand the reason we are here today. The Royal Navy would like your cooperation in halting the advances of Iron Blood.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "I cannot tell you what it is you need to: for your country, but... as a warrior, it should be your duty to fight for your homeland. I hope that you can reconsider and join our fight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "Well:, I hope you can back up your words by disarming right now.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "We: owe you our gratitude for clearing out the blockade for us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "We must take our leave now, but... we: hope to hear your official response soon.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
