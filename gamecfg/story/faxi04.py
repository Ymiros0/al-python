return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "It's not your fault. We:n't have a choice as things currently stand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "Please track:wn the source of the signal!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			mode = 2,
			say = "\"Put:wn your weapons, and: not resist.\" This was the order that we were given.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_faxi1",
			blackBg = True,
			say = "In:ing so, we will push back our enemies and emerge victorious. When that comes, we shall regain our lost glory!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
