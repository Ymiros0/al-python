return {
	...
	scripts = {
		...
		},
		{
			side = 2,
			mode = 2,
			say = "The enemy was strong:. But we too have grown. We are no longer the same Vichya Dominion that we were before.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			soundeffect = "event./battle/boom2",
			dir = 1,
			say = "So, looks like we've ended up fighting after all... Though, I won't get to show off if the enemy:esn't have any planes...",
			flashN = {
				color = {
					1,
					1,
		...
		},
		{
			...
			soundeffect = "event./battle/boom2",
			dir = 1,
			say = "Don't let your guard:wn! I'll leave the air defense here to you! I'm going to find that Siren carrier and smash it to pieces!",
			flashN = {
				color = {
					1,
					1,
