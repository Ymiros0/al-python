return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "We're just here to recover what was taken by the Crimson Axis! We:n't have to fight!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "It is always an honor when my foes recognize me. Unfortunately, that:esn't change the fact that I'll have to sink you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Those girls in the landing force... That was your:ing...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "Hmph. This is but an opportunity from God. If I defeat \"the world's strongest,\": perhaps Richelieu...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
