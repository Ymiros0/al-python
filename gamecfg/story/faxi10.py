return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Richelieu, I heard that we're all going to be moved to another:ck. Is that True?!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Doesn't that mean that you're telling us to flee?! How: you expect us to: something so cowardly?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "The world is not such a simple place... Just: as you've been told. When your fitting is completed, seek me out again. I'll always be waiting for you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Lay:wn your arms, and come with us...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			soundeffect = "event./battle/boom2",
			dir = 1,
			say = "How could you: such a thing?",
			effects = {
				{
					active = False,
					name = "rangbaer"
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "When the war is over, you'll surely be completed. We'll settle our score:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "Sure. I'm also looking forward to that day... Until:... let me rest a while...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Remember,:n't: anything that will tarnish your noble name...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
