	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"I:n't have TOO much work at the moment.\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "And what better way to: that than with some stunning fireworks, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506020,
			say = "But, that can be fixed with an expansion. We could make new and exciting kinds of fireworks! What: you say, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
