return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 519010,
			say = "The more, the merrier, right? Or at least, it'll get:ne quicker that way. I'll ask around if anyone else can give a hand!",:
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506020,
			say = "I say we: as she suggested and help ourselves while we wait for her to come back.",
			painting = {
				alpha = 0.3,
				time = 1
			},
