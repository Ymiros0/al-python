return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 904010,
			say = "Excellent work, everyone. Why:n't we take a break with some desserts?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 801030,
			say = "Hey, girls, watch this! I can: magic just like Opie! I cast Crackly Fire!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hey,:n't run away! I wanna see the bazooka in action!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Gosh, she's quick on her feet... Um, Commander, An Shan and I will go make sure Fu Shun:esn't get up to no good.",
			painting = {
				alpha = 0.3,
				time = 1
			},
