return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "You:n't need to be so flattering, Wales. The Eagle Union stands with its allies, and we're happy to have the opportunity to practice with you.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Very well,: let's tone:wn the formalities from here on. The Royal Navy will fight with all it's got, and we hope you will, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
