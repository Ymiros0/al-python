return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I'm honored, but I alone:n't deserve all the credit. I couldn't have:ne it without the rest of the fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Moreover, ensuring the safety of NY City should be your highest priority. You:n't need to worry about us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
