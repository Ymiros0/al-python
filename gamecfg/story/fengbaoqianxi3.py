return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "That you did. Job well:ne getting those ships back to port.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "Among other things... I've got goods to relocate, strategic:cuments to draft, and messages to relay... Basically, up to my neck in paperwork.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What she said. Why: you ask? Did something happen?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "I've already informed the Commander about it, so consider that:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Dedication? That's just the coffee:ing the talking...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right, everyone. Inspect your gear and restock on supplies and ammo. Soon as everyone's:ne, we'll sortie.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
