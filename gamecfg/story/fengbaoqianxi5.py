return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "As you probably saw, these Sirens:n't fight so good, but they: have numbers on their side. Clearing all of 'em out is gonna take some time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, but there's been a change of plans. Higher-ups gave us a special mission; we'll be:ing reconnaissance in Siren territory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right, let's: this! With the combined power of Enterprise and the Knights of the Sea, we're unstoppable!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
