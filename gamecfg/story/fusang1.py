return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "By the way, Milord, what are you:ing all the way out here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "After seeing her gentle smile, there was no way I'd be able to turn:wn her generous offer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
