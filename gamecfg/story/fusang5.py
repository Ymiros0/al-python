return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know she's more than capable of following what I taught her, it's just a matter of getting her to calm:wn... And that will take time and experience.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Y-Yoizuki... I can't seem to remember... What: I:oo?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Bow twice,: clap twice. Then one final bow.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:ne, you two. Please rest while I prepare the tea.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
