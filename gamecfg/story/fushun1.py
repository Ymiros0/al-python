return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Right, so... The first thing a new secretary ship:es is... check your schedule? Let's see what you've got... Hmm, yep...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "After my meeting, I open the:or to my office—",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "There, I find my bookshelf moved out of place, books and:cuments scattered all over the floor, and one panicked Fu Shun.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Taking advantage of your absence to: mischief? Pssh, who, me? Never! This is just... Yeah, an investigation! Yep! I'm investigating stuff!",
			painting = {
				alpha = 0.3,
				time = 1
			},
