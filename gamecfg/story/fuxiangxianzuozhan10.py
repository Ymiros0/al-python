return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Fog appearing out of nowhere in an unremarkable part of the ocean and engulfing our fleet. Sounds quite familiar,:es it not?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm all but certain. The first thing we should try to: is find and destroy the Mirror Sea control unit to break free from it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "True. That's what we've been:ing up to now anyway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Gosh, it's almost like we were sent straight here to: Akagi's and Kaga's dirty work. They could've at least told us what we were getting into...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
