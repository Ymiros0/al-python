return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Heh, keep 'em coming! I'll knock:wn whatever you throw at me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I have no plans to be anywhere near there, and I've already notified any relevant allies. In case someone:es end up getting caught up, I trust you'll be able to clear out the mass-produced ships.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Good point. Well, how about we get the show on the road: with this next exercise?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
