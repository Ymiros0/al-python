return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 407030,
			dir = 1,
			say = "It's impossible to track:wn all of them. Weser, were you able to locate the carrier?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...I:n't want to think too much about it, but... this must be Siren interference.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
