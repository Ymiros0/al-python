return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Meaning, they're the same as what the Sirens have created... You must have Sardegnian Pawns too,:n't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Of course we:. Those shots were just feints meant to make the training more realistic.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Goodness, Eugen really has a pokerface like nobody else:es...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I read the briefing, that's how. Now, could you: as I told you to? It's rude to keep our guest waiting.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
