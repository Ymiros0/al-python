	...
	scripts = {
		{
			...
			side = 2,
			nameColor = "#a9f548",
			say = "Strasser,: you read me? We're just about to arrive at the coordinates you sent!",
			dir = 1,
			bgm = "xinnong-2",
			typewriter = {
				speed = 0.05,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey, some Pawn-looking ship just turned up! Eisen, what: you think we should:?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
