return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Are you all:ne playing cat and mouse yet? Good.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wait, Eugen?! What are you:ing here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I've been trying to reach you this entire time, but I suppose our comms network is:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...Hang on, on that note, how are we even chatting right now? Weren't the comms:wn up until just a minute ago?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, we have a plan of our own. You:n't need to call Strasser, we'll just take it from here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
