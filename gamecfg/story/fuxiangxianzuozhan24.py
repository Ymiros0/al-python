return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I like her style, though she could learn a thing or two about exercising restraint. That's one thing Friedrich has that she:esn't.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_fuxiangxian_2",
			say = "Shortly after the first planes arrive at the target and begin circling around, one of them loses control,: another, and another... They either waste their payloads, or crash into the sea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So,: it. Blow it to smithereens while Strasser still has their attention.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
