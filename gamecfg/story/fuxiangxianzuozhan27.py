return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't: that! You're gonna make Hipper worry about you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(But this place gives off completely different vibes, and the Pawns there were made with some mysterious device in some kind of sculpting room, or whatever... I really:n't know what to make of this.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, in the end, it:esn't really matter why you're here. Since you're our allies, feel free to stock up on supplies from our base.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Alright:. Like I said before, keep that communicator with you at all times.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Who knows? I:n't know myself, so that's all I can really say.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
