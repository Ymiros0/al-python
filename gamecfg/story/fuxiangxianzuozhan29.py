return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_fuxiangxian_5",
			say = "Though she was barely able to:dge the tentacles, the seemingly weightless tentacles instantly turned to make another attack on her, putting her in a rough spot.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And stay:wn...! W-wait, that rigging is so massive that we can't get through it...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
