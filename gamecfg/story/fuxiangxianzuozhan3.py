return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just want to make sure. in addition to the mass-produced Sirens, we'll be fighting:ppelgangers of ships from Iron Blood, the Sakura Empire, and Sardegna?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You would know this if you'd actually read the briefing. I:n't have the time to explain it in detail just for you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
