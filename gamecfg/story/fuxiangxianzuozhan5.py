return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 407030,
			dir = 1,
			say = "You... You absolute scatterbrain! You:n't know what the Conductor:es?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Smasher, Scavenger, Conductor... Their names are all too similar! Can't we just change her entry in the database to \"Octopus\" and be:ne with it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
