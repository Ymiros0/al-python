return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Thank you. You've all:ne well. Da Recco, despite her appearances, Lady Friedrich is an excellent stateswoman who earned the trust of Bismarck.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 601040,
			say = "Ugh... Well, if Miss Veneto says it's fine,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 601060,
			say = "Oooh... You can: it, Maestrale! Go, go!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
