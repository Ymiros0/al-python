return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What were they hoping to achieve by changing their coloration? It will: nothing to impede our fleet, accompanied by the Eternal Flagship herself–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "First they mock our proud colors,: they send Pawns at us. Disgusting.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Those armored carrier sisters must've had similar apprehensions when they first fought their own:ppelgangers.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
