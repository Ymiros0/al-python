return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Either that, or the Sirens are trying to lure us into a corner with Pawns as the bait,: turn the walls and trap us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So! Aquila, keep on:ing your thing with the recon!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
