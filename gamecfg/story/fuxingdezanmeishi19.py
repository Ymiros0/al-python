return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Hey Maestrale, is it just me, or:es it feel like we're going in circles?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't think so, but I can understand why you might think that. Every segment:es look the same.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 607010,
			say = "Indeed, the Sirens enjoy conducting psychological warfare as much as they: normal warfare.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 602010,
			say = "It's no wonder we have never achieved a decisive victory against them after all this time. Winning a battle:es not win one the war.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
