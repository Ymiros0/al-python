return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Still, we:n't have much choice if we wanna save Gioberti and the artworks... Hehehehe... I'd better tell Lady Veneto...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605010,
			say = "Hm? Why: you ask, all of a sudden?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605010,
			say = "...And hoping we:n't catch on?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
