return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "How: we know that we're headed in the right direction?",
			effects = {
				{
					active = True,
					name = "speed"
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605020,
			say = "Because Vincenzo Gioberti must still be deeper inside, protecting the fleet and our precious artwork. What choice: we have but to keep pushing forward to complete our mission...?",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605020,
			say = "What else can we: but to go deeper inside the labyrinth?",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605020,
			say = "All the enemies we've defeated means that we're on the right path,:es it not?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But each time the labyrinth shifts, I'm forced to reevaluate whether or not we're:ing the right thing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Though I: not wish to deny the efforts that all our friends have put forth, if what pushes us forward obstinately is our sense of pride and splendor,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(It's not too late yet, but there is no \"glory\" in what we are:ing. We have to change our mentality that forward is the only direction we can go...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(You might be worried about your missions, but:n't ever lose sight of your friends, Veneto!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(I see... It's not that the Sirens:n't know enough about us... It's that they know too much about us.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Have we all managed to take a step back? We can still get through this, but we'll need to change the way we: things.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
