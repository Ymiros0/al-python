	...
	scripts = {
		{
			...
			bgm = "story-6",
			dir = 1,
			say = "So this is your:ing, Tester...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Now uploading data. This body will: be surrendered for the purpose of testing experimental EMP weapons.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She's completely ignoring us, as if we:n't even matter to her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I am loathe to run my rapier through an opponent that will not draw her blade, but my code of conduct:es not prohibit any tactic from being used against a Siren foe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
