return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 603030,
			say = "I:n't think we should worry about that at this point. Unlike us, the coastal artillery takes a long time to get warmed up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 499020,
			say = "I: hope you will allow me to compose the next movement of your symphony...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
