return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605010,
			say = "What we: know is that the coordinates of this Mirror Sea match the ones given to us by Vincenzo Gioberti. I can confidently say that this is the same place.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 605010,
			say = "We weren't able to locate Littorio or Gioberti, but we: have a pretty good idea of this Mirror Sea's range.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
