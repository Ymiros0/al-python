return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xinnong_cg1",
			say = "The destroyer, Hibiki, was careening:wn a flight of stairs, her balance failing her as she struggled to contain an armful of ceremonial items.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Don't whine to me. We shipgirls:n't get hurt so easily. And didn't I tell you to be careful with these ceremonial items?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We're nearly ready to begin the ritual, so please: tread with a little more care from now on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Certainly. I will: so at once.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "However, I need you to: something, Ryuuhou. An offering in which the ships participating in the ritual compete for glory – a Combined Fleet exercise – is necessary as a display of the Sakura Empire's strength.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
