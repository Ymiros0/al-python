return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That is correct. We: conduct exercise battles as a show of respect.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 302210,
			dir = 1,
			say = "...Difficult, but not impossible. Without a:ubt, a host's job is to make their guests feel welcome. And if that is what you desire,: we can: so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
