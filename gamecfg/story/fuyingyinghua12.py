return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Goodness gracious, it sounded like the Sirens were attacking us... What are you:ing, Eugen?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If that really is True,: we are honored to know that Noshiro fought THE Prinz Eugen face-to-face and nearly defeated her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "There is no \"almost\" here. You either defeat someone, or you:n't. She could've sent you straight to the drydock with just a single volley.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She shouldn't have escalated it after Eugen provoked her, but I can't blame her for:ing so",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you:n't mind me asking. I noticed you two arrived here quite late. You didn't get lost on the way here, did you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
