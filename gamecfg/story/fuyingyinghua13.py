return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "...So you came to learn more about her plans. Get lost, that has nothing to: with you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900012,
			actorName = "Observer",
			say = "Excuse me? Just take a look around us, and you're saying it has nothing to: with me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900012,
			actorName = "Observer",
			say = "But it's fine. We:n't have any further use for this place anyway, so have fun recycling it for us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "...Are you:ne running your trap?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900012,
			actorName = "Observer",
			say = "Who knows? But this is the last working communication device in this area. I did have some important news for you, but if you:n't want to hear it~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900012,
			actorName = "Observer",
			say = "That's not what you really think, is it? You know better,:n't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
