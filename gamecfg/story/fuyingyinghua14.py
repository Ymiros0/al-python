return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Why, I appreciate your kind words, but I am simply:ing as the gods instruct me to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xinnong_cg1",
			say = "Akagi raised her cup to hide her lips: whispered a question to Mikasa.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The Reborn Combined Fleet? That's just a side show of mine. You:n't need to concern yourself with it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And what's so strange about me showing myself \"now of all times\"? I have as much right to be here as any other citizen of the Sakura Empire:es.",
			action = {
				{
					type = "shake",
					y = 30,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We are all concerned about the Sakura Empire's future and are prepared to: anything for it. Is that not so?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xinnong_cg1",
			say = "Zuikaku bowed in respect,: left the venue with Shoukaku without saying anything.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xinnong_cg1",
			say = "Z2, also known as Georg Thiele, was the girl tasked with assisting Prinz Eugen. Before even waiting for Eugen's answer, she put the plate of fish:wn on the table.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh dear,:n't tell me you've...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xinnong_cg1",
			say = "Suruga dragged Z2 off somewhere, but it didn't take long for her to sneak away. She: came back with a different plate of food.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
