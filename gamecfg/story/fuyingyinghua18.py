return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Ryuuhou, what: you think the Sirens' goal is? Are they after... Watatsumi?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 306070,
			dir = 1,
			say = "They might be after the First and Fifth Carrier Divisions and Mikasa. But no matter what they're after or what they:, they shall not have it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 302210,
			dir = 1,
			say = "That:esn't seem to be all... Our instruments are starting to malfunction.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's the Sirens':ing. We just got here from across the islands, and it seems this entire region has turned into a Mirror Sea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm fine. We took care of all the mass-produced units in our sector,: rushed over here when we spotted your recon planes.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.181}",
			say = "We may not be able to stop this Mirror Sea merely by defeating the Sirens this time. Ryuuhou, what should we: next?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
