return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Shells from Siren battleships rained:wn ceaselessly around Kawakaze.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			soundeffect = "event./battle/boom2",
			dir = 1,
			say = "Lady Nagato, please put me:wn! You must make it out!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			soundeffect = "event./battle/boom2",
			say = "Ignoring Kawakaze's protests, Nagato raised her formidable rigging, firing back at the encroaching enemies while:ing her best to avoid their barrage.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			soundeffect = "event./battle/boom2",
			say = "Suddenly, several bombs rained:wn upon the approaching Siren forces.",
			flashN = {
				color = {
					1,
					1,
