return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Suruga",
			dir = 1,
			say = "I am relieved that you are here, Lady Nagato! We were at a loss as to what to: in case of an emergency...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Suruga",
			dir = 1,
			say = "Um, if Shinano was unable to carry out the ritual,: the plan was to have Yamashiro: it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Kawakaze",
			dir = 1,
			say = "Yes. If it's just sailing,: I'll be ok...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
