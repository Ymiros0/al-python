return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Faced with the might of advanced weaponry as well as the violent forces of nature, the helpless girls could: nothing but retreat.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Now:, this ceremony shall now commence upon Akagi's orders on behalf of Ryuuhou, who is unable to join us tonight.",
			effects = {
				{
					active = False,
					name = "juqingshitou"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: you plan to: with Watatsumi?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 301100,
			dir = 1,
			say = "Um, excuse me! What should Hibiki:...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
