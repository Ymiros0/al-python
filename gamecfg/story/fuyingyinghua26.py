return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Allow me to come clean about this ceremony. Though I have taken the initiative in using Siren technology, everything I: is for the sake of the Sakura Empire's future.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The path you walk is now distorted. I fear that if you continue:wn this path, you will soon turn your blade against your own people.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "？？？",
			dir = 1,
			say = "Lady Nagato, stand:wn. I: not wish to point my blade at my people.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "？？？",
			dir = 1,
			say = "That history is False. This stone:es not exist in your world.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "As if lightning had struck, the deed was:ne before anyone in the hall could react.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
