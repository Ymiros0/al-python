return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "My my, if it isn't Akagi from the Sakura Empire? If you're here to send us off, we:n't need *that* much hospitality.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Watatsumi. You said you wanted to see what you could: with it, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
