return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Kaga,: not underestimate her. Even if she's a light carrier, she must be powerful if she is in charge of organizing the ritual.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 306070,
			dir = 1,
			say = "Indeed. All I: is for the Sakura Empire's future!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
