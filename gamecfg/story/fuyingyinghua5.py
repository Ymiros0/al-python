return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It seems the First Carrier Division has:ne a lot of work behind the scenes...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, you could be right, Mikasa. You're a veteran after all, so you probably have a better feel for these things than I:. One day, I wanna be as renowned as you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "However, she is now one of the leaders of the Sakura Empire. It would be unwise to: anything that would directly aggravate her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What I'm getting at is, we are participating in the ritual to discover what Akagi's True motive is. If Shinano is truly all-aware,: she would know whether Akagi is colluding with the Sirens, or still stands on our side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We've had many chances to: this with the Northern Parliament and the Royal Navy, but now that Iron Blood has gotten involved, I:ubt our regular methods will work...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The ritual host should be be here soon, so let's get ready to: this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
