return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So you're the fabled third Kii-class battleship. I can hardly believe my eyes... Nevertheless, you have:ne an awe-inspiring job on the ritual thus far. I thank you on the behalf of all the Sakura Empire.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			actor = 305140,
			dir = 1,
			say = "Thank you. However, I did only what anyone in my position would:. I:n't deserve any special praise for that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If that is a direct order,: I shall comply with it. As you wish, I shall hold nothing back...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
