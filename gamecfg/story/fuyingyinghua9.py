return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Are you:ne yet, Thiele? It's almost time for lunch.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm:ing the best I can... I'll be:ne recording soon, so just wait a little longer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I have one secured, but I:ubt we'll need it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We should be fine if it goes as planned and we can use this ritual as a way to bolster our forces. If it:esn't, however...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Good. Now:, let's stop pretending like we're lost and head over to them. We:n't want to make them wait around too long~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
