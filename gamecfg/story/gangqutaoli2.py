return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Jeez... if you knocked them out,: we wouldn't be able to ask for directions!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ahem! You: have a point. Let's have them show us the way out.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "My pride as an \"imperial\" ship will not allow it! Zeppy, if you also represent the pride of the Iron Blood,: there's no way you could drag such a small destroyer into this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "O-ohh... Then, what should we:? How: you think we should get out of here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
