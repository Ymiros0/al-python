return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's right! What are we going to: with these kids, nya?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Leave this one to me,:. Although our personalities are different, she's still me after all, so I won't treat her poorly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I guess that's settled:. Akashi, isn't it time you sealed away that strange device? If something like this ever happens again... surely you are aware of the consequences?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:, everyone, let's show our new friends to the:rms. Little Bel, please tell Commander that the three of you have arrived safely.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I suppose that's one thing taken care of... But moving forward, I:n't know if I'll be able to fit in...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
