return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And you... You just nodded along to whatever she told you to:. Are you sure you’re okay with this? You know the workload is only going to get more and more unreasonable...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "N-no, I can manage on my own! I:n’t need your help for something like this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wh-what is it? “I can’t see in front of me?” ...Look, I:n’t need your concern! As if I’d let something like that trip me up!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You’re always sticking to me... If you:n’t give me some personal space, I...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wh-what are you:ing all of a sudden?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(What: I:, what: I:?! Even though it was an emergency, this is a kabedon... right out of one of those mangas...!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
