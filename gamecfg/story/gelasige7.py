return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I, I’ll fulfill my duties as your secretary, so:n’t you fret!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Instead, I tell her not to stress herself out too much, and: return to my work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Then, I’ll be sure to be more gentle... and comforting. Ah, and:... “Suddenly, the wind blows—”)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
