return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_alexandria_1",
			hidePaintObj = True,
			say = "A lighthearted sea shanty played over the desk radio in the Sardegnian:cking facility's break room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "The weather:es seem a little odd today...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601100,
			say = "Yep! I:n't really understand what's going on in the song, but it sounds fun, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603060,
			say = "Actually... They were planning to hold a presentation in the Upper Senate today. I hope the sandstorm:esn't interrupt that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "Not just communications. We won't be able to: any work outside.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601100,
			say = "Now I'm sad. I won't have anything to:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603060,
			say = "Stories, huh? Will any old story from before our coming to the Oasis:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603060,
			say = "I: have some, but they're from a long time ago... Before this whole war even started.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603060,
			say = "If I tell a story,: you have to share one too, okay? You must have plenty of fascinating things to talk about.",
			painting = {
				alpha = 0.3,
				time = 1
			},
