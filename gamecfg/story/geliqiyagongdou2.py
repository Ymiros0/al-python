return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Then I would suggest you: it quickly. I can't hide the truth forever.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "We:n't have permission to interfere in this Reenactment.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603060,
			say = "When things settle:wn, we'll find an opportunity to return them to their rightful place. Does that work for everyone?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "But, look at how things have changed since:... *sigh*...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "Yeah,: there's the thing with the Crimson Axis...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "\"Damn! If you haven't figured out how to end the war,::n't start it in the first place!\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601100,
			say = "She's like a super-big-shot who carried a whole fight on her back a long time ago! Andrea,: you know Granny Mikasa?",
			painting = {
				alpha = 0.3,
				time = 1
			},
