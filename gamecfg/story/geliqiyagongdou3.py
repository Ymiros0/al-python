return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305110,
			say = "Hahaha, come on, you:n't have to butter me up. We're all just:ing our jobs.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Good question. Your meeting with Lady Nagato is the day after tomorrow, so how about I show you the sights until:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "In that case, I should ask now. Are there any things I should avoid:ing, or be careful about:ing, in the Sakura Empery?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305110,
			say = "Uh, what...? Hahaha, you:n't have to be so tense. Take it easy.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605070,
			say = "Hopes for the future... I:n't know if I can envision things that far ahead, hahaha...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305110,
			say = "There'll be plenty of shipgirls, like you, who can: even better than we did. Maybe it's about time for us to exit the spotlight.",
			painting = {
				alpha = 0.3,
				time = 1
			},
