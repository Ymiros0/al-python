return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commander, it's time to bring back a classic, nya! We're:ing another Muse System test, nya!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "I look at Mikasa,: Clemenceau,: Marco Polo, who's standing by the:or outside my office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 699010,
			say = "Why am I here? Because this is a big event. Sardegna:es not sit out on such things.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Isn't that what they've been:ing this whole time?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Since we're:ing this again, I say let's change the rules a bit and give as many people as possible the chance to be part of the show.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "The green cat disappears:wn the corridor. Mikasa waits until she's gone,: approaches me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
