return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "(You have the confidence to take center stage, but:n't forget about the teamwork.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 599010,
			say = "It just feels right for me to: the honors! Let me be a little biased toward my countrymen!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_ouxiangsanqi_1",
			hidePaintObj = True,
			say = "A brief flurry occurred as the shipgirls got up on stage, all:nning idol attire.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 312010,
			say = "They'll: be rated based on the quality of their performance and their appeal, nya!",
			painting = {
				alpha = 0.3,
				time = 1
			},
