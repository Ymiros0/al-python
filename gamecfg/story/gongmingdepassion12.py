	...
	scripts = {
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Whew... Performing simultaneously with your opponent is much more tiring than I thought.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307100,
			say = "Polaris will surely sing their hearts out, and I expect the rest of you to: the same.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207110,
			say = "Heehee. At any rate, we have:ne our part.",
			painting = {
				alpha = 0.3,
				time = 1
			},
