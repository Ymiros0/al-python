return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "How are your other members:ing? Are they still resting?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(We're three tests deep into the Muse System, and there is still so much we:n't know about it. More than we even realized.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 302240,
			say = "Also, why are you still working, Commander? I think you have more pressing things to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 302240,
			say = "Then Eugen's after that,: Roon, followed by Unicorn and Hammann.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Mhm. Although, if all their wishes personally involve you,: you're out of luck. Heehee.",
			painting = {
				alpha = 0.3,
				time = 1
			},
