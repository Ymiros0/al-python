return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I:n't like being referred to like some old school teacher just because I took part in a Muse System test some time ago.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207140,
			say = "Are you absolutely certain you:n't wish to join our team?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207030,
			say = "Heehee. I: want to join you, just not right now.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Sorry for butting in, nya. I've been asked to tell everyone to gather at the:ck, nya.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207140,
			say = "What a pain in the bum... I'm off to the:ck.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "I'm sure you have some questions, like \"why: we have to split into groups and compete?\" or \"who is the sponsor?\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
