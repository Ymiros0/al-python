return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I suppose that settles the sponsor question. What shall be:ne about the prize, though?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Oh, one more thing – what: we formally call this joint sponsorship? Do we just say \"sponsored by all factions\"?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
