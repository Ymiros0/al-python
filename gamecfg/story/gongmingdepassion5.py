return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502023,
			say = "You got that right! Let's: what the Dragon Sisters: best and burn the competition!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502023,
			say = "Wait, \"again\"? What: you mean by that?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "(Huan, please:n't bring up the kitchen thing in front of them...)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Aww, really? You:n't want to have a wish granted if you win?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403150,
			say = "You could wish to sleep in all you want or say goodbye to work forever, but you: you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
