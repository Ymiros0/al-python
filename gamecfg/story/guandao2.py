return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "It is now day four. I have procrastinated on some things as well, leaving me with this absurd amount of work to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Oh, uh... There's just one last thing I have to:. Don't worry about me, you're free to leave.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Her workplace morale is important. Improving her performance is important, too, but... I guess I'll: that step by step.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "The late-night silence is broken by a knocking on my:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "The time to cover it up has passed. She picks up the:cument I was just going through.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 118020,
			say = "Hang on a sec... Didn't I: this one earlier today?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 118020,
			say = "Is this entire pile made up of:cuments I worked on?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Because, like... Come on, isn't paperwork just a thing adults: to kill time?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "She picks up a stack of papers before she has even finished speaking, sits:wn at her desk, and gets to work immediately.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The papers aren't going anywhere, but the food won't stay hot forever, sooo... Can I eat first,: work, please?",
			painting = {
				alpha = 0.3,
				time = 1
			},
