return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Though I was wondering if she was going to head to the Royal Navy's:rms, I instead saw her pass it by and head somewhere else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hearing you say that makes me very happy. Well:, I suppose I should start making preparations for it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
