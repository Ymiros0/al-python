return {
	...
	scripts = {
		...
		{
			say = "When I exited the office after finishing up all of my work, Illustrious was waiting for me at the:or.",
			side = 2,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "However, I was very busy at that time, so I forgot to send her a response. I'm worried about what I should: now...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "Why:n't you invite her to the tea party?",
					flag = 1
				}
			}
		},
