return {
	...
	scripts = {
		...
		{
			say = "After finishing writing the letters, I escorted Illustrious back to the Royal Navy's:rms.",
			side = 2,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "A member of the Royal Maids will be setting the tableware for the tea party. Is there anything else we need to:?",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All of these:n't fit well enough... It'd be nice if there was a high-quality one...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
