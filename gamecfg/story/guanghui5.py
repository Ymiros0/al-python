return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The road to this hill just won't:. It's hard to walk up here because it's covered with branches and fallen leaves.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I always lose my balance when I look:wn, so I never look at the ground...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, keep an eye on my sister, would you? Make sure she:esn't fall over when cleaning and such!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_twilight",
			say = "Of course I had no intention of turning her:wn. I extended my hand toward her to show my willingness, but...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
