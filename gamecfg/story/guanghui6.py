return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...And with this, the cleaning is:ne.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm sure this tea party will be the best there ever was. Really, I'm so grateful for all you've:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"Commander, make sure you take good care of my sister. Make sure she:esn't fall over when cleaning and such!\"",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Slowly matching her pace, I continued to escort her:wn the hill.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
