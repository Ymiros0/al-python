return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "While I was looking:wn at the wide view of the port, Illustrious came to my side.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Um... If you:n't mind, could you spare some time to come to this place with me again? Just the two of us...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
