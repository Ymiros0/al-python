return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I believe her, Ark Royal wouldn't: something so ignoble...",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm telling you, it had nothing to: with Warspite, I was after... I was escorting the destroyers behind her!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
