return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Uuuughhh... I'm:ing it... it's just really dusty over here...",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I feel like Glorious is just:ing everything herself... We came here to help, but is this helping...?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "You sure you'll be okay, Glorious? There's a lot to: here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				...
				{
					content = "Why:n't you two stay and help.",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Commander, they have things to:. We can take care of this ourselves...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_outdoor",
			say = "While the work itself wasn't terribly difficult, it did involve a lot of pieces of big equipment. It was a bit much even for an aircraft carrier like Glorious. ...I had a feeling there really wasn't much the destroyers could:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
