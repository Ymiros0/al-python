return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Haah... Now that that's:ne with...",
			bgm = "story-1",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You can't: that! Everyone's busy preparing for battle. That's so much more important!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_outdoor",
			say = "Glorious was:ing everything she could to put on a brave face. But—",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... I've always been so clumsy, I'm totally useless in battle, it's all I can: to make sure I'm not holding everyone else back!",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
