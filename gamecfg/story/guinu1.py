return {
	...
	scripts = {
		...
		{
			say = "I was back in my office, having just wrapped up a strategy meeting with the Sakura Empire. Upon opening the:or, I felt a light breeze brush against my cheek.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Right after I shut the window, there was a knock-knock on the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...Stay still. Hold it right there and:n't move a muscle.",
			effects = {
				{
					active = True,
					name = "speed"
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Beads of cold sweat ran:wn my body, whereas Kinu was the spitting image of calmness. She came over and quietly threw open the window.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Here is a fact about wasps. if you swing at them, they will perceive you as a threat. But stay still, and they'll: you no harm.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "There. All:ne... It worries me to think a little wasp could get the better of someone in your position.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I mean it when I say this. you need to get stronger. Otherwise, how: you expect to control a demon such as I?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
