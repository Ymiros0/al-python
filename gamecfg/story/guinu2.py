return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I've yet to: my daily sword practice, which I suspect would be a good starting point for building both your muscle and discipline.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Here we are. First off.: a thousand swings.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...What's with that look? Are you let:wn because you expected something much more involved?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...You want to try anyway? Very well. Then let us: a bit of light sparring. En garde!",
			effects = {
				{
					active = True,
					name = "speed"
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "It went just as poorly as one would expect. She either:dged or intercepted almost every strike I made at her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hahahah! You lack the skill of a warrior, but you: have the mettle of one. That deserves praise, if nothing else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
