return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Abukuma? What are you:ing out here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just:n't overdo it, all right, Commander? Also, sorry ahead of time for this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right,:... Aw, shucks, I think I've got something big on the hook.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_142",
			say = "However, I had to: something on the odd chance she wasn't faking it. Stepping out of the waterfall, I waded through the river to help Abukuma.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I stood right next to her as she fell in the river. You should've ordered me to jump to her rescue, not: it yourself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "As long as you learn from your mistake, it's no harm:ne. On a more immediate note. you failed! Start over from the beginning!",
			effects = {
				{
					active = True,
					name = "speed"
