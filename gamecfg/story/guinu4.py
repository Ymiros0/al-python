return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "It had been a while since the waterfall training. Every now and:, I would catch Kinu seemingly deep in thought.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All this is to say. you think it looks cool,:n't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Just out of curiosity. have you ever considered wearing a cloak? Naturally, you wouldn't look as good in one as I:, but still.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
