return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 302080,
			nameColor = "#a9f548",
			say = "Your swings are starting to shape up. Well:ne.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "In the:rm... I was just dusting the dressing room when a ghost jumped at me out of nowhere...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Which is to say, someone or something has infiltrated our:rmitory? This warrants an investigation.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "Uranami? What the hell are you:ing here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
