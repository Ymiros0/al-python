return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I can tell you're ogling me. I'm going to ask you nicely to stop it. We aren't here to: anything risqué.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I didn't know exactly how I could help, but I had to: something, so I proposed an activity we could: together.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well? Do we keep playing, or: you give up?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Nagara threw open the:or. She promptly froze in surprise when she laid eyes on Kinu.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Just to make it clear. I:n't HATE Nagara, I simply can't stand how touchy-feely she is with me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Would you: me a favor and forget the face I pulled back there? It won't happen ever again, I assure you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "After Nagara left, Kinu regained her composure. She now had the same collected look like she always:es.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
