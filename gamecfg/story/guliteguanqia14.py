return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hmm, let's see... Let's head:wn to the beach while surveying our surroundings.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Since that giant kaiju emerged from the sea and: vanished back into the sea, it has to be hiding somewhere.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800060,
			say = "Also, Hiryuu-senpai's able to: so many cool maneuvers with her planes! I've only seen formations like that in movies!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "And: I went through some intensive training. Now, I fight with my buddy, Goldburn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
