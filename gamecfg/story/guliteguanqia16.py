return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "I:n't think Mujina's taken notice of us either... Alright everyone, now's our chance!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wait, let's slow:wn a sec. If we were sent here by the Sirens, shouldn't we at least try to talk things through?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "And what if the other side:esn't feel like talking?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "You:n't need to tell me that. After all, you should always hamstring your prey before going in for the kill~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
