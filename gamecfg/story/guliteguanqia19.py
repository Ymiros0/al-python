return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "...I:n't have any specific details, but all kinds of blueprints and weapon designs flashed through my head.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Who would its second priority be:? Mujina?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800020,
			say = "I guess I'd be third on that list:? Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Dunno who comes after that, but it:es feel pretty scary having a huge monster like that coming after you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "I can't even fight. All I can: is use the school's facilities to help others resupply, and make riggings. Does that sound like a high-ranking elite to you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purity",
			side = 2,
			say = "Besides, if everyone's beloved Miss Purity was able to regain control of this Mirror Sea... Maybe I'd even: you a favor and send you back home~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But we:n't really have a choice. We can't break through the enemy lines ourselves.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900318,
			say = "Nonsense. The first thing you'd: when you regain your powers would be to attack us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hass, Namiko, Kasumi, and I will make sure she:esn't try anything funny.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Sounds like a plan:... I'm glad the Royal Maids are a reliable bunch.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
