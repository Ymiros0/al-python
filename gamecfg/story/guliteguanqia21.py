return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "With only two control devices back under my control, I can already: thiiiiis! Muahahahahaha!!",
			actorPosition = {
				x = 150,
				y = -400
			},
		...
		},
		{
			...
			actorName = "Giant Purity",
			hidePaintObj = True,
			say = "But that:esn't mean that you should just take your sweet time either!",
			dialogShake = {
				speed = 0.08,
				x = 15,
				number = 2
