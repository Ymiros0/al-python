return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "Color me surprised, Edinburgh. You certainly rose to the occasion, and: exceeded it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ehehe, I'm flattered... All right:, let's finish mopping up these mass-produced ships!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
