return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Keep laying:wn the fire support! Don't stop shooting!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900318,
			say = "Even with all the control devices, we still aren't able to take:wn that kaiju...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehe. I'll come with you:. I want to take a better look at this splendid scenery from a distance~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800040,
			say = "If Hass is going,: count me in as well~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...Also am I going crazy, or:es nobody here have any sense of urgency?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I guess it's because Purity is:ing most of the hard work, not us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
