return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wow... If the kaiju's attack didn't work on Purity,:–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Lure the kaiju into thinking it can finish you off,: blow it to pieces when it's lowered its guard!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Giant Purity",
			hidePaintObj = True,
			say = "Huh? Oh, I see! ...Blargh! Curses! I'm:ne foooooor––!",
			actorPosition = {
				x = 150,
				y = -400
			},
