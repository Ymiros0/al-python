return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So, now that we've defeated the kaiju and regained control of the Mirror Sea...:es that mean we can go home?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800060,
			say = "I thought some kind of:or or portal would open up after we defeated the kaiju... Is it not going to be that simple?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800040,
			say = "What: you think, Miss Purity?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "She's a high-ranking elite Siren, after all. I:ubt anything bad happened to her. Probably.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Fair point. But I:n't think that's anything you need to worry about.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "As for our friends from another world,:n't you fret. I'm sure we'll be able to figure out a solution once we get back to the Port.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Let's head back to the Port:, everyone! Set sail!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900318,
			say = "I can understand your enthusiasm, but: you even know how to get back from where we are now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
