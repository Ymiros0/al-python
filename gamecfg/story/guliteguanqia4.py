return {
	...
	scripts = {
		{
			say = "The group hurried:wn the hallway toward the gym.",
			side = 2,
			dir = 1,
			bgmDelay = 2,
			bgm = "ssss-az-pv",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You're not wrong, but if there's anything I can: to help...",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't think so... Now that I'm looking closely... is that person walking towards us WITH the kaiju?!",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Why:n't you try calling Akane? We're not in the middle of class right now, so we can use our phones, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
