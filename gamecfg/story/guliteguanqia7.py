return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahh, I remember now! I went to the plaza, and:...",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So Akane, is this world your:ing?",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Those Sirens created this entire space. It reminds me a bit of how I used to create kaijus back:.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So basically, I have nothing to: with whoever made this world, nor am I some kind of god here.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If she was invited here by the Sirens just like me,: she's most likely being deceived as well.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "And our friends from another world as well~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
