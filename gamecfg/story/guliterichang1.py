return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "A what now, nya? I:n't sell any– Actually, let me have a look, nya...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "And spend ages searching? No thanks... Why: you spread your goods out so far, anyway?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Apparently~! Why: you keep these around, Akashi? I bet they:n't even work anymore!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_148",
			say = "Rikka held her fist high in the air: gave the TV a great thump.",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "For:ing what, nya? Writing off my valuable products as junk, nya? You wish, nya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
