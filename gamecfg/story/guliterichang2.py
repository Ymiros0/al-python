return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't have any real strengths...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Sure you:, Spee. You've got a cute fashion sense. You dress to match your personality, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800031,
			say = "A photographic memory is a bit TOO great,:n't you think? Got anything more ordinary?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
