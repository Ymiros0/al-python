return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 408050,
			say = "Hey, U-37! Don't forget we still have to: the thing!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800050,
			say = "If it's just a little game,: sure... Playing out on the open sea might be fun.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 10800050,
			say = "Who:esn't? But I've never:ne it in water before. Is the game some kind of regional variant of it, or...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Okay:... I guess we're playing hide-and-seek instead.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
