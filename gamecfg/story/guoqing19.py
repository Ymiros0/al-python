return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff0000",
			dir = 1,
			say = "One day you will understand the reason why we: what we:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Observer",
			blackBg = True,
			say = "In either case, the question is if this is a True Awakening. It:esn't meet the right conditions.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
