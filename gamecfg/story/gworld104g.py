	...
	scripts = {
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Transferring zone data... Complete. The Operation Siren map is divided into:zens of zones, based on naval command’s evaluation of the local climate and intensity of hostile presence.",
