return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "\"Hearken! If this treasure ye crave,: embark on this hunt, and prove ye are brave!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			stopbgm = True,
			hidePaintObj = True,
			say = "What: you think this treasure is, anyway?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I guess so... A fluffy pillow made of diamonds,:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Come on,:n't be such a wet blanket...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That's just wishful thinking. We:n't live in a video game.",
			painting = {
				alpha = 0.3,
				time = 1
			},
			...
			options = {
				...
				{
					content = "\"We:n't?! My whole life is a lie!\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#A9F548FF",
			say = "Commander, please:n't enable them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It's called \"ice cream\"... Also,:n't eat too much.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_unnamearea_1",
			hidePaintObj = True,
			say = "Their treasure talk:es make me wonder what we'll find.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
