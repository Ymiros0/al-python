return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "The beach is beautiful, with shells of various colors:tting the sand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But at the same time, this is the turtles' home... We:n't wanna disrupt it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "\"I say we: the turtles a favor and help clean up this place thoroughly.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Good idea. We:n't want them choking on bits of plastic...",
			painting = {
				alpha = 0.3,
				time = 1
			},
