return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "Ayanami bends:wn and whispers something to a seagull.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "It lets out a cheerful cry, as though it's eagerly anticipating tonight's dinner,: flies off again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
