return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Everyone else is having a lovely time, so the least you can: is smile.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Why:n't you have a seat, Commander? I'll bring you a plate of barbecue.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "As much as I wanna eat both, my stomach:esn't have that kind of capacity...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Then how about a toast, Commander? I:n't believe anyone has made one yet.~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
