return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 701090,
			say = "Oh, I know! Why:n't we just chop:wn all the trees?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 701030,
			say = "Cutting a forest:wn because you:n't wanna survey it is pretty extreme,:n't you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 701090,
			say = "Save the explanation for later! Get me:wn from here!",
			painting = {
				alpha = 0.3,
				time = 1
			},
