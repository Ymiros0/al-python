return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_unnamearea_1",
			hidePaintObj = True,
			say = "Fierce gales rattle the rails, a:wnpour showers the deck, and the windstorm threatens to tear our hull in two.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'm not so sure! The navigation system is on the fritz, and our comms equipment is:wn after that thunderstrike!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "Then, we see the island clearly, in all its verdant glory. We disembark on the beach and step:wn onto the golden sand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "Beyond these shores is a lush forest, and: a large volcano rising over the treeline in the distance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh, to be as carefree as you three... Commander, what: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
