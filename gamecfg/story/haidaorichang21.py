return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "My,: we have a customer trying to be the first to enjoy the hot spring?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Heehee, but you:n't have to leave so soon. It's okay, Commander♡",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Heehee. Why:n't you go ahead and get undressed?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Heheheh. Akagi, what exactly: you think you're:ing?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307010,
			say = "*sigh*... Well, you see our conundrum. What should we:, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "If that's what you want, Commander... I suppose I:n't mind sharing once in a while.",
			painting = {
				alpha = 0.3,
				time = 1
			},
