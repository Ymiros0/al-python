return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "This place is even more dilapidated than I expected. I:ubt there's anything of value left here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "While we're at it, we should also look for items and mechanisms that open:ors.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Okay:... I suggest we split up and look for out-of-place things.",
			painting = {
				alpha = 0.3,
				time = 1
			},
