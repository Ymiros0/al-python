return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We're just walking:wn a normal path...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There's a big:or up ahead. If there's treasure, it must be in the room beyond.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That may be. Regardless, I'll try to figure out how to open this:or...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_500",
			hidePaintObj = True,
			say = "The four shipgirls approach the large:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I:n't see a lock. No slot to fit anything into the:or, either.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_500",
			hidePaintObj = True,
			say = "The:or slowly opens a bit, rumbling loudly all the while.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If she's a monster,: we have no choice... Everyone, get ready to fight. We're taking her:wn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
