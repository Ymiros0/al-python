return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:n't think merely reaching the island's highest point grants you ownership of it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 699010,
			say = "Now let's see... Yes, over there will: just fine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Ahem. Da Vinci, would you please use your drone to take us back:wn?",
			painting = {
				alpha = 0.3,
				time = 1
			},
