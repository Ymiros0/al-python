return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "The air is filled by the chirps of birds of paradise. Sunlight breaks through the leaves, creating scattered light:ts on the grassy ground below.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_summerisland_map",
			hidePaintObj = True,
			say = "Javelin hums a peppy tune while collecting dead branches off the ground. She:esn't seem the least concerned over being shipwrecked.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
