return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Throwing:wn the gauntlet, eh? Don't expect me to go easy on you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yo, the pizza's:ne! Who wants a slice?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102090,
			say = "Whoa, smells good! Don't mind if I:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 408080,
			say = "And drink it:wn with a cup of carbonated coffee. Raaawr!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "I'm not:ne with you! Get back here!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_106",
			hidePaintObj = True,
			say = "\"Enigmatic as ever. What have you been:ing these past few days?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
