return {
	...
	scripts = {
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#A9F548FF",
			say = "I'll use that to make a wood pickaxe, mine enough iron to make an iron pickaxe,: use that to mine for diamonds...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Little fragments like this are all I can get at the moment, since I:n't have a way to mine...",
			painting = {
				alpha = 0.3,
				time = 1
			},
