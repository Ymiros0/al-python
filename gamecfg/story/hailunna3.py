return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If I remember right, we just have to turn right here,: left,: left again, and:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Eek! Oh god! Did I: something wrong?",
			flashout = {
				dur = 0.15,
				alpha = {
					0,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"No, it's fine. I:ubt that flickering was because of you.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "The office was bathed in the faint glow of a lone light bulb atop my desk. Helena and I found a cozy spot to sit:wn and rest for a bit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
