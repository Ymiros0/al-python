return {
	...
	scripts = {
		...
		{
			say = "After carrying the:cuments to a safer place, Helena and I mopped the floor.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "We were both tired after dealing with so much in such a short timespan, so we lay:wn on the couch to rest for a bit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "The shaking in her hand calmed:wn little by little, giving way to a comforting warmth.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I:n't blame her for:zing off on me. Her first day on the job had been incredibly hectic.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
