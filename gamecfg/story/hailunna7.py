return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Opening my eyes, the first thing I saw was... Helena's thighs. It seemed I'd asked for a lap pillow at some point before:zing off again.",
			flashout = {
				dur = 0.3,
				alpha = {
					0,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahem. What the hell are you two:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "To check on you. You never came back to the:rm last night.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Care to walk me through what happened? Please:n't tell me any funny business went:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We need to order a new windowpane, replace fried wires, tidy up the place... There's a lot to: to better prepare for the next storm.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Something's fishy here... I'm going to have to press her for the real answer about what went:wn last night.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
