return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502070,
			say = "Um, I'm so sorry for what just happened... I:n't know what came over me...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "It's fine,:n't worry about it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502070,
			say = "\"The seven-colored bridge cleaves the rain, the autumnal sky pristine and clear. Upon the mounts' brow, fresh verdance:th appear.\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502070,
			say = "Though the seasons:n't quite line up, the scene that this poem describes really resonates with me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
