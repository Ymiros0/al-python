return {
	...
	scripts = {
		...
		},
		{
			...
			bgm = "story-1",
			dir = 1,
			say = "If you said you haven't looked at it,: that means you haven't looked at it! After I put all that time and effort into writing the report, how: you plan to make it up to me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "... What: you mean you:n't have any work for me right this second...?! You've been so busy over there, so why aren't you letting me help?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
