return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "... Let's see, today's work is... this entire mountain of:cuments?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "... And the timestamp on these:cuments... no way, this entire morning?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "...and is totally dreamy on the battlefield, so why: I get treated like this...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
