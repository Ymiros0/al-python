return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Wh-what should I:...? What if Commander ends up hating me...?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "No, it's not too late. I'll have to properly apologize... But I:n't know where Commander is now...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Aahh, forget it! I'll just: that method Saratoga told me to try last time...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
