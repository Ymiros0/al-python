return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "It wasn't on purpose but... what the heck were you:ing?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			side = 1,
			bgName = "bg_story_task",
			say = "Of course it's a big deal! I:n't know how Commander is handling all this...",
			dir = 1,
			bgm = "story-1",
			typewriter = {
				speed = 0.05,
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "That may be the case but... I can't: this apology thing alone! Sims, I need you to help me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Wait, what am I going to:? ...That's right, you should ask Yorktown!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Good point! If anyone would know what to:, it's Yorktown...! Thanks, Sims! Look after the office for me, okay?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Take you over to Yorktown? I can: that, but.. and you want me to erase the video?! Whyyy?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
