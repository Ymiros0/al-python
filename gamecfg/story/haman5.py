return {
	...
	scripts = {
		...
		},
		{
			...
			bgm = "story-1",
			dir = 1,
			say = "...And:, I chased Commander out of the office...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "...And now I:n't know where to find Commander...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "...But even:, how am I supposed to apologize...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Hammann, as long as you really are sorry,: you should just be True to yourself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
