return {
	...
	scripts = {
		...
		},
		{
			...
			bgm = "story-1",
			dir = 1,
			say = "Hammann, Commander is right here. Why:n't you say what you told me and apologize properly?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Ah! That thing Saratoga told you: is good fun and all, but let's not: that again!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Of course I wouldn't! ...Jeez! All I have to: is apologize, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "I get grumpy if you:n't pay attention to me... so...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
