return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Oh, seems someone left the:or open.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205093,
			say = "Thanks. I hope you:n't mind having me here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_157",
			say = "Grozny poured the contents of the teapot into her trusty canteen,: chugged the hot tea all in one go.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You can't: that, Grozny! You're supposed to take your time with tea, you know? Also, you should be drinking from a teacup instead!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
