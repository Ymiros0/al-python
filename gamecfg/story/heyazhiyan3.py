return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now let's: it one more time, from the top. Yat Sen, would you mind listening again?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Roon, upon further consideration, I'm willing to: a duet with you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now:, let's get to it, shall we?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
