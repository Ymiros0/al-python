return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Calm:wn! Calm! Yourself! Down!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I can't! I can't: it! How's anyone supposed to calm:wn with this going on around them?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "Calm:wn, Mio. There are Siren fleets around us as far as the eye can see...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Never mind that, we've been sent to another world! How the heck: we get back?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
