return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 10500040,
			dir = 1,
			say = "And: the girls who got them out of a tight situation. Kawakaze and Zuikaku. The Resistance grows stronger!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait, wait, WAIT! Calm:wn, you two!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She's a Siren. After all the Sirens have:ne, I'm not going to simply take her word for it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "Uhh, have I horribly wronged some of you in the past? I mean, if you want us to prove our allegiance, I can go out back and commit:uble suicide with Tessy. We can always get new bodies.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yup... Anyway, we need to come up with a plan for what to: next.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "These are abnormal circumstances, and I'm willing to accept abnormal things within reason. But:n't get careless, Javelin.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
