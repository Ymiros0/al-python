return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "(The rigging Purity made:esn't function the same way as ours...)",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Even:, you can't simply equip a ship's rigging and master its use immediately. The Mirror Sea must be affecting her somehow.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500040,
			dir = 1,
			say = "Oh yeah, why can't we just get riggings for everyone: face the Sirens head-on?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I can't pull that off, though. I:n't know much about your world, and I'm not much of a fighter either, so sorry if I say anything that sounds weird!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't know how to fight? I thought you're part of the Resistance?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Aww,:n't be like that! Experience is still experience!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
