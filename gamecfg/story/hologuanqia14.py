return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But just because I'm maid:esn't mean I'm good at housekeeping, that's a stereotype! Video games, however, you bet I am!!!!!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500030,
			dir = 1,
			say = "Back: I figured I'd need them at some point, so I hid stores of them all over the place, although I'm not sure if they're still there...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So, if you are performers of some sort, why: you have massive amounts of TNT lying around?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500040,
			dir = 1,
			say = "That's easy peasy~ Let's rev up our engines and: it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
