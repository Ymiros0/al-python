return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But the clones only LOOK like someone else, and still follow the Sirens' orders. Just knock 'em:wn like bowling pins!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Yamada Hermione",
			say = "Now remain still as I: as my master instructed and end your lives.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Yamada Hermione",
			dir = 1,
			say = "Please: not interfere, Miss Sora. It is my duty to kill these people.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
