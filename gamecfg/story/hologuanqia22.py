return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That means there's a high chance that Tester is that alleged \"ruler of time and space\"... Oh, right, how are you Hololivers:ing? Everything all right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahahahah, all we need to: is smack 'em:wn and put an end to whatever scheme the Sirens are trying to pull!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
