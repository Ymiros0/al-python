return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "So yeah, everyone's been talking about \"solving the mystery of the Mirror Sea\" and stuff. If you wanna: that, just get to the foundation of it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "You heard me. I:n't mean foundation as in the bottom of this ocean sector or whatever, but the foundation behind the very concept of the Mirror Sea. Don't ask why, I just know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let's: it! We might find some sort of clue in there!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
