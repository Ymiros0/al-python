return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 10500010,
			dir = 1,
			say = "And it's all made from the ocean... If only we could simply swim beneath it. Go:wn where it's wetter,:wn where it's better.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If the key to solving the mystery of the Mirror Sea really:es lie in here,: the enemy must be ready to protect it fiercely. Stay on your guards.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
