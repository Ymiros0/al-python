return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 10500070,
			dir = 1,
			say = "That's thanks to Z23's idea! \"If you were to remodel the labyrinth, how would you: it?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Everything falls into place when I view it from the perspective of what my clone would:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
