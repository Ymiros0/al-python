	...
	scripts = {
		{
			...
			dir = -1,
			actorName = "???",
			say = "It's just as the cards said... They'll get here no matter what I: to try to stop them.",
			bgm = "holo-control",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			actor = 10500070,
			dir = 1,
			say = "She's a fortuneteller, so she can: things like that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Kawakaze is entirely focused on Iiyo, and:esn't notice the attack coming at her from the shadows.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
