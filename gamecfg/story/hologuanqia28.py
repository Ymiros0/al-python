return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But it's annoying that we can't reduce their numbers. They'll wear us:wn over time if they simply retreat, heal, and come back to fight us again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500020,
			dir = 1,
			say = "I'm:ne being hesitant. From now on, my mind is set. we'll put a stop to the Sirens' schemes and end this whole ordeal.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
