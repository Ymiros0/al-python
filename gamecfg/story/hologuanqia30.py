return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "I wasn't going to ditch~ There's other stuff I could be:ing, like expanding the base's defences or reinforcing the walls, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500040,
			dir = 1,
			say = "Even if you're not able to help out here,:n't think you're dead weight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "But, I'm a Siren, you know? Who knows what I might: if things get a little chaotic here~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500050,
			dir = 1,
			say = "If you wish to get under Tessy's skin as well: you may certainly join us, Purity.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That decides it. We'll have you help, even if you:n't want to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
