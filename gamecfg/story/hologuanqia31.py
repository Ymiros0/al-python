	...
	scripts = {
		{
			...
			dir = 1,
			say = "\"Are you sure about this?\" \"I:n't think you're going to make it.\" \"Hell lies just ahead, all right?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "???",
			dir = 1,
			say = "Natsuiro Matsuri, answer me! Among the Hololive girls, who: you love the most?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Ma Tsu Ri",
			say = "Imposter? If you're the real deal,: you should be able to answer this question. Now, answer me! Among the Hololive girls, who: you love the most?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you plan to get in my way,: Natsuiro Matsuri will dance with you - with everything she has!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Woah, I:n't know what just happened, but she started pulling out inspirational one-liners?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
