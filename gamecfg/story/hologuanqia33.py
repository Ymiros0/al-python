return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Oh, and you:n't need to bother teleporting these pawns back all the time. I'm the ruler of time and space; as long as I have direct control over the Mirror Sea, I:n't need an army...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500060,
			dir = 1,
			say = "Nooooo...! Shion:esn't want to be trapped inside anymore...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If Atago was here, she'd take this thing:wn in one hit...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And uh... especially, the:or traps... Um, watch your heads...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500030,
			dir = 1,
			say = "I feel like the past Aquas are looking:wn on me from the skies, watching me waving my arms...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
