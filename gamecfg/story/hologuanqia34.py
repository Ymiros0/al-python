return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "By lava,: you mean magma? Is a hotspot suddenly forming above the ocean?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500040,
			dir = 1,
			say = "Well, I:n't know how much farther we're going to be able to see...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But:ing something is better than:ing nothing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
