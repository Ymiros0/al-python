return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't let your guard:wn. These pawns are completely under the Sirens' command.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"You're not our ally? So you're the enemy,:?\" Ahahaha! I always wanted to try saying that!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500020,
			dir = -1,
			say = "It's really going to come:wn to this, huh? Fine:. Everyone, get ready for battle! Don't hesitate!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
