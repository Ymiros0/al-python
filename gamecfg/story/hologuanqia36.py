return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm sorry, Miss Sora, I'm so very sorry! I'm so sorry, so please:n't bomb me. I'm sorry! I'm very, very sorry!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "Heeh~ Purity:esn't really know what's going on, but for an enemy to be this strong, surely there's some external factor involved? For example, an energy supply or something~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Miss Sora?",
			say = "Umm, I have a message from the ruler of space and time herself. \"Everyone, keep going and:n't stop for anything!\"",
			bgm = "holo-inochi",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "(... Well:ne, Tessy! I didn't think you'd be able to activate all these functions so quickly!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500040,
			dir = 1,
			say = "Hmm... we won't have time to slowly look around:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
