return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "As far as I know, the damaged \"pieces\" that have taken damage during this time have yet to finish being repaired. What: you plan to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(I-I really:n't want to so I'll pass!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Like I thought. I really:n't fit in.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(It's good to let your guard:wn from time to time.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
