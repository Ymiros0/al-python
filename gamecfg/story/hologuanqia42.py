return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Purity",
			dir = 1,
			say = "Ey everyone,:n't panic, and grab hooold of my rigging~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "While it is our duty as warships to defeat Sirens, I have no desire to force you all to cooperate in:ing so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500020,
			dir = 1,
			say = "I lost my way for a little bit, but... no longer. If I have no choice but to defeat them in order to take everyone back safely... I'll: it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
