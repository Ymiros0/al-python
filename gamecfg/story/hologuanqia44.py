return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't really get it, but you've been the only one playing since we started!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Master Detective Fubuki?",
			say = "I just have to defeat your Fubuki in order to win! Now, you would: well to bow before the most noble power in the entire Hololive Headquarters!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
