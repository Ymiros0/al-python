return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "It:esn't matter. From the beginning, the only purpose you've all served was to buy more time for me while I increased my authorization over the Mirror Sea. In other words, \"pieces.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500060,
			dir = 1,
			say = "(Miss Sora:esn't get it at all,:es she...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10500070,
			dir = 1,
			say = "(Zuikaku:esn't get it either...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
