return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900215,
			dir = 1,
			say = "... What? I:n't even get what just happened... But I guess we're saved now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900215,
			dir = 1,
			say = "Calm:wn, Fubuki. You're making her uncomfortable.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "You:n't have any rigging from what I can see... But you've got cat ears and know our names... Are you from the Sakura Empire, by any chance?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... I:n't understand what you're talking about.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900209,
			dir = 1,
			say = "I honestly:n't know how or why we ended up here... But I can say this place looks familiar.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900209,
			dir = 1,
			say = "We were just building stuff like usual,: this blinding light appeared outta nowhere... Next thing we know, a Siren fleet is attacking us, and our friends are nowhere to be seen...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I:n't watch much TV, but isn't this like that \"isekai anime\" trope Ikazuchi mentioned before?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
