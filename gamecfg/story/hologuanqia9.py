return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Turned:wn without a moment's delay... But that's what's so attractive about you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900209,
			dir = 1,
			say = "I wish I could say I:n't. She's, uhh... unusual.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Man, I:n't get what goes through Fubuki's mind. Whatever, let's go help them out!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
