return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900214,
			nameColor = "#a9f548",
			say = "Fubuki, you:n't look so good. Are you getting sick~?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Huh? It's normal to like cute girls... right? Why: you all look like you found a half-eaten worm in your apple?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It might be normal for most people, but in Matsuri's case... how: I put this, it goes a bit overboard...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
