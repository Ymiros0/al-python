return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I see... She's a bit of a motherly character:. Phew, at least it wasn't over something weird...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "She:esn't normally: many maid-like things, so she might struggle a bit... but even that's going to be so precious...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mmhm! As a magician, I: believe that the air in this world is better for my skin!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
