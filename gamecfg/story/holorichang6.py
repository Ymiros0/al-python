return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I have the master key on this save file. Take the lift, exit the tower, and: cross the canyon...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Long Island, I think I know how to: it now! You can head back if you're busy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Eh? Night:esn't begin until the date changes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
