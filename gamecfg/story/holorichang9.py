return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Lady Nagato, you:n't need to...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... Hiei will be preparing tonight's banquet. Until:, please make yourselves comfortable here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's fine and good, but, why:n't you go play with them right now? Isn't it boring sitting around all day? They want to play with you, so why not?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "... Hmm,:es that girl named Mutsu not seem quite precocious? She reminds me of myself.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
