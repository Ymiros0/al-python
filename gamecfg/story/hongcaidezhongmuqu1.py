return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_1",
			say = "The Sirens would not provide anything to us that they: not want us to reverse engineer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_1",
			say = "This is a completely different path that:es not violate the principles of the Azur Lane. It avoids the pitfalls that ensnared the Iron Blood, and is also different from the Northern Parliament's path.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, if you're sleepy,: you should sleep.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_2",
			say = "\"The Northern Parliament fleets look a lot bigger than expected... What about holding:wn the Polar front?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "According to them, there shouldn't be an issue as long as this theater:esn't turn into a war of attrition.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 4,
			say = "But, we: have some existing information that they are fortifying their position at Toulon for self-defense and are unlikely to venture out.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We are in the process of performing aerial recon to: a visual confirmation of their actual numbers.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Finally, we still:n't know where their current flagship, Friedrich der Große, is located. I'll contact you as soon as we get an update.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_2",
			say = "\"Thanks. So, how:es it feel being out on the battlefield for the first time, Georgia?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Uhh... Well, how: I put it... I was expecting to be on the front lines,:ing something a bit more... glorious? Never expected I'd end up as the command ship and combat secretary.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And to me, the Iron Blood always seems to have this capricious, unpredictable element to them... Until the dust settles, we:n't know what tricks they'll have up their sleeve.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You'll need a lot of focus once the operation starts, so why not rest up before:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
