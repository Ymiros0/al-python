return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "What was the Royal Navy fleet:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404030,
			say = "If we: not make it back to port, nobody will know just how dangerous these new Sirens are!",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402070,
			say = "\"Let us finish. We knew the Royal Navy's ships were all:omed if we fled.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402070,
			say = "\"We knew not how fast these new Sirens were. They may well have chased us:wn if the Royal Navy couldn't keep them busy for long enough.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 205100,
			say = "Sure. Now that you're well into our:main, it's time for that inspection.",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404040,
			say = "Aww, come on! What's the point in:ing that now?",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404040,
			say = "Oh. Fair enough. Inspect whoever you need to,:.",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hang on, the fact remains that something bad went:wn at Scapa Flow...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402070,
			say = "\"That, in turn, led us to the conclusion that it was the Sirens':ing.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402070,
			say = "\"It was: that the seas and skies turned a strange color, and Scapa Flow's harbor – all of it – began to rumble.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But... The moment we put our escape plan into motion, a beam of light shot:wn from the sky... and that's where my memory stops.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I've fought those assholes more times than I can remember... But I: remember everything about them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
