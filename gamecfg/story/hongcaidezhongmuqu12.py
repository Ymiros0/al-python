return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 307060,
			say = "Should be good for a warmup! Just:n't get too cocky because these are Mark II's.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 307060,
			say = "Listen! These Sirens are pushovers for shipgirls like us! They:n't stand a chance against our riggings!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
