return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Fair enough, but who's to say we can't socialize a little? What are you:ing here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "My job. What else should I be:ing?",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "And:n't say \"drinking with me.\" That's not going to happen.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Hahahah! What,: you expect me to simply turn around and let you cuff me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "If you want to: it the easy way, yes. The hard way entails us blasting you to bits first! Fire!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
