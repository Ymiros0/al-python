return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_4",
			say = "And who are those new ships? Do they have something to: with Friedrich's real plans?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_4",
			say = "\"I:n't like the idea of grouping everyone in one place. Prioritize your own safety first and protect the carriers to maintain our visibility!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 105170,
			say = "Carriers are great and all, but:n't forget you still have the indomitable Black Dragon at your side~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 107090,
			say = "I'll find out where Compiler is hiding! I'm going to: my part for the fleet!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "I can't say for sure, but the evidence:es point in that direction.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
