return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_11",
			say = "The sender's name is anonymous, but the only person I can imagine:ing this is...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			actor = 499020,
			say = "You already know this,:n't you? Every faction is connected to the Sirens to some extent through the Naval HQ.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_11",
			say = "(The best way to: that is to keep the fleets out of each others' line of sight and focus their firepower on the Sirens from different angles.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
