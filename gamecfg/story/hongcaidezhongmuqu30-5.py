return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "I can confirm that the barrier is starting to go:wn! For a moment there, I was worried that my planes wouldn't: anything against the Siren facilities...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "And now that you're:wn, the chain of command has fallen apart.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "Well:ne, my child. Nobody can anticipate the things you'll:. Not I, not the Sirens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704020,
			say = "Hmph. I know what to: without needing to take orders from anyone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
