return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "They're gonna be a thorn in our side even after we win, huh? We've already made it this far, so:n't get yourselves hurt now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "Hmm? I didn't: anything in particular. My darling human is quite resilient, after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "We've never been able to: more than push them back in the past. But now, we've eliminated one of their program terminals.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"Now that Bismarck is back in power, what direction: you expect the Iron Blood to go in?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "Don't be silly. I just want to resume working behind the scenes, where I: best. I:n't belong in front of a podium.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "If I knew what it is, I would tell you a little more. Sadly, I:n't.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "What might they be saying right now behind closed conference room:ors? That was a question for future me to answer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
