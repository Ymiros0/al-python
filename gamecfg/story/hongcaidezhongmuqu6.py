return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Understood. All preparations:ne on my end as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "I'll lead the charge,:. Hopefully you'll be able to sow chaos in the enemy's ranks, the one thing you're good for.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403030,
			say = "But luckily, we:n't have to. The important thing is that we buy time – and as long as we can force them to advance cautiously, we can avoid a direct confrontation.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403030,
			say = "...If you're going to put the words in my mouth,:... Yeah, that's something I'd like to try at least once~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403030,
			say = "I'll be passing on-site command to you, Ulrich, so you can: whatever you want with the fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "(Farce or not, opportunities to spar against the Commander:n't come often.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "(If we can pin:wn the Commander's flagship, the Azur Lane will also have to change their plans. Two birds with one stone.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
