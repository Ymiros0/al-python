return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "See? I told you it was worth a visit. Since we have plenty of time to look around,:es anything catch your eye?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501060,
			say = "Greetings! ...Oh, I:n't see you girls every day. Do you have business at our:rm or something?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We would like to decorate our:rmitory in the same style as yours and perhaps even have some fun together.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501070,
			say = "If you:n't believe us, we'll cook a feast for you tonight! That's sure to help with your own festival prep.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501060,
			say = "Hold on,:esn't that mean there are no good cooks available?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501070,
			say = "No, calm:wn, Lady Yuen... You've been in this situation countless times... Just calm:wn and think about it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
