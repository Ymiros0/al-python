return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_512",
			hidePaintObj = True,
			say = "Looking up the words \"Huan Ch'ang\" written on the:or plate, I couldn't help but wonder... How did it come to this?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "The:or to my office is thrown open, and in jumps two little shipgirls.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501060,
			say = "But what's:ne is:ne, and we need your help, Commander!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(They probably came to the Empery:rm,: this and that happened...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "They were forthcoming a moment ago, and now they're reluctant to share anything, looking back towards the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "I shoot Chi An a look of:ubt – among other feelings – as she tries to act cute.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The problem is – we:n't have the ingredients...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501060,
			say = "I:n't think that's such a hot idea... She won't like diving a solution to a problem of our making.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Chi An, say something! Convince the Commander to: it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502090,
			say = "Okay... Commander,: it for me? Pleeease?",
			painting = {
				alpha = 0.3,
				time = 1
			},
