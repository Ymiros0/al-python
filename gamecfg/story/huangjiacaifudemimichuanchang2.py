return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "Royal Fortune's Secret Shipyard - Keel laid:wn",
		...
		},
		{
			...
			side = 2,
			bgName = "bg_battleshipyard_1",
			say = "The keel is an oblong structural part located:wn the middle of the hull's underside. It connects with the ship's sternpost.",
			dir = 1,
			actor = 9600010,
			nameColor = "#A9F548FF",
			hidePaintObj = True,
