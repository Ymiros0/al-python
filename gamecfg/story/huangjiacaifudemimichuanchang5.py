return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600010,
			say = "It:esn't matter if you use the best wood around – it's still gonna rot if it spends too long in the sea.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600010,
			say = "While they: give it a pretty colour and create value from a visual standpoint, for the ship itself, they're bad news.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600010,
			say = "If ya:n't: anything about 'em, they'll leave even a good warship riddled with holes in less than a year.",
			painting = {
				alpha = 0.3,
				time = 1
			},
