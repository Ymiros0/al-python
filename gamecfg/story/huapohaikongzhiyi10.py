	...
	scripts = {
		{
			...
			side = 2,
			nameColor = "#ff5c5c",
			say = "Damnit, Enterprise! ...Ugh, is it impossible to take:wn the Eagle Union's Task Force?",
			dir = 1,
			bgm = "battle-boss-2",
			effects = {
				{
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Zuikaku, calm:wn... *cough* *cough*... Let's withdraw for now and come up with a plan...",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "I can't believe I let my guard:wn like that... just after Taihou took a torpedo hit as well...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I guess that means we can finally catch our breath for the time being... Well:ne, everyone~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Why:n't you just tell her about it directly next time?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102090,
			dir = 1,
			say = "Not just about the battle, but how you were shining brilliantly on the battlefield as you took:wn:zens of enemy planes! Ehehe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107230,
			dir = 1,
			say = "(Though I'm still inexperienced, if I keep striving to learn everything I can from the battlefield,:...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107230,
			dir = 1,
			say = "Enterprise... Yeah! Thanks, I'll: my best!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
