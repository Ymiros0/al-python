return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Got it. The enemy's air forces shouldn't be as strong as they were before, but...:n't let your guard:wn. We're engaging the enemy, full force!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm not planning on letting any through... But if any: make it past me, I'll leave that to you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
