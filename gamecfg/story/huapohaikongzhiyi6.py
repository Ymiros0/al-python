return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107230,
			dir = 1,
			say = "(Even though the submarine got a good hit on their carrier, I:ubt a Sakura Empire carrier would sink just from that. Even Saratoga has taken plenty of hits.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107230,
			dir = 1,
			say = "(Things:n't seem to be going badly at all. Let's hurry and group up with the main fleet.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
