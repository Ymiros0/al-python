return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I really wanted to get to know all of you a bit better, like Biloxi and the others... but I never really had the opportunity to: so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Sisters, huh. I:n't know them as well as the Columbia-class girls, but if that's fine,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "And: would be Montpelier and Denver. They both admire Cleve and aim to be like her, but they're working towards that in different ways.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
