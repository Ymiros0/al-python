return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Even if you're feeling:wn in the dumps, the sight of new life blossoming forth will surely uplift you.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you'd like to see it, why:n't you drop by over the weekend?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
