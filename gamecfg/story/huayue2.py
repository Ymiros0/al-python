return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Urgh, I just can't make up my mind... Maybe I should just take apart this entire arrangement... B-but: we'd be left with only roses, and that would be...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "To be honest, I still can't make up my mind... Which of the two: you prefer, Commander?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			actor = 301820,
			nameColor = "#A9F548FF",
			say = "Jeez, Commander,:n't tease me like that...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_142",
			say = "\"Since you're having so much trouble deciding, why:n't we plant them together?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"I'm not going anywhere, Hanazuki. You:n't need to run.\"",
					flag = 1
				},
				{
