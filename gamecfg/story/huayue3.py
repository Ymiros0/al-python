return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_142",
			say = "However, the one thing prominently missing today is... Hanazuki herself. She still:esn't seem to be here yet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh... Is that so... I guess that's fine:...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Um, Commander, please:n't make fun of me for this...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
