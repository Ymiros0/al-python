return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_142",
			say = "Before I knew it, my visits to Hanazuki's garden room had become a habitual occurrence. I started passing by whenever I had nothing to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				...
				{
					content = "What were we drinking just now:?",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_142",
			say = "After finishing the last bit of tea, I go to set my teacup:wn on the tray when I suddenly feel a warmth against the back of my hand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I, I'm really sorry... I:n't think I can say it after all...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Thank you for spending the day with me, Commander... If you:n't mind, would you come see me again?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
