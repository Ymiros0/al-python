return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't get it... There's a celebration on and you're here working all day?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hah! Now, we got a lotta work to:, so you run along. This isn't a place for kids to play. Come back when the concert's on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But like... Where: I go? Commander's busy with whatever. Who am I supposed to play with?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Show yourself, coward! I'll:uble my prices, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, nothing beats a good prank! Now, what to: next... I guess I could go check out the Lecture Hall...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
