return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey,:n't go back to sleep. Manjuus,: me a favor and grab a glass of water.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What are you:ing here? Get out of my room!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "... Hang out? Since when are we friends? Since when: we not hate each other?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This has nothing to: with back:. This is about protecting my dear, sweet, beloved Commander...",
