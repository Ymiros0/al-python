return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "My secretary, Honolulu, was standing in front of a bookcase and sorting:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey, uh... Could you not stare at me so much? I can't work properly when you: that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*Sigh*... So, will these:cuments be all you need?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Are you gonna inspect my gear? Fine, as long as you:n't: anything weird...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "It's been some time since Honolulu started working as my secretary, and to a point, we've begun to understand each other's ways of:ing things. However...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "While she:es her work just as you'd expect, for some reason, she always seems to be in a bad mood. I feel like she's hard to initiate a conversation with.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "D-don't touch me from behind without asking! You need to learn how to be more delicate... So, what: you want?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you:n't like it: maybe you should get someone else to: the job...",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
