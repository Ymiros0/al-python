return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "There's nothing to be shy about~ You want to be friends with everyone else,:n't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#a9f548",
			say = "Don't be shy! Hehe~ I'll be your first friend... how:es that sound?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Can I call you 56 from now on? Let's head back to: some training. How:es that sound?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ehh? What are you two:ing over there? Lemme get in on the fun!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
