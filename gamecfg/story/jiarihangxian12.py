return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "There's not much we can:. It's probably one of you-know-who's plans anyway... For now, let's just work on getting it to 100%.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "As they say. when in:ubt, turn to people with more expertise.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "\"Who: you think I should choose, Mikasa?\"",
					flag = 1
				}
			}
		},
