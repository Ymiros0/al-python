return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Shame that we're not the ones on stage, but we'll leave it to you. Don't let us:wn, 5th.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hah! I promise we won't let you:wn, great and honorable Akagi~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
