return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 10600040,
			dir = 1,
			say = "I'm fine,:n't worry! With this, we can travel on water! I've got to admit, it's pretty exciting!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"A battle between worlds\"... surely that:esn't mean we have to...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we are,: I won't go:wn without a fight...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ahaha, I:n't really get it, but... we'll help out, too!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
