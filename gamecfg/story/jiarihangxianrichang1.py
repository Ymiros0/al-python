return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Hey, why:n't we go for some crepes?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "A-anyway! I'm in the mood for one! So,: you want to go, or not? I:n't have all day... silly:g.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Whichever you order, I promise they're all delicious! My personal favorite might be the mango vaNonela, though~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Well, if you think it's good,: I guess...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "We'll have two mango vaNonela crepes.",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I told you! We simply ran into each other... Come here now, silly:g. We're leaving.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But now that I know she's safe and:ing perfectly fine, my worries have eased up a little.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...What? What are you grinning for, you silly:g?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
