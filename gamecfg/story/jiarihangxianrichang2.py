return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Fancy ourselves beachside architects,: we? Well, I shall be waiting to see your finalized creations.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_106",
			say = "Marie and Honoka's creation is a giant sphere,:nned with a necktie and a navy cap. It looks a lot like...",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So, Commander, which: you think is the best? You're the judge!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
