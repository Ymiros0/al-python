return {
	...
	scripts = {
		...
		{
			say = "Monica asked me to come with her, saying she had something she wanted to: together.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I: as she asks and cover up my eyes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Well~? Which card: you choose, Commander~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
