return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I: not mind. I've lived for far too long to fuss over inconsequential details such as that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "They have temples where they worship the gods, and shrine maidens that tend to them. Where, I wonder,: the similarities end?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
