return {
	...
	scripts = {
		...
		},
		{
			...
			optionFlag = 3,
			nameColor = "#A9F548FF",
			say = "Hmm... Just \"Detective,\" I guess? If that's too plain,: you can call me the Private Eye of Justice!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107094,
			say = "That is all. What: you think of the incident so far, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
			...
			options = {
				{
					content = "We:n't have enough clues.",
					flag = 1
				},
				{
