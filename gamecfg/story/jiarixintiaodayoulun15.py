return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600040,
			say = "I didn't: anything this time! I swear on my afterlife!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107094,
			say = "I:n't even have to think! I'd choose going to the bar with you, of course!",
			painting = {
				alpha = 0.3,
				time = 1
			},
