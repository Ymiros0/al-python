return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "The real Essex did, of course, assist in the investigations. But there's no:ubt that there was a fake in our midst at times.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "This is a big ship, and a lot has happened. You knew that I:n't have the time and energy to verify everything.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "You used that fact to your advantage. There were several times when I had my:ubts, but every time, my attention was diverted somewhere else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FF9B93",
			say = "Heehee. I see, I see~ Why:n't you call your friends for help,:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Next time? Are you going to: this again?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
