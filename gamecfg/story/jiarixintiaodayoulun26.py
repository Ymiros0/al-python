return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101401,
			say = "Is it that we:n't get to see fish often? I've heard not even the submarines see them much.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "Something on your mind, Commander? Are you thinking about what to: with the fish when we're back home?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 108080,
			say = "I-I have! I'll take them in and look after them. I:n't want anything to happen to the fishies!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_173",
			hidePaintObj = True,
			say = "She runs her slim fingers around in my palm,: locks them between mine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
