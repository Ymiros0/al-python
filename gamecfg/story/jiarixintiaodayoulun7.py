return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh yeah, what were you guys planning to: anyway if you hadn't run into us?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901050,
			say = "But, things are way more fun when they:n't go as planned, right? Heehee~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yes, magnificent bands of light that hang:wn like curtains from the skies.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "*gasp*... You're right! I'll ask Ingraham if she can: something about it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well, since we've all been talking about the same thing for a while now, why:n't we formally set course for the polar south?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 105170,
			say = "The Tempesta crew seems to be on board as well, and opportunities to hang out and try something new:n't come around too often. Let's all head:wn there together, yeah?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Alrighty:! Let's vote on it, pirate-style! If everyone agrees on the same thing, we'll ask Commander to change course!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600010,
			say = "Now:, can I see a show of hands? All in favour–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 904010,
			say = "I:n't think that potato chips and cola counts as a proper meal... Why not head back to the cruise ship? There's plenty of food on board.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600030,
			say = "Hmm... That sounds pretty promising. How:es a bonfire barbecue sound?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actor = 9600040,
			say = "A barbecue sounds nice... but I could: without the bonfire...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_162",
			hidePaintObj = True,
			say = "The high-quality ham that São Martinho brought over is sliced thinly,: paired together with Owari's freshly-farmed melons for a light and savory snack.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_162",
			hidePaintObj = True,
			say = "Before I realize it, the barbecue bonanza is already winding:wn, and someone signals its end by sticking a sword into the bonfire.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Wasn't into ballroom dancin' back:. Still ain't now.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Excuse me? Does this Iris swashbuckler have any better ideas? If not,: as I say!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600010,
			say = "Ballroom dancing is THE symbol of elegance and high class. Us piratey types:n't mesh well with that, you know.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Et tu, my servant? ...I suppose I:n't mind going along with that idea! Now:, my maids shall see to it that the venue is set up properly!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Let's see if there's anything I can: to help.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
