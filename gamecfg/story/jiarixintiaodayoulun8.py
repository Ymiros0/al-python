return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Commander, are you awake? Can you open the:or?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9600010,
			say = "The one and only! I have something important to tell you, so please open the:or!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_136",
			hidePaintObj = True,
			say = "I throw on my clothes as quickly as possible and go to meet Royal Fortune at the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I guess that's True. Nobody's ever heard of the abductee getting to decide what to: and where to go.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			say = "The ship weathers the storm without rocking too hard,: returns to the regular, tranquil seas.",
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Plus, we're cruising as normal and TB hasn't sounded any alarm. I'll just find something to: and forget about this.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
