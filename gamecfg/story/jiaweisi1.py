return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now:, Commander, I propose we start on today's work right away.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I accepted the:cuments and began reading through the first sheet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 201340,
			say = "Because if not, you're sorely mistaken if you think I'll: everything for you regardless.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
