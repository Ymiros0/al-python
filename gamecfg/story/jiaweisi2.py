return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 201340,
			say = "We:n't want that to happen, so have this warming cup of tea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Don't mention it. I'm only:ing what's expected of me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "I've also shredded all the old:cuments due for disposal.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "You have the right attitude, but taking breaks is important too. Making sure you: so is also part of my job.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
