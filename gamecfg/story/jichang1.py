	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"According to legends passed:wn from yore, stars were beings of light or flame, ones that took ships and travelers alike under their protection.",
					3
				},
				{
				...
				{
					"Many stars besides Polaris shine brightly upon the sea. What kinds of hopes and dreams: these stars carry?",
					6
				},
				{
