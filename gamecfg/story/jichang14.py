return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "On one side we have the imposing Verheerender duo, nya! If it's one thing they've shown they:n't have, it's mercy, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm afraid I:n't quite understand what that means, Sheffy...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202250,
			dir = 1,
			say = "Thus, everyone knows. The Master:es not wish for any one team to have an advantage over another, you see.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "Now, however, we have another problem. expressing our feelings through song:es seem a difficult task...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
