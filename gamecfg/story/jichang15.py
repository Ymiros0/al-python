return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			blackBg = True,
			say = "This thread:es not need a weaver, for the heart produces it naturally, spool after spool, simply through contact with others.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I can: it, but I think I'm lacking in the cuteness department. Do you think I'd stick out in a bad way because of it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(But... Master assigned me these duties because they are important! If I abscond from them, I... Oh dear, I:n't know what to:...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Not really. Anyone can: it with enough practice. Tashkent just learns slightly quicker than most people.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701050,
			say = "Once I've mastered it,: I will teach it to them. Tashkent can't be the only good dancer in the troupe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Aha,: strive for greater vocal softness I shall, Mentor Sara. Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "To win my Commander's affection with the most stellar performance possible, why else? Why, even that wench Akagi has:ne the same.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
