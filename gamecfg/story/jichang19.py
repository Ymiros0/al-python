return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh no, nya... The mood in here has:ne a complete μ-turn, nya! Verheerender look like they're about to start shooting everything in sight!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And I:n't wanna get caught in the crossfire, nya... I need to get out of here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 103250,
			dir = 1,
			say = "Halfway to death, geesh... Don't: that again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
