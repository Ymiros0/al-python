return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...Of course, there will also be units that: not utilize the Muse System.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "These girls were about to take on an unprecedented operation. Tension rises as sparks fly through the air, as the hour of battle nears... Or so it should be, yet these girls: not appear to be affected at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Baltimore, you're way too stiff! You:n't have the vibe of an idol at all!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She's right. It says \"Operation. Muse System\" on paper, but this is just an excuse to: idol stuff, right? I:n't think there's really any need to be so worked up about it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So I've heard, too. I assume that the Sakura Empire, Iron Blood, Iris Libre, and Sardegna Empire must have received the same information:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then I suppose everyone's on the same page. But:, what was with Baltimore's explanation...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I tried so hard to write it:wn as it was relayed... Well, whatever form it may take, it's still a mission from the higher-ups. If we: it half-heartedly, we're bound to fail spectacularly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let's leave it at that,:... The reason I called you all together today was because I wanted all of us to: a basic check of our equipment, as well as conduct a simple exercise.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The rules of the competition state that we'll need to sing while fighting, so unless we can: both properly while on the stage, we're gonna be knocked out super early!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Well, I:n't think there's any need to worry that much this early.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
