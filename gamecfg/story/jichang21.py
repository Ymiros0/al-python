return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Tashkent I believe is in class at the moment, but I'm afraid I:n't know where Albacore could be.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What: you know. Apparently, tons of people wanna have a shot at it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I've got some catching up to: on my hero side-gig, so I'll sleep on it for a bit before I decide.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You're kidding! You're seriously:ne being an idol forever unless the Commander or Le Triomphant beg you for it?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Although unlike them, I guess you REALLY:n't wanna: it.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander? I've finished up the report you asked for. Please,: give it a look.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: I propose? Well, something to: with music, stars, and everyone dancing on the stage together. Not quite sure yet...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
