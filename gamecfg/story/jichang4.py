return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			dir = 1,
			say = "I know that Sheffield was part of the previous Muse System unit, so I was wondering.: you know what kinds of lessons they took to prepare for their performance?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Are you reaaally gonna be like that? Anyway, well? What: you want us to:, Baltimore?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
