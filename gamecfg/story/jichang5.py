return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(Illustrious isn't particularly good at dancing, and:esn't get what being an idol entails.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All righty:. Think I could ask you a favor?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Can't you: that yourself? Everyone knows your specialty lies in sneaky information-gathering.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Just so you know, gathering intel is fine and dandy, but:n't you go around pulling pranks on others.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Thanks, you'd both be:ing us a huge service. All right, let's head out!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
