return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			expression = 1,
			say = "For us to achieve these objectives, it is of vital importance that every single vessel here:es her very best to fight and cooperate with her sisters.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Understood. The Fist unit will see it:ne!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 703010,
			nameColor = "#A9F548FF",
			say = "The Lightning unit will: all in our power to see your orders satisfied.",
			painting = {
				alpha = 0.3,
				time = 1
			},
