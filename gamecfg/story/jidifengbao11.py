return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 799010,
			say = "Tell me,: you know the phrase \"geomagnetic reversal?\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 799010,
			say = "I:n't like taking on problems until I've witnessed them with my own two eyes. It's just that seeing it for myself helped me make a hypothesis.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That will mean taking the brunt of their enormous forces. We:n't have the luxury of fantasizing about anything else. Comrades! Do you still believe that you can rise above this challenge?",
			painting = {
				alpha = 0.3,
				time = 1
			},
