return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705010,
			say = "I:n't care! Send all the reinforcements you want, it won't matter!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_hms_8",
			say = "Before Gangut could fire her main cannon once more, Chkalov's carrier-borne craft mowed:wn the Siren reinforcements with explosions.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hold it! I:n't know if I believe you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you know the entirety of our strategy,: enlighten us. We'd all love to hear your opinion.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "The whole point of your struggle here is to detain my forces and allow your stupid friends to move as they like through my:main!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "I'll slaughter you all in seconds, and:, I'll: the same to the other units!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705010,
			say = "You're the only one who's going:wn there, Omitter!",
			painting = {
				alpha = 0.3,
				time = 1
			},
