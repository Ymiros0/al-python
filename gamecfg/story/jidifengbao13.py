return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702070,
			say = "Then why:n't you go back and get it? Time is ticking, and the mission has already started.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_hms_8",
			say = "It was: that a white owl emerged from the curtain of snow and approached the group.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
