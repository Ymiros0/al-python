return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 703020,
			say = "I:n't like this... Voroshilov, what are the coordinates of our objective now?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702070,
			say = "But we are still able to trace abnormal wavelengths, so it:esn't seem like the device is malfunctioning...",
			painting = {
				alpha = 0.3,
				time = 1
			},
