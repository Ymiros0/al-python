return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705070,
			say = "Kirov's Weasel unit stopped the weather control device, so the snow has calmed:wn here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702070,
			say = "If it's the Sirens,: they'd send forces to attack or distract us, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
