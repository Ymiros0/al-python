return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702070,
			say = "Not necessarily. Most of them:n't seem to have been destroyed by our weapons.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702070,
			say = "If Rossiya's unit had come through here,: they would have said something over comms. The fact that they haven't means...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705070,
			say = "Kursk, what will we: if it really is a META?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705070,
			say = "Do we fight? Try to reason with them? Or: we try to gather the other units now?",
			painting = {
				alpha = 0.3,
				time = 1
			},
