return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That's not it. It's just that, when it comes to the Sirens, our stuff always breaks at a pivotal moment. So forgive me if I:n't expect much.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702050,
			say = "When that time comes, focus on keeping yourself safe. Don't you dare: anything stupid.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "All we can: is pray that things work out. Mm, that's all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702050,
			say = "But it:esn't look like they brought the firepower to support us in battle. This one's up to the Northern Parliament.",
			painting = {
				alpha = 0.3,
				time = 1
			},
