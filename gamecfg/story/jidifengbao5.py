return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 707010,
			say = "It's not following us. Does that mean those:n't leave their patrol area, or something?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 707010,
			say = "B-but Kronshtadt and I only went there once. I hope the unit tasked with the research base is:ing okay...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705050,
			say = "That:esn't merit concern at this moment, Minsk.",
			painting = {
				alpha = 0.3,
				time = 1
			},
