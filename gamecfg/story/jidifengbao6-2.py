return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "And the mass-produced Sirens here are a type I've never seen before. Rossiya,: you know them?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "No... But I: know that these are much stronger than any other mass-produced ships we've fought.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Another Omitter came out! This one:esn't seem like the real one, either!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If we're going to retreat,: it should wait until we have a better idea of their mass-produced ships' features! Hold on a little longer!",
			painting = {
				alpha = 0.3,
				time = 1
			},
