return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 701090,
			say = "I'm not about to talk about Sirens' aesthetic choices, but: they normally leave conquered buildings intact?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 701090,
			say = "We:n't even have to kill them all, either. Our attack will draw plenty of Siren attention.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What in the... Mechanic, what have you:ne?",
			painting = {
				alpha = 0.3,
				time = 1
			},
