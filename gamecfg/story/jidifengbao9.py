return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ever since Rossiya's unit took:wn that Siren fortress, the weather in this area has been so unstable...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_hms_8",
			say = "Gromky held her hat:wn and tried her hardest to fight the wind, but the wild blizzard seemed unwilling to allow the fleet's advance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I:n't know its inner workings myself, but according to Voroshilov, it seems to be made to \"modify the climate of a permafrost environment to make it livable\"...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I will decide when to activate them. When I:, we charge through all at once.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 701020,
			say = "Yeeeah! I'll: my best to hold out!",
			painting = {
				alpha = 0.3,
				time = 1
			},
