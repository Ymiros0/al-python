return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 903020,
			dir = 1,
			say = "A fleet of capital ships:esn't exactly make for the most agile hunters.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 903010,
			dir = 1,
			say = "It would be my honor to exchange fire with you right here, Littorio, but why:n't we try to resolve this without violence?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 605020,
			dir = 1,
			say = "I can consider taking you up on that offer... but:n't think that means I'll just let you go.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 903020,
			dir = 1,
			say = "(I know there are some battles that you shouldn't take, but... Sometimes, you:n't have a choice and just have to leave things to fate, right?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
