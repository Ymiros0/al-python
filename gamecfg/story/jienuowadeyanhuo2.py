return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I: wonder how Sardegna will respond... If we're lucky, they won't even get the chance to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Mhm. Fingers crossed they:n't catch on to us, or we'll lose the element of surprise.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What must we: for total success,:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "Until:, we'd better stay on our guards. Lead the way, Algérie!",
			effects = {
				{
					active = True,
					name = "speed"
