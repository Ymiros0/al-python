return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn. Our cover hasn't been blown just yet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Are you... Vichya ships? What are you:ing here? There's not supposed to be any major fleet movement tonight...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
