return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Please. I:n't want to hear that from you, Ms. Knight who's always busting her butt in battles.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Although, I'm glad I:n't have to make a show out of using my rigging, like you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah. This is going to come:wn to a race against time more than a battle against enemies.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "All righty, let's get this job:ne quickly!",
			effects = {
				{
					active = True,
					name = "speed"
