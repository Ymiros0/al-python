return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Is it something to: with the Sacred Sakura? If so, what?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Understood. What: you need me to:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305050,
			say = "Allegedly, the real Watatsumi was handed to Iron Blood,: later retrieved by Akagi. However, I suspect we once again will be unable to determine whether or not it is real.",
			painting = {
				alpha = 0.3,
				time = 1
			},
