return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305120,
			say = "What: you say we end the tour here and take a little break? You could use one, what with how pale you look.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Sure:. Tester, Purifier, Compiler, and Omitter... Just like with the Pawns, they look the same as their originals.",
			painting = {
				alpha = 0.3,
				time = 1
			},
