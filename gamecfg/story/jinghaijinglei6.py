return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Alright. Careful so you:n't trip.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "(First I was converted to a carrier in Amagi's stead,: the Commander appeared and somehow changed the Reenactment, resulting in Tosa's survival...)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Mutsuki visited just a while ago. It felt a bit awkward talking to her in front of the:or, but rules are rules.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...Alright, I'll just wait outside:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Arranging a fireworks display is very time-consuming. I:ubt she'll even come home today.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You:n't happen to know when she'll be back,: you? I really need to talk to her.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301110,
			say = "I see, I see! But I:n't know. Do you, Inazuma?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307020,
			say = "Guess I'll be on my way:. You two be good, alright?",
			painting = {
				alpha = 0.3,
				time = 1
			},
