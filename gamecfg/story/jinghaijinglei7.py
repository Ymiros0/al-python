return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307010,
			say = "Your rondo may have reached its denouement, but I still have many, many things to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 499020,
			say = "We shall meet again in another place. Until:, may you be in good health, Akagi. Heehee.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Pardon me for interrupting you while you are busy. There's a girl at the:or with a message from Musashi.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307010,
			say = "Ah, Musashi... I knew you'd: something like this sooner or later.",
			painting = {
				alpha = 0.3,
				time = 1
			},
