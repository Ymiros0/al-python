	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"There's no telling what the Sirens are up to. We can't let our guards:wn yet.\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Really? Are you gonna be treating us:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"As this is a military port, please proceed along the designated approach route and: not stop or stray from it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
