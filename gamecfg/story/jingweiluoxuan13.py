return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "\"We're still hanging in there, but AF's runways got torn up pretty badly by the first wave of airstrikes. In any case,:n't expect any air support from us~\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If the attack didn't come from a \"real\" allied plane,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 107140,
			say = "Unfortunately, no. The ones I was tracking have all been shot:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 105170,
			say = "Welp, change in plans:. Let's track those Eagle Union planes instead... and oh, be mindful of the altitude.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
