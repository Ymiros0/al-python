return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(But unlike the Siren Pawns, these Ashes ships really:n't seem any different from us... Maybe there is a chance.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = True,
			say = "So:n't worry about anything else... and fight for your lives.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 108060,
			say = "Ahaha~! I prefer:ing things from behind~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 105170,
			say = "Well:ne, Archerfish. Now, it's my turn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
