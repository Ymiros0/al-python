return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 105170,
			say = "From everything you've told me, it's pretty clear that the Sirens are involved,:n'tcha think?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That's right! Besides,:n'tcha think the commander would've:ne the same thing?",
			effects = {
				{
					active = True,
					name = "speed"
