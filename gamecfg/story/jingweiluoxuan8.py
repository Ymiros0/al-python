return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "\"It's hard to believe, but the coordinates where you went missing:es differ from where you later escaped.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Finally, some good news... I'll go ahead and contact Allen directly:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 101450,
			say = "Yesterday evening, a sea fog suddenly appeared around the base, and: Sakura Empire carriers started bombarding us...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
