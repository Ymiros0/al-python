return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 312010,
			say = "But I'm not:ne yet, nya! Even if all you: is come and window-shop, you'll get a gift bag ABSOLUTELY FREE, nya!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "I couldn't have:ne it without you, Commander, nya~",
			painting = {
				alpha = 0.3,
				time = 1
			},
