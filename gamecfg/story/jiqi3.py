return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Cavalla, you act as bait to lure her attention,: Dace and I will wait for an opening to strike.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So tired... I definitely:n't wanna go sleep in my room... Nope, not at all...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(What the heck is Cavalla:ing?!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Destroyers:n't scare m– Oh, God! That nearly hit me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "... Okay, I DID tell you to act as bait, but you didn't need to: crazy things like that!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
