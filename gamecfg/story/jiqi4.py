return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "... What we're:ing? Just a friendly competition between us subs. Loser has to buy Oxy-cola for everyone else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That'd make the Commander feel bad about it and make her resign. Now:, Cavalla, you owe us some...~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If she did: she'll end up where the Sakura Empire is conducting an exercise...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*Giggle*, it's your fault for not realizing one was coming. You won't be able to defeat me if you:n't concentrate~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
