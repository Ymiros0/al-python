return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I'm presuming the idea is that we'll each take turns telling a story and: decide whose is the best.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				...
				{
					content = "A story about a detective who uses his wits to track:wn a criminal",
					flag = 3
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That:es it! Next time I'm gonna make it clear to you that I'm not a baby anymore!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
