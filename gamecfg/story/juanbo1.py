return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			blackBg = True,
			say = "\"Examine all past records and draft a financial report,\" they said, which boils:wn to days of crunching numbers and scanning fine print made for ants.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I'm taking another plunge into paperwork hell today, taking my secretary:wn with me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All right, I'll take over for you! I may not know all these difficult adulty words, but my stamina will get the job:ne!",
			flashout = {
				dur = 0.5,
				alpha = {
					0,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Commander! How: you write– Wah?! Oh shoot!",
			flashout = {
				dur = 0.5,
				alpha = {
					0,
