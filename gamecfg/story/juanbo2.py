return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Makinami went to the archives to fetch some:cuments, but still isn't back yet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's gotta be tough for the Commander... Stuck in a chair all day, reading and writing:cuments...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey, I see the:rmitory now! Let's have a race to the– Wah?! Oopsies!",
			action = {
				{
					type = "move",
					y = -2500,
