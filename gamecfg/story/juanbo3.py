return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Welp, time to get back into the ring and slog through more:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey, I'm not a burden bird! I'm:ing a great job going around retrieving mail and:cuments and stuff!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahah, most excellent. You deserve a reward for your diligence. What: you say I ask Hiei to make you a treat later?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Sure thing! I'll: it right aw– Wah?! Triple-whoopsie-daisy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
