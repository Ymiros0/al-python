	...
	scripts = {
		{
			...
			hidePaintObj = True,
			say = "A fireplace burned in the corner of a dimly lit house, letting out quiet crackles now and:.",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Why: people call her that, purin?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There's nothing I can:, purin...",
			painting = {
				alpha = 0.3,
				time = 1
			},
