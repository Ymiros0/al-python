return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "What defenses:es that port have?",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			options = {
				{
					content = "Then all we can: is to lure the fleet away.",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We need reinforcements, my darling. Say, while we keep them busy, could you: something for me~?",
			painting = {
				alpha = 0.3,
				time = 1
			},
