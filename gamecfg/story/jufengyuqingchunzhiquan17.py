return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That was a pain... I'm:ne, by the way.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Terminal says it needs you to: its job.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "(Put your right hand:wn.)",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			bgName = "bg_jufengv1_4",
			hidePaintObj = True,
			say = "Mary puts Whydah back:wn after holding her high in the air like a baby.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "And while I: prefer the indoors, I've built up SOME resistance to the outdoors.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Noooo! Not again! Let me:ooown!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
