return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "...You feel like we set off too soon? I mean, it's what Golden Hind asked us to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "She:esn't want to draw attention, so we have to sail alone... which, I'll admit, makes this a pretty tiny expedition team.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh dear... You:n't know who São Martinho is.",
			actor = 9600030,
		...
		},
		{
			...
			options = {
				{
					content = "Why: they call her that?",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Why:es she have her sights on us?! Golden Hind! I thought ya were a reputable businesswoman!",
			actor = 9600010,
			actorName = "Royal Fortune",
			hidePaintObj = True,
			withoutPainting = True,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "In these trying times, I suppose the threat of violence is a part of:ing business.",
			actor = 9600030,
			actorName = "Golden Hind",
			hidePaintObj = True,
			withoutPainting = True,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "While the cities in Thalassopolis have non-conflict agreements, they can't: much to stop someone with more guns.",
			actor = 9600030,
			actorName = "Golden Hind",
			hidePaintObj = True,
			withoutPainting = True,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ya think I'm stupid? You'll just come and nick everything that's not nailed:wn!",
			actor = 9600010,
			actorName = "Royal Fortune",
			hidePaintObj = True,
			withoutPainting = True,
