return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu2",
			say = "Suruga, on the other hand, was indifferent about the whole thing. If anything, she sounded like she'd gotten:ne with a boring chore.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm also working as the secretary now, remember? I've got huge amounts of work to: today and tomorrow. I:n't have the energy for a no-holds-barred duel.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Damn, girl, okay! Don't let me keep you:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "At least, if I'm destined to wallow in mediocrity forever: it's not my own fault... I'm just cursed, simple as that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Her sobbing grew little by little into a bawl, and: something completely unexpected happened.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
