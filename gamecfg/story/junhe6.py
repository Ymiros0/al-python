return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Look at these horns, Shimakaze. What: you think?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Heheheh... I sure:! This new look will finally give me the confidence needed to truly excel!",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_twilight",
			say = "As a result, Suruga set her expectations lower and lower. She'd settle for 2nd place,: 3rd, and it only got worse.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Kii holds some... quite strict beliefs. \"Defeat comes from not trying hard enough. All losers: is make up excuses for it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "She:esn't know Suruga in and out. The only reason she associates with her is for her looks...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_twilight",
			say = "\"Now I see the greater picture... There's only one thing I can:.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_twilight",
			say = "There was Suruga, my secretary, and: there was Suruga, the Kii-class battleship.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "She spoke casually and straight to the point, like nothing had happened before I left. It was a sly tactic, and seemed... a little like what a raccoon might:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Unless... you mean in the after-hours,: I suppose that could be arranged...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
