return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Suruga, how:es the battle fare?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you need someone to lure our opponents in,: Yukikaze the Great will: it! Just give me the order!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "In other words, we'll also need some way of buying time while luring them. Do you have any ideas on how to: that, Yukikaze?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I, I see... Then, I will: whatever I can to support you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You can count on Yukikaze to get it:ne! Wa hah hah!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
