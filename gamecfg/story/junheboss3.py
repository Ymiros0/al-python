return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Somehow, we managed to fend off the Commander's onslaught... But as the battle gets drawn out, we'll surely get whittled:wn...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You won't be alone. We'll bait the ship the Commander is on to come here,: attack all at once.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It:esn't matter if you use cannons or bombs, just take out that flagship! Got it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But how: you know where the Commander is?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Why, I thought you of all people would know, Taihou... Would you mind:ing some recon for us?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
