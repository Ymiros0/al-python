return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We still aren't:ne?! Yukikaze the Great may be second to none, but even I:n't have limitless stamina!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But it's fine... At this range, everything turns into an all-out brawl, and it'll be impossible to keep track of what every ship is:ing. This is my best opportunity.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Taihou,: you read me? I've transferred my flagship status to you! The moment my gunfire stops, send your bombers over to my location!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "D-did you just get Taihou to back:wn?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
