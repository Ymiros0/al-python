return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "Yukikaze, Taihou, and of course, Suruga, you've all:ne me proud. Even the Commander has praised your outstanding performance during this exercise.",
			bgm = "cw-level",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Heheh! We:n't need any cheap tricks for that! This is nothing that cannot be solved with Yukikaze the Great's extraordinary luck!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(You:n't say! And how in the world could I have known the Commander's fleet would be so powerful?!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So what: you say, Suruga? Won't you become an official member of our fleet?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Considering your exercise performance, you might get accustomed to life here even quicker than those girls from the development:ck. Hahaha!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You have plenty of time. Ponder it for a while and: what your heart says is right.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
