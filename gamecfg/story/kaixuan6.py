return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = -1,
			say = "Anyway, all you gotta: is hit 'em with your feelings! Use words for stuff that can be conveyed with words. Use your fists for all the stuff that can't!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = -1,
			say = "You have a point. There's no guarantee with this kind of stuff, but:n't you think it's better to express yourself than to keep your emotions bottled up?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
