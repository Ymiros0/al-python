return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.94}",
			say = "I never back:wn! Not from duels!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "L-let's cheer for both sides:! {namecode.94} you can: it! Z1～Fight!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "You:n't take school seriously! I keep getting complaints about you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
