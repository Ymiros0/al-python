return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Aha,:ne with work~ Sooo tired~ Hurry up and come give me a massage~♪",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Concord, who has a tendency to wear her heart on her sleeves, certainly shows no intention of:ing any actual work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehe, sit:wn already~ As a reward, Commander, I'll also give you a shoulder rub~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
