return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "How many times: I have to tell you, I'm the elder sister! Address me accordingly!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Jeez, if you:n't show some restraint in your snacking, you're soon going to need a new wardrobe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm~:ing anything requires willpower, and Concord's determination to fill up with more sugar is certainly awe-inspiring!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
