return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Eating the same thing that someone else made every day... who is to say that won't get stale as well? What: you think?",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "How about this~ I'll learn to make sweets as well, and: Commander can try some!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I will cheer for you! If you: a good job, I'll only eat your snacks for the next year!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
