return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now if you'll excuse me, let's begin today's work. Shall I start by organizing your:cuments?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(I'll follow the commander's instructions and organize all the:cuments into their respective files.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(I lean:wn to pick up the fallen object, and that was when...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
