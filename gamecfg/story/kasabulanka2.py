return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "(Compared to when I first began my secretary work, the location of the supplies and:cuments in the office had become almost second nature to me.)",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, I knew it! I can tell from your:pey expression that you forgot all about it! You did this last time, and the time before as well! Forgetting all about me because of your work!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "P-please calm:wn. What's the matter?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know... Can't: anything about that, but— Commander, please make sure you remember next time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm very sorry. As the secretary ship, please allow me to offer my apologies instead. I hope it will be enough for you to calm:wn?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "A-anyway,: you understand how serious this is?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
