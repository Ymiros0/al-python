return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Actually, why was it so hard for me to just say something nice back, like \"you've been:ing a great job\"...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now:, that's all the work finished for the day. Commander, you'll have an early start tomorrow morning, so make sure you go to bed on time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Come in, the:or's not locked—",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
