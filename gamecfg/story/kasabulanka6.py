return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "(I was helping Commander record:wn the things that had been discussed, based on our reference materials. Before I knew it, it was already late at night.)",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(I guess I ended up:zing off while thinking about Commander because I had been working so hard...)",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "This won't:... I'm still at work...",
			action = {
				{
					type = "shake",
					y = 0,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(In my panic, I spun around and caught my foot on something, and I felt myself going:wn– Suddenly... I felt myself being tightly hugged in Commander's arms!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
