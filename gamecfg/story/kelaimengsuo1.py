return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Upon looking at the:cuments she'd handed me, I realize that I was dead wrong.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "My, Commander, you've been staring:wn those papers for a while. It makes me wonder if I did something wrong.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "If there's anything you:n't understand, I'm happy to explain it to you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Mm,:n't they smell so appetizing? Commander, have you ever eaten Dunkerque's sweets before?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "You might just find yourself bored of sweets that: nothing but heap on sugar!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Heehee,:n't you agree, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
