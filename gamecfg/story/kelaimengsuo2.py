return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_103",
			hidePaintObj = True,
			say = "(But I still:n't feel comfortable leaving her alone in my office. I hope nothing bad has happened in my absence...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 904010,
			say = "Clemenceau,: you think crème brûlée and macarons are a good combination for the party? Or would Mont Blanc and chocolate muffins be better?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "If it's to go with coffee,: you'd want to base it on the type and recipe of the coffee.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Nothing explosive, please. We:n't want to turn the tea party into a fireworks show, now,: we?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll help decorate the venue, too! ...Is there anything I can:, though?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Heehee, I'm kidding. This is trivial, really, so it:esn't affect my secretary ship work.",
			painting = {
				alpha = 0.3,
				time = 1
			},
