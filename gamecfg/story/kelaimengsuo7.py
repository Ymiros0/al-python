return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_521",
			hidePaintObj = True,
			say = "After that, Richelieu took them back to the cat café, and Jean Bart's sister ships got her to go back to the Iris:rm.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Well, I:n't like having to share the things I care about...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "It can't beg others for affection, and I:n't want anyone touching it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "After all, if I'm to give it all of my love,: I want that in return.",
			painting = {
				alpha = 0.3,
				time = 1
			},
