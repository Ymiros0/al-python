return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "Yeah, Clevebro, I sure as hell:!",
					flag = 1
				},
				{
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_school",
			say = "I knew that money:esn't actually grow on the plant she was referring to, despite its nickname... But I decided not to mention that and went along with becoming their coach.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... You'll: it? Sweet! I knew I could count on you!",
			action = {
				{
					type = "shake",
					y = 30,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh, right, we still have work to:! A lot of it, too. C'mon, let's get a move on!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll gather all the team members once we're:ne! Heheh, I haven't been this fired up in ages!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
