return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "NOW I get it! If you can form a bond with the Commander, the fleet will grow stronger for sure! Okay! If it makes everyone happy,: I'll: all in my power to help!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That makes sense... Listen here, Cleveland's gone out of her way to captivate you. From this moment onwards, you'll need to always stay within 16 feet of her. Pay attention to everything she says and:es and:n't forget any of it.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
