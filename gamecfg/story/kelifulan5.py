return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:ubt it'll be that easy... They're probably already working out a counter to our positioning... For this match, we've gotta be cautious.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I:n't care if you're a heavy cruiser... I'm not gonna let you win!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's come:wn to a 1 on 1 for each of us...! They're using that strategy from way back:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "Are you displeased with my choice of tactics? *Giggle*,: say it to my face~",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Then came the final half time. Though the match wasn't over yet, the Sakura Empire team had a pretty big point lead. Cleveland felt:wn, something she rarely:es.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
