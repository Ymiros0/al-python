return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Kent throws open the:or like the bundle of energy she is, while still somehow managing to deliver the proper polite pleasantries.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey! Commander,:n’t just stand there gawking, you’ve got work to: too! Come on!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heh heh~ I am a proper maid, you know! And I’m not even a little bit tired. Just tell me what to: next!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "...How: I put this? I guess I finally see the Kent I’m used to?",
			effects = {
				{
					active = False,
					name = "speed"
