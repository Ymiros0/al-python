return {
	...
	scripts = {
		...
		{
			say = "The first day may have seen a couple reckless accidents, but since: Kent has been handling her secretarial duties just fine.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "And honestly, with all the work to be:ne around here, she:es make things easier.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh, never mind! We’ve got way too much to: today! Call me if you need my help!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
