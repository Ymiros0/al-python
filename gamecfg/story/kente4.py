return {
	...
	scripts = {
		...
		{
			say = "With my work:ne, for the time being, I stretch and peer out the window to find a beautiful, sunny day.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "A walk every now and: is fine. I’ll head out with Kent.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You just happen to, eh? So what: you: here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It seems its curiosity spurred it upwards, and now it can no longer get:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "Getting the cat:wn will be no easy feat. We could get a ladder or something from Akashi...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Climbing a tree is a piece of cake for this Kent! Watch me get that kitty right:wn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
