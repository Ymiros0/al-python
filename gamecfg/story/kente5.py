return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don’t worry! I’ve almost got you! I’ll be there in a second,:n’t be scared―",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "Kent’s happy voice calls:wn from overhead, and the kitten in my arms meows softly, with apparent relief.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Truth be told, I: have a thing for felines, but I’m more of a tiger girl than a housecat one!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
