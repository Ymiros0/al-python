return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "...The missing page must be in with those:cuments she filed earlier.",
			effects = {
				{
					active = False,
					name = "memoryFog"
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "But I need this:ne today... I guess I have to go ask her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "There’s no way she’s actually got a pet tiger... right? With some apprehension, I drag myself to Kent’s:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Huh? A wild animal...? Oh! You:n’t mean this guy? !",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "My work’s still not:ne, and I’m already exhausted...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
