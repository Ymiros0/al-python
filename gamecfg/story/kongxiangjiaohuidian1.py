return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I can't wait to get out there and: some good work!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "Just:n't be reckless. Both of us might be a bit rusty after all this time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 408040,
			say = "Because if I go:wn, who else is gonna cover you?",:
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 408040,
			say = "And I swear, I'll lay:wn my life for you if anyone tries to hurt you ever again!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 408040,
			say = "Alrighty:, I'll scout ahead for now! Please follow my lead!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_unnamearea_1",
			hidePaintObj = True,
			say = "U-556 sailed ahead of her eagerly, sometimes looking around, other times dipping into the ocean before leaping out like a:lphin.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 205010,
			say = "In the meantime,:n't use the Tower of Midgard under any circumstances. Is that clear?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "(One thing is clear– we can't afford to let our guard:wn.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_unnamearea_2",
			hidePaintObj = True,
			say = "Dark clouds covered the seas, with distant thunder rumbling now and:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "Sure, but what are you afraid of? We already took:wn Compiler.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "Dammit... Then,:... Make a break for it while I cover you!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "Look, you:n't have to console me. I've already come to terms with my greater purpose...",
			painting = {
				alpha = 0.3,
				time = 1
			},
