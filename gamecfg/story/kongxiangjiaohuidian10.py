return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 405030,
			say = "So why even come here? What the hell: you want?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 405030,
			say = "What: you know?! You've:ne jack shit for us!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "It's True that I've made mistakes, and that I've let:wn my country and my friends. But, allow me to correct one thing–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "If you really did: it, I wouldn't hold it against you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
