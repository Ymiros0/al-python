return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_bsmre_4",
			hidePaintObj = True,
			say = "Everyone surveyed their surroundings. The scenery around them seemed slightly different, but without a:ubt, they were still inside the Mirror Sea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "Whoever is behind this clearly:esn't plan on letting us leave.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "Bismarck, is it just me, or:es it feel like something major shifted inside this Mirror Sea at some point?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "Let me get one thing straight: – Zuikaku, you and Gneisenau were the first to arrive, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Let's see... We went through the gate, used the:me projector in the control center, and fought a bunch of mass-produced ships...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "This is completely unlike any functionality of the Tower of Midgard we're familiar with in the real world, but the more pressing question is – what: those floating cubes:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Agreed. While my Geryon is able to offer some protection, I: not want to test its limits with your lives on the line.",
			painting = {
				alpha = 0.3,
				time = 1
			},
