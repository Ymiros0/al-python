return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 9708010,
			actorName = "U-556 META?",
			say = "The Parzival of the Seas still has important things to:, so stop wasting my time!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Looks sort of like her, but she sure:esn't SOUND like her.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "Without a:ubt, that's a telltale sign of METAmorphosis.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "I'm not sure. Geryon is able to absorb external sources of corrosion. If her hull has already been corrupted, I'm afraid there's not much I can: about that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "(From what Scharnhorst and Gneisenau have told me, the symptoms of METAmorphosis, namely changes in power and external appearance,: not necessarily reflect the degree of corrosion.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "They've got U-556 surrounded! Even a META:esn't stand a chance against this many of 'em!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "What's she:ing? Did her memories get wiped by METAmorphosis or something?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704010,
			say = "That's not the issue. She:esn't seem to have the ability to distinguish friend from foe at the moment. The more aggressively we intervene, the more likely she'll see us as enemies.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "What: we::? We can't just watch while she gets blasted to pieces!",
			painting = {
				alpha = 0.3,
				time = 1
			},
