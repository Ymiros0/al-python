return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_bsmre_4",
			hidePaintObj = True,
			say = "Her attack neutralized, U-556:ve back beneath the waters.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_bsmre_4",
			hidePaintObj = True,
			say = "At Bismarck's command, the steel beast reluctantly stood:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "No. You saved me,:n't you remember?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405030,
			say = "Bismarck, we're:ne on our end.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "But, she still:esn't look like she used to.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "U-556... Unless absolutely necessary, I:n't want you fighting at all until we return to the Floating Fortress.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = True,
			say = "I mean... If you're sure,: I'll: as you say!",
			painting = {
				alpha = 0.3,
				time = 1
			},
