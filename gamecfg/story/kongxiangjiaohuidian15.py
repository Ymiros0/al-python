return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Thiiis...:esn't look like the Fortress.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_bsmre_5",
			hidePaintObj = True,
			say = "They all looked around. While a few details had changed, they were, without a:ubt, still trapped in the perplexing Mirror Sea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_bsmre_5",
			hidePaintObj = True,
			say = "Two helix-like pathways spiraled through the city, reaching:wn towards the Tower of Midgard's gate.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405030,
			say = "The tallest building... Why:es it seem like I've seen it before?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "That:esn't tell us anything at all. Can you try taking a picture of it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "It's worth a shot, but:n't expect anything.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			say = "Lord Bismarck,: you think we should all split up?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405030,
			say = "That's what I was gonna: anyway.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Whatever you:,:n't intervene, and:n't get too close.",
			painting = {
				alpha = 0.3,
				time = 1
			},
