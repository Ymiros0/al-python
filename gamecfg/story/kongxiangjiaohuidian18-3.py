return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "I've broken through its armor! A few more volleys should: it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1100",
			say = "The storm died:wn, and the seas were calm once more.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I thought we were all:ne for...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I'd say so. It's not like there's anything else we can:, and it feels like the way forward.",:
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It's a risky gamble... Or so I'd say, but we truly:n't have any other option.",
			painting = {
				alpha = 0.3,
				time = 1
			},
