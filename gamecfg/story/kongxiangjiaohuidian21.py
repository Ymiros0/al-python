return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704010,
			say = "Please, there's no way it's me. Surely you:n't think Bismarck would bring up this subject as a joke?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704010,
			say = "Besides, we all have our own unique signals, so I have no way of recognizing someone I:n't know.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704010,
			say = "You have those fancy beacon trackers,:n't you? I reckon you'll have better luck using those than asking me for help.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "This was kind of an emergency operation, and META beacon trackers:n't exactly come cheap...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "Huh? You baked a beacon tracker into Geryon on top of all the insane stuff he already can:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "Argh... I'm so JEALOUS... But also so impressed at the same time!! Write that:wn, Regina!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704010,
			say = "Unlike us, they:n't care about collateral damage. They would have no issue with razing the whole tower should it stand in their way.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll: it. Just give me the order.",
			painting = {
				alpha = 0.3,
				time = 1
			},
