return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "What shall we:, Bismarck? Run for our lives?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "(These things seem to be able to materialize hull-corroding attacks. I:n't want to push my luck with them twice.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "Ulrich, take command. Bombard them to slow them:wn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "And what are you planning to:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Good boy. If you're worried about me,:n't be.",
			painting = {
				alpha = 0.3,
				time = 1
			},
