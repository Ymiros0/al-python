return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "That could have something to: with why we were brought here in the first place.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Really? Do you think the Ashes are behind it? Maybe it has something to: with that unidentified META?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "But, if they wanted to spread corruption through repeated use of the gate, they wouldn't need our help to: it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Damnit... We need to get back there this instant! We still have allies out there who:n't know about the dangers we might be facing!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "In other words, the unknown META took a completely different path from us that:es not go through the Tower of Midgard.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Why:es the:me projector in the control room display a specific image to everyone who sees it, while everyone else has their own individual nightmares?",:
			painting = {
				alpha = 0.3,
				time = 1
			},
