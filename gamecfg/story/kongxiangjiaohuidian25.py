return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_bsmre_cg11",
			say = "The two stepped into the command center. The projector:me's surface still continued to reflect the annihilated Iron Blood fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_bsmre_cg11",
			nameColor = "#A9F548FF",
			say = "The third one with Friedrich is the odd one out. If anyone else here had seen it on the:me, they'd immediately dismiss it as fake.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_bsmre_cg11",
			nameColor = "#A9F548FF",
			say = "Alright:. Don't get yourself killed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
