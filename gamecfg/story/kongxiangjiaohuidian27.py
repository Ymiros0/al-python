return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xiangting_0",
			say = "Bismarck signaled for Geryon to stand:wn, approaching the girl alone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Good, we're on the same page:. How: you plan to get out?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "I:n't have a plan, at the moment.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "My allies would surely know what to:, but on my own, I'm helpless.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "Indeed I am. I wish I could tell you where Friedrich is, but I: not know.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "*sigh*... We only just figured out this place is structured like an hourglass. Back:, we didn't know it was important.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "I thought only Helena could: something like that...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "If you can analyze the structure of an illusion,: the illusion itself can be considered a pathway of sorts.",
			painting = {
				alpha = 0.3,
				time = 1
			},
