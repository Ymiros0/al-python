return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Are we still dreaming? This:esn't feel real to me...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "Yes. I:n't know why she's here, but it's a very bad sign.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = True,
			say = "We:n't know for sure, but we have to work under the assumption that she:es.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = True,
			say = "In the meantime, I'll: whatever I can.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "As for why she'd: that, I cannot say. All I know is, she's causing damage to The Hermit while the latter is pinned:wn by the Ashes.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "Maybe that has something to: with The Devil's current condition...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "Well, no... Like you said, it just means she:esn't consider you a serious threat.",
			painting = {
				alpha = 0.3,
				time = 1
			},
