return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ulrich, gather everyone. I'll explain what we're going to: next.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 401990,
			say = "In fact, it:esn't seem like either of the two have plans on annihilating us.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "As much as I:n't like the idea of running with our tails between our legs, I'll: anything to get out of this place.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "That said, I:n't think we can just walk out. Her aircraft will still pose a threat to us.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "One quick thing before we: that. Could you examine this one?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = True,
			say = "Okay,: listen. We're still in danger and need as many of us fighting as possible.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a020f0",
			say = "Are you sure you want to: that?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "Okay. I'll: what I can, but if you push yourself too far, there's no going back.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			actor = 9712010,
			say = "You need to promise that if Bismarck or I order you to stop fighting, you will: so at once. Is that clear?",
			painting = {
				alpha = 0.3,
				time = 1
			},
