return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I've lost quite a few aircraft, but you:n't see me throwing in the towel already.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Even if they were standing still, we've still got to:dge their attacks! We can barely land a hit on them!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			dir = 1,
			say = "Are you sure we should: this, Bismarck?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9712010,
			dir = 1,
			say = "But what if this is exactly what the Sirens want us to:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 405050,
			dir = 1,
			say = "Before you can make a decision, you need to overcome your fears and:ubts.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "The old me would try to carry the weight of the world, unwaveringly following the path she believed in, even if she had to: it alone.",
			painting = {
				alpha = 0.3,
				time = 1
			},
