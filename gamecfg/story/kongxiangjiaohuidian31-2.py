return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 405050,
			dir = 1,
			say = "U-556, listen! Go underwater and:n't resurface until I tell you to!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			nameColor = "#A9F548FF",
			side = 2,
			say = "It:dged the first shell with a backstep, and the second hit the water behind it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 405050,
			dir = 1,
			say = "I'm:ne playing games with you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
