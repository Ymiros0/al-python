return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_bsmre_cg12",
			nameColor = "#A9F548FF",
			say = "(But, to: that, she has to split up computing resources among not just her own Enforcers, but The Hermit's as well.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_bsmre_cg12",
			say = "Streaks of light: appeared all across its steel body.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			say = "Everything came:wn to these final, ultimate attacks.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
