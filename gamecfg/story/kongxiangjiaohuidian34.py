return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhuiluo_2",
			say = "A sea dyed deep red. This battlefield had become a grave shipyard – the final resting place for:zens of smoking wreckages.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Enterprise META",
			say = "We're:ne on our end. All of you, give me a status report.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			actorName = "Arbiter. The Hermit IX",
			say = "Should've figured. You Ashes have absolutely no idea what you're:ing.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Enterprise META",
			say = "\"You can't: anything without Zero's express permission.\" That's what you're thinking.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Arbiter. The Hermit IX",
			say = "All you'll: is create one more thing that wants you dead.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Arbiter. The Hermit IX",
			say = "What?! What are you going to: to it?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Enterprise META",
			say = "But, that was:. I've changed my mind.",
			painting = {
				alpha = 0.3,
				time = 1
			},
