return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "What: you make of this, Regensburg?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = -1,
			nameColor = "#A9F548FF",
			say = "It:esn't make any sense. Having the gate be accessible is crucial for logistics and evacuation. Ulrich should be well aware of the dangers of messing with the gate's location.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "(We:n't have much of a lead to work with except these undecipherable coordinates, and the fact that three people are missing.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "We obviously:n't have anything of the sort around our Tower of Midgard.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "That's right. We still:n't know the full extent of what Mirror Seas are capable of.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 402100,
			say = "But, no point in speculation. What: we: next, Bismarck?",
			painting = {
				alpha = 0.3,
				time = 1
			},
