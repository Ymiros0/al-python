return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "I:n't know, but I have a theory.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405050,
			say = "When I sank following the battle with the Royal Navy long ago, she:ve into the water to save me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_bsmre_2",
			hidePaintObj = True,
			say = "Just:, the vivid imagery of U-556 just before she disappeared beneath the waves flashed through Bismarck's mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
