return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "I:n't need to think or feel. I need only destroy my enemies.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhuiluo_2",
			say = "U-556 ignored Gneisenau. She:ve beneath the waves once more, heading straight towards a light in the distance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "The Tower of Midgard? That can't be... It:esn't exist in my branch...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "I've already rediscovered my reason to fight... So I:n't have time to waste on these illusions!",
