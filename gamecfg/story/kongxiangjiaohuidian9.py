return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9704010,
			say = "Don't mention it. I only did what needed to be:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I mean, I haven't:ne anything worthy of thanks yet...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Uhh,:n't think so? We had our hands full with the Sirens.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That makes sense... Energy:es dissipate as it travels, after all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			actorName = "Gneisenau META",
			say = "Bismarck, you feel it too,:n't you? The aura coming from the control room is making my stomach turn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Gneisenau, take the others away from the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Wait outside the:or. No, just to be safe, at the end of the corridor. I'll handle this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Stick together. I'll call you once I'm:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
