return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hmm... I: hope this is a figment of me still being half-asleep. Because if not, it would mean I now find myself in quite a conundrum...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "These buildings are made of a material I: not recognize. Similarly, their architecture is foreign to me as well...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "No, that's preposterous. I:ubt any alchemist has the skill to transport me across worlds without me noticing.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hmm... Perhaps the place I chose to rest just so happened to be a:or between realms?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "Okay, it's not like I had NOTHING to: with you ending up here... but 99% of it is Tester's darn fault!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hrm. Judging from the state of this battlefield, you:n't seem to be lying. I will trust you for now.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Very well. A different question,:. You mentioned \"the rest\" a moment ago. Do I take that to mean there are others you've involved in this situation besides myself?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			actor = 900233,
			nameColor = "#A9F548FF",
			say = "Why: you sound more annoyed than scared? Most people dropped in the middle of a war zone would be having a panic attack by now.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			nameColor = "#A9F548FF",
			say = "Sure... but that's easier said than:ne. First, you aren't going anywhere until we clear out Tester's forces. Second, the other folks will be in a whole lot more trouble without you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Urgh... Seems like I: not have much of a choice:. I suppose I can treat this as an unplanned adventure and lend you my strength.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "Okay, first things first – hop on my rigging. I'm gonna take you to my base and get you kitted out. You:n't stand a ghost's chance against the Sirens without some gear.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
