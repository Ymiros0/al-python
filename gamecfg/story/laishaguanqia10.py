return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "Alright, that was easy. Let's head to the next island while the Enforcers: their thing.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "Wait. What are these humanoid creatures:ing? I thought you said you'd leave this site alone?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "If I:n't, the next people who come through here are gonna meet one gruesome fate or another.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "Oho. How considerate of you. What of the boxes scattered about the site,:? Are they part of the cleanup as well?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Well, the synthesis was a success... at least as far as I can tell. Serri, Lila, what: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900040,
			say = "It feels like a set of armor and a weapon in one, yet it:esn't weigh me:wn whatsoever, almost as though it's an extension of my body.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Finding out the truth is what I:! And I have a feeling it's gonna make a helluva scoop!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Oh yeah? You wanna throw:wn the gauntlet and see who is better at it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Why? You're neither a journalist nor an investigator. Do you have some secret skill I:n't know about?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Ah, like a sleuth who's in and out of the field in a flash. You're on! Let's see what you can:, detective Shimakaze!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "Wait a sec! There could be traps along the... Ugh, why: I even bother...",
			painting = {
				alpha = 0.3,
				time = 1
			},
