return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Hey, is it just me, or:es the sky look... off?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "How:es that work? Is there a magic barrier of some sort?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "Why they'd: that, I can't imagine. Whatever their reasons, the fact remains that Siren ruins are rife with danger.",
			painting = {
				alpha = 0.3,
				time = 1
			},
