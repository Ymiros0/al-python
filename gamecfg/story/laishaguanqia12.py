return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301290,
			say = "It:esn't help that this whole place is booby-trapped!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Created by Ingraham, this capable little bot has accompanied me on hundreds of missions. You can count on him to get the job:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "Well, that's convenient. I'm in favor of letting Bristol deal with the treasure chests while the rest take a break. What: you all think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
