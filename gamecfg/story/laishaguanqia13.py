return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "You think the Oren have something to: with these ruins? Like maybe they made contact with the Sirens long, long ago?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900040,
			say = "I seriously:ubt that. Serri and I have never been here before, and neither has anyone else of our kind as far as we know.",:
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101490,
			say = "That is, until one day... when a meteorite came crashing:wn from the sky!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "If we assume you're correct,: where: the Oren fit into the picture?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101490,
			say = "Since we know they:n't like alchemists, they scattered the recipes all over the place, erected a monument, and: went back to their home world!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900040,
			say = "I can see where you're coming from, but without riggings, I seriously:ubt even the Oren could simply wipe out a fleet of Sirens armed to the teeth.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The monument and alchemy recipe:n't sit well with me, either. Even presuming that the Oren left them behind, who in the world could have prepared them beforehand?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "While we've put this conversation aside for this moment, why:n't we return to the Land of Beginnings for the time being? This was a battlefield, so there's no telling what might explode at any given time. It would be dangerous to remain here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
