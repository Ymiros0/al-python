return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "We:n't want something going WAY wrong and destroying the transporter before the others get here. That'd be catastrophic.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "Hrmmm... I:ubt it will have the intended effect.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "Say what?! You're not saying this stuff wouldn't scare them, are you? Then... Fine! I'm:ubling the firepower!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301290,
			say = "Okay, so we found our third key. But, uh... We still:n't know where the \"Desolate Capital\" is,: we? How will we find the last one?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "If \"breaching the towering barrier\" means opening some kind of:or,: that means we can open three out of four:ors now, yeah? That just leaves one.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "And if the Mirror Sea belongs to the Sirens, why: we have to be nice and use a key for every single:or? I bet we could blow that last one away with cannon fire.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "(Do we have the numbers to attack the Sirens' central hub head-on? I have my:ubts.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "You could say that... But we:n't have any other leads. I will take the vanguard; let us investigate the Siren island to the north!",
			painting = {
				alpha = 0.3,
				time = 1
			},
