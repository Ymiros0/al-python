return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207050,
			say = "Everyone, be careful. My recon plane was immediately shot:wn after it flew through the barrier up ahead.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "I'm thinking about the, well, \"door\" over there. It:esn't look like any old:or you just open with a key, more like a big obstacle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301290,
			say = "We've come this far – I see no reason to worry about any barrier! All we need to: is circle around it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
