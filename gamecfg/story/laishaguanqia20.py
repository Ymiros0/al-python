return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301290,
			say = "As: I! Please let me come along!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207050,
			say = "*sigh*... Alright, I'll: a slow takeoff. Please:n't: anything reckless, like firing your cannons from the air.",
			painting = {
				alpha = 0.3,
				time = 1
			},
