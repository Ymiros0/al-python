return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Gotcha. I'll just kick back for a while: start making dinner!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "How:es the rigging feel, Klaudia? Anything look wrong with it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "As:es whoever made these recipes. My hat's off to the person who came up with equipment that has both stellar form and function.",
			painting = {
				alpha = 0.3,
				time = 1
			},
