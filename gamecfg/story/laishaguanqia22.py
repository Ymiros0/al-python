return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "If you decide to join forces with the great and generous Purity,: you'll be able to keep your current powers.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "Whaddya say? You get this sweet resistance badge, and we can destroy all of Tester's stupid experiments together. Sweet deal,:nt'cha think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "But the principle behind all this has nothing to: with dreams, correct?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actorName = "Purity",
			say = "Though... If you just want proof of your adventure here, I can make it so you:n't forget everything entirely.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "A treasure remaining in my memories, hm? That:esn't sound bad at all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But I: have one question. Was it True when you said that the flow of time here differs from that of my own world?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "So, a girl's got stuff to:, but weren't you in a hurry to get home? I can send you back first.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "If you're busy,: tend to your own matters first. I'd like to take another look around before I leave.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "Really? Well, be my guest! I've activated the teleporter, and I left how-to instructions on the pedestal there. It's easy, so: it yourself if you wanna.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Heheh. Yeah, I figured out what to: with them. I made this!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "...So all that's left to: now is reach the control center,: we'll be able to go home?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Whoa, I had no idea a rigging could: that! It's like having your own pocket dimension!",
			painting = {
				alpha = 0.3,
				time = 1
			},
