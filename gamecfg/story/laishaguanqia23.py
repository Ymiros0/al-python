	...
	scripts = {
		{
			...
			bgName = "bg_ryza_2",
			stopbgm = True,
			say = "The girls inserted the keycard into a device on the barrier's:or, causing all Siren defenses in the area to halt operation. On the other side, a long path across the surface of the water revealed itself.",
			bgm = "ryza-az-theme",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Don't take that for granted. Even if their mind-blowingly strong defenses shut:wn, I guarantee you there's a Siren hiding in ambush somewhere.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We're all in this together, and if you want to go exploring,: I guess we could take a brief detour.",
			painting = {
				alpha = 0.3,
				time = 1
			},
