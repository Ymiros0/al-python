return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "Hrmmm... But these riggings:n't seem like something that can be made through alchemy,: they?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "Once I'm:ne, I'll need you to divide the recipe and materials for five people's worth of riggings,: find places to hide them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
