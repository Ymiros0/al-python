return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "I just gotta make the salvage program handle the rest... There! Now, we can kick back until the recycling process is all:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Then is my job here:ne? I expect you to make up for your \"1% of the blame\" and send me back from whence I came.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "So if we leave without:ing anything, they're just gonna arrive at an empty patch of water with a portal sitting in the middle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Incidentally, what would you: if I were to refuse?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The island to the west is shrouded in purple woodlands, and the last island to the east seems to be:tted with metallic city ruins. Miss Ryza, have you managed to decipher that stone monument?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Basically, there are five islands in this archipelago, and the island we're on lies in the center. There's also a few hints that tell us what we have to:.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "First, we have to find hidden recipes, presumably alchemy recipes, spread out across the islands. Apparently we'll get new powers if we: that.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301290,
			say = "Bristol, Alfredo, let's all calm:wn here! After all, isn't the prospect of seeing real-life alchemy the most exciting thing of all?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I made those myself using alchemy. It's what I:, 'cause I'm a real, honest-to-goodness alchemist!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...Right, I said that earlier. I guess it:es sound ridiculous if you haven't seen it with your own eyes...",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Then why:n't you give them a demonstration with the cauldron we found?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well, I'd totally love to, but I:n't have any materials on me.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
