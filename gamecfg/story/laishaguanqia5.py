return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "This plant caught my eye. What: you think about it?",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Eek, a bug! P-please:n't bring it near me!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "(Wow, she's really jumping to conclusions here! Obviously, the Sirens just turned salt water into fresh water. I:n't know WHY they'd: that, but...)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "Ahem. I hate to rain on your parade, but:esn't this entire thing seem a bit TOO convenient to anyone else?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There so happens to be a cauldron fit for alchemy, a stone monument telling us what to: to get back home, and that's only the start of it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Granted, I:n't understand how alchemy works, but I seriously:ubt it can simply poof a rigging into existence. Even if it can, can we really trust this cauldron to work as Ryza expects?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305140,
			say = "...Well, what's:ne is:ne. I suppose we could conduct a performance test. Just please, try to be careful.",
			painting = {
				alpha = 0.3,
				time = 1
			},
