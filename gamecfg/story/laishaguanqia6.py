return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "A real tough customer, aren't you... Well, in any case, what are we gonna: with this next area?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "C'mon,:n't be like that. I could make it look like the place you're from. Whaddya say to that?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "I could restore it back to its lush, green state for you. How's about a trip:wn memory lane, huh?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "I: appreciate the sentiment, but all things created in this place are fakes, are they not?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "Purity",
			say = "You sure you:n't wanna see it? It'd be a piece of cake for me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900060,
			say = "I: not care. If you absolutely must create a forest,: keep what you have now. This has more atmosphere.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Purity",
			say = "Sounds good to me! Now the question is, what kind of monsters: I plop:wn? You need at least a LITTLE challenge for it to be a real adventure.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301290,
			say = "Well, why:n't we just split up and check all of them?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207050,
			say = "However, we: not yet know where this \"Desolate Capital\" lies. I presume the \"Central Foundation\" should wait until we've collected the keys, as well...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "How about we go for the grove first? If that's the Underworld we know,: it ought to be familiar.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101490,
			say = "Heheh, ruins are always teeming with secrets. Getting you back home is important, but:n't forget the pleasure of adventure!",
			painting = {
				alpha = 0.3,
				time = 1
			},
