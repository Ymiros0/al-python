return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "This place:es remind me of home.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101490,
			say = "They ruined people's homes... That's:wnright evil!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Hehe... All I'm:ing is using alchemy where it feels right, y'know?",
			painting = {
				alpha = 0.3,
				time = 1
			},
