return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Serri, what are you:ing in the grass?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "I:n't think her ability extends quite THAT far, but it's close.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "These plants are only replicas. I:n't feel anything from them. No life, no growth. It's hard to even call them plants.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "No,:n't go rushing in! It could be booby-trapped!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "I have to say, it's really convenient that they wrote:wn all the items we need again.",
			painting = {
				alpha = 0.3,
				time = 1
			},
