return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That:esn't mean this'll be a walk in the park though, nya. I'll probably run into Sirens going to and from this place, nya. I'll need to hire bodyguards, nya...",
			painting = {
				alpha = 0.3,
				time = 1
			},
