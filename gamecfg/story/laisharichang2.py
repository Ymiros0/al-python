return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "But until:, at least we have roofs over our heads and three meals a day, courtesy of the port cafeteria and the Commander!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Hope we:n't come at a bad time!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Welcome to my (temporary) atelier, Alfredo! I:n't think I've met your friends before. Are they your fellow Sardegnians?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "Besides, we've got work to:, Miss Alchemist...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "It's no wonder Ryza:esn't know... Hehehe... See, we wanted to ask you for a favor...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Besides, I've wanted to make something out of the heaps of new ingredients I've discovered since I arrived here... So that's what I'm gonna:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "So... the things you wrote:wn can make bombs if they resonate with each other...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Only problem is, I:n't have any ingredients yet since I just set up my atelier. On that note, wanna come with me and look for some?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "Sure, we'll come along. You're:ing us a favor, after all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "And if you need a guide, I'm your girl! Nobody knows the port's secret spots like I:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "This is a good chance to make Torricelli catch some sunlight, too. Why:n't we head out right away?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900010,
			say = "Nice work, everyone! Now it's finally time to: alchemy!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "So,: you reckon this is all the bombs you'll need?",
			painting = {
				alpha = 0.3,
				time = 1
			},
