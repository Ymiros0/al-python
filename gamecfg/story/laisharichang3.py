return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well:, Choukai... Show me what you've got.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Lunch? Why, thank you! Are you sure you:n't want to eat with us?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I've got business with her, nya. We'll join you after we're:ne talking, nya.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900040,
			say = "What: you want, Akashi? It must be important if it's in private.",
			painting = {
				alpha = 0.3,
				time = 1
			},
