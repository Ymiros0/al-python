return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_unnamearea_1",
			say = "Once the smoke clears, the Sardegnian girls lay eyes on a hot spring bigger than their wildest expectations. They: catch sight of a familiar figure...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We're excavating a hot spring and were just about to set off the TNT we'd put:wn, nya.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900020,
			say = "I heard about it through Ryza,: I thought helping you all out would be a way to repay you for all your help.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900020,
			say = "You're welcome. Having said that, I:n't think my help alone will be enough. We'll need some more people to get all the additional supplies...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102090,
			say = "The Knights of the Sea, a.k.a. the Cleveland class is here too! Hope you:n't mind us helping out with your cool project!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Hey,:n't forget about us! We're the ones who found this spot in the first place!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 10900020,
			say = "Heheh,:n't worry, we hear you. Now we should have all the help we're going to need!",
			painting = {
				alpha = 0.3,
				time = 1
			},
