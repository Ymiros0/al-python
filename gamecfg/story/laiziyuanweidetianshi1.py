return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "No. She simply came here on a whim, as she usually:es.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 902010,
			say = "I:n't! Respect my right to pray on my own terms!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "She shot glances in the different directions La Galissonnière and Le Terrible had left,: gave a parting prayer to the Iris sculpture.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
