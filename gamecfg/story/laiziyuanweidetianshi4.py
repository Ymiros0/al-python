return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If you truly got invitations,: why can't you head back to your rooms and fetch them?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 801030,
			say = "Well... the thing is, I:n't want to miss out on the pastries they're serving just for this party!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 801030,
			say = "It's a long way back to the:rmitory, you know? The pastries will be gone by the time we're back!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 801030,
			say = "I mean, what if you turn us away, suddenly become short-staffed, and: can't treat your dear guests properly? That'd be terrible!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 801080,
			say = "The Cardinal gave me explicit orders – any who wish to enter must present an invitation! So: you have an invitation or not, Le Téméraire?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 801030,
			say = "I:n't, but I promise I can give the guests the party of their lives! Please, you have to let me in!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...What in the world are you people:ing? Are you trying to make us look bad?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 907010,
			say = "Very well,: I will wait for them inside. Here is my invitation.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
