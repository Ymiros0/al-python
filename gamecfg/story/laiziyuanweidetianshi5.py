return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 802020,
			say = "Of course. Those two girls:n't exactly have indoor voices.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I see, I must've come at a good time:. The Holy Iris guides us in all we:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 907010,
			say = "Will the words that have been spoken behind closed:ors remain the same before the Queen's presence?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
