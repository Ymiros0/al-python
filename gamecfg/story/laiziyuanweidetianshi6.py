return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Having said that, as a member of the Royal Maids, I: have immense pride in our desserts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'll: just that. Enterprise, let's head over right now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_115",
			say = "Joffre savored the cookie she was given,: noticed Howe was staring at her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205090,
			say = "Thank you very much! Now,:n't mind if I:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205090,
			say = "Alright:! I'll be waiting tomorrow at the mansion we're staying at.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
