return {
	...
	scripts = {
		...
		{
			say = "Once the party came to a close, the Royal Navy guests headed for the mansion they'd be staying at. Joffre, meanwhile, was about to leave for the Iris:rmitory.",
			side = 2,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's gotten late. I will walk you to the:rm.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I: appreciate the thought, but I can walk there myself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If you say so... You should: the same.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_iris_night",
			say = "Back at the:rmitory, a girl kneeled in a room bathed in moonlight.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 907010,
			say = "A meeting, I see... That must mean there's more \"work\" to:. I'll have to save the cookies for after that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
