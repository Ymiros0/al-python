return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "She rigged my:or with some kind of contraption before she left. I wonder what that's about.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "Oh, you have a blow dryer ready? Okay,: on second thought, by all means.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Please:. Sara's pranks must be relentless for you to keep a blow dryer lying around the office...",
			painting = {
				alpha = 0.3,
				time = 1
			},
