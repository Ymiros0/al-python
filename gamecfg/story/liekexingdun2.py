return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"Now and:, in my spare time. Say, have you ever wanted to swap roles with Saratoga? As in, be the little sister instead?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I'm... I'm planning my next concert, and I:n't know what kind of performance it should be.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "But I:n't want to base everything on numbers, or I feel like it'll cease to be my concert, my music.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "Luckily, I know someone who can: the number-crunching for her. It would also: her some good to take a day off and clear her mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "You think that'll solve it? Hmm... If it:esn't work out, at least we'll spend a day together.",
			painting = {
				alpha = 0.3,
				time = 1
			},
