return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "After a moment's hesitation, Lexington knocks on the:or leading to a quiet room.",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Come in. I wasn't expecting visitors today, so I:n't have– Oh! Commander and Lexington! Hi there.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yeah, it's the proof to Bulschwartz's None-point problem. I'm nearly finished with it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh, pardon my math jargon. It's fine if you:n't understand. Anyway, you two came at the perfect time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Thank you. But: I really look THAT under the weather?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Although, she didn't give me specifics, so I just assumed you coming here has something to: with your problem.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Princeton quickly jots:wn something on her notepad,: rips the sheet off and folds it up before handing it to me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "This insight is all I can give you. The Commander and other people will need to: the rest. Sorry.",
			painting = {
				alpha = 0.3,
				time = 1
			},
