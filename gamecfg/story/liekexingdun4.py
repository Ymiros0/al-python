return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Lexington and I take a stroll:wn the port's main road.",
			bgmDelay = 2,
			bgm = "story-richang-1",
			flashout = {
				black = True,
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "I again check the note I received,: weigh our options on what to: next.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "It's only a probability, not a guarantee that people will like it. But I:n't feel like that's fully solved my problem...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_165",
			say = "As soon as we step through the:or, we're greeted by a strange sight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "But WE should be helping her cook! Having a machine: it is so boring! And I need an excuse to get up to kitchen hijinks, but that's unrelated.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "But the food:es taste the same... So what actually matters...",
			painting = {
				alpha = 0.3,
				time = 1
			},
