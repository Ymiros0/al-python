return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "With your help, this will be:ne in a flash.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "She opens the:or, and to the surprise of us both...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "But why? I said I'd: it myself...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I mainly: background work these days. It makes everyone else's job easier.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Since they're the ones:ing the hard work of creating a wonderful performance, it's only fair that I take care of the little things.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Hm? I:n't remember this being here...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403070,
			say = "Ugh,: I really have to say this? Fine... Ahem! We'll take care of the small stuff. You just focus on enjoying yourself! Got it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#A9F548FF",
			say = "I'll only forgive you if you: two things – lay off the work, and bring the Commander to the concert!",
			painting = {
				alpha = 0.3,
				time = 1
			},
