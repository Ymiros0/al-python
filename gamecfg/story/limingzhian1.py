return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Certainly. Even I long to prove my worth on the battlefield every now and:, hehe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Fiiiiine, though I:n't see why it matters since there's nobody else around... Well, let's move on:!",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You really:n't plan on telling me anything, huh? Well, fine, I didn't want to know anyway!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900218,
			nameColor = "#a9f548",
			say = "Good day, comrades. I assume that after reading the contents of our next operation, some:ubts may linger on your mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900218,
			nameColor = "#a9f548",
			say = "Due to the importance of the situation, some details could not be adequately put:wn into text, hence the purpose of this call. If you have any questions, feel free to ask me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Alright... If that's the case, how: we know so much about this facility?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That makes sense. I'll leave the complicated political stuff to you:, Soyuz.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900218,
			nameColor = "#a9f548",
			say = "Frankly... We:n't know exactly what \"it\" is either.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...You:n't know? What: you mean by that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900218,
			nameColor = "#a9f548",
			say = "Good luck. I'll be ending the communication:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't think I've ever seen Soyuz look unsure of herself before. Guess there's a first for everything.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
