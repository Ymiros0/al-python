return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Pamiat', how much: you know about that \"failed\" Polar Expedition?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Probably nothing that you:n't already know. Even after all our hard work, we went home empty-handed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But when we tracked:wn the signal, we couldn't find any trace of the ship that had sent it. No signs of movement, no wreckage, nothing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Since:, that expedition has remained buried under a mountain of:cuments as a \"failed\" operation. Only recently has it been dug back out.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yeah, that:es make sense! Anomalies can occur inside a Mirror Sea even in the absence of Sirens, and...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wait a minute,:esn't that mean that whatever device sending the junk signal is still in operation somewhere?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
