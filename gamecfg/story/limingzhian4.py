return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "???",
			say = "If you want to find out what happened, you'll have to: the rest of the work yourself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "As long as the Naval HQ:es not cease their actions, an agreement between ships only carries so much weight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "???",
			say = "But, there is something we can:. Not through Reenactments, but through our power. And the Commander's power.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_italy",
			say = "After the communication ended, Soyuz remained silent for a few seconds...::zens of seconds.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
