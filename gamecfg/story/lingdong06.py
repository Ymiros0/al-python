return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "Tsk... I:n't have time for you little worms! I have more important things to:!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Understood. But, I would wager that she's bluffing and will turn to attack the convoy soon enough. How soon: you think you can affect repairs?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
