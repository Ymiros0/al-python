return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Hmm, so it's just like back: with the Z Fleet... Giving her even more power:esn't affect the outcome.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "And if \"she\" gets in the way... Ahaha, well, you already know what to:.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
