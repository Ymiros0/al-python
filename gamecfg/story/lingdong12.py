return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "I can't connect either... The situation is the same as in the Mirror Sea... We'll need to make: on our own...",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It:es. We've already gotten this far, so we should pay a visit to this \"Lone Queen in the North.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
