return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#D6341DFF",
			dir = 1,
			say = "... This has nothing to: with you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purifier",
			dir = 1,
			say = "Now now,:n't go anywhere! I just did the calculations, and if this massive singularity were to collapse, half of the entire Northern Parliament would go poof!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			actorName = "Purifier",
			dir = 1,
			say = "If you insist on continuing anyway...: I will use all the tools I have available to me as a subprogram to stop you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She... shot:wn all my Corsairs?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purifier",
			dir = 1,
			say = "Ahaha~ Calm:wn, lady. There's no point chasing after her anyway. And in case you forgot. I'm your opponent here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
