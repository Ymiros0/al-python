return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Purifier",
			dir = 1,
			say = "Listen here! We, the Sirens, are your enemy! We are the big bad meanies who take your oceans as our own! We are the ones who cause all the wars in the world! And:n't you forget it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Purifier",
			dir = 1,
			say = "Next time we meet, I'll have an even more powerful weapon for you guys! Until:, stay alive and get stronger for me! Hahahaha~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That settles it:. We can go home now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#ff0000",
			say = "So you had Victorious' planes shot:wn to lure her in... Well planned.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
