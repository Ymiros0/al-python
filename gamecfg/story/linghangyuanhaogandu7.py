return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Hey, I'm just:ing my duty as your guardian.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You heard me correctly! If you:n't tell me, I will run away from home right now!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Don't be modest! I'll: anything to make your wish come True, no matter what it is!",
			painting = {
				alpha = 0.3,
				time = 1
			},
