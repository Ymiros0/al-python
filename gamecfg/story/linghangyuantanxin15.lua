return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "Good... Uh, why are you staring at me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "Oh. You're spoiled, is what you're saying.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "Alright, then I'll cook dinner for you, my hardworking princess. I'll fry you an egg for extra nutrition, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
