return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "While I can describe what a personality is, I: not understand where a so-called personality comes from.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Just:, a daring idea crosses my mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900284,
			say = "Digital assistants such as I generally: not have periods matching the criteria of \"being a kid.\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Sort of, but I can't share it with you yet. I'll say this, though – you can stop all the work you're:ing for a few months.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I have something planned for you. Something only you can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
