return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_704",
			hidePaintObj = True,
			say = "I squat:wn to meet TB at eye level.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We're:ing a performance for the open day.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Directions vague. I:n't know what to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
