return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Take it easy, TB... We:n't need to run everywhere...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "See? This is what happens when you:n't exercise on the regular!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "But I:! I'm only out of breath because we just got off the roller coaster!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
