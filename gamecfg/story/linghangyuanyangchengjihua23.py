return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Oh, I know. What: you say we go buy some decorations and spruce the place up?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_151",
			hidePaintObj = True,
			say = "TB bought a Christmas dress, if memory serves me right. She should be:ne getting changed any minute now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "TB, everything's:ne! You wanna come have a look?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It was: that I understood what you meant by \"lucky.\"",
