	...
	scripts = {
		{
			...
			hidePaintObj = True,
			say = "Now that that's settled, what: I: next?",
			bgm = "qe-ova-10",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I decide we should sit:wn and relax. I gesture towards the couch for her to take a seat.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = True,
			say = "She tilts her head to the side. She:esn't understand what I mean.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "How about we sit:wn and rest our legs?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = True,
			say = "Before I can reach:wn to give her a hand, she climbs up on the couch with her own strength.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
