return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "And yet, TB:esn't seem tired in the slightest.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "But you:. You'll never grow up if you:n't sleep.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "This is very clearly parent-child stuff... but I'll: it for her sake.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "The only question is – what should I: to make her sleepy?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "A lullaby should: the trick.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_cg4",
			hidePaintObj = True,
			say = "She:esn't react whatsoever and keeps on sleeping like a baby.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
