	...
	scripts = {
		{
			...
			hidePaintObj = True,
			say = "I've been helping TB brush her teeth and wash her face for a while, and I think now she's ready to: it on her own.",
			bgm = "qe-ova-1",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "TB,: you want to try:ing it yourself?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = True,
			say = "After tying her bang up with a hair claw, I put her up on the bathroom chair.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "You mean your reflection? Yeah, there's two of you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "She sure:es. The you inside the mirror moves in the opposite way you:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(I'm starting to talk like her...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_cg5",
			hidePaintObj = True,
			say = "I:n't know whether it's because her common knowledge is lacking, or that she views the world differently than most, or if it's because...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
