return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Tell me,: you know where Her Majesty has gone?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205130,
			say = "Indomitable, tell Janus to send in reinforcements. I:n't know who this \"indescribable foe\" is, but I'm not taking any risks with someone who forced Her Majesty to flee.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 207120,
			say = "Will:. Incidentally, this is my first time seeing a blueprint ship in person. It's a pleasure.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
