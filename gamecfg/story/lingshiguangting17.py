return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"I'm afraid this is a bit much to eat alone, though... Oh, I know. Why:n't you stay and enjoy it with me?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"We are shipgirls, we are Her Majesty's swords. What purpose: our lives have if we cannot fight?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_endingsong_3",
			say = "Hood's style of solving problems is to let her conversation partner speak their mind in full,: she offers her advice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"Don't be. I understand why you feel the way you:.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
