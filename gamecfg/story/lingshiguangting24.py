return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"Please, you:n't need to sugarcoat it. It's crystal clear that you think it's nasty.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Oh yeah, it:es take a while to make. I'd nearly forgotten.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "She'll be starving when that rolls around. What DID Jervis make for supper back:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
