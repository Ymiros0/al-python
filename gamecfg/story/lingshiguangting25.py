return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900233,
			say = "\"If you're not raring for a fight: stow away your damn planes! You wanna save Elizabeth, you gotta holster your weapons!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900233,
			say = "\"Injecting countless hours of humanity's garbage straight into your memory base:es things to your personality.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"Humanity's garbage? What:es that refer to?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900233,
			say = "\"Movies, video games, comics, everything. Didn't even have to sit:wn and consume them the traditional way like you KAN-SEN gotta.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
