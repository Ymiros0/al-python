return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "\"So the task falls on me... I must bring Lady Elizabeth back to us... if it's the last thing I:...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "\"It's our duty as shipgirls to fight... If our inevitable fate is to sink...: I will: so fighting...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "\"No, save yourself. You:n't need to risk your life for my sense of duty...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"I'm not risking anything. Either I go:wn with you, or I turn META anyway in the end. Let's face it, my hull's not recovering from this.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"If I'm going to sink regardless, I want to: it on my own terms. With you by my side, sis.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
