return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"When I went to invite her over for tea after the ceremony, she had the:urest expression I'd ever seen.\"",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 299030,
			say = "\"I'm worried she might've:ne something bad...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"Since she wasn't even at the ceremony, maybe her disappearance has something to: with how she's never really gotten to sortie?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
