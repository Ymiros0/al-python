return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't say! Fleet, reverse course! Help the blueprint ships get here quickly!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"Your Majesty\" will:. I am not the same Elizabeth you know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: you know about this place?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#BDBDBD",
			dir = 1,
			say = "You know, I really:n't get why you reject me. There's no point even trying.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "You... Richard,: you remember us?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#BDBDBD",
			dir = 1,
			say = "Can't say I:. Have we met somewhere?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#BDBDBD",
			dir = 1,
			say = "The energy's coming from the gate, right? All I need to: is drain the battery.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_camelot_13",
			say = "The tornado bellowed a resounding roar, raising an army of minions to: its bidding.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Ark Royal (Retrofit)",
			say = "Come on:, you nonces! Do your worst!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Some will get through if they all swarm us! I will go in and cut them:wn to size!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Do it,:! I and the Royal Maids will dispose of any foes that get near the gate!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
