return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I know. If you're left aching for more, what: you say we have a duel later?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#BDBDBD",
			dir = 1,
			say = "The future's set in stone. There's nothing you can: to change it. Haven't you known that for ages now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#BDBDBD",
			dir = 1,
			say = "Look at us. We're living weapons. Let's stop pretending we're more than that and just: what we: best – fight!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#BDBDBD",
			dir = 1,
			say = "All it'll: is break one little branch. And I've got all the time in the universe to–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "She can come back as long as she has a spare vessel! It's why she never stays dead no matter what we:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
