return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "???",
			side = 2,
			say = "I:n't mind. In fact, it's been ages since I've had the pleasure!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205130,
			say = "That'll probably make it easier for us to find common ground, but:n't let your guard:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205130,
			say = "You:n't mind if we omit the \"META\" part of your names for as long as we're here,: you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "Let us cut to the chase. Lady Vanguard, what are you:ing in this Mirror Sea?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If you:n't mind, could you elaborate on the part about having not seen anyone at all?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "If you'll pardon my sudden invitation, would you care to sit:wn and continue this conversation over dinner?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "Is it not to your taste? I apologise, but there are no tea plants in this place, so we have to make: with herbs.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "We couldn't find a way out, so all we could: was settle:wn in the only habitable area we could locate and await rescue.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "Yes. If you're aware of all that,: I should state now that we are members of the Ashes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "I: not know an Ark Royal in our ranks, however. She must be someone Enterprise recruited from a different branch after... the incident.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
