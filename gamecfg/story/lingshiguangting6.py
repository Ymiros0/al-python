return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "Go after Zero! Hurry, Helena's hacking can't slow them:wn forever!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Yes, and your overconfidence has led you to your:om. It seems you haven't learned from the past.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Enterprise META",
			side = 2,
			say = "I count nine Arbiters vessels... It'll be tough, but we can: it. Zero's brought the whole party to defend her mainframe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "That brings us to where we are now. I:n't know what Antiochus is planning, all I know is we're not a part of it, as they've apparently forgotten about us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "If our fighting days were behind us, the least we could: for our lost comrades is live here and know peace and happiness.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "But what:es it have to: with Her Majesty? What led her to come here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "The Royal Navy:esn't have its own Black Cube. Her Majesty reasoned we may be able to find information leading us to a cure by exploring Siren territory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205130,
			say = "You:n't need to worry about us, actually. We have a teleporter that can take us out of here. It's the key to bringing home Her Majesty and fulfilling our oaths.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205130,
			say = "If you:n't mind, I'd like to retake my pledge of loyalty.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900326,
			say = "Need I give my life for the good of all, it shall be:ne–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
