return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "... but:esn't seem to be having much luck.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "In a flash of light, talismans flew forth as if cutting through the thick, stagnant air of the warehouse. And:-",
			flashN = {
				color = {
					1,
					1,
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "As the secretary ship, I'm:ing my best to protect you, Commander!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
