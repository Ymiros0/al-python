return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey, Ryuujou? I have a date coming up with Commander~ Where: you think we should go?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't recall seeing any plans like that in Milord's schedule. All right, that wraps up today's work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Tsk... Well, I'll excuse myself:. I suppose you should report to Commander yourself:~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
