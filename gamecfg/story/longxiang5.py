return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If this keeps up, I won't even be able to: my normal military work, let alone serve as the secretary ship.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_room",
			say = "Before she noticed, she had already cleaned the floor three times, spent two hours organizing things, and hid away all the:lls in her room. When all was said and:ne, the morning was already over.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
