	...
	scripts = {
		{
			...
			bgm = "level",
			dir = 1,
			say = "Enterprise, I'm sooo bored~ Why:n't we go grab Minneapolis and: head to shore for a barbecue?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "Saratoga,:n't be too relaxed. Our mission isn't to be taken lightly.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Though I'm upset that Astoria and the others were hurt, just being mad won't accomplish anything... We simply have to: what we have to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The battle isn't over yet. If you:n't keep calm, you might make a mistake at a crucial moment. Relax, relax~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Sorry, Sara. I know you're still coping with Lexington, you:n't have to worry about me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
