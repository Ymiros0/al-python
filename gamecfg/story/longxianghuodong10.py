	...
	scripts = {
		{
			...
			bgm = "battle-boss-2",
			dir = 1,
			say = "Ugh... so this is... all I could:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's good:. Next, we should check in to see how Saratoga is:ing-",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Zuikaku, orders are orders. All we can: is make sure that her sacrifices are not in vain.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
