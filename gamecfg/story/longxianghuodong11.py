return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "Saratoga... just what are you:ing...",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hehe, let Miss Sara break it:wn for you~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I contacted our allies to search the surrounding waters while Portland and the others tied Ryuujou:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Thank you. If that is the case,: these wounds are well-earned.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wasp and I will handle the rest, so:n't worry!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Sorry for causing you trouble... I'll leave the rest to you:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
