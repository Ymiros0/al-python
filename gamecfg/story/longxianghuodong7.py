return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I'm fine,:n't worry about me. I can... *cough* *cough*... keep going!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Heh... after what happened at Midway... if those two are Akagi and Kaga's successors,: their fixation on me is not that unexpected.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heheh,:n't you forget! Saratoga is the big senior of the Union carriers!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
