	...
	scripts = {
		{
			...
			bgm = "level",
			dir = 1,
			say = "Haah... I wonder what Indy is:ing right now~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "You're worrying too much... For how much you:te on her, you really ought to believe in her a bit more. She's not that weak, you know.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahh!! Does that mean she's grown up enough to fly away on her own? Indy,:n't leave meee! Stay with your big sister forever~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's not even what I said... Ah, forget it. Every time I'm around you, I can't seem to stay serious... Portland,: you not get nervous at all?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
