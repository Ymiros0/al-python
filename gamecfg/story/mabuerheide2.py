return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Whew! While we're blowing away them cobwebs anyhoo, we might as well get something:ne. Question is. what?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You heard the camerawoman! C'mon:, next to me. Ready? Say cheese!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "star_level_bg_113",
			dir = 1,
			say = "Memphis flapped the forming photo through the air to speed the process up. After that was:ne, she handed it to Marblehead.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Anyhoo, feeling like you cleared your head, Commander? Good. I've gotta run now, but I'll catch you later! And:n't forget my name next time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
