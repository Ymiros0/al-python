return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...Wait, crap, I ruined my chance to: another \"Guess who\"!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				...
				{
					content = "\"I:n't have to guess anymore.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Premium chocolate, at that. Omaha: be living up to her name as a chocolate gourmand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh yeah, forgot to ask before we started chowing:wn. why're you out and about today, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So like, please? Can we take a stroll together,: go on a little date?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
