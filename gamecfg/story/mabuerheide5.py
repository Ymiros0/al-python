return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The seashell's helix structure captures ambient noise, which: resonates inside. As a result, the noise is amplified, making it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "star_level_bg_106",
			dir = 1,
			say = "Cutting herself off, she awkwardly took the seashell out of my hand,: took the conversation in another direction.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
