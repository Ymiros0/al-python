return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Anyway, I'm happy with the way I am now. I:n't wanna go back to the old me, not at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Today was a boatload of fun! Let's: it again sometime! Now, if you:n't mind, I've gotta head off and complete some missions.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
