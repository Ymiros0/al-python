return {
	...
	scripts = {
		...
		},
		{
			...
			say = "It was the start of a new day. I was just about to start working, but: a certain someone covered my eyes from behind.",
			dir = 1,
			bgmDelay = 2,
			bgm = "story-1",
			flashout = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"I thought, 'Your smile always brightens up my day.' Just seeing it makes me more productive. And boosting productivity is exactly what an ideal secretary should:.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
