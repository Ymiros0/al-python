return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We won't know until we investigate further. What: you suggest, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "\"Urgh! *cough*! Crazy Sirens... Now you've really gone and:ne it!\"",
			dialogShake = {
				speed = 0.09,
				x = 8.5,
				number = 2
		...
		},
		{
			...
			side = 2,
			blackBg = True,
			say = "\"You leave me no choice! Sorry for this, but it's gotta be:ne!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
