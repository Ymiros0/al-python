return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 701040,
			dir = 1,
			say = "I'm not really feeling it, but... I'll: it if I must! Ура! ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you were surprised by what you saw,:n't be shy and just give it to us straight! After all, you're no longer in the Eagle Union, comrade! We'd be glad to listen to anything you have to say!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But before that, let's get you acquainted with everyone here. The one who should: the honors is... the leader of the fleet!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 705050,
			dir = 1,
			say = "Having that said, that title is just provisional in nature. In actuality, we: not observe rank or status in our command structure.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 705050,
			dir = 1,
			say = "I assume I:n't need to introduce Avrora and Pamiat Merkuria...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
