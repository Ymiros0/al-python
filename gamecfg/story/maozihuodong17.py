return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Haha! What: you think, Commander? Pretty good coordination on the fly, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So, what will your orders be, Commander? I'll: anything you say~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_cccp_7",
			say = "I'm worried about my friends. But, now that our communications have been disrupted by the Mirror Sea, what should we: next...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "From the information we've been able to analyze, we believe that: nucleus is located within the Siren stronghold.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Aha! I get it! If we just capture the stronghold, all we have to: is wait for the others to show up!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's decided:. I'll be counting on you~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
