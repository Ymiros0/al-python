return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 701040,
			dir = 1,
			say = "Well:, I'll keep looking at you since you're fine with it anyway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "I see. Should Tashkent teach you about Sardegna:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 701040,
			dir = 1,
			say = "You see, everyone treats me pretty well, but I:n't really have anyone to talk with.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
