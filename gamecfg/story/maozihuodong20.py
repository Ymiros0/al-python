return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then, we have to find some way of shutting:wn the Mirror Sea first. It'll be too hard for us to get around that iceberg.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900188,
			dir = 1,
			say = "In other words, we'll have to take:wn that Siren stronghold?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107070,
			dir = 1,
			say = "Yeah, that's the quickest way to get things:ne. We should act quickly while their forces are diverted.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			dir = 1,
			say = "We:n't have any other choice... Let's hurry up and get going!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
