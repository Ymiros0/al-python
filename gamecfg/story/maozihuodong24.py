return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "I:n't remember inviting you barbarous louts to my estate. Crass creatures, stupid beyond comprehension.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Shoot...! I:n't like the looks of this! Everyone, retreat, hurry!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
