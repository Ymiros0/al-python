return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107030,
			dir = 1,
			say = "Nice thinking, Hornet! But thinking isn't as fun as:ing! Sister Sara, scrambling bombers!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Just as Saratoga began to cheer, the stronghold's defenses came to life. The bombs that had been dropped were repelled by shields that materialized out of nowhere, and Saratoga's bombers were mercilessly mowed:wn by withering anti-air fire.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Good, I was afraid things would be too boring! Let's kick:wn their front:or, smash through that carapace, and tear:wn their defenses!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
