return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, you:n't happen to have a plan,: you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Should it come:wn to it, we cannot win a war of attrition with the Sirens. It's likely that if we keep pushing, we'll be quickly surrounded even if we: make it to the stronghold.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The best we can: is wait here and hold the line until our backup arrives...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Guess I'll rev up the ol' engine and help too. I can't promise you I'll kick much Siren butt at all, but it's better than me:ing nothing, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
