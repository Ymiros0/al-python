return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Alright, now we're almost:ne with everything we need for the Halloween party. All that's left is...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehehe... what: you think? I designed it myself. When I finished it ahead of time, I figured I might as well put it on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
