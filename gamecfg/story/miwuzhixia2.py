return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What's:ne is:ne. Besides, we have to pass through here to get to our objective. So, what: we: now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's obvious; we fight our way out of here. Which, funNoney enough, we might've needed to: later anyway, if these Sirens were gonna attack the Canal Stronghold.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "By the way, Helena, would you please see if you can contact with Canal Stronghold? I suspect we're being jammed, but it:esn't hurt to try.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
