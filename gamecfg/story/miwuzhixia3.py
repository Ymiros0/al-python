return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:. We've got 2 options; either we make a beeline for the fortress, or we \"take the bait,\" so to speak.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Obviously, I:n't intend to just walk into a trap here. Helena,: me a favor and contact NY City. Ask them to send reinforcements.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This is just a hunch of mine, but I:ubt the Sirens' plan is as one-dimensional as it looks.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Let's proceed cautiously and uncover what they're really:ing here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "Everyone clear on what to:? Then let's go!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
