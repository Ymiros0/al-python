return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 201160,
			dir = -1,
			say = "And we'll have to make some trouble for the Iron Bloods. Those cargo ships over there should: the trick.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 201160,
			dir = -1,
			say = "Now:, let's cause as much destruction as possible!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
