return {
	...
	scripts = {
		...
		{
			say = "Nelson, Rodney, and I finally arrived at the Eagle Union:rms.",
			side = 2,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Umm, we brought some tea leaves over from our:rmitory. Should I prepare some iced tea for everyone?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "A bit blunt, but... I:n't mind people being a bit more efficiency-minded.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It seems we're on the same page. Now:, let's continue our discussion.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we encounter the enemy... We'll hit their weak point,: split up to flank them from the sides, cutting off their reinforcements while chipping them:wn piecemeal.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Hmm. That's not a bad plan. What: you think, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: you think about, \"The Nelson Touch\"?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"The Nelson Touch,\" huh? Then that's what we'll: if we encounter enemies.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
