return {
	...
	scripts = {
		...
		},
		{
			...
			say = "When I came back to my senses, I was lying:wn on bed, and I could see Nelson's figure sitting by my side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If, by any chance, you: the same thing in the future, I will never forgive you. Got it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Nelson left, slamming the:or shut in her wake. Was she blushing though, or was I just imagining things...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
