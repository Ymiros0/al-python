return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Just as the pile of paperwork begins to bring my mood:wn, I hear a knock at the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Before I can respond, the:or flies open and a shipgirl confidently saunters right in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
