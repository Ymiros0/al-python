return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_wild",
			say = "When I look around, I see parched grass growing along the riverside. Shrubs:t the landscape, but they all appear yellow and withered.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "C'mon. They:n't call me a cowboy for nothin'!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ridin' ain't easy enough for a beginner to: alone.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "Awright. Lean back against me and hold those reins tight so you:n't fall! Let's ride!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "But if you wanna sightsee, I reckon I oughta slow things:wn a bit.",
			painting = {
				alpha = 0.3,
				time = 1
			},
