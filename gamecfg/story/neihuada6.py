return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_wild",
			say = "The night before, I'd:ne some miscellaneous port administration work before throwing myself into bed. Seems like I slept in pretty late.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_wild",
			say = "\"My body is heavy, but my mind:es feel really refreshed.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If your mind is refreshed,: my plan went off without a hitch. Hahaha!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I made ya breakfast. Or lunch by now, I guess. After you chow:wn, I'll take ya somewhere nice.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "How: you feel, young'un? There's somethin' about a ride like this once in a while, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
