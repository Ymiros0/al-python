return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Fiiine, fine. I'll tell ya, so sit your butts:wn...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"Why: I not remember any of this happening?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Rumors about you are gonna spread far and wide through the port. They'll become legends, and:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Besides, work has just calmed:wn for the moment. Why not listen in on \"our\" heroic adventures for a while?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
