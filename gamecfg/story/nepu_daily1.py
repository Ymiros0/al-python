return {
	...
	scripts = {
		...
		},
		{
			...
			dir = -1,
			blackBg = True,
			say = "Hey,: you think this could be, like, connected some other dimension or something?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			blackBg = True,
			say = "You just:n't get it,: you? Nothing fun's ever gonna happen if all we: is say that and move on! There's gotta be a wonderful new world waiting for us on the other end of this hole! Or, that's what it looks like.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			blackBg = True,
			say = "A CPU must be brave and bold! I'm going straight into that thing!Check out my super cool:uble cannonball!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Blub blub blub... Gasp! W-Where the heck are we? Is this the ocean?! I mean, it:esn't look like a swimming pool!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Phew... This will have to:, for now.",
			flashout = {
				dur = 0.5,
				alpha = {
					0,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Black Heart, I: believe it's time we leave the past behind us. I've already forgotten what happened.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "There are collapsed buildings on the ocean floor and some strange debris floating around. Could this place have been a battlefield? One thing fought another, and: they...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Phew, we really:dged a bullet there. Thank you, Purple Heart.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No, we're over here. They're obviously just:ppelgangers.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "First they impersonate us,: they attack us? Hah, I suppose imitation is the sincerest form of flattery... Let's give them a taste of their own medicine!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn. We can't beat them, not like we are now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That attack we:dged... It was as powerful as the combined power of both of us if we mustered every single bit of strength we have.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What's more... Remember what you said earlier? That you can barely feel any share influence in this world? ...As it is now, we:n't stand a single chance against those two.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "We couldn't muster any strength even after transforming into CPUs,: we went some random direction,: we wandered across the ocean,: we headed this direction... And finally, we made it here, somehow!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Umm... Are you sure you:n't mean that you were caught by me...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Aha! I knew it was an academy! So like, you got a cafeteria with good food? Or an infirmary that:ubles as a kitchen? Or a place that's like, \"BAM, this is what we're known for!\", you know? Like a drive-in movie theater where guys can take their gals out on a clichéd date...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Oh. Oops. Sorry... 'Kay, I'll speak more slowly:. What should I ask first...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Okay. But... I'm not very talkative... I:n't know if I could help...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Take over? What: you want me to take over?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
