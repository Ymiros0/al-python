return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When we play games, we:n't want to be interrupted by anyone, we want to be free and, how should I say it... We need a place to soothe our minds. An isolated, quiet, peaceful place...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ohoho,:n't be silly, now... I am a god, and a gamer, and a gaming god... But we are known as CPUs!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			actorName = "{namecode.37}",
			say = "Hum hum, if that's the plan,: it would be nice if we had a few more players...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sure, come on in~! We:n't get visitors every day, so we'll have tons of fun. Let's all be social rejects together~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Indeed... As you said, you:n't get a chance like this every day, so we should enjoy it to the fullest.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
