return {
	...
	scripts = {
		...
		},
		{
			...
			say = "I didn't provide anything for free, nya. I will get my share of the profits you earn from this event:wn to the last cent. Capiche?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Firefight, firepower, firefight, firepower... Ahh, I:n't have enough ammo!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "You'll have to: something about that on your own... Things are only getting worse for me over here as well!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What?! No wonder your team's got better stats than we:! But that makes this a 3v2!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I see! So at this corner you: a four-wheel drift!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And all you were:ing was putting the pedal to the metal and crashing into things.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you're gonna be that way: fine. I guess I'll give you as much advice as I can, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Her Majesty seems to have become interested in games as of late... If you:n't mind, may I ask you to let us play with you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:? In that case... I would love to try one of those!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
