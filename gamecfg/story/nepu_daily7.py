return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 0,
			nameColor = "#a9f548",
			say = "...Now:, while I totally didn't expect you all to just sit around and play games all day, it seems you did investigate as I told you to. You have:ne well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Woo-hoo! I knew you could: it, Histy! So:... can we just stay here forever?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "...What are you on about? We obviously can't: that.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "For a while I had no idea how we'd manage in this world... But we did, somehow. We couldn't have:ne it alone though. Thank you for helping us out so much, everyone.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Oh, you wanna: that? Stay up all night talking about games, again?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...We:n't have time for that. We gotta get going.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, I:n't want to leave either... But I've got Lastation to take care of, and I promise we'll meet again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Come on, guys... Let's just stay one more night while we're still here! I've gotten hooked on Oxy-Cola and Torpedo Tempura... And I need my daily:se!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Wowzers! Thanks, Javelin! Holy moley, there's like a:zen Oxy-colas in here! We could all have 3 each!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.6}",
			say = "...But I remember Nep-Nep:wning a whole bottle. Maybe she has the same taste as we:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Histoire",
			say = "Now:, CPUs, please line up in front of the wormhole and prepare to jump into it.",
			withoutPainting = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			actorName = "Histoire",
			say = "I can't simply leave an inter-dimensional wormhole open here, so once you're:ne saying goodbye, I will close it for the time being.",
			withoutPainting = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			actorName = "Histoire",
			say = "When you have business in this world, I can open it again, so you:n't need to worry about that.",
			withoutPainting = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, I guess you're right... Z23, Ayanami, thank you once again. We all had our ups and:wns, but I enjoyed myself too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sigh... I:n't either, I've barely even started on reading the books from this world... I could never get bored of talking with Künne either... ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey,:n't say anything that'll make them expect too much.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I will. Thanks! I'm always finding ways to have fun no matter where I am, so:n't worry! And I promise I'll be back to have even more fun with you guys... So just wait for me until:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
