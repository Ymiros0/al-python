return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait, Laffey,:n't fall asleep just yet! The reconnaissance mission:esn't end until we're back in port!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Ahhh... I can't: it! I had no idea fighting those full-powered CPU clones would be so tiring...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mhm... it's not Noire's fault. Surely it's the:ing of the Mirror Sea...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Just the two of you:n't instill a whole lot of confidence, so I decided to check in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.98}",
			say = "It's quite simple, nya. When in Rome,: as the Romans:. All we need to: is to equip you CPUs with your own ship rigging!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "To think that something like this could be:ne... Akashi, can we equip these right now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.98}",
			say = "Hmm... I:n't think I can make it tonight. Why:n't you all get some rest, nya?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.98}",
			say = "Akashi will have it:ne by the morning. Look forward to it, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
