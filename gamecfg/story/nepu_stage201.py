return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "{namecode.37}",
			dir = 1,
			say = "Your ship rigging can be controlled freely with just your thoughts. As long as you:n't space out, there shouldn't be any risk of misfiring... Woah,:n't point those guns over here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mine seems to be different from Neptune's, with these main turrets. This one focuses on heavy firepower,:esn't it? The color also matches, not bad!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Then,:, can I turn my torpedoes into cute:lphins?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "We:n't quite understand the circumstances, but they have not been able to draw out their full power. There still appear to be possibilities that remain hidden from our understanding.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
