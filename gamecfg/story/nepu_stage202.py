return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			withoutPainting = True,
			say = "It's too difficult to: right now... I'm going to need quite a bit of time. Everyone, please wait a while longer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Histoire,: you know something about those fakes?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... and: someone used our data to make those clones?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			withoutPainting = True,
			say = "In any case, I will: my best to re-open the wormhole. Everyone, make sure to be careful.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sirens? I:n't really get it, but they sure sound like an insidious bunch. But to think they could create a full-power CPU...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Aww,:n't be a party pooper, Blanc. Has the real thing ever lost to the fake before? Since we're the real deal, there's no way we'd lose! Checkmate!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
