return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "It's too early to celebrate. Don't you still have something to:?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Perhaps that has something to: with Blanc and me coming here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			withoutPainting = True,
			say = "That's correct. For the time being, please continue to investigate the Mirror Seas and suppress any CPU clones you encounter. Well:, until later.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... She just says whatever she wants to say, and: cuts off the line...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She just drops the important details and: is all like \"I'll leave the rest with you,\" before bouncing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "... In any case, we've all got to: our best.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Hehe... Well:, let us determine just who the superior one is...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
