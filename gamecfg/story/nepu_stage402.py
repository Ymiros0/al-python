return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If what Histoire said is correct,: this should be the last zone...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Histy?!  Well:... is this really the last stage?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Nep-Nep,: you all really have to go?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			say = "You:n't need to be in such a hurry... it's fine to stay at the academy a bit longer...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Waaaah! Don't wanna,:n't wanna,:n't wanna! I'm not ready to leave yet! I want to stay here and play with everyone a bit longer! Let's change the departure date. Maybe three months out.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			withoutPainting = True,
			say = "Therefore, it's \"see you later,\" not \"goodbye.\" If you wanted to come back tomorrow, you would be able to. As such,: not worry too much about not being able to see each other.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "No, no,:n't hesitate to come at any time. We'll always welcome you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
