return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "While working with Newcastle in the office, I heard a knock at the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "However, there are situations in which the pursuit of perfection is not the best way to get things:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
