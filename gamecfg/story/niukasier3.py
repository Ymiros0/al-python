return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Umm, where did Newcastle go? I:n't know either...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Newcastle? If she's not with Sheffield,: she's probably somewhere reading by herself!",
			flashout = {
				black = True,
				dur = 0.4,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Anyway, I:n't know where she is... but she has been helping out with maid duties, so I'd guess maybe she's off:ing something like that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Why not try looking in that empty lot behind the Royal Navy's:rms? That's where we usually dry out the laundry...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
