	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "Don't: anything, like a wimp",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "Newcastle paused for a moment, but: resumed looking over her:cuments as if nothing even happened.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				...
				{
					content = "Let's not: this after all...",
					flag = 2
				}
			}
		},
