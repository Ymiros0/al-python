return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now:, I have other business to attend to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The purpose of this trip was partly to buy some items that Akashi:esn't stock, and wouldn't be worth ordering.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Since we're here, why:n't we renew my insurance as well?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
