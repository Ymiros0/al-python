return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, why:n't we rest for a bit?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_105",
			say = "In accordance to Newcastle's suggestion, we sat:wn on a bench at the street corner.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ever since I accepted Her Majesty's appointment, I've pretty much:ne everything with the other maids. Even afterwards, when I returned to the Royal Islands, I was always with Glasgow...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm sorry, I hope it:esn't sound like I'm brooding...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
