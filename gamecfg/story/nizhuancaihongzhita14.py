return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "(If so, that would explain why she:esn't match up to the caliber of the \"META\" ships mentioned in the briefings...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Once again, lower your weapons and pull back to a safe distance. You've:ne enough here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
