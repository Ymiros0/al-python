return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Ulrich von Hutten",
			say = "If there exists a past different from the one you know,: a different future must exist as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Gneisenau META",
			say = "No... There's no way... She can't have:ne this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Gneisenau META",
			say = "You understand the hefty price she paid for using the Black Cube's power,:n't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Ulrich von Hutten",
			say = "I:. I've seen what happened to her. That's why Friedrich took over for her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_midgard_5",
			say = "This:es not signify the end of her ceaseless war, but it:es signify something else...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Gneisenau META",
			say = "You... You: know the way out of here, I presume?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Ulrich von Hutten",
			say = "Of course I will. How could I turn:wn a friend?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
