return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Anyone can accomplish great feats if they:n't fall for distractions and just focus on their job.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "What you see before you is the Tower of Midgard. Let us not waste time pointing out how it:es not resemble a tower.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 407030,
			say = "Correct. They were first built inside the flying fortress,: assembled on-site here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 406020,
			say = "Now that you mention it, those structures: resemble the flying fortress a bit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Got it. We'll just have to see for ourselves what we can: once we're inside.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That about:es it for the briefing. See you on the other side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
