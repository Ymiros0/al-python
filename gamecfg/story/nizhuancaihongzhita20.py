return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403100,
			say = "Well, that's not much of a big deal. They can't:dge us if we go in for a good hand-to-hand beatdown.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Even I'm not:wn for something like that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "They keep diving too whenever I try to dive to track them:wn! There's no way to tell exactly how many enemies we're dealing with!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
