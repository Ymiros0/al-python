return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_midgard_3",
			say = "Scharnhorst hung up,: ground to a halt and lowered her weapons.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "One of our goals with this mission is to gather intel inside the Singularity. This is the perfect opportunity to: so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All you must: is lure the Arbiter close to the Singularity's exit. Then we can easily call for reinforcements, or flee back to our world as a last resort.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "We have a huge fleet waiting just past that portal. If the Arbiter insisted on pursuing us, it'd be the last thing she:es.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Sell her on it,:. You're the one who has to fight, not her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
