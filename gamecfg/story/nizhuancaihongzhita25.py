return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 406020,
			say = "Haven't found anything inside my observable range. The Sirens have shot:wn any recons trying to fly beyond that though.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "It:esn't really matter whether or not Enterprise ignored us, had a change of heart, or simply decided not to get you involved. Whatever the end result is, the fact that we can't get in touch means that she's not coming.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 9704010,
			say = "But from how aggressively the Sirens are shooting:wn your recons... they're surely hiding something.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Whether or not I'm hiding something, I'd shoot:wn enemy recons regardless. Plus, the Sirens are always hiding something, and there's always next time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "So, you think the Sirens' behavior has something to: with Scharnhorst not returning yet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402060,
			say = "Woah, Gneisenau finally asked us for help! That's the kind of plot arc I'm:wn for!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 406020,
			say = "That's right! Not even a bad girl like me would: something like that. Let's go find her!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 408120,
			say = "I just brought over some supplies on our mass-produced ships, so let's: a quick field maintenance before we get going!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
