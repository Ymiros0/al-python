return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey, Elbe,:n't take this the wrong way, but... Couldn't you have chosen a different route?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If it'll get these assholes to stop making so much noise, I'm:wn to throw:wn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "It's not your fault. We know they're here, but we can't: anything until they make the first move anyway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But what are they:ing inside the wreckage? ...If they were really trying to ambush us, would they really be making so much noise?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402060,
			say = "And I:n't think that explosion was caused by U-1206 firing a torpedo, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403100,
			say = "Why would they: that? To recover resources? Have the Sirens ever needed to: that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
