return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402060,
			say = "Well,: whatever you need, but:n't go running off once the actual operation starts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403090,
			say = "Aww, look at Eisen! He's looking restless too. Poor boy needs a vacay just as much as I:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403090,
			say = "Ah, gotcha! Meanwhile, I just got:ne running a final inspection on some equipment.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
