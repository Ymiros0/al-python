return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "We'll arrive back at the Tower soon. We:n't have the time to spare though. Break through by force!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "It'd be a different story if you weren't injured, but the Iron Blood:es not make futile sacrifices.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "If the Ashes leave their members to die,: I'll have no part of it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "I:n't believe that the Sirens just happened to lose track of you... right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "...Then we will: the same for you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Not everyone was born strong. And:n't worry, I'm not:ing this path on my own...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
