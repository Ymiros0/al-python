return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We:n't have much time left... but as long as we can keep up the pace, we should be able to make it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "There's no time to explain. If we:n't take care of her and the Tower is destroyed, we'll be stuck here for eternity.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Roon",
			say = "Doesn't look like they want to talk. Guess there's only one thing left to:, Mainz.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
