return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_midgard_6",
			say = "Blow after blow rained:wn until finally, the armor split apart.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Don't get ahead of yourself. As long as we're inside the Singularity, she can continuously repair off any damage we: inflict.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You're right... Roon, Ulrich, we need to pull back, lest the unthinkable actually:es occur.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_midgard_2",
			say = "Relieved, she promptly fell back:wn, exhausted from the mission.",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			sequence = {
				...
				{
					"\"...If they attack us,: we shall respond in kind.\"",
					3
				},
				{
