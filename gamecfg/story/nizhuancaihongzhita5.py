return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Or a:nut, with the shimmering layer being the glaze.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Halo! That's the word! And what the heck: you mean \"donut\"?! There's no \"shimmering layer\" either!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm no expert on the names of shapes, but even I can tell ya that ain't no:nut.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402060,
			say = "Fair. Feels like we should be:in' something besides twiddlin' our thumbs while the others defend the Tower...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
