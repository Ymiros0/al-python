return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 407030,
			say = "We're almost:ne with them. The Tower's turrets will make short work of the Sirens once Heinrich's team softens them up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Everyone, run a final equipment check,: prepare to enter the Singularity.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey, Ulrich, what shape: you think the Singularity is? Like a:nut?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It is no:nut – it is a tower. A tower that extends into other worlds...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "(Above, the:main of the gods. Below, the land of the dead. And betwixt the two... Midgard.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "What matters is directionality. If this is a tower, and not a bridge,: we will either go up... or:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Enter in formation. U-1206 goes first, Magdeburg and I follow,: Adalbert. Elbe takes the rear, leading the mass-produced ships forward.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 406010,
			say = "I:n't expect you to conquer another dimension with your planes, but... well, I wish you the best of luck.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "As: I. I look forward to seeing your findings.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
