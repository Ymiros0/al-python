return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 406020,
			say = "Smaller? Ah, that's because this Tower:esn't have the defensive turrets. They're separate from the Singularity generator, so that's probably why they're not here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "We:n't have any concrete way of finding them, but it's possible we will as we survey this area. That is our job.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "If anyone else has one, ask it now. I cannot have you:ubting the mission's purpose in the midst of a battle.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 406020,
			say = "No:ubts here. Now, are we heading for the wrecks I spotted earlier?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
