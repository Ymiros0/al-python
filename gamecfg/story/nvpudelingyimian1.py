return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'd just sat:wn to have a break since there were no customers, and: you show up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I guess I could have my break after you've ordered something. Not like anyone could complain:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#a9f548",
			say = "\"Please make yourself at home until:. I'll be back shortly.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hats off to the Royal Maids who: this every day. I'd go mental if I had to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 5,
			nameColor = "#a9f548",
			say = "Just need to get through today,: I'll finally get to vent some steam!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 6,
			nameColor = "#a9f548",
			say = "I mean... If you really enjoy having me as a maid,: I guess I'll bear with it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
