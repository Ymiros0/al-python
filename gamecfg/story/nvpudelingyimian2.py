return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "W-welcome back, Mast– Ah, forget it! I'm not:ing it. So, what's brought you here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Or is it the fact I'm lying:wn? I'll have you know I'm enjoying a break after cleaning all day.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Let's hear your order. If it's on the menu, I'll have it:ne in a flash.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "Even if I say \"sure,\" there's no guarantee I'll: a good–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "If you really need:cuments sorted, ask me again after I've finished my job here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I sat:wn with my drink, but held off on sipping it. I could feel Ägir's gaze on me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#a9f548",
			say = "What: you think? It's child's play for me! No trouble at all...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
