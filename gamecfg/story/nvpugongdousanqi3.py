return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202090,
			say = "I was gonna offer to make some for ya after the exercise, but Belfast has banned me from:ing that...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206070,
			say = "Remember, their task force members aren't used to each other's:ctrines. We are better coordinated than them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
