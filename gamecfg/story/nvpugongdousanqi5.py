return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Both teams had one of those, you:lt!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You're excused. My servant and I are:ne talking. Go on, tell us why you're here.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You can bet on it. I'll personally ensure my servant here:esn't get caught up in work and lose track of time.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
