return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You said the same thing five minutes ago. No work is going to get:ne if you stay in bed all day...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_115",
			say = "After getting dressed and washing her face, the little queen sat:wn at her work desk.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The data we gathered suggests META involvement, though the specific readings: not match anything we have on record. Furthermore, we are unable to trace how these infiltrations took place.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 205050,
			say = "While there may be some connection between the two events, we: not have any hard evidence to link them as of yet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "For the time being, all we can: is continue investigating.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But, what:es this unidentified META want with our Royal Islands?",
			painting = {
				alpha = 0.3,
				time = 1
			},
