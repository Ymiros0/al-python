return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "No, I:n't! I'm just passing through!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 205130,
			say = "I'm afraid I can't: that, Your Majesty. It is my job to protect you, and to that end, I must know where you're going.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Fine, fine! If I must be held to the same standard,: you two come with me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
