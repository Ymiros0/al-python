return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9704030,
			say = "Nobody said it'd be straightforward, but that:esn't make this less boring.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You're sure you:n't want a Royal Maid stationed here? It must be exhausting:ing everything yourselves.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9704040,
			say = "If anyone could use more protection, I would say you: during these visits, Your Majesty.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But, let's see... Good, the connection is stable and it:esn't seem we're being traced. We might just be able to receive data.",
			painting = {
				alpha = 0.3,
				time = 1
			},
