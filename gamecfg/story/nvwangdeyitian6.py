return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_115",
			say = "She leafed through a few reports on her desk, tossing finalized:cuments into a big pile.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ah, Bel. What: you have for me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "(If we get to it before the Tribunal:es, we might be able to get a step ahead of the Naval HQ and assist Richelieu in the process.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Just bring dinner over to my bedchamber. I:n't want anyone bothering me this evening.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There's STILL more work to:? Ugh, let me rest for half an hour first...",
			painting = {
				alpha = 0.3,
				time = 1
			},
