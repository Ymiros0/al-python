return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So, what are our options? Contacting Akagi's group is a given, but there has to be something we can: here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Azusa's right. Panicking won't: us any good, so we should try to get a grasp of the situation first.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Excuse me, but, what:es that mean?",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, that:esn't seem to be the case this time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
