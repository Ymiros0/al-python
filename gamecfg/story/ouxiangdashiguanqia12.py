return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't let your guard:wn until we can get you through, though. Do your best out there.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 403070,
			dir = 1,
			say = "I'm getting a bad feeling about this... Hey, Sheffy,: you think this is...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 10700050,
			dir = 1,
			say = "What: you mean by that? Are we going to have a repeat of the thing that happened when we arrived?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
