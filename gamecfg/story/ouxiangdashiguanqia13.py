return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn, Akashi. Tell us what exactly is going on, and what we need to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we succeed, we can save this world from destruction,: truly go back home as heroes! Everyone's happy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
