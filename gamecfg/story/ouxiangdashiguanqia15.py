return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we succeed, we can save this world from destruction,: truly go back home as heroes! That way, everyone's happy!",
			flashout = {
				black = True,
				dur = 0.3,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ami's just getting started, so:n't you dare go anywhere!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
