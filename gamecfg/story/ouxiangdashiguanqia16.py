return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When the energy dissipated, all the mass-produced ships in the area shut:wn as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Next time,: some proper research before sending us on a dangerous wild goose chase...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Thanks again, for everything you've:ne for us here.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "C'mon, we:n't have time to sleep on the job. Let's continue the photoshoot! Haruka, you're next!",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
