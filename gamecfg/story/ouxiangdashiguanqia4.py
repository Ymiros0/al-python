return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: we:, Akagi? We're not going to be able to get through here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...it feels like they:n't know who they're singing for...",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			hidePaintEquip = True,
			dir = 1,
			say = "While I:n't believe that there are winners or losers when it comes to concerts, I'd say this is the main reason for our \"defeat.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you are unable to defeat those clones,: you must undergo special training and try again! Also,: deploy the other Muse units!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know, I know! However, if we:n't investigate that location, there's no way to get these girls back home, correct?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintEquip = True,
			dir = 1,
			say = "Hmm, I see. If there's anything we can: to help...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 401236,
			dir = 1,
			say = "Calm:wn, Akashi... They're just going to be advising us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 401236,
			dir = 1,
			say = "They'll basically only be helping out with rehearsals and lessons, so:n't go cooking up any weird plans.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
