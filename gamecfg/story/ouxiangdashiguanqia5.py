return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Laffey, please:n't fall asleep on the equipment!",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I thought we were just:ing a test run, but I guess we ended up:ing a full-scale setup.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Woah,:n't start practicing your dance steps before warming up first!",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			blackbg = True,
			nameColor = "#a9f548",
			say = "It's time to head:wn to the venue!",
			hidePaintEquip = True,
			effects = {
				{
					active = True,
