return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Even though those mass-produced ships are approaching the girls, they:n't seem to show any intent on attacking the ships they're on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We might not even be able to get on stage if we:n't get that ship out of the way first.",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			actor = 401236,
			dir = 1,
			say = "Even if we: that, if that ship calls for additional reinforcements, we won't even be able to return to port.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			paintingNoise = True,
			actorName = "？？？",
			say = "And make it:uble! Mami Futami is here to save the day!",
			effects = {
				{
					active = True,
					name = "speed"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Of course! If we:n't win, we won't be able to move forwards or backwards, isn't that right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
