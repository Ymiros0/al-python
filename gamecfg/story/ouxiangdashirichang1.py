return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Definitely. Plus, there are so many things here we'd never get to see back home, so you'd never get tired of the view. By the way,:esn't it feel like there are more people here than usual?",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh hey, Azusa and Chihaya! What are you two:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
