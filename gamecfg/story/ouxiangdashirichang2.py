return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Thanks for the suggestions! The shrine is a bit out of the way, so we should save that for the end... Why:n't we head to the canteen first?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Ah, um,: I suppose I'll try a bit... Woah! Apple juice? ...It's so crisp and refreshing!",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(There's a ton of fun stuff to: here, and everyone seems super nice, but it really is a much different world here compared to back home...)",
			hidePaintEquip = True,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			actor = 10700010,
			nameColor = "#a9f548",
			say = "All these familiar sights and sounds are finally letting me calm:wn... Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
