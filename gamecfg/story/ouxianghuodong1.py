return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			blackBg = True,
			say = "These traditions have evolved and taken many different forms as they were passed:wn the ages...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You have music, nya! You have a bunch of cute girls, nya! There's only one logical thing to:, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right! Experimental Muse System testing unit, \"Polaris,\" let's make sure to: our best!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "*sigh*... I hope this:esn't take long...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "W-well... None of us have:ne something like this before... Anyway, Gascogne, we'll follow your lead!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
