return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "But:n't you think it's a pity to ignore all the time and effort we've put into accumulating on-stage experience?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Hmm, in that case, why:n't we lend our expertise to those girls? Polaris has the Commander backing them up, but I'm sure the others could use some guidance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's not that big of a deal, honestly. All you have to: is post some daily thoughts that aren't related to private or combat-related information.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
