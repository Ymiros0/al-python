return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Did everyone have a chance to pick up some merchandise during the:wntime, nya? How about refilling your supplies, nya? If you want to step out for some fresh air, this would be the time: it, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wow, look at all the Special-type destroyers who've come out to cheer for me! Heyyy, Ayanami~! Inazuma, Ikazuchi~! I'll: my best~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "There are only two battles left. All we have to: is hold out a bit longer.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
