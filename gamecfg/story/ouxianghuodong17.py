return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 301014,
			dir = 1,
			say = "Eh...? Our idol names won't match up:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 301014,
			dir = 1,
			say = "Snow is fine and good, but what:es that have to: with kitties? Gah... we've got to come up with something...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What...? That actually:esn't sound too bad... actually, that sounds terrible! I'm not:ing that ever again!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 301014,
			dir = 1,
			say = "I'm very sorry! ? Let's try this again:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
