return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ehehe! Even though I lost, it:esn't feel half bad~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 905030,
			dir = 1,
			say = "I:n't feel like just another warship setting off for battle. Being able to prepare for this performance with everyone, and:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Gascogne, you seem a bit different. Well, nothing wrong with that, right? We're about:ne with our testing as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
