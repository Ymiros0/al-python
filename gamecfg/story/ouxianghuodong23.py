	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We've reached the Muse System's limit...! Singing protocol powering:wn...",
			bgm = "azumaster-ins",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			actor = 403070,
			dir = 1,
			say = "*gasp*... You're right... I:n't think... I can go any further...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "However, any participants who want to continue their idol activities after today will be permitted to: so, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Besides, after I went through all this effort to get:lled up, it would be a shame if the Commander did not get to gaze upon me a bit longer... right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
