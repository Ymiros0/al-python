	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Polaris, Saratoga,: your best!",
			bgm = "azumaster-ins",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Don't worry, it's fine. We've all got to: our best to cheer everyone on, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 403070,
			dir = 1,
			say = "...I'm happy for you and I'm going to let you finish, but I:n't think the rest of us can: stuff like that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
