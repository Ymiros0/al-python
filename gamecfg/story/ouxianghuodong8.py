return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Miss Hipper! W-well met! L-let's: our best to successfully carry out this rigging test!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202250,
			dir = 1,
			say = "...It looks like we won't even have to: anything. The venue's excitement level has already dropped three bars.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn, Zed! You're too nervous! You can't allow yourself to get caught up in your opponent's pace while you're on stage!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mhm! We'll: everything we can to ensure the trial run is as successful as possible!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
