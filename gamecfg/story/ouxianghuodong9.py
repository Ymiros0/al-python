return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, everyone in Polaris,:n't worry about us! Keep moving on to your next test!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102240,
			dir = 1,
			say = "Yeah, there's no:ubt that fighting with the Muse System feels different. I'd say that it's a bit easier to use...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Gascogne's combat operation patterns: not differ from specifications in trials and simulations.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(As I expected... As Kansen, our equipment:es not vary significantly as long as it's constrained by our hull and core structure.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
