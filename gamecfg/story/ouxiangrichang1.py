return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Why: I only hear Cleveland? Where are the rest of you?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...and that's the story nya! We're gonna need you to: some proper music band rehearsing type stuff nya!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Brand new band, Polaris,:ing their first group rehearsal nya! Got a real ring to it nya! Break a leg nya! Commander's rooting for you too nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When I agreed to: testing on new experimental equipment, I never thought it meant joining a band.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now... I:n't actually know where to begin...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
