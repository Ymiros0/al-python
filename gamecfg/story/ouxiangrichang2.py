return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Phew... what: you say we call it a day?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If that's how you feel,: I suppose we can take a break... But it's not like I'm tired or anything.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Since we're:ne for the day, I'll go get us some drinks. Who wants what? Oxy-Colas? Coolant?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hehe... Since it has nothing to: with my Commander, I suppose I can let you have it. Just:n't let me see you slurping:wn your coffee and we won't have a problem~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I will fetch your beverages:. Kindly wait a moment.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
