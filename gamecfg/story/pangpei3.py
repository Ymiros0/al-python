return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "There was a knock on the office:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "The:or opened, and into the office stepped da Vinci, the local inventor.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "That I am! So, since you're here, what is it you need? Don't be shy, tell me and I'll have it:ne in a flash!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "You mean that cat toy that barks like a:g?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "And to: that, I'm gonna need some money. I figure about this much...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "You're only saying that because you:n't see the genius of my invention.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "The Commander would reject it before you were halfway:ne writing!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "You:n't know that! Nothing is impossible! Anyone would approve it if they just knew what's so innovative about the Doggo Cattron 3000!",
			painting = {
				alpha = 0.3,
				time = 1
			},
