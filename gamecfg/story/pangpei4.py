return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "It's not. First of all, though, please sleep in the Sardegnian:rm and not here. I'll write your request:wn and present it to the Commander.",
			painting = {
				alpha = 0.3,
				time = 1
			},
