return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Although at a snail's pace and with missteps along the way, Pompeo was chipping away at the pile of:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Now that I'm processing it myself, the sheer volume of work to: is really sinking in.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "Whew... Let's see how much is left to:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "If the Commander finds out THIS is all I managed to:, I'm so:ne for... Everyone's going to hate me...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Think about it this way – the Commander:esn't work alone, so why should you have to?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "The source of the voice stepped forth and gently moved aside the:cuments obscuring Pompeo's view.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "Yeah, there's tons! For a start, could you review these:cuments for me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 607010,
			say = "She had gone around claiming that you'll permit anything while the Commander is absent, which is why Impero came to visit you earlier. She shouldn't have:ne that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "Thanks for:ing that. Dealing with her was a pain because she just wouldn't back:wn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Think nothing of it. Also, shouldn't you be working now? I believe these:cuments are due today, so...",
			painting = {
				alpha = 0.3,
				time = 1
			},
