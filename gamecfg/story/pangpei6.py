return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "Evening was drawing near. Though it took considerable effort, the girls eventually managed to escort the sleepyhead Impero to her:rm room.",
			bgm = "story-richang-8",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 607010,
			say = "Oh, one of the:cuments mentioned that. Ingraham was in charge of maintenance that day, but: she got assigned an urgent mission.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601070,
			say = "Okay:. Da Vinci,: you reckon you could: it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 607010,
			say = "Apropos of nothing, I heard from Veneto that when signing:cuments, the secretary may use either her name or simply write, \"Request approved.\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh... Okay, I'll just write Pompeo Magno,:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
