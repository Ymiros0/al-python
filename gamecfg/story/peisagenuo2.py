return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "\"Quick:uble-check... Yes, I'd say that's about it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Oh,: you want to take a look through it? I'll set it up right now!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "...That'll: it. I:ubt you'll be able to set up manual focus on your first try, so I put it on auto-focus for now.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			say = "How: you like it? You can see all the wharf from your office. Awesome, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				{
					content = "\"Why:n't we go look together?\"",
					flag = 1
				}
			}
		},
