return {
	...
	scripts = {
		...
		},
		{
			...
			stopbgm = True,
			bgmDelay = 1,
			say = "The:or to my office slowly opens, and one dejected Ema appears.",
			bgm = "story-richang-7",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "After weakly greeting me, she takes a seat and stares vacantly at the:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "So I organize these files... And: these...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "(I:n't think she realizes that she's been sorting the same pile of:cuments over and over.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "Sorry... I'm not getting any work:ne at all, am I?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "(I hear someone talking, but... I:ubt they're talking to me.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "(This is bad... I already have the perfect route in mind, but how: I even begin to tell them...)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I was kidding about the date thing! Calm:wn a little.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Okay! Geez, Avrora, I'm coming! You:n't have to pull!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "There are so many places I want people to know about, but I just:n't know how to communicate it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "I'm not very good company, it's impossible to tell what I'm thinking, and I:n't express myself enough...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "(She's only making herself feel worse. I should: something.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
