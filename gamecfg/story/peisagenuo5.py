return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "The:or to my office slowly opens, and once again, one dejected Ema appears.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "Y-You:n't think she's adding some weird features to my telescope, is she?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Even as she mumbles about her feelings, she never stops organizing:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "...Hm? Uhh... It:esn't have any lenses?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Emanuele Pessagno",
			say = "Every day, you sit here and: your work...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Hey, it's the telescope:rk, too!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yes, we have some:cuments that we'd like the Commander to check.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "I'll: my best to get better at communicating, so just give me a little longer...",
			painting = {
				alpha = 0.3,
				time = 1
			},
