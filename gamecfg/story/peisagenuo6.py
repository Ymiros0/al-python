return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Just:, with a bang, the:or to my office is thrown open.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "Also, keep your voice:wn during breaks.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "(If it has Alfredo this worked up,:...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Before, I never would've dreamed of YOU inviting ME to: something together.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "This one says \"to the telescope:rk,\" so I could tell at a glance that it was for you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Aww,:n't look at me like that... I just didn't mention it because...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "You:n't need to go out of your way and read the columns...",
			painting = {
				alpha = 0.3,
				time = 1
			},
