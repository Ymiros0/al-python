return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "As we all know, most of an iceberg’s actual mass is hidden under the surface — in theory. Based on our observations, however, the icebergs here: not have substantial underwater structures. Rather than “floating,” they seem to be suspended within the water.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we blast ‘em to pieces, the fragments disappear, but: an identical iceberg will float up to take its place soon afterwards!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Of all the Mirror Seas discovered by mankind, this may be the first that:es not fall into one of those categories.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "On the battlefield, the Sirens often directly convert a portion of the ocean into a Mirror Sea, suggesting that whatever device they use to: this must be portable.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I assume they’re still ironing out technical challenges for the various modules, but I:n’t know how much progress they’ve made.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_cccpv2_2",
			say = "That:es sound plausible. Perhaps the Sirens’ main base, which has never been pinpointed so far, is hidden somewhere in the depths of the ocean in a similar form?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
