return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I didn't find much in the way of treasure. All I recovered was this stack of misprinted:cuments.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			actor = 702040,
			dir = 1,
			say = "And finally, what is a blueprint if not a plan for the future? Whose plan is it, and what is it they were trying to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 705040,
			dir = 1,
			say = "These:cuments may not tell us all that much, but it's clear that the Sirens know much more than we:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
