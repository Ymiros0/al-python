return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Belorussiya took the others out to intercept them, but we need to hurry up and grab as many:cuments as we can before getting out of here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What should we:,:? We'll be annihilated for sure if we remain here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If we head in the opposite direction of the Gate, we might just find the exit. It's better than awaiting our:om, at least...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_cccpv2_9",
			dir = 1,
			say = "I:, but... why did I forget in the first place? Why did I only remember just now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_cccpv2_7",
			dir = 1,
			say = "Simultaneously, the auditorium's monitors sprung to life, showing me what appeared to be footage of Northern Parliament girls:ing battle with strange enemies.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
