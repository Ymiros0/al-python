	...
	scripts = {
		{
			...
			side = 2,
			bgName = "bg_cccpv2_7",
			say = "The auditorium's exit was not physically blocked, but I couldn't go beyond its open:ors. It's as though there was an invisible barrier, locking me in here.",
			dir = 1,
			bgm = "bsm-2",
			flashout = {
				black = True,
		...
		},
		{
			...
			say = "<The computational system has encountered an error. Security mode has been activated, and will shut:wn in 19 minutes and 7 seconds.>",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_cccpv2_7",
			dir = 1,
			say = "Similar to what my fleet is:ing,:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
