return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We've lost nearly all of our mass-produced ships except for the icebreaker, but... we didn't have that many to begin with, and they:n't have the same maneuverability as we:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We'll have to make: without. I didn't expect to make it this far in, so I didn't bring as many mass-produced ships as I could have.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Sorry, Belorussiya, but I:n't intend to sink without seeing what's on the other side of that iceberg!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...I know you:n't like making sacrifices, but the world cannot afford to lose you here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_cccpv2_10",
			dir = 1,
			say = "If this is actually a \"Reenactment,\": there is no escape route anyway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I see... As much as I:n't believe in giving up, I:n't think I have the strength anymore to search for the control device for this Mirror Sea...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_cccpv2_7",
			dir = 1,
			say = "Is there any way to leave this facility:?",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Will everything disappear once the lights go out? I:n't think we can hold on that long...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
