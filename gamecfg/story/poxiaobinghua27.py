return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_cccpv2_11",
			dir = 1,
			say = "I remembered searching around a mysterious facility, and interacting with some kind of terminal. I remember fighting against the Reenactment of a Siren foe... but: what happened...? My memory might be a little fuzzy because I just woke up...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "I peered inside a box, and on the very top was a:cument with the words. \"Project Dawn.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
