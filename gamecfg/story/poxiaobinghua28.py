return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "My memory also feels incomplete... I remember entering a mysterious facility in the City of Light and recovering some data, and: we ended up in a desperate battle against the enemy...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't know... The recording equipment I brought in is completely blank. It's been running the entire time, but there's nothing but noise from the time we entered the city of light...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hey,:n't just leave Kirov behind... Wait, what are those ships coming towards us?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Did the Azur Lane schedule a joint exercise in our waters? I:n't remember hearing anything about that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "There definitely isn't anything of the sort. What have our outposts been:ing, letting such a large fleet sail through without notifying us?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "To what: we owe the pleasure, comrades? I: not recall the Northern Parliament requesting aid from the Azur Lane.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahaha, of course not, comrade! We were simply:ing a bit of sightseeing before bringing the Commander back to port! Would you care to accompany us?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No:ubt the Northern Parliament found a reason to keep the Commander around longer...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: our friends of the Royal Navy think of this?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Very well. What: you want to:, Comrade?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_cccpv2_12",
			say = "(Or so I'd like to say... But I:n't think there's a way to keep this from turning ugly...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Commander, thank you for everything you've:ne for the Northern Parliament. May we fight again side by side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 703010,
			nameColor = "#a9f548",
			say = "I guess that's it,:. Don't get yourself killed out there.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
