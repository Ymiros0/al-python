return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 705040,
			dir = 1,
			say = "Of course I’d be willing to explain things to you, Comrade, as long as you:n’t record anything:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Comrade,: you know when and how the first shipgirls were born?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 705040,
			dir = 1,
			say = "Haha, it's just a fanciful conjecture. But assuming that what we just told you is True, Comrade, who: you think was the first shipgirl?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
