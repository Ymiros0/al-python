return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_bsmlevel",
			say = "Gremyashchy was the perfect representation of the stoic fighting style of the Northern Parliament, expressionlessly mowing:wn the enemy ships that occasionally appeared in our way. Among all the destroyers I’ve commanded, Gremyashchy’s combat capabilities were absolutely top-notch.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Think nothing of it. I’m just:ing my job. Mm, that’s all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_bsmlevel",
			say = "Now that you mention it, I: remember something about that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				...
				{
					content = "“You’ve:ne well to serve your country.”",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n’t really need the honors. All that matters to me is:ing my job well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It’s only fitting that she would come:wn to guard someone as important as you, Comrade~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 1,
			actor = 701070,
			say = "Unlike the other destroyers I’ve worked with, Gremyashchy:esn’t solely rely on her gunnery and torpedo strikes. She prefers to quickly close the gap on her enemies before dispatching them with a swing of her massive, comically exaggerated chain mace.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
