	...
	scripts = {
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That should wrap things up over here. I: believe this is my first time meeting you in person, Commander. I am the flagship of the Secret Room’s defense fleet, heavy cruiser Tallinn.",
			bgm = "bgm-cccp2",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_bsmlevel",
			say = "(I could sense a:mineering aura from Tallinn. As the flagship of a fleet that had been fighting tooth and nail, on top of her experience in the Iron Blood, she was a force to be reckoned with...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_bsmlevel",
			say = "So, when you say that the Sanctum is safe,:es that mean it’s around here somewhere?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_bsmlevel",
			say = "...We’re still surrounded by icebergs and freezing winds. It’s somewhere in these waters:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oho,: you remember how shocked we were the first time we came here? It wouldn’t be fair if our Comrade missed out on that rite of passage. But:n’t worry, Tallinn, everything has been taken care of.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
