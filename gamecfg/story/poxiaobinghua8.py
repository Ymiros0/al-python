return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When the weather is warmer, this area:esn’t stay frozen over like it is now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_cccpv2_1",
			say = "An icebreaker submarine... I:n’t think the Naval HQ, or any of the other factions, have ever seen a vessel like this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
