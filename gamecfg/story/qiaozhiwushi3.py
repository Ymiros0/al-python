return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_107",
			say = "One day, I suddenly heard Queen Elizabeth's distinctive voice as I passed by the Royal:rms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ughh... so spicy... but there:es seem to be a nice flavour lingering in my mouth...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Queen Elizabeth gulped:wn the glass of water, and immediately afterwards, continued her showdown with the mapo tofu.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
