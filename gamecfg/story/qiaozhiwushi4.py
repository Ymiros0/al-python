return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "No, Commander, thank you for being frank with your observations. If those were the conclusions you made,: we indeed have a problem.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I see... That may not have been my intention at all, but if the Commander made that observation,: surely others must have as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
