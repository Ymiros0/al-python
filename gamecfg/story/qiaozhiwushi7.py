return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_107",
			say = "One day, King George V asked me to prepare supper at the Royal Navy:rms — my biggest test yet since I started to learn how to cook for her sake.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heehee. I:n't recall:ing any such thing~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "In any case, thank you as well for:ing all of this for me, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
