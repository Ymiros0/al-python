	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"How long:es it take to brew this tea?\"",
					flag = 4
				}
			}
		},
		...
		},
		{
			...
			optionFlag = 4,
			nameColor = "#A9F548FF",
			say = "While some people enjoy this kind of taste,: be careful to watch the time carefully if you wish to fully appreciate the aroma.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Oh, but: remember to take your time. The tea is piping hot, after all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you:n't have any plans afterwards, would you like to take a stroll through the garden with me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Now:, Commander, please close your eyes, take in the aroma of the tea, and feel the warm sunlight caressing your cheeks.",
			painting = {
				alpha = 0.3,
				time = 1
			},
