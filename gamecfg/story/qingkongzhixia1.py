return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107030,
			say = "Now, we'll only be touching on this briefly today, so:n't forget to read further during the holidays!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "\"The arrival of the aircraft carrier officially signaled the end of the Sirens':minion of the skies over our seas...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107030,
			say = "Then why:n't I call and tell her you're arguing with me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107030,
			say = "Fine, fine. That's it for this term,:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107030,
			say = "Hi, Lex! Yeah, I just got:ne! Let's go!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107030,
			say = "Sounds great! Will we be fine on time, though? I:n't wanna miss the plane.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Saratoga was so much more like a teacher back:.",
			bgm = "blueocean-image",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I can only hope that the new research they're:ing at the Sea of Stars will go smoothly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
