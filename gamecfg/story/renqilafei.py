return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander,: you know a good nap spot...?",
			flashout = {
				dur = 0.5,
				alpha = {
					0,
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Out of the blue, there was a knock on the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "That being the case, the least I could: was cover her with something so she:esn't catch a cold. I took my coat and carefully tucked her in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
