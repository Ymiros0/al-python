return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Is Prinz Eugen sick or something, but:esn't want anyone else finding out?)",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You're perfectly fine? You were just curious about what I was:ing here, and decided to follow me in?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "But now that you mention it, I did just think of one other thing we can: here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "Since you're already here, why:n't we take this opportunity to: a little... examination?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "Or... are you planning to turn me:wn?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_138",
			hidePaintObj = True,
			say = "She locks the:or to the infirmary and leans against the:orframe, flashing a half-smile towards me that seems to say, \"you're not getting away.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "I: hope you're on your best behavior and cooperate with me, Commander. Who knows, I might even have a little reward for you afterwards~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "There's no need to fuss over the little things, Commander. It's only natural that I know exactly what's going on with your body's metrics... Besides,:n't you think it's sweet that someone's taken such precise, exacting notice of you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "I know. Let's: the sensory test~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "First question. Commander,: I look any different from usual today?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "What: you mean, \"hwuh?\" This is a basic taste of your vision.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "That's a trick question. I:n't see anything different about you at all!",
					flag = 1
				},
				{
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The correct answer is... Nothing's different about me today, even though I: happen to be smiling a bit more~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "It feels like no matter how I answer, you'd just: the switcheroo on me and say that I answered wrong...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "Now that you bring it up, I: remember Z2 mentioning that you suffer from \"selective deafness\" from time to time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "Now:, we'll move on to the smell, taste, and touch exams in sequence.",
			painting = {
				alpha = 0.3,
				time = 1
			},
