return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 307010,
			actorName = "???",
			say = "I was able to resolve the little problem I had with the Eagle Union thanks to your help, but things haven't been any less troublesome since:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			actorName = "??",
			say = "Please:n't disturb the Commander's rest. Last night's work was arduous after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "??",
			say = "There's no need to pout. Go on now,:n't keep Kaga and the others waiting.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know you've been quite busy recently, so I was wondering if you'd like me to: more to tend to your health.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I did promise to take care of myself, but my promise:esn't end with my own health. Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Come to think of it, since you: have the day off... Let's take advantage of the opportunity and have a little outing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehe, are you worried about me? I'm:ing just fine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Please:n't forget, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "After all, that is something only \"people\" can:, not Cubes...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
