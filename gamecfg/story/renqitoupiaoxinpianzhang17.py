return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "No. It just felt like the most appropriate thing to say, and someone had to: it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The polling venue will stay open for another week, and you can claim a trophy in the exchange shop until:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
