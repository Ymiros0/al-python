return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It's unbelievable that it's:ne already. Didn't they start construction, like, just the other day?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Uh, I'm sure the Commander's enthusiastic support for this event had something to: with it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
