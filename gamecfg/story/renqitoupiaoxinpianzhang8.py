return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It's not the end of the world if you:n't get your desired placing, though.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The pamphlet says those who:n't win the group rounds will still have a chance in the repechage round.",
			painting = {
				alpha = 0.3,
				time = 1
			},
