return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "Uh, can't you just, like, bring it up with them? Like normal people:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "Ise and Hyuuga could maybe: it, but most of us aren't the types who can just ask someone about a joint exercise...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "Then why:n't I: it? I was just about to head their way anyhow.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.47}",
			say = "If Zuikaku will ask on our behalf,: I'm sure it'll go well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_outdoor",
			say = "Zuikaku went to the Eagle Union:rmitory and proposed the joint exercise. Almost everybody she told about it agreed to participate.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "This happens surprisingly often~ Like, I'm just out and about,: suddenly somebody asks me for a favor.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
