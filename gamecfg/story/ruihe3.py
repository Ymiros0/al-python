return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "You heard right! ... Hey, what're you:ing, Commander? What are you hiding from?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.92}",
			say = "That goes for you too, Zuikaku. You're the secretary, so: your job right... Now, Akagi, after you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "Like, I know she can be overbearing sometimes, but:n't you think you were overreacting to her just a little much?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You:n't understand,: you, Zuikaku?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "I:n't know whether to be happy or sad about that... It's a weird feeling...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
