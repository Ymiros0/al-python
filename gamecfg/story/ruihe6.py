return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.95}",
			say = "I noticed that you hadn't come back to the:rm yet, so I reasoned that you must still be hard at work...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_night",
			say = "I:n't remember anything like that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "(I knew it. sis has been:ing all sorts of stuff with the Commander when I'm not around...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "... Alright,:... I'll just go and leave my snacks in the fridge...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
