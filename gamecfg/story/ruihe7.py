return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "You:n't have to force yourself to eat it... Sis has already gotten you some snacks, so I'll save mine for next time, okay...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.96}",
			say = "But... if you'd every now and: tell me that you like me more...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
