return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn... Calm:wn, Warspite... Great! That should: it for Her Majesty's eyebrows!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm just:ing this 'cause it's fun~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Neptune, I:n't know how to say this, but... isn't this a bit too big?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Hmm? Never mind, we're about:ne over here anyway. I will accompany Her Majesty to the party later, so: continue the good work, Seattle.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
