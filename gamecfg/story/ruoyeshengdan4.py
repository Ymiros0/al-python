return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah,:n't worry! There's still plenty of time! I didn't come to rush you anyway~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Since you're here:, why not have some sweets? Would you like a sundae, or a slice of cake?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That's an easy one! Double the sugar,:uble the sweetness. Double the sweetness, and:uble the deliciousness, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You really: love your sugar,:n'tcha~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Of course~ As long as it's sweet, I'm totally:wn~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
