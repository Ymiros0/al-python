return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Phew... I finished the cookies on time, and the party was a huge hit. Thanks, guys! I couldn't have:ne it without your help!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:ne, Lady Warspite, Lady Neptune.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
