return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900218,
			say = "Kronshtadt, what: you think about the invitation we received from Sardegna?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "Now that the situation in the NA Ocean is finally starting to wind:wn, it's certainly not a bad time to reboot the event.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900218,
			say = "I must admit, it's an efficient way of:ing so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "I: think it would be in our best interests to go.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900218,
			say = "Unfortunately, the Polar Fleet is tied up with some investigatory work right now and won't be able to provide you with much support. I: hope you understand.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "I've been dealt worse hands before. But, I: have one request.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "I want authorization to see all of the higher-ups' classified:cuments on the Europa operation. Can't be rushing in blind after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 900218,
			say = "...I: wonder, is that request actually for work purposes, or to sate your own curiosity?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
