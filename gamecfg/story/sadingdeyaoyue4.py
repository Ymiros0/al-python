return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "H-huuuh? Why are you making ME: manual labor?! Hermione, heeeelp!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "...But, you: have a point, Warspite. Taking all these treasures over to Sardegna is a rather risky affair.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Your Majesty, is there nothing for me to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "Phew... I'll let Bel handle the exhibition:... Time to sit back and enjoy a nice cup of tea~♪",
			effects = {
				{
					active = False,
					name = "speed"
