return {
	...
	scripts = {
		...
		},
		{
			...
			say = "The fourth photo was of Saratoga,:ing her work as an idol(?) even on her day off...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Miss Saratoga,: ya reckon... *cough!* I mean,: you think we'd be able to: something like that?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Yeah! Let's: our darndest... to enjoy the party!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
