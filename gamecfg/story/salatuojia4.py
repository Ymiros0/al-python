return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm... whose turn is it next~? Chitose is really scary when she's mad, so maybe Commander will:~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Above all else, I:n't want to see you get injured in action because people no longer want to work with you. That's why you need to make sure to properly apologize.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sara, you're not a child anymore. If you won't stop pulling pranks on people,: can you at least make sure that you apologize right away?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I feel bad for the girls you pranked too. It makes me very, very sad to see you: things like that to others...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
