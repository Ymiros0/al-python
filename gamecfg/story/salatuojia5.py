return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm, actually let's practice a bit more. I:n't mind if it's Lex or Comet's group, but I definitely:n't want to lose to those upstart Sakura idols!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's fine, it's fine! We all know each other here anyways. While this kind of stuff normally would be a bit problematic, it's not like Gridley plans to: anything bad, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
