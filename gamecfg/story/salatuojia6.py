return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sorry, Sara, I can't reach that either... Why:n't you try using your planes?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All righty! A little bit of work for a prime photo op? That's way too good of a deal! But, why: you suddenly want to make bento box meal?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
