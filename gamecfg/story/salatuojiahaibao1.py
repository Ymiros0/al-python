return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "C'mon, we'd better move out now! If we:n't, someone else will find it before us!",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I: have to say it's wonderful to see everyone:ing their part to help protect the seas.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And Sara, be nice and:n't cause any trouble for the Commander, okay?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
