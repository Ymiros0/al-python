return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "Hmm... It:esn't seem the Seal is in this area...",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Okay! You lead the way! (Lexington has her hands full at the moment, so we need to: the best we can on our own...!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Cleve... I will continue:wn my own path...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
