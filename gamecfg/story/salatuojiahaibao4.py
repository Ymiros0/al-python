return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Great job, San Diego! There's no:ubt about it, this is the location of the latest Seal sighting!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Saratoga?! ... If that's how you want it,: you'll get it! Quick, everyone!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "And:, from the center of the stage, with lights shining:wn on it, emerged none other than the star of the show...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
