return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just looking at them gives me the urge to scoop them up and:... \"something.\" Hehehe~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hehehe, the little Mutsukis are here! Have a look around. But watch your feet and:n't trip.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Aaaahhh! Mu-Mutsuki,:n't push it... That button says \"Danger,: not push\"...",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wh-why:es your collection have a self-destruct system?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now now, Mutsuki and Kisaragi, we:n't need you crying either. Zuikaku, you go get help. We have a lot to: here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
