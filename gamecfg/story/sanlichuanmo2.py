return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oy... It's okay, now. Settle:wn. No more crying, Mutsuki. There there... show me a smile. Smile for a candy~ Coochee coochee coo!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What's:ne is:ne. Getting mad wouldn't help.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But I still have a lot of work to:...",
			paintingFadeOut = {
				time = 0.5,
				side = 2
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Um... Mutsuki, you:n't have to walk so fast.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let's: our best, everyone! We'll fix up the model museum as soon as we can!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
