return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Uunya... I'm finally:ne with the preparations, nya! I was afraid I wasn't going to be able to make it to the banquet, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "That should be obvious... Anyway, you should get:wn from there before you get your new clothes dirty.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.20}",
			say = "... As if. I just hope that Commander:esn't forget about the banquet due to having too much work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.71}",
			say = "We just need to: our part so that everyone can have a good time at the banquet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
