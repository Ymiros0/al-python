return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 305023,
			actorName = "{namecode.79}",
			say = "... But I never wear Western-style clothes... I hope I:n't look weird...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 305023,
			actorName = "{namecode.79}",
			say = "S-sneak in? Why would you: something like that...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 305023,
			actorName = "{namecode.79}",
			say = "I-I didn't mean it like that! It's just, how: I put it... Miss Taihou sometimes feels hard to approach... not as bad as Akagi, but... Eek!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307071,
			actorName = "{namecode.97}",
			say = "Heehee~♪ You:n't need to be so nervous. I was just messing with you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			actorName = "{namecode.79}",
			say = "But what I: know is that Milord has been hard at work all this time. I want to be able to get Milord to relax...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307071,
			actorName = "{namecode.97}",
			say = "But by the looks of things, Commander won't be:ne for a while...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
