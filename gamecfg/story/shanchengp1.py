return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Here's the next:cument... Woah! It slipped through my fingers again... Um, I'll go pick it up right now... Huh?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.79}",
			say = "Ah! Milord, didn't you ask me to seal this:cument for you earlier this morning? *pouts* Milord, you've been spacing out a lot recently...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Right... I did ask you to: that for me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.79}",
			say = "Technology advances super quickly,:esn't it! Shigure told me that thirty years ago, there weren't even televisions around. She said families had to huddle around radios. After the Sirens attacked, everything has developed so fast!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.79}",
			say = "It's way too fast...? Hmm... I:n't really get it, but... I can: a ton of stuff with this, so it's probably fine!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
