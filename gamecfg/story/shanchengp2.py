return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Good morning, Milord! Let's: our best today!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			actorName = "{namecode.57}",
			say = "Yup. Michishio and the others needed some supplies for the:rm. I can't be relying on Mikuma forever for this kind of stuff...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			actorName = "{namecode.17}",
			say = "That darn Shiranui raised her prices again recently. And since those two run the only stores here on the base, complaining won't even: you any good...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.79}",
			say = "Is that so? I:n't really get it, but leave it to me! The next time I go to buy tech packs, I'll be sure to give her a scolding!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			actorName = "{namecode.57}",
			say = "Haha, you two get along really well,:n't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
