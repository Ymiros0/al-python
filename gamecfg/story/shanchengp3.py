return {
	...
	scripts = {
		...
		},
		{
			...
			optionFlag = 1,
			actorName = "{namecode.79}",
			say = "What:es \"borrowed\" mean? Um, it's because you've agreed to spend the day with me, or something like that!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 2,
			actorName = "{namecode.78}",
			say = "Oh that's what \"borrowed\" means? ... I:n't think I get it, but that's all right...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Easier said than:ne. An elaborate shrine like this must have been incredibly difficult to build...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
