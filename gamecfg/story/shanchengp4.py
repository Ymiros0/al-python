return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "M-Milord, p-please:n't look inside the drawer! ...Awawa!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "All right, I'm going to head back to the:rm now. Yamashiro, how about you and Commander?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.79}",
			say = "Um... there's still something I want to:, so I'll head back later! Milord, can you keep me company for a little longer?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
