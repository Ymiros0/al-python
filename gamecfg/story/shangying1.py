return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "It certainly:es! Soon it will be spring.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "They certainly:! Would you like a cup of tea?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Then why:n't we have a Flower Festival so we can watch them bloom together?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "That sounds like a great idea! I think we should: it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "I mean, sure, but... why:es the idea of a Flower Festival excite you so much, Hiryuu?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "If you're in favor of it,: let's: it! Please, allow me to make all the necessary preparations~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
