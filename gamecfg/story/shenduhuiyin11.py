	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "There it is! Picking up a reading! Patching up errant data... Aaand:ne! I've located a meteorite fragment, everyone!",
			flashin = {
				delay = 1,
				dur = 1,
				black = True,
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "Will:! Finally I get to use the grappling hands on this baby!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_deepecho_4",
			say = "Kronshtadt lay:wn in a chair resembling a dental engine, and Arkhangelsk took a seat next to her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "This is almost like a:ctor's office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Kronshtadt",
			say = "Please, it was a joke. I just need something to distract me from the thought that this machine might: me in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Arkhangelsk",
			say = "Sorry, allow me to play along:. \"Why yes, I:. Only the finest for you, Miss Kronshtadt.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Arkhangelsk",
			say = "Yup. Let me: one final check. Artifact is in place... Computer systems online... Data transfer port set to open...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
