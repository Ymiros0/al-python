return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1104 ",
			say = "The experience felt a lot like:wning an entire barrel of vodka: getting carted through a desert of snow and ice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Ugghh... Why: I have the mother of all hangovers when I've not had a drop to drink...",
			flashout = {
				dur = 1,
				alpha = {
					0,
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701100,
			say = "As hard as I can? I can: that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Stop it, Kiev. Pulling her cheeks again won't: anything but hurt her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's a pleasant change of scenery,:n't get me wrong, but a lot of things:n't feel right here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "But:n't worry, I'll get us out of this. Wherever we are, nobody alive expects us to be here. A spy like me couldn't ask for better circumstances than that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
