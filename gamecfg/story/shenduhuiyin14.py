return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701100,
			say = "I:n't think they've ever heard of you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Their planes are moving unbelievably fast, but I'll: my best!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xiangting_3",
			say = "The tornado's rapid formation sent a ripple across the sea, growing into a towering tsunami. Only moments later, they came crashing:wn on the girls.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
