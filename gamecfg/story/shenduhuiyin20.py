return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "No. They're most similar to Northern Parliament ships, but they:n't look right...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701100,
			say = "Bad idea. What would you: if a potentially dangerous shipgirl approached you without warning?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "Good point! I'll give them a heads-up through my communicator:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "That said, it:es feel pretty strange to contact them now after we ghosted them just earlier!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xiangting_3",
			say = "Far faster than the streams were the waves generated by the tornado's formation. They would come:wn on the girls in just moments from now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "(I WILL persist, find out who's creating this black tornado, burn their identity into my memory, and learn the truth behind this dream if it's the last thing I:!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_xiangting_3",
			say = "Each hit bore:wn on her like a sub-zero slash and burned like the flame of a blowtorch, wearing away at her rigging, her body, and her spirit bit by bit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_deepecho_9",
			say = "The mass-produced ships that:tted the horizon had been completely obliterated, leaving only a roaring maelstrom sitting atop a throne of shattered hulls.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_deepecho_9",
			say = "When Kronshtadt turned her eyes to the center of the maelstrom, it was: that she came face-to-face with \"her.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
