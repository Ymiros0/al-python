return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Had we:ne the same as before, it'd be rushing towards us right now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But we're not seeing one, soooo...:es that mean we did it? Did we get around the tsunami?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "So if they: form despite us being nowhere near, we'll see it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu2",
			say = "Kiev responded immediately with a volley. The girl:dged and circled behind Soobrazitelny, who was still reeling from shock.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu2",
			say = "Kronshtadt ordered her comrades to stand:wn before walking with a brave stride towards the girl only known as Bon Homme Richard.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
