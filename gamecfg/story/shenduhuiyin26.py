return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "We were trapped in a dense fog...: a black tornado appeared... After that, we were all knocked out by a huge wave...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Oh right, Kronshtadt said the same thing, didn't she? She was talking about being in a dream,: getting jolted back to reality by that black wave...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701100,
			say = "But, why: I remember now? Shouldn't we forget about the dream after we come back...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "She...:esn't seem to be conscious yet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't know. When I woke up, I saw her next to me in this state...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wait, that's it! If Kronshtadt is trapped inside the dream, why:n't we go back in and \"finish\" it for her?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701100,
			say = "Uhh... I:n't think we have the time for that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If the submarine goes:wn, Kronshtadt's gonna be the least of our worries!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What should we::? We still have plenty of supplies, but... can we only wait for help?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "C'mon, genius mechanic, think! How: we all get out of here alive?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "And how: we rescue Kronshtadt from her dream? Graaaaaaah!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Not like there's anything else we can:... But here's the problem – even if we: manage to bring Kronshtadt back,: what?",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "Does that mean it's coming from the meteorite:?! If we can find some way of amplifying it,: it'll be picked up by the research base, and our comrades will know about it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wait. Who's going to pilot the submarine:? If you strengthen the connection, we're all going to get pulled inside the dream, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "What other choice: we have at this point? If we:n't try something bold and daring, we'll just be waiting for our:om!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Understood. How long:es it take to: all of those things?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "How about the signal from the meteorite? We're casually:ing all kinds of revolutionary things here, but I hope Soyuz at least manages to get the signal...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "There's no guarantee. All we can: is send out the signal to draw in anyone who's paying attention. Also, you never know what might bite.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 705060,
			say = "Hopefully we'll have Kronshtadt back by: too...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't want to think about losing another comrade ever again...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 705060,
			say = "Anyway, are you sure everything's ready to go, Soobrazitelny? We can take some time to:uble-check things if needed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 707010,
			say = "Are we ready to connect:? Let's make ourselves comfortable first~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
