return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_116",
			say = "Suffolk was running through the palace's corridors, a stack of:cuments in her arms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Miss Neptune! What are you:ing here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "Got it! Anyway, let's get those:cuments to Her Majesty before she gets angry! Let's pick up the pace, Sheffy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
