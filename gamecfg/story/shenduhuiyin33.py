return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_guild_blue",
			say = "The risk of communications between factions breaking:wn. The possibility of a Siren counterattack. The Commander's response...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "This probably isn't the brightest idea, but I:n't see any other way...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If things are left to continue:wn this path, we're all going to be in danger, including the Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
