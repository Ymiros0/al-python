return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "...Wait, I forgot that we're on the clock! We have a job to:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 705060,
			say = "Before we:, I have a question for you, Miss Genius Mechanic.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "No, it's about the port the sub was:cked in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "See those cables extending to the surface? I bet they connect the heating element to some sort of machine further:wn below!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yeah, I'd take off like a rocket if it wasn't for the fact that I have a job to:! Speaking of which...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "What I: know is hard to explain... Don't worry though, you'll soon see for yourself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
