return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 707010,
			say = "Whew... I'm:ne loading the equipment! Kiev,: you have the courage to at least get up on the pier?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "How about something I:n't already know, for starters?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "...How am I supposed to know what you:n't know?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 705060,
			say = "Now you're being silly. How would I ask a question about what I:n't know about?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You're missing the point. How would I know what you: or: not know?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "For the love of... I:n't know what to ask about because I:n't know what I:n't know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Adding lemon to black tea?! That's disgusting! Nobody in the Royal Navy would: that! Who told you this? The Iron Blood?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "I:n't plan on sharing it with anyone else. This information is only meant for those in the know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
