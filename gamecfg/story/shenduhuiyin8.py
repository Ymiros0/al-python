return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701100,
			say = "So what: we: now? I:ubt we'll find any leads here on the surface.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What: you think? We must go deeper, of course!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 701090,
			say = "We could be walking into a Siren trap, but the only way we'll find out is by diving with the sub and investigating. So I propose we: just that!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "True, and we have to test her diving performance anyway! Let's get ready to go:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "(Good thing we eliminated all the Sirens first before going underwater. Because once we:, we can't fight back.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 718010,
			say = "(Smashing up the place,: vanishing without a trace. Just the way I like it.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
