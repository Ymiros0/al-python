return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "{namecode.78}",
			dir = 1,
			say = "No,:n't get me wrong. To see everyone in the Sakura Empire enjoy themselves makes me feel excited too. I was just thinking out loud.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.79}",
			dir = 1,
			say = "Just:n't overthink it, okay? ...Wait, what is that...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.79}",
			dir = 1,
			say = "N-no, I:n't... I know I:n't look good in Christmas stuff...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.79}",
			dir = 1,
			say = "I-if you think so: I'll try it on...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Christmas Photography Mode Gridley, at your service! The commander tasked me with:cumenting everyone's Christmas experience this year!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
