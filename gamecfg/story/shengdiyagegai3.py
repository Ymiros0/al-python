return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "I feel like I kinda get it, but I:n't really...",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What the heck: you: to get retrofitted...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hold up, you can get a retrofit just by sleeping?! I need to write this:wn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "N-never mind, it:esn't matter! What I'm saying is. you want a retrofit? Then work hard for it! It won't just fall into your lap!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If that's all,: I'm going back to sleep now... Good night, or morning, or whatever it is... Zzzzz...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "And so, San Diego felt like she had adopted the right mindset to receive a retrofit. Perhaps her goal was just within reach, and all she had to: was keep advancing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
