return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't have a retrofit, yet you've got that aura thingy like it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Yeah. Everybody learns new things and grow as people every day. How they: it differs from person to person.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
