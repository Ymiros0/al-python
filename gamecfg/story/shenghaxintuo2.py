return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "The port's overhead crane has broken:wn, too. We'll need to have it repaired.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "Oh, Commander? You're just standing at the:or... Are you entranced by the sight of my work?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "San Jacinto puts:wn her:cuments, rests her chin in her hands, and smiles meaningfully at me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "You scrape by on convenient instant foods when you're busy,:n't you? From now on, we're having no more of that!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "I sound a little too proud,:n't I? I just hope my home cooking is enough to soothe your heart, Commander~",
			painting = {
				alpha = 0.3,
				time = 1
			},
