return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "By afternoon, the pile of:cuments on my desk has shrunk considerably.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I:n't think I've ever seen her in such a hurry...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Carrying her over to the couch and laying her:wn there wouldn't be too difficult.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "When you're waking a sleeping beauty,:n't you need the magic of love? True love's kiss, was it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "You went through the trouble to princess carry me. And: you go back to work like nothing happened? That's just mean~",
			painting = {
				alpha = 0.3,
				time = 1
			},
