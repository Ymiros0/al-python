return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "Heehee. I'll take that as my reward,:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Just going out together:esn't seem like it's enough. I should commit more than that.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I:n't want to use an off-handed comment to disguise that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "If there's anything you want to: tomorrow, I'd appreciate it if you let me know in advance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
