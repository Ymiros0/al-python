return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Where: you plan to take me first, hmm?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107300,
			say = "If you:n't answer, I'm going to assume that's a yes~ Heheheh♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_522",
			hidePaintObj = True,
			say = "Like our last destination, I pick the spot and have her choose what we:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				{
					content = "If it's JUST a normal horror movie,: I'm fine.",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You:n't get to see sights like this every day...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "If you're having fun,: let's go see more sights after this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
