	...
	scripts = {
		{
			...
			bgm = "level-french2",
			dir = 1,
			say = "Miss Richelieu, what would you like to:? Should we attack...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Everyone, stand:wn. I'll go talk to her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "And: there's Strasbourg, Provence, Bretagne, and Jean Bart...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "I wonder... how they're:ing now...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "Even if the Iron Blood is far from just, they are rational and: not betray their allies.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "...Heh. It seems like we're traveling:wn two parallel lines.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "My intent is the same. I have no desire to fight you, but sometimes the world:esn't work out the way you want it to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
