return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "The others were looking on from a distance, but they seemed to be:ing well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Does it have to: with that black thing you showed me earlier...? The thing that powered up the mass-produced ships?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "No matter how high the stakes, there's no way you can: everything alone. Are you sure you'll be fine?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
