return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Le Terrible,: you know where Richelieu is?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But:n't worry about me. Le Terrible brought me some snacks.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Thanks, Jean Bart! We'll be heading back:~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Anyone can: it as long as they calm:wn and put their mind to it. With how fidgety you are, I can see how that would be hard, though.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Really, huh? Well, even if I:n't: it, someone else will take care of it.",:
			dialogShake = {
				speed = 0.09,
				x = 8.5,
				number = 2
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "Vauquelin and La Galissonnière are:ing their part. I need to hurry and finish my preparations too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "(A very old box from the Iris Orthodoxy... the seal of the Vichya Dominion was attached later. There's no sign that it's ever been opened, and this girl:esn't seem to know what it is either.)",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
