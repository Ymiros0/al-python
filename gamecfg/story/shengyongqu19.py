return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So you've figured out how to:dge my spells? Let's see how you deal my serious sorcery...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = -1,
			say = "Hey, I:n't want to deal with that at all! I mean, uh, come at me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Vauquelin, why are you:ing this...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
