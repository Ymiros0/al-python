return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Back:, Dunkerque mentioned something about being \"puppets of the Iron Blood\"...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't worry about it. Back:, it was only natural for everyone to feel distrust towards the Royal Navy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
