	...
	scripts = {
		{
			...
			dir = 1,
			blackBg = True,
			say = "Algérie, um... I:n't think I can deal with their entire vanguard by myself...",
			bgm = "bgm-cccp2",
			flashin = {
				delay = 1,
				dur = 1,
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "I can: that, but... what if they:n't stand:wn...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "(I said I'd focus on:dging, but they're coming after me a lot harder all of a sudden!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What did Vauquelin come here for:...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't know. Richelieu and the others should already be at the Basilica, and none of us seem to be injured... Wait, no...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know that... even if I apologize now, I won't be able to change what has already been:ne...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It is True that what happened to Dunkerque indeed was the responsibility of the Royal Navy, and Richelieu:es bear a portion of that burden. However...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
