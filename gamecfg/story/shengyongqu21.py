return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just what are they trying to: here? The Vichya forces have gone through all this trouble to defend this Basilica and to try to push us back... for what purpose?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Does this Basilica have anything to: with those cognitive chip-enhanced mass-produced ships?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Above them was a:me of light, shimmering like the vaulted ceiling of the Basilica, touched by the hand of the Divine.",
			flashout = {
				dur = 0.5,
				alpha = {
					0,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Miss Richelieu,: you think this is what the Vichya Dominion and the Iron Blood were after?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Whatever you:,:n't touch the barrier. Stay calm, and find a way to the Basilica where the light conjoins.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
