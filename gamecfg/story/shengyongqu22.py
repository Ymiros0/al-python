return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If this barrier was a part of Algérie's tactics,: we can assume the Vauquelin's fleet was a diversion to pull away our vanguard fleet while she planned to attack us here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Indeed. Without a:ubt, Algérie must be aiming for that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Béarn, just in case, I want you to shoot:wn some of the enemy planes into the Skybound Wall to see what happens. Algérie should still have another strategy saved up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
