return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Her Majesty said that there is much we still: not understand about the cognitive chips... Iris Libre:esn't seem to know more than we: in that regard.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I figured something was amiss. After all, enemy aircraft that I shot:wn were able to pass through the wall of light, but Illustrious's planes were running into something.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "So what: you say we... have some fuuunnn?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
