return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Algérie, you never told me what I was supposed to: in this kind of situation...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Hmm? For the fun of it, why else? Algérie told me to neutralize the carrier fleet, so I'm gonna: it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "I:n't remember anything like that... I thought I was supposed to trade my life for all their carriers...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 903020,
			dir = 1,
			say = "That's enough. Come back through the barrier. We still have a chance to win, so:n't burn your life out here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "...Fine:. Well, guess we'll have to play later.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Illustrious, Béarn,:n't chase after them. We need to regroup and prepare for the decisive battle against Algérie's fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
