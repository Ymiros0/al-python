return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Yes. Even if Iron Blood reinforcements: show up, it's very possible that the situation will devolve into an all-out brawl.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Having that said,:esn't their combat force look pretty sparse, regardless of how many defenses they've set up around here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Illustrious, not to demean the enemy, but:esn't it seem like Algérie and the others are purely fighting out of obligation?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "If we have to fight in earnest,: I must steel my resolve. We must honor the Lord in everything we:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
