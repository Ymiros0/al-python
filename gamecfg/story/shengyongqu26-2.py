return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 903020,
			dir = 1,
			say = "I want to be able to lead a fleet as large as that too... though that is a bit of a juveNonee wish.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Fellow children of the Iris, no longer should we make enemies of each other! Should we fight, we should: it together – against none other than the enemies of our homeland!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
