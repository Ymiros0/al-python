return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Welp, looks like we're outta options... Algérie, what: we: now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 901030,
			dir = 1,
			say = "Wh-what: we:? ...I knew I should've booked it when I had the chance...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Not like that would've:ne you any good. The Royal Navy is waiting for you on the other side, remember?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "How distasteful... it wouldn't be fun at all to go:wn the same way Dunkerque did...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
