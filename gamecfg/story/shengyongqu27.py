return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Back:... after the fall of the Iris Orthodoxy, we were given an impossible decision.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "...Or so I would like to say, but I:n't think there's any way to rebuild a bridge between us, wouldn't you agree?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "If Vauquelin and Algérie have nothing to say, how 'bout I: the honors instead?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Second, I:n't wanna hear your apologies... Maybe Dunkerque or Jean Bart might be interested, but y'know...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Finally, what to: about all this... Algérie, are you sure you:n't wanna use that black cube?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_qiongding_5",
			say = "And:, a drop of black ink fell upon the pure, white world.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_qiongding_5",
			say = "The black:ts quickly grew larger, covering where \"She\" was like a thin film...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
