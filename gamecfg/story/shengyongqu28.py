return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "You:n't have to tell me! Looks like things are gonna get... Actually, there's nothing fun about this situation...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "If this is going to be another repeat of what happened with Bismarck...: we must stop Algérie at all costs.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "If their goal was to recreate the legend of the Basilica,: we must avoid the third sacrament, or everything will be burned away!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But, when we fought Bismarck, the only thing we could: was sink her...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Suddenly, the lull on the battlefield was broken by a violent and indiscriminate bombardment. Streaks of dark artillery rained:wn upon Iris, Vichya, and Royal alike.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "Richelieu, what are we going to:? If we can't get Algérie back, everything's going to be destroyed!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
