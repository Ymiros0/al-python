return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 903020,
			dir = 1,
			say = "Isn't that perfectly normal? The Royal Navy and the Eagle Union both have ships like that...: there's even Sovetskaya Rossiya from the Northern Parliament.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			dir = 1,
			say = "Well, guess that's that:~ Since the Vichya is still keeping an eye on us, we'd better save the chatter for next time. Let's have lots of fun again next time?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
