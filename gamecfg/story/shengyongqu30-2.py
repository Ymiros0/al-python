return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 807010,
			dir = 1,
			say = "That took long enough. How is our vanguard fleet:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Torpedoes that:n't leave a wake... are those the Sakura Empire's oxygen torpedoes?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "No, the situation hasn't changed. If Jean Bart is with the Iron Blood,: Algérie and the others are...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "There's no point asking someone when you:n't even know who they really are...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "She calls herself my sister ship, but we:n't have enough information right now to ascertain her identity.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sacrificing your friends for the sake of an experiment... I:n't think even Bismarck would've made that order.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
