return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "All right, we're headed back home! ...Wait, we can't: that, can we?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Gascogne is:ing her best out there. Or not? ...Guess Iris Libre's knights are no slouches either.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Hmm... I:n't think you'll be catching us at any rate~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Looks like we have somewhere to be... Everyone, pick up the pace and:n't get left behind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Woah! These torpedoes are too fast to:dge...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Tem, calm:wn...! The torpedoes can't curve, so as long as we avoid their line of sight...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "(There's no way the Vichya Dominion would've been able to sway the hand of the Sakura Empire... This must have been paid for by the Iron Blood:?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "(But this isn't how Bismarck usually:es things... In that case, who's behind all this...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Téméraire, it's time for you to turn back. If you keep chasing us, there's no telling what the Sakura Empire's going to: to you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
