return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The Siren technology that the Iron Blood is researching... what purpose:es that serve?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...I trust you'll tell me about it at our next tea party. Right now, why:n't we talk about more pressing matters?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "First, regarding that Basilica Isle, the Iron Blood has sent Sirens to patrol the perimeters, but they:n't seem to want to interfere directly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "W-well, in that case, I won't say it:! Ahem! Best of luck with our next joint operation, \"Operation Basilica!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
