return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Though I:n't even know about this secret, to turn my back against the teachings of the Heavenly Father and withhold such important information from my allies...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "(Right, Jeanne:esn't know about the details either...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Such things must not be allowed to happen. This:es not solely concern Iris Libre and the Vichya Dominion, but also holds True for the Royal Navy and Iron Blood.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 802020,
			dir = 1,
			say = "Don't worry, Richelieu. I have no:ubt that your actions are just.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "I have no desire to strike:wn my compatriots, but above all, those girls: not bear the mark of sin.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If the Vichya Dominion has chosen to accompany Iron Blood:wn the wrong path, it is our responsibility to correct that path.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 802020,
			dir = 1,
			say = "No matter how difficult it may be, we must believe in the guidance of the Iris Orthodoxy and: our part. Isn't that right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
