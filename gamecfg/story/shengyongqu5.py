return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 801030,
			dir = 1,
			say = "We talked about religion, and about picnicking, and:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 801030,
			dir = 1,
			say = "I guess you're right. But teaming up with the Royal Navy... still:esn't feel quite right. Hmm...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...That's enough of the:wner talk! Let's just forget about this and let Béarn handle the complicated stuff!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
