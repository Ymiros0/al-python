return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "The best case scenario would be to convince Richelieu to rejoin us,: we'd launch a pincer attack and take out the Royal Navy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "...Should we just lay:wn our arms and surrender,:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "We can't: that. Not just because we are the proud Templar Knights of the Vichya Dominion, but given Jean Bart and Dunkerque's current state, we can't give the Iron Blood any reason to turn on us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "And since Richelieu... surely:es not want to fight us either, this is the best opportunity we're going to get.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "And:, we'll look for an opportunity to weaken the Royal Navy before going in for the kill?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
