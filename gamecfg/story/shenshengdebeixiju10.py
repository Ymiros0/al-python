return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "No, Veneto, it's not over yet. If we can take out the enemy carrier,: we can seize Malta before dawn comes. Then the Royal Navy will have their hands tied without their precious intel.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
