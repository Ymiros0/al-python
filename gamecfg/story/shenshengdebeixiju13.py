return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahahaha... It was so pleasant and warm outside that I ended up:zing off...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn, you two. It feels like it's been ages since we've all sat:wn together for tea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
