return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Ah, um... can you stop:ing that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "Ahh,: you not see the value of this opportunity? We must seize it with both hands!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Now:, Great Flagship, my sweet signora...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
