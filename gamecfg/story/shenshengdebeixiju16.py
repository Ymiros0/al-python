return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 207050,
			dir = -1,
			say = "But:n't worry, I made sure to not hit any vital areas. Just disable her, as Illustrious instructed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Warspite",
			say = "Um... w-well:ne, I suppose. We should hurry and search for this \"Jewel of Calabria\" next.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
