return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "That is the purpose of our wager here. If your Royal Navy falls here, what chance to: you stand against the Iron Blood and their Siren masters?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let me ask you:. Should we stop you here and prove that we are capable of protecting the Mediterranean, would you rejoin the Azur Lane?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
