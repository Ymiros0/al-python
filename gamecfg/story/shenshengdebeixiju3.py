return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffde38",
			dir = 1,
			say = "Makes you wonder what they were even trying to:. Doesn't it, Pola?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Vittorio Veneto",
			dir = 1,
			say = "You've all:ne well. Cesare, could you guide everyone to La Spezia? You've all earned some time to rest and recover.",
			effects = {
				{
					active = True,
					name = "weineituo"
