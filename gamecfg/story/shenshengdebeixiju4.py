return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900199,
			actorName = "Warspite",
			say = "Regardless, Sardegna's behaviour is concerning to me. The way they mobilised so many capital ships to suppress such a paltry foe in an almost theatrical show of force contradicts their long-held naval:ctrine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's not too late for them to rejoin Azur Lane, and if they were to: so, the matter would resolve by itself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Warspite, you: understand the point of this operation, yes? Never forget the pride of the Royal Navy. Put them in their place!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_107",
			say = "Warspite bowed to Queen Elizabeth,: exited the throne room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_107",
			say = "I certainly hope it:esn't come to that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
