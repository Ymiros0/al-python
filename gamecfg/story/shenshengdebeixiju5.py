return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 605020,
			dir = 1,
			say = "I see. So how:es the Royal Navy plan to act?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffde38",
			say = "To gain control over the Mediterranean, we will need to break the Royal Navy's blockade. We will need Malta in order to: so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffde38",
			dir = 1,
			say = "Veneto, what are we to: if our own flagship is this hesitant about taking action?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffde38",
			say = "If you're not going to have more confidence in both yourself and in your fleet,: you should just let me be flagship for this operation.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffde38",
			say = "If that is what you want,: so it shall be.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
