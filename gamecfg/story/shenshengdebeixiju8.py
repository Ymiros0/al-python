return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Warspite",
			say = "They claimed that they wanted to carry out this search operation at nighttime because the Sirens are supposedly more active:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Warspite",
			say = "But, it just so happens that our patrol units at Malta:n't operate at night. There's a possibility that they want to seize on that opportunity.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Warspite",
			say = "You... did what? In any case, we:n't have any proof that the Sardegnians are actually plotting something...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I have prepared countermeasures and a follow-up plan in case the Sardegnians would: anything that's not in our best interest. Oh, I've also prepared...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
