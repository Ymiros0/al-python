return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Commander, please:n't tease me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Maybe a little... But Commander,:n't you think the night sky here has its own unique flavor?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That one is Ursa Major, and the one next to it is Ursa Minor. And:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Umm... I:n't think you're right about that. Actually, I like it when things are livelier.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But since my sleep schedule is so different from everyone else's, I:n't get many opportunities to hang out with them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
