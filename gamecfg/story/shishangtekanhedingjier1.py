return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Opening my eyes, I'm greeted by a cloudless blue sky and sea that stretch to the horizon... and Shinano,:nning a swimsuit, looking abashed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "This one hopes... this unsightly appearance:esn't cause you offense...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Ah... No, it's alright. Please: continue...",
			painting = {
				alpha = 0.3,
				time = 1
			},
