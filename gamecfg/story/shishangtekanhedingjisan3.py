return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_142",
			hidePaintObj = True,
			say = "The drops of water rolling gently:wn the petals are proof of how well they're cared for.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "You're:ing wonderfully at the tea ceremony and caring for the flowers. Good job.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
