return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_128",
			hidePaintObj = True,
			say = "Albion looks:wn just slightly and thanks me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Words can display emotion. Even if you:n't know the origin or background, you should be able to read between the lines a bit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "What: you think now that you've heard the rest?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = "headtouch",
			say = "Why:n't we let it mark a fresh start to our night together?",
			painting = {
				alpha = 0.3,
				time = 1
			},
