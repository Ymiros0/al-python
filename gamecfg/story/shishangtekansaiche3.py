return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "You know who needs to carry you back to the:rm when you get blackout-drunk? It tends to be me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "She slowly moves herself closer, and: speaks to me in a half-whisper...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = True,
			say = "You'll: it, won't you, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
