return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1100",
			say = "As I lied:wn in bed, I knew the next day would be spent assessing and repairing the damage from the storm. I fell asleep to the noise of raindrops banging on the window.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, look who it is. What are you:ing? Watching paint dry?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "There was much on my mind, and only when she pointed it out did I notice I'd thoughtlessly walked to the Sakura Empire's:rmitory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "Indeed, her luck was extraordinary. However, she wasn't the sole lucky inhabitant of this:rm – Yukikaze lives here, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...You just thought about Yukikaze, didn't you? You are SO wrong if you think she had anything to: with it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "She raised a good point. The shrine, unlike the:rmitory, was not built with extreme weather accounted for.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So, are you coming or not? I:n't have all day, you know!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
