return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_129",
			say = "\"I'm going around the port and:ing damage assessment. Shigure told me to come along.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Of cooourse! Right, Commander? I mean, you wouldn't refuse me if I asked you to: it, would you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_129",
			say = "They needed help, and it had to be:ne eventually anyway. I told them yes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
