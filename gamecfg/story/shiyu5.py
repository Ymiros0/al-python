return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			bgmDelay = 2,
			say = "Breaktime's over, Commander. We've still got to find that dumb:g!",
			bgm = "story-1",
			flashout = {
				black = True,
				dur = 1,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_room",
			say = "Shigure was right. The sun would set before long if we didn't find her. We gave our thanks to Yamashiro and Fusou,: resumed our search.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_129",
			say = "She sang her friends' praises before: tooting her own horn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Like you, Commander. You hate being lonely,:n't you? Which is why I'm even giving you the time of day! And I expect at least a \"thank you\" for it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_129",
			say = "Even though she prompted me to: it, I did feel grateful towards her. I said my thanks, after which she turned around, satisfied, and started walking again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
