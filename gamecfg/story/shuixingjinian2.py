return {
	...
	scripts = {
		...
		},
		{
			...
			say = "I open her:or, and immediately feel like I'm stepping into a warzone. Candy bar wrappers and empty bottles of soda are strewn all over the place, and her shelves look like they haven't been organized in ages.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Wait, hold up, what are you:ing?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"Sorry, but you should take a break every now and:.\"",
					flag = 1
				}
			}
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hmph. I AM taking breaks! What: you think I'm:ing right now?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll: as you say! If you can beat me in a game, that is!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That:esn't count! You just got lucky! Come on, rematch! Best of three!",
			painting = {
				alpha = 0.3,
				time = 1
			},
