return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "I was just about to call Avrora when I hear the familiar sound of boots clopping:wn the hallway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Why would I: that? You never said anything about a specific time I had to be in your office, so that's on you~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Ahaha♪ In my defense, I had to: a ton of stuff to prepare for my new position.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Great~ Let's start on this stack of:cuments:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Come on,:n't just sit on your butt, Commander! We've both got work to:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
