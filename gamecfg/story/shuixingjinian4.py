return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Lastly, there's the open sea exercise report. All you need to: is read through it and: sign off on it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "And that's that. I've:ne pretty much everything you asked for. Way to go me, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Oh, forget it. Just know that I want some more of that \"ramen\" as a reward for my hard work! Take me to a restaurant once we're:ne today!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Now chop chop, Commander! There's still tons of work to be:ne!",
			painting = {
				alpha = 0.3,
				time = 1
			},
