return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Though I have already gotten a lot:ne, the amount of paperwork pending my review and approval is staggering.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Nevertheless, I have to keep chipping away. Just when I go to pick up my pen again, I feel something soft press:wn on my head.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "I'm gonna sit on your lap. Can't get any work:ne now, can you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "...Don't give me that look. I'm tired too. All I'm:ing is resting on you instead of a pillow. Nothing wrong with that, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Her long, smooth hair drapes:wn right in front of me. My chest and thighs, where she's resting against me, won't stop singing praises of her softness.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "You're comfier than any high-end chair I've sat on. I seriously need to: this more often, hehe~♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
