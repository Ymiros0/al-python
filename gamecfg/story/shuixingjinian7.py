return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_108",
			hidePaintObj = True,
			say = "If she was this good all along...:es that mean she threw the game back when I visited her room?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Heheh! Tell me more about how great I am! Bow:wn for bonus points if you want!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_main_twilight",
			hidePaintObj = True,
			say = "Pamiat' skips along excitedly as we head back to the:rms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "I sit:wn on the bench. She huddles up right next to me, resting her head on my shoulder in a sweet manner.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You work hard on weekdays: get to play even harder on weekends!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "As long as that stays True... I:n't mind staying your secretary forever, to tell you the truth.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Just:n't expect me to work for free, and:n't make me: overtime♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Shh,:n't argue, just close your eyes for a sec.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I was gonna give you a reward, but I guess you:n't want it~",
			painting = {
				alpha = 0.3,
				time = 1
			},
