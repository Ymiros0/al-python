return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't? I see... Seems like there's not much to: today...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I mean, yes, I'm not:ing anything at the moment, and that's not a strange question, but...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "\"What I want to:\"... What exactly could that mean?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
