	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"<size=51>\"Once you:, you'll feel less lonely!\"</size>",
					6
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What the Commander said... \"What I want to:\"...",
			effects = {
				{
					active = True,
					name = "memoryFog"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Spee? What are you:ing over there?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "I wound up having to listen to Deutschland's complaints all the way back to the:rm.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
