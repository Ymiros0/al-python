return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Say again? We're:ne already? But my main guns are only just starting to heat up!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "By the way, I: joint exercises with the Scharnhorst sisters every week.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "Maybe my battle buddies would know what the Commander really meant by \"what you want to:.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "Never step:wn, no matter who you're dealing with – that's my style.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "\"What I want to:\"... That's a good question.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Since you asked, Spee, what: you want to:? Do you have any dreams?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I... There's nothing in particular that I want to:. As long as I'm allowed to stay here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_nepu1",
			say = "Yeah... As long as I'm surrounded by people I know and not all alone, like back:, I'll be fine...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
