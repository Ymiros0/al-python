	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"<size=51>\"And I:n't just mean someone who listens to what you say.\"</size>",
					3
				},
				{
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"What I want to:\"... It might be a good idea to ask Eugen what the Commander meant.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Honestly, I'm satisfied with the status quo. Ah, but if you'd like, I could look for something to:. It seems like it could be fun.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "People like you, well... The moment you find out there are more things to life besides fighting, you end up not knowing what you want to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "End up... not knowing what I want to:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then... how: I find things I enjoy:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
