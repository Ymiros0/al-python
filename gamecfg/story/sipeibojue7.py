return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "What am I supposed to: here...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "The Commander walked over and whispered that into my ear,: went back to Deutschland.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's fine. This all boils:wn to a silly ego battle with this lowly animal anyway. If that's what you say,: it's fine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Even if I fight to protect them, that:esn't mean fighting is all there is to it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
