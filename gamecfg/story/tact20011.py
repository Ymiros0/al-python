return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			nameColor = "#ff0000",
			say = "Listen up, you fools standing before the Shark Sisters! This is where our hunt begins! And:n't you dare disappoint me!",
			shake = {
				speed = 1,
				number = 3
			},
		...
		},
		{
			...
			hideOther = True,
			nameColor = "#ff0000",
			say = "Scharnhorst-class battlecruisers Scharnhorst and Gneisenau, ready for battle! Come and face your:om!",
			subActors = {
				{
					actor = 404020,
					pos = {
