return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			nameColor = "#ff0000",
			say = "Guess it's just like the intel said. The wind:esn't blow out here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			nameColor = "#ff0000",
			say = "Feels like the pressure's way higher than on the outside too... This:esn't feel right...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
