return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			nameColor = "#ff0000",
			say = "Yeah... I:n't know how this fleet managed to appear again when it:esn't exist anymore... The situation is even worse than I thought.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff0000",
			actorName = "Observer",
			say = "So what: you say about becoming my new Pawns? I could turn you into a new species so we can gather more fascinating data.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			nameColor = "#ff0000",
			say = "U-47, go on without me... The enemy shouldn't be able to follow us:wn to our maximum depth...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff0000",
			actorName = "Observer",
			say = "Now, how: you plan to get out of this one, little Miss. Left Behind?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
