return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			nameColor = "#a9f548",
			say = "*Phew*... Looks like it's finally started to cool:wn a little bit tonight... It's way too humid and hot here, and the sun is oppressive as well. If not for this mission, I would have booked it long ago.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
