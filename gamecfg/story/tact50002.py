return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actorName = "{namecode.54}",
			say = "If you understand,: let's go moving. Choukai and the others have already begun to engage the enemies in the north, so we should join up as soon as possible.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
