return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			nameColor = "#a9f548",
			say = "Okay~ In that case, why:n't you take off your blazer and pass it over to me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			nameColor = "#a9f548",
			say = "We're in the tropics, after all. This is just how the climate is all year 'round. At least it cools:wn at night.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			nameColor = "#a9f548",
			say = "Also, going on patrol is tiring and boring... Why: we have to run around when Enterprise and the others could handle it?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			side = 1,
			nameColor = "#a9f548",
			say = "Quincy knows everything,:esn't she? Is she becoming a better big sister than me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
