return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			nameColor = "#a9f548",
			say = "Dele... gation? What:es that mean?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			nameColor = "#a9f548",
			say = "For the time being, I'll issue an alarm to mobilize all our forces, but I:n't think reinforcements are going to be able to make it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			nameColor = "#a9f548",
			say = "You:n't need to explain that to me! The enemy's right in front of our eyes!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
