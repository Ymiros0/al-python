	...
	scripts = {
		{
			...
			say = "Phew, looks like it's over. As expected, there's no one who can match our expertise in night battles. Should we finish chasing:wn those transports?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "Aoba, Furutaka,:n't gloat too much. I'm wary as to why the enemies were so underprepared. Plus, their air support hasn't shown up yet, so we should consider ourselves lucky.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "You have a point. By the way, before we left, who was it yelling \"I absolutely:n't wanna go?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actorName = "{namecode.69}",
			say = "Unfortunately, there are no \"if's\" in the world. Let's go, there is only so much we can: tonight. It's a pity that we couldn't stop the enemies from landing, but I won't give up here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
