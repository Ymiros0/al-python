return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "A new batch of reports rests atop my desk. I reach out to read one, but:, out of nowhere...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Queen Elizabeth vigorously throws open the:or and dumps a stack of papers on my desk.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What: you say to that? It'd foster healthy competition in a race to provide the customers with the best service.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Very well, I approve of this idea. As: you, right, servant?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"Wait... Who said anything about winners and losers? Do we really have to: that?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We have an agreement:. Better start setting up our respective shops, hmm, Queen?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Belfast bows gracefully to me,: she and Elizabeth leave my office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
