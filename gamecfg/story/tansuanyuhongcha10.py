return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405012,
			say = "If you'd like us to: that,: it can be arranged.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That's what we asked you to: – decide which store you, personally, like the most.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"I:. There's much I'd like to say as a preface to deciding the winner...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
