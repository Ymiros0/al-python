return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_coffeetea_3",
			say = "\"I'm just dropping in to see how you're all:ing. Don't mean to disturb you, so I'll be on my way now.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Bismarck",
			say = "Hmm... We still have leftovers in the kitchen,:n't we?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
