return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_150",
			say = "Surprisingly, I'm greeted by Noshiro of all people. She gestures for me to step inside, which I:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Queen Elizabeth",
			say = "Your seat is over there. Sit:wn, servant.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Queen Elizabeth",
			say = "What: you think of that, servant? You have the final say in the matter.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
