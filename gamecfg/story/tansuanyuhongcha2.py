return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If anyone has ideas or suggestions,:n't be afraid to share them right now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The Royal Maids are experts when it comes to service. I:ubt we'll beat them when it comes to that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "So our efforts should go into our menu. The Commander is a known fan of Iron Blood coffee, so why:n't we center our theme around that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 403100,
			say = "A cage of death. Perfect for burning calories after you wolf:wn a bunch of pastries.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
