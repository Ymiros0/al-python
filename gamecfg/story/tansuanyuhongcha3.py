return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I am certain beyond a:ubt they will base their entire strategy on us fielding the Royal Maids, as one would expect.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What is a maid supposed to:? I've never worked as one. Someone will have to teach me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 202070,
			say = "Will:! Thank you for this honour, Your Highness!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Certainly. Ladies, let us try a small exercise. I want you to imagine this room is the teahouse,: I want you to conduct yourself as you believe a maid would.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Don't be afraid to make mistakes. Everyone:es, initially. For now, any amount of practice is good.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 205090,
			say = "Goodness, a maid's work is much harder than I thought... Thanks for everything you:, Belfast.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Think nothing of it. The other maids and I are only:ing our jobs.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
