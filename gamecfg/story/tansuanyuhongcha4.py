return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If you want to kick back and relax,: you should visit The Royal Tea instead.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "Whether Albacore meant to or not, her shrewdness got Penelope and Leipzig to back:wn. Now I can finally move on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
