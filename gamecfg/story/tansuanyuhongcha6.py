return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_150",
			say = "Upon opening the:or, I'm immediately greeted by the harmonious sound of violin music.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_150",
			say = "Southampton comes into the room, violin in hand and:nning a maid uniform.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_150",
			say = "\"The music adds so much to the atmosphere. I love how you can hear it in here even when the:or is closed.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 202072,
			say = "And I'd better get back to work. Breaktime is over. Please: enjoy the rest of the performance, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
