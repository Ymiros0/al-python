return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_coffeetea_2",
			say = "I turn my attention from Elizabeth to Howe and Penelope, watching quietly while they put things:wn on the table.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_coffeetea_2",
			say = "I: as urged and drink the tea Penelope poured for me. It tastes pretty good. I'd gladly have another cup.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
