return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you continue to sleep,: I'm afraid you'll be eating breakfast alone your Majesty.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.13}",
			dir = -1,
			say = "{namecode.14},:n't look at me that way, enough I get it already, I'll learn how to bake scones the way Edinburgh makes it—— Even though I might not be able to make it as tasty.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
