return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Cygnet, what are you and Edinburgh:ing? Your faces are all dirty, come here and let me wipe off the dirt.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We are adding tea leaves to our baked sweet potatoes,: you want to try, Hood?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "R-really? We thought that peeling sweet potatoes would be below what the eloquent Hood would tolerate to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Laughs) Who exactly: you think I am? If peeling sweet potatoes is below me,: that kind of eloquence—— must be some kind of bluff.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "When no one is available to make food or go out to buy snacks for the tea party,: roasting sweet potatoes is the easiest option!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ha, this is called sharing happiness with commoners. On occasion, we should mingle and: what the common folk are:ing.~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
