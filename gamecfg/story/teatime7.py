return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "No, please:n't force other people to eat food which they: not like!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, your Majesty, let’s exchange our sweet potatoes:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahh,: you all went to be fed?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah,: I'll take my leave as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
