return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Nee-sama, I can't: that! What if the enemy attacks while we're unprepared?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=51>To let my guard:wn... at such a critical time...</size>",
					6
				},
				{
					"<size=51>…</size> ",
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Speaking of which,:n't you agree we would be more evenly matched in a wargame than in a board game?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
