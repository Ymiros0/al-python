	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"<size=51>If this is to be my fate,: at least let me meet my end on the battlefield.</size>",
					10
				},
				{
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(However, sending a hastily cobbled-together fleet into Siren territory is extremely ill-advised... What should I:...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "*Gasp* *Gasp* ... Houshou,: you have... some spare time?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Eh? Kaga? B-but I only learned how to use these planes recently... I:n't have any real combat experience...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't quite understand the situation, but for you to be this desperate... I'll see what I can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "As her words vanished into the wind, over a:zen aircraft began to materialize from Houshou's flight deck, encircling the sky above her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
