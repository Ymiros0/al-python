return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Please:n't overexert yourself, Amagi. You should leave the front lines to us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = -1,
			side = 2,
			say = "Amagi bent:wn to pick up a piece of tattered cloth from the water's surface. Without a:ubt, it was a piece of Kaga's outfit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
