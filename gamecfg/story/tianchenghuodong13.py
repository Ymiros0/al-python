return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 304050,
			dir = -1,
			say = "The recon plane was most likely shot:wn by the Sirens. Since none of the other planes have been able to locate Kaga so far, heading towards 9 o'clock is our best bet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Y-yes ma'am! I will: my best!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
