return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Sensing an opportunity, a Siren aircraft swooped:wn towards the disabled Amagi, screeching as a bomb emerged from its underside.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "There was a flash, and: a terrible explosion-",
			flashN = {
				color = {
					1,
					1,
		...
		},
		{
			...
			actor = 304050,
			dir = -1,
			say = "*cough* ... You fool... why didn't you:dge...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Kaga turned to survey the fleet - battered, bruised, and running out of ammunition. As their anti-air fire dwindled, more and more bullets began to rain:wn around Kaga and Amagi.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "At this rate, we're all going to be wiped out! What should I:?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 305070,
			dir = 1,
			say = "Amagi, surely you:n't plan to lose here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Caught off guard, the Siren aircraft were mowed:wn until not a single one remained.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll: as you said. I'll return to port and become the strongest sword of the Sakura Empire, able to cut:wn any foe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
