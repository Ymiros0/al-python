return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "She finally regained consciousness just earlier, but I:n't have much more good news for you. She's going to need more rest, and won't be taking any visitors today.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			dir = -1,
			blackBg = True,
			say = "There's... just one more thing left to:... please...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			blackBg = True,
			say = "Of course. I will make sure it is:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Those of you who wish to leave a strong impression,: your best to display your formidable power and your graceful technique!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
