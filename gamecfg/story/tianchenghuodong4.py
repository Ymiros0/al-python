	...
	scripts = {
		{
			...
			dir = -1,
			stopbgm = True,
			say = "It's over. There's nothing one can: when facing superior firepower.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			dir = -1,
			say = "If we can gather some new insight, or even learn what not: in the future, that would make this exercise a success. ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			dir = -1,
			say = "This is what happens when I:n't exercise for so long... *Cough, cough*... I feel like I could faint... ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
