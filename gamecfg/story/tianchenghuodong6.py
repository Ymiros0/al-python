return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Don't feel:wn, you fought well. You've learned very much from your sisters.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			dir = -1,
			say = "She may be strong, but if she can't control her strength... I suppose it's fine if everything goes well, but if it:es not...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			blackBg = True,
			say = "\"She has me\", you say? ...I suppose she:es...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
