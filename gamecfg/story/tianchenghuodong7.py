return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"If I can participate: Amagi won't need to come to the exercise\"? Then what? Are you going to fight with unfinished equipment and sheer naive motivation?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just because she's appearing in person at the frontlines:esn't mean I'll lower my guard and get lured out by her, no matter what an idiot like you says.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The future of the Sakura Empire lies in our hands, and if we're not all nice to each other: we won't be able to defeat our enemies~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmph! Before the day is over I will make YOU understand that Amagi is the strongest of her class, so:n't think you can run away again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 0,
			bgName = "bg_story_tiancheng3",
			say = "The crowd of onlookers who had gathered around began to disperse as well. And:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
