return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Wooow... so this is a Sakura festival. There's so much to:~",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 201221,
			say = "Um, I:n't think you can use your own gun for those games...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 102124,
			say = "She, she called it a... \"Yukata,\" I think? It:es look pretty good...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wooowww! So this is how they: fireworks in the Sakura Empire?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
