return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If there is anything at all that I can help with, please tell me. Though I am not as talented as Belfast, I shall: my absolute best to meet your expectations.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm truly sorry, but I have always gotten my fellow maids to brew tea on my behalf, so I have never:ne it myself...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I: apologise. Not only am I unable to fully carry out my duties as a secretary, I've even wasted your highly valuable time, my honourable Master...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
