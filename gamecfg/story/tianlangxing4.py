return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't know how useful our advice would be, but we could maybe teach you something.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I have:ne a general background check on all of the attendees, and my survey of the perimeter's defences and emergency escape routes is 90% complete.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If there is anything I may have not accounted for, please: let me know.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That should be everything. Oh, right, I nearly forgot to ask an important question.: you have a dress prepared?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
