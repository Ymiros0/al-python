return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_battle_night",
			say = "That decision I made in the banquet hall came from my trust in Sirius and the knowledge that if anyone could: it, it would be her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_battle_night",
			say = "And so, Sirius,:nning her white rose dress, made her triumphant return.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No matter the attire I may wear, I will always be your maid,:ing everything in her power to fulfil your wishes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
