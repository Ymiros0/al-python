return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 607010,
			say = "Is there anything I can: to help?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "The latter pair were standing next to the copying machine, humming cheerfully while carefully copying the:cuments they were given.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "...But for whatever reason, they were stuffing the:cuments back into the same old mess of a drawer that they came out of.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Look what I can: when I get serious, Commander! Praise me, praise me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 601020,
			say = "Um, Miss Aquila, you shouldn't just stuff the:cuments back into the drawer...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 607010,
			say = "Did I mess up? I thought I was just:ing what Libeccio told me to...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 601040,
			say = "Libeccio, what in the world are you:ing?! Jeez, y-you even got Miss Aquila to...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "After the slight interruption, the workflow was corrected and the:cuments were soon organized correctly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Whatever Aquila was missing, it certainly didn't seem to be her ability to get work:ne...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
