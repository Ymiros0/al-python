return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait, this is the secretary ship's duty. I'm fine:ing this on my-",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Besides, isn't it obvious that comrades should help each other out? Everyone else:es the same!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well, I'll be leaving:! More Justice awaits!",
			paintingFadeOut = {
				time = 0.5,
				side = 2
			},
