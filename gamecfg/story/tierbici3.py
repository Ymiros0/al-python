return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh, it's Eugen... My aim is nothing praiseworthy. You and Hipper are also:ing quite well, aren't you?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "My, aren't you modest. Did you hear that, Hipper? You'd: well to learn from her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, you've got nothing to: with this! Eugen! Stay there! Don't run! Today's the day I'll make you understand that I'M the matriarch of the Hipper class!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
