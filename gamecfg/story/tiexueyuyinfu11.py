return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 205050,
			dir = -1,
			say = "By the decree of the Queen, you are to lay:wn your arms and come with us. You shall have a fair trial in our courts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffde38",
			dir = 1,
			say = "So, is this how the Royal Navy:es things, O \"Sailor King?\"",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			actor = 405010,
			dir = 1,
			say = "Tell me... You may be cutting edge warships, but: your hearts even know the thrill of battle?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205050,
			dir = -1,
			say = "She:esn't have the ammo for this. Fear not, our enemy is on her last legs!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
