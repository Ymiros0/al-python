return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 205050,
			dir = -1,
			say = "We won't be able to:dge in time! Brace for impact, everyone!!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 405010,
			dir = 1,
			say = "I:n't know what you're plotting, Siren...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "You are so small, so insignificant. Even if I was to tell you, you: not even have the power to choose your own destiny.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "If you are able to transcend your limitations as \"Bismarck\" and become one with your \"alter ego,\" perhaps: you may find your answer...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Until:... we shall be awaiting your little dance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
