return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffde38",
			dir = 1,
			say = "Bismarck, could we slow:wn a little? It's pretty unpleasant to cruise at full speed on these harsh waves.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffde38",
			dir = -1,
			say = "Don't underestimate them. I:ubt the Royal Navy would stand on the sidelines and wait around after what happened.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#ffde38",
			dir = 1,
			say = "Sorry, no can:. I'm running on fumes. You should take a moment to catch your own breath, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
