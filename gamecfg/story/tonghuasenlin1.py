return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "There are so many better things you could be:ing, nya. So many more fun things, nya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It'll be free of charge just like last time since you'd be:ing us a favor, nya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I've asked a Royal Maid to brief you this time. If you have any questions for her::n't be afraid to ask, nya.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Correct. Staff members will join your party during this adventure, and they will essentially try to guide you:wn the right path.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm sure you:n't want to listen to me talking all day long, so please head on inside and have fun, Master.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
