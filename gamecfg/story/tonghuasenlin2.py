return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So please, help me get back home! I:n't want to be wolf food! I'll: anything you ask in return!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_158",
			say = "After walking for a while, we came across a cabin amid the trees. On the other side of the:or was a place lined with mirrors in all directions.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_158",
			say = "Everywhere I looked there were:ors and corridors reflected in the mirrors, and there was no telling which led to the exit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Tell me, why: you need to traverse through this maze?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You will?! That's so kind! But I wonder – how long: you wish to play?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_158",
			say = "\"What, just like that? I didn't: anything, and you're letting me move forward?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
