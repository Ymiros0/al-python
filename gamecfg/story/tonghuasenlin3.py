return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Now come into the castle, quick. We:n't have much time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_158",
			say = "She dropped:wn a ladder from the balcony to me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The problem is, I:n't how long it is until their shift change, and there's nothing in this hall that tells the time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Comman– I mean, my love,: you have any ideas?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "We're almost there, my love! Freedom is just past this:or!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If I said this is as far as you'll go, what would you:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Let us hear your answer. What: you say?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "\"We'll: as you ask.\"",
					flag = 1
				},
				{
					content = "\"Feed someone a poisoned apple? I:n't think so.\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "What you think is unimportant. You will: it. Exercise caution, as Snow White is not so easily fooled.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
