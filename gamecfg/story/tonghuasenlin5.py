return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yes, I'm sure of it now – you're not the wolf. You:n't even have jaws big enough to eat me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Remember to close the:or on your way out. Le Malin insisted I should rehearse in solitude.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Close the:or for me, and you may take that spare red hood by the entrance for yourself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
