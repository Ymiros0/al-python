return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "Sometimes, she produces some sort of lab report and writes something:wn. She rarely ever talks unless spoken to first.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "I did that long ago. It felt like plain busy work... Hehehe... You underestimate me,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "Now if you:n't mind, I'd like to be left to my devices...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "When you think about it... Staying out of your hair counts as helping you: your paperwork, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"Doing nothing:es not count as helping.\"",
					flag = 1
				},
				{
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			optionFlag = 1,
			say = "She takes back the organized folder,: shuffles back into her dark corner...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Fine... I:n't wanna, but if you insist...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Suddenly I:n't feel like surveying your office anymore... Oh well, I'll go back to my corner and get to work.",
			painting = {
				alpha = 0.3,
				time = 1
			},
