return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "It's time for a break, so I raise the idea of going on a stroll with Torricelli. To my surprise, she:esn't want to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "Not really... I just:n't want to run into someone I know, because: I'd have to say hi and that stuff...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608010,
			say = "Um, that's not to say I:n't like going out with you. That's different. But...",
			painting = {
				alpha = 0.3,
				time = 1
			},
