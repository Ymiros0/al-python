return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_outdoor",
			dir = 1,
			say = "\"What are you:ing out here all by yourself?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_outdoor",
			dir = 1,
			say = "For a moment, I forgot all about the stress of my job. I sat:wn next to U-47 and appreciated the calming sound.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_outdoor",
			dir = 1,
			say = "She bluntly announced her departure,: got up to leave.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_outdoor",
			dir = 1,
			say = "\"Quiet? It's pretty far from the:rms, so I suppose so...?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_outdoor",
			dir = 1,
			say = "She gave a concise response,: resumed her walking and left the pier.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "And:, it was just me. I stuck around for a while longer, simply taking in the sound of the waves.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
