return {
	...
	scripts = {
		...
		},
		{
			...
			say = "I was:ing work in the office, when suddenly someone came knocking on my:or.",
			dir = 1,
			bgmDelay = 2,
			bgm = "story-1",
			flashout = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"It's fine, I'm not:ing anything particularly important. You can stay as long as you want.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "She was just sitting on the couch by the:or, not making a single peep. Feeling curious, I walked over to check on her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
