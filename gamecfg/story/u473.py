return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"Ah, you're welcome. By the way,: you have a straw? There's none on the carton.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "She shrugged,: started scouring the bookshelf for something to read, like yesterday. Meanwhile, I got a glass and poured the milk into it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"There's nothing I desperately need your help with, but I appreciate the offer. For future reference though, what: you excel at?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "She was content to leave it at that, and: pulled out a paperback from the bookshelf.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Just like yesterday, she sat:wn on the couch and began reading in silence.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't help around the office, but you still left this book here just for me. You're really quiet, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't get me wrong, I:n't want you to start running your mouth. I like peace and quiet, so I'm fine with that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "\"You:n't need to exchange words to enjoy each other's company.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "She briefly echoed my sentiment,: focused her attention back to the book.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
