return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "I was staring idly at her. Sensing this, she turned around, and our gazes met. Just as I remembered I should start working, I heard a banging on the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "A voice yelled from beyond the:or, breaking the peaceful silence up to that point.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Startled by this abrupt noise, I got up and opened the:or. U-81 immediately sprung inside.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "U-81 sat:wn on the couch with a disgruntled expression. I watched her as I returned to my desk to sit:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What're you:ing, Commander? Don't you have work to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Trying to avoid making U-81 suspicious, I sat:wn in my chair and positioned my legs so they wouldn't bump into U-47.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "U-81 apologized,: promptly darted out of the office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "\"It's no big deal, so:n't worry about it. But why were you hiding from her?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's not to say I:n't like them, it's just... I'd rather bail when things get rowdy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "She explained herself,: sat:wn on the couch and picked up her book where she left off.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
