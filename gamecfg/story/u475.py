return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, I know, I'm the seeker. Could you pipe:wn? Commander's trying to work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll just keep to myself... Lord knows what damage my bad luck could cause if I: anything else...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "The trio couldn't seem any more different, but U-47 did say she:esn't dislike them, so I assumed they were at least on friendly terms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "U-47 closed the book she was reading,: rose from the couch and walked over to the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'd like some time alone first,: we can practice. I'm kinda in a restless mood right now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah, she's not much of a team player... My biggest concern is just making sure I:n't mess up during the battle...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Any advice on what we should:, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
