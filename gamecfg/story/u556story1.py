return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I found the:or unlocked... had I forgotten to lock it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "It turned out all the books and:cuments I needed to organize had been haphazardly stacked about the floor.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "The:or was unlocked when I got here, so I figured I'd see if there was anything I could: before you showed up, Commander!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But it turns out all this stuff here is really complicated and I:n't get it at all. I never knew a secretary ship had to: so much reading...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "*Pant* ... *pant* ... You'll teach me what to:, right, Commander? Fantastic!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hm? That:esn't look right. Don't tell me I forgot... oh this one isn't right either. Neither is that one. Or this one. But this one should be...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
