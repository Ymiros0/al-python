return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "At first, U-556 needed a lot of guidance in performing her secretarial duties. But by mid morning she knew what she was:ing and was ready to help with a workload a bit heavier than usual.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Commander? What's wrong? Why: you suddenly look all serious...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "U-556 seemed like she understood what we were:ing. So I took advantage of her enthusiasm and gave her some simple things to work on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Just hand this over to Akashi:wn at the shop? I'm on it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "U-556 snatched the:cument out of my hand and flew out the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
