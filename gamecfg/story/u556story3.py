return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Oh yeah! Tomorrow's a day off so why:n't you come play with us, Commander? You know working all the time is bad for you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "I made my way back to the office and quietly closed the:or. Locking it would be against the rules, but I was already confident I had a perfect hiding spot.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "All I had to: was wait out the end of the game. Not to mention this was a great opportunity to get some work d-",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "I determined that U-81, hide and seek pro that she was, would no:ubt have a masterful hiding spot.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 3,
			say = "I determined that hiding in plain sight would be the best move. All I had to: was wait for U-556 to head off in search of the others, whereupon I would simply march up to the starting point and declare myself safe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I really:n't think the bathhouse pool is that good of a hiding spot...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
