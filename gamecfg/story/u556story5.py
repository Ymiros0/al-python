return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "She: gathered up some squadmates as quickly as she could and set off for the source of the distress signal.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_night",
			say = "It was a False alarm. I had them send the device off to the eggheads for inspection. No:ubt Yuubari and her team could work it out.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Listen, U-556, I get that you take your promise seriously. But I really can handle myself without you. You:n't have to worry.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Kinda harsh,:n't you think, Bismarck?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
