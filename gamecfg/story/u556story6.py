return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "You know,:n't you, Commander? I told you before, Bismarck and I made a \"Promise.\"",
			bgm = "story-2",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "No, no, you didn't: anything wrong. It's my fault for being such a brat and bothering you all the time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "U-556! On the honor of the Parzival name, and before Neptune, lord of the seas,: you swear.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
