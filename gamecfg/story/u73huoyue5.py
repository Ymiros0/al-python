return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You see, U-73, the explosion happened because you mistreated the reagent for another. This is how you: it, see?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I had no idea you could even: that...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If you ever have any questions,:n't hesitate to come to the science department.~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
