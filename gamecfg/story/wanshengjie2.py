return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The atmosphere seems to be more tense than last year... {namecode.6}, what: you think?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "W-wait, waitt!! Don’t you all ought to knock on the:or before entering!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			say = "Hey, if I win the duel this time,: you gotta help me!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
