return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "{namecode.20}",
			dir = -1,
			say = "As long as {namecode.19} made these,: no matter how bad they taste...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.19}",
			dir = 1,
			say = "Idiot, as long as you can taste the most delicious pumpkin pies,: I:n’t care about playing!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
