return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_162",
			say = "It seemed I'd loosened up so much on this rare day off that I'd laid:wn and fallen asleep on a bench.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll be a good girl, I promise! Please:n't abduct me!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
