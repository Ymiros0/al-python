return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Now, let's go in this room, lock the:or, turn on the phone signal jammer... Heehee! Now nobody can interrupt us.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well alright, lie:wn. We're gonna heal all of ya fatigue. Swallow this, and get ready for the full healing experience!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_162",
			say = "\"Wait, you're actually:ing this? It's not an act?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ehehe... You can't escape, so just relax and let me: all the work.",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
