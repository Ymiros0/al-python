return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Who: ya think you are, running in out of nowhere and demanding him from me?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That's my line! Why: you get to monopolize him outta nowhere?! If you're plannin' somethin' untoward—",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "Explain everything to calm them:wn",
					flag = 1
				},
				{
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "Ahahaha... What:es it mean for a shipgirl to be another shipgirl's first mate?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_162",
			say = "\"What: you mean by 'that time'?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But:n't you worry! We'll have plenty of chances to see each other! Our date can wait until next time, Commander!",
			hidePaintEquip = True,
			painting = {
				alpha = 0.3,
				time = 1
