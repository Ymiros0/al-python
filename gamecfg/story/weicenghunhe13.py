return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102270,
			dir = 1,
			say = "(At this rate, our supplies are going to get whittled:wn... What should we:...?!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Cooper, could you tone it:wn a notch? I can't focus with you constantly yelling \"Cyclone Smasher!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107110,
			dir = 1,
			say = "(...or maybe not. I'm sure she's thinking hard about what Enterprise would: in this situation.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Enterprise, if you were here right now, what would you:...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...I've got it! If the Sirens did in fact create a Mirror Sea here,: the core must be located somewhere!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we break that core, whatever it is,: that should also dissipate this heavy mist.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
