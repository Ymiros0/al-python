return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll make sure to: better next time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't need to state the obvious...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(Damn it, Intrepid! You're always ruining everything! You're always messing up! It's always you being sent to the:cks!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "*glug* *glug* (Who the hell would: that...?! I'm drowning over here!)",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Woah woah,:n't get mad at me! I'll carry you up right now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
