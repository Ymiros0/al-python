return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't think that's likely. Normally, all communications are cut off from the Mirror Sea. However, I've been receiving a string of messages.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "In other words, their communication equipment started to fail after entering the fog, and: they encountered Sirens... This sure:esn't smell like a coincidence to me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I agree... What: you think, Enterprise?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "However, given the present conditions, we:n't have a lead as to where to start searching, and we can't cover this entire area.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "For the time being, let's head back and join up with the stronghold reinforcement fleet. We can organize our information and: draft a rescue plan.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
