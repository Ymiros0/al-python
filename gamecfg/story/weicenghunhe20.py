return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When'd they surround me...?! Shoot, is this the end? What should I:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This'll:! If I remember correctly, that one large Siren was...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_underwater",
			say = "After a while, when the waters finally calmed:wn...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
