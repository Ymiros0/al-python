return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "The enemy's aerial ambush was quickly mowed:wn by the combined anti-air fire of the Atlanta and Oakland-class ships.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "How:es a huge wave like this appear out of nowhere?! Hang on, everyone!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
