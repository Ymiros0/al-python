return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 101440,
			dir = 1,
			say = "And:n't forget to make one for me! I've always been afraid of not having the right tools for the job even though I already have my special move!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 103240,
			dir = 1,
			say = "\"It's not the superpower that makes the hero, but rather the super things that they:.\" Isn't that right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102260,
			dir = 1,
			say = "And right now, the heroic thing to:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
