return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_banama_2",
			say = "With the arrival of unexpected reinforcements, Enterprise struck:wn enemy after enemy with no burdens in her heart knowing that her friends were safe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
