return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't have to read off the script, you know...",
			effects = {
				{
					active = False,
					name = "speed"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Allen M. Sumner-class destroyer, Cooper here! You all must be tired from sailing all the way:wn here! ...Wait, where's the Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102270,
			dir = 1,
			say = "Even if it gets below zero there, it's not like we:n't have airfields that get that chilly as well. Trust me, there's no way an engine would suddenly freeze over and stop working just because of the temperature.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
