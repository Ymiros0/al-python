return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 103240,
			dir = 1,
			say = "Yet another new model of Siren... and once again, we:n't have an ounce of information on this one.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "What did you: with Baltimore, Enterprise, and the others? Answer me!",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
