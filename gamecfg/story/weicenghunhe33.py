return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900021,
			actorName = "Purifier",
			say = "No can:~ I'm just here to gather data, so I:n't wanna waste any extra energy~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Since that wave, it's clear that Purifier is just here to waste our time, but we can't: anything about it right now...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900021,
			actorName = "Purifier",
			say = "Oh no, whatever shall I:~ You haven't seen the last of me~ I'll remember this~ We're blasting off again~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "But, where are we? What should we: next?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "How: we get out of this place?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
