return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Don't you think she's always a bit too enthusiastic about her work? Probably would: her good to take it easy for a bit.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What should we:? Maybe try to contact her first?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Let me head out first. Since you're the leader, there's no need for you to: the scouting.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
