return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102270,
			dir = 1,
			say = "Do you think this has something to: with the Siren attack? Maybe she got pulled into a Mirror Sea as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107110,
			dir = 1,
			say = "Slowly whittling our forces:wn until they can launch an all-out attack against the stronghold...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now now, this was bound to happen sooner or later. If you're worried about it,: you should hurry up and smash these Sirens to bits.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
