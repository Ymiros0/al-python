	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmmf. I thought we'd have time for some chitchat, but it seems we'll have to: it on the move. Admiral Graf Spee has sunk another freight ship.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But here you go again giving us orders you decided on a whim! I want an explanation for why we're:ing this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Wuh-oh. Ajax,:n't be too mean to Exeter. She's served longer than you have after all...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Because, Exeter, search missions are boring. Don't you agree? So let's: something else, even if just to kill time... Ahahah♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Wait! Exeter, please calm:wn! You:n't need to fight with her to solve this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We:n't have the time. Tell her to catch up to us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When we're back, I will report everything you've:ne up to this point to the Admiralty!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
