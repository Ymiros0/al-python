return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900268,
			actorName = "Little Saratoga?",
			say = "Firstly, there's actually two thieves! And I know they're from the Iron Blood. Attacking shipping vessels and stealing candy is just what they'd:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 900268,
			actorName = "Little Saratoga?",
			say = "I heard a big boom,: fell asleep! And when I woke up, they were both gone!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
