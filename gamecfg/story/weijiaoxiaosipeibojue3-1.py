return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Lower your weapons and hand over the candy! If you:n't, we'll have no choice but to fight you!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Little Spee",
			say = "Beer and bratwurst aren't the only important things in life. Candy is, too. You all just:n't understand that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			expression = 6,
			side = 2,
			say = "All I need is a little more candy,: candy will cover the whole ocean. Nobody can stop me now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			actor = 107990,
			side = 2,
			say = "I... I:n't know what her deal is, but I: know she's up to no good!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			expression = 1,
			side = 2,
			say = "F-fine,: we'll fight it out. I'm just as strong as you. Don't blame me if you get hurt and cry!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
