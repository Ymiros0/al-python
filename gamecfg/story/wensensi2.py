return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Astoria... why are you:ing this too...",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "I suppose I can relate with how you're feeling, Astoria. Vincennes:es give off that aura that makes you want to protect her...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
