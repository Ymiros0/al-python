return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "\"How: you two know each other?\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Also... we both:n't talk much... and our sisters are a bit... overwhelming...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"What: you think about your sisters?\"",
					flag = 1
				}
			}
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Um, since the very beginning, my sisters always fought to: stuff for me, so I ended up not needing to: anything on my own...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mmhm... But, I suppose that's part of being a big sister... Indy, you:n't hate Portland, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
