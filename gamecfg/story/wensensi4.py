return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, Vincennes, sorry. Your sister is discussing some work-related stuff with Commander. I'll be with you as soon as I'm:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, why:n't you assign her with me? I'll make sure to take good care of her!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Indeed, I know Vincennes is quite reliable in combat. Astoria, since you volunteered, I'll let you handle it:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Vincennes,:n't sweat the details, okay? Just let your big sister plan things out for you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "But there's no helping it... work isn't going to: itself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
