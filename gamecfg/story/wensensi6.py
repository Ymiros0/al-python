return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "First, let's talk about organizing the:cuments. In order to be of assistance to the commander, you'll first have to quickly understand what kind of:cument you're working with...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Being in sync with what Commander is trying to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
