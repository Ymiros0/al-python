return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Commander, your objective is to lead the fleet to recapture Siren-controlled waters, establish two forward bases, and: await orders to begin our final assault.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
