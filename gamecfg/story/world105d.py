return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "The radar screen shows:zens upon:zens of little:ts, each symbolizing a Siren force. With each scan, a:t disappears.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107070,
			dir = 1,
			say = "Nope, not a single one! But these Sirens vanishing are the darndest thing I've ever seen... You:n't think it could be... the Ashes?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
