return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "And what: we have here... You must be the commander who’s the source of “Enterprise’s” suffering.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "You still haven't realized it, have you? Pitiful... I:n't know why she cares so much about you, but as long as you stay out of my way, we won't have any trouble.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "Don't know,:n't care. I:n't have time to talk with you people. Out of my way, or I will annihilate every last one of you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
