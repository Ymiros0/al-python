return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107060,
			dir = 1,
			say = "can't say for sure. What we: know is that they know just how critical this operation is. All we can: is hope they'll keep to themselves, as agreed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 103160,
			dir = 1,
			say = "I'm not so much worried about any one person on their side sparking trouble, but the Royal Navy’s and Iron Blood’s respective leaders:n't exactly get along...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Either way, there’s not much we can: but put our faith in Her Majesty’s ability to keep the situation under control.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
