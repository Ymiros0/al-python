return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ugh. If only she’d contact us, or: anything to show acknowledgement...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Communications request from Iron Blood received. An encrypted channel is ready to be established. What: you wish to:?",
		...
		},
		{
			...
			actor = 405020,
			dir = 1,
			say = "Sorry for not calling you sooner. Is there something you want to discuss? Then we should: it in person.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sorry, it’s just that nobody told us you’d be passing through one of our sectors. If you can't link up with us,:: you think you could turn back to a sector you have jurisdiction over?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 405020,
			dir = 1,
			say = "Allow me to clarify what she meant. We: not wish to interfere in your operations, and we have no intentions of trespassing on Eagle Union territory. This, however, is not your territory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 405020,
			dir = 1,
			say = "If you still object to our presence here,: we will have to settle it in person...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
