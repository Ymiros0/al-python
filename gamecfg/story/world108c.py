return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Vanished? What: you mean vanished? A whole fleet can't go up in smoke!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "“Saratoga is right. It:esn't make sense otherwise.”",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The Iris Libre still has some qualms about this whole thing, but... what: you think, Commander? Should we just pretend you never saw any Iron Blood ships?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			dir = 1,
			say = "With that settled:, lemme give you a briefing of the agreement Elizabeth struck up!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205010,
			dir = 1,
			say = "Hood’s fleet, meanwhile, has been:ing quite well. Do regroup with her at a later point to discuss strategies!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
