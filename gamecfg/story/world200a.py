return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now:, Commander, Enterprise, and my friends of the Royal Navy, let’s make Operation Siren a success!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "An excellent speech, Hood. Well:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "There is one objective that unites us all - to take:wn the Sirens. Plain and simple.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But, I'll have George with me this time, so:n't worry.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No clue. I'm looking into it, but I:n't have any details just yet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That thing says it “can't pass the Turing Test,” but:n't you think that warrants suspicion in itself?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "If not,: our meeting is adjourned! Do your utmost to display the glory of the Royal Navy to the world. Good luck in Operation Siren!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
