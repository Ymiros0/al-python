return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 201130,
			dir = 1,
			say = "...Ah, sorry, sorry. Did I make things awkward? They're our friends though, so you:n't have to be shy~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Woah! W-wow, we've gotta: our part too:! Opie, we're also gonna be heading out to the front lines!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
