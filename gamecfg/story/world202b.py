return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Until now, all the scouting we've:ne has been at a distance. There’s no telling what dangers are waiting for us at the heart of their territory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202190,
			dir = 1,
			say = "However, we: know that the situation is urgent. I'm sending over the coordinates of the distress signal now, so please arrange a rescue operation with due haste.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205060,
			dir = 1,
			say = "I'll go too. If this is a trap laid by the Sirens, we: not want to risk them getting trapped in a Mirror Sea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That’s settled:. Please join Grenville’s group and investigate the source of the distress signal. If something did happen, make sure to rescue the survivors.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
