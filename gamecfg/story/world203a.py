return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 801040,
			dir = 1,
			say = "From this distance, it:esn't look like there’s anything over there. Just another gloomy patch of ocean...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 801030,
			dir = 1,
			say = "Let’s circle around and take a look! All we have to: is keep our distance, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
