return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 801040,
			dir = 1,
			say = "I:n't see any friendly ships here, but there aren't many Sirens either...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 801040,
			dir = 1,
			say = "All I'm seeing are the destroyed husks of Siren ships, but I:n't think any Royal Navy ships passed through this area.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205060,
			dir = 1,
			say = "This isn't something that Warspite would:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 207050,
			dir = 1,
			say = "Wales,: we have any weapons that are capable of that?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
