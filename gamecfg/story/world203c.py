return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hold, Formidable! We're only here on a rescue mission! We:n't have the firepower to fight against the Ashes right now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205060,
			dir = 1,
			say = "There really was an Eagle Union fleet here? ...Thank goodness we made it in time:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
