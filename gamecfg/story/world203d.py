return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait... The sample of the mass-produced Siren we collected was lost when we were attacked earlier. If we:n't go back to look for it, I won't be able to complete the mission...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 207050,
			dir = 1,
			say = "Good. Let’s all get back into formation: and prepare to head back. Remember, our mission’s not over until you get back to port safely.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
