return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If distance is an issue,: all we have to: is close the gap... After all, gravity can't mess with the strike of a sword.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But our attacks aren't:ing anything to its armour either! Come help us out over here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't have any data on it. It might even be a new model...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...We:n't have much of a choice right now. Everyone, We'll find out right here and now whether we can make that enemy bleed! Begin attacking!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
