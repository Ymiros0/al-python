	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Finally... the last enemy is:wn!",
			bgm = "story-french1",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(...A new type of Siren that can manipulate gravity. We have no idea just how strong it is, but we: know that we can't afford to ignore this threat.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
