return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107090,
			dir = 1,
			say = "Our task is to clear out zone C, which is in the Northwest sector, and: establish two Outposts for the final offensive.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "Yep. The whereabouts of Tirpitz's fleet is still unknown, and we:n't even know whether they're Pawns or not, which is a big, security-threatening question mark...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107110,
			dir = 1,
			say = "I:n't get it. Why would an Iron Blood fleet waltz into OUR area of operations anyway?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If it's to assist in Operation Siren, they could've at least contacted us about it. Hell,: we could've worked together...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:ubt they came here simply to assist us. This is Iron Blood we're talking about, the faction led by Friedrich and Bismarck.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We'll find the Iron Blood fleet sooner or later, and when we:, we can ask them what their intentions are.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
