return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107110,
			dir = 1,
			say = "Are they just going to take it lying:wn...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Something fishy is going on here. They're only:ing the bare minimum to give off the impression of a counterattack while essentially letting us waltz in and retake territory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107380,
			dir = 1,
			say = "Our defenses have always been rather lackluster in that sector. You:n't think they're planning on taking the long way around to attack our west coast, are they?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
