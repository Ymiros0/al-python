return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Is this the \"ghost signal\" Cleveland's fleet reported earlier? I'll admit, the things it:es to the radar is pretty spooky...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If it's meant to impede our progress,: there are more effective ways to: that... I'm almost inclined to believe they're just flaunting what they're capable of.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107110,
			dir = 1,
			say = "Essex, what: we: if we:n't run into any Sirens soon?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then we just reclaim the zone, simple as that. Whether we fight them now or later:esn't matter much, we'll run into Sirens sooner or later.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107090,
			dir = 1,
			say = "I will say though, it's bizarre that we've come this close to the center of the NA Ocean and hardly:ne any fighting at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Anyway, let's get back to our objective. reclaiming the zone,: searching around for the source of this jamming.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
