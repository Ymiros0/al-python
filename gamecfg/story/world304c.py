return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900286,
			actorName = "？？？",
			say = "Hear my word, all you within this region. I am Arbiter. Lay:wn your arms and surrender. Resistance is futile.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "In full, my name is Arbiter. Temperance ⅩⅣ. If you insist on titles,: call me by this one.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "This is your last warning. Lay:wn your arms and surrender. Resistance is futile.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Yeah, like we're going to: what some random voice over the radio tells us!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ff5c5c",
			say = "I offered you the easy way, and you rejected it. If I must beat you into submission,: I shall.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107090,
			dir = 1,
			say = "That:esn't leave us with much choice but to locate and destroy the jammer,:...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We'll be fine,:n't worry. Now let's show these Sirens what we're really made of!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
