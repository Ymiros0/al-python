return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107110,
			dir = 1,
			say = "If they've got all that,: it's no wonder we didn't detect them until they were right in our faces.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "At the very least, we took a considerable amount of them out. I:ubt they will attack us again right away.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107090,
			dir = 1,
			say = "Once we establish an Outpost and gain a foothold in this zone, we'll be able to repair our electronics. We just have to keep going until:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
