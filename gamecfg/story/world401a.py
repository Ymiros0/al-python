return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I see... You:n’t look like you came from sightseeing though. Did something happen on the way?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now now, everyone, let’s calm:wn~ We’re all here for the sake of peace, so why:n’t we set this aside for now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "We’ll begin the negotiations when the Iron Blood arrives. Until:, please enjoy everything Taranto has to offer.~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
