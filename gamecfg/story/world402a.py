return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That’s True. I:n’t see any ships here from either the Vichya or the Iron Blood.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(A modular, large-scale:ck. Energy absorption devices. Adaptive bioengineered rigging. Communication equipment resistant to EM attacks. Even “imitations” of Mirror Seas...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yuubari,: you think there’s anything here you’d be able to use?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
