	...
	scripts = {
		{
			...
			dir = 1,
			bgmDelay = 1,
			say = "The Iron Blood:esn’t seem to be coming. Is this their idea of a joint operation?",
			bgm = "bsm-7",
			flashin = {
				delay = 1,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I’m not sure exactly what Friedrich is planning, but our main fleet has also moved to the NA Ocean. If everyone’s operating in the same area,:esn’t that technically qualify as a joint operation?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Where’s your main fleet:, and what are they:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, sorry, you can just use the communicator. That should: just fine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
