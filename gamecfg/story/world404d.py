return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Amagi?",
			say = "How is my little sister:ing? I trust that you’ve been taking good care of her like I asked?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Amagi?",
			say = "Ah, how I regret the decision I made back:. Look what has happened to my Akagi, to my Sakura Empire. All because of you, Kaga...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know you:n’t like us, but luring us out here to get rid of us in an “accident” is a really unfunny joke, Kaga~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So basically, everyone covered by this fog is showed some kind of illusion as if they’re trapped in a dream? What: you think, Kongou?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
