return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "As for why it didn’t affect Yukikaze... Maybe she was lucky enough to get out of it before it could affect her. Or maybe she:esn’t have enough going on in her head for the Sirens to toy with...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Calm:wn, Yuubari! You only just came out of your hallucination, so rest up first!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...No, we shouldn’t talk of this plan any more. All we need to: is to focus and charge forward.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I can’t accept that. I can’t: something like that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...She:esn’t seem any different to me... W-woah, those flames definitely aren’t normal!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait, wait... What am I going to: if I accidentally hit Jintsuu?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Maybe I’ll aim a bit to the side:... Hmm, maybe I should just call out to her with a loudspeaker or something...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "...Yukikaze, what are you:ing here alone?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
