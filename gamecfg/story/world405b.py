return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But Akagi:esn’t even seem to notice...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I: know one thing for certain though. We’re going to have to defeat that Siren if we want to rescue Akagi...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let’s get moving:. Shoukaku, Kaga, attack the Siren with me draw its attention away. Yukikaze, Jintsuu, bring Akagi back safely!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
