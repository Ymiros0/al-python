	...
	scripts = {
		{
			...
			side = 2,
			nameColor = "#a9f548",
			say = "I:n’t think I’m landing a single hit... Zuikaku, what about you?",
			dir = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yukikaze,: you still remember the direction you went in to leave this—",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We’re almost there... If we work together,:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
