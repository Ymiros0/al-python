return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_chuanwu1",
			say = "Though the Eagle Union's fleet is assembled and stands ready, the green light has not been given to continue the large-scale assault, and the operation's progress has slowed:wn considerably.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I initially also tried to send some recons out to survey the situation, but my planes were shot:wn before they could gather any information.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_chuanwu1",
			say = "Two approaches have been hotly debated. the first, launching a focused assault to break through the Sirens' defensive line, and the second, slowly whittling their forces:wn until we have them surrounded.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_port_chuanwu1",
			say = "What's more, some are requesting our capital ships be withdrawn and reassigned to: Siren research missions instead.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
