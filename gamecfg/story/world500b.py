return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Sheffield bowed to me,: left quite abruptly after offering her... advice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "While I:n't exactly have to keep it secret from you, I'd rather wait until I have all the facts before telling you about it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"Does it have something to: with Naval HQ?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's strange how the Siren stronghold appearing made Naval HQ: a strategic 180. Don't you think so too?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"I:ubt anybody saw this sudden reversal coming.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "And I:ubt anybody's happy with it either. We still have to investigate the stronghold and all, but...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Gosh,:n't sneak up on us like that... Didn't you say you were leaving?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Her Majesty has been preoccupied with other business as of late, but yes, she is:ing quite well. I shall ask her to contact you at a later point.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "As I am but a simple maid, I know not what Her Majesty plans to:. But, if you'll allow me to conjecture...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"True. Let's hope that:esn't happen.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
