return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah. The storm we observed in the Bermuda Triangle:esn't even hold a candle to this one.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107060,
			dir = 1,
			say = "Doubtful. It:esn't really FEEL like the other Singularities we've encountered...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107060,
			dir = 1,
			say = "At any rate, we have to eliminate all the Sirens in the area, and:–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
