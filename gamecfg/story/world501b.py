return {
	...
	scripts = {
		...
		},
		{
			...
			paintingNoise = True,
			dir = 1,
			say = "Nope, not a word so far. I'd take their silence to mean tacit permission to keep:ing what you're:ing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102230,
			dir = 1,
			say = "Agreed, though it's a shame we can't pinpoint their exact location yet. It:esn't help the bulky decryption machine is extremely tough to transport.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So: why would she start a fight and reveal her location, especially so close to us? It:esn't make sense...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Alternatively, she:esn't even know we're here. Whatever the case, how: we proceed?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
