return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Is she planning to use the Sirens to get us off her tail? But: why did she reveal her location to us in the first place?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now we have an idea of what we're up against. We can't defeat them here if we:n't attack with everything we've got.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, what: we:? We can't fight possibly fight the Sirens and Hiryuu at the same time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "First you challenge us to a fight out of nowhere,: you decide to flee in the middle of it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We have no other choice, Birmingham. We:n't know the full extent of what Hiryuu is capable of, but we did learn a little more about her today.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107060,
			dir = 1,
			say = "I'm confident they'll make the correct decision once they realize the entire operation is at risk if we:n't strike with all the power we can muster.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
