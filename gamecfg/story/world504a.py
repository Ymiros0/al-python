return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "It's very straightforward. All you have to: is steadily clear all the obstacles in your path and eliminate every last Siren you see.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			paintingNoise = True,
			dir = 1,
			say = "Long ago, the Sirens appeared and ushered in an age of terror. Humanity could: nothing but watch as they seized our seas with ruthless aggression.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
