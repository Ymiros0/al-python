return {
	...
	scripts = {
		...
		},
		{
			...
			paintingNoise = True,
			dir = 1,
			say = "Their aircraft proved a tad troublesome to bring:wn, but they never stood a chance against our combined air force.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			paintingNoise = True,
			dir = 1,
			say = "Well, we're moving on to the next area:. Good luck over there, or whatever.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wow! It's amazing what we can: when we really go all-out like this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
