return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Indeed they:. Might I say, researching even ordinary Siren technology is a tall order.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah. I:n't even wanna think about what would happen if they used Siren tech for evil.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Basically, they're a cut above mass-produced units, though they:n't quite rival the elites.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
