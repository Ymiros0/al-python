return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yes, Your Majesty. The first round of reconnaissance has been completed. There are several stray Siren fleets, but there:es not seem to be a sizable force holding the line.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
