return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Both storms seem to be spinning at the same velocity, making it appear completely still from the inside... Enterprise, Commander, what: you think?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well,: that makes sense. The Ashes and the Sirens must have fought around here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's correct. Everyone could already have guessed this was a Singularity, but I had to see firsthand what it has to: with the Ashes and the Sirens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm pretty sure the Commander gets out more than you:, but hey...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
