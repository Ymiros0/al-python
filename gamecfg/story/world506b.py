return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Thank you. It's a huge weight off our shoulders now that you're here. Since we:n't have any information about the inside of the Singularity, we can use all the help we can get.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, you:n't look so good... Is it due to the trauma you experienced from the storm?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You know as well as I: that I'm not pushing myself as hard as you are~♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Anyway, Commander. I looked over everyone else earlier and nobody's taken any serious damage. They're all:ing just fine~",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
