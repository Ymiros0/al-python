return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Enterprise META",
			say = "It:esn't matter. They'll pursue us no matter what branch we escape to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "It began with just a few broken-off fragments floating in with the waves. Then more appeared, and: even more...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I've never seen such a gruesome sight before. Calling this the site of a battle:esn't: it justice...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
