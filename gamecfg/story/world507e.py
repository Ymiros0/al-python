return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107090,
			dir = 1,
			say = "If we suppose that's True,: everything adds up. As for who eliminated them, I would speculate it was the Ashes. Though it could've been someone else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107060,
			dir = 1,
			say = "However, there's a hole in your theory. If the Ashes are responsible for the fresh wrecks,: who the hell is responsible for those older ones?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What:es \"dimensionally divergent\" mean, exactly?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If I remember right, it's something like... Singularities:n't have fixed space in three dimensions. Rather, they exhibit more complex properties.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hey! Don't scoff at royalty! Go on:, continue with your explanation if you're so eager to share it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			dir = 1,
			say = "All righty:. When the inside of the Singularity is directly observed, it will continue to expand. That's why it seems like there's no end to it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"I:n't think I caught all that...\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "That's fair. It's pretty complicated stuff. But:n't worry, I'll get us out of here in no time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
