return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Three of them match the descriptions of:cumented elite Sirens. As for the remaining two, I concur with Miss Memphis and conclude that they are Ashes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Not to mention we didn't have a coordinate tracker back:. Locating her was like trying to find a needle in a haystack...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "They:n't know we're here yet, so now's a good time to–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Ark Royal conceded the argument with a sigh,: directed her gaze at me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707020,
			dir = 1,
			say = "...You:n't need to know anything more than that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "Please:n't take offense, she's always like this. Having said that, perhaps you should take a leaf out of her book.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "That being the case, I'd like to propose a temporary truce between us. Together, we can get out of this sticky situation. What: you say?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What: I think? Thinking and making decisions is your job, you:ltish servant!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "I'll have faith in your assessments,:. Proceed as proposed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
