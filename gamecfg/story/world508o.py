return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "Well,: this is farewell. I'll be hoping for your safe escape.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "While I:n't:ubt that you would: that for us,:n't bother.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "Hahaha, you're not wrong... My sister isn't here, so I guess I ended up:ing something that's not in my nature.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "Perhaps... but that no longer has anything to: with us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"Until:, just try to hang in there, everyone!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
