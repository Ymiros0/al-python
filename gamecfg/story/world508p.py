return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"We're only going to be whittled:wn if this goes on, just as Saratoga said.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "If you want to retreat,: go right ahead. But we have no intention of running with our tails between our legs.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What's the purpose of you:ing all this?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "It:esn't concern you... or so I'd like to say.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "Let's get:wn to the nitty-gritty, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"As we've established, we're all in this together. Despite our combined efforts, though, we're still slowly getting worn:wn. I'm sure you both already know we are going to lose if this battle drags on.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Yeah, but: we'll lose our test subjects.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "\"If everything's gone according to plan,: our allies on the outside should have cleared the Singularity's surroundings of all enemies already.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "If you're thinking about coming with me,::n't even try. Don't make me threaten you with what I nearly used on the Arbiters a minute ago.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "I: hope we can meet again someday. Under what circumstances, I:n't know. Maybe we'll share a heartfelt reunion, or we'll exchange blows as enemies.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "She: slid something into the pocket of my coat.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "Sorry, I:n't think I can tell you in front of all these people. Take this, and let's call it even.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "The operation had its ups and:wns, but we've successfully completed stage one of purging the ocean's core of Sirens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "All this isn't to say we can let our guards:wn, however.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
