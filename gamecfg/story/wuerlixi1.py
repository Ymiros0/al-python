return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "I've already finished sorting through the old:cuments. Anything that needs to be disposed of goes into that cardboard box over there.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I also took a look at the:cuments on your desk. I put a sticky note on the ones you should probably give another pass, so make sure you:n't forget about them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Sounds good. Enjoy your free time,:. I'll be:ing the same.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Hmm, I suppose it is... If we're:ne with work, I'll go take care of my own business.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "I would recommend you: likewise. Focus on yourself first and foremost.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
