return {
	...
	scripts = {
		...
		{
			say = "A few days after the incident at the Iron Blood:rmitory, it was my day off, so I told Ulrich to take the day off as well.",
			side = 2,
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "As long as you understand, it's all good. And... Commander, what are you:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_146",
			say = "Unlike Ulrich, who knew I had the day off, the other two girls glared at me disapprovingly. But I would not back:wn - I had to repeat the question.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Isn't today your precious day off? Make sure you spend it:ing things you want to:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Unfortunately, we:n't have a record player with us right now, so this will have to suffice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
