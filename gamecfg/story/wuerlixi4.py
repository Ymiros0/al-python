return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Hey, Hipper,:n't go so far ahead of the rest of the team! Slow:wn and match our pace!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If you say so. To be honest, I:n't like fighting... But if that's what's necessary to bring back my allies safely during a real battle, I'll: it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "By the way,: you not need me back on secretary duties? I can head back to the office if you need me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"Really,:n't worry about it. Go and rest up.\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 405030,
			say = "Listen, I:n't need you to look after me. Just let me know if things get busy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
