	...
	scripts = {
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"It's fine, I can: it myself...\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "I:n't think you can. Your hands are still shaking. Just behave and: as I say.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "I took a sideways glance at her as she sifted through the remaining:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "Saying that, she came back over to the bed and sat:wn by my side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
