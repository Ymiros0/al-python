return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "...I might as well get some work:ne.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "Should I try to get a head start on next week's work, or enjoy what little time I have off... What to:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Just as I'm about to come to a decision, I suddenly hear someone knocking at the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Hmm, that:es seem like a just course of action.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 907010,
			say = "First, let us: our morning prayers while there is still time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
