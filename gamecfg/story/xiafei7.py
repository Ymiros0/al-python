return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "When all was said and:ne, it was quite late by the time Joffre and I parted ways.",
			bgm = "story-richang-1",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "I finally plant my stamp on the last:cument and lean back to stretch–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 907010,
			say = "Here are the:cuments I organized earlier.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Another pile of:cuments instantly materialize on the desk that I had worked so hard to tidy up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 907010,
			say = "You: understand, Commander,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
