return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "Ah, so you've forgotten where you left last night's:cuments? That explains it. ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Could you tell me more about the:cuments? Do they have any markings, or other distinctive feature?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If my memory serves me right, those:cuments are in the third folder inside your left-hand drawer. They were scheduled to be posted later today.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "She really was like that when she first arrived at port. Whatever she was:ing, it had something to: with Essex.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
