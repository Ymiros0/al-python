return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Does it have to: with how the Eagle Union's anti-sub exercise went, by any chance?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So it's been since ancient times, but it rings:ubly True when one is up against Enterprise.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
