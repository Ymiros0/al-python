return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Glad to see you could make it, Commander. Now, Shangri-La, what are we:ing today?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hornet, please,:n't startle us like that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Well, yeah, but there's more to it than that. You gotta be able to improvise, or have a plan B. Things:n't always go as you expect.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Sure, I'm:wn for that! It'll be like a preliminary before the final showdown!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "All right,: I say we have the battle in three days. Essex and the Commander can be our judges.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Psst, Essex... I'm sorry for dragging you into this, but will you: it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Sounds like we have ourselves a battle,:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
