return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I know it's rather abrupt, but: you have a moment? I'd like to ask you some questions about the Yorktown class.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It's a pleasure, Shoukaku. I have some questions, if you:n't mind...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Holy cow, look! She's written:wn every single thing you said!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
