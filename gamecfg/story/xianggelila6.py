return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm all set. All there is to: now is put my plan into practice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "That plan's not gonna: you any good if someone throws a wrench into it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Perhaps, but wrenches can be:dged if you know their trajectory. Especially if the wrench is slow and predictable.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			seDelay = 1,
			say = "Shangri-La will forever be out of reach if this is the best you can:!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
