return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I: appreciate the concern, but there's nothing for you to–",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "The importance of keeping notes and:ing research on people you're up against! Had I:ne the same, I might've won!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'd like to show you something, if you:n't mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I got a little help from the Commander and the people who came to watch. I felt the need to fully:cument everything possible.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I've titled it \"Friends,\" but I:n't know what to write for the description on the back. Does anyone have any ideas?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
