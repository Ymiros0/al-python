return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "I'm really just:ing my job.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "One meeting after another, plans upon plans, until even the most basic of things can't be:ne anymore.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "So, Memphis, what: you personally think about the reformation of the Azur Lane?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What about you, Commander? What: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I want to tear:wn the walls between us and unite all the factions.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "All that would: is create the illusion of an alliance while we plot against each other in secret. A repeat of the past; coexistence without cooperation.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_545",
			hidePaintObj = True,
			say = "Memphis sends a:cument over to my device.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
