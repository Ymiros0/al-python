return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Looks like you've:ne your homework already. But you'd better add \"the one who's going to smash your face in\" to that list.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Tester",
			dir = 1,
			say = "... Once we defeat you, we will guide NY City and Commander:wn the True path.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Tester",
			dir = 1,
			say = "You would even strike:wn your allies without hesitation if you were ordered to.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
