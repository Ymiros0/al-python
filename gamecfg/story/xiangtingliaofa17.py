return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "\"The Singularity has the ability to alter the course of the war.\" If this is True,: it must be heavily guarded.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Heh,:esn't matter who stands in my way, I'll blow 'em all away!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
