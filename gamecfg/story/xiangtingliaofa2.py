return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I suppose that's to be expected, though... We let our guard:wn because Newport was far from the front lines...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Besides, if they're going to attack us on our home soil,: we'll have to give 'em a taste of Eagle Union hospitality!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
