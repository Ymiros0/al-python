return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "？？？",
			dir = 1,
			say = "But if you truly insist on standing in our way,: I will have to show you...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "That's enough, we've already finished what we needed to: here.",
			soundeffect = "event./battle/boom2",
			flashout = {
				dur = 0.15,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(That second ship:esn't look like she's from the Sakura Empire... but if she is...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
