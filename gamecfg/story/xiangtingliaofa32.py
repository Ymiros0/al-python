return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Observer",
			dir = 1,
			say = "Ah, \"people\"... What exactly: you mean by \"people\"?",
			effects = {
				{
					active = True,
					name = "guanchazhe"
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "If you're referring to those Pawns, they were made specifically for your disposal. You can: with them as you please.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "Observer",
			dir = 1,
			say = "Oh,:n't be like that. Being the Prototype that you are, we can always reconcile and be friends whenever you'd like.",
			effects = {
				{
					active = True,
					name = "guanchazhe"
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "But you'll never save anyone if you keep walking:wn that path. You will only experience that same agonizing sorrow, again and again. And what a miserable life - frozen in time - that would be.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
