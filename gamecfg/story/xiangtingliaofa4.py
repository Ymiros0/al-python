return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "What good:es yelling at a lifeless lump of metal:? Are you trying to blow off steam...?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			actor = 103160,
			dir = 1,
			say = "So,: you even need any help here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That decides it:. We'll make the Sirens atone for their sins in blood!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
