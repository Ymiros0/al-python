return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, um, it's basically:ne! Dewey and Aylwin are transporting everyone to the evacuation point...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "C'mon,:. Since evacuations are already:ne, let's get to the front lines and drive those Sirens back.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
