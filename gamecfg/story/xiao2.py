return {
	...
	scripts = {
		...
		{
			say = "One day, I found Akatsuki and Kuroshio:ing something in the area behind the academy.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "Kuroshio jumped high into the air, pulled off an impressive somersault,: gently landed on the ground.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "Like a scene out of a cartoon, Akatsuki noticed how high up she was,: began falling to the ground. Kuroshio leaped into the air and caught her again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Umm... Because I am a ninja, but in many ways, I:n't feel like one...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But, I: not object to learning them as something nice to show to one's companions. Oyashio has always been:ing that, in fact.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
