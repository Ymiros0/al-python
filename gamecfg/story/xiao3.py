return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "P-please,:n't talk about that...!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Our task here is:ne, so I believe we should head back. We wouldn't want to get in the way of their work, would we?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I see! Alright:, we're leaving now! See you two later!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
