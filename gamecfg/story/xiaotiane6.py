return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Hahaha...Vampire's the same as usual today...Wait,: you know how these clothes got here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "I saw it all, those clothes were blown from the destroyers':rms here to the carriers' quarters. The wind was strong yesterday, remember?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
