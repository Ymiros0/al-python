return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So, could you all help me make some zouni? You can be the first to taste it once it's:ne nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Woof! I smell mochi! Let's eat, right now! ...But I:n't wanna leave the kotatsu, it's too comfy...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't think we should rush it; it's important to get New Year's food:ne right...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Okay,: it's time for us to withdraw! We'll be back to help again when the zouni is ready!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
