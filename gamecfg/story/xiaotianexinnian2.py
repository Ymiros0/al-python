return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmph, I:n't see why anyone would get so fired up over a bit of snowfall.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "In that case, why:n't we tag along?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "We're just:ing our job. That:esn't warrant any praise.",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Heh! Carriers:n't stand an icicle's chance in hell against me in a snowball fight!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait! We just cleaned the yard, so please:n't make a mess in it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Huh? Fine...: let's: it somewhere else. Then at least we won't make a mess of the yard.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Everyone gets so excited around New Year's... I just hope they:n't make a mess... *Sigh*, my stomach's already starting to ache...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
