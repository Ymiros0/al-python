return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I should expect no less of the Royal Navy's most sworn and trusted friend. Then how: you like THIS?!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(Whispering) Ufufu... I just need to eliminate all the people here,: I can be with the commander forever...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hahah, now things are getting interesting! Knights of the Sea, let's: this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
