return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "From them, huh? I believe it's called \"the more, the merrier.\" If you're that curious about it you may as well come to the Sakura Empire:rmitory and see for yourselves.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Exactly. If you're so curious: we could invite everyone to try and show how generous the Sakura Empire is. Any objections, Akagi?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Since the snow on your clothes is starting to melt, perhaps we should head for the:rmitory soon?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Whew~ My zouni is finally:ne nya! Who wants to be the first to...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
