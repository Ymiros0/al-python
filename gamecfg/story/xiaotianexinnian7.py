return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "<size=24>Shh! You:n't need to tell anyone that nya!</size>",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Anyhow, be quick and make your wishes nya! And:n't forget you have to clap twice, put your hands together, and bow nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.152}",
			say = "That they:. Let's work together to restore peace and harmony to this world.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
