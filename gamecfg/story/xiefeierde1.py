return {
	...
	scripts = {
		...
		{
			say = "Though I was supposed to be taking the day off, I didn't particularly have anything I wanted to:, so I soon found myself wandering aimlessly around the port.",
			side = 2,
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_school",
			say = "I could hear the voices of Kent and Suffolk coming from the Royal Navy:rmitory, but who was this third voice?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:, if you:n't mind, please take a few steps back. You're soiling the freshly-mopped floor.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Well, since I really did have nothing better to:, I might as well come back later.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
