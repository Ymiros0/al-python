return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Mm. I'll leave this invitation with you:. I look forward to meeting you there, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Things might get a bit ugly if you:n't show up on time... or at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
