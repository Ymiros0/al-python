return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yes... I went to greet Commander, but: Yuudachi said something about fresh meat and bolted off.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I went to chase after her along with Ariake and Shigure, but: got lost in the crowd...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't worry about it... I didn't really: anything...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm about to let you in on a little secret. See, the trick is, just: what you wanna:! You can go dancing like those two lovebirds over there. Or sink your fangs into some grub like Yuudachi over there.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Do what I want to:, huh... Thanks for the help, Shigure, I think I have a better idea now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
