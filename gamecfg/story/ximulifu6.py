return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Woooooahh! Let's not get too trigger happy here. I'm just out here monitoring the situation, making sure no questionable individuals get in and whatnot. I'm absolutely not:ing anything suspicious at all!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Calm:wn. You're only drawing more attention to yourself like that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ah... Phew... It's just you, Georgia. What are you:ing outside?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
