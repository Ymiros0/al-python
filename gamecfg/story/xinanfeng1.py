return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605020,
			say = "This is the last batch of:cuments needing your approval. Go ahead and sign off on them after you've had a look.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "In any case, I shall take my leave. I: hope you enjoy this rare afternoon of leisure and get to rest early.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Ehh? I was being serious, Commander! I've already:ne my preparations for becoming the secretary ship!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "What: you mean by \"preparations?\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Now: you get it? I wasn't playing around - I'm seriously going to become the secretary ship!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "She:es seem to be taking this seriously. Commander, why not give her a trial period?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Commander, I'll: my best! Even Littorio believes in me, so it's okay, right? Right~?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 3,
			nameColor = "#A9F548FF",
			say = "Hooray! Thanks a bunch, Commander! I won't let you:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I know you're still having your:ubts about this, but I'm sure it'll be fine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
