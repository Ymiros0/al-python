return {
	...
	scripts = {
		...
		},
		{
			side = 2,
			bgName = "bg_story_task",
			say = "Libeccio greeted me in the same energetic way she always did, except suddenly she seemed to realize something. Modifying her behavior halfway, she curtsies politely, perhaps having something to: with the content of her \"strategy guide.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "Commander, the tea is ready. Next up is getting all the:cuments organized, right?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "Hehe, piece of cake! All the stamped:cuments go over here, and the ones that still need to be checked go in this other pile––",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "Owwie, that was a close one... Gah! The:cuments!",
			dialogShake = {
				speed = 0.08,
				x = 15,
				number = 2
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601040,
			say = "Ah, um, excuse me... I got a little worried so I'm here to check on how Libeccio is:ing...",
			painting = {
				alpha = 0.3,
				time = 1
			},
