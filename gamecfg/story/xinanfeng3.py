return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Also, I've finished sorting out the:cuments! Here, you can take a look!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			side = 2,
			bgName = "bg_story_task",
			say = "From a glance, it certainly seems like she grouped the:cuments correctly. Infinitely better than yesterday's pile of:cuments scattered all over the ground.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			bgName = "bg_story_task",
			say = "While reading over the:cuments, I notice from the corner of my eye that Libeccio's teacup is totally empty.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
