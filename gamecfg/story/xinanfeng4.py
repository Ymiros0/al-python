return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Here,:cuments... Laffey, isn't sleepy at all...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "I got an extra blanket for you, so you can take a nap on the sofa if you'd like! After I'm:ne with work, we can go outside and play!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll be returning to my room:. If you get stuck anywhere in the game, you know how to reach me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "What: you think, Commander? Pretty good, huh?",
			painting = {
				alpha = 0.3,
				time = 1
			},
