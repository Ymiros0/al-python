return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Mm... She:es tend to think about all sorts of complicated things...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I want to introduce all my friends to Maestrale! What: you think of that, Commander?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "As for my other friends... Hmm, there are so many nice girls here, I:n't know who to introduce to Maestrale next!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			side = 2,
			bgName = "bg_story_task",
			say = "\"It:esn't have to be one person. Why not introduce everyone?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
