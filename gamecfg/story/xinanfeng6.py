return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commander, I've finished sorting out all your:cuments. Just sign here after you've looked over everything!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The:cuments that can be shredded are in this stack over here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "Ehehe... To be honest, at first, I didn't know if I would be able to: this job well.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That'd be great! It's a pinky promise:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601050,
			say = "You'd better not break that promise:! Not in a hundred years!",
			painting = {
				alpha = 0.3,
				time = 1
			},
