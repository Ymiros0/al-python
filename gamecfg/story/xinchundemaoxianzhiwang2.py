return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It wasn't me! I didn't spike the tea! I haven't:ne anything!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "Then what were you:ing with a teapot full of foul tea when I came into the kitchen?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501060,
			say = "Ugh! You're not at all sorry for what you've:ne!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Because I haven't:ne anything wrong!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Exactly! Just because you saw me holding a teapot:esn't mean I put anything in it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 504010,
			say = "That:esn't clear you of suspicion, though. You're staying right where you are.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Commandeeer! Help Lady Yuen:oown! They're punishing me for something I didn't:oo!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "Pleeease! I promise I won't go anywhere near the kitchen and the storeroom for a month! Just let me:oown!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_127",
			hidePaintObj = True,
			say = "It's too much to bear. I cave in and decide to let her:wn anyway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "*sigh*... If you insist,: I'll let her off the hook just this once.",
			painting = {
				alpha = 0.3,
				time = 1
			},
