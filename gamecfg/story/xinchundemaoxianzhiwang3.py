return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501070,
			say = "You need to eat something to calm:wn... Like some dried apple slices!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "Chen Hai",
			nameColor = "#A9F548FF",
			say = "Commander,: you have a moment?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501070,
			say = "Ugh... I told you so! I told you I didn't: anything!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I'm almost:ne with my work, so let's head to the:rm in a minute.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501070,
			say = "Ahah! Even you fell for my trick, my rival! This proves beyond a:ubt that Lady Yuen is the best, the most daring adventurer at the port!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 501070,
			say = "What: you think, huh? Aren't you impressed?",
			painting = {
				alpha = 0.3,
				time = 1
			},
