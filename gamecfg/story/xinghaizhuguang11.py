return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actorName = "Arbiter. The Devil XV",
			say = "Guns and torpedoes alone won't:. Use your drones as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Arbiter. The Devil XV",
			say = "Why are you still here? Don't you have things to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "(What: we: now? Is this normal in the Sea of Stars?)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "(No, what am I saying? There's nothing normal about our communications being:wn!)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actorName = "Arbiter. The Devil XV",
			say = "...Nope, mine:esn't work either. We're all cut off from them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Arbiter. The Devil XV",
			say = "Okay, you clearly:n't want to hitch a ride.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
