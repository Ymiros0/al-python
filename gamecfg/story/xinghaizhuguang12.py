	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"\"Hey,: you think we'll ever be able to go home?\"",
					4.5
				},
				{
				...
				{
					"But I can say this –:n't lose hope.",
					7.5
				},
				{
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The Commander connected to the Reality Lens, lost connection with the control room,: wound up in a different simulation...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "TB should call us when the connection is back online. Let's inspect the area until:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "And ever since:, the Crown has been under Siren control.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Remember, we're in a construction based on abnormal data gathered from a simulation. This Crown:esn't HAVE to be the same one we know about.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That:es make sense, and it IS possible. But we:n't have hard evidence that it was.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "What I:n't understand is – why was this data in a simulation of the Coral Sea?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "TB, what's happening? What: we:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
