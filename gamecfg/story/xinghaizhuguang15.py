return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107230,
			nameColor = "#A9F548FF",
			say = "Well, I've already broken them, so it:esn't matter now...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 107230,
			nameColor = "#A9F548FF",
			say = "Devil, I:n't care whether you're real or a simulation. I'm taking you:wn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "...Say,: you have any idea how much of a mess you're in right now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We're going to take you:wn... no matter what it takes.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "And,: you know where that simulation space is located?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I-I:n't know. I just arrived at the Sea of Stars, so...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "How interesting. It really:es make me feel better knowing there are folks out there with luck even worse than mine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "...Don't tell them? And who are you, telling me what not to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "...Fine,: I won't tell them. I'll just watch what happens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "Listen up – I hate dealing with those Harbingers as much as you:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_zhuguang_3",
			nameColor = "#FEF15E",
			say = "I'll: something about those mist entities. You two run that-a-way in the meantime.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
