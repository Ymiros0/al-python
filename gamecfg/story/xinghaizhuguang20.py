return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 101510,
			nameColor = "#A9F548FF",
			say = "There are so many of them... but they:n't show up on the radar.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_zhuguang_4",
			hidePaintObj = True,
			say = "Regardless of how unbelievable the shipgirls thought it, the very real fleet made up of:zens of ships was slowly approaching them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "*sniffle*... W-warning? That:esn't sound good...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "???",
			nameColor = "#FEF15E",
			say = "Order. lay:wn your arms and submit to an inspection.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Also, \"lay:wn our arms?\" Fat chance! Who: you think you are to boss us around?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "(At least we'll gather some data while we're at it. You:n't: battle with flying warships every day.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
