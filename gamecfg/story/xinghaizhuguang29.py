return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_zhuguang_4",
			hidePaintObj = True,
			say = "The storm died:wn, and the Enforcers and their warships had suffered serious casualties.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "I:n't expect a storm to leave a wreckage, but why didn't the Sirens when they're so similar to the ANTI-X?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "Yeah, she means business. The whole Task Force:es.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "And so:es every other one. Our Task Forces are the best of the best in our world.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "However, I should state that these Enforcers: not appear to be frontline units.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You can't modify a Cube like that after it has formed a hull, so it had to be:ne before:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yes. The signs are there, even if I:n't know how exactly they did it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "That has the benefit of slowing:wn METAmorphosis to a crawl as long as your hull:esn't get damaged and you:n't suffer external corrosion.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "How are shipgirls supposed to fight X when they:n't have the strength to: it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "That's reasonable. I've seen what METAmorphosis:es to people.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Then after I'm:ne fighting, I purge that corrosion and my hull returns to its pre-transformation state.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "Uhh... I:n't quite get the analogy, but I'll assume it's close enough.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "The takeaway is this. X's corrosion isn't natural, but your hull changing is. You:n't need to be deathly afraid of it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "If that happens, all you can: is hope your friends will give you intensive medical care and try to: everything possible to save you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "It is. It's probably why they put limiters on your Cubes in the first place – to make absolutely sure it:esn't happen.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "I honestly:n't know. Modifying an existing hull takes an immense amount of work.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I mean, we didn't really: much. Hell, we did more harm than good to your warships in particular.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "Yes? Oh, I guess you:n't have those yet. Physical it is,:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "Let me just tell the 3D printer to get on that... There. We'll hand it to you at the base once it's:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 9706030,
			say = "Besides, you still have your \"quiz\" to:,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
