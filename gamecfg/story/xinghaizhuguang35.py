return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Her rigging was stripped:wn to its base, its shark-like heads having been detached along with all removable auxiliary weapons.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 799010,
			say = "Without knowing the root of the issue, there's nothing we can:. I say we instead focus on improving the material of your weaponry.",
			painting = {
				alpha = 0.3,
				time = 1
			},
