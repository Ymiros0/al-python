return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Settle:wn, Princeton. We're still inside the Sea of Stars. Like I said before, it's not much more than a realistic sci-fi movie set.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That all goes:wn the drain if something goes wrong, so we simulate its performance before using any Wisdom Cubes to actually make something.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 101510,
			nameColor = "#A9F548FF",
			say = "What I: know is that I feel stronger. This'll let me fight harder.",
			painting = {
				alpha = 0.3,
				time = 1
			},
