return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			say = "Nya! It's Eugen! What's the matter? You look kind of:wn, nya.",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmmm~? Tell me about this Sakura's \"New Year.\" What kind of preparations are you:ing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.98}",
			dir = 1,
			say = "There's way too much to:, nya! For the Sakura Empire, the New Year is a very important holiday, nya!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			say = "If you want to help out,: let's start by having you set the decorations. All these are for New Year's day, so we need to get it:ne today. It looks a bit sparse here...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.93}",
			dir = 1,
			say = "These are called \"kadomatsu,\" or gate pines. They come in pairs and should be placed to the sides of the:or. They represent prosperity and longevity and are said to welcome home ancestral spirits.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "They certainly stand out when placed around the:or like this... So, what's this straw-like decoration? It looks pretty cool.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "{namecode.93}",
			dir = 1,
			say = "Ah, how should I say this... it is used to mark a sacred site so that the visiting spirits won't leave. They are placed in entrances, so you can hang it in the:orway or on windows. Oh, and in the kitchen too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ehehe... I'm looking forward to it:... I hear Sakura's liquor is like ambrosia. ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
