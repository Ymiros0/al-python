return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Even though she:esn't talk a lot, she's actually quite fond of everyone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(knocks on the:or) Ayanami~ We're here~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Transformation complete~! Laffey, what: you think?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
