return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "You:n't need to push me around~ I of all people would never forget my duties!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Jeez, you're such a hardass~ Maybe da Vinci can invent something to: the patrolling for us!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Why:n't you try looking straight up~ That's right, I'm right above you!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Hehe, I:n't mind telling, but why not take a guess first?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "My intuition as a journalist is telling me... that you took advantage of your position as the venue's designer to: something funny with those drones!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Sure, sure, coming right:wn. But patrolling the venue comes first.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Which place: you want to check out first?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Let's split up into two teams! If anyone runs into any trouble, we'll contact the other team right away. How's that? We'll get things:ne faster this way!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "You're just trying to get back to whatever you were:ing before... Well, whatever...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That settles it:! I've already seen the designs of all the pavilions, so it:esn't matter which one we start with.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601090,
			say = "Sure. My group will head to the Northern Parliament pavilion:... By the way, why'd you choose the Dragon Empery first?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Don't worry! You know what my three principles are –:n't tell lies,:n't ask leading questions, and keep the gossip to a healthy level!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "If we:n't hurry it up, we might miss that terrible thing Alfredo is so concerned about!",
			painting = {
				alpha = 0.3,
				time = 1
			},
