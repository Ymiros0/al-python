return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Those eagles especially! We'll run out of ammo if we keep trying to shoot them all:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "By vanishing from sight! Alfredo, lay:wn a smokescreen!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601080,
			say = "Looking for treasure? You reckon we'll find a chest in this place? If you:, let me snap a pic before you open it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
