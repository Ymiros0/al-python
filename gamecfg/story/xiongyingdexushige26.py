return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 602020,
			say = "I'm:ing fine! Worry about yourself!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 602020,
			say = "What?! Fine,: we'll just take cover somewhere over there instead!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 602020,
			say = "Don't be ridiculous! Nobody is sacrificing themselves today. What you're gonna: is pick a direction and run!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			side = 2,
			say = "There were:zens and:zens of blimps, all bearing the same ghastly appearance as the eagles and the ghost ships, advancing on the Sirens.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			blackBg = True,
			actor = 602020,
			say = "Don't know,:n't care! Just focus on breaking the enemy line to get us out of immediate danger!",
			painting = {
				alpha = 0.3,
				time = 1
			},
