return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603050,
			say = "We need only to locate and destroy it,: a way out should present itself.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603050,
			say = "While we still:n't know where Roma is, she may have had the same idea as us and headed for the Colosseum.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 603050,
			say = "We might overlook something important from that high in the sky. Furthermore, I:n't feel comfortable with relying solely on the airships if we get into another battle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
