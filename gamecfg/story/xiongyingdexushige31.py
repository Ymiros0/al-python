return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Alfredo Oriani",
			say = "They'll surround us sooner or later if we:n't: something!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			say = "I:ubt we're gonna get good news anytime soon...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			side = 2,
			say = "Emanuele pointed:wn at the sea. The air was filled with smoke and fumes from the two Sardegnian girls' ongoing battle with the Pawn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Alfredo Oriani",
			say = "How'd you estimate that?! More importantly, what are we supposed to:?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Leonardo da Vinci",
			say = "Calm:wn! I'll think of something, just give me some time!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Alfredo Oriani",
			say = "The eagles are coming for our flagship! They're trying to take us:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Emanuele Pessagno",
			say = "Um, why:n't we get off the ship for now...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Leonardo da Vinci",
			say = "There's only one way to find out if I'm right or not, and I have to: it myself! Captain Alfredo, I'm getting off the ship!",
			painting = {
				alpha = 0.3,
				time = 1
			},
