return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "As soon as I heard those words from Prinz Eugen's lips, I already could picture Hipper's furious expression in my mind... Nevertheless, I took a deep breath and pushed the office:ors open.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Eh? You wanted me to come wake you up? Excuse me? Wh-who: you take your secretary for?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I sat:wn, sighing a breath of relief, knowing that Hipper is acting the same as always.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			actorName = "Prinz Eugen",
			say = "Oh my... I was about to bring over the previous report, but saw Hipper running:wn the hall... What'd you: this time, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
