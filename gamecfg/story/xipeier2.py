return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Seriously... Whether's it's Eugen or that big idiot, why: they always... Am I reading too much into things? Did I misunderstand something? Fat chance, right? Yeah, no way...",
			flashout = {
				black = False,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_room",
			say = "My fault? What did I: to wrong her?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Deep breaths, deep breaths... Whew... Whatever, forget it. Anyway, what: you want?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "What am I:ing? ...Arranging flowers, I guess?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "I'll: this sometimes when I want to calm:wn. It's easier for me to concentrate when I'm alone... Why: I need to calm:wn in the first place...?! Why, that's... because... of... you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Gaahhh! It took me all that time to calm:wn, and now I'm all worked up again!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
