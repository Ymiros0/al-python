return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Hey! U-101, please:n't tell me you ran someone over! Hey, we're so sorry! This all happened because I– Geh... Wh-wh-wh-why are you here?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "U-101",
			say = "Hey, Hipper, wanna take him out for a spin? Hehe, or we can:uble ride~ I've not had my daily fill of adrenaline yet!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "U-101",
			say = "There you go:ing it again~ Besides, what's there to be embarrassed about?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_school",
			say = "Huh. Come to think about it... We did: something like that, didn't we...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
