return {
	...
	scripts = {
		...
		},
		{
			...
			say = "So, that's what happened. What: you think?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Glowworm",
			say = "I wouldn't know what to: either!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "I can't seem to calm:wn, or I can't figure out what to say. Seriously, I:n't get it at all! Geez, why am I letting some idiot get me all flustered?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Prinz Eugen",
			say = "I see... But, you already know what you should: next, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "What: washboards have to: with any of this?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "R-romance?! Having that said, I: like Glowworm's suggestion. \"Muster up the courage to charge forward!\" That very much suits her style...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
