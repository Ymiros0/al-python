return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Hipper suddenly threw open the:or and barged in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Why else would I be here... Look what you've:ne to me! I haven't been myself lately because of you!",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "But: nothing came of it at all! Ever since we got back, I've been cleaning up after your messes, nonstop!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Hipper was so... embarrassed? That she looked like she was about to cry. Just:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Prinz Eugen",
			say = "Well, whatever the case may be... the cat's out of the bag now, isn't it? What: the two of you plan to: now?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "I-I suppose I have no choice:! Be grateful that I'm willing to give you the time of day!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
