return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Excuse me? You still haven't finished your work? Good grief, you shouldn't have put it off earlier:! Learn to use your brain, you big moron!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "All right, stop wasting your breath and sit:wn! Here, this is the report from today's exercise, which you can use as a reference for planning your next sortie.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "You what? You forgot? Geez,: you even have two lone braincells rubbing in that thick skull of yours?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "You:n't see it? I think they both look happier than they were before.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Prinz Eugen",
			say = "She's just:ing her best to help.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Say what? You still haven't finished organizing your files? Geez, you really can't get anything:ne without me!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Admiral Hipper",
			say = "Fine, fine. I'll: it for you, but promise me, you'll work harder, become someone more capable, and:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Hipper's attitude:esn't seem to have changed much compared to before, but...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
