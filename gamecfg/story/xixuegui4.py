return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ah, no, not at all! Vampire, you tried to: a good thing by helping others, and we all respect that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I can't even: the basics properly, and who needs a nurse like that... I suppose I'll return this outfit to Akashi and apologize to everyone...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Mutsuki got sick all of a sudden! Wh-what should we:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
