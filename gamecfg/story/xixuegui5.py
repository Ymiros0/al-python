return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Everything will be okay. Vestal says it's just an ordinary fever. But, we have to: our part here too. Kisaragi, mind bringing bring me two towels and a basin of water?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Don't you worry, nya. When you wake up, you'll feel back to normal, nya? ...Huh? My job here is already:ne, nya?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Um, Javelin told me... She was worried about your health because of it. Nobody ever said you were:ing something bad.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:, Commander, can I keep this outfit:? For purposes other than seduction~",
			paintingFadeOut = {
				time = 0.5,
				side = 2
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... Of course, I'll make sure to: my job properly too! Thou hast my promise!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
