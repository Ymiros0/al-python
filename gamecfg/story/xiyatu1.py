return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"Now that you mention it, it:es feel like there's been a flood of new breakfast options lately.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...You mean it? Aw yeah,: let's get this show on the road!",
			painting = {
				alpha = 0.3,
				time = 1
			},
