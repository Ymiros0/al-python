return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Several days pass. I'm walking:wn the road when I notice something odd.",
			bgmDelay = 2,
			bgm = "story-richang-2",
			flashout = {
				black = True,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "And phase two, that's about... Ah, you probably:n't remember.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Bingo. You connected the:ts! Hahaha!",
			painting = {
				alpha = 0.3,
				time = 1
			},
