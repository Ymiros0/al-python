return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_103",
			say = "\"I love your enthusiasm, but we:n't have all the manpower and resources in the world.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "So? Isn't that normal? Everyone knows cats and:gs are natural enemies.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "Whoa! What's with the robot cats and:gs? Are they barking instead of meowing and vice versa?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 608020,
			say = "My Doggo Cattrons and Kitty Dogbots are a work of genius. Whether you're a cat or a:g person, you'll love these adorable robo-critters!",
			painting = {
				alpha = 0.3,
				time = 1
			},
