return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Next item on the party preparations list. the food. Seattle and I arrive at the Sakura Empire:rm to hammer out our plans.",
			bgmDelay = 2,
			bgm = "story-richang-2",
			flashout = {
				black = True,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Welcome to our:rmitory. Please have a seat and I'll bring tea out to you shortly.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "But:, those who prefer a stronger taste may complain that it needs more seasoning. Accounting for everyone's tastes is a tall order, I'm afraid...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "You can always experiment and see what people like. And I've got the perfect occasion for you to: it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "See, I'm throwing a party with a multinational theme on our next holiday, and I'd like you two to: the catering!",
			painting = {
				alpha = 0.3,
				time = 1
			},
