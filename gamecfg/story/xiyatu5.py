return {
	...
	scripts = {
		...
		},
		{
			...
			say = "We arrive at the Eagle Union:rm to look for a set piece for the party.",
			bgmDelay = 2,
			bgm = "story-richang-2",
			flashout = {
				black = True,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "And when it comes to surprises, nobody:es them better than the Eagle Union!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_145",
			say = "As soon as we step into the:rm's common lounge, a firecracker goes off above our heads.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "All our alleys, even! What: you girls think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
