return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "Check these out! Da Vinci invented these. Called 'em \"Warpy-Worpy VR Lenses,\" I think? Wonder what they:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Next time I'm throwing a party, I'm so:ing it in the place this is based on!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "Huh. I:n't see any jam in the cake. Maybe– Whoa!",
			painting = {
				alpha = 0.3,
				time = 1
			},
