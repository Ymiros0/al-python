return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"It was awesome. Hopefully we can: something like it again.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "Hang on,:n't say anything! I need a second to sort my thoughts out! I'll just, uhh...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199010,
			say = "Commander, I like you too. I had way more fun walking around at the party with you than I normally:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
