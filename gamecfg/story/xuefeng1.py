return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.22}",
			say = "Now! Bow:wn before me and place me in the main fleet!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "Uhh... Y-Yukikaze is always like this... so:n't let it bother you too much... okay?",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			say = "Huh? How would I know how to: something like that? More importantly, Commander, is it fine to leave Yukikaze alone over there?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
