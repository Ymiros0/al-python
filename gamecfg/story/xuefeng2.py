return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Zed, I:n't quite get this question~",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I've been having trouble trying to: maintenance on my equipment, since I can't really see from this angle... Yuki~ could you lend me a hand?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
