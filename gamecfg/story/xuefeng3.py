return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "What the heck! What is this loser:ing here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "Wa ha ha ha! Even though you've never defeated Yukikaze the Great even once? Hmph! Come at me:!"
		},
		{
			actor = 301130,
			nameColor = "#a9f548",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "*pant* *pant*... I thought you only had your dumb luck going for you but... seems like you: have some real skill...",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.22}",
			say = "We're not...:ne yet! Nowaki, bring the towel and the water bottle! We're going another round!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			say = "They could've just played rock-paper-scissors... so how did it escalate into all this? I:n't get it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
