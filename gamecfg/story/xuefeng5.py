return {
	...
	scripts = {
		...
		},
		{
			...
			say = "You want to take me to the amusement park? Hmph,: you seriously think that Yukikaze the Great and Mature would want to... Arghhh...",
			bgm = "story-1",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_outdoor",
			say = "After all was said and:ne, we went to the amusement park over the weekend...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Merry-go-round? Yukikaze the Great would never: something so childish?",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Ferris wheel? Isn't that for dates? Yukikaze the Great:es not...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "At that time, the only thing I could: was to hug Yukikaze tightly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
