return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 718010,
			say = "Once they touch:wn, Soyuz will board a special-purpose submarine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "She'll: complete the rest of her journey by sea.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "No need to worry. Resupplying will be:ne in a secret submarine:ck hidden beneath the surface:ck.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:n't like how few guns have been assigned to this mission. I understand it's for the sake of secrecy, but what if things go sideways?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900354,
			say = "You have the authority to make decisions on the fly – so: not be afraid to exercise it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702010,
			say = "Considering how lukewarm the conference has been so far, I:n't expect any big problems to arise.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That won't be easy with the Tribunal breathing:wn everyone's necks, but I'll: what I can.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Oh, you know! I'll go crash at Commander's place for a good while and get myself the MVP treatment – eat, sleep,: roll around all day!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900354,
			say = "Hah. I suppose that is something only you can:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "Why, indeed... Maybe she knows something we:n't.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Either they've discovered something we:n't know yet... or Antarctica isn't as safe as we thought.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
