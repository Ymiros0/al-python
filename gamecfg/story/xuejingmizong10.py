return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "The sound of gears grinding together. Slowly, the steel blast:ors opened like the jaws of some giant.",
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Because it looks so boring, people who:n't know any better will go, \"Meh, just another Northern Parliament base,\" and write it off!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_543",
			hidePaintObj = True,
			say = "After traversing a long corridor and passing through many blast-resistant roller shutters, the girls finally arrived at an elevator that would take them:wn to the bunker.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "All we need to: is get off at the right floor and we'll gain access to the Ring.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "Of course, we have areas further:wn to explore, but let's take things one at a time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
