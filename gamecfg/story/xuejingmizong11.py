return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you could just ride an elevator all the way:wn to the bottom, you might as well get rid of all the security 'cause it could be so easily bypassed.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "How the hell: you create crystals out of rock and ice?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "It:esn't seem like we'll learn how, either. The manufacturing machines have all been destroyed from the inside, and there are no logs left...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705080,
			say = "Ognevoy might be right. What happened here falls in the:main of magic.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Through some means, the ice and rock were combined to form the crystals, which were: carried to the surface.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "We will need to conduct research into how this was:ne, and how the mechanism behind the rigging resonance works.",
			painting = {
				alpha = 0.3,
				time = 1
			},
