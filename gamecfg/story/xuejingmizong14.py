return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_xuejing_cg5",
			hidePaintObj = True,
			say = "She tried to lift the lock on the device, and:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_xuejing_4",
			hidePaintObj = True,
			say = "After going through the tablet's contents, Soyuz sat:wn on a chair to compose her thoughts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "(I:n't know who, but SOMEONE has pinpointed the location of her mainframe.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
