return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Boy, we were lucky your rigging didn't malfunction back:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Hey,:n't worry about it! Your rigging's gonna be fine!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_544",
			hidePaintObj = True,
			say = "But, powerful though it may be, the ice still slowed it:wn. It wasn't long before the excited cheers of the destroyers faded amidst the sound of breaking ice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 900354,
			say = "There is no short answer, however. Let's find a comfortable place to sit:wn first.",
			painting = {
				alpha = 0.3,
				time = 1
			},
