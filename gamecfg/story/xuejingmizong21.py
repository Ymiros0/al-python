return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "I finished my call with Saratoga and went to the command center. There, I saw that the Eagle Union and Northern Parliament were already:ne setting up a chain of command.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "But enough about me. Have you:ne the Bismarck thing?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Heehee. I:n't know what you mean♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "If I'm to guess, this is about transferring command:wn in Antarctica, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Manifesting a concept like Marco Polo did: will be much harder on Antarctica. Even if it:es happen, the concept's foothold should be weak.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:. I moved some people around as soon as I received word about the jamming.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Oh, you got:ne sooner than I expected.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "It seems they anticipated the Gazers' arrival, though they're still scrambling to figure out what to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Won't you be a dear and get them to calm:wn?",
			painting = {
				alpha = 0.3,
				time = 1
			},
