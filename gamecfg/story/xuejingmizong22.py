return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			blackBg = True,
			say = "She is the key to all this. If we can neutralize her, it should end the crisis right there and:.",
			canMarkNode = {
				"storymap_nanjidalu",
				{
					1,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			blackBg = True,
			say = "All we need to: is lure her into an ambush and we can wipe out her and her Gazer army in one fell swoop.",
			canMarkNode = {
				"storymap_nanjidalu",
				{
					1,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			blackBg = True,
			say = "Add to that a few:zen cruisers and destroyers.",
			canMarkNode = {
				"storymap_nanjidalu",
				{
					1,
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107039,
			say = "Soyuz,: you read me? What's your status?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404050,
			say = "Soyuz, our fleet is in position. All there is to: now is wait for the target to come.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101480,
			say = "This is Ingraham. We're:ne evacuating all the Union and Royal Navy forces. The escort fleets will now join you in battle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "But... that's what makes Comrade Commander so reliable,:n't you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
