return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "The Knights of the Sea are:ne letting you run rampant!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "I mean, of course she couldn't. Being disconnected from your mainframe:es that to you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "She hasn't connected to her mainframe for a very long time now. Why? I:n't know.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "Like, at this point, why would she even bother? She can't: jack!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "It's no wonder,:, that she hasn't shown herself for so long.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I would like it if the enemy of my enemy were my friend... but you:n't seem keen on an alliance.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You clearly:n't like Observer either, though. Why:n't you take it out on her and we can all part on peaceful terms?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			dir = 1,
			say = "No can:. In case you forgot, I've got things to: here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "We have stopped an invasion such as this once. We will: it again.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "If you wanna stop me: you'd better give me your best shot! Ahahaha!",
			painting = {
				alpha = 0.3,
				time = 1
			},
