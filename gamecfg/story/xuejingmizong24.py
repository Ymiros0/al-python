return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "She:esn't stand a chance against our firepower!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "In this case, though... it almost:esn't feel right with how easily she's going:wn...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "(No... Could she be:ing the same?)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Look what you're:ing now. Do you think they'd be proud of you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "No! I'm:ing this because it's what my fallen comrades would have wanted!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#C3ABFF",
			say = "Wouldn't you know it – your Ring of Whatever isn't just a:omsday bunker.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#C3ABFF",
			say = "You think it's your ray of hope? You couldn't be more wrong. It's an express ticket to your:wnfall.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#C3ABFF",
			say = "This is what Project Dawn is! This is the obsession that's been passed:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#C3ABFF",
			dir = 1,
			say = "Now it's yours. Do you want to: the same as them?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "All you've:ne is escape the fate of being controlled by one Siren in favor of another one. You're still being controlled.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#C3ABFF",
			say = "You've got low-level programs, blindly following orders, and: you've got the Arbiters.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			say = "I pressed the button to call the girls, to cut off that ear-piercing laughter, but:...",
			bgm = "story-darkplan",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			nameColor = "#A9F548FF",
			say = "...Helena. So you heard it, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_port_chongdong",
			nameColor = "#A9F548FF",
			say = "Then I might as well ask you. Is what she said about Project Dawn True?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			nameColor = "#A9F548FF",
			say = "\"Reality can only become truth... if enough faith goes into it.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_port_chongdong",
			nameColor = "#A9F548FF",
			say = "Thank you. Next thing to deal with,:, is that ocean-freezing power of hers.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_port_chongdong",
			nameColor = "#A9F548FF",
			say = "From what I can tell, it's not an Arbiter or META ability. It's simply a bluff, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
