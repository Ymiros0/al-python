return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Our allies continued to strike:wn Gazers, all the while cornering the mastermind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(If she's imitating Bon Homme Richard,: she must still have an ace up her sleeve.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Memphis and Helena need to raise the security of our command network! If I:n't tell them now...!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Lock:wn this facility at once!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(This is definitely an enemy attack... But how: you get gas through communication lines?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			say = "In a world of pure white, at the far end of my vision, stood a single:or.",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It would be reasonable to presume this is the result of an enemy attack,:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "Is that so? Incidentally, so: I.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "I went through that:or and witnessed an unusual sight...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I think that:or leads to the data preserved at the Wisdom Cube's inception.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "First things first, let's see what's behind that:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
