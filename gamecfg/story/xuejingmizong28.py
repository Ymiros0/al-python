return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_542",
			hidePaintObj = True,
			say = "I instructed the Combined Azur Lane fleet to move to safe waters,: spread out and return to their faction's area of control.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_542",
			hidePaintObj = True,
			say = "Now, having:ne all this, it was time to contact the girl who'd helped me so much during this operation...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Yeah. About the crystals. While they: exhibit some resonance with riggings, the amount is just not enough to be practical.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9702010,
			say = "\"Resculpting\" is... Well, it's a special stage of METAmorphosis, fraught with danger and instability. I:n't want to tell you too much.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "Why: you think they changed? Where: the energy and data that turned them into what they are come from?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I:n't reckon you have all the answers, but maybe you can tell me a thing or two?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9702010,
			say = "I can't, since I:n't know what things you truly saw in there.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "What was that about the sun? What:es that have to: with anything?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
