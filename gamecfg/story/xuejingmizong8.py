return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Let me start by saying that the Eagle Union almost certainly:esn't know what I'm about to tell you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "It is a:omsday bunker a thousand meters below the surface. It was built to protect all the people inside no matter what calamity was unfolding on the surface.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "Naturally, I have no reason to believe it had anything to: with the discovery of the rigging-enhancing crystal...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705080,
			say = "Königsberg seemed completely unaware of it. I take it this is highly classified intel,:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Let's not jump to conclusions. We:n't yet KNOW if the Ring created the snowmelt area.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 705020,
			say = "It shouldn't be able to. It's in a:rmant state right now.",
			painting = {
				alpha = 0.3,
				time = 1
			},
