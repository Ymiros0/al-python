return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "That's weird, I could've sworn I went off to wake up the Commander... Guess I dreamt it all up... Alright:, back to sleep...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Not so much for me, you know? I was fast asleep, so I:n't know the feeling of being carried in your arms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So I'm offering you the opportunity to: it again! Carry me like a princess!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "If I saw something like that, I'd be like. \"that poor girl... She's fast asleep, and the Commander's just carrying her around the place like that? How could anyone: something so cruel...\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Wait,:es this mean they all think I'm annoying and:n't care what happens to me?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Darn it... Well, no use thinking too hard about it! I'm ready to start working! Let's: this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
