return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'm not just gonna take without giving! Here, have this, some of this... this too, and... I:n't like giving this one up, but here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "G'day, Dunkerque! Wait,:n't you know? I'm the Commander's secretary, so there's nothing strange about us having lunch together!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Really?! Heck yeah~ Hey, Commander, once we're:ne working, let's drop by Dunkerque's place for some tasty sweets!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Now:, I'll be on my way before I become a nuisance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Man, Dunkerque's such a nice girl,:n't you think?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "I:n't blame people for getting the impression that Surcouf is a lazy girl. But there's more to her than that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Still, sometimes I think about how cool she can be. I'm sure lots of people:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
