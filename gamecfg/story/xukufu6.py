return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Besides, you really think she can: her job in this sorry state she's in?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "Point to all the processed:cuments on your desk",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Are you saying your work gets:ne even if she's useless, and you:n't even wish that she'd: anything useful?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
