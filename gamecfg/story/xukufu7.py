return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I didn't MEAN to fall asleep and leave you hanging! P-please,:n't be angry... okay?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wow, it's all:ne! You're the most amazing person ever, Commander!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "I couldn't have:ne it without you",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "... Ah well, better not think too hard♪ If you say I was useful,: I was!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "I say first we get some dinner,: we head straight to Dunkerque's place for dessert~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
