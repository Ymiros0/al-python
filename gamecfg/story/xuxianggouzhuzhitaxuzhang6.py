return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 107070,
			say = "Plus, this is a pretty weird Mirror Sea if I've ever seen one. It looks imposing as hell, but there aren't many enemies and the only ones that: show up are weak.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 107070,
			say = "Look, Enterprise has better things to:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I'm the victor here, so can't you: a little favor for me?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 107070,
			say = "That makes sense... Let's hurry up and meet up with the others:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "If you have time to tease me,: help out already!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Prinz Eugen, reporting for duty–– or so I'd like to say, but that:esn't seem to be necessary anymore.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
