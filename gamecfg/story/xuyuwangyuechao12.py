return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_yunxian_3",
			hidePaintObj = True,
			say = "The shipgirls rushed outside to see what was going on. Musashi, the head of the group, urged her shocked friends to calm:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "The foreboding dark mist – the Shadow of Corruption – whatever you:,: not let it escape the sanctuary!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll use my cheat skills! Old Man,:n't you move a muscle!",
			painting = {
				alpha = 0.3,
				time = 1
			},
