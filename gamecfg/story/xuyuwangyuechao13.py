return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Owari",
			say = "What the heck are you:in' up there, girl?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Owari",
			say = "What to:, what to:... Wait, I've got it! Hold on!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_yunxian_3",
			hidePaintObj = True,
			say = "Zuihou, while hardly the most calm and composed person Owari knew, had never broken:wn crying like this before.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305130,
			say = "Look, we'll find a safe place for you to calm:wn! Follow me!",
			painting = {
				alpha = 0.3,
				time = 1
			},
