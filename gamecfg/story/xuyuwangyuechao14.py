return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_yunxian_3",
			hidePaintObj = True,
			say = "She looked:wn, but couldn't see anything. It was like staring into a pitch-black abyss.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I have no idea, and I:n't think we have time to think about it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301890,
			say = "We've got to find Zuihou quickly,: go and rescue Musashi!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301900,
			say = "If anything, she has no:ubt felled the creature by now!",
			painting = {
				alpha = 0.3,
				time = 1
			},
