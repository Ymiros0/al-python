return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "...And: we have the power to deal with it in our current state?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Are your rituals able to: that?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			oldPhoto = True,
			say = "This was the Sakuran ritual of forming a barrier:main.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			oldPhoto = True,
			say = "Once the barrier had been fully formed, the colors surrounding them seemed to be absorbed into the:main itself.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			oldPhoto = True,
			say = "She: drew it from the scabbard and gripped its hilt tightly, reaffirming her determination to fight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "We must push back the darkness and form a new seal that:es not draw its power from the very same source of corruption.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
