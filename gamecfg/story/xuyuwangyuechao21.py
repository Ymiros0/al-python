return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_510",
			hidePaintObj = True,
			say = "From it, dark mist began to gush forth and infect this:main, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305130,
			say = "Wait... If she did that,: who was the person we met just earlier?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301890,
			say = "It really:esn't matter what you call her...",
			painting = {
				alpha = 0.3,
				time = 1
			},
