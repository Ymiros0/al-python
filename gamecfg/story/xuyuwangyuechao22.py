return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "I: not. But, assuming the Great Sage's seal still hasn't been fully destroyed...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Only you can: it, Musashi. I trust you to save them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I shall: use the power of the sanctuary's seal to transport all of you outside it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
