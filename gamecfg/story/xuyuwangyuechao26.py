return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "The Great Sage",
			nameColor = "#A9F548FF",
			say = "This is my duty. Something that only I can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actorName = "The Great Sage",
			nameColor = "#A9F548FF",
			say = "Who am I to transcend above the mortal realm, looking:wn upon creation like some sort of god? No salvation can come from that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actorName = "The Great Sage",
			nameColor = "#A9F548FF",
			say = "All that I've:ne to defy destiny will remain as proof that I was human.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actorName = "The Great Sage",
			nameColor = "#A9F548FF",
			say = "Let us purge the dark mist that threatens to burn the world:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
