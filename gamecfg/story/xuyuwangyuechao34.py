return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actorName = "???",
			say = "You look rather worn:wn by the banquet. My condolences.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_510",
			hidePaintObj = True,
			say = "Eventually, I told her that I'd best get back to the dinner party. When I turned around to: just that...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
