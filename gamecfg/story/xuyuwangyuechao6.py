return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			oldPhoto = True,
			say = "When she listened carefully, she heard faint breathing behind the screen:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			oldPhoto = True,
			say = "She carefully opened the:or, trying not to make a sound, and glanced inside before closing it again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
