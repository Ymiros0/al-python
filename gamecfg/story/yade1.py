return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "My... You:n't look too hot, Commander. Are you okay?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Well, I suppose all I can really: is find typos and the like... The actual decision-making falls to you, in the end. Okay! Good work today, Commander.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Commander,: you ever find yourself wanting to be a little lazy?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Of course, I:n't mean just abandoning your work wholesale. After all, a girl as good as me would never neglect her duties.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "As for what you'll: while you're off work, this good girl will gladly find something for you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Why:n't we give it a try tomorrow morning?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You:n't need to: anything; leave it aaall to me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "I watched Jade leave as I cleaned up the rest of my:cuments.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
