return {
	...
	scripts = {
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "Oh,: you like these, Commander? Spee recommended I try them a while back.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:n't think she likes them because of the taste, though. It's more likely because they're fun to put on your fingers.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "And:, she threw the whole piece into her mouth and went, \"Eww...\" It was just hilarious!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Ahaha! You know exactly who loves these,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hmm... Okay. Until we think of any fun topics of conversation, let's continue what we were:ing before.",
			painting = {
				alpha = 0.3,
				time = 1
			},
