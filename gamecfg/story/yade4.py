return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Our supply of snacks is running thin faster than usual? Hmm, what could that possibly have to: with me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "Really, Elbe can't: anything without me, can she?",
			painting = {
				alpha = 0.3,
				time = 1
			},
