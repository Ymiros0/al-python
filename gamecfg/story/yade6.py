return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'd love to see your swimming, if you:n't mind.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It:esn't have to be top speed. All I want is for you to push me and my swim ring around the pool.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_133",
			say = "\"If that's all you want, I:n't mind.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "While we're here, why:n't I take a picture? Look over here, Commander.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hm? Commander? You're slowing:wn. Are you already tired?",
			painting = {
				alpha = 0.3,
				time = 1
			},
