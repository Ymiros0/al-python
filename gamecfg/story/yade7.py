return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "You're so sweet that I:n't know whether I really look like a good girl or a bad girl to you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "I:n't plan to let anyone take my time with you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406010,
			say = "I:n't know what you're so happy about, but congratulations on whatever it may be.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "A familiar voice called from beyond the:or before coming in with snacks.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 406030,
			say = "I:n't suppose I have to explain what we're going to: now.",
			painting = {
				alpha = 0.3,
				time = 1
			},
