return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Her Majesty is certain beyond a:ubt that there's something here. We just haven't found it yet because I'm dead weight...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "You're not dead weight at all. If failing to find anything noteworthy is a crime,: I'm equally guilty of it as well.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "Calm:wn, Royal Oak! You know everyone cares about and respects you!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "Please:n't berate yourself like that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That should: it. Argus, is the alarm still sounding?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "A False alarm:esn't explain the footsteps your heard, though.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "I see... Also, I think I should: a more thorough system inspection. We might find something new.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "It's getting worse! Oh goodness, what: we:?! One thing after the next is failing!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "Royal Oak,: you hear me?! What's happening over there?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
