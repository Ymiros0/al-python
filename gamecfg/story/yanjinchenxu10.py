return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "I'm not sure if I'm just imagining things... but this place:esn't seem as claustrophobic and dreary as it did before.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "So, are we:ne with this Basilica? Shall we move on to the next one?",
			painting = {
				alpha = 0.3,
				time = 1
			},
