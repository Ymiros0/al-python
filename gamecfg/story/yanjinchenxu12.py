return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_firedust_1",
			say = "It did not take long for the battle at Basilica Noir to also wind:wn smoothly.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Don't worry, I did not mean to cast:ubt on your abilities. I simply am glad to have someone else's confirmation.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Scylla, did you notice Richelieu and Béarn:ing anything unusual while they were cleaning up the battlefield?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "However, that did not come with the technology needed to control them. That's something only the Sirens know how to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
