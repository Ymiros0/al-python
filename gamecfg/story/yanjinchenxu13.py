return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 807010,
			say = "I can't give you a definitive answer without:ing a bit of investigation myself, but they might've been sent deeper into the catacombs–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "...One of the Basilica's facilities, responsible for breaking:wn and recycling the Pawns manufactured here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The situation:wn there probably isn't very optimistic either, but it:esn't change the task at hand.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I'll trust your assessment of the situation:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Naturally, as these facilities belonged to the Iris Orthodoxy, the Cardinal should have the final say over what to: with them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "There's no need to be so formal. Though I've had to choose my words carefully,: let Queen Elizabeth know that I am extremely grateful for her assistance.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "Much obliged. Now, all we need to: is to wait for Béarn to finish reactivating the purification system.",
			painting = {
				alpha = 0.3,
				time = 1
			},
