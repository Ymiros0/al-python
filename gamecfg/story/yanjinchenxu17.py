return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Hmm... You're right, I:n't see any sort of control device here, and the entire place is crawling with enemies...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Things:n't add up:. There are four different-coloured Basilicas corresponding to each of the Horsemen, but I'm only seeing one type of enemy here – red.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Based on my experiences, that:es sound somewhat plausible...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "So my question is – why are they not:wn here either?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "That's begging the question, Hero. What evidence: we have?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We:n't know if there's any inherent differences in strength between the fleets.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202330,
			say = "Do you think this has something to: with \"concepts?\" Just like how the concept of sanctity kept us safe earlier,: you think something here is amplifying the concept of War?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "And if the Four Horsemen are fighting over control of this area,: the concept of war would permeate every corner of this space.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "What about the concepts of Death and Famine? For Pawns and mass-produced machines, these concepts: not exist at all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "By the way, how did the Orthodoxy try to fight against the Horsemen back:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I:n't think that'll be necessary. You had us activate the purification stations at each of the four Basilicas in a specific order, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "If that symbolises the breaking of the seals from the Scriptures, what: you think would happen if we defeated the Horsemen in the opposite order?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "We'll follow the order of Vert, Noir, Rouge, and: finally Blanc. Given the diminished strength of the first two Horsemen, we should also take advantage of that opportunity to learn how to best fight in this space.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What: you think about my proposal, Cardinal?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "It's certainly worth a shot. We have more resources at our disposal now than we ever did back:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
