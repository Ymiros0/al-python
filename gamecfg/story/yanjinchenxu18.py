return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202330,
			say = "An intricate scythe was discarded nearby, leaving no:ubt that this is where Vert, the Horseman of Death met its demise.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202330,
			say = "Neither Pawns nor conventional mass-produced ships are able to cause this kind of damage, so that most likely narrows things:wn to two of the remaining Horsemen.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202330,
			say = "For machines that: not know the concept of \"Death,\" this space seems like a particularly unforgiving place to fight.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Very well:. Everyone, spread out, and avoid unnecessary combat. Remember, your priority is just to confirm the existence of the remaining Horsemen!",
			painting = {
				alpha = 0.3,
				time = 1
			},
