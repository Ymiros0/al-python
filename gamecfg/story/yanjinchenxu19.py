return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "But, uh... Here, why:n't you use these binoculars? You'll at least be able to see farther this way.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 206020,
			say = "But I got sent off to this operation and won't get to see her for a while, so why:n't you go ahead and see if it works fine?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 205140,
			say = "Um, alright:. If you:n't mind, I...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 807010,
			say = "This is Béarn, light carrier of Iris Libre. My Royal Navy friends,: you copy?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 205140,
			say = "According to Lady Implacable, the Horseman of Famine should be defeated next, right? If the mass-produced ships manage to take it:wn...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Not particularly. War hasn't made any moves as of yet, but the sheer number of mass-produced ships are slowing us:wn even if they're not a major threat.",
			painting = {
				alpha = 0.3,
				time = 1
			},
