return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Let's ignore them, since they're not:ing anything.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Don't be daft. Until we understand how this place works, I:n't want you accidentally waking up the Horseman.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But whatever you:,:n't touch it. And:n't shoot at it either.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "It's big, it's white, and it's kind of just sitting there behind the wall of light.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "Is that... La Galissonnière? What is a member of the Tribunal:ing here?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Seems our beacon tracker was useless... So, some of you: have a way of evading our detection.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "You're a long way from home. Whatcha:ing here?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900353,
			say = "Whoa, excuse me? You accusing me of something as lame as stealing? I've got way better stuff to:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900353,
			say = "Once I got:wn here, I could tell that the Sirens were exploiting the concepts of the Four Horsemen of the Apocalypse to develop self-reinforcing superweapons. As long as those factories keep churning out Pawns, the Horsemen will keep getting stronger ad infinitum.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "On the bright side, stopping the experiment is also simple – all you need to: is shut:wn the factory, and \"seal\" the Horsemen in reverse order.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 900353,
			say = "I'm makin' it sound easy, but I shouldn't have to tell you that you:n't kill a Horseman of the Apocalypse in one afternoon.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "You said you're here to destroy a Siren test site. I: find that interesting.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Don't tell me... you got sent here to: grunt work because you're the newest of the bunch?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Grunt work, huh? You:n't know anything about us Ashes.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You still want the test site gone, no? I:n't see why we can't work towards that together.",
			painting = {
				alpha = 0.3,
				time = 1
			},
