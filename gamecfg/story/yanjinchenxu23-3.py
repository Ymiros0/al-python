return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Did that thing just:dge her shot? So much for being halfway dead!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Small correction – our Ashes ally isn't:ing much of anything.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			paintingNoise = True,
			dir = 1,
			say = "La Galissonnière, what are you:ing? Didn't you say you'd help us?",
			painting = {
				alpha = 0.3,
				time = 1
			},
