return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I must ask... What did you: back there?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "What: you think? I offered a prayer, and it was answered.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Bingo. Well, kind of. You can't just make any concept real – it's got to: with faith.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Use your brain before you pray. Don't go around offering words of power to a harbinger of:om.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "If that's what it takes to defeat the Sirens, sure. Can I: it right here?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I suppose it must be:ne in a reasonably dignified location, huh.",
			painting = {
				alpha = 0.3,
				time = 1
			},
