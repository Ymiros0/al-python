return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 207070,
			dir = 1,
			say = "If you:n't start pulling your weight, maybe you'll lose a limb or two as well.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 805010,
			dir = 1,
			say = "Calm:wn, Implacable. She:esn't trust us to not use her as cannon fodder, which is sensible.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "We:n't have much of a choice anyway, so let's at least give her the best conditions to succeed.",
			painting = {
				alpha = 0.3,
				time = 1
			},
