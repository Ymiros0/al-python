return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_firedust_7",
			say = "Then, with a hollow snap, it broke into a:zen little pieces.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Just because they haven't been manifested in the form of Horsemen:es not mean that the concepts:n't exist!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "If you:n't want the world to end, you'd better get that idea out of your head!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "So, if that's no longer an option, how: you propose we take:wn the last Horseman?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "*sigh*... I suppose we're in a real bind:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But that:esn't improve our situation. While you can leave this place whenever you want, we can't unless we finish the job.",
			painting = {
				alpha = 0.3,
				time = 1
			},
