return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "(She was right. All along, the Tribunal had a way to eliminate this Horseman... So why didn't they: it?)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_firedust_7",
			say = "Following the procedures she remembered, she input a sequence of parameters,: hit finalize.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Oh well. She:esn't owe us anything, and it's not like we can make her stay anyway.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Speaking of leaving, it's time we: the same. Take care of the Basilica Island, Cardinal.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "The entire Basilica system was designed with a higher authorisation level than sysadmin, preventing Argus from shutting:wn its emergency mode.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "My question is, what might that authorisation be? What purpose:es it serve, and who holds it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202330,
			say = "I...:n't have enough information to answer that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
