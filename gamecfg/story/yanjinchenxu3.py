return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 201360,
			say = "Whoa, it's not:ing anything! Is this thing broken, or what?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 201360,
			say = "For real? Dungeons are cool and all, but I:n't wanna marathon four in a row.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 202330,
			say = "The lighthouse tower to the southwest should:. Royal Oak and Argus focused their investigation there, as well.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Oh, the protagonist, you say? Naturally, that means you'll: the lion's share of the work, yes?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 207070,
			say = "Oh, I'm so very sorry. As an apology, I shall let you lead the way:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 201360,
			say = "Now you get it! You're about to see how a Hero:es dungeon-crawling!",
			painting = {
				alpha = 0.3,
				time = 1
			},
