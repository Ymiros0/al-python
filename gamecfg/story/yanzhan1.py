return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(Now what shall we: about this...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "Nng... Hm? Hrmm? Warspite? You're here by my side...? Very good:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(That is the reaction I expected... But I: believe we can make the meeting on time.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ahem! Now:, the Royal Navy has agreed to a second round of large-scale exercises with the Eagle Union!",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Right:, I shall gladly take on the training of the Royal Navy!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
