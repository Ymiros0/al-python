return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(I: find myself more relaxed when chatting with the Commander. All the stress of the day washes right away.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(... When I put it like that, I realize I: often go looking to talk with the Commander of my own accord...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Sigh. Now:, if you have something you need to say, Warspite, we certainly shan't interfere. You have your own affairs to manage, of course.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
