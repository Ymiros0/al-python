return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(Don't tell me... the Commander hid most of the work to: later so we would have more time to chat?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(For I am Warspite. I have borne witness to every bitter twist of war, and found nothing that can bend me, the \"Unsinkable Legend\". No matter who may threaten to harm you, the girls, or the entire fleet, they would have to go through my broken body to: it.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
