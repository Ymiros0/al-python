return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 904010,
			dir = 1,
			say = "There should be nothing to worry about. Since the repairs are about:ne, I alone should be able to...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Just tell us: if that's the case... All right, before we go, let's go over the mission one more time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't want to end up fighting Iris Libre... but if it comes:wn to it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 904010,
			dir = 1,
			say = "Very well. If we must fight,: I shall: my part.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
