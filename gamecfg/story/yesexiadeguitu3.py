return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900236,
			dir = 1,
			say = "I hope we:n't run into any more trouble on the way to Toulon...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hehe. I've had plenty of time to rest up in the:cks... But, I also haven't been able to contribute to the Vichya's war efforts as a result...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hmm...? Sorry, I only heard about half of it... But, in any case, I:n't think you need to blame yourself, Dunkerque.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Regardless of the camp - Royal Navy, Iron Blood, or Iris... I:n't think there's anything we can: about the fact that their leaders think of us as weapons of war.",
			paintingFadeOut = {
				time = 0.5,
				side = 2
			},
