return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900236,
			dir = 1,
			say = "Macarons, Montblancs, profiteroles, mille-feuille... there's so much stuff here I:n't know where to start...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900236,
			dir = 1,
			say = "I know! Now, where to start... Mmmmm! So good! Tartu,: you want some as well? Dunkerque, can Tartu also have some?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
