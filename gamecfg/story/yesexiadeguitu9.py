return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "Wait, Dunkerque! What: you possibly hope to achieve returning to the Vichya Dominion in its current state?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900236,
			dir = 1,
			say = "I know, I know! Tartu, why:es it feel like you're hyper focused today~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 901020,
			dir = 1,
			say = "Huh? I was just thinking about the best way to:ck...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "In this \"Simulation,\" the Royal Navy will be dismantled after:zens of their ships sink to the hands of battleship Jean Bart...",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
