return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Why:n't we: a little cleaning first?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101480,
			say = "Nothing major, just thinking about how to get some work:ne. Speaking of which, are you here to pick up that thing you asked me to repair for you last month?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101480,
			say = "If so, I unfortunately have bad news for you. I still need, lemme think, another two months or so? That should: it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_148",
			say = "Ingraham throws open the:or to the warehouse behind her, revealing a mountain of miscellaneous items that leaves Cooper awestruck.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101440,
			say = "Oh, right! The Commander gave you permission to store your stuff in this warehouse, right? Why:n't you apply for another storage place?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101480,
			say = "Forget it. All that would: is:uble the backlog eventually.",
			painting = {
				alpha = 0.3,
				time = 1
			},
