return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101480,
			say = "Commander, what:es this mean...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"What:es it mean to you when you help fix stuff for your friends around the port?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"I see. I'll have to give your application some thought:.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "\"While I'm:ing that, there's a set of recently-retired equipment in the warehouse. How about you use those to take care of your problems in the short term?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101480,
			say = "I'll: just that! Thank you so much, Commander!",
			painting = {
				alpha = 0.3,
				time = 1
			},
