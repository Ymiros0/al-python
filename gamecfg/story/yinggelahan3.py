return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Thanks a ton, Cooper... I couldn't have:ne it... without you...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101440,
			say = "Ahaha... I guess you're right. Maybe we can let her \"adventure\" in here after we're:ne cleaning up.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Now, I can finally get some serious work:ne...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "...I'm telling you, it:esn't make any sense why these aren't installed with the same functionalities they have in those movies!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "They're supposed to be able to transform and bounce around, but these can't: anything like that at all! Such a disappointment!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102260,
			say = "That's right! Take a look over here – in the movies, this bit is supposed to automatically transform. But, I have to: it myself with this version!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_148",
			say = "Ingraham:odles a few diagrams on her workbench, puts on her goggles, and starts \"repairing\" the shield.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
