return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "There's no answer from the other side of the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "After a long while, the:or cracks open.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 101490,
			say = "Woah... what's going on with this light? What'd you: to it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_109",
			say = "There is that unmistakable glimmer of wonder in her eyes once more, a fact that:es not escape Ingraham's notice.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
