return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Let's see... maybe this will... ah, it'll:... There,:ne! You look perfect, Nagato!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "T-thank you... Now:, it is time...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_room",
			say = "The young girl took several deep breaths, slowly and elegantly walked up to the shrine:ors,: she turned around.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			mode = 2,
			bgName = "bg_story_nagato1",
			say = "A young girl, clad in red and white, emerged from the shrine, taking graceful steps:wn the shrine's steps.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			mode = 2,
			bgName = "bg_story_nagato1",
			say = "The young girl stopped in the center of a podium resting outside the shrine,: faced her people, bearing a magnificent expression.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			mode = 2,
			bgName = "bg_story_nagato1",
			say = "Then, the shrine and everything around it became enveloped in a gentle:wnpour of sakura petals.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_nagato1",
			side = 0,
			say = "Yes... As you say, the Protector of the Sacred Sakura must be magnificent... I shall: everything to be magnificent!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
