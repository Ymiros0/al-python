return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Nagato took aim at and fired the Siren, but she:dged it. Purifier didn't respond by preparing for combat, instead she turned to Nagato with a displeased look.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actorName = "Purifier",
			dir = 1,
			say = "Let's see... \"When the Winter's Crown is:nned, when the Steel Sakura blooms... the Souls' Transmigration will begin... and start the Final Prelude\"?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
