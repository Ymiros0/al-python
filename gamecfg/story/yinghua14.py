return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "For being your first real battle, that was spectacular. How:es it feel to be victorious?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "If the Spirits I saw in my slumber are the \"souls\" the Siren spoke of,: they aren't gathering here, but in a far-off, distant place.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Whether the Sirens are behind this, or a being beyond my comprehension, I can't say. But I: know that somewhere in this world, there is a force trying to cause great change.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "If you were in this situation beyond all expectations... what would you:?",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
