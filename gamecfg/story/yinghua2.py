return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "I:n't blame you for being so excited to see such a nostalgic place... but could you at least show a little consideration for the elderly... *Panting*...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			dir = 1,
			say = "Sorry, Mikasa! We'll slow:wn. Also, this is the first time I've heard you complaining...",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Ahaha, um... I appreciate the thought... But I:n't think my palate is ready to try that yet...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
