return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "By \"someone important,\" surely you:n't mean...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 1,
			dir = 1,
			say = "I:. We must rescue Nagato, who has remained by the Sacred Sakura all this time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "We'd better hurry,:! But first, we'll have to take care of these guys!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "All we can: now is wait... We must wait until the one who can oppose the Sirens and change fate itself has arrived...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
