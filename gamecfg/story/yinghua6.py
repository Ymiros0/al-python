return {
	...
	scripts = {
		...
		},
		{
			...
			side = 0,
			bgName = "bg_story_nagato2",
			say = "Nagato! Sirens have surrounded this place! I heard they're supposed to protect it, but: that means...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 0,
			bgName = "bg_story_nagato2",
			say = "Those idiots! They:n't even know what we're capable of, yet they go and: this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 0,
			bgName = "bg_story_nagato2",
			say = "I know they have! But it matters not... There is only one thing I can: to atone for my wrongdoings.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_nagato2",
			blackBg = True,
			say = "Thank you for everything you've:ne, Mutsu.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
