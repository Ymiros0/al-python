return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 0,
			say = "If you still wish to have it your way,: show me your resolve through a battle!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 0,
			say = "I knew it! I knew this would happen! It's so clichéd, yet it always:es!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
