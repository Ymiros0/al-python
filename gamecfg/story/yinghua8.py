return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_nagato3",
			dir = 0,
			say = "And all I can: is watch over her and keep her safe from the Sirens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 0,
			blackBg = True,
			say = "That is our goal, too. Kawakaze, you have:ne well. We shall take care of the rest!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
