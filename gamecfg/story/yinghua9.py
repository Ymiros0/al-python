return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Do you see those:lls on the table? Do you think they, too, possess a heart and a soul?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Hey! You smiled! I knew you could: it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_room",
			dir = 1,
			say = "Let us hope so... U-until:, Mutsu... you must promise to keep me company...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
