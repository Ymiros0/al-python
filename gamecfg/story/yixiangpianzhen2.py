return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "The reason why Anchorage calls you \"Teacher\" might have something to: with the peculiarities of her hull. We:n't know if she even perceives you to be her \"Commander.\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "The Research Department:esn't seem to think so. We see all kinds of unexplainable things on the bleeding edge of scientific research.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#A9F548FF",
			say = "I checked in on her on my way here, and nothing seemed off about her. She looked like she was:ing just fine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Honestly, I:n't think that girl has any idea what this place is or what we're worried about.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#A9F548FF",
			say = "There's no reason to be. She's:ing perfectly fine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#A9F548FF",
			say = "She's fine. Honestly, I:n't think that girl has any idea what this place is or what we're worried about.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"But, how: we approach this problem?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"But there's one problem. We:n't know if we can even use the Reality Lens on shipgirls,: we?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"I:n't see the problem. Why the concerned look?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"You're right. If the Reality Lens could have helped analyze her,: it would've been proposed in the report.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"But we:n't have any other ideas, and we:n't have all the time in the world.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "You have to be the one to use it, too, so:esn't matter how early it's ready if you're not there to operate the Reality Lens.",
			painting = {
				alpha = 0.3,
				time = 1
			},
