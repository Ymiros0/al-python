return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 112010,
			say = "Worse, we:n't know what might happen when you interact with Anchorage's \"anomalies.\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 112010,
			say = "Speaking from a professional's perspective, I'm still opposed to you:ing this.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"We could give the algorithm more time to be perfected, sure, but that:esn't mean waiting will solve all of our problems.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"It could take years before we feel 'ready.' I say we: it now instead of waiting.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "\"Do you remember Bismarck's Cube? We:n't know what effects hull anomalies might have on a shipgirl, but we: know how serious they can be.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
