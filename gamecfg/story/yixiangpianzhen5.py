return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1104",
			say = "Suddenly, I spotted a:or standing in the distance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1104",
			say = "But:, I noticed Anchorage next to the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1104",
			say = "\"And what:es it mean for the Reality Lens to dream, anyway...?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			options = {
				{
					content = "\"It's just beyond that:or, right?\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_1104",
			say = "Anchorage pointed to the:or and urged me to go in.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 199030,
			say = "It's Anchorage's first time... so Anchorage wants you to: it, Teacher!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_1104",
			stopbgm = True,
			say = "I steeled my resolve and headed through the:or.",
			bgmDelay = 0.5,
		...
		},
		{
			...
			side = 2,
			actorName = "???",
			say = "Oh, calm:wn. I'm just a recording. Or, well... More precisely, an AI that can play recordings.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actorName = "Recorder",
			say = "Oh, that's bad. Ahhh, I've really:ne it now...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actorName = "Recorder",
			say = "No, this bit of sentimental data is far too vague. I:n't think she'd: anything that simple...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actorName = "Recorder",
			say = "I:n't know the details. After all... I'm just an AI who plays recordings!",
			painting = {
				alpha = 0.3,
				time = 1
			},
