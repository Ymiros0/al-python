return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 112010,
			say = "This is awful! If we:n't stop the data, it'll just keep growing!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "I guess... that's all we can:, huh? We'll have to use the last resort the Commander and Saratoga left for us.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "TB",
			side = 2,
			say = "In 10 minutes, the core of the facility will be locked:wn. In 30 minutes, so will the remainder of the facility.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "We:n't have much time. We have to save the Commander and Anchorage!",
			painting = {
				alpha = 0.3,
				time = 1
			},
