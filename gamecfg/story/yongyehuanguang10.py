return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't seem like the praying type. Worried about the commander~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 206060,
			dir = 1,
			say = "We've already been spotted, so I:n't think running will: us any good at this point. We'd best call the main fleet and engage the enemy at once.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
