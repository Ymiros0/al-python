return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "...Oh my, is that a Royal recon plane? What are we ever to: if they \"find out\" about our plans?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Well:ne. Ah, how proud I am of our wonderful Iron Blood technology... Ehehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
