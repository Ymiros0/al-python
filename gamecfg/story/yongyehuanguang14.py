return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Don't worry, it's not your fault. There's only so much you can: with all those planes circling over us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't think so. The Iron Blood's main fleet has already joined up with Hipper.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What: you mean...? I'm sure I saw a ship in the distance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't mind, but that runs the risk of it getting shot:wn... Wait, what's this?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
