return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 205100,
			dir = 1,
			say = "Bloody hell, they could've told us before the Sirens got here. What's the Northern Parliament:ing anyway?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205100,
			dir = 1,
			say = "What: you think?! The Sirens are popping out left and right, so we're not going to be able to go anywhere without dealing with them first!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
