return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 408070,
			dir = 1,
			say = "All righty, looks like our mass-produced fleet is:ne for as well. How about we wrap things up over here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Good. From this engagement, it is clear that the Iron Blood at least:es not want to sabotage the war effort against the Sirens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It would've been better to just let us pass through:... Ahaha...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "(It:esn't seem like the communication device is malfunctioning though... Are the messages somehow not getting relayed properly...?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = True,
			nameColor = "#a9f548",
			say = "(I can't: anything about it though... so all I can: is continue to press forward!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
