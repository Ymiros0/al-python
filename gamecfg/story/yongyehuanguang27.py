	...
	scripts = {
		{
			...
			dir = 1,
			bgmDelay = 1,
			say = "So that's how this device works. It:esn't just listen in on transmissions, it actually \"catches\" them. Unbelievable.",
			bgm = "bsm-5",
			flashin = {
				delay = 1,
				dur = 1,
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "So be it. Just:ing that is sufficient to disrupt the \"Reenactment,\" isn't it? In that sense, it more than:es its job.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
