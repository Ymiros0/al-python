return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "After you're:ne dealing with the planes, we could use your help. Even though they're just mass-produced models, we're having trouble dealing with the heavy cruisers.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 206060,
			dir = 1,
			say = "I would've liked to say that the Iron Blood is behind it, but that:esn't seem to be the case.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
