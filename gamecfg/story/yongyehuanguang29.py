return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "There's no way I'd: that~ Wouldn't we be playing right into the Sirens' \"Reenactment\" if we tried to use them?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "I've already:ne what I came here to:. I'll be taking everyone back home soon enough.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "...Huh? We barely just got here, and haven't even gotten anything:ne! Are you sure that plan is working?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
