return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 202270,
			dir = 1,
			say = "Even the commander? ...We might not be able to fulfill our mission even after dropping off the supplies:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If things go south, the Boss won't be able to leave the Northern Parliament:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 207010,
			dir = 1,
			say = "I appreciate the optimism, but I:n't think they're coming to chat. In any case, let's all keep our wits about us. The people fighting on the front lines are waiting for our aid.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
