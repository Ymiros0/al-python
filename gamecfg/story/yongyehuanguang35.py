return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "Valiant and Howe:dged and weaved between Omitter's attacks, ruination flashing all around them as they waited for a single decisive moment.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Cannonfire, torpedo barrage, beam weapon...: repeat...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
