return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't know the exact situation, but our forces there are still locked in combat. You should immediately turn around and reinforce them as soon as possible!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If the escort fleet has already arrived safely,: there's no reason for us to be here anymore. Everyone, turn around and join up with Perseus's group.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
