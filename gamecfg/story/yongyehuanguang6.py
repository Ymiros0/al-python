return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "After forcing Hermione to swerve sharply to evade her last torpedo, U-73 quickly:ve under the waves and retreated from the battlefield.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I:n't think so. Nobody got hit, right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 207010,
			dir = 1,
			say = "Not sure. What: you think they could learn from an engagement like that...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
