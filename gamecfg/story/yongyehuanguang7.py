return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "It's True that the Royal Navy:ctrine encourages us to proactively take the fight to the enemy if they seek to assemble their forces against us... but even when we're on a transport mission?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "If we turned around and left, what would the transport fleet:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n't think Her Majesty would choose this place for a decisive confrontation with the Iron Blood. Surely there's some kind of mistake...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "If we wait a bit longer, maybe the escort fleet will decide to leave... Even if they:n't, we'll still have our chance soon.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
