return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Back:, the Iron Blood and Royal Navy both fought the Sirens together as a part of Azur Lane.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 206060,
			dir = 1,
			say = "Natural phenomena like this: appear in the Polar North, though it is strange that we didn't see any signs of an aurora given the visibility.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 206060,
			dir = 1,
			say = "Vampire,:n't you think it's a good idea to have your casket freshened up a little?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
