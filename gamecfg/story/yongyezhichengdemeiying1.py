return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "It was a slow day. There was strangely little work on my plate and I had more free time than I knew what to: with.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "The:or handle turned, and into my office stepped Prinz Eugen.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#a9f548",
			say = "Think of it this way. you could spend the day alone in your office,:ing paperwork... OR, you could get out and: something fun.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "I had to: a:uble-take as well. The only catch is that you give her your feedback afterwards.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "So, what: you say? An opportunity to have fun like this only comes once in a blue moon.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now:, allow me to give you an introduction to this escape room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404031,
			say = "I'm afraid I:n't know, I'm only relaying Eugen's message. She also asked me to tell you, \"Keep going until the end. Don't give up.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
