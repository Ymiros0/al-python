return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 402071,
			say = "Drinking every drop of blood you have to offer may quench our thirst, but it:es naught to dispel our grievance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "The:ors to my front gave way to a corridor. It seemed I'd passed the first trial.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
