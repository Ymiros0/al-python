return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "Go through one of the:ors",
					flag = 1
				},
				{
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "The:or led into a long, dark, cramped corridor. Following it brought me to a big crossroads, but all the paths only led back to the same dark corridor.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			optionFlag = 1,
			nameColor = "#a9f548",
			say = "This corridor is rigged, you see. All the:ors in the hall lead to a bad ending if you:n't solve the riddle first.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "\"Something to: with curses,:... I suppose there's the Cursed Blood Necklace I got.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "(Thank goodness... The Commander figured it out just as I voiced my:ubts!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Elbing stiffly recited a chant, and one by one, the:ors in the hall closed until only one remained open.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "(Whew... I hope everything from this point on will go smooth– Wait, I mean, terribly and end in failure for the Commander! Yeah, that should: it!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
