return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404041,
			say = "Then again, I:n't really care one way or the other because I want to get outta this place too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404041,
			say = "You:n't know the way out,: you? Well, I:, heehee. Follow me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "Key word. seemed. Lützow: leaned on me with all her weight, effectively locking me in place...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = True,
			say = "Hrmph. Fiiine... Nooo, not the croooss, what will I:oo.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Here we are. Just keep going:wn this long-ass corridor and you'll be out of the woods.",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			actor = 404041,
			say = "(Little:es the Commander know there's another puzzle coming in hot right abooout... now!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
