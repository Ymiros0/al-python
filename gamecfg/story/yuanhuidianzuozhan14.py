return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_yuanhuidian",
			nameColor = "#A9F548FF",
			say = "Well, while we're still here, why:n't we end things with a proper shipgirl-on-shipgirl battle?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "The Pawns have gotten almost all the action this whole time, and I wanna see how we actually compare to each other. What: you say?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 404050,
			say = "Are you sure you want to? While I: have blanks to spare, they still hurt if they hit you in the wrong places.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "The same goes for you. If you:n't have a problem with that,: I'm all for it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
