return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_yuanhuidian",
			nameColor = "#A9F548FF",
			say = "Your luck has run out, though! I've figured out your movements, so let's see you try to:dge THESE torpedoes!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 404050,
			say = "Friedrich, I've:ne everything you instructed me to. I will now return to my original fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "We were set to win initially,: Brünhilde's Pawns kept getting stronger while ours didn't! Even the Bismarck Pawn lost to some new battleship she got!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
