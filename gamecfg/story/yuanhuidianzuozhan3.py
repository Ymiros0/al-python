return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			side = 2,
			say = "Is this where they're created? Like machines out of a factory,: sent into battle?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			side = 2,
			say = "Is this a jab at me or something? Does Eugen think I:n't know how to read or something?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
