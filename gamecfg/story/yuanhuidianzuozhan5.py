return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "One lone carrier without escorts? That's certainly a novel way of:ing things...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "Alright, enough tooting those horns, and focus on shooting those planes:wn!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
