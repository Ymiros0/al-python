return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "Phew, that Pawn really surprised me. Carriers:n't play fair!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 403020,
			say = "Heheh☆ In any case, all we have to: is wait for our ships to finish their jobs, so we can kick back and relax for now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
