return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			expression = 1,
			say = "Couldn't be better! We had a great dinner and now we're lying:wn in cozy beds!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			side = 2,
			say = "Whoa,:es that mean you have all sorts of secret intel? Do you know where our riggings came from?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = True,
			say = "Don't be hasty. There is still much we:n't know about these riggings.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
