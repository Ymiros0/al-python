return {
	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				{
					"<size=51>'How long have I been out? I still have a mission to:...'</size>",
					2.5
				},
				{
		...
		},
		{
			...
			bgName = "star_level_bg_154",
			hidePaintObj = True,
			say = "A figure I can only assume is Avrora barks out an order,: turns her attention to me.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 702012,
			nameColor = "#A9F548FF",
			say = "Of course you:n't. Like you:n't all tell me that every single day.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 702012,
			actorName = "Avrora?",
			say = "Since you didn't want to: this the easy way, we'll: it the hard way.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_154",
			hidePaintObj = True,
			say = "Wait a second. Avrora would never say or: anything like this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 2,
			say = "\"I:n't care what you: to me! I'm not telling you a damn thing!\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Although... This is the least I can:, after that blunder.",
			painting = {
				alpha = 0.3,
				time = 1
			},
