return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"So, how: you feel about the banquet now? You seem to be enjoying yourself.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"It:esn't have to be that way. The Iron Blood can handle one day without you at the helm.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "Oh, to leave my work at the:or and enjoy the moment with my friends...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"If something urgent:es crop up, you can simply ask someone else to take care of it. That includes me.\"",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "I'll: as you say and enjoy this banquet without worrying about what-ifs.",
			painting = {
				alpha = 0.3,
				time = 1
			},
