return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "After a quick look around, I figure out who's watching. She:esn't realize yet that I'm here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107090,
			say = "Please:n't say you heard me grumbling just now...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"No thanks, and I think you've had too much. I'd offer to sit:wn with you, but I think what you need now is to rest in the lounge.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107090,
			say = "And that, right:, is when I realized! *glug glug*...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "She forcefully puts her bottle:wn on the table with an audible thud,: looks at me intently again.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 107090,
			say = "The first step to:ing that is to go back to my:rm room, together!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "It:esn't seem like there's any chance she'll budge on this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
