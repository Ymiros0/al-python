return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_night",
			hidePaintObj = True,
			say = "Curious about what the Sakura Empire is:ing, I decide to go have a look – until a sound interrupts my thoughts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What: we:? Our luggage is all over the road!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "Don't panic. First, check if anybody is hurt,: load the baggage back into the carriage.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301880,
			say = "What: we:... Lady Musashi is meant to appear at the banquet really sooon!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 301880,
			say = "Not too long, luckily! Allow me to: it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "You mean calling Richelieu? It's best if I: that myself.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "Accident or not, it affects the schedule. The least I can: is personally apologize to her for the delay.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "Now, it'll take a while for Wakatsuki to clean my garb, and I:n't wish to stand around idly.",
			painting = {
				alpha = 0.3,
				time = 1
			},
