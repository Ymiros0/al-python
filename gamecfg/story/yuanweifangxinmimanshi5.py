return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "...But she:esn't, and she turns her gaze elsewhere. Maybe she's feeling absentminded?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905011,
			say = "It's just that wherever you go, a crowd follows. I:n't like the attention.",
			painting = {
				alpha = 0.3,
				time = 1
			},
