return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "And yet, that:esn't seem to extend to her. It's as though there's an invisible, people-repelling barrier around her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "To answer you – yes, I:. I'm all ears.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"You should let loose – you'd be more approachable:.\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "You know me, Commander. I'm not a party person. It:esn't come naturally to me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "Judging by how she's:ing, it seems I made the right decision.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"Alright. Them aside,:, how are you enjoying the banquet?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"I:n't think Eugen sent me that photo just to show she and the rest are having a good time. They're concerned about you.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = True,
			say = "\"Why:n't you go join them? Then they wouldn't be concerned about you.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "If you:n't mind, would you like to go with me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405011,
			say = "Thank you for accepting my invitation. Let's: as you suggested and go enjoy this banquet.~",
			painting = {
				alpha = 0.3,
				time = 1
			},
