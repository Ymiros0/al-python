return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305050,
			say = "If it was, why: I continue to feel that stinging pain from when I touched the Sacred Sakura?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_508",
			hidePaintObj = True,
			say = "The screen:or slid open, and Kawakaze, the white-haired servant of the Guardian Fox, sat on her knees behind it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_508",
			hidePaintObj = True,
			say = "After wiping her:wn with a hand towel, she helped Nagato change into her usual day clothes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
