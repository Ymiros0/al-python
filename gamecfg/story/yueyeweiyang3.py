return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_510",
			hidePaintObj = True,
			say = "It was: that a slight breeze lifted some fallen leaves and blew them toward the young Guardian Fox.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...Musashi,: you remember this place?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you and I have had similar dreams,: the solution to this problem is all but clear.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If signs of decay can be found there, too,: that will explain things.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 305100,
			say = "However, I:n't know if we have the strength to fight our enemy today...",
			painting = {
				alpha = 0.3,
				time = 1
			},
