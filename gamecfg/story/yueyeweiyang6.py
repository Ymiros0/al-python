return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "But weirdly, nobody in the Sakura Empire ever SAW her:ing that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Anyway, that's all I know. I:n't actually know what happened inside the sanctuary, okay?",
			painting = {
				alpha = 0.3,
				time = 1
			},
