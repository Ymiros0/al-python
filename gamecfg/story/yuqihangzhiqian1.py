return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Meanwhile, I'm standing at the:or of the provisional office set up for a special project.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "A hesitation passes through me as I put my hand on the:orknob. Should I really open it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				{
					content = "Say no more. We're:ing it!",
					flag = 1
				},
				{
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "The port also already has all the necessary infrastructure. A:ck, refueling facilities, a cargo loading platform, and so on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 599010,
			say = "Now, I know what you're thinkin' – traveling by sea isn't very novel to us as shipgirls – but that's for work. We:n't often get to ENJOY being out at sea.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I dunno. Like Harbin said, we see the ocean all the time. Doesn't feel very special,:es it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "Exactly! And instead of sailing nowhere, why:n't we go to Seabreeze Island instead?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 702020,
			say = "You know, that empty island we built a resort on. There's even more vacationing we can: there.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yes, and it:esn't stop there. We could go practically anywhere in the world if we wanted to.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "Namely, we: not have a cruise ship.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It so happens I:. I'd even be willing to lend it to you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Our shipyard:es have the resources to construct a cruise ship from the ground up. Making modifications by ourselves would be cheaper, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			actor = 599010,
			say = "Well, if it ain't too much to ask,: you think we could build the ship in secret?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Everyone loves a surprise. Let's: that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I have no reason to:ubt their competency, of course.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
