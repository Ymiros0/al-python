return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "It's a new day, and I'm at the:or to the Cruise Planning Committee. Again.",
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "It's not breaking my promise if I overhear them through the:or... right?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "Ugh... I'm beat. I:n't know if I can keep on pretending to work hard like this.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "Emden said the Commander WILL give in to curiosity and walk through that:or...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "But I'm really starting to:ubt that! All my efforts have been for nothing!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "*sigh*... Well, since it:esn't matter, I'm gonna: something fun instead.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "Let's see here... What game: I play...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "That cruise ship is:omed if she keeps manning the phone...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
