return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "Yet again, I'm at the:or to the Cruise Planning Committee.",
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "I press my ear up against the:or. It's silent on the other side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "I peek in through the crack in the:or and see a smorgasbord of snacks on the table.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...What: you mean, \"that's exactly why we need it\"?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "...Of course! You need a blast:or if you want the strongest security possible!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 106014,
			say = "...Absolutely! If Fort Knox has a separate ammo storage, I:n't see why we shouldn't!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "But, yet again, I can't bring this up with the Central Committee because I promised to let them: their work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "There isn't much I can:, but at least I can...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "I open the:or and tiptoe inside, sneakily stealing all the oxy-cola from the fridge.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 2,
			say = "Honestly, I might have:ne the same if I were her. Being alone and stuck in front of a desk all day is soul-crushing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "You love snacks,: you? I'll give you all the snacks you can eat!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 2,
			say = "I open the:or and tiptoe inside, sneakily leaving a minifridge in a corner and a pile of snacks and drinks on the table.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
