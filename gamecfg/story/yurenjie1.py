return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Nuh-uh, that's impossible, bulin! Not even my almighty wrench can: that, bulin!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Even if that god:es exist, they live in some unreachably distant place, bulin!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			say = "I'll find that hammer if it's the last thing I:, bulin!",
			subActors = {
				{
					actor = 100010,
					pos = {
