return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "An RPG where you:n't know your own abilities? That's... novel.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Skills aside, how am I meant to know what to: if I:n't even know my stats?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "A-anyway, it's a game, so:n't worry about it too much!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That about:es it for the tutorial. Commander, you'll learn faster if you just give it a try.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
