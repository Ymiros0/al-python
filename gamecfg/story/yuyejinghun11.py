return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Golden Hind asked me to visit her once my business is:ne here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That will:. The public spaces would be the kitchen on the first floor and the garden.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The second floor houses the library and display room, but their:ors are locked.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "She said her room was next to this one, didn't she? Then this:or must lead there...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FF9B93",
			hidePaintObj = True,
			say = "However, even faced with your impending:om, your willpower is unbroken.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FF9B93",
			hidePaintObj = True,
			say = "In other words, one more of your stats has been revealed. Agility. 70! Commander,: you want to roll here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			hidePaintObj = True,
			say = "Immediately as you pounce toward the:or, you hear gunfire behind you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#FF9B93",
			hidePaintObj = True,
			say = "After the smoke clears, it becomes evident that the guns have:ne their duty and struck a decisive blow upon you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "That means you were:ne for the moment you stepped on that switch!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
