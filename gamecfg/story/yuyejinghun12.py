return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "(I just:n't have enough information yet... I should build up a bigger knowledge base before I take action.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The housekeeper:es not answer. She simply stares, a sharp twinkle in her eye.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "She traces a route in the air with her fingers to tell you how to reach the dining room. Just:, the button on her sleeve happens to reflect the dim light of the room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Also, allow me to warn you once more.: not enter bedrooms or other private spaces without the occupant's permission.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
