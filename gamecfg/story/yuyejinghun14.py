return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You ask her to take:wn the partition dividing the dining room and the banquet hall, to which she is shocked to hear.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Roll a D100... 69. Nice, but unfortunately, you get distracted by how soft her hand feels before you can connect the:ts.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FF9B93",
			hidePaintObj = True,
			say = "However, even though you muster all your strength, the chef's grip on your arm:es not budge.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Actually, I had nothing to: with it. Eugen was the only one excited about it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
