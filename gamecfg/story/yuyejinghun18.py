return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Z2",
			hidePaintObj = True,
			say = "Sure. What are you going to: with it? Threaten the two servants standing outside?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You can't: any investigating when that happens. You just have to wait and recover.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
