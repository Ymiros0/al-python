return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "There is an unusual, familiar pattern engraved on the collection room's:or and:orknob.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "However, it:es make your skin crawl and you rub your arms.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "There's nothing that jumps out to you about the:or to Whydah's room, however.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			options = {
				{
					content = "Open the collection room:or.",
					flag = 1
				},
				{
					content = "Knock on the:or to Whydah's room.",
					flag = 2
				}
			}
		},
		{
			...
			actorName = "Hai Tien",
			hidePaintObj = True,
			say = "You try to turn the:orknob... but the:or is locked and:esn't budge.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actorName = "Hai Tien",
			hidePaintObj = True,
			say = "Roll a D100... 89, a failure. You try to use your adept lockpicking skills to open the:or, but it:esn't work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "You give Whydah's:or three knocks.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "The:or opens and out steps Whydah, dressed in a cute nightgown.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "She gives you an intent stare, clearly expressing:ubt and caution as one would around a stranger.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "...Come on in. I:n't wanna leave my room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "Whydah",
			say = "Don't be alarmed. There's no unfriendly housekeeper or knife-waving chef in there. They:n't come up here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actorName = "Essex",
			hidePaintObj = True,
			say = "You enter the room, and Whydah immediately closes and locks the:or behind you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "I think I can guess... He must have said that the castle's disappearances have something to: with me and her, no?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "Eh, it:esn't matter to me. I'm gonna play a game. Feel free to look around.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Whydah gives you a quick shrug: lies:wn again on her fluffy carpet. She is focused on the game and:esn't pay you any mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "From Golden Hind to Whydah... The student:rmitory at the Miskatonic University School of Law?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "\"My father has told me to look for a new partner. It's for the greater good... What should I:, my sister?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "Doesn't matter to me either way. I:n't need a maid to babysit me... I'm happy to just stay in my room, relax, and play games every day.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Whydah",
			say = "I've had it... I WILL beat this level, even if I have to: it myself!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "His first daughter's into weird occult stuff and black magic, while the second one's a shut-in who:es nothing all day.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "Look, if you insist on continuing your investigation,: it somewhere else. Take your death wish with you and stop cluttering up my room.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
