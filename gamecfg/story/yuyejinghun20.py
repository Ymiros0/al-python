return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "And why: you think I'd give it to you? I only acted nice because I wanted you to leave. I'm not in any mood to help you out.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Also, Whydah is now madly in love with you! She will: anything for your sake.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			say = "Oh, dear... Investigator, what have you:ne to Whydah?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 9600051,
			actorName = "Whydah",
			say = "Even if you're a:ll, we'll always be together, honey~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Uh-huh. So they turned me into a:ll?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Obsessive love resulting in your eternal imprisonment... Now that is art. How: you like this ending, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
