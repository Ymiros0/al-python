return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Essex",
			hidePaintObj = True,
			say = "You cling to the wall as you walk:wn the dark corridor.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "No, it is:rmant in your pocket. Listening closely, you hear footsteps approaching from behind you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "However, you: realize that there's a:or next to you. You:n't know where it leads.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
