return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Essex",
			hidePaintObj = True,
			say = "At long last, you and Royal Fortune arrive in the study. You lock the:or tightly, sealing out all danger on the other side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "If you use Eagle Eye, you may be able to narrow:wn your search even further.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Roll a D100... 33. Success. Without hesitation, you grab another book from the– Wait, what? What's that book:ing there?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Yes! I mean, no! That book is unimportant! You:n't need to read it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "(You:n't hear Hai Tien lose her cool every day. Something's clearly up with this book. Let's give it a read.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Royal Fortune",
			say = "Huh?! Are you:ne already? What did you find?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Royal Fortune",
			say = "Well... I picked a couple of books Lord Manjuu and his family had read, and: I saw this photo album, and I just got absorbed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "Royal Fortune",
			say = "While I still:n't fully believe in you, I have no one else I can turn to.",:
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
