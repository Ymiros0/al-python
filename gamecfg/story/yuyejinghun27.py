	...
	scripts = {
		{
			...
			actorName = "Essex",
			hidePaintObj = True,
			say = "The maid steels herself and runs out of the study. You hear the commotion outside the:or intensify. You know for certain that she won't hold them back for long.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Some time has passed, and you now hear noise from the other side of the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Someone is pounding on the:or. They've gotten past Royal Fortune... You only have enough time to read one more book.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "\"...I shoved Morgan into the secret room behind the painting in the study. God will: the right thing for me.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Golden Hind and the servants are still breaking:wn the:or. You need to make a decision, and quick!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But:, the charm in your pocket and the lantern resonate, and a comforting, soft light embraces you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				...
				{
					content = "I'm:ing this for the money!",
					flag = 3
				},
				{
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Golden Hind and her fellow cult members from the castle are currently being treated at a mental hospital. The damage:ne by the cult to their sanity is slowly, but surely, being undone.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But, despite her grumblings about what a pain it is, she is:ing a stellar job. Moreover, Royal Fortune is still by her side for the ride.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
