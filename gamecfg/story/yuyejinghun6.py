return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "(Isn't this the servants' room...? Very suspicious. I:n't want her to know I'm following her, so I'll wait a moment before tailing her.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Where in the world am I? And why:es this hallway seem to go on forever?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(Does that mean this NPC:esn't like me? She did reference my \"commission\" fee, so is she unhappy with that?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Well:ne, Yukikaze the Great!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Just:, strange information appears out of nowhere in the Commander's mind!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Something approaches from outside the:or...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
