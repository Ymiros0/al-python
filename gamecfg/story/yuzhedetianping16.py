return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "That unknown substance will cause unimaginable damage if we:n't: somethin' about the enemy!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			actor = 905020,
			say = "I'm not telling you not to fight, alright? If the Gazers launch a direct attack on Toulon,: you may counterattack.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 807020,
			say = "Please:n't feel too:wncast, Jean Bart. I would suspect Clemenceau has a plan.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 807020,
			say = "Still,:n't you think you should have faith in her?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "She saved me once, but I can't forgive her for what she's:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
