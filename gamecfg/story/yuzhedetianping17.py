return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_underheaven_3",
			hidePaintObj = True,
			say = "The first shows a place covered in white,:tted with hundreds of cocoon-like objects of varying sizes.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_underheaven_3",
			hidePaintObj = True,
			say = "\"Don't take that personally, Shinano. Others:n't understand the power you have, but I:.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "No... She is correct... I have no evidence, therefore it is natural that I be:ubted...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "What we: not yet know is if you and this one are the only dreamers, or if all shipgirls are...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			blackBg = True,
			say = "They: wound up alone inside a bunker, but as they assured me, there was no need to worry whatsoever and they'll find an alternate escape route.",
			canMarkNode = {
				"huanlujianhai1",
				{
					1,
		...
		},
		{
			...
			hidePaintObj = True,
			blackBg = True,
			say = "They said they'd mop up the stragglers: group up with us. More importantly, though, they told me a very important piece of information.",
			canMarkNode = {
				"huanlujianhai1",
				{
					1,
