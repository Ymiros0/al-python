return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Everyone here, including Memphis... seems a little too excited,:n't you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_roma_12",
			hidePaintObj = True,
			say = "\"Something weird is going on. It may be the World Expo, but even:—\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				{
					content = "\"I:n't know what's going on here, but we need to put a stop to this!\"",
					flag = 1
				},
				{
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "(This:esn't make any sense... People aren't behaving the way they normally would!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
