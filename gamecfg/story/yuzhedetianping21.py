return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "Marco Polo",
			say = "No, what am I saying? That:esn't matter!",
			dialogShake = {
				speed = 0.08,
				x = 15,
				number = 2
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "Crap! I can't:dge it in time!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "I need help! My throne is breaking:wn as we speak!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "How could you: this? How could even YOU betray me, Clemenceau?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "Clemenceau",
			say = "Don't sulk. I feel the same about your dream, and I'm thankful for all you've:ne for me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "Why... Why would you: this to me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
