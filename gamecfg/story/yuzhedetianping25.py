return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 302210,
			say = "Assuming this thing:es spawn more enemies, we should destroy it now before it becomes fully operational.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "What: you think, Shinano? Should we attack?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "This one is inclined to: so... Lady Jeanne, what: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I:n't get it... Why won't anyone understand me?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I'm so tired... Is there nothing I can:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
