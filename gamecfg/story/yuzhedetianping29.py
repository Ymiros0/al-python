return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Slow:wn, now. Don't stray from the rest of the fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 900354,
			side = 2,
			say = "No:ubt Her Majesty and Bismarck are panicking, too. I'd love to see their faces right now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 718010,
			say = "By \"her,\": you mean Marco Polo?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you acknowledge her to that extent,: I'm sure she's quite capable.",
			painting = {
				alpha = 0.3,
				time = 1
			},
