return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9707010,
			say = "We've been monitoring this:or for some time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9707010,
			say = "You:n't think Enterprise has forgotten us,: you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffa500",
			say = "Maybe not normally, Ark Royal, but that:esn't mean you can be certain.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9707010,
			say = "She's been pushing herself this whole time, fighting nonstop. She's never been able to put:wn her weapons or have a moment of relaxation.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9707010,
			say = "My mental state would surely break:wn sooner or later, and I'd turn into one of those kaiju you see in Sakuran movies.",
			action = {
				{
					type = "shake",
					y = 0,
