return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 205029,
			say = "We:n't need to rush to her aid. Ultimately, this conflict is something they have to resolve internally.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403030,
			say = "In other words, we'll become a reserve force. If you:n't want us stealing work from you, you better be quick♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
