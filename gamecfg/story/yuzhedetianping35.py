return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_underheaven_12",
			hidePaintObj = True,
			say = "The Spear of Destiny, the key to striking:wn the False God, was also in its final preparations.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If it:esn't, however, you might find yourself wishing you'd brought more friends, Commander.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 805010,
			say = "With the powers of conceptual manifestation counteracting each other here, this comes:wn to an old-fashioned gunfight. Commander, the Iris fleet awaits your orders!",
			painting = {
				alpha = 0.3,
				time = 1
			},
