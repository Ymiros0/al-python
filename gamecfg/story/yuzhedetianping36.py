return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "The Gazers coming in from the surrounding waters are getting knocked:wn one after the next. They can't break through our defenses.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "Whether it's the Commander's presence or this:main affecting me, I feel ready to take on anything...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Without the Commander, our coordination will break:wn, and our morale will plummet – yours included. Ensuring the Commander's safety is number one.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 905020,
			say = "Furthermore,:esn't the Sakuran fleet need you and your abilities to command it?",
			painting = {
				alpha = 0.3,
				time = 1
			},
