return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_504",
			hidePaintObj = True,
			say = "Countless drones appeared in the sky, emerging from nowhere just like the swarmers:wn at sea level.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#ffa500",
			actor = 9707010,
			say = "If we let her make her next attack, we're not going to be able to:dge it...",
			painting = {
				alpha = 0.3,
				time = 1
			},
