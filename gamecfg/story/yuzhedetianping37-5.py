return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_504",
			hidePaintObj = True,
			say = "Like a deity parting the waters, the Hierophant shrugged aside even the densest barrage of cannon fire, not even slowing:wn in the slightest.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_504",
			hidePaintObj = True,
			say = "I saw her shadow cover my entire being, her wand bearing:wn on me––",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_504",
			hidePaintObj = True,
			say = "As the Hierophant's wand came:wn, my vision was engulfed by the radiant web of lights coming from the drones surrounding her.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = True,
			say = "The Commander has:ne well to buy me enough time to arrive.",
			painting = {
				alpha = 0.3,
				time = 1
			},
