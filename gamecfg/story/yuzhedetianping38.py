return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_cccpv2_9",
			hidePaintObj = True,
			say = "But, when we hear two sets of footsteps coming:wn the corridor, she freezes in place, as if having turned into a statue.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_cccpv2_9",
			hidePaintObj = True,
			say = "I see. The:ctors must be here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#ffff4d",
			say = "That's right. Zero:esn't count.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#ffff4d",
			say = "Of course, it:esn't stop there.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#ffff4d",
			say = "We still need more testing, but she can already communicate with cats,:gs, and:lphins.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#ffff4d",
			say = "Ahem! Anzeel, how many times: I have to tell you–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#ffff4d",
			say = "Ah, yes. Of course you'd go:wn that route.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#ffff4d",
			say = "C'mon, Commander. What: you think?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 1,
			say = "\"The concept of 'the enemy' isn't necessarily set in stone. If two parties can communicate,: peace must be an option.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "The Hierophant, your work is:ne for now. Enter sleep mode.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			optionFlag = 2,
			say = "She did not resist. On the:ctor's orders, she began her shutdown program.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_505",
			hidePaintObj = True,
			say = "A:or sppears in the distance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_505",
			hidePaintObj = True,
			say = "A familiar:or, standing alone in the pure-white chamber.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_underheaven_13",
			hidePaintObj = True,
			say = "I can't help but to think to myself, what if the Crown was controlling the concepts within the:main the entire time, rather than the Hierophant?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
