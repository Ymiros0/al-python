return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_xinnong2_2",
			hidePaintObj = True,
			say = "\"If you have this dream often,: maybe it's more than just a dream.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "However, it:es not happen with every dream. Only with some...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "However, they: not always lead one to good dreams... Just yesterday, this one dreamed of something terrifying.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_xinnong2_2",
			hidePaintObj = True,
			say = "\"Likewise, I:n't have any vivid memories after early this morning.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 307080,
			say = "This one hopes it was only a dream... but if it is a potential reality,: it may be disastrous...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_xinnong2_2",
			hidePaintObj = True,
			say = "\"In other words, we need to: everything we can to keep it from becoming reality.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
