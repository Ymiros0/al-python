return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Through the cathedral's stained glass windows, brilliant sunshine shone:wn upon religious artifacts and a floor made hundreds of years ago.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Indeed. After all they've been through, offering them our blessings is the least we can:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_507",
			hidePaintObj = True,
			say = "Richelieu and her compatriots appeared before the podium,:nning dignified robes that conveyed the power vested within them by the Holy Iris.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "An ancient memory to be passed:wn?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Of course, there is no:ubt in my mind the faith and feelings in people's hearts were genuine.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...Well:ne, Richelieu. Well:ne, my sister.",
			painting = {
				alpha = 0.3,
				time = 1
			},
