return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "...Hm? Commander, you:n't look too good. Are you feeling sick?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_roma_12",
			hidePaintObj = True,
			say = "\"Physically, I'm fine. But I have to: something about what I saw in that dream.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102050,
			say = "You really: look sick... I'll call for a medic right away!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "...I trust you. If danger is coming,: I'll help out!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 601080,
			side = 2,
			say = "Things: get pretty crowded on closing day. I wouldn't blame her too much for getting lost!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "That's fine, but: we have to be all secretive about this?",
			painting = {
				alpha = 0.3,
				time = 1
			},
