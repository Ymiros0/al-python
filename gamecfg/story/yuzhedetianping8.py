return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "By the way, are we calling these giant machines \"Gazers?\" They: look a bit like those monsters, straight out of books and movies.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 901040,
			say = "I, I:n't want to look at those things anymore... O Holy Iris, please give me the strength to overcome this trial!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "You couldn't possibly have predicted this. The more pressing matter is what we: from here.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Given their numbers, combat capabilities, and our lack of information... I: not think this is a battle we can take, even were we to all work together.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 605010,
			side = 2,
			say = "That's a scenario I:n't want to imagine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Agreed. I'm afraid even we:n't have any clues as to what they are...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_italy",
			hidePaintObj = True,
			say = "\"That being said, Eugen has a point. These new enemies:n't look like any Sirens we're familiar with, and their behaviors are completely different.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_story_italy",
			hidePaintObj = True,
			say = "\"But that still:esn't answer the question of the hour – just what in the world are they?\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 803010,
			say = "Guichen,: you reckon the same will happen to Vichya and Iris Libre?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_italy",
			hidePaintObj = True,
			say = "Then, just as the mood was about to reach its lowest point, a shrill voice sent a chill:wn everyone's spine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 102160,
			say = "Ugh! Why is EVERYONE:ing it to us today?!",
			action = {
				{
					type = "shake",
					y = 45,
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Under normal circumstances, I'd shrug this off as a prank, but not this time. Do you know what you've:ne to the World Expo?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605010,
			say = "What you've:ne is a betrayal of your homeland. It is a declaration of war against the whole world.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 605010,
			say = "How dare you...! Kersaint, take:wn the Skybound Wall! I will destroy this traitorous fool myself!",
			painting = {
				alpha = 0.3,
				time = 1
			},
			...
			options = {
				{
					content = "(Try to get Veneto to calm:wn.)",
					flag = 1
				},
				{
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 907010,
			say = "But:, Marseillaise... and the stronghold on Saint Helena...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 907010,
			say = "You... What did you:, Marco Polo?!",
			action = {
				{
					type = "shake",
					y = 45,
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "And:, all war and strife will vanish, and humankind may live in a timeless utopia.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#ffff4d",
			say = "You: not need to know, and I have no obligation to answer you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
