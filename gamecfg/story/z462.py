	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				...
				{
					"I am but a:ll with a borrowed name, seeking the meaning of my existence.",
					3
				},
				{
					"",
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "Is it fine to put these resources here? Mm... I shall: as you have commanded.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		{
			bgName = "bg_story_task",
			say = "Though there is much I: not understand, since serving as the secretary ship, my world has already begun to change.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		{
			bgName = "bg_story_task",
			say = "\"Physical contact...\" I still:n't get it. Though my curious heart longs to find out, once the waves of battle come crashing in, such idle thoughts are quickly tossed aside.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
