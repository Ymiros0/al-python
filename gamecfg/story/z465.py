return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_school",
			dir = -1,
			say = "Close friends, is it? Heh... that's not something I ever expected to hear from a destroyer. But in Viersech's case... it somehow:esn't feel strange at all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 0,
			bgName = "bg_story_school",
			say = "Also, I've:ne nothing worthy of praise. For fellow members of the Iron Blood, helping each other needs no second thought.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_school",
			dir = -1,
			say = "Even if that is the case, I: have a suggestion for you, Viersechs. Could you: something about the way you talk?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_school",
			dir = -1,
			say = "Aren't you having some trouble fitting in with the other destroyers? Why:n't you try to learn a little?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_school",
			dir = -1,
			say = "Mhm. Continue to: your best. I shall be cheering for you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
