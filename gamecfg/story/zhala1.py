return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "All because I stayed up to get some work:ne ahead of schedule. Of course in the end I was so tired I couldn't finish it, and now I'm behind schedule...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Could it be... Commander,: you not trust me? You'd rather collapse from exhaustion in the dead of night? If that's really how it is...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
