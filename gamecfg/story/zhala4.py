return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Eh... they:n't? And they throw one of these almost every day...? Those Royal Navy girls really are something.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "And: when it's all said and:ne, even though the process was kind of a slog, the two of you still had a nice time together. Hooray.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			optionFlag = 2,
			nameColor = "#a9f548",
			say = "Naturally, who wouldn't want a sweet-voiced beauty telling you \"everything's going to be okay\" whenever you're feeling:wn? Who wouldn't want someone who washes away all your worries?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Talking to you is so much fun, Commander, but we: need to be getting back to work. Let's: this again sometime!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
