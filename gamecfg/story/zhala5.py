return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Break time, Commander. Put your work:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hehe... Is there anything your secretary can: for you? Just say the first thing on your mind.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now:, come rest your head right here on my lap. Don't be nervous, just relax.",
			flashout = {
				black = True,
				dur = 0.5,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "Commander, you're not allowed to fall asleep until after I'm:ne. Okay? Hehehe.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
