return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "That's all we needed to get for everybody. Thanks so much, Commander. There's no way I could've:ne this in one trip without you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "What: you mean you're embarrassed? That's right, \"tenacemente\" –:n't you remember my motto, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
