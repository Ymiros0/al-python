return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "\"I want to show her my strong and heroic side! I:n't want to be prey that she toys with.\" That's what your eyes are saying. They're full of frustration that you've never succeeded.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
