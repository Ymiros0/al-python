return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "But before I can round the corner just in front of my office, I hear a voice coming from near my:orway.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 205130,
			say = "And how: I: that without one of those invitations you mentioned, exactly?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				...
				{
					content = "\"I:n't need an invitation,: I?\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Though sometimes, I: worry a little...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Thank you so much! But I'm always available to: odd jobs for you, so please ask me next time if you see fit!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404030,
			say = "I:n't know if this would count, but you've been on my mind... Ack! A-ahem, I mean, nothing's wrong!",
			painting = {
				alpha = 0.3,
				time = 1
			},
