return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404030,
			say = "Well, umm... Sorry, but I:n't know if I can answer that yet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404030,
			say = "While I:, though, I also worry whether I'm properly meeting your expectations...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_zhedie_16",
			say = "After putting her:ubts behind her, Seydlitz charges toward her prey in high spirits. I rush to follow after.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
