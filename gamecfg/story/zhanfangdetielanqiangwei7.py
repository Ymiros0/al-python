return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			say = "While I was thinking about the upcoming party at the port, someone opens the:or to the lounge.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "It took longer than usual to:ll myself up, but it was worth every second!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 404032,
			say = "No matter what you expect of me, I will: all in my power to exceed expectations!",
			painting = {
				alpha = 0.3,
				time = 1
			},
