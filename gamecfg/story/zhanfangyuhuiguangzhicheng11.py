	...
	scripts = {
		{
			nameColor = "#5CE6FF",
			side = 2,
			say = "Holding Miss D's hand, I step through the:or into the 7th car. Suddenly, I am thrust into nothingness.",
			hidePaintObj = True,
			blackBg = True,
		...
		},
		{
			...
			bgName = "bg_huiguangzhicheng_1",
			hidePaintObj = True,
			say = "I stand in a city carved from marble, arches of gold spanning overhead. The scent of the Iris countryside fills the air, as:es faint, serene cathedral music.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Yeah! I:n't care what she thinks, we're gonna call her that!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Anything I can:, she can:! Which means yeah, she will! Unless she's a total moron!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "And what are we here to:? Catch the whale! Whale tiiime!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			hidePaintObj = True,
			say = "That:es explain why we couldn't detect an intrusion from far away... The fact we can't detect her now either likely means she moved elsewhere.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#5CE6FF",
			say = "Elizabeth, Miss D called you a moron earlier for not using the direct route through the 6th car's:or.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "No,:n't come here! You weren't supposed to be here to begin with!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Nuh-uh! No confrontations! I'm gonna catch the whale: bail!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "I'm with Miss D on this. Please: it.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
