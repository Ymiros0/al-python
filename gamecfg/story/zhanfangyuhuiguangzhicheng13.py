return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_huiguangzhicheng_1",
			hidePaintObj = True,
			say = "Every drone touched by the light swiftly loses control and falls to the ground. The whale: turns its:rsal fin and starts swimming for the Martyrium's center at speed.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Doesn't matter! All that matters is that it:esn't get away again!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			hidePaintObj = True,
			say = "We said we'll: it, remember? Believe us, we won't let it flee.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "What: you think? Death! Death is the whole shtick of this place, remember?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Like I said,:n't worry about it! Just come along!",
			painting = {
				alpha = 0.3,
				time = 1
			},
