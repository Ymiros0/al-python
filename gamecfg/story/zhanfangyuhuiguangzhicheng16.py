return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "This ONLY happens with you every time we warp! If you're:ing it on purpose, cut it out!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 901050,
			say = "Okay,: why are we here? Did you make a wrong turn or something, Miss D?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "I:n't make mistakes, full stop! Tell them, Elizabeth!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "You're still with us, Elizabeth! I thought our comms would be:wn.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "(Then if this is a mix of concepts,:es that mean it's closer to what the space originally looked like?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Hang on... It:esn't just LOOK different, it functions differently, too!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 901070,
			say = "Uh, isn't time a constant? Because it:esn't really start or stop?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "(If my guess is right,: this is a recording of the death of someone from that timeline – or of the \"death\" of this space.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FFC960",
			hidePaintObj = True,
			say = "Dying in there, so to speak,:es not spell your literal death. That would only be a concern if the concept were to engulf you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 901050,
			say = "Great idea! Only problem is, I:n't see the whale anywhere. It's probably run off again.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "I:. It's Samos Island, located in the Bermuda Sea. Well, Samos Island from the future.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Fiiine, we'll: as you say, assistant. We'll investigate the institute and THEN go catch the whale!",
			painting = {
				alpha = 0.3,
				time = 1
			},
