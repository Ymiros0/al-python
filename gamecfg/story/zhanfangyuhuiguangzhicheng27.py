return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_huiguangzhicheng_5",
			say = "If I used that, I could: more than just tell them where I was – I could help the METAs in their fight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_huiguangzhicheng_5",
			nameColor = "#5CE6FF",
			say = "You mean as soon as Devil cut off our communications,:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			dir = 1,
			say = "It's just a shame that our little power boost already went away. Even if we joined the battle, I:n't think there's much we could:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#5CE6FF",
			say = "But that:esn't mean we're sitting out this battle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
