return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_huiguangzhicheng_5",
			nameColor = "#5CE6FF",
			say = "That really is the control center,:. Rodney's been neutralized! It's about time you surrender!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FFC960",
			dir = 1,
			say = "How, pray tell,: you expect to control this place?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 805030,
			say = "Death's Shadow is defeated. If Miss D:esn't have control of the whale,: who could possibly...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 900432,
			say = "I:ubt she'll come with us. Mind if we leave her with you, Helena?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "Yeah. Hunting:wn Arbiters isn't our job.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 900432,
			say = "Ahahahaha! Guess there's nothing to: but say goodbye,:!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 900432,
			say = "And boy,: I hope I never run into you test site beta folk again.",
			painting = {
				alpha = 0.3,
				time = 1
			},
