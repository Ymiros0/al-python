return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "(This:esn't really FEEL like a city based on the idea of death, though. It more brings to mind images of brilliance and holiness.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "(Is it:wn to interpretation? Is this how Alsace views death?)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 901050,
			say = "Alsace,:es this city have, like, a name?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 803020,
			say = "This brings to mind an idea – the Martyrium. How:es that sound for a name?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9705040,
			say = "If others accept the concept, it:... Bah, never mind that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#5CE6FF",
			actor = 900430,
			say = "Then: it! Go to the city! Start the train NOW!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#5CE6FF",
			say = "What: you mean? There are others?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#FFC960",
			actor = 9705040,
			say = "STOP! RUSHING! US! Furthermore, we:n't know who we're up against! Rushing in blindly will be our death!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#FFC960",
			say = "Commander, I've heard you're an excellent babysitter. Watch this sassy child in our absence! Make sure she:esn't run off.",
			painting = {
				alpha = 0.3,
				time = 1
			},
