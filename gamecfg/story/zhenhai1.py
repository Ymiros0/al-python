return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Um... Would you mind waiting a little longer? I need time to calm my beating heart, and I fear I can't live up to your hopes until:. Please give me a moment...",
			painting = {
				alpha = 0.3,
				time = 1
			},
			...
			options = {
				...
				{
					content = "I'm not going to: anything weird.",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I see... I will: everything I can to help.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "Before you ask,:n't worry. I finished all my secretary work while you were away.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "I:n't blame you for thinking that. All Empery girls love tea, and I, especially so.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "It's too soon for ahas and I see's. How can you be sure I:n't have a different goal in mind? For instance, trying to see into people's minds by understanding them through what they eat.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "Which: you think it is, hmm? Am I trying new things, or trying to read people? Try to guess, Commander.",
			painting = {
				alpha = 0.3,
				time = 1
			},
