return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Chen Hai shoots me a look of slight confusion as I lock the:or to the office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "Hang on, why did you lock the:or? By \"guidance\" did you mean...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "(I think she's misreading the mood... which may be to my advantage. What's most important is that I find \"it\" before she:es.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I gave you a massage a while ago to help you relax, and I was entirely in control back:...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "But now, you want to take the lead. I:n't think... I could handle that...",
			painting = {
				alpha = 0.3,
				time = 1
			},
