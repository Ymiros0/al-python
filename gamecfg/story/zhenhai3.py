return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "You needn't put yourself:wn. If anything, I'm amazed at how quickly you've improved. Keep at it, and I'm certain victory will be yours one day.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				...
				{
					content = "Show me how it's:ne, Master Chen Hai!",
					flag = 2
				}
			}
		},
