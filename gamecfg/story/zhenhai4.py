return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			say = "I accompany Chen Hai to the swimming pool. Someone has added a small artificial waterfall to the pool. When and why, I:n't know.",
			bgm = "story-richang-6",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I've obviously heard about it before, I just:n't see what it has to: with Go.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "When you play with me, inhibition prevents you from reaching a state of flow,:es it not?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Alright. Then what exactly: I have to:?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_164",
			hidePaintObj = True,
			say = "She points me to under the waterfall. I sit:wn in the water, most of my clothes still on.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_164",
			hidePaintObj = True,
			say = "The water:esn't feel as cold as I expected it to. Hell, it's closer to a warm shower than anything else.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "First, hold my hand. Concentrate your mind on only the sensation in your hand,: breathe steadily.",
			painting = {
				alpha = 0.3,
				time = 1
			},
