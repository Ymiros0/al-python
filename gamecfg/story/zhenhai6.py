return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "That should be it... Say, Commander,:es your back hurt after sitting for so long? I could give you a massage, if you'd like.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "Hell, I:n't even want a break. What I want is to find an opponent and play a match.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			hidePaintObj = True,
			say = "Suddenly, Hai Tien opens the:or to the office.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "Oh, I know. Why:n't you and her play each other? She can teach you more of those \"tricks\" of hers, and you can practice what you've learned.",
			painting = {
				alpha = 0.3,
				time = 1
			},
