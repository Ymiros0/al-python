return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "You:n't have to apologize. One day, the game will be mine.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 502070,
			say = "I-if you're:ing a review, I'd like to help!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "...That's very kind of you, but:n't you have deadlines?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 506010,
			say = "Ah, I just remembered, you finished a new chapter. You:n't mind if the Commander and I read it before our review,: you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			hidePaintObj = True,
			say = "Hai Tien leaves the office in a real hurry, and:, it's just me and Chen Hai again.",
			bgm = "story-richang-8",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "I guess so. That:esn't change the fact that I really want to get good, though.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#A9F548FF",
			say = "How: I put it... When I saw you take command of the fleet, I just felt captivated by how calm and cool you looked when giving orders.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
