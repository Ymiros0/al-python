return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_fuxiangxian_1",
			say = "The girls, having finished their training for the day,:cked at the pier and had a lively chat.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_fuxiangxian_1",
			nameColor = "#A9F548FF",
			say = "But:n't worry about her. I've already urged her to rest and recover.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 601020,
			say = "Splendid. Now:, I should really be on my way!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "A:uble:se of carbonation! That's supposed to be like, super refreshing!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 403090,
			say = "Not a bad start. I'll note it:wn. Anyone else?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Being scared has nothing to: with it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If you wanna: this, you've gotta: it yourself. Good luck.",
			painting = {
				alpha = 0.3,
				time = 1
			},
