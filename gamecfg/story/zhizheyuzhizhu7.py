return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Yes. Thanks to the intel you provided us, we were able to narrow:wn its coordinates.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 205010,
			say = "That sure:es put some of what I heard in perspective... I wish my servant would just tell me what's going on in person.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "Moving on:. Has the Northern Parliament made any moves I should be aware of?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 405010,
			say = "We can't: anything about the Reenactments. They must forge their own future.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 205010,
			say = "I see. Nothing to worry about,:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 205010,
			say = "Yes, yes... In the meantime,:n't use the Tower of Midgard under any circumstances. Is that clear?",
			painting = {
				alpha = 0.3,
				time = 1
			},
