return {
	...
	scripts = {
		...
		},
		{
			...
			side = 1,
			dir = -1,
			say = "Haha, if you:n't make mooncakes good enough to match my wine, you won't get a single sip!",
			paintingFadeOut = {
				time = 0.5,
				side = 0
			},
		...
		},
		{
			...
			side = 0,
			dir = -1,
			say = "I understand! So it seems that the Mid-Autumn Festival is one that “celebrates the reunion with friends and family”, but…how come it seems like such a:wner right now? In the Dragon Empery, all festivals should be very lively!",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Well:, wait for me a bit. This damper of an atmosphere is no festival at all, a festival should be livelier!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
