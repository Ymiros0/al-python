return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Ping Hai",
			dir = 1,
			say = "Hehehe~ Sara borrowed the mooncake molds from me… I like to eat steamed buns so it:esn't matter, I can eat all of these by myself!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Sister…:n’t choke on your food, here, drink some osmanthus wine~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Tastes so so good! Give me ten barrels,: the cavalry of the ocean will be yours to command!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "Oh, I'll have to write this all:wn! If I have trouble making this, can I still ask you for advice?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
