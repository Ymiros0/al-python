return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yes. We only have that much left. They are too fragile though. Let's put:wn our hatred towards each other, at least just for today.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "I:n't drink, and there's nothing to be put:wn... But —— it smells really good~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yes, they are quite similar. Except the rewards are mooncakes... Did I hear the mooncakes are all gone? Let's use these lanterns:. Write:wn your wishes on them,: let fly... high to the rim of the world.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
