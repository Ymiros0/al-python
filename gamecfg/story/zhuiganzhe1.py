return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Oh my... How many home runs:es that make now...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hehe, fine by me. Let’s call it for the day:— Hey, isn’t that the commander over there?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Great. Can I count on you to escort me:, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
