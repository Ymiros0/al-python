return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hmm... this is barley tea, not black tea? I:n’t think I’ve ever had this before. Hehe, how interesting~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Chaser poured the barley tea into a teacup rather than a regular cup, and sat:wn in front of me, face-to-face across the desk.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
