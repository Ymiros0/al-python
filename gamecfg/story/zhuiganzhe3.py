return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "This is the Vichiya:rmitory! Let’s hurry inside.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_main_day",
			dir = 1,
			say = "Chaser quietly pushed the:or open and went through.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "A cake! Marvelous! I’ve brought some delicious teas myself, I: hope you’ll let me serve you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Hm. You and the Commander followed me... I forgot to ask you to wait by the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I’ll get out the tea I brought, and Dunkerque, you fetch that cake of yours a little early. What: you say?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "Chaser: leaned in and whispered directly to my ear.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Now:, Dunkerque, would you show us to the kitchen?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "...Actually, I’d say what really mattered more was the way she cared about other people, and charmed them in:ing so.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
