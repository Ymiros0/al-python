return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I:n’t mind showing you, but it is dangerous to handle the naked blade... You should not get too close.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Perhaps later:, should we get the chance. Righto!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_outdoor",
			dir = 1,
			say = "Chaser, biting her fingernails with anticipation and making me honestly kind of anxious, hurried into the Sakura:rmitory.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Pardon... But why: you care so much for samurai and ninja?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Well:, bear witness to my ninjutsu!",
			effects = {
				{
					active = True,
					name = "speed"
