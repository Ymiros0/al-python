return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Seems like you: all of it with your rigging...?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You want to see something that:esn’t use rigging...? Hm...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_day",
			say = "She released my arm... And that was the most shocking thing Chaser had:ne over the past few days.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
