return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_main_twilight",
			say = "After leaving the Sakura:rms, I told Chaser to come by later as she prepared to return to the Royal Navy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Now:, why did you ask me here?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Thank you. I’ll: my best to live up to your expectations, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
