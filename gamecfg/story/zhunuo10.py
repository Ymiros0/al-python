return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#D6341D",
			dir = -1,
			say = "You needn't worry about me. With a fleet so small, they couldn't: much harm to me. However...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#D6341D",
			dir = -1,
			say = "It's strange; I can't explain why, but it:esn't feel like we won at all...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
