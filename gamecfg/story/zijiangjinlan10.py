return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Look at that fog... Assuming this isn't the Sirens':ing, Akagi must be up to something major.",
			effects = {
				{
					active = True,
					name = "miwu_01",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "If we huddle here all scared and let Akagi: whatever she wants, she could potentially take five points' worth of bases this turn.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Ugh, trying to read the situation is giving me a headache... I was told that all I had to: was follow the orders.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "We ARE the ones actually:ing the fighting, after all. It's inevitable that we'll have to make our own assessments.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Now:, we'll prepare to attack the Diadem of Light, and split Akagi's forces:wn the middle while we're at it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We:n't know for sure if that's actually what Akagi is going for, but this move at least matches her aggression.",
			painting = {
				alpha = 0.3,
				time = 1
			},
