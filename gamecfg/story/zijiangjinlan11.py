return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "I already know what Akagi seeks to:, but if I were to disclose it, she would change her actions accordingly.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "(Does nobody else feel something strange about this? How are we supposed to get any practical training:ne when you can \"will\" incredible power into existence here?)",:
			painting = {
				alpha = 0.3,
				time = 1
			},
