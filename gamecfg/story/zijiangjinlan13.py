return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well, we:n't necessarily have to fight, right? Musashi only ordered for us to move to this area.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "If you:n't want to fight, I certainly won't force you to.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "But:n't come a single step closer. Those are Lady Nagato's orders.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I was right not to let my guard:wn...! But considering the damage those two have already sustained, we clearly have the upper hand!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "In this exercise, there is no reason for us to take up arms against one another. Sakawa, Wakatsuki, stand:wn!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "So, you:n't need to apologize, and you should continue this exercise as usual.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "We didn't: anything wrong, did we?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Most likely. Perhaps due to the time I spent sealed inside the Sacred Sakura, this:main also reflected the vivid memories I have of that place.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "In any case, there is no more need for us to battle each other. If you remain unconvinced,: you will have to go through me first.",
			painting = {
				alpha = 0.3,
				time = 1
			},
