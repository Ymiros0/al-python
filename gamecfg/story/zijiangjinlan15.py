return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "A Compiler vessel... What were we:ing while Milord was struggling for survival...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Calm:wn, Yamashiro. Akagi has already taken the base.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Akagi, what did you just: to that Compiler...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Nagato has also descended upon the battlefield. If we: not act quickly, there will be no more bases left to take, and we will be forced into a stalemate.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I suppose this means that even if the mainframe has been destroyed, its data can still be used to create spares... But what is the point in:ing that––",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "A more important objective...? Are you talking about the tower over there? I'm not sure I'll be able to take:wn even stronger enemies...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Hold on. I'm not:ne talking yet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Mikasa has already formed a perimeter through the southern side of the board. If we allow her forces to join up with Nagato's, we're as good as:ne.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Now:, Great Veteran Mikasa. It's your move.",
			painting = {
				alpha = 0.3,
				time = 1
			},
