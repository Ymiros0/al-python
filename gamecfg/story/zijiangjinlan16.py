return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Why is she:ing this? Shouldn't Akagi know that our forces are concentrated around the Diadem of Light?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Regardless of what Akagi is specifically aiming to:, she's going to keep her forces in an area where they will be able to come to each others' aid.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "After all, we're in no hurry to take the central tower. If anything, Akagi would: us a huge favor by scouting out exactly what kind of enemy we're dealing with in that tower.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Omitters tend to be more aggressive than other types of Sirens, but this isn't a fight we can back:wn from.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "I will lead the charge! Capture the Diadem of Light,: turn around as a unit and intercept Akagi's fleet!",
			painting = {
				alpha = 0.3,
				time = 1
			},
