return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Knowing Akagi, she wouldn't: anything unless she seeks to gain an advantage from it, but we can't afford to sit around idly either.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "So, how about you and Kinu? What are you two going to:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
