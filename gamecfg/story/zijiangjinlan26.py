return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Out of the four ships who were too close to the tower, only Yamashiro managed to withstand that shockwave... Damn that Akagi, she left a path to the tower open on purpose knowing exactly what it:es!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "This game may well be settled by whoever captures that tower, but it's clear that none of us have the capability to: so just yet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Mikasa, I:n't think I'll be of much use right now due to the weather conditions, but I can continue to perform recon around the tower while taking advantage of my speed and maneuverability.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "If she:es decide to enter the battle herself, someone will have to stop her.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "So, uh, is there anything you need me to:?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Alrighty:. Let's get this show on the road...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Good. Let's focus on improving our combat capabilities,: come back for that tower later.",
			painting = {
				alpha = 0.3,
				time = 1
			},
