return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Damnit... I can't move my rigging anymore after taking that shockwave head-on... I think I'm:ne for...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Hatakaze, retreat while you still can. I:n't know how much time we have, but we need to stall as long as possible while there's still no clear route to capturing the tower.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Precisely. The biggest toss-up is what Musashi plans to:, but if we can get Hatakaze patched up this turn, Musashi will have to decide if it's worth for her to finish the job.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "(This is my test to the two of you, Musashi and Akagi. You thought Hatakaze would be easy pickings, but let's see what you're willing to: to thin out our numbers.)",
			painting = {
				alpha = 0.3,
				time = 1
			},
