return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.91}",
			say = "And even if they see it, they will never know if the power is \"mine,\" or simply a product of this:main.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.91}",
			say = "There's nothing you can: to stop me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.91}",
			say = "I must: what Amagi could not...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "{namecode.91}",
			say = "There's just one last thing to: before this \"domain\"... or rather, this Mirror Sea, becomes worthless to me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
