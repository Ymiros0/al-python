return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_fuxiangxian_3",
			hidePaintObj = True,
			say = "As she made her way through the entrance, she noticed a certain familiar object placed on a plinth near the:or.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Man, was I surprised to hear your voice during that fight against Compiler. I'm glad you're:ing well!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Does it have anything to: with our Watatsumi?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = True,
			say = "Calm:wn, Zuikaku. I won't be able to answer your questions if you keep firing them out one after another.",
			painting = {
				alpha = 0.3,
				time = 1
			},
