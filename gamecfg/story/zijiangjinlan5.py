return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "So, Akagi, Mikasa, Nagato, and: Musashi each take their turns in that order... I wonder if there's any special reasoning behind that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "That I cannot say. I: tend to overthink things after all, just as you said.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Despite being defense-oriented, Nagato:esn't believe in the wait-and-see approach.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Don't get too cocky. We might be able to wipe these Sirens out with ease normally, but remember - our rigging isn't as powerful as usual. We also:n't know if those Sirens have been enhanced in any way.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "Well, they:n't seem to have the hostile aura most Sirens give off. Does that mean we figured out a way to control them?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "I:ubt there's anything substantial you have to worry about. I heard this exercise area reflects the mental state of its participants.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "This is a good opportunity to learn about what Akagi's after, so all we need to: is to remain vigilant.",
			painting = {
				alpha = 0.3,
				time = 1
			},
