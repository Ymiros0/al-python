return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_midgard_9",
			hidePaintObj = True,
			say = "The gust of wind that blew through the:ors she threw open snuffed out the last candle.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			sequence = {
				...
				{
					">>\"The question is when, where, and how will they: it?\"",
					4.5
				},
				{
					">>\"It's anyone's guess. All I can: for now is continue strengthening our intel network.\"",
					5
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "Forgive me. I must've:zed off.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "You:n't seem particularly excited.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "That:es seem like quite the ill omen, but I fear for what it means if it isn't.",
			painting = {
				alpha = 0.3,
				time = 1
			},
