return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "Le Terrible,: you think the stronghold would be able to defend against those Enforcers we fought against earlier?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "As long as the Sirens:n't completely flatten the mountains on the island...",
			painting = {
				alpha = 0.3,
				time = 1
			},
