return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_unnamearea_1",
			hidePaintObj = True,
			say = "The girl changed directions, and slowed:wn her speed into a cautious advance.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "I'm glad to see that you're:ing well still, Marseillaise.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "You're searching for a place to bunker:wn in, right?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 902020,
			say = "If that was your intention,: I can't–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "Wait,:n't be in such a rush.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 807010,
			say = "I:n't believe this area to be a Mirror Sea. At least, none of my equipment indicates anything to that extent.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "Yes. Look at it this way – if the Sirens:n't want to deploy their forces somewhere,: we shouldn't either.",
			painting = {
				alpha = 0.3,
				time = 1
			},
