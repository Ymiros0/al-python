return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "Setting aside the motivations of the higher-ups, the Tribunal has always been a shadowy organization. It's only natural that they have secrets they:n't want the general public to know.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "I will be back sometime later to check on you, so bear with it until:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			actor = 902020,
			say = "I am the fighting angel of the Iris Orthodoxy. To: battle is my purpose.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
