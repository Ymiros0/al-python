	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				...
				{
					">>...If the arrival of the antediluvial flood is inevitable,: wise is she who prepares the Ark.",
					5
				}
			}
		},
		...
		},
		{
			...
			hidePaintObj = True,
			nameColor = "#92fc63",
			say = "But... something still:esn't seem quite right.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
