return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 902020,
			say = "...It has nothing to: with you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "...But, it probably has everything to: with me. You're mad at me, aren't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 902020,
			say = "If only you didn't try to save me back:, and instead protected the Crown––",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 902010,
			say = "Algérie, I:n't like our odds right now. Are you gonna get mad at me if I surrender?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "Iris Libre and the Vichya Dominion are two parts of one whole. Everything I've:ne is for the sake of restoring the one Iris Orthodoxy.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 805010,
			say = "Deep:wn, you already know the answer,:n't you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 801070,
			say = "Though, we'll be breathing:wn your neck the whole time, so I'm sure you won't enjoy those arrangements.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			actor = 903020,
			say = "Hah... I have no other choice:.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			actor = 903020,
			say = "Having all that said though, Richelieu,:n't let your idealism get the better of you. You can't erase the scars of the past, or pretend none of it ever happened.",
			painting = {
				alpha = 0.3,
				time = 1
			},
