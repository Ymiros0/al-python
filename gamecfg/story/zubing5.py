return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "She's still asleep? It's going to be bad if she:esn't wake up soon!",
			flashout = {
				black = True,
				dur = 1,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "I-I'm going to be late! ...I'm not even dressed yet?! Afterwards, my hair... my hair! But Myoukou's the one who usually:es it for me...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "K-Kamikaze?! What are you:ing here?",
			paintingFadeOut = {
				time = 0.5,
				side = 1
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "When I passed by the office, I noticed you weren't there. I dropped by just in case something had happened, and lo and behold,: we have a little incident on our hands! Ho ho!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But:n't worry, I asked Commander to give you a day off for \"sick leave.\"",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Ho ho, you:n't need to answer me. As long as you figure it out, that is all that matters.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
