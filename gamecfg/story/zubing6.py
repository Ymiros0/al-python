return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "She's:ing a lot better now than at first? Well of course! She's one of my precious juniors after all!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Wh-what should I:... I've folded so many without realizing it... If I give all of these to Commander at once...",
			flashout = {
				black = True,
				dur = 0.25,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(So it seems that Ashigara really:es feel that way about Commander... In that case, I've got to step up as her senior!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "(If you: that, d-d-d-doesn't that mean it's just the two of us here?!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
