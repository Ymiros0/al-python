return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "D-don't worry about it! I:n't know what was going through my head just now...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "Um,:... I'll be looking forward to it...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "Myoukou",
			say = "You rascals... what the hell are you all:ing? Didn't anyone ever teach you that it's rude to eavesdrop?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_room",
			say = "The:or suddenly swung open, and several girls crumpled through the:orway.",
			dialogShake = {
				speed = 0.09,
				x = 12.75,
				number = 2
		...
		},
		{
			...
			dir = 1,
			blackBg = True,
			say = "It seems like before we get to decide on the date, I have some explaining to:...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
