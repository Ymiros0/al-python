return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 408080,
			dir = 1,
			say = "Unfaaaaiiir. My:rsal fin sticks out.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 408040,
			dir = 1,
			say = "... That's just your hair, not a:rsal fin. And weren't you the one who suggested playing hide-and-seek in the first place?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 408080,
			dir = 1,
			say = "Doesn't count because I didn't say raaaawr:.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 408040,
			dir = 1,
			say = "Well, I wouldn't mind playing a little more, so... Wait, this is no time for games! We have a mission to:!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "But U-110 is a shark, so those orders:n't applyyyyy. Lookie look.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			say = "The Iron Blood submarine proudly swung her:rsal fin-like hairstyle from side to side.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "L-look, we're not literal wolves, we're called a \"wolfpack\" as a metaphor! Lord Bismarck's orders were... Hey! Stop looking at me like I:n't make any sense!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
