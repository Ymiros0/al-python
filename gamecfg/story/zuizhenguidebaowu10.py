return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "(It:esn't seem this will work... Umm, let's try...)",
			effects = {
				{
					active = True,
					name = "Story_Light01"
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(I'll drop it in the ocean,: swim away while she's picking it up. Perfect plan.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
