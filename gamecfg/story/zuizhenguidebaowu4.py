return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			say = "Amazon fired a warning shot at U-110, who'd only:ve just beneath the water. U-110 resurfaced and poked her head above the surface.",
			actorPosition = {
				x = 0,
				y = -1000
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Hah hah! It's time for an example of how anti-submarine warfare is really:ne!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
