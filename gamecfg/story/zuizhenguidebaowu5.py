return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "I:n't wanna fight anymore. I'm going home. Then I'm gonna take a baaaath.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Exactly! Which means this conversation is:ne and over! Full stop!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 408080,
			dir = 1,
			say = "Then can I leave when you're:ne?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "Why: you think we would just let you get away?",
			action = {
				{
					type = "shake",
					y = 30,
