return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 408040,
			dir = 1,
			say = "*Ahem*! Anyway, what's:ne is:ne! Our first order of business right now is to stun them with a counterattack before we run away!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "Then I will: the same. I'm the B-class destroyer Bulldog. Nice meeting you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 408040,
			dir = 1,
			say = "You're fine, you:n't need to introduce yourself! Go on, get out of here!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
