return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Grrr... If we:n't know where they're headed, our transport ships will be attacked again...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "You:n't need to worry about that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "They might destroy our cargo ships even if we chase after them now, and: all would be for nothing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
