return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 408040,
			dir = 1,
			say = "They're not chasing you, are they? Okay,: let's use this chance to run away!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I feigned death. Then I dropped my backpack to slow Bulldog:wn. It was noooot easy.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 408040,
			dir = 1,
			say = "Well, nicely:ne... Just:n't: anything that dangerous again, okay? Next time, they might take your lollipop away from you!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
