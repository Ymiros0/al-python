...
def var_0_1.InitCri(arg_8_0, arg_8_1):
...
def var_0_1.PlayBGM(arg_10_0, arg_10_1, arg_10_2):
	local var_10_0 = "bgm-" .. arg_10_1

	if arg_10_0.bgmName == var_10_0:
		return
...
def var_0_1.StopBGM(arg_12_0):
	arg_12_0.criInst.StopBGM(CriWareMgr.CRI_FADE_TYPE.FADE_INOUT)

	arg_12_0.bgmName = None

def var_0_1.StopPlaybackInfoForce(arg_13_0, arg_13_1):
	arg_13_1.playback.Stop(True)

def var_0_1.LoadCV(arg_14_0, arg_14_1, arg_14_2):
	local var_14_0 = var_0_1.GetCVBankName(arg_14_1)

	arg_14_0.LoadCueSheet(var_14_0, arg_14_2)

def var_0_1.LoadBattleCV(arg_15_0, arg_15_1, arg_15_2):
	local var_15_0 = var_0_1.GetBattleCVBankName(arg_15_1)

	arg_15_0.LoadCueSheet(var_15_0, arg_15_2)

def var_0_1.UnloadCVBank(arg_16_0):
	var_0_1.GetInstance().UnloadCueSheet(arg_16_0)

def var_0_1.GetCVBankName(arg_17_0):
	return "cv-" .. arg_17_0

def var_0_1.GetBattleCVBankName(arg_18_0):
	return "cv-" .. arg_18_0 .. "-battle"

def var_0_1.CheckFModeEvent(arg_19_0, arg_19_1, arg_19_2, arg_19_3):
	if not arg_19_1:
		return
...
def var_0_1.CheckHasCue(arg_23_0, arg_23_1, arg_23_2):
	local var_23_0 = CriAtom.GetCueSheet(arg_23_1)

	return var_23_0 != None and var_23_0.acb.Exists(arg_23_2)

def var_0_1.PlaySoundEffect_V3(arg_24_0, arg_24_1, arg_24_2):
	arg_24_0.CheckFModeEvent(arg_24_1, function(arg_25_0, arg_25_1)
		arg_24_0.PlayCV_V3(arg_25_0, arg_25_1, arg_24_2), function(arg_26_0)
		arg_24_0.PlaySE_V3(arg_26_0, arg_24_2))

def var_0_1.PlayMultipleSound_V3(arg_27_0, arg_27_1, arg_27_2):
	arg_27_0.CheckFModeEvent(arg_27_1, function(arg_28_0, arg_28_1)
		arg_27_0.CreateCvMultipleHandler(arg_28_0, arg_28_1, arg_27_2), function(arg_29_0)
		arg_27_0.PlaySE_V3(arg_29_0, arg_27_2))

def var_0_1.StopSoundEffect_V3(arg_30_0, arg_30_1):
	arg_30_0.CheckFModeEvent(arg_30_1, function(arg_31_0, arg_31_1)
		arg_30_0.StopCV_V3(), function(arg_32_0)
		arg_30_0.StopSE_V3())

def var_0_1.UnloadSoundEffect_V3(arg_33_0, arg_33_1):
	arg_33_0.CheckFModeEvent(arg_33_1, function(arg_34_0, arg_34_1)
		arg_33_0.UnloadCueSheet(arg_34_0), function(arg_35_0)
		arg_33_0.StopSE_V3())

def var_0_1.PlayCV_V3(arg_36_0, arg_36_1, arg_36_2, arg_36_3):
	assert(arg_36_1, "cueSheetName can not be None.")
	assert(arg_36_2, "cueName can not be None.")
	arg_36_0.criInst.PlayVoice(arg_36_2, CriWareMgr.CRI_FADE_TYPE.NONE, arg_36_1, function(arg_37_0)
		if arg_36_3 != None:
			arg_36_3(arg_37_0))

def var_0_1.CreateCvMultipleHandler(arg_38_0, arg_38_1, arg_38_2, arg_38_3):
	if not arg_38_0.luHandle:
	...
	for iter_38_0, iter_38_1 in ipairs(arg_38_0.cvCacheDataList):
		if iter_38_1[1] == arg_38_1 and iter_38_1[2] == arg_38_2:
			var_38_0 = False
...
def var_0_1.LateCvHandler(arg_39_0):
	for iter_39_0, iter_39_1 in ipairs(arg_39_0.cvCacheDataList):
		...
		if iter_39_0 == 1:
			...
			onDelayTick(function()
				arg_39_0.criInst.PlaySound(var_39_3, CriWareMgr.CRI_FADE_TYPE.FADE_CROSS, function(arg_42_0)
					if var_39_2 != None:
						var_39_2(arg_42_0)), iter_39_0 * 0.4)

	arg_39_0.cvCacheDataList = None

	if arg_39_0.luHandle:
		LateUpdateBeat.RemoveListener(arg_39_0.luHandle)

		arg_39_0.luHandle = None

def var_0_1.StopCV_V3(arg_43_0):
	arg_43_0.criInst.GetChannelData(var_0_1.C_VOICE).channelPlayer.Stop()

def var_0_1.PlaySE_V3(arg_44_0, arg_44_1, arg_44_2):
	assert(arg_44_1, "cueName can not be None.")
	arg_44_0.criInst.PlayAnySE(arg_44_1, None, function(arg_45_0)
		if arg_44_2 != None:
			arg_44_2(arg_45_0))

def var_0_1.StopSE_V3(arg_46_0):
...
def var_0_1.InitBgmCfg(arg_57_0, arg_57_1):
	...
	if OPEN_SPECIAL_IP_BGM and PLATFORM_CODE == PLATFORM_US:
		...
		local function var_57_4(arg_59_0)
			...
			for iter_59_0, iter_59_1 in ipairs(var_57_0):
				if iter_59_1 == arg_59_0:
					var_59_0 = True
...
def var_0_1.IsDefaultBGM(arg_61_0):
	return arg_61_0.isDefaultBGM

def var_0_1.getAtomSource(arg_62_0, arg_62_1):
