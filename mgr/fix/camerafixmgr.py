...
def var_0_0.SetMaskAsTopLayer(arg_2_0, arg_2_1):
	if arg_2_1:
...
def var_0_0.LateUpdate(arg_4_0):
	if arg_4_0.shouldFix:
...
def var_0_0.AdaptTo(arg_6_0, arg_6_1, arg_6_2):
	...
	if var_6_0 > ADAPT_NOTICE and var_6_1 < arg_6_2:
...
def var_0_0.Padding(arg_7_0):
	...
	elif var_7_5 > arg_7_0.maxAspectRatio:
		var_7_4 = var_7_2
...
def var_0_0.ResetPadding(arg_8_0):
...
def var_0_0.GetBattleUIRatio(arg_9_0):
	if arg_9_0.currentWidth / arg_9_0.currentHeight > ADAPT_NOTICE and NotchAdapt.CheckNotchRatio < arg_9_0.targetRatio:
		return NotchAdapt.CheckNotchRatio

	return arg_9_0.targetRatio

def var_0_0.GetCurrentWidth(arg_10_0):
	return arg_10_0.currentWidth

def var_0_0.GetCurrentHeight(arg_11_0):
