...
def var_0_0.NextOne(arg_7_0):
	if arg_7_0.eventTrigger:
		arg_7_0.eventTrigger.Trigger()

def var_0_0.UpdateFinger(arg_8_0, arg_8_1, arg_8_2):
	...
	if arg_8_2.slipAnim and not LeanTween.isTweening(arg_8_0.fingerXyz.gameObject):
		...
		LeanTween.value(arg_8_0.fingerXyz.gameObject, 0, -200, 1).setOnUpdate(System.Action_float(function(arg_9_0)
			arg_8_0.fingerXyz.localPosition = Vector3(arg_9_0, 0, 0))).setRepeat(-1)
	elif not arg_8_2.slipAnim and LeanTween.isTweening(arg_8_0.fingerXyz.gameObject):
		LeanTween.cancel(arg_8_0.fingerXyz.gameObject)
	else
		arg_8_0.fingerXyz.localPosition = Vector3.zero

def var_0_0.ClearFingerTimer(arg_10_0):
	if arg_10_0.fingerTimer:
		arg_10_0.fingerTimer.Stop()

		arg_10_0.fingerTimer = None

def var_0_0.OnClear(arg_11_0):
	if arg_11_0.eventTrigger:
		arg_11_0.eventTrigger.Clear()

		arg_11_0.eventTrigger = None
