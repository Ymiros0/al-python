...
def var_0_0.GetState(arg_4_0):
	...
	if arg_4_0.curGroupIndex > #var_0_0.GroupNameList:
...
def var_0_0.initData(arg_8_0):
	...
	arg_8_0.frameTimer = None
	arg_8_0.finishCount = 0
	arg_8_0.totalCount = 0
	arg_8_0.groupList = {}

	for iter_8_0, iter_8_1 in ipairs(var_0_0.GroupNameList):
		local var_8_0 = GroupHelper.GetGroupMgrByName(iter_8_1)

		table.insert(arg_8_0.groupList, var_8_0)

def var_0_0.clearTimer(arg_9_0):
	if arg_9_0.frameTimer:
		arg_9_0.frameTimer.Stop()

		arg_9_0.frameTimer = None

def var_0_0.checkWithIndex(arg_10_0, arg_10_1):
	if arg_10_1 > #var_0_0.GroupNameList:
		arg_10_0.clearTimer()
...
def var_0_0.onCheckD(arg_11_0):
	local var_11_0 = arg_11_0.groupList[arg_11_0.curGroupIndex]
	local var_11_1 = var_11_0.state

	if var_11_1 == DownloadState.CheckToUpdate or var_11_1 == DownloadState.CheckOver or var_11_1 == DownloadState.UpdateSuccess:
		arg_11_0.curGroupIndex = arg_11_0.curGroupIndex + 1

		arg_11_0.checkWithIndex(arg_11_0.curGroupIndex)
	elif var_11_0.state == DownloadState.CheckFailure:
		arg_11_0.clearTimer()

def var_0_0.createCheckTimer(arg_12_0):
	arg_12_0.frameTimer = FrameTimer.New(function()
		arg_12_0.onCheckD(), 1, -1)

	arg_12_0.frameTimer.Start()

def var_0_0.updateWithIndex(arg_14_0, arg_14_1):
	if arg_14_1 > #var_0_0.GroupNameList:
		arg_14_0.clearTimer()
...
def var_0_0.onUpdateD(arg_15_0):
	local var_15_0 = arg_15_0.groupList[arg_15_0.curGroupIndex]

	if var_15_0.state == DownloadState.UpdateSuccess:
	...
	elif var_15_0.state == DownloadState.UpdateFailure:
		arg_15_0.clearTimer()

def var_0_0.createUpdateTimer(arg_16_0):
	arg_16_0.frameTimer = FrameTimer.New(function()
		arg_16_0.onUpdateD(), 1, -1)
