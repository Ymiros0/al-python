...
def var_0_1.SetOwner(arg_3_0, arg_3_1):
...
def var_0_1.SetBlackboradValue(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
...
def var_0_1.SendEvent(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	arg_5_3 = arg_5_3 or arg_5_0.mainOwner

	if arg_5_2 == None:
		arg_5_3.SendEvent(arg_5_1)
	else
		arg_5_3.SendEvent(arg_5_1, arg_5_2, None)

def var_0_1.SendGlobalEvent(arg_6_0, arg_6_1, arg_6_2):
	arg_6_0.mainOwner.graph.SendGlobalEvent(arg_6_1, arg_6_2, None)

def var_0_1.RegisterFunc(arg_7_0, arg_7_1, arg_7_2):
	arg_7_0.functionDic[arg_7_1] = arg_7_2

def var_0_1.CallFunc(arg_8_0, arg_8_1, ...):
	assert(arg_8_0.functionDic[arg_8_1], "with out register call." .. arg_8_1)
	arg_8_0.functionDic[arg_8_1](...)

def var_0_1.Clear(arg_9_0):
	arg_9_0.mainOwner = None
	arg_9_0.functionDic = {}

def LuaActionTaskCall(arg_10_0, ...):
