...
def var_0_0.Play(arg_2_0, arg_2_1, arg_2_2):
	...
	if arg_2_1.show_event == 1:
		onDelayTick(function()
			if arg_2_0._anim:
				arg_2_0._anim.Play()

			arg_2_0._play(arg_2_1, var_2_1, arg_2_2), 0.66)
	else
...
def var_0_0._play(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
	...
	if arg_4_2.char_type == EducateConst.WORD_TYPE_ASIDE:
		...
		if arg_4_2.char_type == EducateConst.WORD_TYPE_CHILD:
			var_4_7 = arg_4_0.name
		elif arg_4_2.char_type == EducateConst.WORD_TYPE_PLAYER:
	...
	function var_4_6.endFunc()
		...
		for iter_5_0 = 1, #arg_4_0.drops:
			table.insert(var_5_0, function(arg_6_0)
				...
				if var_6_0.type == EducateConst.DROP_TYPE_BUFF:
