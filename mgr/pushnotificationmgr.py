...
def var_0_1.Init(arg_1_0):
	...
	for iter_1_0, iter_1_1 in ipairs(var_0_0.push_data_template):
...
def var_0_1.Reset(arg_2_0):
	var_0_2 = {}

	for iter_2_0, iter_2_1 in ipairs(var_0_0.push_data_template):
...
def var_0_1.setSwitch(arg_3_0, arg_3_1, arg_3_2):
	if not var_0_0.push_data_template[arg_3_1]:
		return
...
def var_0_1.setSwitchShipName(arg_4_0, arg_4_1):
	var_0_3 = arg_4_1

	PlayerPrefs.SetInt("setting_ship_name", arg_4_1 and 1 or 0)

def var_0_1.isEnabled(arg_5_0, arg_5_1):
	return var_0_2[arg_5_1]

def var_0_1.isEnableShipName(arg_6_0):
	return var_0_3

def var_0_1.Push(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
...
def var_0_1.cancelAll(arg_8_0):
	NotificationMgr.Inst.CancelAllLocalNotifications()

def var_0_1.PushAll(arg_9_0):
	local var_9_0 = getProxy(PlayerProxy)

	if var_9_0 and var_9_0.getInited():
		arg_9_0.cancelAll()

		if var_0_2[var_0_1.PUSH_TYPE_EVENT]:
			arg_9_0.PushEvent()

		if var_0_2[var_0_1.PUSH_TYPE_GOLD]:
			arg_9_0.PushGold()

		if var_0_2[var_0_1.PUSH_TYPE_OIL]:
			arg_9_0.PushOil()

		if var_0_2[var_0_1.PUSH_TYPE_BACKYARD]:
			arg_9_0.PushBackyard()

		if var_0_2[var_0_1.PUSH_TYPE_SCHOOL]:
			arg_9_0.PushSchool()

		if var_0_2[var_0_1.PUSH_TYPE_TECHNOLOGY]:
			arg_9_0.PushTechnlogy()

		if var_0_2[var_0_1.PUSH_TYPE_BLUEPRINT]:
			arg_9_0.PushBluePrint()

		if var_0_2[var_0_1.PUSH_TYPE_COMMANDER]:
			arg_9_0.PushCommander()

		if var_0_2[var_0_1.PUSH_TYPE_GUILD_MISSION_FORMATION]:
			arg_9_0.PushGuildMissionFormation()

def var_0_1.PushEvent(arg_10_0):
...
def var_0_1.PushGold(arg_11_0):
	...
	if var_11_8 < var_11_3:
		local var_11_9 = var_11_7 + (var_11_3 - var_11_8) / var_11_4 * 60 * 60 / 3

		if var_11_9 > var_0_0.TimeMgr.GetInstance().GetServerTime():
...
def var_0_1.PushOil(arg_12_0):
	...
	if var_12_8 < var_12_3:
		local var_12_9 = var_12_7 + (var_12_3 - var_12_8) / var_12_4 * 60 * 60 / 3

		if var_12_9 > var_0_0.TimeMgr.GetInstance().GetServerTime():
...
def var_0_1.PushBackyard(arg_13_0):
	local var_13_0 = getProxy(DormProxy).getRawData().getFoodLeftTime()

	if var_13_0 > var_0_0.TimeMgr.GetInstance().GetServerTime():
...
def var_0_1.PushSchool(arg_14_0):
	...
	for iter_14_0, iter_14_1 in ipairs(var_14_0):
		if iter_14_1.finishTime > var_0_0.TimeMgr.GetInstance().GetServerTime():
...
def var_0_1.PushBluePrint(arg_16_0):
	...
	if var_16_0 and var_16_1 and var_16_2:
		...
		if var_16_3:
			...
			for iter_16_0, iter_16_1 in ipairs(var_16_4):
				...
				if var_16_5 > var_0_0.TimeMgr.GetInstance().GetServerTime():
...
def var_0_1.PushCommander(arg_17_0):
	...
	if var_17_0 and var_17_1:
		...
		for iter_17_0, iter_17_1 in pairs(var_17_2):
			if iter_17_1.getState() == CommanderBox.STATE_STARTING:
...
def var_0_1.PushGuildMissionFormation(arg_18_0):
	...
	if not var_18_1 or var_18_1 and not var_18_1.IsParticipant():
		return
	...
	if var_18_3 <= var_0_0.TimeMgr.GetInstance().GetServerTime():
		return
...
def var_0_1.log(arg_19_0, arg_19_1, arg_19_2, arg_19_3):
