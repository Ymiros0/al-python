...
def var_0_0.ExistCache(arg_5_0, arg_5_1):
	return arg_5_0.caches[arg_5_1] != None

def var_0_0.ExistArg(arg_6_0, arg_6_1):
	return arg_6_0.caches[arg_6_1][1] != None

def var_0_0.GetArg(arg_7_0, arg_7_1):
	if not arg_7_0.ExistCache(arg_7_1):
		return None

	if not arg_7_0.ExistArg(arg_7_1):
		return None
