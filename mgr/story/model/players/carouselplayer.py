...
def var_0_0.OnEnter(arg_2_0, arg_2_1, arg_2_2, arg_2_3):
	arg_2_0.StartAnimtion(arg_2_1, arg_2_3)

def var_0_0.StartAnimtion(arg_3_0, arg_3_1, arg_3_2):
...
def var_0_0.RegisetEvent(arg_5_0, arg_5_1):
	var_0_0.super.RegisetEvent(arg_5_0, arg_5_1)
	triggerButton(arg_5_0._go)

def var_0_0.ReplaceBg(arg_6_0, arg_6_1, arg_6_2, arg_6_3):
