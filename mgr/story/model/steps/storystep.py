...
def var_0_0.ShouldShake(arg_2_0):
	return arg_2_0.shakeTime > 0

def var_0_0.GetShakeTime(arg_3_0):
	return arg_3_0.shakeTime

def var_0_0.SetDefaultTb(arg_4_0, arg_4_1):
	if not arg_4_0.defaultTb or arg_4_0.defaultTb <= 0:
		arg_4_0.defaultTb = arg_4_1

def var_0_0.SetPlaceholderType(arg_5_0, arg_5_1):
	arg_5_0.placeholderType = arg_5_1

def var_0_0.ShouldReplacePlayer(arg_6_0):
	return bit.band(arg_6_0.placeholderType, Story.PLAYER) > 0

def var_0_0.ShouldReplaceTb(arg_7_0):
	return bit.band(arg_7_0.placeholderType, Story.TB) > 0

def var_0_0.ReplacePlayerName(arg_8_0, arg_8_1):
	if not getProxy(PlayerProxy) or not getProxy(PlayerProxy).getRawData():
		return arg_8_1
...
def var_0_0.ExistDispatcher(arg_10_0):
	return arg_10_0.dispatcher != None

def var_0_0.GetDispatcher(arg_11_0):
	return arg_11_0.dispatcher

def var_0_0.IsRecallDispatcher(arg_12_0):
	if not arg_12_0.ExistDispatcher():
		return False

	local var_12_0 = arg_12_0.GetDispatcher()

	return var_12_0.callbackData != None and var_12_0.callbackData.name != None

def var_0_0.GetDispatcherRecallName(arg_13_0):
	if not arg_13_0.IsRecallDispatcher():
		return None

	return arg_13_0.GetDispatcher().callbackData.name

def var_0_0.ShouldHideUI(arg_14_0):
	if not arg_14_0.IsRecallDispatcher():
		return False

	return arg_14_0.GetDispatcher().callbackData.hideUI == True

def var_0_0.ExistIcon(arg_15_0):
	return arg_15_0.icon != None

def var_0_0.GetIconData(arg_16_0):
	return arg_16_0.icon

def var_0_0.SetId(arg_17_0, arg_17_1):
	arg_17_0.id = arg_17_1

def var_0_0.GetId(arg_18_0):
	return arg_18_0.id

def var_0_0.AutoShowOption(arg_19_0):
	arg_19_0.autoShowOption = True

def var_0_0.SkipEventForOption(arg_20_0):
	return arg_20_0.ExistOption() and arg_20_0.autoShowOption

def var_0_0.IsRecallOption(arg_21_0):
	if arg_21_0.ExistOption() and arg_21_0.GetOptionCnt() > 1 and arg_21_0.recallOption:
		return True

	return False

def var_0_0.SetBranchCode(arg_22_0, arg_22_1):
	arg_22_0.selectedBranchCode = arg_22_1

def var_0_0.GetSelectedBranchCode(arg_23_0):
	return arg_23_0.selectedBranchCode

def var_0_0.ExistLocation(arg_24_0):
	return arg_24_0.location != None

def var_0_0.GetLocation(arg_25_0):
	return {
		text = arg_25_0.location[1] or "",
		time = arg_25_0.location[2] or 999
	}

def var_0_0.ExistMovableNode(arg_26_0):
	return arg_26_0.movableNode != None and type(arg_26_0.movableNode) == "table" and #arg_26_0.movableNode > 0

def var_0_0.GetPathByString(arg_27_0, arg_27_1, arg_27_2):
	local var_27_0 = {}
...
def var_0_0.GenMoveNode(arg_28_0, arg_28_1):
	local var_28_0 = {}

	if type(arg_28_1.path) == "table":
		for iter_28_0, iter_28_1 in ipairs(arg_28_1.path):
			table.insert(var_28_0, Vector3(iter_28_1[1], iter_28_1[2], 0))
	elif type(arg_28_1.path) == "string":
...
def var_0_0.GetMovableNode(arg_29_0):
	if not arg_29_0.ExistMovableNode():
		return {}

	local var_29_0 = {}

	for iter_29_0, iter_29_1 in pairs(arg_29_0.movableNode or {}):
...
def var_0_0.OldPhotoEffect(arg_30_0):
	return arg_30_0.oldPhoto

def var_0_0.ShouldBgGlitchArt(arg_31_0):
	return arg_31_0.bgGlitchArt

def var_0_0.IsSameBranch(arg_32_0, arg_32_1):
	return not arg_32_0.branchCode or arg_32_0.branchCode == arg_32_1

def var_0_0.GetMode(arg_33_0):
	assert(False, "should override this function")

def var_0_0.GetFlashoutData(arg_34_0):
	if arg_34_0.flashout:
...
def var_0_0.GetFlashinData(arg_35_0):
	if arg_35_0.flashin:
...
def var_0_0.GetBgColor(arg_36_0):
	return Color.New(arg_36_0.bgColor[1] or 0, arg_36_0.bgColor[2] or 0, arg_36_0.bgColor[3] or 0)

def var_0_0.IsBlackBg(arg_37_0):
	return arg_37_0.blackBg

def var_0_0.GetBgName(arg_38_0):
	return arg_38_0.bgName

def var_0_0.GetBgShadow(arg_39_0):
	return arg_39_0.bgShadow

def var_0_0.IsDialogueMode(arg_40_0):
	return arg_40_0.GetMode() == Story.MODE_DIALOGUE

def var_0_0.GetBgmData(arg_41_0):
	return arg_41_0.bgm, arg_41_0.bgmDelay, arg_41_0.bgmVolume

def var_0_0.ShoulePlayBgm(arg_42_0):
	return arg_42_0.bgm != None

def var_0_0.ShouldStopBgm(arg_43_0):
	return arg_43_0.stopbgm

def var_0_0.GetEffects(arg_44_0):
	return arg_44_0.effects

def var_0_0.ShouldBlink(arg_45_0):
	return arg_45_0.blink != None

def var_0_0.GetBlinkData(arg_46_0):
	return arg_46_0.blink

def var_0_0.ShouldBlinkWithColor(arg_47_0):
	return arg_47_0.blinkWithColor != None

def var_0_0.GetBlinkWithColorData(arg_48_0):
	return arg_48_0.blinkWithColor

def var_0_0.ShouldPlaySoundEffect(arg_49_0):
	return arg_49_0.soundeffect != None

def var_0_0.GetSoundeffect(arg_50_0):
	return arg_50_0.soundeffect, arg_50_0.seDelay

def var_0_0.ShouldPlayVoice(arg_51_0):
	return arg_51_0.voice != None

def var_0_0.ShouldStopVoice(arg_52_0):
	return arg_52_0.stopVoice

def var_0_0.GetVoice(arg_53_0):
	return arg_53_0.voice, arg_53_0.voiceDelay

def var_0_0.ExistOption(arg_54_0):
	return arg_54_0.options != None and #arg_54_0.options > 0

def var_0_0.GetOptionCnt(arg_55_0):
	if arg_55_0.ExistOption():
		return #arg_55_0.options
	else
		return 0

def var_0_0.SetOptionSelCodes(arg_56_0, arg_56_1):
	arg_56_0.optionSelCode = arg_56_1

def var_0_0.IsBlackFrontGround(arg_57_0):
	return arg_57_0.blackFg > 0, Mathf.Clamp01(arg_57_0.blackFg)

def var_0_0.GetOptionIndexByAutoSel(arg_58_0):
	local var_58_0 = 0
	local var_58_1 = 0

	for iter_58_0, iter_58_1 in ipairs(arg_58_0.options):
		if arg_58_0.optionSelCode and iter_58_1.flag == arg_58_0.optionSelCode:
			var_58_0 = iter_58_0

			break

		if iter_58_1.autochoice and iter_58_1.autochoice == 1:
			var_58_1 = iter_58_0
...
def var_0_0.ShouldJumpToNextScript(arg_62_0):
	return arg_62_0.nextScriptName != None

def var_0_0.GetNextScriptName(arg_63_0):
	return arg_63_0.nextScriptName

def var_0_0.ShouldDelayEvent(arg_64_0):
	return arg_64_0.eventDelay and arg_64_0.eventDelay > 0

def var_0_0.GetEventDelayTime(arg_65_0):
	return arg_65_0.eventDelay

def var_0_0.GetUsingPaintingNames(arg_66_0):
	return {}
