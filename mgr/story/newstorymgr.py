...
def var_0_0.CheckResDownload(arg_44_0, arg_44_1, arg_44_2):
	...
	originalPrint("start:wnload res " .. var_44_1)
...
def var_0_0.CheckState(arg_49_0):
	if arg_49_0.state == var_0_3 or arg_49_0.state == var_0_1 or arg_49_0.state == var_0_4:
		return False
...
def var_0_0.OnEnd(arg_74_0, arg_74_1):
	...
	if arg_74_0.state == var_0_3 or arg_74_0.state == var_0_5:
