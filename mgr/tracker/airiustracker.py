...
def var_0_0.Tracking(arg_2_0, arg_2_1, arg_2_2, arg_2_3):
	...
	if pg.SdkMgr.GetInstance().GetChannelUID() == "0":
		...
		elif arg_2_1 == TRACKING_PURCHASE_CLICK_MONTHLYCARD:
		...
		elif arg_2_1 == TRACKING_PURCHASE_CLICK_DIAMOND:
		...
		elif arg_2_1 == TRACKING_PURCHASE_CLICK_GIFTBAG:
	...
	originalPrint("track:ne.")

def var_0_0.YS_S2S(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5, arg_3_6, arg_3_7):
	...
	for iter_3_0, iter_3_1 in pairs(var_3_2):
...
def var_0_0.transMoney(arg_5_0, arg_5_1):
