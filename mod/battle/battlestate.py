...
def var_0_2.IsAutoBotActive(arg_2_0):
...
def var_0_2.GetState(arg_5_0):
	return arg_5_0._state

def var_0_2.GetBattleType(arg_6_0):
	return arg_6_0._battleType

def var_0_2.SetBattleUI(arg_7_0, arg_7_1):
	arg_7_0._baseUI = arg_7_1

def var_0_2.EnterBattle(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_2.GenerateVertifyData(arg_15_0):
	return

def var_0_2.Vertify():
	return True, -1

def var_0_2.ChangeState(arg_17_0, arg_17_1):
	arg_17_0._state = arg_17_1

	if arg_17_1 == var_0_2.BATTLE_STATE_OPENING:
		...
		if var_17_0:
			...
			arg_17_0._battleCommand.DoPrologue()
	elif arg_17_1 == var_0_2.BATTLE_STATE_FIGHT:
		arg_17_0.ActiveAutoComponentTimer()
	elif arg_17_1 == var_0_2.BATTLE_STATE_REPORT:
		-- block empty

def var_0_2.GetUI(arg_19_0):
	return arg_19_0._baseUI

def var_0_2.ConfigBattleEndFunc(arg_20_0, arg_20_1):
	arg_20_0._endFunc = arg_20_1

def var_0_2.BattleEnd(arg_21_0):
...
def var_0_2.BattleTimeUp(arg_23_0):
...
def var_0_2.ExitBattle(arg_26_0):
...
def var_0_2.Stop(arg_27_0, arg_27_1):
	arg_27_0.disableCommon()
	arg_27_0._baseUI.exitBattle(arg_27_1)

def var_0_2.disableCommon(arg_28_0):
...
def var_0_2.reportDelayTimer(arg_29_0, arg_29_1, arg_29_2):
	local var_29_0
...
def var_0_2.SetTakeoverProcess(arg_31_0, arg_31_1):
...
def var_0_2.ClearTakeoverProcess(arg_32_0):
...
def var_0_2.IsPause(arg_33_0):
	return arg_33_0._isPause

def var_0_2.Pause(arg_34_0):
...
def var_0_2.Resume(arg_36_0):
	if arg_36_0._state == var_0_2.BATTLE_STATE_IDLE:
		arg_36_0.ChangeState(var_0_2.BATTLE_STATE_OPENING)
		UpdateBeat.Add(arg_36_0.Update, arg_36_0)
	elif arg_36_0._state == var_0_2.BATTLE_STATE_REPORT:
		return
...
def var_0_2.ScaleTimer(arg_38_0, arg_38_1):
...
def var_0_2.GetTimeScaleRate(arg_39_0):
	return arg_39_0._timeScale or 1

def var_0_2.CacheTimescaler(arg_40_0, arg_40_1):
