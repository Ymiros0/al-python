...
def var_0_3.DoPrologue(arg_3_0):
	(function()
		arg_3_0._uiMediator.OpeningEffect(function()
			...
			arg_3_0._state.ChangeState(var_0_0.Battle.BattleState.BATTLE_STATE_FIGHT), SYSTEM_DEBUG)
...
def var_0_3.RemoveEvent(arg_11_0):
...
def var_0_3.onAddUnit(arg_13_0, arg_13_1):
	...
	if var_13_0 != var_0_0.Battle.BattleConst.UnitType.ENEMY_UNIT and var_13_0 != var_0_0.Battle.BattleConst.UnitType.BOSS_UNIT and var_13_0 != var_0_0.Battle.BattleConst.UnitType.MINION_UNIT and var_13_0 != var_0_0.Battle.BattleConst.UnitType.NPC_UNIT and var_13_0 == var_0_0.Battle.BattleConst.UnitType.BOSS_UNIT:
		-- block empty

def var_0_3.RegisterUnitEvent(arg_14_0, arg_14_1):
...
def var_0_3.onRemoveUnit(arg_16_0, arg_16_1):
	...
	arg_16_0._unitDataList[var_16_0] = None

def var_0_3.onPlayerShutDown(arg_17_0, arg_17_1):
	if arg_17_1.Data.unit == arg_17_0._userFleet.GetMainList() == 0:
	...
	if #arg_17_0._userFleet.GetScoutList() == 0:
		arg_17_0._dataProxy.KillAllAirStrike()
		arg_17_0._dataProxy.KillAllEnemy()
		arg_17_0._dataProxy.CLSBullet(var_0_0.Battle.BattleConfig.FRIENDLY_CODE)
		arg_17_0._dataProxy.CLSBullet(var_0_0.Battle.BattleConfig.FOE_CODE)
...
def var_0_3.onWillDie(arg_19_0, arg_19_1):
	...
	if var_19_0.IsBoss() and not var_19_1:
		arg_19_0._dataProxy.KillAllEnemy()

def var_0_3.onShutDownPlayer(arg_20_0, arg_20_1):
