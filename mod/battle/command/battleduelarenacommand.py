...
def var_0_3.ConfigBattleData(arg_2_0, arg_2_1):
	arg_2_0._battleInitData = arg_2_1

def var_0_3.Initialize(arg_3_0):
	arg_3_0.Init()
...
def var_0_3.InitProtocol(arg_12_0):
	return

def var_0_3.AddEvent(arg_13_0):
...
def var_0_3.RemoveEvent(arg_14_0):
...
def var_0_3.onAddUnit(arg_15_0, arg_15_1):
...
def var_0_3.RegisterUnitEvent(arg_16_0, arg_16_1):
...
def var_0_3.onRemoveUnit(arg_18_0, arg_18_1):
	...
	arg_18_0._unitDataList[var_18_0] = None

def var_0_3.onPlayerShutDown(arg_19_0, arg_19_1):
	if arg_19_0._state.GetState() != arg_19_0._state.BATTLE_STATE_FIGHT:
		return

	if arg_19_0._failReason == None:
	...
	if #arg_19_0._userFleet.GetUnitList() == 0 or #arg_19_0._rivalFleet.GetUnitList() == 0:
		arg_19_0._dataProxy.CalcDuelScoreAtEnd(arg_19_0._userFleet, arg_19_0._rivalFleet)

		if arg_19_0._failReason:
	...
	if not arg_19_1.Data.unit.IsMainFleetUnit() and var_19_2 == 0 and var_19_3 == 0:
		...
		for iter_19_2, iter_19_3 in ipairs(var_19_5):
...
def var_0_3.onUpdateCountDown(arg_20_0, arg_20_1):
	if arg_20_0._dataProxy.GetCountDown() <= 0:
...
def var_0_3.onUpdateUnitHP(arg_21_0, arg_21_1):
...
def var_0_3.onUnitDying(arg_22_0, arg_22_1):
	local var_22_0 = arg_22_1.Dispatcher
	local var_22_1 = var_22_0.GetUniqueID()

	if var_22_0.GetUnitType() != var_0_0.Battle.BattleConst.UnitType.MINION_UNIT:
		arg_22_0._dataProxy.CalcBattleScoreWhenDead(var_22_0)

	arg_22_0._dataProxy.KillUnit(var_22_1)

def var_0_3.onShutDownPlayer(arg_23_0, arg_23_1):
