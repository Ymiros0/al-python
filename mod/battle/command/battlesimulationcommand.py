...
def var_0_3.DoPrologue(arg_4_0):
	...
	if var_4_2 == 0:
		...
		for iter_4_2, iter_4_3 in ipairs(var_4_3):
...
def var_0_3.onPlayerShutDown(arg_19_0, arg_19_1):
	...
	if #arg_19_0._rivalFleet.GetUnitList() == 0:
	...
	if arg_19_1.Data.unit == arg_19_0._userFleet.GetFlagShip():
		arg_19_0._dataProxy.CalcSimulationScoreAtEnd(arg_19_0._userFleet, arg_19_0._rivalFleet)
		arg_19_0._state.BattleEnd()

		return

	if #arg_19_0._userFleet.GetScoutList() == 0:
		arg_19_0._dataProxy.CalcSimulationScoreAtEnd(arg_19_0._userFleet, arg_19_0._rivalFleet)
		arg_19_0._state.BattleEnd()

	if #arg_19_0._rivalFleet.GetScoutList() == 0 and not arg_19_0._rivalDisadvatage:
		arg_19_0.rivalMainUnitPhase()

def var_0_3.rivalMainUnitPhase(arg_20_0):
	...
	for iter_20_0, iter_20_1 in ipairs(var_20_0):
		for iter_20_2, iter_20_3 in ipairs(var_0_0.Battle.BattleConfig.SIMULATION_ADVANTAGE_CANCEL_LIST):
...
def var_0_3.onUpdateCountDown(arg_21_0, arg_21_1):
	local var_21_0 = arg_21_0._dataProxy.GetCountDown()

	if arg_21_0._buffStartTime:
...
def var_0_3.onUpdateUnitHP(arg_22_0, arg_22_1):
...
def var_0_3.onShutDownPlayer(arg_24_0, arg_24_1):
...
def var_0_3.startBuffCount(arg_25_0):
