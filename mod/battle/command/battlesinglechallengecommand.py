...
def var_0_4.ConfigBattleData(arg_2_0, arg_2_1):
	arg_2_0._challengeInfo = arg_2_1.ChallengeInfo

def var_0_4.onInitBattle(arg_3_0):
...
def var_0_4.initWaveModule(arg_4_0):
...
def var_0_4.DoPrologue(arg_10_0):
	...
	arg_10_0._uiMediator.SeaSurfaceShift(45, 0, None, var_10_0)

def var_0_4.onPlayerShutDown(arg_13_0, arg_13_1):
	if arg_13_0._state.GetState() != arg_13_0._state.BATTLE_STATE_FIGHT:
		return

	if arg_13_1.Data.unit == arg_13_0._userFleet.GetFlagShip():
		arg_13_0._dataProxy.CalcChallengeScore(False)
		arg_13_0._state.BattleEnd()

		return

	if #arg_13_0._userFleet.GetScoutList() == 0:
		arg_13_0._dataProxy.CalcChallengeScore(False)
		arg_13_0._state.BattleEnd()

def var_0_4.onUpdateCountDown(arg_14_0, arg_14_1):
	if arg_14_0._dataProxy.GetCountDown() <= 0:
		arg_14_0._dataProxy.CalcChallengeScore(False)
		arg_14_0._state.BattleEnd()

def var_0_4.monsterEnhance(arg_15_0, arg_15_1):
