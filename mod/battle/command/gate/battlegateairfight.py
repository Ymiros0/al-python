...
def var_0_0.Exit(arg_2_0, arg_2_1):
	...
	if arg_2_0.statistics._battleScore >= ys.Battle.BattleConst.BattleScore.B and var_2_0 and not var_2_0.isEnd():
		local var_2_1 = 0
		...
		if var_2_1 < math.min(var_2_4 * 2, var_2_2 * 3):
