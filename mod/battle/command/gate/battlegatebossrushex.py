...
def var_0_0.Entrance(arg_1_0, arg_1_1):
	...
	if var_1_10.GetMode() == BossRushSeriesData.MODE.SINGLE:
		var_1_14 = var_1_13[1]
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_20):
		var_1_19[#var_1_19 + 1] = iter_1_1.id

	local var_1_21 = var_1_1.getRawData()

	if var_1_5 and var_1_9 > var_1_21.oil:
	...
	local function var_1_22(arg_2_0)
		...
		if var_1_4.enter_energy_cost > 0:
			...
			for iter_2_0, iter_2_1 in ipairs(var_1_20):
