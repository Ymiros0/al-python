...
def var_0_0.Entrance(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_11.ships):
	...
	if var_1_5 and var_1_13 > var_1_15.oil:
	...
	if chapter.getPlayType() == ChapterConst.TypeExtra:
		var_1_19 = True
	...
	local function var_1_20(arg_2_0)
		...
		if var_1_4.enter_energy_cost > 0 and not var_1_19:
			local var_2_0 = pg.gameset.battle_consume_energy.key_value

			for iter_2_0, iter_2_1 in ipairs(var_1_14):
...
def var_0_0.Exit(arg_4_0, arg_4_1):
	...
	if arg_4_0.statistics.submarineAid:
		...
		if var_4_10:
			...
			for iter_4_0, iter_4_1 in ipairs(var_4_11):
				if arg_4_0.statistics[iter_4_1.id]:
	...
	for iter_4_2, iter_4_3 in ipairs(arg_4_0.statistics._enemyInfoList):
