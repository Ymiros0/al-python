...
def var_0_0.Entrance(arg_1_0, arg_1_1):
	...
	if not getProxy(MilitaryExerciseProxy).getSeasonInfo().canExercise():
	...
	if var_1_9 and var_1_14 > var_1_17.oil:
	...
	for iter_1_2, iter_1_3 in ipairs(var_1_7.mainShips):
		var_1_18 = var_1_18 + iter_1_3.level

	for iter_1_4, iter_1_5 in ipairs(var_1_7.vanguardShips):
	...
	local function var_1_19(arg_2_0)
		...
		if var_1_8.enter_energy_cost > 0:
