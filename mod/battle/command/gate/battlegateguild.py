...
def var_0_0.Exit(arg_4_0, arg_4_1):
	...
	for iter_4_0, iter_4_1 in pairs(var_4_5.getCommanders()):
		table.insert(var_4_6, iter_4_1.id)

	local var_4_7 = var_4_5.GetShips()

	for iter_4_2, iter_4_3 in ipairs(var_4_7):
	...
	if arg_4_0.statistics.submarineAid:
		...
		if var_4_8:
			...
			for iter_4_4, iter_4_5 in ipairs(var_4_9):
				local var_4_10 = iter_4_5.ship

				if arg_4_0.statistics[var_4_10.id]:
					table.insert(var_4_3, var_4_10)

			for iter_4_6, iter_4_7 in pairs(var_4_8.getCommanders()):
	...
	for iter_4_8, iter_4_9 in ipairs(var_4_3):
		local var_4_13 = arg_4_0.statistics[iter_4_9.id]

		if var_4_11 < var_4_13.output:
...
def var_0_0.SendRequest(arg_6_0, arg_6_1, arg_6_2):
	pg.ConnectionMgr.GetInstance().Send(40003, arg_6_1, 40004, function(arg_7_0)
		if arg_7_0.result == 0 or arg_7_0.result == 1030:
			arg_6_2(arg_7_0)
		elif arg_7_0.result == 20:
		...
		elif arg_7_0.result == 4:
			pg.m02.sendNotification(GAME.QUIT_BATTLE)
		else
			arg_6_0.RequestFailStandardProcess(arg_7_0))

def var_0_0.GetGuildBossMission():
...
def var_0_0.UpdateGuildBossMission():
...
def var_0_0.GeneralPlayerCosume(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4):
...
def var_0_0.GeneralPackage(arg_12_0, arg_12_1):
	local var_12_0 = 0
	local var_12_1 = {}
	local var_12_2 = {}
	...
	for iter_12_2, iter_12_3 in ipairs(arg_12_0.statistics._enemyInfoList):
