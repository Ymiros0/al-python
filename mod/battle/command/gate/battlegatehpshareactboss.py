...
def var_0_0.Entrance(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_17):
	...
	if var_1_1.IsOilLimit(var_1_14) and var_1_20[1] > 0:
	...
	if var_1_4.getRawData().getResource(var_1_23) <= 0:
		pg.TipsMgr.GetInstance().ShowTips(i18n("stage_beginStage_error_noTicket"))

		return

	if var_1_8 and var_1_19 > var_1_21.oil:
	...
	local function var_1_26(arg_2_0)
		...
		if var_1_7.enter_energy_cost > 0:
			local var_2_1 = pg.gameset.battle_consume_energy.key_value

			for iter_2_0, iter_2_1 in ipairs(var_1_17):
...
def var_0_0.Exit(arg_4_0, arg_4_1):
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.statistics._enemyInfoList):
