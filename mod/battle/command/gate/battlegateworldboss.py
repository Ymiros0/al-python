...
def var_0_0.Entrance(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_10):
	...
	if var_1_14.IsSelfBoss(var_1_15) and var_1_15.GetSelfFightCnt() > 0:
		var_1_7 = var_1_15.GetOilConsume()

	if var_1_4 and var_1_7 > var_1_12.oil:
	...
	local function var_1_17(arg_2_0)
		...
		if var_1_3.enter_energy_cost > 0:
		...
		if var_1_14.IsSelfBoss(var_1_15):
			var_1_15.IncreaseFightCnt()
		else
			if WorldBossConst._IsCurrBoss(var_1_15):
				var_1_14.reducePt()
...
def var_0_0.Exit(arg_5_0, arg_5_1):
	if arg_5_1.CheaterVertify():
		return
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_0.statistics._enemyInfoList):
