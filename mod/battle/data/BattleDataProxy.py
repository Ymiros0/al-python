...
def var_0_9.InitBattle(arg_2_0, arg_2_1):
...
def var_0_9.OnCameraRatioUpdate(arg_3_0):
...
def var_0_9.Start(arg_4_0):
	arg_4_0._startTimeStamp = pg.TimeMgr.GetInstance().GetCombatTime()

def var_0_9.TriggerBattleInitBuffs(arg_5_0):
...
def var_0_9.TirggerBattleStartBuffs(arg_6_0):
	for iter_6_0, iter_6_1 in pairs(arg_6_0._fleetList):
		local var_6_0 = iter_6_1.GetUnitList()
		local var_6_1 = iter_6_1.GetScoutList()
		local var_6_2 = var_6_1[1]
		local var_6_3 = #var_6_1 > 1 and var_6_1[#var_6_1] or None
		local var_6_4 = #var_6_1 == 3 and var_6_1[2] or None
		...
		for iter_6_2, iter_6_3 in ipairs(var_6_0):
			...
			if arg_6_0._battleInitData.MapAuraSkills:
				for iter_6_4, iter_6_5 in ipairs(arg_6_0._battleInitData.MapAuraSkills):
					local var_6_9 = var_0_0.Battle.BattleBuffUnit.New(iter_6_5.id, iter_6_5.level)

					iter_6_3.AddBuff(var_6_9)

			if arg_6_0._battleInitData.MapAidSkills:
				for iter_6_6, iter_6_7 in ipairs(arg_6_0._battleInitData.MapAidSkills):
					local var_6_10 = var_0_0.Battle.BattleBuffUnit.New(iter_6_7.id, iter_6_7.level)

					iter_6_3.AddBuff(var_6_10)

			if arg_6_0._currentStageData.stageBuff:
				for iter_6_8, iter_6_9 in ipairs(arg_6_0._currentStageData.stageBuff):
		...
		for iter_6_10, iter_6_11 in ipairs(var_6_12):
			underscore.each(arg_6_0._battleInitData.ChapterBuffIDs or {}, function(arg_9_0)
				if var_0_5.GetSLGStrategyBuffByCombatBuffID(arg_9_0).type == ChapterConst.AirDominanceStrategyBuffType:
					local var_9_0 = var_0_0.Battle.BattleBuffUnit.New(arg_9_0)

					iter_6_11.AddBuff(var_9_0))

def var_0_9.InitAllFleetUnitsWeaponCD(arg_10_0):
...
def var_0_9.InitUnitWeaponCD(arg_11_0):
	arg_11_0.CheckWeaponInitial()

def var_0_9.StartCardPuzzle(arg_12_0):
	for iter_12_0, iter_12_1 in pairs(arg_12_0._fleetList):
		iter_12_1.GetCardPuzzleComponent().Start()

def var_0_9.PausePuzzleComponent(arg_13_0):
	for iter_13_0, iter_13_1 in pairs(arg_13_0._fleetList):
		local var_13_0 = iter_13_1.GetCardPuzzleComponent()

		if var_13_0:
			var_13_0.BlockComponentByCard(True)

def var_0_9.ResumePuzzleComponent(arg_14_0):
...
def var_0_9.GetInitData(arg_16_0):
	return arg_16_0._battleInitData

def var_0_9.GetDungeonData(arg_17_0):
	return arg_17_0._dungeonInfo

def var_0_9.InitData(arg_18_0, arg_18_1):
	...
	elif arg_18_0._expeditionTmp.map_id:
	...
	if arg_18_0._battleInitData.RepressInfo:
		local var_18_3 = arg_18_0._battleInitData.RepressInfo

		if arg_18_0._battleInitData.battleType == SYSTEM_SCENARIO:
		...
		elif arg_18_0._battleInitData.battleType == SYSTEM_WORLD or arg_18_0._battleInitData.battleType == SYSTEM_WORLD_BOSS:
			arg_18_0._repressEnemyHpRant = var_18_3.repressEnemyHpRant
...
def var_0_9.initCommanderBuff(arg_21_0):
	local var_21_0 = {}
...
def var_0_9.DeactiveProxy(arg_23_0):
	arg_23_0._state = None

	arg_23_0.Clear()
	var_0_0.Battle.BattleDataProxy.super.DeactiveProxy(arg_23_0)

def var_0_9.InitUserShipsData(arg_24_0, arg_24_1, arg_24_2, arg_24_3, arg_24_4):
...
def var_0_9.InitUserSupportShipsData(arg_25_0, arg_25_1, arg_25_2):
...
def var_0_9.InitUserAidData(arg_26_0):
...
def var_0_9.SetSubmarinAidData(arg_27_0):
...
def var_0_9.CelebrateVictory(arg_30_0, arg_30_1):
	local var_30_0
...
def var_0_9.InitStageData(arg_31_0):
	...
	if arg_31_0._battleInitData.battleType == SYSTEM_DUEL:
		...
		if arg_31_0._currentStageData.mainUnitPosition and arg_31_0._currentStageData.mainUnitPosition[var_0_4.FRIENDLY_CODE]:
...
def var_0_9.GetVanguardBornCoordinate(arg_32_0, arg_32_1):
	if arg_32_1 == var_0_4.FRIENDLY_CODE:
		return arg_32_0._currentStageData.fleetCorrdinate
	elif arg_32_1 == var_0_4.FOE_CODE:
		return arg_32_0._currentStageData.rivalCorrdinate

def var_0_9.GetTotalBounds(arg_33_0):
	return arg_33_0._totalUpperBound, arg_33_0._totalLowerBound, arg_33_0._totalLeftBound, arg_33_0._totalRightBound

def var_0_9.GetTotalRightBound(arg_34_0):
	return arg_34_0._totalRightBound

def var_0_9.GetTotalLowerBound(arg_35_0):
	return arg_35_0._totalLowerBound

def var_0_9.GetUnitBoundByIFF(arg_36_0, arg_36_1):
	if arg_36_1 == var_0_4.FRIENDLY_CODE:
	...
	elif arg_36_1 == var_0_4.FOE_CODE:
...
def var_0_9.GetFleetBoundByIFF(arg_37_0, arg_37_1):
	if arg_37_1 == var_0_4.FRIENDLY_CODE:
	...
	elif arg_37_1 == var_0_4.FOE_CODE:
...
def var_0_9.ShiftFleetBound(arg_38_0, arg_38_1, arg_38_2):
...
def var_0_9.GetFieldBound(arg_39_0):
...
def var_0_9.GetFleetByIFF(arg_40_0, arg_40_1):
...
def var_0_9.GetAidUnit(arg_41_0):
	return arg_41_0._aidUnitList

def var_0_9.GetFleetList(arg_42_0):
	return arg_42_0._fleetList

def var_0_9.GetEnemySubmarineCount(arg_43_0):
	return arg_43_0._enemySubmarineCount

def var_0_9.GetCommander(arg_44_0):
	return arg_44_0._commander

def var_0_9.GetCommanderBuff(arg_45_0):
	return arg_45_0._commanderBuff, arg_45_0._subCommanderBuff

def var_0_9.GetStageInfo(arg_46_0):
	return arg_46_0._currentStageData

def var_0_9.GetWinningStreak(arg_47_0):
	return arg_47_0._chapterWinningStreak

def var_0_9.GetBGMList(arg_48_0, arg_48_1):
	if not arg_48_1:
		return arg_48_0._initBGMList
	else
		return arg_48_0._otherBGMList

def var_0_9.GetDungeonLevel(arg_49_0):
	return arg_49_0._dungeonLevel

def var_0_9.SetDungeonLevel(arg_50_0, arg_50_1):
	arg_50_0._dungeonLevel = arg_50_1

def var_0_9.IsCompletelyRepress(arg_51_0):
	return arg_51_0._completelyRepress

def var_0_9.GetRepressReduce(arg_52_0):
	return arg_52_0._repressReduce

def var_0_9.GetRepressLevel(arg_53_0):
	return arg_53_0._repressLevel

def var_0_9.updateInit(arg_54_0, arg_54_1):
...
def var_0_9.updateLoop(arg_55_0, arg_55_1):
	...
	for iter_55_2, iter_55_3 in pairs(arg_55_0._unitList):
		if iter_55_3.IsSpectre():
			if iter_55_3.GetAttrByName(var_0_0.Battle.BattleBuffSetBattleUnitType.ATTR_KEY) <= var_0_4.FUSION_ELEMENT_UNIT_TYPE:
				-- block empty
			else
			...
			if var_55_2 == var_0_4.FRIENDLY_CODE:
				var_55_0[var_55_2] = math.max(var_55_0[var_55_2], var_55_1)
			elif var_55_2 == var_0_4.FOE_CODE:
	...
	if arg_55_0._fleetList[var_0_4.FOE_CODE]:
	...
	for iter_55_4, iter_55_5 in pairs(arg_55_0._bulletList):
		...
		if var_55_14 == var_0_3.BulletOutBound.SPLIT and var_55_13 == var_0_3.BulletType.SHRAPNEL and (var_55_12.x > arg_55_0._bulletRightBound and var_55_11.x > 0 or var_55_12.x < arg_55_0._bulletLeftBoundSplit and var_55_11.x < 0 or var_55_12.z > arg_55_0._bulletUpperBound and var_55_11.z > 0 or var_55_12.z < arg_55_0._bulletLowerBoundSplit and var_55_11.z < 0):
		...
		elif var_55_14 == var_0_3.BulletOutBound.COMMON and (var_55_12.x > arg_55_0._bulletRightBound and var_55_11.x > 0 or var_55_12.z < arg_55_0._bulletLowerBound and var_55_11.z < 0):
			arg_55_0.RemoveBulletUnit(iter_55_5.GetUniqueID())
		elif var_55_12.x < arg_55_0._bulletLeftBound and var_55_11.x < 0 and var_55_13 != var_0_3.BulletType.BOMB:
			if var_55_14 == var_0_3.BulletOutBound.RANDOM:
			...
			local var_55_16 = iter_55_5.GetCurrentState and iter_55_5.GetCurrentState() or None

			if var_55_16 == var_0_0.Battle.BattleShrapnelBulletUnit.STATE_FINAL_SPLIT:
				-- block empty
			elif var_55_16 == var_0_0.Battle.BattleShrapnelBulletUnit.STATE_SPLIT and not iter_55_5.IsFragile():
				-- block empty
			elif var_55_14 == var_0_3.BulletOutBound.COMMON and var_55_12.z > arg_55_0._bulletUpperBound and var_55_11.z > 0 or var_55_14 == var_0_3.BulletOutBound.VISION and var_55_12.z > arg_55_0._bulletUpperBoundVision and var_55_11.z > 0 or iter_55_5.IsOutRange(arg_55_1):
				if iter_55_5.GetExist():
					iter_55_5.OutRange()
				else
					arg_55_0.RemoveBulletUnit(iter_55_5.GetUniqueID())
	...
	for iter_55_6, iter_55_7 in pairs(arg_55_0._aircraftList):
		...
		if var_55_17 == var_0_4.FRIENDLY_CODE:
			var_55_18 = arg_55_0._totalRightBound
		elif var_55_17 == var_0_4.FOE_CODE:
			var_55_18 = arg_55_0._totalLeftBound

		if iter_55_7.GetPosition().x * var_55_17 > math.abs(var_55_18) and iter_55_7.GetSpeed().x * var_55_17 > 0:
			iter_55_7.OutBound()
		else
...
def var_0_9.UpdateAutoComponent(arg_56_0, arg_56_1):
...
def var_0_9.UpdateWeather(arg_57_0, arg_57_1):
	for iter_57_0, iter_57_1 in ipairs(arg_57_0._weahter):
		if iter_57_1 == var_0_3.WEATHER.NIGHT:
			local var_57_0 = {
...
def var_0_9.UpdateEscapeOnly(arg_58_0, arg_58_1):
	for iter_58_0, iter_58_1 in pairs(arg_58_0._foeShipList):
		iter_58_1.Update(arg_58_1)

def var_0_9.UpdateCountDown(arg_59_0, arg_59_1):
	...
	if math.floor(arg_59_0._countDown - var_59_0) == 0 or var_59_0 == 0:
...
def var_0_9.SpawnMonster(arg_60_0, arg_60_1, arg_60_2, arg_60_3, arg_60_4, arg_60_5):
	...
	local var_60_8 = var_0_5.CreateBattleUnitData(var_60_0, arg_60_3, arg_60_4, arg_60_1.monsterTemplateID, None, var_60_2, arg_60_1.extraInfo, None, None, None, None, arg_60_1.level)
	...
	if var_60_8.GetIFF() == var_0_4.FRIENDLY_CODE:
...
def var_0_9.UpdateHostileSubmarine(arg_62_0, arg_62_1):
	if arg_62_1:
...
def var_0_9.SpawnNPC(arg_63_0, arg_63_1, arg_63_2):
	...
	local var_63_4 = var_0_5.CreateBattleUnitData(var_63_0, var_63_1, arg_63_2.GetIFF(), arg_63_1.monsterTemplateID, None, var_63_3, arg_63_1.extraInfo, None, None, None, None, arg_63_1.level)
	...
	if table.contains(TeamType.SubShipType, var_63_2.type):
		...
		if var_63_4.GetIFF() != var_0_4.FRIENDLY_CODE:
...
def var_0_9.EnemyEscape(arg_65_0):
	for iter_65_0, iter_65_1 in pairs(arg_65_0._foeShipList):
		if iter_65_1.ContainsLabelTag(var_0_4.ESCAPE_EXPLO_TAG):
...
def var_0_9.GetNPCTeam(arg_66_0, arg_66_1):
...
def var_0_9.KillNPCTeam(arg_67_0, arg_67_1):
...
def var_0_9.SpawnVanguard(arg_68_0, arg_68_1, arg_68_2):
...
def var_0_9.SpawnMain(arg_69_0, arg_69_1, arg_69_2):
	local var_69_0
...
def var_0_9.SpawnSub(arg_70_0, arg_70_1, arg_70_2):
	local var_70_0
	...
	if arg_70_2 == var_0_4.FRIENDLY_CODE:
...
def var_0_9.SpawnManualSub(arg_71_0, arg_71_1, arg_71_2):
...
def var_0_9.SpawnSupportUnit(arg_72_0, arg_72_1, arg_72_2):
...
def var_0_9.ShutdownPlayerUnit(arg_73_0, arg_73_1):
...
def var_0_9.updateDeadList(arg_74_0):
...
def var_0_9.KillUnit(arg_75_0, arg_75_1):
	...
	elif var_75_2 == var_0_4.FOE_CODE:
		arg_75_0._foeShipList[arg_75_1] = None

		if var_75_1 == var_0_3.UnitType.ENEMY_UNIT or var_75_1 == var_0_3.UnitType.BOSS_UNIT:
			if var_75_0.GetTeam():
	...
	elif var_75_2 == var_0_4.FRIENDLY_CODE:
...
def var_0_9.KillAllEnemy(arg_76_0):
	for iter_76_0, iter_76_1 in pairs(arg_76_0._unitList):
		if iter_76_1.GetIFF() == var_0_4.FOE_CODE and iter_76_1.IsAlive() and not iter_76_1.IsBoss():
			iter_76_1.DeadAction()

def var_0_9.KillSubmarineByIFF(arg_77_0, arg_77_1):
...
def var_0_9.KillAllAircraft(arg_78_0):
...
def var_0_9.KillWaveSummonMonster(arg_79_0, arg_79_1):
...
def var_0_9.IsThereBoss(arg_80_0):
	return arg_80_0.GetActiveBossCount() > 0

def var_0_9.GetActiveBossCount(arg_81_0):
	local var_81_0 = 0
...
def var_0_9.setShipUnitBound(arg_82_0, arg_82_1):
...
def var_0_9.generatePlayerUnit(arg_83_0, arg_83_1, arg_83_2, arg_83_3, arg_83_4):
	...
	if var_83_5.GetIFF() == var_0_4.FRIENDLY_CODE:
		arg_83_0._friendlyShipList[var_83_0] = var_83_5
	elif var_83_5.GetIFF() == var_0_4.FOE_CODE:
...
def var_0_9.generateSupportPlayerUnit(arg_85_0, arg_85_1, arg_85_2):
...
def var_0_9.SwitchSpectreUnit(arg_86_0, arg_86_1):
...
def var_0_9.GetUnitList(arg_87_0):
	return arg_87_0._unitList

def var_0_9.GetFriendlyShipList(arg_88_0):
	return arg_88_0._friendlyShipList

def var_0_9.GetFoeShipList(arg_89_0):
	return arg_89_0._foeShipList

def var_0_9.GetFoeAircraftList(arg_90_0):
	return arg_90_0._foeAircraftList

def var_0_9.GetFreeShipList(arg_91_0):
	return arg_91_0._freeShipList

def var_0_9.GetSpectreShipList(arg_92_0):
	return arg_92_0._spectreShipList

def var_0_9.GenerateUnitID(arg_93_0):
	arg_93_0._unitCount = arg_93_0._unitCount + 1

	return arg_93_0._unitCount

def var_0_9.GetCountDown(arg_94_0):
	return arg_94_0._countDown

def var_0_9.SpawnAirFighter(arg_95_0, arg_95_1):
...
def var_0_9.ClearAirFighterTimer(arg_100_0):
...
def var_0_9.KillAllAirStrike(arg_101_0):
	for iter_101_0, iter_101_1 in pairs(arg_101_0._aircraftList):
		if iter_101_1.__name == var_0_0.Battle.BattleAirFighterUnit.__name:
...
def var_0_9.GetAirFighterInfo(arg_102_0, arg_102_1):
	return arg_102_0._airFighterList[arg_102_1]

def var_0_9.GetAirFighterList(arg_103_0):
	return arg_103_0._airFighterList

def var_0_9.CreateAircraft(arg_104_0, arg_104_1, arg_104_2, arg_104_3, arg_104_4):
	...
	if arg_104_1.GetIFF() == var_0_4.FRIENDLY_CODE:
		-- block empty
	else
		var_104_2 = True
...
def var_0_9.CreateAirFighter(arg_105_0, arg_105_1):
...
def var_0_9.doCreateAirUnit(arg_106_0, arg_106_1, arg_106_2, arg_106_3, arg_106_4):
...
def var_0_9.KillAircraft(arg_107_0, arg_107_1):
...
def var_0_9.GetAircraftList(arg_108_0):
	return arg_108_0._aircraftList

def var_0_9.GenerateAircraftID(arg_109_0):
	arg_109_0._aircraftCount = arg_109_0._aircraftCount + 1

	return arg_109_0._aircraftCount

def var_0_9.CreateBulletUnit(arg_110_0, arg_110_1, arg_110_2, arg_110_3, arg_110_4):
...
def var_0_9.RemoveBulletUnit(arg_111_0, arg_111_1):
...
def var_0_9.GetBulletList(arg_112_0):
	return arg_112_0._bulletList

def var_0_9.GenerateBulletID(arg_113_0):
...
def var_0_9.CLSBullet(arg_114_0, arg_114_1, arg_114_2):
...
def var_0_9.CLSAircraft(arg_115_0, arg_115_1):
...
def var_0_9.CLSMinion(arg_116_0):
	for iter_116_0, iter_116_1 in pairs(arg_116_0._unitList):
		if iter_116_1.GetIFF() == var_0_4.FOE_CODE and iter_116_1.IsAlive() and not iter_116_1.IsBoss():
			iter_116_1.SetDeathReason(var_0_3.UnitDeathReason.CLS)
			iter_116_1.DeadAction()

def var_0_9.SpawnColumnArea(arg_117_0, arg_117_1, arg_117_2, arg_117_3, arg_117_4, arg_117_5, arg_117_6, arg_117_7, arg_117_8):
...
def var_0_9.SpawnCubeArea(arg_118_0, arg_118_1, arg_118_2, arg_118_3, arg_118_4, arg_118_5, arg_118_6, arg_118_7, arg_118_8, arg_118_9):
...
def var_0_9.SpawnLastingColumnArea(arg_119_0, arg_119_1, arg_119_2, arg_119_3, arg_119_4, arg_119_5, arg_119_6, arg_119_7, arg_119_8, arg_119_9, arg_119_10, arg_119_11):
...
def var_0_9.SpawnLastingCubeArea(arg_120_0, arg_120_1, arg_120_2, arg_120_3, arg_120_4, arg_120_5, arg_120_6, arg_120_7, arg_120_8, arg_120_9, arg_120_10, arg_120_11, arg_120_12):
...
def var_0_9.SpawnTriggerColumnArea(arg_121_0, arg_121_1, arg_121_2, arg_121_3, arg_121_4, arg_121_5, arg_121_6, arg_121_7, arg_121_8):
...
def var_0_9.GetAOEList(arg_124_0):
	return arg_124_0._AOEList

def var_0_9.GenerateAreaID(arg_125_0):
	arg_125_0._AOECount = arg_125_0._AOECount + 1

	return arg_125_0._AOECount

def var_0_9.SpawnWall(arg_126_0, arg_126_1, arg_126_2, arg_126_3, arg_126_4):
...
def var_0_9.RemoveWall(arg_127_0, arg_127_1):
...
def var_0_9.SpawnShelter(arg_128_0, arg_128_1, arg_128_2):
...
def var_0_9.RemoveShelter(arg_129_0, arg_129_1):
...
def var_0_9.RemoveEnvironment(arg_137_0, arg_137_1):
...
def var_0_9.DispatchWarning(arg_138_0, arg_138_1, arg_138_2):
	arg_138_0.DispatchEvent(var_0_0.Event.New(var_0_1.UPDATE_ENVIRONMENT_WARNING, {
		isActive = arg_138_1
	}))

def var_0_9.GetEnvironmentList(arg_139_0):
	return arg_139_0._environmentList

def var_0_9.GernerateEnvironmentID(arg_140_0):
	arg_140_0._environmentIndex = arg_140_0._environmentIndex + 1

	return arg_140_0._environmentIndex

def var_0_9.SpawnEffect(arg_141_0, arg_141_1, arg_141_2, arg_141_3):
...
def var_0_9.SpawnUIFX(arg_142_0, arg_142_1, arg_142_2, arg_142_3, arg_142_4):
...
def var_0_9.SpawnCameraFX(arg_143_0, arg_143_1, arg_143_2, arg_143_3, arg_143_4):
...
def var_0_9.GetFriendlyCode(arg_144_0):
	return arg_144_0._friendlyCode

def var_0_9.GetFoeCode(arg_145_0):
	return arg_145_0._foeCode

def var_0_9.GetOppoSideCode(arg_146_0):
	if arg_146_0 == var_0_4.FRIENDLY_CODE:
		return var_0_4.FOE_CODE
	elif arg_146_0 == var_0_4.FOE_CODE:
		return var_0_4.FRIENDLY_CODE

def var_0_9.GetStatistics(arg_147_0):
	return arg_147_0._statistics

def var_0_9.BlockManualCast(arg_148_0, arg_148_1):
...
def var_0_9.JamManualCast(arg_149_0, arg_149_1):
	arg_149_0.DispatchEvent(var_0_0.Event.New(var_0_1.JAMMING, {
		jammingFlag = arg_149_1
	}))

def var_0_9.SubmarineStrike(arg_150_0, arg_150_1):
...
def var_0_9.GetWaveFlags(arg_151_0):
	return arg_151_0._waveFlags

def var_0_9.AddWaveFlag(arg_152_0, arg_152_1):
	if not arg_152_1:
		return
...
def var_0_9.RemoveFlag(arg_153_0, arg_153_1):
	if not arg_153_1:
		return
...
def var_0_9.DispatchCustomWarning(arg_154_0, arg_154_1):
	arg_154_0.DispatchEvent(var_0_0.Event.New(var_0_1.EDIT_CUSTOM_WARNING_LABEL, {
		labelData = arg_154_1
	}))

def var_0_9.DispatchGridmanSkill(arg_155_0, arg_155_1, arg_155_2):
	arg_155_0.DispatchEvent(var_0_0.Event.New(var_0_1.GRIDMAN_SKILL_FLOAT, {
		type = arg_155_1,
		IFF = arg_155_2
	}))

def var_0_9.SpawnFusionUnit(arg_156_0, arg_156_1, arg_156_2, arg_156_3, arg_156_4):
...
def var_0_9.DefusionUnit(arg_157_0, arg_157_1):
...
def var_0_9.FreezeUnit(arg_158_0, arg_158_1):
...
def var_0_9.ActiveFreezeUnit(arg_159_0, arg_159_1):
