...
def var_0_0.HandleBulletHit(arg_6_0, arg_6_1, arg_6_2):
	if not arg_6_2:
	...
	if arg_6_2.GetUnitType() == var_0_3.UnitType.PLAYER_UNIT and arg_6_2.GetIFF() == var_0_4.FRIENDLY_CODE:
		ys.Battle.BattleCameraUtil.GetInstance().StartShake(pg.shake_template[var_0_3.ShakeType.HIT])

	return True

def var_0_0.HandleDamage(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4):
	if arg_7_2.GetIFF() == var_0_4.FOE_CODE and arg_7_2.IsShowHPBar():
	...
	if var_0_6.IsInvincible(arg_7_2):
		return
	...
	if not var_7_8 and arg_7_1.GetWeaponTempData().type != var_0_3.EquipmentType.ANTI_AIR:
		...
		if var_7_16 and var_7_16.IsAlive() and var_7_16.GetUnitType() != ys.Battle.BattleConst.UnitType.AIRFIGHTER_UNIT:
			if table.contains(var_0_3.AircraftUnitType, var_7_16.GetUnitType()):
	...
	if var_7_18 != var_0_3.UnitType.AIRCRAFT_UNIT and var_7_18 != var_0_3.UnitType.AIRFIGHTER_UNIT and var_7_18 != var_0_3.UnitType.FUNNEL_UNIT and var_7_18 != var_0_3.UnitType.UAV_UNIT:
		var_7_19 = False
...
def var_0_0.HandleMeteoDamage(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_0.HandleDirectDamage(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4):
	local var_9_0
	...
	if not var_9_4:
		...
		if var_9_5 != var_0_3.UnitType.AIRCRAFT_UNIT and var_9_5 != var_0_3.UnitType.AIRFIGHTER_UNIT and var_9_5 != var_0_3.UnitType.FUNNEL_UNIT and var_9_5 != var_0_3.UnitType.UAV_UNIT:
			var_9_6 = False

		arg_9_0.obituary(arg_9_1, var_9_6, arg_9_3)

def var_0_0.obituary(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
...
def var_0_0.HandleAircraftMissDamage(arg_11_0, arg_11_1, arg_11_2):
	if arg_11_2 == None:
		return
...
def var_0_0.HandleShipMissDamage(arg_12_0, arg_12_1, arg_12_2):
	if arg_12_2 == None:
		return
	...
	if var_12_3:
		...
		if table.contains(TeamType.SubShipType, var_12_4):
			...
			if var_12_3.IsAlive() and var_0_2.RollSubmarineDualDice(arg_12_1):
...
def var_0_0.HandleCrashDamage(arg_13_0, arg_13_1, arg_13_2):
...
def var_0_0.HandleBuffPlacer(arg_14_0, arg_14_1, arg_14_2):
	local var_14_0 = var_0_5.GetBuffTemplate(arg_14_0.buff_id).effect_list
	local var_14_1 = False

	if var_14_0[1].type == "BattleBuffDOT":
		if var_0_2.CaclulateDOTPlace(arg_14_0.rant, var_14_0[1], arg_14_1, arg_14_2):
			var_14_1 = True
	elif var_0_2.IsHappen(arg_14_0.rant or 10000):
		var_14_1 = True
...
def var_0_0.HandleDOTPlace(arg_15_0, arg_15_1, arg_15_2):
	...
	if var_0_2.IsHappen(var_15_0.ACC + arg_15_1.GetAttrByName(var_15_1.hit) - arg_15_2.GetAttrByName(var_15_1.resist)):
		return True

	return False

def var_0_0.HandleShipCrashDamageList(arg_16_0, arg_16_1, arg_16_2):
	...
	for iter_16_2, iter_16_3 in ipairs(arg_16_2):
		if var_16_0[iter_16_3] == None:
			...
			local var_16_3 = pg.TimeMgr.GetInstance().AddBattleTimer("shipCld", None, var_0_4.SHIP_CLD_INTERVAL, var_16_2, True)
...
def var_0_0.HandleShipCrashDecelerate(arg_18_0, arg_18_1, arg_18_2):
	if arg_18_2 == 0 and arg_18_1.IsCrash():
		arg_18_1.SetCrash(False)
	elif arg_18_2 > 0 and not arg_18_1.IsCrash():
		arg_18_1.SetCrash(True)

def var_0_0.HandleWallHitByBullet(arg_19_0, arg_19_1, arg_19_2):
	return (arg_19_1.GetCldFunc()(arg_19_2))

def var_0_0.HandleWallHitByShip(arg_20_0, arg_20_1, arg_20_2):
	arg_20_1.GetCldFunc()(arg_20_2)

def var_0_0.HandleWallDamage(arg_21_0, arg_21_1, arg_21_2):
	if arg_21_2.GetIFF() == var_0_4.FOE_CODE and arg_21_2.IsShowHPBar():
		arg_21_0.DispatchEvent(ys.Event.New(var_0_1.HIT_ENEMY, arg_21_2))

	local var_21_0 = var_0_6.GetCurrent(arg_21_1, "id")

	if var_0_6.IsInvincible(arg_21_2):
		return
