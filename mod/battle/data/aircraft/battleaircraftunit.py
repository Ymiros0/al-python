...
def var_0_6.Ctor(arg_1_0, arg_1_1):
...
def var_0_6.SetBound(arg_2_0, arg_2_1, arg_2_2):
	arg_2_0._top = arg_2_1
	arg_2_0._bottom = arg_2_2

	if arg_2_0._tmpData.spawn_brownian:
...
def var_0_6.Clear(arg_9_0):
	if arg_9_0._createTimer:
...
def var_0_6.SetWeaponPreCastBound(arg_10_0):
	return

def var_0_6.EnterGCD(arg_11_0):
	return

def var_0_6.CreateWeapon(arg_12_0):
	local var_12_0 = {}

	for iter_12_0, iter_12_1 in ipairs(arg_12_0._tmpData.weapon_ID):
...
def var_0_6.ShutdownWeapon(arg_13_0):
	for iter_13_0, iter_13_1 in ipairs(arg_13_0.GetWeapon()):
		iter_13_1.Clear()

def var_0_6.UpdateWeapon(arg_14_0):
	if arg_14_0._currentState == arg_14_0.STATE_ATTACK:
		for iter_14_0, iter_14_1 in ipairs(arg_14_0.GetWeapon()):
			iter_14_1.Update()

def var_0_6.GetWeapon(arg_15_0):
	return arg_15_0._weapon

def var_0_6.GetCurrentHP(arg_16_0):
	return arg_16_0._currentHP

def var_0_6.GetMaxHP(arg_17_0):
	return var_0_0.Battle.BattleAttr.GetCurrent(arg_17_0, "maxHP")

def var_0_6.IsUndefeated(arg_18_0):
	return arg_18_0._undefeated

def var_0_6.IsAlive(arg_19_0):
	return arg_19_0._aliveState

def var_0_6.IsCease(arg_20_0):
	return False

def var_0_6.GetOxyState(arg_21_0):
	return None

def var_0_6.IsBoss(arg_22_0):
	return None

def var_0_6.HandleDamageToDeath(arg_23_0):
...
def var_0_6.UpdateHP(arg_24_0, arg_24_1, arg_24_2):
	...
	if var_24_3 < arg_24_0._currentHP:
		arg_24_0._currentHP = var_24_3

	if arg_24_0._currentHP < 0:
	...
	if arg_24_0._currentHP <= 0 and arg_24_0.IsAlive():
		arg_24_0.onDead()

	return arg_24_1

def var_0_6.onDead(arg_25_0):
	arg_25_0._currentState = arg_25_0.STATE_DESTORY
	arg_25_0._aliveState = False

def var_0_6.UpdateSpeed(arg_26_0):
...
def var_0_6.SetWeanponPotential(arg_30_0, arg_30_1):
	arg_30_0._weaponPotential = arg_30_1

def var_0_6.SetTargetZ(arg_31_0):
...
def var_0_6.SetMotherUnit(arg_32_0, arg_32_1):
	...
	if var_32_1.remote:
		...
		if var_32_4 and var_32_4[var_32_0]:
...
def var_0_6.ContainsLabelTag(arg_35_0, arg_35_1):
	if arg_35_0._labelTagList == None:
		return False

	for iter_35_0, iter_35_1 in ipairs(arg_35_1):
		if table.contains(arg_35_0._labelTagList, iter_35_1):
			return True

	return False

def var_0_6.SetIFF(arg_36_0, arg_36_1):
	arg_36_0._IFF = arg_36_1

def var_0_6.SetPosition(arg_37_0, arg_37_1):
	arg_37_0._pos.Set(arg_37_1.x, arg_37_1.y, arg_37_1.z)

def var_0_6.IsOutViewBound(arg_38_0):
	local var_38_0 = arg_38_0.GetPosition()
	local var_38_1 = var_38_0.x
	local var_38_2 = var_38_0.z

	if var_38_1 > arg_38_0._cameraRight or var_38_2 > arg_38_0._cameraTop or var_38_2 < arg_38_0._cameraBottom:
		return True

def var_0_6.GetDistance(arg_39_0, arg_39_1):
	local var_39_0 = arg_39_0._battleProxy.FrameIndex

	if arg_39_0._frame != var_39_0:
...
def var_0_6.GetDirection(arg_57_0):
	return arg_57_0._dir

def var_0_6.GetTemplate(arg_58_0):
	return arg_58_0._tmpData

def var_0_6.GetTemplateID(arg_59_0):
	return arg_59_0._tmpData.id

def var_0_6.GetUnitType(arg_60_0):
	return arg_60_0._type

def var_0_6.GetHPRate(arg_61_0):
	return arg_61_0._currentHP / arg_61_0.GetMaxHP()

def var_0_6.GetBoxSize(arg_62_0):
	return arg_62_0._cldComponent.GetCldBoxSize()

def var_0_6.GetSpeedRatio(arg_63_0):
	return var_0_4.GetSpeedRatio(arg_63_0.GetSpeedExemptKey(), arg_63_0._IFF)

def var_0_6.GetSpeedExemptKey(arg_64_0):
	return arg_64_0._speedExemptKey

def var_0_6.IsPlayerAircraft(arg_65_0):
	return arg_65_0._isPlayerAircraft

def var_0_6.IsShowHPBar(arg_66_0):
	return False

def var_0_6.SetUnVisitable(arg_67_0):
	var_0_0.Battle.BattleAttr.UnVisitable(arg_67_0)

def var_0_6.SetVisitable(arg_68_0):
	var_0_0.Battle.BattleAttr.Visitable(arg_68_0)

def var_0_6.IsVisitable(arg_69_0):
	return var_0_0.Battle.BattleAttr.IsVisitable(arg_69_0)

def var_0_6.OverrideDeadFX(arg_70_0, arg_70_1):
	arg_70_0._deadFX = arg_70_1

def var_0_6.GetDeadFX(arg_71_0):
	return arg_71_0._deadFX

def var_0_6.TriggerBuff(arg_72_0, arg_72_1, arg_72_2):
	return

def var_0_6.AddCreateTimer(arg_73_0, arg_73_1, arg_73_2):
...
def var_0_6.GetCldBox(arg_77_0):
	return arg_77_0._cldComponent.GetCldBox(arg_77_0.GetPosition())

def var_0_6.GetCldData(arg_78_0):
	return arg_78_0._cldComponent.GetCldData()

def var_0_6.AddBuff(arg_79_0):
	return

def var_0_6.SetBuffStack(arg_80_0):
	return

def var_0_6.RemoveBuff(arg_81_0):
	return

def var_0_6.TriggerBuff(arg_82_0):
	return

def var_0_6.CloakExpose(arg_83_0):
	return

def var_0_6.GetCurrentOxyState(arg_84_0):
	return None

def var_0_6.RemoveRemoteBoundBone(arg_85_0):
	return

def var_0_6.SetRemoteBoundBone(arg_86_0):
	return

def var_0_6.GetRemoteBoundBone(arg_87_0):
	return
