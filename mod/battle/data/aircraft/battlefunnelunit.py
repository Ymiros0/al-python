...
def var_0_4.updateExist(arg_3_0):
	if not arg_3_0._existStartTime:
		return

	if arg_3_0._existStartTime + arg_3_0._existDuration < pg.TimeMgr.GetInstance().GetCombatTime():
		arg_3_0.changePartolState(var_0_4.CRASH_STATE)

def var_0_4.UpdateWeapon(arg_4_0):
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.GetWeapon()):
		iter_4_1.Update()

def var_0_4.SetMotherUnit(arg_5_0, arg_5_1):
...
def var_0_4.SetTemplate(arg_6_0, arg_6_1):
...
def var_0_4.changePartolState(arg_7_0, arg_7_1):
	if arg_7_1 == var_0_4.MOVE_STATE:
		arg_7_0.changeToMoveState()
	elif arg_7_1 == var_0_4.STOP_STATE:
		arg_7_0.changeToStopState()
	elif arg_7_1 == var_0_4.CRASH_STATE:
		arg_7_0.changeToCrashState()

	arg_7_0._portalState = arg_7_1

def var_0_4.AddCreateTimer(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_4.changeToCrashState(arg_19_0):
	arg_19_0._existStartTime = None

	if arg_19_0.GetIFF() == var_0_1.FOE_CODE:
		arg_19_0._speedDir = Vector3.left
	elif arg_19_0.GetIFF() == var_0_1.FRIENDLY_CODE:
		arg_19_0._speedDir = Vector3.right

	arg_19_0.updatePatrol = arg_19_0._updateCrash

def var_0_4._updateCrash(arg_20_0):
