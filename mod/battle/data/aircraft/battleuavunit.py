...
def var_0_4.SetTemplate(arg_3_0, arg_3_1):
...
def var_0_4.changePartolState(arg_4_0, arg_4_1):
	if arg_4_1 == var_0_4.MOVE_STATE:
		arg_4_0.changeToMoveState()
	elif arg_4_1 == var_0_4.HOVER_STATE:
		arg_4_0.changeToHoverState()

	arg_4_0._portalState = arg_4_1

def var_0_4.AddCreateTimer(arg_5_0, arg_5_1, arg_5_2):
...
def var_0_4._updateCreate(arg_7_0):
	arg_7_0.UpdateSpeed()

	arg_7_0._pos = arg_7_0._pos + arg_7_0._speed

def var_0_4.changeToMoveState(arg_8_0):
	arg_8_0._cruiseLimit = arg_8_0._centerPos.x
	arg_8_0.updatePatrol = arg_8_0._updateMove

def var_0_4._updateMove(arg_9_0, arg_9_1):
	arg_9_0.UpdateSpeed()

	arg_9_0._pos = arg_9_0._pos + arg_9_0._speed

	if arg_9_0._IFF == var_0_1.FRIENDLY_CODE:
		if arg_9_0._pos.x > arg_9_0._cruiseLimit:
			arg_9_0.changePartolState(var_0_4.HOVER_STATE)
	elif arg_9_0._IFF == var_0_1.FOE_CODE and arg_9_0._pos.x < arg_9_0._cruiseLimit:
		arg_9_0.changePartolState(var_0_4.HOVER_STATE)

def var_0_4.changeToHoverState(arg_10_0):
	arg_10_0._hoverStartTime = pg.TimeMgr.GetInstance().GetCombatTime()
	arg_10_0.updatePatrol = arg_10_0._updateHover

def var_0_4._updateHover(arg_11_0, arg_11_1):
...
def var_0_4.GetSize(arg_12_0):
	if arg_12_0._portalState == var_0_4.HOVER_STATE:
		local var_12_0 = pg.TimeMgr.GetInstance().GetCombatTime() - arg_12_0._hoverStartTime
		local var_12_1 = math.cos(var_12_0)

		if var_12_1 > 0 and var_12_1 < 0.2:
			var_12_1 = 0.2
		elif var_12_1 <= 0 and var_12_1 > -0.2:
			var_12_1 = -0.2
