...
def var_0_0.CreateContextCalculateDamage(arg_1_0, arg_1_1, arg_1_2, arg_1_3):
	...
	elif var_1_9 == var_0_1.WeaponDamageAttr.AIR:
	...
	elif var_1_9 == var_0_1.WeaponDamageAttr.ANTI_AIR:
		-- block empty
	elif var_1_9 == var_0_1.WeaponDamageAttr.ANIT_SUB:
		-- block empty

	local var_1_25 = var_1_5.luck - var_1_14.luck

	if var_0_3.GetCurrent(arg_1_1, "perfectDodge") == 1:
		var_1_19 = True

	if not var_1_19:
		var_1_21 = var_1_23

		if var_0_3.GetCurrent(arg_1_0, "GCT") == 1:
			var_1_20 = True
	...
	if arg_1_1.GetCurrentOxyState() == var_0_1.OXY_STATE.DIVE:
...
def var_0_0.parseCompare(arg_2_0, arg_2_1):
...
def var_0_0.parseFormula(arg_3_0, arg_3_1):
	local var_3_0 = {}
	local var_3_1 = {}

	for iter_3_0 in string.gmatch(arg_3_0, "%w+%.?%w*"):
		table.insert(var_3_0, iter_3_0)

	for iter_3_1 in string.gmatch(arg_3_0, "[^%w%.]"):
