...
def var_0_3.SetArgs(arg_2_0, arg_2_1):
	arg_2_0._host = arg_2_1

	for iter_2_0, iter_2_1 in ipairs(arg_2_0._effectList):
		iter_2_1.SetArgs(arg_2_1, arg_2_0)

def var_0_3.setRemoveTime(arg_3_0):
	arg_3_0._RemoveTime = pg.TimeMgr.GetInstance().GetCombatTime() + arg_3_0._time
	arg_3_0._cancelTime = None

def var_0_3.Attach(arg_4_0, arg_4_1):
	arg_4_0._stack = 1
...
def var_0_3.Stack(arg_5_0, arg_5_1):
...
def var_0_3.UpdateStack(arg_6_0, arg_6_1, arg_6_2):
	return

def var_0_3.Remove(arg_7_0):
	arg_7_0.onTrigger(var_0_2.ON_REMOVE, arg_7_0._host)

	arg_7_0._host.GetFleetBuffList()[arg_7_0._id] = None

	arg_7_0.Clear()

def var_0_3.Update(arg_8_0, arg_8_1, arg_8_2):
	if arg_8_0.IsTimeToRemove(arg_8_2):
		arg_8_0.Remove()
	else
		arg_8_0.onTrigger(var_0_2.ON_UPDATE, arg_8_1, arg_8_2)

def var_0_3.onTrigger(arg_9_0, arg_9_1, arg_9_2, arg_9_3):
	local var_9_0 = arg_9_0._triggerSearchTable[arg_9_1]

	if var_9_0 == None or #var_9_0 == 0:
		return
	...
	for iter_9_0, iter_9_1 in ipairs(var_9_0):
		...
		if iter_9_1.IsActive():
			iter_9_1.NotActive()
			iter_9_1.Trigger(arg_9_1, arg_9_2, arg_9_0, arg_9_3)
			iter_9_1.SetActive()

def var_0_3.IsTimeToRemove(arg_10_0, arg_10_1):
	if arg_10_0._time == 0:
		return False
	else
		return arg_10_1 >= arg_10_0._RemoveTime

def var_0_3.IsActive(arg_11_0):
	return arg_11_0._isActive

def var_0_3.SetActive(arg_12_0):
	arg_12_0._isActive = True

def var_0_3.NotActive(arg_13_0):
	arg_13_0._isActive = False

def var_0_3.GetCaster(arg_14_0):
	return None

def var_0_3.GetID(arg_15_0):
	return arg_15_0._id

def var_0_3.GetLv(arg_16_0):
	return 1

def var_0_3.Clear(arg_17_0):
	arg_17_0._host = None

	for iter_17_0, iter_17_1 in ipairs(arg_17_0._effectList):
		iter_17_1.Clear()
