...
def var_0_1.SetArgs(arg_3_0, arg_3_1, arg_3_2):
	...
	if arg_3_0._tempData.arg_list.comboDamage:
...
def var_0_1.onStack(arg_5_0, arg_5_1, arg_5_2):
...
def var_0_1.UpdateAttr(arg_8_0, arg_8_1):
	assert(arg_8_0._attr != "velocity", ">>BattleBuffAddAttr(Ratio)不可用于修改速度，使用BattleBuffFixVelocity!")

	if arg_8_0._attr == "injureRatio":
		arg_8_0.UpdateAttrMul(arg_8_1)
	else
		arg_8_0.UpdateAttrAdd(arg_8_1)

	if arg_8_0._attr == "cloakExposeExtra" or arg_8_0._attr == "cloakRestore" or arg_8_0._attr == "cloakRecovery":
		arg_8_1.UpdateCloakConfig()

	if arg_8_0._attr == "lockAimBias":
		arg_8_1.UpdateAimBiasSkillState()

def var_0_1.CheckWeapon(arg_9_0):
	if arg_9_0._attr == "loadSpeed":
		return True
	else
		return False

def var_0_1.UpdateAttrMul(arg_10_0, arg_10_1):
	local var_10_0 = 1
	local var_10_1 = 1
	local var_10_2 = {}
	local var_10_3 = {}
	...
	for iter_10_0, iter_10_1 in pairs(var_10_4):
		for iter_10_2, iter_10_3 in ipairs(iter_10_1._effectList):
			if iter_10_3.GetEffectType() == var_0_1.FX_TYPE and iter_10_3.IsSameAttr(arg_10_0._attr):
				...
				if var_10_7 < var_10_5 and var_10_5 > 0:
					var_10_0 = var_10_0 * (1 + var_10_5) / (1 + var_10_7)
					var_10_7 = var_10_5

				if var_10_5 < var_10_8 and var_10_5 < 0:
	...
	if arg_10_0.CheckWeapon():
		arg_10_1.FlushReloadingWeapon()

def var_0_1.UpdateAttrAdd(arg_11_0, arg_11_1):
	...
	for iter_11_0, iter_11_1 in pairs(var_11_2):
		for iter_11_2, iter_11_3 in ipairs(iter_11_1._effectList):
			if iter_11_3.GetEffectType() == var_0_1.FX_TYPE and iter_11_3.IsSameAttr(arg_11_0._attr):
				...
				if var_11_9 < var_11_7 and var_11_7 > 0:
					var_11_3 = var_11_3 + var_11_7 - var_11_9
					var_11_9 = var_11_7

				if var_11_7 < var_11_10 and var_11_7 < 0:
...
def var_0_1.UpdateAttrHybrid(arg_12_0, arg_12_1):
	local var_12_0 = arg_12_1.GetBuffList()
	local var_12_1 = {}
	local var_12_2 = {}

	for iter_12_0, iter_12_1 in pairs(var_12_0):
		for iter_12_2, iter_12_3 in ipairs(iter_12_1._effectList):
			if iter_12_3.GetEffectType() == var_0_1.FX_TYPE and iter_12_3.IsSameAttr(arg_12_0._attr):
