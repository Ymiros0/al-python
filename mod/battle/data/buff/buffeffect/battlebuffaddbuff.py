...
def var_0_3.onUpdate(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	local var_3_0 = arg_3_3.timeStamp

	if var_3_0 >= arg_3_0._nextEffectTime:
		arg_3_0.attachBuff(arg_3_0._buff_id, arg_3_0._level, arg_3_1)

		arg_3_0._nextEffectTime = var_3_0 + arg_3_0._time

def var_0_3.onBulletHit(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
	if not arg_4_0.equipIndexRequire(arg_4_3.equipIndex):
		return

	local var_4_0 = arg_4_3.target

	if (not arg_4_0._weaponType or arg_4_3.weaponType == arg_4_0._weaponType) and var_4_0.IsAlive():
		arg_4_0.attachBuff(arg_4_0._buff_id, arg_4_0._level, var_4_0)

def var_0_3.onBulletCreate(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
...
def var_0_3.onTrigger(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
	var_0_3.super.onTrigger(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	arg_7_0.AddBuff(arg_7_1, arg_7_3)

def var_0_3.AddBuff(arg_8_0, arg_8_1, arg_8_2):
	if not arg_8_0.commanderRequire(arg_8_1, arg_8_0._tempData.arg_list):
		return

	if not arg_8_0.ammoRequire(arg_8_1):
		return
	...
	if arg_8_0._check_target:
		...
		if var_8_0 >= arg_8_0._minTargetNumber and var_8_0 <= arg_8_0._maxTargetNumber:
			...
			for iter_8_0, iter_8_1 in ipairs(var_8_1):
				if arg_8_0._isBuffStackByCheckTarget:
...
def var_0_3.attachBuff(arg_9_0, arg_9_1, arg_9_2, arg_9_3):
	local var_9_0 = var_0_1.GetBuffTemplate(arg_9_1).effect_list
	local var_9_1

	if #var_9_0 == 1 and var_9_0[1].type == "BattleBuffDOT":
		if var_0_2.CaclulateDOTPlace(arg_9_0._rant, var_9_0[1], arg_9_0._caster, arg_9_3):
			var_9_1 = var_0_0.Battle.BattleBuffUnit.New(arg_9_1, None, arg_9_0._caster)

			var_9_1.SetOrb(arg_9_0._caster, 1)
	elif var_0_2.IsHappen(arg_9_0._rant):
