...
def var_0_1.calcEnhancement(arg_5_0, arg_5_1, arg_5_2):
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_1):
		...
		for iter_5_2, iter_5_3 in ipairs(arg_5_0._weaponLabelList):
			if not table.contains(var_5_2, iter_5_3):
				var_5_1 = 0

				break

		if arg_5_0._weaponIndexList:
			local var_5_3 = iter_5_1.GetEquipmentIndex()

			if not table.contains(arg_5_0._weaponIndexList, var_5_3):
				var_5_1 = var_5_1 * 0
