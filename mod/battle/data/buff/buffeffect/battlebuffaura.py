...
def var_0_1.SetArgs(arg_2_0, arg_2_1, arg_2_2):
	...
	arg_2_0._aura = var_0_0.Battle.BattleDataProxy.GetInstance().SpawnLastingColumnArea(var_0_2.AOEField.SURFACE, arg_2_1.GetIFF(), arg_2_1.GetPosition(), arg_2_0._auraRange, 0, var_2_1, var_2_2, arg_2_0._friendly, None, var_2_3, False)
...
def var_0_1.getAreaCldFunc(arg_3_0, arg_3_1):
	local function var_3_0(arg_4_0)
		...
		for iter_4_0, iter_4_1 in ipairs(arg_4_0):
			if iter_4_1.Active:
				for iter_4_2, iter_4_3 in ipairs(var_4_0):
					if iter_4_3.GetUniqueID() == iter_4_1.UID:
	...
	local function var_3_2(arg_6_0)
		if arg_6_0.Active:
			...
			for iter_6_0, iter_6_1 in ipairs(var_6_0):
				if iter_6_1.GetUniqueID() == arg_6_0.UID:
