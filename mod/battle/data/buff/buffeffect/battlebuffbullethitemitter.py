...
def var_0_0.Battle.BattleBuffBulletHitEmitter.Ctor(arg_1_0, arg_1_1):
	var_0_0.Battle.BattleBuffBulletHitEmitter.super.Ctor(arg_1_0, arg_1_1)

def var_0_0.Battle.BattleBuffBulletHitEmitter.SetArgs(arg_2_0, arg_2_1, arg_2_2):
...
def var_0_0.Battle.BattleBuffBulletHitEmitter.onBulletCreate(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	local var_3_0 = arg_3_3._bullet

	if var_0_0.Battle.BattleFormulas.IsHappen(arg_3_0._rate):
