...
def var_0_0.Battle.BattleBuffBulletPierce.Ctor(arg_1_0, arg_1_1):
	var_0_0.Battle.BattleBuffBulletPierce.super.Ctor(arg_1_0, arg_1_1)

def var_0_0.Battle.BattleBuffBulletPierce.SetArgs(arg_2_0, arg_2_1, arg_2_2):
...
def var_0_0.Battle.BattleBuffBulletPierce.onBulletCreate(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	local var_3_0 = arg_3_3._bullet

	if arg_3_0.IsHappen(tonumber(arg_3_0._rate)) and (arg_3_0._bulletType == var_3_0._tempData.type or arg_3_0._bulletType == 0):
