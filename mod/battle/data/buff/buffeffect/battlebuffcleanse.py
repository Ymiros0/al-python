...
def var_0_1.onTrigger(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
	...
	if arg_3_0._check_target:
		local var_3_0 = #arg_3_0.getTargetList(arg_3_1, arg_3_0._check_target, arg_3_0._tempData.arg_list, arg_3_3)

		if var_3_0 >= arg_3_0._minTargetNumber and var_3_0 <= arg_3_0._maxTargetNumber:
			for iter_3_0, iter_3_1 in ipairs(arg_3_0._buffIDList):
				arg_3_1.RemoveBuff(iter_3_1)
	else
		for iter_3_2, iter_3_3 in ipairs(arg_3_0._buffIDList):
