...
def var_0_4.onTakeDamage(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
...
def var_0_4.onRemove(arg_4_0, arg_4_1, arg_4_2):
	local var_4_0 = 0
	local var_4_1
...
def var_0_4.generateBuff(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	return {
		id = arg_5_0,
		icon = arg_5_0,
		time = arg_5_1,
