...
def var_0_0.Battle.BattleBuffLink.Ctor(arg_1_0, arg_1_1):
	var_0_0.Battle.BattleBuffLink.super.Ctor(arg_1_0, arg_1_1)

def var_0_0.Battle.BattleBuffLink.SetArgs(arg_2_0, arg_2_1, arg_2_2):
	arg_2_0._target = arg_2_0._tempData.arg_list.target
	arg_2_0._buff_id = arg_2_0._tempData.arg_list.buff_id

def var_0_0.Battle.BattleBuffLink.Trigger(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4):
