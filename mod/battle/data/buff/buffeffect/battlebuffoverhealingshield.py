...
def var_0_1.onOverHealing(arg_3_0, arg_3_1, arg_3_2, arg_3_3):
...
def var_0_1.onUpdate(arg_4_0, arg_4_1, arg_4_2):
	...
	while var_4_0 > 0:
		if var_4_1 >= arg_4_0._shieldList[var_4_0].timeStamp:
...
def var_0_1.onTakeDamage(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	local var_5_0 = #arg_5_0._shieldList

	if arg_5_0.damageCheck(arg_5_3) and var_5_0 > 0:
		local var_5_1 = arg_5_3.damage
		local var_5_2 = 0

		while var_5_1 > 0 and var_5_2 < var_5_0:
			var_5_2 = var_5_2 + 1
		...
		while var_5_0 > 0:
			if arg_5_0._shieldList[var_5_0].value <= 0:
...
def var_0_1.updateLabelTag(arg_6_0, arg_6_1):
	if #arg_6_0._shieldList <= 0:
		for iter_6_0, iter_6_1 in ipairs(arg_6_0._shieldLabel):
			arg_6_1.RemoveLabelTag(iter_6_1)
	elif not arg_6_1.ContainsLabelTag(arg_6_0._shieldLabel):
		for iter_6_2, iter_6_3 in ipairs(arg_6_0._shieldLabel):
