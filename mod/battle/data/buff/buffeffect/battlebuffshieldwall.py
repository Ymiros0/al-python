...
def var_0_2.onStack(arg_6_0, arg_6_1, arg_6_2):
...
def var_0_2.onWallCld(arg_8_0, arg_8_1):
	if not arg_8_1.GetIgnoreShield() and arg_8_1.GetType() == arg_8_0._bulletType and arg_8_0._count > 0:
		if arg_8_0._doWhenHit == "intercept":
			arg_8_1.Intercepted()
			arg_8_0._dataProxy.RemoveBulletUnit(arg_8_1.GetUniqueID())

			arg_8_0._count = arg_8_0._count - 1
		elif arg_8_0._doWhenHit == "reflect" and arg_8_0.GetIFF() != arg_8_1.GetIFF():
			arg_8_1.Reflected()
...
def var_0_2.IsWallActive(arg_11_0):
	return arg_11_0._count > 0

def var_0_2.Deactive(arg_12_0):
	if arg_12_0._effectIndex:
		local var_12_0 = {
