...
def var_0_0.Battle.BattleBuffSize.Ctor(arg_1_0, arg_1_1):
	var_0_0.Battle.BattleBuffSize.super.Ctor(arg_1_0, arg_1_1)

def var_0_0.Battle.BattleBuffSize.SetArgs(arg_2_0, arg_2_1, arg_2_2):
	arg_2_0._number = arg_2_0._tempData.arg_list.number or 1

def var_0_0.Battle.BattleBuffSize.onAttach(arg_3_0, arg_3_1, arg_3_2):
	local var_3_0 = {
...
def var_0_0.Battle.BattleBuffSize.onRemove(arg_4_0, arg_4_1, arg_4_2):
	local var_4_0 = {
