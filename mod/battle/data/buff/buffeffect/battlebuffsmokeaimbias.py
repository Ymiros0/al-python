...
def var_0_4.SetArgs(arg_2_0, arg_2_1, arg_2_2):
	return

def var_0_4.onAttach(arg_3_0, arg_3_1, arg_3_2):
	var_0_5.SetCurrent(arg_3_1, var_0_4.ATTR_SMOKE, 1)
	var_0_1.AttachSmoke(arg_3_1)

	if BATTLE_ENEMY_AIMBIAS_RANGE:
...
def var_0_4.onUpdate(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
	local var_4_0 = {
...
def var_0_4.onRemove(arg_5_0, arg_5_1, arg_5_2):
	if BATTLE_ENEMY_AIMBIAS_RANGE:
