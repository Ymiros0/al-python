...
def var_0_2.Trigger(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4):
...
def var_0_2.onUpdate(arg_6_0, arg_6_1, arg_6_2):
	arg_6_0.onTrigger(arg_6_1, arg_6_2)

def var_0_2.onStack(arg_7_0, arg_7_1, arg_7_2):
	arg_7_0.onTrigger(arg_7_1, arg_7_2)

def var_0_2.getTargetList(arg_8_0, arg_8_1, arg_8_2, arg_8_3):
	local var_8_0
...
def var_0_2.IsActive(arg_9_0):
	return arg_9_0._isActive

def var_0_2.SetActive(arg_10_0):
	arg_10_0._isActive = True

def var_0_2.NotActive(arg_11_0):
	arg_11_0._isActive = False

def var_0_2.Clear(arg_12_0):
	return

def var_0_2.Dispose(arg_13_0):
	return
