...
def var_0_7.SetTemplateData(arg_2_0, arg_2_1):
...
def var_0_7.GetPierceCount(arg_3_0):
	return 1

def var_0_7.RegisterOnTheAir(arg_4_0, arg_4_1):
	arg_4_0._onTheHighest = arg_4_1

def var_0_7.SetExplodePosition(arg_5_0, arg_5_1):
	arg_5_0._explodePos = arg_5_1.Clone()
	arg_5_0._explodePos.y = var_0_1.BombDetonateHeight

def var_0_7.GetExplodePostion(arg_6_0):
	return arg_6_0._explodePos

local var_0_8 = 1 / var_0_6.viewFPS

def var_0_7.SetSpawnPosition(arg_7_0, arg_7_1):
	var_0_7.super.SetSpawnPosition(arg_7_0, arg_7_1)

	arg_7_0._verticalSpeed = arg_7_0.GetTemplate().extra_param.launchVrtSpeed

def var_0_7.Update(arg_8_0, arg_8_1):
	var_0_7.super.Update(arg_8_0, arg_8_1)

	if arg_8_0._state == arg_8_0.STATE_LAUNCH and arg_8_1 > arg_8_0.GetTemplate().extra_param.launchRiseTime + arg_8_0._timeStamp:
		arg_8_0.CompleteRise()

def var_0_7.CompleteRise(arg_9_0):
	arg_9_0._state = arg_9_0.STATE_ATTACK
	arg_9_0._gravity = 0

	if arg_9_0._onTheHighest:
...
def var_0_7.GetMissileTargetPosition(arg_12_0):
	if arg_12_0._targetType == var_0_7.TYPE_RANGE:
		return arg_12_0.aimRange()
	elif arg_12_0._targetType == var_0_7.TYPE_COORD:
		return arg_12_0.aimCoord()
	elif arg_12_0._targetType == var_0_7.TYPE_TARGET:
		return arg_12_0.aimTarget()

def var_0_7.aimRange(arg_13_0):
...
def var_0_7.aimTarget(arg_15_0):
