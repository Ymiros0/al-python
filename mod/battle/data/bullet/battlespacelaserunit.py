...
def var_0_3.ExecuteLifeEndCallback(arg_3_0):
	if arg_3_0._lifeEndCb:
		arg_3_0._lifeEndCb()

def var_0_3.AssertFields(arg_4_0, arg_4_1):
	assert(arg_4_0[arg_4_1], "Lack Field " .. arg_4_1)

def var_0_3.SetTemplateData(arg_5_0, arg_5_1):
...
def var_0_3.GetHitInterval(arg_6_0):
	return arg_6_0._hitInterval

def var_0_3.DoTrack(arg_7_0):
...
def var_0_3.SetLifeTime(arg_9_0, arg_9_1):
	arg_9_0._lifeTime = arg_9_1

def var_0_3.SetAlert(arg_10_0, arg_10_1):
...
def var_0_3.IsAlert(arg_11_0):
	return arg_11_0._alertFlag

def var_0_3.Update(arg_12_0, arg_12_1):
...
def var_0_3.GetCollidedList(arg_13_0):
	return arg_13_0._collidedList, arg_13_0._collidedTimes

def var_0_3.RegisterLifeEndCB(arg_14_0, arg_14_1):
	arg_14_0._lifeEndCb = arg_14_1

def var_0_3.UnRegisterLifeEndCB(arg_15_0):
