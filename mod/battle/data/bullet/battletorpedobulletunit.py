...
def var_0_2.GetExplodePostion(arg_3_0):
	return arg_3_0._explodePos

def var_0_2.SetExplodePosition(arg_4_0, arg_4_1):
	arg_4_0._explodePos = arg_4_1

def var_0_2.InitCldComponent(arg_5_0):
	var_0_2.super.InitCldComponent(arg_5_0)
	arg_5_0.ResetCldSurface()

def var_0_2.Hit(arg_6_0, arg_6_1, arg_6_2):
