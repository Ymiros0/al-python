...
def var_0_3.SetReferencePoint(arg_2_0, arg_2_1):
	arg_2_0._currentReferencePoint = arg_2_1

def var_0_3.ChangeState(arg_3_0, arg_3_1):
...
def var_0_3.Update(arg_4_0):
	...
	if arg_4_0._currentState.IsFinish(arg_4_0):
		if arg_4_0._currentState == arg_4_0._moveToState:
			arg_4_0._callback()
