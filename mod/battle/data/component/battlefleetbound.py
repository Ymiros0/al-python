...
def var_0_2.GetAbsoluteRight(arg_4_0):
	return arg_4_0._absoluteRight

def var_0_2.ConfigAreaData(arg_5_0, arg_5_1, arg_5_2):
...
def var_0_2.SwtichCommon(arg_6_0):
	if arg_6_0._iff == var_0_1.FRIENDLY_CODE:
	...
	elif arg_6_0._iff == var_0_1.FOE_CODE:
...
def var_0_2.SwtichDuelAggressive(arg_7_0):
	if arg_7_0._iff == var_0_1.FRIENDLY_CODE:
	...
	elif arg_7_0._iff == var_0_1.FOE_CODE:
...
def var_0_2.SwtichDBRGL(arg_8_0):
	if arg_8_0._iff == var_0_1.FRIENDLY_CODE:
	...
	elif arg_8_0._iff == var_0_1.FOE_CODE:
...
def var_0_2.FixCardPuzzleInput(arg_9_0, arg_9_1):
