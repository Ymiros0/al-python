...
def var_0_4.ConfigCallback(arg_2_0, arg_2_1):
	arg_2_0._callback = arg_2_1

def var_0_4.GetUniqueID(arg_3_0):
	return arg_3_0._uid

def var_0_4.SetTemplate(arg_4_0, arg_4_1):
	arg_4_0._template = arg_4_1

	arg_4_0.initBehaviours()

def var_0_4.SetAOEData(arg_5_0, arg_5_1):
	arg_5_0._expireTimeStamp = pg.TimeMgr.GetInstance().GetCombatTime() + arg_5_0._template.life_time
	arg_5_0._aoeData = arg_5_1

def var_0_4.GetAOEData(arg_6_0):
	return arg_6_0._aoeData

def var_0_4.GetBehaviours(arg_7_0):
	return arg_7_0._behaviours

def var_0_4.GetTemplate(arg_8_0):
	return arg_8_0._template

def var_0_4.UpdateFrequentlyCollide(arg_9_0, arg_9_1):
	for iter_9_0, iter_9_1 in ipairs(arg_9_0._behaviours):
		iter_9_1.UpdateCollideUnitList(arg_9_1)

def var_0_4.Update(arg_10_0):
	for iter_10_0, iter_10_1 in ipairs(arg_10_0._behaviours):
		iter_10_1.OnUpdate()

def var_0_4.IsExpire(arg_11_0, arg_11_1):
	return arg_11_1 > arg_11_0._expireTimeStamp

def var_0_4.Dispose(arg_12_0):
	if arg_12_0._callback:
		arg_12_0._callback()

	for iter_12_0, iter_12_1 in ipairs(arg_12_0._behaviours):
		iter_12_1.Dispose()

def var_0_4.initBehaviours(arg_13_0):
