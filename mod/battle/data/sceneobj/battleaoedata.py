...
def var_0_2.StartTimer(arg_2_0):
	if arg_2_0._lifeTime == -1:
		arg_2_0._flag = False
...
def var_0_2.SetOpponentAffected(arg_13_0, arg_13_1):
	arg_13_0._opponentAffected = arg_13_1

def var_0_2.OpponentAffected(arg_14_0):
	return arg_14_0._opponentAffected

def var_0_2.SetIndiscriminate(arg_15_0, arg_15_1):
	arg_15_0._indicriminate = arg_15_1

def var_0_2.GetIndiscriminate(arg_16_0):
	return arg_16_0._indicriminate

def var_0_2.GetActiveFlag(arg_17_0):
	return arg_17_0._flag

def var_0_2.SetActiveFlag(arg_18_0, arg_18_1):
	arg_18_0._flag = arg_18_1

def var_0_2.Dispose(arg_19_0):
	for iter_19_0, iter_19_1 in ipairs(arg_19_0._component):
		iter_19_1.Dispose()

	arg_19_0._component = None

	arg_19_0.RemoveTimer()

	arg_19_0._cldObjList = None

def var_0_2.GetUniqueID(arg_20_0):
	return arg_20_0._areaUniqueID

def var_0_2.GetIFF(arg_21_0):
	return arg_21_0._IFF

def var_0_2.GetAreaType(arg_22_0):
	return arg_22_0._areaType

def var_0_2.GetPosition(arg_23_0):
	return arg_23_0._pos

def var_0_2.GetTickness(arg_24_0):
	return arg_24_0._tickness

def var_0_2.GetLifeTime(arg_25_0):
	return arg_25_0._lifeTime

def var_0_2.GetFieldType(arg_26_0):
	return arg_26_0._fieldType

def var_0_2.GetDiveFilter(arg_27_0):
	return arg_27_0._diveFilter

def var_0_2.GetCldFunc(arg_28_0):
	return arg_28_0._areaCldFunc

def var_0_2.GetHeight(arg_29_0):
	return arg_29_0._height

def var_0_2.GetWidth(arg_30_0):
	return arg_30_0._width

def var_0_2.GetAngle(arg_31_0):
	return arg_31_0._angle

def var_0_2.GetRange(arg_32_0):
	return arg_32_0._range

def var_0_2.GetSectorAngle(arg_33_0):
	return arg_33_0._sectorAngle

def var_0_2.SetAreaType(arg_34_0, arg_34_1):
	arg_34_0._areaType = arg_34_1

	arg_34_0.InitCldComponent()

def var_0_2.SetDiveFilter(arg_35_0, arg_35_1):
	arg_35_0._diveFilter = arg_35_1

def var_0_2.SetPosition(arg_36_0, arg_36_1):
	arg_36_0._pos = arg_36_1

def var_0_2.SetTickness(arg_37_0, arg_37_1):
	arg_37_0._tickness = arg_37_1

def var_0_2.SetFieldType(arg_38_0, arg_38_1):
	arg_38_0._fieldType = arg_38_1

def var_0_2.SetLifeTime(arg_39_0, arg_39_1):
	arg_39_0._lifeTime = arg_39_1

def var_0_2.SetHeight(arg_40_0, arg_40_1):
	arg_40_0._height = arg_40_1

def var_0_2.SetWidth(arg_41_0, arg_41_1):
	arg_41_0._width = arg_41_1

def var_0_2.SetAngle(arg_42_0, arg_42_1):
	arg_42_0._angle = arg_42_1

def var_0_2.SetRange(arg_43_0, arg_43_1):
	arg_43_0._range = arg_43_1

def var_0_2.SetSectorAngle(arg_44_0, arg_44_1, arg_44_2):
	...
	if arg_44_2 == var_0_1.UnitDir.LEFT:
		arg_44_0._normalizeOffset = math.pi - var_44_1
	elif arg_44_2 == var_0_1.UnitDir.RIGHT:
...
def var_0_2.SetAnchorPointAlignment(arg_45_0, arg_45_1):
	if arg_45_1 == var_0_2.ALIGNMENT_LEFT:
		arg_45_0._alignment = Vector3(arg_45_0._width * 0.5, 0, 0)
	elif arg_45_1 == var_0_2.ALIGNMENT_RIGHT:
		arg_45_0._alignment = Vector3(arg_45_0._width * -0.5, 0, 0)

def var_0_2.GetAnchorPointAlignment(arg_46_0):
	return arg_46_0._alignment

def var_0_2.GetFXStatic(arg_47_0):
	return arg_47_0._fxStatic

def var_0_2.SetFXStatic(arg_48_0, arg_48_1):
	arg_48_0._fxStatic = arg_48_1

def var_0_2.AppendComponent(arg_49_0, arg_49_1):
	table.insert(arg_49_0._component, arg_49_1)

def var_0_2.InitCldComponent(arg_50_0):
	if arg_50_0._areaType == var_0_1.AreaType.CUBE:
		arg_50_0._cldComponent = var_0_0.Battle.BattleCubeCldComponent.New(arg_50_0._width, arg_50_0._tickness, arg_50_0._height, 0, 0)
	elif arg_50_0._areaType == var_0_1.AreaType.COLUMN:
...
def var_0_2.GetCldComponent(arg_51_0):
	return arg_51_0._cldComponent

def var_0_2.DeactiveCldBox(arg_52_0):
	arg_52_0._cldComponent.SetActive(False)

def var_0_2.GetCldBox(arg_53_0):
	return arg_53_0._cldComponent.GetCldBox(arg_53_0.GetPosition() + arg_53_0._alignment)

def var_0_2.GetCldData(arg_54_0):
	return arg_54_0._cldComponent.GetCldData()

def var_0_2.UpdateDistanceInfo(arg_55_0):
	for iter_55_0, iter_55_1 in ipairs(arg_55_0._cldObjList):
		local var_55_0
		...
		if var_55_1 <= var_55_5 and var_55_5 <= var_55_2:
			var_55_6 = True
		elif var_55_5 < var_55_1:
			var_55_7 = var_55_1
		elif var_55_2 < var_55_5:
			var_55_7 = var_55_2
		...
		if var_55_4 <= var_55_8 and var_55_8 <= var_55_3:
			var_55_9 = True
		elif var_55_8 < var_55_4:
			var_55_10 = var_55_4
		elif var_55_3 < var_55_8:
			var_55_10 = var_55_3

		if var_55_6 and var_55_9:
			var_55_0 = 0
		elif var_55_6:
