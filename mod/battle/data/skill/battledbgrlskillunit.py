...
def var_0_3.SetTarget(arg_5_0, arg_5_1):
	arg_5_0._lastEffectTarget = arg_5_1

def var_0_3.Interrupt(arg_6_0):
	for iter_6_0, iter_6_1 in ipairs(arg_6_0._effectList):
		iter_6_1.Interrupt()
...
def var_0_3.GetDamageSum(arg_8_0):
	local var_8_0 = 0
...
def var_0_3.IsFireSkill(arg_9_0, arg_9_1):
	local var_9_0 = False
	local var_9_1 = var_0_0.Battle.BattleDataFunction.GetSkillTemplate(arg_9_0, arg_9_1)

	for iter_9_0, iter_9_1 in ipairs(var_9_1.effect_list):
		if iter_9_1.type == var_0_0.Battle.BattleSkillFire.__name or iter_9_1.type == var_0_0.Battle.BattleSkillFireSupport.__name:
			var_9_0 = True
