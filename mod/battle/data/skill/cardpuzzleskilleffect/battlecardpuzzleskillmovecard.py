...
def var_0_2.MoveCardAfterCast(arg_2_0):
	if arg_2_0._moveID or arg_2_0._moveLabel:
		return var_0_2.super.MoveCardAfterCast(arg_2_0)
	else
		return arg_2_0._moveTo

def var_0_2.SkillEffectHandler(arg_3_0):
	...
	if arg_3_0._moveID:
		...
		for iter_3_2, iter_3_3 in ipairs(var_3_6):
			var_3_1[arg_3_0._moveOP](var_3_1, iter_3_3)
			var_3_2.Remove(iter_3_3, arg_3_0._moveTo)
	elif arg_3_0._moveOther:
		local var_3_7 = var_3_2.GetCardList()

		for iter_3_4, iter_3_5 in ipairs(var_3_7):
			if iter_3_5 != arg_3_0._card:
