...
def var_0_1.GetIndex(arg_3_0):
	return arg_3_0._index

def var_0_1.GetToIndex(arg_4_0):
	return arg_4_0._toIndex

def var_0_1.Active(arg_5_0, arg_5_1):
	arg_5_0._startTime = pg.TimeMgr.GetInstance().GetCombatTime()

def var_0_1.IsExpired(arg_6_0):
	if arg_6_0._duration > 0 and pg.TimeMgr.GetInstance().GetCombatTime() - arg_6_0._startTime > arg_6_0._duration:
		return True
	else
		return False

def var_0_1.GetDirection(arg_7_0, arg_7_1):
	return

def var_0_1.Finish(arg_8_0):
