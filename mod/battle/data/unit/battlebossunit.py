...
def var_0_7.IsBoss(arg_2_0):
	return True

def var_0_7.BarrierStateChange(arg_3_0, arg_3_1, arg_3_2):
	local var_3_0 = {
...
def var_0_7.UpdateHP(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4):
	local var_4_0 = var_0_7.super.UpdateHP(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4) or 0

	if var_4_0 < 0:
		for iter_4_0, iter_4_1 in ipairs(arg_4_0._autoWeaponList):
