...
def var_0_8.IsShowHPBar(arg_6_0):
	return False

def var_0_8.GetMaster(arg_7_0):
	return arg_7_0._master

def var_0_8.DispatchVoice(arg_8_0):
	return

def var_0_8.Retreat(arg_9_0):
