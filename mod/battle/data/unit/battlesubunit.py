...
def var_0_7.setWeapon(arg_2_0, arg_2_1):
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1):
		if iter_2_0 > Ship.WEAPON_COUNT and iter_2_1:
			var_2_4 = var_2_4 + iter_2_1.torpedoAmmo

	local var_2_5 = {}

	for iter_2_2, iter_2_3 in ipairs(arg_2_1):
		if iter_2_3 and iter_2_3.skin and iter_2_3.skin != 0 and Equipment.IsOrbitSkin(iter_2_3.skin):
			arg_2_0._orbitSkinIDList = arg_2_0._orbitSkinIDList or {}

			table.insert(arg_2_0._orbitSkinIDList, iter_2_3.skin)

		if iter_2_2 <= Ship.WEAPON_COUNT:
			...
			local function var_2_7(arg_3_0, arg_3_1, arg_3_2)
				...
				if var_3_0.type == var_0_4.EquipmentType.TORPEDO:
	...
	repeat
		...
		for iter_2_6, iter_2_7 in ipairs(var_2_5):
			if iter_2_7.ammo <= 0 and var_2_4 > 0:
...
def var_0_7.AddDisposableTorpedo(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5):
