...
def var_0_11.init(arg_2_0):
	arg_2_0._buffAttr = {}
	arg_2_0._attrList = {}
	arg_2_0._clampList = {}

def var_0_11.AddBaseAttr(arg_3_0, arg_3_1, arg_3_2):
...
def var_0_11.SetAttr(arg_4_0, arg_4_1, arg_4_2):
...
def var_0_11.specificAttrUpdate(arg_5_0, arg_5_1):
	if arg_5_1 == "BaseEnergyBoostRate" or arg_5_1 == "BaseEnergyBoostExtra":
		arg_5_0._client.FlushHandOverheat()

def var_0_11.checkClamp(arg_6_0, arg_6_1):
	if arg_6_0._attrList[arg_6_1] == None:
		return
...
def var_0_11.GetCurrent(arg_7_0, arg_7_1):
