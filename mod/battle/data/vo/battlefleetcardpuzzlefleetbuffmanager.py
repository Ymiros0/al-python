...
def var_0_10.Trigger(arg_2_0, arg_2_1, arg_2_2):
	local var_2_0 = {}

	for iter_2_0, iter_2_1 in pairs(arg_2_0._buffList):
		if iter_2_1.IsResponTo(arg_2_1):
			table.insert(var_2_0, iter_2_1)

	for iter_2_2, iter_2_3 in ipairs(var_2_0):
		iter_2_3.onTrigger(arg_2_1, arg_2_2)

def var_0_10.Update(arg_3_0, arg_3_1):
	local var_3_0 = arg_3_0._buffList

	for iter_3_0, iter_3_1 in pairs(var_3_0):
		iter_3_1.Update(arg_3_1)

def var_0_10.AttachCardPuzzleBuff(arg_4_0, arg_4_1):
...
def var_0_10.GetCardPuzzleBuff(arg_5_0, arg_5_1):
	return arg_5_0._buffList[arg_5_1]

def var_0_10.GetCardPuzzleBuffList(arg_6_0):
	return arg_6_0._buffList

def var_0_10.init(arg_7_0):
	arg_7_0._buffList = {}
