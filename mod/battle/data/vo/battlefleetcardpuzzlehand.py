...
def var_0_12.Ctor(arg_1_0, arg_1_1, arg_1_2):
	arg_1_0._cardPuzzleComponent = arg_1_1
	arg_1_0._indexID = arg_1_2

	arg_1_0.init()

def var_0_12.GetIndexID(arg_2_0):
	return arg_2_0._indexID

def var_0_12.EnterCoolDownByType(arg_3_0, arg_3_1, arg_3_2):
	if arg_3_2 > 0:
...
def var_0_12.Add(arg_4_0, arg_4_1):
...
def var_0_12.Update(arg_5_0, arg_5_1):
	for iter_5_0, iter_5_1 in pairs(arg_5_0._typeCDTimeStampList):
		if iter_5_1 < arg_5_1:
			arg_5_0._typeCDTimeStampList[iter_5_0] = -1

def var_0_12.Dispose(arg_6_0):
	return

def var_0_12.GetCardList(arg_7_0):
	return arg_7_0._handCardList

def var_0_12.IsFull(arg_8_0):
	return arg_8_0.GetLength() >= var_0_7.BASE_MAX_HAND + arg_8_0._attrManager.GetCurrent("HandExtra")

def var_0_12.init(arg_9_0):
	...
	for iter_9_0, iter_9_1 in pairs(CardPuzzleCard.CARD_TYPE):
