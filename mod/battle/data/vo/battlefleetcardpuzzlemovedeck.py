...
def var_0_11.Ctor(arg_1_0, arg_1_1, arg_1_2):
...
def var_0_11.GetIndexID(arg_3_0):
	return arg_3_0._indexID

def var_0_11.Dispose(arg_4_0):
	return

def var_0_11.GetCardList(arg_5_0):
	return arg_5_0._moveCardList

def var_0_11.Update(arg_6_0, arg_6_1):
	arg_6_0.update(arg_6_1)

def var_0_11.init(arg_7_0):
...
def var_0_11.updateTimeStamp(arg_8_0):
	arg_8_0._lastUpdateTimeStamp = pg.TimeMgr.GetInstance().GetCombatTime()

def var_0_11.update(arg_9_0, arg_9_1):
	if arg_9_0.GetLength() < arg_9_0._maxMoveCard + arg_9_0._attrManager.GetCurrent("MoveExtra"):
...
def var_0_11.GetGeneratePorcess(arg_10_0):
	return arg_10_0._generating

def var_0_11.TryPlayTopMoveCard(arg_11_0):
	local var_11_0 = arg_11_0.GetLength()

	if var_11_0 > 0:
		return arg_11_0.GetCardList()[var_11_0]

def var_0_11.RestartGenrate(arg_12_0):
