...
def var_0_6.UpdateMotion(arg_2_0):
...
def var_0_6.IsFatalDamage(arg_3_0):
	return arg_3_0._count == 0

def var_0_6.AppendUnit(arg_4_0, arg_4_1):
...
def var_0_6.RemoveUnit(arg_5_0, arg_5_1):
	local var_5_0 = 0

	for iter_5_0, iter_5_1 in ipairs(arg_5_0._enemyList):
		if iter_5_1 == arg_5_1:
			var_5_0 = iter_5_0
...
def var_0_6.refreshTeamFormation(arg_7_0):
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0._enemyList):
		if iter_7_0 == 1:
...
def var_0_6.Dispose(arg_8_0):
	arg_8_0._enemyList = None
	arg_8_0._motionReferenceUnit = None
	arg_8_0._motionVO = None
