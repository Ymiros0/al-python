...
def var_0_5.UpdateCloakConfig(arg_3_0):
...
def var_0_5.SetRecoverySpeed(arg_4_0, arg_4_1):
	arg_4_0._fieldRecoveryOverride = arg_4_1

def var_0_5.AppendExpose(arg_5_0, arg_5_1):
...
def var_0_5.AppendStrikeExpose(arg_6_0):
...
def var_0_5.AppendBombardExpose(arg_7_0):
...
def var_0_5.AppendExposeSpeed(arg_8_0, arg_8_1):
	arg_8_0._exposeSpeed = arg_8_1

def var_0_5.ForceToMax(arg_9_0):
	arg_9_0.ForceToRate(1)

def var_0_5.ForceToRate(arg_10_0, arg_10_1):
	arg_10_0._cloakValue = math.floor(arg_10_1 * arg_10_0._exposeValue)

	arg_10_0.UpdateCloakState()

def var_0_5.UpdateDotExpose(arg_11_0, arg_11_1):
	if arg_11_1 != arg_11_0._cloakBottom:
		arg_11_0._cloakBottom = arg_11_1

		arg_11_0._client.DispatchEvent(var_0_0.Event.New(var_0_1.UPDATE_CLOAK_LOCK))

def var_0_5.UpdateTauntExpose(arg_12_0, arg_12_1):
	if arg_12_1:
		arg_12_0._tauntCloakBottom = arg_12_0._restoreValue
	else
		arg_12_0._tauntCloakBottom = None

def var_0_5.UpdateCloakState(arg_13_0):
	local var_13_0

	if arg_13_0._cloakValue >= arg_13_0._exposeValue:
		var_13_0 = var_0_5.STATE_UNCLOAK
	elif arg_13_0._cloakValue < arg_13_0._restoreValue:
		var_13_0 = var_0_5.STATE_CLOAK

	if var_13_0 and var_13_0 != arg_13_0._currentState:
		arg_13_0._currentState = var_13_0

		if arg_13_0._currentState == var_0_5.STATE_UNCLOAK:
			var_0_4.Uncloak(arg_13_0._client)
			arg_13_0.triggerBuff()
		elif arg_13_0._currentState == var_0_5.STATE_CLOAK:
			var_0_4.Cloak(arg_13_0._client)
			arg_13_0.triggerBuff()

def var_0_5.GetCloakValue(arg_14_0):
	return arg_14_0._cloakValue

def var_0_5.GetCloakMax(arg_15_0):
	return arg_15_0._exposeValue

def var_0_5.GetCloakLockMin(arg_16_0):
	return arg_16_0._fireLockValue

def var_0_5.GetCloakRestoreValue(arg_17_0):
	return arg_17_0._restoreValue

def var_0_5.GetCloakBottom(arg_18_0):
	if arg_18_0._tauntCloakBottom:
		return math.max(arg_18_0._tauntCloakBottom, arg_18_0._cloakBottom)
	else
		return arg_18_0._cloakBottom

def var_0_5.GetCurrentState(arg_19_0):
	return arg_19_0._currentState

def var_0_5.GetExposeSpeed(arg_20_0):
	return arg_20_0._exposeSpeed

def var_0_5.updateCloakValue(arg_21_0, arg_21_1):
...
def var_0_5.initCloak(arg_22_0):
