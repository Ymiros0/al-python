...
def var_0_3.Input(arg_3_0, arg_3_1, arg_3_2):
	var_0_3.super.Input(arg_3_0, arg_3_1, arg_3_2)
	arg_3_0.shiftTick(0, 10)

local var_0_4 = Vector3.up

def var_0_3._moveTick(arg_4_0):
	if arg_4_0._moveCount <= 0:
		arg_4_0.shiftTick(-1)
	else
