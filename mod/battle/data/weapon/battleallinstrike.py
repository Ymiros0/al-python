...
def var_0_6.Update(arg_2_0):
	arg_2_0.UpdateReload()

def var_0_6.UpdateReload(arg_3_0):
	if arg_3_0._CDstartTime and not arg_3_0._jammingStartTime:
		if arg_3_0.GetReloadFinishTimeStamp() <= pg.TimeMgr.GetInstance().GetCombatTime():
			arg_3_0.handleCoolDown()
		else
			return

def var_0_6.Clear(arg_4_0):
	arg_4_0._skill.Clear()

def var_0_6.Dispose(arg_5_0):
	var_0_0.EventDispatcher.DetachEventDispatcher(arg_5_0)

def var_0_6.SetHost(arg_6_0, arg_6_1):
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_0._hiveList):
...
def var_0_6.AppendReloadFactor(arg_9_0, arg_9_1, arg_9_2):
	arg_9_0._reloadFacotrList[arg_9_1] = arg_9_2

def var_0_6.RemoveReloadFactor(arg_10_0, arg_10_1):
	if arg_10_0._reloadFacotrList[arg_10_1]:
		arg_10_0._reloadFacotrList[arg_10_1] = None

def var_0_6.GetReloadFactorList(arg_11_0):
	return arg_11_0._reloadFacotrList

def var_0_6.SetAllInWeaponVO(arg_12_0, arg_12_1):
	arg_12_0._allInWeaponVo = arg_12_1
	arg_12_0._currentState = var_0_6.STATE_READY

def var_0_6.GetCurrentState(arg_13_0):
	return arg_13_0._currentState

def var_0_6.GetHost(arg_14_0):
	return arg_14_0._host

def var_0_6.GetType(arg_15_0):
	return var_0_1.EquipmentType.AIR_ASSIST

def var_0_6.Fire(arg_16_0):
	arg_16_0._host.TriggerBuff(var_0_0.Battle.BattleConst.BuffEffectType.ON_ALL_IN_STRIKE_STEADY, {})

	for iter_16_0, iter_16_1 in ipairs(arg_16_0._hiveList):
...
def var_0_6.TriggerBuffOnReady(arg_17_0):
	arg_17_0._host.TriggerBuff(var_0_0.Battle.BattleConst.BuffEffectType.ON_AIR_ASSIST_READY, {})

def var_0_6.SingleFire(arg_18_0):
	for iter_18_0, iter_18_1 in ipairs(arg_18_0._hiveList):
...
def var_0_6.GetReloadTime(arg_19_0):
	local var_19_0 = var_0_5.GetCurrent(arg_19_0._host, "loadSpeed")

	if arg_19_0._reloadMax != arg_19_0._cacheReloadMax or var_19_0 != arg_19_0._cacheHostReload:
...
def var_0_6.GetReloadTimeByRate(arg_20_0, arg_20_1):
...
def var_0_6.SetModifyInitialCD(arg_21_0):
	arg_21_0._modInitCD = True

def var_0_6.GetModifyInitialCD(arg_22_0):
	return arg_22_0._modInitCD

def var_0_6.InitialCD(arg_23_0):
...
def var_0_6.GetCDStartTimeStamp(arg_27_0):
	return arg_27_0._CDstartTime

def var_0_6.handleCoolDown(arg_28_0):
	...
	arg_28_0._CDstartTime = None
	arg_28_0._jammingTime = 0
	arg_28_0._reloadBoostList = {}

def var_0_6.FlushReloadRequire(arg_29_0):
	if not arg_29_0._CDstartTime or arg_29_0._reloadRequire == 0:
		return True
...
def var_0_6.QuickCoolDown(arg_30_0):
	if arg_30_0._currentState == arg_30_0.STATE_OVER_HEAT:
		...
		arg_30_0._CDstartTime = None
		arg_30_0._reloadBoostList = {}

def var_0_6.ReloadBoost(arg_31_0, arg_31_1):
	local var_31_0 = 0

	for iter_31_0, iter_31_1 in ipairs(arg_31_0._reloadBoostList):
...
def var_0_6.GetReloadRate(arg_38_0):
	if arg_38_0._currentState == arg_38_0.STATE_READY:
		return 0
	elif arg_38_0._CDstartTime:
		return (arg_38_0.GetReloadFinishTimeStamp() - pg.TimeMgr.GetInstance().GetCombatTime()) / arg_38_0._reloadRequire
	else
		return 1

def var_0_6.GetDamageSUM(arg_39_0):
	local var_39_0 = 0
	local var_39_1 = 0

	for iter_39_0, iter_39_1 in ipairs(arg_39_0._hiveList):
		for iter_39_2, iter_39_3 in ipairs(iter_39_1.GetATKAircraftList()):
			local var_39_2 = iter_39_3.GetWeapon()

			for iter_39_4, iter_39_5 in ipairs(var_39_2):
				var_39_0 = var_39_0 + iter_39_5.GetDamageSUM()

	local var_39_3 = arg_39_0._skill.GetSkillEffectList()

	for iter_39_6, iter_39_7 in ipairs(var_39_3):
...
def var_0_6.GetStrikeSkillID(arg_40_0):
