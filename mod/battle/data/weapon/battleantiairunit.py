...
def var_0_1.FilterTarget(arg_3_0):
	...
	for iter_3_0, iter_3_1 in pairs(var_3_0):
		if iter_3_1.GetIFF() != var_3_2 and iter_3_1.IsVisitable():
			var_3_1[var_3_3] = iter_3_1
			var_3_3 = var_3_3 + 1

	return var_3_1

def var_0_1.Spawn(arg_4_0, arg_4_1, arg_4_2):
...
def var_0_1.TriggerBuffWhenSpawn(arg_5_0, arg_5_1):
	local var_5_0 = {
		_bullet = arg_5_1,
