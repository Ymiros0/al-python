...
def var_0_10.AppendCrewUnit(arg_3_0, arg_3_1):
...
def var_0_10.RemoveCrewUnit(arg_4_0, arg_4_1):
	if arg_4_0._crewUnitList[arg_4_1]:
		if arg_4_1 == arg_4_0._host:
...
def var_0_10.FlushCrewUnit(arg_5_0, arg_5_1):
...
def var_0_10.Spawn(arg_6_0, arg_6_1, arg_6_2):
	local var_6_0
...
def var_0_10.getAimPoint(arg_7_0, arg_7_1):
	local var_7_0
...
def var_0_10.GetCrewUnitList(arg_8_0):
	return arg_8_0._crewUnitList

def var_0_10.GetRange(arg_9_0):
	return arg_9_0._range

def var_0_10.GetAttackAngle(arg_10_0):
	return arg_10_0._aimAngle

def var_0_10.GetReloadTime(arg_11_0):
	return arg_11_0._interval

def var_0_10.flush(arg_12_0):
	arg_12_0._range = 0
...
def var_0_10.DoAreaSplit(arg_13_0, arg_13_1):
	local function var_13_0(arg_14_0)
		...
		for iter_14_0, iter_14_1 in ipairs(arg_14_0):
			if iter_14_1.Active:
				...
				if var_14_2 and var_14_2.IsVisitable():
		...
		for iter_14_2, iter_14_3 in ipairs(var_14_0):
	...
	for iter_13_0, iter_13_1 in pairs(arg_13_0._crewUnitList):
	...
	for iter_13_2, iter_13_3 in pairs(arg_13_0._hitFXResIDList):
...
def var_0_10.SwitchHost(arg_15_0):
	local var_15_0 = {}

	for iter_15_0, iter_15_1 in pairs(arg_15_0._crewUnitList):
...
def var_0_10.FilterTarget(arg_18_0):
	...
	for iter_18_0, iter_18_1 in pairs(var_18_0):
		if iter_18_1.GetIFF() != var_18_2 and iter_18_1.IsVisitable():
			var_18_1[var_18_3] = iter_18_1
			var_18_3 = var_18_3 + 1

	return var_18_1

def var_0_10.Update(arg_19_0):
	if arg_19_0._currentState != var_0_10.STATE_DISABLE:
		var_0_10.super.Update(arg_19_0)

def var_0_10.RemovePrecastTimer(arg_20_0):
	return

def var_0_10.Dispose(arg_21_0):
	var_0_10.super.Dispose(arg_21_0)

	arg_21_0._crewUnitList = None
	arg_21_0._weightList = None
