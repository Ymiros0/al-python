...
def var_0_9.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3):
	arg_1_0._fleetVO = arg_1_1
	arg_1_0._range = 180
	arg_1_0._duration = arg_1_3

def var_0_9.SwitchHost(arg_2_0, arg_2_1):
	arg_2_0._host = arg_2_1

def var_0_9.Detect(arg_3_0):
...
def var_0_9.Update(arg_4_0, arg_4_1):
	if arg_4_1 > arg_4_0._snoarStartTime + arg_4_0._duration:
		arg_4_0._detectedList = None

		arg_4_0._fleetVO.RemoveIndieSonar(arg_4_0)

def var_0_9.FilterTarget(arg_5_0):
