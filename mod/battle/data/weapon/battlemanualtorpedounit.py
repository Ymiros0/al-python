...
def var_0_2.createMajorEmitter(arg_2_0, arg_2_1, arg_2_2):
	local function var_2_0(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
		local var_3_0 = arg_2_0._emitBulletIDList[arg_2_2]
		local var_3_1 = arg_2_0.Spawn(var_3_0, None, var_0_2.INTERNAL)

		var_3_1.SetOffsetPriority(arg_3_3)
		var_3_1.SetShiftInfo(arg_3_0, arg_3_1)
		var_3_1.SetRotateInfo(None, arg_2_0._botAutoAimAngle, arg_3_2)
	...
	var_0_2.super.createMajorEmitter(arg_2_0, arg_2_1, arg_2_2, None, var_2_0, var_2_1)

def var_0_2.Update(arg_5_0):
	arg_5_0.UpdateReload()

def var_0_2.SetPlayerTorpedoWeaponVO(arg_6_0, arg_6_1):
	arg_6_0._playerTorpedoVO = arg_6_1

def var_0_2.TriggerBuffOnReady(arg_7_0):
	arg_7_0._host.TriggerBuff(var_0_0.Battle.BattleConst.BuffEffectType.ON_MANUAL_TORPEDO_READY, {})

def var_0_2.Fire(arg_8_0, arg_8_1):
	if arg_8_1:
		arg_8_0.updateMovementInfo()

		local var_8_0 = var_0_0.Battle.BattleTargetChoise.TargetHarmRandomByWeight(arg_8_0._host, None, arg_8_0.GetFilteredList())[1]
...
def var_0_2.InitialCD(arg_10_0):
...
def var_0_2.handleCoolDown(arg_14_0):
	...
	arg_14_0._CDstartTime = None
	arg_14_0._reloadBoostList = {}

def var_0_2.FlushReloadMax(arg_15_0, arg_15_1):
	if var_0_2.super.FlushReloadMax(arg_15_0, arg_15_1):
		return True

	arg_15_0._playerTorpedoVO.RefreshReloadingBar()

def var_0_2.FlushReloadRequire(arg_16_0):
	if var_0_2.super.FlushReloadRequire(arg_16_0):
		return True

	arg_16_0._playerTorpedoVO.RefreshReloadingBar()

def var_0_2.QuickCoolDown(arg_17_0):
	if arg_17_0._currentState == arg_17_0.STATE_OVER_HEAT:
		...
		arg_17_0._CDstartTime = None
		arg_17_0._reloadBoostList = {}

def var_0_2.Prepar(arg_18_0):
...
def var_0_2.ReloadBoost(arg_20_0, arg_20_1):
	local var_20_0 = 0

	for iter_20_0, iter_20_1 in ipairs(arg_20_0._reloadBoostList):
...
def var_0_2.AppendReloadBoost(arg_21_0, arg_21_1):
	if arg_21_0._currentState == arg_21_0.STATE_OVER_HEAT:
