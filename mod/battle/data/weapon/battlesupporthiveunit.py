	...
	if arg_2_0._currentState == arg_2_0.STATE_READY:
		if arg_2_0._host.GetUnitType() != var_0_1.UnitType.PLAYER_UNIT:
			if arg_2_0._preCastInfo.time == None:
				...
				arg_2_0.PreCast()
		elif #var_0_0.Battle.BattleTargetChoise.TargetAircraftGB(arg_2_0._host) > 0:
			arg_2_0._currentState = arg_2_0.STATE_PRECAST_FINISH
...
def var_0_3.createMajorEmitter(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5):
	local function var_4_0(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
		...
		if arg_4_0._debugRecordDEFAircraft:
			table.insert(arg_4_0._debugRecordDEFAircraft, var_5_0)

	var_0_3.super.createMajorEmitter(arg_4_0, arg_4_1, arg_4_2, None, var_4_0, None)

def var_0_3.SpwanAircraft(arg_6_0, arg_6_1):
