...
def var_0_2.Clear(arg_3_0):
	...
	arg_3_0._charAttachPointPool = None

	Object.Destroy(arg_3_0._fxContainer)

	arg_3_0._fxContainer = None
	arg_3_0._fxContainerTf = None

def var_0_2.GetFX(arg_4_0, arg_4_1, arg_4_2):
...
def var_0_2.GetCharacterFX(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5):
	if arg_5_2 == None:
	...
	if var_5_3 != None:
		...
		if var_5_3.mirror and var_5_0.transform.parent.transform.lossyScale.x < 0:
...
def var_0_2.PopCharacterAttachPoint(arg_6_0):
	return arg_6_0._charAttachPointPool.GetObject()

def var_0_2.PushCharacterAttachPoint(arg_7_0, arg_7_1):
