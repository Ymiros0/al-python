...
def var_0_4.MakeBullet(arg_1_0):
	return var_0_0.Battle.BattleTorpedoBullet.New()

def var_0_4.onBulletHitFunc(arg_2_0, arg_2_1, arg_2_2):
	...
	if table.contains(var_0_2, arg_2_2):
		var_2_4 = var_0_4.GetSceneMediator().GetAircraft(arg_2_1).GetUnitData()
	elif table.contains(var_0_3, arg_2_2):
		var_2_4 = var_0_4.GetSceneMediator().GetCharacter(arg_2_1).GetUnitData()

	if not var_2_4 or not var_2_1 or var_2_4.GetUniqueID() != var_2_1.GetUniqueID():
		return
	...
	if var_2_0.GetPierceCount() <= 0:
		var_2_0.CleanAimMark()
		var_2_3.RemoveBulletUnit(var_2_0.GetUniqueID())

def var_0_4.onBulletMissFunc(arg_3_0):
	var_0_4.onBulletHitFunc(arg_3_0)

def var_0_4.MakeModel(arg_4_0, arg_4_1, arg_4_2):
	...
	if var_4_0.GetIFF() != var_4_2.GetFriendlyCode() and var_4_1.alert_fx != "":
