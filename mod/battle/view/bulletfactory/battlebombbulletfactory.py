...
def var_0_1.MakeBullet(arg_7_0):
	return var_0_0.Battle.BattleBombBullet.New()

def var_0_1.onBulletHitFunc(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_1.onBulletMissFunc():
	return

def var_0_1.MakeModel(arg_10_0, arg_10_1, arg_10_2):
	...
	if var_10_0.GetIFF() != arg_10_0.GetDataProxy().GetFriendlyCode() and var_10_0.GetExist() and var_10_6.alert_fx != "":
...
def var_0_1.CreateBulletAlert(arg_12_0):
	...
	if var_12_5[var_12_1] and var_12_5[var_12_1].y_scale == True:
		var_12_4 = var_12_0
