...
def var_0_1.onBulletHitFunc(arg_3_0, arg_3_1, arg_3_2):
	...
	if var_3_2.GetPierceCount() <= 0:
		var_3_1.RemoveBulletUnit(var_3_2.GetUniqueID())

def var_0_1.onBulletMissFunc(arg_5_0):
	var_0_1.onBulletHitFunc(arg_5_0)

def var_0_1.MakeModel(arg_6_0, arg_6_1, arg_6_2):
	...
	if var_6_0.GetIFF() != var_6_2.GetFriendlyCode() and var_6_1.alert_fx != "":
