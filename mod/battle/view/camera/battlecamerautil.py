...
def var_0_4.ActiveMainCemera(arg_2_0):
	CameraMgr.instance.SetActiveMainCamera(arg_2_0)

def var_0_4.Initialize(arg_3_0):
...
def var_0_4.Clear(arg_4_0):
	...
	arg_4_0._uiMediator = None

def var_0_4.SetMapData(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4):
...
def var_0_4.SetFocusFleet(arg_6_0, arg_6_1):
...
def var_0_4.SetCameraSilder(arg_7_0, arg_7_1):
	arg_7_0._gesture.SetGestureComponent(arg_7_1)

def var_0_4.SwitchCameraPos(arg_8_0, arg_8_1):
	if arg_8_1 == "TWEEN_TO_CHARACTER":
		function arg_8_0._currentCameraPos()
			return arg_8_0._fromTo.GetCameraPos()
	elif arg_8_1 == "FOLLOW_GESTURE":
		function arg_8_0._currentCameraPos()
...
def var_0_4.GetS2WPoint(arg_12_0, arg_12_1):
	return arg_12_0._camera.ScreenToWorldPoint(arg_12_1)

def var_0_4.setArrowPoint(arg_13_0):
	local var_13_0 = 1
...
def var_0_4.Update(arg_14_0):
	local var_14_0 = arg_14_0.GetCameraPoint()
	local var_14_1 = arg_14_0._cameraTF.position

	if var_14_1.x != var_14_0.x or var_14_1.z != var_14_0:
		arg_14_0._cameraTF.position = var_14_0

		var_0_1.UpdateCameraPositionArgs()

	if arg_14_0._shakeInfo and arg_14_0._shakeEnabled:
		arg_14_0.DoShake()

def var_0_4.StartShake(arg_15_0, arg_15_1):
	if arg_15_0._shakeInfo and (arg_15_0._shakeInfo._priority > arg_15_1.priority or arg_15_1.priority == 0):
		return
	...
	if arg_15_0._shakeInfo._bounce:
		arg_15_0._shakeInfo._duration = arg_15_0._shakeInfo._duration * 0.5

	arg_15_0._shakeInfo._priority = arg_15_1.priority

def var_0_4.StopShake(arg_16_0):
	arg_16_0._shakeInfo = None

def var_0_4.DoShake(arg_17_0):
	...
	if arg_17_0._shakeInfo._count >= arg_17_0._shakeInfo._loop:
	...
	if arg_17_0._shakeInfo._elapsed > arg_17_0._shakeInfo._duration:
		if arg_17_0._shakeInfo._bounce:
...
def var_0_4.bounceReverse(arg_18_0):
	if arg_18_0._fricCoefH != 0:
		arg_18_0._fricCoefH = 1 / arg_18_0._fricCoefH

	if arg_18_0._fricCoefV != 0:
...
def var_0_4.PauseShake(arg_19_0):
	arg_19_0._shakeEnabled = False

def var_0_4.ResumeShake(arg_20_0):
	arg_20_0._shakeEnabled = True

def var_0_4.active(arg_21_0):
	UpdateBeat.Add(arg_21_0.Update, arg_21_0)

def var_0_4.Deactive(arg_22_0):
	UpdateBeat.Remove(arg_22_0.Update, arg_22_0)

def var_0_4.CutInPainting(arg_23_0, arg_23_1, arg_23_2):
	arg_23_0.DispatchEvent(var_0_0.Event.New(var_0_2.SHOW_PAINTING, {
		caster = arg_23_1,
		speed = arg_23_2
	}))

def var_0_4.BulletTime(arg_24_0, arg_24_1, arg_24_2, arg_24_3):
	local var_24_0 = {
		key = arg_24_1,
		speed = arg_24_2,
		exemptUnit = arg_24_3
	...
	if arg_24_0._uiMediator and arg_24_0._uiMediator.GetAppearFX() != None:
		arg_24_0._uiMediator.GetAppearFX().GetComponent(typeof(Animator)).speed = 1 / (arg_24_2 or 1)

def var_0_4.ZoomCamara(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4):
...
def var_0_4.FocusCharacter(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4, arg_27_5):
	arg_27_0.StopShake()
...
def var_0_4.ResetFocus(arg_29_0):
	arg_29_0.StopShake()
...
def var_0_4.GetCharacterArrowBarPosition(arg_31_0, arg_31_1, arg_31_2):
	...
	if arg_31_1.x >= arg_31_0._arrowLeftHorizon and arg_31_1.x < arg_31_0._arrowRightHorizon and arg_31_1.y >= arg_31_0._arrowBottomHorizon and arg_31_1.y <= arg_31_0._arrowTopHorizon:
		return None
	else
		...
		if var_31_8 > var_31_1.y:
			var_31_8 = var_31_1.y
			var_31_6 = var_31_7 / var_31_3 * (var_31_8 - var_31_2.y)
		elif var_31_8 < var_31_0.y:
			var_31_8 = var_31_0.y
			var_31_6 = var_31_7 / var_31_3 * (var_31_8 - var_31_2.y)
...
def var_0_4.GetCameraPoint(arg_32_0):
	return arg_32_0._currentCameraPos()

def var_0_4.GetArrowCenterPos(arg_33_0):
	return arg_33_0._arrowCenterPos

def var_0_4.GetCamera(arg_34_0):
	return arg_34_0._camera

def var_0_4.Add2Camera(arg_35_0, arg_35_1, arg_35_2):
...
def var_0_4.PauseCameraTween(arg_36_0):
	LeanTween.pause(go(arg_36_0._camera))
	LeanTween.pause(go(arg_36_0._uiCamera))

def var_0_4.ResumeCameraTween(arg_37_0):
