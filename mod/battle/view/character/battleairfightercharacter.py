...
def var_0_3.SetUnitData(arg_2_0, arg_2_1):
	arg_2_0._unitData = arg_2_1

	arg_2_0.AddUnitEvent()
	arg_2_1.SetUnVisitable()

def var_0_3.AddModel(arg_3_0, arg_3_1):
...
def var_0_3.Update(arg_4_0):
	...
	if var_4_0 == var_0_2.STRIKE_STATE_DOWN or var_4_0 == var_0_2.STRIKE_STATE_ATTACK or var_4_0 == var_0_2.STRIKE_STATE_UP:
		arg_4_0.UpdateShadow()

def var_0_3.AddUnitEvent(arg_5_0):
...
def var_0_3.onStrikeStateChange(arg_7_0):
	...
	elif var_7_0 == var_0_2.STRIKE_STATE_BACK:
	...
	elif var_7_0 == var_0_2.STRIKE_STATE_DOWN:
		-- block empty
	elif var_7_0 == var_0_2.STRIKE_STATE_ATTACK:
		-- block empty
	elif var_7_0 == var_0_2.STRIKE_STATE_UP:
		-- block empty
	elif var_7_0 == var_0_2.STRIKE_STATE_FREE:
		-- block empty
	elif var_7_0 == var_0_2.STRIKE_STATE_BACKWARD:
