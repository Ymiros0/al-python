...
def var_0_2.RegisterWeaponListener(arg_2_0, arg_2_1):
...
def var_0_2.UnregisterWeaponListener(arg_3_0, arg_3_1):
...
def var_0_2.onWeaponPrecastFinish(arg_8_0, arg_8_1):
...
def var_0_2.OnUpdateHP(arg_9_0, arg_9_1):
	var_0_2.super.OnUpdateHP(arg_9_0, arg_9_1)

	if arg_9_1.Data.dHP <= 0:
		arg_9_0.AddBlink(1, 1, 1, 0.1, 0.1, True)

def var_0_2.AddModel(arg_10_0, arg_10_1):
...
def var_0_2.getCharacterPos(arg_16_0):
