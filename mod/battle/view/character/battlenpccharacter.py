...
def var_0_2.SetHPColor(arg_2_0, arg_2_1):
	arg_2_0._HPColor = arg_2_1

def var_0_2.GetHPColor(arg_3_0):
	return arg_3_0._HPColor

def var_0_2.SetModleID(arg_4_0, arg_4_1):
	arg_4_0._prefab = arg_4_1

def var_0_2.GetModleID(arg_5_0):
	if arg_5_0._prefab:
		return arg_5_0._prefab
	else
		return arg_5_0._unitData.GetTemplate().prefab

def var_0_2.SetUnvisible(arg_6_0):
	arg_6_0._isUnvisible = True

def var_0_2.MakeVisible(arg_7_0):
	if arg_7_0._isUnvisible:
