...
def var_0_5.SetUnitData(arg_2_0, arg_2_1):
	var_0_5.super.SetUnitData(arg_2_0, arg_2_1)

	arg_2_0._chargeWeaponList = {}

	for iter_2_0, iter_2_1 in ipairs(arg_2_1.GetChargeList()):
		arg_2_0.InitChargeWeapon(iter_2_1)

	arg_2_0._torpedoWeaponList = {}

	for iter_2_2, iter_2_3 in ipairs(arg_2_1.GetTorpedoList()):
	...
	if var_2_0 != None:
		for iter_2_4, iter_2_5 in ipairs(var_2_0):
			arg_2_0.InitAirAssit(iter_2_5)

	arg_2_0._weaponSectorList = {}

def var_0_5.AddUnitEvent(arg_3_0):
...
def var_0_5.RemoveUnitEvent(arg_4_0):
	...
	for iter_4_4, iter_4_5 in ipairs(arg_4_0._airAssistList):
...
def var_0_5.Update(arg_5_0):
	var_0_5.super.Update(arg_5_0)
	arg_5_0.UpdatePosition()
	arg_5_0.UpdateMatrix()

	if not arg_5_0._inViewArea or not arg_5_0._alwaysHideArrow:
		arg_5_0.UpdateArrowBarPostition()

	if arg_5_0._unitData.GetOxyState():
		arg_5_0.UpdateOxygenBar()

	if arg_5_0._cloakBar:
...
def var_0_5.AddArrowBar(arg_10_0, arg_10_1):
	...
	if arg_10_0._unitData.IsMainFleetUnit() and arg_10_0._unitData.GetFleetVO().GetMainList()[3] == arg_10_0._unitData:
		arg_10_1.transform.SetSiblingIndex(arg_10_1.transform.parent.childCount - 3)

	arg_10_0.UpdateVectorBar()

def var_0_5.GetReferenceVector(arg_11_0, arg_11_1):
	if arg_11_0._inViewArea:
		return var_0_5.super.GetReferenceVector(arg_11_0, arg_11_1)
	else
		return arg_11_0._arrowVector

def var_0_5.DisableWeaponTrack(arg_12_0):
	if arg_12_0._torpedoTrack:
		arg_12_0._torpedoTrack.SetActive(False)

def var_0_5.SonarAcitve(arg_13_0, arg_13_1):
	if var_0_0.Battle.BattleAttr.HasSonar(arg_13_0._unitData):
		arg_13_0._sonar.GetComponent(typeof(Animator)).enabled = arg_13_1

def var_0_5.UpdateDiveInvisible(arg_14_0):
...
def var_0_5.Dispose(arg_15_0):
	arg_15_0._torpedoIcons = None
	arg_15_0._renderer = None
	arg_15_0._sonar = None
	arg_15_0._diveMark = None
	arg_15_0._oxygenBar = None
	arg_15_0._oxygenSlider = None

	Object.Destroy(arg_15_0._arrowBar)

	for iter_15_0, iter_15_1 in ipairs(arg_15_0._weaponSectorList):
		iter_15_1.Dispose()

	arg_15_0._weaponSectorList = None

	var_0_5.super.Dispose(arg_15_0)

def var_0_5.GetModleID(arg_16_0):
	return arg_16_0._unitData.GetTemplate().prefab

def var_0_5.OnUpdateHP(arg_17_0, arg_17_1):
	var_0_5.super.OnUpdateHP(arg_17_0, arg_17_1)
	arg_17_0.UpdateVectorBar()

def var_0_5.onInitWeaponCD(arg_18_0, arg_18_1):
	arg_18_0.onTorepedoReady()

def var_0_5.onCastBlink(arg_19_0, arg_19_1):
...
def var_0_5.onTorpedoWeaponFire(arg_20_0, arg_20_1):
	arg_20_0._torpedoTrack.SetActive(False)
	arg_20_0.onTorepedoReady()

def var_0_5.onTorpedoPrepar(arg_21_0, arg_21_1):
...
def var_0_5.onTorpedoCancel(arg_22_0, arg_22_1):
	arg_22_0._torpedoTrack.SetActive(False)

def var_0_5.onTorepedoReady(arg_23_0, arg_23_1):
	local var_23_0 = 0

	for iter_23_0, iter_23_1 in ipairs(arg_23_0._torpedoWeaponList):
		if iter_23_1.GetCurrentState() == iter_23_1.STATE_READY:
			var_23_0 = var_23_0 + 1

	for iter_23_2 = 1, var_0_0.Battle.BattleConst.MAX_EQUIPMENT_COUNT:
		LuaHelper.SetTFChildActive(arg_23_0._torpedoIcons, "torpedo_" .. iter_23_2, iter_23_2 <= var_23_0)

def var_0_5.onAAMissileWeaponFire(arg_24_0, arg_24_1):
	arg_24_0.onAAMissileReady()

def var_0_5.onWillDie(arg_25_0, arg_25_1):
	for iter_25_0, iter_25_1 in ipairs(arg_25_0._smokeList):
		if iter_25_1.active == True:
			iter_25_1.active = False

			local var_25_0 = iter_25_1.smokes

			for iter_25_2, iter_25_3 in pairs(var_25_0):
				if iter_25_2.unInitialize:
					-- block empty
				else
					SetActive(iter_25_3, False)

def var_0_5.AddHPBar(arg_26_0, arg_26_1):
	var_0_5.super.AddHPBar(arg_26_0, arg_26_1)

	arg_26_0._torpedoIcons = arg_26_0._HPBarTf.Find("torpedoIcons")

	if #arg_26_0._torpedoWeaponList <= 0:
		arg_26_0._torpedoIcons.gameObject.SetActive(False)

	arg_26_0._sonar = arg_26_0._HPBarTf.Find("sonarMark")

	if var_0_0.Battle.BattleAttr.HasSonar(arg_26_0._unitData):
...
def var_0_5.InitAirAssit(arg_34_0, arg_34_1):
...
def var_0_5.InitTorpedoWeapon(arg_35_0, arg_35_1):
...
def var_0_5.onActiveWeaponSector(arg_36_0, arg_36_1):
	...
	if var_36_1:
		...
		arg_36_0._weaponSectorList[var_36_2] = None

def var_0_5.OnAnimatorTrigger(arg_37_0):
	arg_37_0._unitData.CharacterActionTriggerCallback()

def var_0_5.OnAnimatorEnd(arg_38_0):
	arg_38_0._unitData.CharacterActionEndCallback()

def var_0_5.OnAnimatorStart(arg_39_0):
