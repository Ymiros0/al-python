...
def var_0_2.MakeCharacter(arg_2_0):
	return var_0_0.Battle.BattleAircraftCharacter.New()

def var_0_2.MakeModel(arg_3_0, arg_3_1):
	local function var_3_0(arg_4_0)
		...
		if arg_3_1.GetUnitData().GetIFF() == var_0_1.FOE_CODE:
...
def var_0_2.MakeBloodBar(arg_6_0, arg_6_1):
	local var_6_0

	if arg_6_1.GetUnitData().IsPlayerAircraft():
...
def var_0_2.SetHPBarWidth(arg_7_0, arg_7_1, arg_7_2):
	local var_7_0 = 40
...
def var_0_2.MakeShadow(arg_8_0, arg_8_1):
	arg_8_1.AddShadow()
