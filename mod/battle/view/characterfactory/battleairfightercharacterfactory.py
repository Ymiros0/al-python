...
def var_0_0.Battle.BattleAirFighterCharacterFactory.Ctor(arg_1_0):
...
def var_0_0.Battle.BattleAirFighterCharacterFactory.MakeCharacter(arg_2_0):
	return var_0_0.Battle.BattleAirFighterCharacter.New()

def var_0_0.Battle.BattleAirFighterCharacterFactory.MakeModel(arg_3_0, arg_3_1):
...
def var_0_0.Battle.BattleAirFighterCharacterFactory.MakeBloodBar(arg_6_0, arg_6_1):
