...
def var_0_1.MakeModel(arg_3_0, arg_3_1, arg_3_2):
	local function var_3_0(arg_4_0)
		...
		if #var_4_1.GetTorpedoList() > 0:
			arg_3_0.MakeTorpedoTrack(arg_3_1)

		if var_4_1.GetAimBias() and var_4_1.GetAimBias().GetHost() == var_4_1:
...
def var_0_1.MakeChargeArea(arg_8_0, arg_8_1):
...
def var_0_1.MakeTorpedoTrack(arg_9_0, arg_9_1):
	local var_9_0 = arg_9_0.GetFXPool().GetFX("SquareAlert", arg_9_1.GetTf())

	arg_9_1.AddTorpedoTrack(var_9_0)

def var_0_1.RemoveCharacter(arg_10_0, arg_10_1, arg_10_2):
	local var_10_0 = arg_10_0.GetSceneMediator()

	if arg_10_2 and arg_10_2 != var_0_0.Battle.BattleConst.UnitDeathReason.KILLED:
		-- block empty
	else
