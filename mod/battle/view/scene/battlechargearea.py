...
def var_0_0.Battle.BattleChargeArea.Ctor(arg_1_0, arg_1_1):
	arg_1_1.gameObject.SetActive(False)

	arg_1_0._areaTf = arg_1_1.transform
	arg_1_0._areaGO = arg_1_1

def var_0_0.Battle.BattleChargeArea.InitArea(arg_2_0):
...
def var_0_0.Battle.BattleChargeArea.Update(arg_3_0, arg_3_1):
	arg_3_0._areaTf.position = arg_3_1

def var_0_0.Battle.BattleChargeArea.SetWeapon(arg_4_0, arg_4_1):
	arg_4_0._chargeWeapon = arg_4_1

	arg_4_0.InitArea()

def var_0_0.Battle.BattleChargeArea.SetActive(arg_5_0, arg_5_1):
	arg_5_0._areaGO.SetActive(arg_5_1)

def var_0_0.Battle.BattleChargeArea.GetActive(arg_6_0):
	return arg_6_0._areaGO.GetActive()

def var_0_0.Battle.BattleChargeArea.Reset(arg_7_0):
