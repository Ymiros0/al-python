...
def var_0_1.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(var_0_1.LAYERS):
...
def var_0_1.ShiftSurface(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4):
	if arg_2_0._shiftTimer:
		return
	...
	if arg_2_2 < arg_2_1:
		var_2_1 = -1
	elif arg_2_1 < arg_2_2:
		var_2_1 = 1
	else
		return

	local function var_2_2()
		if (arg_2_2 - var_2_0) * var_2_1 > 0:
...
def var_0_1.setSpeedScaler(arg_8_0, arg_8_1):
	for iter_8_0, iter_8_1 in ipairs(arg_8_0.mapLayerCtrls):
		iter_8_1.speedScaler = arg_8_1

def var_0_1.updateSeaSpeed(arg_9_0):
	local var_9_0 = var_0_0.Battle.BattleVariable.MapSpeedRatio

	for iter_9_0, iter_9_1 in ipairs(arg_9_0.seaAnimList):
		iter_9_1.AdjustAnimSpeed(var_9_0)

def var_0_1.Dispose(arg_10_0):
	if arg_10_0._shiftTimer:
	...
	if arg_10_0._go:
		...
		arg_10_0._go = None
		arg_10_0._buffer = None
		arg_10_0._bufferRenderer = None

def var_0_1.GetMapResNames(arg_11_0, arg_11_1):
	local var_11_0 = pg.map_data[arg_11_0]

	return string.split(var_11_0[arg_11_1 .. "_shot"], ";")

def var_0_1.setActive(arg_12_0, arg_12_1):
