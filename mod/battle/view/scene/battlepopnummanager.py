...
def var_0_3.Init(arg_2_0, arg_2_1):
	arg_2_0._allBundlePool = {}
	arg_2_0._activeList = {}
	arg_2_0._popSkin = arg_2_1

def var_0_3.GetPopSkin(arg_3_0):
	return arg_3_0._popSkin

def var_0_3.InitialBundlePool(arg_4_0, arg_4_1):
...
def var_0_3.InitialScorePool(arg_5_0, arg_5_1):
...
def var_0_3.Clear(arg_6_0):
	for iter_6_0, iter_6_1 in pairs(arg_6_0._allBundlePool):
		iter_6_1.Dispose()

	arg_6_0._popSkin = None
	arg_6_0._activeList = {}

def var_0_3.GetBundle(arg_7_0, arg_7_1):
	local var_7_0 = var_0_3.getBundleType(arg_7_1)

	return (arg_7_0._allBundlePool[var_7_0].GetObject())

def var_0_3.getType(arg_8_0, arg_8_1, arg_8_2, arg_8_3):
	local var_8_0 = 1
	local var_8_1

	if arg_8_0 and not arg_8_2:
...
def var_0_3.getBundleType(arg_9_0):
	local var_9_0

	if table.contains(var_0_3.AIR_UNIT_TYPE, arg_9_0):
...
def var_0_3.generateTempPool(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4):
...
def var_0_3.resetPopParent(arg_11_0, arg_11_1, arg_11_2):
	arg_11_1.UpdateInfo("parentTF", arg_11_2)

	for iter_11_0, iter_11_1 in ipairs(arg_11_1.list):
