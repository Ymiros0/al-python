...
def var_0_2.ConfigIconSkin(arg_2_0, arg_2_1):
	arg_2_0._iconTpl = arg_2_1
	arg_2_0._iconContainer = arg_2_1.parent

def var_0_2.AppendIcon(arg_3_0, arg_3_1, arg_3_2):
...
def var_0_2.RemoveIcon(arg_4_0, arg_4_1, arg_4_2):
	local var_4_0 = arg_4_0._iconList[arg_4_1]

	if not var_4_0:
		return

	if arg_4_2.totalNumber <= 0:
		Object.Destroy(var_4_0)

		arg_4_0._iconList[arg_4_1] = None
	else
		arg_4_0.setIconNumber(var_4_0.transform.Find("FighterIcon"), arg_4_2.totalNumber)

def var_0_2.Dispose(arg_5_0):
	for iter_5_0, iter_5_1 in pairs(arg_5_0._iconList):
		Object.Destroy(iter_5_1)

	arg_5_0._iconList = None

def var_0_2.setIconNumber(arg_6_0, arg_6_1, arg_6_2):
