...
def var_0_2.ConfigCallback(arg_2_0, arg_2_1):
...
def var_0_2.init(arg_3_0):
	...
	var_3_0.AddPointDownFunc(function()
		...
		if arg_3_0._hitCount >= var_0_2.COUNT:
...
def var_0_2.Puase(arg_7_0):
	LeanTween.cancel(go(arg_7_0._blocker))

def var_0_2.ClickEase(arg_8_0):
...
def var_0_2.Eliminate(arg_10_0, arg_10_1):
...
def var_0_2.Dispose(arg_12_0):
	if arg_12_0.eventTriggers:
		for iter_12_0, iter_12_1 in pairs(arg_12_0.eventTriggers):
			ClearEventTrigger(iter_12_0)

		arg_12_0.eventTriggers = None
