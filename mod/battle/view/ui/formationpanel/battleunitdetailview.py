...
def var_0_6.SetUnit(arg_2_0, arg_2_1):
	var_0_0.EventListener.AttachEventListener(arg_2_0)

	arg_2_0._unit = arg_2_1

	if arg_2_0._unit.GetUnitType() == var_0_3.UnitType.PLAYER_UNIT:
		...
		for iter_2_0 = 1, arg_2_0._unit.GetTemplate().star:
	...
	for iter_2_1, iter_2_2 in ipairs(var_0_6.PrimalAttr):
	...
	for iter_2_3, iter_2_4 in pairs(var_0_6.BaseEnhancement):
...
def var_0_6.Update(arg_3_0):
	for iter_3_0, iter_3_1 in ipairs(var_0_6.PrimalAttr):
		arg_3_0.updatePrimalAttr(iter_3_1)

	for iter_3_2, iter_3_3 in pairs(var_0_6.BaseEnhancement):
		arg_3_0.updateBaseEnhancement(iter_3_2, iter_3_3)

	local var_3_0 = arg_3_0._unit.GetAttr()

	for iter_3_4, iter_3_5 in pairs(var_3_0):
		if string.find(iter_3_4, "DMG_TAG_EHC_") or string.find(iter_3_4, "DMG_FROM_TAG_") or table.contains(var_0_6.SecondaryAttrListener, iter_3_4):
...
def var_0_6.ConfigSkin(arg_4_0, arg_4_1):
	arg_4_0._go = arg_4_1
	...
	for iter_4_0, iter_4_1 in ipairs(var_0_6.DefaultActive):
		SetActive(var_4_0.Find(iter_4_1), True)

def var_0_6.updateHP(arg_5_0):
	...
	for iter_5_0, iter_5_1 in pairs(var_5_3):
		for iter_5_2, iter_5_3 in ipairs(iter_5_1.GetEffectList()):
			if iter_5_3.__name == "BattleBuffShield" or iter_5_3.__name == "BattleBuffRecordShield":
				var_5_4 = var_5_4 + math.max(0, iter_5_3.GetEffectAttachData())

	setText(arg_5_0._shield, var_5_4)

def var_0_6.updatePrimalAttr(arg_6_0, arg_6_1):
...
def var_0_6.updateBaseEnhancement(arg_7_0, arg_7_1, arg_7_2):
...
def var_0_6.updateSecondaryAttr(arg_8_0, arg_8_1, arg_8_2):
	if not arg_8_0._secondaryAttrList[arg_8_1]:
...
def var_0_6.updateBuffList(arg_9_0):
	local var_9_0 = arg_9_0._unit.GetBuffList()

	for iter_9_0, iter_9_1 in pairs(arg_9_0._buffList):
		if not var_9_0[iter_9_0]:
			GameObject.Destroy(iter_9_1.gameObject)

			arg_9_0._buffList[iter_9_0] = None

	for iter_9_2, iter_9_3 in pairs(var_9_0):
		if not arg_9_0._buffList[iter_9_2]:
			arg_9_0.addBuff(iter_9_2, iter_9_3)
		else
			local var_9_1 = arg_9_0._buffList[iter_9_2]

			if iter_9_3._stack > 1:
				local var_9_2 = var_9_1.Find("buff_stack")

				setActive(var_9_2, True)
				setText(var_9_2, "x" .. iter_9_3._stack)

	for iter_9_4, iter_9_5 in pairs(var_9_0):
		local var_9_3 = iter_9_5.GetEffectList()

		for iter_9_6, iter_9_7 in ipairs(var_9_3):
			if iter_9_7.__name == var_0_0.Battle.BattleBuffCastSkill.__name and (not arg_9_0._skillList[iter_9_7._skill_id] or not table.contains(arg_9_0._skillList[iter_9_7._skill_id].effectList, iter_9_7)):
				arg_9_0.addSkillCaster(iter_9_7)

def var_0_6.updateWeaponList(arg_10_0):
	...
	for iter_10_2, iter_10_3 in ipairs(var_10_3):
		...
		if var_10_4 != var_0_5.STRIKE_AIRCRAFT and var_10_4 != var_0_5.FLEET_ANTI_AIR:
...
def var_0_6.updateWeaponProgress(arg_13_0):
	for iter_13_0, iter_13_1 in pairs(arg_13_0._weaponList):
	...
	for iter_13_2, iter_13_3 in pairs(arg_13_0._aaList):
...
def var_0_6.updateBarProgress(arg_14_0, arg_14_1):
...
def var_0_6.updateBulletAttrBuff(arg_15_0, arg_15_1):
	...
	for iter_15_0, iter_15_1 in pairs(var_15_2):
		var_15_5[iter_15_0] = True

	for iter_15_2, iter_15_3 in pairs(arg_15_0._unit.GetBuffList()):
		for iter_15_4, iter_15_5 in ipairs(iter_15_3.GetEffectList()):
			if iter_15_5.__name == var_0_0.Battle.BattleBuffAddBulletAttr.__name:
				local var_15_6 = arg_15_1.GetEquipmentIndex()

				if iter_15_5.equipIndexRequire(var_15_6):
...
def var_0_6.addSkillCaster(arg_17_0, arg_17_1):
	local var_17_0 = arg_17_1._skill_id
	local var_17_1 = arg_17_1._srcBuff.GetLv()

	if not var_0_0.Battle.BattleSkillUnit.IsFireSkill(var_17_0, var_17_1):
		return
...
def var_0_6.updateSkillList(arg_18_0):
	for iter_18_0, iter_18_1 in pairs(arg_18_0._skillList):
		arg_18_0.updateCastEffectTpl(iter_18_0)

def var_0_6.updateCastEffectTpl(arg_19_0, arg_19_1):
	...
	for iter_19_0, iter_19_1 in ipairs(var_19_2):
...
def var_0_6.Dispose(arg_20_0):
	pg.DelegateInfo.Dispose(arg_20_0)

	arg_20_0._unit = None
	arg_20_0._secondaryAttrList = None
	arg_20_0._buffList = None
	arg_20_0._weaponList = None

	GameObject.Destroy(arg_20_0._go)
	var_0_0.EventListener.DetachEventListener(arg_20_0)

def var_0_6.setDeltaText(arg_21_0, arg_21_1):
