...
def var_0_3.Dispose(arg_2_0):
	arg_2_0._affixList = None
	arg_2_0._affixContainer = None
	arg_2_0._affixTpl = None
	arg_2_0._desc = None
	arg_2_0._tf = None
	arg_2_0._go = None

def var_0_3.Active(arg_3_0, arg_3_1):
	setActive(arg_3_0._go, arg_3_1)

def var_0_3.SetReferenceCard(arg_4_0, arg_4_1):
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_0._affixViewList):
