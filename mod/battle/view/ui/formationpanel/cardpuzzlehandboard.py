...
def var_0_4.Update(arg_3_0):
	for iter_3_0, iter_3_1 in ipairs(arg_3_0._activeCardList):
		iter_3_1.Update()

	for iter_3_2, iter_3_3 in ipairs(arg_3_0._freeCardList):
		iter_3_3.Update()

def var_0_4.onUpdateCards(arg_4_0, arg_4_1):
	...
	while var_4_1 > 0:
		...
		if not table.contains(var_4_0, var_4_3):
			if var_4_3.GetCurrentPile() == arg_4_0._cardPuzzleInfo.CARD_PILE_INDEX_DECK:
	...
	for iter_4_0, iter_4_1 in ipairs(var_4_0):
		...
		for iter_4_2, iter_4_3 in ipairs(arg_4_0._activeCardList):
			if iter_4_3.GetCardInfo() == iter_4_1:
				var_4_4 = iter_4_3
...
def var_0_4.getCard(arg_5_0):
	local var_5_0

	if #arg_5_0._idleCardList > 0:
	...
	local function var_5_4()
		if var_5_0.GetState() == var_5_0.STATE_LONG_PRESS:
			var_5_3()

		if var_5_0.GetState() != var_5_0.STATE_LOCK:
	...
	local function var_5_6()
		...
		arg_5_0._cardEnterHand = None
		arg_5_0._cardEnterDeck = None

		arg_5_0.UnlockCardInHand()
		arg_5_0.activeHighlight(False)
		arg_5_0.SetAllCardBlockRayCast(True)
		onDelayTick(function()
			arg_5_0._cardPuzzleInfo.BlockComponentByCard(False), 0.06)
...
def var_0_4.recyleCard(arg_13_0, arg_13_1):
	for iter_13_0, iter_13_1 in ipairs(arg_13_0._activeCardList):
...
def var_0_4.delayRecyleCard(arg_14_0, arg_14_1):
	arg_14_1.ChangeState(arg_14_1.STATE_LOCK)

	for iter_14_0, iter_14_1 in ipairs(arg_14_0._activeCardList):
		if iter_14_1 == arg_14_1:
	...
	arg_14_1.MoveToDeck(function()
		for iter_15_0, iter_15_1 in ipairs(arg_14_0._freeCardList):
			if iter_15_1 == arg_14_1:
				arg_14_1.SetToObjPoolRecylePos()
				table.remove(arg_14_0._freeCardList, iter_15_0)

				break

		table.insert(arg_14_0._idleCardList, arg_14_1), arg_14_0._drawPos)

def var_0_4.onUpdateFleetAttr(arg_16_0, arg_16_1):
	for iter_16_0, iter_16_1 in ipairs(arg_16_0._activeCardList):
		iter_16_1.UpdateTotalCost()
		iter_16_1.UpdateBoostHint()

		local var_16_0 = iter_16_1.GetCardInfo()

def var_0_4.init(arg_17_0):
...
def var_0_4.updateCardReferenceInHand(arg_18_0):
	for iter_18_0, iter_18_1 in ipairs(arg_18_0._activeCardList):
...
def var_0_4.getcardGap(arg_19_0):
	local var_19_0 = #arg_19_0._activeCardList

	if #arg_19_0._activeCardList <= var_0_2.BASE_MAX_HAND:
		return var_0_4.BASE_GAP
	else
		return 830 / (var_19_0 - 1)

def var_0_4.setDragingCard(arg_20_0, arg_20_1):
	arg_20_0._cardPuzzleInfo.SetDragingCard(arg_20_1)
	arg_20_0._cardPuzzleInfo.SendUpdateAim()

def var_0_4.sort(arg_21_0):
	return

def var_0_4.activeHighlight(arg_22_0, arg_22_1):
	if arg_22_1:
		...
		arg_22_0._deckDelegate.AddPointEnterFunc(function()
			...
			local var_25_0 = arg_22_0._holdingCard.GetCardInfo().GetReturnCost() != None
...
def var_0_4.LockCardInHand(arg_27_0):
	for iter_27_0, iter_27_1 in ipairs(arg_27_0._activeCardList):
		iter_27_1.ChangeState(iter_27_1.STATE_LOCK)

def var_0_4.SetAllCardBlockRayCast(arg_28_0, arg_28_1):
	for iter_28_0, iter_28_1 in ipairs(arg_28_0._activeCardList):
		iter_28_1.BlockRayCast(arg_28_1)

def var_0_4.UnlockCardInHand(arg_29_0, arg_29_1):
	if arg_29_1:
		arg_29_1.ChangeState(var_0_0.Battle.CardPuzzleCombatCard.STATE_FREE)
	else
		for iter_29_0, iter_29_1 in ipairs(arg_29_0._activeCardList):
			iter_29_1.ChangeState(var_0_0.Battle.CardPuzzleCombatCard.STATE_FREE)

def var_0_4.TryPlayCard(arg_30_0, arg_30_1):
	local var_30_0 = arg_30_1.GetCardInfo()

	return (arg_30_0._cardPuzzleInfo.PlayCard(var_30_0))

def var_0_4.TryPlayReturnCard(arg_31_0, arg_31_1):
	local var_31_0 = arg_31_1.GetCardInfo()

	return (arg_31_0._cardPuzzleInfo.ReturnCard(var_31_0))

def var_0_4.Dispose(arg_32_0):
	return
