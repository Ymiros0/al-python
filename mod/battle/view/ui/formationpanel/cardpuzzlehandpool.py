...
def var_0_3.SetCardPuzzleComponent(arg_2_0, arg_2_1):
	...
	for iter_2_0 = 1, var_0_0.Battle.BattleFleetCardPuzzleHand.MAX_HAND:
...
def var_0_3.onUpdateCards(arg_3_0, arg_3_1):
	local var_3_0 = arg_3_0._hand.GetCardList()

	for iter_3_0 = 1, arg_3_0._hand.MAX_HAND:
		arg_3_0._cardList[iter_3_0].SetCardInfo(var_3_0[iter_3_0])

def var_0_3.onUpdateFleetAttr(arg_4_0, arg_4_1):
	for iter_4_0 = 1, arg_4_0._hand.MAX_HAND:
...
def var_0_3.updateHandCard(arg_6_0):
	for iter_6_0, iter_6_1 in ipairs(arg_6_0._cardList):
		iter_6_1.updateCardView()

def var_0_3.sort(arg_7_0):
	return

def var_0_3.instCardView(arg_8_0):
...
def var_0_3.test(arg_10_0, arg_10_1):
...
def var_0_3.Dispose(arg_14_0):
	arg_14_0._cardTpl = None
	arg_14_0._cardContainer = None
	arg_14_0._cardList = None
