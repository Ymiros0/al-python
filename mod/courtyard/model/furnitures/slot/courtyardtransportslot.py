...
def var_0_0.OnInit(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_1[2]):
...
def var_0_0.OnStart(arg_5_0):
	...
	Timer.New(function()
		arg_5_0.End(), var_5_0.time, 1).Start()

def var_0_0.Occupy(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
	arg_7_0.index = 1

	var_0_0.super.Occupy(arg_7_0, arg_7_1, arg_7_2, arg_7_3)

def var_0_0.Link(arg_8_0, arg_8_1, arg_8_2, arg_8_3):
	arg_8_0.index = 2

	var_0_0.super.Occupy(arg_8_0, arg_8_1, arg_8_2, arg_8_3)

def var_0_0.IsFirstTime(arg_9_0):
