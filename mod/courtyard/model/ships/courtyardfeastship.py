...
def var_0_0.GetInterActionExpress(arg_10_0, arg_10_1):
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_0):
		...
		if var_10_1 == arg_10_1.configId and #var_10_2 > 0:
			return var_10_2[math.random(1, #var_10_2)]

def var_0_0.IsSameInterAction(arg_11_0, arg_11_1, arg_11_2):
	local var_11_0 = arg_11_0.interActionConfig[arg_11_2] or {}

	for iter_11_0, iter_11_1 in ipairs(var_11_0):
		if arg_11_1.configId == iter_11_1:
			return True

	return False

def var_0_0._ChangeState(arg_12_0, arg_12_1, arg_12_2):
	var_0_0.super._ChangeState(arg_12_0, arg_12_1, arg_12_2)

	if arg_12_1 == CourtYardShip.STATE_TOUCH and arg_12_0.bubble == FeastShip.BUBBLE_TYPE_GREET:
