...
def var_0_0.BeginCheckChange(arg_2_0):
	arg_2_0.Reset()

	arg_2_0.setup = True
	arg_2_0.headSample = arg_2_0.storey.ToTable()

def var_0_0.TakeSample(arg_3_0):
	if not arg_3_0.setup:
		return
	...
	for iter_3_0, iter_3_1 in pairs(arg_3_0.furnitures):
		if not var_3_2[iter_3_1.id]:
			table.insert(var_3_1, iter_3_1.id)

	for iter_3_2, iter_3_3 in pairs(var_3_2):
		if iter_3_3.IsDirty():
...
def var_0_0.Reset(arg_4_0):
	...
	for iter_4_0, iter_4_1 in pairs(arg_4_0.furnitures):
		if iter_4_1.IsDirty():
			iter_4_1.UnDirty()

def var_0_0.EndCheckChange(arg_5_0):
	arg_5_0.Clear()

def var_0_0.Clear(arg_6_0):
	arg_6_0.furnitures = None
	arg_6_0.setup = False
	arg_6_0.headSample = None

def var_0_0.HasChange(arg_7_0):
	local var_7_0 = arg_7_0.storey.ToTable()
	local var_7_1 = arg_7_0.headSample

	if table.getCount(var_7_0) != table.getCount(var_7_1):
		return True
	...
	for iter_7_0, iter_7_1 in pairs(var_7_0):
		if not var_7_2(iter_7_1, var_7_1[iter_7_1.id]):
			return True

	return False

def var_0_0.GetHeadSample(arg_9_0):
	local var_9_0 = {}

	for iter_9_0, iter_9_1 in pairs(arg_9_0.headSample):
