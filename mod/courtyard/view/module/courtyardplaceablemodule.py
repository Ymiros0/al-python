...
def var_0_0.OnIconLoaed(arg_3_0):
...
def var_0_0.CreateWhenStoreyInit(arg_5_0):
	arg_5_0.PuddingAnim()

def var_0_0.BlocksRaycasts(arg_6_0, arg_6_1):
	return

local var_0_1 = "follower_"

def var_0_0.NewBoneFollower(arg_7_0, arg_7_1):
...
def var_0_0.FindBoneFollower(arg_8_0, arg_8_1):
	local var_8_0 = var_0_1 .. arg_8_1

	return arg_8_0.bones[var_8_0]

def var_0_0.PuddingAnim(arg_9_0):
	if not arg_9_0.iconLoaded:
...
def var_0_0.CancelPuddingAnim(arg_12_0):
	if arg_12_0.doPuddingAniming:
		LeanTween.cancel(arg_12_0._tf.gameObject)

		arg_12_0._tf.localScale = Vector3(arg_12_0.normalX, arg_12_0.normalY, 1)
		arg_12_0.doPuddingAniming = None

def var_0_0.GetParentTF(arg_13_0):
	if arg_13_0.data.GetDeathType() == CourtYardConst.DEPTH_TYPE_MAT:
		return arg_13_0.mat
	else
		return arg_13_0.floor

def var_0_0.GetSpine(arg_14_0):
	assert(False)

def var_0_0.GetData(arg_15_0):
	return arg_15_0.data

def var_0_0.SetSiblingIndex(arg_16_0, arg_16_1):
	if arg_16_1 != arg_16_0._tf.GetSiblingIndex():
		arg_16_0._tf.SetSiblingIndex(arg_16_1)

	arg_16_0._go.name = arg_16_0.data.id .. "_" .. arg_16_1

def var_0_0.SetAsLastSibling(arg_17_0):
...
def var_0_0.UpdatePosition(arg_19_0, arg_19_1, arg_19_2):
...
def var_0_0.OnDispose(arg_20_0):
	for iter_20_0, iter_20_1 in pairs(arg_20_0.bones):
		if not IsNil(iter_20_1):
			Object.Destroy(iter_20_1.gameObject)

	arg_20_0.bones = {}

	if arg_20_0.dragAgent:
		arg_20_0.dragAgent.Dispose()

		arg_20_0.dragAgent = None

	if LeanTween.isTweening(go(arg_20_0._tf)):
		LeanTween.cancel(go(arg_20_0._tf))

def var_0_0.OnDestroy(arg_21_0):
	return

def var_0_0.OnBeginDrag(arg_22_0):
	return

def var_0_0.OnDragging(arg_23_0, arg_23_1):
	return

def var_0_0.OnDragEnd(arg_24_0, arg_24_1):
	return
