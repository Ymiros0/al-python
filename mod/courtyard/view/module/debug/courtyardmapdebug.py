...
def var_0_0.Init(arg_3_0):
	...
	for iter_3_0 = var_3_1, var_3_3:
		local var_3_5 = {}

		for iter_3_1 = var_3_2, var_3_4:
...
def var_0_0.Flush(arg_4_0):
	...
	for iter_4_0, iter_4_1 in pairs(arg_4_0.mapGrids):
...
def var_0_0.Clear(arg_5_0):
	for iter_5_0, iter_5_1 in pairs(arg_5_0.mapGrids):
