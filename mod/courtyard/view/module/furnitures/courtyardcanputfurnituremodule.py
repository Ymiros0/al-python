...
def var_0_0.RemoveChild(arg_4_0, arg_4_1):
	local var_4_0 = arg_4_1.data.GetDeathType() .. arg_4_1.data.id

	arg_4_0.childModules[var_4_0] = None

	arg_4_1._tf.SetParent(arg_4_0.GetParentTF())

def var_0_0.AddListeners(arg_5_0):
...
def var_0_0.AddAreaListener(arg_7_0, arg_7_1, arg_7_2):
...
def var_0_0.RemoveAreaListener(arg_9_0, arg_9_1, arg_9_2):
	local var_9_0 = arg_9_0.callbacks[arg_9_2]

	if var_9_0:
		arg_9_0.data.placeableArea.RemoveListener(arg_9_1, var_9_0)

		arg_9_0.callbacks[var_9_0] = None

def var_0_0.OnRemoveItem(arg_10_0, arg_10_1):
...
def var_0_0.OnAddItem(arg_11_0, arg_11_1):
...
def var_0_0.RefreshDepth(arg_12_0):
	for iter_12_0, iter_12_1 in ipairs(arg_12_0.data.placeableArea.GetItems()):
		local var_12_0 = iter_12_1.GetDeathType() .. iter_12_1.id

		arg_12_0.childModules[var_12_0].SetSiblingIndex(iter_12_0 - 1)

def var_0_0.BlocksRaycasts(arg_13_0, arg_13_1):
	...
	if (var_13_0 or var_13_1) and arg_13_1 == False:
		return
