...
def var_0_0.Init(arg_2_0, arg_2_1, arg_2_2):
	...
	ResourceMgr.Inst.getAssetAsync("sfurniture/" .. arg_2_2.GetFirstSlot().GetName(), "", typeof(GameObject), UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_3_0)
		...
		arg_2_0.OnReset(arg_2_1)), True, True)
...
def var_0_0.OnCantPlace(arg_7_0):
	if arg_7_0.furnitureSpineStateSkeletonGraphic.material != arg_7_0.cantPlaceMat:
...
def var_0_0.OnCanPlace(arg_8_0):
	if arg_8_0.furnitureSpineStateSkeletonGraphic.material != arg_8_0.canPlaceMat:
...
def var_0_0.OnReset(arg_9_0, arg_9_1):
	if arg_9_0.furnitureSpineStateSkeletonGraphic.material != arg_9_0.selectedMat:
...
def var_0_0.OnClear(arg_10_0):
	if arg_10_0.furnitureSpineStateAnimUI:
		Object.Destroy(arg_10_0.furnitureSpineStateAnimUI)

		arg_10_0.furnitureSpineStateAnimUI = None
