...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.voiceBtn, function()
		arg_3_0.Emit("PlayFurnitureVoice", arg_3_0.furniture.id), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.bgVoiceBtn, function()
		arg_3_0.Emit("PlayFurnitureBg", arg_3_0.furniture.id)
		setActive(arg_3_0.bgVoiceMark, arg_3_0.furniture.GetMusicData()), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.musicalInstrumentsBtn, function()
		if arg_3_0.furniture.IsMusicalInstruments():
			arg_3_0.Emit("PlayMusicalInstruments", arg_3_0.furniture.id), SFX_PANEL)
