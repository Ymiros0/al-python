...
def var_0_0.BlurPanel(arg_7_0):
	pg.UIMgr.GetInstance().BlurPanel(arg_7_0._tf)
	var_0_0.super.Show(arg_7_0)

def var_0_0.GetKeys(arg_8_0):
	return {
		{
			"7D",
			"pipa_1"
...
def var_0_0.GetTpl(arg_9_0):
	if #arg_9_0.keyTplPool > 0:
...
def var_0_0.InitKeys(arg_10_0, arg_10_1):
...
def var_0_0.InitKey(arg_12_0, arg_12_1, arg_12_2, arg_12_3):
...
def var_0_0.OnStartPlay(arg_15_0, arg_15_1):
	return

def var_0_0.OnEndPlay(arg_16_0, arg_16_1):
	return

def var_0_0.AnimationForKey(arg_17_0, arg_17_1):
	local var_17_0 = arg_17_1.Find("animation").GetComponent(typeof(Animation))

	var_17_0.Stop()
	var_17_0.Play()

def var_0_0.ClearAnimationForKey(arg_18_0, arg_18_1):
	arg_18_1.Find("animation").GetComponent(typeof(Animation)).Stop()
	arg_18_1.Find("animation").GetComponent(typeof(DftAniEvent)).SetEndEvent(None)

def var_0_0.RegisetEvent(arg_19_0):
...
def var_0_0.ClearAllAnimation(arg_22_0):
	for iter_22_0, iter_22_1 in ipairs(arg_22_0.tpls):
