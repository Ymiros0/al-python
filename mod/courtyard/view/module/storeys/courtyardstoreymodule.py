...
def var_0_0.GetDefaultBgm(arg_2_0):
...
def var_0_0.AllModulesAreCompletion(arg_9_0):
	for iter_9_0, iter_9_1 in pairs(arg_9_0.modules):
		if not iter_9_1.IsCompletion():
			return False

	return True

def var_0_0.OnRemindSave(arg_10_0):
...
def var_0_0.OnEnterEidtMode(arg_13_0):
	for iter_13_0, iter_13_1 in pairs(arg_13_0.modules):
		if isa(iter_13_1, CourtYardShipModule):
...
def var_0_0.OnExitEidtMode(arg_14_0):
	for iter_14_0, iter_14_1 in pairs(arg_14_0.modules):
		if isa(iter_14_1, CourtYardShipModule):
			iter_14_1.SetActive(True)
		else
			iter_14_1.BlocksRaycasts(False)

def var_0_0.OnCreateItem(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.OnAddItem(arg_16_0):
	if not arg_16_0.isInit:
		return
...
def var_0_0.InitFurnitureState(arg_19_0, arg_19_1, arg_19_2):
	arg_19_0.GetFurnitureStateMgr(arg_19_2).OnInit(arg_19_1, arg_19_2)

def var_0_0.UpdateFurnitureState(arg_20_0, arg_20_1, arg_20_2, arg_20_3):
...
def var_0_0.ResetFurnitureSelectedState(arg_22_0, arg_22_1):
...
def var_0_0.OnRemoveIllegalityItem(arg_29_0):
	pg.TipsMgr.GetInstance().ShowTips("Remove illegal Item")

def var_0_0.OnOpenLayer(arg_30_0, arg_30_1):
	for iter_30_0, iter_30_1 in pairs(arg_30_0.modules):
		if isa(iter_30_1, CourtYardShipModule):
			iter_30_1.HideAttachment(arg_30_1)

def var_0_0.EnableZoom(arg_31_0, arg_31_1):
	arg_31_0.zoomAgent.enabled = arg_31_1

def var_0_0.RegisterOp(arg_32_0, arg_32_1):
	setActive(arg_32_0.rotationBtn, not arg_32_1.DisableRotation())
	onButton(arg_32_0, arg_32_0.rotationBtn, function()
		arg_32_0.Emit("RotateFurniture", arg_32_1.id), SFX_PANEL)
	onButton(arg_32_0, arg_32_0.confirmBtn, function()
		arg_32_0.Emit("UnSelectFurniture", arg_32_1.id), SFX_PANEL)
	onButton(arg_32_0, arg_32_0.removeBtn, function()
		arg_32_0.Emit("RemoveFurniture", arg_32_1.id), SFX_PANEL)
...
def var_0_0.UnRegisterOp(arg_40_0):
...
def var_0_0.OnItemDirChange(arg_41_0, arg_41_1, arg_41_2):
	if isa(arg_41_1, CourtYardFurniture):
		arg_41_0.UpdateSelectedPosition(arg_41_1)

		if arg_41_0.data.InEidtMode() and arg_41_0.gridAgent:
...
def var_0_0.OnRotateItemFailed(arg_42_0):
	pg.TipsMgr.GetInstance().ShowTips(i18n("backyard_backyardScene_error_canNotRotate"))

def var_0_0.OnDisableRotation(arg_43_0):
	pg.TipsMgr.GetInstance().ShowTips(i18n("backyard_backyardScene_Disable_Rotation"))

def var_0_0.OnAddItemFailed(arg_44_0):
	pg.TipsMgr.GetInstance().ShowTips(i18n("backyard_backyardScene_error_noPosPutFurniture"))

def var_0_0.OnDestoryItem(arg_45_0, arg_45_1):
	arg_45_0.Item2Module(arg_45_1).Dispose()

	arg_45_0.modules[arg_45_1.GetDeathType() .. arg_45_1.id] = None

def var_0_0.OnChildItem(arg_46_0, arg_46_1, arg_46_2):
	local var_46_0 = arg_46_0.Item2Module(arg_46_1)
	local var_46_1 = arg_46_0.Item2Module(arg_46_2)

	var_46_1.AddChild(var_46_0)

	if isa(arg_46_1, CourtYardShip):
		var_46_1.BlocksRaycasts(True)

def var_0_0.OnUnChildItem(arg_47_0, arg_47_1, arg_47_2):
	local var_47_0 = arg_47_0.Item2Module(arg_47_1)
	local var_47_1 = arg_47_0.Item2Module(arg_47_2)

	var_47_1.RemoveChild(var_47_0)

	if isa(arg_47_1, CourtYardShip):
		var_47_1.BlocksRaycasts(False)

def var_0_0.OnEnterArch(arg_48_0, arg_48_1, arg_48_2):
	return

def var_0_0.OnExitArch(arg_49_0, arg_49_1, arg_49_2):
	return

def var_0_0.OnAddMatItem(arg_50_0):
	if not arg_50_0.isInit:
		return

	arg_50_0.RefreshMatDepth()

def var_0_0.OnRemoveMatItem(arg_51_0, arg_51_1):
	arg_51_0.Item2Module(arg_51_1).SetAsLastSibling()

def var_0_0.OnShowFurnitureDesc(arg_52_0, arg_52_1):
	arg_52_0.descPage.ExecuteAction("Show", arg_52_1)

def var_0_0.OnItemInterAction(arg_53_0, arg_53_1, arg_53_2, arg_53_3):
	...
	if #var_53_2 == 0:
		...
		for iter_53_0, iter_53_1 in ipairs(var_53_2):
...
def var_0_0.OnClearItemInterAction(arg_54_0, arg_54_1, arg_54_2, arg_54_3):
	local var_54_0 = arg_54_0.Item2Module(arg_54_1)
	local var_54_1 = arg_54_0.Item2Module(arg_54_2)

	if isa(var_54_1, CourtYardFurnitureModule) and #arg_54_2.GetUsingSlots() == 0:
		var_54_1.BlocksRaycasts(False)

	local var_54_2 = arg_54_0.Item2Module(arg_54_2)

	if arg_54_3.GetBodyMask():
...
def var_0_0.AddInteractionFollower(arg_55_0, arg_55_1, arg_55_2, arg_55_3):
	local var_55_0 = arg_55_1.GetFollower()

	if not var_55_0 or not arg_55_2:
		return
...
def var_0_0.ClearInteractionFollower(arg_56_0, arg_56_1, arg_56_2, arg_56_3):
	...
	if not IsNil(var_56_2):
		setActive(var_56_2, False)

def var_0_0.OnTouchItem(arg_57_0, arg_57_1):
	if isa(arg_57_1, CourtYardFurniture):
...
def var_0_0.OnCancelTouchItem(arg_58_0, arg_58_1):
	if isa(arg_58_1, CourtYardFurniture):
		arg_58_0.effectAgent.DisableEffect(arg_58_1.GetTouchEffect())
		arg_58_0.bgAgent.Switch(False, arg_58_1.GetTouchBg())

def var_0_0.OnItemPlayMusic(arg_59_0, arg_59_1, arg_59_2):
	if arg_59_2 == 1:
		arg_59_0.soundAgent.Play(arg_59_1)
	elif arg_59_2 == 2:
		arg_59_0.bgmAgent.Play(arg_59_1)

def var_0_0.OnItemStopMusic(arg_60_0, arg_60_1, arg_60_2):
	if arg_60_2 == 2:
		arg_60_0.bgmAgent.Reset()
	elif arg_60_2 == 1:
		arg_60_0.soundAgent.Stop()

def var_0_0.OnMuteAll(arg_61_0):
	arg_61_0.bgmAgent.Clear()
	arg_61_0.soundAgent.Clear()

def var_0_0.OnPlayMusicalInstruments(arg_62_0, arg_62_1):
	if arg_62_0.descPage and arg_62_0.descPage.GetLoaded() and arg_62_0.descPage.isShowing():
		arg_62_0.descPage.Close()

	if arg_62_1.GetType() == Furniture.TYPE_LUTE:
		arg_62_0.playTheLutePage.ExecuteAction("Show", arg_62_1)

def var_0_0.OnStopPlayMusicalInstruments(arg_63_0, arg_63_1):
	arg_63_0.bgmAgent.Reset()

	if arg_63_0.descPage and arg_63_0.descPage.GetLoaded():
		arg_63_0.descPage.ExecuteAction("Show", arg_63_1)

def var_0_0.OnAddEffect(arg_64_0, arg_64_1):
	arg_64_0.effectAgent.EnableEffect(arg_64_1)

def var_0_0.OnRemoveEffect(arg_65_0, arg_65_1):
	arg_65_0.effectAgent.DisableEffect(arg_65_1)

def var_0_0.OnBackPressed(arg_66_0):
	if arg_66_0.playTheLutePage and arg_66_0.playTheLutePage.GetLoaded() and arg_66_0.playTheLutePage.isShowing():
		arg_66_0.playTheLutePage.Hide()

		return

	if arg_66_0.descPage and arg_66_0.descPage.GetLoaded() and arg_66_0.descPage.isShowing():
...
def var_0_0.UpdateSelectedPosition(arg_67_0, arg_67_1):
...
def var_0_0.GetGridAgent(arg_68_0, arg_68_1, arg_68_2):
	local var_68_0

	if isa(arg_68_1, CourtYardWallFurniture):
		var_68_0 = arg_68_0.gridAgents[2]
	else
		var_68_0 = arg_68_0.gridAgents[1]

	if arg_68_0.gridAgent and var_68_0 != arg_68_0.gridAgent:
...
def var_0_0.ItemsIsLoaded(arg_69_0):
	if table.getCount(arg_69_0.modules) == 0:
		return False

	for iter_69_0, iter_69_1 in pairs(arg_69_0.modules):
		if not iter_69_1.IsInit():
			return False

	return True

def var_0_0.Item2Module(arg_70_0, arg_70_1):
	return arg_70_0.modules[arg_70_1.GetDeathType() .. arg_70_1.id]

def var_0_0.RefreshDepth(arg_71_0):
	for iter_71_0, iter_71_1 in ipairs(arg_71_0.data.GetItems()):
		arg_71_0.Item2Module(iter_71_1).SetSiblingIndex(iter_71_0 - 1)

def var_0_0.RefreshMatDepth(arg_72_0):
	for iter_72_0, iter_72_1 in ipairs(arg_72_0.data.GetMatItems()):
		arg_72_0.Item2Module(iter_72_1).SetSiblingIndex(iter_72_0 - 1)

def var_0_0.OnTakePhoto(arg_73_0):
...
def var_0_0.OnDispose(arg_75_0):
	arg_75_0.exited = True

	arg_75_0.dftAniEvent.SetEndEvent(None)

	for iter_75_0, iter_75_1 in pairs(arg_75_0.modules):
		iter_75_1.Dispose()

	arg_75_0.modules = None

	for iter_75_2, iter_75_3 in pairs(arg_75_0.factorys):
		iter_75_3.Dispose()

	arg_75_0.factorys = None

	arg_75_0.dragBtn.Dispose()

	arg_75_0.dragBtn = None

	for iter_75_4, iter_75_5 in pairs(arg_75_0.gridAgents):
		iter_75_5.Dispose()

	arg_75_0.gridAgents = None

	if var_0_1:
		arg_75_0.mapDebug.Dispose()

	if arg_75_0.pedestalModule:
		arg_75_0.pedestalModule.Dispose()

		arg_75_0.pedestalModule = None

	arg_75_0.effectAgent.Dispose()

	arg_75_0.effectAgent = None

	arg_75_0.soundAgent.Dispose()

	arg_75_0.soundAgent = None

	arg_75_0.bgAgent.Dispose()

	arg_75_0.bgAgent = None

	arg_75_0.bgmAgent.Dispose()

	arg_75_0.bgmAgent = None

	arg_75_0.descPage.Destroy()

	arg_75_0.descPage = None

	arg_75_0.playTheLutePage.Destroy()

	arg_75_0.playTheLutePage = None

	if not IsNil(arg_75_0._go):
