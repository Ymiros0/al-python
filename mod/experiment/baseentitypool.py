...
def var_0_0.Get(arg_2_0, arg_2_1):
...
def var_0_0.Return(arg_3_0, arg_3_1, arg_3_2):
	arg_3_1.Dispose()
...
def var_0_0.ReturnArray(arg_4_0, arg_4_1, arg_4_2):
	for iter_4_0, iter_4_1 in ipairs(arg_4_1):
		arg_4_0.Return(iter_4_1, arg_4_2)

def var_0_0.ReturnMap(arg_5_0, arg_5_1, arg_5_2):
	for iter_5_0, iter_5_1 in pairs(arg_5_1):
