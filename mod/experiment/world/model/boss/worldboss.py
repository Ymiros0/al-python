...
def var_0_0.SetJoinTime(arg_4_0, arg_4_1):
	arg_4_0.joinTime = arg_4_1

def var_0_0.GetJoinTime(arg_5_0):
	return arg_5_0.joinTime

def var_0_0.GetMetaId(arg_6_0):
	return arg_6_0.config.meta_id

def var_0_0.IncreaseFightCnt(arg_7_0):
	arg_7_0.fightCount = arg_7_0.fightCount + 1

def var_0_0.GetSelfFightCnt(arg_8_0):
	return arg_8_0.fightCount

def var_0_0.GetOilConsume(arg_9_0):
	if not arg_9_0.IsSelf():
		return 0
...
def var_0_0.SetRankCnt(arg_10_0, arg_10_1):
	arg_10_0.rankCount = arg_10_1

def var_0_0.GetRankCnt(arg_11_0):
	return arg_11_0.rankCount

def var_0_0.GetPlayer(arg_12_0):
	return arg_12_0.player

def var_0_0.IsFullPeople(arg_13_0):
	return arg_13_0.GetRankCnt() >= pg.gameset.joint_boss_fighter_max.key_value

def var_0_0.UpdateBossType(arg_14_0, arg_14_1):
	if not arg_14_0.IsSelf():
		arg_14_0.type = arg_14_1

def var_0_0.GetWaitForResultTime(arg_15_0):
	return arg_15_0.killTime

def var_0_0.ShouldWaitForResult(arg_16_0):
	return pg.TimeMgr.GetInstance().GetServerTime() < arg_16_0.killTime

def var_0_0.GetRoleName(arg_17_0):
	if arg_17_0.player:
		return arg_17_0.player.name
	else
		return ""

def var_0_0.isSameLevel(arg_18_0, arg_18_1):
	return arg_18_0.level == arg_18_1.level

def var_0_0.SetBossType(arg_19_0):
	...
	if arg_19_0.owner == var_19_0.id:
		return var_0_0.BOSS_TYPE_SELF
	else
		if var_19_2 and var_19_2.getMemberById(arg_19_0.owner):
			return var_0_0.BOSS_TYPE_GUILD

		if var_19_1.getFriend(arg_19_0.owner):
			return var_0_0.BOSS_TYPE_FRIEND

	return var_0_0.BOSS_TYPE_WORLD

def var_0_0.IsSelf(arg_20_0):
	return arg_20_0.type == var_0_0.BOSS_TYPE_SELF

def var_0_0.GetType(arg_21_0):
	return arg_21_0.type

def var_0_0.GetStageID(arg_22_0):
	return arg_22_0.config.expedition_id

def var_0_0.UpdateHp(arg_23_0, arg_23_1):
	arg_23_0.hp = arg_23_1

def var_0_0.GetHP(arg_24_0):
	return arg_24_0.hp

def var_0_0.Active(arg_25_0):
	return arg_25_0.id > 0

def var_0_0.isDeath(arg_26_0):
	return arg_26_0.hp <= 0

def var_0_0.UpdateKillTime(arg_27_0):
	local var_27_0 = nowWorld().GetBossProxy().GetRank(arg_27_0.id)

	if var_27_0 and #var_27_0 > 1:
