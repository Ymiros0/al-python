...
def var_0_0.Ctor(arg_4_0, arg_4_1, arg_4_2):
...
def var_0_0.Dispose(arg_6_0, arg_6_1):
	...
	for iter_6_0 in pairs(var_0_0.InheritNameList):
...
def var_0_0.InheritReset(arg_7_0, arg_7_1):
	arg_7_1 = arg_7_1 or {}
...
def var_0_0.GetRound(arg_20_0):
	return arg_20_0.roundIndex % 2

def var_0_0.IncRound(arg_21_0):
	arg_21_0.roundIndex = arg_21_0.roundIndex + 1

def var_0_0.ResetRound(arg_22_0):
	arg_22_0.roundIndex = 0

def var_0_0.UpdateProgress(arg_23_0, arg_23_1):
...
def var_0_0.GetShipVOs(arg_43_0):
...
def var_0_0.GetWorldRank(arg_57_0):
	local var_57_0 = 0
...
def var_0_0.GetBossProxy(arg_59_0):
	return arg_59_0.worldBossProxy

def var_0_0.GetTaskProxy(arg_60_0):
	return arg_60_0.taskProxy

def var_0_0.GetInventoryProxy(arg_61_0):
	return arg_61_0.inventoryProxy

def var_0_0.GetCollectionProxy(arg_62_0):
	return arg_62_0.collectionProxy

def var_0_0.VerifyFormation(arg_63_0):
	local var_63_0 = {}
...
def var_0_0.CalcRepairCost(arg_65_0, arg_65_1):
	...
	if arg_65_1.IsBroken():
		...
		return (_.detect(var_65_1, function(arg_66_0)
			return arg_66_0[1] >= var_65_0) or var_65_1[#var_65_1])[2] * pg.gameset.world_port_service_2_price.key_value
		...
		return (_.detect(var_65_2, function(arg_67_0)
			return arg_67_0[1] >= var_65_0) or var_65_2[#var_65_2])[2] * (_.detect(var_65_3, function(arg_68_0)
			return arg_68_0[1] >= arg_65_1.hpRant) or var_65_3[#var_65_3])[2]

	return 0

def var_0_0.GetMoveRange(arg_69_0, arg_69_1):
...
def var_0_0.IsRookie(arg_70_0):
	return arg_70_0.activateCount == 0 and arg_70_0.progress <= 0

def var_0_0.EntranceToReplacementMapList(arg_71_0, arg_71_1):
	local var_71_0 = {}
	...
	if var_71_2.isPressing and #arg_71_1.config.complete_chapter > 0:
...
def var_0_0.ReplacementMapType(arg_74_0, arg_74_1):
...
def var_0_0.FindTreasureEntrance(arg_75_0, arg_75_1):
	return underscore.values(arg_75_0.atlas.GetTreasureDic(arg_75_1))[1]

def var_0_0.TreasureMap2ItemId(arg_76_0, arg_76_1, arg_76_2):
...
def var_0_0.CheckFleetMovable(arg_77_0):
...
def var_0_0.SetAchieveSuccess(arg_78_0, arg_78_1, arg_78_2):
...
def var_0_0.GetMapAchieveStarDic(arg_79_0, arg_79_1):
	return arg_79_0.achieveEntranceStar[arg_79_1] or {}

def var_0_0.GetAchievement(arg_80_0, arg_80_1):
...
def var_0_0.GetAchievements(arg_81_0, arg_81_1):
	local var_81_0 = {}
...
def var_0_0.IsNormalAchievementAchieved(arg_84_0, arg_84_1):
	return arg_84_0.CountAchievements(arg_84_1) >= #arg_84_1.config.normal_target

def var_0_0.AnyUnachievedAchievement(arg_85_0, arg_85_1):
...
def var_0_0.GetFinishAchievements(arg_87_0, arg_87_1):
...
def var_0_0.CountAchievements(arg_88_0, arg_88_1):
	local var_88_0 = 0
	local var_88_1 = 0
	local var_88_2 = 0
...
def var_0_0.BuildFormationIds(arg_90_0):
	local var_90_0 = {
		[FleetType.Normal] = {},
		[FleetType.Submarine] = {}
	}
	...
	for iter_90_2, iter_90_3 in pairs(var_90_0):
		for iter_90_4 = 1, var_90_1[iter_90_2]:
	...
	if var_90_5:
		for iter_90_9 = #var_90_0[FleetType.Normal] + 1, var_90_5:
...
def var_0_0.FormationIds2NetIds(arg_91_0, arg_91_1):
	local var_91_0 = {}
...
def var_0_0.CompareRedeploy(arg_92_0, arg_92_1):
	local var_92_0 = {
		TeamType.Main,
		TeamType.Vanguard,
		TeamType.Submarine
...
def var_0_0.IsSystemOpen(arg_93_0, arg_93_1):
...
def var_0_0.CalcCDTimeCost(arg_94_0, arg_94_1, arg_94_2):
...
def var_0_0.GetReqCDTime(arg_95_0, arg_95_1):
	return arg_95_0.cdTimeList[arg_95_1] or 0

def var_0_0.SetReqCDTime(arg_96_0, arg_96_1, arg_96_2):
	arg_96_0.cdTimeList[arg_96_1] = arg_96_2

def var_0_0.InitWorldShopGoods(arg_97_0):
	arg_97_0.goodDic = {}
...
def var_0_0.UpdateWorldShopGoods(arg_98_0, arg_98_1):
...
def var_0_0.GetWorldShopGoodsDictionary(arg_100_0):
	return arg_100_0.goodDic

def var_0_0.InitWorldColorDictionary(arg_101_0):
	arg_101_0.colorDic = {}
...
def var_0_0.AddGlobalBuff(arg_105_0, arg_105_1, arg_105_2):
...
def var_0_0.RemoveBuff(arg_106_0, arg_106_1, arg_106_2):
	assert(arg_106_1)
...
def var_0_0.GetWorldMapBuffLevel(arg_107_0):
...
def var_0_0.GetWorldMapBuffAverageLevel(arg_109_0):
...
def var_0_0.GetWorldMapBuffs(arg_111_0):
...
def var_0_0.CheckResetAward(arg_123_0, arg_123_1):
...
def var_0_0.ClearResetAward(arg_124_0):
	arg_124_0.resetAward = None
	arg_124_0.resetLimitTip = None

def var_0_0.GetTargetMapPressingCount(arg_125_0, arg_125_1):
	local var_125_0 = 0
...
def var_0_0.ClearAllFleetDefeatEnemies(arg_126_0):
	underscore.each(arg_126_0.GetFleets(), function(arg_127_0)
		arg_127_0.ClearDefeatEnemies())

def var_0_0.GetAreaEntranceIds(arg_128_0, arg_128_1):
	return arg_128_0.atlas.areaEntranceList[arg_128_1]

def var_0_0.CalcOrderCost(arg_129_0, arg_129_1):
	local var_129_0 = 0
...
def var_0_0.GetDisplayPressingCount(arg_131_0):
	local var_131_0 = 0
...
def var_0_0.CheckCommanderInFleet(arg_132_0, arg_132_1):
...
def var_0_0.CheckSkipBattle(arg_134_0):
	return getProxy(PlayerProxy).getRawData().CheckIdentityFlag() and world_skip_battle == 1

def var_0_0.IsMapVisioned(arg_135_0, arg_135_1):
...
def var_0_0.HasAutoFightDrops(arg_136_0):
	local var_136_0 = arg_136_0.autoInfos

	return #var_136_0.drops > 0 or underscore.any(var_136_0.salvage, function(arg_137_0)
		return #arg_137_0 > 0) or #var_136_0.buffs > 0 or #var_136_0.message > 0

def var_0_0.AddAutoInfo(arg_138_0, arg_138_1, arg_138_2):
	if arg_138_1 == "drops":
...
def var_0_0.InitAutoInfos(arg_139_0):
	arg_139_0.autoInfos = {
		drops = {},
		salvage = {
			{},
...
def var_0_0.TriggerAutoFight(arg_140_0, arg_140_1):
	arg_140_1 = arg_140_1 and arg_140_0.GetActiveMap().CanAutoFight()

	if tobool(arg_140_1) != tobool(arg_140_0.isAutoFight):
...
def var_0_0.TriggerAutoSwitch(arg_141_0, arg_141_1):
	if tobool(arg_141_1) != tobool(arg_141_0.isAutoSwitch):
		arg_141_0.isAutoSwitch = arg_141_1

		pg.m02.sendNotification(GAME.WORLD_TRIGGER_AUTO_SWITCH)

def var_0_0.GetHistoryLowestHP(arg_142_0, arg_142_1):
	return arg_142_0.lowestHP[arg_142_1] or 10000

def var_0_0.SetHistoryLowestHP(arg_143_0, arg_143_1, arg_143_2):
...
def var_0_0.SetGlobalFlag(arg_144_0, arg_144_1, arg_144_2):
	arg_144_0.gobalFlag[var_0_2[arg_144_1]] = arg_144_2

def var_0_0.GetGobalFlag(arg_145_0, arg_145_1):
