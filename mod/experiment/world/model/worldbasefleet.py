...
def var_0_0.Setup(arg_2_0, arg_2_1):
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.commanders or {}):
		arg_2_0.commanderIds[iter_2_1.pos] = iter_2_1.id

def var_0_0.UpdateShips(arg_4_0, arg_4_1):
...
def var_0_0.GetShips(arg_12_0, arg_12_1):
	...
	_.each({
		...
		for iter_13_0, iter_13_1 in ipairs(arg_12_0[arg_13_0]):
			if arg_12_1 or iter_13_1.IsAlive():
				table.insert(var_12_0, iter_13_1))

	return var_12_0

def var_0_0.GetShipVOs(arg_14_0, arg_14_1):
	return _.map(arg_14_0.GetShips(arg_14_1), function(arg_15_0)
		return WorldConst.FetchShipVO(arg_15_0.id))

def var_0_0.GetTeamShips(arg_16_0, arg_16_1, arg_16_2):
	return _(arg_16_0[arg_16_1]).chain().filter(function(arg_17_0)
		return arg_16_2 or arg_17_0.IsAlive()).value()

def var_0_0.GetTeamShipVOs(arg_18_0, arg_18_1, arg_18_2):
	return _.map(arg_18_0.GetTeamShips(arg_18_1, arg_18_2), function(arg_19_0)
		return WorldConst.FetchShipVO(arg_19_0.id))

def var_0_0.GetFlagShipVO(arg_20_0):
	if arg_20_0.GetFleetType() == FleetType.Submarine:
		return WorldConst.FetchShipVO(_.detect(arg_20_0[TeamType.Submarine], function(arg_21_0)
			return arg_21_0.IsAlive()).id)
	else
		return WorldConst.FetchShipVO(_.detect(arg_20_0[TeamType.Main], function(arg_22_0)
			return arg_22_0.IsAlive()).id)

def var_0_0.IsAlive(arg_23_0):
	return _.any(arg_23_0[TeamType.Main], function(arg_24_0)
		return arg_24_0.IsAlive()) and _.any(arg_23_0[TeamType.Vanguard], function(arg_25_0)
		return arg_25_0.IsAlive())

def var_0_0.GetLevel(arg_26_0):
	local var_26_0 = arg_26_0.GetShips(True)

	return math.floor(_.reduce(var_26_0, 0, function(arg_27_0, arg_27_1)
		return arg_27_0 + WorldConst.FetchRawShipVO(arg_27_1.id).level) / #var_26_0)

def var_0_0.BuildFormationIds(arg_28_0):
	local var_28_0 = {
		[TeamType.Main] = {},
		[TeamType.Vanguard] = {},
		[TeamType.Submarine] = {}
	...
	for iter_28_2, iter_28_3 in pairs(arg_28_0.commanderIds):
...
def var_0_0.getTeamByName(arg_30_0, arg_30_1):
	local var_30_0 = {}

	for iter_30_0, iter_30_1 in ipairs(arg_30_0[arg_30_1]):
		if iter_30_1.IsAlive():
			table.insert(var_30_0, iter_30_1.id)

	return var_30_0

def var_0_0.getFleetType(arg_31_0):
	return arg_31_0.GetFleetType()

def var_0_0.getShipVOsDic(arg_32_0):
	local var_32_0 = {}
	local var_32_1 = arg_32_0.GetShipVOs()

	for iter_32_0, iter_32_1 in ipairs(var_32_1):
