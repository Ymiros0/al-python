...
def var_0_0.DebugPrintAttachmentCell(arg_2_0, arg_2_1):
	if not var_0_0.Debug:
		return
...
def var_0_0.GetProgressAtlas(arg_3_0):
...
for iter_0_0, iter_0_1 in pairs(var_0_0.ReqName):
...
def var_0_0.DirToLine(arg_4_0):
	if arg_4_0 == var_0_0.DirNone:
		return {
			row = 0,
			column = 0
		}
	elif arg_4_0 == var_0_0.DirUp:
		return {
			row = -1,
			column = 0
		}
	elif arg_4_0 == var_0_0.DirRight:
		return {
			row = 0,
			column = 1
		}
	elif arg_4_0 == var_0_0.DirDown:
		return {
			row = 1,
			column = 0
		}
	elif arg_4_0 == var_0_0.DirLeft:
		return {
			row = 0,
			column = -1
		}
...
def var_0_0.InFOVRange(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4):
...
def var_0_0.Pos2FogRes(arg_11_0, arg_11_1):
	arg_11_0 = arg_11_0 % 3
	arg_11_1 = arg_11_1 % 3
...
def var_0_0.GetTerrainEffectRes(arg_12_0, arg_12_1, arg_12_2):
...
def var_0_0.GetWindScale(arg_16_0):
...
def var_0_0.GetTerrainMoveStepDuration(arg_17_0):
...
def var_0_0.CalcModelPosition(arg_18_0, arg_18_1):
...
def var_0_0.ExtendPropertiesRatesFromBuffList(arg_19_0, arg_19_1):
...
def var_0_0.AppendPropertiesFromBuffList(arg_20_0, arg_20_1, arg_20_2):
...
def var_0_0.CalcRelativeRectPos(arg_21_0, arg_21_1, arg_21_2, arg_21_3):
	...
	for iter_21_0 = arg_21_3, 0, -50:
		local var_21_7 = Vector3(iter_21_0, 0, 0)

		for iter_21_1 = 360 / var_21_5, 1, -1:
...
def var_0_0.GetMapIconState(arg_24_0):
	if arg_24_0 == 1:
		return "normal"
	elif arg_24_0 == 2:
		return "danger"
...
def var_0_0.HasDangerConfirm(arg_25_0):
	if arg_25_0 == 1:
		return False
	elif arg_25_0 == 2:
		return False
...
def var_0_0.BuildHelpTips(arg_26_0):
...
def var_0_0.FindStageTemplates(arg_27_0):
	local var_27_0 = {}
...
def var_0_0.GetRookieBattleLoseStory():
...
def var_0_0.IsWorldGuideEnemyId(arg_29_0):
	if var_0_0.GuideEnemyEnd:
		return False
...
def var_0_0.WorldLevelCorrect(arg_30_0, arg_30_1):
...
def var_0_0.GetAreaFocusPos(arg_31_0):
	local var_31_0 = pg.world_regions_data[arg_31_0].regions_pos

	return Vector2(var_31_0[1], var_31_0[2])

def var_0_0.GetTransportBlockEvent():
	if not var_0_0.blockEventDic:
...
def var_0_0.GetTransportStoryEvent():
	if not var_0_0.blockStoryDic:
...
def var_0_0.IsWorldHelpNew(arg_34_0, arg_34_1):
	if arg_34_1:
...
def var_0_0.ParsingBuffs(arg_35_0):
	local var_35_0 = {}
...
def var_0_0.CompareBuffs(arg_37_0, arg_37_1):
...
def var_0_0.FetchWorldShip(arg_38_0):
...
def var_0_0.FetchShipVO(arg_39_0):
...
def var_0_0.FetchRawShipVO(arg_40_0):
...
def var_0_0.ReqWorldCheck(arg_41_0):
	local var_41_0 = {}
...
def var_0_0.GetObstacleKey(arg_46_0):
	return bit.lshift(1, #var_0_0.ObstacleType - table.indexof(var_0_0.ObstacleType, arg_46_0))

def var_0_0.GetObstacleConfig(arg_47_0, arg_47_1):
	local var_47_0 = var_0_0.GetObstacleKey(arg_47_1)

	return bit.band(var_0_0.ObstacleConfig[arg_47_0], var_47_0) > 0

def var_0_0.RangeCheck(arg_48_0, arg_48_1, arg_48_2):
	for iter_48_0 = arg_48_0.row - arg_48_1, arg_48_0.row + arg_48_1:
		for iter_48_1 = arg_48_0.column - arg_48_1, arg_48_0.column + arg_48_1:
			if var_0_0.InFOVRange(arg_48_0.row, arg_48_0.column, iter_48_0, iter_48_1, arg_48_1):
				arg_48_2(iter_48_0, iter_48_1)

def var_0_0.CheckWorldStorySkip(arg_49_0):
...
def var_0_0.GetNShopTimeStamp():
	if not var_0_0.nShopTimestamp:
		local var_50_0 = {}
