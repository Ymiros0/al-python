...
def var_0_0.Setup(arg_2_0, arg_2_1, arg_2_2):
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_0.config.map_transfer):
...
def var_0_0.IsOpen(arg_3_0):
	return arg_3_0.GetBaseMap().IsMapOpen()

def var_0_0.GetBaseMapId(arg_4_0):
	return arg_4_0.config.chapter

def var_0_0.GetBaseMap(arg_5_0):
	return nowWorld().GetMap(arg_5_0.GetBaseMapId())

def var_0_0.GetColormaskUniqueID(arg_6_0):
	return arg_6_0.config.color_id

def var_0_0.GetAreaId(arg_7_0):
	return arg_7_0.config.regions

def var_0_0.IsPressing(arg_8_0):
	return arg_8_0.GetBaseMap().isPressing

def var_0_0.HasPort(arg_9_0, arg_9_1):
...
def var_0_0.GetPortId(arg_10_0):
...
def var_0_0.UpdateDisplayMarks(arg_12_0, arg_12_1, arg_12_2):
...
def var_0_0.GetDisplayMarks(arg_13_0):
	return arg_13_0.marks

def var_0_0.GetSairenMapId(arg_14_0):
	return arg_14_0.config.sairen_chapter[1]

def var_0_0.UpdateSairenMark(arg_15_0, arg_15_1):
	if tobool(arg_15_0.becomeSairen) != tobool(arg_15_1):
		arg_15_0.becomeSairen = arg_15_1

def var_0_0.GetAchievementAwards(arg_16_0):
