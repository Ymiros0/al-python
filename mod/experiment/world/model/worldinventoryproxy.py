...
def var_0_0.GetItem(arg_3_0, arg_3_1):
	return arg_3_0.data[arg_3_1]

def var_0_0.GetItemCount(arg_4_0, arg_4_1):
	local var_4_0 = arg_4_0.GetItem(arg_4_1)

	return var_4_0 and var_4_0.count or 0

def var_0_0.AddItem(arg_5_0, arg_5_1, arg_5_2):
...
def var_0_0.RemoveItem(arg_6_0, arg_6_1, arg_6_2):
...
def var_0_0.GetItemList(arg_8_0):
	return _(arg_8_0.data).chain().values().filter(function(arg_9_0)
		return arg_9_0.count > 0).value()

def var_0_0.CalcResetExchangeResource(arg_10_0):
	local var_10_0 = {}
...
def var_0_0.GetItemsByType(arg_11_0, arg_11_1):
