...
def var_0_0.getConfigTable(arg_3_0):
	return BaseVO.getConfigTable(arg_3_0)

def var_0_0.getWorldItemType(arg_4_0):
	return arg_4_0.getConfig("usage")

def var_0_0.getWorldItemOpenDisplay(arg_5_0):
	return arg_5_0.getConfig("open_box")

def var_0_0.getItemQuota(arg_6_0):
	return arg_6_0.getConfig("usage_arg")[1]

def var_0_0.getItemBuffID(arg_7_0):
	return arg_7_0.getConfig("usage_arg")[2]

def var_0_0.getItemRegenerate(arg_8_0):
	return arg_8_0.getConfig("usage_arg")[2]

def var_0_0.getItemStaminaRecover(arg_9_0):
	return arg_9_0.getConfig("usage_arg")[1]

def var_0_0.getItemWorldBuff(arg_10_0):
	local var_10_0 = arg_10_0.getConfig("usage_arg")

	return var_10_0[1], var_10_0[2]

def var_0_0.getItemFlagKey(arg_11_0):
	return arg_11_0.getConfig("usage_arg")[1]

def var_0_0.isDesignDrawing(arg_12_0):
	return False
