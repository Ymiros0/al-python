...
def var_0_0.DebugPrint(arg_2_0):
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_0.GetShips(True)):
...
def var_0_0.Setup(arg_7_0, arg_7_1):
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_1.commander_list or {}):
	...
	if arg_7_0.GetFleetType() == FleetType.Submarine:
		arg_7_0.row = -1
		arg_7_0.column = -1

def var_0_0.GetCost(arg_10_0):
	local var_10_0 = {
		gold = 0,
		oil = 0
	}
...
def var_0_0.FormationEqual(arg_13_0, arg_13_1):
	...
	for iter_13_0 = 1, math.max(#var_13_0, #var_13_1):
		if var_13_0[iter_13_0] != var_13_1[iter_13_0]:
			return False

	return True

def var_0_0.GetPropertiesSum(arg_16_0):
	local var_16_0 = {
		cannon = 0,
		antiAir = 0,
		air = 0,
...
def var_0_0.GetGearScoreSum(arg_17_0, arg_17_1):
	local var_17_0 = 0
...
def var_0_0.GetLevelCount(arg_18_0):
...
def var_0_0.AddShip(arg_20_0, arg_20_1, arg_20_2):
	assert(arg_20_1.class == WorldMapShip)
	assert(not _.any(arg_20_0.GetShips(True), function(arg_21_0)
		return arg_21_0.id == arg_20_1.id), "ship exist in port. " .. arg_20_1.id)
...
def var_0_0.RemoveShip(arg_22_0, arg_22_1):
	...
	for iter_22_0 = #var_22_1, 1, -1:
		if var_22_1[iter_22_0].id == arg_22_1:
			local var_22_2 = table.remove(var_22_1, iter_22_0)

			var_22_2.fleetId = None

			arg_22_0.DispatchEvent(var_0_0.EventRemoveShip, var_22_2)

			return var_22_2, iter_22_0

def var_0_0.ReplaceShip(arg_23_0, arg_23_1, arg_23_2):
	assert(arg_23_0.GetShip(arg_23_1))

	if arg_23_0.GetShip(arg_23_2.id):
...
def var_0_0.SwitchShip(arg_24_0, arg_24_1, arg_24_2):
	...
	for iter_24_0, iter_24_1 in ipairs(arg_24_0[var_24_2]):
		if iter_24_1.id == arg_24_1:
			var_24_4 = iter_24_0

		if iter_24_1.id == arg_24_2:
			var_24_5 = iter_24_0

	if var_24_4 != var_24_5:
...
def var_0_0.RepairSubmarine(arg_32_0):
...
def var_0_0.GetSpeed(arg_34_0):
	local var_34_0 = pg.gameset.world_move_initial_step.key_value

	if #arg_34_0.GetBuffsByTrap(WorldBuff.TrapVortex) > 0:
		var_34_0 = math.min(var_34_0, 1)

	for iter_34_0, iter_34_1 in ipairs(arg_34_0.GetBuffsByTrap(WorldBuff.TrapCripple)):
		var_34_0 = math.min(var_34_0, iter_34_1.GetTrapParams()[2])

	return var_34_0

def var_0_0.GetStepDurationRate(arg_35_0):
	local var_35_0 = 1

	for iter_35_0, iter_35_1 in ipairs(arg_35_0.GetBuffsByTrap(WorldBuff.TrapCripple)):
		var_35_0 = math.min(var_35_0, iter_35_1.GetTrapParams()[3] / 100)

	return 1 / var_35_0

def var_0_0.GetFOVRange(arg_36_0):
	local var_36_0 = 1

	for iter_36_0, iter_36_1 in ipairs(arg_36_0.GetBuffsByTrap(WorldBuff.TrapCripple)):
		var_36_0 = math.min(var_36_0, iter_36_1.GetTrapParams()[1] / 100)

	return math.floor(WorldConst.GetFOVRadius() * var_36_0)

def var_0_0.GetCarries(arg_37_0):
	return arg_37_0.carries

def var_0_0.ExistCarry(arg_38_0, arg_38_1):
	return _.any(arg_38_0.carries, function(arg_39_0)
		return arg_39_0.id == arg_38_1)

def var_0_0.AddCarry(arg_40_0, arg_40_1):
	table.insert(arg_40_0.carries, arg_40_1)
	arg_40_0.DispatchEvent(WorldMapFleet.EventAddCarry, arg_40_1)

def var_0_0.RemoveCarry(arg_41_0, arg_41_1):
	for iter_41_0, iter_41_1 in ipairs(arg_41_0.carries):
		if iter_41_1.id == arg_41_1:
			for iter_41_2 = #arg_41_0.carries, iter_41_0 + 1, -1:
...
def var_0_0.RemoveAllCarries(arg_42_0):
	local var_42_0

	for iter_42_0 = #arg_42_0.carries, 1, -1:
		local var_42_1 = table.remove(arg_42_0.carries)

		arg_42_0.DispatchEvent(WorldMapFleet.EventRemoveCarry, var_42_1)

def var_0_0.BuildCarryPath(arg_43_0, arg_43_1, arg_43_2, arg_43_3):
...
def var_0_0.GetBuffList(arg_49_0):
...
def var_0_0.UpdateBuffs(arg_51_0, arg_51_1):
	if arg_51_0.buffs != arg_51_1:
		local var_51_0 = nowWorld()

		if not var_51_0.isAutoFight:
			local var_51_1 = var_51_0.GetActiveMap()

			for iter_51_0, iter_51_1 in pairs(WorldConst.CompareBuffs(arg_51_0.buffs, arg_51_1).add):
				if #iter_51_1.config.trap_lua > 0:
...
def var_0_0.GetBuff(arg_52_0, arg_52_1):
	return arg_52_0.buffs[arg_52_1]

def var_0_0.GetBuffsByTrap(arg_53_0, arg_53_1):
	return underscore.filter(arg_53_0.GetBuffList(), function(arg_54_0)
		return arg_54_0.GetTrapType() == arg_53_1)

def var_0_0.HasTrapBuff(arg_55_0):
	for iter_55_0, iter_55_1 in ipairs(arg_55_0.GetBuffList()):
		if iter_55_1.GetTrapType() != 0:
			return True

	return False

def var_0_0.GetBuffFxList(arg_56_0):
	local var_56_0 = {}

	_.each(arg_56_0.GetBuffList(), function(arg_57_0)
		if arg_57_0.config.buff_fx and #arg_57_0.config.buff_fx > 0:
			table.insert(var_56_0, arg_57_0.config.buff_fx))

	return var_56_0

def var_0_0.GetWatchingBuff(arg_58_0):
	local var_58_0 = {}

	for iter_58_0, iter_58_1 in ipairs(pg.gameset.world_sairenbuff_fleeticon.description):
		var_58_0[iter_58_1] = True

	for iter_58_2, iter_58_3 in ipairs(arg_58_0.GetBuffList()):
		if var_58_0[iter_58_3.id]:
			return iter_58_3

	return None

def var_0_0.AddDefeatEnemies(arg_59_0, arg_59_1):
	if arg_59_1:
		arg_59_0.defeatEnemies = arg_59_0.defeatEnemies + 1

		arg_59_0.DispatchEvent(var_0_0.EventUpdateDefeat)

def var_0_0.ClearDefeatEnemies(arg_60_0):
	arg_60_0.defeatEnemies = 0

	arg_60_0.DispatchEvent(var_0_0.EventUpdateDefeat)

def var_0_0.getDefeatCount(arg_61_0):
	return arg_61_0.defeatEnemies

def var_0_0.getMapAura(arg_62_0):
	local var_62_0 = {}

	for iter_62_0, iter_62_1 in ipairs(arg_62_0.GetShips(True)):
		var_62_0 = table.mergeArray(var_62_0, iter_62_1.GetImportWorldShipVO().getMapAuras())

	return var_62_0

def var_0_0.getMapAid(arg_63_0):
	local var_63_0 = {}

	for iter_63_0, iter_63_1 in ipairs(arg_63_0.GetShips(True)):
		local var_63_1 = iter_63_1.GetImportWorldShipVO().getMapAids()

		for iter_63_2, iter_63_3 in ipairs(var_63_1):
...
def var_0_0.outputCommanders(arg_64_0):
	local var_64_0 = {}

	for iter_64_0, iter_64_1 in pairs(arg_64_0.commanderIds):
		assert(iter_64_1, "id is None")
...
def var_0_0.getCommanders(arg_65_0, arg_65_1):
	local var_65_0 = {}

	if arg_65_1 and arg_65_0.IsCatSalvage():
		-- block empty
	else
		for iter_65_0, iter_65_1 in pairs(arg_65_0.commanderIds):
			var_65_0[iter_65_0] = getProxy(CommanderProxy).getCommanderById(iter_65_1)

	return var_65_0

def var_0_0.getCommanderByPos(arg_66_0, arg_66_1):
	return arg_66_0.getCommanders()[arg_66_1]

def var_0_0.updateCommanderByPos(arg_67_0, arg_67_1, arg_67_2):
	if arg_67_2:
		arg_67_0.commanderIds[arg_67_1] = arg_67_2.id
	else
		arg_67_0.commanderIds[arg_67_1] = None

	arg_67_0.updateCommanderSkills()

def var_0_0.getCommandersAddition(arg_68_0):
	local var_68_0 = {}

	for iter_68_0, iter_68_1 in pairs(CommanderConst.PROPERTIES):
		local var_68_1 = 0

		for iter_68_2, iter_68_3 in pairs(arg_68_0.getCommanders()):
...
def var_0_0.getCommandersTalentDesc(arg_69_0):
	local var_69_0 = {}

	for iter_69_0, iter_69_1 in pairs(arg_69_0.getCommanders()):
		local var_69_1 = iter_69_1.getTalentsDesc()

		for iter_69_2, iter_69_3 in pairs(var_69_1):
			if var_69_0[iter_69_2]:
...
def var_0_0.findCommanderBySkillId(arg_70_0, arg_70_1):
...
def var_0_0.updateCommanderSkills(arg_73_0):
	local var_73_0 = #arg_73_0.skills

	while var_73_0 > 0:
		local var_73_1 = arg_73_0.skills[var_73_0]

		if not arg_73_0.findCommanderBySkillId(var_73_1.id) and var_73_1.GetSystem() == FleetSkill.SystemCommanderNeko:
	...
	for iter_73_0, iter_73_1 in pairs(var_73_2):
		for iter_73_2, iter_73_3 in ipairs(iter_73_1.getSkills()):
			for iter_73_4, iter_73_5 in ipairs(iter_73_3.GetTacticSkillForWorld()):
				table.insert(arg_73_0.skills, FleetSkill.New(FleetSkill.SystemCommanderNeko, iter_73_5))

def var_0_0.getSkills(arg_74_0):
	return arg_74_0.skills

def var_0_0.getSkill(arg_75_0, arg_75_1):
	return _.detect(arg_75_0.getSkills(), function(arg_76_0)
		return arg_76_0.id == arg_75_1)

def var_0_0.findSkills(arg_77_0, arg_77_1):
	return _.filter(arg_77_0.getSkills(), function(arg_78_0)
		return arg_78_0.GetType() == arg_77_1)

def var_0_0.IsCatSalvage(arg_79_0):
	return arg_79_0.catSalvageFrom and arg_79_0.catSalvageFrom > 0

def var_0_0.UpdateCatSalvage(arg_80_0, arg_80_1, arg_80_2, arg_80_3):
	...
	if arg_80_0.GetRarityState() == 2 and not var_80_0.isAutoFight:
...
def var_0_0.IsSalvageFinish(arg_81_0):
...
def var_0_0.GetRarityState(arg_83_0):
	if arg_83_0.catSalvageStep == 0:
		return 0

	if var_0_1(arg_83_0.catSalvageList[arg_83_0.catSalvageStep]):
		return 2
	else
		for iter_83_0 = 1, arg_83_0.catSalvageStep - 1:
			if var_0_1(arg_83_0.catSalvageList[iter_83_0]):
				return 1

	return 0

def var_0_0.GetSalvageScoreRarity(arg_84_0):
	local var_84_0 = 0

	for iter_84_0, iter_84_1 in ipairs(arg_84_0.catSalvageList):
		var_84_0 = var_84_0 + pg.world_catsearch_node[iter_84_1].score

	local var_84_1

	for iter_84_2, iter_84_3 in ipairs(pg.gameset.world_catsearch_score.description):
		if iter_84_3 < var_84_0:
			var_84_1 = iter_84_2
		else
			break
...
def var_0_0.GetDisplayCommander(arg_85_0):
	local var_85_0 = arg_85_0.getCommanders()

	for iter_85_0 = 1, 2:
		if arg_85_0.commanderIds[iter_85_0]:
			return getProxy(CommanderProxy).getCommanderById(arg_85_0.commanderIds[iter_85_0])

def var_0_0.HasCommander(arg_86_0, arg_86_1):
	for iter_86_0, iter_86_1 in pairs(arg_86_0.commanderIds):
		if arg_86_1 == iter_86_1:
			return True

	return False

def var_0_0.switchShip(arg_87_0, arg_87_1, arg_87_2, arg_87_3, arg_87_4, arg_87_5):
