...
def var_0_0.Setup(arg_6_0, arg_6_1):
	...
	if not arg_6_0.updateTimer:
		arg_6_0.updateTimer = Timer.New(function()
			arg_6_0.UpdateStamina(), 1, -1)
...
def var_0_0.Dispose(arg_8_0):
	...
	if arg_8_0.updateTimer:
		arg_8_0.updateTimer.Stop()

	if arg_8_0.transform:
...
def var_0_0.UpdateStamina(arg_11_0):
	...
	if var_11_2 > 0:
		...
		if arg_11_0.stamina < arg_11_0.GetMaxStamina():
...
def var_0_0.CheckUpdateShow(arg_12_0):
...
def var_0_0.Show(arg_13_0):
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_6):
				...
				if iter_13_0 > 1:
					...
					onButton(arg_13_0, var_13_5, function()
						if iter_13_1.drop.count == 0:
							...
							if var_15_0.CheckResetProgress() and PlayerPrefs.GetString("world_stamina_reset_tip", "") != var_15_2 and var_15_0.GetResetWaitingTime() < 259200 and arg_13_0.GetTotalStamina() + iter_13_1.stamina > arg_13_0.GetMaxStamina():
					...
					onButton(arg_13_0, var_13_5, function()
						if iter_13_1.drop.count < iter_13_1.cost:
							pg.TipsMgr.GetInstance().ShowTips(i18n("common_no_oil"))
						elif iter_13_1.times == 0:
							...
							if var_18_0.CheckResetProgress() and PlayerPrefs.GetString("world_stamina_reset_tip", "") != var_18_2 and var_18_0.GetResetWaitingTime() < 259200 and arg_13_0.GetTotalStamina() + iter_13_1.stamina > arg_13_0.GetMaxStamina():
							...
							seriesAsync(var_18_1, function()
								pg.m02.sendNotification(GAME.WORLD_STAMINA_EXCHANGE)), SFX_CONFIRM), SFX_PANEL)

	if arg_13_0.preSelectIndex:
		triggerToggle(var_13_3.GetChild(arg_13_0.preSelectIndex - 1), True)
	else
		local var_13_8 = 1

		for iter_13_2 = 2, #var_13_6:
			if var_13_6[iter_13_2].drop.count > 0:
				var_13_8 = iter_13_2
...
def var_0_0.GetExchangeData(arg_30_0):
...
def var_0_0.GetExchangeItems(arg_31_0):
	...
	for iter_31_0, iter_31_1 in ipairs(pg.gameset.world_supply_itemlist.description):
...
def var_0_0.ExchangeStamina(arg_32_0, arg_32_1, arg_32_2):
...
def var_0_0.GetDisplayStanima(arg_33_0):
