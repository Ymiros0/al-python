...
def var_0_0.OnInit(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.rtExit, function()
		arg_4_0.Hide(), SFX_UI_CANCEL)
	onButton(arg_4_0, arg_4_0.rtClick.Find("enemy"), function()
		arg_4_0.Hide(True), SFX_CONFIRM)
...
def var_0_0.Show(arg_12_0, arg_12_1, arg_12_2):
...
def var_0_0.Hide(arg_14_0, arg_14_1):
	if LeanTween.isTweening(arg_14_0.alphaLT):
		return
	...
	seriesAsync(var_14_0, function()
		arg_14_0.wsDragProxy.onDragFunction = None
...
def var_0_0.Setup(arg_17_0, arg_17_1, arg_17_2):
	arg_17_0.map = arg_17_1
	arg_17_0.wsDragProxy = arg_17_2

def var_0_0.DisplayWindow(arg_18_0, arg_18_1, arg_18_2):
	if isActive(arg_18_0.rtPanel) and arg_18_0.attachment == arg_18_1:
		arg_18_0.HideWindow()
	else
...
def var_0_0.Update(arg_22_0, arg_22_1):
	if arg_22_0.attachment != arg_22_1:
		arg_22_0.attachment = arg_22_1

		arg_22_0.OnUpdate()

def var_0_0.OnUpdate(arg_23_0):
	...
	if WorldMapAttachment.IsEnemyType(var_23_1.type):
		var_23_5 = True
		var_23_6 = False
		var_23_3 = var_23_1.GetBuffList()
		var_23_4 = var_23_0.GetBuffList(WorldMap.FactionEnemy, var_23_1)

		if var_23_1.config.difficulty == ys.Battle.BattleConst.Difficulty.WORLD:
		...
		if var_23_8 == 1 or var_23_8 == 3:
			...
			setText(arg_23_0.rtInfo.Find("Text"), var_23_1.config.scan_desc)
	elif var_23_1.type == WorldMapAttachment.TypeTrap:
		var_23_5 = True
		var_23_6 = True
	...
	elif var_23_1.type == WorldMapAttachment.TypePort:
