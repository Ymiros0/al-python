...
def var_0_0.UpdateAtlas(arg_3_0, arg_3_1):
	if arg_3_0.atlas != arg_3_1:
...
def var_0_0.LoadModel(arg_6_0, arg_6_1):
	local var_6_0 = {}

	if not arg_6_0.tfModel:
...
def var_0_0.LoadScene(arg_11_0, arg_11_1):
	SceneOpMgr.Inst.LoadSceneAsync("scenes/worldmap3d", "worldmap3d", LoadSceneMode.Additive, function(arg_12_0, arg_12_1)
		...
		arg_11_0.dragTrigger.AddDragFunc(function(arg_13_0, arg_13_1)
			...
			if not arg_11_0.nowArea or arg_11_0.CheckIsTweening():
				return

			if arg_11_0.selectEntrance:
...
def var_0_0.ReturnScene(arg_16_0):
	arg_16_0.ReturnModel()

	if arg_16_0.transform:
		...
		arg_16_0.cmPointer = None

def var_0_0.ShowOrHide(arg_17_0, arg_17_1):
...
def var_0_0.GetOffsetMapPos(arg_18_0):
...
def var_0_0.UpdateSelect(arg_19_0, arg_19_1, arg_19_2, arg_19_3):
	if arg_19_1:
		arg_19_0.nowArea = arg_19_1.GetAreaId()

		arg_19_0.FocusPos(Vector2(arg_19_1.config.area_pos[1], arg_19_1.config.area_pos[2]) + arg_19_0.GetOffsetMapPos(), None, 1, True, function()
...
def var_0_0.UpdateModelMask(arg_21_0):
	var_0_0.super.UpdateModelMask(arg_21_0)
	arg_21_0.UpdateAreaLock()

def var_0_0.UpdateEntranceMask(arg_22_0, arg_22_1):
...
def var_0_0.OnUpdateProgress(arg_23_0, arg_23_1, arg_23_2, arg_23_3):
	var_0_0.super.OnUpdateProgress(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	arg_23_0.UpdateAreaLock()

def var_0_0.UpdateAreaLock(arg_24_0):
	for iter_24_0 = 1, 5:
		...
		if var_24_0 and arg_24_0.areaLockPressingAward[iter_24_0]:
			for iter_24_1, iter_24_2 in ipairs(arg_24_0.areaLockPressingAward[iter_24_0]):
				arg_24_0.entranceTplDic[iter_24_2].UpdatePressingAward()

			arg_24_0.areaLockPressingAward[iter_24_0] = None

def var_0_0.OnUpdateActiveEntrance(arg_25_0, arg_25_1, arg_25_2, arg_25_3):
...
def var_0_0.OnUpdatePressingAward(arg_26_0, arg_26_1, arg_26_2, arg_26_3):
	arg_26_3 = arg_26_3 or arg_26_0.atlas.transportDic

	for iter_26_0, iter_26_1 in pairs(arg_26_3):
		if iter_26_1:
			local var_26_0 = arg_26_0.atlas.GetEntrance(iter_26_0).GetAreaId()

			if nowWorld().CheckAreaUnlock(var_26_0):
...
def var_0_0.OnUpdatePortMark(arg_27_0, arg_27_1, arg_27_2, arg_27_3):
	for iter_27_0, iter_27_1 in pairs(arg_27_3):
		if iter_27_1:
			arg_27_0.entranceTplDic[iter_27_0].UpdatePort(arg_27_0.atlas.GetEntrancePortInfo(iter_27_0))

def var_0_0.NewEntranceTplDic(arg_28_0):
	for iter_28_0, iter_28_1 in pairs(arg_28_0.atlas.entranceDic):
		arg_28_0.entranceTplDic[iter_28_1.id] = arg_28_0.NewEntranceTpl(iter_28_1)

def var_0_0.DisposeEntranceTplDic(arg_29_0):
	WPool.ReturnArray(_.values(arg_29_0.entranceTplDic))

	arg_29_0.entranceTplDic = {}

def var_0_0.NewEntranceTpl(arg_30_0, arg_30_1):
...
def var_0_0.FindEntranceTpl(arg_31_0, arg_31_1):
	return arg_31_0.entranceTplDic[arg_31_1.id]

def var_0_0.UpdateScale(arg_32_0, arg_32_1):
...
def var_0_0.FocusPos(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4, arg_33_5):
	if arg_33_0.twRotateId:
		LeanTween.cancel(arg_33_0.twRotateId)

		arg_33_0.twRotateId = None
...
def var_0_0.FocusPosInArea(arg_37_0, arg_37_1, arg_37_2, arg_37_3):
	if arg_37_1:
...
def var_0_0.SwitchArea(arg_38_0, arg_38_1, arg_38_2, arg_38_3):
	local var_38_0 = {}

	if arg_38_2 and tobool(arg_38_1) != tobool(arg_38_0.nowArea):
...
def var_0_0.SwitchMode(arg_44_0, arg_44_1, arg_44_2, arg_44_3):
	local function var_44_0(arg_45_0)
		...
		local var_45_1 = LeanTween.value(go(arg_44_0.tfAreaScene), arg_44_1 and 1 or 0, arg_44_1 and 0 or 1, var_0_0.baseDuration).setOnUpdate(System.Action_float(function(arg_46_0)
			var_45_0.alpha = arg_46_0)).setOnComplete(System.Action(function()
			var_45_0.alpha = 1

			var_45_0.UpdateAlpha()
			setActive(arg_44_0.tfAreaScene, not arg_44_1)

			return arg_45_0())).uniqueId
	...
	local function var_44_1(arg_48_0)
		...
		local var_48_1 = LeanTween.value(go(arg_44_0.tfMapScene), arg_44_1 and 0 or 1, arg_44_1 and 1 or 0, var_0_0.baseDuration).setOnUpdate(System.Action_float(function(arg_49_0)
			var_48_0.alpha = arg_49_0)).setOnComplete(System.Action(function()
			var_48_0.alpha = 1

			var_48_0.UpdateAlpha()
			setActive(arg_44_0.tfMapScene, arg_44_1)

			return arg_48_0())).uniqueId
	...
	local function var_44_2(arg_51_0)
		...
		table.insert(var_51_0, function(arg_52_0)
			...
			local var_52_2 = LeanTween.value(go(var_52_0), arg_44_1 and 1 or 0, arg_44_1 and 0 or 1, var_51_1).setOnUpdate(System.Action_float(function(arg_53_0)
				var_52_1.SetFloat("_Invisible", arg_53_0))).setOnComplete(System.Action(function()
		...
		table.insert(var_51_0, function(arg_55_0)
			...
			local var_55_2 = LeanTween.value(go(var_55_0), arg_44_1 and 1 or 0, arg_44_1 and 0 or 1, var_51_1).setOnUpdate(System.Action_float(function(arg_56_0)
				var_55_1.alpha = arg_56_0)).setOnComplete(System.Action(function()
				var_55_1.alpha = 1
...
def var_0_0.BreathRotate(arg_61_0, arg_61_1):
	if arg_61_0.twRotateId:
		LeanTween.cancel(arg_61_0.twRotateId)

		arg_61_0.twRotateId = None
	...
	arg_61_0.twRotateId = LeanTween.rotateY(go(arg_61_0.tfEntity), var_0_0.LowRotation, var_0_0.BreathTime / 2).setEase(LeanTweenType.easeOutSine).setOnComplete(System.Action(function()
		var_61_1())).setDelay(1).uniqueId

def var_0_0.CheckIsTweening(arg_65_0):
	while #arg_65_0.twFocusIds > 0 and not LeanTween.isTweening(arg_65_0.twFocusIds[1]):
		table.remove(arg_65_0.twFocusIds, 1)

	return arg_65_0.isTransAnim or #arg_65_0.twFocusIds > 0

def var_0_0.ActiveTrans(arg_66_0, arg_66_1):
	if arg_66_0.entranceTplDic[arg_66_1.id].portCamp:
		-- block empty
	else
...
def var_0_0.DisplayTransport(arg_69_0, arg_69_1, arg_69_2):
	local var_69_0 = {}

	for iter_69_0, iter_69_1 in pairs(arg_69_0.atlas.transportDic):
		if iter_69_1 and not arg_69_1[iter_69_0]:
			var_69_0[iter_69_0] = True

	arg_69_0.UpdateTransMark(var_69_0, arg_69_2)

def var_0_0.UpdateTransMark(arg_70_0, arg_70_1, arg_70_2):
	for iter_70_0, iter_70_1 in pairs(arg_70_1):
		if iter_70_1:
			arg_70_0.isTransAnim = True

			arg_70_0.ActiveTrans(arg_70_0.atlas.GetEntrance(iter_70_0))

	if arg_70_0.isTransAnim:
...
def var_0_0.UpdateActiveMark(arg_72_0):
