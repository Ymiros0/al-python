...
def var_0_0.Update(arg_7_0, arg_7_1):
	...
	if arg_7_1 == None or arg_7_1 == WorldMapCell.EventUpdateInFov or arg_7_1 == WorldMapCell.EventUpdateFog:
		setActive(arg_7_0.rtAttachments, var_7_0.GetInFOV() and not var_7_0.InFog())

	if arg_7_1 == None or arg_7_1 == WorldMapCell.EventUpdateFog:
		if arg_7_0.fogTimer:
			arg_7_0.wsTimer.RemoveInMapTimer(arg_7_0.fogTimer)

			arg_7_0.fogTimer = None
		...
		if var_7_0.InFog():
			if arg_7_1 and var_7_3 > 0:
				...
				arg_7_0.fogTimer = arg_7_0.wsTimer.AddInMapTimer(function()
					...
					arg_7_0.wsTimer.AddInMapTween(arg_7_0.fogUid), var_7_3)

				arg_7_0.fogTimer.Start()
			else
				setCanvasGroupAlpha(arg_7_0.rtFog, 1)
		elif arg_7_1 and var_7_3 > 0:
			arg_7_0.fogTimer = arg_7_0.wsTimer.AddInMapTimer(function()
	...
	if arg_7_1 == None or arg_7_1 == WorldMapCell.EventUpdateInFov or arg_7_1 == WorldMapCell.EventUpdateDiscovered:
		if arg_7_0.maskTimer:
			arg_7_0.wsTimer.RemoveInMapTimer(arg_7_0.maskTimer)

			arg_7_0.maskTimer = None

		if arg_7_0.maskUid:
			arg_7_0.wsTimer.RemoveInMapTween(arg_7_0.maskUid)

			arg_7_0.maskUid = None
		...
		if var_7_0.GetInFOV():
			if arg_7_1 and var_7_3 > 0:
				arg_7_0.maskTimer = arg_7_0.wsTimer.AddInMapTimer(function()
					...
					arg_7_0.wsTimer.AddInMapTween(arg_7_0.maskUid), var_7_3)
...
def var_0_0.UpdateFogImage(arg_12_0):
...
def var_0_0.GetWorldPos(arg_13_0):
