...
def var_0_0.UpdateObject(arg_3_0, arg_3_1):
	assert(arg_3_1.GetModelAngles and arg_3_1.UpdateModelAngles and arg_3_1.UpdateModelAction)

	arg_3_0.wsObject = arg_3_1

def var_0_0.UpdateAction(arg_4_0, arg_4_1):
	arg_4_0.moveAction = arg_4_1

def var_0_0.UpdateDirType(arg_5_0, arg_5_1):
	arg_5_0.dirType = arg_5_1

def var_0_0.StartMove(arg_6_0, arg_6_1, arg_6_2, arg_6_3):
...
def var_0_0.MoveStep(arg_7_0):
	...
	if arg_7_0.dirType == WorldConst.DirType4:
		if var_7_3.column < var_7_2.column:
			var_7_5.z = 180
		elif var_7_3.column > var_7_2.column:
			var_7_5.z = 0
		elif var_7_3.row < var_7_2.row:
			var_7_5.z = 90
		elif var_7_3.row > var_7_2.row:
			var_7_5.z = 270

		var_7_0.UpdateModelAngles(var_7_5)
	elif arg_7_0.dirType == WorldConst.DirType2:
		if var_7_3.column < var_7_2.column or var_7_3.column == var_7_2.column and var_7_4.column < var_7_2.column:
			var_7_5.y = 180
		elif var_7_3.column != var_7_2.column or var_7_4.column != var_7_2.column:
			var_7_5.y = 0
	...
	arg_7_0.twId = LeanTween.value(var_7_0.transform.gameObject, 0, 1, var_7_3.duration).setOnUpdate(System.Action_float(function(arg_8_0)
		...
		if var_7_0.rtShadow:
			var_7_0.rtShadow.localPosition = Vector3(0, -var_8_2, 0))).setOnComplete(System.Action(function()
		arg_7_0.step = arg_7_0.step + 1

		if arg_7_0.step >= #var_7_1:
			arg_7_0.twId = None
			...
			onDelayTick(function()
				arg_7_0.MoveStep(), 0.015))).uniqueId

	arg_7_0.FlushPaused()

def var_0_0.UpdatePaused(arg_11_0, arg_11_1):
	if arg_11_0.paused != arg_11_1:
		arg_11_0.paused = arg_11_1

		arg_11_0.FlushPaused()

def var_0_0.FlushPaused(arg_12_0):
	if arg_12_0.paused:
...
def var_0_0.CalcUpOffset(arg_13_0, arg_13_1, arg_13_2):
...
def var_0_0.IsMoving(arg_14_0):
	return arg_14_0.twId != None
