...
def var_0_0.Init(arg_3_0):
	...
	onToggle(arg_3_0, arg_3_0.toggleSkipPrecombat, function(arg_4_0)
		PlayerPrefs.SetInt("world_skip_precombat", arg_4_0 and 1 or 0), SFX_PANEL)
...
def var_0_0.Update(arg_5_0, arg_5_1, arg_5_2):
	if arg_5_0.entrance != arg_5_1 or arg_5_0.map != arg_5_2 or arg_5_0.gid != arg_5_2.gid:
...
def var_0_0.RemoveFleetListener(arg_9_0, arg_9_1):
	if arg_9_1:
...
def var_0_0.OnUpdateSelectedFleet(arg_10_0, arg_10_1):
	local var_10_0 = arg_10_0.map.GetFleet()

	if not arg_10_1 or arg_10_0.fleet != var_10_0:
...
def var_0_0.UpdateBtns(arg_19_0):
...
def var_0_0.OnUpdateInfoBtnTip(arg_20_0):
...
def var_0_0.OnUpdateHelpBtnTip(arg_22_0, arg_22_1):
