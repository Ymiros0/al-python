...
def var_0_0.IsLinkType(arg_1_0):
	return arg_1_0 > var_0_0.LINK

def var_0_0.IsMeta(arg_2_0):
	return arg_2_0 == var_0_0.META

def var_0_0.Nation2Print(arg_3_0):
...
def var_0_0.Nation2Side(arg_4_0):
	if not var_0_0.side:
		var_0_0.side = {
			[0] = "West",
			"West",
...
def var_0_0.Nation2Name(arg_6_0):
	if not var_0_0.nationName:
		var_0_0.nationName = {
...
def var_0_0.Nation2facionName(arg_7_0):
	if not var_0_0.facionName:
		var_0_0.facionName = {
