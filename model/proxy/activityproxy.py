...
def var_0_0.register(arg_1_0):
	arg_1_0.on(11200, function(arg_2_0)
		...
		if arg_2_0.hx_list:
			for iter_2_0, iter_2_1 in ipairs(arg_2_0.hx_list):
				table.insert(arg_1_0.hxList, iter_2_1)

		for iter_2_2, iter_2_3 in ipairs(arg_2_0.activity_list):
			if not pg.activity_template[iter_2_3.id]:
				...
				if var_2_1 == ActivityConst.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2:
					if var_2_0.checkBattleTimeInBossAct():
						arg_1_0.InitActtivityFleet(var_2_0, iter_2_3)
				elif var_2_1 == ActivityConst.ACTIVITY_TYPE_CHALLENGE:
					arg_1_0.InitActtivityFleet(var_2_0, iter_2_3)
				elif var_2_1 == ActivityConst.ACTIVITY_TYPE_PARAMETER:
					arg_1_0.addActivityParameter(var_2_0)
				elif var_2_1 == ActivityConst.ACTIVITY_TYPE_BUFF:
					table.insert(arg_1_0.buffActs, var_2_0.id)
				elif var_2_1 == ActivityConst.ACTIVITY_TYPE_BOSSRUSH:
					arg_1_0.InitActtivityFleet(var_2_0, iter_2_3)
				elif var_2_1 == ActivityConst.ACTIVITY_TYPE_BOSSSINGLE:
					arg_1_0.InitActtivityFleet(var_2_0, iter_2_3)
				elif var_2_1 == ActivityConst.ACTIVITY_TYPE_EVENT_SINGLE:
		...
		for iter_2_4, iter_2_5 in pairs(arg_1_0.data):
			arg_1_0.sendNotification(GAME.ACTIVITY_BE_UPDATED, {
				isInit = True,
				activity = iter_2_5
			})

		if arg_1_0.data[ActivityConst.MILITARY_EXERCISE_ACTIVITY_ID]:
	...
	arg_1_0.on(11201, function(arg_4_0)
		...
		if var_4_1 == ActivityConst.ACTIVITY_TYPE_PARAMETER:
			arg_1_0.addActivityParameter(var_4_0)

		if not arg_1_0.data[var_4_0.id]:
			arg_1_0.addActivity(var_4_0)
		else
			arg_1_0.updateActivity(var_4_0)

		if var_4_1 == ActivityConst.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2:
...
def var_0_0.getAliveActivityByType(arg_11_0, arg_11_1):
	for iter_11_0, iter_11_1 in pairs(arg_11_0.data):
		if iter_11_1.getConfig("type") == arg_11_1 and not iter_11_1.isEnd():
			return iter_11_1

def var_0_0.getActivityByType(arg_12_0, arg_12_1):
	for iter_12_0, iter_12_1 in pairs(arg_12_0.data):
		if iter_12_1.getConfig("type") == arg_12_1:
			return iter_12_1

def var_0_0.getActivitiesByType(arg_13_0, arg_13_1):
	local var_13_0 = {}

	for iter_13_0, iter_13_1 in pairs(arg_13_0.data):
		if iter_13_1.getConfig("type") == arg_13_1:
			table.insert(var_13_0, iter_13_1)

	return var_13_0

def var_0_0.getActivitiesByTypes(arg_14_0, arg_14_1):
	local var_14_0 = {}

	for iter_14_0, iter_14_1 in pairs(arg_14_0.data):
		if table.contains(arg_14_1, iter_14_1.getConfig("type")):
			table.insert(var_14_0, iter_14_1)

	return var_14_0

def var_0_0.GetEarliestActByType(arg_15_0, arg_15_1):
...
def var_0_0.getMilitaryExerciseActivity(arg_18_0):
	local var_18_0

	for iter_18_0, iter_18_1 in pairs(arg_18_0.data):
		if iter_18_1.getConfig("type") == ActivityConst.ACTIVITY_TYPE_MILITARY_EXERCISE:
			var_18_0 = iter_18_1
...
def var_0_0.getPanelActivities(arg_19_0):
	local function var_19_0(arg_20_0)
		...
		if var_20_1:
			if var_20_0 == ActivityConst.ACTIVITY_TYPE_CHARGEAWARD:
				var_20_1 = arg_20_0.data2 == 0
			elif var_20_0 == ActivityConst.ACTIVITY_TYPE_PROGRESSLOGIN:
	...
	for iter_19_0, iter_19_1 in pairs(arg_19_0.data):
		if var_19_0(iter_19_1):
...
def var_0_0.checkHxActivity(arg_22_0, arg_22_1):
	if arg_22_0.hxList and #arg_22_0.hxList > 0:
		for iter_22_0 = 1, #arg_22_0.hxList:
			if arg_22_0.hxList[iter_22_0] == arg_22_1:
				return True

	return False

def var_0_0.getBannerDisplays(arg_23_0):
	return _(pg.activity_banner.all).chain().map(function(arg_24_0)
		return pg.activity_banner[arg_24_0]).filter(function(arg_25_0)
		return pg.TimeMgr.GetInstance().inTime(arg_25_0.time) and arg_25_0.type != GAMEUI_BANNER_9 and arg_25_0.type != GAMEUI_BANNER_11 and arg_25_0.type != GAMEUI_BANNER_10 and arg_25_0.type != GAMEUI_BANNER_12 and arg_25_0.type != GAMEUI_BANNER_13).value()

def var_0_0.getActiveBannerByType(arg_26_0, arg_26_1):
	...
	for iter_26_0, iter_26_1 in ipairs(var_26_0):
		...
		if pg.TimeMgr.GetInstance().inTime(var_26_1.time):
			return var_26_1

	return None

def var_0_0.getNoticeBannerDisplays(arg_27_0):
	return _.map(pg.activity_banner_notice.all, function(arg_28_0)
		return pg.activity_banner_notice[arg_28_0])

def var_0_0.findNextAutoActivity(arg_29_0):
	local var_29_0
	local var_29_1 = pg.TimeMgr.GetInstance()
	local var_29_2 = var_29_1.GetServerTime()

	for iter_29_0, iter_29_1 in ipairs(arg_29_0.getPanelActivities()):
		if iter_29_1.isShow() and not iter_29_1.autoActionForbidden:
			local var_29_3 = iter_29_1.getConfig("type")

			if var_29_3 == ActivityConst.ACTIVITY_TYPE_7DAYSLOGIN:
				local var_29_4 = iter_29_1.getConfig("config_id")
				local var_29_5 = pg.activity_7_day_sign[var_29_4].front_drops

				if iter_29_1.data1 < #var_29_5 and not var_29_1.IsSameDay(var_29_2, iter_29_1.data2) and var_29_2 > iter_29_1.data2:
					var_29_0 = iter_29_1

					break
			elif var_29_3 == ActivityConst.ACTIVITY_TYPE_PROGRESSLOGIN:
				local var_29_6 = getProxy(ChapterProxy)

				if iter_29_1.data1 < 7 and not var_29_1.IsSameDay(var_29_2, iter_29_1.data2) or iter_29_1.data1 == 7 and not iter_29_1.achieved and var_29_6.isClear(204):
					var_29_0 = iter_29_1

					break
			elif var_29_3 == ActivityConst.ACTIVITY_TYPE_MONTHSIGN:
				local var_29_7 = pg.TimeMgr.GetInstance().STimeDescS(var_29_2, "*t")

				iter_29_1.setSpecialData("reMonthSignDay", None)

				if var_29_7.year != iter_29_1.data1 or var_29_7.month != iter_29_1.data2:
					...
					break
				elif not table.contains(iter_29_1.data1_list, var_29_7.day):
					var_29_0 = iter_29_1

					break
				elif var_29_7.day > #iter_29_1.data1_list and pg.activity_month_sign[iter_29_1.data2].resign_count > iter_29_1.data3:
					for iter_29_2 = var_29_7.day, 1, -1:
						if not table.contains(iter_29_1.data1_list, iter_29_2):
							iter_29_1.setSpecialData("reMonthSignDay", iter_29_2)

							break

					var_29_0 = iter_29_1
			elif iter_29_1.id == ActivityConst.SHADOW_PLAY_ID and iter_29_1.clientData1 == 0:
				...
				if var_29_10 and not var_29_10.isReceive():
					var_29_0 = iter_29_1

					break

	if not var_29_0:
		for iter_29_3, iter_29_4 in pairs(arg_29_0.data):
			if not iter_29_4.isShow() and iter_29_4.getConfig("type") == ActivityConst.ACTIVITY_TYPE_7DAYSLOGIN:
				local var_29_11 = iter_29_4.getConfig("config_id")
				local var_29_12 = pg.activity_7_day_sign[var_29_11].front_drops

				if iter_29_4.data1 < #var_29_12 and not var_29_1.IsSameDay(var_29_2, iter_29_4.data2) and var_29_2 > iter_29_4.data2:
					var_29_0 = iter_29_4
...
def var_0_0.findRefluxAutoActivity(arg_30_0):
	local var_30_0 = arg_30_0.getActivityByType(ActivityConst.ACTIVITY_TYPE_REFLUX)

	if var_30_0 and not var_30_0.isEnd() and not var_30_0.autoActionForbidden:
		local var_30_1 = pg.TimeMgr.GetInstance()

		if var_30_0.data1_list[2] < #pg.return_sign_template.all and not var_30_1.IsSameDay(var_30_1.GetServerTime(), var_30_0.data1_list[1]):
			return 1

def var_0_0.existRefluxAwards(arg_31_0):
	local var_31_0 = arg_31_0.getActivityByType(ActivityConst.ACTIVITY_TYPE_REFLUX)

	if var_31_0 and not var_31_0.isEnd():
		local var_31_1 = pg.return_pt_template

		for iter_31_0 = #var_31_1.all, 1, -1:
			local var_31_2 = var_31_1.all[iter_31_0]
			local var_31_3 = var_31_1[var_31_2]

			if var_31_0.data3 >= var_31_3.pt_require and var_31_2 > var_31_0.data4:
				return True

		local var_31_4 = getProxy(TaskProxy)
		local var_31_5 = _(var_31_0.getConfig("config_data")[7]).chain().map(function(arg_32_0)
			return arg_32_0[2]).flatten().map(function(arg_33_0)
			return var_31_4.getTaskById(arg_33_0) or var_31_4.getFinishTaskById(arg_33_0) or False).filter(function(arg_34_0)
			return not not arg_34_0).value()

		if _.any(var_31_5, function(arg_35_0)
			return arg_35_0.getTaskStatus() == 1):
			return True

def var_0_0.getActivityById(arg_36_0, arg_36_1):
	return Clone(arg_36_0.data[arg_36_1])

def var_0_0.RawGetActivityById(arg_37_0, arg_37_1):
	return arg_37_0.data[arg_37_1]

def var_0_0.updateActivity(arg_38_0, arg_38_1):
	...
	if arg_38_1.getConfig("type") == ActivityConst.ACTIVITY_TYPE_PT_CRUSING:
		local var_38_0 = pg.battlepass_event_pt[arg_38_1.id].target

		if arg_38_0.data[arg_38_1.id].data1 < var_38_0[#var_38_0] and arg_38_1.data1 - arg_38_0.data[arg_38_1.id].data1 > 0:
...
def var_0_0.addActivity(arg_39_0, arg_39_1):
	assert(arg_39_0.data[arg_39_1.id] == None, "activity already exist" .. arg_39_1.id)
...
def var_0_0.getBuildActivityCfgByID(arg_43_0, arg_43_1):
...
def var_0_0.addVitemById(arg_49_0, arg_49_1, arg_49_2):
	...
	if var_49_1 != 0:
		...
		if var_49_2 and not var_49_2.isEnd():
			PlayerResChangeCommand.UpdateActivity(var_49_2, arg_49_2)

def var_0_0.monitorTaskList(arg_50_0, arg_50_1):
	if arg_50_1 and not arg_50_1.isEnd() and arg_50_1.getConfig("type") == ActivityConst.ACTIVITY_TYPE_TASK_LIST_MONITOR:
		local var_50_0 = arg_50_1.getConfig("config_data")[1] or {}

		if getProxy(TaskProxy).isReceiveTasks(var_50_0):
			pg.m02.sendNotification(GAME.ACTIVITY_OPERATION, {
				cmd = 1,
				activity_id = arg_50_1.id
			})

def var_0_0.InitActtivityFleet(arg_51_0, arg_51_1, arg_51_2):
	getProxy(FleetProxy).addActivityFleet(arg_51_1, arg_51_2.group_list)

def var_0_0.InitActivityBossData(arg_52_0, arg_52_1):
	...
	for iter_52_0, iter_52_1 in pairs(var_52_0.normal_expedition_drop_num or {}):
		for iter_52_2, iter_52_3 in pairs(iter_52_1[1]):
...
def var_0_0.AddInstagramTimer(arg_53_0, arg_53_1):
	...
	if var_53_0:
		...
		if var_53_2 <= 0:
			...
			arg_53_0.instagramTimer = Timer.New(function()
				var_53_3()
				arg_53_0.RemoveInstagramTimer(), var_53_2, 1)

			arg_53_0.instagramTimer.Start()

def var_0_0.RemoveInstagramTimer(arg_56_0):
	if arg_56_0.instagramTimer:
		arg_56_0.instagramTimer.Stop()

		arg_56_0.instagramTimer = None

def var_0_0.RegisterRequestTime(arg_57_0, arg_57_1, arg_57_2):
	if not arg_57_1 or arg_57_1 <= 0:
		return

	arg_57_0.requestTime[arg_57_1] = arg_57_2

def var_0_0.remove(arg_58_0):
	arg_58_0.RemoveInstagramTimer()

def var_0_0.addActivityParameter(arg_59_0, arg_59_1):
...
def var_0_0.getActivityParameter(arg_60_0, arg_60_1):
	if arg_60_0.params[arg_60_1]:
		local var_60_0, var_60_1 = unpack(arg_60_0.params[arg_60_1])

		if not (var_60_1 > 0) or not (var_60_1 <= pg.TimeMgr.GetInstance().GetServerTime()):
			return var_60_0

def var_0_0.IsShowFreeBuildMark(arg_61_0, arg_61_1):
	for iter_61_0, iter_61_1 in ipairs(arg_61_0.getActivitiesByType(ActivityConst.ACTIVITY_TYPE_BUILD_FREE)):
		if iter_61_1 and not iter_61_1.isEnd() and iter_61_1.data1 > 0 and iter_61_1.stopTime - pg.TimeMgr.GetInstance().GetServerTime() < 259200 and tobool(arg_61_1) == (PlayerPrefs.GetString("Free_Build_Ticket_" .. iter_61_1.id, "") == pg.TimeMgr.GetInstance().CurrentSTimeDesc("%Y/%m/%d")):
			return iter_61_1

	return False

def var_0_0.getBuildFreeActivityByBuildId(arg_62_0, arg_62_1):
	for iter_62_0, iter_62_1 in ipairs(arg_62_0.getActivitiesByType(ActivityConst.ACTIVITY_TYPE_BUILD_FREE)):
		if underscore.any(iter_62_1.getConfig("config_data"), function(arg_63_0)
			return arg_63_0 == arg_62_1):
			return iter_62_1

def var_0_0.getBuildPoolActivity(arg_64_0, arg_64_1):
	if arg_64_1.IsActivity():
		return arg_64_0.getActivityById(arg_64_1.activityId)

def var_0_0.getEnterReadyActivity(arg_65_0):
	local var_65_0 = {
	...
	for iter_65_2, iter_65_3 in pairs(arg_65_0.data):
		local var_65_3 = iter_65_3.getConfig("type")

		if var_65_2[var_65_3] and not iter_65_3.isEnd() and not existCall(var_65_0[var_65_3], iter_65_3):
			var_65_2[var_65_3] = math.max(var_65_2[var_65_3], iter_65_2)

	table.sort(var_65_1)

	for iter_65_4, iter_65_5 in ipairs(var_65_1):
		if var_65_2[iter_65_5] > 0:
			return arg_65_0.data[var_65_2[iter_65_5]]

def var_0_0.AtelierActivityAllSlotIsEmpty(arg_67_0):
	local var_67_0 = getProxy(ActivityProxy).getActivityByType(ActivityConst.ACTIVITY_TYPE_ATELIER_LINK)

	if not var_67_0 or var_67_0.isEnd():
		return False

	local var_67_1 = var_67_0.GetSlots()

	for iter_67_0, iter_67_1 in pairs(var_67_1):
		if iter_67_1[1] != 0:
			return False

	return True

def var_0_0.OwnAtelierActivityItemCnt(arg_68_0, arg_68_1, arg_68_2):
	local var_68_0 = getProxy(ActivityProxy).getActivityByType(ActivityConst.ACTIVITY_TYPE_ATELIER_LINK)

	if not var_68_0 or var_68_0.isEnd():
		return False
...
def var_0_0.refreshActivityBuffs(arg_69_0):
	arg_69_0.actBuffs = {}

	local var_69_0 = 1

	while var_69_0 <= #arg_69_0.buffActs:
		local var_69_1 = arg_69_0.data[arg_69_0.buffActs[var_69_0]]

		if not var_69_1 or var_69_1.isEnd():
...
def var_0_0.GetActivityBossRuntime(arg_83_0, arg_83_1):
	if not arg_83_0.extraDatas[arg_83_1]:
...
def var_0_0.GetTaskActivities(arg_84_0):
	local var_84_0 = {}

	table.Foreach(Activity.GetType2Class(), function(arg_85_0, arg_85_1)
		if not isa(arg_85_1, ITaskActivity):
			return
...
def var_0_0.GetActBossLinkPTActID(arg_89_0, arg_89_1):
	local var_89_0 = table.Find(arg_89_0.data, function(arg_90_0, arg_90_1)
		if arg_90_1.getConfig("type") != ActivityConst.ACTIVITY_TYPE_PT_BUFF:
			return
...
def var_0_0.CheckDailyEventRequest(arg_91_0, arg_91_1):
	if arg_91_1.CheckDailyEventRequest():
