...
def var_0_0.register(arg_1_0):
	...
	for iter_1_0 = 1, var_0_0.MAX_PREFAB_FLEET:
	...
	for iter_1_2, iter_1_3 in ipairs(pg.commander_data_create_material.all):
	...
	arg_1_0.on(25039, function(arg_3_0)
		for iter_3_0, iter_3_1 in ipairs(arg_3_0.commander_list):
			local var_3_0 = Commander.New(iter_3_1)

			arg_1_0.addCommander(var_3_0)
			table.insert(arg_1_0.newCommanderList, var_3_0))

def var_0_0.GetNewestCommander(arg_4_0, arg_4_1, arg_4_2):
	local var_4_0 = defaultValue(arg_4_2, True)

	if arg_4_1 >= #arg_4_0.newCommanderList:
		return arg_4_0.newCommanderList
	else
		local var_4_1 = {}

		for iter_4_0 = #arg_4_0.newCommanderList - arg_4_1 + 1, #arg_4_0.newCommanderList:
...
def var_0_0.resetBoxUseCnt(arg_15_0):
	arg_15_0.boxUsageCount = 0

	arg_15_0.sendNotification(var_0_0.RESERVE_CNT_UPDATED, 0)

def var_0_0.updateBox(arg_16_0, arg_16_1):
	arg_16_0.boxes[arg_16_1.id] = arg_16_1

def var_0_0.addBox(arg_17_0, arg_17_1):
	arg_17_0.boxes[arg_17_1.id] = arg_17_1

def var_0_0.getBoxes(arg_18_0):
	local var_18_0 = {}

	for iter_18_0, iter_18_1 in ipairs(arg_18_0.boxes):
		table.insert(var_18_0, iter_18_1)

	return var_18_0

def var_0_0.getBoxById(arg_19_0, arg_19_1):
	assert(arg_19_0.boxes[arg_19_1], "attemp to get a None box" .. arg_19_1)

	return arg_19_0.boxes[arg_19_1]

def var_0_0.getCommanderById(arg_20_0, arg_20_1):
	local var_20_0 = arg_20_0.data[arg_20_1]

	if var_20_0:
		return var_20_0.clone()

def var_0_0.RawGetCommanderById(arg_21_0, arg_21_1):
	local var_21_0 = arg_21_0.data[arg_21_1]

	if var_21_0:
		return var_21_0

def var_0_0.GetSameConfigIdCommanderCount(arg_22_0, arg_22_1):
	local var_22_0 = 0

	for iter_22_0, iter_22_1 in pairs(arg_22_0.data):
		if iter_22_1.configId == arg_22_1:
			var_22_0 = var_22_0 + 1

	return var_22_0

def var_0_0.addCommander(arg_23_0, arg_23_1):
...
def var_0_0.updateCommander(arg_24_0, arg_24_1):
	assert(arg_24_0.data[arg_24_1.id], "commander can not be None")
...
def var_0_0.removeCommanderById(arg_25_0, arg_25_1):
	arg_25_0.checkPrefabFleet(arg_25_1)
	assert(arg_25_0.data[arg_25_1], "commander can not be None")

	arg_25_0.data[arg_25_1] = None

	arg_25_0.sendNotification(var_0_0.COMMANDER_DELETED, arg_25_1)

def var_0_0.checkPrefabFleet(arg_26_0, arg_26_1):
	for iter_26_0, iter_26_1 in pairs(arg_26_0.prefabFleet):
		if iter_26_1.contains(arg_26_1):
			iter_26_1.removeCommander(arg_26_1)

def var_0_0.haveFinishedBox(arg_27_0):
	for iter_27_0, iter_27_1 in pairs(arg_27_0.boxes):
		if iter_27_1.getState() == CommanderBox.STATE_FINISHED:
			return True

	return False

def var_0_0.IsFinishAllBox(arg_28_0):
	local var_28_0 = 0
	local var_28_1 = 0
	local var_28_2 = 0

	for iter_28_0, iter_28_1 in pairs(arg_28_0.boxes):
		local var_28_3 = iter_28_1.getState()

		if var_28_3 == CommanderBox.STATE_FINISHED:
			var_28_0 = var_28_0 + 1
		elif var_28_3 == CommanderBox.STATE_EMPTY:
			var_28_1 = var_28_1 + 1
...
def var_0_0.GetCommanderHome(arg_31_0):
	return arg_31_0.commanderHome

def var_0_0.StartCalcExpTimer(arg_32_0, arg_32_1):
	...
	arg_32_0.calcExpTimer = Timer.New(function()
		...
		arg_32_0.StartCalcExpTimer(3600), arg_32_1, 1)

	arg_32_0.calcExpTimer.Start()

def var_0_0.RemoveCalcExpTimer(arg_34_0):
	if arg_34_0.calcExpTimer:
		arg_34_0.calcExpTimer.Stop()

		arg_34_0.calcExpTimer = None

def var_0_0.AnyCatteryExistOP(arg_35_0):
...
def var_0_0.AnyCatteryCanUse(arg_36_0):
...
def var_0_0.IsHome(arg_37_0, arg_37_1):
...
def var_0_0.UpdateOpenCommanderScene(arg_38_0, arg_38_1):
	arg_38_0.openCommanderScene = arg_38_1

def var_0_0.InCommanderScene(arg_39_0):
	return arg_39_0.openCommanderScene

def var_0_0.AnyPoolIsWaiting(arg_40_0):
	local var_40_0 = 0

	for iter_40_0, iter_40_1 in pairs(arg_40_0.boxes):
		local var_40_1 = iter_40_1.getState()

		if var_40_1 == CommanderBox.STATE_WAITING or var_40_1 == CommanderBox.STATE_STARTING:
			return False

		if var_40_1 == CommanderBox.STATE_FINISHED:
			var_40_0 = var_40_0 + 1

	return var_40_0 > 0

def var_0_0.ShouldTipBox(arg_41_0):
	local function var_41_0()
		local var_42_0 = 0

		for iter_42_0, iter_42_1 in pairs(arg_41_0.pools):
			var_42_0 = var_42_0 + iter_42_1.getItemCount()

		return var_42_0 > 0

	local function var_41_1()
		for iter_43_0, iter_43_1 in pairs(arg_41_0.boxes):
			if iter_43_1.getState() == CommanderBox.STATE_EMPTY:
				return True
...
def var_0_0.CalcQuickItemUsageCnt(arg_44_0):
	...
	for iter_44_0, iter_44_1 in pairs(arg_44_0.boxes):
	...
	for iter_44_2, iter_44_3 in ipairs(var_44_8):
		...
		elif var_44_10 == CommanderBox.STATE_STARTING:
			var_44_4 = var_44_4 + 1
			var_44_6 = var_44_6 + 1
		...
		if var_44_5 == var_44_3:
			break
		elif var_44_3 < var_44_5:
			var_44_5 = var_44_3
			var_44_6 = var_44_6 - 1
	...
	for iter_44_4, iter_44_5 in ipairs(var_44_7):
