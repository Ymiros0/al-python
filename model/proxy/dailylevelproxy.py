...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(13201, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.count_list):
		...
		for iter_2_2, iter_2_3 in ipairs(arg_2_0.chapter_count_list):
			table.insert(arg_1_0.chapterCountList, {
				id = iter_2_3.id,
				count = iter_2_3.count
			})

		for iter_2_4, iter_2_5 in ipairs(arg_2_0.quick_expedition_list):
		...
		for iter_2_6 = #arg_1_0.dailyList, 1, -1:
			...
			if var_2_1 and type(var_2_1) == "table" and pg.TimeMgr.GetInstance().inTime(var_2_1) and var_2_3 > (arg_1_0.data[var_2_2] or 0):
				arg_1_0.dailyTip = True)

def var_0_0.AddQuickStage(arg_3_0, arg_3_1):
	arg_3_0.quickStages[arg_3_1] = True

def var_0_0.CanQuickBattle(arg_4_0, arg_4_1):
	return arg_4_0.quickStages[arg_4_1] == True

def var_0_0.clearChaptersDefeatCount(arg_5_0):
	arg_5_0.chapterCountList = {}

def var_0_0.ifShowDailyTip(arg_6_0):
	return arg_6_0.dailyTip

def var_0_0.setDailyTip(arg_7_0, arg_7_1):
	arg_7_0.dailyTip = arg_7_1

def var_0_0.getChapterDefeatCount(arg_8_0, arg_8_1):
...
def var_0_0.updateChapterDefeatCount(arg_10_0, arg_10_1):
...
def var_0_0.resetDailyCount(arg_12_0):
	...
	for iter_12_0, iter_12_1 in pairs(arg_12_0.data):
		if var_12_0[iter_12_0].limit_type == 1 or var_12_0[iter_12_0].limit_type == 2 and var_12_1:
...
def var_0_0.GetRestEliteCount(arg_13_0):
	return math.max(0, pg.gameset.elite_quota.key_value - arg_13_0.eliteCount)

def var_0_0.IsEliteEnabled(arg_14_0):
	return arg_14_0.GetRestEliteCount() > 0

def var_0_0.EliteCountPlus(arg_15_0):
