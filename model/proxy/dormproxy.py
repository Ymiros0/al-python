...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(19010, function(arg_4_0)
		for iter_4_0, iter_4_1 in ipairs(arg_4_0.pop_list):
...
def var_0_0.GetVisitorShip(arg_5_0):
	return arg_5_0.visitorShip

def var_0_0.SetVisitorShip(arg_6_0, arg_6_1):
	arg_6_0.visitorShip = arg_6_1

def var_0_0.getBackYardShips(arg_7_0):
	local var_7_0 = {}
	local var_7_1 = getProxy(BayProxy)

	for iter_7_0, iter_7_1 in ipairs(arg_7_0.data.shipIds):
...
def var_0_0.UpdateInimacyAndMoney(arg_16_0):
	arg_16_0.updateDrom(arg_16_0.data, BackYardConst.DORM_UPDATE_TYPE_SHIP)

def var_0_0.clearInimacyAndMoney(arg_17_0, arg_17_1):
...
def var_0_0.isLackOfFood(arg_18_0):
	if arg_18_0.getTrainShipCount() == 0:
		return False

	local var_18_0 = arg_18_0.getRestFood()

	if not arg_18_0.isLoadExp:
		var_18_0 = var_18_0 - arg_18_0.data.load_food

	return var_18_0 <= 0

def var_0_0.havePopEvent(arg_19_0):
	local var_19_0 = arg_19_0.getBackYardShips()

	for iter_19_0, iter_19_1 in pairs(var_19_0):
		if iter_19_1.hasStateInfo3Or4():
			return True

	return False

def var_0_0.AddFurniture(arg_20_0, arg_20_1):
...
def var_0_0.AddFurniTrues(arg_21_0, arg_21_1):
	for iter_21_0, iter_21_1 in ipairs(arg_21_1):
...
def var_0_0.updateDrom(arg_25_0, arg_25_1, arg_25_2):
...
def var_0_0.getData(arg_26_0):
	return (arg_26_0.data or Dorm.New({
		id = 1
	})).clone()

def var_0_0.updateFood(arg_27_0, arg_27_1):
...
def var_0_0.getRestFood(arg_28_0):
	return arg_28_0.data.food

def var_0_0.GetCustomThemeTemplates(arg_29_0):
	return arg_29_0.customThemeTemplates

def var_0_0.SetCustomThemeTemplates(arg_30_0, arg_30_1):
	arg_30_0.customThemeTemplates = arg_30_1

def var_0_0.GetCustomThemeTemplateById(arg_31_0, arg_31_1):
	return arg_31_0.customThemeTemplates[arg_31_1]

def var_0_0.UpdateCustomThemeTemplate(arg_32_0, arg_32_1):
...
def var_0_0.DeleteCustomThemeTemplate(arg_33_0, arg_33_1):
	arg_33_0.customThemeTemplates[arg_33_1] = None

	arg_33_0.sendNotification(var_0_0.THEME_TEMPLATE_DELTETED, {
		templateId = arg_33_1
	})

def var_0_0.AddCustomThemeTemplate(arg_34_0, arg_34_1):
...
def var_0_0.GetUploadThemeTemplateCnt(arg_35_0):
	local var_35_0 = 0

	for iter_35_0, iter_35_1 in pairs(arg_35_0.customThemeTemplates):
		if iter_35_1.IsPushed():
			var_35_0 = var_35_0 + 1

	return var_35_0

def var_0_0.GetShopThemeTemplates(arg_36_0):
	return arg_36_0.shopThemeTemplates

def var_0_0.SetShopThemeTemplates(arg_37_0, arg_37_1):
	arg_37_0.shopThemeTemplates = arg_37_1

def var_0_0.GetShopThemeTemplateById(arg_38_0, arg_38_1):
	return arg_38_0.shopThemeTemplates[arg_38_1]

def var_0_0.IsInitShopThemeTemplates(arg_39_0):
	return arg_39_0.shopThemeTemplates != None

def var_0_0.UpdateShopThemeTemplate(arg_40_0, arg_40_1):
...
def var_0_0.DeleteShopThemeTemplate(arg_41_0, arg_41_1):
	arg_41_0.shopThemeTemplates[arg_41_1] = None

	arg_41_0.sendNotification(var_0_0.SHOP_THEME_TEMPLATE_DELETED, {
		id = arg_41_1
	})

def var_0_0.GetCollectionThemeTemplates(arg_42_0):
	return arg_42_0.collectionThemeTemplates

def var_0_0.SetCollectionThemeTemplates(arg_43_0, arg_43_1):
	arg_43_0.collectionThemeTemplates = arg_43_1

def var_0_0.GetCollectionThemeTemplateById(arg_44_0, arg_44_1):
	return arg_44_0.collectionThemeTemplates[arg_44_1]

def var_0_0.AddCollectionThemeTemplate(arg_45_0, arg_45_1):
...
def var_0_0.DeleteCollectionThemeTemplate(arg_46_0, arg_46_1):
	arg_46_0.collectionThemeTemplates[arg_46_1] = None

	arg_46_0.sendNotification(var_0_0.COLLECTION_THEME_TEMPLATE_DELETED, {
		id = arg_46_1
	})

def var_0_0.GetThemeTemplateCollectionCnt(arg_47_0):
	return table.getCount(arg_47_0.collectionThemeTemplates or {})

def var_0_0.UpdateCollectionThemeTemplate(arg_48_0, arg_48_1):
...
def var_0_0.GetTemplateNewID(arg_49_0):
	local var_49_0 = _.map(_.values(arg_49_0.customThemeTemplates or {}), function(arg_50_0)
		return arg_50_0.GetPos())

	for iter_49_0 = 1, 10:
		if not table.contains(var_49_0, iter_49_0):
			return iter_49_0

def var_0_0.GetSystemThemes(arg_51_0):
	if not arg_51_0.systemThemes or #arg_51_0.systemThemes == 0:
		local var_51_0 = pg.backyard_theme_template

		for iter_51_0, iter_51_1 in ipairs(var_51_0.all):
			if var_51_0[iter_51_1].is_view == 1:
...
def var_0_0.ResetSystemTheme(arg_52_0, arg_52_1):
	if not arg_52_0.systemThemes or #arg_52_0.systemThemes == 0:
		return

	for iter_52_0, iter_52_1 in ipairs(arg_52_0.systemThemes):
		if iter_52_1.id == arg_52_1:
...
def var_0_0.NeedRefreshThemeTemplateShop(arg_53_0):
	if not arg_53_0.refreshThemeTemplateShopTime:
		arg_53_0.refreshThemeTemplateShopTime = 0

	local var_53_0 = pg.TimeMgr.GetInstance().GetServerTime()

	if var_53_0 > arg_53_0.refreshThemeTemplateShopTime:
...
def var_0_0.NeedCollectionTip(arg_54_0):
...
def var_0_0.NeedShopShowHelp(arg_55_0):
	local var_55_0 = getProxy(PlayerProxy).getRawData().id

	if not (PlayerPrefs.GetInt("backyard_template_help" .. var_55_0, 0) > 0):
...
def var_0_0.GetTag7Furnitures(arg_56_0):
	local var_56_0 = {}
	local var_56_1 = pg.furniture_data_template.get_id_list_by_tag[7]

	for iter_56_0, iter_56_1 in ipairs(var_56_1):
		local var_56_2 = pg.furniture_shop_template[iter_56_1]

		if var_56_2 and var_56_2.not_for_sale == 0 and pg.TimeMgr.GetInstance().inTime(var_56_2.time):
			table.insert(var_56_0, iter_56_1)

	return var_56_0

def var_0_0.IsShowRedDot(arg_57_0):
