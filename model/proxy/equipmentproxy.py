...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(14001, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.equip_list):
			local var_2_0 = Equipment.New(iter_2_1)

			arg_1_0.data.equipments[var_2_0.id] = var_2_0

		for iter_2_2, iter_2_3 in ipairs(arg_2_0.ship_id_list):
			table.insert(arg_1_0.shipIdListInTimeLimit, iter_2_3)

		for iter_2_4, iter_2_5 in ipairs(arg_2_0.spweapon_list):
	...
	arg_1_0.on(14101, function(arg_3_0)
		for iter_3_0, iter_3_1 in ipairs(arg_3_0.equip_skin_list):
			arg_1_0.equipmentSkinIds[iter_3_1.id] = {
				id = iter_3_1.id,
				count = iter_3_1.count
			})
	arg_1_0.on(14200, function(arg_4_0)
		for iter_4_0, iter_4_1 in ipairs(arg_4_0.spweapon_list):
...
def var_0_0.getEquipmentSkins(arg_5_0):
	return arg_5_0.equipmentSkinIds or {}

def var_0_0.getSkinsByType(arg_6_0, arg_6_1):
	local var_6_0 = {}
	...
	for iter_6_0, iter_6_1 in pairs(var_6_2):
		...
		if table.contains(var_6_1[iter_6_1.id].equip_type, arg_6_1):
			table.insert(var_6_0, iter_6_1)

	return var_6_0

def var_0_0.getSkinsByTypes(arg_7_0, arg_7_1):
	if not arg_7_1 or #arg_7_1 <= 0:
		return {}
	...
	for iter_7_0, iter_7_1 in pairs(var_7_2):
		assert(var_7_1[iter_7_1.id], "miss config equip_skin_template >> " .. iter_7_1.id)

		local var_7_3 = False

		for iter_7_2 = 1, #arg_7_1:
			if table.contains(var_7_1[iter_7_1.id].equip_type, arg_7_1[iter_7_2]):
				var_7_3 = True
...
def var_0_0.getEquipmnentSkinById(arg_8_0, arg_8_1):
	return arg_8_0.equipmentSkinIds[arg_8_1]

def var_0_0.addEquipmentSkin(arg_9_0, arg_9_1, arg_9_2):
	if arg_9_0.equipmentSkinIds[arg_9_1]:
...
def var_0_0.useageEquipmnentSkin(arg_10_0, arg_10_1):
	assert(arg_10_0.equipmentSkinIds[arg_10_1], "equipmentSkin is None--" .. arg_10_1)
...
def var_0_0.addEquipment(arg_11_0, arg_11_1):
...
def var_0_0.addEquipmentById(arg_12_0, arg_12_1, arg_12_2, arg_12_3):
...
def var_0_0.updateEquipment(arg_13_0, arg_13_1):
	assert(isa(arg_13_1, Equipment), "should be an instance of Equipment")

	arg_13_0.data.equipments[arg_13_1.id] = arg_13_1.count != 0 and arg_13_1.clone() or None
...
def var_0_0.removeEquipmentById(arg_14_0, arg_14_1, arg_14_2):
	local var_14_0 = arg_14_0.data.equipments[arg_14_1]

	assert(var_14_0 != None, "equipment should exist")
...
def var_0_0.getEquipments(arg_15_0, arg_15_1):
	local var_15_0 = {}

	for iter_15_0, iter_15_1 in pairs(arg_15_0.data.equipments):
		if iter_15_1.count > 0:
...
def var_0_0.getEquipmentsByFillter(arg_16_0, arg_16_1, arg_16_2):
	local var_16_0 = {}

	for iter_16_0, iter_16_1 in pairs(arg_16_0.data.equipments):
		if iter_16_1.count > 0 and table.contains(arg_16_2, iter_16_1.getConfig("type")) and not table.contains(iter_16_1.getConfig("ship_type_forbidden"), arg_16_1):
			table.insert(var_16_0, iter_16_1.clone())

	return var_16_0

def var_0_0.GetEquipmentsRaw(arg_17_0):
	local var_17_0 = {}

	for iter_17_0, iter_17_1 in pairs(arg_17_0.data.equipments):
		if iter_17_1.count > 0:
			table.insert(var_17_0, iter_17_1)

	return var_17_0

def var_0_0.getEquipmentById(arg_18_0, arg_18_1):
	if arg_18_0.data.equipments[arg_18_1] != None:
		return arg_18_0.data.equipments[arg_18_1].clone()

	return None

def var_0_0.getSameTypeEquipmentId(arg_19_0, arg_19_1):
	local var_19_0 = Equipment.New({
		id = arg_19_1.getConfig("id")
	})
	local var_19_1

	while var_19_0.config.next != 0:
		local var_19_2 = arg_19_0.getEquipmentById(var_19_0.config.next)

		if var_19_2 and var_19_2.count > 0:
			var_19_1 = var_19_2
...
def var_0_0.getEquipCount(arg_20_0):
	local var_20_0 = 0

	for iter_20_0, iter_20_1 in pairs(arg_20_0.data.equipments):
		var_20_0 = var_20_0 + iter_20_1.count

	return var_20_0

def var_0_0.getEquipmentSkinCount(arg_21_0):
...
def var_0_0.getCapacity(arg_22_0):
	return (arg_22_0.getEquipCount())

def var_0_0.getTimeLimitShipList(arg_23_0):
	local var_23_0 = getProxy(BayProxy)
	local var_23_1 = {}
	local var_23_2

	for iter_23_0, iter_23_1 in ipairs(arg_23_0.shipIdListInTimeLimit):
...
def var_0_0.clearTimeLimitShipList(arg_24_0):
	arg_24_0.shipIdListInTimeLimit = {}

def var_0_0.GetSpWeapons(arg_25_0):
	return arg_25_0.spWeapons

def var_0_0.GetSpWeaponByUid(arg_26_0, arg_26_1):
	return arg_26_0.spWeapons[arg_26_1]

def var_0_0.StaticGetSpWeapon(arg_27_0, arg_27_1):
	local var_27_0
	local var_27_1

	if arg_27_0 and arg_27_0 > 0:
...
def var_0_0.GetSameTypeSpWeapon(arg_28_0, arg_28_1):
	local var_28_0
	...
	while var_28_1 != 0:
		...
		if var_28_3.GetRarity() != arg_28_1.GetRarity():
			break

		for iter_28_0, iter_28_1 in pairs(arg_28_0.GetSpWeapons()):
			if iter_28_1.GetConfigID() == var_28_1:
				var_28_0 = iter_28_1
	...
	if not var_28_0:
		...
		while var_28_4 != 0:
			...
			if var_28_6.GetRarity() != arg_28_1.GetRarity():
				break

			for iter_28_2, iter_28_3 in pairs(arg_28_0.GetSpWeapons()):
				if iter_28_3.GetConfigID() == var_28_4:
					var_28_0 = iter_28_3
...
def var_0_0.GetSpWeaponCapacity(arg_29_0):
	return arg_29_0.spWeaponCapacity

def var_0_0.AddSpWeaponCapacity(arg_30_0, arg_30_1):
	arg_30_0.spWeaponCapacity = arg_30_0.spWeaponCapacity + arg_30_1

def var_0_0.GetSpWeaponCount(arg_31_0):
	return table.getCount(arg_31_0.GetSpWeapons())

def var_0_0.AddSpWeapon(arg_32_0, arg_32_1):
	arg_32_1.SetShipId(None)

	arg_32_0.spWeapons[arg_32_1.GetUID()] = arg_32_1

	arg_32_0.facade.sendNotification(var_0_0.SPWEAPONS_UPDATED)

def var_0_0.RemoveSpWeapon(arg_33_0, arg_33_1):
	arg_33_0.spWeapons[arg_33_1.GetUID()] = None

	arg_33_0.facade.sendNotification(var_0_0.SPWEAPONS_UPDATED)

var_0_0.EquipTransformTargetDict = {}

for iter_0_0, iter_0_1 in ipairs(pg.equip_upgrade_data.all):
...
for iter_0_3, iter_0_4 in ipairs(pg.equip_upgrade_template.all):
...
def var_0_0.OnEquipsUpdate(arg_38_0, arg_38_1):
	if not arg_38_0.weakTable.equipsDict:
		return

	arg_38_0.weakTable.equipsDict.UpdateEquipment(arg_38_1)

def var_0_0.OnShipEquipsAdd(arg_39_0, arg_39_1, arg_39_2, arg_39_3):
	if not arg_39_0.weakTable.equipsDict:
		return
...
def var_0_0.OnShipEquipsRemove(arg_40_0, arg_40_1, arg_40_2, arg_40_3):
	if not arg_40_0.weakTable.equipsDict:
		return
