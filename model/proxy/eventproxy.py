...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(13011, function(arg_3_0)
		for iter_3_0, iter_3_1 in ipairs(arg_3_0.collection):
...
def var_0_0.updateInfo(arg_6_0, arg_6_1):
	arg_6_0.eventList = {}
...
def var_0_0.updateNightInfo(arg_7_0, arg_7_1):
...
def var_0_0.getActiveShipIds(arg_8_0):
	local var_8_0 = {}

	for iter_8_0, iter_8_1 in ipairs(arg_8_0.eventList):
		if iter_8_1.state != EventInfo.StateNone:
			for iter_8_2, iter_8_3 in ipairs(iter_8_1.shipIds):
				table.insert(var_8_0, iter_8_3)

	return var_8_0

def var_0_0.findInfoById(arg_9_0, arg_9_1):
	for iter_9_0, iter_9_1 in ipairs(arg_9_0.eventList):
		if iter_9_1.id == arg_9_1:
			return iter_9_1, iter_9_0

	return None, -1

def var_0_0.countByState(arg_10_0, arg_10_1):
	local var_10_0 = 0

	for iter_10_0, iter_10_1 in ipairs(arg_10_0.eventList):
		if iter_10_1.state == arg_10_1:
			var_10_0 = var_10_0 + 1

	return var_10_0

def var_0_0.hasFinishState(arg_11_0):
	if arg_11_0.countByState(EventInfo.StateFinish) > 0:
		return True

def var_0_0.countBusyFleetNums(arg_12_0):
	local var_12_0 = 0

	for iter_12_0, iter_12_1 in ipairs(arg_12_0.eventList):
		if not iter_12_1.IsActivityType() and iter_12_1.state != EventInfo.StateNone:
			var_12_0 = var_12_0 + 1
...
def var_0_0.updateTime(arg_13_0):
	...
	for iter_13_0, iter_13_1 in pairs(arg_13_0.eventList):
		if iter_13_1.updateTime():
			var_13_0 = True
...
def var_0_0.getEventList(arg_14_0):
	return Clone(arg_14_0.eventList)

def var_0_0.getActiveEvents(arg_15_0):
	local var_15_0 = {}

	for iter_15_0, iter_15_1 in ipairs(arg_15_0.eventList):
		if iter_15_1.finishTime >= pg.TimeMgr.GetInstance().GetServerTime():
			table.insert(var_15_0, iter_15_1)

	return var_15_0

def var_0_0.fillRecommendShip(arg_16_0, arg_16_1):
...
def var_0_0.fillRecommendShipLV1(arg_17_0, arg_17_1):
...
def var_0_0.checkNightEvent(arg_18_0):
...
def var_0_0.AddActivityEvents(arg_20_0, arg_20_1, arg_20_2):
	for iter_20_0 = #arg_20_0.eventList, 1, -1:
		local var_20_0 = arg_20_0.eventList[iter_20_0]

		if var_20_0.IsActivityType() and var_20_0.BelongActivity(arg_20_2):
			table.remove(arg_20_0.eventList, iter_20_0)

	for iter_20_1, iter_20_2 in ipairs(arg_20_1):
		print("add collection-----------", iter_20_2.id)
		table.insert(arg_20_0.eventList, iter_20_2)

	pg.ShipFlagMgr.GetInstance().UpdateFlagShips("inEvent")

def var_0_0.AddActivityEvent(arg_21_0, arg_21_1):
	print("zero add collection-----------", arg_21_1.id)
	table.insert(arg_21_0.eventList, arg_21_1)

def var_0_0.CanJoinEvent(arg_22_0, arg_22_1):
	if not arg_22_1.reachNum():
		return False, i18n("event_minimus_ship_numbers", arg_22_1.template.ship_num)

	if not arg_22_1.reachLevel():
		return False, i18n("event_level_unreached")

	if not arg_22_1.reachTypes():
		return False, i18n("event_type_unreached")

	if not arg_22_1.IsActivityType() and arg_22_0.busyFleetNums >= arg_22_0.maxFleetNums:
	...
	if var_22_0 and var_22_0 < 0:
		return False, i18n("event_over_time_expired")

	local var_22_1 = getProxy(PlayerProxy).getData()

	if arg_22_1.getOilConsume() > var_22_1.oil:
		local var_22_2

		if not ItemTipPanel.ShowOilBuyTip(arg_22_1.getOilConsume()):
...
def var_0_0.CanFinishEvent(arg_23_0, arg_23_1):
	...
	if var_23_1.OilMax(var_23_2):
		return False, i18n("oil_max_tip_title") .. i18n("resource_max_tip_event")

	local var_23_3 = var_23_0.drop_gold_max or 0

	if var_23_1.GoldMax(var_23_3):
		return False, i18n("gold_max_tip_title") .. i18n("resource_max_tip_event")

	return True

def var_0_0.GetEventByActivityId(arg_24_0, arg_24_1):
	for iter_24_0, iter_24_1 in ipairs(arg_24_0.eventList):
		if iter_24_1.BelongActivity(arg_24_1):
			return iter_24_1, iter_24_0

def var_0_0.GetEventListForCommossionInfo(arg_25_0):
	...
	_.each(var_25_0, function(arg_26_0)
		if arg_26_0.IsActivityType():
			if arg_26_0.state == EventInfo.StateNone:
				var_25_6 = var_25_6 + 1
			elif arg_26_0.state == EventInfo.StateActive:
				var_25_5 = var_25_5 + 1
			elif arg_26_0.state == EventInfo.StateFinish:
				var_25_4 = var_25_4 + 1
		elif arg_26_0.state == EventInfo.StateNone:
			-- block empty
		elif arg_26_0.state == EventInfo.StateActive:
			var_25_2 = var_25_2 + 1
