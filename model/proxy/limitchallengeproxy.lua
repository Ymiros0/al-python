...
function var_0_0.setCurMonthPassedIDList(arg_5_0, arg_5_1)
	for iter_5_0, iter_5_1 in ipairs(arg_5_1) do
		table.insert(arg_5_0.curMonthPassedIDList, iter_5_1)
	end
end

function var_0_0.setPassTime(arg_6_0, arg_6_1, arg_6_2)
	local var_6_0 = arg_6_0.passTimeDict[arg_6_1]

	if not var_6_0 then
		arg_6_0.passTimeDict[arg_6_1] = arg_6_2
	elseif arg_6_2 < var_6_0 then
		arg_6_0.passTimeDict[arg_6_1] = arg_6_2

		arg_6_0:sendNotification(LimitChallengeConst.UPDATE_PASS_TIME)
	end

	if not table.contains(arg_6_0.curMonthPassedIDList, arg_6_1) then
		table.insert(arg_6_0.curMonthPassedIDList, arg_6_1)
	end
end

function var_0_0.setAwarded(arg_7_0, arg_7_1)
	arg_7_0.awardedDict[arg_7_1] = true
end

function var_0_0.getPassTimeByChallengeID(arg_8_0, arg_8_1)
	return arg_8_0.passTimeDict[arg_8_1]
end

function var_0_0.getMissAwardChallengeIDLIst(arg_9_0)
	local var_9_0 = {}
...
function var_0_0.isAwardedByChallengeID(arg_10_0, arg_10_1)
	return arg_10_0.awardedDict[arg_10_1]
end

function var_0_0.isLevelUnlock(arg_11_0, arg_11_1)
	if arg_11_1 == 1 then
		return true
	end
