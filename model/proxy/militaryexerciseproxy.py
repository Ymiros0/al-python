...
def var_0_0.register(arg_1_0):
	arg_1_0.on(18005, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.target_list):
...
def var_0_0.addSeasonInfo(arg_3_0, arg_3_1):
...
def var_0_0.addRefreshCountTimer(arg_4_0):
...
def var_0_0.addSeasonOverTimer(arg_7_0):
...
def var_0_0.removeRefreshTimer(arg_10_0):
	if arg_10_0.refreshCountTimer:
		arg_10_0.refreshCountTimer.Stop()

		arg_10_0.refreshCountTimer = None

def var_0_0.removeSeasonOverTimer(arg_11_0):
	if arg_11_0.SeasonOverTimer:
		arg_11_0.SeasonOverTimer.Stop()

		arg_11_0.SeasonOverTimer = None

def var_0_0.remove(arg_12_0):
	arg_12_0.removeRefreshTimer()
	arg_12_0.removeSeasonOverTimer()

def var_0_0.updateSeasonInfo(arg_13_0, arg_13_1):
...
def var_0_0.getSeasonInfo(arg_14_0):
	return Clone(arg_14_0.seasonInfo)

def var_0_0.RawGetSeasonInfo(arg_15_0):
	return arg_15_0.seasonInfo

def var_0_0.updateRivals(arg_16_0, arg_16_1):
	arg_16_0.seasonInfo.updateRivals(arg_16_1)
	arg_16_0.sendNotification(var_0_0.RIVALS_UPDATED, Clone(arg_16_1))

def var_0_0.getRivals(arg_17_0):
	return Clone(arg_17_0.seasonInfo.rivals)

def var_0_0.getRivalById(arg_18_0, arg_18_1):
	for iter_18_0, iter_18_1 in ipairs(arg_18_0.getRivals()):
		if iter_18_1.id == arg_18_1:
			return iter_18_1

def var_0_0.getPreRivalById(arg_19_0, arg_19_1):
	for iter_19_0, iter_19_1 in pairs(arg_19_0.seasonInfo.GetPreRivals()):
		if arg_19_1 == iter_19_0:
			return Clone(iter_19_1)

def var_0_0.getExerciseFleet(arg_20_0):
	return Clone(arg_20_0.seasonInfo.fleet)

def var_0_0.updateExerciseFleet(arg_21_0, arg_21_1):
	arg_21_0.seasonInfo.updateFleet(arg_21_1)
	pg.ShipFlagMgr.GetInstance().UpdateFlagShips("inExercise")
	arg_21_0.sendNotification(var_0_0.EXERCISE_FLEET_UPDATED, arg_21_1.clone())

def var_0_0.increaseExerciseCount(arg_22_0):
	arg_22_0.seasonInfo.increaseExerciseCount()

def var_0_0.reduceExerciseCount(arg_23_0):
	arg_23_0.seasonInfo.reduceExerciseCount()

def var_0_0.updateArenaRankLsit(arg_24_0, arg_24_1):
...
def var_0_0.getArenaRankList(arg_25_0):
