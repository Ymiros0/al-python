...
def var_0_0.CheckHasHub(arg_2_0, arg_2_1):
	return arg_2_0.miniGameHubDataDic[arg_2_1] != None

def var_0_0.GetMiniGameData(arg_3_0, arg_3_1):
	if arg_3_0.miniGameDataDic[arg_3_1] == None:
		local var_3_0 = {
			id = arg_3_1
		}
...
def var_0_0.GetMiniGameDataByType(arg_4_0, arg_4_1):
	for iter_4_0, iter_4_1 in pairs(arg_4_0.miniGameDataDic):
		if iter_4_1.getConfig("type") == arg_4_1 and iter_4_1.CheckInTime():
			return iter_4_1

def var_0_0.GetHubByHubId(arg_5_0, arg_5_1):
	if arg_5_0.miniGameHubDataDic[arg_5_1] == None:
		local var_5_0 = {
			id = arg_5_1
		}
...
def var_0_0.GetHubByGameId(arg_6_0, arg_6_1):
	local var_6_0 = arg_6_0.GetMiniGameData(arg_6_1).getConfig("hub_id")

	if arg_6_0.miniGameHubDataDic[var_6_0] == None:
		local var_6_1 = {
			id = var_6_0
		}
...
def var_0_0.UpdataHubData(arg_7_0, arg_7_1):
...
def var_0_0.GetHighScore(arg_8_0, arg_8_1):
	return arg_8_0.GetHubByGameId(arg_8_1).highScores[arg_8_1] or {}

def var_0_0.UpdataHighScore(arg_9_0, arg_9_1, arg_9_2):
	local var_9_0 = arg_9_0.GetHubByGameId(arg_9_1)
	local var_9_1 = 0

	if var_9_0.highScores[arg_9_1] and var_9_0.highScores[arg_9_1][1]:
		var_9_1 = var_9_0.highScores[arg_9_1][1]

	if var_9_1 <= arg_9_2[1]:
		...
		for iter_9_0, iter_9_1 in ipairs(arg_9_2):
...
def var_0_0.GetRank(arg_10_0, arg_10_1):
	return arg_10_0.GetMiniGameData(arg_10_1).GetRank()

def var_0_0.SetRank(arg_11_0, arg_11_1, arg_11_2):
	arg_11_0.GetMiniGameData(arg_11_1).SetRank(arg_11_2)

def var_0_0.CanFetchRank(arg_12_0, arg_12_1):
	return arg_12_0.GetMiniGameData(arg_12_1).CanFetchRank()

def var_0_0.RequestInitData(arg_13_0, arg_13_1, arg_13_2):
	local var_13_0 = arg_13_0.GetMiniGameData(arg_13_1)
	local var_13_1 = var_13_0.getConfig("request_data") == 1

	if arg_13_2 and not var_13_1:
		return

	if var_13_0.CheckInTime():
		local var_13_2 = arg_13_0.GetHubByGameId(arg_13_1)
		local var_13_3 = var_13_0.getConfig("type")

		if (var_13_3 == MiniGameConst.MG_TYPE_2 or var_13_3 == MiniGameConst.MG_TYPE_3 or var_13_3 == MiniGameConst.MG_TYPE_5) and not var_13_0.GetRuntimeData("fetchData"):
