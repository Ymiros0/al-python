...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(11003, function(arg_3_0)
		...
		if arg_1_0.data.GetDaysFromRegister() == 1:
			pg.TrackerMgr.GetInstance().Tracking(TRACKING_2D_RETENTION)
		elif arg_1_0.data.GetDaysFromRegister() == 6:
	...
	arg_1_0.on(11004, function(arg_4_0)
		...
		if arg_1_0.data.isFull():
			-- block empty)
	arg_1_0.on(10999, function(arg_5_0)
		if arg_5_0.reason == LOGOUT_NEW_VERSION:
			getProxy(SettingsProxy).lastRequestVersionTime = None
		else
	...
	arg_1_0.on(11015, function(arg_6_0)
		...
		for iter_6_0, iter_6_1 in ipairs(arg_6_0.buff_list):
			local var_6_1 = {
				id = iter_6_1.id,
...
def var_0_0.remove(arg_9_0):
	arg_9_0.clearTimesListener()

def var_0_0.getSummaryInfo(arg_10_0):
	return arg_10_0.summaryInfo

def var_0_0.setSummaryInfo(arg_11_0, arg_11_1):
	arg_11_0.summaryInfo = arg_11_1

def var_0_0.flushTimesListener(arg_12_0):
...
def var_0_0.clearTimesListener(arg_14_0):
	if arg_14_0.fourClockId:
		pg.TimeMgr.GetInstance().RemoveTimer(arg_14_0.fourClockId)

		arg_14_0.fourClockId = None

def var_0_0.updatePlayer(arg_15_0, arg_15_1):
...
def var_0_0.UpdatePlayerRes(arg_16_0, arg_16_1):
	if not arg_16_0.data:
		return
...
def var_0_0.updatePlayerMedalDisplay(arg_17_0, arg_17_1):
	arg_17_0.data.displayTrophyList = arg_17_1

def var_0_0.getPlayerId(arg_18_0):
	return arg_18_0.data.id

def var_0_0.setFlag(arg_19_0, arg_19_1, arg_19_2):
	arg_19_0._flags[arg_19_1] = arg_19_2

def var_0_0.getFlag(arg_20_0, arg_20_1):
	return arg_20_0._flags[arg_20_1]

def var_0_0.isSelf(arg_21_0, arg_21_1):
	return arg_21_0.data.id == arg_21_1

def var_0_0.setInited(arg_22_0, arg_22_1):
	arg_22_0.inited = arg_22_1

def var_0_0.getInited(arg_23_0):
	return arg_23_0.inited

def var_0_0.setRefundInfo(arg_24_0, arg_24_1):
	local var_24_0

	if arg_24_1 and #arg_24_1 > 0:
		var_24_0 = {}
...
def var_0_0.getRefundInfo(arg_25_0):
	if not arg_25_0.refundInfo:
		return None

	if #arg_25_0.refundInfo <= 0:
		return None

	return arg_25_0.refundInfo

def var_0_0.IsShowCommssionTip(arg_26_0):
	...
	for iter_26_0, iter_26_1 in ipairs(var_26_9):
		if iter_26_1.attrName == "stock":
	...
	if var_26_17 and not var_26_17.isEnd():
