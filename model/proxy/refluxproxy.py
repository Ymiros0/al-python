...
def var_0_0.setData(arg_3_0, arg_3_1):
...
def var_0_0.setSignLastTimestamp(arg_6_0, arg_6_1):
	arg_6_0.signLastTimestamp = arg_6_1 or pg.TimeMgr.GetInstance().GetServerTime()

def var_0_0.addSignCount(arg_7_0):
	arg_7_0.signCount = arg_7_0.signCount + 1

def var_0_0.addPtAfterSubTasks(arg_8_0, arg_8_1):
...
def var_0_0.addPTStage(arg_9_0):
	arg_9_0.ptStage = arg_9_0.ptStage + 1

def var_0_0.isActive(arg_10_0):
	return arg_10_0.active

def var_0_0.isCanSign(arg_11_0):
	if arg_11_0.isActive() and not arg_11_0.autoActionForbidden:
		...
		if var_11_1 < var_11_2 and not var_11_5:
			return True

def var_0_0.isInRefluxTime(arg_12_0):
	if arg_12_0.isActive():
		local var_12_0 = pg.TimeMgr.GetInstance()
		local var_12_1 = #pg.return_sign_template.all

		if arg_12_0.returnTimestamp + var_12_1 * 86400 <= var_12_0.GetServerTime():
			return False
		else
			return True
	else
...
def var_0_0.setAutoActionForbidden(arg_13_0, arg_13_1):
