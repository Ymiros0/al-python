...
def var_0_0.SetData(arg_2_0, arg_2_1):
	...
	for iter_2_0 = 1, #pg.SecondaryPWDMgr.LIMITED_OPERATION:
		table.insert(var_2_0.system_list, arg_2_1.system_list[iter_2_0])

def var_0_0.OnFirstSet(arg_3_0, arg_3_1):
	...
	var_3_0.fail_cd = None
	var_3_0.notice = Clone(arg_3_1.tip)

def var_0_0.OnSettingsChange(arg_4_0, arg_4_1):
	...
	var_4_0.fail_cd = None
	var_4_0.fail_count = 0

def var_0_0.GetPermissionState(arg_5_0):
	if arg_5_0.data.state == 0:
		return True

	local var_5_0 = arg_5_0.data.fail_cd
	local var_5_1 = pg.TimeMgr.GetInstance().GetServerTime()

	if var_5_0 and var_5_1 < var_5_0:
