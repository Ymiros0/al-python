...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(11300, function(arg_2_0)
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.notice_list):
			local var_2_0 = False

			for iter_2_2 = 1, #arg_1_0.data:
				if arg_1_0.data[iter_2_2].id == iter_2_1.id:
...
def var_0_0.testData(arg_3_0, arg_3_1):
...
def var_0_0.getServerNotices(arg_4_0, arg_4_1):
	local var_4_0 = {}

	for iter_4_0, iter_4_1 in ipairs(arg_4_0.data):
		if not arg_4_1 or not iter_4_1.isRead:
			table.insert(var_4_0, iter_4_1)

	return var_4_0

def var_0_0.needAutoOpen(arg_5_0):
	local var_5_0 = True

	if PlayerPrefs.HasKey(var_0_0.KEY_STOP_REMIND):
		local var_5_1 = PlayerPrefs.GetInt(var_0_0.KEY_STOP_REMIND)
		local var_5_2 = pg.TimeMgr.GetInstance()

		if not arg_5_0.hasNewNotice() and var_5_2.IsSameDay(var_5_1, var_5_2.GetServerTime()):
			var_5_0 = False
	elif arg_5_0.runtimeUniqueCode and arg_5_0.runtimeUniqueCode == arg_5_0.getUniqueCode():
		var_5_0 = False
...
def var_0_0.setStopRemind(arg_6_0, arg_6_1):
	if arg_6_1:
...
def var_0_0.getStopRemind(arg_7_0):
	return PlayerPrefs.HasKey(var_0_0.KEY_STOP_REMIND)

def var_0_0.setStopNewTip(arg_8_0):
	PlayerPrefs.SetInt(var_0_0.KEY_NEWLY_ID, arg_8_0.getUniqueCode())
	PlayerPrefs.Save()
	arg_8_0.sendNotification(var_0_0.SERVER_NOTICES_UPDATE)

def var_0_0.hasNewNotice(arg_9_0):
	if PlayerPrefs.HasKey(var_0_0.KEY_NEWLY_ID) and PlayerPrefs.GetInt(var_0_0.KEY_NEWLY_ID) == arg_9_0.getUniqueCode():
		return False

	return True

def var_0_0.getUniqueCode(arg_10_0):
