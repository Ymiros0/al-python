...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(12201, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.forbidden_skin_type):
			arg_1_0.forbiddenSkinList[iter_2_0].type = iter_2_1)

def var_0_0.getOverDueSkins(arg_5_0):
	local var_5_0 = {}

	for iter_5_0, iter_5_1 in ipairs(arg_5_0.cacheSkins):
...
def var_0_0.addExpireTimer(arg_11_0, arg_11_1):
	...
	local function var_11_0()
		...
		_.each(var_12_1, function(arg_13_0)
			if arg_13_0.skinId == arg_11_1.id:
...
def var_0_0.removeExpireTimer(arg_14_0, arg_14_1):
	if arg_14_0.timers[arg_14_1]:
		arg_14_0.timers[arg_14_1].Stop()

		arg_14_0.timers[arg_14_1] = None

def var_0_0.removeSkinById(arg_15_0, arg_15_1):
	arg_15_0.skins[arg_15_1] = None

	arg_15_0.removeExpireTimer(arg_15_1)
	arg_15_0.facade.sendNotification(var_0_0.SHIP_SKINS_UPDATE)

def var_0_0.hasSkin(arg_16_0, arg_16_1):
	return arg_16_0.skins[arg_16_1] != None

def var_0_0.hasNonLimitSkin(arg_17_0, arg_17_1):
	local var_17_0 = arg_17_0.skins[arg_17_1]

	return var_17_0 != None and not var_17_0.isExpireType()

def var_0_0.hasOldNonLimitSkin(arg_18_0, arg_18_1):
	local var_18_0 = arg_18_0.skins[arg_18_1]

	return var_18_0 and not var_18_0.HasNewFlag() and not var_18_0.isExpireType()

def var_0_0.getSkinCountById(arg_19_0, arg_19_1):
	return arg_19_0.hasSkin(arg_19_1) and 1 or 0

def var_0_0.InForbiddenSkinListAndHide(arg_20_0, arg_20_1):
...
def var_0_0.InForbiddenSkinListAndShow(arg_22_0, arg_22_1):
...
def var_0_0.InForbiddenSkinList(arg_24_0, arg_24_1):
	return _.any(arg_24_0.forbiddenSkinList, function(arg_25_0)
		return arg_25_0.id == arg_24_1)

def var_0_0.remove(arg_26_0):
	for iter_26_0, iter_26_1 in pairs(arg_26_0.timers):
		iter_26_1.Stop()

	arg_26_0.timers = None

def var_0_0.GetAllSkins(arg_27_0):
	local var_27_0 = {}
	...
	for iter_27_0, iter_27_1 in ipairs(pg.shop_template.get_id_list_by_genre[ShopArgs.SkinShop]):
		var_27_2(iter_27_1)

	for iter_27_2, iter_27_3 in ipairs(pg.shop_template.get_id_list_by_genre[ShopArgs.SkinShopTimeLimit]):
		var_27_2(iter_27_3)

	local var_27_3 = getProxy(ActivityProxy)
	local var_27_4 = pg.activity_shop_extra.get_id_list_by_commodity_type[DROP_TYPE_SKIN]

	for iter_27_4, iter_27_5 in ipairs(var_27_4):
		local var_27_5 = pg.activity_shop_extra[iter_27_5]
		local var_27_6 = var_27_3.getActivityById(var_27_5.activity)

		if var_27_5.activity == 0 and pg.TimeMgr.GetInstance().inTime(var_27_5.time) or var_27_6 and not var_27_6.isEnd():
	...
	for iter_27_8 = #var_27_0, 1, -1:
		local var_27_12 = var_27_0[iter_27_8].getSkinId()

		if arg_27_0.InForbiddenSkinList(var_27_12) or not arg_27_0.InShowTime(var_27_12):
			table.remove(var_27_0, iter_27_8)

	return var_27_0

def var_0_0.GetShopShowingSkins(arg_31_0):
	local var_31_0 = {}
	...
	for iter_31_0, iter_31_1 in ipairs(pg.shop_template.get_id_list_by_genre[ShopArgs.SkinShop]):
		var_31_2(iter_31_1)

	for iter_31_2, iter_31_3 in ipairs(pg.shop_template.get_id_list_by_genre[ShopArgs.SkinShopTimeLimit]):
		var_31_2(iter_31_3)

	local var_31_3 = getProxy(ActivityProxy)
	local var_31_4 = pg.activity_shop_extra.get_id_list_by_commodity_type[DROP_TYPE_SKIN]

	for iter_31_4, iter_31_5 in ipairs(var_31_4):
...
def var_0_0.GetAllSkinForShip(arg_35_0, arg_35_1):
	...
	for iter_35_0 = #var_35_1, 1, -1:
		local var_35_2 = var_35_1[iter_35_0]

		if var_35_2.skin_type == ShipSkin.SKIN_TYPE_NOT_HAVE_HIDE and not arg_35_0.hasSkin(var_35_2.id):
			table.remove(var_35_1, iter_35_0)
		elif not arg_35_0.InShowTime(var_35_2.id):
			table.remove(var_35_1, iter_35_0)

	if pg.ship_data_trans[var_35_0] and not arg_35_1.isRemoulded():
		local var_35_3 = ShipGroup.GetGroupConfig(var_35_0).trans_skin

		for iter_35_1 = #var_35_1, 1, -1:
			if var_35_1[iter_35_1].id == var_35_3:
				table.remove(var_35_1, iter_35_1)

				break

	for iter_35_2 = #var_35_1, 1, -1:
		local var_35_4 = var_35_1[iter_35_2]

		if var_35_4.show_time and (type(var_35_4.show_time) == "string" and var_35_4.show_time == "stop" or type(var_35_4.show_time) == "table" and not pg.TimeMgr.GetInstance().inTime(var_35_4.show_time)):
			table.remove(var_35_1, iter_35_2)

		if var_35_4.no_showing == "1":
			table.remove(var_35_1, iter_35_2)
		elif PLATFORM == PLATFORM_KR and pg.ship_skin_template[var_35_4.id].isHX == 1:
			table.remove(var_35_1, iter_35_2)

	if PLATFORM_CODE == PLATFORM_CH:
		local var_35_5 = pg.gameset.big_seven_old_skin_timestamp.key_value

		for iter_35_3 = #var_35_1, 1, -1:
			if var_35_1[iter_35_3].skin_type == ShipSkin.SKIN_TYPE_OLD and var_35_5 < arg_35_1.createTime:
				table.remove(var_35_1, iter_35_3)

	if #arg_35_0.forbiddenSkinList > 0:
		for iter_35_4 = #var_35_1, 1, -1:
			local var_35_6 = var_35_1[iter_35_4].id

			if not arg_35_0.hasSkin(var_35_6) and arg_35_0.InForbiddenSkinListAndHide(var_35_6):
				table.remove(var_35_1, iter_35_4)

	return var_35_1

def var_0_0.GetShareSkinsForShipGroup(arg_36_0, arg_36_1):
	local var_36_0 = pg.ship_data_group.get_id_list_by_group_type[arg_36_1][1]
	local var_36_1 = pg.ship_data_group[var_36_0]

	if not var_36_1.share_group_id or #var_36_1.share_group_id <= 0:
		return {}

	local var_36_2 = {}

	for iter_36_0, iter_36_1 in ipairs(var_36_1.share_group_id):
		local var_36_3 = pg.ship_skin_template.get_id_list_by_ship_group[iter_36_1]

		for iter_36_2, iter_36_3 in ipairs(var_36_3):
			local var_36_4 = ShipSkin.New({
				id = iter_36_3
			})

			if var_36_4.CanShare():
				table.insert(var_36_2, var_36_4)

	return var_36_2

def var_0_0.GetShareSkinsForShip(arg_37_0, arg_37_1):
	local var_37_0 = arg_37_1.groupId

	return arg_37_0.GetShareSkinsForShipGroup(var_37_0)

def var_0_0.GetAllSkinForARCamera(arg_38_0, arg_38_1):
	local var_38_0 = ShipGroup.getSkinList(arg_38_1)

	for iter_38_0 = #var_38_0, 1, -1:
		if var_38_0[iter_38_0].skin_type == ShipSkin.SKIN_TYPE_OLD:
	...
	if var_38_1 != 0:
		...
		if var_38_3:
			for iter_38_1, iter_38_2 in ipairs(var_38_0):
				if iter_38_2.skin_type == ShipSkin.SKIN_TYPE_REMAKE and var_38_3.trans:
					var_38_2 = True

					break

		if not var_38_2:
			for iter_38_3 = #var_38_0, 1, -1:
				if var_38_0[iter_38_3].id == var_38_1:
					table.remove(var_38_0, iter_38_3)

					break

	for iter_38_4 = #var_38_0, 1, -1:
		local var_38_4 = var_38_0[iter_38_4]

		if var_38_4.skin_type == ShipSkin.SKIN_TYPE_NOT_HAVE_HIDE and not arg_38_0.hasSkin(var_38_4.id):
			table.remove(var_38_0, iter_38_4)
		elif var_38_4.no_showing == "1":
			table.remove(var_38_0, iter_38_4)
		elif PLATFORM == PLATFORM_KR and pg.ship_skin_template[var_38_4.id].isHX == 1:
			table.remove(var_38_0, iter_38_4)
		elif not arg_38_0.InShowTime(var_38_4.id):
			table.remove(var_38_0, iter_38_4)

	if #arg_38_0.forbiddenSkinList > 0:
		for iter_38_5 = #var_38_0, 1, -1:
			local var_38_5 = var_38_0[iter_38_5].id

			if not arg_38_0.hasSkin(var_38_5) and arg_38_0.InForbiddenSkinListAndHide(var_38_5):
				table.remove(var_38_0, iter_38_5)

	return var_38_0

def var_0_0.InShowTime(arg_39_0, arg_39_1):
	local var_39_0 = pg.ship_skin_template_column_time[arg_39_1]

	if var_39_0 and var_39_0.time != "" and type(var_39_0.time) == "table" and #var_39_0.time > 0:
		return pg.TimeMgr.GetInstance().passTime(var_39_0.time)

	return True

def var_0_0.HasFashion(arg_40_0, arg_40_1):
	if #arg_40_0.GetShareSkinsForShip(arg_40_1) > 0:
		return True
...
def var_0_0.GetEncoreSkins(arg_41_0):
	...
	local function var_41_1(arg_42_0)
		...
		if var_42_0 and var_42_0[1] and type(var_42_0[1]) == "table":
	...
	for iter_41_0, iter_41_1 in ipairs(var_41_0):
		if iter_41_1.getDataConfig("type") == 5 and not var_41_1(iter_41_1):
			return iter_41_1.getConfig("config_data")

	return {}

def var_0_0.GetOwnSkins(arg_43_0):
	local var_43_0 = {}
	local var_43_1 = arg_43_0.getRawData()

	for iter_43_0, iter_43_1 in pairs(var_43_1):
		table.insert(var_43_0, iter_43_1)

	local var_43_2 = getProxy(CollectionProxy).shipGroups

	for iter_43_2, iter_43_3 in pairs(var_43_2):
		if iter_43_3.married == 1:
...
def var_0_0.GetOwnAndShareSkins(arg_44_0):
	...
	for iter_44_2, iter_44_3 in pairs(var_44_2):
		if iter_44_3.married == 1:
			local var_44_3 = arg_44_0.GetShareSkinsForShipGroup(iter_44_3.id)

			for iter_44_4, iter_44_5 in ipairs(var_44_3):
				if not var_44_1[iter_44_5.id]:
					table.insert(var_44_0, iter_44_5)

	return var_44_0

def var_0_0.GetProbabilitySkins(arg_45_0, arg_45_1):
	local var_45_0 = {}
	...
	for iter_45_0, iter_45_1 in ipairs(var_45_3):
		if iter_45_1.getConfig("genre") != ShopArgs.SkinShopTimeLimit:
			var_45_4[iter_45_1.getSkinId()] = iter_45_1.id

	for iter_45_2, iter_45_3 in ipairs(arg_45_1):
...
def var_0_0.GetSkinProbabilitys(arg_48_0, arg_48_1):
	local var_48_0 = {}
