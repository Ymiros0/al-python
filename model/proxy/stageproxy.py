...
def var_0_0.register(arg_1_0):
	arg_1_0.on(13001, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_0.expedition_list):
	...
	arg_1_0.on(13100, function(arg_3_0)
		...
		for iter_3_0, iter_3_1 in ipairs(arg_3_0.random_expedition_list):
			local var_3_0 = Stage.New(iter_3_1)

			var_3_0.display("loaded")

			if not arg_1_0.data.randomexpeditions[var_3_0.id]:
...
def var_0_0.remove(arg_4_0):
	...
	arg_4_0.timerId = None

def var_0_0.addStage(arg_5_0, arg_5_1):
	assert(isa(arg_5_1, Stage), "should be an instance of Stage")
	assert(arg_5_0.data.satges[arg_5_1.id] == None, "ship already exist, use updateStage() instead")
...
def var_0_0.getStageById(arg_6_0, arg_6_1):
	if arg_6_0.data.satges[arg_6_1] != None:
		return arg_6_0.data.satges[arg_6_1].clone()

def var_0_0.updateStage(arg_7_0, arg_7_1):
...
def var_0_0.getRandomStages(arg_8_0):
	return Clone(arg_8_0.data.randomexpeditions) or {}

def var_0_0.addRandomStage(arg_9_0, arg_9_1):
	assert(isa(arg_9_1, Stage), "should be an instance of Stage")
	assert(arg_9_0.data.randomexpeditions[arg_9_1.id] == None, "ship already exist, use updateStage() instead")
...
def var_0_0.listenerRandomStage(arg_10_0):
	arg_10_0.timerId = pg.TimeMgr.GetInstance().AddTimer("listenerRandomStage", 0, 1, function()
		if arg_10_0.data.randomexpeditions and table.getCount(arg_10_0.data.randomexpeditions) > 0:
			local var_11_0 = pg.TimeMgr.GetInstance().GetServerTime()

			for iter_11_0, iter_11_1 in pairs(arg_10_0.data.randomexpeditions):
				if iter_11_1.out_time == var_11_0:
					arg_10_0.removeRandomStageById(iter_11_1.id))

def var_0_0.removeRandomStageById(arg_12_0, arg_12_1):
	assert(arg_12_0.data.randomexpeditions[arg_12_1], "不存在随机卡关" .. arg_12_1)

	arg_12_0.data.randomexpeditions[arg_12_1] = None
