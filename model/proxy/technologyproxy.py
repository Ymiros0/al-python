...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.on(63100, function(arg_4_0)
		for iter_4_0, iter_4_1 in ipairs(arg_4_0.blueprint_list):
...
def var_0_0.setVersion(arg_5_0, arg_5_1):
	PlayerPrefs.SetInt("technology_version", arg_5_1)
	PlayerPrefs.Save()

def var_0_0.getVersion(arg_6_0):
	if not PlayerPrefs.HasKey("technology_version"):
...
def var_0_0.getConfigMaxVersion(arg_7_0):
	return arg_7_0.maxConfigVersion

def var_0_0.setTendency(arg_8_0, arg_8_1, arg_8_2):
	arg_8_0.tendency[arg_8_1] = arg_8_2

def var_0_0.getTendency(arg_9_0, arg_9_1):
	return arg_9_0.tendency[arg_9_1]

def var_0_0.updateBlueprintStates(arg_10_0):
	for iter_10_0, iter_10_1 in pairs(arg_10_0.bluePrintData or {}):
		iter_10_1.updateState()

def var_0_0.getColdTime(arg_11_0):
	return arg_11_0.coldTime

def var_0_0.updateColdTime(arg_12_0):
	arg_12_0.coldTime = pg.TimeMgr.GetInstance().GetServerTime() + 86400

def var_0_0.updateRefreshFlag(arg_13_0, arg_13_1):
...
def var_0_0.updateTechnologys(arg_14_0, arg_14_1):
	arg_14_0.data = {}

	for iter_14_0, iter_14_1 in ipairs(arg_14_1):
		arg_14_0.tendency[iter_14_1.id] = iter_14_1.target

		for iter_14_2, iter_14_3 in ipairs(iter_14_1.technologys):
...
def var_0_0.updateTechnologyQueue(arg_16_0, arg_16_1):
	arg_16_0.queue = {}
...
def var_0_0.moveTechnologyToQueue(arg_18_0, arg_18_1):
	...
	arg_18_0.data[arg_18_1] = None

def var_0_0.removeFirstQueueTechnology(arg_19_0):
	assert(#arg_19_0.queue > 0)
	table.remove(arg_19_0.queue, 1)

def var_0_0.getActivateTechnology(arg_20_0):
	for iter_20_0, iter_20_1 in pairs(arg_20_0.data or {}):
		if iter_20_1.isActivate():
			return Clone(iter_20_1)

def var_0_0.getTechnologyById(arg_21_0, arg_21_1):
	assert(arg_21_0.data[arg_21_1], "technology should exist>>" .. arg_21_1)

	return arg_21_0.data[arg_21_1].clone()

def var_0_0.updateTechnology(arg_22_0, arg_22_1):
...
def var_0_0.getBuildingBluePrint(arg_30_0):
	for iter_30_0, iter_30_1 in pairs(arg_30_0.bluePrintData):
		if iter_30_1.isDeving() or iter_30_1.isFinished():
			return iter_30_1

def var_0_0.GetBlueprint4Item(arg_31_0, arg_31_1):
	return arg_31_0.item2blueprint[arg_31_1]

def var_0_0.getCatchupData(arg_32_0, arg_32_1):
	if not arg_32_0.catchupData[arg_32_1]:
...
def var_0_0.updateCatchupData(arg_33_0, arg_33_1, arg_33_2, arg_33_3):
	arg_33_0.catchupData[arg_33_1].addTargetNum(arg_33_2, arg_33_3)

def var_0_0.getCurCatchNum(arg_34_0):
	if arg_34_0.curCatchupTecID != 0 and arg_34_0.curCatchupGroupID != 0:
		return arg_34_0.catchupData[arg_34_0.curCatchupTecID].getTargetNum(arg_34_0.curCatchupGroupID)
	else
		return 0

def var_0_0.getCatchupState(arg_35_0, arg_35_1):
	if not arg_35_0.catchupData[arg_35_1]:
		return TechnologyCatchup.STATE_UNSELECT

	return arg_35_0.catchupData[arg_35_1].getState()

def var_0_0.updateCatchupStates(arg_36_0):
	for iter_36_0, iter_36_1 in pairs(arg_36_0.catchupData):
		iter_36_1.updateState()

def var_0_0.isOpenTargetCatchup(arg_37_0):
	return pg.technology_catchup_template != None and #pg.technology_catchup_template.all > 0

def var_0_0.getNewestCatchupTecID(arg_38_0):
	return math.max(unpack(pg.technology_catchup_template.all))

def var_0_0.isOnCatchup(arg_39_0):
	return arg_39_0.curCatchupTecID != 0 and arg_39_0.curCatchupGroupID != 0

def var_0_0.getBluePrintVOByGroupID(arg_40_0, arg_40_1):
	return arg_40_0.bluePrintData[arg_40_1]

def var_0_0.getCurCatchupTecInfo(arg_41_0):
	return {
...
def var_0_0.setCurCatchupTecInfo(arg_42_0, arg_42_1, arg_42_2):
...
def var_0_0.addCatupPrintsNum(arg_43_0, arg_43_1):
...
def var_0_0.IsShowTip(arg_44_0):
...
def var_0_0.calcMaxPursuingCount(arg_48_0, arg_48_1):
	...
	local function var_48_3(arg_49_0)
		...
		while arg_49_0 < var_48_0[var_49_0][1]:
			var_49_0 = var_49_0 - 1
	...
	for iter_48_0 = arg_48_0.getPursuingTimes(arg_48_1.isRarityUR()) + 1, var_48_0[#var_48_0][1] - 1:
		local var_48_5 = arg_48_1.getPursuingPrice(var_48_3(iter_48_0))

		if var_48_1 < var_48_5:
			return var_48_2
		else
...
def var_0_0.calcPursuingCost(arg_50_0, arg_50_1, arg_50_2):
	...
	local function var_50_2(arg_51_0)
		...
		while arg_51_0 < var_50_0[var_51_0][1]:
			var_51_0 = var_51_0 - 1
	...
	for iter_50_0 = arg_50_0.getPursuingTimes(arg_50_1.isRarityUR()) + 1, var_50_0[#var_50_0][1] - 1:
...
def var_0_0.getPursuingDiscount(arg_52_0, arg_52_1):
	...
	while arg_52_0 < var_52_0[var_52_1][1]:
		var_52_1 = var_52_1 - 1

	return var_52_0[var_52_1][2]

def var_0_0.getItemCanUnlockBluePrint(arg_53_0, arg_53_1):
	if not arg_53_0.unlockItemDic:
		arg_53_0.unlockItemDic = {}

		for iter_53_0, iter_53_1 in ipairs(pg.ship_data_blueprint.all):
			local var_53_0 = arg_53_0.bluePrintData[iter_53_1]

			for iter_53_2, iter_53_3 in ipairs(var_53_0.getConfig("gain_item_id")):
...
def var_0_0.CheckPursuingCostTip(arg_54_0, arg_54_1):
	if var_0_0.getPursuingDiscount(arg_54_0.pursuingTimes + 1, False) > 0 and var_0_0.getPursuingDiscount(arg_54_0.pursuingTimesUR + 1, True) > 0:
		return False
	...
	if arg_54_1:
		...
		for iter_54_2 = 1, arg_54_0.maxConfigVersion:
			var_54_0[iter_54_2] = True

	for iter_54_3, iter_54_4 in pairs(arg_54_0.bluePrintData):
		if var_54_0[iter_54_4.getConfig("blueprint_version")] and iter_54_4.isPursuingCostTip():
			return True
