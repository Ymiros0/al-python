...
def var_0_0.Ctor(arg_3_0, arg_3_1):
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_1.data1_list or {}):
		table.insert(arg_3_0.data1_list, iter_3_1)

	arg_3_0.data2_list = {}

	for iter_3_2, iter_3_3 in ipairs(arg_3_1.data2_list or {}):
		table.insert(arg_3_0.data2_list, iter_3_3)

	arg_3_0.data3_list = {}

	for iter_3_4, iter_3_5 in ipairs(arg_3_1.data3_list or {}):
		table.insert(arg_3_0.data3_list, iter_3_5)

	arg_3_0.data4_list = {}

	for iter_3_6, iter_3_7 in ipairs(arg_3_1.data4_list or {}):
		table.insert(arg_3_0.data4_list, iter_3_7)

	arg_3_0.data1KeyValueList = {}

	for iter_3_8, iter_3_9 in ipairs(arg_3_1.date1_key_value_list or {}):
		arg_3_0.data1KeyValueList[iter_3_9.key] = {}

		for iter_3_10, iter_3_11 in ipairs(iter_3_9.value_list or {}):
			arg_3_0.data1KeyValueList[iter_3_9.key][iter_3_11.key] = iter_3_11.value

	arg_3_0.buffList = {}

	for iter_3_12, iter_3_13 in ipairs(arg_3_1.buff_list or {}):
		table.insert(arg_3_0.buffList, ActivityBuff.New(arg_3_0.id, iter_3_13.id, iter_3_13.timestamp))

	if arg_3_0.getConfig("type") == ActivityConst.ACTIVITY_TYPE_NEWSERVER_SHOP:
		arg_3_0.data2KeyValueList = {}

		for iter_3_14, iter_3_15 in ipairs(arg_3_1.date1_key_value_list or {}):
			...
			for iter_3_16, iter_3_17 in ipairs(iter_3_15.value_list or {}):
...
def var_0_0.GetBuffList(arg_4_0):
	return arg_4_0.buffList

def var_0_0.AddBuff(arg_5_0, arg_5_1):
	assert(isa(arg_5_1, ActivityBuff), "activityBuff should instance of ActivityBuff")
	table.insert(arg_5_0.buffList, arg_5_1)

def var_0_0.setClientList(arg_6_0, arg_6_1):
	arg_6_0.clientList = arg_6_1

def var_0_0.getClientList(arg_7_0):
	return arg_7_0.clientList

def var_0_0.updateDataList(arg_8_0, arg_8_1):
	table.insert(arg_8_0.data1_list, arg_8_1)

def var_0_0.setDataList(arg_9_0, arg_9_1):
	arg_9_0.data1_list = arg_9_1

def var_0_0.updateKVPList(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
	if not arg_10_0.data1KeyValueList[arg_10_1]:
		arg_10_0.data1KeyValueList[arg_10_1] = {}

	arg_10_0.data1KeyValueList[arg_10_1][arg_10_2] = arg_10_3

def var_0_0.getKVPList(arg_11_0, arg_11_1, arg_11_2):
	if not arg_11_0.data1KeyValueList[arg_11_1]:
		arg_11_0.data1KeyValueList[arg_11_1] = {}

	return arg_11_0.data1KeyValueList[arg_11_1][arg_11_2] or 0

def var_0_0.getData1(arg_12_0):
	return arg_12_0.data1

def var_0_0.getStrData1(arg_13_0):
	return arg_13_0.str_data1

def var_0_0.getData3(arg_14_0):
	return arg_14_0.data3

def var_0_0.getData1List(arg_15_0):
	return arg_15_0.data1_list

def var_0_0.bindConfigTable(arg_16_0):
	return pg.activity_template

def var_0_0.getDataConfigTable(arg_17_0):
	local var_17_0 = arg_17_0.getConfig("type")
	local var_17_1 = arg_17_0.getConfig("config_id")

	if var_17_0 == ActivityConst.ACTIVITY_TYPE_MONOPOLY:
		return pg.activity_event_monopoly[tonumber(var_17_1)]
	elif var_17_0 == ActivityConst.ACTIVITY_TYPE_PIZZA_PT or var_17_0 == ActivityConst.ACTIVITY_TYPE_PT_BUFF:
		return pg.activity_event_pt[tonumber(var_17_1)]
	elif var_17_0 == ActivityConst.ACTIVITY_TYPE_VOTE:
		return pg.activity_vote[tonumber(var_17_1)]

def var_0_0.getDataConfig(arg_18_0, arg_18_1):
...
def var_0_0.readyToAchieve(arg_21_0):
	...
	var_0_0.readyToAchieveDic = var_0_0.readyToAchieveDic or {
		...
		[ActivityConst.ACTIVITY_TYPE_LEVELAWARD] = function(arg_23_0)
			...
			for iter_23_0 = 1, #var_23_1.front_drops:
				local var_23_2 = var_23_1.front_drops[iter_23_0][1]

				if var_23_2 <= var_23_0.level and not _.include(arg_23_0.data1_list, var_23_2):
					return True
		...
		[ActivityConst.ACTIVITY_TYPE_STORY_AWARD] = function(arg_24_0)
			...
			for iter_24_0 = 1, #var_24_1.chapter:
				local var_24_2 = var_24_1.chapter[iter_24_0]

				if getProxy(ChapterProxy).isClear(var_24_2) and not _.include(arg_24_0.data1_list, var_24_2):
					return True
		...
		[ActivityConst.ACTIVITY_TYPE_TASKS] = function(arg_25_0)
			...
			if var_25_2 and not var_25_2.isEnd() and var_25_2.getConfig("config_client").linkActID == arg_25_0.id and var_25_2.readyToAchieve():
				return True

			if arg_25_0.getConfig("config_client") and arg_25_0.getConfig("config_client").decodeGameId:
				...
				if var_25_4:
					...
					local var_25_7 = _.all(var_25_6, function(arg_27_0)
						return getProxy(TaskProxy).getFinishTaskById(arg_27_0) != None)

					if var_25_4.ultimate <= 0 and var_25_7:
						return True

			if arg_25_0.getConfig("config_client") and arg_25_0.getConfig("config_client").linkTaskPoolAct:
				...
				if var_25_9 and var_25_9.readyToAchieve():
					return True
		...
		[ActivityConst.ACTIVITY_TYPE_RETURN_AWARD] = function(arg_34_0)
			...
			if var_34_0 == 1:
				...
				for iter_34_0, iter_34_1 in ipairs(arg_34_0.getClientList()):
					var_34_3 = var_34_3 + iter_34_1.getPt()

				local var_34_4 = 0

				for iter_34_2 = #var_34_2, 1, -1:
					if table.contains(arg_34_0.data1_list, var_34_2[iter_34_2]):
						var_34_4 = iter_34_2
		...
		[ActivityConst.ACTIVITY_TYPE_MINIGAME] = function(arg_37_0)
			...
			if var_37_0.getConfig("reward") != 0 and var_37_0.usedtime >= var_37_0.getConfig("reward_need") and var_37_0.ultimate == 0:
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_TURNTABLE] = function(arg_38_0)
			...
			if var_38_1 != 0:
				...
				for iter_38_0, iter_38_1 in ipairs(var_38_2):
					if (var_38_3.getTaskById(iter_38_1) or var_38_3.getFinishTaskById(iter_38_1)).getTaskStatus() == 1:
						return True

				local var_38_4 = pg.TimeMgr.GetInstance().DiffDay(arg_38_0.data1, pg.TimeMgr.GetInstance().GetServerTime()) + 1

				if math.clamp(var_38_4, 1, pg.activity_event_turning[arg_38_0.getConfig("config_id")].total_num) > arg_38_0.data3:
					for iter_38_2, iter_38_3 in ipairs(var_38_2):
						if (var_38_3.getTaskById(iter_38_3) or var_38_3.getFinishTaskById(iter_38_3)).getTaskStatus() != 2:
							return False
				...
				if math.clamp(var_38_5, 1, pg.activity_event_turning[arg_38_0.getConfig("config_id")].total_num) > arg_38_0.data3:
					return True
		...
		[ActivityConst.ACTIVITY_TYPE_SHRINE] = function(arg_40_0)
			...
			for iter_40_0 = 1, var_40_3:
				local var_40_6 = var_40_0[iter_40_0][1]

				if var_40_6 and iter_40_0 <= var_40_5 and not var_40_4.IsPlayed(var_40_6):
					return True

			if var_40_1 <= var_40_3 and var_40_1 <= arg_40_0.data2 and not (arg_40_0.data1 > 0):
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF] = function(arg_42_0)
			...
			for iter_42_0, iter_42_1 in ipairs(var_42_0):
				...
				if var_42_2 and var_42_1 < #var_42_2.buff:
					...
					if underscore.all(var_42_3, function(arg_43_0)
						...
						elif var_43_0 > DROP_TYPE_USE_ACTIVITY_DROP:
		...
		[ActivityConst.ACTIVITY_TYPE_EXPEDITION] = function(arg_45_0)
			if arg_45_0.data3 > 0 and arg_45_0.data1 != 0:
				return True
			else
				for iter_45_0 = 1, #arg_45_0.data1_list:
					if not bit.band(arg_45_0.data1_list[iter_45_0], ActivityConst.EXPEDITION_TYPE_GOT) != 0:
						if bit.band(arg_45_0.data1_list[iter_45_0], ActivityConst.EXPEDITION_TYPE_OPEN) != 0:
							return True
						elif bit.band(arg_45_0.data1_list[iter_45_0], ActivityConst.EXPEDITION_TYPE_BAOXIANG) != 0:
							return True
						elif bit.band(arg_45_0.data1_list[iter_45_0], ActivityConst.EXPEDITION_TYPE_BOSS) != 0:
							return True
		...
		[ActivityConst.ACTIVITY_TYPE_CLIENT_DISPLAY] = function(arg_46_0)
			...
			if var_46_0 and var_46_0.linkGameHubID:
				local var_46_1 = getProxy(MiniGameProxy).GetHubByHubId(var_46_0.linkGameHubID)

				if var_46_1:
					if var_46_0.trimRed:
						if var_46_1.ultimate == 1:
							return False

						if var_46_1.usedtime == var_46_1.getConfig("reward_need"):
							return True
		...
		[ActivityConst.ACTIVITY_TYPE_PUZZLA] = function(arg_48_0)
			...
			if var_48_3:
				...
				if var_48_4 and var_48_4.readyToAchieve():
					return True
			...
			if var_48_5 and var_48_5.chapter > 0 and arg_48_0.data1 < 1:
				return True

			if var_48_5 and #var_48_5.auto_finish_args > 0 and arg_48_0.data1 == 1:
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_APRIL_REWARD] = function(arg_51_0)
			if arg_51_0.data1 == 0:
				...
				if arg_51_0.getConfig("config_client").autounlock <= var_51_1 - var_51_0:
					return True
			elif arg_51_0.data1 != 0 and arg_51_0.data2 == 0:
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_PT_OTHER] = function(arg_55_0)
			if arg_55_0.data2 and arg_55_0.data2 <= 0 and arg_55_0.data1 >= pg.activity_event_avatarframe[arg_55_0.getConfig("config_id")].target:
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_HOTSPRING] = function(arg_56_0)
			...
			if arg_56_0.GetSlotCount() < arg_56_0.GetTotalSlotCount() and var_56_1 <= arg_56_0.GetCoins():
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_FIREWORK] = function(arg_57_0)
			...
			if arg_57_0.data1 > 0 and var_57_1 <= var_57_2:
				return True
		...
		[ActivityConst.ACTIVITY_TYPE_ISLAND] = function(arg_59_0)
			for iter_59_0, iter_59_1 in pairs(getProxy(IslandProxy).GetNodeDic()):
				if iter_59_1.IsVisual() and iter_59_1.RedDotHint():
					return True
		...
		[ActivityConst.ACTIVITY_TYPE_CARD_PUZZLE] = function(arg_61_0)
			...
			if #var_61_1 == #var_61_2:
				return False

			local function var_61_3()
				for iter_62_0, iter_62_1 in ipairs(var_61_2):
					if not table.contains(var_61_1, iter_62_1[1]) and var_61_0 >= iter_62_1[1]:
						return True
		...
		[ActivityConst.ACTIVITY_TYPE_GIFT_UP] = function(arg_66_0)
			...
			return underscore(var_66_0).chain().first(var_66_1).any(function(arg_67_0)
				...
				return var_67_0.canPurchase() and var_67_0.inTime() and not var_67_0.IsGroupLimit()).value(),
		[ActivityConst.ACTIVITY_TYPE_UR_EXCHANGE] = function(arg_68_0)
			if getProxy(ShopsProxy).getActivityShops() == None:
				return False
			...
			local var_68_4 = var_68_3 < var_68_2 and pg.activity_shop_template[var_68_0.goodsId[var_68_3]] or None

			return var_68_3 < var_68_2 and var_68_1 >= var_68_4.resource_num
	}

	return switch(arg_21_0.getConfig("type"), var_0_0.readyToAchieveDic, None, arg_21_0)

def var_0_0.IsShowTipById(arg_70_0):
	var_0_0.ShowTipTableById = var_0_0.ShowTipTableById or {
		[ActivityConst.ACTIVITY_ID_US_SKIRMISH_RE] = function()
			...
			for iter_71_0, iter_71_1 in ipairs(var_71_1):
		...
		[ActivityConst.POCKY_SKIN_LOGIN] = function()
			...
			local function var_72_8()
				...
				for iter_75_0 = 1, math.min(#var_75_0, var_72_4.data3):
					local var_75_1 = var_75_0[iter_75_0]
					local var_75_2 = var_72_1.getTaskById(var_75_1)

					if var_75_2 and var_75_2.isFinish() and not var_75_2.isReceive():
						return True

			local function var_72_9()
				if not (var_72_5 and var_72_5.readyToAchieve()) or not var_72_3:
					return False
...
def var_0_0.isShow(arg_78_0):
	if arg_78_0.getConfig("is_show") <= 0:
		return False

	if arg_78_0.getConfig("type") == ActivityConst.ACTIVITY_TYPE_RETURN_AWARD:
		return arg_78_0.data1 != 0
	elif arg_78_0.getConfig("type") == ActivityConst.ACTIVITY_TYPE_CLIENT_DISPLAY:
	...
	elif arg_78_0.getConfig("type") == ActivityConst.ACTIVITY_TYPE_SURVEY:
	...
	elif arg_78_0.getConfig("type") == ActivityConst.ACTIVITY_TYPE_UR_EXCHANGE:
		if getProxy(ShopsProxy).getActivityShops() == None:
			return False
...
def var_0_0.isAfterShow(arg_81_0):
	if arg_81_0.configId == ActivityConst.UR_TASK_ACT_ID or arg_81_0.configId == ActivityConst.SPECIAL_WEAPON_ACT_ID:
...
def var_0_0.getShowPriority(arg_83_0):
	return arg_83_0.getConfig("is_show")

def var_0_0.left4Day(arg_84_0):
	if arg_84_0.stopTime - pg.TimeMgr.GetInstance().GetServerTime() < 345600:
		return True

	return False

def var_0_0.getAwardInfos(arg_85_0):
	return arg_85_0.data1KeyValueList or {}

def var_0_0.updateData(arg_86_0, arg_86_1, arg_86_2):
	if arg_86_0.getConfig("type") == ActivityConst.ACTIVITY_TYPE_LOTTERY:
		if not arg_86_0.getAwardInfos()[arg_86_1]:
			arg_86_0.data1KeyValueList[arg_86_1] = {}

		for iter_86_0, iter_86_1 in ipairs(arg_86_2):
			if arg_86_0.data1KeyValueList[arg_86_1][iter_86_1]:
...
def var_0_0.getTaskShip(arg_87_0):
	return arg_87_0.getConfig("config_client")[1]

def var_0_0.getNotificationMsg(arg_88_0):
	local var_88_0 = arg_88_0.getConfig("type")
	local var_88_1 = ActivityProxy.ACTIVITY_SHOW_AWARDS

	if var_88_0 == ActivityConst.ACTIVITY_TYPE_SHOP:
		var_88_1 = ActivityProxy.ACTIVITY_SHOP_SHOW_AWARDS
	elif var_88_0 == ActivityConst.ACTIVITY_TYPE_LOTTERY:
		var_88_1 = ActivityProxy.ACTIVITY_LOTTERY_SHOW_AWARDS
	elif var_88_0 == ActivityConst.ACTIVITY_TYPE_REFLUX:
		var_88_1 = ActivityProxy.ACTIVITY_SHOW_REFLUX_AWARDS
	elif var_88_0 == ActivityConst.ACTIVITY_TYPE_RED_PACKETS or var_88_0 == ActivityConst.ACTIVITY_TYPE_RED_PACKET_LOTTER:
		var_88_1 = ActivityProxy.ACTIVITY_SHOW_RED_PACKET_AWARDS

	return var_88_1

def var_0_0.getDayIndex(arg_89_0):
...
def var_0_0.isVariableTime(arg_92_0):
	local var_92_0, var_92_1 = parseTimeConfig(arg_92_0.getConfig("time"))

	return var_92_1 and var_92_1[1] == "newuser"

def var_0_0.setSpecialData(arg_93_0, arg_93_1, arg_93_2):
	arg_93_0.speciaData = arg_93_0.speciaData and arg_93_0.speciaData or {}
	arg_93_0.speciaData[arg_93_1] = arg_93_2

def var_0_0.getSpecialData(arg_94_0, arg_94_1):
	return arg_94_0.speciaData and arg_94_0.speciaData[arg_94_1] and arg_94_0.speciaData[arg_94_1] or None

def var_0_0.canPermanentFinish(arg_95_0):
	local var_95_0 = arg_95_0.getConfig("type")

	if var_95_0 == ActivityConst.ACTIVITY_TYPE_TASK_LIST:
		...
		return underscore.all(underscore.flatten({
			...
			return var_95_2.getFinishTaskById(arg_96_0) != None)
	elif var_95_0 == ActivityConst.ACTIVITY_TYPE_PT_BUFF:
...
def var_0_0.GetShopTime(arg_97_0):
...
def var_0_0.GetCrusingUnreceiveAward(arg_98_0):
	...
	for iter_98_0, iter_98_1 in ipairs(arg_98_0.data1_list):
		var_98_2[iter_98_1] = True

	for iter_98_2, iter_98_3 in ipairs(var_98_0.target):
		if iter_98_3 > arg_98_0.data1:
			break
		elif not var_98_2[iter_98_3]:
	...
	for iter_98_4, iter_98_5 in ipairs(arg_98_0.data2_list):
		var_98_3[iter_98_5] = True

	for iter_98_6, iter_98_7 in ipairs(var_98_0.target):
		if iter_98_7 > arg_98_0.data1:
			break
		elif not var_98_3[iter_98_7]:
			table.insert(var_98_1, Drop.Create(var_98_0.drop_client_pay[iter_98_6]))

	return PlayerConst.MergePassItemDrop(var_98_1)

def var_0_0.GetCrusingInfo(arg_99_0):
	...
	for iter_99_0, iter_99_1 in ipairs(var_99_0.key_point_display):
		var_99_3[iter_99_1] = True

	for iter_99_2, iter_99_3 in ipairs(var_99_0.target):
	...
	for iter_99_4, iter_99_5 in ipairs(arg_99_0.data1_list):
		var_99_6[iter_99_5] = True

	local var_99_7 = {}

	for iter_99_6, iter_99_7 in ipairs(arg_99_0.data2_list):
		var_99_7[iter_99_7] = True

	local var_99_8 = 0

	for iter_99_8, iter_99_9 in ipairs(var_99_2):
		if var_99_4 < iter_99_9.pt:
			break
		else
			var_99_8 = iter_99_8
