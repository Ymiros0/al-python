...
def var_0_0.GetItems(arg_3_0):
	return arg_3_0.items

def var_0_0.InitItems(arg_4_0, arg_4_1):
...
def var_0_0.GetSlots(arg_6_0):
	return arg_6_0.slots

def var_0_0.UpdateBuffSlots(arg_7_0, arg_7_1):
...
def var_0_0.AddItem(arg_9_0, arg_9_1):
...
def var_0_0.GetItemById(arg_10_0, arg_10_1):
	return arg_10_0.items[arg_10_1]

def var_0_0.subItemCount(arg_11_0, arg_11_1, arg_11_2):
	if not arg_11_0.items[arg_11_1]:
		return

	arg_11_0.items[arg_11_1].count = math.max(0, arg_11_0.items[arg_11_1].count - arg_11_2)

def var_0_0.GetAllVitems(arg_12_0):
	return table.map(arg_12_0.GetItems(), function(arg_13_0)
		return arg_13_0.count)

def var_0_0.getVitemNumber(arg_14_0, arg_14_1):
	local var_14_0 = arg_14_0.GetItemById(arg_14_1)

	return var_14_0 and var_14_0.count or 0

def var_0_0.addVitemNumber(arg_15_0, arg_15_1, arg_15_2):
	arg_15_0.AddItem(AtelierMaterial.New({
		configId = arg_15_1,
		count = arg_15_2
	}))

def var_0_0.subVitemNumber(arg_16_0, arg_16_1, arg_16_2):
	arg_16_0.subItemCount(arg_16_1, arg_16_2)

def var_0_0.GetFormulas(arg_17_0):
	return arg_17_0.formulas

def var_0_0.InitAllFormulas(arg_18_0):
	arg_18_0.formulas = {}
...
def var_0_0.InitFormulaUseCounts(arg_20_0, arg_20_1):
