...
def var_0_0.GetSignedList(arg_2_0):
	return arg_2_0.data1_list

def var_0_0.GetIndexByToday(arg_3_0):
	return arg_3_0.getDayIndex()

def var_0_0.GetTotalDayCnt(arg_4_0):
	return #arg_4_0.GetDropList()

def var_0_0.GetDropList(arg_5_0):
	local var_5_0 = {}

	for iter_5_0, iter_5_1 in ipairs(arg_5_0.dataConfig.drop_display):
...
def var_0_0.GetCanGetAwardIndexList(arg_11_0):
	...
	for iter_11_0 = var_11_2 + 1, var_11_4:
		table.insert(var_11_5, iter_11_0)

	return var_11_5

def var_0_0.GetAwardState(arg_13_0, arg_13_1):
	local var_13_0 = arg_13_0.GetCanGetAwardIndexList()

	if table.contains(var_13_0, arg_13_1):
		return var_0_0.STATE_CAN_GET
	elif table.contains(arg_13_0.data2_list, arg_13_1):
		return var_0_0.STATE_GOT
	else
		return var_0_0.STATE_EMPTY

def var_0_0.GetGetAwardCnt(arg_14_0):
	return #arg_14_0.data2_list

def var_0_0.GetAllAwards(arg_15_0):
...
def var_0_0.GetIndexAward(arg_16_0, arg_16_1):
	if not table.contains(arg_16_0.data2_list, arg_16_1):
		arg_16_0.data2 = arg_16_0.data2 + 1

		table.insert(arg_16_0.data2_list, arg_16_1)

def var_0_0.IsManualSignActAndAnyAwardCanGet(arg_17_0):
	local var_17_0 = getProxy(ActivityProxy).getActivityById(arg_17_0)

	if not var_17_0 or var_17_0.isEnd():
		return False

	if not isa(var_17_0, ManualSignActivity):
		return False
