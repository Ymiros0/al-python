...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_1.skins):
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_1.regular_trigger):
	...
	for iter_1_4, iter_1_5 in ipairs(arg_1_1.dialogues):
		arg_1_0.talkDic[iter_1_5] = True

	arg_1_0.collectItemDic = {}

	for iter_1_6, iter_1_7 in ipairs(arg_1_1.collections):
		arg_1_0.collectItemDic[iter_1_7] = True

	arg_1_0.zoneDic = {}

	for iter_1_8, iter_1_9 in ipairs(pg.dorm3d_zone_template.get_id_list_by_char_id[arg_1_0.configId]):
		local var_1_0 = Dorm3dZone.New({
			configId = iter_1_9
		})
		local var_1_1 = var_1_0.GetWatchCameraName()

		if var_1_1 and var_1_1 != "":
			arg_1_0.zoneDic[var_1_1] = var_1_0

def var_0_0.bindConfigTable(arg_10_0):
	return pg.dorm3d_dorm_template

def var_0_0.getFavorConfig(arg_11_0, arg_11_1, arg_11_2):
...
def var_0_0.GetSkinModelName(arg_26_0):
...
def var_0_0.getTalkingList(arg_42_0):
...
def var_0_0.getEnterTalking(arg_43_0):
...
def var_0_0.getFurnitureTalking(arg_45_0, arg_45_1):
...
def var_0_0.getTouchConfig(arg_47_0, arg_47_1):
	local var_47_0
	local var_47_1 = {}

	for iter_47_0, iter_47_1 in ipairs(pg.dorm3d_touch_data.get_id_list_by_char_id[arg_47_0.configId]):
		if arg_47_1 == pg.dorm3d_touch_data[iter_47_1].trigger_area:
	...
	for iter_47_2, iter_47_3 in ipairs(var_47_0.stage_unlock):
		if var_47_2 < iter_47_2:
			break
		else
	...
	local var_47_3 = {
		[0] = envFunc(function()
			up,:nw, left, right, zoom_in, zoom_out = unpack(var_47_0.camera_trigger[var_47_2]), {})
	}

	for iter_47_4, iter_47_5 in ipairs(var_47_1):
...
def var_0_0.getGiftIds(arg_49_0):
	local var_49_0 = pg.dorm3d_gift.get_id_list_by_ship_group_id

	return table.mergeArray(var_49_0[0], var_49_0[arg_49_0.configId])

def var_0_0.getCollectConfig(arg_50_0, arg_50_1):
	local var_50_0 = pg.dorm3D_collect[arg_50_0.configId]

	return var_50_0 and var_50_0[arg_50_1] or None

def var_0_0.getTriggerableCollectItems(arg_51_0):
	local var_51_0 = {}

	for iter_51_0, iter_51_1 in ipairs(arg_51_0.getCollectConfig("collection_template_list")):
		local var_51_1 = pg.dorm3d_collection_template[iter_51_1]

		if not arg_51_0.collectItemDic[iter_51_1] and arg_51_0.checkUnlockConfig(var_51_1.unlock):
			table.insert(var_51_0, iter_51_1)

	return var_51_0

def var_0_0.checkUnlockConfig(arg_52_0, arg_52_1):
	local var_52_0, var_52_1 = unpack(arg_52_1)

	return switch(var_52_0, {
		function()
			if arg_52_0.level >= var_52_1:
				return True
			else
		...
		function()
			if underscore.any(arg_52_0.furnitures, function(arg_55_0)
				...
				return False, string.format("without:rm furniture.%d", var_52_1),
		function()
			if getProxy(ApartmentProxy).isGiveGiftDone(var_52_1):
				return True
			else
...
def var_0_0.getZone(arg_58_0, arg_58_1):
	return arg_58_0.zoneDic[arg_58_1]

def var_0_0.getZoneNames(arg_59_0):
