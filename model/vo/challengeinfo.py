...
def var_0_0.checkRecord(arg_3_0, arg_3_1):
	local var_3_0 = arg_3_1.getMode()
	local var_3_1 = arg_3_1.getScore()

	if var_3_0 == ChallengeProxy.MODE_CASUAL:
...
def var_0_0.getGradeList(arg_4_0):
	return {
...
def var_0_0.getSeasonID(arg_5_0):
	return arg_5_0._seasonID

def var_0_0.getDungeonIDList(arg_6_0):
	return Clone(arg_6_0._dungeonList)

def var_0_0.getActivityIndex(arg_7_0):
