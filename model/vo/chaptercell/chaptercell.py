...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	arg_1_0.item = None
	arg_1_0.itemOffset = None
	arg_1_0.flagList = {}

	if arg_1_1.flag_list:
		for iter_1_0, iter_1_1 in ipairs(arg_1_1.flag_list):
			table.insert(arg_1_0.flagList, iter_1_1)

def var_0_0.updateFlagList(arg_2_0, arg_2_1):
	arg_2_0.flagList = arg_2_0.flagList or {}

	table.clear(arg_2_0.flagList)

	for iter_2_0, iter_2_1 in ipairs(arg_2_1.flag_list):
		table.insert(arg_2_0.flagList, iter_2_1)

def var_0_0.GetFlagList(arg_3_0):
	return arg_3_0.flagList

def var_0_0.GetWeatherFlagList(arg_4_0):
	return _.filter(arg_4_0.GetFlagList(), function(arg_5_0)
		return tobool(pg.weather_data_template[arg_5_0]))

def var_0_0.checkHadFlag(arg_6_0, arg_6_1):
	return table.contains(arg_6_0.flagList, arg_6_1)

def var_0_0.Line2Name(arg_7_0, arg_7_1):
	return "chapter_cell_" .. arg_7_0 .. "_" .. arg_7_1

def var_0_0.Line2QuadName(arg_8_0, arg_8_1):
	return "chapter_cell_quad_" .. arg_8_0 .. "_" .. arg_8_1

def var_0_0.Line2MarkName(arg_9_0, arg_9_1, arg_9_2):
	return "chapter_cell_mark_" .. arg_9_0 .. "_" .. arg_9_1 .. "#" .. arg_9_2

def var_0_0.MinMaxLine2QuadName(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
	return "chapter_cell_quad_" .. arg_10_0 .. "_" .. arg_10_1 .. "_" .. arg_10_2 .. "_" .. arg_10_3

def var_0_0.Line2RivalName(arg_11_0, arg_11_1, arg_11_2):
	return "rival_" .. arg_11_1 .. "_" .. arg_11_2

def var_0_0.LineAround(arg_12_0, arg_12_1, arg_12_2):
	local var_12_0 = {}

	for iter_12_0 = -arg_12_2, arg_12_2:
		for iter_12_1 = -arg_12_2, arg_12_2:
			if arg_12_2 >= math.abs(iter_12_0) + math.abs(iter_12_1):
