...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2):
	...
	_.each(arg_1_1.strategy_ids, function(arg_4_0)
		if pg.strategy_data_template[arg_4_0]:
...
def var_0_0.prepareShips(arg_13_0, arg_13_1):
	arg_13_0.statics = {}
...
def var_0_0.updateShips(arg_15_0, arg_15_1):
...
def var_0_0.ResortShips(arg_17_0):
	local var_17_0 = {
		TeamType.Vanguard,
		TeamType.Main,
		TeamType.Submarine
...
def var_0_0.getTeamByName(arg_22_0, arg_22_1):
	local var_22_0 = {}
...
def var_0_0.flushShips(arg_23_0):
...
def var_0_0.getShip(arg_28_0, arg_28_1):
	return arg_28_0.ships[arg_28_1]

def var_0_0.getShips(arg_29_0, arg_29_1):
	local var_29_0 = {}
	local var_29_1 = arg_29_0.getFleetType()

	if var_29_1 == FleetType.Normal:
	...
	elif var_29_1 == FleetType.Submarine:
		_.each(arg_29_0.getShipsByTeam(TeamType.Submarine, arg_29_1), function(arg_32_0)
			table.insert(var_29_0, arg_32_0))
	elif var_29_1 == FleetType.Support:
		for iter_29_0, iter_29_1 in pairs(arg_29_0.ships):
			table.insert(var_29_0, iter_29_1)

	return var_29_0

def var_0_0.getShipsByTeam(arg_33_0, arg_33_1, arg_33_2):
	local var_33_0 = {}

	for iter_33_0, iter_33_1 in ipairs(arg_33_0[arg_33_1]):
		if iter_33_1.hpRant > 0:
			var_33_0[#var_33_0 + 1] = iter_33_1

	if arg_33_2:
		for iter_33_2, iter_33_3 in ipairs(arg_33_0[arg_33_1]):
			if iter_33_3.hpRant <= 0:
				var_33_0[#var_33_0 + 1] = iter_33_3

	return var_33_0

def var_0_0.containsShip(arg_34_0, arg_34_1):
	return arg_34_0.ships[arg_34_1] and True or False

def var_0_0.replaceShip(arg_35_0, arg_35_1, arg_35_2):
	errorMsg("ChapterFleet replaceShip function used")

	if arg_35_0.ships[arg_35_1] and not arg_35_0.ships[arg_35_2.id]:
		local var_35_0 = arg_35_0.ships[arg_35_1]
		local var_35_1 = arg_35_0.fetchShipVO(arg_35_2.id)

		if var_35_1:
			if var_35_1.getTeamType() == var_35_0.getTeamType():
				if not var_35_0.isSameKind(var_35_1) and arg_35_0.containsSameKind(var_35_1):
					arg_35_0.removeShip(arg_35_1)
				else
					var_35_1.hpRant = arg_35_2.hp_rant
					arg_35_0.ships[arg_35_1] = None
					arg_35_0.ships[var_35_1.id] = var_35_1

					local var_35_2 = arg_35_0[var_35_1.getTeamType()]

					for iter_35_0 = 1, #var_35_2:
						if var_35_2[iter_35_0].id == arg_35_1:
...
def var_0_0.addShip(arg_36_0, arg_36_1):
	errorMsg("ChapterFleet addShip function used")

	if not arg_36_0.ships[arg_36_1.id]:
...
def var_0_0.removeShip(arg_37_0, arg_37_1):
	errorMsg("ChapterFleet removeShip function used")

	arg_37_0.ships[arg_37_1] = None
	...
	for iter_37_0 = 1, #var_37_0:
		local var_37_1 = arg_37_0[var_37_0[iter_37_0]]

		for iter_37_1 = #var_37_1, 1, -1:
			if var_37_1[iter_37_1].id == arg_37_1:
				table.remove(var_37_1, iter_37_1)

def var_0_0.switchShip(arg_38_0, arg_38_1, arg_38_2, arg_38_3):
...
def var_0_0.getInvestSums(arg_46_0, arg_46_1):
...
def var_0_0.getDodgeSums(arg_48_0):
...
def var_0_0.getAntiAircraftSums(arg_50_0):
...
def var_0_0.getShipAmmo(arg_52_0):
	local var_52_0 = 0

	if arg_52_0.getFleetType() == FleetType.Normal:
		for iter_52_0, iter_52_1 in pairs(arg_52_0.ships):
			var_52_0 = math.max(var_52_0, iter_52_1.getShipAmmo())
	elif arg_52_0.getFleetType() == FleetType.Submarine:
		for iter_52_2, iter_52_3 in pairs(arg_52_0.ships):
			var_52_0 = var_52_0 + iter_52_3.getShipAmmo()
	elif arg_52_0.getFleetType() == FleetType.Support:
		var_52_0 = 0

	return var_52_0

def var_0_0.clearShipHpChange(arg_53_0):
	for iter_53_0, iter_53_1 in pairs(arg_53_0.ships):
		arg_53_0.ships[iter_53_1.id].hpChange = 0

def var_0_0.getEquipAmbushRateReduce(arg_54_0):
	local var_54_0 = 0

	for iter_54_0, iter_54_1 in pairs(arg_54_0.ships):
		for iter_54_2, iter_54_3 in pairs(iter_54_1.getActiveEquipments()):
			if iter_54_3:
				var_54_0 = math.max(var_54_0, iter_54_3.getConfig("equip_parameters").ambush_extra or 0)

	return var_54_0 / 10000

def var_0_0.getEquipDodgeRateUp(arg_55_0):
	local var_55_0 = 0

	for iter_55_0, iter_55_1 in pairs(arg_55_0.ships):
		for iter_55_2, iter_55_3 in pairs(iter_55_1.getActiveEquipments()):
			if iter_55_3:
				var_55_0 = math.max(var_55_0, iter_55_3.getConfig("equip_parameters").avoid_extra or 0)

	return var_55_0 / 10000

def var_0_0.isFormationDiffWith(arg_56_0, arg_56_1):
	local var_56_0 = {
		TeamType.Main,
		TeamType.Vanguard,
		TeamType.Submarine
	...
	for iter_56_0, iter_56_1 in ipairs(var_56_0):
		...
		for iter_56_2 = 1, math.max(#var_56_1, #var_56_2):
			if var_56_1[iter_56_2] != var_56_2[iter_56_2] and (var_56_1[iter_56_2] == None or var_56_2[iter_56_2] == None or var_56_1[iter_56_2].id != var_56_2[iter_56_2].id):
				return True

	return False

def var_0_0.getShipIds(arg_57_0):
	local var_57_0 = {}
	local var_57_1 = arg_57_0.getFleetType()

	if var_57_1 == FleetType.Normal:
...
def var_0_0.getOwnStrategies(arg_70_0):
	local var_70_0 = {}
...
def var_0_0.achievedStrategy(arg_74_0, arg_74_1, arg_74_2):
	arg_74_0.stgPicked[arg_74_1] = (arg_74_0.stgPicked[arg_74_1] or 0) + arg_74_2

def var_0_0.consumeOneStrategy(arg_75_0, arg_75_1):
	local var_75_0 = arg_75_0.getOwnStrategies()

	if var_75_0[arg_75_1] and var_75_0[arg_75_1] > 0:
		...
		if var_75_2[arg_75_1]:
			var_75_2[arg_75_1] = math.max(0, var_75_2[arg_75_1] - 1)

def var_0_0.GetStrategyCount(arg_76_0, arg_76_1):
...
def var_0_0.getFormationStg(arg_78_0):
	return PlayerPrefs.GetInt("team_formation_" .. arg_78_0.id, 1)

def var_0_0.canUseStrategy(arg_79_0, arg_79_1):
	local var_79_0 = pg.strategy_data_template[arg_79_1.id]

	if var_79_0.type == ChapterConst.StgTypeForm:
		if arg_79_0.getFormationStg() == var_79_0.id:
			pg.TipsMgr.GetInstance().ShowTips(i18n("level_scene_formation_active_already"))

			return False
	elif var_79_0.type == ChapterConst.StgTypeConsume or var_79_0.type == ChapterConst.StgTypeBindSupportConsume:
		if arg_79_1.count <= 0:
...
def var_0_0.getNextStgUser(arg_81_0, arg_81_1):
	return arg_81_0.id

def var_0_0.GetStatusStrategy(arg_82_0):
	return arg_82_0.stgIds

def var_0_0.getFleetType(arg_83_0):
	local var_83_0 = 0

	for iter_83_0, iter_83_1 in pairs(arg_83_0.ships):
		local var_83_1 = iter_83_1.getTeamType()

		if var_83_1 == TeamType.Submarine:
			return FleetType.Submarine
		elif var_83_1 == TeamType.Vanguard:
			var_83_0 = var_83_0 + 1
...
def var_0_0.canClearTorpedo(arg_84_0):
...
def var_0_0.getHuntingRange(arg_86_0, arg_86_1):
	if arg_86_0.getFleetType() != FleetType.Submarine:
		assert(False)
...
def var_0_0.getMapAura(arg_92_0):
	local var_92_0 = {}

	for iter_92_0, iter_92_1 in pairs(arg_92_0.ships):
		local var_92_1 = iter_92_1.getMapAuras()

		for iter_92_2, iter_92_3 in ipairs(var_92_1):
			table.insert(var_92_0, iter_92_3)

	return var_92_0

def var_0_0.getMapAid(arg_93_0):
	local var_93_0 = {}

	for iter_93_0, iter_93_1 in pairs(arg_93_0.ships):
		local var_93_1 = iter_93_1.getMapAids()

		for iter_93_2, iter_93_3 in ipairs(var_93_1):
...
def var_0_0.updateCommanderSkills(arg_94_0):
...
def var_0_0.getFleetAirDominanceValue(arg_106_0):
	local var_106_0 = 0

	for iter_106_0, iter_106_1 in ipairs(arg_106_0.getShips(False)):
		var_106_0 = var_106_0 + calcAirDominanceValue(iter_106_1, arg_106_0.getCommanders())

	return var_106_0

def var_0_0.StaticTransformChapterFleet2Fleet(arg_107_0, arg_107_1):
	...
	for iter_107_0, iter_107_1 in pairs(arg_107_0.commanders):
