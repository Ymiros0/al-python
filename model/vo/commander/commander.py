...
def var_0_0.rarity2Frame(arg_2_0):
	if not var_0_0.frames:
		var_0_0.frames = {
			"2",
			"2",
			"2",
...
def var_0_0.Ctor(arg_3_0, arg_3_1):
	...
	if arg_3_1.name and arg_3_1.name != "":
	...
	for iter_3_0, iter_3_1 in ipairs(arg_3_1.ability_origin):
	...
	for iter_3_2, iter_3_3 in ipairs(arg_3_1.ability):
	...
	for iter_3_4, iter_3_5 in ipairs(arg_3_1.skill):
...
def var_0_0.IsRegularTalent(arg_4_0):
	return arg_4_0.getConfig("ability_refresh_type") == var_0_4

def var_0_0.getRenameTime(arg_5_0):
	return arg_5_0.renameTime

def var_0_0.setRenameTime(arg_6_0, arg_6_1):
	arg_6_0.renameTime = arg_6_1

def var_0_0.canModifyName(arg_7_0):
	return pg.TimeMgr.GetInstance().GetServerTime() >= arg_7_0.renameTime

def var_0_0.getRenameTimeDesc(arg_8_0):
...
local function var_0_5(arg_16_0, arg_16_1)
	...
	for iter_16_0, iter_16_1 in ipairs(arg_16_1):
		if arg_16_0.IsLearnedTalent(iter_16_1.id):
			return iter_16_1

	return arg_16_1[1]

def var_0_0.GetDisplayTalents(arg_18_0):
	if arg_18_0.IsRegularTalent():
		local var_18_0 = {}

		for iter_18_0, iter_18_1 in ipairs(arg_18_0.getConfig("ability_show")):
			local var_18_1 = CommanderTalent.New({
				id = iter_18_1
			})

			if not var_18_0[var_18_1.groupId]:
		...
		for iter_18_2, iter_18_3 in pairs(var_18_0):
...
def var_0_0.IsLearnedTalent(arg_20_0, arg_20_1):
	for iter_20_0, iter_20_1 in ipairs(arg_20_0.talents):
		if iter_20_1.id == arg_20_1:
			return True

	return False

def var_0_0.getTalents(arg_21_0):
	return arg_21_0.talents

def var_0_0.getTalentOrigins(arg_22_0):
	return arg_22_0.talentOrigins

def var_0_0.addTalent(arg_23_0, arg_23_1):
...
def var_0_0.deleteTablent(arg_25_0, arg_25_1):
	for iter_25_0, iter_25_1 in ipairs(arg_25_0.talents):
		if iter_25_1.id == arg_25_1:
			table.remove(arg_25_0.talents, iter_25_0)

			break

def var_0_0.getTalent(arg_26_0, arg_26_1):
	for iter_26_0, iter_26_1 in pairs(arg_26_0.talents):
		if iter_26_1 == arg_26_1:
			return iter_26_1

def var_0_0.resetTalents(arg_27_0):
	arg_27_0.talents = Clone(arg_27_0.talentOrigins)

def var_0_0.getNotLearnedList(arg_28_0):
	return arg_28_0.notLearnedList

def var_0_0.updateNotLearnedList(arg_29_0, arg_29_1):
	arg_29_0.notLearnedList = arg_29_1

def var_0_0.getResetTalentConsume(arg_30_0):
	return pg.gameset.commander_skill_reset_cost.description[1][arg_30_0.pt]

def var_0_0.getTotalPoint(arg_31_0):
	return math.floor(arg_31_0.level / CommanderConst.TALENT_POINT_LEVEL) * CommanderConst.TALENT_POINT

def var_0_0.getTalentPoint(arg_32_0):
	return arg_32_0.getTotalPoint() - arg_32_0.pt

def var_0_0.updatePt(arg_33_0, arg_33_1):
	arg_33_0.pt = arg_33_1

def var_0_0.getPt(arg_34_0):
	return arg_34_0.pt

def var_0_0.fullTalentCnt(arg_35_0):
	return #arg_35_0.talents >= CommanderConst.MAX_TELENT_COUNT

def var_0_0.hasTalent(arg_36_0, arg_36_1):
	return arg_36_0.getSameGroupTalent(arg_36_1.groupId) != None

def var_0_0.getSameGroupTalent(arg_37_0, arg_37_1):
	for iter_37_0, iter_37_1 in ipairs(arg_37_0.talents):
		if iter_37_1.groupId == arg_37_1:
			return iter_37_1

def var_0_0.getTalentsDesc(arg_38_0):
	local var_38_0 = {}
	local var_38_1 = arg_38_0.getTalents()

	for iter_38_0, iter_38_1 in ipairs(var_38_1):
		for iter_38_2, iter_38_3 in pairs(iter_38_1.getDesc()):
			if var_38_0[iter_38_2]:
...
def var_0_0.getAbilitys(arg_39_0):
	return arg_39_0.abilitys

def var_0_0.updateAbilitys(arg_40_0):
	...
	for iter_40_0, iter_40_1 in ipairs(var_40_3):
...
def var_0_0.getAbilitysAddition(arg_42_0):
	...
	local function var_42_4(arg_43_0)
		...
		for iter_43_0, iter_43_1 in pairs(arg_42_0.abilitys):
			local var_43_1 = var_0_2[iter_43_1.id]

			if var_43_1["rate_" .. arg_43_0]:
	...
	for iter_42_0, iter_42_1 in ipairs(CommanderConst.PROPERTIES):
		var_42_5[iter_42_1] = var_42_4(iter_42_1)

	return var_42_5

def var_0_0.getTalentsAddition(arg_44_0, arg_44_1, arg_44_2, arg_44_3, arg_44_4):
	local var_44_0 = 0
	local var_44_1 = arg_44_0.getTalents()

	for iter_44_0, iter_44_1 in pairs(var_44_1):
		local var_44_2, var_44_3 = iter_44_1.getAttrsAddition()
		local var_44_4

		if arg_44_1 == CommanderConst.TALENT_ADDITION_NUMBER:
			var_44_4 = var_44_2
		elif arg_44_1 == CommanderConst.TALENT_ADDITION_RATIO:
			var_44_4 = var_44_3
		...
		if var_44_5:
			if #var_44_5.nation > 0 and not table.contains(var_44_5.nation, arg_44_3):
				var_44_6 = False

			if #var_44_5.shiptype > 0 and not table.contains(var_44_5.shiptype, arg_44_4):
				var_44_6 = False
		else
			var_44_6 = False
...
def var_0_0.getAttrRatioAddition(arg_45_0, arg_45_1, arg_45_2, arg_45_3):
	if table.contains(CommanderConst.PROPERTIES, arg_45_1):
...
def var_0_0.getAttrValueAddition(arg_46_0, arg_46_1, arg_46_2, arg_46_3):
	if table.contains(CommanderConst.PROPERTIES, arg_46_1):
		return (arg_46_0.getTalentsAddition(CommanderConst.TALENT_ADDITION_NUMBER, arg_46_1, arg_46_2, arg_46_3))
	else
		return 0

def var_0_0.addExp(arg_47_0, arg_47_1):
	if arg_47_0.isMaxLevel():
		return

	arg_47_0.exp = arg_47_0.exp + arg_47_1

	while not arg_47_0.isMaxLevel() and arg_47_0.canLevelUp():
		arg_47_0.exp = arg_47_0.exp - arg_47_0.getNextLevelExp()

		arg_47_0.updateLevel()

def var_0_0.ReduceExp(arg_48_0, arg_48_1):
	arg_48_0.exp = arg_48_0.exp - arg_48_1

	while arg_48_0.exp < 0:
		arg_48_0.level = arg_48_0.level - 1
		arg_48_0.exp = arg_48_0.getNextLevelExp() + arg_48_0.exp

def var_0_0.canLevelUp(arg_49_0):
	return arg_49_0.exp >= arg_49_0.getNextLevelExp()

def var_0_0.isMaxLevel(arg_50_0):
	return arg_50_0.getMaxLevel() <= arg_50_0.level

def var_0_0.getMaxLevel(arg_51_0):
	return arg_51_0.maxLevel

def var_0_0.updateLevel(arg_52_0):
	arg_52_0.level = arg_52_0.level + 1

	arg_52_0.updateAbilitys()

	if arg_52_0.level % CommanderConst.TALENT_POINT_LEVEL == 0:
		arg_52_0.notLearnedList = {}

def var_0_0.getConfigExp(arg_53_0, arg_53_1):
...
def var_0_0.getNextLevelExp(arg_54_0):
	return arg_54_0.getConfigExp(arg_54_0.level)

def var_0_0.UpdateLevelAndExp(arg_55_0, arg_55_1, arg_55_2):
	arg_55_0.exp = arg_55_2
	arg_55_0.level = arg_55_1

def var_0_0.getName(arg_56_0, arg_56_1):
	if arg_56_1:
		return arg_56_0.getConfig("name")
	else
		return arg_56_0.name or arg_56_0.getConfig("name")

def var_0_0.setName(arg_57_0, arg_57_1):
	arg_57_0.name = arg_57_1

def var_0_0.getRarity(arg_58_0):
	return arg_58_0.getConfig("rarity")

def var_0_0.isSSR(arg_59_0):
	return arg_59_0.getRarity() == 5

def var_0_0.isSR(arg_60_0):
	return arg_60_0.getRarity() == 4

def var_0_0.isR(arg_61_0):
	return arg_61_0.getRarity() == 3

def var_0_0.getPainting(arg_62_0):
	return arg_62_0.getConfig("painting")

def var_0_0.getLevel(arg_63_0):
	return arg_63_0.level

def var_0_0.getDestoryedExp(arg_64_0, arg_64_1):
	local var_64_0 = 0

	for iter_64_0 = 1, arg_64_0.level - 1:
	...
	local function var_64_2()
		...
		for iter_65_0, iter_65_1 in ipairs(var_65_2):
...
def var_0_0.getDestoryedSkillExp(arg_66_0, arg_66_1):
	if arg_66_1 == arg_66_0.groupId:
		return pg.gameset.commander_skill_exp.key_value

	return 0

def var_0_0.updateAbilityTime(arg_67_0, arg_67_1):
	arg_67_0.abilityTime = arg_67_1

def var_0_0.GetNextResetAbilityTime(arg_68_0):
	if pg.gameset.commander_ability_reset_time.key_value == 1:
...
def var_0_0.canEquipToFleetList(arg_73_0, arg_73_1, arg_73_2, arg_73_3):
	...
	for iter_73_0, iter_73_1 in pairs(arg_73_0):
		if iter_73_0 == arg_73_1:
			for iter_73_2, iter_73_3 in pairs(iter_73_1):
				local var_73_2 = var_73_0.getCommanderById(iter_73_3)

				if var_73_2 and var_73_2.groupId == var_73_1.groupId and iter_73_2 != arg_73_2:
					return False, i18n("commander_can_not_select_same_group")
		else
			for iter_73_4, iter_73_5 in pairs(iter_73_1):
				if arg_73_3 == iter_73_5:
					return False, i18n("commander_is_in_fleet_already")

	return True

def var_0_0.ExistCleanFlag(arg_74_0):
...
def var_0_0.ExitFeedFlag(arg_75_0):
...
def var_0_0.ExitPlayFlag(arg_76_0):
...
def var_0_0.UpdateHomeOpTime(arg_77_0, arg_77_1, arg_77_2):
	if arg_77_1 == 1:
...
def var_0_0.IsSameTalent(arg_78_0):
