...
function var_0_0.InitSwitch()
	...
	var_0_0.ConfigCase = {
		...
		[DROP_TYPE_ITEM] = function(arg_18_0)
			...
			if var_18_0.type == Item.LOVE_LETTER_TYPE then
	...
	function var_0_0.ConfigDefault(arg_44_0)
		...
		if var_44_0 > DROP_TYPE_USE_ACTIVITY_DROP then
	...
	var_0_0.CountCase = {
		...
		[DROP_TYPE_ITEM] = function(arg_46_0)
			...
			if arg_46_0:getConfig("type") == Item.LOVE_LETTER_TYPE then
		...
		[DROP_TYPE_VITEM] = function(arg_54_0)
			if arg_54_0:getConfig("virtual_type") == 22 then
		...
		[DROP_TYPE_WORLD_ITEM] = function(arg_59_0)
			...
			if var_59_0.type ~= World.TypeFull then
				assert(false)
	...
	function var_0_0.CountDefault(arg_61_0)
		...
		if var_61_0 > DROP_TYPE_USE_ACTIVITY_DROP then
	...
	var_0_0.TransCase = {
		...
		[DROP_TYPE_RESOURCE] = function(arg_85_0)
			for iter_85_0, iter_85_1 in ipairs(getProxy(ActivityProxy):getActivitiesByType(ActivityConst.ACTIVITY_TYPE_PT_CRUSING)) do
				if pg.battlepass_event_pt[iter_85_1.id].pt == arg_85_0.id then
					return nil, arg_85_0
				end
			end
		...
		[DROP_TYPE_VITEM] = function(arg_87_0, arg_87_1, arg_87_2)
			...
			return switch(arg_87_0:getConfig("virtual_type"), {
				function()
					if arg_87_0:getConfig("link_id") == ActivityConst.LINLK_DUNHUANG_ACT then
						return nil, arg_87_0
					end
		...
		[DROP_TYPE_SHIP] = function(arg_93_0, arg_93_1)
			if Ship.isMetaShipByConfigID(arg_93_0.id) and Player.isMetaShipNeedToTrans(arg_93_0.id) then
	...
	var_0_0.AddItemCase = {
		...
		[DROP_TYPE_ITEM] = function(arg_97_0)
			if arg_97_0:getConfig("type") == Item.EXP_BOOK_TYPE then
		...
		[DROP_TYPE_FURNITURE] = function(arg_101_0)
			...
			if var_101_1:isRecordTime() then
		...
		[DROP_TYPE_VITEM] = function(arg_103_0)
			...
			switch(arg_103_0:getConfig("virtual_type"), {
				...
				function()
					...
					if var_105_2 and not var_105_2:isEnd() then
						if not table.contains(var_105_2.data1_list, arg_103_0.id) then
				...
				function()
					...
					for iter_106_0, iter_106_1 in ipairs(var_106_1) do
						...
						if var_106_3 and var_106_3.ticket_id_period == arg_103_0.id then
				...
				[10] = function()
					...
					if var_111_1 and not var_111_1:isEnd() then
				...
				[14] = function()
					...
					if WorldBossConst.WORLD_BOSS_ITEM_ID == arg_103_0.id then
						var_115_0:AddSummonPt(arg_103_0.count)
					elseif WorldBossConst.WORLD_PAST_BOSS_ITEM_ID == arg_103_0.id then
				...
				[15] = function()
					...
					if var_116_1 and not var_116_1:isEnd() then
						local var_116_2 = pg.activity_event_grid[var_116_1.data1]

						if arg_103_0.id == var_116_2.ticket_item then
							var_116_1.data2 = var_116_1.data2 + arg_103_0.count
						elseif arg_103_0.id == var_116_2.explore_item then
				...
				[16] = function()
					...
					for iter_117_0, iter_117_1 in pairs(var_117_1) do
						if iter_117_1 and not iter_117_1:isEnd() and arg_103_0.id == iter_117_1:getConfig("config_id") then
				...
				[21] = function()
					...
					if var_119_1 and not var_119_1:isEnd() then
						var_119_1.data2 = 1
				...
				[23] = function()
					local var_121_0 = (function()
						for iter_122_0, iter_122_1 in ipairs(pg.gameset.package_lv.description) do
							if arg_103_0.id == iter_122_1[1] then
								return iter_122_1[2]
							end
						end
					end)()
				...
				[24] = function()
					...
					if var_123_1 and not var_123_1:isEnd() and var_123_1:getConfig("type") == ActivityConst.ACTIVITY_TYPE_HOTSPRING then
				...
				[25] = function()
					...
					if var_124_1 and not var_124_1:isEnd() then
						...
						if not table.contains(var_124_1.data1_list, arg_103_0.id) then
						...
						if var_124_2 > 0 then
							...
							if var_124_3 and not var_124_3:isEnd() then
		...
		[DROP_TYPE_SKIN_TIMELIMIT] = function(arg_135_0)
			...
			if var_135_3 and var_135_3:isExpireType() then
		...
		[DROP_TYPE_BUFF] = function(arg_136_0)
			...
			if var_136_2 and not var_136_2:isEnd() then
	...
	function var_0_0.AddItemDefault(arg_140_0)
		if arg_140_0.type > DROP_TYPE_USE_ACTIVITY_DROP then
			local var_140_0 = getProxy(ActivityProxy):getActivityById(pg.activity_drop_type[arg_140_0.type].activity_id)

			if arg_140_0.type == DROP_TYPE_RYZA_DROP then
				if var_140_0 and not var_140_0:isEnd() then
			...
			elseif var_140_0 and not var_140_0:isEnd() then
	...
	var_0_0.MsgboxIntroCase = {
		...
		[DROP_TYPE_ITEM] = function(arg_142_0, arg_142_1, arg_142_2)
			...
			if arg_142_0:getConfig("type") == Item.LOVE_LETTER_TYPE then
				var_142_0 = string.gsub(var_142_0, "$1", ShipGroup.getDefaultShipNameByGroupID(arg_142_0.extra))
			elseif arg_142_0:getConfig("combination_display") ~= nil then
		...
		[DROP_TYPE_SHIP] = function(arg_144_0, arg_144_1, arg_144_2)
			...
			local var_144_1, var_144_2, var_144_3 = ShipWordHelper.GetWordAndCV(var_144_0, ShipWordHelper.WORD_TYPE_DROP, nil, PLATFORM_CODE ~= PLATFORM_US)
		...
		[DROP_TYPE_OPERATION] = function(arg_145_0, arg_145_1, arg_145_2)
			...
			local var_145_1, var_145_2, var_145_3 = ShipWordHelper.GetWordAndCV(var_145_0, ShipWordHelper.WORD_TYPE_DROP, nil, PLATFORM_CODE ~= PLATFORM_US)
	...
	function var_0_0.MsgboxIntroDefault(arg_162_0, arg_162_1, arg_162_2)
		if arg_162_0.type > DROP_TYPE_USE_ACTIVITY_DROP then
	...
	var_0_0.UpdateDropCase = {
		[DROP_TYPE_RESOURCE] = function(arg_163_0, arg_163_1, arg_163_2)
			if arg_163_0.id == PlayerConst.ResStoreGold or arg_163_0.id == PlayerConst.ResStoreOil then
