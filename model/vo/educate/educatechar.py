...
def var_0_0.Ctor(arg_2_0, arg_2_1):
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.attrs):
...
def var_0_0.initStageCfg(arg_4_0):
	arg_4_0.stage2timeRange = {}

	for iter_4_0, iter_4_1 in ipairs(arg_4_0.getConfig("stage")):
		arg_4_0.stage2timeRange[iter_4_0] = {
			EducateHelper.CfgTime2Time(iter_4_1)
		}

def var_0_0.GetStageByTime(arg_5_0, arg_5_1):
	arg_5_0.time2stage = {}

	for iter_5_0, iter_5_1 in pairs(arg_5_0.stage2timeRange):
		if EducateHelper.InTime(arg_5_1, iter_5_1[1], iter_5_1[2]):
			return iter_5_0

	return 1

def var_0_0.initFavorCfg(arg_6_0):
	arg_6_0.favorLv2NeedExp = {}
	arg_6_0.favorLv2PerformIds = {}
	arg_6_0.favorReplaceCfg = {}
	arg_6_0.favorMaxLv = arg_6_0.getConfig("favor_level")

	for iter_6_0, iter_6_1 in ipairs(arg_6_0.getConfig("favor_exp")):
	...
	for iter_6_2, iter_6_3 in ipairs(arg_6_0.getConfig("trigger_performance_replace")):
		arg_6_0.favorReplaceCfg[iter_6_3[1]] = iter_6_3[2]

def var_0_0.SetCallName(arg_7_0, arg_7_1):
	arg_7_0.callName = arg_7_1

def var_0_0.GetCallName(arg_8_0):
	return arg_8_0.callName

def var_0_0.GetName(arg_9_0):
	return arg_9_0.getConfig("name")

def var_0_0.GetStage(arg_10_0):
	return arg_10_0.stage

def var_0_0.GetNextWeekStage(arg_11_0):
	local var_11_0 = EducateHelper.GetTimeAfterWeeks(arg_11_0.curTime, 1)

	return arg_11_0.GetStageByTime(var_11_0) or 1

def var_0_0.GetPlanCnt(arg_12_0):
	return arg_12_0.getConfig("stage_plan_number")[arg_12_0.stage]

def var_0_0.GetNextWeekPlanCnt(arg_13_0):
	return arg_13_0.getConfig("stage_plan_number")[arg_13_0.GetNextWeekStage()]

def var_0_0.GetSiteCnt(arg_14_0):
	if not getProxy(EducateProxy).InVirtualStage():
		return arg_14_0.getConfig("stage_site_number")[arg_14_0.stage]
	else
		return arg_14_0.getConfig("stage_site_number")[arg_14_0.stage + 1]

def var_0_0.GetStageReaminWeek(arg_15_0, arg_15_1):
	return (arg_15_0.getConfig("stage")[arg_15_1][2][1] + 1 - arg_15_0.curTime.month) * 4 - arg_15_0.curTime.week

def var_0_0.GetAttrIdsByType(arg_16_0, arg_16_1):
	if arg_16_1 == var_0_0.ATTR_TYPE_MAJOR:
		return arg_16_0.getConfig("attr_1_list")

	if arg_16_1 == var_0_0.ATTR_TYPE_PERSONALITY:
		return arg_16_0.getConfig("attr_2_list")

	if arg_16_1 == var_0_0.ATTR_TYPE_MINOR:
		return arg_16_0.getConfig("attr_3_list")

	return {}

def var_0_0.GetAttrTypeById(arg_17_0, arg_17_1):
	if table.contains(arg_17_0.getConfig("attr_1_list"), arg_17_1):
		return var_0_0.ATTR_TYPE_MAJOR

	if table.contains(arg_17_0.getConfig("attr_2_list"), arg_17_1):
		return var_0_0.ATTR_TYPE_PERSONALITY

	if table.contains(arg_17_0.getConfig("attr_3_list"), arg_17_1):
		return var_0_0.ATTR_TYPE_MINOR

	assert(False, "not exist attr id." .. arg_17_1)

def var_0_0.IsPersonalityAttr(arg_18_0, arg_18_1):
	return table.contains(arg_18_0.getConfig("attr_2_list"), arg_18_1)

def var_0_0.GetAttrGroupByType(arg_19_0, arg_19_1):
	local var_19_0 = {}

	for iter_19_0, iter_19_1 in pairs(arg_19_0.attrs):
		if pg.child_attr[iter_19_0].type == arg_19_1:
...
def var_0_0.GetAttrSortIds(arg_21_0):
...
def var_0_0.GetAttrById(arg_24_0, arg_24_1):
	return arg_24_0.attrs[arg_24_1] or 0

def var_0_0.GetAttrInfo(arg_25_0, arg_25_1):
...
def var_0_0.GetFavor(arg_32_0):
	return arg_32_0.favor

def var_0_0.GetFavorMaxLv(arg_33_0):
	return arg_33_0.favorMaxLv

def var_0_0.GetFavorUpgradExp(arg_34_0, arg_34_1):
	return arg_34_0.favorLv2NeedExp[arg_34_1] or 999999

def var_0_0.GetFavorUpgradPerformIds(arg_35_0, arg_35_1):
	return arg_35_0.GetPerformByReplace(arg_35_1) or {}

def var_0_0.GetPerformByReplace(arg_36_0, arg_36_1):
	if arg_36_0.favorReplaceCfg[arg_36_1]:
		local var_36_0 = arg_36_0.GetPersonalityId()

		for iter_36_0, iter_36_1 in ipairs(arg_36_0.favorReplaceCfg[arg_36_1]):
			if iter_36_1[1] == 1 and var_36_0 == iter_36_1[2]:
				return iter_36_1[3]

	return arg_36_0.favorLv2PerformIds[arg_36_1]

def var_0_0.CheckFavor(arg_37_0):
	if arg_37_0.favor.lv >= arg_37_0.GetFavorMaxLv():
		return False

	return arg_37_0.favor.exp >= arg_37_0.GetFavorUpgradExp(arg_37_0.favor.lv)

def var_0_0.UpgradeFavor(arg_38_0):
...
def var_0_0.GetFavorPerformIds(arg_39_0):
	return arg_39_0.GetFavorUpgradPerformIds(arg_39_0.favor.lv)

def var_0_0.GetMoodStage(arg_40_0):
	local var_40_0 = pg.gameset.child_emotion.description

	if arg_40_0.mood <= var_40_0[1][1][1]:
		return 1

	if arg_40_0.mood >= var_40_0[#var_40_0][1][2]:
		return #var_40_0

	for iter_40_0, iter_40_1 in ipairs(var_40_0):
		if arg_40_0.mood >= iter_40_1[1][1] and arg_40_0.mood <= iter_40_1[1][2]:
			return iter_40_0

def var_0_0.CheckEndCondition(arg_41_0, arg_41_1):
	...
	for iter_41_0, iter_41_1 in ipairs(arg_41_1):
		...
		if var_41_2 == EducateConst.DROP_TYPE_ATTR:
			if not iter_41_1[3]:
				if var_41_0 != iter_41_1[2]:
					return False
			elif arg_41_0.attrs[iter_41_1[2]] < iter_41_1[3]:
				return False
		elif var_41_2 == EducateConst.DROP_TYPE_RES and arg_41_0[var_0_0.RES_ID_2_NAME[iter_41_1[2]]] < iter_41_1[3]:
			return False

	return True

def var_0_0.getCurMainIndex(arg_42_0, arg_42_1):
	local var_42_0 = arg_42_1 or arg_42_0.curTime
	local var_42_1 = arg_42_0.GetPersonalityId()

	for iter_42_0, iter_42_1 in ipairs(arg_42_0.getConfig("char_prefab")):
		local var_42_2, var_42_3 = EducateHelper.CfgTime2Time(iter_42_1[1])

		if EducateHelper.InTime(var_42_0, var_42_2, var_42_3):
			if iter_42_1[2] == 0:
				return iter_42_0
			elif iter_42_1[2] == var_42_1:
				return iter_42_0

	return 1

def var_0_0.UpdateMainInfo(arg_43_0):
...
def var_0_0.GetBGName(arg_44_0):
	if not getProxy(EducateProxy).InVirtualStage():
...
def var_0_0.getBgmByStage(arg_45_0, arg_45_1):
	local var_45_0 = arg_45_0.getConfig("bgm")[arg_45_1]

	if type(var_45_0) == "string":
		return var_45_0
	elif type(var_45_0) == "table":
		local var_45_1 = arg_45_0.GetPersonalityId()

		for iter_45_0, iter_45_1 in ipairs(var_45_0):
			if iter_45_1[1] == var_45_1:
				return iter_45_1[2]
...
def var_0_0.GetPaintingName(arg_47_0):
	if not getProxy(EducateProxy).InVirtualStage():
...
def var_0_0.GetMainDialogueInfo(arg_48_0):
	if not getProxy(EducateProxy).InVirtualStage():
...
def var_0_0.GetNextWeekMainInfo(arg_49_0):
...
def var_0_0.OnNewWeek(arg_50_0, arg_50_1):
