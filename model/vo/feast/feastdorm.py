...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_2.special_roles):
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_2.party_roles):
...
def var_0_0.GetInvitedFeastShips(arg_2_0):
	return arg_2_0.invitedFeastShips

def var_0_0.GetInvitedFeastShipList(arg_3_0):
...
def var_0_0.GetInvitedFeastShip(arg_5_0, arg_5_1):
	return arg_5_0.invitedFeastShips[arg_5_1]

def var_0_0.GetFeastShipList(arg_6_0):
	return arg_6_0.feastShips

def var_0_0.GetFeastShip(arg_7_0, arg_7_1):
	return arg_7_0.feastShips[arg_7_1]

def var_0_0.RemoveShip(arg_8_0, arg_8_1):
	arg_8_0.feastShips[arg_8_1] = None

def var_0_0.AddShip(arg_9_0, arg_9_1):
	arg_9_0.feastShips[arg_9_1.tid] = arg_9_1

def var_0_0.SetRefreshTime(arg_10_0, arg_10_1):
	arg_10_0.refreshTime = arg_10_1

def var_0_0.ShouldRandomShips(arg_11_0):
...
def var_0_0.GetMapSize(arg_12_0):
	local var_12_0 = 0
	local var_12_1 = 0
...
def var_0_0.GetPutFurnitureList(arg_13_0, arg_13_1):
	local var_13_0 = {}
	...
	for iter_13_0, iter_13_1 in pairs(var_13_3):
...
def var_0_0.GetPutShipList(arg_14_0, arg_14_1):
	local var_14_0 = {}

	for iter_14_0, iter_14_1 in pairs(arg_14_0.feastShips):
