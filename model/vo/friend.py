...
def var_0_0.increaseUnreadCount(arg_2_0):
	arg_2_0.unreadCount = arg_2_0.unreadCount + 1

def var_0_0.resetUnreadCount(arg_3_0):
	arg_3_0.unreadCount = 0

def var_0_0.isOnline(arg_4_0):
	return arg_4_0.online == var_0_0.ONLINE

def var_0_0.hasUnreadMsg(arg_5_0):
	return arg_5_0.unreadCount > 0

def var_0_0.GetManifesto(arg_6_0):
