...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_3):
...
def var_0_0.GetIcon(arg_5_0):
	return arg_5_0.getConfig("pic") or arg_5_0.configId

def var_0_0.GetFleetByIndex(arg_6_0, arg_6_1):
	return arg_6_0.fleets[arg_6_1]

def var_0_0.GetMainFleet(arg_7_0):
	return arg_7_0.fleets[var_0_0.MAIN_FLEET_ID]

def var_0_0.GetSubFleet(arg_8_0):
	return arg_8_0.fleets[var_0_0.SUB_FLEET_ID]

def var_0_0.UpdateFleet(arg_9_0, arg_9_1):
	arg_9_0.fleets[arg_9_1.id] = arg_9_1

def var_0_0.GetFleets(arg_10_0):
	return arg_10_0.fleets

def var_0_0.GetAllShipIds(arg_11_0):
	local var_11_0 = {}

	for iter_11_0, iter_11_1 in pairs(arg_11_0.fleets):
		local var_11_1 = iter_11_1.GetShips()

		for iter_11_2, iter_11_3 in ipairs(var_11_1):
...
def var_0_0.GetMyShipIds(arg_12_0):
	local var_12_0 = {}

	for iter_12_0, iter_12_1 in pairs(arg_12_0.fleets):
...
def var_0_0.GetShipsSplitByUserID(arg_13_0):
	local var_13_0 = {}
	local var_13_1 = getProxy(PlayerProxy).getRawData().id

	for iter_13_0, iter_13_1 in pairs(arg_13_0.fleets):
		local var_13_2 = iter_13_1.GetShips()

		for iter_13_2, iter_13_3 in ipairs(var_13_2):
			local var_13_3 = iter_13_3.member.id

			if var_13_3 != var_13_1:
...
def var_0_0.GetTotalHp(arg_14_0):
...
def var_0_0.GetEmenyId(arg_33_0):
	return arg_33_0.getConfig("expedition_id")[2][1]

def var_0_0.CanFormation(arg_34_0):
	return False

def var_0_0.ExistCommander(arg_35_0, arg_35_1):
	for iter_35_0, iter_35_1 in pairs(arg_35_0.fleets):
		if iter_35_1.ExistCommander(arg_35_1):
			return True

	return False

def var_0_0.GetFleetUserId(arg_36_0, arg_36_1, arg_36_2):
	for iter_36_0, iter_36_1 in pairs(arg_36_0.fleets):
		if iter_36_1.ContainShip(arg_36_1, arg_36_2):
			return iter_36_1

	return False

def var_0_0.GetFleetCommanderId(arg_37_0, arg_37_1):
	for iter_37_0, iter_37_1 in pairs(arg_37_0.fleets):
		if iter_37_1.ExistCommander(arg_37_1):
			return iter_37_1
