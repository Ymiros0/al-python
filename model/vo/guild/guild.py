...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_1.member or {}):
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_1.log or {}):
	...
	for iter_1_4, iter_1_5 in ipairs(var_0_2.all):
...
def var_0_0.updateBaseInfo(arg_2_0, arg_2_1):
...
def var_0_0.updateExtraInfo(arg_3_0, arg_3_1):
	...
	for iter_3_0, iter_3_1 in pairs(var_0_1.get_id_list_by_group):
	...
	for iter_3_2, iter_3_3 in ipairs(var_3_0.technologys or {}):
...
def var_0_0.SetMaxMemberCntAddition(arg_4_0, arg_4_1):
	arg_4_0.maxMemberCntAddition = arg_4_1

def var_0_0.updateUserInfo(arg_5_0, arg_5_1):
	...
	for iter_5_0, iter_5_1 in ipairs(var_5_0.donate_tasks or {}):
	...
	for iter_5_2, iter_5_3 in pairs(var_0_1.get_id_list_by_group):
	...
	for iter_5_4, iter_5_5 in ipairs(var_5_0.tech_id or {}):
...
def var_0_0.IsCompletion(arg_6_0):
	return arg_6_0.completion

def var_0_0.AddExtraDonateCnt(arg_7_0, arg_7_1):
	arg_7_0.extraDonateCnt = arg_7_0.extraDonateCnt + arg_7_1

def var_0_0.ReduceExtraDonateCnt(arg_8_0, arg_8_1):
	if arg_8_0.extraDonateCnt <= 0:
		return
...
def var_0_0.GetExtraDonateCnt(arg_9_0):
	return arg_9_0.extraDonateCnt

def var_0_0.AddExtraBattleCnt(arg_10_0, arg_10_1):
	arg_10_0.extraBattleCnt = arg_10_0.extraBattleCnt + arg_10_1

def var_0_0.ReduceExtraBattleCnt(arg_11_0, arg_11_1):
	if arg_11_0.extraBattleCnt <= 0:
		return
...
def var_0_0.GetExtraBattleCnt(arg_12_0):
	return arg_12_0.extraBattleCnt

def var_0_0.StartTech(arg_13_0, arg_13_1):
	local var_13_0 = pg.guild_technology_template[arg_13_1].group

	arg_13_0.technologyGroups[var_13_0].Start()

def var_0_0.GetEvents(arg_14_0):
	return arg_14_0.events

def var_0_0.GetEventById(arg_15_0, arg_15_1):
	return _.detect(arg_15_0.events, function(arg_16_0)
		return arg_16_0.id == arg_15_1)

def var_0_0.GetActiveEvent(arg_17_0):
	return _.detect(arg_17_0.events, function(arg_18_0)
		return arg_18_0.IsActive())

def var_0_0.CanCancelTech(arg_19_0):
	return arg_19_0.techCancelCnt == 0

def var_0_0.UpdateTechCancelCnt(arg_20_0):
	arg_20_0.techCancelCnt = arg_20_0.techCancelCnt + 1

def var_0_0.ResetTechCancelCnt(arg_21_0):
	arg_21_0.techCancelCnt = 0

def var_0_0.shouldRefreshCaptial(arg_22_0):
	return arg_22_0.refreshCaptialTime < pg.TimeMgr.GetInstance().GetServerTime()

def var_0_0.setRefreshCaptialTime(arg_23_0):
	arg_23_0.refreshCaptialTime = pg.TimeMgr.GetInstance().GetServerTime() + GuildConst.REFRESH_CAPITAL_TIME

def var_0_0.shouldRefreshWeeklyTaskProgress(arg_24_0):
	return pg.TimeMgr.GetInstance().GetServerTime() >= arg_24_0.weeklyTaskNextRefreshTime

def var_0_0.setRefreshWeeklyTaskProgressTime(arg_25_0):
	arg_25_0.weeklyTaskNextRefreshTime = pg.TimeMgr.GetInstance().GetServerTime() + GuildConst.WEEKLY_TASK_PROGRESS_REFRESH_TIME

def var_0_0.hasWeeklyTaskFlag(arg_26_0):
	return arg_26_0.weeklyTaskFlag != 0

def var_0_0.setWeeklyTaskFlag(arg_27_0, arg_27_1):
	arg_27_0.weeklyTaskFlag = arg_27_1

def var_0_0.getTechnologyGroups(arg_28_0):
	local var_28_0 = {}

	for iter_28_0, iter_28_1 in pairs(arg_28_0.technologyGroups):
		table.insert(var_28_0, iter_28_1)

	return var_28_0

def var_0_0.getTechnologyGroupById(arg_29_0, arg_29_1):
	return arg_29_0.technologyGroups[arg_29_1]

def var_0_0.getActiveTechnologyGroup(arg_30_0):
	for iter_30_0, iter_30_1 in pairs(arg_30_0.technologyGroups):
		if iter_30_1.isStarting():
			return iter_30_1

def var_0_0.GetTechnologys(arg_31_0):
	return arg_31_0.technologys

def var_0_0.getTechnologyById(arg_32_0, arg_32_1):
	return arg_32_0.technologys[arg_32_1]

def var_0_0.getTechnologys(arg_33_0):
	local var_33_0 = {}

	for iter_33_0, iter_33_1 in pairs(arg_33_0.technologys):
		table.insert(var_33_0, iter_33_1)

	return var_33_0

def var_0_0.getSupplyConsume(arg_34_0):
...
def var_0_0.getSupplyCnt(arg_37_0):
	...
	if arg_37_0.lastBenefitFinishTime > 0 and arg_37_0.lastBenefitFinishTime > arg_37_0.benefitTime and var_37_4 <= arg_37_0.lastBenefitFinishTime:
...
def var_0_0.getSelectableWeeklyTasks(arg_45_0):
	local var_45_0 = {}

	if GuildMember.IsAdministrator(arg_45_0.getSelfDuty()):
		local var_45_1 = pg.guild_mission_template

		for iter_45_0, iter_45_1 in ipairs(var_45_1.all):
...
def var_0_0.shouldRequestCapitalLog(arg_46_0):
	if pg.TimeMgr.GetInstance().GetServerTime() - arg_46_0.requestCapitalLogTime > GuildConst.REQUEST_LOG_TIME:
		return True

	return False

def var_0_0.updateCapitalLogs(arg_47_0, arg_47_1):
	arg_47_0.capitalLogs = arg_47_1
	arg_47_0.requestCapitalLogTime = pg.TimeMgr.GetInstance().GetServerTime()

def var_0_0.getCapitalLogs(arg_48_0):
	return arg_48_0.capitalLogs

def var_0_0.getMaxDonateCnt(arg_49_0):
	return pg.guildset.contribution_task_num.key_value

def var_0_0.getRemainDonateCnt(arg_50_0):
	return arg_50_0.getMaxDonateCnt() - arg_50_0.donateCount

def var_0_0.updateDonateCount(arg_51_0):
	if arg_51_0.getRemainDonateCnt() > 0:
		arg_51_0.donateCount = arg_51_0.donateCount + 1
	else
		arg_51_0.ReduceExtraDonateCnt(1)

def var_0_0.canDonate(arg_52_0):
	return arg_52_0.getRemainDonateCnt() > 0 or arg_52_0.extraDonateCnt > 0

def var_0_0.getDonateTasks(arg_53_0):
	return arg_53_0.donateTasks

def var_0_0.updateDonateTasks(arg_54_0, arg_54_1):
	arg_54_0.donateTasks = arg_54_1

def var_0_0.getDonateTaskById(arg_55_0, arg_55_1):
	return _.detect(arg_55_0.donateTasks, function(arg_56_0)
		return arg_56_0.id == arg_55_1)

def var_0_0.updateWeeklyTask(arg_57_0, arg_57_1):
	arg_57_0.weeklyTask = arg_57_1

def var_0_0.getWeeklyTask(arg_58_0):
	return arg_58_0.weeklyTask

def var_0_0.GetActiveWeeklyTask(arg_59_0):
	if arg_59_0.weeklyTask and arg_59_0.weeklyTask.id != 0:
		return arg_59_0.weeklyTask

	return None

def var_0_0.addCapital(arg_60_0, arg_60_1):
	arg_60_0.updateCapital(arg_60_0.capital + arg_60_1)

def var_0_0.updateCapital(arg_61_0, arg_61_1):
	arg_61_0.capital = arg_61_1

def var_0_0.consumeCapital(arg_62_0, arg_62_1):
	arg_62_0.updateCapital(arg_62_0.capital - arg_62_1)

def var_0_0.getCapital(arg_63_0):
	return arg_63_0.capital

def var_0_0.setkickLeaderTime(arg_64_0, arg_64_1):
	arg_64_0.kickLeaderTime = arg_64_1

def var_0_0.getKickLeftTime(arg_65_0):
	local var_65_0 = pg.TimeMgr.GetInstance().GetServerTime()

	return arg_65_0.kickLeaderTime - var_65_0

def var_0_0.inKickTime(arg_66_0):
	return arg_66_0.kickLeaderTime != 0

def var_0_0.getAssistantMaxCount(arg_67_0):
	return pg.guild_data_level[arg_67_0.level].assistant_commander

def var_0_0.getAssistantCount(arg_68_0):
	local var_68_0 = 0

	for iter_68_0, iter_68_1 in pairs(arg_68_0.member):
		if iter_68_1.duty == GuildConst.DUTY_DEPUTY_COMMANDER:
			var_68_0 = var_68_0 + 1

	return var_68_0

def var_0_0.setMemberCount(arg_69_0, arg_69_1):
	arg_69_0.memberCount = arg_69_1

def var_0_0.getSortMember(arg_70_0):
	local var_70_0 = {}

	for iter_70_0, iter_70_1 in pairs(arg_70_0.member):
		table.insert(var_70_0, iter_70_1)

	return var_70_0

def var_0_0.getBgName(arg_71_0):
	if arg_71_0.faction == GuildConst.FACTION_TYPE_BLHX:
		return "bg/bg_guild_blue_n"
	elif arg_71_0.faction == GuildConst.FACTION_TYPE_CSZZ:
		return "bg/bg_guild_red_n"

def var_0_0.addLog(arg_72_0, arg_72_1):
	table.insert(arg_72_0.logInfo, 1, arg_72_1)

	if #arg_72_0.logInfo > 100:
		table.remove(arg_72_0.logInfo, #arg_72_0.logInfo)

def var_0_0.getLogs(arg_73_0):
	return arg_73_0.logInfo

def var_0_0.getMemberById(arg_74_0, arg_74_1):
	return arg_74_0.member[arg_74_1]

def var_0_0.updateMember(arg_75_0, arg_75_1):
	arg_75_0.member[arg_75_1.id] = arg_75_1

def var_0_0.addMember(arg_76_0, arg_76_1):
	arg_76_0.member[arg_76_1.id] = arg_76_1

def var_0_0.deleteMember(arg_77_0, arg_77_1):
	arg_77_0.member[arg_77_1] = None

def var_0_0.getDutyByMemberId(arg_78_0, arg_78_1):
	for iter_78_0, iter_78_1 in pairs(arg_78_0.member):
		if iter_78_1.id == arg_78_1:
			return iter_78_1.duty

def var_0_0.setId(arg_79_0, arg_79_1):
	arg_79_0.id = arg_79_1

def var_0_0.setName(arg_80_0, arg_80_1):
	arg_80_0.name = arg_80_1

def var_0_0.getPolicyName(arg_81_0):
	return GuildConst.POLICY_NAME[arg_81_0.policy]

def var_0_0.getFactionName(arg_82_0):
	return GuildConst.FACTION_NAME[arg_82_0.faction]

def var_0_0.getName(arg_83_0):
	return arg_83_0.name

def var_0_0.setPolicy(arg_84_0, arg_84_1):
	arg_84_0.policy = arg_84_1

def var_0_0.getPolicy(arg_85_0):
	return arg_85_0.policy

def var_0_0.setFaction(arg_86_0, arg_86_1):
	arg_86_0.faction = arg_86_1

def var_0_0.getFaction(arg_87_0):
	return arg_87_0.faction

def var_0_0.setManifesto(arg_88_0, arg_88_1):
	arg_88_0.manifesto = arg_88_1

def var_0_0.getManifesto(arg_89_0):
	return arg_89_0.manifesto or ""

local var_0_4 = 86400

def var_0_0.inChangefactionTime(arg_90_0):
	local var_90_0 = arg_90_0.changeFactionTime - pg.TimeMgr.GetInstance().GetServerTime()

	if arg_90_0.changeFactionTime != 0 and not (var_90_0 < 0):
		return True

def var_0_0.changeFactionLeftTime(arg_91_0):
...
def var_0_0.updateExp(arg_94_0, arg_94_1):
	arg_94_0.exp = arg_94_1

def var_0_0.updateLevel(arg_95_0, arg_95_1):
	arg_95_0.level = arg_95_1

def var_0_0.getCommader(arg_96_0):
	for iter_96_0, iter_96_1 in pairs(arg_96_0.member):
		if iter_96_1.duty == GuildConst.DUTY_COMMANDER:
			return iter_96_1

def var_0_0.getCommaderName(arg_97_0):
...
def var_0_0.setAnnounce(arg_98_0, arg_98_1):
	arg_98_0.announce = arg_98_1

def var_0_0.GetAnnounce(arg_99_0):
	return arg_99_0.announce

def var_0_0.getEnableDuty(arg_100_0, arg_100_1, arg_100_2):
	if arg_100_2 == GuildConst.DUTY_RECRUIT:
		return {}

	local var_100_0 = {}

	if arg_100_1 == GuildConst.DUTY_COMMANDER:
		if arg_100_0.getAssistantMaxCount() == arg_100_0.getAssistantCount():
	...
	elif arg_100_1 == GuildConst.DUTY_DEPUTY_COMMANDER:
		var_100_0 = {
			GuildConst.DYTY_PICKED,
			GuildConst.DUTY_ORDINARY
		}
...
def var_0_0.warpChatInfo(arg_101_0, arg_101_1):
...
def var_0_0.getSelfDuty(arg_103_0):
	local var_103_0 = getProxy(PlayerProxy).getRawData()

	return arg_103_0.getDutyByMemberId(var_103_0.id)

def var_0_0.GetOfficePainting(arg_104_0):
	local var_104_0 = arg_104_0.getFaction()

	if var_104_0 == GuildConst.FACTION_TYPE_BLHX:
		return "guild_office_blue"
	elif var_104_0 == GuildConst.FACTION_TYPE_CSZZ:
		return "guild_office_red"

def var_0_0.ShouldShowDonateTip(arg_105_0):
	return arg_105_0.getMaxDonateCnt() > arg_105_0.donateCount

def var_0_0.ShouldWeeklyTaskTip(arg_106_0):
...
def var_0_0.IsFinishAllTechnologyGroup(arg_109_0):
	for iter_109_0, iter_109_1 in pairs(arg_109_0.technologyGroups):
		if not iter_109_1.isMaxLevel():
			return False

	return True

def var_0_0.ShouldShowSupplyTip(arg_110_0):
...
def var_0_0.GetMembers(arg_112_0):
	return arg_112_0.member

def var_0_0.GetAllAssaultShip(arg_113_0):
	local var_113_0 = {}

	for iter_113_0, iter_113_1 in pairs(arg_113_0.member):
		local var_113_1 = iter_113_1.GetAssaultFleet().GetShipList()

		for iter_113_2, iter_113_3 in ipairs(var_113_1):
			table.insert(var_113_0, iter_113_3)

	return var_113_0

def var_0_0.GetRecomForBossEvent(arg_114_0, arg_114_1, arg_114_2, arg_114_3):
	local var_114_0 = {}

	for iter_114_0, iter_114_1 in pairs(arg_114_0.member):
		if not table.contains(arg_114_3, iter_114_1.id):
...
def var_0_0.GetMemberShips(arg_116_0, arg_116_1):
	local var_116_0 = {}
	local var_116_1 = {}
...
def var_0_0.IsAdministrator(arg_118_0):
	return GuildMember.IsAdministrator(arg_118_0.getSelfDuty())

def var_0_0.GetMissionAndAssultFleetShips(arg_119_0):
	local var_119_0 = {}
	local var_119_1 = arg_119_0.GetActiveEvent()

	if var_119_1 and not var_119_1.IsExpired():
	...
	for iter_119_2, iter_119_3 in pairs(var_119_7):
	...
	for iter_119_4, iter_119_5 in pairs(var_119_9):
...
def var_0_0.GetBossMissionShips(arg_120_0):
	local var_120_0 = {}
	local var_120_1 = arg_120_0.GetActiveEvent()

	if var_120_1 and not var_120_1.IsExpired():
		local var_120_2 = var_120_1.GetBossShipIds()

		for iter_120_0, iter_120_1 in ipairs(var_120_2):
			table.insert(var_120_0, iter_120_1)

	return var_120_0

def var_0_0.ExistCommander(arg_121_0, arg_121_1):
...
def var_0_0.IncActiveEventCnt(arg_122_0):
	arg_122_0.activeEventCnt = arg_122_0.activeEventCnt + 1

def var_0_0.ResetActiveEventCnt(arg_123_0):
	arg_123_0.activeEventCnt = 0

def var_0_0.ShouldTipActiveEvent(arg_124_0):
	return arg_124_0.activeEventCnt + 1 <= arg_124_0.tipActiveEventCnt

def var_0_0.GetActiveEventCnt(arg_125_0):
