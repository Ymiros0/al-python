...
def var_0_0.GetLiveness(arg_5_0):
	return arg_5_0.liveness

def var_0_0.IsRecruit(arg_6_0):
	return arg_6_0.duty == GuildConst.DUTY_RECRUIT

def var_0_0.AddLiveness(arg_7_0, arg_7_1):
	print("add member liveness", arg_7_1)

	arg_7_0.liveness = arg_7_0.liveness + arg_7_1

	if arg_7_0.CanUpgradeDuty():
		arg_7_0.duty = arg_7_0.duty - 1

def var_0_0.CanUpgradeDuty(arg_8_0):
	return arg_8_0.duty == GuildConst.DUTY_RECRUIT and arg_8_0.liveness >= pg.guildset.guild_active_become_regular.key_value

def var_0_0.UpdateExternalAssaultFleet(arg_9_0, arg_9_1):
	arg_9_0.externalAssaultFleet = arg_9_1

def var_0_0.GetExternalAssaultFleet(arg_10_0):
	return arg_10_0.externalAssaultFleet

def var_0_0.UpdateAssaultFleet(arg_11_0, arg_11_1):
	arg_11_0.assaultFleet = arg_11_1

def var_0_0.GetAssaultFleet(arg_12_0):
	return arg_12_0.assaultFleet

def var_0_0.UpdateAssaultFleetShips(arg_13_0, arg_13_1, arg_13_2):
	arg_13_0.assaultFleet.InitShips(arg_13_1, arg_13_2)

def var_0_0.UpdateExternalAssaultFleetShips(arg_14_0, arg_14_1, arg_14_2):
	arg_14_0.externalAssaultFleet.InitShips(arg_14_1, arg_14_2)

def var_0_0.isNewMember(arg_15_0):
	local var_15_0 = pg.TimeMgr.GetInstance()
	local var_15_1 = var_15_0.GetServerTime()

	if arg_15_0.joinTime != 0 and var_15_0.IsSameDay(var_15_1, arg_15_0.joinTime):
		return True

	return False

def var_0_0.setDuty(arg_16_0, arg_16_1):
	arg_16_0.duty = arg_16_1

def var_0_0.GetDuty(arg_17_0):
	return arg_17_0.duty

def var_0_0.IsCommander(arg_18_0):
	return arg_18_0.duty == GuildConst.DUTY_COMMANDER

def var_0_0.isLongOffLine(arg_19_0):
	return pg.TimeMgr.GetInstance().GetServerTime() - arg_19_0.preOnLineTime > 864000

def var_0_0.setDamage(arg_20_0, arg_20_1):
	arg_20_0.damage = arg_20_1

def var_0_0.getDamage(arg_21_0):
	if arg_21_0.damage:
		return arg_21_0.damage

	return 0

def var_0_0.GetShip(arg_22_0):
	return Ship.New({
...
def var_0_0.GetJoinZeroTime(arg_23_0):
