...
def var_0_0.SetName(arg_3_0, arg_3_1):
	arg_3_0.name = arg_3_1

def var_0_0.SetWeekScore(arg_4_0, arg_4_1):
	arg_4_0.weekScore = arg_4_1

def var_0_0.SetMonthScore(arg_5_0, arg_5_1):
	arg_5_0.monthScore = arg_5_1

def var_0_0.SetTotalScore(arg_6_0, arg_6_1):
	arg_6_0.totalScore = arg_6_1

def var_0_0.SetScore(arg_7_0, arg_7_1, arg_7_2):
	if arg_7_1 == 1:
...
def var_0_0.GetWeekScore(arg_8_0):
	return arg_8_0.weekScore

def var_0_0.GetMonthScore(arg_9_0):
	return arg_9_0.monthScore

def var_0_0.GetTotalScore(arg_10_0):
	return arg_10_0.totalScore

def var_0_0.GetScore(arg_11_0, arg_11_1):
	if arg_11_1 == 0:
