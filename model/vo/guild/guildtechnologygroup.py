...
def var_0_0.AddProgress(arg_3_0, arg_3_1):
	arg_3_0.progress = arg_3_0.progress + arg_3_1

	if arg_3_0.GetTargetProgress() <= arg_3_0.progress:
		arg_3_0.LevelUp()
