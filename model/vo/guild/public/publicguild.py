...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in pairs(var_0_1.get_id_list_by_group):
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_1.technologys or {}):
...
def var_0_0.InitUser(arg_2_0, arg_2_1):
	arg_2_0.donateCount = arg_2_1.donate_count
	arg_2_0.donateTasks = {}

	for iter_2_0, iter_2_1 in ipairs(arg_2_1.donate_tasks or {}):
	...
	for iter_2_2, iter_2_3 in ipairs(arg_2_1.tech_id or {}):
...
def var_0_0.GetTechnologyGroups(arg_3_0):
	return arg_3_0.technologyGroups

def var_0_0.GetDonateTasks(arg_4_0):
	return arg_4_0.donateTasks

def var_0_0.GetTechnologys(arg_5_0):
	return arg_5_0.technologys

def var_0_0.GetTechnologyById(arg_6_0, arg_6_1):
	return arg_6_0.technologys[arg_6_1]

def var_0_0.GetDonateCount(arg_7_0):
	return arg_7_0.donateCount

def var_0_0.GetDonateTaskById(arg_8_0, arg_8_1):
	for iter_8_0, iter_8_1 in ipairs(arg_8_0.donateTasks):
		if iter_8_1.id == arg_8_1:
			return iter_8_1

def var_0_0.HasDonateCnt(arg_9_0):
	return arg_9_0.GetRemainDonateCnt() > 0

def var_0_0.UpdateDonateTasks(arg_10_0, arg_10_1):
	arg_10_0.donateTasks = arg_10_1

def var_0_0.IncDonateCount(arg_11_0):
	arg_11_0.donateCount = arg_11_0.donateCount + 1

def var_0_0.GetRemainDonateCnt(arg_12_0):
	return arg_12_0.maxDonateCntPreDay - arg_12_0.donateCount

def var_0_0.ResetDonateCnt(arg_13_0):
