...
def var_0_0.GetEffectName(arg_26_0):
...
def var_0_0.CanTrigger(arg_29_0):
	if arg_29_0.getConfig("type") == 5:
		return True
	else
		return not arg_29_0.IsCompleted()

def var_0_0.CanToggleOn(arg_30_0):
