...
def var_0_0.IsShipExpType(arg_3_0):
	return arg_3_0.getConfig("type") == var_0_0.EXP_BOOK_TYPE

def var_0_0.getConfigData(arg_4_0):
	local var_4_0 = {
...
def var_0_0.InitConfig(arg_7_0):
...
def var_0_0.CombinationDisplay(arg_23_0, arg_23_1):
	return var_0_0.StaticCombinationDisplay(arg_23_1)

def var_0_0.InTimeLimitSkinAssigned(arg_24_0):
	local var_24_0 = var_0_0.getConfigData(arg_24_0)

	if var_24_0.type != var_0_0.SKIN_ASSIGNED_TYPE:
		return False
...
def var_0_0.GetValidSkinList(arg_25_0):
...
def var_0_0.IsAllSkinOwner(arg_26_0):
...
def var_0_0.GetOverflowCheckItems(arg_28_0, arg_28_1):
...
def var_0_0.IsSkinShopDiscountType(arg_32_0):
	return arg_32_0.getConfig("usage") == ItemUsage.SKIN_SHOP_DISCOUNT

def var_0_0.CanUseForShop(arg_33_0, arg_33_1):
...
def var_0_0.GetConsumeForSkinShopDiscount(arg_34_0, arg_34_1):
...
def var_0_0.getName(arg_35_0):
	return arg_35_0.name or arg_35_0.getConfig("name")

def var_0_0.getIcon(arg_36_0):
