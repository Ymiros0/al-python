...
def var_0_0.GetExpandId(arg_2_0):
	local var_2_0 = arg_2_0.level - 1

	for iter_2_0, iter_2_1 in ipairs(arg_2_0.expandIds):
		if arg_2_0.shopCfg[iter_2_1].limit_args[1][2] == var_2_0:
			return iter_2_1

def var_0_0.IsMaxLevel(arg_3_0):
	return arg_3_0.level >= var_0_0.MAX_LEVEL

def var_0_0.GetMapSize(arg_4_0):
	return var_0_0.StaticGetMapSize(arg_4_0.level)

def var_0_0.StaticGetMapSize(arg_5_0):
...
def var_0_0.getExtendTrainPosShopId(arg_10_0):
	...
	for iter_10_0, iter_10_1 in pairs({
		...
		if var_10_0[iter_10_1].effect_args == ShopArgs.EffectDromExpPos and arg_10_0.exp_pos >= var_10_0[iter_10_1].limit_args[1][2] and arg_10_0.exp_pos <= var_10_0[iter_10_1].limit_args[1][3]:
			return iter_10_1

def var_0_0.bindConfigTable(arg_11_0):
	return pg.dorm_data_template

def var_0_0.getComfortable(arg_12_0, arg_12_1):
	local var_12_0 = 0
	local var_12_1 = {}
...
def var_0_0.increaseTrainPos(arg_18_0):
	arg_18_0.exp_pos = arg_18_0.exp_pos + 1

def var_0_0.increaseRestPos(arg_19_0):
	arg_19_0.rest_pos = arg_19_0.rest_pos + 1

def var_0_0.increaseFoodExtendCount(arg_20_0):
	arg_20_0.food_extend_count = arg_20_0.food_extend_count + 1

def var_0_0.extendFoodCapacity(arg_21_0, arg_21_1):
	arg_21_0.dorm_food_max = arg_21_0.dorm_food_max + arg_21_1

def var_0_0.levelUp(arg_22_0):
...
def var_0_0.consumeFood(arg_23_0, arg_23_1):
	arg_23_0.food = math.max(arg_23_0.food - arg_23_1, 0)

def var_0_0.restNextTime(arg_24_0):
...
def var_0_0.GetCapcity(arg_27_0):
	local var_27_0 = arg_27_0.dorm_food_max

	return arg_27_0.getConfig("capacity") + var_27_0

def var_0_0.setShipIds(arg_28_0, arg_28_1):
	arg_28_0.shipIds = arg_28_1

def var_0_0.addShip(arg_29_0, arg_29_1):
	table.insert(arg_29_0.shipIds, arg_29_1)

def var_0_0.deleteShip(arg_30_0, arg_30_1):
	for iter_30_0, iter_30_1 in ipairs(arg_30_0.shipIds):
		if iter_30_1 == arg_30_1:
			table.remove(arg_30_0.shipIds, iter_30_0)

			break

def var_0_0.GetStateShipCnt(arg_31_0, arg_31_1):
	local var_31_0 = 0

	for iter_31_0, iter_31_1 in ipairs(arg_31_0.shipIds):
		if getProxy(BayProxy).RawGetShipById(iter_31_1).state == arg_31_1:
			var_31_0 = var_31_0 + 1

	return var_31_0

def var_0_0.GetStateShips(arg_32_0, arg_32_1):
	local var_32_0 = {}

	for iter_32_0, iter_32_1 in ipairs(arg_32_0.shipIds):
		local var_32_1 = getProxy(BayProxy).RawGetShipById(iter_32_1)

		if var_32_1.state == arg_32_1:
			table.insert(var_32_0, var_32_1)

	return var_32_0

def var_0_0.GetStateShipsById(arg_33_0, arg_33_1):
	local var_33_0 = {}

	for iter_33_0, iter_33_1 in ipairs(arg_33_0.shipIds):
		local var_33_1 = getProxy(BayProxy).RawGetShipById(iter_33_1)

		if var_33_1.state == arg_33_1:
			var_33_0[var_33_1.id] = var_33_1

	return var_33_0

def var_0_0.GetNonStateShips(arg_34_0, arg_34_1):
	local var_34_0 = {}

	for iter_34_0, iter_34_1 in ipairs(arg_34_0.shipIds):
		local var_34_1 = getProxy(BayProxy).RawGetShipById(iter_34_1)

		if var_34_1.state != arg_34_1:
...
def var_0_0.GetShips(arg_35_0):
	...
	for iter_35_0, iter_35_1 in ipairs(arg_35_0.shipIds):
...
def var_0_0.AnyShipExistIntimacyOrMoney(arg_36_0):
	local var_36_0 = arg_36_0.GetShips()

	for iter_36_0, iter_36_1 in pairs(var_36_0):
		if iter_36_1.state_info_3 > 0 or iter_36_1.state_info_4 > 0:
			return True

	return False

def var_0_0.GetThemeList(arg_37_0, arg_37_1):
	return arg_37_0.themes

def var_0_0.SetTheme(arg_38_0, arg_38_1, arg_38_2):
	arg_38_0.themes[arg_38_1] = arg_38_2

def var_0_0.GetTheme(arg_39_0, arg_39_1):
	return arg_39_0.themes[arg_39_1]

def var_0_0.GetPurchasedFurnitures(arg_40_0):
	return arg_40_0.furnitures

def var_0_0.GetOwnFurnitureCount(arg_41_0, arg_41_1):
...
def var_0_0.SetFurnitures(arg_42_0, arg_42_1):
	arg_42_0.furnitures = arg_42_1

def var_0_0.AddFurniture(arg_43_0, arg_43_1):
	if not arg_43_0.furnitures[arg_43_1.id]:
		arg_43_1.MarkNew()
...
def var_0_0.IsPurchasedFurniture(arg_44_0, arg_44_1):
	return arg_44_0.furnitures[arg_44_1] != None and arg_44_0.furnitures[arg_44_1].count > 0

def var_0_0.HasFurniture(arg_45_0, arg_45_1):
	return arg_45_0.furnitures[arg_45_1] != None

def var_0_0.GetFurniture(arg_46_0, arg_46_1):
	return arg_46_0.furnitures[arg_46_1]

def var_0_0.GetPutFurnitureList(arg_47_0, arg_47_1):
	local var_47_0 = {}
	local var_47_1 = arg_47_0.GetTheme(arg_47_1)
	local var_47_2 = var_47_1 and var_47_1.GetAllFurniture() or {}

	for iter_47_0, iter_47_1 in pairs(var_47_2):
...
def var_0_0.GetPutShipList(arg_48_0, arg_48_1):
	local var_48_0 = {}
	local var_48_1 = ({
		Ship.STATE_TRAIN,
		Ship.STATE_REST
	...
	for iter_48_0, iter_48_1 in pairs(arg_48_0.GetShips()):
		if iter_48_1.state == var_48_1:
