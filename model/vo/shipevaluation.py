...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_1.discuss_list):
...
def var_0_0.sortEvas(arg_2_0):
	...
	local var_2_1 = _(arg_2_0.evas).chain().slice(var_2_0 + 1, #arg_2_0.evas - var_2_0).sort(function(arg_4_0, arg_4_1)
		...
		if var_4_0 <= -5 or var_4_1 <= -5:
			return var_4_1 < var_4_0
		else
			return arg_4_0.id > arg_4_1.id).value()

	for iter_2_0 = 1, #arg_2_0.evas:
