...
def var_0_0.AddExp(arg_2_0, arg_2_1):
	if arg_2_0.IsMaxLevel():
		return
	...
	while var_2_1 >= pg.skill_need_exp[var_2_2].exp:
...
def var_0_0.StaticGetNextLevelExp(arg_9_0):
