...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_1.data1_list):
	...
	for iter_1_2, iter_1_3 in ipairs(var_1_1.all):
		if arg_1_1.id == var_1_1[iter_1_3].activity:
...
def var_0_0.getSortGoods(arg_5_0):
	local var_5_0 = {}

	for iter_5_0, iter_5_1 in pairs(arg_5_0.goods):
...
def var_0_0.getToggleImage(arg_16_0):
	return pg.activity_template[arg_16_0.activityId].config_client.toggle or "huodongdduihuan_butten"

def var_0_0.getResId(arg_17_0):
	local var_17_0

	for iter_17_0, iter_17_1 in pairs(arg_17_0.goods):
		var_17_0 = iter_17_1
...
def var_0_0.GetResList(arg_18_0):
	local var_18_0 = {}

	for iter_18_0, iter_18_1 in pairs(arg_18_0.goods):
