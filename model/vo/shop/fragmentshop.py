...
def var_0_0.update(arg_1_0, arg_1_1, arg_1_2, arg_1_3):
	arg_1_0.id = arg_1_1
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_3):
	...
	if arg_1_0.id and arg_1_0.id > 0 and arg_1_0.getConfigTable():
		...
		for iter_1_4, iter_1_5 in ipairs(arg_1_0.getConfig("blueprint_shop_goods")):
			var_1_1(iter_1_5, Goods.TYPE_FRAGMENT)

		for iter_1_6, iter_1_7 in ipairs(arg_1_0.getConfig("blueprint_shop_limit_goods")):
			var_1_1(iter_1_7, Goods.TYPE_FRAGMENT_NORMAL)

def var_0_0.Reset(arg_3_0, arg_3_1):
	local var_3_0 = {}

	for iter_3_0, iter_3_1 in ipairs(arg_3_0.getConfig("blueprint_shop_limit_goods")):
