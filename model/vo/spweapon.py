...
def var_0_0.CreateByNet(arg_2_0):
...
def var_0_0.GetUpgradableSkillInfo(arg_30_0):
	local var_30_0 = 0
	local var_30_1 = 1
...
def var_0_0.GetActiveUpgradableSkill(arg_31_0, arg_31_1):
...
def var_0_0.RemapSkillId(arg_32_0, arg_32_1):
...
def var_0_0.GetBaseAttributes(arg_37_0):
	return {
		arg_37_0.attr1 or 0,
		arg_37_0.attr2 or 0
	}

def var_0_0.SetBaseAttributes(arg_38_0, arg_38_1):
	arg_38_0.attr1 = arg_38_1[1]
	arg_38_0.attr2 = arg_38_1[2]

def var_0_0.GetAttributeOptions(arg_39_0):
	return {
		arg_39_0.attrTemp1 or 0,
		arg_39_0.attrTemp2 or 0
	}

def var_0_0.SetAttributeOptions(arg_40_0, arg_40_1):
	arg_40_0.attrTemp1 = arg_40_1[1]
	arg_40_0.attrTemp2 = arg_40_1[2]

def var_0_0.GetPropertiesInfo(arg_41_0):
	local var_41_0 = {
		attrs = {}
	}
...
def var_0_0.GetWearableShipTypes(arg_42_0):
