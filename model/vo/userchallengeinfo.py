...
def var_0_0.UpdateChallengeInfo(arg_2_0, arg_2_1):
	...
	for iter_2_0, iter_2_1 in ipairs(arg_2_1.dungeon_id_list):
	...
	if arg_2_0._mode == ChallengeProxy.MODE_INFINITE:
		arg_2_0.setInfiniteDungeonIDListByLevel()

	arg_2_0._fleetList = {}

	for iter_2_2, iter_2_3 in ipairs(arg_2_1.groupinc_list):
		arg_2_0.updateChallengeFleet(iter_2_3)

	arg_2_0._buffList = {}

	for iter_2_4, iter_2_5 in ipairs(arg_2_1.buff_list):
		table.insert(arg_2_0._buffList, iter_2_5)

	arg_2_0._lastScore = 0

def var_0_0.updateChallengeFleet(arg_3_0, arg_3_1):
	local var_3_0 = Challenge2Fleet.New(arg_3_1)

	if var_3_0.isSubmarineFleet():
...
def var_0_0.updateLevelForward(arg_5_0):
	arg_5_0._level = arg_5_0._level + 1

def var_0_0.updateShipHP(arg_6_0, arg_6_1, arg_6_2):
	if not (arg_6_0._fleet.updateShipsHP(arg_6_1, arg_6_2) or arg_6_0._submarineFleet.updateShipsHP(arg_6_1, arg_6_2)):
		assert(False, "challenge unit not exist")

def var_0_0.getRegularFleet(arg_7_0):
	return arg_7_0._fleet

def var_0_0.getSubmarineFleet(arg_8_0):
	return arg_8_0._submarineFleet

def var_0_0.getShipUIDList(arg_9_0):
	local var_9_0 = {}
	...
	for iter_9_2, iter_9_3 in ipairs(var_9_2):
...
def var_0_0.getRound(arg_11_0):
	return math.ceil(arg_11_0._level / #arg_11_0._dungeonIDList)

def var_0_0.getMode(arg_12_0):
	return arg_12_0._mode

def var_0_0.getDungeonIDList(arg_13_0):
	return Clone(arg_13_0._dungeonIDList)

def var_0_0.getSeasonID(arg_14_0):
	return arg_14_0._seasonIndex

def var_0_0.getResetFlag(arg_15_0):
	return arg_15_0._resetflag

def var_0_0.getScore(arg_16_0):
	return arg_16_0._score

def var_0_0.getLastScore(arg_17_0):
	return arg_17_0._lastScore

def var_0_0.getActivityIndex(arg_18_0):
	return arg_18_0._activityIndex

def var_0_0.getNextExpedition(arg_19_0):
...
def var_0_0.setInfiniteDungeonIDListByLevel(arg_20_0):
...
def var_0_0.getNextInfiniteDungeonIDList(arg_21_0):
...
def var_0_0.getNextStageID(arg_22_0):
	return arg_22_0.getNextExpedition().dungeon_id

def var_0_0.IsFinish(arg_23_0):
	if arg_23_0._level % #arg_23_0._dungeonIDList == 0:
		return True
	else
		return False
