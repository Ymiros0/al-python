...
def var_0_1.Pack(arg_2_0, arg_2_1, arg_2_2, arg_2_3):
	local var_2_0 = arg_2_3.SerializeToString()
	local var_2_1 = ""
	local var_2_2 = arg_2_0.ps

	if #var_2_0 > arg_2_0.defaultBuffSize - 7:
...
def var_0_1.Unpack(arg_3_0, arg_3_1, arg_3_2):
...
def var_0_1.GetProtocolWithName(arg_4_0, arg_4_1):
	if arg_4_0._protocols[arg_4_1] != None:
