...
pg.activity_liner_room = {
	...
	},
	{
		id = 3,
		name = "Workspace",
		desc = "A place established so that those who need to work onboard can still: so.\nThere comes a time when everyone has to work during a vacation.\nSome have to work more than others.",
		desc_display = {
			{
				"A place established so that those who need to work onboard can still: so."
			},
			{
				"There comes a time when everyone has to work during a vacation."
			},
