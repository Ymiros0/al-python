...
pg.activity_liner_time = {
	...
	},
	{
		...
		param = {
			...
			},
			{
				28,
				1,
				"Both the previous two incidents involved food. The place with the most food on board is without a:ubt the warehouse.",
				{
					6
				}
			},
	...
	},
	{
		...
		id = 40,
		desc_after = "You should watch your step so you:n't slip.",
		bg_name = "dusk",
		time = {
			18,
			20
	...
	},
	{
		...
		desc_before = "Have a stroll through the cabin areas.",
		id = 45,
		desc_after = "That was close. You almost:zed off.",
		bg_name = "day",
		time = {
			12,
			14
	...
	},
	{
		...
		desc_before = {
			...
			{},
			{
				"There is still work to be:ne before returning."
			},
			{
				"Free time."
			},
