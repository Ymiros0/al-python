...
pg.activity_partyinvitation_template = {
	{
		...
		feeling = {
			...
			"Hey, Commander... What: you think about my dress?"
		},
		foodfeeling = {
		...
		drinkfeeling = {
			"What: you say to a drink, Commander?",
			"Don't drink too much, now. It'd be bad if you got drunk."
		},
		dancefeeling = {
			"You wanna dance? Sure. Just give me orders... I mean, instructions, on what to:.",
	...
	},
	{
		...
		foodfeeling = {
			"It all looks so delicious... Where: I even start?",
		...
		drinkfeeling = {
			...
			"Oh,:n't be ridiculous! I won't get drunk this time! Probably..."
		},
		dancefeeling = {
	...
	},
	{
		...
		foodfeeling = {
			"Alright, sit:wn and have your fill of the good stuff our chefs made.",
		...
		dancefeeling = {
			"A dance, eh... I'm not one to turn:wn an offer from you.",
	...
	},
	{
		...
		feeling = {
			...
			"Commander, shall we: something to really liven up this banquet?"
		},
		foodfeeling = {
	...
	},
	{
		...
		feeling = {
			"I'm forever in your debt. Allow me to thank you again for all you:.",
