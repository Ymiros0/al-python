...
pg.activity_ryza_item = {
	...
	{
		rarity = 2,
		display = "A common weed that grows absolutely everywhere. It has no distinct features, which is why it:esn't have a proper name. At the same time, it's also a staple ingredient in a large number of alchemy recipes.",
		name = "Nameless Grass",
		type = 1,
		benefit_buff = "",
		prop_level = 1,
