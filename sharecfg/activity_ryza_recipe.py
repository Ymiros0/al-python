...
pg.activity_ryza_recipe = {
	...
	{
		display = "An improved tool for splitting firewood and cutting:wn trees for lumber. It's been modified for better balance and sharpness, making gathering easier than ever.",
		rarity = 3,
		name = "Golden Axe",
		type = 3,
		id = 2,
	...
	[10] = {
		display = "An Augment Module for Reisalin Stout. A constantly glowing staff. It continues to give off a bright, dazzling light even if you:n't: anything. It's said that its light makes the hearts of everyone it shines on brighter.",
		rarity = 4,
	...
	[30] = {
		display = "An Augment Module for Patricia Abelheim. A sentient sword that chooses its own wielder. If a warrior:esn't have a proud soul, they'll never be able to use it no matter how skilled they might be.",
		rarity = 4,
		name = "Edel Schwert",
		type = 1,
		id = 30,
	...
	[120] = {
		display = "A bullet that:es not require a gun barrel. When you release it toward the target, it will fly around in the sky and: go in a straight line to the target, exploding on impact.",
		rarity = 4,
		name = "Bubble Bullet",
		type = 1,
		id = 120,
	...
	[190] = {
		display = "An item resembling a keycard, made from combining the other four keys. It should slot into the device by the barrier's:or at the Central Foundation.",
		rarity = 3,
