...
pg.item_data_frame = {
	...
	[319] = {
		...
		id = 319,
		time_second = 0,
		desc = "<color=#ffffff>Beyond the open:or lies a new future.</color>\nObtained from the \"Rondo at Rainbow's End\" event",
		scene = {}
	},
	[320] = {
		time_limit_type = 0,
	...
	[322] = {
		...
		id = 322,
		time_second = 0,
		desc = "<color=#ffffff>\"From sea of cloud comes lonely rays, as fleeting as the morning haze. From its scabbard:es heavenly sword draw, a violet flash sundering sky, earth, and all.\"</color>\nObtained from the \"Violet Tempest, Blooming Lycoris\" event.",
		scene = {}
	},
	[323] = {
		time_limit_type = 0,
