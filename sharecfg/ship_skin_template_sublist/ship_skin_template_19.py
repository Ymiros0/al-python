...
pg.base.ship_skin_template_19 = {
	...
	[9702040] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "I'm La Galissonnière, the shipgirl from hell! I've come for your soul! ...Wow, didn't even flinch. Guess it's True that you:n't fear death. Heheh, let's see if I can get a more interesting response out of you next time~♪",
		voice_actor = 238,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9702070] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Yoohoo! Nice to meet you, Commander... When can I start? Heehee. You clearly:n't understand the situation here. If you want the privilege of working with the noble Lady Pamiat' Merkuria, you'll have to earn it!",
		voice_actor = 219,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9703020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "You must be the Commander. I am the heavy cruiser Algérie. So, what pleasures can I experience here? I: hope you won't disappoint me. Heehee~",
		voice_actor = 142,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9705010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "I am battleship Fusou. I have come to bring peace to this world's tormented souls. Commander,: you seek blessings... or redemption?",
		voice_actor = 71,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9705020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Are you this fleet's Commander, Milord? I see. You have great potential, but your skills need some refinement. I wonder what's the best way to train you... You'll see soon enough – stay alert until:!",
		voice_actor = 71,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9705040] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "So you are the Commander? Very well. From this point forth, you will use your courage and intellect for our purposes! ...We:n't have all day, now. You are our servant, so this won't go anywhere until you swear your fealty.",
		voice_actor = 28,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9707010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "I'm getting all fired up! The name's Hiryuu, Hiryuu from the 2nd CarDiv. As a member of this fleet, I'll obey your orders. I: hope that you are qualified to lead us.",
		voice_actor = 30,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10100061] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "It's good to take it easy and celebrate once in a while, but especially in moments like these, you can't afford to let your guard:wn. Commander, why:n't we spar for a bit? Don't even think about holding back - come at me!",
		voice_actor = 80,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "nepblack",
	...
	[10100071] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "B-bastard! Where are you looking? I bet you're thinking I look like a kid! Eh....? They're just right? If Commander says something like that... I:n't know how to react...",
		voice_actor = 81,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "nepwhite",
	...
	[10100081] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Commander, are you having a good time? Ehehe, I certainly am. It's not often that we get to relax like this. Why:n't we head out and enjoy the breeze?",
		voice_actor = 65,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "nepgreen",
	...
	[10400011] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "The clothes from the Sakura Empire are so stylish! Commander, since it's a rare occasion, let's go take a look around! Ah, of course,:n't forget to run the reel~♪",
		voice_actor = 176,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10400020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Well met. I'm Kizuna AI, the new addition to your base. I will: all in my power to be at least of some use. It is a pleasure meeting you, Commander.",
		voice_actor = 176,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10500010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "We meet at last! I'm Hololive's virtual fox, Shirakami Fubuki! Commander, now that you've called me, we're gonna have a foxin' good time! Now:, let's get to work!",
		voice_actor = 206,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10500020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Hey Commander, it's nice to meet you~! I'm Tokino Sora, a virtual idol affiliated with Hololive! I'll: my absolute best here like I always:! I'll be in your care, so cheer me on, Commander!",
		voice_actor = 211,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10500021] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "\"Hello, my friends! I hope you're well~! This is Sora, on site at a beach in a slightly different world!\" Beach visits just feel so invigorating,:n't they? On another note, I can't swim…",
		voice_actor = 211,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10500031] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Commander, good Aquafternoon~! Nice to meet you, it's Aqua, the Gamer Maid from Hololive! I'll show ya what the strongest maid can:!",
		voice_actor = 208,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10500041] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "I'm the lovely high school girl, now in her extra-pure pajamas, Natsuiro Matsuri! Hey hey, Commander, what: you think? Surprised? Don't gawk at me too much~",
		voice_actor = 207,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600011] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Hmm, this swimsuit is pretty cute, but isn't it a bit childish? ...In any case, if you like it,: it's all good!",
		voice_actor = 252,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Um... Are you the Commander? Oh, perfect! It's nice to meet you. My name is Honoka! I:n't know how much I'll be able to help, but... let's be friends!",
		voice_actor = 251,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600021] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Whoa, the sea is so pretty~! It's as beautiful as the Venus Islands! I'm so blown away, I:n't even feel the heat anymore!",
		voice_actor = 251,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600040] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "It's nice to meet you! From what I've heard, you're the \"Commander,\" right? I'm Misaki. I have experience with various part-time jobs, so... I'm confident that I can be of help to you all. Let's: our best!",
		voice_actor = 144,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600050] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Are you the person who led Misaki to this port? You go by the name... \"Commander\"? Hmm... I:n't know how you sweet-talked her into it, but you're not fooling me. The moment you: anything strange... you better be on guard! My name? It's Nagisa. You... silly:g!",
		voice_actor = 182,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600051] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Whew! The wind feels great! ...What are you staring at me like that for, you silly:g? You're the one who said you wanted to go to the beach, remember? To start with, how about... we take a stroll?",
		voice_actor = 182,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600060] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Oh? You:n't seem to fear me... Who might you be? ...I see, so it is you who rules over this place. Then I shall call you \"Commander.\" I am Nyotengu. You would: best to keep me entertained, hehe.",
		voice_actor = 253,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10600071] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "\"Welcome to Monica's Fantabulous Casino! Where you can have your every whim satisfied!\" ...Oh, that:esn't sound very casino-managery? Heheh!",
		voice_actor = 234,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10700010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Hello, Commander! I'm the idol, Haruka Amami! I'll: my best to share my dreams with everyone in port! Let's all have a great time together!",
		voice_actor = 94,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10700021] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Oh, the fireworks display is starting. I'm planning to meet up with the others after this, but... Why:n't we spend some time enjoying the view here first?",
		voice_actor = 80,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10700030] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Hello, hello~! My name is Iori Minase! It's such a pleasure to meet you! ...Huh? There's no need for me to force myself...? Hey, wait a second, what: you mean by that?!",
		voice_actor = 89,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10800021] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Welcome back, Commander. You sure brought a lot of goodies back for me, huh? Now:,:n't just keep standing there, hurry and come to me~",
		voice_actor = 108,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10800041] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Woo, you're here! So, how was it? This meeting spot was pretty easy to find, right? Welp, let's get going:!",
		voice_actor = 294,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[10800050] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "Hello, my name is Yume Minami. I've ended up in this world for whatever reason. I'll: my best to contribute to the fleet as a heavy cruiser.",
		voice_actor = 295,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
