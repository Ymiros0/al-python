...
pg.skill_world_display = {
	...
	[16190] = {
		desc_get = "",
		id = 16190,
		desc = "[Operation Siren]\nDecreases this ship's DMG taken by $1 and increases her FP by $2. When this ship enters the battle. restores $3 of this ship's max HP. 5s after this ship's HP falls below 50.0% as a result of DMG taken, or 60s after she enters the battle. this ship leaves the battle (the Tolls of War debuff:es not affect when this ship leaves the battle).",
		desc_get_add = {
			{
				"15.0%",
				"30.0%"
