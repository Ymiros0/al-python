...
pg.base.strategy_data_template = {
	...
	[200085] = {
		...
		icon = "200085",
		buff_type = 0,
		desc = "An improved tool for splitting firewood and cutting:wn trees for lumber. It's been modified for better balance and sharpness, making gathering easier than ever.",
		arg = {}
	},
	[200086] = {
		buff_id = 0,
	...
	[200538] = {
		...
		icon = "200538",
		buff_type = 0,
		desc = "\"Commander, behold my next move.\"\nIn battle, allied Tribunal mass-produced ships and Mechanicus Confessors will lay:wn supporting barrages.",
		arg = {}
	},
	[200541] = {
		buff_id = 200541,
