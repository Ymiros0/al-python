...
pg.world_collection_file_template = {
	...
	[3303] = {
		...
		is_classified = 0,
		group_ID = 3,
		content = "...The Northern Parliament will once again be sending their tried and tested nuclear-powered space shuttle on a resupply mission to Space Station Emir. The shuttle will be delivering the regular cargo consisting of food supplies and research equipment, in addition to 3 medium-sized supplementary Cube power units.\nOnce they have been successfully installed, these units will: provide the station's existing installations with additional output.\n\nThe Northern Parliament intends to install additional Cube power units on the station in the future and further expand the Emir's operational scope.\nAdditionally, a Northern Parliament space program representative announced that plans are in the works to construct a new:cking platform that would allow the station to store and launch probes into deep-space. These probes are currently under development and will be powered with Cube technology.\n\nUpon review of both nuclear-powered and Cube-powered space shuttles for use in low-Earth orbit, scientists found that Cube-powered shuttles: not have any significant advantages over their older nuclear-powered counterparts. In light of these findings, many organizations have announced plans to invest research into Cube-powered deep-space probes that can take off directly from space station:cking platforms instead...",
		pic = ""
	},
	[3304] = {
		id = 3304,
	...
	[13206] = {
		...
		is_classified = 0,
		group_ID = 6,
		content = "…The convoy sent to refloat the platform broadcasted a distress signal before all contact was lost. Naval servicemen stationed on the floating:ck near the disaster site were immediately dispatched to investigate and begin a rescue mission.\n\nAccording to a sergeant who was among the first responders, only a handful of the several:zen vessels in the convoy were found, and all of those vessels were either on fire or had capsized.\n\nThanks to the heroic efforts of the rescue team, one sole survivor was found inside a freezer aboard a salvage vessel that sustained comparatively little damage. Unfortunately, this survivor displayed severe mental disturbance and was transported to the nearest research facility for medical observation and treatment. The individual remains in an uncommunicative state.\n\nA follow-up investigation revealed numerous signs of fighting aboard the salvage ship, suggesting that a riot had broken out immediately before the incident. Findings indicate that a person had set fire to the galley, which: spread throughout the rest of the ship. It is possible that this riot is connected to the outbreaks of mass hysteria reported on the East Coast.\n\nThe records gathered from the ship suggest that, just prior to the incident, the crew had managed to recover an object of substantial importance from the sunken platform. As this object was not found aboard the ship during the investigation, it is likely that it sunk to the ocean floor once again...",
		pic = ""
	},
	[13301] = {
		id = 13301,
