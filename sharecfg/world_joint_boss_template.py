		...
		description = {
			{
				...
				3,
				"This ship can lay:wn special light and dark cards. The cards inflict area of effect damage."
			},
			{
		...
		description = {
			{
				...
				3,
				"This ship can lay:wn special cards that form chains of fire and explode."
			},
			{
				"Scorching Seas",
				2,
		...
		description = {
			{
				"Dominion Expansion",
				1,
				"This ship exerts a field of:minion and summons Phantom Knights during battle. <color=#92fc63>The Phantom Knights are resistant to attacks from non-META ships</color>. \nOnce all Phantom Knights have been defeated, this ship <color=#92fc63>becomes weaker</color> and permanently takes increased DMG."
			},
			{
				"META Affinity",
				2,
	...
	},
	{
		...
		description = {
			...
			},
			{
				"My Phantoms",
				3,
				"When the battle starts. summons 7 phantoms of Rodney. \nThe phantoms: not attack and their DMG taken is set to 1. <color=#92fc63>When a phantom is eliminated, Rodney META's DMG dealt increases and her DMG taken decreases.</color> \nWhen the battle is at 10s remaining. all phantoms are eliminated."
			},
			{
				"Rodney's Demise",
				2,
