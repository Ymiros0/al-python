...
def ClearAllText(arg_28_0):
	...
	for iter_28_0 = 1, var_28_0.Length:
...
def eachChild(arg_43_0, arg_43_1):
	...
	for iter_43_0 = var_43_0.childCount - 1, 0, -1:
...
def GetInChildren(arg_56_0, arg_56_1):
	local function var_56_0(arg_57_0, arg_57_1)
		...
		for iter_57_0 = 0, arg_57_0.childCount - 1:
...
def seriesAsync(arg_60_0, arg_60_1, ...):
	local var_60_0 = 0
...
def seriesAsyncExtend(arg_62_0, arg_62_1, ...):
	local var_62_0
...
def pressPersistTrigger(arg_103_0, arg_103_1, arg_103_2, arg_103_3, arg_103_4, arg_103_5, arg_103_6, arg_103_7):
	...
	var_103_0.AddPointDownFunc(function()
		var_103_1 = Timer.New(function()
			...
			existCall(arg_103_2), arg_103_1, -1)
...
def OnSliderWithButton(arg_114_0, arg_114_1, arg_114_2):
	...
	onButton(arg_114_0, arg_114_1.Find("up"), function()
		var_114_0.value = math.clamp(var_114_0.value + var_114_1, var_114_0.minValue, var_114_0.maxValue), SFX_PANEL)
