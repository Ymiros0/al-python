...
def var_0_0.TransActivity2ShopData(arg_4_0, arg_4_1):
	if arg_4_1 and not arg_4_1.isEnd():
		local var_4_0 = ActivityShop.New(arg_4_1)

		arg_4_0.viewComponent.SetShop(var_4_0)

def var_0_0.AddSpecialList(arg_5_0, arg_5_1):
	local var_5_0 = {}

	if pg.gameset.activity_lottery_rewards:
		for iter_5_0, iter_5_1 in ipairs(pg.gameset.activity_lottery_rewards.description or {}):
...
def var_0_0.HandleSpecialReach(arg_6_0, arg_6_1):
	if not pg.gameset.activity_lottery_rewards or not pg.gameset.activity_lottery_rewards.description:
		return

	local var_6_0 = _.reduce(arg_6_1.data2_list, 0, function(arg_7_0, arg_7_1)
		return arg_7_0 + arg_7_1)

	for iter_6_0, iter_6_1 in ipairs(pg.gameset.activity_lottery_rewards.description):
		if var_6_0 >= iter_6_1[1] and not table.contains(arg_6_1.data3_list, iter_6_1[1]):
...
def var_0_0.handleNotification(arg_9_0, arg_9_1):
	...
	if var_9_0 == ActivityProxy.ACTIVITY_UPDATED:
		if var_9_1.getConfig("type") == ActivityConst.ACTIVITY_TYPE_SHOP_PROGRESS_REWARD:
