...
def var_0_0.didEnter(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.msgbox.Find("window/button_container/Button1"), function()
		setActive(arg_5_0.msgbox, False), SFX_CANCEL)
...
def var_0_0.ShowEnterMsg(arg_11_0):
...
def var_0_0.UpdateGoods(arg_14_0):
	...
	UIItemList.StaticAlign(arg_14_0.goodsContainer, arg_14_0.goodsContainer.GetChild(0), #var_14_0, function(arg_16_0, arg_16_1, arg_16_2)
		...
		onButton(arg_14_0, arg_16_2, function()
			arg_14_0.OnClickCommodity(var_16_0, function(arg_18_0, arg_18_1)
				arg_14_0.OnPurchase(var_16_0, arg_18_1)), SFX_PANEL))
	...
	UIItemList.StaticAlign(arg_14_0.specialsContainer, arg_14_0.specialsContainer.GetChild(0), 3, function(arg_19_0, arg_19_1, arg_19_2)
		...
		onButton(arg_14_0, arg_19_2, function()
			arg_14_0.emit(BaseUI.ON_DROP, var_19_0), SFX_PANEL))
...
def var_0_0.Purchase(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4):
	arg_23_0.ShowMsgbox({
		...
		def onYes:()
			if arg_23_0.CheckRes(arg_23_1, arg_23_2):
				arg_23_4(arg_23_1, arg_23_2)
	})

def var_0_0.OnClickCommodity(arg_25_0, arg_25_1, arg_25_2):
	if not arg_25_0.CheckRes(arg_25_1, 1):
		return
...
def var_0_0.OnPurchase(arg_26_0, arg_26_1, arg_26_2):
...
def var_0_0.SetActiveBubble(arg_29_0, arg_29_1, arg_29_2):
	if arg_29_0.chatActive == tobool(arg_29_1) and not arg_29_2:
		return
...
def var_0_0.AddPollingChat(arg_32_0):
	...
	arg_32_0.pollTimer = Timer.New(function()
		...
		arg_32_0.pollIndex = (arg_32_0.pollIndex + 1) % #arg_32_0.pollText, 6)

	arg_32_0.pollTimer.Start()

def var_0_0.StopPolling(arg_34_0):
	if not arg_34_0.pollTimer:
		return

	arg_34_0.pollTimer.Stop()

	arg_34_0.pollTimer = None

def var_0_0.StopChat(arg_35_0):
	if LeanTween.isTweening(go(arg_35_0.chat)):
