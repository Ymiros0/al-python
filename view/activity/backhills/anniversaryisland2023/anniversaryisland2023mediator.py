...
def var_0_0.handleNotification(arg_3_0, arg_3_1):
	...
	if var_3_0 == ActivityProxy.ACTIVITY_SHOW_AWARDS:
...
def var_0_0.CheckPreloadData(arg_4_0, arg_4_1):
	if getProxy(ContextProxy).getContextByMediator(AnniversaryIsland2023Mediator):
