...
def var_0_0.BuildTaskVOs(arg_4_0):
...
def var_0_0.UpdateTaskListItem(arg_10_0, arg_10_1, arg_10_2):
	arg_10_1 = arg_10_1 + 1
	...
	onButton(arg_10_0, var_10_0.Find("BG/Commit"), function()
		arg_10_0.emit(AnniversaryIslandSpringTask2023Mediator.SHOW_SUBMIT_WINDOW, var_10_1), SFX_PANEL)
	onButton(arg_10_0, var_10_0.Find("BG/Reward"), function()
		arg_10_0.emit(AnniversaryIslandSpringTask2023Mediator.SUBMIT_TASK, var_10_1), SFX_PANEL)
...
def var_0_0.didEnter(arg_16_0):
	...
	onButton(arg_16_0, arg_16_0._tf.Find("Top/Home"), function()
		arg_16_0.quickExitFunc(), SFX_CANCEL)
