...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0._upper.Find("pengpengdong"), function()
		pg.m02.sendNotification(GAME.GO_MINI_GAME, 51), SFX_PANEL)
	...
	arg_3_0.InitFacilityCross(arg_3_0._map, arg_3_0._upper, "tebiezuozhan", function()
		...
		if not var_14_1 or not var_14_0.getMapById(var_14_1).isUnlock():
...
def var_0_0.IsShowMainTip(arg_18_0):
	if arg_18_0 and not arg_18_0.isEnd():
