...
def var_0_0.updateSwitchBtnTF(arg_23_0):
	...
	for iter_23_0, iter_23_1 in ipairs(arg_23_0.switchBtnList):
		...
		if var_23_1 == 0 or iter_23_0 == arg_23_0.curPage:
			setActive(var_23_0, False)

		if var_23_1 > 0 and iter_23_0 != arg_23_0.curPage:
...
def var_0_0.checkAward(arg_26_0):
	...
	if #arg_26_0.activeIDList == #arg_26_0.allIDList and arg_26_0.activityData.data1 != 1:
