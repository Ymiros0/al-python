...
def var_0_0.didEnter(arg_3_0):
	...
	arg_3_0.InitFacilityCross(arg_3_0._map, arg_3_0._upper, "xuanshangban", function()
		if var_0_0.XuanShangBanFirstTip():
...
def var_0_0.XuanShangBanFirstTip():
...
def var_0_0.IsFinishAllActTask():
...
def var_0_0.MiMiChuanChangTip():
	if not var_0_0.IsFinishAllActTask():
...
def var_0_0.IsShowMainTip(arg_16_0):
	if arg_16_0 and not arg_16_0.isEnd():
