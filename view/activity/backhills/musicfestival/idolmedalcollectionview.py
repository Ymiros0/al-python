...
def var_0_0.addListener(arg_7_0):
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.switchBtnList):
		onToggle(arg_7_0, iter_7_1, function(arg_10_0)
			if arg_10_0 == True:
				arg_7_0.curPage = iter_7_0

				arg_7_0.updateSwitchBtnTF()
				arg_7_0.updateMedalContainerView(iter_7_0), SFX_PANEL)

	addSlip(SLIP_TYPE_HRZ, arg_7_0.bg, function()
		if arg_7_0.curPage > 1:
			triggerToggle(arg_7_0.switchBtnList[arg_7_0.curPage - 1], True)
		else
			return, function()
		if arg_7_0.curPage < var_0_0.PAGE_NUM:
			triggerToggle(arg_7_0.switchBtnList[arg_7_0.curPage + 1], True)
		else
			return)

def var_0_0.updateMedalContainerView(arg_13_0, arg_13_1):
...
def var_0_0.updateMedalView(arg_14_0, arg_14_1, arg_14_2):
...
def var_0_0.updateSwitchBtnTF(arg_16_0):
	for iter_16_0, iter_16_1 in ipairs(arg_16_0.switchBtnList):
		...
		if var_16_2 == 0 or iter_16_0 == arg_16_0.curPage:
			setActive(var_16_0, False)

		if var_16_2 > 0 and iter_16_0 != arg_16_0.curPage:
			setActive(var_16_0, True)
			setText(var_16_1, var_16_2)

def var_0_0.updateAfterSubmit(arg_17_0, arg_17_1):
...
def var_0_0.UpdateActivity(arg_18_0):
	return

def var_0_0.caculateActivatable(arg_19_0, arg_19_1):
	...
	for iter_19_0, iter_19_1 in ipairs(var_19_0):
		...
		if not var_19_2 and var_19_3:
			var_19_1 = var_19_1 + 1

	return var_19_1

def var_0_0.checkAward(arg_20_0):
	if #arg_20_0.activeIDList == #arg_20_0.allIDList and arg_20_0.activityData.data1 != 1:
