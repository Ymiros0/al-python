...
def var_0_0.GetContainerPositions(arg_1_0):
	return {
		32.4,
		132.7
	}
...
def var_0_0.findUI(arg_8_0):
	...
	arg_8_0.overlayingImage = None

	for iter_8_2 = 0, arg_8_0.selectPanelContainer.childCount - 1:
	...
	for iter_8_3, iter_8_4 in pairs(var_0_1):
...
def var_0_0.addListener(arg_10_0):
	...
	onButton(arg_10_0, arg_10_0.buttonShare, function()
		...
		arg_10_0.UpdateView(), SFX_PANEL)

	local var_10_0 = GameObject.Find("OverlayCamera").GetComponent("Camera")

	for iter_10_0, iter_10_1 in ipairs(arg_10_0.allItems):
		...
		local function var_10_3()
			if not arg_10_0.overlayingImage:
				return

			local var_21_0 = arg_10_0.overlayingImage

			arg_10_0.overlayingImage = None

			for iter_21_0, iter_21_1 in ipairs(arg_10_0.listStayInPanel):
				if iter_21_1 == var_21_0:
					setParent(var_21_0, arg_10_0.selectPanelContainer)
					setAnchoredPosition(var_21_0, arg_10_0.selectedPositionsInPanels[var_21_0])

					return

			for iter_21_2, iter_21_3 in ipairs(arg_10_0.listShowOnPanel):
				if iter_21_3 == var_21_0:
		...
		var_10_2.AddPointClickFunc(function(arg_22_0, arg_22_1)
			...
			if arg_10_0.lastSelectedImage == iter_10_1:
				arg_10_0.SwitchSelectedImage(None)
			else
		...
		var_10_2.AddDragEndFunc(function(arg_25_0, arg_25_1)
			...
			if not rtf(arg_10_0.pageModified).rect.Contains(var_25_2):
...
def var_0_0.SwitchSelectedImage(arg_26_0, arg_26_1):
	if arg_26_0.lastSelectedImage == arg_26_1:
		return

	if arg_26_0.lastSelectedImage:
...
def var_0_0.ResetPanel(arg_27_0):
	for iter_27_0, iter_27_1 in ipairs(arg_27_0.listShowOnPanel):
...
def var_0_0.UpdateView(arg_28_0):
	if arg_28_0.pageIndex == 1:
		arg_28_0.updateMedalContainerView()

	for iter_28_0 = 1, #arg_28_0.pages:
...
def var_0_0.updateMedalContainerView(arg_29_0):
	for iter_29_0, iter_29_1 in ipairs(arg_29_0.allIDList):
		arg_29_0.updateMedalView(arg_29_0.allIDList, iter_29_1)

def var_0_0.updateMedalView(arg_30_0, arg_30_1, arg_30_2):
...
def var_0_0.updateAfterSubmit(arg_32_0):
	return

def var_0_0.UpdateActivity(arg_33_0):
	arg_33_0.initData()
	arg_33_0.checkAward()
	arg_33_0.UpdateView()

def var_0_0.SwitchPage(arg_34_0, arg_34_1):
	arg_34_0.pageIndex = math.clamp(arg_34_0.pageIndex + arg_34_1, 1, #arg_34_0.pages)

	arg_34_0.UpdateView()

def var_0_0.checkAward(arg_35_0):
	if #arg_35_0.activeIDList == #arg_35_0.allIDList and arg_35_0.activityData.data1 != 1:
