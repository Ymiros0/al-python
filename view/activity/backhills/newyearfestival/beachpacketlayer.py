...
def var_0_0.initData(arg_5_0):
	...
	if var_5_1:
		for iter_5_0, iter_5_1 in ipairs(var_5_1):
			...
			if not arg_5_0.awardListMap[var_5_6]:
...
def var_0_0.addListener(arg_8_0):
	...
	onButton(arg_8_0, arg_8_0.homeBtn, function()
		arg_8_0.emit(var_0_0.ON_HOME), SFX_PANEL)
...
def var_0_0.updateActData(arg_12_0):
	...
	for iter_12_0, iter_12_1 in pairs(var_12_0.data2_list):
		if not table.contains(arg_12_0.gotIndexList, iter_12_1):
			table.insert(arg_12_0.gotIndexList, iter_12_1)

	arg_12_0.gotIDList = {}

	for iter_12_2, iter_12_3 in pairs(var_12_0.data1_list):
		if not table.contains(arg_12_0.gotIDList, iter_12_3):
			table.insert(arg_12_0.gotIDList, iter_12_3)

def var_0_0.updatePacketTpl(arg_13_0, arg_13_1, arg_13_2):
	...
	onButton(arg_13_0, arg_13_2, function()
		if not var_13_3 and arg_13_0.curCount > 0:
...
def var_0_0.updatePacketList(arg_15_0):
	for iter_15_0, iter_15_1 in ipairs(arg_15_0.packetTFList):
		arg_15_0.updatePacketTpl(iter_15_0, iter_15_1)

def var_0_0.updateAwardTpl(arg_16_0, arg_16_1, arg_16_2):
...
def var_0_0.updateAwardList(arg_18_0):
	for iter_18_0, iter_18_1 in ipairs(arg_18_0.awardTFList):
...
def var_0_0.playAni(arg_20_0, arg_20_1):
	arg_20_0.isPlaying = True

	setActive(arg_20_0.aniPanel, True)
	arg_20_0.aniSC.SetActionCallBack(None)
...
def var_0_0.isPacketIndexGot(arg_22_0, arg_22_1):
	return table.contains(arg_22_0.gotIndexList, arg_22_1)

def var_0_0.isAwardGot(arg_23_0, arg_23_1):
	return table.contains(arg_23_0.gotIDList, arg_23_1)

def var_0_0.getAwardCountByLevel(arg_24_0, arg_24_1):
	return #arg_24_0.getAwardListByLevel(arg_24_1)

def var_0_0.getAwardListByLevel(arg_25_0, arg_25_1):
	return arg_25_0.awardListMap[arg_25_1]

def var_0_0.onSubmitFinished(arg_26_0):
