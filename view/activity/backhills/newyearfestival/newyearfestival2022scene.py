...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.btnPlayFirework, function()
		...
		if not var_7_0 or not (#var_7_0 >= 4) or var_7_0[4] != SummerFeastScene.GetCurrentDay():
			return
...
def var_0_0.RegisterDataResponse(arg_12_0):
	...
	for iter_12_0, iter_12_1 in ipairs(var_12_0):
		arg_12_0.Respones.AddRawListener({
			...
			if not var_13_0 or IsNil(var_13_0.Find("level")):
				return
	...
	for iter_12_2, iter_12_3 in ipairs(var_12_1):
		arg_12_0.Respones.AddRawListener({
			...
			if not var_14_0 or IsNil(var_14_0.Find("tip")):
				return
...
def var_0_0.UpdateView(arg_17_0):
	...
	for iter_17_0, iter_17_1 in pairs(arg_17_0.Buildings):
...
def var_0_0.TryPlayStory(arg_19_0):
...
def var_0_0.PlayFirework(arg_22_0, arg_22_1):
	...
	arg_22_0.fireworkTimer = Timer.New(function()
		arg_22_0.loader.GetPrefab("ui/firework", "", function(arg_25_0)
			...
			arg_25_0.transform.localScale = Vector3(1.2, 1.2, 1.2), "Firework2"), 2)
	...
	arg_22_0.fireworkTimer2 = Timer.New(function()
		arg_22_0.loader.GetPrefab("ui/firework", "", function(arg_27_0)
			...
			arg_27_0.transform.localPosition = Vector2(-465, -90), "Firework3"), 3)

	arg_22_0.fireworkTimer2.Start()

def var_0_0.ClearEffectFirework(arg_28_0):
	arg_28_0.StopSE()
	arg_28_0.loader.ClearRequest("Firework")
	arg_28_0.loader.ClearRequest("Firework2")
	arg_28_0.loader.ClearRequest("Firework3")

	if arg_28_0.fireworkTimer:
		arg_28_0.fireworkTimer.Stop()

		arg_28_0.fireworkTimer = None

	if arg_28_0.fireworkTimer2:
		arg_28_0.fireworkTimer2.Stop()

		arg_28_0.fireworkTimer2 = None

def var_0_0.PlaySE(arg_29_0):
	if arg_29_0.SETimer:
		return
