...
def var_0_0.didEnter(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.btn_receive, function()
		...
		if var_11_0.ultimate != 0 or var_11_0.usedtime < var_11_0.getConfig("reward_need"):
			return
	...
	if arg_4_0.contextData.isOpenShrine:
		arg_4_0.contextData.isOpenShrine = None

		pg.m02.sendNotification(GAME.GO_MINI_GAME, 3)

	local var_4_1 = var_4_0.GetMiniGameData(3)

	if var_4_1 and not var_4_1.GetRuntimeData("isInited"):
...
def var_0_0.UpdateView(arg_17_0):
	...
	for iter_17_0, iter_17_1 in ipairs(arg_17_0.group_get):
...
def var_0_0.TryPlayStory(arg_18_0):
	return
