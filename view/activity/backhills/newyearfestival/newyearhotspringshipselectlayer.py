...
def var_0_0.SetActivity(arg_3_0, arg_3_1):
...
def var_0_0.UpdateSlots(arg_7_0):
...
def var_0_0.AddCard(arg_9_0, arg_9_1, arg_9_2, arg_9_3):
	local var_9_0

	if arg_9_2 == 0 and arg_9_3:
		...
		onButton(arg_9_0, var_9_1, function()
			arg_9_0.emit(NewYearHotSpringShipSelectMediator.OPEN_CHUANWU, arg_9_1, arg_9_3), SFX_PANEL)
		...
		if arg_9_3.state == Ship.STATE_REST or arg_9_3.state == Ship.STATE_TRAIN:
			if arg_9_3.state == Ship.STATE_TRAIN:
				var_9_4 = var_9_4 + Ship.BACKYARD_1F_ENERGY_ADDITION
			elif arg_9_3.state == Ship.STATE_REST:
				var_9_4 = var_9_4 + Ship.BACKYARD_2F_ENERGY_ADDITION

			for iter_9_0, iter_9_1 in ipairs(getProxy(ActivityProxy).getBackyardEnergyActivityBuffs()):
		...
		if arg_9_2 == 0:
			onButton(arg_9_0, var_9_6, function()
				arg_9_0.emit(NewYearHotSpringShipSelectMediator.OPEN_CHUANWU, arg_9_1), SFX_PANEL)
		elif arg_9_2 == 1:
			onButton(arg_9_0, var_9_6, function()
				arg_9_0.emit(NewYearHotSpringShipSelectMediator.EXTEND, arg_9_1), SFX_PANEL)
		elif arg_9_2 == 2:
			-- block empty

	setActive(var_9_0, True)

def var_0_0.CleanCards(arg_14_0):
