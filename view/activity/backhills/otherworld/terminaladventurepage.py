	...
	arg_5_0.awardUIList.make(function(arg_6_0, arg_6_1, arg_6_2)
		if arg_6_0 == UIItemList.EventUpdate:
			...
			onButton(arg_5_0.binder, arg_6_2.Find("IconTpl"), function()
				arg_5_0.emit(BaseUI.ON_DROP, var_6_3), SFX_PANEL)
...
def var_0_0.UpdatePt(arg_8_0, arg_8_1):
	arg_8_0.ptData = ActivityPtData.New(arg_8_1)

	arg_8_0.UpdatePtView()

def var_0_0.UpdatePtView(arg_9_0):
...
def var_0_0.InitTaskUI(arg_10_0):
