...
local function var_0_2(arg_1_0)
	...
	for iter_1_0 = arg_1_0[1], arg_1_0[2]:
		if var_0_0.config[iter_1_0]:
...
def var_0_0.OnInit(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.randomBtn, function()
		...
		arg_4_0.managedTween(LeanTween.delayedCall, function()
			...
			setActive(arg_4_0.randomGreyBtn, not arg_4_0.unlockRandom), var_0_0.RANDOM_CHANGE_TIME, None), SFX_PANEL)
	onButton(arg_4_0, arg_4_0.randomGreyBtn, function()
		pg.TipsMgr.GetInstance().ShowTips(i18n("personal_random_tip")), SFX_PANEL)
	...
	if arg_4_0.unlockRandom and arg_4_0.GetLocalName() != "":
...
def var_0_0.UpdateView(arg_9_0, arg_9_1):
	...
	if arg_9_0.contextData.upgrade:
		arg_9_0.upgradeCfg = {}

		for iter_9_2, iter_9_3 in ipairs(arg_9_0.activity.GetShowConfig()):
			arg_9_0.upgradeCfg[iter_9_3[1]] = iter_9_3[2]

		arg_9_0.PlayUpgradeAnims()

def var_0_0.SetDefaultName(arg_10_0):
	setInputText(arg_10_0.nameInput, arg_10_0.showName)

def var_0_0.UpdateInfo(arg_11_0, arg_11_1):
...
def var_0_0.UpdateProperty(arg_12_0, arg_12_1):
	local var_12_0 = 0

	for iter_12_0, iter_12_1 in ipairs(var_0_0.PROPERTY_IDS):
		var_12_0 = var_12_0 + 1
	...
	for iter_12_2 = 1, arg_12_0.propertyContent.childCount - 1:
		if var_12_0 < iter_12_2:
			setActive(arg_12_0.propertyContent.GetChild(iter_12_2 - 1), False)

def var_0_0.UpdateAbility(arg_13_0, arg_13_1):
	local var_13_0 = {}

	if arg_13_1:
		var_13_0 = arg_13_0.GetRandomAbilityIds()
	elif OtherworldMapScene.personalRandomData:
		for iter_13_0, iter_13_1 in pairs(OtherworldMapScene.personalRandomData):
			if table.contains(var_0_0.ABILITY_IDS, iter_13_0):
				table.insert(var_13_0, iter_13_0)
	else
		for iter_13_2, iter_13_3 in pairs(arg_13_0.showCfg):
			if table.contains(var_0_0.ABILITY_IDS, iter_13_2):
				table.insert(var_13_0, iter_13_2)

	table.sort(var_13_0)

	for iter_13_4, iter_13_5 in ipairs(var_13_0):
	...
	for iter_13_6 = 1, arg_13_0.abilityContent.childCount:
		if iter_13_6 > #var_13_0:
			setActive(arg_13_0.abilityContent.GetChild(iter_13_6 - 1), False)

def var_0_0.GetRollAttrInfoById(arg_14_0, arg_14_1, arg_14_2):
	local var_14_0 = ""

	if arg_14_2:
		local var_14_1 = var_0_0.config[arg_14_1].random_value

		if table.contains(var_0_0.PROPERTY_IDS, arg_14_1) or arg_14_1 == var_0_0.LV_ID:
		...
		if OtherworldMapScene.personalRandomData:
			var_14_0 = OtherworldMapScene.personalRandomData[arg_14_1]

	return var_0_0.config[arg_14_1].name, tostring(var_14_0)

def var_0_0.GetRandomAbilityIds(arg_15_0):
	local var_15_0 = {}

	for iter_15_0 = 1, #var_0_0.ABILITY_IDS:
	...
	for iter_15_1 = 1, var_0_0.RANDOM_ABILITY_CNT:
...
def var_0_0.PlayUpgradeAnims(arg_16_0):
	seriesAsync({
		function(arg_17_0)
		...
		arg_16_0.contextData.upgrade = None)

def var_0_0.GetStaticInfo(arg_21_0, arg_21_1):
...
def var_0_0.PlayLevelAnim(arg_22_0, arg_22_1):
	...
	if var_22_2:
		arg_22_0.managedTween(LeanTween.delayedCall, function()
			setActive(arg_22_0.lvUpgradeTF, False), var_0_0.UPGRADE_TAG_SHOW_TIME, None)
		arg_22_0.managedTween(LeanTween.value, None, go(arg_22_0.lvValue), var_22_0, var_22_1, var_0_0.LV_ANIM_TIME).setOnUpdate(System.Action_float(function(arg_24_0)
			setText(arg_22_0.lvValue, math.floor(arg_24_0)))).setOnComplete(System.Action(function()
			arg_22_1()))

		local var_22_3 = var_0_0.config[var_0_0.LV_ID].random_value[2]

		arg_22_0.managedTween(LeanTween.value, None, go(arg_22_0.lvSlider), var_22_0 / var_22_3, var_22_1 / var_22_3, var_0_0.LV_ANIM_TIME).setOnUpdate(System.Action_float(function(arg_26_0)
			setSlider(arg_22_0.lvSlider, 0, 1, arg_26_0)))
	else
		arg_22_1()

def var_0_0.PlayPropertyAnim(arg_27_0, arg_27_1):
	local var_27_0 = {}

	for iter_27_0 = 1, #var_0_0.PROPERTY_IDS:
		...
		if var_27_6:
			table.insert(var_27_0, function(arg_28_0)
				...
				arg_27_0.managedTween(LeanTween.delayedCall, function()
					setActive(arg_27_0.findTF("upgrade", var_27_2), False), var_0_0.UPGRADE_TAG_SHOW_TIME, None)
				arg_27_0.managedTween(LeanTween.value, None, go(var_27_2), var_27_4, var_27_5, var_0_0.PROPERTY_TPL_ANIM_TIME).setOnUpdate(System.Action_float(function(arg_30_0)
					setText(arg_27_0.findTF("value/Text", var_27_2), math.floor(arg_30_0)))).setOnComplete(System.Action(function()
					arg_28_0())))

	seriesAsync(var_27_0, function()
		arg_27_1())

def var_0_0.GetDynamicInfo(arg_33_0, arg_33_1):
	local var_33_0 = {}
	local var_33_1 = {}

	for iter_33_0, iter_33_1 in pairs(arg_33_0.showCfg):
		if table.contains(var_0_0.ABILITY_IDS, iter_33_0):
			table.insert(var_33_0, iter_33_0)

	table.sort(var_33_0)

	for iter_33_2, iter_33_3 in pairs(arg_33_0.upgradeCfg):
		if table.contains(var_0_0.ABILITY_IDS, iter_33_2):
...
def var_0_0.PlayAbilityAnim(arg_35_0, arg_35_1):
	...
	if var_35_2:
		...
		for iter_35_0 = 1, #var_35_1:
			...
			if var_35_0[iter_35_0] != var_35_5:
				if not var_35_4:
					table.insert(var_35_3, function(arg_36_0)
						arg_35_0.managedTween(LeanTween.value, None, go(var_35_6), 1, 0, var_0_0.ABILITY_TPL_ANIM_TIME).setEase(LeanTweenType.easeInBack).setOnUpdate(System.Action_float(function(arg_37_0)
							GetOrAddComponent(var_35_6, typeof(CanvasGroup)).alpha = arg_37_0)).setOnComplete(System.Action(function()
				...
				table.insert(var_35_3, function(arg_39_0)
					...
					arg_35_0.managedTween(LeanTween.value, None, go(var_35_6), 0, 1, var_0_0.ABILITY_TPL_ANIM_TIME).setEase(LeanTweenType.easeOutBack).setOnUpdate(System.Action_float(function(arg_40_0)
						GetOrAddComponent(var_35_6, typeof(CanvasGroup)).alpha = arg_40_0)).setOnComplete(System.Action(function()
						arg_39_0())))
...
def var_0_0.GetLocalName(arg_43_0):
	if not arg_43_0.unlockRandom:
		return ""

	return PlayerPrefs.GetString(var_0_1 .. arg_43_0.playerId)

def var_0_0.SetLocalName(arg_44_0, arg_44_1):
	if not arg_44_0.unlockRandom:
		return
