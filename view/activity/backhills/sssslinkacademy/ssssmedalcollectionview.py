...
def var_0_0.AddListener(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.infoArea1, function()
		...
		if not table.contains(arg_5_0.activeIDList, var_8_1) and table.contains(arg_5_0.activatableIDList, var_8_1):
	...
	onButton(arg_5_0, arg_5_0.infoArea2, function()
		...
		if not table.contains(arg_5_0.activeIDList, var_9_1) and table.contains(arg_5_0.activatableIDList, var_9_1):
			arg_5_0.emit(MedalCollectionTemplateMediator.MEMORYBOOK_UNLOCK, {
				id = var_9_1,
				actId = arg_5_0.activityData.id
			}), SFX_PANEL)
	...
	for iter_5_0 = 1, 6:
		onButton(arg_5_0, arg_5_0._tf.Find("Desk/Slot" .. iter_5_0 .. "/Click"), function()
			...
			arg_5_0.UpdateView(), SFX_PANEL)

def var_0_0.UpdateAfterSubmit(arg_11_0, arg_11_1):
...
def var_0_0.UpdateAfterFinalMedal(arg_12_0):
...
def var_0_0.UpdateView(arg_13_0):
	for iter_13_0 = 1, 6:
		...
		_.each({
			...
			if table.contains(arg_13_0.activeIDList, arg_14_0):
				var_13_0 = var_13_0 + 1
			elif table.contains(arg_13_0.activatableIDList, arg_14_0):
				var_13_1 = True)
...
def var_0_0.UpdateInfo(arg_15_0):
