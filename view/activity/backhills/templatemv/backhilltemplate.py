...
def var_0_0.InitStudents(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
	local var_7_0 = var_0_0.getStudents(arg_7_1, arg_7_2, arg_7_3)
	local var_7_1 = {}

	for iter_7_0, iter_7_1 in pairs(arg_7_0.graphPath.points):
		if not iter_7_1.outRandom:
	...
	for iter_7_2, iter_7_3 in pairs(var_7_0):
		if not arg_7_0.academyStudents[iter_7_2]:
	...
	if #var_7_0 > 0:
		arg_7_0.sortTimer = Timer.New(function()
			arg_7_0.sortStudents(), 0.2, -1)

		arg_7_0.sortTimer.Start()
		arg_7_0.sortTimer.func()

def var_0_0.ChooseRandomPos(arg_10_0, arg_10_1):
...
def var_0_0.sortStudents(arg_11_0):
	...
	for iter_11_0, iter_11_1 in pairs(var_11_0):
		if iter_11_1.childCount > 1:
			local var_11_1 = {}

			for iter_11_2 = 1, iter_11_1.childCount:
			...
			table.sort(var_11_1, function(arg_12_0, arg_12_1)
				...
				if math.abs(var_12_0) < 1:
					return arg_12_0.index < arg_12_1.index
				else
					return var_12_0 > 0)

			for iter_11_3, iter_11_4 in ipairs(var_11_1):
				iter_11_4.tf.SetSiblingIndex(iter_11_3 - 1)

def var_0_0.clearStudents(arg_13_0):
	if arg_13_0.sortTimer:
		arg_13_0.sortTimer.Stop()

		arg_13_0.sortTimer = None

	if arg_13_0.academyStudents:
		for iter_13_0, iter_13_1 in pairs(arg_13_0.academyStudents):
			iter_13_1.detach()
			Destroy(iter_13_1._go)

		table.clear(arg_13_0.academyStudents)

def var_0_0.AutoFitScreen(arg_14_0):
...
def var_0_0.IsMiniActNeedTip(arg_15_0):
...
def var_0_0.UpdateActivity(arg_16_0, arg_16_1):
	return

def var_0_0.BindItemActivityShop(arg_17_0):
...
def var_0_0.BindItemSkinShop(arg_19_0):
...
def var_0_0.BindItemBuildShip(arg_21_0):
	arg_21_0.InitFacilityCross(arg_21_0._map, arg_21_0._upper, "xianshijianzao", function()
		...
		if var_22_1 and not var_22_1.isEnd():
			var_22_0 = BuildShipScene.PROJECTS.ACTIVITY
		elif var_22_2 and not var_22_2.isEnd():
			var_22_0 = ({
...
def var_0_0.BindItemBattle(arg_23_0):
...
def var_0_0.UpdateBuildingTip(arg_25_0, arg_25_1, arg_25_2):
	if not arg_25_1:
		return False
	...
	if not var_25_1 or var_25_0 >= #var_25_1.buff:
		return False
	...
	return _.all(var_25_2, function(arg_26_0)
		...
		elif var_26_0 > DROP_TYPE_USE_ACTIVITY_DROP:
