...
def var_0_0.UpdateActivity(arg_1_0, arg_1_1):
...
def var_0_0.UpdateAfterSubmit(arg_3_0, arg_3_1):
	arg_3_0.CheckAward()

def var_0_0.UpdateAfterFinalMedal(arg_4_0):
	return

def var_0_0.CheckAward(arg_5_0):
	if #arg_5_0.activeIDList == #arg_5_0.allIDList and arg_5_0.activityData.data1 != 1:
