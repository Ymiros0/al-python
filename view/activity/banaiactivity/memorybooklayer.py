...
local function var_0_6(arg_1_0)
	...
	function var_1_0.Clear(arg_5_0, arg_5_1)
		arg_5_1.GetComponent(typeof(Image)).sprite = None
...
def var_0_0.setActivity(arg_9_0, arg_9_1):
...
def var_0_0.getMemoryState(arg_10_0, arg_10_1):
...
def var_0_0.updateMemorys(arg_11_0):
	arg_11_0.memorys = {}

	for iter_11_0, iter_11_1 in ipairs(arg_11_0.targetItems):
...
def var_0_0.didEnter(arg_13_0):
	...
	onButton(arg_13_0, arg_13_0.backBtn, function()
		arg_13_0.emit(var_0_0.ON_CLOSE), SOUND_BACK)
	...
	onButton(arg_13_0, arg_13_0.page1.Find("switch"), function()
		arg_13_0.updateMemoryBook(var_0_0.PAGE_TWO), SFX_PANEL)
	onButton(arg_13_0, arg_13_0.page2.Find("switch"), function()
		arg_13_0.updateMemoryBook(var_0_0.PAGE_ONE), SFX_PANEL)
...
def var_0_0.getStartAndEndIndex(arg_18_0, arg_18_1):
	local var_18_0 = (arg_18_1 - 1) * var_0_4 + 1
	local var_18_1 = var_18_0 + var_0_4 - 1

	return var_18_0, var_18_1

def var_0_0.updateMemoryBook(arg_19_0, arg_19_1, arg_19_2):
	for iter_19_0, iter_19_1 in ipairs(arg_19_0.gameObjects):
	...
	for iter_19_2 = var_19_1, var_19_2:
	...
	if arg_19_1 == var_0_0.PAGE_ONE:
		var_19_4 = arg_19_0.updatePageTip(var_0_0.PAGE_TWO)
	elif arg_19_1 == var_0_0.PAGE_TWO:
...
def var_0_0.addRingDragListenter(arg_22_0):
	...
	var_22_0.AddDragEndFunc(function(arg_25_0, arg_25_1)
		if var_22_1 < -50:
			if arg_22_0.page == var_0_0.PAGE_ONE:
				arg_22_0.updateMemoryBook(var_0_0.PAGE_TWO)
		elif var_22_1 > 50 and arg_22_0.page == var_0_0.PAGE_TWO:
			arg_22_0.updateMemoryBook(var_0_0.PAGE_ONE))

def var_0_0.updatePageTip(arg_26_0, arg_26_1):
...
def var_0_0.updateMemoryItem(arg_28_0, arg_28_1, arg_28_2):
	...
	if var_28_0 == var_0_1:
		-- block empty
	elif var_28_0 == var_0_2:
		local var_28_3 = var_28_2()

		onButton(arg_28_0, var_28_3, function()
			arg_28_0.emit(MemoryBookMediator.ON_UNLOCK, arg_28_2.id, arg_28_0.activity.id), SFX_PANEL)
	elif var_28_0 == var_0_3:
		var_28_2()

def var_0_0.GetMemorySprite(arg_31_0, arg_31_1, arg_31_2):
	local var_31_0 = arg_31_1 .. "_" .. arg_31_2

	if arg_31_0.sprites[var_31_0]:
...
def var_0_0.updateProgress(arg_32_0):
...
def var_0_0.updateAward(arg_33_0, arg_33_1):
	if not arg_33_0.isInitAward:
		arg_33_0.isInitAward = True

		local var_33_0 = arg_33_0.awardVO[1]
		local var_33_1 = arg_33_0.awardVO[2]

		if var_33_0 == DROP_TYPE_FURNITURE:
	...
	if LeanTween.isTweening(go(arg_33_0.awardLabel)):
		LeanTween.cancel(go(arg_33_0.awardLabel))

	if arg_33_1 and not var_33_3:
		blinkAni(arg_33_0.awardLabel, 0.8, None, 0.5)
...
def var_0_0.willExit(arg_36_0):
	...
	arg_36_0.sprites = None
	arg_36_0.getSprite = None
