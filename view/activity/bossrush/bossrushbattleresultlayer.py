...
def var_0_0.GetAtalsName(arg_3_0):
...
def var_0_0.didEnter(arg_6_0):
	...
	for iter_6_0 = 1, #var_6_4:
		...
		if var_6_0.GetMode() == BossRushSeriesData.MODE.SINGLE:
			var_6_10 = var_6_3[1]
	...
	local function var_6_19(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
		UIItemList.StaticAlign(arg_14_0, arg_14_0.GetChild(0), #arg_14_1, function(arg_15_0, arg_15_1, arg_15_2)
			...
			if var_15_1.level < var_15_0.level:
				local var_15_11 = 0

				for iter_15_0 = var_15_1.level, var_15_0.level - 1:
	...
	local function var_6_20(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4)
		...
		if not arg_17_4:
			...
			for iter_17_0, iter_17_1 in pairs(arg_17_2):
	...
	local function var_6_21(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
		...
		if arg_20_2:
			...
			if arg_20_2._scoreMark == ys.Battle.BattleConst.DEAD_FLAG:
	...
	onButton(arg_6_0, arg_6_0.rightBottomPanel.Find("confirmBtn"), function()
		arg_6_0.emit(BossRushBattleResultMediator.ON_SETTLE), SFX_PANEL)
	...
	if arg_6_0.resultScroll.rect.width >= arg_6_0.resultList.rect.width:
...
def var_0_0.HideConfirmPanel(arg_35_0):
	setActive(arg_35_0.rightBottomPanel.Find("confirmBtn"), False)

def var_0_0.onBackPressed(arg_36_0):
