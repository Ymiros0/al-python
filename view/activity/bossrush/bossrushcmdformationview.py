...
def var_0_0.init(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0._tf.Find("bg"), function()
		arg_2_0.onBackPressed(), SFX_PANEL)
...
def var_0_0.setCallback(arg_9_0, arg_9_1):
	arg_9_0.callback = arg_9_1

def var_0_0.updateFleet(arg_10_0, arg_10_1):
	arg_10_0.fleet = arg_10_1

	arg_10_0.updateDesc()
	arg_10_0.updateRecordFleet()

def var_0_0.setCommanderPrefabs(arg_11_0, arg_11_1):
	arg_11_0.prefabFleets = arg_11_1

	arg_11_0.updateRecordPanel()

def var_0_0.updateRecordFleet(arg_12_0):
	local var_12_0 = arg_12_0.fleet.getCommanders()

	for iter_12_0, iter_12_1 in ipairs(arg_12_0.recordCommanders):
...
def var_0_0.updateRecordPanel(arg_13_0):
...
def var_0_0.UpdatePrefabFleet(arg_15_0, arg_15_1, arg_15_2, arg_15_3):
	...
	onButton(arg_15_0, arg_15_2.Find("use_btn"), function()
		...
		arg_15_0.CloseRecordPanel(), SFX_PANEL)
...
def var_0_0.updateDesc(arg_20_0):
	local var_20_0 = arg_20_0.fleet.getCommanders()

	for iter_20_0 = 1, CommanderConst.MAX_FORMATION_POS:
...
def var_0_0.updateAdditions(arg_21_0):
...
def var_0_0.updateSkillTF(arg_24_0, arg_24_1, arg_24_2):
...
def var_0_0.updateCommander(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4):
...
def var_0_0.OpenRecordPanel(arg_29_0):
