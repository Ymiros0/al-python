...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0._tf.Find("Confirm"), function()
		arg_3_0.emit(BossRushBattleResultMediator.ON_SETTLE), SFX_PANEL)
	...
	_.each(_.range(#var_3_2), function(arg_5_0)
		...
		local var_5_5 = (function()
			...
			local var_6_1 = (function()
				...
				return var_6_0.newShips[1] and var_6_0.newShips[1].id or None)()
			...
			return var_6_2.getPainting())() or "changdao"
...
def var_0_0.shareEx(arg_8_0):
	return

def var_0_0.setPainting(arg_9_0, arg_9_1, arg_9_2, arg_9_3):
	setPaintingPrefabAsync(arg_9_1, arg_9_2, "biandui", arg_9_3)

def var_0_0.retPainting(arg_10_0, arg_10_1, arg_10_2):
...
def var_0_0.willExit(arg_12_0):
	...
	if arg_12_0.retPaintings and #arg_12_0.retPaintings > 0:
		for iter_12_0, iter_12_1 in ipairs(arg_12_0.retPaintings):
			arg_12_0.retPainting(iter_12_1[1], iter_12_1[2])

def var_0_0.loadUI(arg_13_0):
