...
def var_0_0.InitUI(arg_3_0):
	...
	table.Foreach(arg_3_0.fleetIndexToggles, function(arg_5_0, arg_5_1)
		if arg_5_0 >= #arg_3_0.fleetIndexToggles:
...
def var_0_0.didEnter(arg_6_0):
	...
	onButton(arg_6_0, arg_6_0.btnGo, function()
		for iter_7_0 = 1, #arg_6_0.contextData.fleets - 1:
			if arg_6_0.contextData.fleets[iter_7_0].isLegalToFight() != True:
		...
		arg_6_0.emit(BossRushFleetSelectMediator.ON_PRECOMBAT), SFX_UI_WEIGHANCHOR_GO)
	...
	onButton(arg_6_0, arg_6_0.btnBack, function()
		arg_6_0.onCancelHard(), SFX_CANCEL)
		...
		table.Foreach(arg_6_0.modeToggles, function(arg_13_0, arg_13_1)
			onToggle(arg_6_0, arg_13_1, function(arg_14_0)
				...
				table.Foreach(arg_6_0.fleetIndexToggles, function(arg_15_0, arg_15_1)
					triggerToggle(arg_15_1, arg_15_0 == arg_6_0.contextData.fleetIndex)), SFX_PANEL))
	...
	for iter_6_0 = #arg_6_0.fleetIndexToggles - 1, var_6_2, -1:
	...
	if not var_6_10:
		...
		UIItemList.StaticAlign(var_6_11, var_6_11.GetChild(0), #var_6_12, function(arg_25_0, arg_25_1, arg_25_2)
			...
			onButton(arg_6_0, arg_25_2, function()
				arg_6_0.ShowDropDetail(var_25_1), SFX_PANEL))
		...
		UIItemList.StaticAlign(var_6_13, var_6_13.GetChild(0), #var_6_14, function(arg_27_0, arg_27_1, arg_27_2)
			...
			onButton(arg_6_0, arg_27_2, function()
				arg_6_0.ShowDropDetail(var_27_1), SFX_PANEL))
	else
	...
	pg.UIMgr.GetInstance().BlurPanel(arg_6_0._tf, None, {})

local var_0_2 = {
	[99] = True
}

def var_0_0.ShowDropDetail(arg_29_0, arg_29_1):
	local var_29_0 = Item.getConfigData(arg_29_1.id)

	if var_29_0 and var_0_2[var_29_0.type]:
		local var_29_1 = var_29_0.display_icon
		local var_29_2 = {}

		for iter_29_0, iter_29_1 in ipairs(var_29_1):
...
def var_0_0.onCancelHard(arg_31_0):
...
def var_0_0.setHardShipVOs(arg_33_0, arg_33_1):
	arg_33_0.shipVOs = arg_33_1

def var_0_0.initAddButton(arg_34_0, arg_34_1, arg_34_2, arg_34_3):
	...
	for iter_34_0, iter_34_1 in ipairs(var_34_0):
		...
		if arg_34_2 == arg_34_0.shipVOs[iter_34_1].getTeamType():
	...
	UIItemList.StaticAlign(var_34_4, var_34_4.GetChild(0), 3, function(arg_37_0, arg_37_1, arg_37_2)
		...
		local var_37_0 = var_34_2[arg_37_1] and arg_34_0.shipVOs[var_34_2[arg_37_1]] or None
...
def var_0_0.updateEliteFleets(arg_40_0):
	...
	local var_40_16 = (function(arg_48_0)
		if type(arg_48_0) != "table":
			return {}

		return arg_48_0)(var_40_0.GetAdditionalAwards())
...
def var_0_0.initCommander(arg_50_0, arg_50_1, arg_50_2):
	...
	for iter_50_0 = 1, 2:
		...
		onButton(arg_50_0, var_50_4, function()
			arg_50_0.emit(BossRushFleetSelectMediator.OPEN_COMMANDER_PANEL, arg_50_1), SFX_PANEL)
