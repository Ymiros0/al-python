...
def var_0_0.bindEvent(arg_2_0):
	...
	arg_2_0.bind(var_0_0.REMOVE_SHIP, function(arg_7_0, arg_7_1, arg_7_2)
		(function(arg_8_0, arg_8_1)
			if not arg_8_0.canRemove(arg_8_1):
	...
	arg_2_0.bind(var_0_0.ON_START, function(arg_15_0, arg_15_1)
		...
		seriesAsync({
			function(arg_16_0)
				for iter_16_0 = 1, #arg_2_0.contextData.fleets - 1:
					if arg_2_0.contextData.fleets[iter_16_0].isLegalToFight() != True:
			...
			function(arg_19_0)
				table.SerialIpairsAsync(arg_2_0.contextData.fleets, function(arg_20_0, arg_20_1, arg_20_2)
					...
					if _.any(arg_20_1.getShipIds(), function(arg_21_0)
						...
						local var_21_1, var_21_2 = ShipStatus.ShipStatusCheck("inActivity", var_21_0, None, {
							inActivity = var_20_2
						})
					...
					arg_20_2(), arg_19_0),
			function(arg_22_0)
				if arg_2_0.contextData.mode == BossRushSeriesData.MODE.SINGLE:
					...
					table.SerialIpairsAsync(arg_2_0.contextData.fleets, function(arg_25_0, arg_25_1, arg_25_2)
						Fleet.EnergyCheck(_.map(_.values(arg_25_1.ships), function(arg_26_0)
							return getProxy(BayProxy).getShipById(arg_26_0)), Fleet.DEFAULT_NAME[arg_25_0], function(arg_27_0)
							if arg_27_0:
								arg_25_2()), arg_22_0),
			function(arg_28_0)
	...
	arg_2_0.bind(var_0_0.SHOW_CONTINUOUS_OPERATION_WINDOW, function(arg_30_0)
		...
		local function var_30_5()
			...
			if var_30_4 == BossRushSeriesData.MODE.SINGLE:
...
def var_0_0.onAutoBtn(arg_35_0, arg_35_1):
...
def var_0_0.onAutoSubBtn(arg_36_0, arg_36_1):
...
def var_0_0.changeFleet(arg_37_0, arg_37_1):
...
def var_0_0.refreshEdit(arg_38_0, arg_38_1):
...
def var_0_0.commitEdit(arg_39_0):
...
def var_0_0.listNotificationInterests(arg_42_0):
	return {
