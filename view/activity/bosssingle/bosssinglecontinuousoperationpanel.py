...
def var_0_0.UpdateAutoFightMark(arg_3_0):
...
def var_0_0.didEnter(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.btnOn, function()
		...
		arg_4_0.emit(BattleMediator.HIDE_ALL_BUTTONS, True), SFX_PANEL)
	onButton(arg_4_0, arg_4_0.btnOff, function()
		...
		arg_4_0.emit(BattleMediator.HIDE_ALL_BUTTONS, False), SFX_PANEL)
...
def var_0_0.UpdateBattleTimes(arg_7_0):
...
def var_0_0.OnEnterBattleResult(arg_8_0):
	setActive(arg_8_0.btnOff.Find("small"), False)
	setActive(arg_8_0.btnOff.Find("common"), True)

def var_0_0.AnimatingSlider(arg_9_0):
	setActive(arg_9_0.slider, True)
	arg_9_0.managedTween(LeanTween.value, function()
		arg_9_0.emit(BossSingleContinuousOperationMediator.ON_REENTER), go(arg_9_0.slider), 1, 0, 5).setOnUpdate(System.Action_float(function(arg_11_0)
