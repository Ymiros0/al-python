...
def var_0_0.BindBattleEvents(arg_2_0):
	...
	arg_2_0.bind(var_0_0.ON_PRECOMBAT, function(arg_6_0, arg_6_1)
		...
		if var_6_0[arg_6_1].isLegalToFight() != True:
		...
		if _.any(var_6_1, function(arg_7_0)
			...
			return _.any(arg_7_0.getShipIds(), function(arg_8_0)
				...
				local var_8_1, var_8_2 = ShipStatus.ShipStatusCheck("inActivity", var_8_0, None, {
					inActivity = var_6_2
				})
	...
	arg_2_0.bind(var_0_0.ON_SELECT_COMMANDER, function(arg_17_0, arg_17_1, arg_17_2)
		...
		arg_2_0.sendNotification(GAME.GO_SCENE, SCENE.COMMANDERCAT, {
			...
			ignoredIds = {},
			def onCommander:(arg_18_0)
				return True,
			def onSelected:(arg_19_0, arg_19_1)
				local var_19_0 = arg_19_0[1]
				local var_19_1 = getProxy(CommanderProxy).getCommanderById(var_19_0)

				for iter_19_0, iter_19_1 in pairs(var_17_0):
					if iter_19_0 == arg_17_1:
						for iter_19_2, iter_19_3 in pairs(var_17_2):
							if iter_19_3.groupId == var_19_1.groupId and iter_19_2 != arg_17_2:
								pg.TipsMgr.GetInstance().ShowTips(i18n("commander_can_not_select_same_group"))

								return
					elif iter_19_0 == var_0_0.GetPairedFleetIndex(arg_17_1):
						local var_19_2 = iter_19_1.getCommanders()

						for iter_19_4, iter_19_5 in pairs(var_19_2):
							if var_19_0 == iter_19_5.id:
				...
				arg_19_1(),
			def onQuit:(arg_20_0)
				var_17_1.updateCommanderByPos(arg_17_2, None)
				var_2_0.updateActivityFleet(arg_2_0.contextData.activityID, arg_17_1, var_17_1)
				arg_20_0()
		}))
...
def var_0_0.getDockCallbackFuncs4ActicityFleet(arg_27_0, arg_27_1, arg_27_2):
	...
	local function var_27_4(arg_28_0, arg_28_1)
		...
		if arg_27_0 and arg_27_0.isSameKind(arg_28_0):
			return True

		for iter_28_0, iter_28_1 in ipairs(var_27_3.ships or {}):
			if arg_28_0.isSameKind(var_27_0.getShipById(iter_28_1)):
	...
	local function var_27_6(arg_30_0)
		...
		if #arg_30_0 > 0:
			...
			if not var_27_3.containShip(var_30_0):
				var_27_3.insertShip(var_30_0, None, arg_27_2)
			elif arg_27_0:
				var_27_3.insertShip(arg_27_0, None, arg_27_2)
