...
def var_0_0.InitData(arg_4_0):
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.activity.getConfig("config_data")[3]):
	...
	for iter_4_2 = 1, var_0_0.ROOM_NUM:
		table.insert(arg_4_0.map2Story, {})

	for iter_4_3 = 1, #arg_4_0.storyGroup:
	...
	if arg_4_0.activity.data1 != None and arg_4_0.activity.data1 != 0:
		for iter_4_4 = 1, #arg_4_0.storyGroup:
			...
			if arg_4_0.storyGroup[iter_4_4] == arg_4_0.activity.data1:
				break
...
def var_0_0.InitCharacter(arg_7_0):
...
def var_0_0.didEnter(arg_9_0):
	for iter_9_0 = 1, var_0_0.ROOM_NUM:
		...
		onButton(arg_9_0, var_9_0, function()
			for iter_10_0, iter_10_1 in ipairs(arg_9_0.map2Story[iter_9_0]):
				if table.contains(arg_9_0.explorableStories, iter_10_1):
					arg_9_0.PlayStory(iter_10_1)

					break, SFX_PANEL)

	if table.contains(arg_9_0.explorableStories, arg_9_0.storyGroup[15]) or table.contains(arg_9_0.exploredStories, arg_9_0.storyGroup[15]):
		local var_9_3

		for iter_9_1 = #arg_9_0.exploredStories, 1, -1:
			if not arg_9_0.IsBadEnd(arg_9_0.exploredStories[iter_9_1]):
	...
	if var_9_6 and not arg_9_0.IsPlayed(var_9_6):
...
def var_0_0.InitButton(arg_13_0):
	onButton(arg_13_0, arg_13_0.button1F, function()
		...
		setActive(arg_13_0.floors[1], False), var_0_0.WALK_SE)
	onButton(arg_13_0, arg_13_0.button2F, function()
		...
		setActive(arg_13_0.floors[2], False), var_0_0.WALK_SE)
	...
	onButton(arg_13_0, arg_13_0.buttonAward, function()
		...
		arg_13_0.ExplorableEffect(False), SFX_PANEL)
	onButton(arg_13_0, arg_13_0.buttonAwardGet, function()
		local var_19_0 = underscore(arg_13_0.taskGroup).chain().map(function(arg_20_0)
			return arg_13_0.taskProxy.getTaskVO(arg_20_0)).filter(function(arg_21_0)
			return arg_21_0.getTaskStatus() == 1).value()

		if #var_19_0 > 0:
			arg_13_0.emit(CastleMainMediator.ON_TASK_SUBMIT, var_19_0), SFX_PANEL)
	onButton(arg_13_0, arg_13_0.awardWindowBg, function()
		setActive(arg_13_0.awardWindow, False)
		arg_13_0.ExplorableEffect(True), SFX_CANCEL)
	onButton(arg_13_0, arg_13_0.buttonCharacter, function()
		arg_13_0.UpdateCard()
		setActive(arg_13_0.characterWindow, True)
		pg.UIMgr.GetInstance().BlurPanel(arg_13_0.characterCard), SFX_PANEL)
	onButton(arg_13_0, arg_13_0.characterWindowBg, function()
		...
		arg_13_0.CheckGuide(), SFX_CANCEL)
	onButton(arg_13_0, arg_13_0.buttonRandom, function()
		if arg_13_0.IsFinish():
			if #getInputText(arg_13_0.nameInput) == 0:
				pg.TipsMgr.GetInstance().ShowTips(i18n("roll_noname"))
			else
				arg_13_0.RollCharacterCard(), SFX_CANCEL)
	onButton(arg_13_0, arg_13_0.buttonDice, function()
		if arg_13_0.diceCount < 1:
			if table.contains(arg_13_0.explorableStories, arg_13_0.storyGroup[23]) or table.contains(arg_13_0.explorableStories, arg_13_0.storyGroup[24]):
				pg.TipsMgr.GetInstance().ShowTips(i18n("roll_ending_tip1"))
			elif table.contains(arg_13_0.exploredStories, arg_13_0.storyGroup[23]) and table.contains(arg_13_0.exploredStories, arg_13_0.storyGroup[24]):
		...
		if arg_13_0.IndexofStory(arg_13_0.explorablePos) > arg_13_0.IndexofStory(arg_13_0.currentPos):
	...
	onButton(arg_13_0, arg_13_0.buttonDiceContinue, function()
		...
		arg_13_0.UpdateFlush()
		arg_13_0.CheckGuide()
		arg_13_0.ExplorableEffect(True), SFX_PANEL)

def var_0_0.UpdateFlush(arg_28_0):
	...
	if arg_28_0.IndexofStory(arg_28_0.explorablePos) == 15 and arg_28_0.IndexofStory(arg_28_0.explorablePos) > arg_28_0.IndexofStory(arg_28_0.currentPos):
		setActive(arg_28_0.button1F, True)

	setActive(arg_28_0.buttonDice, not arg_28_0.IsFinish())

def var_0_0.UpdateDice(arg_29_0):
	arg_29_0.diceCount = arg_29_0.activity.data2

	if table.contains(arg_29_0.explorableStories, arg_29_0.explorablePos) and arg_29_0.IsBadEnd(arg_29_0.explorablePos):
		arg_29_0.diceCount = arg_29_0.diceCount - 1

	setText(arg_29_0.diceRes, i18n("roll_times_left", arg_29_0.diceCount))

	if arg_29_0.explorablePos == arg_29_0.currentPos and arg_29_0.diceCount > 0:
...
def var_0_0.UpdateMap(arg_30_0):
	for iter_30_0 = 1, var_0_0.ROOM_NUM:
		arg_30_0.ChangeRoomColor(iter_30_0, var_0_0.TRANSPARENT_COLOR)
		arg_30_0.ChangeRoomMark(iter_30_0, None)

	for iter_30_1, iter_30_2 in ipairs(arg_30_0.exploredStories):
	...
	if arg_30_0.IsFinish():
		setActive(findTF(arg_30_0.main, "finish_mask"), True)

		return

	for iter_30_3, iter_30_4 in ipairs(arg_30_0.exploredStories):
		local var_30_2 = arg_30_0.story2Map[iter_30_4]

		if arg_30_0.IsBadEnd(iter_30_4):
			if var_30_2 != 17:
				if var_30_2 != 4:
	...
	for iter_30_5, iter_30_6 in ipairs(arg_30_0.explorableStories):
	...
	if #arg_30_0.exploredStories > 0:
		local var_30_4

		for iter_30_7, iter_30_8 in ipairs(arg_30_0.storyGroup):
			if not arg_30_0.IsBadEnd(iter_30_8) and table.contains(arg_30_0.exploredStories, iter_30_8):
				var_30_4 = iter_30_8
...
def var_0_0.UpdateAward(arg_31_0):
	...
	if not arg_31_0.IsPlayed(var_31_0) and getProxy(TaskProxy).isReceiveTasks(arg_31_0.taskGroup):
		playStory(var_31_0)

def var_0_0.UpdateCharacter(arg_33_0):
...
def var_0_0.UpdateTask(arg_34_0, arg_34_1, arg_34_2):
	...
	onButton(arg_34_0, var_34_1, function()
		arg_34_0.emit(BaseUI.ON_DROP, var_34_5), SFX_PANEL)
...
def var_0_0.UpdateAttrLock(arg_36_0):
	arg_36_0.attrLock = {}

	for iter_36_0, iter_36_1 in ipairs(arg_36_0.exploredStories):
		if arg_36_0.story2Attr[iter_36_1] != None:
			for iter_36_2, iter_36_3 in ipairs(arg_36_0.story2Attr[iter_36_1]):
				table.insert(arg_36_0.attrLock, iter_36_3)

def var_0_0.UpdateCard(arg_37_0):
	...
	for iter_37_0 = 1, arg_37_0.attrGroup.childCount:
		local var_37_0 = arg_37_0.attrGroup.GetChild(iter_37_0 - 1)

		for iter_37_1 = 1, var_37_0.childCount:
	...
	for iter_37_2 = 1, arg_37_0.skillGroup.childCount:
		local var_37_3 = arg_37_0.skillGroup.GetChild(iter_37_2 - 1)

		for iter_37_3 = 1, var_37_3.childCount:
...
def var_0_0.RollCharacterCard(arg_38_0):
	for iter_38_0 = 1, arg_38_0.attrGroup.childCount:
		local var_38_0 = arg_38_0.attrGroup.GetChild(iter_38_0 - 1)

		for iter_38_1 = 1, var_38_0.childCount:
	...
	for iter_38_2 = 1, arg_38_0.skillGroup.childCount:
		local var_38_6 = arg_38_0.skillGroup.GetChild(iter_38_2 - 1)

		for iter_38_3 = 1, var_38_6.childCount:
...
def var_0_0.IsFinish(arg_39_0):
	return #arg_39_0.exploredStories == 24

def var_0_0.GetRandomValue(arg_40_0, arg_40_1):
	local var_40_0 = {}

	for iter_40_0 = 1, #arg_40_0:
	...
	for iter_40_1 = 1, arg_40_1:
		table.insert(var_40_1, arg_40_0[var_40_0[iter_40_1]])

	return var_40_1

def var_0_0.GetColorValue(arg_41_0, arg_41_1):
...
def var_0_0.CheckAwardGet(arg_42_0):
	local var_42_0 = False

	for iter_42_0, iter_42_1 in ipairs(arg_42_0.taskGroup):
		if arg_42_0.taskProxy.getTaskVO(iter_42_1).getTaskStatus() == 1:
			var_42_0 = True

	setActive(arg_42_0.buttonAwardGet, var_42_0)
	setActive(findTF(arg_42_0.buttonAward, "red"), var_42_0)

def var_0_0.PlayStory(arg_43_0, arg_43_1):
	if arg_43_0.IsPlayed(arg_43_1):
		return
...
def var_0_0.StoryActEnd(arg_44_0, arg_44_1):
	if not arg_44_0.waitPlayStory:
		return

	local var_44_0, var_44_1 = arg_44_0.storyMgr.StoryId2StoryName(arg_44_0.waitPlayStory)

	local function var_44_2()
		if arg_44_0.story2Attr[arg_44_0.waitPlayStory] == None:
			return False

		local var_45_0 = 0

		for iter_45_0, iter_45_1 in ipairs(arg_44_0.story2Attr[arg_44_0.waitPlayStory]):
			if not table.contains(arg_44_0.attrLock, iter_45_1):
				var_45_0 = var_45_0 + 1
	...
	playStory(var_44_0, function()
		if var_44_2():
			...
			for iter_46_0, iter_46_1 in ipairs(arg_44_0.story2Attr[arg_44_0.waitPlayStory]):
				if iter_46_1 < 11:
...
def var_0_0.FirstStory(arg_47_0):
...
def var_0_0.RollDice(arg_50_0, arg_50_1, arg_50_2):
	...
	for iter_50_2, iter_50_3 in ipairs(arg_50_0.storyGroup):
		arg_50_0.UnlockStory(iter_50_3)

		if iter_50_3 == arg_50_2:
			break

def var_0_0.SetAnim(arg_54_0, arg_54_1, arg_54_2, arg_54_3):
	local var_54_0 = arg_54_1.GetComponent(typeof(SpineAnimUI))

	var_54_0.SetActionCallBack(None)
...
def var_0_0.UnlockStory(arg_56_0, arg_56_1):
	if table.contains(arg_56_0.explorableStories, arg_56_1) or table.contains(arg_56_0.exploredStories, arg_56_1):
		return

	table.insert(arg_56_0.explorableStories, arg_56_1)

	if arg_56_0.IndexofStory(arg_56_1) > arg_56_0.IndexofStory(arg_56_0.explorablePos):
		arg_56_0.explorablePos = arg_56_1

def var_0_0.ExploreStory(arg_57_0, arg_57_1):
	if table.contains(arg_57_0.exploredStories, arg_57_1):
		return

	if not table.contains(arg_57_0.explorableStories, arg_57_1):
		return

	table.removebyvalue(arg_57_0.explorableStories, arg_57_1)
	table.insert(arg_57_0.exploredStories, arg_57_1)

	if arg_57_0.IndexofStory(arg_57_1) > arg_57_0.IndexofStory(arg_57_0.currentPos):
		arg_57_0.currentPos = arg_57_1

def var_0_0.IndexofStory(arg_58_0, arg_58_1):
...
def var_0_0.ChangeRoomColor(arg_62_0, arg_62_1, arg_62_2):
...
def var_0_0.ChangeRoomMark(arg_63_0, arg_63_1, arg_63_2, arg_63_3):
	...
	if arg_63_2:
		if arg_63_2 == var_0_0.MARK_CURRENT:
			setActive(var_63_1, True)
		elif arg_63_2 == var_0_0.MARK_UNEXPLORED:
			setActive(var_63_2, True)
		elif arg_63_2 == var_0_0.MARK_BAD:
			setActive(var_63_3, True)
		elif arg_63_2 == var_0_0.MARK_EXPLORABLE:
			setActive(var_63_4, True)

def var_0_0.GetRoomTF(arg_64_0, arg_64_1):
	if arg_64_1 == var_0_0.ROOM_NUM:
		return arg_64_0.rooms[1].GetChild(arg_64_0.rooms[1].childCount - 1)
	elif arg_64_1 < arg_64_0.rooms[1].childCount:
...
def var_0_0.CheckGuide(arg_65_0):
	for iter_65_0, iter_65_1 in pairs({
		...
		if not arg_65_0.IsPlayed(var_65_1) and var_65_2(arg_65_0):
			if var_65_0 == "guide":
				pg.NewGuideMgr.GetInstance().Play(var_65_1, None, function()
...
def var_0_0.onBackPressed(arg_76_0):
	if isActive(arg_76_0.diceWindow):
		return
