...
def var_0_0.setColorItems(arg_3_0, arg_3_1):
	arg_3_0.colorItems = arg_3_1

def var_0_0.setColorGroups(arg_4_0, arg_4_1):
...
def var_0_0.DidMediatorRegisterDone(arg_6_0):
	...
	PoolMgr.GetInstance().GetUI(arg_6_0.coloringUIGroupName, False, function(arg_7_0)
		...
		for iter_7_0 = arg_6_0.colorgroupbehind.childCount - 1, 0, -1:
...
def var_0_0.didEnter(arg_9_0):
	onButton(arg_9_0, arg_9_0.btnBack, function()
		...
		arg_9_0.emit(var_0_0.ON_BACK, None, 0.3), SOUND_BACK)
	...
	onButton(arg_9_0, arg_9_0.btnShare, function()
		pg.ShareMgr.GetInstance().Share(pg.ShareMgr.TypeColoring), SFX_PANEL)
	onNextTick(function()
		if arg_9_0.exited:
			return
...
def var_0_0.uiStartAnimating(arg_14_0):
	local var_14_0 = 0
	local var_14_1 = 0.3

	arg_14_0.topPanel.anchoredPosition = Vector2(0, arg_14_0.topPanel.rect.height)

	shiftPanel(arg_14_0.topPanel, None, 0, var_14_1, var_14_0, True, True, None)

def var_0_0.uiExitAnimating(arg_15_0):
	local var_15_0 = 0
	local var_15_1 = 0.3

	shiftPanel(arg_15_0.topPanel, None, arg_15_0.topPanel.rect.height, var_15_1, var_15_0, True, True, None)

def var_0_0.initColoring(arg_16_0):
	...
	onButton(arg_16_0, arg_16_0.arrowDown, function()
		arg_16_0.scrollColor.GetComponent(typeof(ScrollRect)).verticalNormalizedPosition = 0, SFX_PANEL)

	local var_16_0 = 1

	for iter_16_0 = 1, #arg_16_0.colorGroups:
		if arg_16_0.colorGroups[iter_16_0].getState() == ColorGroup.StateColoring:
			var_16_0 = iter_16_0
...
def var_0_0.initInteractive(arg_20_0):
	for iter_20_0, iter_20_1 in pairs(arg_20_0.paintsgroup):
		...
		onButton(arg_20_0, iter_20_1, function()
			...
			if arg_20_0.selectedIndex != var_20_0 and var_21_0 != ColorGroup.StateLock:
			...
			elif var_21_0 == ColorGroup.StateLock:
				pg.TipsMgr.GetInstance().ShowTips(i18n("coloring_lock"))

			arg_20_0.updatePage(), SFX_PANEL)

	for iter_20_2 = 0, #arg_20_0.colorPlates - 1:
		...
		onButton(arg_20_0, var_20_2, function()
			...
			if var_22_0.getState() == ColorGroup.StateColoring and not var_22_0.canBeCustomised():
				...
				if var_22_2 != 0:
					...
					if var_22_3 and #var_22_3 > 0:
						arg_20_0.emit(ColoringMediator.EVENT_COLORING_CELL, {
							activityId = arg_20_0.activity.id,
							id = var_22_0.id,
							cells = var_22_3
						})
				elif not var_22_0.isAllFill(arg_20_0.selectedColorIndex):
					pg.TipsMgr.GetInstance().ShowTips(i18n("coloring_color_not_enough")), SFX_PANEL)

	onButton(arg_20_0, arg_20_0.toggleEraser, function()
		arg_20_0.SelectColoBar(0), SFX_PANEL)

def var_0_0.SelectColoBar(arg_24_0, arg_24_1):
	if arg_24_0.selectedColorIndex != 0 and arg_24_0.selectedColorIndex != arg_24_1:
	...
	if arg_24_0.selectedColorIndex != 0:
...
def var_0_0.updatePage(arg_25_0):
	for iter_25_0, iter_25_1 in ipairs(arg_25_0.paintsgroup):
...
def var_0_0.updateSelectedColoring(arg_26_0):
	...
	setActive(arg_26_0.title.parent, var_26_3 != None)
...
def var_0_0.updateCells(arg_27_0):
	...
	var_27_3.AddPointClickFunc(function(arg_28_0, arg_28_1)
		if not var_27_0.canBeCustomised():
			return
		...
		if var_27_0.getState() == ColorGroup.StateColoring:
			...
			if not var_27_0.canBeCustomised():
				return
			elif arg_27_0.selectedColorIndex == 0 and not var_27_0.hasFill(var_28_1, var_28_2):
				return
	...
	var_27_3.AddDragFunc(function(arg_31_0, arg_31_1)
		...
		if IsUnityEditor or not arg_27_0.zoom.enabled:
...
def var_0_0.updateCell(arg_33_0, arg_33_1, arg_33_2):
	...
	if var_33_3 == ColorGroup.StateFinish or var_33_3 == ColorGroup.StateAchieved:
		var_33_2 = var_33_1

	local var_33_4 = arg_33_1 .. "_" .. arg_33_2
	local var_33_5 = arg_33_0.cells.Find(var_33_4)

	if var_33_1 or var_33_2:
...
def var_0_0.calcCellSize(arg_34_0):
...
def var_0_0.searchColoringCells(arg_36_0, arg_36_1, arg_36_2, arg_36_3, arg_36_4):
	local var_36_0 = {
		row = arg_36_2,
		column = arg_36_3,
		color = arg_36_4
	...
	if arg_36_1.canBeCustomised():
		...
		while #var_36_5 > 0 and var_36_2 > 0:
			local var_36_7 = table.remove(var_36_5, 1)

			if not arg_36_1.hasFill(var_36_7.row, var_36_7.column) and var_36_7.color == arg_36_4:
				...
				_.each(var_36_6, function(arg_37_0)
					...
					if var_37_0 and not (_.any(var_36_5, function(arg_38_0)
						return arg_38_0.row == var_37_0.row and arg_38_0.column == var_37_0.column) or _.any(var_36_4, function(arg_39_0)
...
def var_0_0.SearchValidDiagonalColoringCells(arg_40_0, arg_40_1, arg_40_2, arg_40_3):
	assert(arg_40_1)

	local var_40_0 = {}

	if arg_40_1.getState() != ColorGroup.StateColoring or arg_40_1.canBeCustomised() or arg_40_3 == 0:
		return var_40_0
	else
