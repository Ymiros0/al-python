...
def var_0_0.didEnter(arg_5_0):
	...
	for iter_5_0, iter_5_1 in pairs(arg_5_0.taskGroupList):
				...
				table.sort(arg_5_0.tempTaskGroup, CompareFuncs({
					function(arg_12_0)
						return underscore.all(arg_12_0, function(arg_13_0)
							return arg_13_0.isReceive()) and 1 or 0,
					function(arg_14_0)
						return arg_14_0[1].id
				}))
				arg_5_0.taskGroupItemList.align(#arg_5_0.tempTaskGroup)
				arg_5_0.updateTaskInfo(), SFX_PANEL)

		if var_5_1.Find("mask"):
	...
	if arg_5_0.contextData.weekToggle and not arg_5_0.taskGroupList[arg_5_0.contextData.weekToggle].isLock:
		arg_5_0.weekToggle = arg_5_0.contextData.weekToggle
		arg_5_0.contextData.weekToggle = None
	else
		...
		for iter_5_2, iter_5_3 in ipairs(var_5_2):
			...
			if var_5_3.isLock:
				break
			elif underscore.any(underscore.flatten(var_5_3.task_group), function(arg_16_0)
...
def var_0_0.setActivity(arg_21_0, arg_21_1):
	arg_21_0.activity = arg_21_1

	for iter_21_0, iter_21_1 in pairs(arg_21_1.GetCrusingInfo()):
	...
	for iter_21_2, iter_21_3 in ipairs(arg_21_1.getConfig("config_data")):
...
def var_0_0.updatePhaseInfo(arg_22_0):
	setText(arg_22_0.textPhase, i18n("cruise_task_phase", arg_22_0.phase))

	if arg_22_0.phase < #arg_22_0.awardList:
...
def var_0_0.updateTaskInfo(arg_23_0):
	local var_23_0 = 0
	local var_23_1 = 0
...
def var_0_0.updateTaskGroup(arg_27_0, arg_27_1, arg_27_2):
	...
	for iter_27_0, iter_27_1 in ipairs(arg_27_2):
		if not iter_27_1.isReceive():
...
def var_0_0.updateTaskDisplay(arg_32_0, arg_32_1, arg_32_2):
	...
	onButton(arg_32_0, arg_32_1.Find("IconTpl"), function()
		arg_32_0.emit(var_0_0.ON_DROP, var_32_3), SFX_PANEL)
	...
	onButton(arg_32_0, arg_32_1.Find("go"), function()
		arg_32_0.emit(CrusingTaskMediator.ON_TASK_GO, arg_32_2), SFX_PANEL)
	onButton(arg_32_0, arg_32_1.Find("get"), function()
		arg_32_0.emit(CrusingTaskMediator.ON_TASK_SUBMIT, arg_32_2), SFX_CONFIRM)

def var_0_0.updateCurrentTaskGroup(arg_36_0):
