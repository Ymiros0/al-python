...
def var_0_0.handleNotification(arg_8_0, arg_8_1):
	...
	if var_8_0 == ActivityProxy.ACTIVITY_UPDATED:
		if var_8_1.id == arg_8_0.viewComponent.activity.id:
			arg_8_0.viewComponent.setActivity(var_8_1)

			if arg_8_0.viewComponent.phase == #arg_8_0.viewComponent.awardList:
		...
		if var_8_1.id == Item.QUICK_TASK_PASS_TICKET_ID:
