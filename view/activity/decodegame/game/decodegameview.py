...
def var_0_0.SetUI(arg_2_0, arg_2_1):
	...
	arg_2_0.dftAniEvent.SetEndEvent(function(arg_3_0)
		for iter_3_0, iter_3_1 in ipairs(arg_2_0.animCallbacks):
			iter_3_1()
...
def var_0_0.DoEnterAnim(arg_4_0, arg_4_1):
...
def var_0_0.Inited(arg_6_0, arg_6_1):
	onButton(arg_6_0, arg_6_0._tf.Find("btn/back"), function()
		arg_6_0.controller.ExitGame(), SFX_CANCEL)
	...
	onButton(arg_6_0, arg_6_0.bookBtn, function()
		if arg_6_0.controller.CanSwitch():
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_0.mapBtns):
...
def var_0_0.UpdateMap(arg_11_0, arg_11_1):
	arg_11_0.mapItems = {}
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_0.mapPasswords):
		local var_11_1 = "-"

		if arg_11_1.isUnlock:
...
def var_0_0.UpdateMapItem(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4):
	...
	onButton(arg_13_0, arg_13_1, function()
		arg_13_0.controller.Unlock(arg_13_3.index), SFX_PANEL)

	arg_13_0.mapItems[arg_13_3.index] = arg_13_1

def var_0_0.OnMapRepairing(arg_15_0, arg_15_1):
	...
	LeanTween.value(go(arg_15_0.encodingSlider), 0, 1, DecodeGameConst.DECODE_MAP_TIME).setOnUpdate(System.Action_float(function(arg_16_0)
		setFillAmount(arg_15_0.encodingSlider, arg_16_0))).setOnComplete(System.Action(function()
		pg.UIMgr.GetInstance().UnblurPanel(arg_15_0.encodingPanel, arg_15_0._tf)
		setActive(arg_15_0.encodingPanel, False)
		arg_15_1()))

def var_0_0.OnSwitch(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4, arg_18_5, arg_18_6, arg_18_7):
...
def var_0_0.OnExitMap(arg_20_0, arg_20_1, arg_20_2, arg_20_3):
	if arg_20_2:
...
def var_0_0.OnEnterMap(arg_21_0, arg_21_1, arg_21_2, arg_21_3):
	parallelAsync({
		function(arg_22_0)
		...
		function(arg_24_0)
			...
			LeanTween.value(go(arg_21_0.mapItemContainer), 0, arg_21_0.containerSize.y, DecodeGameConst.SCAN_MAP_TIME).setOnUpdate(System.Action_float(function(arg_25_0)
				arg_21_0.mapItemContainer.sizeDelta = Vector2(arg_21_0.containerSize.x, arg_25_0))).setOnComplete(System.Action(function()
...
def var_0_0.UnlockMapItem(arg_28_0, arg_28_1, arg_28_2):
	...
	LeanTween.value(go(var_28_1), 0, 1, 0.3).setOnUpdate(System.Action_float(function(arg_29_0)
		var_28_2.alpha = arg_29_0)).setOnComplete(System.Action(arg_28_2))

def var_0_0.UpdateCanUseCnt(arg_30_0, arg_30_1):
...
def var_0_0.UpdateProgress(arg_31_0, arg_31_1, arg_31_2, arg_31_3, arg_31_4):
	local var_31_0 = arg_31_1

	if var_31_0 < DecodeGameConst.MAP_ROW * DecodeGameConst.MAP_COLUMN * DecodeGameConst.MAX_MAP_COUNT:
	...
	if arg_31_2 == DecodeGameConst.MAX_MAP_COUNT and not arg_31_0.blinkFlag:
	...
	elif arg_31_2 == DecodeGameConst.MAX_MAP_COUNT:
...
def var_0_0.OnEnterDecodeMapBefore(arg_34_0, arg_34_1):
...
def var_0_0.OnEnterDecodeMap(arg_35_0, arg_35_1, arg_35_2):
	parallelAsync({
		function(arg_36_0)
		...
		for iter_38_0, iter_38_1 in ipairs(arg_35_1):
			arg_35_0.UpdatePassWord(iter_38_1, iter_38_0)

		setActive(arg_35_0.passWordTF, True)
		arg_35_2())

def var_0_0.OnEnterNormalMapBefore(arg_39_0, arg_39_1):
	parallelAsync({
		function(arg_40_0)
...
def var_0_0.OnEnterNormalMap(arg_42_0, arg_42_1, arg_42_2):
	seriesAsync({
		function(arg_43_0)
		...
		function(arg_45_0)
			...
			for iter_45_0, iter_45_1 in ipairs(arg_42_1.passwordIndexs):
...
def var_0_0.OnDecodeMap(arg_46_0, arg_46_1, arg_46_2):
	local var_46_0 = {}

	local function var_46_1(arg_47_0)
		for iter_47_0, iter_47_1 in ipairs(arg_46_1.items):
			if iter_47_1.index == arg_47_0:
				return iter_47_1

	for iter_46_0, iter_46_1 in ipairs(arg_46_1.passwordIndexs):
		...
		table.insert(var_46_0, {
			target = var_46_2,
			sizeDelta = var_46_3,
			starPosition = var_46_5,Position = var_46_6,
	...
	local function var_46_7()
		...
		for iter_48_0, iter_48_1 in ipairs(var_46_0):
			...
			if var_48_0.y >= var_48_2.y and var_48_0.y <= var_48_3.y:
	...
	LeanTween.value(go(arg_46_0.line1), 0, var_46_8, DecodeGameConst.SCAN_GRID_TIME).setOnUpdate(System.Action_float(function(arg_49_0)
		...
		var_46_7())).setOnComplete(System.Action(function()
		setActive(arg_46_0.line1, False)

		for iter_50_0, iter_50_1 in ipairs(var_46_0):
...
def var_0_0.UpdatePassWord(arg_51_0, arg_51_1, arg_51_2):
	if arg_51_1 == False:
		return
...
def var_0_0.OnRightCode(arg_52_0, arg_52_1, arg_52_2, arg_52_3):
	...
	arg_52_0.timer2 = Timer.New(function()
		setActive(arg_52_0.lightRight, False), 1, 1)

	arg_52_0.timer2.Start()

def var_0_0.OnFalseCode(arg_54_0, arg_54_1):
	arg_54_0.RemoveTimers()
	setActive(arg_54_0.lightLeft, True)

	arg_54_0.timer1 = Timer.New(function()
		setActive(arg_54_0.lightLeft, False), 1, 1)
...
def var_0_0.RemoveTimers(arg_57_0):
	if arg_57_0.timer1:
		arg_57_0.timer1.Stop()

		arg_57_0.timer1 = None

	if arg_57_0.timer2:
		arg_57_0.timer2.Stop()

		arg_57_0.timer2 = None

def var_0_0.OnSuccess(arg_58_0, arg_58_1):
	...
	LeanTween.value(var_58_0, 0, -140, DecodeGameConst.GET_AWARD_ANIM_TIME / 2).setOnUpdate(System.Action_float(function(arg_59_0)
		tf(var_58_0).eulerAngles = Vector3(0, 0, arg_59_0))).setOnComplete(System.Action(function()
...
def var_0_0.ShowHelper(arg_62_0, arg_62_1, arg_62_2):
	local var_62_0 = getProxy(PlayerProxy).getRawData().id

	if PlayerPrefs.GetInt("DecodeGameHelpBg" .. var_62_0 .. arg_62_1, 0) > 0:
		arg_62_2()
...
def var_0_0.Dispose(arg_69_0):
	...
	arg_69_0.mapItems = None

	arg_69_0.RemoveTimers()
	arg_69_0.dftAniEvent.SetEndEvent(None)

	arg_69_0.animCallbacks = None
