...
def var_0_0.Start(arg_2_0, arg_2_1, arg_2_2, arg_2_3):
	arg_2_0.delta = 0
...
def var_0_0.GetConfigByScore(arg_8_0, arg_8_1):
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_0):
		...
		if var_8_2 <= arg_8_1 and arg_8_1 <= var_8_3:
			var_8_1 = iter_8_1
	...
	if var_8_4 < var_8_7 and var_8_7 <= var_8_4 + var_8_5:
		var_8_8 = 2
	elif var_8_7 > var_8_4 + var_8_5 and var_8_7 <= 100:
		var_8_8 = 3

	return FushunAdventureGameConst.ENEMYS[var_8_8]

def var_0_0.UpdateScore(arg_9_0, arg_9_1):
	arg_9_0.score = arg_9_1

	if arg_9_0.mode == var_0_2:
		return

	local var_9_0 = arg_9_0.CalcTime(arg_9_1)

	if arg_9_0.targetTime != var_9_0:
		arg_9_0.changeTime = var_9_0

def var_0_0.CalcTime(arg_10_0, arg_10_1):
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_0):
		...
		if var_10_2 <= arg_10_1 and arg_10_1 <= var_10_3:
			var_10_1 = iter_10_1
