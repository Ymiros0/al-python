...
def var_0_0.didEnter(arg_3_0):
	...
	onToggle(arg_3_0, arg_3_0.btnBuild, function(arg_5_0)
		...
		if arg_5_0:
			arg_3_0.showPage(var_0_3), SFX_CONFIRM)
	onToggle(arg_3_0, arg_3_0.btnTask, function(arg_6_0)
		...
		if arg_6_0:
			arg_3_0.showPage(var_0_1), SFX_CONFIRM)
	onToggle(arg_3_0, arg_3_0.btnHistory, function(arg_7_0)
		...
		if arg_7_0:
			arg_3_0.showPage(var_0_2), SFX_CONFIRM)
	onButton(arg_3_0, arg_3_0.submitConfirm, function()
		...
		setActive(arg_3_0.submitPanel, False), SOUND_BACK)
...
def var_0_0.clearTagBtn(arg_11_0):
...
def var_0_0.showPage(arg_12_0, arg_12_1):
...
def var_0_0.openSubmitPanel(arg_13_0, arg_13_1):
...
def var_0_0.updateTask(arg_14_0, arg_14_1):
