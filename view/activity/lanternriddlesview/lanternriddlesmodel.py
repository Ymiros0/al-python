...
def var_0_0.Init(arg_2_0):
	...
	for iter_2_0, iter_2_1 in ipairs(var_0_1.all):
...
def var_0_0.WrapQuestion(arg_3_0, arg_3_1, arg_3_2):
	local var_3_0 = {
		{
...
def var_0_0.IsFinishQuestion(arg_4_0, arg_4_1):
	return table.contains(arg_4_0.finishList, arg_4_1)

def var_0_0.GetNextTime(arg_5_0, arg_5_1):
	return arg_5_0.nextTimes[arg_5_1] or 0

def var_0_0.SetNextTime(arg_6_0, arg_6_1):
	local var_6_0 = 0

	for iter_6_0, iter_6_1 in ipairs(arg_6_0.questiones):
		if iter_6_1.id == arg_6_1:
...
def var_0_0.GetLockTime(arg_7_0):
	return arg_7_0.lockTime

def var_0_0.GetAnswerFlag(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_0.SetAnswerFlag(arg_11_0, arg_11_1, arg_11_2):
	local var_11_0 = getProxy(PlayerProxy).getRawData().id

	PlayerPrefs.SetInt(arg_11_1 .. "_" .. arg_11_2 .. "_" .. var_11_0, 1)
	PlayerPrefs.Save()

	for iter_11_0, iter_11_1 in ipairs(arg_11_0.questiones):
		if iter_11_1.id == arg_11_1:
			for iter_11_2, iter_11_3 in ipairs(iter_11_1.answers):
				if iter_11_3[1] == arg_11_2:
					iter_11_3[2] = True

					break

def var_0_0.UpdateWrongAnswerFlag(arg_12_0, arg_12_1, arg_12_2):
	local var_12_0 = _.detect(arg_12_0.questiones, function(arg_13_0)
		return arg_13_0.id == arg_12_1).answers[arg_12_2]

	arg_12_0.SetAnswerFlag(arg_12_1, var_12_0[1])
	arg_12_0.SetNextTime(arg_12_1)

def var_0_0.UpdateRightAnswerFlag(arg_14_0, arg_14_1):
	if not table.contains(arg_14_0.finishList, arg_14_1):
	...
	if arg_14_0.unlockCount <= 0:
		for iter_14_0, iter_14_1 in ipairs(arg_14_0.questiones):
			if not iter_14_1.isFinish:
				iter_14_1.isUnlock = False

def var_0_0.UpdateData(arg_15_0, arg_15_1):
