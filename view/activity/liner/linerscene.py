...
def var_0_0.addListeners(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.findTF("home", arg_4_0.topUI), function()
		arg_4_0.quickExitFunc(), SFX_PANEL)
	...
	onButton(arg_4_0, arg_4_0.findTF("fullview", arg_4_0.topUI), function()
		if arg_4_0.mode == var_0_0.MODE_NORMAL:
			arg_4_0.SwitchMode(var_0_0.MODE_FULLVIEW)
		else
			arg_4_0.SwitchMode(var_0_0.MODE_NORMAL), SFX_PANEL)
...
def var_0_0.didEnter(arg_13_0):
	...
	table.insert(var_13_0, function(arg_14_0)
		if arg_13_0.activity.GetCurIdx() == 1:
			arg_13_0.managedTween(LeanTween.delayedCall, function()
				local var_15_0 = arg_13_0.targetIds[1]

				triggerButton(arg_13_0.findTF(tostring(var_15_0), arg_13_0.roomsTF)), var_0_0.AUTO_DELAY_TIME, None)
		else
			arg_14_0())
...
def var_0_0.InitRooms(arg_18_0):
	arg_18_0.rooms = {}
	arg_18_0.roomChars = {}
	...
	eachChild(arg_18_0.roomsTF, function(arg_19_0)
		...
		if table.contains(arg_18_0.roomIds, var_19_0):
	...
	arg_18_0.floatItemList.make(function(arg_20_0, arg_20_1, arg_20_2)
		...
		if arg_20_0 == UIItemList.EventUpdate:
			...
			onButton(arg_18_0, arg_20_2, function()
				arg_18_0.FocusNode(var_20_0), SFX_PANEL))

def var_0_0.UpdateRooms(arg_24_0):
...
def var_0_0.OnUpdateRoom(arg_26_0, arg_26_1, arg_26_2):
	if not table.contains(arg_26_0.roomIds, arg_26_1):
		...
		onButton(arg_26_0, arg_26_2, function()
			if arg_26_0.mode == var_0_0.MODE_FULLVIEW:
				arg_26_0.SwitchMode(var_0_0.MODE_NORMAL)
				arg_26_0.FocusNode(arg_26_1), SFX_CONFIRM)
	...
	onButton(arg_26_0, arg_26_2, function()
		...
		if not var_26_1 or var_26_3:
			return

		if arg_26_0.isFinishAll and not arg_26_0.isReallyTime:
		...
		switch(var_26_0, {
			[LinerTime.TYPE.TARGET] = function()
				pg.NewStoryMgr.GetInstance().Play(arg_26_0.curTime.GetStory(), function()
					...
					arg_26_0.needAutoCheck = True, True),
			...
			[LinerTime.TYPE.EVENT] = function()
				...
				if var_36_0 == LinerTime.EVENT_SUB_TYPE.CLUE:
					arg_26_0.roomPage.ExecuteAction("ShowInfo", arg_26_0.activity, arg_26_1, function()
						arg_26_0.CheckTime())
				elif var_36_0 == LinerTime.EVENT_SUB_TYPE.STORY:
			...
			[LinerTime.TYPE.STORY] = function()
				seriesAsync({
					function(arg_40_0)
						if arg_26_0.activity.GetCurIdx() == 1:
							arg_40_0()
						else
							arg_26_0.PlayAnim(function()
								arg_26_0.UpdateBg("day"), arg_40_0),
					function(arg_42_0)
	...
	if not arg_26_0.isFinishAll or arg_26_0.isFinishAll and not arg_26_0.isReallyTime:
		arg_26_0.UpdateRoomChar(arg_26_1, arg_26_2)

def var_0_0.UpdateRoomChar(arg_44_0, arg_44_1, arg_44_2):
	if arg_44_0.oldTime.id == arg_44_0.curTime.id and not arg_44_0.isFirstUpdate:
		return
	...
	if var_44_3 == var_44_4 and not arg_44_0.isFirstUpdate:
		return

	local var_44_5 = arg_44_0.findTF("char", arg_44_2)

	if arg_44_0.roomChars[arg_44_1][1] and arg_44_0.roomChars[arg_44_1][2]:
		if LeanTween.isTweening(arg_44_0.roomChars[arg_44_1][2]):
		...
		arg_44_0.roomChars[arg_44_1][1] = None
		arg_44_0.roomChars[arg_44_1][2] = None
...
def var_0_0.InitCharBehavior(arg_46_0, arg_46_1, arg_46_2, arg_46_3):
	...
	if var_46_0.type == 2:
		...
		arg_46_0.managedTween(LeanTween.value, None, go(arg_46_2), var_46_3, var_46_4, var_46_5).setOnUpdate(System.Action_float(function(arg_47_0)
			setLocalPosition(arg_46_2, {
				x = arg_47_0
			})

			if arg_47_0 == var_46_3:
				setLocalScale(arg_46_2, {
					x = var_46_1,
					y = var_46_1
				})

			if arg_47_0 == var_46_4:
				setLocalScale(arg_46_2, {
					x = -var_46_1,
					y = var_46_1
				}))).setLoopPingPong()

def var_0_0.GetRandomItems(arg_48_0, arg_48_1, arg_48_2):
	assert(arg_48_2 <= #arg_48_1, "不合法的随机数量")

	local var_48_0 = {}

	for iter_48_0 = 1, #arg_48_1:
	...
	for iter_48_1 = 1, arg_48_2:
		table.insert(var_48_1, arg_48_1[var_48_0[iter_48_1]])

	return var_48_1

def var_0_0.InitRandomChars(arg_49_0):
	for iter_49_0, iter_49_1 in pairs(arg_49_0.roomChars):
		if iter_49_1[1] and iter_49_1[2]:
			if LeanTween.isTweening(iter_49_1[2]):
				LeanTween.cancel(iter_49_1[2])

			PoolMgr.GetInstance().ReturnSpineChar(iter_49_1[1], iter_49_1[2])

			arg_49_0.roomChars[iter_49_0][1] = None
			arg_49_0.roomChars[iter_49_0][2] = None

	local var_49_0 = arg_49_0.GetRandomItems(underscore.filter(arg_49_0.roomIds, function(arg_50_0)
		return arg_50_0 != 4 and arg_50_0 != 31), var_0_0.FINISH_CHAR_CNT)
	local var_49_1 = arg_49_0.GetRandomItems(arg_49_0.sdConfig, var_0_0.FINISH_CHAR_CNT)

	for iter_49_2, iter_49_3 in ipairs(var_49_0):
...
def var_0_0.FillRandomChars(arg_52_0):
	if arg_52_0.oldTime.id == arg_52_0.curTime.id and not arg_52_0.isFirstUpdate:
		return
	...
	for iter_52_0, iter_52_1 in ipairs(arg_52_0.roomIds):
		local var_52_3 = arg_52_0.rooms[iter_52_1].GetSpineCharInfo(arg_52_0.curTime.id)

		if var_52_3 and var_52_3[1] and var_52_3[2]:
			table.removebyvalue(var_52_0, iter_52_1)

			if table.contains(var_52_1, var_52_3[1]):
				table.removebyvalue(var_52_1, var_52_3[1])

			var_52_2 = var_52_2 + 1

	if arg_52_0.randomIds and #arg_52_0.randomIds > 0:
		for iter_52_2, iter_52_3 in pairs(arg_52_0.roomChars):
			if iter_52_3[1] and iter_52_3[2] and table.contains(arg_52_0.randomIds, iter_52_2):
				if LeanTween.isTweening(iter_52_3[2]):
					LeanTween.cancel(iter_52_3[2])

				PoolMgr.GetInstance().ReturnSpineChar(iter_52_3[1], iter_52_3[2])

				arg_52_0.roomChars[iter_52_2][1] = None
				arg_52_0.roomChars[iter_52_2][2] = None
	...
	arg_52_0.randomIds = arg_52_0.GetRandomItems(underscore.filter(var_52_0, function(arg_53_0)
		return arg_53_0 != 4 and arg_53_0 != 31), var_52_4)

	local var_52_5 = arg_52_0.GetRandomItems(var_52_1, var_52_4)

	for iter_52_4, iter_52_5 in ipairs(arg_52_0.randomIds):
...
def var_0_0.UpdateTimeUI(arg_58_0):
	if arg_58_0.isReallyTime:
		...
		arg_58_0.finishTimer = Timer.New(function()
			arg_58_0.UpdateFinishTime(), 60, -1)
...
def var_0_0.CheckTime(arg_66_0):
...
def var_0_0.UpdateView(arg_68_0, arg_68_1):
	arg_68_0.UpdateBg()
	...
	if arg_68_0.curTime.GetType() != LinerTime.TYPE.EXPLORE and arg_68_0.targetIds[1]:
		arg_68_0.FocusNode(arg_68_0.targetIds[1], arg_68_1)
	else
		arg_68_0.onDragFunction()

	if arg_68_0.curTime.GetType() == LinerTime.TYPE.EXPLORE and not pg.NewStoryMgr.GetInstance().IsPlayed("Liner_1"):
	...
	if arg_68_0.oldTime.id != arg_68_0.curTime.id:
		arg_68_0.PlayBGM()

def var_0_0.UpdateData(arg_70_0):
	...
	arg_70_0.oldTime = arg_70_0.curTime and Clone(arg_70_0.curTime) or None
	arg_70_0.curTime = arg_70_0.activity.GetCurTime()

	if not arg_70_0.oldTime:
		arg_70_0.oldTime = Clone(arg_70_0.curTime)

	if arg_70_0.isFinishAll:
		if not arg_70_0.isReallyTime:
			arg_70_0.targetIds = {
				var_0_0.FINISH_TARGET_ROOM_ID
			}
		else
			arg_70_0.targetIds = {}
	elif arg_70_0.curTime.GetType() == LinerTime.TYPE.EVENT:
		arg_70_0.targetIds = {
...
def var_0_0.onDragFunction(arg_73_0):
	...
	for iter_73_0, iter_73_1 in ipairs(arg_73_0.targetIds):
		...
		if var_73_0:
			...
			for iter_73_2, iter_73_3 in ipairs(var_0_0.screenPoints):
...
def var_0_0.FocusNode(arg_74_0, arg_74_1, arg_74_2):
	...
	if arg_74_0.twFocusId:
		LeanTween.cancel(arg_74_0.twFocusId)

		arg_74_0.twFocusId = None
	...
	table.insert(var_74_1, function(arg_75_0)
		...
		arg_74_0.twFocusId = LeanTween.move(arg_74_0.mapTF, Vector3(var_74_0.x, var_74_0.y, 0), var_75_1).setEase(LeanTweenType.easeInOutSine).setOnUpdate(System.Action_float(function(arg_76_0)
			arg_74_0.onDragFunction())).setOnComplete(System.Action(arg_75_0)).uniqueId)
...
def var_0_0.SwitchMode(arg_78_0, arg_78_1, arg_78_2):
	...
	arg_78_0.managedTween(LeanTween.value, None, go(arg_78_0.mapTF), var_78_1, var_78_2, var_0_0.SCALE_ANIM_TIME).setEase(LeanTweenType.easeInOutSine).setOnUpdate(System.Action_float(function(arg_79_0)
	...
	if not var_78_0:
		arg_78_0.managedTween(LeanTween.move, None, go(arg_78_0.mapTF), Vector3(0, 0, 0), var_0_0.SCALE_ANIM_TIME).setEase(LeanTweenType.easeInOutSine).setOnComplete(System.Action(function()
			if arg_78_2:
				arg_78_2()))
	elif arg_78_2:
		arg_78_2()

def var_0_0.PlayAnim(arg_81_0, arg_81_1, arg_81_2):
	seriesAsync({
		function(arg_82_0)
			if not arg_81_0.swithAnimTF:
		...
		function(arg_84_0)
			...
			var_84_0.SetActionCallBack(function(arg_85_0)
				if arg_85_0 == "finish":
					...
					setActive(arg_81_0.swithAnimTF, False)
				elif arg_85_0 == "action" and arg_81_1:
					arg_81_1())
			var_84_0.SetAction("action", 0)
	}, function()
		return)

def var_0_0.onBackPressed(arg_87_0):
	if arg_87_0.timePage and arg_87_0.timePage.GetLoaded() and arg_87_0.timePage.isShowing():
		return

	var_0_0.super.onBackPressed(arg_87_0)

def var_0_0.willExit(arg_88_0):
	arg_88_0.timePage.Destroy()

	arg_88_0.timePage = None

	arg_88_0.roomPage.Destroy()

	arg_88_0.roomPage = None

	for iter_88_0, iter_88_1 in pairs(arg_88_0.roomChars):
		if iter_88_1[1] and iter_88_1[2]:
			PoolMgr.GetInstance().ReturnSpineChar(iter_88_1[1], iter_88_1[2])

	arg_88_0.roomChars = None

	if arg_88_0.finishTimer != None:
		arg_88_0.finishTimer.Stop()

		arg_88_0.finishTimer = None
