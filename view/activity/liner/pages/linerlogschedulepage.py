...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.getBtn, function()
		arg_3_0.emit(LinerLogBookMediator.GET_SCHEDULE_AWARD, arg_3_0.activity.id, arg_3_0.curIdx, arg_3_0.groups[arg_3_0.curIdx].GetDrop()), SFX_CONFIRM)
	...
	arg_3_0.toggleUIList.make(function(arg_7_0, arg_7_1, arg_7_2)
		if arg_7_0 == UIItemList.EventInit:
			...
			onToggle(arg_3_0, arg_7_2, function(arg_8_0)
				if arg_8_0:
					if arg_3_0.curIdx and arg_3_0.curIdx == var_7_0:
						return

					arg_3_0.curIdx = var_7_0

					arg_3_0.FlushPage(True), SFX_CONFIRM)
...
def var_0_0.UpdateActivity(arg_9_0, arg_9_1):
...
def var_0_0._getLogDesc(arg_10_0, arg_10_1):
...
def var_0_0._getReallyTime(arg_11_0, arg_11_1):
	for iter_11_0, iter_11_1 in ipairs(arg_11_0.times):
		...
		if var_11_0 <= arg_11_1[1] and var_11_1 >= arg_11_1[2]:
			return iter_11_1
...
def var_0_0.UpdateItem(arg_12_0, arg_12_1, arg_12_2):
	...
	if var_12_3 and var_12_2.GetType() == LinerTime.TYPE.EXPLORE:
...
def var_0_0.FlushPage(arg_14_0):
	arg_14_0.anim.Play()
	...
	onButton(arg_14_0, arg_14_0.awardTF, function()
		arg_14_0.emit(BaseUI.ON_DROP, var_14_0), SFX_PANEL)
...
def var_0_0.IsTipWithGroupId(arg_18_0, arg_18_1):
	local var_18_0 = table.indexof(arg_18_0.GetTimeGroupIds(), arg_18_1)

	if arg_18_0.IsGotTimeAward(var_18_0):
		return False
