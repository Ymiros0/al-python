...
def var_0_0.initActivityPools(arg_5_0):
...
def var_0_0.didEnter(arg_8_0):
	onButton(arg_8_0, arg_8_0.findTF("top/back_btn"), function()
		arg_8_0.emit(var_0_0.ON_CLOSE), SOUND_BACK)
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_0):
		...
		onButton(arg_8_0, iter_8_1, function()
			if not arg_8_0.activityPool:
				return

			if arg_8_0.activityPool != arg_8_0.showActivityPool:
			...
			if not arg_8_0.activityPool.enoughResForUsage(var_10_0):
			...
			if arg_8_0.playerVO.OilMax(1) or arg_8_0.playerVO.GoldMax(1):
				pg.MsgboxMgr.GetInstance().ShowMsgBox({
	...
	onButton(arg_8_0, arg_8_0.descBtn, function()
		if not arg_8_0.showActivityPool:
			return

		local var_14_0, var_14_1 = arg_8_0.showActivityPool.getItems()

		arg_8_0.showBonus(var_14_0, var_14_1), SFX_PANEL)
	...
	for iter_8_2 = 1, table.getCount(arg_8_0.activityPools):
		local var_8_2 = arg_8_0.attrs.Find("arr_" .. iter_8_2)

		if not IsNil(var_8_2):
...
def var_0_0.onActivityUpdated(arg_18_0, arg_18_1):
	arg_18_0.setActivity(arg_18_1)
	arg_18_0.updateActivityPoolState()
	arg_18_0.switchToPool(arg_18_1.data1)

def var_0_0.initPoolTFs(arg_19_0):
	arg_19_0.activityPoolTFs = {}

	for iter_19_0, iter_19_1 in pairs(arg_19_0.activityPools):
		...
		onToggle(arg_19_0, var_19_0, function(arg_20_0)
			if arg_20_0:
				if not iter_19_1.prevId or arg_19_0.activityPools[iter_19_1.prevId].canOpenNext():
					arg_19_0.emit(LotteryMediator.ON_SWITCH, arg_19_0.activityVO.id, iter_19_1.id)
				else
					arg_19_0.switchToPool(iter_19_1.id))

def var_0_0.updateActivityPoolState(arg_21_0):
	for iter_21_0, iter_21_1 in pairs(arg_21_0.activityPools):
		...
		if arg_21_0.attrTFs[iter_21_1.index - 1]:
			triggerToggle(arg_21_0.attrTFs[iter_21_1.index - 1], var_21_1)

def var_0_0.switchToPool(arg_22_0, arg_22_1):
...
def var_0_0.updateAwardsFetchedCount(arg_23_0, arg_23_1):
	if arg_23_0.awardsCounttxt:
	...
	for iter_24_1 = 1, var_24_1:
		...
		if var_24_3:
			...
			onButton(arg_24_0, var_24_2, function()
				arg_24_0.emit(var_0_0.ON_DROP, var_24_4), SFX_PANEL)

def var_0_0.showBonus(arg_26_0, arg_26_1, arg_26_2):
...
def var_0_0.updateDrop(arg_29_0, arg_29_1, arg_29_2, arg_29_3, arg_29_4):
	if arg_29_1 == UIItemList.EventUpdate:
