...
def var_0_0.confirm(arg_9_0, arg_9_1):
	...
	if type(var_9_3) == "table":
		for iter_9_0, iter_9_1 in ipairs(var_9_3):
...
def var_0_0.onUpdatePlayer(arg_12_0, arg_12_1):
	arg_12_0.player = arg_12_1

def var_0_0.onUpdateGift(arg_13_0):
