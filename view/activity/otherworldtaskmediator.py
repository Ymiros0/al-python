...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.TASK_GO, function(arg_6_0, arg_6_1)
		...
		if var_6_0[1] == SCENE.OTHERWORLD_MAP:
...
def var_0_0.checkActStory(arg_8_0, arg_8_1, arg_8_2, arg_8_3):
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_0):
		...
		if table.contains(arg_8_2, var_8_2):
...
def var_0_0.onUIAvalible(arg_11_0):
	return
...
def var_0_0.handleNotification(arg_13_0, arg_13_1):
	...
	if var_13_0 == GAME.SUBMIT_AVATAR_TASK_DONE:
	...
	elif var_13_0 == GAME.ZERO_HOUR_OP_DONE:
		arg_13_0.viewComponent.updateTask(True)
