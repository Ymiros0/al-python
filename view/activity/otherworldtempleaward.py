...
def var_0_0.updateSelect(arg_6_0, arg_6_1):
	...
	for iter_6_0 = 1, #arg_6_0._awardItems:
...
def var_0_0.setItemData(arg_7_0, arg_7_1, arg_7_2):
	...
	onButton(arg_7_0._event, arg_7_1, function()
		arg_7_0._event.emit(BaseUI.ON_DROP, var_7_4), SFX_PANEL)
...
def var_0_0.updateItemsCount(arg_9_0, arg_9_1):
	local var_9_0 = 0

	if arg_9_1 > #arg_9_0._awardItems:
