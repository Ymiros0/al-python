...
def var_0_0.DoMove(arg_6_0, arg_6_1):
	local var_6_0
...
def var_0_0.DoCheck(arg_7_0, arg_7_1):
	...
	if math.abs(var_7_2.y) >= var_7_0.rect.height:
		var_7_0.GetComponent(typeof(Image)).sprite = None
		arg_7_0.names[var_7_0] = None
...
def var_0_0.GetBg(arg_9_0, arg_9_1):
	return var_0_0.bgMaps[arg_9_1] or var_0_0.bgMaps[#var_0_0.bgMaps]

def var_0_0.LoadImage(arg_10_0, arg_10_1, arg_10_2):
	LoadSpriteAtlasAsync("clutter/bg" .. arg_10_1, None, function(arg_11_0)
		arg_10_2(arg_11_0))

def var_0_0.LoadEffect(arg_12_0, arg_12_1, arg_12_2):
	local var_12_0 = var_0_0.effects[tonumber(arg_12_1)]

	if var_12_0:
		PoolMgr.GetInstance().GetUI(var_12_0, True, function(arg_13_0)
			if not arg_12_0.list:
...
def var_0_0.ReturnEffect(arg_14_0, arg_14_1):
	if arg_14_1.childCount > 0:
...
def var_0_0.Clear(arg_15_0):
	eachChild(arg_15_0.tr, function(arg_16_0)
		arg_16_0.GetComponent(typeof(Image)).sprite = None
