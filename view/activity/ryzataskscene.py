...
def var_0_0.init(arg_2_0):
	...
	arg_2_0.enterTaskId = arg_2_0.contextData.task_id or None
	...
	for iter_2_1 = 1, #arg_2_0.ptBuffs:
...
def var_0_0.updateTask(arg_3_0, arg_3_1):
	arg_3_0.displayTask = {}
	...
	if var_3_9 and #var_3_9 > 0:
		for iter_3_1 = 1, #var_3_9:
			...
			if var_3_12 > 0:
				if not arg_3_0.displayTask[var_3_12]:
	...
	local function var_3_13(arg_4_0, arg_4_1)
		if arg_4_0.isOver() and not arg_4_1.isOver():
			return False
		elif not arg_4_0.isOver() and arg_4_1.isOver():
			return True

		if arg_4_0.isFinish() and not arg_4_1.isFinish():
			return True
		elif not arg_4_0.isFinish() and arg_4_1.isFinish():
			return False

		if arg_4_0.isNew() and not arg_4_1.isNew():
			return True
		elif not arg_4_0.isNew() and arg_4_1.isNew():
			return False

		if arg_4_0.id > arg_4_1.id:
			return False
		elif arg_4_0.id < arg_4_1.id:
			return True

	for iter_3_2, iter_3_3 in pairs(arg_3_0.displayTask):
...
def var_0_0.didEnter(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.btnPoint, function()
		if isActive(arg_5_0.pointPanel):
			setActive(arg_5_0.pointPanel, False)
		else
			setActive(arg_5_0.pointPanel, True), SOUND_BACK)
	onButton(arg_5_0, arg_5_0.btnMain, function()
		arg_5_0.emit(BaseUI.ON_HOME), SOUND_BACK)
	...
	onButton(arg_5_0, arg_5_0.pointMask, function()
		setActive(arg_5_0.pointPanel, False), SOUND_BACK)
	...
	onButton(arg_5_0, arg_5_0.detailBtnSubmit, function()
		...
		if arg_5_0.selectTask.getConfig("sub_type") == 1006:
	...
	if PlayerPrefs.GetInt("ryza_task_help_" .. getProxy(PlayerProxy).getRawData().id) != 1:
		var_5_2 = True
...
def var_0_0.onClickTag(arg_21_0):
	print("点击了Tag")

	local var_21_0 = arg_21_0.showTagIndex

	if var_21_0 and var_21_0 > 0:
		if arg_21_0.displayTask[var_21_0] and #arg_21_0.displayTask[var_21_0] > 0:
	...
	if arg_21_0.enterTaskId and arg_21_0.enterTaskId > 0:
		for iter_21_0 = 1, #arg_21_0.showTasks:
			if arg_21_0.showTasks[iter_21_0].id == arg_21_0.enterTaskId:
				arg_21_0.scrollIndex = iter_21_0

	arg_21_0.scrollRect.SetTotalCount(#arg_21_0.showTasks, 0)

	if arg_21_0.scrollIndex != None:
		local var_21_1 = arg_21_0.scrollRect.HeadIndexToValue(arg_21_0.scrollIndex - 1)

		arg_21_0.scrollRect.ScrollTo(var_21_1)

def var_0_0.onUpdateTaskItem(arg_22_0, arg_22_1, arg_22_2):
	if arg_22_0.exitFlag:
		return
	...
	LeanTween.value(arg_22_2, 0, 1, 0.3).setEase(LeanTweenType.linear).setOnUpdate(System.Action_float(function(arg_23_0)
		var_22_0.alpha = arg_23_0)).setOnComplete(System.Action(function()
		arg_22_0.leanTweens[arg_22_2] = None))
	...
	if arg_22_0.enterTaskId != None and arg_22_0.enterTaskId > 0:
		if var_22_2 == arg_22_0.enterTaskId:
			triggerButton(arg_22_2)

			arg_22_0.enterTaskId = None
			arg_22_0.scrollIndex = None
	elif arg_22_1 == 1:
		triggerButton(arg_22_2)

		arg_22_0.scrollIndex = None

def var_0_0.updateDetail(arg_26_0):
	...
	if not var_26_10 or var_26_10 == 0:
		var_26_10 = "attack"

	if not var_26_8 and var_26_3 < var_26_2:
		var_26_2 = var_26_3
	...
	if #arg_26_0.iconTfs < #arg_26_0.awards:
		local var_26_12 = #arg_26_0.awards - #arg_26_0.iconTfs

		for iter_26_0 = 1, var_26_12:
	...
	for iter_26_1 = 1, #arg_26_0.iconTfs:
		if iter_26_1 <= #arg_26_0.awards:
			...
			onButton(arg_26_0, arg_26_0.iconTfs[iter_26_1], function()
				arg_26_0.emit(BaseUI.ON_DROP, var_26_15), SFX_PANEL)
			setActive(arg_26_0.iconTfs[iter_26_1], True)
		else
			setActive(arg_26_0.iconTfs[iter_26_1], False)

def var_0_0.openSubmitPanel(arg_28_0, arg_28_1):
...
def var_0_0.willExit(arg_29_0):
	...
	if arg_29_0.leanTweens and #arg_29_0.leanTweens > 0:
		for iter_29_0, iter_29_1 in pairs(arg_29_0.leanTweens):
			if LeanTween.isTweening(iter_29_1):
				LeanTween.cancel(iter_29_1)

		arg_29_0.leanTweens = {}

	for iter_29_2 = 1, #arg_29_0.allDisplayTask:
