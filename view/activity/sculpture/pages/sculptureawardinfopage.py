...
def var_0_0.UpdateCard(arg_8_0, arg_8_1, arg_8_2):
	...
	LoadSpriteAtlasAsync("SculptureRole/" .. var_8_1 .. "_normal", None, function(arg_9_0)
		if arg_8_0.exited:
			return
	...
	var_8_3.make(function(arg_10_0, arg_10_1, arg_10_2)
		if arg_10_0 == UIItemList.EventUpdate:
			...
			onButton(arg_8_0, arg_10_2, function()
				arg_8_0.emit(BaseUI.ON_DROP, var_10_1), SFX_PANEL))
