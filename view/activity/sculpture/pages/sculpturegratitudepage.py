...
def var_0_0.Flush(arg_8_0, arg_8_1):
	...
	if var_8_0 == SculptureActivity.STATE_FINSIH:
		arg_8_0.Clear()
...
def var_0_0.SetScrollTxt(arg_9_0, arg_9_1):
	...
	arg_9_0.timer = Timer.New(function()
		scrollToBottom(arg_9_0.wordTxtScr), 0.1, -1)
...
def var_0_0.InitAwards(arg_13_0):
	...
	arg_13_0.uilist.make(function(arg_14_0, arg_14_1, arg_14_2)
		if arg_14_0 == UIItemList.EventUpdate:
			...
			onButton(arg_13_0, arg_14_2, function()
				arg_13_0.emit(BaseUI.ON_DROP, var_14_1), SFX_PANEL))
	arg_13_0.uilist.align(#var_13_0)

def var_0_0.LoadChar(arg_16_0, arg_16_1):
...
def var_0_0.State2CharNameAndActionName(arg_17_0, arg_17_1):
	local var_17_0 = arg_17_0.activity.GetResorceName(arg_17_0.id)

	if arg_17_1 == SculptureActivity.STATE_FINSIH:
		return var_17_0, "gift_get_", "take_wait_"
	else
		return var_17_0, "gift_wait_"

def var_0_0.LoadSculpture(arg_18_0, arg_18_1):
...
def var_0_0.InitSculpture(arg_20_0, arg_20_1):
	...
	var_20_0.AddDragEndFunc(function(arg_23_0, arg_23_1)
		...
		if var_23_1.Intersects(var_23_2):
...
def var_0_0.UpdateRole(arg_24_0, arg_24_1, arg_24_2, arg_24_3, arg_24_4):
	if arg_24_0.charName == arg_24_1:
		return
	...
	PoolMgr.GetInstance().GetSpineChar("takegift_" .. arg_24_1, True, function(arg_25_0)
		...
		if arg_24_3:
			var_25_0.SetActionCallBack(function(arg_26_0)
				if arg_26_0 == "finish":
					var_25_0.SetActionCallBack(None)
...
def var_0_0.ClearChar(arg_27_0):
	if arg_27_0.charName and arg_27_0.charGo:
		if arg_27_0.spineAnimUI:
			arg_27_0.spineAnimUI.SetActionCallBack(None)

			arg_27_0.spineAnimUI = None

		PoolMgr.GetInstance().ReturnSpineChar(arg_27_0.charName, arg_27_0.charGo)

		arg_27_0.charName = None
		arg_27_0.charGo = None

def var_0_0.RegisterEvent(arg_28_0):
