...
def var_0_0.initNotificationHandleDic(arg_16_0):
	arg_16_0.handleDic = {
		...
		[var_0_0.DISPLAY_NODES] = function(arg_25_0, arg_25_1)
			...
			if var_25_0 and #var_25_0 > 0 and not arg_25_0.viewComponent.focusList(var_25_0, LeanTweenType.easeInOutSine):
		...
		[GAME.ISLAND_FLOWER_GET_DONE] = function(arg_27_0, arg_27_1)
			for iter_27_0, iter_27_1 in pairs(getProxy(IslandProxy).GetNodeDic()):
				if iter_27_1.getConfig("type") == 5 and iter_27_1.getConfig("params")[1] == "flowerfield":
					arg_27_0.viewComponent.refreshNode(iter_27_0),
		[ActivityProxy.ACTIVITY_UPDATED] = function(arg_28_0, arg_28_1)
			if arg_28_1.getBody().id == ActivityConst.ISLAND_TASK_ID:
