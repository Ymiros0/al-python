...
def var_0_0.setShop(arg_2_0, arg_2_1):
	...
	arg_4_0.goodsItemList.make(function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == UIItemList.EventUpdate:
			...
			onButton(arg_4_0, arg_5_2, function()
				arg_4_0.emit(SixthAnniversaryIslandShopMediator.OPEN_GOODS_WINDOW, arg_4_0.goodsList[arg_5_1]), SFX_PANEL)
...
def var_0_0.updateGoodsCard(arg_9_0, arg_9_1, arg_9_2):
...
def var_0_0.refreshGoodsCard(arg_11_0, arg_11_1):
...
def var_0_0.didEnter(arg_12_0):
	...
	arg_12_0.timer = Timer.New(function()
		...
		if arg_12_0.strTime != var_13_0:
			setText(arg_12_0.rtTime, var_13_0), 1)
