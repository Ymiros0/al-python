	...
	arg_1_0.uiList.make(function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == UIItemList.EventUpdate:
			...
			onToggle(arg_1_0, arg_2_2, function(arg_3_0)
				...
				setTextColor(arg_2_2.Find("Text"), Color.NewHex(arg_1_0.DAY_COLOR[arg_3_0 and 1 or 2])), SFX_PANEL))

def var_0_0.OnDataSetting(arg_4_0):
	if not arg_4_0.idLists:
...
def var_0_0.OnUpdateFlush(arg_7_0):
	...
	if not arg_7_0.index:
		arg_7_0.index = arg_7_0.nday

		while arg_7_0.index > 0 and not arg_7_0.gifts[arg_7_0.index].canPurchase() and not arg_7_0.freeGifts[arg_7_0.index].canPurchase():
...
def var_0_0.ShowGifts(arg_8_0, arg_8_1):
...
def var_0_0.UpdateCard(arg_10_0, arg_10_1, arg_10_2):
	local var_10_0

	if arg_10_2.isChargeType():
		var_10_0 = {
			isFree = False,
	...
	if not tonumber(var_10_0.price):
	...
	UIItemList.StaticAlign(arg_10_1.Find("awards"), arg_10_1.Find("awards/award"), #var_10_0.items, function(arg_13_0, arg_13_1, arg_13_2)
		if arg_13_0 == UIItemList.EventUpdate:
			...
			onButton(arg_10_0, arg_13_2, function()
				arg_10_0.emit(BaseUI.ON_DROP, var_13_0), SFX_PANEL))
	...
	onButton(arg_10_0, arg_10_1, function()
		...
		elif not arg_10_2.canPurchase():
			pg.TipsMgr.GetInstance().ShowTips(i18n("buy_countLimit"))
		else
			arg_10_0.OnCharge(arg_10_2), SFX_PANEL)

def var_0_0.OnCharge(arg_16_0, arg_16_1):
	if arg_16_1.isChargeType():
		...
		if type(var_16_11) == "table":
			for iter_16_0, iter_16_1 in ipairs(var_16_11):
