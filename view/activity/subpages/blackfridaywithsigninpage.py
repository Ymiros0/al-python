...
def var_0_0.OnFirstFlush(arg_2_0):
	...
	if arg_2_0.contextData.showByNextAct:
		arg_2_0.contextData.showByNextAct = None

		triggerToggle(arg_2_0.toggles[2], True)

def var_0_0.GetSignInAct(arg_4_0):
	return (getProxy(ActivityProxy).getActivityById(arg_4_0.signInActId))

def var_0_0.ClientSignInActIsEnd(arg_5_0):
...
def var_0_0.FlushSignInInfo(arg_6_0):
...
def var_0_0.FlushSignAwardsState(arg_9_0):
	...
	arg_9_0.signInUIlist.each(function(arg_10_0, arg_10_1)
		if not var_9_3 and not var_9_1:
