...
def var_0_0.OnFirstFlush(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.getBtn, function()
		if arg_3_0.submitVO:
			arg_3_0.emit(ActivityMediator.ON_TASK_SUBMIT, arg_3_0.submitVO), SFX_PANEL)
...
def var_0_0.OnUpdateFlush(arg_7_0):
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.taskList):
		...
		if var_7_2.getTaskStatus() == 1:
			var_7_0 = var_7_0 + 1

			if not arg_7_0.submitVO:
				arg_7_0.submitVO = var_7_2

		if var_7_2.getTaskStatus() == 2:
			var_7_1 = var_7_1 + 1
