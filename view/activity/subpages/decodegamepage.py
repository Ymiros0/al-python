...
def var_0_0.GetProgressColor(arg_5_0):
...
def var_0_0.UpdateGameProgress(arg_8_0):
	...
	if var_8_5 < DecodeGameConst.MAP_ROW * DecodeGameConst.MAP_COLUMN * DecodeGameConst.MAX_MAP_COUNT:
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_7):
		if iter_8_1:
			var_8_8 = var_8_8 + 1
...
def var_0_0.IsFinishAllTasks(arg_9_0):
	local var_9_0 = arg_9_0.taskGroup[#arg_9_0.taskGroup]

	return _.all(var_9_0, function(arg_10_0)
		return getProxy(TaskProxy).getFinishTaskById(arg_10_0) != None)

def var_0_0.UpdateCanUseCnt(arg_11_0, arg_11_1):
