...
def var_0_0.OnInit(arg_1_0):
	...
	onButton(arg_1_0, var_1_2, function()
		arg_1_0.emit(BaseUI.ON_DROP, var_1_1), SFX_PANEL)

def var_0_0.SetData(arg_3_0):
...
def var_0_0.OnFirstFlush(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.goBtn, function()
		pg.m02.sendNotification(GAME.GO_MINI_GAME, var_0_2), SFX_PANEL)
...
def var_0_0.CheckGet(arg_8_0):
	if arg_8_0.ultimate == 0:
		if arg_8_0.data.getConfig("reward_need") > arg_8_0.usedtime:
			return
