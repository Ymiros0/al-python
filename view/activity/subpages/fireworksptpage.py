...
def var_0_0.OnFirstFlush(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.nextPageBtn, function()
		arg_3_0.UpdateFrieworkPanel(arg_3_0.pageIndex + 1), SFX_PANEL)
...
def var_0_0.UpdataPageIndex(arg_8_0):
	...
	for iter_8_0 = #arg_8_0.fireworkPages, 1, -1:
		local var_8_0 = 0

		eachChild(arg_8_0.fireworkPages[iter_8_0], function(arg_9_0)
			local var_9_0 = tonumber(arg_9_0.name)

			if table.contains(arg_8_0.unlockIds, var_9_0):
				var_8_0 = var_8_0 + 1)

		if var_8_0 != arg_8_0.fireworkPages[iter_8_0].childCount:
			arg_8_0.pageIndex = iter_8_0

	if #arg_8_0.unlockIds == #arg_8_0.fireworkIds:
		arg_8_0.pageIndex = 1
...
def var_0_0.OnUnlockClick(arg_14_0, arg_14_1):
	...
	pg.MsgboxMgr.GetInstance().ShowMsgBox({
		...
		def onYes:()
			if arg_14_0.ptNum < arg_14_0.ptConsume:
