...
def var_0_0.OnDataSetting(arg_4_0):
...
def var_0_0.OnUpdateFlush(arg_6_0):
	if arg_6_0.curIndex == 0 and arg_6_0.activity.data4 > 0:
		...
		arg_6_0.rotate()
	elif arg_6_0.activity.data4 > 0:
		if arg_6_0.activity.data4 <= arg_6_0.groupNum:
			arg_6_0.curIndex = arg_6_0.activity.data4
			arg_6_0.curShipGroupID = arg_6_0.configData.groupid_list[arg_6_0.curIndex]
			arg_6_0.curTaskIDList = arg_6_0.configData.task_table[arg_6_0.curIndex]
			arg_6_0.curStoryID = arg_6_0.configData.story_list[arg_6_0.curIndex]
		...
		arg_6_0.curIndex = 0
		arg_6_0.curShipGroupID = None
		arg_6_0.curTaskIDList = None
		arg_6_0.curStoryID = None

		setActive(arg_6_0.taskPanel, False)

		if arg_6_0.progressStep > arg_6_0.groupNum:
...
def var_0_0.rotate(arg_8_0):
	...
	LeanTween.value(go(arg_8_0.circleTF), 0, var_8_5, var_8_3).setEase(LeanTweenType.easeInOutCirc).setOnUpdate(System.Action_float(function(arg_9_0)
		arg_8_0.circleTF.localEulerAngles = Vector3(0, 0, -arg_9_0))).setOnComplete(System.Action(function()
		pg.NewStoryMgr.GetInstance().Play(arg_8_0.curStoryID, function()
			arg_8_0.updateTaskPanel(), True, True)

		arg_8_0.isTurning = False))

def var_0_0.updateTaskPanel(arg_12_0):
	...
	arg_12_0.taskUIItemList.make(function(arg_15_0, arg_15_1, arg_15_2)
		if arg_15_0 == UIItemList.EventUpdate:
			...
			onButton(arg_12_0, var_15_1, function()
				arg_12_0.emit(BaseUI.ON_DROP, var_15_5), SFX_PANEL)
			...
			onButton(arg_12_0, var_15_8, function()
				arg_12_0.emit(ActivityMediator.ON_TASK_GO, var_15_3), SFX_PANEL)
			onButton(arg_12_0, var_15_9, function()
				arg_12_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_15_3), SFX_PANEL))
	arg_12_0.taskUIItemList.align(#arg_12_0.curTaskIDList)

	local var_12_2 = True

	for iter_12_0, iter_12_1 in ipairs(arg_12_0.curTaskIDList):
		if (arg_12_0.taskProxy.getTaskById(iter_12_1) or arg_12_0.taskProxy.getFinishTaskById(iter_12_1)).getTaskStatus() != 2:
			var_12_2 = False
	...
	if var_12_2:
		...
		if var_12_4:
			pg.NewStoryMgr.GetInstance().Play(var_12_4, None)

	if arg_12_0.maxday <= arg_12_0.progressStep:
		var_12_2 = False
	...
	onButton(arg_12_0, arg_12_0.backBtn, function()
		arg_12_0.resetIndex(), SFX_CANCEL)
...
def var_0_0.checkAward(arg_21_0):
	if arg_21_0.isGotFinalAward == 0 and arg_21_0.progressStep == arg_21_0.groupNum:
		if arg_21_0.curTaskIDList:
			local var_21_0 = True

			for iter_21_0, iter_21_1 in ipairs(arg_21_0.curTaskIDList):
				if (arg_21_0.taskProxy.getTaskById(iter_21_1) or arg_21_0.taskProxy.getFinishTaskById(iter_21_1)).getTaskStatus() != 2:
					var_21_0 = False

					break

			if var_21_0 and arg_21_0.activity.data4 != 0 and arg_21_0.activity.data3 == arg_21_0.groupNum:
