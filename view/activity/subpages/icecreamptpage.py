...
def var_0_0.findUI(arg_5_0):
	...
	for iter_5_1, iter_5_2 in ipairs(arg_5_0.mainToggleTFList):
...
def var_0_0.addListener(arg_6_0):
	if IsUnityEditor:
		...
		onButton(arg_6_0, var_6_0, function()
			for iter_7_0 = 1, 4:
				...
				PlayerPrefs.SetInt(var_7_0, 0), SFX_PANEL)
	...
	onButton(arg_6_0, arg_6_0.battleBtn, function()
		arg_6_0.emit(ActivityMediator.SPECIAL_BATTLE_OPERA), SFX_PANEL)
	onButton(arg_6_0, arg_6_0.openBtn, function()
		arg_6_0.openMainPanel(), SFX_PANEL)
	...
	onButton(arg_6_0, arg_6_0.shareBtn, function()
		arg_6_0.share(), SFX_PANEL)

def var_0_0.initMainPanel(arg_15_0):
	onButton(arg_15_0, arg_15_0.backBG, function()
		arg_15_0.closeSpecial()

		if arg_15_0.isFinished():
			setActive(arg_15_0.openBtn, True), SFX_CANCEL)

	for iter_15_0, iter_15_1 in ipairs(arg_15_0.mainToggleTFList):
		onToggle(arg_15_0, iter_15_1, function(arg_17_0)
				...
				for iter_17_1 = 1, 3:
					...
					onToggle(arg_15_0, var_17_3[iter_17_1], function(arg_18_0)
						if arg_18_0 == True:
							...
							arg_15_0.curSelectIndex = 0, SFX_PANEL)
			...
			arg_15_0.updateMainSelectPanel(), SFX_PANEL)

	onButton(arg_15_0, arg_15_0.selectBtn, function()
		if not arg_15_0.isFinished():
			if arg_15_0.curSelectIndex:
...
def var_0_0.updateIcecream(arg_48_0, arg_48_1):
	...
	if var_48_6:
		for iter_48_0, iter_48_1 in pairs(var_48_0):
			if iter_48_1 > 0 and iter_48_0 > 1:
				var_48_6 = False
	...
	if var_48_0[2] and var_48_0[2] > 0:
	...
	if var_48_0[3] and var_48_0[3] > 0:
	...
	if var_48_0[4] and var_48_0[4] > 0:
...
def var_0_0.updateMainSelectPanel(arg_49_0):
	...
	if arg_49_0.selectedList[2] and arg_49_0.selectedList[2] > 0:
	...
	if arg_49_0.selectedList[3] and arg_49_0.selectedList[3] > 0:
	...
	if arg_49_0.selectedList[4] and arg_49_0.selectedList[4] > 0:
...
def var_0_0.isFinished(arg_50_0):
	return #arg_50_0.activity.data2_list == 4

def var_0_0.changeIndexSelect(arg_51_0):
...
def var_0_0.getSelectedList(arg_52_0):
	...
	for iter_52_0, iter_52_1 in ipairs(arg_52_0.activity.data2_list):
		arg_52_0.selectedList[iter_52_0] = iter_52_1

	if arg_52_0.isFinished():
		for iter_52_2 = 1, 4:
...
def var_0_0.saveSelectedList(arg_53_0):
	for iter_53_0 = 1, 4:
...
def var_0_0.share(arg_54_0):
	PoolMgr.GetInstance().GetUI("IcecreamSharePage", False, function(arg_55_0)
		...
		if arg_54_0.shareGo:
			...
			arg_54_0.shareGo = None)

def var_0_0.initSD(arg_56_0):
