...
def var_0_0.OnFirstFlush(arg_3_0):
	arg_3_0.uilist.make(function(arg_4_0, arg_4_1, arg_4_2)
		if arg_4_0 == UIItemList.EventInit:
			...
			onButton(arg_3_0, arg_4_2, function()
				arg_3_0.emit(BaseUI.ON_DROP, var_4_3), SFX_PANEL)
	...
	onButton(arg_3_0, arg_3_0.signBtn, function()
		if not arg_3_0.remainCnt or arg_3_0.remainCnt <= 0:
			return
		...
		seriesAsync({
			function(arg_7_0)
				...
				if checkExist(var_7_0, {
					...
					arg_7_0(),
			function(arg_8_0)
				if arg_3_0.curTaskVO.getTaskStatus() == 1:
	...
	onButton(arg_3_0, arg_3_0.linerBtn, function()
		if arg_3_0.IsLockLiner():
			return

		seriesAsync({
			function(arg_14_0)
				if arg_3_0.preStory and arg_3_0.preStory != "" and not pg.NewStoryMgr.GetInstance().IsPlayed(arg_3_0.preStory):
					pg.NewStoryMgr.GetInstance().Play(arg_3_0.preStory, arg_14_0)
				else
					arg_14_0()
		}, function()
			arg_3_0.emit(ActivityMediator.EVENT_GO_SCENE, SCENE.LINER)), SFX_PANEL)
...
def var_0_0.OnUpdateFlush(arg_16_0):
	...
	if not var_16_0:
		...
		if arg_16_0.curTaskVO.getTaskStatus() == 1:
...
def var_0_0.IsFinishSign(arg_17_0):
...
def var_0_0.IsLockLiner(arg_19_0):
