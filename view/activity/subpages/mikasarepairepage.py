...
def var_0_0.update_task_list_mikasa_museum(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
	...
	for iter_4_0 = 1, 4:
		...
		for iter_4_1 = 1, 4:
			...
			if not var_4_9[iter_4_0]:
				var_4_9[iter_4_0] = var_4_0.getTaskById(var_4_15) and var_4_15 or None
		...
		onButton(arg_4_0, var_4_13, function()
			arg_4_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_4_0.getTaskById(var_4_9[iter_4_0])), SFX_PANEL)
		setActive(var_4_12.Find("gear"), not var_4_23.isFinish())

		if not var_4_23.isFinish():
		...
		local var_4_27 = var_4_26 and (var_4_0.getTaskById(var_4_26) or var_4_0.getFinishTaskById(var_4_26)) or None
	...
	onButton(arg_4_0, var_4_28, function()
		if not var_4_30.isFinish():
			...
			if _.all(_.flatten({
				...
				return var_4_0.getFinishTaskById(arg_8_0) != None):
			...
			arg_4_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_4_30), SFX_PANEL)
...
def var_0_0.set_mikasa_btn(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5):
	...
	if var_9_1.getConfig("sub_type") == 90 and arg_9_5:
		for iter_9_0, iter_9_1 in ipairs(arg_9_5):
			if iter_9_1[1] == arg_9_1 and iter_9_1[2] == var_9_1.getProgress() and not pg.NewStoryMgr.GetInstance().IsPlayed(iter_9_1[3]):
