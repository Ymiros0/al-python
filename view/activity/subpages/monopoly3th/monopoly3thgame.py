...
def var_0_0.initUI(arg_4_0):
	...
	for iter_4_0 = 1, 3:
		...
		for iter_4_1 = 1, var_4_0.childCount:
	...
	PoolMgr.GetInstance().GetSpineChar(var_4_2, True, function(arg_5_0)
		...
		arg_4_0.changeCharAction(var_0_11, 0, None)
...
def var_0_0.initEvent(arg_6_0):
	onButton(arg_6_0._binder, arg_6_0.btnStart, function()
		...
		arg_6_0._event.emit(Monopoly3thPage.ON_START, arg_6_0.activity.id, function(arg_8_0)
			if arg_8_0 and arg_8_0 > 0:
				...
				arg_6_0.updataUI()
				arg_6_0.checkCharActive()), SFX_PANEL)
	...
	onButton(arg_6_0._binder, arg_6_0.char, function()
		...
		if LeanTween.isTweening(go(arg_6_0.cellPos)):
			LeanTween.cancel(go(arg_6_0.cellPos))

		arg_6_0.changeCharAction(var_0_15, 1, function()
			arg_6_0.changeCharAction(var_0_11)), SFX_PANEL)
	onButton(arg_6_0._binder, arg_6_0.btnRp, function()
		if arg_6_0.leftAwardCnt > 0:
			arg_6_0._event.emit(Monopoly3thPage.ON_AWARD), SFX_PANEL)

def var_0_0.checkPlayerRandomMove(arg_13_0):
	if not arg_13_0.model or arg_13_0.inAnimatedFlag:
		return
	...
	if math.random() > 0.5:
		...
		arg_13_0.changeCharAction(var_0_10, 0, None)
		LeanTween.value(go(arg_13_0.cellPos), 0, var_13_1, var_13_2).setEase(LeanTweenType.linear).setOnUpdate(System.Action_float(function(arg_14_0)
			...
			var_13_3 = arg_14_0)).setOnComplete(System.Action(function()
			arg_13_0.changeCharAction(var_0_11, 0, None)))
	else
		arg_13_0.changeCharAction(var_0_12, 1, function()
			arg_13_0.changeCharAction(var_0_11))

def var_0_0.checkCountStory(arg_17_0, arg_17_1):
...
def var_0_0.changeAnimeState(arg_19_0, arg_19_1):
	if arg_19_1:
...
def var_0_0.checkCharActive(arg_20_0):
	if arg_20_0.anim:
		if arg_20_0.effectId and arg_20_0.effectId > 0:
			arg_20_0.changeAnimeState(True)
			arg_20_0.checkEffect(function()
				arg_20_0.changeAnimeState(False)
				arg_20_0.checkCharActive())
		elif arg_20_0.step and arg_20_0.step > 0:
			arg_20_0.changeAnimeState(True)
...
def var_0_0.firstUpdata(arg_23_0, arg_23_1):
	...
	if arg_23_0.pos and arg_23_0.pos > 0:
		arg_23_0.updateMap(arg_23_0.pos * 1100 % 2500)

def var_0_0.updataActivity(arg_24_0, arg_24_1):
	arg_24_0.activityDataUpdata(arg_24_1)
	arg_24_0.updataUI()

def var_0_0.checkLastBonus(arg_25_0):
	if (not arg_25_0.lastBonusFlag or arg_25_0.lastBonusFlag == 0) and arg_25_0.useCount and arg_25_0.useCount >= arg_25_0.lastBonusTimes:
	...
	if arg_25_0.lastBonusFlag == 1:
		setActive(findTF(arg_25_0.labelDropShip, "get"), False)
		setActive(findTF(arg_25_0.labelDropShip, "got"), True)
		setActive(findTF(arg_25_0.labelDropShip, "text"), False)

def var_0_0.activityDataUpdata(arg_27_0, arg_27_1):
...
def var_0_0.checkStep(arg_28_0, arg_28_1):
	if arg_28_0.step > 0:
...
def var_0_0.updataUI(arg_33_0):
	...
	LeanTween.delayedCall(go(arg_33_0.btnRp), 1, System.Action(function()
		if arg_33_0.commonAnim.isActiveAndEnabled:
...
def var_0_0.updataChar(arg_35_0):
	if not isActive(arg_35_0.char):
		SetActive(arg_35_0.char, True)
		arg_35_0.char.SetAsLastSibling()

def var_0_0.checkEffect(arg_36_0, arg_36_1):
	if arg_36_0.effectId > 0:
			...
			function(arg_37_0)
				if var_36_1:
					arg_36_0.changeCharAction(var_36_1, 1, function()
						arg_36_0.changeCharAction(var_0_11, 0, None)
						arg_37_0())
				else
					arg_37_0(),
			function(arg_39_0)
				if var_36_0 and tonumber(var_36_0) != 0:
...
def var_0_0.moveCharWithPaths(arg_46_0, arg_46_1, arg_46_2, arg_46_3):
	if not arg_46_1 or #arg_46_1 <= 0:
		if arg_46_3:
			arg_46_3()
	...
	table.insert(var_46_0, function(arg_47_0)
		...
		arg_46_0.changeCharAction(arg_46_2, 0, None)

		local var_47_3 = var_47_1 / (var_47_0 / 0.6)
		local var_47_4 = 0

		if LeanTween.isTweening(go(arg_46_0.cellPos)):
		...
		LeanTween.value(go(arg_46_0.cellPos), 0, var_47_1, var_47_0).setEase(LeanTweenType.linear).setOnUpdate(System.Action_float(function(arg_48_0)
			...
			var_47_2 = arg_48_0)).setOnComplete(System.Action(function()
			arg_47_0())))
	table.insert(var_46_0, function(arg_50_0)
		arg_46_0.changeCharAction(var_0_11, 0, None)
		arg_50_0())
	seriesAsync(var_46_0, arg_46_3)

def var_0_0.createCell(arg_51_0, arg_51_1):
...
def var_0_0.updateMap(arg_52_0, arg_52_1):
	for iter_52_0 = 1, #arg_52_0.mapCells:
	...
	for iter_52_3 = 1, #arg_52_0.groundChildsList:
		local var_52_5 = arg_52_0.groundChildsList[iter_52_3]

		for iter_52_4 = #var_52_5, 1, -1:
			local var_52_6 = var_52_5[iter_52_4]

			if var_52_6.anchoredPosition.x <= -var_52_6.sizeDelta.x and #var_52_5 > 1:
...
def var_0_0.changeCharAction(arg_53_0, arg_53_1, arg_53_2, arg_53_3):
	if arg_53_0.actionName == arg_53_1 and arg_53_0.actionName != var_0_13:
		return

	arg_53_0.actionName = arg_53_1

	arg_53_0.anim.SetActionCallBack(None)
	...
	if arg_53_2 != 1 and arg_53_3:
		arg_53_3()

def var_0_0.getActionName(arg_55_0, arg_55_1):
	local var_55_0 = arg_55_0.mapIds[arg_55_1]
	local var_55_1 = pg.activity_event_monopoly_map[var_55_0].icon

	if var_55_1 == "icon_1":
		return var_0_9
	elif var_55_1 == "icon_2":
		return var_0_7
	elif var_55_1 == "icon_3":
		return None
	elif var_55_1 == "icon_4":
		return var_0_9
	elif var_55_1 == "icon_5":
		return var_0_8
	elif var_55_1 == "icon_6":
		return var_0_9

	return var_0_9

def var_0_0.dispose(arg_56_0):
	if arg_56_0.model:
		PoolMgr.GetInstance().ReturnSpineChar(var_0_1, arg_56_0.model)

	if arg_56_0.randomMoveTiemr:
		if arg_56_0.randomMoveTiemr.running:
			arg_56_0.randomMoveTiemr.Stop()

		arg_56_0.randomMoveTiemr = None

	if LeanTween.isTweening(go(arg_56_0.btnRp)):
		LeanTween.cancel(go(arg_56_0.btnRp))

	if LeanTween.isTweening(go(arg_56_0.cellPos)):
