...
def var_0_0.initEvent(arg_4_0):
	...
	for iter_4_0 = 1, #arg_4_0.showChars:
	...
	onButton(arg_4_0._binder, arg_4_0.btnRp, function()
		if arg_4_0.leftAwardCnt > 0:
			arg_4_0._event.emit(MonopolyCar2Page.ON_AWARD), SFX_PANEL)
...
def var_0_0.initChar(arg_31_0):
	...
	for iter_31_0 = 1, #arg_31_0.showCharNames:
...
def var_0_0.dispose(arg_69_0):
	...
	for iter_69_0 = 1, 3:
		if arg_69_0.showCharNames[iter_69_0]:
