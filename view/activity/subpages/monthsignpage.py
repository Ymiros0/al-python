...
def var_0_0.OnInit(arg_1_0):
	...
	arg_1_0.monthSignReSignUI = MonthSignReSignUI.New(arg_1_0._tf, arg_1_0.event, None)

	arg_1_0.bind(var_0_0.SHOW_RE_MONTH_SIGN, function(arg_2_0, arg_2_1, arg_2_2)
		if not arg_1_0.monthSignReSignUI.GetLoaded():
...
def var_0_0.OnDataSetting(arg_3_0):
	...
	if tonumber(pg.TimeMgr.GetInstance().STimeDescS(var_3_0, "%m")) == pg.activity_template[ActivityConst.MONTH_SIGN_ACTIVITY_ID].config_client[1]:
...
def var_0_0.OnUpdateFlush(arg_8_0):
	...
	if var_8_3 and #var_8_3 > 0:
		...
		if not table.contains(MonthSignPage.MONTH_SIGN_SHOW, arg_8_0.activity.id .. "." .. var_8_4):
			table.insert(MonthSignPage.MONTH_SIGN_SHOW, arg_8_0.activity.id .. "." .. var_8_4)

			if not arg_8_0.monthSignReSignUI.GetLoaded():
				arg_8_0.monthSignReSignUI.Load()

			arg_8_0.monthSignReSignUI.ActionInvoke("setAwardShow", var_8_3)
		elif arg_8_0.monthSignReSignUI:
			arg_8_0.monthSignReSignUI.ActionInvoke("setAwardShow", var_8_3)

def var_0_0.showReMonthSign(arg_9_0):
	return

def var_0_0.OnDestroy(arg_10_0):
	removeAllChildren(arg_10_0.items)

	arg_10_0.monthSignPageTool = None

	arg_10_0.monthSignReSignUI.Destroy()

	arg_10_0.monthSignReSignUI = None

def var_0_0.UseSecondPage(arg_11_0, arg_11_1):
	return tonumber(pg.TimeMgr.GetInstance().CurrentSTimeDesc("%m", True)) == pg.activity_template[arg_11_1.id].config_client[1]

def var_0_0.isDirtyRes(arg_12_0):
	if arg_12_0.specialTag and arg_12_0.getUIName() != arg_12_0.activity.getConfig("page_info").ui_name2:
		return True
