	...
	arg_3_0.uilist.make(function(arg_4_0, arg_4_1, arg_4_2)
		if arg_4_0 == UIItemList.EventUpdate:
			...
			onButton(arg_3_0, var_4_1, function()
				arg_3_0.emit(BaseUI.ON_DROP, var_4_5), SFX_PANEL)
			...
			onButton(arg_3_0, var_4_8, function()
				arg_3_0.emit(ActivityMediator.ON_TASK_GO, var_4_3), SFX_PANEL)
			onButton(arg_3_0, var_4_9, function()
				arg_3_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_4_3), SFX_PANEL))
	arg_3_0.itemList.make(function(arg_8_0, arg_8_1, arg_8_2)
		if arg_8_0 == UIItemList.EventInit:
			...
			onButton(arg_3_0, arg_8_2, function()
				arg_3_0.emit(BaseUI.ON_DROP, var_8_1), SFX_PANEL)
		elif arg_8_0 == UIItemList.EventUpdate:
