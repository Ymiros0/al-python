...
def var_0_0.OnFirstFlush(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.rightStage.Find("battle_btn"), function()
		arg_5_0.emit(ActivityMediator.SPECIAL_BATTLE_OPERA), SFX_PANEL)
...
def var_0_0.SetAction(arg_10_0, arg_10_1):
	if not arg_10_0.spine:
		return
...
def var_0_0.OnUpdateFlush(arg_11_0):
	...
	if arg_11_0.usmLRQ and arg_11_0.usmLRQ.name != var_11_2:
		arg_11_0.usmLRQ.Stop()

		arg_11_0.usmLRQ = None

	if arg_11_0.usmName != var_11_2:
		arg_11_0.usmLRQ = LoadPrefabRequestPackage.New(var_11_1 .. "/" .. var_11_2, var_11_2, function(arg_12_0)
			if not IsNil(arg_11_0.usm):
				Destroy(arg_11_0.usm)

			arg_11_0.usm = arg_12_0

			setParent(arg_12_0, arg_11_0.bg.Find("usm"))).Start()
...
def var_0_0.UpdateTaskList(arg_13_0):
	...
	if not arg_13_0.startTaskid:
		arg_13_0.startTaskid = var_13_8
		arg_13_0.startStatus = var_13_14

	local var_13_17 = False

	if arg_13_0.startTaskid != var_13_8:
		arg_13_0.startTaskid = var_13_8
		arg_13_0.startStatus = var_13_14
		var_13_17 = True
	elif arg_13_0.startStatus != var_13_14:
		arg_13_0.startStatus = var_13_14
		var_13_17 = True

	local var_13_18 = arg_13_0.GetCurrentDay()

	if var_13_17 and var_13_18 > arg_13_0.startDay:
	...
	if var_13_16 == 2:
		...
		onButton(arg_13_0, var_13_3, function()
			...
			if var_14_0 > arg_13_0.startDay:
				...
				arg_13_0.OnUpdateFlush(), SFX_PANEL)
	...
	if arg_13_0.ptData.level >= #arg_13_0.ptData.targets and arg_13_0.nday >= #arg_13_0.taskGroup and var_13_14 == 2 and arg_13_0.nday2 >= #arg_13_0.taskGroup2 and var_13_15 == 2:
		setActive(var_13_3, False)

		var_13_20 = var_13_2
		var_13_21 = var_13_13
	elif arg_13_0.nday <= arg_13_0.nday2 and var_13_14 != 2:
		setActive(var_13_2, False)
	...
	onButton(arg_13_0, var_13_5, function()
		arg_13_0.emit(BaseUI.ON_DROP, var_13_24), SFX_PANEL)
	...
	onButton(arg_13_0, var_13_1, function()
		arg_13_0.emit(ActivityMediator.ON_TASK_GO, var_13_21), SFX_PANEL)
	onButton(arg_13_0, var_13_20, function()
		arg_13_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_13_21), SFX_PANEL)

def var_0_0.UpdatePTList(arg_18_0):
	if not arg_18_0.ptData:
		return
...
def var_0_0.OnDestroy(arg_19_0):
	if arg_19_0.spineLRQ:
		arg_19_0.spineLRQ.Stop()

		arg_19_0.spineLRQ = None
