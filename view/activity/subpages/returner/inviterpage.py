...
def var_0_0.Init(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0.pushBtn, function()
		...
		if not arg_2_0.returners or #arg_2_0.returners >= 3:
...
def var_0_0.Update(arg_7_0, arg_7_1):
	...
	if not ActivityMainScene.FetchReturnersTime or var_7_0 >= ActivityMainScene.FetchReturnersTime:
...
def var_0_0.getTotalPt(arg_8_0, arg_8_1):
	local var_8_0 = 0

	for iter_8_0, iter_8_1 in ipairs(arg_8_0.returners):
...
def var_0_0.UpdateData(arg_9_0):
	...
	for iter_9_0 = 1, #arg_9_0.targets:
		local var_9_1 = arg_9_0.targets[iter_9_0]

		if not table.contains(arg_9_0.fetchList, var_9_1):
			arg_9_0.nextIndex = iter_9_0

			break

	if arg_9_0.nextIndex == -1:
...
def var_0_0.UpdateTasks(arg_12_0, arg_12_1):
	if arg_12_0.isPush:
		...
		for iter_12_0 = #arg_12_1, 1, -1:
			if arg_12_0.getTask(arg_12_1[iter_12_0]):
				var_12_3 = iter_12_0
		...
		if (not var_12_4 or var_12_4.isReceive()) and var_12_3 < var_12_1:
			if var_12_3 == #arg_12_1 and var_12_4 and var_12_4.isReceive():
...
def var_0_0.UpdateTaskTF(arg_13_0, arg_13_1):
	...
	onButton(arg_13_0, arg_13_0.taskGoBtn, function()
		arg_13_0._event.emit(ActivityMediator.ON_TASK_GO, arg_13_1), SFX_PANEL)
	onButton(arg_13_0, arg_13_0.taskGetBtn, function()
		arg_13_0._event.emit(ActivityMediator.ON_TASK_SUBMIT, arg_13_1), SFX_PANEL)

local function var_0_1(arg_16_0, arg_16_1)
	LoadSpriteAsync("qicon/" .. arg_16_1.getPainting(), function(arg_17_0)
		if not IsNil(arg_16_0):
...
def var_0_0.UpdateReturners(arg_18_0):
...
def var_0_0.Dispose(arg_20_0):
	pg.DelegateInfo.Dispose(arg_20_0)

	arg_20_0.bg.sprite = None
