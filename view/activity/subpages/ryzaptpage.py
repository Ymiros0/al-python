...
def var_0_0.OnUpdateFlush(arg_7_0):
	...
	if isActive(arg_7_0.getBtn) and arg_7_0.specialPhase[var_7_0]:
		setActive(arg_7_0.getBtn, False)
		setActive(arg_7_0.feedBtn, True)
	else
		setActive(arg_7_0.feedBtn, False)

def var_0_0.UpdateSpineIdle(arg_8_0, arg_8_1):
	arg_8_0.kalaAnim.SetAction("pt_ui", 0)

	if arg_8_1 > arg_8_0.puniPhaseCfg[#arg_8_0.puniPhaseCfg]:
...
def var_0_0.PlayKalaAnim(arg_13_0, arg_13_1):
	arg_13_0.kalaAnim.SetActionCallBack(function(arg_14_0)
		if arg_14_0 == "finish":
			arg_13_0.kalaAnim.SetActionCallBack(None)
...
def var_0_0.InitAnimData(arg_17_0):
	...
	for iter_17_2 = 1, arg_17_0.puniPhaseCfg[#arg_17_0.puniPhaseCfg]:
		local var_17_3 = {}

		table.insert(var_17_3, "normal_" .. var_17_2)

		if arg_17_0.specialPhase[iter_17_2]:
...
def var_0_0.GetAnimName(arg_18_0, arg_18_1):
	local var_18_0 = arg_18_1 and arg_18_1 or arg_18_0.ptData.GetLevelProgress()

	if var_18_0 > arg_18_0.puniPhaseCfg[#arg_18_0.puniPhaseCfg]:
...
def var_0_0.OnShowFlush(arg_19_0):
