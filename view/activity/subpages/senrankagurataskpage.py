...
def var_0_0.OnUpdateFlush(arg_4_0):
	...
	if arg_4_0.markClickPos and arg_4_0.markClickPos > 0:
		print("有操作再更新任务面板")
		arg_4_0.openTaskAni()
	elif var_4_0 > 0:
		if arg_4_0.activity.data4 <= arg_4_0.groupNum:
			print("直接更新任务面板")
		...
		if arg_4_0.getStep() > arg_4_0.groupNum:
			-- block empty
...
def var_0_0.findUI(arg_6_0):
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_0.nameList):
	...
	for iter_6_2, iter_6_3 in ipairs(var_6_4):
	...
	for iter_6_4 = 1, #arg_6_0.nameList:
		...
		onButton(arg_6_0, var_6_9, function()
			...
			if var_7_0 < arg_6_0.getCurDayCount() and var_7_0 < arg_6_0.groupNum:
				arg_6_0.markClickPos = iter_6_4

				arg_6_0.selectPos(iter_6_4), SFX_PANEL)
	...
	for iter_6_5 = 1, #arg_6_0.nameList:
...
def var_0_0.updatePosPanel(arg_8_0):
...
def var_0_0.updateTaskPanel(arg_9_0):
	arg_9_0.updateTaskList()
	arg_9_0.updateProgress()
	arg_9_0.updatePainting()

def var_0_0.updateTaskList(arg_10_0):
	local var_10_0 = arg_10_0.getCurTaskIDList()

	for iter_10_0, iter_10_1 in ipairs(arg_10_0.taskTFList):
		...
		onButton(arg_10_0, var_10_11, function()
			arg_10_0.emit(ActivityMediator.ON_TASK_GO, var_10_2), SFX_PANEL)
		...
		onButton(arg_10_0, var_10_14, function()
			arg_10_0.emit(BaseUI.ON_DROP, var_10_13), SFX_PANEL)

		if arg_10_0.isFinishedCurTaskList():
			...
			if var_10_16:
				pg.NewStoryMgr.GetInstance().Play(var_10_16, None)

def var_0_0.updateProgress(arg_14_0):
	local var_14_0 = arg_14_0.getStep()

	for iter_14_0, iter_14_1 in ipairs(arg_14_0.progressTFList):
...
def var_0_0.updatePainting(arg_15_0):
...
def var_0_0.openTaskAni(arg_16_0):
	...
	local var_16_8 = System.Action(function()
		...
		if var_18_1:
			pg.NewStoryMgr.GetInstance().Play(var_18_1, function()
				...
				setActive(arg_16_0.taskPanel, True), True, True)
		else
			arg_16_0.updateTaskPanel()
			setActive(arg_16_0.posPanel, False)
			setActive(arg_16_0.taskPanel, True)

		arg_16_0.markClickPos = None)

	var_16_3.SetAsLastSibling()
	arg_16_0.managedTween(LeanTween.value, None, go(var_16_3), var_16_7, 0, 1, 0.5).setOnComplete(var_16_8)

	arg_16_0.tweenTF = var_16_3

def var_0_0.check(arg_20_0):
	if not arg_20_0.isGotFinalAward():
		local var_20_0 = arg_20_0.getStep()

		if var_20_0 <= arg_20_0.groupNum and arg_20_0.getCurTaskIDList() and arg_20_0.isFinishedCurTaskList():
			print("清除位置")
			arg_20_0.resetPos()

		if var_20_0 == arg_20_0.groupNum and not arg_20_0.getCurTaskIDList():
			print("领取最终奖励")
			arg_20_0.getFinalAward()

def var_0_0.isGotFinalAward(arg_21_0):
	return arg_21_0.activity.data2 > 0

def var_0_0.getStep(arg_22_0):
	return arg_22_0.activity.data3

def var_0_0.getCurIndex(arg_23_0):
	return arg_23_0.activity.data4

def var_0_0.getCurTaskIDList(arg_24_0):
	local var_24_0 = arg_24_0.getCurIndex()

	return arg_24_0.configData.task_table[var_24_0]

def var_0_0.isFinishedCurTaskList(arg_25_0):
...
def var_0_0.getCurDayCount(arg_27_0):
