...
def var_0_0.OnUpdateFlush(arg_3_0):
	...
	for iter_3_0 = 1, 2:
		...
		onButton(arg_3_0, var_3_4, function()
			arg_3_0.emit(BaseUI.ON_DROP, var_3_8), SFX_PANEL)
		...
		onButton(arg_3_0, var_3_11, function()
			arg_3_0.emit(ActivityMediator.ON_TASK_GO, var_3_6), SFX_PANEL)
		onButton(arg_3_0, var_3_12, function()
			arg_3_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_3_6), SFX_PANEL)
