...
def var_0_0.OnInit(arg_1_0):
	...
	if not var_1_1 or not var_1_1.isShow():
...
def var_0_0.switchNextPaint(arg_4_0):
	...
	local var_4_3 = None or LoadSprite(var_4_2, var_4_1)
...
def var_0_0.initBtnEvent(arg_11_0, arg_11_1, arg_11_2):
	if arg_11_2 == 1:
		...
		onButton(arg_11_0, arg_11_1, function()
			arg_11_0.emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.ACTIVITY_TYPE_RETURN_AWARD_ID6), SFX_PANEL)
	elif arg_11_2 == 4:
		onButton(arg_11_0, arg_11_1, function()
			arg_11_0.emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.SIX_SIGN_ACT_ID), SFX_PANEL)
	elif arg_11_2 == 5:
		onButton(arg_11_0, arg_11_1, function()
...
def var_0_0.OnDestroy(arg_20_0):
	if LeanTween.isTweening(go(arg_20_0.paintFrontTF)):
