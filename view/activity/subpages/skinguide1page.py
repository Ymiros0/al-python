...
def var_0_0.OnFirstFlush(arg_3_0):
	...
	for iter_3_0 = 1, #arg_3_0.taskList:
		...
		onButton(arg_3_0, findTF(var_3_8, "normal"), function()
			arg_3_0.selectedChange(var_3_1), SFX_PANEL)

		if var_3_4.getTaskStatus() == 1 and arg_3_0.remainCnt > 0:
			var_3_0 = iter_3_0

	arg_3_0.updateUI()
	arg_3_0.selectedChange(var_3_0)

def var_0_0.selectedChange(arg_7_0, arg_7_1):
	for iter_7_0 = 1, #arg_7_0.itemTfs:
	...
	if arg_7_0.selectedIndex != arg_7_1:
...
def var_0_0.updateUI(arg_9_0):
	for iter_9_0 = 1, #arg_9_0.itemTfs:
...
def var_0_0.OnLoadLayers(arg_10_0):
	return

def var_0_0.OnRemoveLayers(arg_11_0):
	return
