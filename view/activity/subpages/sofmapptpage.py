...
def var_0_0.OnUpdateFlush(arg_8_0):
	...
	if var_8_3 <= var_0_0.SpineActionByStep[1]:
		arg_8_0.shopAnim.SetAction("stand2", 0)
	elif var_8_3 <= var_0_0.SpineActionByStep[2]:
		arg_8_0.shopAnim.SetAction("stand1", 0)
	elif var_8_3 <= var_0_0.SpineActionByStep[3]:
		arg_8_0.shopAnim.SetAction("stand1x2", 0)
	elif var_8_3 <= var_0_0.SpineActionByStep[4]:
		arg_8_0.shopAnim.SetAction("stand1x4", 0)
	elif var_8_3 <= var_0_0.SpineActionByStep[5]:
		arg_8_0.shopAnim.SetAction("stand1x8", 0)

	if not arg_8_0.showBubbleTag:
		arg_8_0.showBubble()
...
def var_0_0.showBubble(arg_10_0, arg_10_1):
	local var_10_0

	if not arg_10_1:
		if isActive(arg_10_0.battleBtn):
			var_10_0 = i18n("sofmapsd_1")
		elif isActive(arg_10_0.getBtn):
			var_10_0 = i18n("sofmapsd_2")
		elif isActive(arg_10_0.gotBtn):
