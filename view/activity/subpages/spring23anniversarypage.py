...
def var_0_0.findUI(arg_2_0):
	...
	for iter_2_3 = 1, var_2_0 * 3:
		if table.contains(arg_2_0.hideIndex, (iter_2_3 - 1) % var_0_5 + 1) or not arg_2_0.scrollAble and iter_2_3 > var_0_5:
...
def var_0_0.initData(arg_3_0):
	...
	if arg_3_0.displayDatas and #arg_3_0.displayDatas:
		for iter_3_0 = 1, #arg_3_0.displayDatas:
			local var_3_1 = arg_3_0.displayDatas[iter_3_0]
			local var_3_2 = var_3_1[1]
			local var_3_3 = var_3_1[2]

			if var_3_3 and var_3_3 != 0:
	...
	if var_3_0 and #var_3_0 > 0:
		for iter_3_1 = #var_0_2, 1, -1:
			local var_3_7 = var_0_2[iter_3_1]

			if table.contains(var_3_0, var_3_7):
...
def var_0_0.initBtnList(arg_11_0, arg_11_1):
	for iter_11_0 = 1, #arg_11_1:
		arg_11_0.initBtnEvent(arg_11_1[iter_11_0], iter_11_0)

def var_0_0.initBtnEvent(arg_12_0, arg_12_1, arg_12_2):
	if arg_12_2 == 1:
		onButton(arg_12_0, arg_12_1, function()
			arg_12_0.emit(ActivityMediator.GO_PRAY_POOL), SFX_PANEL)
	elif arg_12_2 == 2:
		onButton(arg_12_0, arg_12_1, function()
			arg_12_0.emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.ACTIVITY_TYPE_RETURN_AWARD_ID5), SFX_PANEL)
	elif arg_12_2 == 3:
		onButton(arg_12_0, arg_12_1, function()
			arg_12_0.emit(ActivityMediator.EVENT_GO_SCENE, var_0_6), SFX_PANEL)
	elif arg_12_2 == 4:
		onButton(arg_12_0, arg_12_1, function()
			arg_12_0.emit(ActivityMediator.GO_MINI_GAME, var_0_1), SFX_PANEL)
	elif arg_12_2 == 5:
		onButton(arg_12_0, arg_12_1, function()
			arg_12_0.emit(ActivityMediator.EVENT_GO_SCENE, SCENE.SUMMARY), SFX_PANEL)
	elif arg_12_2 == 6:
		onButton(arg_12_0, arg_12_1, function()
...
def var_0_0.initTimer(arg_19_0):
	...
	arg_19_0.frameTimer = Timer.New(function()
		...
		if arg_19_0.paintStaticCountValue >= arg_19_0.paintStaticTime:
			arg_19_0.paintStaticCountValue = 0

			arg_19_0.switchNextPaint(), var_19_0, -1, False)

	arg_19_0.frameTimer.Start()

	if arg_19_0.scrollAble:
		arg_19_0.frameTimer2 = Timer.New(function()
			...
			if arg_19_0.startAnchoredPosX - var_21_0 >= arg_19_0.moveLength:
				var_21_0 = arg_19_0.btnContainer.anchoredPosition.x + arg_19_0.moveLength

			arg_19_0.btnContainer.anchoredPosition = Vector3(var_21_0, 0, 0), var_19_0, -1, False)

		arg_19_0.frameTimer2.Start()

def var_0_0.OnDestroy(arg_22_0):
	if LeanTween.isTweening(go(arg_22_0.paintFrontTF)):
		LeanTween.cancel(go(arg_22_0.paintFrontTF))

	if arg_22_0.frameTimer:
		arg_22_0.frameTimer.Stop()

		arg_22_0.frameTimer = None

	if arg_22_0.frameTimer2:
		arg_22_0.frameTimer2.Stop()

		arg_22_0.frameTimer2 = None
