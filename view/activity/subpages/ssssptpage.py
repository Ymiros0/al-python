...
def var_0_0.OnFirstFlush(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0.monster, function()
		if arg_2_0.monster.localScale.x == var_0_1[#var_0_1][2]:
			arg_2_0.OpenMonsterWin(), SFX_PANEL)
	onButton(arg_2_0, arg_2_0.findTF("close", arg_2_0.window), function()
		setActive(arg_2_0.window, False), SFX_PANEL)
...
def var_0_0.OnUpdateFlush(arg_10_0):
	...
	if isActive(arg_10_0.getBtn) and arg_10_0.IsSpecialPhase():
		setActive(arg_10_0.getBtn, False)
		setActive(arg_10_0.feedBtn, True)
	else
		setActive(arg_10_0.feedBtn, False)

def var_0_0.IsSpecialPhase(arg_11_0):
	local var_11_0 = arg_11_0.ptData.GetLevelProgress()
	local var_11_1 = False

	for iter_11_0, iter_11_1 in ipairs(var_0_1):
		if var_11_0 == iter_11_1[1]:
			var_11_1 = True

	return var_11_1

def var_0_0.GetMonsterScale(arg_12_0, arg_12_1):
	local var_12_0 = 1

	for iter_12_0, iter_12_1 in ipairs(var_0_1):
		if arg_12_1 > iter_12_1[1]:
			var_12_0 = iter_12_1[2]

	return var_12_0

def var_0_0.UpdateMonster(arg_13_0):
...
def var_0_0.PlayFeedAni(arg_14_0):
	...
	arg_14_0.managedTween(LeanTween.moveX, function()
		arg_14_0.PlayThrowFoodAni(function()
			arg_14_0.PlayMonsterAni()), arg_14_0.role, arg_14_0.role.localPosition.x + var_0_3, var_0_2).setLoopPingPong(1)

def var_0_0.PlayThrowFoodAni(arg_17_0, arg_17_1):
	...
	arg_17_0.foodTimer = Timer.New(function()
		...
		if var_17_2 == var_0_6:
			...
			var_17_2 = var_17_2 + 1, var_0_5 / var_0_6, var_0_6)

	arg_17_0.foodTimer.Start()

def var_0_0.PlayMonsterAni(arg_19_0):
	...
	arg_19_0.monsterTimer = Timer.New(function()
		...
		if var_19_3 == var_0_8:
			...
			arg_19_0.monsterTimer = None
			arg_19_0.isPlaying = False

			if #arg_19_0.coutinuePlay > 0:
				table.remove(arg_19_0.coutinuePlay, 1)
				arg_19_0.PlayFeedAni()
		else
			var_19_3 = var_19_3 + 1, var_0_7 / var_0_8, var_0_8)

	arg_19_0.managedTween(LeanTween.moveX, function()
		arg_19_0.managedTween(LeanTween.moveY, function()
			arg_19_0.monsterTimer.Start(), arg_19_0.monster, arg_19_0.monster.localPosition.y + var_0_4, var_0_2).setLoopPingPong(2), arg_19_0.monster, arg_19_0.monster.localPosition.x + var_0_3, var_0_2).setLoopPingPong(2)

def var_0_0.OpenMonsterWin(arg_23_0):
	setActive(arg_23_0.window, True)
	arg_23_0.monsterAni.Play("ATK")
	setLocalPosition(arg_23_0.spriteRole, Vector2(-180, -115))

	if LeanTween.isTweening(go(arg_23_0.spriteRole)):
		LeanTween.cancel(go(arg_23_0.spriteRole))

	arg_23_0.managedTween(LeanTween.moveX, None, arg_23_0.spriteRole, arg_23_0.spriteRole.localPosition.x + 20, 0.8).setLoopPingPong()

def var_0_0.OnHideFlush(arg_24_0):
	setActive(arg_24_0.window, False)

def var_0_0.OnDestroy(arg_25_0):
	arg_25_0.cleanManagedTween()

	if arg_25_0.foodTimer:
		arg_25_0.foodTimer.Stop()

		arg_25_0.foodTimer = None

	if arg_25_0.monsterTimer:
		arg_25_0.monsterTimer.Stop()

		arg_25_0.monsterTimer = None
