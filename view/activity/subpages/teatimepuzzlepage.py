...
def var_0_0.OnFirstFlush(arg_2_0):
	...
	for iter_2_0, iter_2_1 in ipairs(var_2_0 or {}):
	...
	if arg_2_0.activity.left4Day():
		for iter_2_2 = 1, arg_2_0.total:
	...
	onButton(arg_2_0, arg_2_0.GOBtn, function()
		...
		if not var_3_1 or var_3_1.isEnd():
			return
