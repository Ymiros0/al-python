...
def var_0_0.initBtnList(arg_9_0, arg_9_1):
	onButton(arg_9_0, arg_9_1[1], function()
		arg_9_0.emit(ActivityMediator.GO_PRAY_POOL), SFX_PANEL)
	onButton(arg_9_0, arg_9_1[2], function()
		arg_9_0.emit(ActivityMediator.EVENT_GO_SCENE, SCENE.SUMMARY), SFX_PANEL)
	onButton(arg_9_0, arg_9_1[3], function()
		arg_9_0.emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.ACTIVITY_TYPE_RETURN_AWARD_ID3), SFX_PANEL)
	...
	onButton(arg_9_0, arg_9_1[6], function()
		arg_9_0.emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.PIZZAHUT_PT_PAGE), SFX_PANEL)
