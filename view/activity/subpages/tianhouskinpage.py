...
def var_0_0.OnFirstFlush(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.fireworkBtn, function()
		pg.m02.sendNotification(GAME.GO_MINI_GAME, 26), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.shootBtn, function()
		pg.m02.sendNotification(GAME.GO_MINI_GAME, 27), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.foodBtn, function()
		pg.m02.sendNotification(GAME.GO_MINI_GAME, 25), SFX_PANEL)
	...
	onButton(arg_3_0, arg_3_0.playEffectBtn, function()
		if not arg_3_0.ishow:
			return

		arg_3_0.PlayFirework(var_3_0)
		setActive(arg_3_0.playEffectBtn, False), SFX_PANEL)
...
def var_0_0.OnUpdateFlush(arg_9_0):
	...
	if var_9_0.ultimate == 0 and var_9_1 <= var_9_0.usedtime:
...
def var_0_0.TransformColor(arg_10_0):
...
def var_0_0.PlayFirework(arg_11_0, arg_11_1):
...
def var_0_0.ClearEffectFirework(arg_13_0):
	arg_13_0.StopSE()

	if arg_13_0.fireEffect:
		pg.PoolMgr.GetInstance().ReturnPrefab("ui/firework", "", arg_13_0.fireEffect)

def var_0_0.PlaySE(arg_14_0):
	if arg_14_0.SETimer:
		return
...
def var_0_0.StopSE(arg_16_0):
	if arg_16_0.SETimer:
		pg.CriMgr.GetInstance().StopSEBattle_V3()
		arg_16_0.SETimer.Stop()

		arg_16_0.SETimer = None

def var_0_0.OnHideFlush(arg_17_0):
