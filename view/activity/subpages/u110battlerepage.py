...
def var_0_0.OnFirstFlush(arg_3_0):
	onButton(arg_3_0, arg_3_0.battleBtn, function()
		...
		if not var_4_1 or var_4_1.isEnd():
...
def var_0_0.OnUpdateFlush(arg_7_0):
	...
	onButton(arg_7_0, arg_7_0.awardTF, function()
		arg_7_0.emit(BaseUI.ON_DROP, var_7_6), SFX_PANEL)
...
def var_0_0.findCurTaskIndex(arg_10_0):
	local var_10_0

	for iter_10_0, iter_10_1 in ipairs(arg_10_0.taskIDList):
		if arg_10_0.taskProxy.getTaskVO(iter_10_1).getTaskStatus() <= 1:
			var_10_0 = iter_10_0

			break
		elif iter_10_0 == #arg_10_0.taskIDList:
			var_10_0 = iter_10_0
