...
def var_0_0.OnFirstFlush(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0._btnSimulate, function()
		if arg_4_0.config.expedition == 0:
	...
	onButton(arg_4_0, arg_4_0._btnExchange, function()
		if arg_4_0.canExchange:
			...
			arg_4_0.leantween = LeanTween.delayedCall(1, System.Action(function()
				setActive(arg_4_0._ptTip, False))).uniqueId, SFX_PANEL)
...
var_0_0.taskTypeDic = {
	[var_0_0.SP_FIRST] = function(arg_14_0, arg_14_1)
		...
		return var_14_1, var_14_0 != 1 and var_14_2 or None,
	[var_0_0.SP_DAILY] = function(arg_16_0, arg_16_1)
		...
		return var_16_2 and "1/1" or "0/1", not var_16_2 and var_16_0 or None,
	[var_0_0.RANDOM_DAILY] = function(arg_18_0, arg_18_1)
		...
		for iter_18_0, iter_18_1 in pairs(arg_18_1):
			local var_18_4 = var_0_0.CheckSingleTask(iter_18_1)

			if var_18_4 == 2:
				var_18_3 = var_18_3 + 1
			elif var_18_4 == 1 or var_18_4 == 0:
				var_18_2 = var_18_2 + 1
				var_18_0 = iter_18_1
		...
		return var_18_3 .. "/" .. var_18_5, var_18_2 != 0 and var_18_1 or None,
	[var_0_0.CHALLANGE] = function(arg_20_0, arg_20_1)
		...
		return var_20_3, var_20_0 != #arg_20_1 and var_20_4 or None,
	[var_0_0.MINI_GAME] = function(arg_22_0, arg_22_1)
		...
		return var_22_1 and "1/1" or "0/1", not var_22_1 and var_22_2 or None,
	[var_0_0.SHOP_BUY] = function(arg_24_0, arg_24_1)
		...
		return var_24_2 - var_24_1 .. "/" .. var_24_2, not var_24_3 and var_24_0 or None
}

def var_0_0.UpdateTask(arg_26_0, arg_26_1, arg_26_2):
	...
	setActive(arg_26_0.findTF("complete", arg_26_2), var_26_5 == None)
	setActive(arg_26_0.findTF("btn_go", arg_26_2), var_26_5 != None)
...
def var_0_0.OnUpdateFlush(arg_28_0):
	var_0_1("updateFlush")
...
def var_0_0.GetGoodsResCnt(arg_29_0, arg_29_1):
	return arg_29_0.actShop.GetCommodityById(arg_29_1).GetPurchasableCnt()

def var_0_0.UpdateExchangeStatus(arg_30_0):
	...
	arg_30_0.curGoods = arg_30_0.exchangeState < arg_30_0.length and pg.activity_shop_template[arg_30_0.goodsId[arg_30_0.exchangeState]] or None
...
def var_0_0.UpdatePtCount(arg_32_0):
