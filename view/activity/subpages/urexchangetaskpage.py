...
def var_0_0.OnDataSetting(arg_2_0):
	...
	if not arg_2_0.GetTaskById(var_2_1):
...
def var_0_0.OnUpdateFlush(arg_3_0):
	...
	local function var_3_3(arg_5_0)
		if arg_5_0.isFinish() and not arg_5_0.isReceive():
			return 0
		elif arg_5_0.isReceive():
			return 2
		else
			return 1
...
def var_0_0.UpdateTask(arg_11_0, arg_11_1, arg_11_2):
	...
	onButton(arg_11_0, var_11_2, function()
		arg_11_0.emit(BaseUI.ON_DROP, var_11_1), SFX_PANEL)
	...
	if var_11_3 and not var_11_4:
		onButton(arg_11_0, arg_11_1, function()
			arg_11_0.emit(ActivityMediator.ON_TASK_SUBMIT, arg_11_2), SFX_PANEL)
	else
