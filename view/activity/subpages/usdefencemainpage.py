...
def var_0_0.updateAwardBtn(arg_8_0):
	...
	if var_8_0 == 0:
		...
		onButton(arg_8_0, arg_8_0.awardTF, function()
			arg_8_0.taskListView.Load(), SFX_PANEL)
		...
		onButton(arg_8_0, arg_8_0.awardTF, function()
			...
			arg_8_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_11_0), SFX_PANEL)
		onButton(arg_8_0, arg_8_0.achievementBtn, function()
			local var_12_0 = arg_8_0.taskProxy.getTaskVO(arg_8_0.finalTaskID)

			arg_8_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_12_0), SFX_PANEL)
	elif var_8_0 == 2:
		setActive(arg_8_0.activeTF, False)
		setActive(arg_8_0.finishedTF, False)
...
def var_0_0.submitFinishedTask(arg_13_0):
	for iter_13_0, iter_13_1 in ipairs(arg_13_0.taskIDList):
		local var_13_0 = arg_13_0.taskProxy.getTaskById(iter_13_1)

		if var_13_0 and var_13_0.isFinish():
			arg_13_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_13_0)

def var_0_0.getFinalTaskStatus(arg_14_0):
