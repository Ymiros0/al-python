...
def var_0_0.OnDataSetting(arg_2_0):
	...
	if var_2_0.data4 == 0 and var_2_0.data2 >= 7:
		...
		return True
	elif defaultValue(var_2_0.data2_list[1], 0) > 0 or defaultValue(var_2_0.data2_list[2], 0) > 0:
		arg_2_0.emit(ActivityMediator.EVENT_OPERATION, {
			cmd = 2,
			activity_id = var_2_0.id
		})
...
def var_0_0.OnFirstFlush(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.btn, function()
		arg_3_0.emit(ActivityMediator.GO_DODGEM), SFX_PANEL)
