...
def var_0_0.getDoingTask(arg_6_0, arg_6_1, arg_6_2):
	local var_6_0 = getProxy(TaskProxy)
	local var_6_1 = _.flatten(arg_6_1.getConfig("config_data"))
	local var_6_2
	local var_6_3

	if arg_6_1.getConfig("type") == ActivityConst.ACTIVITY_TYPE_TASKS:
...
def var_0_0.flush_task_list_pt(arg_7_0):
	...
	if var_7_4:
		...
		onButton(arg_7_0, arg_7_0.award, function()
			arg_7_0.emit(BaseUI.ON_DROP, var_7_9), SFX_PANEL)
		...
		onButton(arg_7_0, arg_7_0.btn, function()
			if not var_7_4.isFinish():
				arg_7_0.emit(ActivityMediator.ON_TASK_GO, var_7_4)
			else
				if not arg_7_0.TaskSubmitCheck(var_7_4):
					return

				arg_7_0.emit(ActivityMediator.ON_TASK_SUBMIT, var_7_4), SFX_PANEL)
		setButtonEnabled(arg_7_0.btn, not var_7_4.isReceive())

def var_0_0.TaskSubmitCheck(arg_10_0, arg_10_1):
	if var_0_0.checkList[arg_10_1.id]:
		local var_10_0 = getProxy(BayProxy).getShips()

		for iter_10_0, iter_10_1 in ipairs(var_10_0):
			if iter_10_1.getGroupId() == var_0_0.checkList[arg_10_1.id] and iter_10_1.isActivityNpc():
				return True
...
def var_0_0.setImportantProgress(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5):
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_4):
		for iter_11_2, iter_11_3 in ipairs(arg_11_5):
			if iter_11_1 == iter_11_3:
				...
				onButton(arg_11_0, var_11_11, function()
					arg_11_0.emit(BaseUI.ON_DROP, var_11_12), SFX_PANEL)
