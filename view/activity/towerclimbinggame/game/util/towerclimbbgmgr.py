...
def var_0_0.Init(arg_2_0, arg_2_1, arg_2_2):
	...
	seriesAsync(var_2_0, function()
		...
		for iter_5_0, iter_5_1 in ipairs(arg_2_0.list):
...
def var_0_0.DoMove(arg_6_0, arg_6_1, arg_6_2):
	local var_6_0 = {}
	local var_6_1

	for iter_6_0, iter_6_1 in ipairs(arg_6_0.list):
		if iter_6_1:
...
def var_0_0.DoCheck(arg_10_0, arg_10_1):
	...
	if math.abs(var_10_2.y) >= var_10_0.rect.height:
		var_10_0.GetComponent(typeof(Image)).sprite = None
		arg_10_0.names[var_10_0] = None
...
def var_0_0.GetBg(arg_12_0, arg_12_1):
	return var_0_0.bgMaps[arg_12_1] or var_0_0.bgMaps[#var_0_0.bgMaps]

def var_0_0.LoadImage(arg_13_0, arg_13_1, arg_13_2):
	LoadSpriteAtlasAsync("clutter/towerclimbing_bg" .. arg_13_1, None, function(arg_14_0)
		arg_13_2(arg_14_0))

def var_0_0.LoadEffect(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.ReturnEffect(arg_17_0, arg_17_1):
...
def var_0_0.Clear(arg_18_0):
	eachChild(arg_18_0.tr, function(arg_19_0)
		arg_19_0.GetComponent(typeof(Image)).sprite = None
