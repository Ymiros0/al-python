...
def var_0_0.handleNotification(arg_4_0, arg_4_1):
	...
	if var_4_0 == GAME.SEND_MINI_GAME_OP_DONE and var_4_1.hubid == 9 and var_4_1.cmd == MiniGameOPCommand.CMD_SPECIAL_GAME and var_4_1.argList[1] == MiniGameDataCreator.TowerClimbingGameID and var_4_1.argList[2] == 2:
