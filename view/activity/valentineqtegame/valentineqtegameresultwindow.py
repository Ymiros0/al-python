...
def var_0_0.Init(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0.shareBtn, function()
		pg.ShareMgr.GetInstance().Share(pg.ShareMgr.TypeValentineQte, None, {
...
def var_0_0.GetChatTxt(arg_7_0, arg_7_1):
	local var_7_0

	for iter_7_0, iter_7_1 in ipairs(ValentineQteGameConst.CHAT_CONTENT):
		local var_7_1 = iter_7_1[1]
		local var_7_2 = iter_7_1[2]
		local var_7_3 = iter_7_1[3]

		if var_7_1 <= arg_7_1 and arg_7_1 <= var_7_2:
			var_7_0 = var_7_3
