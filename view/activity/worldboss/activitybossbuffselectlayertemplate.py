...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0._tf.Find("Rewards/Reward"), function()
		arg_3_0.emit(ActivityBossBuffSelectMediator.SHOW_REWARDS, arg_3_0.rewards, arg_3_0.targets, var_3_0.GetHighestScore()), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.startBtn, function()
		arg_3_0.emit(ActivityBossBuffSelectMediator.ON_START, arg_3_0.activeBuffs), SFX_PANEL)
...
def var_0_0.UpdateBuffItem(arg_14_0, arg_14_1, arg_14_2):
	...
	onButton(arg_14_0, var_14_0, function()
		...
		arg_14_0.UpdateView(), SFX_PANEL)

def var_0_0.UpdateActiveBuffs(arg_16_0):
...
def var_0_0.UpdateActiveBuffItem(arg_19_0, arg_19_1, arg_19_2):
