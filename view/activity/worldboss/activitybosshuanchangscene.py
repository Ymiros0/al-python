...
def var_0_0.UpdateDropItems(arg_4_0):
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.contextData.DisplayItems or {}):
		...
		onButton(arg_4_0, var_4_0, function()
			arg_4_0.emit(var_0_0.ON_DROP, var_4_1), SFX_PANEL)

def var_0_0.UpdatePage(arg_6_0):
	...
	for iter_6_1 = 1, #arg_6_0.stageList - 1:
		local var_6_5 = arg_6_0.contextData.normalStageIDs[iter_6_1]
		local var_6_6 = arg_6_0.stageList[iter_6_1]

		for iter_6_2, iter_6_3 in ipairs(arg_6_0.contextData.ticketInitPools):
			for iter_6_4, iter_6_5 in ipairs(iter_6_3[1]):
				if iter_6_5 == var_6_5:
	...
	if arg_6_0.bonusWindow and arg_6_0.bonusWindow.IsShowing():
...
def var_0_0.UpdateRank(arg_7_0, arg_7_1):
	arg_7_1 = arg_7_1 or {}

	for iter_7_0 = 1, #arg_7_0.rankList:
