...
def var_0_0.GetPairedFleetIndex(arg_1_0):
	if arg_1_0 < Fleet.SUBMARINE_FLEET_ID:
		return arg_1_0 + 10
	else
		return arg_1_0 - 10
...
def var_0_0.BindEvent(arg_3_0):
	...
	arg_3_0.bind(var_0_0.ON_PRECOMBAT, function(arg_7_0, arg_7_1)
		...
		if var_7_0[arg_7_1].isLegalToFight() != True:
		...
		if _.any(var_7_1, function(arg_8_0)
			...
			return _.any(arg_8_0.getShipIds(), function(arg_9_0)
				...
				local var_9_1, var_9_2 = ShipStatus.ShipStatusCheck("inActivity", var_9_0, None, {
					inActivity = var_7_2
				})
		...
		if not arg_3_0.contextData.activity.IsOilLimit(var_7_6):
			var_7_7 = {
				0,
				0
			}
		...
		arg_3_0.addSubLayers(Context.New({
			...
			data = {
				...
				fleets = var_7_1,
				costLimit = var_7_7,
				def OnConfirm:(arg_10_0)
					if not arg_3_0.contextData.activity.checkBattleTimeInBossAct():
	...
	arg_3_0.bind(var_0_0.ON_EX_PRECOMBAT, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if var_15_0[arg_15_1].isLegalToFight() != True:
			pg.TipsMgr.GetInstance().ShowTips(i18n("elite_disable_formation_unsatisfied"))
		...
		if _.any(var_15_1, function(arg_16_0)
			...
			return _.any(arg_16_0.getShipIds(), function(arg_17_0)
				...
				local var_17_1, var_17_2 = ShipStatus.ShipStatusCheck("inActivity", var_17_0, None, {
					inActivity = var_15_2
				})
		...
		seriesAsync({
			function(arg_18_0)
				...
				if not arg_15_2 and not pg.NewStoryMgr.GetInstance().IsPlayed(var_18_0):
					pg.MsgboxMgr.GetInstance().ShowMsgBox({
						hideNo = False,
						showStopRemind = True,
						hideYes = False,
			...
			function(arg_21_0)
				...
				if not arg_3_0.contextData.activity.IsOilLimit(var_21_3):
					var_21_4 = {
						0,
						0
					}
	...
	arg_3_0.bind(var_0_0.ON_SP_PRECOMBAT, function(arg_23_0, arg_23_1)
		...
		if var_23_0[arg_23_1].isLegalToFight() != True:
			pg.TipsMgr.GetInstance().ShowTips(i18n("elite_disable_formation_unsatisfied"))
		...
		if _.any(var_23_1, function(arg_24_0)
			...
			return _.any(arg_24_0.getShipIds(), function(arg_25_0)
				...
				local var_25_1, var_25_2 = ShipStatus.ShipStatusCheck("inActivity", var_25_0, None, {
					inActivity = var_23_2
				})
	...
	arg_3_0.bind(var_0_0.ON_SELECT_COMMANDER, function(arg_35_0, arg_35_1, arg_35_2)
		...
		arg_3_0.sendNotification(GAME.GO_SCENE, SCENE.COMMANDERCAT, {
			...
			ignoredIds = {},
			def onCommander:(arg_36_0)
				return True,
			def onSelected:(arg_37_0, arg_37_1)
				local var_37_0 = arg_37_0[1]
				local var_37_1 = getProxy(CommanderProxy).getCommanderById(var_37_0)

				for iter_37_0, iter_37_1 in pairs(var_35_0):
					if iter_37_0 == arg_35_1:
						for iter_37_2, iter_37_3 in pairs(var_35_2):
							if iter_37_3.groupId == var_37_1.groupId and iter_37_2 != arg_35_2:
								pg.TipsMgr.GetInstance().ShowTips(i18n("commander_can_not_select_same_group"))

								return
					elif iter_37_0 == var_0_0.GetPairedFleetIndex(arg_35_1):
						local var_37_2 = iter_37_1.getCommanders()

						for iter_37_4, iter_37_5 in pairs(var_37_2):
							if var_37_0 == iter_37_5.id:
				...
				arg_37_1(),
			def onQuit:(arg_38_0)
				var_35_1.updateCommanderByPos(arg_35_2, None)
				var_3_0.updateActivityFleet(var_3_1.id, arg_35_1, var_35_1)
				arg_38_0()
		}))
	...
	arg_3_0.bind(var_0_0.ONEN_BUFF_SELECT, function(arg_41_0)
		...
		;(function(arg_42_0)
			if not arg_42_0 or arg_42_0.isEnd():
				return
			...
			var_41_0 = _G[var_42_0])(arg_3_0.contextData.activity)
		arg_3_0.addSubLayers(Context.New({
			mediator = var_41_1,
...
def var_0_0.listNotificationInterests(arg_43_0):
	return {
...
def var_0_0.handleNotification(arg_44_0, arg_44_1):
	local var_44_0 = arg_44_1.getName()
	local var_44_1 = arg_44_1.getBody()

	if var_44_0 == ActivityProxy.ACTIVITY_ADDED or var_44_0 == ActivityProxy.ACTIVITY_UPDATED:
		if var_44_1.id == arg_44_0.contextData.ptActId:
			if arg_44_0.contextData.ptData:
				arg_44_0.contextData.ptData.Update(var_44_1)
			else
				arg_44_0.contextData.ptData = ActivityBossPtData.New(var_44_1)

			arg_44_0.UpdateView()
		elif var_44_1.id == arg_44_0.contextData.activityID:
			arg_44_0.UpdateActivityData(var_44_1)
			arg_44_0.UpdateView()
	elif var_44_0 == PlayerProxy.UPDATED:
		arg_44_0.RequestAndUpdateView()
	elif var_44_0 == GAME.BEGIN_STAGE_DONE:
		arg_44_0.contextData.editFleet = None
	...
	elif var_44_0 == GAME.ACT_BOSS_EXCHANGE_TICKET_DONE:
		if arg_44_0.contextData.ready2battleCb:
			arg_44_0.contextData.ready2battleCb()

			arg_44_0.contextData.ready2battleCb = None
	elif var_44_0 == GAME.GET_POWERRANK_DONE:
		if var_44_1.type == PowerRank.TYPE_ACT_BOSS_BATTLE:
			arg_44_0.UpdateRankData(var_44_1.list)
	elif var_44_0 == GAME.ACT_NEW_PT_DONE:
		arg_44_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_44_1.awards)
	elif var_44_0 == GAME.COMMANDER_ACTIVITY_FORMATION_OP_DONE:
	...
	elif var_44_0 == CommanderProxy.PREFAB_FLEET_UPDATE:
	...
	elif var_44_0 == ActivityBossBuffSelectMediator.ON_START:
		arg_44_0.viewComponent.ShowSPFleet()

def var_0_0.RequestAndUpdateView(arg_45_0):
	arg_45_0.sendNotification(GAME.ACTIVITY_BOSS_PAGE_UPDATE, {
		activity_id = arg_45_0.contextData.activityID
	})

def var_0_0.UpdateView(arg_46_0):
	arg_46_0.viewComponent.UpdateView()

def var_0_0.UpdateRankData(arg_47_0, arg_47_1):
	arg_47_0.viewComponent.UpdateRank(arg_47_1)

def var_0_0.UpdateActivityData(arg_48_0, arg_48_1):
...
def var_0_0.getDockCallbackFuncs4ActicityFleet(arg_49_0, arg_49_1, arg_49_2):
	...
	local function var_49_4(arg_50_0, arg_50_1)
		...
		if arg_49_0 and arg_49_0.isSameKind(arg_50_0):
			return True

		for iter_50_0, iter_50_1 in ipairs(var_49_3.ships):
			if arg_50_0.isSameKind(var_49_0.getShipById(iter_50_1)):
	...
	local function var_49_6(arg_52_0)
		...
		if #arg_52_0 > 0:
			...
			if not var_49_3.containShip(var_52_0):
				var_49_3.insertShip(var_52_0, None, arg_49_2)
			elif arg_49_0:
				var_49_3.insertShip(arg_49_0, None, arg_49_2)
