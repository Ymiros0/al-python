...
def var_0_0.UpdateView(arg_6_0, arg_6_1):
...
def var_0_0.UpdateList(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4):
	...
	arg_7_0.UIlist.make(function(arg_8_0, arg_8_1, arg_8_2)
		...
		onButton(arg_7_0, arg_8_2.Find("award"), function()
			arg_7_0.emit(BaseUI.ON_DROP, var_8_2), SFX_PANEL)
...
def var_0_0.OnShow(arg_10_0):
	pg.UIMgr.GetInstance().BlurPanel(arg_10_0._tf)

def var_0_0.OnHide(arg_11_0):
