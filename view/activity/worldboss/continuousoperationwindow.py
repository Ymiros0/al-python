...
def var_0_0.didEnter(arg_5_0):
	onButton(arg_5_0, arg_5_0.panel.Find("battle"), function()
		...
		if arg_5_0.contextData.oilCost * var_6_0 > getProxy(PlayerProxy).getRawData().oil:
			pg.TipsMgr.GetInstance().ShowTips(i18n("stage_beginStage_error_noResource"))

			return

		arg_5_0.emit(PreCombatMediator.CONTINUOUS_OPERATION), SFX_PANEL)
	...
	onToggle(arg_5_0, arg_5_0.panel.Find("ticket/checkbox"), function(arg_9_0)
		...
		arg_5_0.UpdateContent(), SFX_PANEL, SFX_CANCEL)
...
def var_0_0.UpdateContent(arg_11_0):
	...
	if var_11_10 > getProxy(PlayerProxy).getRawData().oil:
