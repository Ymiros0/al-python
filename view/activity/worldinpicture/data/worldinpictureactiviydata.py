...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_0.config.zone):
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_0.config.box):
		local var_1_0 = iter_1_3[1]
		local var_1_1 = iter_1_3[2]

		if not arg_1_0.boxItems[var_1_0]:
			arg_1_0.boxItems[var_1_0] = {}

		arg_1_0.boxItems[var_1_0][var_1_1] = True

def var_0_0.WarpDrawArea(arg_2_0, arg_2_1):
	...
	for iter_2_0 = var_2_0, var_2_2:
		for iter_2_1 = var_2_1, var_2_3:
			table.insert(var_2_4, Vector2(iter_2_0, iter_2_1))

	return var_2_4

def var_0_0.GetMapRowAndColumn(arg_3_0):
	return arg_3_0.size[1], arg_3_0.size[2]

def var_0_0.GetTravelPoint(arg_4_0):
	return arg_4_0.travelPoint

def var_0_0.GetDrawPoint(arg_5_0):
	return arg_5_0.drawPoint

def var_0_0.GetTravelProgress(arg_6_0):
	return #arg_6_0.travelList

def var_0_0.GetMaxTravelCnt(arg_7_0):
	local var_7_0, var_7_1 = arg_7_0.GetMapRowAndColumn()

	return var_7_0 * var_7_1

def var_0_0.IsTravelAll(arg_8_0):
	return arg_8_0.GetTravelProgress() >= arg_8_0.GetMaxTravelCnt()

def var_0_0.GetDrawProgress(arg_9_0):
	return #arg_9_0.drawList

def var_0_0.GetMaxDrawCnt(arg_10_0):
	return #arg_10_0.drawAreaList

def var_0_0.IsDrawAll(arg_11_0):
	return arg_11_0.GetDrawProgress() >= arg_11_0.GetMaxDrawCnt()

def var_0_0.GetTravelList(arg_12_0):
	return arg_12_0.travelList

def var_0_0.GetDrawList(arg_13_0):
	return arg_13_0.drawList

def var_0_0.GetAwardList(arg_14_0):
	return arg_14_0.awardList

def var_0_0.IsFirstTravel(arg_15_0):
	return #arg_15_0.travelList == 1

def var_0_0.OutSide(arg_16_0, arg_16_1, arg_16_2):
...
def var_0_0.IsOpened(arg_17_0, arg_17_1, arg_17_2):
...
def var_0_0.CanSelect(arg_18_0, arg_18_1, arg_18_2):
	if #arg_18_0.travelList == 0:
		return True

	if arg_18_0.IsOpened(arg_18_1, arg_18_2):
		return False
...
def var_0_0.ExistBox(arg_20_0, arg_20_1, arg_20_2):
	return arg_20_0.boxItems[arg_20_1] and arg_20_0.boxItems[arg_20_1][arg_20_2] == True

def var_0_0.AnyAreaCanDraw(arg_21_0):
...
def var_0_0.GetDrawIndex(arg_29_0, arg_29_1, arg_29_2):
	local var_29_0 = -1

	for iter_29_0, iter_29_1 in ipairs(arg_29_0.drawAreaList):
...
def var_0_0.IsDrawed(arg_31_0, arg_31_1, arg_31_2):
	local var_31_0 = arg_31_0.GetDrawIndex(arg_31_1, arg_31_2)

	return table.contains(arg_31_0.drawList, var_31_0)

def var_0_0.CanDraw(arg_32_0, arg_32_1, arg_32_2):
	if arg_32_0.IsDrawed(arg_32_1, arg_32_2):
		return False

	local var_32_0

	for iter_32_0, iter_32_1 in ipairs(arg_32_0.drawAreaList):
...
def var_0_0.Convert2DrawAreaHead(arg_35_0, arg_35_1, arg_35_2):
	local var_35_0
	local var_35_1

	for iter_35_0, iter_35_1 in ipairs(arg_35_0.drawAreaList):
...
def var_0_0.GetDrawAnimData(arg_37_0, arg_37_1, arg_37_2):
	local var_37_0 = arg_37_0.GetDrawIndex(arg_37_1, arg_37_2)

	return arg_37_0.drawAreaAnimList[var_37_0]

def var_0_0.FindNextTravelable(arg_38_0):
	if arg_38_0.GetTravelPoint() <= 0:
		return None

	local var_38_0, var_38_1 = arg_38_0.GetMapRowAndColumn()

	for iter_38_0 = 1, var_38_0:
		for iter_38_1 = 1, var_38_1:
			if arg_38_0.CanSelect(iter_38_0, iter_38_1):
...
def var_0_0.FindNextDrawableAreaHead(arg_39_0):
	if arg_39_0.GetDrawPoint() <= 0:
		return None

	for iter_39_0, iter_39_1 in ipairs(arg_39_0.drawAreaList):
