...
def var_0_0.emit(arg_2_0, ...):
	if arg_2_0.inAniming:
		return

	var_0_0.super.emit(arg_2_0, ...)

def var_0_0.OnOpenCellErro(arg_3_0, arg_3_1):
	if arg_3_1:
		arg_3_0.onkeyTravelProcess = False

		arg_3_0.UpdateTravelBtnState()

def var_0_0.OnOpenCell(arg_4_0, arg_4_1, arg_4_2, arg_4_3):
	...
	arg_4_0.DoAnimtion("picture_faguang", var_4_1, function()
		...
		if arg_4_3 and arg_4_0.data.ExistBox(arg_4_1, arg_4_2):
		...
		if arg_4_3:
			...
			if not var_5_1 or not arg_4_0.data.FindNextTravelable():
				arg_4_0.emit(WorldInPictureMediator.RESULT_ONEKEY_AWARD)
			elif var_5_1 == True:
				triggerButton(arg_4_0.onekeyTravelBtn))

def var_0_0.CloseSelector(arg_6_0, arg_6_1, arg_6_2):
	if arg_6_0.data.IsFirstTravel():
		for iter_6_0, iter_6_1 in ipairs(arg_6_0.selectors):
			for iter_6_2, iter_6_3 in ipairs(iter_6_1):
				iter_6_3.alpha = 0
	else
		local var_6_0 = arg_6_0.selectors[arg_6_1][arg_6_2]

		if var_6_0 and var_6_0.alpha != 0:
			var_6_0.alpha = 0

def var_0_0.HightLightOpenArea(arg_7_0, arg_7_1, arg_7_2):
	local var_7_0 = {
	...
	local function var_7_1(arg_8_0)
		if arg_7_0.data.IsOpened(arg_8_0.x, arg_8_0.y) or arg_7_0.data.OutSide(arg_8_0.x, arg_8_0.y):
			return

		if not arg_7_0.selectors[arg_8_0.x] or not arg_7_0.selectors[arg_8_0.x][arg_8_0.y]:
...
def var_0_0.RpAnim(arg_9_0, arg_9_1, arg_9_2):
	...
	LeanTween.value(var_9_0.gameObject, var_9_0.anchoredPosition.y, var_9_0.anchoredPosition.y + 35, 0.75).setOnUpdate(System.Action_float(function(arg_10_0)
		var_9_0.anchoredPosition = Vector2(var_9_0.anchoredPosition.x, arg_10_0))).setOnComplete(System.Action(function()
		if arg_9_0.exited:
			return
...
def var_0_0.HideBox(arg_12_0, arg_12_1, arg_12_2):
	local var_12_0

	if arg_12_0.boxes[arg_12_1]:
		var_12_0 = arg_12_0.boxes[arg_12_1][arg_12_2]

	if var_12_0:
		var_12_0.alpha = 0

def var_0_0.OnDrawAreaErro(arg_13_0, arg_13_1):
	if arg_13_1:
		arg_13_0.onkeyDrawPorcess = False

		arg_13_0.UpdateDrawBtnState()

def var_0_0.OnDrawArea(arg_14_0, arg_14_1, arg_14_2, arg_14_3):
	...
	arg_14_0.CreateAnimal(arg_14_1, arg_14_2, False, function(arg_15_0)
		...
		arg_14_0.DoAnimtion("picture_bichu", var_15_3, function()
			...
			if arg_14_3:
				...
				if not var_16_0 or not arg_14_0.data.FindNextDrawableAreaHead():
					arg_14_0.emit(WorldInPictureMediator.RESULT_ONEKEY_AWARD)
				elif arg_14_3 and var_16_0 == True:
					triggerButton(arg_14_0.onekeyDrawBtn)))

def var_0_0.HideDrawarea(arg_18_0, arg_18_1, arg_18_2):
	local var_18_0

	if arg_18_0.drawableAare[arg_18_1]:
		var_18_0 = arg_18_0.drawableAare[arg_18_1][arg_18_2]

	if var_18_0:
		var_18_0.alpha = 0

def var_0_0.SetData(arg_19_0, arg_19_1):
	arg_19_0.data = arg_19_1

def var_0_0.init(arg_20_0):
...
def var_0_0.didEnter(arg_21_0):
	onButton(arg_21_0, arg_21_0.backBtn, function()
		if arg_21_0.opType == var_0_1 and arg_21_0.onkeyTravelProcess:
			arg_21_0.onkeyTravelProcess = False

			arg_21_0.UpdateTravelBtnState()

			return
		elif arg_21_0.opType == var_0_2 and arg_21_0.onkeyDrawPorcess:
		...
		arg_21_0.emit(var_0_0.ON_BACK), SFX_CANCEL)
	...
	onButton(arg_21_0, arg_21_0.onekeyTravelBtn, function()
		if arg_21_0.forceStopTravelPorcess:
			return

		if arg_21_0.data.IsTravelAll():
			return

		if arg_21_0.data.GetTravelPoint() <= 0:
			pg.TipsMgr.GetInstance().ShowTips(i18n("worldinpicture_tavel_point_tip"))

			return

		if arg_21_0.onkeyTravelProcess:
			arg_21_0.onkeyTravelProcess = False
		...
		if var_24_0 and var_24_1:
			arg_21_0.onkeyTravelProcess = True

			arg_21_0.UpdateTravelBtnState()
			arg_21_0.emit(WorldInPictureMediator.ON_AUTO_TRAVEL, var_24_0.x, var_24_0.y, var_24_1), SFX_PANEL)
	onButton(arg_21_0, arg_21_0.onekeyDrawBtn, function()
		if arg_21_0.forceStopDrawPorcess:
			return

		if arg_21_0.data.IsDrawAll():
			return

		if arg_21_0.data.GetDrawPoint() <= 0:
			pg.TipsMgr.GetInstance().ShowTips(i18n("worldinpicture_draw_point_tip"))

			return

		if arg_21_0.onkeyDrawPorcess:
			arg_21_0.onkeyDrawPorcess = False
		...
		if var_25_0 and var_25_1:
			arg_21_0.onkeyDrawPorcess = True

			arg_21_0.UpdateDrawBtnState()
			arg_21_0.emit(WorldInPictureMediator.ON_AUTO_DRAW, var_25_0.x, var_25_0.y, var_25_1), SFX_PANEL)

	arg_21_0.opType = var_0_1

	onButton(arg_21_0, arg_21_0.onDisable, function()
		pg.TipsMgr.GetInstance().ShowTips(i18n("worldinpicture_not_area_can_draw")), SFX_PANEL)
	onButton(arg_21_0, arg_21_0.btnOn, function()
		...
		if arg_21_0.inAniming:
			return

		arg_21_0.opType = var_0_2

		arg_21_0.UpdateSwitcherState(), SFX_PANEL)
...
def var_0_0.SaveCharPosition(arg_32_0, arg_32_1, arg_32_2):
	local var_32_0 = getProxy(PlayerProxy).getRawData().id

	PlayerPrefs.SetString("WorldInPictureScene_1" .. var_32_0, arg_32_1 .. "#" .. arg_32_2)
	PlayerPrefs.Save()

def var_0_0.moveChar(arg_33_0, arg_33_1, arg_33_2, arg_33_3):
	if LeanTween.isTweening(go(arg_33_0.char)):
		LeanTween.cancel(go(arg_33_0.char))

	if isActive(arg_33_0.char):
		arg_33_0.hideChar(function()
			arg_33_0.showChar(arg_33_1, arg_33_2, arg_33_3))
	else
		arg_33_0.showChar(arg_33_1, arg_33_2, arg_33_3)

def var_0_0.showChar(arg_35_0, arg_35_1, arg_35_2, arg_35_3):
...
def var_0_0.hideChar(arg_38_0, arg_38_1):
...
def var_0_0.UpdateChar(arg_41_0, arg_41_1, arg_41_2):
	if arg_41_1 == Vector2.zero:
		setActive(arg_41_0.char, False)

		return

	if LeanTween.isTweening(arg_41_0.char):
		LeanTween.cancel(arg_41_0.char)

	if arg_41_0.data.IsTravelAll():
		setActive(arg_41_0.char, False)
...
def var_0_0.UpdateSwitcherState(arg_43_0):
...
def var_0_0.CreateCell(arg_48_0, arg_48_1, arg_48_2, arg_48_3):
	if arg_48_0.exited:
		return
	...
	if not arg_48_0.cells[arg_48_1]:
		arg_48_0.cells[arg_48_1] = {}

	onButton(arg_48_0, var_48_0, function()
		if arg_48_0.opType == var_0_1:
			if arg_48_0.onkeyTravelProcess:
			...
			if arg_48_0.data.IsTravelAll():
				return

			if arg_48_0.data.GetTravelPoint() <= 0:
				pg.TipsMgr.GetInstance().ShowTips(i18n("worldinpicture_tavel_point_tip"))

				return

			if arg_48_0.data.CanSelect(arg_48_1, arg_48_2):
				arg_48_0.emit(WorldInPictureMediator.ON_TRAVEL, arg_48_1, arg_48_2, arg_48_3)
		elif arg_48_0.opType == var_0_2:
			if arg_48_0.onkeyDrawPorcess:
			...
			if arg_48_0.data.IsDrawAll():
				return

			if arg_48_0.data.GetDrawPoint() <= 0:
				pg.TipsMgr.GetInstance().ShowTips(i18n("worldinpicture_draw_point_tip"))

				return

			if arg_48_0.data.CanDraw(arg_48_1, arg_48_2):
				local var_50_0, var_50_1, var_50_2 = arg_48_0.data.Convert2DrawAreaHead(arg_48_1, arg_48_2)

				arg_48_0.emit(WorldInPictureMediator.ON_DRAW, var_50_0, var_50_1, var_50_2), SFX_PANEL)
...
def var_0_0.CreateSelector(arg_51_0, arg_51_1, arg_51_2):
	if not arg_51_0.data.CanSelect(arg_51_1, arg_51_2):
		return
	...
	if not arg_51_0.selectors[arg_51_1]:
		arg_51_0.selectors[arg_51_1] = {}

	arg_51_0.selectors[arg_51_1][arg_51_2] = var_51_1

def var_0_0.CreateBox(arg_52_0, arg_52_1, arg_52_2):
	if not arg_52_0.data.ExistBox(arg_52_1, arg_52_2) or arg_52_0.data.IsOpened(arg_52_1, arg_52_2):
		return
	...
	if not arg_52_0.boxes[arg_52_1]:
		arg_52_0.boxes[arg_52_1] = {}

	arg_52_0.boxes[arg_52_1][arg_52_2] = var_52_1

def var_0_0.CreateDrawableArea(arg_53_0, arg_53_1, arg_53_2):
	local var_53_0 = arg_53_0.data.GetDrawableArea(arg_53_1, arg_53_2)

	if not var_53_0 or arg_53_0.data.IsDrawed(arg_53_1, arg_53_2):
		return
	...
	if not arg_53_0.drawableAare[arg_53_1]:
		arg_53_0.drawableAare[arg_53_1] = {}

	arg_53_0.drawableAare[arg_53_1][arg_53_2] = var_53_5

def var_0_0.UpdateDrawableAreas(arg_54_0):
	local var_54_0 = arg_54_0.data.GetDrawableAreasState()

	for iter_54_0, iter_54_1 in ipairs(var_54_0):
		local var_54_1 = iter_54_1.position

		if arg_54_0.drawableAare[var_54_1.x] and arg_54_0.drawableAare[var_54_1.x][var_54_1.y]:
			arg_54_0.drawableAare[var_54_1.x][var_54_1.y].alpha = iter_54_1.open and 1 or 0

def var_0_0.CreateAnimal(arg_55_0, arg_55_1, arg_55_2, arg_55_3, arg_55_4):
	if not arg_55_0.data.GetDrawableArea(arg_55_1, arg_55_2) or not arg_55_0.data.IsDrawed(arg_55_1, arg_55_2):
		return
	...
	if not arg_55_0.animals[arg_55_1]:
...
def var_0_0.UpdatePoints(arg_58_0):
...
def var_0_0.DoAnimtion(arg_59_0, arg_59_1, arg_59_2, arg_59_3):
	if arg_59_0.timer:
		arg_59_0.timer.Stop()
...
def var_0_0.GetRedPacket(arg_62_0):
	if #arg_62_0.redpackets <= 0:
...
def var_0_0.LoadEffect(arg_63_0, arg_63_1, arg_63_2):
	ResourceMgr.Inst.getAssetAsync("UI/" .. arg_63_1, "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_64_0)
		if arg_63_0.exited:
			return

		arg_63_2(Object.Instantiate(arg_64_0, arg_63_0._tf).transform)), True, True)

def var_0_0.willExit(arg_65_0):
	for iter_65_0, iter_65_1 in ipairs(arg_65_0.redpackets):
		if LeanTween.isTweening(iter_65_1.gameObject):
			LeanTween.cancel(iter_65_1)

	if LeanTween.isTweening(arg_65_0.char):
