...
def var_0_0.updateCurrPage(arg_5_0):
...
def var_0_0.handleNotification(arg_7_0, arg_7_1):
	...
	if var_7_0 == AttireProxy.ATTIREFRAME_EXPIRED:
		if arg_7_0.viewComponent.page == AttireScene.PAGE_ICONFRAME or arg_7_0.viewComponent.page == AttireScene.PAGE_CHATFRAME:
			arg_7_0.updateCurrPage()
	elif var_7_0 == GAME.ATTIRE_APPLY_DONE:
		arg_7_0.updateCurrPage()
		pg.TipsMgr.GetInstance().ShowTips(i18n("dress_up_success"))
	elif var_7_0 == PlayerProxy.UPDATED or var_7_0 == GAME.CHANGE_PLAYER_MEDAL_DISPLAY_DONE:
		arg_7_0.viewComponent.setPlayer(getProxy(PlayerProxy).getData())
		arg_7_0.updateCurrPage()
	elif var_7_0 == GAME.GET_ATTIRE_DONE:
		arg_7_0.updateCurrPage()
