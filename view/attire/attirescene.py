...
def var_0_0.setAttires(arg_2_0, arg_2_1):
...
def var_0_0.didEnter(arg_5_0):
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_0.toggles):
...
def var_0_0.switchPage(arg_8_0, arg_8_1):
	if arg_8_0.page:
...
def var_0_0.updateCurrPage(arg_9_0):
	assert(arg_9_0.page)
