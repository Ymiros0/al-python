...
def var_0_0.ThemeSortIndex2ServerIndex(arg_1_0, arg_1_1):
	arg_1_1 = defaultValue(arg_1_1, True)
	arg_1_0 = defaultValue(arg_1_0, 1)

	if arg_1_0 == 1:
		return 5
	elif arg_1_0 == 2 and arg_1_1:
		return 1
	elif arg_1_0 == 2 and not arg_1_1:
		return 2
	elif arg_1_0 == 3 and arg_1_1:
		return 4
	elif arg_1_0 == 3 and not arg_1_1:
		return 3

def var_0_0.ServerIndex2ThemeSortIndex(arg_2_0):
	if arg_2_0 == 5:
		return 1, True
	elif arg_2_0 == 4:
		return 3, True
