...
def var_0_0.PlayEnterAnimation(arg_4_0):
	arg_4_0.animation.Play("anim_backyard_furniture_itemin")

def var_0_0.UpdateMark(arg_5_0, arg_5_1):
	if not arg_5_0.furniture:
...
def var_0_0.Flush(arg_6_0, arg_6_1, arg_6_2, arg_6_3):
	if arg_6_1.id == arg_6_0.furniture.id:
		arg_6_0.Update(arg_6_1, arg_6_2, arg_6_3)
	else
		arg_6_0.Update(arg_6_0.furniture, arg_6_2, arg_6_3)

def var_0_0.HasMask(arg_7_0):
