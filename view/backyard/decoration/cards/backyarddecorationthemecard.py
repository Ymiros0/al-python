...
def var_0_0.RemoveSizeTag(arg_2_0, arg_2_1):
...
def var_0_0.Update(arg_3_0, arg_3_1, arg_3_2):
	...
	if not var_3_0:
		...
		if not var_3_1:
			if BackYardThemeTempalteUtil.FileExists(arg_3_1.GetTextureIconName()) or arg_3_1.IsPushed():
				local var_3_2 = arg_3_1.GetIconMd5()

				BackYardThemeTempalteUtil.GetTexture(arg_3_1.GetTextureIconName(), var_3_2, function(arg_4_0)
					if not IsNil(arg_3_0.rawIcon) and arg_4_0:
...
def var_0_0.UpdateState(arg_7_0, arg_7_1):
	if arg_7_0.themeVO.id != "":
...
def var_0_0.Dispose(arg_8_0):
	...
	if not IsNil(arg_8_0.rawIcon.texture):
		Object.Destroy(arg_8_0.rawIcon.texture)

		arg_8_0.rawIcon.texture = None
