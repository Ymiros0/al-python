...
def var_0_0.SetUp(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4):
	arg_5_0.Show()
...
def var_0_0.DormUpdated(arg_8_0, arg_8_1):
	arg_8_0.dorm = arg_8_1

	arg_8_0.UpdateFliterData()
	arg_8_0.OnDormUpdated()

def var_0_0.FurnitureUpdated(arg_9_0, arg_9_1):
	arg_9_0.OnFurnitureUpdated(arg_9_1)

def var_0_0.CustomThemeAdded(arg_10_0, arg_10_1):
	arg_10_0.customTheme[arg_10_1.id] = arg_10_1

	arg_10_0.CustomThemeUpdated(arg_10_0.customTheme)

def var_0_0.CustomThemeDeleted(arg_11_0, arg_11_1):
	for iter_11_0, iter_11_1 in pairs(arg_11_0.customTheme):
		if iter_11_1.id == arg_11_1:
			arg_11_0.customTheme[iter_11_0] = None

			break

	arg_11_0.CustomThemeUpdated(arg_11_0.customTheme)

def var_0_0.ThemeUpdated(arg_12_0):
	arg_12_0.OnThemeUpdated()

def var_0_0.CustomThemeUpdated(arg_13_0, arg_13_1):
	arg_13_0.customTheme = arg_13_1

	arg_13_0.ThemeUpdated()

def var_0_0.OrderModeUpdated(arg_14_0, arg_14_1):
	arg_14_0.orderMode = arg_14_1

	arg_14_0.UpdateFliterData()

	if arg_14_0.contextData.filterPanel.GetLoaded():
...
def var_0_0.UpdateFliterData(arg_15_0):
...
def var_0_0.ShowFilterPanel(arg_16_0, arg_16_1):
...
def var_0_0.SearchKeyUpdated(arg_18_0, arg_18_1):
...
def var_0_0.OnDisplayList(arg_21_0):
	return

def var_0_0.OnDormUpdated(arg_22_0):
	return

def var_0_0.OnFurnitureUpdated(arg_23_0, arg_23_1):
	return

def var_0_0.OnThemeUpdated(arg_24_0):
	return

def var_0_0.OnOrderModeUpdated(arg_25_0):
	return

def var_0_0.OnFilterDone(arg_26_0, arg_26_1):
	return

def var_0_0.GetDisplays(arg_27_0):
	return {}

def var_0_0.OnSearchKeyChanged(arg_28_0):
	return

def var_0_0.OnBackPressed(arg_29_0):
	return False

def var_0_0.OnApplyThemeBefore(arg_30_0):
	return

def var_0_0.OnApplyThemeAfter(arg_31_0, arg_31_1):
	return
