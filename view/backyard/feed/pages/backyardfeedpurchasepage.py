...
def var_0_0.Show(arg_7_0, arg_7_1):
	...
	onButton(arg_7_0, arg_7_0.minusBtn, function()
		...
		var_7_4 = var_7_4 - 1
		arg_7_0.countValue.text = var_7_4
		arg_7_0.total.text = var_7_3 * var_7_4, SFX_PANEL)
...
def var_0_0.Purchase(arg_14_0, arg_14_1):
	if getProxy(PlayerProxy).getRawData()[id2res(arg_14_1.resourceType)] < arg_14_1.resourceNum * arg_14_1.count:
		if arg_14_1.resourceType == 4:
			GoShoppingMsgBox(i18n("switch_to_shop_tip_3", i18n("word_gem")), ChargeScene.TYPE_DIAMOND)
		elif arg_14_1.resourceType == 2 and ItemTipPanel.ShowOilBuyTip(arg_14_1.resourceNum * arg_14_1.count):
			-- block empty
		else
...
def var_0_0.UpdateFood(arg_15_0, arg_15_1):
