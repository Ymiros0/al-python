...
def var_0_0.UpdateInfo(arg_3_0, arg_3_1):
...
def var_0_0.DoAnimation(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	if arg_5_2.level == arg_5_2.getMaxLevel():
		return
...
def var_0_0.DoLevelUpAnimation(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5, arg_8_6, arg_8_7):
	local var_8_0
	local var_8_1
	local var_8_2
	...
	local function var_8_4()
		TweenValue(arg_8_0.slider, 0, 1, arg_8_7, 0, function(arg_12_0)
			arg_8_0.SetSliderValue(arg_8_0.slider, arg_12_0), var_8_0)
	...
	TweenValue(arg_8_0.slider, arg_8_1, arg_8_2, arg_8_7, 0, function(arg_14_0)
		arg_8_0.SetSliderValue(arg_8_0.slider, arg_14_0 / arg_8_2), var_8_0)

def var_0_0.SetSliderValue(arg_15_0, arg_15_1, arg_15_2):
	if arg_15_2 != 0 and arg_15_2 < 0.03:
		arg_15_2 = 0.03

	arg_15_1.value = arg_15_2

def var_0_0.Dispose(arg_16_0):
	if LeanTween.isTweening(arg_16_0.slider.gameObject):
		LeanTween.cancel(arg_16_0.slider.gameObject)

	if LeanTween.isTweening(arg_16_0.additionTF.gameObject):
