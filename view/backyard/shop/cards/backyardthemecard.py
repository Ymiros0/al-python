...
def var_0_0.UpdateSelected(arg_4_0, arg_4_1):
	local var_4_0 = arg_4_1 and arg_4_1.id == arg_4_0.themeVO.id

	if IsNil(arg_4_0.content):
		return

	if LeanTween.isTweening(arg_4_0.content.gameObject):
...
def var_0_0.Dispose(arg_6_0):
	if LeanTween.isTweening(arg_6_0.content.gameObject):
