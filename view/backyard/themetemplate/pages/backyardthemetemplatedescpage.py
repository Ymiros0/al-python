...
def var_0_0.ThemeTemplateUpdate(arg_3_0, arg_3_1):
	if arg_3_0.template and arg_3_0.template.id == arg_3_1.id:
		arg_3_0.template = arg_3_1

		arg_3_0.Flush()

def var_0_0.UpdateDorm(arg_4_0, arg_4_1):
	arg_4_0.dorm = arg_4_1

def var_0_0.PlayerUpdated(arg_5_0, arg_5_1):
	arg_5_0.player = arg_5_1

def var_0_0.OnLoaded(arg_6_0):
...
def var_0_0.OnInit(arg_7_0):
	onButton(arg_7_0, arg_7_0.copyBtn, function()
		if arg_7_0.player:
			...
			pg.TipsMgr.GetInstance().ShowTips(i18n("friend_id_copy_ok")), SFX_PANEL)

def var_0_0.SetUp(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4):
...
def var_0_0.RefreshSortBtn(arg_10_0):
	local var_10_0
	local var_10_1

	if arg_10_0.pageType == BackYardConst.THEME_TEMPLATE_TYPE_CUSTOM:
		local var_10_2
...
def var_0_0.Update1(arg_12_0):
	onButton(arg_12_0, arg_12_0.btn1, function()
		arg_12_0.contextData.infoPage.ExecuteAction("SetUp", arg_12_0.template, arg_12_0.dorm, arg_12_0.player), SFX_PANEL)
...
def var_0_0.Update2(arg_17_0):
	local var_17_0 = arg_17_0.template
	local var_17_1 = var_17_0.IsPushed()

	onButton(arg_17_0, arg_17_0.btn1, function()
		arg_17_0.emit(NewBackYardThemeTemplateMediator.ON_DELETE_TEMPLATE, var_17_0), SFX_PANEL)
	onButton(arg_17_0, arg_17_0.btn2, function()
		if var_17_1:
			...
			arg_17_0.emit(NewBackYardThemeTemplateMediator.ON_UPLOAD_TEMPLATE, var_17_0), SFX_PANEL)
...
def var_0_0.UpdatePlayer(arg_21_0):
	if not arg_21_0.template.ExistPlayerInfo():
		...
		LoadSpriteAsync("qicon/" .. var_21_0.getPainting(), function(arg_22_0)
			if IsNil(arg_21_0.icon):
				return

			arg_21_0.icon.sprite = arg_22_0)

		if arg_21_0.preLoadIcon:
		...
		onButton(arg_21_0, arg_21_0.icon, function()
			if var_21_0.id == getProxy(PlayerProxy).getRawData().id:
				return

			local var_24_0 = tf(arg_21_0.icon.gameObject).position
			local var_24_1 = arg_21_0.template.GetName()

			arg_21_0.emit(NewBackYardThemeTemplateMediator.ON_DISPLAY_PLAYER_INFO, var_21_0.id, var_24_0, arg_21_0.template.id), SFX_PANEL)

def var_0_0.UpdateLikeInfo(arg_25_0):
	...
	onButton(arg_25_0, arg_25_0.heart, function()
		if arg_25_0.pageType == BackYardConst.THEME_TEMPLATE_TYPE_CUSTOM:
			return

		if not var_25_2:
			arg_25_0.emit(NewBackYardThemeTemplateMediator.ON_LIKE_THEME, arg_25_0.template, arg_25_0.template.time), SFX_PANEL)
	...
	onButton(arg_25_0, arg_25_0.collection, function()
		...
		if var_25_3:
			...
			arg_25_0.emit(NewBackYardThemeTemplateMediator.ON_COLECT_THEME, arg_25_0.template, False, arg_25_0.template.time), SFX_PANEL)
	setActive(arg_25_0.collectionSel, var_25_3 or var_25_1)

def var_0_0.UpdateWindow(arg_29_0):
	local var_29_0 = True

	if arg_29_0.pageType == BackYardConst.THEME_TEMPLATE_TYPE_SHOP:
		arg_29_0.frame.sizeDelta = Vector2(arg_29_0.frame.sizeDelta.x, 456)
	elif arg_29_0.pageType == BackYardConst.THEME_TEMPLATE_TYPE_CUSTOM:
		if arg_29_0.template.IsPushed():
			arg_29_0.frame.sizeDelta = Vector2(arg_29_0.frame.sizeDelta.x, 456)
		else
			var_29_0 = False
			arg_29_0.frame.sizeDelta = Vector2(arg_29_0.frame.sizeDelta.x, 395)
	elif arg_29_0.pageType == BackYardConst.THEME_TEMPLATE_TYPE_COLLECTION:
		arg_29_0.frame.sizeDelta = Vector2(arg_29_0.frame.sizeDelta.x, 456)
