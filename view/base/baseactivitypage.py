...
def var_0_0.SetShareData(arg_1_0, arg_1_1):
	arg_1_0.shareData = arg_1_1

def var_0_0.SetUIName(arg_2_0, arg_2_1):
...
def var_0_0.Flush(arg_4_0, arg_4_1):
	...
	if arg_4_0.OnDataSetting():
		return

	if defaultValue(arg_4_0.isFirst, True):
...
def var_0_0.ShowOrHide(arg_5_0, arg_5_1):
...
def var_0_0.BindPageLink(arg_6_0):
	for iter_6_0, iter_6_1 in ipairs(arg_6_0.GetPageLink()):
		ActivityConst.PageIdLink[iter_6_1] = arg_6_0.activity.id

def var_0_0.OnInit(arg_7_0):
	return

def var_0_0.OnDataSetting(arg_8_0):
	return

def var_0_0.GetPageLink(arg_9_0):
	return {}

def var_0_0.OnFirstFlush(arg_10_0):
	return
...
def var_0_0.OnShowFlush(arg_13_0):
	return

def var_0_0.OnDestroy(arg_14_0):
	return

def var_0_0.OnLoadLayers(arg_15_0):
	return

def var_0_0.OnRemoveLayers(arg_16_0):
	return

def var_0_0.UseSecondPage(arg_17_0, arg_17_1):
	return False
