...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	local var_1_1 = arg_1_1 and isa(arg_1_1, BaseEventLogic) and arg_1_1.event or None
	local var_1_2 = {}
...
def var_0_0.InvokeParent(arg_2_0, arg_2_1, ...):
	if arg_2_0.viewParent:
		arg_2_0.viewParent[arg_2_1](arg_2_0.viewParent, ...)

def var_0_0.Init(arg_3_0):
	if arg_3_0._state != var_0_0.STATES.LOADED:
		return
...
def var_0_0.Destroy(arg_4_0):
	if arg_4_0._state == var_0_0.STATES.DESTROY:
		return
	...
	if arg_4_0._go != None and var_4_1:
...
def var_0_0.RawShow(arg_8_0):
	var_0_0.super.Show(arg_8_0)

def var_0_0.IsShowing(arg_9_0):
	return arg_9_0.GetLoaded() and isActive(arg_9_0._go)

def var_0_0.IsHiding(arg_10_0):
...
def var_0_0.OnShow(arg_12_0):
	return

def var_0_0.OnHide(arg_13_0):
	return
