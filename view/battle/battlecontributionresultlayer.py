...
def var_0_0.setActId(arg_1_0, arg_1_1):
...
def var_0_0.setPoint(arg_3_0):
	arg_3_0._contributionPoint = 0

	for iter_3_0, iter_3_1 in ipairs(arg_3_0.contextData.drops):
		if iter_3_1.configId == arg_3_0._resourceID:
...
def var_0_0.rankAnimaFinish(arg_5_0):
...
def var_0_0.setCondition(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
