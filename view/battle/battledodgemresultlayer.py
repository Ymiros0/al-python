...
def var_0_0.rankAnimaFinish(arg_4_0):
...
def var_0_0.skip(arg_13_0):
	if arg_13_0._stateFlag == BattleResultLayer.STATE_REPORTED:
		arg_13_0.displayBG()
	elif arg_13_0._stateFlag == BattleResultLayer.STATE_DISPLAYED:
