...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.ON_BACK_PRE_SCENE, function()
		...
		if var_8_6 and arg_1_0.contextData.bossId:
			...
			if var_1_1 == SYSTEM_DUEL:
				-- block empty
			elif var_1_1 == SYSTEM_SCENARIO:
				local var_8_11 = var_8_2.getContextByMediator(ChapterPreCombatMediator)

				if var_8_11:
					var_8_2.removeChild(var_8_11)
			elif var_1_1 != SYSTEM_PERFORM and var_1_1 != SYSTEM_SIMULATION:
	...
	arg_1_0.bind(var_0_0.ON_QUIT_BATTLE_MANUALLY, function(arg_9_0)
		...
		elif var_1_1 == SYSTEM_BOSS_SINGLE and getProxy(ContextProxy).getCurrentContext().getContextByMediator(BossSingleContinuousOperationMediator):
			getProxy(ContextProxy).GetPrevContext(1).addChild(Context.New({
	...
	if arg_1_0.contextData.continuousBattleTimes and arg_1_0.contextData.continuousBattleTimes > 0:
		if var_1_1 == SYSTEM_BOSS_SINGLE:
			if not getProxy(ContextProxy).getCurrentContext().getContextByMediator(BossSingleContinuousOperationMediator):
		...
		elif not getProxy(ContextProxy).getCurrentContext().getContextByMediator(ContinuousOperationMediator):
...
def var_0_0.onPauseBtn(arg_13_0):
	local var_13_0 = ys.Battle.BattleState.GetInstance()

	if arg_13_0.contextData.system == SYSTEM_PROLOGUE or arg_13_0.contextData.system == SYSTEM_PERFORM:
		local var_13_1 = {}
		...
		var_13_0.Pause()
	elif arg_13_0.contextData.system == SYSTEM_DODGEM:
		local var_13_3 = {
		...
		var_13_0.Pause()
	elif arg_13_0.contextData.system == SYSTEM_SIMULATION:
		local var_13_4 = {
			text = "text_cancel_fight",
			btnType = pg.MsgboxMgr.BUTTON_RED,
			def onCallback:()
		...
		var_13_0.Pause()
	elif arg_13_0.contextData.system == SYSTEM_SUBMARINE_RUN or arg_13_0.contextData.system == SYSTEM_SUB_ROUTINE or arg_13_0.contextData.system == SYSTEM_REWARD_PERFORM or arg_13_0.contextData.system == SYSTEM_AIRFIGHT:
		var_13_0.Pause()
		arg_13_0.warnFunc(function()
			ys.Battle.BattleState.GetInstance().Resume())
	elif arg_13_0.contextData.system == SYSTEM_CARDPUZZLE:
...
def var_0_0.warnFunc(arg_26_0, arg_26_1):
	...
	if var_26_5 and #var_26_5 > 0:
		var_26_3 = i18n(var_26_5)
	elif var_26_1 == SYSTEM_CHALLENGE:
		var_26_3 = i18n("battle_battleMediator_clear_warning")
	elif var_26_1 == SYSTEM_SIMULATION:
...
def var_0_0.guideDispatch(arg_28_0):
	return

local function var_0_1(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	local var_29_0 = {}

	for iter_29_0, iter_29_1 in ipairs(arg_29_1.getActiveEquipments()):
		if iter_29_1:
			var_29_0[#var_29_0 + 1] = {
	...
	for iter_29_2, iter_29_3 in pairs(var_29_3):
		local var_29_4 = var_29_2(iter_29_3)

		var_29_1[var_29_4.id] = var_29_4

	for iter_29_4, iter_29_5 in pairs(arg_29_1.skills):
		if iter_29_5 and iter_29_5.id == 14900 and not arg_29_1.transforms[16412]:
			-- block empty
		else
	...
	for iter_29_6, iter_29_7 in ipairs(var_29_6):
		local var_29_7 = {}
	...
	for iter_29_8, iter_29_9 in pairs(arg_29_1.getTriggerSkills()):
		local var_29_9 = {
	...
	if var_29_11:
		for iter_29_10, iter_29_11 in pairs(var_29_1):
			local var_29_13 = pg.skill_data_template[iter_29_10].world_death_mark[1]

			if var_29_13 == ys.Battle.BattleConst.DEATH_MARK_SKILL.DEACTIVE:
				var_29_1[iter_29_10] = None
			elif var_29_13 == ys.Battle.BattleConst.DEATH_MARK_SKILL.IGNORE:
				-- block empty
...
def var_0_0.GenBattleData(arg_33_0):
	local var_33_0 = {}
	...
	if var_33_1 == SYSTEM_SCENARIO:
		...
		for iter_33_0, iter_33_1 in pairs(var_33_9):
		...
		if var_33_18 == True or var_33_18 > 0:
			var_33_0.SubFlag = 1
			...
			if var_33_18 != ys.Battle.BattleConst.SubAidFlag.AID_EMPTY:
		...
		local function var_33_22(arg_35_0, arg_35_1, arg_35_2)
			...
			if table.contains(var_33_5, var_35_0):
		...
		for iter_33_4, iter_33_5 in ipairs(var_33_13):
			var_33_22(iter_33_5, var_33_16, var_33_0.MainUnitList)

		for iter_33_6, iter_33_7 in ipairs(var_33_14):
			var_33_22(iter_33_7, var_33_16, var_33_0.VanguardUnitList)

		for iter_33_8, iter_33_9 in ipairs(var_33_15):
		...
		local function var_33_35(arg_36_0, arg_36_1, arg_36_2)
			...
			if table.contains(var_33_5, var_36_0):
				BattleVertify.cloneShipVertiry = True
		...
		local function var_33_41(arg_37_0)
			...
			for iter_37_0, iter_37_1 in ipairs(arg_37_0):
				local var_37_1 = {
		...
		for iter_33_18, iter_33_19 in pairs(var_33_42):
		...
		if var_33_51 == True:
			...
			if var_33_51 != ys.Battle.BattleConst.SubAidFlag.AID_EMPTY:
				var_33_0.TotalSubAmmo = 0

		arg_33_0.mainShips = {}

		for iter_33_20, iter_33_21 in ipairs(var_33_46):
			local var_33_55 = iter_33_21.id
			local var_33_56 = WorldConst.FetchWorldShip(iter_33_21.id).hpRant * 0.0001

			if table.contains(var_33_5, var_33_55):
				BattleVertify.cloneShipVertiry = True
		...
		if var_33_64.difficulty == ys.Battle.BattleConst.Difficulty.WORLD:
	...
	elif var_33_1 == SYSTEM_WORLD_BOSS:
		...
		for iter_33_26, iter_33_27 in ipairs(var_33_74):
			if table.contains(var_33_5, iter_33_27):
				BattleVertify.cloneShipVertiry = True
		...
		for iter_33_28, iter_33_29 in ipairs(var_33_77):
			if table.contains(var_33_5, iter_33_29):
				BattleVertify.cloneShipVertiry = True
	...
	elif var_33_1 == SYSTEM_HP_SHARE_ACT_BOSS or var_33_1 == SYSTEM_ACT_BOSS or var_33_1 == SYSTEM_ACT_BOSS_SP or var_33_1 == SYSTEM_BOSS_EXPERIMENT:
		if arg_33_0.contextData.mainFleetId:
			...
			local function var_33_89(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
				if table.contains(var_33_5, arg_38_0):
					BattleVertify.cloneShipVertiry = True
			...
			for iter_33_30, iter_33_31 in ipairs(var_33_90):
				var_33_89(iter_33_31, var_33_85, var_33_0.MainUnitList, var_33_86)

			for iter_33_32, iter_33_33 in ipairs(var_33_91):
			...
			for iter_33_34, iter_33_35 in ipairs(var_33_94):
			...
			if var_33_1 == SYSTEM_ACT_BOSS_SP:
				...
				var_33_0.ExtraBuffList = _.map(_.select(var_33_104, function(arg_41_0)
					return arg_41_0.CastOnEnemy()), function(arg_42_0)
					return arg_42_0.GetBuffID())
				var_33_0.ChapterBuffIDs = _.map(_.select(var_33_104, function(arg_43_0)
					return not arg_43_0.CastOnEnemy()), function(arg_44_0)
			...
			if var_33_92.isLegalToFight() == True and (var_33_1 == SYSTEM_BOSS_EXPERIMENT or var_33_100 <= var_33_95.oil):
				var_33_0.SubFlag = 1
				var_33_0.TotalSubAmmo = 1
		...
		for iter_33_36, iter_33_37 in pairs(var_33_114):
			local var_33_115 = iter_33_37.ship

			if var_33_115.getTeamType() == TeamType.Main:
				table.insert(var_33_112, var_33_115)
			elif var_33_115.getTeamType() == TeamType.Vanguard:
				table.insert(var_33_113, var_33_115)

		for iter_33_38, iter_33_39 in ipairs(var_33_112):
			var_33_111(iter_33_39, var_33_107, var_33_0.MainUnitList, var_33_108)

		for iter_33_40, iter_33_41 in ipairs(var_33_113):
		...
		for iter_33_42, iter_33_43 in pairs(var_33_119):
			local var_33_120 = iter_33_43.ship

			if var_33_120.getTeamType() == TeamType.Submarine:
				table.insert(var_33_118, var_33_120)

		for iter_33_44, iter_33_45 in ipairs(var_33_118):
	...
	elif var_33_1 == SYSTEM_BOSS_RUSH or var_33_1 == SYSTEM_BOSS_RUSH_EX:
		...
		if var_33_121.GetMode() == BossRushSeriesData.MODE.SINGLE:
		...
		local function var_33_130(arg_46_0, arg_46_1, arg_46_2, arg_46_3)
			if table.contains(var_33_5, arg_46_0):
				BattleVertify.cloneShipVertiry = True
		...
		for iter_33_46, iter_33_47 in ipairs(var_33_133):
			var_33_130(iter_33_47, var_33_132, var_33_0.MainUnitList, var_33_127)

		for iter_33_48, iter_33_49 in ipairs(var_33_134):
		...
		for iter_33_50, iter_33_51 in ipairs(var_33_137):
		...
		if var_33_135.isLegalToFight() == True and var_33_143 <= var_33_138.oil:
			var_33_0.SubFlag = 1
			var_33_0.TotalSubAmmo = 1

		arg_33_0.viewComponent.setFleet(var_33_127, var_33_128, var_33_129)
	elif var_33_1 == SYSTEM_LIMIT_CHALLENGE:
		...
		local function var_33_153(arg_48_0, arg_48_1, arg_48_2, arg_48_3)
			if table.contains(var_33_5, arg_48_0):
				BattleVertify.cloneShipVertiry = True
		...
		for iter_33_52, iter_33_53 in ipairs(var_33_155):
			var_33_153(iter_33_53, var_33_154, var_33_0.MainUnitList, var_33_150)

		for iter_33_54, iter_33_55 in ipairs(var_33_156):
		...
		for iter_33_56, iter_33_57 in ipairs(var_33_158):
		...
		if var_33_149.isLegalToFight() == True and var_33_163 <= var_33_159.oil:
			var_33_0.SubFlag = 1
			var_33_0.TotalSubAmmo = 1

		arg_33_0.viewComponent.setFleet(var_33_150, var_33_151, var_33_152)
	elif var_33_1 == SYSTEM_CARDPUZZLE:
		local var_33_164 = {}
		local var_33_165 = {}
		local var_33_166 = arg_33_0.contextData.relics

		for iter_33_58, iter_33_59 in ipairs(arg_33_0.contextData.cardPuzzleFleet):
	...
	elif var_33_1 == SYSTEM_BOSS_SINGLE:
		if arg_33_0.contextData.mainFleetId:
			...
			local function var_33_175(arg_50_0, arg_50_1, arg_50_2, arg_50_3)
				if table.contains(var_33_5, arg_50_0):
					BattleVertify.cloneShipVertiry = True
			...
			for iter_33_60, iter_33_61 in ipairs(var_33_176):
				var_33_175(iter_33_61, var_33_171, var_33_0.MainUnitList, var_33_172)

			for iter_33_62, iter_33_63 in ipairs(var_33_177):
			...
			for iter_33_64, iter_33_65 in ipairs(var_33_180):
			...
			if var_33_178.isLegalToFight() == True and var_33_184 <= var_33_181.oil:
				var_33_0.SubFlag = 1
				var_33_0.TotalSubAmmo = 1
	...
	elif arg_33_0.contextData.mainFleetId:
		...
		local function var_33_195(arg_52_0, arg_52_1, arg_52_2)
			for iter_52_0, iter_52_1 in ipairs(arg_52_0):
				if table.contains(var_33_5, iter_52_1):
					BattleVertify.cloneShipVertiry = True

				var_33_5[#var_33_5 + 1] = iter_52_1

				local var_52_0 = var_33_4.getShipById(iter_52_1)
				local var_52_1 = var_0_1(var_33_1, var_52_0, None, var_33_187)
		...
		if BATTLE_DEBUG and BATTLE_FREE_SUBMARINE:
			...
			if #var_33_200 > 0:
				...
				for iter_33_66, iter_33_67 in ipairs(var_33_200):
	...
	if var_33_1 == SYSTEM_DUEL and arg_33_0.contextData.rivalId:
	...
	if var_33_210:
		...
		for iter_33_68, iter_33_69 in ipairs(var_33_210.mainShips):
			var_33_212 = var_33_212 + iter_33_69.level

		for iter_33_70, iter_33_71 in ipairs(var_33_210.vanguardShips):
			var_33_212 = var_33_212 + iter_33_71.level

		BattleVertify = BattleVertify or {}
		BattleVertify.rivalLevel = var_33_212

		for iter_33_72, iter_33_73 in ipairs(var_33_210.mainShips):
			if not iter_33_73.hpRant or iter_33_73.hpRant > 0:
				local var_33_213 = var_0_1(var_33_1, iter_33_73, None, True)

				if iter_33_73.hpRant:
					var_33_213.initHPRate = iter_33_73.hpRant * 0.0001

				table.insert(var_33_0.RivalMainUnitList, var_33_213)

		for iter_33_74, iter_33_75 in ipairs(var_33_210.vanguardShips):
			if not iter_33_75.hpRant or iter_33_75.hpRant > 0:
				local var_33_214 = var_0_1(var_33_1, iter_33_75, None, True)

				if iter_33_75.hpRant:
	...
	if var_33_215:
		for iter_33_76, iter_33_77 in ipairs(var_33_215):
			local var_33_218 = {}

			for iter_33_78, iter_33_79 in ipairs(iter_33_77.equipment):
	...
	if var_33_216:
		for iter_33_80, iter_33_81 in ipairs(var_33_216):
			local var_33_220 = {}

			for iter_33_82, iter_33_83 in ipairs(iter_33_81.equipment):
	...
	if var_33_217:
		for iter_33_84, iter_33_85 in ipairs(var_33_217):
			local var_33_222 = {}

			for iter_33_86, iter_33_87 in ipairs(iter_33_85.equipment):
			...
			if var_33_1 == SYSTEM_SIMULATION and #var_33_0.SubUnitList > 0:
				var_33_0.SubFlag = 1
				var_33_0.TotalSubAmmo = 1

def var_0_0.listNotificationInterests(arg_53_0):
	return {
...
def var_0_0.handleNotification(arg_54_0, arg_54_1):
	...
	if var_54_0 == GAME.FINISH_STAGE_DONE:
	...
	elif var_54_0 == GAME.STORY_BEGIN:
		var_54_2.Pause()
	elif var_54_0 == GAME.STORY_END:
		var_54_2.Resume()
	elif var_54_0 == GAME.START_GUIDE:
		var_54_2.Pause()
	elif var_54_0 == GAME.END_GUIDE:
		var_54_2.Resume()
	elif var_54_0 == GAME.PAUSE_BATTLE:
		if not var_54_2.IsPause():
			arg_54_0.onPauseBtn()
	elif var_54_0 == GAME.RESUME_BATTLE:
		var_54_2.Resume()
	elif var_54_0 == GAME.FINISH_STAGE_ERROR:
		gcAll(True)
		...
		if var_54_8:
			...
			if var_54_3 == SYSTEM_DUEL:
				-- block empty
			elif var_54_3 == SYSTEM_SCENARIO:
				local var_54_14 = var_54_9.getContextByMediator(ChapterPreCombatMediator)

				var_54_9.removeChild(var_54_14)
			elif var_54_3 != SYSTEM_PERFORM and var_54_3 != SYSTEM_SIMULATION:
	...
	elif var_54_0 == var_0_0.CLOSE_CHAT:
		arg_54_0.viewComponent.OnCloseChat()
	elif var_54_0 == var_0_0.HIDE_ALL_BUTTONS:
	...
	elif var_54_0 == GAME.QUIT_BATTLE:
		var_54_2.Stop()

def var_0_0.remove(arg_55_0):
