...
def var_0_0.CollectionItems(arg_2_0, arg_2_1):
	eachChild(arg_2_0._tf, function(arg_3_0)
		if arg_3_0 != arg_2_0.mask:
...
def var_0_0.ZoomPainting(arg_9_0, arg_9_1, arg_9_2):
	local function var_9_0()
		...
		LeanTween.value(var_10_4.gameObject, Vector2(var_10_4.localScale.x, var_10_4.localScale.y), var_10_2, 0.2).setOnUpdate(System.Action_UnityEngine_Vector2(function(arg_12_0)
			var_10_4.localScale = Vector3(arg_12_0.x, arg_12_0.y, 1))).setOnComplete(System.Action(arg_9_2))

	onNextTick(var_9_0)

def var_0_0.SetPivot(arg_13_0, arg_13_1, arg_13_2):
...
def var_0_0.RevertItems(arg_15_0):
	for iter_15_0 = #arg_15_0.items, 1, -1:
...
def var_0_0.ZoomMask(arg_16_0, arg_16_1):
	LeanTween.value(arg_16_0.mask.gameObject, Vector2(418, 936), Vector2(4180, 2000), 0.4).setOnUpdate(System.Action_UnityEngine_Vector2(function(arg_17_0)
		arg_16_0.mask.sizeDelta = arg_17_0)).setOnComplete(System.Action(arg_16_1))

def var_0_0.MaskItems(arg_18_0):
	for iter_18_0 = #arg_18_0.items, 1, -1:
...
def var_0_0.SynItemsPosition(arg_20_0):
	for iter_20_0, iter_20_1 in ipairs(arg_20_0.items):
...
def var_0_0.Clear(arg_21_0):
	if arg_21_0.handle:
		...
		arg_21_0.handle = None

	if LeanTween.isTweening(arg_21_0.mask.gameObject):
		LeanTween.cancel(arg_21_0.mask.gameObject)

	if LeanTween.isTweening(arg_21_0.paintingTr.gameObject):
