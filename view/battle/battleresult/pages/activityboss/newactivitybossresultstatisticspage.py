...
def var_0_0.UpdateCommanders(arg_1_0, arg_1_1):
	parallelAsync({
		function(arg_2_0)
...
def var_0_0.GetTicketItemID(arg_6_0, arg_6_1):
...
def var_0_0.GetTicketUseCount(arg_7_0):
	return 1

def var_0_0.GetOilCost(arg_8_0):
	if not (pg.battle_cost_template[arg_8_0.contextData.system].oil_cost > 0):
		return 0

	return var_0_1(arg_8_0.contextData.actId, arg_8_0.contextData.stageId, arg_8_0.contextData.mainFleetId)

def var_0_0.InitActivityPanel(arg_9_0, arg_9_1):
...
def var_0_0.UpdateTicket(arg_10_0, arg_10_1):
...
def var_0_0.LoadActivityBossRes(arg_11_0, arg_11_1):
...
def var_0_0.RegisterEvent(arg_13_0, arg_13_1):
	var_0_0.super.RegisterEvent(arg_13_0, arg_13_1)
	onToggle(arg_13_0, arg_13_0.toggle, function(arg_14_0)
		getProxy(SettingsProxy).setActBossExchangeTicketTip(arg_14_0 and 1 or 0), SFX_PANEL, SFX_CANCEL)
	onButton(arg_13_0, arg_13_0.playAgain, function()
		arg_13_0.OnPlayAgain(arg_13_1), SFX_PANEL)

def var_0_0.IsLastBonus(arg_16_0):
	return arg_16_0.contextData.isLastBonus

def var_0_0.NotEnoughOilCost(arg_17_0):
	local var_17_0 = arg_17_0.GetOilCost()

	if var_17_0 > getProxy(PlayerProxy).getRawData().oil:
		return True, var_17_0

	return False

def var_0_0.NotEnoughShipBag(arg_18_0):
	if getProxy(BayProxy).getShipCount() >= getProxy(PlayerProxy).getRawData().getMaxShipBag():
		return True

	return False

def var_0_0.NotEnoughEnergy(arg_19_0):
...
def var_0_0.NotEnoughTicket(arg_21_0):
	if var_0_2(arg_21_0.contextData.actId, arg_21_0.contextData.stageId) > 0:
		return False
	...
	if var_21_1 > 0 and var_21_2:
		return True

	return False

def var_0_0.OnPlayAgain(arg_22_0, arg_22_1):
	if arg_22_0.IsLastBonus():
	...
	if arg_22_0.NotEnoughShipBag():
		arg_22_0.PassMsgbox("shipCapacity", None, arg_22_1)
...
def var_0_0.PassMsgbox(arg_23_0, arg_23_1, arg_23_2, arg_23_3):
