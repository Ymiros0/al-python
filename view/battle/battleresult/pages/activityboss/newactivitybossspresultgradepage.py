...
def var_0_0.LoadBGAndGrade(arg_1_0, arg_1_1):
	parallelAsync({
		function(arg_2_0)
...
def var_0_0.LoadActivityBossSPRes(arg_5_0, arg_5_1):
...
def var_0_0.InitActivityPanel(arg_7_0, arg_7_1):
...
def var_0_0.UpdateActiveBuffs(arg_8_0, arg_8_1, arg_8_2):
