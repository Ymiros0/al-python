...
def var_0_0.UpdateChapterName(arg_5_0):
	local var_5_0 = arg_5_0.contextData

	if getProxy(ChallengeProxy).getUserChallengeInfo(var_5_0.mode) == ChallengeProxy.MODE_INFINITE:
...
def var_0_0.LoadChallengeRes(arg_6_0, arg_6_1):
	...
	ResourceMgr.Inst.getAssetAsync("BattleResultItems/Challenge", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_7_0)
		if arg_6_0.exited or IsNil(arg_7_0):
			if arg_6_1:
				arg_6_1()
...
def var_0_0.UpdateChallengeInfo(arg_8_0, arg_8_1):
...
def var_0_0.RegisterEvent(arg_9_0, arg_9_1):
	seriesAsync({
		function(arg_10_0)
...
def var_0_0.RegisterChallengeEvent(arg_13_0, arg_13_1):
	if arg_13_0.isTotalClear():
		onButton(arg_13_0, arg_13_0.shareBtn, function()
			arg_13_0.emit(NewBattleResultMediator.CHALLENGE_SHARE), SFX_CONFIRM)
		onButton(arg_13_0, arg_13_0._tf, arg_13_1, SFX_CONFIRM)
	else
		onButton(arg_13_0, arg_13_0.continueBtn, function()
			arg_13_0.OnContinue(arg_13_1), SFX_CONFIRM)
		onButton(arg_13_0, arg_13_0.quitBtn, function()
			arg_13_0.OnQuit(arg_13_1), SFX_CONFIRM)

def var_0_0.OnContinue(arg_17_0, arg_17_1):
	if arg_17_0.isFail():
		arg_17_1()
	else
...
def var_0_0.OnQuit(arg_18_0, arg_18_1):
	if arg_18_0.isFail():
		arg_18_1()
	else
