...
def var_0_0.SetUp(arg_4_0, arg_4_1, arg_4_2):
	seriesAsync({
		function(arg_5_0)
			arg_4_0.cg.alpha = 0
...
def var_0_0.InitMainView(arg_10_0, arg_10_1):
...
def var_0_0.PlayEnterAnimation(arg_14_0, arg_14_1):
	if not getProxy(SettingsProxy).IsDisplayResultPainting():
		arg_14_1()
	...
	if arg_14_0.animation:
		arg_14_0.animation.Play(arg_14_0.resultPaintingData, function()
			arg_14_0.rawImage.texture = None

			Object.Destroy(arg_14_0.rawImage.gameObject)
			arg_14_1())

def var_0_0.LoadBG(arg_16_0, arg_16_1):
	local var_16_0 = arg_16_0._parentTf.Find("Effect")

	if not IsNil(var_16_0):
		...
		ResourceMgr.Inst.getAssetAsync("BattleResultItems/" .. var_16_1, "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_17_0)
			if arg_16_0.exited or IsNil(arg_17_0):
				if arg_16_1:
					arg_16_1()
...
def var_0_0.RegisterEvent(arg_18_0, arg_18_1):
	onButton(arg_18_0, arg_18_0.mainFleetBtn, function()
		...
		arg_18_0.UpdateCommanders(function()
			return)
		arg_18_0.UpdateSwitchBtn(), SFX_PANEL)
	...
	onButton(arg_18_0, arg_18_0.statisticsBtn, function()
		...
		arg_18_0.UpdateShipDetail(), SFX_PANEL)
	onButton(arg_18_0, arg_18_0.confrimBtn, function()
		arg_18_1(), SFX_PANEL)

	if arg_18_0.contextData.autoSkipFlag:
		onNextTick(function()
...
local function var_0_5(arg_26_0, arg_26_1)
	onButton(arg_26_0, arg_26_1, function()
		...
		arg_26_0.metaExpView.setData(var_27_0, function()
			...
			arg_26_0.metaExpView = None)
		arg_26_0.metaExpView.ActionInvoke("Show")
		arg_26_0.metaExpView.ActionInvoke("openPanel"), SFX_PANEL)

def var_0_0.UpdateMetaBtn(arg_29_0):
	local var_29_0 = getProxy(MetaCharacterProxy).getLastMetaSkillExpInfoList()

	if var_29_0 and #var_29_0 > 0:
		ResourceMgr.Inst.getAssetAsync("BattleResultItems/MetaBtn", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_30_0)
			...
			var_0_5(arg_29_0, var_30_0.transform)), True, True)

def var_0_0.StartEnterAnimation(arg_31_0, arg_31_1):
	...
	LeanTween.value(arg_31_0.bottomPanel.gameObject, -320, 0, 0.2).setOnUpdate(System.Action_float(function(arg_33_0)
		setAnchoredPosition(arg_31_0.bottomPanel, {
			y = arg_33_0
		}))).setOnComplete(System.Action(arg_31_1))

def var_0_0.GetShipSlotExpandPosition(arg_34_0, arg_34_1):
	local var_34_0 = arg_34_0.GetShipSlotShrinkPosition(arg_34_1)

	return Vector2(1300, var_34_0.y)

def var_0_0.GetShipSlotShrinkPosition(arg_35_0, arg_35_1):
...
local function var_0_6(arg_36_0, arg_36_1, arg_36_2)
	...
	if arg_36_1 or var_36_1:
		var_36_0 = arg_36_1 and arg_36_1.getConfig("name") or var_36_1 and i18n("Word_Ship_Exp_Buff")

	return var_36_0

def var_0_0.GetAnimationFlag(arg_37_0):
	if arg_37_0.contextData.autoSkipFlag:
		return False
...
def var_0_0.UpdateShipDetail(arg_38_0):
	...
	for iter_38_0, iter_38_1 in ipairs(var_38_4):
...
local function var_0_7(arg_40_0, arg_40_1)
	...
	if IsNil(var_40_0):
		ResourceMgr.Inst.getAssetAsync("BattleResultItems/MVP", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_41_0)
			if arg_40_0.exited or IsNil(arg_41_0):
				return

			Object.Instantiate(arg_41_0, arg_40_1).name = "MVP"), True, True)
	...
	if IsNil(var_40_1):
		ResourceMgr.Inst.getAssetAsync("BattleResultItems/MVPBG", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_42_0)
			if arg_40_0.exited or IsNil(arg_42_0):
				return
			...
			var_42_0.transform.SetAsFirstSibling()), True, True)
...
local function var_0_8(arg_43_0, arg_43_1)
	...
	if IsNil(var_43_0):
		ResourceMgr.Inst.getAssetAsync("BattleResultItems/LevelUp", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_44_0)
			if arg_43_0.exited or IsNil(arg_44_0):
				return

			Object.Instantiate(arg_44_0, arg_43_1).name = "LevelUp"), True, True)
...
local function var_0_9(arg_45_0, arg_45_1)
	...
	if IsNil(var_45_0):
		ResourceMgr.Inst.getAssetAsync("ui/zhandoujiesuan_xingxing", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_46_0)
			if arg_45_0.exited or IsNil(arg_46_0):
				return

			Object.Instantiate(arg_46_0, arg_45_1).name = "Intmacy"), True, True)
...
local function var_0_10(arg_47_0, arg_47_1, arg_47_2, arg_47_3, arg_47_4, arg_47_5)
	...
	var_47_3.make(function(arg_48_0, arg_48_1, arg_48_2)
		if arg_48_0 == UIItemList.EventUpdate:
	...
	if arg_47_5:
		onDelayTick(function()
			...
			var_0_9(arg_47_0, arg_47_1), 1)

def var_0_0.InitShips(arg_50_0, arg_50_1):
	arg_50_0.UpdateShips(True, arg_50_1)

def var_0_0.UpdateShips(arg_51_0, arg_51_1, arg_51_2):
	...
	local function var_51_5()
		for iter_52_0, iter_52_1 in ipairs(var_51_4):
	...
	for iter_51_0, iter_51_1 in ipairs(var_51_1):
		iter_51_1.GetComponent(typeof(CanvasGroup)).alpha = 0

def var_0_0.LoadShipTpls(arg_53_0, arg_53_1, arg_53_2, arg_53_3):
	local var_53_0 = {}

	for iter_53_0 = #arg_53_1 + 1, #arg_53_2:
		table.insert(var_53_0, function(arg_54_0)
			...
			ResourceMgr.Inst.getAssetAsync("BattleResultItems/Ship", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_55_0)
				if arg_53_0.exited or IsNil(arg_55_0):
					arg_54_0()
				...
				arg_54_0()), var_54_0, var_54_0))

	seriesAsync(var_53_0, arg_53_3)

def var_0_0.StartShipsEnterAnimation(arg_56_0, arg_56_1, arg_56_2, arg_56_3):
	if arg_56_2 <= 0:
		for iter_56_0, iter_56_1 in ipairs(arg_56_1):
	...
	for iter_56_2, iter_56_3 in ipairs(arg_56_1):
...
def var_0_0.UpdateSwitchBtn(arg_59_0):
...
def var_0_0.UpdateMvpPainting(arg_60_0, arg_60_1):
...
def var_0_0.RecordPainting(arg_62_0, arg_62_1):
	onNextTick(function()
		local var_63_0 = arg_62_0.resultPaintingTr.Find("fitter").GetChild(0)

		if not IsNil(var_63_0):
...
def var_0_0.UpdateFailedPainting(arg_64_0, arg_64_1):
	...
	ResourceMgr.Inst.getAssetAsync("BattleResultItems/FailedPainting", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_65_0)
		if arg_64_0.exited or IsNil(arg_65_0):
			arg_64_1()
...
def var_0_0.GetPaintingPosition(arg_66_0):
...
def var_0_0.UpdatePaintingPosition(arg_67_0):
	local var_67_0 = arg_67_0.GetPaintingPosition()

	arg_67_0.paintingTr.localPosition = var_67_0

def var_0_0.UpdatePainting(arg_68_0, arg_68_1):
	arg_68_0.UpdatePaintingPosition()

	if arg_68_0.contextData.score > 1:
		arg_68_0.UpdateMvpPainting(arg_68_1)
	else
		arg_68_0.UpdateFailedPainting(arg_68_1)

def var_0_0.DisplayShipDialogue(arg_69_0, arg_69_1):
	local var_69_0
	local var_69_1
	local var_69_2

	if arg_69_0.contextData.score > 1:
		local var_69_3, var_69_4

		var_69_3, var_69_4, var_69_1 = ShipWordHelper.GetWordAndCV(arg_69_1.skinId, ShipWordHelper.WORD_TYPE_MVP, None, None, arg_69_1.getCVIntimacy())
	else
		local var_69_5, var_69_6

		var_69_5, var_69_6, var_69_1 = ShipWordHelper.GetWordAndCV(arg_69_1.skinId, ShipWordHelper.WORD_TYPE_LOSE, None, None, arg_69_1.getCVIntimacy())
...
def var_0_0.PlayMvpShipVoice(arg_70_0):
	if not arg_70_0.contextData.statistics.mvpShipID or type(arg_70_0.contextData.statistics.mvpShipID) == "number" and arg_70_0.contextData.statistics.mvpShipID <= 0:
		return
	...
	if arg_70_0.contextData.score > 1:
		local var_70_4, var_70_5

		var_70_4, var_70_3, var_70_5 = ShipWordHelper.GetWordAndCV(var_70_0.skinId, ShipWordHelper.WORD_TYPE_MVP, None, None, var_70_0.getCVIntimacy())
	else
...
def var_0_0.StopVoice(arg_73_0):
	if arg_73_0._currentVoice:
		arg_73_0._currentVoice.PlaybackStop()

		arg_73_0._currentVoice = None

def var_0_0.UpdateGrade(arg_74_0):
...
def var_0_0.UpdateChapterName(arg_75_0):
...
def var_0_0.UpdatePlayer(arg_76_0):
	...
	if not arg_76_0.contextData.autoSkipFlag:
...
def var_0_0.UpdateCommanders(arg_79_0, arg_79_1):
	...
	local function var_79_3()
		...
		for iter_80_1 = #arg_79_0.commaderTpls, #var_79_2 + 1, -1:
			setActive(arg_79_0.commaderTpls[iter_80_1], False)

	for iter_79_0 = 1, #arg_79_0.emptyTpls:
		setActive(arg_79_0.emptyTpls[iter_79_0], var_79_2[iter_79_0] == None)

	arg_79_0.LoadCommanderTpls(#var_79_2, var_79_3)
	arg_79_1()

def var_0_0.LoadCommanderTpls(arg_81_0, arg_81_1, arg_81_2):
	local var_81_0 = {}

	for iter_81_0 = #arg_81_0.commaderTpls + 1, arg_81_1:
		table.insert(var_81_0, function(arg_82_0)
			...
			ResourceMgr.Inst.getAssetAsync("BattleResultItems/Commander", "", UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_83_0)
				if arg_81_0.exited or IsNil(arg_83_0):
					arg_82_0()

					return

				table.insert(arg_81_0.commaderTpls, Object.Instantiate(arg_83_0, arg_81_0.commmanderContainer).transform)
				arg_82_0()), var_82_0, var_82_0))

	parallelAsync(var_81_0, arg_81_2)

def var_0_0.onBackPressed(arg_84_0):
	if arg_84_0.metaExpView:
		arg_84_0.metaExpView.closePanel()

		arg_84_0.metaExpView = None

		return True

	return False

def var_0_0.OnDestroy(arg_85_0):
	arg_85_0.exited = True

	if arg_85_0.metaExpView:
		arg_85_0.metaExpView.Destroy()

		arg_85_0.metaExpView = None

	if arg_85_0.isShowing():
		arg_85_0.Hide()

	if arg_85_0.animation:
		arg_85_0.animation.Dispose()

	arg_85_0.animation = None

	if LeanTween.isTweening(arg_85_0.topPanel.gameObject):
		LeanTween.cancel(arg_85_0.topPanel.gameObject)

	if LeanTween.isTweening(arg_85_0.bottomPanel.gameObject):
		LeanTween.cancel(arg_85_0.bottomPanel.gameObject)

	if arg_85_0.surfaceShipTpls:
		for iter_85_0, iter_85_1 in ipairs(arg_85_0.surfaceShipTpls):
			if LeanTween.isTweening(iter_85_1.gameObject):
				LeanTween.cancel(iter_85_1.gameObject)

	if arg_85_0.subShipTpls:
		for iter_85_2, iter_85_3 in ipairs(arg_85_0.subShipTpls):
			if LeanTween.isTweening(iter_85_3.gameObject):
				LeanTween.cancel(iter_85_3.gameObject)

	if arg_85_0.numeberAnimations:
		for iter_85_4, iter_85_5 in ipairs(arg_85_0.numeberAnimations):
			iter_85_5.Dispose()

	if arg_85_0.playerAniamtion:
		arg_85_0.playerAniamtion.Dispose()

		arg_85_0.playerAniamtion = None
