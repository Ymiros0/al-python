...
def var_0_0.Execute(arg_2_0):
	...
	if var_2_1 == SYSTEM_DUEL:
		arg_2_0.ExitDuelSystem(var_2_0)
	elif var_2_1 == SYSTEM_ACT_BOSS:
		arg_2_0.ExitActBossSystem(var_2_0)
	elif var_2_1 == SYSTEM_ROUTINE or var_2_1 == SYSTEM_SUB_ROUTINE:
		arg_2_0.ExitRoutineSystem(var_2_0)
	elif var_2_1 == SYSTEM_SCENARIO:
		arg_2_0.ExitScenarioSystem(var_2_0)
	elif var_2_1 == SYSTEM_CHALLENGE:
		arg_2_0.ExitChallengeSystem(var_2_0)
	elif var_2_1 == SYSTEM_HP_SHARE_ACT_BOSS or var_2_1 == SYSTEM_BOSS_EXPERIMENT or var_2_1 == SYSTEM_ACT_BOSS_SP:
		arg_2_0.ExitShareBossSystem(var_2_0)
	elif var_2_1 == SYSTEM_WORLD_BOSS:
		arg_2_0.ExitWorldBossSystem(var_2_0)
	elif var_2_1 == SYSTEM_WORLD:
		arg_2_0.ExitWorldSystem(var_2_0)
	elif var_2_1 == SYSTEM_BOSS_RUSH or var_2_1 == SYSTEM_BOSS_RUSH_EX:
		if arg_2_0.CheckBossRushSystem(var_2_0):
			arg_2_0.ResultRushBossSystem(var_2_0)
	elif var_2_1 == SYSTEM_LIMIT_CHALLENGE:
		arg_2_0.ExitLimitChallengeSystem(var_2_0)
	elif var_2_1 == SYSTEM_BOSS_SINGLE:
...
def var_0_0.ExitDuelSystem(arg_3_0, arg_3_1):
...
def var_0_0.ExitActBossSystem(arg_4_0, arg_4_1):
...
def var_0_0.ExitRoutineSystem(arg_5_0, arg_5_1):
...
def var_0_0.ExitScenarioSystem(arg_6_0, arg_6_1):
	if arg_6_1.needHelpMessage:
...
def var_0_0.ExitShareBossSystem(arg_8_0, arg_8_1):
...
def var_0_0.ExitWorldBossSystem(arg_9_0, arg_9_1):
...
def var_0_0.ExitWorldSystem(arg_10_0, arg_10_1):
...
def var_0_0.ResultRushBossSystem(arg_11_0, arg_11_1):
	...
	if not (arg_11_1.score > ys.Battle.BattleConst.BattleScore.C) and arg_11_1.system == SYSTEM_BOSS_RUSH_EX:
...
def var_0_0.ExitRushBossSystem(arg_13_0, arg_13_1, arg_13_2):
...
def var_0_0.ExitLimitChallengeSystem(arg_14_0, arg_14_1):
...
def var_0_0.ExitBossSingleSystem(arg_15_0, arg_15_1):
...
def var_0_0.ExitCommonSystem(arg_16_0, arg_16_1):
...
local function var_0_1()
	...
	for iter_17_0, iter_17_1 in ipairs(var_17_0):
		if iter_17_1 and not iter_17_1.isEnd():
			table.insert(var_17_1, iter_17_1)

	return var_17_1

def var_0_0.ShowExtraChapterActSocre(arg_18_0, arg_18_1):
	...
	for iter_18_0, iter_18_1 in ipairs(var_18_3):
		local var_18_4 = iter_18_1.getConfig("config_data")
		local var_18_5 = arg_18_1.stageId

		if var_18_4[1] == var_18_5 and var_18_2 and var_18_2.isActExtra():
...
local function var_0_3(arg_21_0, arg_21_1)
	...
	local var_21_1 = var_21_0 and var_21_0.data.autoFlag or None
...
local function var_0_4(arg_23_0, arg_23_1)
	...
	local var_23_1 = var_23_0 and var_23_0.data.autoFlag or None
...
def var_0_0.CheckActBossSystem(arg_27_0, arg_27_1):
	...
	local var_27_1 = _.map(_.values(var_27_0.ships), function(arg_28_0)
		...
		if var_28_0 and var_28_0.energy == Ship.ENERGY_LOW:
			return var_28_0)
	...
	if arg_27_1.statistics._battleScore <= ys.Battle.BattleConst.BattleScore.C:
	...
	if var_27_5 and not var_27_5.data.autoFlag:
		var_0_3(arg_27_1)

		return

	if arg_27_1.continuousBattleTimes < 1:
		var_0_3(arg_27_1)
...
def var_0_0.ContinuousBossRush(arg_30_0, arg_30_1, arg_30_2, arg_30_3, arg_30_4, arg_30_5, arg_30_6):
	seriesAsync({
		function(arg_31_0)
...
def var_0_0.CheckBossRushSystem(arg_33_0, arg_33_1):
	...
	if var_33_0.getCurrentContext().getContextByMediator(ContinuousOperationMediator):
		var_0_5()
...
def var_0_0.CheckBossSingleSystem(arg_36_0, arg_36_1):
	pg.m02.sendNotification(BossSingleContinuousOperationMediator.CONTINUE_OPERATION)

	if var_0_6(arg_36_1) > getProxy(PlayerProxy).getRawData().oil:
	...
	local var_36_1 = _.map(_.values(var_36_0.ships), function(arg_37_0)
		...
		if var_37_0 and var_37_0.energy == Ship.ENERGY_LOW:
			return var_37_0)
	...
	if arg_36_1.statistics._battleScore <= ys.Battle.BattleConst.BattleScore.C:
	...
	if var_36_5 and not var_36_5.data.autoFlag:
		var_0_4(arg_36_1)

		return

	if arg_36_1.continuousBattleTimes < 1:
		var_0_4(arg_36_1)
...
local function var_0_7(arg_39_0, arg_39_1)
	...
	if var_39_0.GetStageBonus(arg_39_1) == 0 and getProxy(SettingsProxy).isTipActBossExchangeTicket() == 1 and var_39_3 > 0:
		return True
...
def var_0_0.listNotificationInterests(arg_41_0):
	return {
...
def var_0_0.handleNotification(arg_42_0, arg_42_1):
	local var_42_0 = arg_42_1.getName()
	local var_42_1 = arg_42_1.getBody()

	if var_42_0 == GAME.BOSSRUSH_SETTLE_DONE:
		arg_42_0.ExitRushBossSystem(arg_42_0.contextData, var_42_1)
	elif var_42_0 == ContinuousOperationMediator.ON_REENTER:
		if not var_42_1.autoFlag:
			var_0_3(arg_42_0.contextData)

			return

		if var_0_7(arg_42_0.contextData.actId, arg_42_0.contextData.stageId):
			pg.m02.sendNotification(GAME.ACT_BOSS_EXCHANGE_TICKET, {
				stageId = arg_42_0.contextData.stageId
			})
		else
			var_0_8(arg_42_0.contextData)
	elif var_42_0 == BossSingleContinuousOperationMediator.ON_REENTER:
		if not var_42_1.autoFlag:
...
def var_0_0.addSubLayers(arg_43_0, arg_43_1, arg_43_2, arg_43_3):
