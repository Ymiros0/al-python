...
def var_0_0.NeedCloseCamera(arg_1_0):
...
def var_0_0.NeedVibrate(arg_2_0):
...
def var_0_0.NeedHelpMessage(arg_3_0, arg_3_1):
	if (arg_3_0 == SYSTEM_SCENARIO or arg_3_0 == SYSTEM_ROUTINE or arg_3_0 == SYSTEM_SUB_ROUTINE or arg_3_0 == SYSTEM_DUEL) and arg_3_1 <= 0:
		return True

	return False

def var_0_0.GetAutoSkipFlag(arg_4_0, arg_4_1):
	if arg_4_1 == SYSTEM_SCENARIO:
		local var_4_0 = getProxy(ChapterProxy).getActiveChapter()

		return getProxy(ChapterProxy).GetChapterAutoFlag(var_4_0.id) == 1
	elif arg_4_1 == SYSTEM_WORLD:
		return nowWorld().isAutoFight

	return arg_4_0.autoSkipFlag or False

def var_0_0.GetExpBuffs(arg_5_0):
	local var_5_0

	if arg_5_0 == SYSTEM_SCENARIO or arg_5_0 == SYSTEM_ROUTINE or arg_5_0 == SYSTEM_ACT_BOSS or arg_5_0 == SYSTEM_HP_SHARE_ACT_BOSS or arg_5_0 == SYSTEM_SUB_ROUTINE or arg_5_0 == SYSTEM_WORLD or arg_5_0 == SYSTEM_BOSS_SINGLE:
...
def var_0_0.GetShipBuffs(arg_7_0):
	local var_7_0

	if arg_7_0 == SYSTEM_SCENARIO or arg_7_0 == SYSTEM_ROUTINE or arg_7_0 == SYSTEM_ACT_BOSS or arg_7_0 == SYSTEM_HP_SHARE_ACT_BOSS or arg_7_0 == SYSTEM_SUB_ROUTINE or arg_7_0 == SYSTEM_WORLD or arg_7_0 == SYSTEM_BOSS_SINGLE:
...
local function var_0_1()
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_3):
		table.insert(var_8_0, iter_8_1)

	for iter_8_2, iter_8_3 in ipairs(var_8_4):
	...
	if var_8_5:
		...
		for iter_8_4, iter_8_5 in ipairs(var_8_6):
...
local function var_0_2()
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_3):
		table.insert(var_10_0, iter_10_1)

	for iter_10_2, iter_10_3 in ipairs(var_10_4):
	...
	if var_10_5:
		...
		for iter_10_4, iter_10_5 in ipairs(var_10_6):
...
local function var_0_5()
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_2.GetShips()):
		table.insert(var_13_0, iter_13_1.ship)

	local var_13_3 = var_13_1.GetSubFleet()

	for iter_13_2, iter_13_3 in ipairs(var_13_3.GetShips()):
...
local function var_0_6(arg_14_0)
	...
	if var_14_1.GetMode() == BossRushSeriesData.MODE.SINGLE:
		var_14_4 = var_14_3[1]
...
def var_0_0.GetNewMainShips(arg_17_0):
	local var_17_0 = arg_17_0.system
	local var_17_1 = {}

	if var_17_0 == SYSTEM_SCENARIO:
		var_17_1 = var_0_1()
	elif var_17_0 == SYSTEM_WORLD:
		var_17_1 = var_0_2()
	elif var_17_0 == SYSTEM_WORLD_BOSS:
		var_17_1 = var_0_3(arg_17_0)
	elif var_17_0 == SYSTEM_HP_SHARE_ACT_BOSS or var_17_0 == SYSTEM_ACT_BOSS or var_17_0 == SYSTEM_ACT_BOSS_SP or var_17_0 == SYSTEM_BOSS_EXPERIMENT or var_17_0 == SYSTEM_BOSS_SINGLE:
		var_17_1 = var_0_4(arg_17_0)
	elif var_17_0 == SYSTEM_GUILD:
		var_17_1 = var_0_5()
	elif var_17_0 == SYSTEM_BOSS_RUSH or var_17_0 == SYSTEM_BOSS_RUSH_EX:
		var_17_1 = var_0_6(arg_17_0)
	elif var_17_0 == SYSTEM_DODGEM or var_17_0 == SYSTEM_SUBMARINE_RUN or var_17_0 == SYSTEM_REWARD_PERFORM or var_17_0 == SYSTEM_AIRFIGHT or var_17_0 == SYSTEM_CARDPUZZLE or var_17_0 == SYSTEM_CHALLENGE:
		-- block empty
	elif var_17_0 == SYSTEM_LIMIT_CHALLENGE:
