...
def var_0_0.initPainting(arg_4_0):
	...
	var_4_0.GetComponent(typeof(DftAniEvent)).SetEndEvent(function(arg_5_0)
		if arg_4_0._currentPainting:
			setActive(arg_4_0._currentPainting, False)

			arg_4_0._currentPainting = None)

def var_0_0.EnableSkillFloat(arg_6_0, arg_6_1):
	if arg_6_1 == arg_6_0._skillFloat:
		return

	arg_6_0._skillFloat = arg_6_1

	if arg_6_0._skillFloat:
		for iter_6_0, iter_6_1 in ipairs(arg_6_0._cacheSkill):
		...
		arg_6_0._preCommanderSkillTF = None
		arg_6_0._preSkillTF = None

	SetActive(arg_6_0.skillTips, arg_6_1)

def var_0_0.SkillHrzPop(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4):
	if not arg_7_0._skillFloat:
	...
	if arg_7_3:
		if arg_7_0._commanderSkillList[arg_7_3] and arg_7_0._commanderSkillList[arg_7_3][arg_7_1]:
			return
		...
		if arg_7_2.GetUnitType() == ys.Battle.BattleConst.UnitType.PLAYER_UNIT:
	...
	if arg_7_2.GetIFF() == ys.Battle.BattleConfig.FRIENDLY_CODE:
	...
	if arg_7_3:
		...
		if var_7_11 == None or var_7_11 == None and var_7_12 and not arg_7_2.IsMainFleetUnit():
			if var_7_8 == ys.Battle.BattleConfig.FRIENDLY_CODE:
			...
			for iter_7_0 = 1, #var_7_19:
				if var_7_19[iter_7_0]:
					var_7_17 = iter_7_0
			...
			if var_7_8 == ys.Battle.BattleConfig.FOE_CODE:
...
def var_0_0.SkillHrzPopCover(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
	arg_10_0.SkillHrzPop(arg_10_1, arg_10_2, None, arg_10_3)

def var_0_0.handleSkillFloatCld(arg_11_0, arg_11_1):
	local var_11_0 = arg_11_1.anchoredPosition
	local var_11_1 = arg_11_0.anchoredPosition.y

	if math.floor(math.abs(var_11_0.y - var_11_1)) <= 112.5:
		var_11_0.y = var_11_1 + 112.5
		arg_11_1.anchoredPosition = var_11_0

def var_0_0.handleSkillSinkCld(arg_12_0, arg_12_1):
	return

def var_0_0.commanderSkillFloat(arg_13_0, arg_13_1, arg_13_2, arg_13_3):
	...
	if arg_13_0._preCommanderSkillTF:
		local var_13_2 = arg_13_0._preCommanderSkillTF.anchoredPosition.y

		if math.floor(math.abs(var_13_1.y - var_13_2)) <= 97.5:
	...
	var_13_0.GetComponent(typeof(DftAniEvent)).SetEndEvent(function(arg_14_0)
		arg_13_0._commanderSkillList[arg_13_1][arg_13_2] = None
		arg_13_0._preCommanderSkillTF = None

		arg_13_0._skillFloatCMDPool.Recycle(arg_13_3))

def var_0_0.CutInPainting(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4):
	if arg_15_0._currentPainting:
	...
	if arg_15_0._skillPaintings[var_15_0] == None:
...
def var_0_0.didEnter(arg_16_0):
	...
	onButton(arg_16_0, arg_16_0.findTF("PauseBtn"), function()
		arg_16_0.emit(BattleMediator.ON_PAUSE), SFX_CONFIRM)
	...
	onToggle(arg_16_0, arg_16_0.findTF("AutoBtn"), function(arg_20_0)
		...
		setActive(var_16_1, var_16_0.ChatUseable()), SFX_PANEL, SFX_PANEL)
...
def var_0_0.exitBattle(arg_28_0, arg_28_1):
	if not arg_28_1:
...
def var_0_0.setChapter(arg_29_0, arg_29_1):
	arg_29_0._chapter = arg_29_1

def var_0_0.setFleet(arg_30_0, arg_30_1, arg_30_2):
	arg_30_0._mainShipVOs = arg_30_1
	arg_30_0._vanShipVOs = arg_30_2

def var_0_0.initPauseWindow(arg_31_0):
	...
	local function var_31_0(arg_32_0, arg_32_1, arg_32_2)
		for iter_32_0 = 1, 3:
			...
			if arg_32_2 and iter_32_0 <= #arg_32_2:
	...
	elif var_31_4 == SYSTEM_ROUTINE or var_31_4 == SYSTEM_DUEL or var_31_4 == SYSTEM_HP_SHARE_ACT_BOSS or var_31_4 == SYSTEM_BOSS_EXPERIMENT or var_31_4 == SYSTEM_ACT_BOSS or var_31_4 == SYSTEM_ACT_BOSS_SP or var_31_4 == SYSTEM_BOSS_RUSH or var_31_4 == SYSTEM_BOSS_RUSH_EX or var_31_4 == SYSTEM_LIMIT_CHALLENGE or var_31_4 == SYSTEM_BOSS_SINGLE:
		setText(var_31_2, "SP")
	...
	elif var_31_4 == SYSTEM_DEBUG:
		setText(var_31_2, "??")
		setText(var_31_3, "碧蓝梦境")
	elif var_31_4 == SYSTEM_CHALLENGE:
	...
	elif var_31_4 == SYSTEM_TEST or var_31_4 == SYSTEM_SUB_ROUTINE or var_31_4 == SYSTEM_PERFORM or var_31_4 == SYSTEM_PROLOGUE or var_31_4 == SYSTEM_DODGEM or var_31_4 == SYSTEM_SIMULATION or var_31_4 == SYSTEM_SUBMARINE_RUN or var_31_4 == SYSTEM_BOSS_EXPERIMENT or var_31_4 == SYSTEM_REWARD_PERFORM or var_31_4 == SYSTEM_AIRFIGHT:
		-- block empty
	elif var_31_4 == SYSTEM_CARDPUZZLE:
		-- block empty
	else
	...
	onButton(arg_31_0, arg_31_0.findTF("help", arg_31_0.pauseWindow), function()
		if BATTLE_DEBUG and PLATFORM == 7:
			setActive(arg_31_0.pauseWindow, False)
			pg.UIMgr.GetInstance().UnblurPanel(arg_31_0.pauseWindow, arg_31_0._tf)
			var_31_1.Resume()
...
def var_0_0.updatePauseWindow(arg_38_0):
	if not arg_38_0.pauseWindow:
		return

	setActive(arg_38_0.pauseWindow, True)
	pg.UIMgr.GetInstance().BlurPanel(arg_38_0.pauseWindow, None, {
	...
	local function var_38_4(arg_39_0, arg_39_1, arg_39_2)
		...
		for iter_39_0 = 1, #arg_39_0:
			local var_39_0 = arg_39_0[iter_39_0].id

			if var_38_1.GetFreezeShipByID(var_39_0):
			...
			elif var_38_1.GetShipByID(var_39_0):
...
def var_0_0.AddUIFX(arg_40_0, arg_40_1, arg_40_2):
...
def var_0_0.OnCloseChat(arg_41_0):
	local var_41_0 = arg_41_0.findTF("chatBtn")

	setActive(var_41_0, ys.Battle.BattleState.GetInstance().IsBotActive())

def var_0_0.clear(arg_42_0):
	arg_42_0._preSkillTF = None
	arg_42_0._preCommanderSkillTF = None
	arg_42_0._commanderSkillList = None
	arg_42_0._skillPaintings = None
	arg_42_0._currentPainting = None
