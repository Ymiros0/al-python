...
def var_0_0.setPlayer(arg_2_0):
	return

def var_0_0.setShips(arg_3_0):
	return
...
def var_0_0.didEnter(arg_6_0):
	...
	onButton(arg_6_0, arg_6_0._skipBtn, function()
		arg_6_0.skip(), SFX_CONFIRM)
	arg_6_0.showPainting()

def var_0_0.rankAnimaFinish(arg_9_0):
	arg_9_0._stateFlag = BattleResultLayer.STATE_REPORTED

def var_0_0.showPainting(arg_10_0):
	local var_10_0
	local var_10_1
	...
	setPaintingPrefabAsync(arg_10_0._painting, arg_10_0.paintingName, "jiesuan", function()
		if findTF(arg_10_0._painting, "fitter").childCount > 0:
	...
	if arg_10_0.contextData.score > 1:
		local var_10_2
	...
	if #var_10_4.text > CHAT_POP_STR_LEN:
...
def var_0_0.skip(arg_13_0):
	if arg_13_0._stateFlag == BattleResultLayer.STATE_RANK_ANIMA:
		-- block empty
	elif arg_13_0._stateFlag == BattleResultLayer.STATE_REPORTED:
