...
def var_0_0.uiStartAnimating(arg_4_0):
	...
	shiftPanel(arg_4_0._middle, 0, None, var_4_1, var_4_0, True, True)
	shiftPanel(arg_4_0._right, 0, None, var_4_1, var_4_0, True, True, None)
	shiftPanel(arg_4_0.topPanel, None, 0, var_4_1, var_4_0, True, True, None, None)

def var_0_0.uiExitAnimating(arg_5_0):
	local var_5_0 = 0
	local var_5_1 = 0.3

	shiftPanel(arg_5_0._middle, -840, None, var_5_1, var_5_0, True, True)
	shiftPanel(arg_5_0._right, 470, None, var_5_1, var_5_0, True, True)
	shiftPanel(arg_5_0.topPanel, None, arg_5_0.topPanel.rect.height, var_5_1, var_5_0, True, True, None, None)
...
def var_0_0.didEnter(arg_6_0):
	...
	onButton(arg_6_0, arg_6_0._startBtn, function()
		...
		for iter_9_0, iter_9_1 in pairs(var_9_0):
			...
			if var_9_1 == ShipStatus.STATE_CHANGE_FAIL:
				pg.TipsMgr.GetInstance().ShowTips(i18n(var_9_2))

				return

		arg_6_0.emit(ChallengePreCombatMediator.ON_START), SFX_UI_WEIGHANCHOR)
	onToggle(arg_6_0, arg_6_0._autoToggle, function(arg_10_0)
		...
		if arg_10_0 and arg_6_0.subUseable == True:
			...
			setActive(arg_6_0._autoSubToggle, False), SFX_PANEL, SFX_PANEL)
...
def var_0_0.onBackPressed(arg_17_0):
	if arg_17_0.strategyPanel and arg_17_0.strategyPanel._go and isActive(arg_17_0.strategyPanel._go):
...
def var_0_0.updateChallenge(arg_19_0, arg_19_1):
...
def var_0_0.updateView(arg_21_0, arg_21_1):
...
def var_0_0.displayFleetInfo(arg_26_0):
