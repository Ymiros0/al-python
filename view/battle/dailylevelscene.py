...
def var_0_0.setDailyCounts(arg_5_0, arg_5_1):
	arg_5_0.dailyCounts = arg_5_1

def var_0_0.setShips(arg_6_0, arg_6_1):
	arg_6_0.shipVOs = arg_6_1

def var_0_0.updateRes(arg_7_0, arg_7_1):
...
def var_0_0.didEnter(arg_8_0):
	...
	onButton(arg_8_0, arg_8_0.backBtn, function()
		if arg_8_0.descMode:
			if LeanTween.isTweening(go(arg_8_0.stageContain)) or LeanTween.isTweening(go(arg_8_0.selQuicklyTF)):
				return
	...
	if arg_8_0.contextData.dailyLevelId:
...
def var_0_0.initItems(arg_13_0):
	...
	for iter_13_0 = #arg_13_0.dailyList, 1, -1:
		...
		if var_13_2 and type(var_13_2) == "table":
			if not pg.TimeMgr.GetInstance().inTime(var_13_2):
	...
	if arg_13_0.contextData.dailyLevelId:
	...
	for iter_13_1, iter_13_2 in pairs(arg_13_0.dailyList):
		arg_13_0.dailyLevelTFs[iter_13_2] = cloneTplTo(arg_13_0.dailylevelTpl, arg_13_0.content, iter_13_2)

def var_0_0.sortDailyList(arg_14_0):
	if #arg_14_0.dailyList % 2 != 1:
...
def var_0_0.updateShowCenter(arg_16_0):
	if not arg_16_0.dailyList or #arg_16_0.dailyList == 0:
		return
...
def var_0_0.displayDailyLevels(arg_17_0):
	for iter_17_0, iter_17_1 in pairs(arg_17_0.dailyLevelTFs):
		arg_17_0.initDailyLevel(iter_17_0)

	arg_17_0.content.GetComponent(typeof(EnhancelScrollView)).def onCenterClick:(arg_18_0)
		arg_17_0.tryOpenDesc(tonumber(arg_18_0.name))
	arg_17_0.centerAniItem = None
	arg_17_0.centerCardId = None
	arg_17_0.checkAniTimer = Timer.New(function()
		if not arg_17_0.descMode:
			local var_19_0
			local var_19_1

			for iter_19_0, iter_19_1 in pairs(arg_17_0.dailyLevelTFs):
				GetComponent(iter_19_1, typeof(CanvasGroup)).alpha = 1

				if not var_19_0 and not var_19_1:
					var_19_0 = iter_19_1
					var_19_1 = iter_19_1
				elif iter_19_1.anchoredPosition.x < var_19_0.anchoredPosition.x:
					var_19_0 = iter_19_1
				elif iter_19_1.anchoredPosition.x > var_19_1.anchoredPosition.x:
					var_19_1 = iter_19_1

			GetComponent(var_19_0, typeof(CanvasGroup)).alpha = 0.5
			GetComponent(var_19_1, typeof(CanvasGroup)).alpha = 0.5

		for iter_19_2, iter_19_3 in pairs(arg_17_0.dailyLevelTFs):
			local var_19_2 = iter_19_3.localScale.x >= 0.98

			if arg_17_0.centerAniItem == iter_19_3 and var_19_2:
				return
			else
				if var_19_2:
...
def var_0_0.initDailyLevel(arg_23_0, arg_23_1):
	...
	if var_23_4 and type(var_23_4) == "table" and pg.TimeMgr.GetInstance().inTime(var_23_4):
...
def var_0_0.UpdateDailyLevelCnt(arg_25_0, arg_25_1):
...
def var_0_0.displayStageList(arg_28_0, arg_28_1):
	...
	local var_28_1 = _.sort(var_28_0.expedition_and_lv_limit_list, function(arg_29_0, arg_29_1)
		...
		if arg_29_0[2] == arg_29_1[2]:
			return arg_29_0[1] < arg_29_1[1]

		if var_29_0 == var_29_1:
			if var_29_0 == 1:
...
def var_0_0.updateStageTF(arg_30_0, arg_30_1, arg_30_2):
	...
	if arg_30_2.level > arg_30_0.player.level:
	...
	onButton(arg_30_0, var_30_1, function()
		pg.TipsMgr.GetInstance().ShowTips(i18n("dailyLevel_unopened")), SFX_PANEL)

def var_0_0.updateStage(arg_33_0, arg_33_1):
	...
	onButton(arg_33_0, var_33_0, function()
		if getProxy(DailyLevelProxy).CanQuickBattle(arg_33_1.id):
			local var_34_0 = pg.expedition_daily_template[arg_33_0.dailyLevelId]

			if (arg_33_0.dailyCounts[arg_33_0.dailyLevelId] or 0) >= var_34_0.limit_time:
				pg.TipsMgr.GetInstance().ShowTips(i18n("dailyLevel_restCount_notEnough"))

				return

			if LeanTween.isTweening(go(arg_33_0.descMain)) or LeanTween.isTweening(go(arg_33_0.listPanel)):
				return

			arg_33_0.OnSelectStage(arg_33_1)
		else
			arg_33_0.OnOpenPreCombat(arg_33_1), SFX_PANEL)

def var_0_0.OnOpenPreCombat(arg_35_0, arg_35_1):
	local var_35_0 = pg.expedition_daily_template[arg_35_0.dailyLevelId]

	if (arg_35_0.dailyCounts[arg_35_0.dailyLevelId] or 0) >= var_35_0.limit_time:
		pg.TipsMgr.GetInstance().ShowTips(i18n("dailyLevel_restCount_notEnough"))
...
def var_0_0.OnSelectStage(arg_36_0, arg_36_1):
	local var_36_0 = arg_36_0.selectedPanel.Find("stagetpl/info")

	onButton(arg_36_0, var_36_0, function()
		arg_36_0.EnableOrDisable(arg_36_1, False), SFX_PANEL)
	onButton(arg_36_0, arg_36_0.selectedPanel, function()
		arg_36_0.EnableOrDisable(arg_36_1, False), SFX_PANEL)
	arg_36_0.EnableOrDisable(arg_36_1, True)

def var_0_0.EnableOrDisable(arg_39_0, arg_39_1, arg_39_2):
	local var_39_0 = arg_39_0.stageTFs[arg_39_1.id].Find("quickly")

	if LeanTween.isTweening(go(arg_39_0.stageContain)) or LeanTween.isTweening(go(arg_39_0.selQuicklyTF)):
		return
	...
	if arg_39_2:
		...
		arg_39_0.DoUnselectAnimtion(var_39_0, function()
			arg_39_0.selectedStage = None)

def var_0_0.DoSelectedAnimation(arg_42_0, arg_42_1, arg_42_2, arg_42_3):
	...
	seriesAsync({
		function(arg_43_0)
			...
			LeanTween.value(go(arg_42_0.stageContain), var_43_0.y, var_43_0.y + arg_42_2, var_42_0).setOnUpdate(System.Action_float(function(arg_44_0)
				...
				setActive(arg_42_0.selectedPanel, True))).setEase(LeanTweenType.easeInOutCirc).setOnComplete(System.Action(arg_43_0)),
		function(arg_45_0)
			...
			LeanTween.value(go(arg_42_0.selQuicklyTF), 0, arg_42_0.selQuicklyTFSizeDeltaY, 0.1).setOnUpdate(System.Action_float(function(arg_46_0)
				...
				arg_42_0.selQuicklyTF.sizeDelta = Vector2(arg_42_0.selQuicklyTF.sizeDelta.x, arg_46_0))).setEase(LeanTweenType.easeInOutCirc).setOnComplete(System.Action(arg_45_0))
	}, arg_42_3)

def var_0_0.DoUnselectAnimtion(arg_47_0, arg_47_1, arg_47_2):
	...
	seriesAsync({
		function(arg_48_0)
			...
			LeanTween.value(go(arg_47_0.selQuicklyTF), arg_47_0.selQuicklyTFSizeDeltaY, 0, 0.1).setOnUpdate(System.Action_float(function(arg_49_0)
				...
				arg_47_0.selQuicklyTF.sizeDelta = Vector2(arg_47_0.selQuicklyTF.sizeDelta.x, arg_49_0))).setEase(LeanTweenType.easeInOutCirc).setOnComplete(System.Action(arg_48_0)),
		function(arg_50_0)
			...
			LeanTween.value(go(arg_47_0.stageContain), var_47_0.y, var_50_0, 0.15).setOnUpdate(System.Action_float(function(arg_51_0)
				arg_47_0.stageContain.anchoredPosition = Vector3(var_47_0.x, arg_51_0, 0))).setDelay(0.1).setEase(LeanTweenType.easeInOutCirc).setOnComplete(System.Action(arg_50_0))
	}, function()
		arg_47_0.stageScrollRect.enabled = True

		arg_47_2())

def var_0_0.UpdateBattleBtn(arg_53_0, arg_53_1):
	...
	onButton(arg_53_0, var_53_2, function()
		arg_53_0.OnOpenPreCombat(arg_53_1), SFX_PANEL)
	...
	onButton(arg_53_0, var_53_3, function()
		arg_53_0.OnQuickBattle(arg_53_1, var_53_1), SFX_PANEL)

	local var_53_4 = var_53_0.Find("once")

	onButton(arg_53_0, var_53_4, function()
		arg_53_0.OnQuickBattle(arg_53_1, 1), SFX_PANEL)
...
def var_0_0.OnQuickBattle(arg_57_0, arg_57_1, arg_57_2):
	if arg_57_2 <= 0:
		pg.TipsMgr.GetInstance().ShowTips(i18n("dailyLevel_restCount_notEnough"))

		return

	if PlayerPrefs.GetInt("daily_level_quick_battle_tip", 0) == 0:
		pg.MsgboxMgr.GetInstance().ShowMsgBox({
...
def var_0_0.enableDescMode(arg_59_0, arg_59_1, arg_59_2):
	...
	local function var_59_0(arg_60_0, arg_60_1, arg_60_2)
		if LeanTween.isTweening(go(arg_60_0)):
	...
	local function var_59_1()
		for iter_62_0, iter_62_1 in pairs(arg_59_0.dailyLevelTFs):
			setButtonEnabled(iter_62_1, not arg_59_1)

			if iter_62_0 != arg_59_0.curId:
				if LeanTween.isTweening(go(iter_62_1)):
...
def var_0_0.flipToSpecificCard(arg_67_0, arg_67_1):
	local var_67_0 = arg_67_0.content.GetComponent(typeof(EnhancelScrollView))

	for iter_67_0, iter_67_1 in pairs(arg_67_0.dailyLevelTFs):
		if arg_67_1 == iter_67_0:
...
def var_0_0.tryPlayGuide(arg_68_0):
	pg.SystemGuideMgr.GetInstance().PlayDailyLevel(function()
		triggerButton(arg_68_0.findTF("help_btn")))

def var_0_0.ShowGuildTaskTip(arg_70_0):
	pg.GuildMsgBoxMgr.GetInstance().NotificationForDailyBattle()

def var_0_0.clearTween(arg_71_0):
	if arg_71_0.tweens:
		cancelTweens(arg_71_0.tweens)

	local function var_71_0(arg_72_0)
		if LeanTween.isTweening(go(arg_72_0)):
			LeanTween.cancel(go(arg_72_0))

	for iter_71_0, iter_71_1 in pairs(arg_71_0.dailyLevelTFs):
		var_71_0(iter_71_1)

	var_71_0(arg_71_0.listPanel)
	var_71_0(arg_71_0.descMain)

def var_0_0.onBackPressed(arg_73_0):
	if arg_73_0.descMode:
		if LeanTween.isTweening(go(arg_73_0.stageContain)) or LeanTween.isTweening(go(arg_73_0.selQuicklyTF)):
			return
...
def var_0_0.willExit(arg_74_0):
	if arg_74_0.selectedStage:
		pg.UIMgr.GetInstance().UnblurPanel(arg_74_0.selectedPanel, arg_74_0._tf)

	arg_74_0.clearTween()

	if arg_74_0.checkAniTimer:
		arg_74_0.checkAniTimer.Stop()

		arg_74_0.checkAniTimer = None
