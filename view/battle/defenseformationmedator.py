...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.OPEN_SHIP_INFO, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		for iter_2_0, iter_2_1 in ipairs(arg_2_2.getShipIds()):
	...
	arg_1_0.bind(var_0_0.CHANGE_FLEET_SHIP, function(arg_6_0, arg_6_1, arg_6_2)
		local var_6_0 = arg_6_1 and arg_6_1.id or None
		...
		for iter_6_0 = #var_6_4, 1, -1:
			if var_6_4[iter_6_0] == var_6_0:
...
def var_0_0.refreshView(arg_8_0, arg_8_1):
	arg_8_0.viewComponent.UpdateFleetView(arg_8_1)

def var_0_0.save(arg_9_0, arg_9_1, arg_9_2):
	if arg_9_1:
...
def var_0_0.configDockYardFunc(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5):
	local function var_10_0(arg_11_0, arg_11_1)
		local var_11_0 = {}

		local function var_11_1(arg_12_0)
			if not arg_10_3:
				for iter_12_0, iter_12_1 in ipairs(_.reverse(arg_12_0)):
					if not table.contains(arg_11_0, iter_12_1):
						table.insert(arg_11_0, 1, iter_12_1)
			elif arg_10_3 and table.getCount(arg_11_0) == 0:
				for iter_12_2, iter_12_3 in ipairs(arg_12_0):
					if iter_12_3 != arg_10_3 and not table.contains(arg_11_0, iter_12_3):
						table.insert(arg_11_0, iter_12_3)
			elif arg_10_3:
				for iter_12_4, iter_12_5 in ipairs(arg_12_0):
					if iter_12_5 == arg_10_3:
						arg_12_0[iter_12_4] = arg_11_0[1]

				arg_11_0 = arg_12_0

		local function var_11_2(arg_13_0)
			if arg_10_4 == TeamType.Main:
				var_11_0.mainShips = arg_13_0 and arg_11_0 or arg_10_1
				var_11_0.vanguardShips = arg_10_2
			elif arg_10_4 == TeamType.Vanguard:
	...
	local function var_10_1(arg_19_0, arg_19_1, arg_19_2)
		...
		local function var_19_1(arg_20_0)
			for iter_20_0, iter_20_1 in ipairs(arg_20_0):
				...
				if (not arg_10_3 or arg_10_3 != iter_20_1 or var_20_0 != var_19_0) and var_20_0 == var_19_0:
					return False

			return True

		if arg_10_4 == TeamType.Main:
			if not var_19_1(arg_10_1):
				return False, i18n("ship_vo_mainFleet_exist_same_ship")
		elif arg_10_4 == TeamType.Vanguard and not var_19_1(arg_10_2):
...
def var_0_0.handleNotification(arg_22_0, arg_22_1):
	...
	if GAME.EXERCISE_FLEET_RESET == var_22_0:
