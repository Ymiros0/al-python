...
def var_0_0.register(arg_1_0):
	...
	if arg_1_0.contextData.EdittingFleet:
		var_1_1.EdittingFleet = arg_1_0.contextData.EdittingFleet
		arg_1_0.contextData.EdittingFleet = None
	...
	arg_1_0.bind(var_0_0.OPEN_SHIP_INFO, function(arg_7_0, arg_7_1, arg_7_2)
		...
		for iter_7_0, iter_7_1 in ipairs(arg_7_2.getShipIds()):
	...
	arg_1_0.bind(var_0_0.CHANGE_FLEET_SHIP, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
		...
		local var_8_2 = var_8_0 and ShipStatus.TAG_BLOCK_PVP or None
		local var_8_3, var_8_4, var_8_5 = arg_1_0.getDockCallbackFuncsForExercise(arg_8_1, arg_8_2, arg_8_3)
		local var_8_6 = {}

		for iter_8_0, iter_8_1 in ipairs(arg_8_2.ships):
			if not arg_8_1 or iter_8_1 != arg_8_1.id:
	...
	arg_1_0.bind(var_0_0.ON_START, function(arg_10_0, arg_10_1)
		...
		if arg_1_0.contextData.rivalId:
		...
		seriesAsync({
			function(arg_11_0)
				if arg_1_0.contextData.OnConfirm:
...
def var_0_0.changeFleet(arg_13_0, arg_13_1):
	if arg_13_0.contextData.system == SYSTEM_SUB_ROUTINE:
...
def var_0_0.refreshEdit(arg_14_0, arg_14_1):
	local var_14_0 = getProxy(FleetProxy)

	var_14_0.EdittingFleet = arg_14_1

	if arg_14_0.contextData.system != SYSTEM_SUB_ROUTINE:
...
def var_0_0.commitEdit(arg_15_0, arg_15_1):
	local var_15_0 = getProxy(FleetProxy)
	local var_15_1 = var_15_0.EdittingFleet

	if var_15_1 == None or var_15_1.isFirstFleet() or var_15_1.isLegalToFight() == True:
		var_15_0.commitEdittingFleet(arg_15_1)
	elif #var_15_1.ships == 0:
		var_15_0.commitEdittingFleet(arg_15_1)

		if arg_15_0.contextData.system == SYSTEM_SUB_ROUTINE:
			-- block empty
	else
		pg.MsgboxMgr.GetInstance().ShowMsgBox({
			...
			def onYes:()
				...
				for iter_16_0 = #var_16_1, 1, -1:
					var_15_1.removeShip(var_16_0[var_16_1[iter_16_0]])

				if var_15_1.id == FleetProxy.PVP_FLEET_ID:
...
def var_0_0.onAutoBtn(arg_17_0, arg_17_1):
...
def var_0_0.onAutoSubBtn(arg_18_0, arg_18_1):
...
def var_0_0.getDockCallbackFuncsForExercise(arg_22_0, arg_22_1, arg_22_2, arg_22_3):
	...
	local function var_22_4(arg_25_0)
		...
		for iter_25_0, iter_25_1 in ipairs(var_25_3):
			local var_25_4 = iter_25_1[1] > 0 and iter_25_1[1] or None
