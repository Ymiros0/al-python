...
def var_0_0.setRival(arg_2_0, arg_2_1):
...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.startBtn, function()
		arg_3_0.emit(RivalInfoMediator.START_BATTLE), SFX_CONFIRM)
	...
	onToggle(arg_3_0, arg_3_0.realNameToggle, function(arg_6_0)
		...
		arg_3_0.UpdateNames(), SFX_PANEL)
	setActive(arg_3_0.realNameToggle, pg.PushNotificationMgr.GetInstance().isEnableShipName())

def var_0_0.UpdateNames(arg_7_0):
	for iter_7_0, iter_7_1 in pairs(arg_7_0.names):
...
def var_0_0.initRivalInfo(arg_8_0):
	...
	setActive(findTF(arg_8_0._tf, "info/rank"), arg_8_0.rivalVO.rank != None)
	setActive(findTF(arg_8_0._tf, "info/medal"), arg_8_0.rivalVO.rank != None)
	setActive(findTF(arg_8_0._tf, "info/medal/Text"), arg_8_0.rivalVO.rank != None)

	if arg_8_0.rivalVO.rank:
	...
	local function var_8_5(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
		...
		setActive(arg_8_0.findTF("content", var_12_0), arg_12_3 != None)
		setActive(arg_8_0.findTF("empty", var_12_0), arg_12_3 == None)
	...
	LeanTween.value(go(var_8_13), 0, var_8_15, 0.5).setOnUpdate(System.Action_float(function(arg_14_0)
		setText(var_8_13, math.floor(arg_14_0)))).setOnComplete(System.Action(function()
