...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.ON_SELECT_ELITE_COMMANDER, function(arg_12_0, arg_12_1, arg_12_2)
		...
		arg_1_0.sendNotification(GAME.GO_SCENE, SCENE.COMMANDERCAT, {
			...
			def onSelected:(arg_14_0, arg_14_1)
				...
				for iter_14_0, iter_14_1 in pairs(var_12_0):
					if iter_14_0 == arg_12_1:
						for iter_14_2, iter_14_3 in pairs(var_12_2):
							if iter_14_3.groupId == var_14_1.groupId and iter_14_2 != arg_12_2:
						...
						for iter_14_4, iter_14_5 in pairs(var_14_2):
							if var_14_0 == iter_14_5.id:
				...
				arg_14_1(),
			def onQuit:(arg_15_0)
				var_12_1.updateCommanderByPos(arg_12_2, None)
				var_1_0.updateActivityFleet(var_1_3.id, arg_12_1, var_12_1)
				arg_15_0()
		})
	...
	arg_1_0.bind(var_0_0.ON_PRECOMBAT, function(arg_16_0, arg_16_1)
		if var_1_0.checkActivityFleet(var_1_3.id) != True:
		...
		if not var_1_2.getUserChallengeInfo(arg_16_1):
...
def var_0_0.handleNotification(arg_19_0, arg_19_1):
	...
	if var_19_0 == GAME.CHALLENGE2_INITIAL_DONE:
	...
	elif var_19_0 == GAME.CHALLENGE2_RESET_DONE:
		if arg_19_0.viewComponent.curMode == ChallengeProxy.MODE_INFINITE and not arg_19_0.viewComponent.isFinishedCasualMode():
		...
		arg_19_0.viewComponent.updateSlider()
		arg_19_0.viewComponent.updateFuncBtns()
	elif var_19_0 == GAME.CHALLENGE2_INFO_DONE:
		if arg_19_0.viewComponent.curMode == ChallengeProxy.MODE_INFINITE and not arg_19_0.viewComponent.isFinishedCasualMode():
			var_19_2.setCurMode(ChallengeProxy.MODE_CASUAL)
	...
	elif var_19_0 == GAME.COMMANDER_ACTIVITY_FORMATION_OP_DONE:
...
def var_0_0.getDockCallbackFuncs(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4):
	...
	local function var_22_4(arg_23_0, arg_23_1)
		...
		for iter_23_0, iter_23_1 in ipairs(arg_22_1):
			if arg_23_0.isSameKind(var_22_0.getShipById(iter_23_1)):
	...
	local function var_22_6(arg_25_0)
		...
		if #arg_25_0 > 0:
			var_25_1.insertShip(var_22_0.getShipById(arg_25_0[1]), None, arg_22_4)
