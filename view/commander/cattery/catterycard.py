...
def var_0_0.Update(arg_2_0, arg_2_1):
	...
	elif var_2_0 == Cattery.STATE_EMPTY:
		arg_2_0.FlushEmpty()
	elif var_2_0 == Cattery.STATE_OCCUPATION:
...
def var_0_0.UpdateStyle(arg_3_0):
	local var_3_0 = arg_3_0.cattery
	local var_3_1 = var_3_0.GetState()

	if not (var_3_1 == Cattery.STATE_LOCK):
		local var_3_2 = var_3_0._GetStyle_()

		if var_3_1 == Cattery.STATE_EMPTY:
...
def var_0_0.FlushEmpty(arg_4_0):
...
def var_0_0.FlushCommander(arg_5_0):
...
def var_0_0.AddExpAnim(arg_9_0, arg_9_1, arg_9_2):
	arg_9_0.RemoveTimer()
