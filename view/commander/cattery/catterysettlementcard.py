...
def var_0_0.UpdateCommander(arg_3_0):
...
def var_0_0.InitAnim(arg_4_0, arg_4_1):
...
def var_0_0.Action(arg_7_0, arg_7_1):
	if not arg_7_0.commander:
		arg_7_1()
...
def var_0_0.DoUpgradeAnim(arg_8_0, arg_8_1):
...
def var_0_0.LoadCommander(arg_15_0, arg_15_1):
...
def var_0_0.ReturnCommander(arg_16_0):
	if arg_16_0.painting:
		retCommanderPaintingPrefab(arg_16_0.char, arg_16_0.painting)

		arg_16_0.painting = None

def var_0_0.Clear(arg_17_0):
	if LeanTween.isTweening(go(arg_17_0.slider)):
		LeanTween.cancel(go(arg_17_0.slider))

	if LeanTween.isTweening(go(arg_17_0.expTxt)):
...
def var_0_0.GetOldCommander(arg_19_0, arg_19_1, arg_19_2):
...
def var_0_0.AddExpAnim(arg_20_0, arg_20_1, arg_20_2, arg_20_3, arg_20_4, arg_20_5, arg_20_6):
	parallelAsync({
		function(arg_21_0)
			LeanTween.value(go(arg_20_0.slider), arg_20_1, arg_20_2, var_0_1).setOnUpdate(System.Action_float(function(arg_22_0)
				arg_20_0.slider.value = arg_22_0)).setOnComplete(System.Action(arg_21_0)),
		function(arg_23_0)
			LeanTween.value(go(arg_20_0.expTxt), arg_20_3, arg_20_4, var_0_1).setOnUpdate(System.Action_float(function(arg_24_0)
				...
				arg_20_0.expTxt.text = "<color=#94d53eFF>" .. var_24_0 .. "/</color>" .. "<color=" .. arg_20_0.GetColor() .. ">" .. arg_20_5 .. "</color>")).setOnComplete(System.Action(arg_23_0))
	}, function()
		if arg_20_6:
			arg_20_6())

def var_0_0.GetColor(arg_26_0):
	return "#9f9999"
