...
def var_0_0.OnInit(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.okBtn, function()
		if arg_5_0.selectedID:
			arg_5_0.emit(CommanderHomeMediator.ON_CHANGE_STYLE, arg_5_0.cattery.id, arg_5_0.selectedID), SFX_PANEL)

def var_0_0.OnInitItem(arg_9_0, arg_9_1):
	local var_9_0 = CatteryStyleCard.New(arg_9_1)

	onButton(arg_9_0, var_9_0._tf, function()
		if not var_9_0.style.IsOwn():
		...
		arg_9_0.emit(CatteryDescPage.CHANGE_STYLE, var_10_0), SFX_PANEL)
...
def var_0_0.Update(arg_12_0, arg_12_1, arg_12_2):
	...
	for iter_12_0, iter_12_1 in ipairs(pg.commander_home_style.all):
