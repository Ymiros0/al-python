...
def var_0_0.Update(arg_2_0, arg_2_1):
	...
	if var_2_0 == CommanderBox.STATE_EMPTY:
		-- block empty
	elif var_2_0 == CommanderBox.STATE_WAITING:
		...
		arg_2_0.waitTimer = Timer.New(function()
			...
			arg_2_0._parent.updateCntLabel(), var_2_1, 1)

		arg_2_0.waitTimer.Start()
	elif var_2_0 == CommanderBox.STATE_STARTING:
		...
		arg_2_0.timer = Timer.New(function()
			...
			if var_4_1 <= 0:
				...
				setFillAmount(arg_2_0.slider, 1 - var_4_1 / var_2_3), 1, -1)

		arg_2_0.timer.Start()
		arg_2_0.timer.func()
		onButton(arg_2_0._parent, arg_2_0.quicklyTool, function()
			arg_2_0._parent.emit(CommanderCatScene.EVENT_QUICKLY_TOOL, arg_2_1.id), SFX_PANEL)
	elif var_2_0 == CommanderBox.STATE_FINISHED:
		...
		onButton(arg_2_0._parent, arg_2_0._tf, function()
			...
			if getProxy(PlayerProxy).getData().commanderBagMax <= var_6_0.getCommanderCnt():
				pg.TipsMgr.GetInstance().ShowTips(i18n("commander_capcity_is_max"))

				return

			arg_2_0._parent.emit(CommanderCatMediator.GET, arg_2_1.id), SFX_PANEL)
...
def var_0_0.playAnim(arg_7_0, arg_7_1):
	arg_7_0.loadBox(arg_7_0.boxVO.getFetchPrefab(), arg_7_0.boxParent, function(arg_8_0)
		...
		arg_8_0.SetActionCallBack(function(arg_9_0)
			if arg_9_0 == "finish":
				arg_8_0.SetActionCallBack(None)
				arg_7_1()))

def var_0_0.loadBox(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
	if not arg_10_1:
		arg_10_0.returnChar()
	else
		if arg_10_0.prefabName == arg_10_1:
			return
		...
		PoolMgr.GetInstance().GetSpineChar(var_10_0, True, function(arg_11_0)
			if arg_10_0.exited or var_10_0 != arg_10_0.prefabName:
...
def var_0_0.removeTimer(arg_12_0):
	if arg_12_0.timer:
		arg_12_0.timer.Stop()

		arg_12_0.timer = None

def var_0_0.removeWaitingTimer(arg_13_0):
	if arg_13_0.waitTimer:
		arg_13_0.waitTimer.Stop()

		arg_13_0.waitTimer = None

def var_0_0.returnChar(arg_14_0):
	if arg_14_0.modelTf and arg_14_0.prefabName:
		PoolMgr.GetInstance().ReturnSpineChar(arg_14_0.prefabName, arg_14_0.modelTf.gameObject)

		arg_14_0.modelTf = None
		arg_14_0.prefabName = None
...
def var_0_0.Destroy(arg_16_0):
	arg_16_0.Clear()
	arg_16_0.returnChar()

	arg_16_0.exited = True
	arg_16_0.boxVO = None
	arg_16_0.loading = None
