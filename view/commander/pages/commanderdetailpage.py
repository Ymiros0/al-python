...
def var_0_0.OnInit(arg_11_0):
	...
	onToggle(arg_11_0, arg_11_0.skillBtn, function(arg_12_0)
		...
		if arg_12_0:
			arg_11_0.emit(CommanderCatScene.EVENT_OPEN_DESC), SFX_PANEL)
	...
	onButton(arg_11_0, arg_11_0.modifyNameBtn, function()
		...
		if not var_15_0.canModifyName():
			...
			arg_11_0.renamePanel.ExecuteAction("Show", var_15_0), SFX_PANEL)

def var_0_0.Update(arg_16_0, arg_16_1, arg_16_2):
...
def var_0_0.UpdateLockState(arg_17_0):
	...
	onButton(arg_17_0, arg_17_0.lockTF, function()
		...
		arg_17_0.emit(CommanderCatMediator.LOCK, arg_17_0.commanderVO.id, var_18_0), SFX_PANEL)
...
def var_0_0.OnSort(arg_22_0, arg_22_1):
...
def var_0_0.UpdatePreView(arg_23_0, arg_23_1):
	arg_23_0.UpdateAbilitys(arg_23_1)
	arg_23_0.UpdatePreviewAddition(arg_23_1)
	arg_23_0.UpdateLevel(arg_23_1)

def var_0_0.UpdatePreViewWithOther(arg_24_0, arg_24_1):
	if not arg_24_1 or #arg_24_1 <= 0:
		return
...
def var_0_0.UpdatePreviewAddition(arg_25_0, arg_25_1):
	arg_25_0.UpdateAbilityAddition(arg_25_1)
	arg_25_0.UpdateTalentAddition()

def var_0_0.UpdateOtherCommander(arg_26_0, arg_26_1):
		...
		if arg_27_0 == UIItemList.EventUpdate:
			...
			if var_27_0:
				...
				onToggle(arg_26_0, arg_27_2, function(arg_28_0)
					if arg_28_0:
						arg_26_0.otherCommanderDescTxt.SetText(var_27_0.getConfig("desc")), SFX_PANEL)

				if arg_27_1 == 0:
					triggerToggle(arg_27_2, True)

			setActive(arg_27_2.Find("empty"), var_27_0 == None)

			arg_27_2.GetComponent(typeof(Image)).enabled = var_27_0 != None
...
def var_0_0.UpdateLevel(arg_29_0, arg_29_1):
...
def var_0_0.UpdateAbilityAddition(arg_31_0, arg_31_1):
...
def var_0_0.UpdateTalents(arg_32_0):
...
def var_0_0.UpdateTalent(arg_34_0, arg_34_1, arg_34_2, arg_34_3):
	...
	if arg_34_3.GetComponent(typeof(Button)):
		onButton(arg_34_0, arg_34_3, function()
			arg_34_0.contextData.treePanel.ExecuteAction("Show", arg_34_2), SFX_PANEL)

	setActive(arg_34_3.Find("lock"), not arg_34_1.IsLearnedTalent(arg_34_2.id))

def var_0_0.UpdateTalentAddition(arg_36_0):
...
def var_0_0.UpdateSkills(arg_38_0):
	...
	onButton(arg_38_0, arg_38_0.skillIcon, function()
		arg_38_0.emit(CommanderCatMediator.SKILL_INFO, var_38_0), SFX_PANEL)

def var_0_0.CanBack(arg_40_0):
	if arg_40_0.renamePanel and arg_40_0.renamePanel.GetLoaded() and arg_40_0.renamePanel.isShowing():
...
def var_0_0.OnDestroy(arg_41_0):
	...
	if arg_41_0.renamePanel:
		arg_41_0.renamePanel.Destroy()

		arg_41_0.renamePanel = None

def var_0_0.Blur(arg_42_0):
	if arg_42_0.isOnAddition or arg_42_0.isOnSkill or arg_42_0.isOnOther:
