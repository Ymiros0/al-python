...
def var_0_0.updateSkillTF(arg_17_0, arg_17_1, arg_17_2):
	...
	if arg_17_1:
		...
		onButton(arg_17_0, arg_17_2, function()
			arg_17_0.emit(FormationMediator.ON_CMD_SKILL, var_17_0), SFX_PANEL)
	else
...
def var_0_0.updateCommander(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4):
	...
	if arg_19_4:
		onButton(arg_19_0, var_19_1, function()
			arg_19_0.emit(FormationMediator.ON_SELECT_COMMANDER, arg_19_2, arg_19_0.fleet.id), SFX_PANEL)
...
def var_0_0.OnDestroy(arg_31_0):
	if arg_31_0.isShowing():
		...
		if isActive(arg_31_0.descPanel):
