...
def var_0_0.OnInit(arg_2_0):
	...
	pressPersistTrigger(arg_2_0.addBtn, 0.5, function()
		if arg_2_0.currCnt > CommanderConst.MAX_GETBOX_CNT - arg_2_0.count - 1:
			return
	...
	onButton(arg_2_0, arg_2_0.maxBtn, function()
		...
		for iter_7_0 = arg_2_0.count, var_7_4 - 1:
	...
	onButton(arg_2_0, arg_2_0.confirmBtn, function()
		if arg_2_0.currCnt > 0:
			arg_2_0.skip = False

			arg_2_0.OnConfirm(arg_2_0.total, arg_2_0.currCnt), SFX_PANEL)
...
def var_0_0.OnConfirm(arg_9_0, arg_9_1, arg_9_2):
	local var_9_0 = getProxy(PlayerProxy).getRawData()

	if arg_9_1 > var_9_0.gold:
...
def var_0_0.GoShoppingMsgBox(arg_11_0, arg_11_1, arg_11_2, arg_11_3):
	if arg_11_3:
		local var_11_0 = ""

		for iter_11_0, iter_11_1 in ipairs(arg_11_3):
...
def var_0_0.updateValue(arg_19_0):
	...
	for iter_19_0 = arg_19_0.count, var_19_0:
...
def var_0_0.endAnim(arg_21_0):
	setActive(arg_21_0.bg1, True)
	setActive(arg_21_0.bg2, False)

	for iter_21_0 = 0, arg_21_0.boxMove.childCount - 1:
		local var_21_0 = arg_21_0.boxMove.GetChild(iter_21_0)

		Destroy(var_21_0)

	for iter_21_1, iter_21_2 in ipairs(arg_21_0.tweenList):
		if iter_21_2:
	...
	if arg_21_0.callback:
		arg_21_0.callback()

		arg_21_0.callback = None

def var_0_0.PlayAnim(arg_22_0, arg_22_1, arg_22_2):
	assert(arg_22_2)
	...
	if arg_22_0.skip:
		...
		arg_22_0.aniEvt.SetTriggerEvent(function(arg_23_0)
			for iter_23_0, iter_23_1 in ipairs(arg_22_1):
				var_22_0 = var_22_0 + iter_23_0

			for iter_23_2, iter_23_3 in ipairs(arg_22_1):
				for iter_23_4 = 1, iter_23_3.count:
					local var_23_0 = LeanTween.delayedCall(0.2 + 1 * var_22_1 + 1 * (iter_23_4 - 1), System.Action(function()
						arg_22_0.playBoxMove(iter_23_3))).uniqueId
