...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.BATCH_GET, function(arg_9_0, arg_9_1)
		...
		for iter_9_0, iter_9_1 in pairs(arg_9_1):
			if iter_9_1.getState() == CommanderBox.STATE_FINISHED:
...
def var_0_0.handleNotification(arg_21_0, arg_21_1):
	...
	if var_21_0 == GAME.COMMANDER_RESERVE_BOX_DONE:
	...
	elif var_21_0 == GAME.COMMANDER_QUICKLY_FINISH_BOXES_ERROR:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_QUICKLY_FINISH_TOOL_ERROR)
	elif var_21_0 == GAME.COMMANDER_UPGRADE_DONE:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_UPGRADE, var_21_1.oldCommander, var_21_1.commander)
	elif var_21_0 == GAME.COMMANDER_LOCK_DONE:
		if var_21_1.flag == 1:
			pg.TipsMgr.GetInstance().ShowTips(i18n("commander_lock_done"))
		elif var_21_1.flag == 0:
			pg.TipsMgr.GetInstance().ShowTips(i18n("commander_unlock_done"))
	elif var_21_0 == GAME.COMMANDER_RENAME_DONE:
		pg.TipsMgr.GetInstance().ShowTips(i18n("commander_rename_success_tip"))
	elif var_21_0 == GAME.COMMANDER_FETCH_NOT_LEARNED_TALENT_DONE:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_FETCH_TALENT_LIST)
	elif var_21_0 == GAME.COMMANDER_LEARN_TALENTS_DONE:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_LEARN_TALENT)
	elif var_21_0 == CommanderProxy.COMMANDER_UPDATED or var_21_0 == CommanderProxy.COMMANDER_ADDED or var_21_0 == CommanderProxy.COMMANDER_DELETED:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_UPDATE)
	elif var_21_0 == GAME.COMMANDER_CATTERY_OP_DONE or var_21_0 == GAME.ZERO_HOUR_OP_DONE or var_21_0 == GAME.PUT_COMMANDER_IN_CATTERY_DONE:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_HOME_TIP)
	elif var_21_0 == GAME.COMMANDER_ON_BUILD_DONE or var_21_0 == GAME.REFRESH_COMMANDER_BOXES_DONE:
		arg_21_0.viewComponent.emit(CommanderCatScene.MSG_BUILD)
	elif var_21_0 == GAME.COMMANDER_ON_OPEN_BOX_DONE:
	...
	elif var_21_0 == GAME.COMMANDER_ON_BATCH_DONE:
		arg_21_0.BatchDisplayCommander(var_21_1.boxIds, var_21_1.commanders)

def var_0_0.BatchDisplayCommander(arg_25_0, arg_25_1, arg_25_2):
	local var_25_0 = {}
	...
	parallelAsync(var_25_0, function()
		...
		for iter_27_0, iter_27_1 in ipairs(arg_25_2):
			table.insert(var_27_0, function(arg_28_0)
				if getProxy(CommanderProxy).hasSkipFlag and not iter_27_1.ShouldTipLock():
					arg_28_0()
				else
...
def var_0_0.DisplayNewCommander(arg_30_0, arg_30_1, arg_30_2):
...
def var_0_0.remove(arg_31_0):
	if pg.ConnectionMgr.GetInstance().isConnected():
