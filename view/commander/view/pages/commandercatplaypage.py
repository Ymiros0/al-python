...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.descBtn, function()
		...
		setActive(arg_3_0.descBtn.Find("sel"), arg_3_0.isOpenDescPage), SFX_PANEL)
...
def var_0_0.Show(arg_14_0, arg_14_1):
	...
	if arg_14_0.isOpenDescPage:
		arg_14_0.UpdateDescPage()

def var_0_0.UpdateMaterials(arg_15_0):
...
def var_0_0.UpdateMainView(arg_17_0):
...
def var_0_0.UpdateDescPage(arg_18_0):
	local function var_18_0(arg_19_0, arg_19_1)
		if not arg_19_0 and arg_19_1.desc_world and arg_19_1.desc_world != "":
...
def var_0_0.CloseDescPage(arg_21_0):
	setActive(arg_21_0.descPage, False)

def var_0_0.SimulateAddSkillExp(arg_22_0, arg_22_1):
...
def var_0_0.UpdateSkillTF(arg_23_0, arg_23_1):
...
def var_0_0.SimulateAddCommanderExp(arg_24_0, arg_24_1):
...
def var_0_0.UpdateCommanderTF(arg_25_0, arg_25_1):
...
def var_0_0.UpdateConsume(arg_26_0, arg_26_1, arg_26_2):
	...
	local function var_26_1()
		if var_26_0.gold < arg_26_0.total:
	...
	onButton(arg_26_0, arg_26_0.confirmBtn, function()
		if not arg_26_1 or #arg_26_1 <= 0:
			return

		arg_26_0.CheckTip(arg_26_1, arg_26_2, var_26_1), SFX_PANEL)

def var_0_0.CheckTip(arg_29_0, arg_29_1, arg_29_2, arg_29_3):
	local var_29_0 = {}

	if CommanderCatUtil.AnySSRCommander(arg_29_1):
	...
	if var_29_1.isMaxLevel() and var_29_1.exp > 0 and not var_29_2.isMaxLevel():
	...
	if arg_29_0.commander.isMaxLevel():
...
def var_0_0.UpdateCard(arg_33_0, arg_33_1, arg_33_2):
	...
	if var_33_1:
		onButton(arg_33_0, var_33_3, function()
			...
			arg_33_0.UpdateMaterials(), SFX_PANEL)
		...
		onButton(arg_33_0, var_33_2, function()
			if table.getCount(getProxy(CommanderProxy).getRawData()) == 1:
				pg.TipsMgr.GetInstance().ShowTips(i18n("commander_material_noenough"))

				return

			if not arg_33_0.commander.getSkills()[1].isMaxLevel() or not arg_33_0.commander.isMaxLevel():
				arg_33_0.emit(CommanderCatMediator.ON_SELECT, arg_33_0.GenSelectData()), SFX_PANEL)

	setActive(var_33_2, not var_33_1)
	setActive(var_33_3, var_33_1)

def var_0_0.GenSelectData(arg_36_0):
...
def var_0_0.Hide(arg_39_0):
	var_0_0.super.Hide(arg_39_0)

def var_0_0.OnDestroy(arg_40_0):
	if arg_40_0.animation:
		arg_40_0.animation.Dispose()

		arg_40_0.animation = None

	arg_40_0.ClearSortData()

def var_0_0.GetSortData(arg_41_0):
	if not var_0_0.SortData:
...
def var_0_0.SaveSortData(arg_42_0, arg_42_1):
	var_0_0.SortData = arg_42_1

def var_0_0.ClearSortData(arg_43_0):
	var_0_0.SortData = None
