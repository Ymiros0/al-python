...
local function var_0_1(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in pairs(var_1_0):
		for iter_1_2, iter_1_3 in pairs(iter_1_1.getCommanders()):
...
local function var_0_2(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in pairs(var_2_2):
		...
		for iter_2_2, iter_2_3 in pairs(iter_2_1.getCommanders()):
...
local function var_0_3(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in pairs(var_3_0.getEliteFleetCommanders()):
...
local function var_0_4(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in pairs(var_4_2):
		...
		for iter_4_2, iter_4_3 in pairs(iter_4_1.getCommanders()):
...
local function var_0_5(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in pairs(var_5_1):
		...
		for iter_5_2, iter_5_3 in pairs(var_5_2.getCommanders()):
...
local function var_0_6(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in pairs(var_6_1):
		...
		for iter_6_2, iter_6_3 in pairs(iter_6_1):
			...
			for iter_6_4, iter_6_5 in pairs(var_6_3.getCommanders()):
...
local function var_0_7(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in pairs(var_7_0):
		...
		for iter_7_2, iter_7_3 in pairs(iter_7_1.getCommanders()):
...
local function var_0_8(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in pairs(var_8_1):
		...
		for iter_8_2, iter_8_3 in pairs(iter_8_1.getCommanders()):
...
local function var_0_9(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in pairs(var_10_2):
		...
		for iter_10_2, iter_10_3 in pairs(iter_10_1.getCommanders()):
			arg_10_1[iter_10_3.id].sub = var_10_3
			arg_10_1[iter_10_3.id].fleetId = var_10_4
			arg_10_1[iter_10_3.id].inFleet = True

def var_0_0.GetCommanderList(arg_11_0):
	local var_11_0 = getProxy(CommanderProxy).getData()

	if CommanderCatScene.FLEET_TYPE_COMMON == arg_11_0.fleetType:
		var_0_1(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_ACTBOSS == arg_11_0.fleetType:
		var_0_2(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_HARD_CHAPTER == arg_11_0.fleetType:
		var_0_3(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_CHALLENGE == arg_11_0.fleetType:
		var_0_4(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_GUILDBOSS == arg_11_0.fleetType:
		var_0_5(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_WORLD == arg_11_0.fleetType:
		var_0_6(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_BOSSRUSH == arg_11_0.fleetType:
		var_0_7(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_LIMIT_CHALLENGE == arg_11_0.fleetType:
		var_0_8(arg_11_0, var_11_0)
	elif CommanderCatScene.FLEET_TYPE_BOSSSINGLE == arg_11_0.fleetType:
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_0.ignoredIds or {}):
		var_11_2[iter_11_1] = True

	local var_11_3 = {}

	for iter_11_2, iter_11_3 in pairs(var_11_0):
		if not var_11_2[iter_11_2]:
			table.insert(var_11_3, iter_11_3)

	return var_11_3

def var_0_0.GetSkillExpAndCommanderExp(arg_13_0, arg_13_1):
	local var_13_0 = 0
	local var_13_1 = 0
...
def var_0_0.AnySSRCommander(arg_14_0):
...
def var_0_0.CalcCommanderConsume(arg_16_0):
...
def var_0_0.SetActive(arg_17_0, arg_17_1):
...
def var_0_0.CommanderInChapter(arg_18_0):
...
def var_0_0.GetAllTalentNames():
	local var_20_0 = {}

	for iter_20_0, iter_20_1 in ipairs(pg.commander_ability_group.all):
		local var_20_1 = pg.commander_ability_group[iter_20_1]

		if var_20_1.ability_list and #var_20_1.ability_list > 0:
...
def var_0_0.ShortenString(arg_21_0, arg_21_1):
	...
	while var_21_1 <= var_21_4:
		...
		if var_21_9 == arg_21_1 - 1:
			var_21_3 = var_21_1
		elif arg_21_1 < var_21_9:
			var_21_5 = True

			break

	if var_21_3 == 0 or var_21_4 < var_21_3 or not var_21_5:
		return arg_21_0
