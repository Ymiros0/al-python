...
def var_0_0.display(arg_5_0):
	...
	var_5_0.make(function(arg_6_0, arg_6_1, arg_6_2)
		if arg_6_0 == UIItemList.EventUpdate:
			...
			if arg_5_0.emojiProxy.fliteNewEmojiDataByType()[var_6_0]:
...
def var_0_0.filter(arg_8_0, arg_8_1):
	...
	if arg_8_1 == ChatConst.EmojiCommon:
		...
		table.sort(var_8_5, function(arg_11_0, arg_11_1)
			if arg_11_0.count == arg_11_1.count:
	...
	if var_8_2[arg_8_1]:
		for iter_8_4, iter_8_5 in pairs(var_8_2[arg_8_1]):
	...
	for iter_8_6 = arg_8_0.emojiContent.childCount - 1, var_8_6, -1:
	...
	for iter_8_7 = arg_8_0.emojiContent.childCount + 1, var_8_6:
		local var_8_8

		if #arg_8_0.tplCaches > 0:
	...
	for iter_8_8 = 0, arg_8_0.emojiContent.childCount - 1:
			...
			if arg_14_0 == UIItemList.EventUpdate:
				PoolMgr.GetInstance().GetPrefab("emoji/" .. var_14_0.pic, var_14_0.pic, True, function(arg_15_0)
					if not IsNil(arg_14_2):
						...
						if table.contains(var_8_1, var_14_0.id):
				...
				onButton(arg_8_0, arg_14_2, function()
					...
					triggerButton(arg_8_0._tf), SFX_PANEL))
		var_8_12.align(#var_8_10)

def var_0_0.emojiIconFliter(arg_17_0):
	...
	for iter_17_2 = arg_17_0.emojiIconContent.childCount + 1, var_17_3:
		cloneTplTo(arg_17_0.emojiDot, arg_17_0.emojiIconDots)

	for iter_17_3 = arg_17_0.emojiIconContent.childCount + 1, var_17_3:
						...
						if not IsNil(arg_21_2):
							...
							onButton(arg_17_0, arg_22_0, function()
								if arg_17_0.contextData.emojiIconCallback:
									...
									arg_17_0.contextData.emojiIconCallback(var_21_0.id), SFX_PANEL)))
						...
						if not IsNil(arg_24_2):
							...
							onButton(arg_17_0, arg_25_0, function()
								if arg_17_0.contextData.emojiIconCallback:
									...
									arg_17_0.contextData.emojiIconCallback(var_24_0.id), SFX_PANEL)))
...
def var_0_0.clearItem(arg_28_0, arg_28_1):
	eachChild(arg_28_1, function(arg_29_0)
		if arg_29_0.childCount > 0:
