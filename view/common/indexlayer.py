...
def var_0_0.init(arg_2_0):
	...
	for iter_2_0 = 1, #var_0_0.panelNames:
...
def var_0_0.initDisplays(arg_8_0):
	local var_8_0 = {
		"sort",
		"index",
		"camp",
...
def var_0_0.initEquipSkinIndex(arg_15_0):
	local var_15_0 = {}

	_.each(IndexConst.EquipSkinIndexTypes, function(arg_16_0)
		local var_16_0 = bit.lshift(1, arg_16_0)

		if bit.band(arg_15_0.contextData.display.equipSkinIndex, var_16_0) > 0:
...
def var_0_0.initEquipSkinTheme(arg_21_0):
	local var_21_0 = {}

	_.each(IndexConst.EquipSkinThemeTypes, function(arg_22_0)
		local var_22_0 = IndexConst.StrLShift("1", arg_22_0)

		if string.find(IndexConst.StrAnd(arg_21_0.contextData.display.equipSkinTheme, var_22_0), "1") != None:
...
def var_0_0.updateEquipSkinTheme(arg_25_0):
	...
	var_25_0.each(function(arg_26_0, arg_26_1)
		...
		local var_26_2 = string.find(IndexConst.StrAnd(arg_25_0.contextData.equipSkinTheme, var_26_1), "1") != None
