...
def var_0_0.initData(arg_3_0):
	...
	for iter_3_0, iter_3_1 in ipairs(pg.child_event_special.all):
		local var_3_1 = EducateSpecialEvent.New(iter_3_1)

		if var_3_1.IsShow() and var_3_1.InMonth(arg_3_0.curTime.month) and var_3_1.IsUnlockSite() and var_3_1.IsMatch(var_3_0):
			if var_3_1.IsImport():
				table.insert(arg_3_0.importEvents, var_3_1)
			elif var_3_1.IsOther():
...
def var_0_0.initNewsList(arg_9_0):
...
def var_0_0.updateEventItem(arg_12_0, arg_12_1, arg_12_2, arg_12_3):
...
def var_0_0.updateNewsList(arg_14_0):
...
def var_0_0.willExit(arg_19_0):
	arg_19_0.animEvent.SetEndEvent(None)
