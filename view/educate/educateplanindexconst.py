...
def var_0_0.filterByType(arg_1_0, arg_1_1):
	if not arg_1_1 or arg_1_1 == var_0_0.TypeAll:
		return True

	for iter_1_0 = 2, #var_0_0.CONFIG.type:
		local var_1_0 = bit.lshift(1, iter_1_0 - 2)

		if bit.band(var_1_0, arg_1_1) > 0:
			local var_1_1 = var_0_0.CONFIG.type[iter_1_0].types

			if table.contains(var_1_1, arg_1_0.GetType()):
				return True
...
def var_0_0.filterByCost(arg_2_0, arg_2_1):
	if not arg_2_1 or arg_2_1 == var_0_0.CostAll:
		return True

	for iter_2_0 = 2, #var_0_0.CONFIG.cost:
		local var_2_0 = bit.lshift(1, iter_2_0 - 2)

		if bit.band(var_2_0, arg_2_1) > 0:
			local var_2_1 = var_0_0.CONFIG.cost[iter_2_0].names

			for iter_2_1, iter_2_2 in ipairs(var_2_1):
				if arg_2_0.getConfig(iter_2_2) > 0:
					return True
...
def var_0_0.filterByAwardRes(arg_3_0, arg_3_1):
	if not arg_3_1 or arg_3_1 == var_0_0.AwardResAll:
		return True
...
def var_0_0.filterByAwardNature(arg_4_0, arg_4_1):
	if not arg_4_1 or arg_4_1 == var_0_0.AwardNatureAll:
		return True
...
def var_0_0.filterByAwardAttr1(arg_5_0, arg_5_1):
	if not arg_5_1 or arg_5_1 == var_0_0.AwardAttr1All:
		return True
...
def var_0_0.filterByAwardAttr2(arg_6_0, arg_6_1):
	if not arg_6_1 or arg_6_1 == var_0_0.AwardAttr2All:
		return True

	return var_0_0.filterByAward(arg_6_0, arg_6_1, "awardAttr2")

def var_0_0.filterByAward(arg_7_0, arg_7_1, arg_7_2):
	for iter_7_0 = 2, #var_0_0.CONFIG[arg_7_2]:
		local var_7_0 = bit.lshift(1, iter_7_0 - 2)

		if bit.band(var_7_0, arg_7_1) > 0:
			local var_7_1 = var_0_0.CONFIG[arg_7_2][iter_7_0]

			for iter_7_1, iter_7_2 in ipairs(var_7_1.ids):
				if arg_7_0.CheckResult(var_7_1.type, iter_7_2):
					return True
