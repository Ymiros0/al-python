...
def var_0_0.updateLimitItem(arg_5_0, arg_5_1, arg_5_2):
...
def var_0_0.updateCostItem(arg_6_0, arg_6_1, arg_6_2):
...
def var_0_0.updateAwardItem(arg_7_0, arg_7_1, arg_7_2):
...
def var_0_0.update(arg_8_0, arg_8_1, arg_8_2):
	...
	onButton(arg_8_0, arg_8_0.unfoldBtn, function()
		...
		arg_8_0.awardUIList.align(#arg_8_0.awardCfg), SFX_PANEL)
	onButton(arg_8_0, arg_8_0.foldBtn, function()
		...
		setActive(arg_8_0.costTF, not var_8_4)
		setActive(arg_8_0.costEmptyTF, not var_8_4 and #arg_8_0.costCfg == 0)
		arg_8_0.awardUIList.align(#arg_8_0.awardCfg > 2 and 2 or #arg_8_0.awardCfg), SFX_PANEL)
	onButton(arg_8_0, arg_8_0._tf, function()
		arg_8_0.viewComponent.OnPlanCardClick(arg_8_1), SFX_PANEL)

def var_0_0.setAwardParam(arg_13_0, arg_13_1):
