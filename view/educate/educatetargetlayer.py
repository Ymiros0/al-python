...
def var_0_0.updataTarget(arg_17_0):
	...
	if not arg_17_0.lastProgress or var_17_2 <= arg_17_0.lastProgress:
...
def var_0_0.playProgressAnim(arg_18_0, arg_18_1):
	...
	arg_18_0.managedTween(LeanTween.delayedCall, function()
		arg_18_0.managedTween(LeanTween.value, None, go(arg_18_0.sliderTF), var_18_0, arg_18_1, 0.264).setOnUpdate(System.Action_float(function(arg_20_0)
			setSlider(arg_18_0.sliderTF, 0, 1, arg_20_0))).setEase(LeanTweenType.easeInCubic), 0.132, None)

def var_0_0.updateItems(arg_21_0):
...
def var_0_0.updateItem(arg_22_0, arg_22_1, arg_22_2, arg_22_3):
	...
	onButton(arg_22_0, arg_22_0.findTF("status/get", arg_22_2), function()
		...
		onDelayTick(function()
			arg_22_0.isClick = None

			arg_22_0.sumbitTask(var_22_0)
			var_22_0.SetRecieve(), 0.5), SFX_PANEL)
...
def var_0_0.willExit(arg_29_0):
	arg_29_0.animEvent.SetEndEvent(None)
	pg.UIMgr.GetInstance().UnOverlayPanel(arg_29_0._tf)

	if arg_29_0.onExit:
		arg_29_0.onExit()
	elif getProxy(EducateProxy).GetCurTime().month == 2:
