...
def var_0_0.handleNotification(arg_7_0, arg_7_1):
	...
	if var_7_0 == EducateProxy.RESOURCE_UPDATED:
		arg_7_0.viewComponent.updateRes()
	elif var_7_0 == EducateProxy.ATTR_UPDATED:
		arg_7_0.viewComponent.updateAttrs()
	elif var_7_0 == EducateProxy.BUFF_ADDED:
		arg_7_0.viewComponent.updateAttrs()
	elif var_7_0 == EducateProxy.TIME_UPDATED:
		arg_7_0.viewComponent.updateTime()
		arg_7_0.viewComponent.updateRes()
		arg_7_0.viewComponent.updateTarget()
	elif var_7_0 == EducateProxy.TIME_WEEKDAY_UPDATED:
		arg_7_0.viewComponent.updateTimeWeekDay(var_7_1.weekDay)
	elif var_7_0 == EducateTaskProxy.TASK_UPDATED or var_7_0 == EducateTaskProxy.TASK_ADDED or var_7_0 == EducateTaskProxy.TASK_REMOVED or var_7_0 == GAME.EDUCATE_SUBMIT_TASK_DONE:
		arg_7_0.viewComponent.updateTarget()
	elif var_7_0 == EducateProxy.CLEAR_NEW_TIP:
		if var_7_1.index == EducateTipHelper.NEW_SITE:
			arg_7_0.viewComponent.clearNewTip(var_7_1.id)
	elif var_7_0 == GAME.EDUCATE_REFRESH_DONE:
		arg_7_0.viewComponent.emit(EducateBaseUI.EDUCATE_CHANGE_SCENE, SCENE.EDUCATE)
	elif var_7_0 == GAME.EDUCATE_TRIGGER_SPEC_EVENT_DONE:
		if var_7_1.type == EducateSpecialEvent.TYPE_SITE:
			arg_7_0.viewComponent.ShowSpecEvent(var_7_1.siteId, var_7_1.id, var_7_1.drops, var_7_1.cb)
	elif var_7_0 == GAME.EDUCATE_MAP_SITE_DONE:
