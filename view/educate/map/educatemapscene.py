...
def var_0_0.preload(arg_2_0, arg_2_1):
	if getProxy(EducateProxy).NeedRequestOptsData():
...
def var_0_0.addListener(arg_8_0):
	onButton(arg_8_0, arg_8_0.homeBtn, function()
		arg_8_0.emit(EducateBaseUI.EDUCATE_CHANGE_SCENE, SCENE.EDUCATE), SFX_PANEL)
...
def var_0_0.playAnim(arg_13_0):
	...
	for iter_13_0 = 1, #arg_13_0.siteIdList:
...
def var_0_0.CheckTips(arg_20_0, arg_20_1):
	local var_20_0 = {}
...
def var_0_0.updateSiteItem(arg_21_0, arg_21_1, arg_21_2):
	...
	onButton(arg_21_0, arg_21_2, function()
		arg_21_0.detailPanel.Show(var_21_0.id), SFX_PANEL)

def var_0_0.clearNewTip(arg_24_0, arg_24_1):
	eachChild(arg_24_0.mapContent, function(arg_25_0)
		if tonumber(arg_25_0.name) == arg_24_1:
			setActive(arg_24_0.findTF("new", arg_25_0), False))

def var_0_0.updateRes(arg_26_0):
	arg_26_0.resPanel.Flush()

def var_0_0.updateAttrs(arg_27_0):
	arg_27_0.archivePanel.Flush()

def var_0_0.updateTime(arg_28_0):
	arg_28_0.siteUIList.align(#arg_28_0.siteIdList)
	arg_28_0.datePanel.Flush()

def var_0_0.updateTarget(arg_29_0):
	arg_29_0.targetPanel.Flush()

def var_0_0.updateTimeWeekDay(arg_30_0, arg_30_1):
	arg_30_0.datePanel.UpdateWeekDay(arg_30_1)

def var_0_0.MoveTargetPanelLeft(arg_31_0):
	arg_31_0.targetPanel.SetPosLeft()

def var_0_0.MoveTargetPanelRight(arg_32_0):
	arg_32_0.targetPanel.SetPosRight()

def var_0_0.ShowSpecEvent(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4):
	arg_33_0.detailPanel.showSpecEvent(arg_33_1, arg_33_2, arg_33_3, arg_33_4)

def var_0_0.ShowSitePerform(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4, arg_34_5):
	arg_34_0.detailPanel.showSitePerform(arg_34_1, arg_34_2, arg_34_3, arg_34_4, arg_34_5)

def var_0_0.onBackPressed(arg_35_0):
	if arg_35_0.detailPanel.isShowing():
...
def var_0_0.willExit(arg_36_0):
	...
	arg_36_0.datePanel = None

	arg_36_0.resPanel.Destroy()

	arg_36_0.resPanel = None

	arg_36_0.topPanel.Destroy()

	arg_36_0.topPanel = None

	arg_36_0.targetPanel.Destroy()

	arg_36_0.targetPanel = None

	arg_36_0.archivePanel.Destroy()

	arg_36_0.archivePanel = None

	arg_36_0.detailPanel.Destroy()

	arg_36_0.detailPanel = None
