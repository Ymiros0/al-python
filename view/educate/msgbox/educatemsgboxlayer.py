...
def var_0_0.ShowMsgBox(arg_5_0, arg_5_1):
	arg_5_0.commonSetting(arg_5_1)
	arg_5_0.showByType(arg_5_1)

def var_0_0.commonSetting(arg_6_0, arg_6_1):
...
def var_0_0.showByType(arg_14_0, arg_14_1):
...
def var_0_0.showSingleItemBox(arg_18_0):
	...
	if arg_18_0.settings.drop.type == EducateConst.DROP_TYPE_RES and var_18_0.id == EducateChar.RES_MOOD_ID:
	...
	if arg_18_0.settings.drop.type == EducateConst.DROP_TYPE_ITEM:
...
def var_0_0.willExit(arg_22_0):
	arg_22_0.animEvent.SetEndEvent(None)
	pg.UIMgr.GetInstance().UnblurPanel(arg_22_0._tf)

	if arg_22_0.contextData.onExit:
