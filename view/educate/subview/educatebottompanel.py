...
def var_0_0.addListener(arg_3_0):
	onButton(arg_3_0, arg_3_0.planBtn, function()
		arg_3_0.emit(EducateBaseUI.EDUCATE_GO_SCENE, SCENE.EDUCATE_SCHEDULE), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.mapBtn, function()
		if isActive(arg_3_0.findTF("lock", arg_3_0.mapBtn)):
			return

		arg_3_0.emit(EducateBaseUI.EDUCATE_GO_SCENE, SCENE.EDUCATE_MAP), SFX_PANEL)
	...
	if arg_3_0.contextData and arg_3_0.contextData.isMainEnter:
		var_3_0 = "anim_educate_bottom_in"

	arg_3_0._tf.GetComponent(typeof(Animation)).Play(var_3_0)

def var_0_0.playGuide(arg_18_0, arg_18_1):
	if not pg.NewStoryMgr.GetInstance().IsPlayed(arg_18_1):
		pg.NewGuideMgr.GetInstance().Play(arg_18_1)
		pg.m02.sendNotification(GAME.STORY_UPDATE, {
			storyId = arg_18_1
		})

def var_0_0.onEnterVirtualStage(arg_19_0):
...
def var_0_0.Flush(arg_20_0):
	...
	if isActive(arg_20_0.schoolBtn) or isActive(arg_20_0.upgradeBtn) or isActive(arg_20_0.targetSetBtn):
		setActive(arg_20_0.planBtn, False)

def var_0_0.isSchoolBtnShow(arg_21_0):
...
def var_0_0.isUpgradeBtnShow(arg_22_0):
...
def var_0_0.isTargetSetBtnShow(arg_23_0):
...
def var_0_0.updateTargetSetBtn(arg_24_0):
...
def var_0_0.updateMapBtnTips(arg_25_0):
