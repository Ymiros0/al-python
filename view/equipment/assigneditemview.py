...
def var_0_0.OnInit(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0.confirmBtn, function()
		...
		if arg_2_0.itemVO.IsDoaSelectCharItem():
		...
		if var_8_1 and var_8_1.getConfig("type") == Item.SKIN_ASSIGNED_TYPE and var_8_1.IsAllSkinOwner():
...
local function var_0_1(arg_16_0)
	...
	return getProxy(CollectionProxy).getShipGroup(var_16_0) != None

def var_0_0.update(arg_17_0, arg_17_1):
	arg_17_0.count = 1
	arg_17_0.selectedIndex = None
	arg_17_0.selectedItem = None
		...
		if arg_19_0 == UIItemList.EventUpdate:
			...
			onToggle(arg_17_0, arg_19_2, function(arg_20_0)
				if arg_20_0:
					...
					arg_17_0.selectedItem = arg_19_2, SFX_PANEL)
	...
	if underscore.any(arg_17_0.displayDrops, function(arg_21_0)
		return arg_21_0.type == DROP_TYPE_ITEM and arg_21_0.getConfig("type") == Item.SKIN_ASSIGNED_TYPE) or var_17_1.type == DROP_TYPE_ITEM and var_17_1.getConfig("type") == Item.ASSIGNED_TYPE:
