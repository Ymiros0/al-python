...
def var_0_0.OnInit(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0.maxBtn, function()
		if not arg_2_0.itemVO or not arg_2_0.selectedIndex:
			return
	...
	onButton(arg_2_0, arg_2_0.confirmBtn, function()
		...
		if not arg_2_0.isAllNeedZero and var_4_2 < var_4_1:
...
def var_0_0.GetBlueprintNeed(arg_8_0, arg_8_1):
...
def var_0_0.checkBlueprintIsUnlock(arg_9_0, arg_9_1):
...
def var_0_0.updateValue(arg_10_0):
...
def var_0_0.updateCountText(arg_13_0):
...
def var_0_0.update(arg_14_0, arg_14_1):
	arg_14_0.count = 1
	arg_14_0.selectedIndex = None
	arg_14_0.selectedItem = None
		...
		if arg_16_0 == UIItemList.EventUpdate:
			...
			onToggle(arg_14_0, arg_16_2, function(arg_17_0)
				if arg_17_0:
					...
					arg_14_0.updateCountText(), SFX_PANEL)
