...
def var_0_0.didEnter(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.findTF("actions/action_button_2", arg_4_0.replacePanel), function()
		if not arg_4_0.contextData.oldShipInfo:
			arg_4_0.emit(EquipmentSkinMediator.ON_EQUIP)
		else
			arg_4_0.emit(EquipmentSkinMediator.ON_EQUIP_FORM_SHIP), SFX_PANEL)

	local var_4_0 = arg_4_0.contextData.mode or var_0_0.DISPLAY

	if var_4_0 == var_0_0.REPLACE and arg_4_0.shipVO:
		arg_4_0.initReplace()
	elif var_4_0 == var_0_0.DISPLAY:
		arg_4_0.initDisplay()

def var_0_0.initDisplay(arg_9_0):
		...
		eachChild(arg_9_0.displayActions, function(arg_10_0)
			...
			if var_10_0:
				onButton(arg_9_0, arg_10_0, function()
					arg_9_0.emit(var_0_0.ON_CLOSE), SFX_PANEL))

	arg_9_0.updateSkinView(arg_9_0.displayPanel, arg_9_0.contextData.skinId)

def var_0_0.initDisplay4Ship(arg_12_0):
	eachChild(arg_12_0.displayActions, function(arg_13_0)
		...
		onButton(arg_12_0, arg_13_0, function()
			...
			elif var_13_0 == "replace":
				arg_12_0.emit(EquipmentSkinMediator.ON_SELECT), SFX_PANEL))

def var_0_0.initReplace(arg_15_0):
	...
	if arg_15_0.contextData.oldShipInfo:
...
def var_0_0.updateSkinView(arg_16_0, arg_16_1, arg_16_2, arg_16_3):
	...
	if var_16_0:
		...
		onButton(arg_16_0, var_16_7, function()
			arg_16_0.emit(EquipmentSkinMediator.ON_PREVIEW, arg_16_2), SFX_PANEL)
		...
		if var_16_8:
			...
			if arg_16_3:
				assert(arg_16_3.id, "old ship id is None")
				assert(arg_16_3.pos, "old ship pos is None")
