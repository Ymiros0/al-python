...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.ON_EQUIP_FORM_SHIP, function(arg_3_0)
		if not arg_1_0.contextData.oldShipInfo:
			return
		...
		assert(var_3_3.id, "old ship id is None")
		assert(var_3_3.pos, "old ship pos is None")
		assert(arg_1_0.contextData.shipId, "new ship id None")
		assert(arg_1_0.contextData.pos, "new ship id None")
		arg_1_0.sendNotification(EquipmentMediator.NO_UPDATE)
