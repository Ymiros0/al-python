...
def var_0_0.register(arg_1_0):
	...
	assert(var_1_1, "equipmentVOs can not be None")
...
def var_0_0.handleNotification(arg_4_0, arg_4_1):
	...
	if var_4_0 == GAME.DESTROY_EQUIPMENTS_DONE:
		arg_4_0.viewComponent.OnResolveEquipDone()

		if table.getCount(var_4_1) != 0:
	...
	elif var_4_0 == GAME.CANCEL_LIMITED_OPERATION:
		-- block empty
