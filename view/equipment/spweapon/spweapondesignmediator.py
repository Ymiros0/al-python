...
def var_0_0.UpdateSpWeapons(arg_6_0):
...
def var_0_0.handleNotification(arg_8_0, arg_8_1):
	...
	if var_8_0 == BagProxy.ITEM_UPDATED:
	...
	elif var_8_0 == GAME.COMPOSITE_SPWEAPON_DONE:
	...
	elif var_8_0 == GAME.EQUIP_SPWEAPON_TO_SHIP_DONE or var_8_0 == EquipmentProxy.SPWEAPONS_UPDATED:
