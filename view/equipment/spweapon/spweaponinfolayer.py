...
def var_0_0.setEquipment(arg_3_0, arg_3_1, arg_3_2):
...
def var_0_0.didEnter(arg_8_0):
	...
	onButton(arg_8_0, arg_8_0._tf.Find("bg"), function()
		arg_8_0.closeView(), SOUND_BACK)
	arg_8_0.initAndSetBtn(var_8_0)

	if var_8_0 == var_0_0.TYPE_DEFAULT:
		arg_8_0.updateOperation1()
	elif var_8_0 == var_0_0.TYPE_SHIP:
		arg_8_0.updateOperation2()
	elif var_8_0 == var_0_0.TYPE_REPLACE:
		arg_8_0.updateOperation3()
	elif var_8_0 == var_0_0.TYPE_DISPLAY:
...
def var_0_0.initAndSetBtn(arg_10_0, arg_10_1):
	if arg_10_1 == var_0_0.TYPE_DEFAULT or arg_10_1 == var_0_0.TYPE_SHIP:
		...
		onButton(arg_10_0, arg_10_0.defaultReplaceBtn, function()
			arg_10_0.emit(SpWeaponInfoMediator.ON_CHANGE), SFX_PANEL)
		onButton(arg_10_0, arg_10_0.defaultEnhanceBtn, function()
			arg_10_0.emit(SpWeaponInfoMediator.ON_INTENSIFY), SFX_PANEL)
		onButton(arg_10_0, arg_10_0.defaultUnloadBtn, function()
			arg_10_0.emit(SpWeaponInfoMediator.ON_UNEQUIP), SFX_UI_DOCKYARD_EQUIPOFF)
		onButton(arg_10_0, arg_10_0.defaultModifyBtn, function()
			arg_10_0.emit(SpWeaponInfoMediator.ON_MODIFY), SFX_PANEL)
	elif arg_10_1 == var_0_0.TYPE_REPLACE:
		...
		onButton(arg_10_0, arg_10_0.replaceConfirmBtn, function()
			if arg_10_0.contextData.quickCallback:
				arg_10_0.contextData.quickCallback()
				arg_10_0.closeView()
			else
				arg_10_0.emit(SpWeaponInfoMediator.ON_EQUIP), SFX_UI_DOCKYARD_EQUIPADD)
	elif arg_10_1 == var_0_0.TYPE_DISPLAY:
...
def var_0_0.updateOperation1(arg_19_0):
...
def var_0_0.updateOperation2(arg_20_0):
...
def var_0_0.updateOperation3(arg_21_0):
	...
	if var_21_0:
		...
		arg_21_0.updateEquipmentPanel(arg_21_0.replaceSrcEquipTF, None)
...
def var_0_0.updateOperationAward(arg_23_0, arg_23_1, arg_23_2, arg_23_3):
	arg_23_0.awards = arg_23_3

	if arg_23_1.childCount == 0:
		for iter_23_0 = 1, #arg_23_3:
			cloneTplTo(arg_23_2, arg_23_1)

	for iter_23_1 = 1, #arg_23_3:
		...
		onButton(arg_23_0, var_23_0, function()
			arg_23_0.emit(var_0_0.ON_DROP, var_23_1), SFX_PANEL)
...
def var_0_0.updateEquipmentPanel(arg_25_0, arg_25_1, arg_25_2, arg_25_3):
...
def var_0_0.cloneSampleTo(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4):
