...
def var_0_0.SetSpweaponVO(arg_3_0, arg_3_1):
...
def var_0_0.ResetMaterialMask(arg_7_0):
	arg_7_0.confirmUpgrade = None
...
def var_0_0.UpdateView(arg_8_0):
	...
	onButton(arg_8_0, arg_8_0.materialStartButton, function()
		if not arg_8_0.confirmUpgrade:
			pg.TipsMgr.GetInstance().ShowTips(i18n("spweapon_tip_transform_materal_check"))

			return

		arg_8_0.emit(SpWeaponModifyMediator.ON_REFORGE), SFX_PANEL)
