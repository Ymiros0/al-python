...
def var_0_0.updateRes(arg_5_0, arg_5_1):
	arg_5_0.playerVO = arg_5_1

def var_0_0.SetSpWeapon(arg_6_0, arg_6_1):
	arg_6_0.spWeaponVO = arg_6_1

def var_0_0.SetSpWeaponList(arg_7_0, arg_7_1):
	arg_7_0.spWeaponList = arg_7_1

def var_0_0.didEnter(arg_8_0):
	onButton(arg_8_0, arg_8_0._tf.Find("BG"), function()
		arg_8_0.emit(var_0_0.ON_CLOSE), SFX_CANCEL)
	onButton(arg_8_0, arg_8_0.leftPanelFilterButton, function()
		...
		arg_8_0.emit(SpWeaponUpgradeMediator.OPEN_EQUIPMENT_INDEX, var_10_0), SFX_PANEL)
	...
	onButton(arg_8_0, arg_8_0.leftPanelClearSelectButton, function()
		...
		arg_8_0.UpdateAll(True), SFX_CANCEL)
	...
	arg_8_0.leftPanelItemRect.make(function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == UIItemList.EventInit:
			pressPersistTrigger(arg_17_2.Find("IconTpl"), 0.5, function()
				...
				if arg_8_0.ptMax or var_18_2 == var_18_3:
					return
				...
				arg_8_0.UpdateAll(True), function()
				if arg_8_0.ptMax:
					pg.TipsMgr.GetInstance().ShowTips(i18n("spweapon_tip_upgrade")), True, True, 0.15, SFX_PANEL)
			pressPersistTrigger(arg_17_2.Find("IconTpl/Reduce"), 0.5, function()
				...
				if (var_20_1 and var_20_1.count or 0) == 0:
					return
				...
				arg_8_0.UpdateAll(True), None, True, True, 0.15, SFX_PANEL)
		elif arg_17_0 == UIItemList.EventUpdate:
...
def var_0_0.UpdateEquipItemByIndex(arg_21_0, arg_21_1, arg_21_2):
	arg_21_1 = arg_21_1 + 1
...
def var_0_0.UpdateEquipItem(arg_22_0, arg_22_1, arg_22_2):
	local var_22_0 = tf(arg_22_2)

	onButton(arg_22_0, var_22_0, function()
		if arg_22_0.GetSelectSpWeapon(arg_22_1):
			return
...
def var_0_0.UpdateSelectPt(arg_27_0):
	arg_27_0.nextSpWeaponVO = None
	arg_27_0.upgradeType = None
	...
	local function var_27_7(arg_28_0)
		for iter_28_0, iter_28_1 in ipairs(arg_28_0):
	...
	if var_27_3 <= var_27_0:
		...
		repeat
			...
			if var_27_4 > 0 and var_27_12.GetRarity() > var_27_9.GetRarity():
				break

			if var_27_12.GetRarity() > var_27_9.GetRarity():
				arg_27_0.upgradeType = var_0_5

			if var_27_0 < var_27_3:
				break
	...
	if arg_27_0.craftMode == var_0_2:
		arg_27_0.upgradeMaxLevel = arg_27_0.spWeaponVO.GetNextUpgradeID() == 0

def var_0_0.AutoSelectMaterials(arg_30_0):
	...
	while True:
		...
		if SpWeapon.New({
			id = var_30_4
		}).GetRarity() > arg_30_0.spWeaponVO.GetRarity():
			break

		var_30_1 = var_30_4

	if var_30_2 <= var_30_0:
		return
...
def var_0_0.UpdateAll(arg_36_0, arg_36_1):
	...
	if var_36_1:
		...
		local var_36_3 = var_36_2 and var_36_2.id or None
		...
		if var_36_3 and var_36_3 > 0:
			...
			arg_36_0.loader.GetSprite("qicon/" .. var_36_4.getPainting(), None, arg_36_0.equipmentPanel.Find("Ship/Icon/Image"))
		...
		for iter_36_0, iter_36_1 in ipairs(var_36_8):
...
def var_0_0.UpdateAttrs(arg_41_0, arg_41_1, arg_41_2, arg_41_3):
	local var_41_0
	local var_41_1

	if arg_41_0.craftMode == var_0_1:
		var_41_0 = SpWeaponHelper.TransformCompositeInfo(arg_41_2)
		var_41_1 = arg_41_2.GetSkillGroup()
		arg_41_3 = arg_41_2
	elif arg_41_0.craftMode == var_0_2:
...
def var_0_0.UpdateSpWeaponUpgradeInfo(arg_42_0, arg_42_1, arg_42_2, arg_42_3, arg_42_4):
	...
	local function var_42_1(arg_43_0, arg_43_1)
		...
		if not arg_43_1.lock_open and arg_43_1.sub and #arg_43_1.sub > 0:
	...
	;(function(arg_44_0, arg_44_1, arg_44_2)
		for iter_44_0, iter_44_1 in ipairs(arg_44_2):
			local var_44_0 = cloneTplTo(arg_44_1, arg_44_0)

			var_42_1(var_44_0, iter_44_1))(arg_42_1.Find("attrs"), var_42_0, arg_42_2)

	local var_42_2 = {}

	if arg_42_3[1].skillId > 0:
		table.insert(var_42_2, {
			name = i18n("spweapon_attr_effect"),
			effect = arg_42_3[1]
		})

	if arg_42_3[2].skillId > 0:
		table.insert(var_42_2, {
			isSkill = True,
	...
	;(function(arg_47_0, arg_47_1, arg_47_2)
		for iter_47_0, iter_47_1 in ipairs(arg_47_2):
			local var_47_0 = cloneTplTo(arg_47_1, arg_47_0)

			var_42_3(var_47_0, iter_47_1))(arg_42_1.Find("attrs"), var_42_0, var_42_2)

def var_0_0.UpdateExpBar(arg_48_0):
...
def var_0_0.UpdateMaterials(arg_49_0):
	...
	for iter_49_0 = 1, #arg_49_0.materialPanelMaterialItems:
		...
		if var_49_0[iter_49_0]:
			...
			if var_49_10.count < var_49_6.count:
	...
	onButton(arg_49_0, arg_49_0.materialPanelButton, function()
		if not var_49_4:
			if not ItemTipPanel.ShowItemTipbyID(var_49_3):
				pg.TipsMgr.GetInstance().ShowTips(i18n("spweapon_tip_materal_no_enough"))

			return

		if arg_49_0.playerVO.gold < var_49_1:
		...
		if not arg_49_0.confirmUpgrade and arg_49_0.upgradeType == var_0_5 and #arg_49_0.upgradNeedMaterials > 0:
			pg.TipsMgr.GetInstance().ShowTips(i18n("spweapon_tip_breakout_materal_check"))

			return

		if arg_49_0.craftMode == var_0_1:
		...
		elif arg_49_0.craftMode == var_0_2:
			arg_49_0.emit(SpWeaponUpgradeMediator.EQUIPMENT_UPGRADE, arg_49_0.spWeaponVO.GetUID(), arg_49_0.consumeItems, arg_49_0.consumeSpweapons), SFX_UI_DOCKYARD_REINFORCE)
...
def var_0_0.UpdatePtMaterials(arg_53_0, arg_53_1):
	...
	for iter_53_0, iter_53_1 in pairs(arg_53_0.spWeaponList):
		if iter_53_1.GetUID() != arg_53_0.spWeaponVO.GetUID() and not iter_53_1.IsUnCraftable() and not iter_53_1.GetShipId() and IndexConst.filterSpWeaponByType(iter_53_1, arg_53_0.contextData.indexDatas.typeIndex) and IndexConst.filterSpWeaponByRarity(iter_53_1, arg_53_0.contextData.indexDatas.rarityIndex):
...
def var_0_0.UpdateSelectMaterial(arg_56_0, arg_56_1, arg_56_2):
	...
	if arg_56_2 > 0:
		...
		if arg_56_2 < 0 and var_56_0:
			var_56_0.count = var_56_0.count + arg_56_2

			if var_56_0.count <= 0:
				table.removebyvalue(arg_56_0.consumeItems, var_56_0)

		if var_56_1 + arg_56_2 <= 0:
			return True

def var_0_0.GetSelectMaterial(arg_57_0, arg_57_1):
	return _.detect(arg_57_0.consumeItems, function(arg_58_0)
		return arg_58_0.id == arg_57_1)

def var_0_0.GetSelectSpWeapon(arg_59_0, arg_59_1):
	if table.contains(arg_59_0.consumeSpweapons, arg_59_1):
		return arg_59_1

def var_0_0.ClearSelectMaterials(arg_60_0):
	table.clear(arg_60_0.consumeItems)
	table.clear(arg_60_0.consumeSpweapons)

def var_0_0.willExit(arg_61_0):
