...
def var_0_0.UpdateSpWeapons(arg_2_0):
...
def var_0_0.handleNotification(arg_9_0, arg_9_1):
	...
	elif var_9_0 == GAME.UPGRADE_SPWEAPON_DONE:
		arg_9_0.viewComponent.SetSpWeapon(var_9_1)
		arg_9_0.viewComponent.ClearSelectMaterials()
		arg_9_0.viewComponent.UpdateAll()
