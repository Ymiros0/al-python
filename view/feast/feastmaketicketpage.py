...
def var_0_0.OnMakeTicket(arg_5_0, arg_5_1):
	if arg_5_0.feastShip and arg_5_0.feastShip.id == arg_5_1:
		...
		arg_5_0.envelopesAnim.SetActionCallBack(function(arg_6_0)
			if arg_6_0 == "finish":
				...
				arg_5_0.envelopesAnim.SetActionCallBack(None)
...
def var_0_0.LoadPuzzleRes(arg_10_0, arg_10_1, arg_10_2):
...
def var_0_0.InitPuzzle(arg_14_0, arg_14_1):
...
def var_0_0.CheckFinish(arg_22_0):
	return arg_22_0.rect.childCount == 1

def var_0_0.Merge(arg_23_0, arg_23_1, arg_23_2, arg_23_3):
	if arg_23_2.level < arg_23_1.level:
...
local function var_0_3(arg_25_0, arg_25_1)
	if arg_25_0.level < arg_25_1.level:
		return arg_25_0.isCompletion
	else
		return arg_25_1.isCompletion

def var_0_0.FindMatcher(arg_26_0, arg_26_1):
	for iter_26_0, iter_26_1 in pairs(arg_26_0.items):
		if (arg_26_1.level + 1 == iter_26_1.level or arg_26_1.level - 1 == iter_26_1.level) and var_0_3(arg_26_1, iter_26_1) and var_0_2(arg_26_1, iter_26_1):
			return iter_26_1

	return None

def var_0_0.OnPass(arg_27_0):
	for iter_27_0, iter_27_1 in ipairs(arg_27_0.items):
...
def var_0_0.RegisterEvent(arg_28_0, arg_28_1):
	onButton(arg_28_0, arg_28_0.back, function()
		arg_28_0.Hide(), SFX_PANEL)
	onButton(arg_28_0, arg_28_0.sendBtn, function()
		arg_28_0.Hide()
		arg_28_0.emit(FeastScene.ON_SKIP_GIVE_GIFT, arg_28_0.feastShip), SFX_PANEL)
	...
	onButton(arg_28_0, arg_28_0.homeBtn, function()
		arg_28_0.emit(BaseUI.ON_HOME), SFX_PANEL)

def var_0_0.ShowDesc(arg_33_0, arg_33_1):
	...
	onButton(arg_33_0, arg_33_0.descTr, function()
		arg_33_0.HideDesc(), SFX_PANEL)

def var_0_0.HideDesc(arg_35_0):
	if not arg_35_0.isShowDesc:
		return
	...
	if arg_35_0.descNode:
		Object.Destroy(arg_35_0.descNode.gameObject)

		arg_35_0.descNode = None

	setActive(arg_35_0.descTr, False)

def var_0_0.Clear(arg_36_0):
	arg_36_0.envelopesAnim.SetActionCallBack(None)
	arg_36_0.CloseTip()

	for iter_36_0, iter_36_1 in ipairs(arg_36_0.items):
		arg_36_0.ClearEvent(iter_36_1.tr)

	arg_36_0.items = {}

	if arg_36_0.puzzleGo:
		Object.Destroy(arg_36_0.puzzleGo)

		arg_36_0.puzzleGo = None

	removeOnButton(arg_36_0.back)

	if LeanTween.isTweening(arg_36_0.sendBtn.gameObject):
		LeanTween.cancel(arg_36_0.sendBtn.gameObject)

	if LeanTween.isTweening(arg_36_0.titleTr.gameObject):
		LeanTween.cancel(arg_36_0.titleTr.gameObject)

	arg_36_0.HideDesc()

def var_0_0.ClearEvent(arg_37_0, arg_37_1):
	local var_37_0 = arg_37_1.GetComponent(typeof(EventTriggerListener))

	var_37_0.AddBeginDragFunc(None)
	var_37_0.AddDragFunc(None)
	var_37_0.AddDragEndFunc(None)
	var_37_0.AddPointUpFunc(None)

	local var_37_1 = arg_37_1.GetComponentsInChildren(typeof(Image))

	for iter_37_0 = 1, var_37_1.Length:
		var_37_1[iter_37_0 - 1].raycastTarget = False

def var_0_0.Hide(arg_38_0):
