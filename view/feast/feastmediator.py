...
def var_0_0.HandleTaskGo(arg_11_0, arg_11_1):
	if arg_11_1.IsActRoutineType() and arg_11_1.getConfig("sub_type") == 430:
		-- block empty
	elif arg_11_1.IsActRoutineType() and arg_11_1.getConfig("sub_type") == 431:
		arg_11_0.viewComponent.emit(FeastScene.GO_INTERACTION)
	elif arg_11_1.IsActType() and (arg_11_1.getConfig("sub_type") == 432 or arg_11_1.getConfig("sub_type") == 433):
		arg_11_0.viewComponent.emit(FeastScene.GO_INVITATION)
	elif arg_11_1.IsActType() and arg_11_1.getConfig("sub_type") == 417:
...
def var_0_0.handleNotification(arg_13_0, arg_13_1):
	...
	if var_13_0 == CourtYardEvent._QUIT:
		...
		if var_13_1.cmd == FeastDorm.OP_INTERACTION:
			...
			var_13_7 = False
		elif var_13_1.cmd == FeastDorm.OP_MAKE_TICKET:
			arg_13_0.viewComponent.emit(FeastScene.ON_MAKE_TICKET, var_13_1.groupId)

		if #var_13_1.awards > 0 and var_13_7:
			...
			if #arg_13_0.caches == 1:
				arg_13_0.DisplayAwards()
	elif var_13_0 == TaskProxy.TASK_ADDED or var_13_0 == TaskProxy.TASK_UPDATED or var_13_0 == TaskProxy.TASK_REMOVED:
		arg_13_0.viewComponent.emit(FeastScene.ON_TASK_UPDATE)
	elif var_13_0 == ActivityProxy.ACTIVITY_UPDATED:
		if var_13_1.id == ActivityConst.FEAST_PT_ACT:
