...
def var_0_0.handleNotification(arg_17_0, arg_17_1):
	...
	if var_17_0 == GAME.FRIEND_SEARCH_DONE:
		if var_17_1.type == SearchFriendCommand.SEARCH_TYPE_RESUME:
			...
			if table.getCount(var_17_1.list) > 0:
				pg.TipsMgr.GetInstance().ShowTips(i18n("friend_search_succeed"))
	elif var_17_0 == GAME.FRIEND_SEND_REQUEST_DONE:
		arg_17_0.viewComponent.removeSearchResult(var_17_1)
		arg_17_0.viewComponent.updatePage(FriendScene.SEARCH_PAGE)
	elif var_17_0 == NotificationProxy.FRIEND_REQUEST_REMOVED or var_17_0 == NotificationProxy.FRIEND_REQUEST_ADDED:
	...
	elif var_17_0 == FriendProxy.FRIEND_REMOVED or var_17_0 == FriendProxy.FRIEND_ADDED or var_17_0 == FriendProxy.FRIEND_UPDATED:
		...
		if var_17_0 == FriendProxy.FRIEND_UPDATED:
			arg_17_0.updateChatNotification()
	elif var_17_0 == FriendProxy.RELIEVE_BLACKLIST or var_17_0 == FriendProxy.BLACK_LIST_UPDATED or var_17_0 == FriendProxy.ADD_INTO_BLACKLIST:
	...
	elif var_17_0 == GAME.VISIT_BACKYARD_DONE:
