...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3):
	...
	onButton(arg_1_0._event, findTF(arg_1_0._tf, "window/btnConfirm"), function()
		if arg_1_0.costPrice > arg_1_0.myGold:
...
def var_0_0.exchangeCoin(arg_9_0):
	if arg_9_0.coinCount == 0:
		return
...
def var_0_0.coinCountChange(arg_10_0):
	if arg_10_0.coinCount < 0:
		arg_10_0.coinCount = 0

	if arg_10_0.coinCount + arg_10_0.myCoinCount > arg_10_0.coinMax:
		arg_10_0.coinCount = arg_10_0.coinMax - arg_10_0.myCoinCount

	local var_10_0 = 0

	for iter_10_0 = 1, arg_10_0.coinCount:
...
def var_0_0.getDiscount(arg_11_0, arg_11_1):
	if arg_11_1 <= 0:
		arg_11_1 = 1
	...
	if var_11_1 != var_11_0:
		return tonumber((var_11_0 - var_11_1) * 100 / var_11_0)

	return 0

def var_0_0.getPriceByCount(arg_12_0, arg_12_1):
	for iter_12_0 = #arg_12_0.gameCoinGold, 1, -1:
		local var_12_0 = arg_12_0.gameCoinGold[iter_12_0]

		if arg_12_1 > var_12_0[1]:
			return var_12_0[2]
...
def var_0_0.getVisible(arg_15_0):
	return isActive(arg_15_0._tf)

def var_0_0.dispose(arg_16_0):
	if arg_16_0.bulrFlag == True:
