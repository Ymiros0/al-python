...
def var_0_0.Update(arg_2_0, arg_2_1, arg_2_2):
	...
	if var_2_8:
		...
		onButton(arg_2_0, arg_2_0._tf, function()
			...
			arg_2_0.DoUprade(arg_2_1), SFX_PANEL)
	elif not var_2_7:
...
def var_0_0.DoUprade(arg_4_0, arg_4_1):
