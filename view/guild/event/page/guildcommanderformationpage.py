...
def var_0_0.OnInit(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0.samllTF, function()
		arg_2_0.openDescPanel(), SFX_PANEL)
	onButton(arg_2_0, arg_2_0.descPanel, function()
		arg_2_0.closeDescPanel(), SFX_PANEL)
	onButton(arg_2_0, arg_2_0.restAllBtn, function()
		if not arg_2_0.fleet.ExistAnyCommander():
			return
	...
	onButton(arg_2_0, arg_2_0.quickBtn, function()
		arg_2_0.OpenRecordPanel(), SFX_PANEL)
	onButton(arg_2_0, arg_2_0.recordPanel.Find("back"), function()
		arg_2_0.CloseRecordPanel(), SFX_PANEL)
	arg_2_0.Show()
...
def var_0_0.Update(arg_8_0, arg_8_1, arg_8_2):
	...
	for iter_8_0 = 1, CommanderConst.MAX_FORMATION_POS:
		...
		assert(arg_8_0["pos" .. iter_8_0], "pos tf can not None")
		arg_8_0.updateCommander(arg_8_0["pos" .. iter_8_0], iter_8_0, var_8_1)

	arg_8_0.updateDesc()
	arg_8_0.updateRecordPanel()

def var_0_0.openDescPanel(arg_9_0, arg_9_1):
	local var_9_0 = arg_9_1 or 0.2

	if LeanTween.isTweening(go(arg_9_0.samllTF)) or LeanTween.isTweening(go(arg_9_0.descFrameTF)):
		return
...
def var_0_0.closeDescPanel(arg_11_0, arg_11_1):
	local var_11_0 = arg_11_1 or 0.2

	if LeanTween.isTweening(go(arg_11_0.samllTF)) or LeanTween.isTweening(go(arg_11_0.descFrameTF)):
		return
...
def var_0_0.updateDesc(arg_13_0):
	local var_13_0 = arg_13_0.fleet.getCommanders()

	for iter_13_0 = 1, CommanderConst.MAX_FORMATION_POS:
		local var_13_1 = var_13_0[iter_13_0]

		assert(arg_13_0["pos" .. iter_13_0], "pos tf can not None")
...
def var_0_0.updateAdditions(arg_14_0):
...
def var_0_0.updateSkillTF(arg_17_0, arg_17_1, arg_17_2):
	...
	if arg_17_1:
		...
		onButton(arg_17_0, arg_17_2, function()
			arg_17_0.emit(GuildEventMediator.ON_CMD_SKILL, var_17_0), SFX_PANEL)
	else
		removeOnButton(arg_17_2)

def var_0_0.updateCommander(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4):
	...
	if arg_19_4:
		onButton(arg_19_0, var_19_1, function()
			arg_19_0.emit(GuildEventMediator.ON_SELECT_COMMANDER, arg_19_0.fleet.id, arg_19_2, arg_19_3), SFX_PANEL)
...
def var_0_0.OpenRecordPanel(arg_22_0):
	setActive(arg_22_0.descFrameTF, False)
	setActive(arg_22_0.recordPanel, True)

def var_0_0.updateRecordPanel(arg_23_0):
	local var_23_0 = arg_23_0.fleet.getCommanders()

	for iter_23_0, iter_23_1 in ipairs(arg_23_0.recordCommanders):
...
def var_0_0.UpdatePrefabFleet(arg_25_0, arg_25_1, arg_25_2, arg_25_3):
	...
	onButton(arg_25_0, arg_25_2.Find("use_btn"), function()
		...
		arg_25_0.CloseRecordPanel(), SFX_PANEL)
...
def var_0_0.CloseRecordPanel(arg_30_0):
