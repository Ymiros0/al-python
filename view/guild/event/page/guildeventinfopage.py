...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.goBtn, function()
		if not GuildMember.IsAdministrator(arg_3_0.guild.getSelfDuty()):
	...
	onButton(arg_3_0, arg_3_0.joinBtn, function()
		if not arg_3_0.activeEvent:
			return

		if arg_3_0.activeEvent.IsLimitedJoin():
			pg.TipsMgr.GetInstance().ShowTips(i18n("guild_join_event_max_cnt_tip"))

			return

		arg_3_0.JoinEvent(), SFX_PANEL)

def var_0_0.JoinEvent(arg_9_0):
	...
	if arg_9_0.activeEvent.GetLeftTime() <= 604800:
		pg.MsgboxMgr.GetInstance().ShowMsgBox({
...
def var_0_0.Refresh(arg_12_0, arg_12_1, arg_12_2):
...
def var_0_0.UpdateBtnState(arg_14_0):
...
def var_0_0.UpdateAwards(arg_15_0, arg_15_1):
	...
	arg_15_0.awardList.make(function(arg_16_0, arg_16_1, arg_16_2)
		if arg_16_0 == UIItemList.EventUpdate:
			...
			onButton(arg_15_0, arg_16_2, function()
				arg_15_0.emit(BaseUI.ON_DROP, var_16_1), SFX_PANEL))
	arg_15_0.awardList.align(#var_15_0)

def var_0_0.UpdateMissions(arg_18_0, arg_18_1):
