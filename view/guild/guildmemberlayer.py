...
def var_0_0.didEnter(arg_8_0):
	...
	for iter_8_0, iter_8_1 in ipairs(arg_8_0.btns):
		onButton(arg_8_0, iter_8_1, function()
			if iter_8_0 == 2 and arg_8_0.memberVO.IsRecruit():
				pg.TipsMgr.GetInstance().ShowTips(i18n("guild_trainee_duty_change_tip"))

				return

			if arg_8_0.page and not arg_8_0.page.GetLoaded():
				return
			...
			var_10_0.ExecuteAction("Show", arg_8_0.guildVO, arg_8_0.playerVO, arg_8_0.memberVO, var_10_1), SFX_PANEL)
		arg_8_0.pages[iter_8_0].SetCallBack(function(arg_12_0)
			arg_8_0.buttonsPanel.localPosition = arg_12_0

			setParent(arg_8_0.buttonsPanel, pg.UIMgr.GetInstance().OverlayMain), function()
			var_8_0()
...
def var_0_0.LoadPainting(arg_15_0, arg_15_1):
	...
	if HXSet.isHxPropose():
		var_15_2 = ""

	if not var_15_2 or var_15_2 == "":
...
def var_0_0.RefreshMembers(arg_16_0):
	if arg_16_0.listPage.GetLoaded():
		arg_16_0.listPage.Flush(arg_16_0.guildVO, arg_16_0.memberVOs, arg_16_0.ranks)

def var_0_0.ActiveDefaultMenmber(arg_17_0):
	if arg_17_0.listPage.GetLoaded():
		arg_17_0.listPage.TriggerFirstCard()

def var_0_0.UpdateRankList(arg_18_0, arg_18_1, arg_18_2):
	arg_18_0.ranks[arg_18_1] = arg_18_2

	if arg_18_0.contextData.rankPage and arg_18_0.contextData.rankPage.GetLoaded():
		arg_18_0.contextData.rankPage.ExecuteAction("OnUpdateRankList", arg_18_1, arg_18_2)

def var_0_0.ShowInfoPanel(arg_19_0, arg_19_1):
	arg_19_0.pages[1].ExecuteAction("Flush", arg_19_1)

def var_0_0.onBackPressed(arg_20_0):
	for iter_20_0, iter_20_1 in ipairs(arg_20_0.pages):
		if iter_20_1.GetLoaded() and iter_20_1.isShowing():
			iter_20_1.Hide()
...
def var_0_0.willExit(arg_21_0):
	...
	arg_21_0.listPage.OnClickMember = None

	arg_21_0.listPage.Destroy()

	for iter_21_0, iter_21_1 in ipairs(arg_21_0.pages):
		iter_21_1.Destroy()
