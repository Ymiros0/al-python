...
def var_0_0.handleNotification(arg_11_0, arg_11_1):
	...
	if var_11_0 == GuildProxy.GUILD_UPDATED:
		arg_11_0.viewComponent.SetGuild(var_11_1)
	elif var_11_0 == PlayerProxy.UPDATED:
		arg_11_0.viewComponent.setPlayer(getProxy(PlayerProxy).getRawData())
	elif var_11_0 == GAME.GUILD_COMMIT_DONATE_DONE:
		arg_11_0.viewComponent.UpdateContribution()

		local function var_11_2()
			return

		if var_11_1.awards and #var_11_1.awards > 0:
			arg_11_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_11_1.awards, var_11_2)
		else
			var_11_2()
	elif var_11_0 == GuildProxy.ON_DONATE_LIST_UPDATED:
		arg_11_0.viewComponent.UpdateContribution()
	elif var_11_0 == GAME.TRIGGER_TASK_DONE:
		pg.TipsMgr.GetInstance().ShowTips(i18n("guild_get_week_done"))
		arg_11_0.viewComponent.UpdateTask()
	elif var_11_0 == GAME.SUBMIT_TASK_DONE:
		arg_11_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_11_1)
		arg_11_0.viewComponent.UpdateTask(True)
	elif var_11_0 == GuildProxy.WEEKLYTASK_ADDED or var_11_0 == GuildProxy.WEEKLYTASK_UPDATED or var_11_0 == GAME.GUILD_WEEKLY_TASK_PROGREE_UPDATE_DONE:
		arg_11_0.viewComponent.UpdateTask()
	elif var_11_0 == GAME.GUILD_GET_SUPPLY_AWARD_DONE:
		arg_11_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_11_1.list)
		arg_11_0.viewComponent.UpdateSupplyPanel()
	elif var_11_0 == GuildProxy.SUPPLY_STARTED:
		arg_11_0.viewComponent.UpdateSupplyPanel()
	elif var_11_0 == GAME.ZERO_HOUR_OP_DONE:
		-- block empty
	elif var_11_0 == TaskProxy.TASK_UPDATED:
		local var_11_3 = getProxy(GuildProxy).getRawData()

		if var_11_3:
			local var_11_4 = var_11_3.getWeeklyTask()

			if var_11_4 and var_11_4.id > 0 and var_11_4.IsSamePrivateTask(var_11_1):
				arg_11_0.viewComponent.UpdateTask()
