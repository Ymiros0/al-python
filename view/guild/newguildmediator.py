...
def var_0_0.handleNotification(arg_6_0, arg_6_1):
	...
	if var_6_0 == GuildProxy.NEW_GUILD_ADDED:
	...
	elif var_6_0 == GAME.CREATE_GUILD_DONE:
		arg_6_0.viewComponent.ClosePage()
	elif var_6_0 == GAME.REMOVE_LAYERS and var_6_1.context.mediator == JoinGuildMediator:
