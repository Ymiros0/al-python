...
def var_0_0.OnInit(arg_3_0):
	...
	onToggle(arg_3_0, arg_3_0.relaxToggle, function(arg_6_0)
		if arg_6_0:
			...
			arg_3_0.newGuildVO.setPolicy(var_6_0), SFX_PANEL)
	onToggle(arg_3_0, arg_3_0.powerToggle, function(arg_7_0)
		if arg_7_0:
			local var_7_0 = GuildConst.POLICY_TYPE_POWER

			arg_3_0.newGuildVO.setPolicy(var_7_0), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.cancelBtn, function()
		if arg_3_0.onCancel:
			arg_3_0.onCancel(), SFX_CANCEL)
	onButton(arg_3_0, arg_3_0.confirmBtn, function()
		...
		if not arg_3_0.newGuildVO.getFaction():
			pg.TipsMgr.GetInstance().ShowTips(i18n("guild_create_error_nofaction"))

			return

		if not arg_3_0.newGuildVO.getPolicy():
		...
		pg.MsgboxMgr.GetInstance().ShowMsgBox({
			...
			def onYes:()
				if arg_3_0.playerVO.getTotalGem() < var_3_0:
...
def var_0_0.Show(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4):
	...
	LeanTween.value(arg_11_0._go, 0, 1, 0.6).setOnUpdate(System.Action_float(function(arg_12_0)
		var_11_0.alpha = arg_12_0)).setOnComplete(System.Action(function()
		arg_11_0.isPlaying = False

		arg_11_3())).setDelay(0.5)
