...
def var_0_0.OnInit(arg_3_0):
	onButton(arg_3_0, arg_3_0.rankBtn, function()
		arg_3_0.contextData.rankPage.ExecuteAction("Flush", arg_3_0.ranks), SFX_PANEL)
...
def var_0_0.Flush(arg_8_0, arg_8_1, arg_8_2, arg_8_3):
...
def var_0_0.SetTotalCount(arg_9_0):
	table.sort(arg_9_0.memberVOs, function(arg_10_0, arg_10_1)
		if arg_10_0.duty != arg_10_1.duty:
...
def var_0_0.OnInitItem(arg_11_0, arg_11_1):
	local var_11_0 = GuildMemberCard.New(arg_11_1)

	onButton(arg_11_0, var_11_0.tf, function()
		if arg_11_0.selected == var_11_0:
			return

		if arg_11_0.selected:
		...
		if arg_11_0.OnClickMember:
			arg_11_0.OnClickMember(var_11_0.memberVO), SFX_PANEL)
...
def var_0_0.OnUpdateItem(arg_13_0, arg_13_1, arg_13_2):
	...
	if not arg_13_0.selected and arg_13_1 == 0:
		triggerButton(var_13_0.tf)

def var_0_0.TriggerFirstCard(arg_14_0):
	for iter_14_0, iter_14_1 in pairs(arg_14_0.items):
		if iter_14_1.memberVO.id == arg_14_0.memberVOs[1].id:
...
def var_0_0.OnDestroy(arg_15_0):
	...
	for iter_15_0, iter_15_1 in pairs(arg_15_0.items):
		iter_15_1.Dispose()
