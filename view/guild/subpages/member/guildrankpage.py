...
def var_0_0.PageId2RankLabel(arg_2_0):
	return var_0_2[arg_2_0]

def var_0_0.GetRank(arg_3_0, arg_3_1):
	return arg_3_0.ranks[arg_3_1]

def var_0_0.OnUpdateRankList(arg_4_0, arg_4_1, arg_4_2):
	if arg_4_2 and table.getCount(arg_4_2) > 0:
		arg_4_0.ranks[arg_4_1] = arg_4_2

		if arg_4_0.pageId == arg_4_1:
...
def var_0_0.InitTags(arg_12_0):
	for iter_12_0, iter_12_1 in ipairs(var_0_1):
		...
		onToggle(arg_12_0, var_12_0, function(arg_13_0)
			if arg_13_0:
				arg_12_0.SwitchPage(iter_12_0), SFX_PANEL)
...
def var_0_0.SwitchPage(arg_15_0, arg_15_1):
	...
	if not var_15_0 or getProxy(GuildProxy).ShouldRefreshRank(arg_15_1):
...
def var_0_0.InitRank(arg_16_0, arg_16_1):
	arg_16_0.displays = {}
