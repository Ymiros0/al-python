...
def var_0_0.OnInit(arg_3_0):
	...
	onToggle(arg_3_0, arg_3_0.toggle, function(arg_4_0)
		...
		setActive(arg_3_0.toggle.Find("off"), not arg_4_0), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.donateBtn, function()
		arg_3_0.emit(GuildTechnologyMediator.ON_OPEN_OFFICE), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.cancelBtn, function()
		arg_3_0.Switch2BreakOutList(), SFX_PANEL)
...
def var_0_0.Flush(arg_10_0):
	if var_0_0.PAGE_DEV == arg_10_0.page:
		arg_10_0.InitBreakOutList()
	elif var_0_0.PAGE_UPGRADE == arg_10_0.page:
		arg_10_0.UpdateUpgradeList()
	elif var_0_0.PAGE_DEV_ITEM == arg_10_0.page:
		arg_10_0.InitDevingItem()

def var_0_0.UpdateUpgradeList(arg_11_0):
...
def var_0_0.UpdateBreakOutList(arg_14_0):
	if arg_14_0.activityGroup:
...
def var_0_0.Switch2BreakOutList(arg_15_0):
...
def var_0_0.InitBreakOutList(arg_16_0, arg_16_1):
