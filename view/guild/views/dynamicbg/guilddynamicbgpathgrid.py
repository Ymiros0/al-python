...
def var_0_0.GetPosition(arg_2_0):
	return arg_2_0.position

def var_0_0.GetLocalPosition(arg_3_0):
	return arg_3_0.localPosition

def var_0_0.GetCenterPosition(arg_4_0):
	return arg_4_0.centerPosition

def var_0_0.CanWalk(arg_5_0):
	return arg_5_0.canWalk and not arg_5_0.IsLock()

def var_0_0.Lock(arg_6_0):
	arg_6_0.lockCnt = arg_6_0.lockCnt + 1

def var_0_0.Unlock(arg_7_0):
	if arg_7_0.lockCnt > 0:
		arg_7_0.lockCnt = arg_7_0.lockCnt - 1

def var_0_0.UnlockAll(arg_8_0):
	arg_8_0.lockCnt = 0

def var_0_0.IsLock(arg_9_0):
	return arg_9_0.lockCnt > 0

def var_0_0.GetAroundGrids(arg_10_0):
