...
def var_0_0.updateFleet(arg_13_0, arg_13_1):
	arg_13_0.fleet = arg_13_1

	arg_13_0.updateDesc()
	arg_13_0.updateRecordFleet()

def var_0_0.updatePrefabs(arg_14_0, arg_14_1):
	arg_14_0.prefabFleets = arg_14_1

	arg_14_0.updateRecordPanel()

def var_0_0.updateRecordFleet(arg_15_0):
	local var_15_0 = arg_15_0.fleet.getCommanders()

	for iter_15_0, iter_15_1 in ipairs(arg_15_0.recordCommanders):
...
def var_0_0.updateRecordPanel(arg_16_0):
...
def var_0_0.UpdatePrefabFleet(arg_18_0, arg_18_1, arg_18_2, arg_18_3):
	...
	onButton(arg_18_0, arg_18_2.Find("use_btn"), function()
		...
		arg_18_0.CloseRecordPanel(), SFX_PANEL)
...
def var_0_0.updateDesc(arg_23_0):
	local var_23_0 = arg_23_0.fleet.getCommanders()

	for iter_23_0 = 1, CommanderConst.MAX_FORMATION_POS:
...
def var_0_0.updateAdditions(arg_24_0):
...
def var_0_0.updateCommander(arg_29_0, arg_29_1, arg_29_2, arg_29_3, arg_29_4):
...
def var_0_0.OpenRecordPanel(arg_32_0):
	setActive(arg_32_0.descFrameTF, False)
	setActive(arg_32_0.recordPanel, True)

def var_0_0.CloseRecordPanel(arg_33_0):
