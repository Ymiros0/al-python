...
def var_0_0.init(arg_1_0):
	...
	arg_1_0.onShipStepChange = None
	arg_1_0.onShipArrived = None
	arg_1_0.lastSelectedId = -1
	arg_1_0.quadState = -1
	arg_1_0.subTeleportTargetLine = None
	arg_1_0.missileStrikeTargetLine = None
	arg_1_0.cellEdges = {}
	arg_1_0.walls = {}
	arg_1_0.material_Add = LoadAny("ui/commonUI_atlas", "add", typeof(Material))
	arg_1_0.loader = AutoLoader.New()

def var_0_0.ExtendItem(arg_2_0, arg_2_1, arg_2_2):
	if IsNil(arg_2_0[arg_2_1]):
		arg_2_0[arg_2_1] = arg_2_2

def var_0_0.getFleetPool(arg_3_0, arg_3_1):
	...
	if not var_3_1:
		...
		if arg_3_1 == FleetType.Submarine:
			var_3_2 = arg_3_0.subTpl
		elif arg_3_1 == FleetType.Transport:
...
def var_0_0.getChampionPool(arg_4_0, arg_4_1):
	...
	if not var_4_1:
		...
		if arg_4_1 == ChapterConst.TemplateOni:
			var_4_2 = arg_4_0.oniTpl
		elif arg_4_1 == ChapterConst.TemplateEnemy:
...
def var_0_0.AddEdgePool(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5):
	if arg_5_0.edgePools[arg_5_1]:
		return
	...
	parallelAsync({
		...
		local function var_10_0(arg_11_0)
			...
			var_11_0.sprite = arg_5_3 and var_5_1 or None
			var_11_0.material = arg_5_5 and var_5_2 or None
		...
		if var_10_1.items:
			for iter_10_0, iter_10_1 in pairs(var_10_1.items):
				var_10_0(iter_10_1)

		if arg_5_0.cellEdges[arg_5_1] and next(arg_5_0.cellEdges[arg_5_1]):
			for iter_10_2, iter_10_3 in pairs(arg_5_0.cellEdges[arg_5_1]):
				var_10_0(iter_10_3))

def var_0_0.GetEdgePool(arg_12_0, arg_12_1):
...
def var_0_0.initAll(arg_13_0, arg_13_1):
	seriesAsync({
		function(arg_14_0)
			arg_13_0.initPlane()
			arg_13_0.initDrag()
		...
		function(arg_16_0)
			...
			for iter_16_0 = 0, ChapterConst.MaxRow - 1:
				for iter_16_1 = 0, ChapterConst.MaxColumn - 1:
...
def var_0_0.clearAll(arg_22_0):
	for iter_22_0, iter_22_1 in pairs(arg_22_0.tweens):
		LeanTween.cancel(iter_22_0)

	table.clear(arg_22_0.tweens)
	arg_22_0.loader.Clear()

	if not IsNil(arg_22_0.cellRoot):
		...
		for iter_22_2, iter_22_3 in pairs(arg_22_0.itemCells):
			iter_22_3.Clear()

		table.clear(arg_22_0.itemCells)

		for iter_22_4, iter_22_5 in pairs(arg_22_0.attachmentCells):
			iter_22_5.Clear()

		table.clear(arg_22_0.attachmentCells)

		for iter_22_6, iter_22_7 in pairs(arg_22_0.extraAttachmentCells):
			iter_22_7.Clear()

		table.clear(arg_22_0.extraAttachmentCells)

		for iter_22_8, iter_22_9 in pairs(arg_22_0.weatherCells):
			iter_22_9.Clear()

		table.clear(arg_22_0.weatherCells)

		for iter_22_10 = 0, ChapterConst.MaxRow - 1:
			for iter_22_11 = 0, ChapterConst.MaxColumn - 1:
				arg_22_0.clearCell(iter_22_10, iter_22_11)

		for iter_22_12, iter_22_13 in pairs(arg_22_0.walls):
			iter_22_13.Clear()

		table.clear(arg_22_0.walls)
		arg_22_0.clearPlane()

	arg_22_0.material_Add = None

	for iter_22_14, iter_22_15 in pairs(arg_22_0.edgePools):
		iter_22_15.Clear()

	arg_22_0.edgePools = None

	for iter_22_16, iter_22_17 in pairs(arg_22_0.pools):
		iter_22_17.ClearItems()

	arg_22_0.pools = None
	GetOrAddComponent(arg_22_0._tf, "EventTriggerListener").enabled = False

	if arg_22_0.dragTrigger:
		ClearEventTrigger(arg_22_0.dragTrigger)

		arg_22_0.dragTrigger = None

	LeanTween.cancel(arg_22_0._tf)

local var_0_2 = 640

def var_0_0.initDrag(arg_23_0):
...
def var_0_0.initPlane(arg_25_0):
	...
	for iter_25_0 = 1, arg_25_0.UIFXList.childCount:
	...
	if type(var_25_5) == "table":
		for iter_25_1, iter_25_2 in pairs(var_25_5):
			if #iter_25_1 <= 0:
				return
	...
	for iter_25_3 = var_25_14.childCount - 1, var_25_13.x, -1:
		Destroy(var_25_14.GetChild(iter_25_3))

	for iter_25_4 = var_25_14.childCount, var_25_13.x - 1:
		Instantiate(var_25_15).transform.SetParent(var_25_14, False)

	for iter_25_5 = 0, var_25_13.x - 1:
	...
	for iter_25_6 = var_25_17.childCount - 1, var_25_13.y, -1:
		Destroy(var_25_17.GetChild(iter_25_6))

	for iter_25_7 = var_25_17.childCount, var_25_13.y - 1:
		Instantiate(var_25_18).transform.SetParent(var_25_17, False)

	for iter_25_8 = 0, var_25_13.y - 1:
	...
	for iter_25_9 = var_25_20.childCount - 1, math.max(var_25_13.x - 1, 0), -1:
		if iter_25_9 > 0:
			Destroy(var_25_20.GetChild(iter_25_9))

	for iter_25_10 = var_25_20.childCount, var_25_13.x - 2:
	...
	for iter_25_11 = var_25_23.childCount - 1, math.max(var_25_13.y - 1, 0), -1:
		if iter_25_11 > 0:
			Destroy(var_25_23.GetChild(iter_25_11))

	for iter_25_12 = var_25_23.childCount, var_25_13.y - 2:
	...
	if var_25_1.seaBase and var_25_1.seaBase != "":
...
def var_0_0.getPoisonTex(arg_29_0):
	...
	if arg_29_0.preChapterId != var_29_0.id:
	...
	if arg_29_0.poisonRectDir == None:
		var_29_6 = var_29_7
	else
		for iter_29_0, iter_29_1 in pairs(var_29_7):
			if arg_29_0.poisonRectDir[iter_29_0] == None:
				var_29_6[iter_29_0] = iter_29_1

	local function var_29_8(arg_30_0)
		for iter_30_0 = arg_30_0.x, arg_30_0.w + arg_30_0.x:
			for iter_30_1 = arg_30_0.y, arg_30_0.h + arg_30_0.y:
				var_29_5.SetPixel(iter_30_0, iter_30_1, Color.New(1, 1, 1, 0))

	for iter_29_2, iter_29_3 in pairs(var_29_6):
		var_29_8(iter_29_3)
...
def var_0_0.showFleetPoisonDamage(arg_31_0, arg_31_1, arg_31_2):
...
def var_0_0.clearPlane(arg_32_0):
	...
	arg_32_0.cellRoot = None
	arg_32_0.quadRoot = None
	arg_32_0.bottomMarkRoot = None
	arg_32_0.topMarkRoot = None
	arg_32_0.restrictMap = None
...
def var_0_0.initFleets(arg_33_0, arg_33_1):
	if arg_33_0.cellFleets:
		existCall(arg_33_1)
	...
	table.ParallelIpairsAsync(var_33_0.fleets, function(arg_34_0, arg_34_1, arg_34_2)
		if arg_34_1.getFleetType() == FleetType.Support:
			return arg_34_2()

		arg_33_0.InitFleetCell(arg_34_1.id, arg_34_2), arg_33_1)

def var_0_0.InitFleetCell(arg_35_0, arg_35_1, arg_35_2):
	local var_35_0 = arg_35_0.contextData.chapterVO
	local var_35_1 = var_35_0.getFleetById(arg_35_1)

	if not var_35_1.isValid():
		existCall(arg_35_2)
	...
	if var_35_4 == FleetType.Transport:
		var_35_5 = TransportCellView
	elif var_35_4 == FleetType.Submarine:
	...
	if var_35_4 == FleetType.Normal or var_35_4 == FleetType.Submarine:
...
def var_0_0.RefreshFleetCells(arg_36_0, arg_36_1):
	if not arg_36_0.cellFleets:
	...
	for iter_36_0, iter_36_1 in pairs(arg_36_0.cellFleets):
		if not var_36_0.getFleetById(iter_36_0):
			table.insert(var_36_1, iter_36_0)

	for iter_36_2, iter_36_3 in pairs(var_36_1):
		arg_36_0.ClearFleetCell(iter_36_3)

	table.ParallelIpairsAsync(var_36_0.fleets, function(arg_37_0, arg_37_1, arg_37_2)
		if arg_37_1.getFleetType() == FleetType.Support:
			return arg_37_2()

		if not arg_36_0.cellFleets[arg_37_1.id]:
			arg_36_0.InitFleetCell(arg_37_1.id, arg_37_2)
		else
			arg_36_0.RefreshFleetCell(arg_37_1.id, arg_37_2), arg_36_1)

def var_0_0.RefreshFleetCell(arg_38_0, arg_38_1, arg_38_2):
	...
	if var_38_1.isValid():
		if var_38_1.getFleetType() == FleetType.Transport:
	...
	if var_38_2.fleetType == FleetType.Transport:
		...
		var_38_2.LoadSpine(var_38_3, None, var_38_4, function()
			var_38_2.GetRotatePivot().transform.localRotation = var_38_1.rotation

			arg_38_0.updateFleet(arg_38_1, arg_38_2))

def var_0_0.clearFleets(arg_41_0):
	if arg_41_0.cellFleets:
		for iter_41_0, iter_41_1 in pairs(arg_41_0.cellFleets):
			arg_41_0.ClearFleetCell(iter_41_0)

		arg_41_0.cellFleets = None

def var_0_0.ClearFleetCell(arg_42_0, arg_42_1):
	...
	if arg_42_0.opBtns[arg_42_1]:
		Destroy(arg_42_0.opBtns[arg_42_1].gameObject)

		arg_42_0.opBtns[arg_42_1] = None

	arg_42_0.cellFleets[arg_42_1] = None

def var_0_0.UpdateFleets(arg_43_0, arg_43_1):
	...
	table.ParallelIpairsAsync(var_43_0.fleets, function(arg_44_0, arg_44_1, arg_44_2)
		if arg_44_1.getFleetType() == FleetType.Support:
			return arg_44_2()

		arg_43_0.updateFleet(arg_44_1.id, arg_44_2), arg_43_1)

def var_0_0.updateFleet(arg_45_0, arg_45_1, arg_45_2):
	...
	if var_45_1:
		...
		if var_45_5 == FleetType.Normal:
			...
			if var_45_7 and var_45_8 == ChapterConst.AttachChampion:
			...
			if var_45_19.gameObject.activeSelf:
				onButton(arg_45_0, var_45_19, function()
					if arg_45_0.parent.isfrozen():
						return
					...
					if var_45_13:
						(function()
							...
							for iter_48_0, iter_48_1 in ipairs(var_48_0):
								if var_45_0.considerAsStayPoint(ChapterConst.SubjectPlayer, var_45_3.row + iter_48_1[1], var_45_3.column + iter_48_1[2]) and not var_45_0.existEnemy(ChapterConst.SubjectPlayer, var_45_3.row + iter_48_1[1], var_45_3.column + iter_48_1[2]):
			...
			if var_45_7 or var_45_9:
				local var_45_24 = var_45_0.getChampion(var_45_3.row, var_45_3.column)

				if var_45_7 and var_45_8 == ChapterConst.AttachChampion and var_45_24.getPoolType() == ChapterConst.TemplateChampion:
			...
			if var_45_1.GetSpineRole() and var_45_10 and arg_45_0.lastSelectedId != var_45_2.id:
				if not var_45_7 and not var_45_9 and arg_45_0.lastSelectedId != -1:
		...
		elif var_45_5 == FleetType.Submarine:
		...
		elif var_45_5 == FleetType.Transport:
...
def var_0_0.UpdateOpBtns(arg_50_0):
...
def var_0_0.GetCellFleet(arg_52_0, arg_52_1):
	return arg_52_0.cellFleets[arg_52_1]

def var_0_0.initTargetArrow(arg_53_0):
...
def var_0_0.updateTargetArrow(arg_54_0, arg_54_1):
	...
	local var_54_3, var_54_4 = (function()
		...
		if var_55_1 == ChapterConst.AttachChampion:
		...
		elif ChapterConst.IsEnemyAttach(var_55_1):
			local var_55_3 = var_54_0.getChapterCell(arg_54_1.row, arg_54_1.column)

			if not var_55_3 or var_55_3.flag != ChapterConst.CellFlagActive:
				return False
...
def var_0_0.clearTargetArrow(arg_56_0):
	if not IsNil(arg_56_0.arrowTarget):
		Destroy(arg_56_0.arrowTarget)

		arg_56_0.arrowTarget = None

def var_0_0.InitDestinationMark(arg_57_0):
...
def var_0_0.UpdateDestinationMark(arg_58_0, arg_58_1):
	if not arg_58_1:
...
def var_0_0.ClearDestinationMark(arg_59_0):
	if not IsNil(arg_59_0.destinationMark):
		Destroy(arg_59_0.destinationMark)

		arg_59_0.destinationMark = None

def var_0_0.initChampions(arg_60_0, arg_60_1):
	if arg_60_0.cellChampions:
		existCall(arg_60_1)
	...
	table.ParallelIpairsAsync(var_60_0.champions, function(arg_61_0, arg_61_1, arg_61_2)
		...
		if arg_61_1.flag != ChapterConst.CellFlagDisabled:
			arg_60_0.InitChampion(arg_61_0, arg_61_2)
		else
			arg_61_2(), arg_60_1)

def var_0_0.InitChampion(arg_62_0, arg_62_1, arg_62_2):
	...
	if var_62_2 == ChapterConst.TemplateChampion:
		var_62_4 = DynamicChampionCellView
	elif var_62_2 == ChapterConst.TemplateEnemy:
		var_62_4 = DynamicEggCellView
	elif var_62_2 == ChapterConst.TemplateOni:
...
def var_0_0.updateChampions(arg_65_0, arg_65_1):
	table.ParallelIpairsAsync(arg_65_0.cellChampions, function(arg_66_0, arg_66_1, arg_66_2)
		arg_65_0.updateChampion(arg_66_0, arg_66_2), arg_65_1)

def var_0_0.updateChampion(arg_67_0, arg_67_1, arg_67_2):
	...
	if var_67_1 and var_67_2:
		var_67_1.UpdateChampionCell(var_67_0, var_67_2, arg_67_2)

def var_0_0.updateOni(arg_68_0):
	local var_68_0 = arg_68_0.contextData.chapterVO
	local var_68_1

	for iter_68_0, iter_68_1 in ipairs(var_68_0.champions):
		if iter_68_1.attachment == ChapterConst.AttachOni:
			var_68_1 = iter_68_0
...
def var_0_0.clearChampions(arg_69_0):
	if arg_69_0.cellChampions:
		for iter_69_0, iter_69_1 in ipairs(arg_69_0.cellChampions):
			if iter_69_1:
				iter_69_1.Clear()
		...
		arg_69_0.cellChampions = None

def var_0_0.initCell(arg_70_0, arg_70_1, arg_70_2):
	...
	if var_70_1:
		...
		if var_70_1.IsWalkable():
			...
			onButton(arg_70_0, var_70_4, function()
				if arg_70_0.isfrozen():
					return

				arg_70_0.ClickGridCell(var_70_1), SFX_CONFIRM)
...
def var_0_0.clearCell(arg_74_0, arg_74_1, arg_74_2):
...
def var_0_0.updateAttachments(arg_76_0):
	for iter_76_0 = 0, ChapterConst.MaxRow - 1:
		for iter_76_1 = 0, ChapterConst.MaxColumn - 1:
...
def var_0_0.UpdateFloor(arg_77_0):
	...
	if var_77_2[ChapterConst.FlagBanaiAirStrike] and next(var_77_2[ChapterConst.FlagBanaiAirStrike]):
		arg_77_0.hideQuadMark(ChapterConst.MarkBanaiAirStrike)
		arg_77_0.showQuadMark(var_77_2[ChapterConst.FlagBanaiAirStrike], ChapterConst.MarkBanaiAirStrike, "cell_coastal_gun", Vector2(110, 110), None, True)

	arg_77_0.updatePoisonArea()

	if var_77_2[ChapterConst.FlagLava] and next(var_77_2[ChapterConst.FlagLava]):
		arg_77_0.hideQuadMark(ChapterConst.MarkLava)
		arg_77_0.showQuadMark(var_77_2[ChapterConst.FlagLava], ChapterConst.MarkLava, "cell_lava", Vector2(110, 110), None, True)

	if var_77_2[ChapterConst.FlagNightmare] and next(var_77_2[ChapterConst.FlagNightmare]):
		...
		if var_77_4 == ChapterConst.StatusDay:
			arg_77_0.showQuadMark(var_77_2[ChapterConst.FlagNightmare], ChapterConst.MarkHideNight, "cell_hidden_nightmare", Vector2(110, 110), None, True)
		elif var_77_4 == ChapterConst.StatusNight:
			arg_77_0.showQuadMark(var_77_2[ChapterConst.FlagNightmare], ChapterConst.MarkNightMare, "cell_nightmare", Vector2(110, 110), None, True)

	local var_77_5 = {}

	for iter_77_4, iter_77_5 in pairs(var_77_0.GetChapterCellAttachemnts()):
		if iter_77_5.data == ChapterConst.StoryTrigger:
			...
			if var_77_6 and var_77_6.c_type == ChapterConst.EvtType_AdditionalFloor:
				var_77_5[var_77_6.icon] = var_77_5[var_77_6.icon] or {}

				table.insert(var_77_5[var_77_6.icon], iter_77_5)

	for iter_77_6, iter_77_7 in pairs(var_77_5):
		arg_77_0.hideQuadMark(iter_77_6)
		arg_77_0.showQuadMark(iter_77_7, iter_77_6, iter_77_6, Vector2(110, 110), None, True)

	local var_77_7 = var_77_0.getConfig("alarm_cell")

	if var_77_7 and #var_77_7 > 0:
		...
		arg_77_0.AddOutlines(var_77_9, None, var_77_7[5], var_77_7[4], var_77_8)

		local var_77_10 = var_77_7[2]

		arg_77_0.hideQuadMark(var_77_10)
		arg_77_0.showQuadMark(var_77_9, var_77_10, var_77_10, Vector2(104, 104), None, True)

	arg_77_0.HideMissileAimingMarks()

	if var_77_2[ChapterConst.FlagMissleAiming] and next(var_77_2[ChapterConst.FlagMissleAiming]):
	...
	if var_77_0.isPlayingWithBombEnemy():
		...
		arg_77_0.showQuadMark(var_77_12, ChapterConst.MarkBomb, "cell_bomb", Vector2(100, 100), None, True)

def var_0_0.updateExtraAttachments(arg_80_0):
	local var_80_0 = arg_80_0.contextData.chapterVO
	local var_80_1 = var_80_0.GetChapterCellAttachemnts()

	for iter_80_0, iter_80_1 in pairs(var_80_1):
		...
		if var_80_6 == ChapterConst.StoryTrigger and var_80_5.c_type != ChapterConst.EvtType_AdditionalFloor:
			var_80_7 = MapEventStoryTriggerCellView

		local var_80_8 = arg_80_0.extraAttachmentCells[iter_80_0]

		if var_80_8 and var_80_8.class != var_80_7:
			var_80_8.Clear()

			var_80_8 = None
			arg_80_0.extraAttachmentCells[iter_80_0] = None
...
def var_0_0.updateAttachment(arg_81_0, arg_81_1, arg_81_2):
	...
	if ChapterConst.IsEnemyAttach(var_81_1.attachment):
		...
		if var_81_1.flag == ChapterConst.CellFlagDisabled:
			if var_81_1.attachment != ChapterConst.AttachAmbush:
				var_81_4 = EnemyDeadCellView
				var_81_5.chapter = var_81_0
				var_81_5.config = var_81_6
		elif var_81_1.flag == ChapterConst.CellFlagActive:
			var_81_4 = var_81_6.icon_type == 1 and StaticEggCellView or StaticChampionCellView
			var_81_5.config = var_81_6
			var_81_5.chapter = var_81_0
			var_81_5.viewParent = arg_81_0
	elif var_81_1.attachment == ChapterConst.AttachBox:
		var_81_4 = AttachmentBoxCell
	elif var_81_1.attachment == ChapterConst.AttachSupply:
		var_81_4 = AttachmentSupplyCell
	elif var_81_1.attachment == ChapterConst.AttachTransport_Target:
		var_81_4 = AttachmentTransportTargetCell
	elif var_81_1.attachment == ChapterConst.AttachStory:
		if var_81_1.data == ChapterConst.Story:
			var_81_4 = MapEventStoryCellView
		elif var_81_1.data == ChapterConst.StoryObstacle:
			var_81_4 = MapEventStoryObstacleCellView
			var_81_5.chapter = var_81_0
	elif var_81_1.attachment == ChapterConst.AttachBomb_Enemy:
		var_81_4 = AttachmentBombEnemyCell
	elif var_81_1.attachment == ChapterConst.AttachLandbase:
		...
		if var_81_7.type == ChapterConst.LBCoastalGun:
			var_81_4 = AttachmentLBCoastalGunCell
		elif var_81_7.type == ChapterConst.LBHarbor:
			var_81_4 = AttachmentLBHarborCell
		elif var_81_7.type == ChapterConst.LBDock:
			var_81_4 = AttachmentLBDockCell
			var_81_5.chapter = var_81_0
		elif var_81_7.type == ChapterConst.LBAntiAir:
			var_81_4 = AttachmentLBAntiAirCell
			var_81_5.info = var_81_1
			var_81_5.chapter = var_81_0
			var_81_5.grid = arg_81_0
		elif var_81_7.type == ChapterConst.LBIdle and var_81_1.attachmentId == ChapterConst.LBIDAirport:
			var_81_4 = AttachmentLBAirport
			var_81_5.extraFlagList = var_81_0.getExtraFlags()
	elif var_81_1.attachment == ChapterConst.AttachBarrier:
		var_81_4 = AttachmentBarrierCell
	elif var_81_1.attachment == ChapterConst.AttachNone:
		var_81_5.fadeAnim = (function()
			...
			if var_82_0.class != StaticEggCellView and var_82_0.class != StaticChampionCellView:
				return
	...
	if var_81_4:
		...
		for iter_81_0, iter_81_1 in pairs(var_81_5):
			var_81_8[iter_81_0] = iter_81_1

		var_81_8.Update()

def var_0_0.InitWalls(arg_83_0):
	local var_83_0 = arg_83_0.contextData.chapterVO

	for iter_83_0 = arg_83_0.indexMin.x, arg_83_0.indexMax.x:
		for iter_83_1 = arg_83_0.indexMin.y, arg_83_0.indexMax.y:
	...
	for iter_83_2, iter_83_3 in pairs(arg_83_0.walls):
		if iter_83_3.WallPrefabs:
...
def var_0_0.InitWallDirection(arg_84_0, arg_84_1, arg_84_2):
	local var_84_0 = arg_84_0.contextData.chapterVO

	if bit.band(arg_84_1.forbiddenDirections, arg_84_2) == 0:
		return

	if arg_84_1.walkable == False:
		return
...
def var_0_0.UpdateWeatherCells(arg_85_0):
	local var_85_0 = arg_85_0.contextData.chapterVO

	for iter_85_0, iter_85_1 in pairs(var_85_0.cells):
		local var_85_1
		...
		if var_85_3 and var_85_3.class != var_85_1:
			var_85_3.Clear()

			var_85_3 = None
			arg_85_0.weatherCells[iter_85_0] = None
...
def var_0_0.updateQuadCells(arg_86_0, arg_86_1):
	arg_86_1 = arg_86_1 or ChapterConst.QuadStateNormal
	arg_86_0.quadState = arg_86_1

	arg_86_0.updateQuadBase()

	if arg_86_1 == ChapterConst.QuadStateNormal:
		arg_86_0.UpdateQuadStateNormal()
	elif arg_86_1 == ChapterConst.QuadStateBarrierSetting:
		arg_86_0.UpdateQuadStateBarrierSetting()
	elif arg_86_1 == ChapterConst.QuadStateTeleportSub:
		arg_86_0.UpdateQuadStateTeleportSub()
	elif arg_86_1 == ChapterConst.QuadStateMissileStrike or arg_86_1 == ChapterConst.QuadStateAirSuport:
		arg_86_0.UpdateQuadStateMissileStrike()
	elif arg_86_1 == ChapterConst.QuadStateExpel:
		arg_86_0.UpdateQuadStateAirExpel()

	arg_86_0.UpdateOpBtns()

def var_0_0.PlayQuadsParallelAnim(arg_87_0, arg_87_1):
	arg_87_0.frozen()
...
def var_0_0.updateQuadBase(arg_90_0):
	...
	local function var_90_1(arg_91_0)
		...
		if var_91_5 and var_91_5.flag == ChapterConst.CellFlagActive and var_91_5.trait != ChapterConst.TraitLurk and var_90_0.getChampionVisibility(var_91_5) and not var_90_0.existFleet(FleetType.Transport, var_91_0, var_91_1):
		...
		if var_90_0.getChapterCell(var_91_0, var_91_1):
			local var_91_8 = var_90_0.getQuadCellPic(arg_91_0)

			if var_91_8:
				arg_90_0.startQuadTween(var_91_2, var_91_3)

				if var_91_8 == "cell_enemy":
					setImageSprite(var_91_3.Find("grid"), GetSpriteFromAtlas("chapter/pic/cellgrid", "cell_enemy_grid"))
...
def var_0_0.UpdateQuadStateBarrierSetting(arg_95_0):
	local var_95_0 = 1
...
def var_0_0.UpdateQuadStateTeleportSub(arg_98_0):
	...
	local var_98_2 = var_98_0.calcWalkableCells(None, var_98_1.line.row, var_98_1.line.column, ChapterConst.MaxStep)
...
def var_0_0.UpdateQuadStateMissileStrike(arg_101_0):
...
def var_0_0.ClickGridCell(arg_105_0, arg_105_1):
	if arg_105_0.quadState == ChapterConst.QuadStateBarrierSetting:
		arg_105_0.OnBarrierSetting(arg_105_1)
	elif arg_105_0.quadState == ChapterConst.QuadStateTeleportSub:
		arg_105_0.OnTeleportConfirm(arg_105_1)
	elif arg_105_0.quadState == ChapterConst.QuadStateMissileStrike:
		arg_105_0.OnMissileAiming(arg_105_1)
	elif arg_105_0.quadState == ChapterConst.QuadStateAirSuport:
		arg_105_0.OnAirSupportAiming(arg_105_1)
	elif arg_105_0.quadState == ChapterConst.QuadStateExpel:
		arg_105_0.OnAirExpelSelect(arg_105_1)
	else
		arg_105_0.emit(LevelUIConst.ON_CLICK_GRID_QUAD, arg_105_1)

def var_0_0.OnBarrierSetting(arg_106_0, arg_106_1):
	local var_106_0 = 1
	...
	;(function(arg_108_0, arg_108_1)
		...
		if not newChapterVO.existBarrier(arg_108_0, arg_108_1) and newChapterVO.modelCount <= 0:
			return
		...
		arg_106_0.emit(LevelMediator2.ON_OP, {
			...
			arg1 = arg_108_0,
			arg2 = arg_108_1
		}))(arg_106_1.row, arg_106_1.column)

def var_0_0.PrepareSubTeleport(arg_109_0):
	...
	for iter_109_0, iter_109_1 in pairs(var_109_0.fleets):
		if iter_109_1.getFleetType() == FleetType.Normal:
	...
	if not (var_109_0.subAutoAttack == 1):
...
def var_0_0.TurnOffSubTeleport(arg_111_0):
	arg_111_0.subTeleportTargetLine = None
...
def var_0_0.OnTeleportConfirm(arg_113_0, arg_113_1):
	local var_113_0 = arg_113_0.contextData.chapterVO
	local var_113_1 = var_113_0.getChapterCell(arg_113_1.row, arg_113_1.column)

	if var_113_1 and var_113_1.IsWalkable() and not var_113_0.existBarrier(arg_113_1.row, arg_113_1.column):
		local var_113_2 = var_113_0.GetSubmarineFleet()

		if var_113_2.startPos.row == arg_113_1.row and var_113_2.startPos.column == arg_113_1.column:
			return

		local var_113_3, var_113_4 = var_113_0.findPath(None, var_113_2.startPos, arg_113_1)

		if var_113_3 >= PathFinding.PrioObstacle or arg_113_1.row != var_113_4[#var_113_4].row or arg_113_1.column != var_113_4[#var_113_4].column:
			return
...
def var_0_0.ShowPathInArrows(arg_114_0, arg_114_1):
	local var_114_0 = arg_114_0.contextData.chapterVO
	local var_114_1 = Clone(arg_114_1)

	table.remove(var_114_1, #var_114_1)

	for iter_114_0 = #var_114_1, 1, -1:
		local var_114_2 = var_114_1[iter_114_0]

		if var_114_0.existEnemy(ChapterConst.SubjectPlayer, var_114_2.row, var_114_2.column) or var_114_0.getFleet(FleetType.Normal, var_114_2.row, var_114_2.column):
			table.remove(var_114_1, iter_114_0)

	arg_114_0.hideQuadMark(ChapterConst.MarkMovePathArrow)
	arg_114_0.showQuadMark(var_114_1, ChapterConst.MarkMovePathArrow, "cell_path_arrow", Vector2(100, 100), None, True)

	local var_114_3 = arg_114_0.markQuads[ChapterConst.MarkMovePathArrow]

	for iter_114_1 = #arg_114_1, 1, -1:
...
def var_0_0.ShowMissileAimingMarks(arg_115_0, arg_115_1):
	_.each(arg_115_1, function(arg_116_0)
		arg_115_0.loader.GetPrefabBYGroup("ui/miaozhun02", "miaozhun02", function(arg_117_0)
			...
			tf(arg_117_0).anchoredPosition = Vector2(var_117_0.x - var_117_1.x, var_117_0.y - var_117_1.y), "MissileAimingMarks"))

def var_0_0.HideMissileAimingMarks(arg_118_0):
	arg_118_0.loader.ReturnGroup("MissileAimingMarks")

def var_0_0.ShowMissileAimingMark(arg_119_0, arg_119_1):
	arg_119_0.loader.GetPrefab("ui/miaozhun02", "miaozhun02", function(arg_120_0)
		...
		tf(arg_120_0).anchoredPosition = Vector2(var_120_0.x - var_120_1.x, var_120_0.y - var_120_1.y), "MissileAimingMark")

def var_0_0.HideMissileAimingMark(arg_121_0):
	arg_121_0.loader.ClearRequest("MissileAimingMark")

def var_0_0.OnMissileAiming(arg_122_0, arg_122_1):
	arg_122_0.HideMissileAimingMark()
	arg_122_0.ShowMissileAimingMark(arg_122_1)

	arg_122_0.missileStrikeTargetLine = arg_122_1

def var_0_0.ShowAirSupportAimingMark(arg_123_0, arg_123_1):
	arg_123_0.loader.GetPrefab("ui/miaozhun03", "miaozhun03", function(arg_124_0)
		...
		tf(arg_124_0).anchoredPosition = Vector2(var_124_0.x - var_124_1.x, var_124_0.y - var_124_1.y), "AirSupportAimingMark")

def var_0_0.HideAirSupportAimingMark(arg_125_0):
	arg_125_0.loader.ClearRequest("AirSupportAimingMark")

def var_0_0.OnAirSupportAiming(arg_126_0, arg_126_1):
...
def var_0_0.ShowAirExpelAimingMark(arg_127_0):
	local var_127_0 = arg_127_0.airSupportTarget

	if not var_127_0 or not var_127_0.source:
		return
	...
	arg_127_0.loader.GetPrefabBYGroup("leveluiview/tpl_airsupportmark", "tpl_airsupportmark", function(arg_129_0)
		var_127_4(arg_129_0, True), "AirExpelAimingMark")
	arg_127_0.loader.GetPrefabBYGroup("leveluiview/tpl_airsupportdirection", "tpl_airsupportdirection", function(arg_130_0)
		...
		for iter_130_0 = 1, 4:
			...
			setActive(var_130_2, var_130_3), "AirExpelAimingMark")

def var_0_0.HideAirExpelAimingMark(arg_131_0):
	arg_131_0.loader.ReturnGroup("AirExpelAimingMark")

def var_0_0.OnAirExpelSelect(arg_132_0, arg_132_1):
	...
	if var_132_3:
		if ChapterConst.IsBossCell(var_132_3):
			pg.TipsMgr.GetInstance().ShowTips(i18n("levelscene_airexpel_select_boss"))

			return

		if var_132_0.existFleet(FleetType.Normal, arg_132_1.row, arg_132_1.column):
			pg.TipsMgr.GetInstance().ShowTips(i18n("levelscene_airexpel_select_battle"))

			return

		if var_132_2.source and table.equal(var_132_2.source.GetLine(), var_132_3.GetLine()):
			var_132_3 = None

		var_132_2.source = var_132_3

		var_132_1()
	elif not var_132_2.source:
		pg.TipsMgr.GetInstance().ShowTips(i18n("levelscene_airexpel_select_enemy"))
	elif ManhattonDist(var_132_2.source, arg_132_1) > 1:
		pg.TipsMgr.GetInstance().ShowTips(i18n("levelscene_airexpel_outrange"))
	elif not var_132_0.considerAsStayPoint(ChapterConst.SubjectChampion, arg_132_1.row, arg_132_1.column):
		pg.TipsMgr.GetInstance().ShowTips(i18n("levelscene_airexpel_outrange"))
	else
		local var_132_4 = arg_132_0.airSupportTarget.source
		local var_132_5 = arg_132_1

		if not var_132_4 or not var_132_5:
			return
...
def var_0_0.CleanAirSupport(arg_135_0):
	arg_135_0.airSupportTarget = None

def var_0_0.startQuadTween(arg_136_0, arg_136_1, arg_136_2, arg_136_3, arg_136_4):
	if arg_136_0.presentTws[arg_136_1]:
		LeanTween.cancel(arg_136_0.presentTws[arg_136_1].uniqueId)

		arg_136_0.presentTws[arg_136_1] = None

	if not arg_136_0.quadTws[arg_136_1]:
...
def var_0_0.cancelQuadTween(arg_137_0, arg_137_1, arg_137_2):
	if arg_137_0.quadTws[arg_137_1]:
		LeanTween.cancel(arg_137_0.quadTws[arg_137_1].uniqueId)

		arg_137_0.quadTws[arg_137_1] = None

	setImageAlpha(arg_137_2, ChapterConst.CellEaseOutAlpha)

def var_0_0.killQuadTws(arg_138_0):
	for iter_138_0, iter_138_1 in pairs(arg_138_0.quadTws):
		LeanTween.cancel(iter_138_1.uniqueId)

	arg_138_0.quadTws = {}

def var_0_0.killPresentTws(arg_139_0):
	for iter_139_0, iter_139_1 in pairs(arg_139_0.presentTws):
		LeanTween.cancel(iter_139_1.uniqueId)

	arg_139_0.presentTws = {}

def var_0_0.startMarkTween(arg_140_0, arg_140_1, arg_140_2, arg_140_3, arg_140_4):
	if not arg_140_0.markTws[arg_140_1]:
...
def var_0_0.cancelMarkTween(arg_141_0, arg_141_1, arg_141_2, arg_141_3):
	if arg_141_0.markTws[arg_141_1]:
		LeanTween.cancel(arg_141_0.markTws[arg_141_1].uniqueId)

		arg_141_0.markTws[arg_141_1] = None

	setImageAlpha(arg_141_2, arg_141_3 or ChapterConst.CellEaseOutAlpha)

def var_0_0.moveFleet(arg_142_0, arg_142_1, arg_142_2, arg_142_3, arg_142_4):
	...
	local function var_142_6()
		...
		if ChapterConst.NeedClearStep(var_145_1):
			var_142_1.step = 0
...
def var_0_0.moveSub(arg_146_0, arg_146_1, arg_146_2, arg_146_3, arg_146_4):
...
def var_0_0.moveChampion(arg_150_0, arg_150_1, arg_150_2, arg_150_3, arg_150_4):
	...
	local function var_150_5()
		if var_150_2.GetRotatePivot:
			var_150_1.rotation = var_150_2.GetRotatePivot().transform.localRotation

		if arg_150_4:
			arg_150_4()

	if var_150_0.getChampionVisibility(var_150_1):
...
def var_0_0.moveTransport(arg_154_0, arg_154_1, arg_154_2, arg_154_3, arg_154_4):
...
def var_0_0.moveCellView(arg_158_0, arg_158_1, arg_158_2, arg_158_3, arg_158_4, arg_158_5, arg_158_6):
	local var_158_0 = arg_158_0.contextData.chapterVO
	local var_158_1

	local function var_158_2()
		if var_158_1 and coroutine.status(var_158_1) == "suspended":
	...
	var_158_1 = coroutine.create(function()
		...
		_.each(arg_158_3, function(arg_161_0)
			...
			if ChapterConst.NeedEasePathCell(var_161_0):
		...
		_.each(arg_158_2, function(arg_162_0)
			arg_158_0.moveStep(arg_158_1, arg_162_0, arg_158_3[#arg_158_3], function()
				...
				if ChapterConst.NeedEasePathCell(var_163_1):
				...
				arg_158_1.ResetCanvasOrder(), function()
				arg_158_5(arg_162_0)
				var_158_2())
			coroutine.yield())
		_.each(arg_158_3, function(arg_165_0)
			...
			if ChapterConst.NeedEasePathCell(var_165_0):
...
def var_0_0.moveStep(arg_166_0, arg_166_1, arg_166_2, arg_166_3, arg_166_4, arg_166_5):
	...
	if arg_166_1.GetRotatePivot:
		var_166_2 = arg_166_1.GetRotatePivot()

	local var_166_3 = arg_166_1.GetLine()

	if arg_166_1.GetAction:
		arg_166_1.SetAction(ChapterConst.ShipMoveAction)

	if not IsNil(var_166_2) and (arg_166_2.column != var_166_3.column or arg_166_3.column != var_166_3.column):
		tf(var_166_2).localRotation = Quaternion.identity

		if arg_166_2.column < var_166_3.column or arg_166_2.column == var_166_3.column and arg_166_3.column < var_166_3.column:
	...
	LeanTween.value(arg_166_1.go, 0, 1, ChapterConst.ShipStepDuration * var_166_1).setOnComplete(System.Action(arg_166_5)).setOnUpdate(System.Action_float(function(arg_167_0)
		...
		if var_166_6 <= 0.5 and arg_167_0 > 0.5:
			arg_166_4()

		var_166_6 = arg_167_0))

def var_0_0.teleportSubView(arg_168_0, arg_168_1, arg_168_2, arg_168_3, arg_168_4, arg_168_5, arg_168_6):
...
def var_0_0.CellToScreen(arg_170_0, arg_170_1, arg_170_2):
...
def var_0_0.AddCellEdge(arg_171_0, arg_171_1, arg_171_2, ...):
	local var_171_0 = 0
	local var_171_1 = 1
...
def var_0_0.AddOutlines(arg_173_0, arg_173_1, arg_173_2, arg_173_3, arg_173_4, arg_173_5):
	local var_173_0 = {}
	local var_173_1 = {}

	for iter_173_0, iter_173_1 in ipairs(arg_173_1):
		for iter_173_2 = 1, 4:
			...
			if not underscore.any(arg_173_1, function(arg_175_0)
				return arg_175_0.row == iter_173_1.row + var_0_5[iter_173_2][1] and arg_175_0.column == iter_173_1.column + var_0_5[iter_173_2][2]) and underscore.any(arg_173_1, function(arg_176_0)
				return arg_176_0.row == iter_173_1.row and arg_176_0.column == iter_173_1.column + var_0_5[iter_173_2][2]) and underscore.any(arg_173_1, function(arg_177_0)
...
def var_0_0.ShowHuntingRange(arg_180_0):
...
def var_0_0.RefreshHuntingRange(arg_182_0, arg_182_1, arg_182_2):
	...
	_.each(arg_182_1, function(arg_183_0)
		arg_182_0.AddCellEdge(arg_182_1, arg_183_0, not arg_182_2, None, None, "SubmarineHunting"))

def var_0_0.ShowStaticHuntingRange(arg_184_0):
	...
	if not arg_184_0.isHuntingRangeVisible():
...
def var_0_0.ShowTargetHuntingRange(arg_186_0, arg_186_1):
	...
	for iter_186_0, iter_186_1 in pairs(var_186_5):
		if not table.containsData(var_186_3, iter_186_1):
...
def var_0_0.OnChangeSubAutoAttack(arg_189_0):
...
def var_0_0.displayEscapeGrid(arg_191_0):
	local var_191_0 = arg_191_0.contextData.chapterVO

	if not var_191_0.existOni():
		return
	...
	arg_191_0.showQuadMark(_.map(var_191_1.escape_grids, function(arg_192_0)
		return {
			row = arg_192_0[1],
			column = arg_192_0[2]
		}), ChapterConst.MarkEscapeGrid, "cell_escape_grid", Vector2(105, 105))

def var_0_0.showQuadMark(arg_193_0, arg_193_1, arg_193_2, arg_193_3, arg_193_4, arg_193_5, arg_193_6):
	arg_193_0.ShowAnyQuadMark(arg_193_1, arg_193_2, arg_193_3, arg_193_4, arg_193_5, False, arg_193_6)

def var_0_0.ShowTopQuadMark(arg_194_0, arg_194_1, arg_194_2, arg_194_3, arg_194_4, arg_194_5, arg_194_6):
	arg_194_0.ShowAnyQuadMark(arg_194_1, arg_194_2, arg_194_3, arg_194_4, arg_194_5, True, arg_194_6)

def var_0_0.ShowAnyQuadMark(arg_195_0, arg_195_1, arg_195_2, arg_195_3, arg_195_4, arg_195_5, arg_195_6, arg_195_7):
	local var_195_0 = arg_195_0.contextData.chapterVO

	for iter_195_0, iter_195_1 in pairs(arg_195_1):
		local var_195_1 = var_195_0.getChapterCell(iter_195_1.row, iter_195_1.column)

		if var_195_1 and var_195_1.IsWalkable():
...
def var_0_0.hideQuadMark(arg_197_0, arg_197_1):
	if arg_197_1 and not arg_197_0.markQuads[arg_197_1]:
		return

	for iter_197_0, iter_197_1 in pairs(arg_197_0.markQuads):
		if not arg_197_1 or iter_197_0 == arg_197_1:
			for iter_197_2, iter_197_3 in pairs(iter_197_1):
				arg_197_0.cancelMarkTween(iter_197_2, iter_197_3)

				iter_197_1[iter_197_2].GetComponent(typeof(Image)).material = None
				iter_197_1[iter_197_2] = None

				PoolMgr.GetInstance().ReturnPrefab("chapter/cell_quad_mark", "", iter_197_3.gameObject)

			table.clear(arg_197_0.markQuads[iter_197_0])

def var_0_0.CreateEdgeIndex(arg_198_0, arg_198_1, arg_198_2, arg_198_3):
	return ChapterCell.Line2Name(arg_198_0, arg_198_1) .. (arg_198_3 and "_" .. arg_198_3 or "") .. "_" .. arg_198_2

def var_0_0.CreateEdge(arg_199_0, arg_199_1, arg_199_2, arg_199_3, arg_199_4, arg_199_5, arg_199_6):
	if arg_199_1 <= 0 or arg_199_1 >= 16:
		return
	...
	while var_199_5 < 4:
		...
		if bit.band(arg_199_1, var_199_4) > 0:
...
def var_0_0.ClearEdge(arg_200_0, arg_200_1):
	for iter_200_0, iter_200_1 in pairs(arg_200_0.cellEdges):
		for iter_200_2 = 1, 4:
			local var_200_0 = arg_200_0.CreateEdgeIndex(arg_200_1.row, arg_200_1.column, iter_200_2, iter_200_0)

			if iter_200_1[var_200_0]:
				...
				iter_200_1[var_200_0] = None

def var_0_0.ClearEdges(arg_201_0, arg_201_1):
	if not next(arg_201_0.cellEdges):
		return

	for iter_201_0, iter_201_1 in pairs(arg_201_0.cellEdges):
		if not arg_201_1 or arg_201_1 == iter_201_0:
			local var_201_0 = arg_201_0.GetEdgePool(iter_201_0)

			for iter_201_2, iter_201_3 in pairs(iter_201_1):
				arg_201_0.cancelMarkTween(iter_201_2, iter_201_3)
				var_201_0.Enqueue(go(iter_201_3), False)

			arg_201_0.cellEdges[iter_201_0] = None

def var_0_0.CreateOutlines(arg_202_0, arg_202_1, arg_202_2, arg_202_3, arg_202_4, arg_202_5):
	local var_202_0 = arg_202_0.contextData.chapterVO
	local var_202_1 = var_202_0.theme.cellSize + var_202_0.theme.cellSpace

	for iter_202_0, iter_202_1 in pairs(arg_202_1):
...
def var_0_0.CreateOutlineCorners(arg_203_0, arg_203_1, arg_203_2, arg_203_3, arg_203_4, arg_203_5):
	local var_203_0 = arg_203_0.contextData.chapterVO

	for iter_203_0, iter_203_1 in pairs(arg_203_1):
...
def var_0_0.updateCoastalGunAttachArea(arg_204_0):
	local var_204_0 = arg_204_0.contextData.chapterVO.getCoastalGunArea()

	arg_204_0.hideQuadMark(ChapterConst.MarkCoastalGun)
	arg_204_0.showQuadMark(var_204_0, ChapterConst.MarkCoastalGun, "cell_coastal_gun", Vector2(110, 110), None, False)

def var_0_0.InitIdolsAnim(arg_205_0):
	...
	for iter_205_0, iter_205_1 in ipairs(var_205_2):
...
def var_0_0.ClearIdolsAnim(arg_206_0):
	if arg_206_0.idols:
		for iter_206_0, iter_206_1 in ipairs(arg_206_0.idols):
			iter_206_1.Clear()

		table.clear(arg_206_0.idols)

		arg_206_0.idols = None

def var_0_0.GetEnemyCellView(arg_207_0, arg_207_1):
...
def var_0_0.TransformLine2PlanePos(arg_209_0, arg_209_1):
...
def var_0_0.isfrozen(arg_213_0):
	return arg_213_0.parent.frozenCount > 0

def var_0_0.clear(arg_214_0):
	arg_214_0.clearAll()

	if (arg_214_0.forzenCount or 0) > 0:
