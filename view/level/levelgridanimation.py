...
def var_0_0.PlaySubAnimation(arg_1_0, arg_1_1, arg_1_2, arg_1_3):
	if not arg_1_1:
		arg_1_3()
	...
	arg_1_0.frozen()
	var_1_0.TweenShining(var_1_2, None, var_1_3, var_1_4, Color.New(1, 1, 1, 0), Color.New(1, 1, 1, 1), False, False, function(arg_2_0)
		if not IsNil(arg_1_1.tfAmmo):
			arg_1_1.tfAmmo.anchoredPosition = Vector2.Lerp(var_0_2, var_0_1, arg_2_0), function()
		if arg_1_0.exited:
			return
...
def var_0_0.TeleportCellByPortalWithCameraMove(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4):
	local var_4_0
	...
	local function var_4_2(arg_6_0)
		arg_4_0.TeleportFleetByPortal(arg_4_2, arg_4_3, function()
			arg_4_0.focusOnCell(arg_4_1.line, var_4_0), arg_6_0)
...
def var_0_0.TeleportFleetByPortal(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4):
	local var_8_0 = arg_8_0.contextData.chapterVO
	local var_8_1 = arg_8_2[1]
	local var_8_2 = arg_8_2[2]

	if not var_8_1 or not var_8_2:
		arg_8_4()
	...
	var_8_3.TweenShining(var_8_4, None, 1, 0, Color.New(1, 1, 1, 0), Color.New(1, 1, 1, 1), False, False, None, function()
		if arg_8_0.exited:
			return
		...
		var_8_3.TweenShining(var_8_4, None, 0, 1, Color.New(1, 1, 1, 0), Color.New(1, 1, 1, 1), False, False, None, function()
			if arg_8_0.exited:
				return
...
def var_0_0.adjustCameraFocus(arg_11_0, arg_11_1):
...
def var_0_0.focusOnCell(arg_12_0, arg_12_1, arg_12_2):
...
def var_0_0.cameraFocus(arg_13_0, arg_13_1, arg_13_2):
...
def var_0_0.PlayChampionSubmarineAnimation(arg_15_0, arg_15_1, arg_15_2, arg_15_3):
	local var_15_0 = arg_15_0.contextData.chapterVO.getChampionIndex(arg_15_1.row, arg_15_1.column)

	if not var_15_0 or var_15_0 <= 0:
		if arg_15_3:
			arg_15_3()
...
def var_0_0.shakeCell(arg_16_0, arg_16_1, arg_16_2):
...
def var_0_0.PlayShellFx(arg_18_0, arg_18_1, arg_18_2):
	...
	seriesAsync({
		function(arg_19_0)
			arg_18_0.loader.GetPrefab("effect/ATdun_full_SLG", "ATdun_full_SLG", function(arg_20_0)
				...
				arg_19_0()),
		function(arg_21_0)
			Timer.New(arg_21_0, 1, None, True).Start(),
		function(arg_22_0)
			if arg_18_0.exited:
				return
...
def var_0_0.PlayMissileExplodAnim(arg_23_0, arg_23_1, arg_23_2):
...
def var_0_0.PlaySonarDetectAnim(arg_32_0, arg_32_1, arg_32_2):
	existCall(arg_32_2)

def var_0_0.PlayAttachmentEffect(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4, arg_33_5):
...
def var_0_0.PlayParticleSystem(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4):
