...
def var_0_0.set(arg_10_0, arg_10_1, arg_10_2):
	...
	GetSpriteFromAtlasAsync("ui/levelstageinfoview_atlas", var_10_3 and "title_print_defense" or "title_print", function(arg_11_0)
		if not IsNil(arg_10_0.titleBGDecoration):
	...
	if not arg_10_1.existAchieve():
		...
		table.insert(arg_10_0.delayTween, LeanTween.value(go(arg_10_0.progress), 0, arg_10_0.chapter.progress, 0.5).setDelay(0.15).setOnUpdate(System.Action_float(function(arg_13_0)
			...
			setText(arg_10_0.txProgress, math.floor(arg_13_0) .. "%"))).uniqueId)
		...
		arg_10_0.achieveList.each(function(arg_14_0, arg_14_1)
			...
			table.insert(arg_10_0.delayTween, LeanTween.delayedCall(0.15 + (arg_14_0 + 1) * 0.15, System.Action(function()
				if not IsNil(arg_14_1):
					...
					setActive(findTF(arg_14_1, "star_empty"), not var_14_1))).uniqueId))

	setText(arg_10_0.txIntro, var_10_1.profiles)
	setText(arg_10_0.txCost, var_10_1.oil)

	if var_10_1.icon and var_10_1.icon[1]:
	...
	if var_10_8:
		...
		onButton(arg_10_0, arg_10_0.loopToggle, function()
			...
			arg_10_0.LTid = LeanTween.value(var_17_1, var_17_2, 0.3).setOnUpdate(System.Action_float(function(arg_18_0)
				arg_10_0.layoutView.preferredWidth = arg_18_0)).setOnComplete(System.Action(function()
				arg_10_0.LTid = None)).uniqueId, SFX_PANEL)
	...
	onButton(arg_10_0, arg_10_0.passState, function()
		...
		if var_10_0.getMapType() == Map.ELITE:
	...
	onButton(arg_10_0, arg_10_0.head, function()
		triggerButton(arg_10_0.passState), SFX_PANEL)
...
def var_0_0.cancelTween(arg_29_0):
	_.each(arg_29_0.delayTween, function(arg_30_0)
		LeanTween.cancel(arg_30_0))

	arg_29_0.delayTween = {}

def var_0_0.updateAchieve(arg_31_0, arg_31_1, arg_31_2, arg_31_3):
	if arg_31_1 == UIItemList.EventUpdate:
...
def var_0_0.updateDrop(arg_32_0, arg_32_1, arg_32_2, arg_32_3):
	if arg_32_1 == UIItemList.EventUpdate:
...
def var_0_0.getChapterAwards(arg_35_0):
	...
	if var_35_0.getPlayType() == ChapterConst.TypeMultiStageBoss:
	...
	local function var_35_7(arg_36_0)
		for iter_36_0, iter_36_1 in ipairs(var_35_5):
			if iter_36_1 == arg_36_0:
				return False

		return True

	for iter_35_1, iter_35_2 in ipairs(var_35_4):
		local var_35_8 = checkExist(pg.expedition_activity_template[iter_35_2], {
			"pt_drop_display"
		})

		if var_35_8 and type(var_35_8) == "table":
			for iter_35_3, iter_35_4 in ipairs(var_35_8):
				if var_35_7(iter_35_4[2]):
	...
	for iter_35_5 = #var_35_5, 1, -1:
		for iter_35_6, iter_35_7 in pairs(var_35_6[var_35_5[iter_35_5]]):
			local var_35_10 = var_35_9.getActivityById(iter_35_6)

			if var_35_10 and not var_35_10.isEnd():
...
def var_0_0.initTestShowDrop(arg_37_0, arg_37_1, arg_37_2):
	if IsUnityEditor:
...
def var_0_0.clearTestShowDrop(arg_40_0):
	if IsUnityEditor:
		local var_40_0 = pg.MsgboxMgr.GetInstance()._go.transform.Find("button_test_show_drop")

		if not IsNil(var_40_0):
			Destroy(var_40_0)

def var_0_0.ShowChapterRewardPanel(arg_41_0):
	if arg_41_0.rewardPanel == None:
...
def var_0_0.ClearChapterRewardPanel(arg_42_0):
	if arg_42_0.rewardPanel != None:
		arg_42_0.rewardPanel.Destroy()

		arg_42_0.rewardPanel = None
