...
def var_0_0.UpdateViewAnimated(arg_4_0, arg_4_1):
	if not arg_4_1:
		return
...
def var_0_0.SetTextAnim(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4):
	if tonumber(arg_5_2.text) == arg_5_3:
		return
	...
	arg_5_0.anims[arg_5_4] = LeanTween.value(go(arg_5_1), 0, 1, 0.3).setLoopPingPong(1).setOnUpdate(System.Action_float(function(arg_6_0)
		...
		if arg_6_0 >= 1 and not var_5_0:
			arg_5_2.text = arg_5_3
			var_5_0 = True)).id

def var_0_0.OnDestroy(arg_7_0):
	for iter_7_0, iter_7_1 in pairs(arg_7_0.anims):
