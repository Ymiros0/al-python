...
def var_0_0.OnInit(arg_2_0):
	...
	for iter_2_0, iter_2_1 in pairs(var_0_1):
		for iter_2_2, iter_2_3 in ipairs(iter_2_1):
			arg_2_0.buff2Character[iter_2_3] = iter_2_0

	arg_2_0.buff2Enemy = {}

	for iter_2_4, iter_2_5 in pairs(var_0_2):
		for iter_2_6, iter_2_7 in ipairs(iter_2_5):
...
def var_0_0.GetIcon(arg_3_0, arg_3_1, arg_3_2):
...
def var_0_0.GetBarTFGroup(arg_4_0, arg_4_1):
	return {
		main = arg_4_1,
...
def var_0_0.UpdateView(arg_5_0, arg_5_1, arg_5_2):
	if table.contains(var_0_3, arg_5_1.id):
		arg_5_0.Hide()
		existCall(arg_5_2)
...
def var_0_0.UpdateKaijuBar(arg_7_0, arg_7_1):
	...
	if var_7_0 and var_7_1 <= var_7_2:
		arg_7_0.animations.Insert(function(arg_8_0)
			...
			LeanTween.value(go(var_7_4), 0, 1, var_8_2).setOnUpdate(System.Action_float(function(arg_9_0)
				...
				setText(var_7_6, string.format("%02d%%", math.floor(var_9_0 * 100))))).setOnComplete(System.Action(arg_8_0)))
...
def var_0_0.UpdateSyberSquadBar(arg_12_0, arg_12_1):
	...
	if var_12_0 and var_12_1 <= var_12_2:
		arg_12_0.animations.Insert(function(arg_13_0)
			...
			LeanTween.value(go(var_12_4), 0, 1, 1).setOnUpdate(System.Action_float(function(arg_14_0)
				...
				setText(var_12_6, string.format("%02d%%", math.floor(var_14_0 * 100))))).setOnComplete(System.Action(arg_13_0)))
...
def var_0_0.ShowPanel(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4):
	...
	local function var_17_5()
		...
		var_17_3.SetEndEvent(None)

		var_17_2.enabled = False
		var_17_2.sprite = None
...
def var_0_0.CloseActions(arg_20_0):
	if arg_20_0.animations and not arg_20_0.animations.stopped:
		arg_20_0.animations.Stop()

	arg_20_0.animations = None

	if arg_20_0.PanelAnimations and not arg_20_0.PanelAnimations.stopped:
		arg_20_0.PanelAnimations.Stop()

	arg_20_0.PanelAnimations = None

	if arg_20_0.cleanActions:
		_.each(arg_20_0.cleanActions, function(arg_21_0)
			arg_21_0())

	arg_20_0.cleanActions = None

	arg_20_0.loader.ClearRequests()

def var_0_0.OnHide(arg_22_0):
