...
def var_0_0.GetAtlasPath(arg_3_0):
...
def var_0_0.InitTransformMapBtn(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	onButton(arg_5_0.sceneParent, arg_5_1, function()
		if arg_5_0.sceneParent.isfrozen():
			return

		seriesAsync({
			function(arg_7_0)
				if not arg_5_0.TrySwitchNextMap(arg_5_2):
					return
...
def var_0_0.PostUpdateMap(arg_10_0, arg_10_1):
...
def var_0_0.UpdateMapItem(arg_13_0, arg_13_1, arg_13_2):
	...
	if arg_13_2.existAchieve():
		for iter_13_0, iter_13_1 in ipairs(arg_13_2.achieves):
	...
	if arg_13_2.getConfig("chapter_tag") == 1:
		var_13_18 = var_13_17
	...
	if var_13_24:
		...
		LeanTween.value(go(var_13_25), 0, 1, 0.2).setOnUpdate(System.Action_float(function(arg_14_0)
			...
			var_13_25.anchoredPosition = var_14_0)).setOnComplete(System.Action(function()
			var_13_26.alpha = 1

			local var_15_0 = var_13_25.anchoredPosition

			var_15_0.y = var_13_28
			var_13_25.anchoredPosition = var_15_0)).setEase(LeanTweenType.easeOutSine).setDelay(0.7)

	local var_13_29 = arg_13_2.id

	onButton(arg_13_0.sceneParent, var_13_1, function()
		if arg_13_0.InvokeParent("isfrozen"):
			return

		if arg_13_0.chaptersInBackAnimating[var_13_29]:
			return

		local var_16_0 = getProxy(ChapterProxy).getChapterById(var_13_29)

		if not var_16_0.isUnlock():
		...
		if not getProxy(ChapterProxy).getMapById(var_16_0.getConfig("map")).isRemaster() and not var_16_0.inActTime():
		...
		if var_16_2 > arg_13_0.sceneParent.player.level:
		...
		if var_16_3 and var_16_3.id != var_13_29:
		...
		if var_16_0.active:
			...
			arg_13_0.InvokeParent("displayChapterPanel", var_16_0, Vector3(var_16_4.x - 10, var_16_4.y + 150)), SFX_UI_WEIGHANCHOR_SELECT)
