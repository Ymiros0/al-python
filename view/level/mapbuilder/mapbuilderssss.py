...
def var_0_0.OnInit(arg_4_0):
	...
	onButton(arg_4_0, arg_4_0.challengeBtn, function()
		...
		arg_4_0.emit(LevelUIConst.SWITCH_CHALLENGE_MAP), SFX_PANEL)
...
def var_0_0.ShowButtons(arg_7_0):
...
def var_0_0.HideButtons(arg_8_0):
...
def var_0_0.UpdateButtons(arg_9_0):
