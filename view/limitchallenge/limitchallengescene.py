...
def var_0_0.willExit(arg_5_0):
	if arg_5_0.leftTimer:
		arg_5_0.leftTimer.Stop()

		arg_5_0.leftTimer = None
...
def var_0_0.findUI(arg_7_0):
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.levelList):
...
def var_0_0.addListener(arg_8_0):
	onButton(arg_8_0, arg_8_0.homeBtn, function()
		arg_8_0.emit(BaseUI.ON_HOME), SFX_PANEL)
	...
	onButton(arg_8_0, arg_8_0.shareBtn, function()
		pg.ShareMgr.GetInstance().Share(pg.ShareMgr.TypeChallenge), SFX_PANEL)

	for iter_8_0, iter_8_1 in ipairs(arg_8_0.levelToggleList):
		onToggle(arg_8_0, iter_8_1, function()
			...
			arg_8_0.updateDebug(), SFX_CONFIRM, SFX_CANCEL)
	...
	arg_8_0.iconUIItemList.make(function(arg_15_0, arg_15_1, arg_15_2)
		if arg_15_0 == UIItemList.EventUpdate:
			...
			if arg_8_0.descList[arg_15_1] != False:
...
def var_0_0.updateDebug(arg_17_0):
	...
	for iter_17_0, iter_17_1 in ipairs(arg_17_0.levelList):
	...
	for iter_17_2, iter_17_3 in ipairs(arg_17_0.levelList):
...
def var_0_0.updateToggleList(arg_18_0):
	local var_18_0 = arg_18_0.getHigestUnlockLevel()

	for iter_18_0, iter_18_1 in ipairs(arg_18_0.levelToggleLockList):
...
def var_0_0.updateLeftTime(arg_19_0):
	if arg_19_0.leftTimer:
		arg_19_0.leftTimer.Stop()

		arg_19_0.leftTimer = None
	...
	if var_19_1 > 0:
		...
		local function var_19_2()
			if var_19_1 <= 0 and arg_19_0.leftTimer:
				arg_19_0.leftTimer.Stop()
...
def var_0_0.updateBossImg(arg_21_0):
	...
	for iter_21_0, iter_21_1 in ipairs(arg_21_0.levelList):
...
def var_0_0.updateDescPanel(arg_22_0):
	arg_22_0.descList = {}
...
def var_0_0.updateAward(arg_24_0):
	...
	if var_24_1 and #var_24_1 > 0:
		...
		onButton(arg_24_0, arg_24_0.awardIconTF, function()
			arg_24_0.emit(BaseUI.ON_DROP, var_24_3), SFX_PANEL)
		setActive(arg_24_0.awardIconTF, True)
	else
		setActive(arg_24_0.awardIconTF, False)

def var_0_0.trigeHigestUnlockLevel(arg_26_0):
	local var_26_0 = arg_26_0.getHigestUnlockLevel()

	triggerToggle(arg_26_0.levelToggleList[var_26_0], True)

def var_0_0.onReqInfo(arg_27_0):
	arg_27_0.initData()
	arg_27_0.updateLeftTime()
	arg_27_0.updateToggleList()
	arg_27_0.trigeHigestUnlockLevel()

def var_0_0.getHigestUnlockLevel(arg_28_0):
	for iter_28_0 = #arg_28_0.levelList, 1, -1:
		local var_28_0 = arg_28_0.levelList[iter_28_0]

		if arg_28_0.proxy.isLevelUnlock(var_28_0):
			return var_28_0

def var_0_0.getBuffIconPath(arg_29_0, arg_29_1, arg_29_2):
