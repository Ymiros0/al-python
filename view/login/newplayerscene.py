...
def var_0_0.onBackPressed(arg_3_0):
	if LeanTween.isTweening(go(arg_3_0.propPanel)):
		return

	pg.CriMgr.GetInstance().PlaySoundEffect_V3(SFX_CANCEL)

	if isActive(arg_3_0.namedPanel):
...
def var_0_0.switchPanel(arg_4_0):
	...
	LeanTween.value(go(arg_4_0.propPanel), 0, 1, 0.5).setOnUpdate(System.Action_float(function(arg_5_0)
		...
		var_4_1.alpha = 1 - arg_5_0)).setOnComplete(System.Action(function()
...
def var_0_0.initCharacters(arg_7_0):
	arg_7_0.charInitPos = {}
...
def var_0_0.didEnter(arg_10_0):
	onButton(arg_10_0, arg_10_0.confirmBtn, function()
		arg_10_0.showNamedPanel(), SFX_PANEL)
	onButton(arg_10_0, findTF(arg_10_0.info, "random_button"), function()
		...
		setInputText(arg_10_0.nickname, var_12_1 .. var_12_2 .. var_12_3 .. var_12_4), SFX_MAIN)
	onButton(arg_10_0, findTF(arg_10_0.info, "btn_container/enter_button"), function()
		if not arg_10_0.contextData.configId:
		...
		arg_10_0.event.emit(NewPlayerMediator.ON_CREATE, var_13_0, arg_10_0.contextData.configId), SFX_CONFIRM)
...
def var_0_0.selectCharacterByIdx(arg_15_0, arg_15_1, arg_15_2):
	...
	if var_15_1 == arg_15_0.shipPrefab:
		return
...
def var_0_0.initSkills(arg_17_0):
	...
	for iter_17_0, iter_17_1 in ipairs(var_17_0.buff_list_display):
		...
		onButton(arg_17_0, var_17_3, function()
			arg_17_0.emit(NewPlayerMediator.ON_SKILLINFO, var_17_1.id), SFX_PANEL)
		LoadImageSpriteAsync("skillicon/" .. var_17_1.icon, findTF(var_17_3, "icon"))

def var_0_0.showNamedPanel(arg_19_0):
...
def var_0_0.closeNamedPanel(arg_20_0):
...
def var_0_0.recycleSpineChar(arg_21_0):
	if arg_21_0.shipPrefab and arg_21_0.shipModel:
		PoolMgr.GetInstance().ReturnSpineChar(arg_21_0.shipPrefab, arg_21_0.shipModel)

		arg_21_0.shipPrefab = None
		arg_21_0.shipModel = None

def var_0_0.willExit(arg_22_0):
	if arg_22_0.eventTriggers:
		for iter_22_0, iter_22_1 in pairs(arg_22_0.eventTriggers):
			ClearEventTrigger(iter_22_0)

		arg_22_0.eventTriggers = None
