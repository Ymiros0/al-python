...
def var_0_0.initUIItemList(arg_6_0):
...
def var_0_0.updateUIItemList(arg_9_0):
...
def var_0_0.confirm(arg_11_0, arg_11_1):
	if not arg_11_1:
		return

	arg_11_1 = Clone(arg_11_1)

	if arg_11_1.isChargeType():
		...
		if arg_11_1.isMonthCard() or arg_11_1.isGiftBox() or arg_11_1.isItemBox() or arg_11_1.isPassItem():
			local var_11_2 = underscore.map(arg_11_1.getConfig("extra_service_item"), function(arg_12_0)
				return Drop.Create(arg_12_0))
			local var_11_3

			if arg_11_1.isPassItem():
		...
		if type(var_11_18) == "table":
			for iter_11_0, iter_11_1 in ipairs(var_11_18):
...
def var_0_0.updateDiamondGoodsVOList(arg_18_0):
	arg_18_0.diamondGoodsVOList = {}

	local var_18_0 = pg.pay_data_display

	for iter_18_0, iter_18_1 in pairs(var_18_0.all):
		local var_18_1 = var_18_0[iter_18_1].extra_service

		if arg_18_0.isNeedHideMonthCard and iter_18_1 == var_0_0.MonthCardID:
			-- block empty
		elif pg.SdkMgr.GetInstance().IgnorePlatform(var_18_0[iter_18_1].ignorePlatform):
			-- block empty
		elif var_18_1 == Goods.MONTH_CARD or var_18_1 == Goods.GEM or var_18_1 == Goods.GIFT_BOX:
...
def var_0_0.sortDiamondGoodsVOList(arg_19_0):
	arg_19_0.diamondGoodsVOListForShow = {}

	for iter_19_0, iter_19_1 in ipairs(arg_19_0.diamondGoodsVOList):
		local var_19_0 = ChargeConst.getBuyCount(arg_19_0.chargedList, iter_19_1.id)

		iter_19_1.updateBuyCount(var_19_0)

		if iter_19_1.canPurchase() and iter_19_1.inTime():
	...
	table.sort(arg_19_0.diamondGoodsVOListForShow, function(arg_20_0, arg_20_1)
		...
		if arg_20_0.isFree():
			return True
		elif arg_20_1.isFree():
			return False

		if arg_20_0.isChargeType() and arg_20_0.isMonthCard():
		...
		if arg_20_1.isChargeType() and arg_20_1.isMonthCard():
...
def var_0_0.setGoodData(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4):
