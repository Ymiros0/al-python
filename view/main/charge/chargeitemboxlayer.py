...
def var_0_0.updatePanel(arg_12_0):
	local var_12_0 = arg_12_0.panelConfig.icon
	local var_12_1 = arg_12_0.panelConfig.name and arg_12_0.panelConfig.name or ""

	if not arg_12_0.panelConfig.tipBonus:
		local var_12_2 = ""

	local var_12_3 = arg_12_0.panelConfig.bonusItem

	if not arg_12_0.panelConfig.tipExtra or not arg_12_0.panelConfig.tipExtra:
		local var_12_4 = ""

	if not arg_12_0.panelConfig.extraItems or not arg_12_0.panelConfig.extraItems:
		local var_12_5 = {}
	...
	if arg_12_0.detailNormalTip:
		setActive(arg_12_0.detailNormalTip, var_12_11)

	if var_12_11:
		if arg_12_0.detailNormalTip.GetComponent("Text"):
	...
	if var_12_10 > 0:
		for iter_12_0, iter_12_1 in ipairs(arg_12_0.detailTags):
