...
def var_0_0.OnDestroy(arg_3_0):
	for iter_3_0, iter_3_1 in ipairs(arg_3_0.cardList):
		iter_3_1.Dispose()
...
def var_0_0.initScrollRect(arg_6_0):
	arg_6_0.cardTable = {}
	arg_6_0.cardList = {}
	...
	local function var_6_0(arg_7_0)
		...
		onButton(arg_6_0, var_7_0.tr, function()
			if var_7_0.goodsVO.isLevelLimit(arg_6_0.player.level):
			...
			if var_8_0 == "ship_bag_size":
				if arg_6_0.player.getMaxShipBagExcludeGuild() >= Player.MAX_SHIP_BAG:
				...
				var_8_2 = var_8_1.id
			elif var_8_0 == "equip_bag_size":
				if arg_6_0.player.getMaxEquipmentBagExcludeGuild() >= Player.MAX_EQUIP_BAG:
				...
				var_8_2 = var_8_1.id
			elif var_8_0 == "commander_bag_size":
				if arg_6_0.player.commanderBagMax >= Player.MAX_COMMANDER_BAG:
				...
				var_8_2 = var_8_1.id
			elif var_8_0 == "spweapon_bag_size":
				if getProxy(EquipmentProxy).GetSpWeaponCapacity() >= EquipmentProxy.MAX_SPWEAPON_BAG:
					pg.TipsMgr.GetInstance().ShowTips(i18n("charge_equip_bag_max"))
				...
				if var_7_0.goodsVO.getConfig("type") == DROP_TYPE_RESOURCE:
...
def var_0_0.updateItemGoodsVOList(arg_13_0):
	...
	for iter_13_0, iter_13_1 in pairs(var_13_0.all):
		...
		if var_13_1.genre == "gem_shop":
			...
			if var_13_6 == "ship_bag_size" and var_13_3 and var_13_4:
				local var_13_7 = arg_13_0.player.getMaxShipBagExcludeGuild()

				if var_13_3 <= var_13_7 and var_13_7 <= var_13_4:
					var_13_5 = True
			elif var_13_6 == "equip_bag_max" and var_13_3 and var_13_4:
				local var_13_8 = arg_13_0.player.getMaxEquipmentBag()

				if var_13_3 <= var_13_8 and var_13_8 <= var_13_4:
					var_13_5 = True
			elif var_13_6 == "commander_bag_size" and var_13_3 and var_13_4:
				local var_13_9 = arg_13_0.player.commanderBagMax

				if var_13_3 <= var_13_9 and var_13_9 <= var_13_4:
					var_13_5 = True
			else
				var_13_5 = True
	...
	for iter_13_2 = #arg_13_0.itemGoodsVOList, 1, -1:
		...
		if not var_13_11.IsShowWhenGroupSale(var_13_12):
			table.remove(arg_13_0.itemGoodsVOList, iter_13_2)

def var_0_0.sortItemGoodsVOList(arg_14_0):
...
def var_0_0.updateGoodsData(arg_16_0):
...
def var_0_0.setGoodData(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4):
...
def var_0_0.reUpdateAll(arg_19_0):
	arg_19_0.updateData()
