...
def var_0_0.handleNotification(arg_15_0, arg_15_1):
	...
	if var_15_0 == PlayerProxy.UPDATED:
	...
	elif var_15_0 == ShopsProxy.FIRST_CHARGE_IDS_UPDATED:
		arg_15_0.viewComponent.setFirstChargeIds(var_15_1)
		arg_15_0.viewComponent.updateCurSubView()
	elif var_15_0 == ShopsProxy.CHARGED_LIST_UPDATED:
		arg_15_0.viewComponent.setChargedList(var_15_1)
		arg_15_0.viewComponent.updateCurSubView()
	elif var_15_0 == GAME.CHARGE_CONFIRM_FAILED:
		getProxy(ShopsProxy).chargeFailed(var_15_1.payId, var_15_1.bsId)
	elif var_15_0 == GAME.SHOPPING_DONE:
		if var_15_1.awards and #var_15_1.awards > 0:
	...
	elif var_15_0 == GAME.USE_ITEM_DONE:
		if table.getCount(var_15_1) != 0:
			arg_15_0.viewComponent.emit(BaseUI.ON_AWARD, {
				items = var_15_1
			})
	elif var_15_0 == GAME.GET_CHARGE_LIST_DONE:
		...
		if var_15_5 or var_15_6 or var_15_7 or var_15_8:
			arg_15_0.viewComponent.updateCurSubView()

		arg_15_0.viewComponent.checkFreeGiftTag()
	elif var_15_0 == GAME.CLICK_MING_SHI_SUCCESS:
		arg_15_0.viewComponent.playHeartEffect()
	elif var_15_0 == PlayerResUI.GO_MALL:
		...
		arg_15_0.viewComponent.updateNoRes(var_15_1 and var_15_1.noRes or None)
	elif var_15_0 == GAME.CHARGE_SUCCESS:
