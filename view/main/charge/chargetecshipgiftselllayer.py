...
def var_0_0.initData(arg_5_0):
	...
	arg_5_0.normalGoodVO = None
	arg_5_0.highGoodVO = None
	arg_5_0.upGoodVO = None

	for iter_5_0, iter_5_1 in ipairs(arg_5_0.goodVOList):
		if iter_5_1.getConfig("limit_arg") == Goods.Tec_Ship_Gift_Arg.Normal:
			arg_5_0.normalGoodVO = iter_5_1
		elif iter_5_1.getConfig("limit_arg") == Goods.Tec_Ship_Gift_Arg.High:
			arg_5_0.highGoodVO = iter_5_1
		elif iter_5_1.getConfig("limit_arg") == Goods.Tec_Ship_Gift_Arg.Up:
...
def var_0_0.updateGiftTF(arg_11_0, arg_11_1, arg_11_2):
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_2.getConfig("display")):
	...
	var_11_17.make(function(arg_16_0, arg_16_1, arg_16_2)
		if arg_16_0 == UIItemList.EventUpdate:
			...
			onButton(arg_11_0, var_16_0, function()
				arg_11_0.emit(BaseUI.ON_DROP, var_16_2), SFX_PANEL)
			setScrollText(var_16_1, var_16_2.getName()))
	var_11_17.align(#var_11_16)

def var_0_0.updateGiftList(arg_18_0):
