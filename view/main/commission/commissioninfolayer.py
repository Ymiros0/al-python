...
def var_0_0.UpdateUrItemEntrance(arg_5_0):
	if not LOCK_UR_SHIP:
		...
		onButton(arg_5_0, arg_5_0.activtyUrExchangeBtn, function()
			arg_5_0.emit(CommissionInfoMediator.ON_UR_ACTIVITY), SFX_PANEL)
	else
		setActive(arg_5_0.activtyUrExchangeBtn, False)

def var_0_0.updateCrusingEntrance(arg_7_0):
	...
	onButton(arg_7_0, arg_7_0.activityCrusingBtn, function()
		arg_7_0.emit(CommissionInfoMediator.ON_CRUSING), SFX_PANEL)

def var_0_0.NotifyIns(arg_9_0, arg_9_1, arg_9_2):
	...
	if var_9_0:
		onButton(arg_9_0, arg_9_0.activityInsBtn, function()
			arg_9_0.emit(CommissionInfoMediator.ON_INS), SFX_PANEL)

def var_0_0.UpdateLinkPanel(arg_11_0):
	local var_11_0 = False

	for iter_11_0 = 1, arg_11_0.linkBtnPanel.childCount:
		if isActive(arg_11_0.linkBtnPanel.GetChild(iter_11_0 - 1)):
			var_11_0 = True
...
def var_0_0.didEnter(arg_12_0):
	onButton(arg_12_0, arg_12_0.oilbubbleTF, function()
		if arg_12_0.isPaying:
			return

		if not getProxy(PlayerProxy).getRawData().CanGetResource(PlayerConst.ResOil):
		...
		arg_12_0.PlayGetResAnimation(arg_12_0.oilbubbleTF, function()
			arg_12_0.emit(CommissionInfoMediator.GET_OIL_RES)), SFX_PANEL)
	onButton(arg_12_0, arg_12_0.goldbubbleTF, function()
		if arg_12_0.isPaying:
			return

		if not getProxy(PlayerProxy).getRawData().CanGetResource(PlayerConst.ResGold):
			pg.TipsMgr.GetInstance().ShowTips(i18n("player_harvestResource_error_fullBag"))

			return

		arg_12_0.PlayGetResAnimation(arg_12_0.goldbubbleTF, function()
			arg_12_0.emit(CommissionInfoMediator.GET_GOLD_RES)), SFX_PANEL)
	onButton(arg_12_0, arg_12_0.classbubbleTF, function()
		if arg_12_0.isPaying:
			return

		if not getProxy(NavalAcademyProxy).GetClassVO().CanGetRes():
			pg.TipsMgr.GetInstance().ShowTips(i18n("player_harvestResource_error_fullBag"))

			return

		arg_12_0.PlayGetResAnimation(arg_12_0.classbubbleTF, function()
			arg_12_0.emit(CommissionInfoMediator.GET_CLASS_RES)), SFX_PANEL)
	onButton(arg_12_0, arg_12_0._tf, function()
		if arg_12_0.contextData.inFinished:
			return
		...
		arg_12_0.PlayExitAnimation(function()
			...
			arg_12_0.isPaying = False), SOUND_BACK)
	arg_12_0.InitItems()
	arg_12_0.UpdateUrItemEntrance()
	arg_12_0.updateCrusingEntrance()
	arg_12_0.metaBossBtn.Flush()

def var_0_0.PlayGetResAnimation(arg_21_0, arg_21_1, arg_21_2):
...
def var_0_0.InitItems(arg_23_0):
	for iter_23_0, iter_23_1 in ipairs(arg_23_0.items):
		iter_23_1.Init()

def var_0_0.OnUpdateEventInfo(arg_24_0):
	arg_24_0.items[1].Update()

def var_0_0.OnUpdateClass(arg_25_0):
	arg_25_0.items[2].Update()

def var_0_0.OnUpdateTechnology(arg_26_0):
	arg_26_0.items[3].Update()

def var_0_0.setPlayer(arg_27_0, arg_27_1):
	arg_27_0.playerVO = arg_27_1

	arg_27_0.updateResource(arg_27_1)

def var_0_0.updateResource(arg_28_0, arg_28_1):
