...
def var_0_0.UpdateList(arg_7_0):
	var_0_0.super.UpdateList(arg_7_0)
	arg_7_0.UpdateActList()

def var_0_0.UpdateActList(arg_8_0):
...
def var_0_0.GetChapterByCount(arg_9_0, arg_9_1):
	local var_9_0 = pg.chapter_template

	for iter_9_0, iter_9_1 in pairs(var_9_0.all):
		if var_9_0[iter_9_1].collection_team == arg_9_1:
			return var_9_0[iter_9_1]

def var_0_0.UpdateListItem(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
...
def var_0_0.UpdateEventInfo(arg_11_0, arg_11_1, arg_11_2):
	local var_11_0 = arg_11_2 and arg_11_2.state or EventInfo.StateNone

	if var_11_0 == EventInfo.StateNone:
		...
		onButton(arg_11_0, arg_11_1.Find("unlock/leisure/go_btn"), function()
			arg_11_0.OnSkip(), SFX_PANEL)
		onButton(arg_11_0, arg_11_1, function()
			triggerButton(arg_11_1.Find("unlock/leisure/go_btn")), SFX_PANEL)
	elif var_11_0 == EventInfo.StateFinish:
		...
		onButton(arg_11_0, arg_11_1.Find("unlock/finished/finish_btn"), function()
			arg_11_0.emit(CommissionInfoMediator.FINISH_EVENT, arg_11_2), SFX_PANEL)
		onButton(arg_11_0, arg_11_1, function()
			triggerButton(arg_11_1.Find("unlock/finished/finish_btn")), SFX_PANEL)
	elif var_11_0 == EventInfo.StateActive:
		setText(arg_11_1.Find("unlock/name_bg/Text"), arg_11_2.template.title)
...
def var_0_0.AddTimer(arg_16_0, arg_16_1, arg_16_2):
	...
	arg_16_0.timers[arg_16_1.id] = Timer.New(function()
		...
		if var_17_0 <= 0:
			...
			arg_16_0.timers[arg_16_1.id] = None

			arg_16_0.OnFlush()
			arg_16_0.UpdateList()
		else
			arg_16_2.text = pg.TimeMgr.GetInstance().DescCDTime(var_17_0), 1, -1)

	arg_16_0.timers[arg_16_1.id].Start()
	arg_16_0.timers[arg_16_1.id].func()

def var_0_0.RemoveTimer(arg_18_0, arg_18_1):
	if arg_18_0.timers[arg_18_1.id]:
		arg_18_0.timers[arg_18_1.id].Stop()

		arg_18_0.timers[arg_18_1.id] = None

def var_0_0.UpdateStyle(arg_19_0, arg_19_1, arg_19_2, arg_19_3):
...
def var_0_0.OnSkip(arg_21_0):
	arg_21_0.emit(CommissionInfoMediator.ON_ACTIVE_EVENT)

def var_0_0.OnFinishAll(arg_22_0):
	local var_22_0 = {}
	local var_22_1 = 0

	_.each(arg_22_0.list, function(arg_23_0)
		if arg_23_0.state == EventInfo.StateFinish:
	...
	if var_22_2 and not var_22_2.isEnd():
		...
		if var_22_3 and var_22_3.state == EventInfo.StateFinish:
