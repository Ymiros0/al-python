...
def var_0_0.UpdateListItem(arg_6_0, arg_6_1, arg_6_2, arg_6_3):
	...
	if var_6_3 == 0:
		...
		onButton(arg_6_0, arg_6_3.Find("unlock/leisure/go_btn"), function()
			arg_6_0.OnSkip(), SFX_PANEL)
		onButton(arg_6_0, arg_6_3, function()
			arg_6_0.OnSkip(), SFX_PANEL)
	elif var_6_1 < var_6_3 - var_6_2:
	...
	elif var_6_1 < var_6_3:
		arg_6_0.UpdateTechnology(arg_6_3, var_6_0)
		arg_6_0.AddTimer(var_6_0, arg_6_3)
	else
		arg_6_0.UpdateTechnology(arg_6_3, var_6_0)

		if var_6_0.finishCondition():
			...
			onButton(arg_6_0, arg_6_3, function()
				triggerButton(var_6_4), SFX_PANEL)
		else
...
def var_0_0.AddTimer(arg_11_0, arg_11_1, arg_11_2):
	...
	arg_11_0.timers[arg_11_1.id] = Timer.New(function()
		...
		if var_12_0 > 0:
			...
			arg_11_0.OnFlush()
			arg_11_0.UpdateList(), 1, -1)

	arg_11_0.timers[arg_11_1.id].Start()
	arg_11_0.timers[arg_11_1.id].func()

def var_0_0.RemoveTimer(arg_13_0, arg_13_1):
	if arg_13_0.timers[arg_13_1.id]:
		arg_13_0.timers[arg_13_1.id].Stop()

		arg_13_0.timers[arg_13_1.id] = None

def var_0_0.UpdateTechnology(arg_14_0, arg_14_1, arg_14_2):
...
def var_0_0.OnFinishAll(arg_17_0):
	...
	if var_17_0.queue[1] and var_17_0.queue[1].isCompleted():
