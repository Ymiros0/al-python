...
def var_0_0.initNotificationHandleDic(arg_8_0):
	arg_8_0.handleDic = {
	...
	arg_8_0.handleElse = None

def var_0_0.ShowAndCheckDrops(arg_15_0, arg_15_1):
	if not arg_15_1:
		return
	...
	seriesAsync(var_15_0, function()
		...
		if PlayerPrefs.GetInt("help_research_package", 0) == 0:
			for iter_19_0, iter_19_1 in ipairs(arg_15_1):
				if iter_19_1.type == DROP_TYPE_ITEM:
