...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4):
	...
	arg_1_0.width = 0
	arg_1_0.height = 0
	arg_1_0.position = None
	arg_1_0.index = arg_1_2
	arg_1_0.isWhite = False
	arg_1_0.currIndex = None
...
def var_0_0.activeMask(arg_2_0, arg_2_1):
	setActive(arg_2_0.mask, arg_2_1)

def var_0_0.activeDesc(arg_3_0, arg_3_1):
	setActive(arg_3_0.textTF, arg_3_1)

def var_0_0.setDesc(arg_4_0, arg_4_1):
	arg_4_0.textTFText.text = arg_4_1

def var_0_0.setCurrIndex(arg_5_0, arg_5_1):
	arg_5_0.currIndex = arg_5_1

def var_0_0.isBlock(arg_6_0):
	return arg_6_0.isWhite

def var_0_0.isRestoration(arg_7_0):
...
def var_0_0.setHightLight(arg_9_0):
	arg_9_0.img.color = Color.New(1, 1, 1, 1)

def var_0_0.setBlock(arg_10_0):
	arg_10_0.img.color = Color.New(1, 1, 1, 0)

def var_0_0.setSprite(arg_11_0, arg_11_1):
...
def var_0_0.setPosition(arg_12_0, arg_12_1, arg_12_2):
	arg_12_0.position = arg_12_1
	arg_12_0.currIndex = arg_12_2

def var_0_0.getPosition(arg_13_0):
	return arg_13_0.position

def var_0_0.getCurrIndex(arg_14_0):
	return arg_14_0.currIndex

def var_0_0.setLocalPosition(arg_15_0, arg_15_1):
	arg_15_0._tr.localPosition = arg_15_1

def var_0_0.getLocalPosition(arg_16_0):
	return arg_16_0._tr.localPosition

def var_0_0.getSurroundPosition(arg_17_0):
	local var_17_0 = {}
