...
def var_0_0.InitInteractable(arg_4_0):
	_.each(arg_4_0.btngroup, function(arg_5_0)
		onButton(arg_4_0, arg_5_0, function()
			...
			if var_6_1 > 0 and var_6_1 <= #arg_4_0.digitGroup:
				...
				if not arg_4_0.inputMode:
					if arg_4_0.timers["input" .. var_6_1]:
	...
	onButton(arg_4_0, arg_4_0.btndelete, function()
		...
		if var_9_0 > 0 and var_9_0 <= #arg_4_0.digitGroup:
			...
			if arg_4_0.timers["input" .. var_9_0]:
	...
	onButton(arg_4_0, arg_4_0.btnconfirm, function()
		if arg_4_0.mode == var_0_0.InputView:
			...
			if #arg_4_0.inputs != 12:
				var_11_0 = False

			for iter_11_0 = 1, 6:
				if string.byte(arg_4_0.inputs, iter_11_0) != string.byte(arg_4_0.inputs, 6 + iter_11_0):
					var_11_0 = False
...
def var_0_0.didEnter(arg_21_0):
	if arg_21_0.contextData.parent:
...
def var_0_0.UpdateInputSlider(arg_22_0):
	...
	for iter_22_0 = 1, #arg_22_0.digitGroup:
		local var_22_1 = arg_22_0.digitGroup[iter_22_0]
		local var_22_2 = iter_22_0 <= #arg_22_0.inputs and string.char(string.byte(arg_22_0.inputs, iter_22_0)) or None

		setText(var_22_1.Find("text"), var_22_0 and var_22_2 or "")
		setActive(var_22_1.Find("space"), not var_22_0 and var_22_2 == None)
		setActive(var_22_1.Find("filled"), not var_22_0 and var_22_2 != None)

def var_0_0.ClearInputTimers(arg_23_0):
	for iter_23_0 = 1, 12:
		if arg_23_0.timers["input" .. iter_23_0]:
			arg_23_0.timers["input" .. iter_23_0].Stop()

			arg_23_0.timers["input" .. iter_23_0] = None

def var_0_0.ClearAllTimers(arg_24_0):
	for iter_24_0, iter_24_1 in pairs(arg_24_0.timers):
		if iter_24_1:
			iter_24_1.Stop()

	arg_24_0.timers = {}

def var_0_0.ClearInputs(arg_25_0):
	arg_25_0.inputs = ""

	arg_25_0.SetInputPos(0)
	arg_25_0.UpdateInputSlider()

def var_0_0.UpdateView(arg_26_0):
	if arg_26_0.mode == var_0_0.InputView:
...
def var_0_0.UpdateInputView(arg_34_0):
...
def var_0_0.UpdateConfirmButton(arg_35_0):
...
def var_0_0.UpdateSetView(arg_36_0):
	setActive(arg_36_0.tipseterror, not arg_36_0.inputnone)

def var_0_0.SetInputPos(arg_37_0, arg_37_1):
...
def var_0_0.Resume(arg_39_0):
	arg_39_0.didEnter()
	setActive(arg_39_0._tf, True)

def var_0_0.SetInputXian(arg_40_0, arg_40_1):
	if arg_40_0.inputMode and arg_40_1 > 0 and arg_40_1 <= #arg_40_0.digitGroup:
