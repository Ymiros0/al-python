...
def var_0_0.SwitchPreviewSkin(arg_13_0, arg_13_1):
	if arg_13_0.displays and arg_13_0.displays[arg_13_1]:
...
def var_0_0.InitSkinPages(arg_17_0, arg_17_1):
	...
	for iter_17_0, iter_17_1 in ipairs(var_17_0):
		table.insert(var_17_1, function(arg_18_0)
			...
			if (iter_17_0 - 1) % 3 == 0 or iter_17_0 == #var_17_0:
				onNextTick(arg_18_0)
			else
				arg_18_0())
...
def var_0_0.OnSelectSkinPage(arg_20_0, arg_20_1):
	if arg_20_0.selectedSkinPageItem:
...
def var_0_0.OnConfirmSkinPage(arg_21_0, arg_21_1):
...
def var_0_0.ToVShip(arg_24_0, arg_24_1):
	if not arg_24_0.vship:
		arg_24_0.vship = {}
...
def var_0_0.MatchIndex(arg_29_0, arg_29_1):
...
def var_0_0.GetSkinList(arg_30_0, arg_30_1, arg_30_2):
	local var_30_0 = {}
	local var_30_1 = getProxy(ShipSkinProxy).GetOwnSkins()

	for iter_30_0, iter_30_1 in pairs(var_30_1):
		if (arg_30_1 == var_0_0.PAGE_ALL or iter_30_1.IsType(arg_30_1)) and not iter_30_1.IsDefault() and iter_30_1.IsMatchKey(arg_30_2) and arg_30_0.MatchIndex(iter_30_1):
			table.insert(var_30_0, iter_30_1)

	return var_30_0

def var_0_0.UpdateSkinCards(arg_31_0):
...
def var_0_0.SortDisplay(arg_32_0, arg_32_1):
	table.sort(arg_32_1, function(arg_33_0, arg_33_1)
		...
		if var_33_0 == var_33_1:
			return arg_33_0.getConfig("group_index") < arg_33_1.getConfig("group_index")
		else
			return var_33_0 < var_33_1)

def var_0_0.OnInitItem(arg_34_0, arg_34_1):
	local var_34_0 = SkinAtlasCard.New(arg_34_1)

	onButton(arg_34_0, var_34_0._tf, function()
		arg_34_0.previewPage.ExecuteAction("Show", var_34_0.skin, var_34_0.index), SFX_PANEL)

	arg_34_0.cards[arg_34_1] = var_34_0

def var_0_0.OnUpdateItem(arg_36_0, arg_36_1, arg_36_2):
	if not arg_36_0.cards[arg_36_2]:
...
def var_0_0.onBackPressed(arg_37_0):
	if arg_37_0.previewPage and arg_37_0.previewPage.GetLoaded() and arg_37_0.previewPage.isShowing():
		if arg_37_0.previewPage.IsShowSelectShipView():
...
def var_0_0.willExit(arg_38_0):
	...
	if arg_38_0.rollingCircleRect:
		arg_38_0.rollingCircleRect.Dispose()

		arg_38_0.rollingCircleRect = None

	if arg_38_0.previewPage:
		arg_38_0.previewPage.Destroy()

		arg_38_0.previewPage = None
