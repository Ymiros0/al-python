...
def var_0_0.IsCenter(arg_5_0, arg_5_1):
	return arg_5_0.index == arg_5_1

def var_0_0.SetPrev(arg_6_0, arg_6_1):
	arg_6_0.prev = arg_6_1

def var_0_0.SetNext(arg_7_0, arg_7_1):
	arg_7_0.nex = arg_7_1
...
def var_0_0.GetSpace(arg_9_0):
	return var_0_1

def var_0_0.GetLocalposition(arg_10_0):
	return arg_10_0.tr.localPosition

def var_0_0.UpdateLocalPosition(arg_11_0, arg_11_1):
	arg_11_0.tr.localPosition = arg_11_1

def var_0_0.Record(arg_12_0):
	arg_12_0.lastIndex = arg_12_0.index
	arg_12_0.lastLocalPosition = arg_12_0.GetLocalposition()

def var_0_0.GetLastPositionAndIndex(arg_13_0):
	return arg_13_0.lastLocalPosition, arg_13_0.lastIndex

def var_0_0.GoForward(arg_14_0):
	if arg_14_0.nex:
