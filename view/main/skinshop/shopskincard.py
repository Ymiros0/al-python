...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2):
	...
	onButton(None, arg_1_0._go, function()
		arg_1_0.view.emit(SkinShopScene.EVENT_ON_CARD_CLICK, arg_1_0), SFX_PANEL)
...
def var_0_0.update(arg_3_0, arg_3_1):
	...
	for iter_3_0, iter_3_1 in pairs(arg_3_0._tagTFs):
		setActive(iter_3_1, False)

	if arg_3_0.goodsVO.type == Goods.TYPE_SKIN:
		...
		if arg_3_0.view.encoreSkinMap[arg_3_1.id] and var_3_7:
