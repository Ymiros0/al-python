...
def var_0_0.register(arg_1_0):
	...
	if arg_1_0.contextData.type == SkinShopScene.SHOP_TYPE_TIMELIMIT:
...
def var_0_0.handleNotification(arg_12_0, arg_12_1):
	...
	if var_12_0 == GAME.SKIN_SHOPPIGN_DONE or var_12_0 == GAME.SKIN_COUPON_SHOPPING_DONE:
		...
		if var_12_4 and var_12_4.genre == ShopArgs.SkinShop or var_12_4.genre == ShopArgs.SkinShopTimeLimit:
	...
	elif var_12_0 == PlayerProxy.UPDATED:
		arg_12_0.viewComponent.setPlayer(var_12_1)
	elif var_12_0 == GAME.BUY_FURNITURE_DONE:
