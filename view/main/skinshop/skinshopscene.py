...
def var_0_0.setSkins(arg_4_0, arg_4_1):
	arg_4_0.skinList = arg_4_1

	arg_4_0.filterSkins()

def var_0_0.SetEncoreSkins(arg_5_0, arg_5_1):
...
def var_0_0.filterSkins(arg_7_0):
...
def var_0_0.didEnter(arg_9_0):
	...
	onButton(arg_9_0, arg_9_0.changeBtn, function()
		...
		if getInputText(arg_9_0.inptuTr) != "":
			setInputText(arg_9_0.inptuTr, ""), SFX_PANEL)
	triggerButton(arg_9_0.changeBtn)
	onButton(arg_9_0, arg_9_0.live2dFilter, function()
		if arg_9_0.defaultIndex.extraIndex == SkinIndexLayer.ExtraL2D:
			arg_9_0.defaultIndex.extraIndex = SkinIndexLayer.ExtraALL
		else
			arg_9_0.defaultIndex.extraIndex = SkinIndexLayer.ExtraL2D

		arg_9_0.OnFilter(arg_9_0.defaultIndex), SFX_PANEL)

def var_0_0.OnSkinListUpdate(arg_21_0, arg_21_1):
...
def var_0_0.OnSearch(arg_22_0):
	arg_22_0.updateShipRect()

def var_0_0.OnFilter(arg_23_0, arg_23_1):
...
def var_0_0.JumpToSkinById(arg_24_0, arg_24_1):
	local var_24_0 = -1
	local var_24_1 = {}

	for iter_24_0, iter_24_1 in ipairs(arg_24_0.displays):
		if arg_24_1 == iter_24_1.getSkinId():
			var_24_0 = iter_24_0
			var_24_1 = iter_24_1
	...
	onNextTick(function()
		for iter_25_0, iter_25_1 in pairs(arg_24_0.cards):
			if iter_25_1.goodsVO.id == var_24_1.id:
				triggerButton(iter_25_1._tf)

				break)

def var_0_0.SwitchCharBg(arg_26_0, arg_26_1):
	local var_26_0 = arg_26_0.furnBg
	local var_26_1 = arg_26_0.charBg

	if not arg_26_1:
		if LeanTween.isTweening(go(var_26_0)) or LeanTween.isTweening(go(var_26_1)):
			return
	else
...
def var_0_0.initSkinPage(arg_31_0):
	local var_31_0 = {}

	arg_31_0.countByIds = {}

	for iter_31_0, iter_31_1 in ipairs(var_0_1.all):
		if iter_31_1 == var_0_0.PAGE_PROPOSE or iter_31_1 == var_0_0.PAGE_TRANS:
			-- block empty
		else
	...
	for iter_31_2, iter_31_3 in ipairs(arg_31_0.skinGoodsVOs):
	...
	for iter_31_4, iter_31_5 in ipairs(var_31_0):
		if arg_31_0.countByIds[iter_31_5] > 0:
			table.insert(var_31_6, iter_31_5)

	if arg_31_0.existAnyEncoreSkin:
	...
	if arg_31_0.viewMode == var_0_0.SHOP_TYPE_TIMELIMIT:
	...
	for iter_31_6, iter_31_7 in ipairs(var_31_6):
		...
		onButton(arg_31_0, var_31_8, function()
			...
			for iter_32_0, iter_32_1 in ipairs(arg_31_0.pageTFs):
				if tonumber(go(iter_32_1).name) == iter_31_7:
					var_32_0 = iter_32_0
...
def var_0_0.UpdateViewMode(arg_39_0, arg_39_1):
	local var_39_0
	local var_39_1
	local var_39_2

	if arg_39_0.viewMode == var_0_0.SHOP_TYPE_TIMELIMIT:
		var_39_0 = var_0_0.PAGE_TIME_LIMIT
	elif arg_39_0.viewMode == var_0_0.SHOP_TYPE_COMMON:
...
def var_0_0.UpdateTagStyle(arg_40_0, arg_40_1, arg_40_2, arg_40_3):
	if arg_40_2[arg_40_3]:
	...
	elif arg_40_3 == var_0_0.PAGE_ALL:
	...
	elif arg_40_3 == var_0_0.PAGE_ENCORE:
...
def var_0_0.updateMainView(arg_41_0, arg_41_1):
	...
	if arg_41_0.prefabName != var_41_2:
	...
	if not var_41_4 and var_41_0.bg_sp != "":
	...
	if var_41_6[1] == False and arg_41_0.painting != var_41_3:
...
def var_0_0.UpdateLiveToggle(arg_43_0, arg_43_1, arg_43_2):
...
def var_0_0.UpdateSpineState(arg_45_0, arg_45_1, arg_45_2):
	local var_45_0 = pg.ship_skin_template[arg_45_1.id].painting
	local var_45_1 = "SpinePainting/" .. string.lower(var_45_0)
	local var_45_2 = HXSet.autoHxShiftPath(var_45_1, None, True)
	...
	if not var_45_3:
		onButton(arg_45_0, arg_45_0.l2dDownloadStateTf, function()
			pg.TipsMgr.GetInstance().ShowTips("word_cmdClose"), SFX_PANEL)
...
def var_0_0.LoadSpine(arg_47_0, arg_47_1):
...
def var_0_0.UnloadSpine(arg_49_0, arg_49_1):
	if arg_49_0.spinePainting:
		arg_49_0.spinePainting.Dispose()

		arg_49_0.spinePainting = None

def var_0_0.UpdateLive2dDownloadState(arg_50_0, arg_50_1, arg_50_2):
	local var_50_0 = pg.ship_skin_template[arg_50_1.id].painting
	local var_50_1 = "live2d/" .. string.lower(var_50_0)
	local var_50_2 = HXSet.autoHxShiftPath(var_50_1, None, True)
	...
	if not var_50_3:
		onButton(arg_50_0, arg_50_0.l2dDownloadStateTf, function()
			if arg_50_0.downloads[arg_50_1.id]:
				return
			...
			var_51_0.Start(var_50_2, function(arg_52_0)
				if arg_52_0 and arg_50_0.skinId == arg_50_1.id:
					arg_50_0.UpdateLive2dDownloadState(arg_50_1)

				var_51_0.Dispose()

				arg_50_0.downloads[arg_50_1.id] = None), SFX_PANEL)
...
def var_0_0.LoadL2d(arg_53_0, arg_53_1):
...
def var_0_0.UnLoadLive2d(arg_55_0, arg_55_1):
	if arg_55_0.live2dChar:
		arg_55_0.live2dChar.Dispose()

		arg_55_0.live2dChar = None

def var_0_0.setBg(arg_56_0, arg_56_1, arg_56_2, arg_56_3):
	...
	if arg_56_3 and arg_56_2.bg_sp != "":
		var_56_1 = arg_56_2.bg_sp

	if var_56_1 != var_56_0.rarity2bgPrintForGet():
...
def var_0_0.GetCurBgTransform(arg_59_0):
	local var_59_0

	if not arg_59_0.bgType:
...
def var_0_0.onBuyDone(arg_62_0, arg_62_1):
...
def var_0_0.OnFurnitureUpdate(arg_64_0, arg_64_1):
	if arg_64_0.goodsId and arg_64_1 and Goods.ExistFurniture(arg_64_0.goodsId) and Goods.Id2FurnitureId(arg_64_0.goodsId) == arg_64_1:
...
def var_0_0.updateBuyBtn(arg_66_0, arg_66_1):
	...
	if var_66_0:
		onButton(arg_66_0, arg_66_0.timelimitBtn, function()
			...
			if var_67_1 and not var_67_1.isExpireType():
				pg.TipsMgr.GetInstance().ShowTips(i18n("already_have_the_skin"))

				return

			arg_66_0.showTimeLimitSkinWindow(arg_66_1), SFX_PANEL)
		...
		onButton(arg_66_0, arg_66_0.itemBtn, function()
			triggerButton(arg_66_0.buyBtn), SFX_PANEL)
		onButton(arg_66_0, arg_66_0.buyBtn, function()
			local var_69_0 = arg_66_1

			if var_69_0.type == Goods.TYPE_SKIN:
				if arg_66_0.showCardId == var_69_0.id:
					if arg_66_1.isDisCount() and var_69_0.IsItemDiscountType():
		...
		onButton(arg_66_0, arg_66_0.activityBtn, function()
			...
			if var_71_2 == 0 and pg.TimeMgr.GetInstance().inTime(var_71_1) or var_71_3 and not var_71_3.isEnd():
				if var_71_0.type == Goods.TYPE_ACTIVITY:
					arg_66_0.emit(SkinShopMediator.GO_SHOPS_LAYER, var_71_0.getConfig("activity"))
				elif var_71_0.type == Goods.TYPE_ACTIVITY_EXTRA:
					local var_71_4 = var_71_0.getConfig("scene")

					if var_71_4 and #var_71_4 > 0:
						arg_66_0.emit(SkinShopMediator.OPEN_SCENE, var_71_4)
					else
						arg_66_0.emit(SkinShopMediator.OPEN_ACTIVITY, var_71_2)
			else
				pg.TipsMgr.GetInstance().ShowTips(i18n("common_activity_not_start")), SFX_PANEL)
		onButton(arg_66_0, arg_66_0.backyardBtn, function()
			arg_66_0.emit(SkinShopMediator.ON_BACKYARD_SHOP), SFX_PANEL)
	...
	onToggle(arg_66_0, arg_66_0.hideObjToggleTF, function(arg_73_0)
		...
		arg_66_0.setBg(var_66_9, var_66_1, arg_73_0), SFX_PANEL)

def var_0_0.showTimeLimitSkinWindow(arg_74_0, arg_74_1):
	...
	pg.MsgboxMgr.GetInstance().ShowMsgBox({
		...
		def onYes:()
			if arg_74_0.skinTicket < var_74_0:
	...
	if var_76_0.getConfig("genre") == ShopArgs.SkinShopTimeLimit:
		...
		if var_76_3:
			arg_76_0.skinTimer = Timer.New(function()
				...
				arg_76_0.limitTxt.text = var_77_0, 1, -1)
			...
			if var_78_2 > 0:
				...
				if var_78_3 > 0:
					...
					if var_78_4 > 0:
						...
						arg_76_0.limitTxt.text = i18n("time_remaining_tip") .. var_78_1 .. i18n("word_second"), 1, -1)

		arg_76_0.shopTimer.Start()
		arg_76_0.shopTimer.func()

def var_0_0.removeShopTimer(arg_79_0):
	if arg_79_0.shopTimer:
		arg_79_0.shopTimer.Stop()

		arg_79_0.shopTimer = None

def var_0_0.updatePrice(arg_80_0, arg_80_1):
...
def var_0_0.loadPainting(arg_81_0, arg_81_1, arg_81_2):
...
def var_0_0.setPaintingPrefab(arg_82_0, arg_82_1, arg_82_2, arg_82_3, arg_82_4):
	...
	if not arg_82_4 and checkABExist("painting/" .. arg_82_2 .. "_n"):
		arg_82_2 = arg_82_2 .. "_n"

	if checkABExist("painting/" .. arg_82_2):
		pg.UIMgr.GetInstance().LoadingOn()
		PoolMgr.GetInstance().GetPainting(arg_82_2, True, function(arg_83_0)
			...
			if not IsNil(var_83_0):
				setActive(var_83_0, False)

			ShipExpressionHelper.SetExpression(var_82_0.GetChild(0), var_82_2))

def var_0_0.recyclePainting(arg_84_0):
	if arg_84_0.painting:
		retPaintingPrefab(arg_84_0.paintingTF, arg_84_0.painting)

	arg_84_0.painting = None

def var_0_0.loadChar(arg_85_0, arg_85_1, arg_85_2):
...
def var_0_0.recycleChar(arg_87_0):
	if not IsNil(arg_87_0.modelTf):
		arg_87_0.modelTf.gameObject.GetComponent("SpineAnimUI").SetActionCallBack(None)
...
def var_0_0.OnCardClick(arg_88_0, arg_88_1):
	if arg_88_0.card and arg_88_0.contextData.key == arg_88_1.goodsVO.getKey():
		return

	if arg_88_0.contextData.key:
		for iter_88_0, iter_88_1 in pairs(arg_88_0.cards):
			if iter_88_1.goodsVO.getKey() == arg_88_0.contextData.key:
	...
	for iter_88_2, iter_88_3 in ipairs(arg_88_0.displays):
		if iter_88_3 == arg_88_0.card.goodsVO:
			arg_88_0.index = iter_88_2

	arg_88_0.SwitchCntPlusPlus()

def var_0_0.UpdateSkinOrFurnitureMode(arg_89_0, arg_89_1):
	setActive(arg_89_0.switchBtn, arg_89_1)
	setActive(arg_89_0.furnBg, arg_89_1)
	setActive(arg_89_0.bgMask, arg_89_1)

def var_0_0.initShips(arg_90_0):
	arg_90_0.cards = {}
	...
	function arg_90_0.shipRect.onUpdateItem(arg_92_0, arg_92_1)
		...
		if arg_90_0.isSwitch and arg_92_0 == 0:
			arg_90_0.isSwitch = None

			triggerButton(var_92_0._tf)

def var_0_0.SwitchCntPlusPlus(arg_93_0):
	arg_93_0.switchCnt = arg_93_0.switchCnt + 1

	if arg_93_0.switchCnt >= 2:
		gcAll()

		arg_93_0.switchCnt = 0

def var_0_0.onNext(arg_94_0):
	if arg_94_0.index == #arg_94_0.displays:
		return

	local var_94_0

	for iter_94_0, iter_94_1 in ipairs(arg_94_0.displays):
		if iter_94_1.getKey() == arg_94_0.contextData.key:
			var_94_0 = iter_94_0
	...
	if var_94_0:
		...
		for iter_94_2, iter_94_3 in pairs(arg_94_0.cards):
			if iter_94_3.goodsVO.getKey() == var_94_4.getKey() and iter_94_3._tf.gameObject.name != "-1":
...
def var_0_0.onPrev(arg_96_0):
	if arg_96_0.index == 1:
		return

	local var_96_0

	for iter_96_0, iter_96_1 in ipairs(arg_96_0.displays):
		if iter_96_1.getKey() == arg_96_0.contextData.key:
			var_96_0 = iter_96_0
	...
	if var_96_0:
		...
		for iter_96_2, iter_96_3 in pairs(arg_96_0.cards):
			if iter_96_3.goodsVO.getKey() == var_96_3.getKey() and iter_96_3._tf.gameObject.name != "-1":
		...
		if var_96_1 and var_96_4():
			local var_96_5 = arg_96_0.shipRect.HeadIndexToValue(var_96_2 - 1)

			arg_96_0.shipRect.SetNormalizedPosition(var_96_5, 0)

def var_0_0.updateShipRect(arg_98_0, arg_98_1):
	arg_98_0.card = None

	if arg_98_0.contextData.pageId and arg_98_0.shipRect:
		arg_98_0.displays = {}
		...
		local function var_98_2(arg_100_0)
			if #var_98_1 == 0:
				for iter_100_0, iter_100_1 in ipairs(arg_98_0.skinGoodsVOs):
					if iter_100_1.getConfig("genre") == ShopArgs.SkinShop:
		...
		for iter_98_0, iter_98_1 in ipairs(arg_98_0.skinGoodsVOs):
			...
			if var_98_6 and var_98_7 == var_0_0.PAGE_TIME_LIMIT and var_98_2(var_98_3) or not var_98_6 and (var_98_7 == var_0_0.PAGE_ALL or var_98_5 == arg_98_0.contextData.pageId) or not var_98_6 and var_98_7 == var_0_0.PAGE_ENCORE and var_98_0(iter_98_1.id):
				local var_98_8 = ShipSkin.New({
					id = var_98_3
				})

				if arg_98_0.MatchIndex(var_98_8) and var_98_8.IsMatchKey(getInputText(arg_98_0.inptuTr)):
...
def var_0_0.ToVShip(arg_103_0, arg_103_1):
	if not arg_103_0.vship:
		arg_103_0.vship = {}
...
def var_0_0.MatchIndex(arg_108_0, arg_108_1):
...
def var_0_0.addVerticalDrag(arg_109_0, arg_109_1, arg_109_2, arg_109_3):
	...
	var_109_0.AddDragFunc(function(arg_111_0, arg_111_1)
		if var_109_5 > arg_111_1.position.y and var_109_4 != 0:
			var_109_2 = arg_111_1.position
			var_109_4 = 0
		elif var_109_5 < arg_111_1.position.y and var_109_3 != 0:
			var_109_2 = arg_111_1.position
			var_109_3 = 0
		...
		if arg_109_2 and var_111_1 > var_109_3:
			var_109_3 = var_111_1

			arg_109_2(var_111_0)

		if arg_109_2 and var_111_1 < var_109_4:
			var_109_4 = var_111_1
...
def var_0_0.willExit(arg_113_0):
	for iter_113_0, iter_113_1 in ipairs(arg_113_0.cards):
		iter_113_1.Dispose()

	arg_113_0.cards = None

	ClearEventTrigger(GetOrAddComponent(arg_113_0._tf, "EventTriggerListener"))
	ClearLScrollrect(arg_113_0.shipRect)

	arg_113_0.shipRect = None
	...
	for iter_113_2, iter_113_3 in pairs(arg_113_0.downloads):
		iter_113_3.Dispose()
	...
	arg_113_0.interactionPreview = None

	if arg_113_0.skinTimer:
		arg_113_0.skinTimer.Stop()

	arg_113_0.skinTimer = None
	arg_113_0.contextData.key = None
	arg_113_0.switchCnt = None
	arg_113_0.contextData.skinId = None
