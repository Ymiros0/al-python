...
def var_0_0.UpdateTrophyGroup(arg_2_0, arg_2_1):
...
def var_0_0.updateInfoView(arg_5_0, arg_5_1):
	arg_5_0._trophy = arg_5_1
	arg_5_0._trophyCount.text = arg_5_1.getConfig("rank")

	if not arg_5_1.isClaimed() and not arg_5_1.canClaimed():
...
def var_0_0.setGray(arg_6_0, arg_6_1, arg_6_2):
...
def var_0_0.PlayClaimAnima(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
...
def var_0_0.IsPlaying(arg_13_0):
