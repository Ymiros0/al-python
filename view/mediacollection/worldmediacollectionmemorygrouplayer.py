...
def var_0_0.OnInit(arg_2_0):
	...
	for iter_2_2, iter_2_3 in ipairs(arg_2_0.memoryActivityToggles):
		onButton(arg_2_0, iter_2_3, function()
			if iter_2_2 == arg_2_0.activityFilter:
				arg_2_0.activityFilter = 0
			elif iter_2_2 != arg_2_0.activityFilter:
				arg_2_0.activityFilter = iter_2_2

			arg_2_0.UpdateActivityBar()
			arg_2_0.MemoryFilter(), SFX_UI_TAG)
	...
	for iter_2_4, iter_2_5 in ipairs(arg_2_0.memoryToggles):
...
def var_0_0.SwitchMemoryFilter(arg_10_0, arg_10_1):
	if arg_10_1 == 1:
		...
		for iter_10_0 in ipairs(arg_10_0.memoryFilterIndex):
			arg_10_0.memoryFilterIndex[iter_10_0] = arg_10_1 - 1 == iter_10_0

		if arg_10_1 - 1 == var_0_0.PAGE_ACTIVITY:
			arg_10_0.activityFilter = 0

			arg_10_0.UpdateActivityBar()

def var_0_0.MemoryFilter(arg_11_0):
	table.clear(arg_11_0.memoryGroups)

	local var_11_0 = not _.all(arg_11_0.memoryFilterIndex, function(arg_12_0)
		return arg_12_0) and arg_11_0.memoryFilterIndex[var_0_0.PAGE_ACTIVITY]

	for iter_11_0, iter_11_1 in ipairs(pg.memory_group.all):
		local var_11_1 = pg.memory_group[iter_11_1]

		if arg_11_0.memoryFilterIndex[var_11_1.type]:
			if var_11_0:
				if arg_11_0.activityFilter == 0 or arg_11_0.activityFilter == var_11_1.subtype:
...
def var_0_0.onInitMemoryGroup(arg_14_0, arg_14_1):
	if arg_14_0.exited:
		return
	...
	onButton(arg_14_0, arg_14_1, function()
		...
		if var_15_0:
			...
			arg_14_0.viewParent.ShowSubMemories(var_15_0), SOUND_BACK)

def var_0_0.onUpdateMemoryGroup(arg_16_0, arg_16_1, arg_16_2):
	if arg_16_0.exited:
		return
	...
	local var_16_4 = _.reduce(var_16_0.memories, 0, function(arg_17_0, arg_17_1)
		...
		if var_17_0.is_open == 1 or pg.NewStoryMgr.GetInstance().IsPlayed(var_17_0.story, True):
			arg_17_0 = arg_17_0 + 1
...
def var_0_0.Return2MemoryGroup(arg_18_0):
	...
	for iter_18_0, iter_18_1 in ipairs(arg_18_0.memoryGroups):
...
def var_0_0.SwitchReddotMemory(arg_19_0):
	local var_19_0 = 0
	local var_19_1 = getProxy(PlayerProxy).getRawData().id

	for iter_19_0, iter_19_1 in ipairs(arg_19_0.memoryGroups):
		if PlayerPrefs.GetInt("MEMORY_GROUP_NOTIFICATION" .. var_19_1 .. " " .. iter_19_1.id, 0) == 1:
			var_19_0 = iter_19_0
...
def var_0_0.GetIndexRatio(arg_20_0, arg_20_1):
	local var_20_0 = 0
...
def var_0_0.UpdateView(arg_21_0):
	...
	for iter_21_0, iter_21_1 in ipairs(arg_21_0.memoryActivityToggles):
		setActive(iter_21_1, _.any(pg.memory_group.all, function(arg_22_0)
			return pg.memory_group[arg_22_0].subtype == iter_21_0))

def var_0_0.UpdateActivityBar(arg_23_0):
	for iter_23_0, iter_23_1 in ipairs(arg_23_0.memoryActivityToggles):
