...
def var_0_0.OnInit(arg_2_0):
	...
	for iter_2_0 = 1, #arg_2_0.recordFilterIndex:
		setActive(arg_2_0.recordToggles[1 + iter_2_0], arg_2_0.recordFilterIndex[iter_2_0])

		if not arg_2_0.recordFilterIndex[iter_2_0]:
			var_2_0 = var_2_0 - 1
		else
...
def var_0_0.OnUpdateGroup(arg_8_0, arg_8_1, arg_8_2):
	if arg_8_0.exited:
		return
	...
	local var_8_8 = _.reduce(var_8_0.child, 0, function(arg_9_0, arg_9_1)
		...
		if var_9_0 and WorldMediaCollectionRecordDetailLayer.CheckRecordIsUnlock(var_9_0):
			arg_9_0 = arg_9_0 + 1
	...
	onButton(arg_8_0, var_8_1, function()
		arg_8_0.viewParent.ShowRecordGroup(var_8_0.id), SFX_PANEL)

def var_0_0.SwitchRecordFilter(arg_11_0, arg_11_1):
	if arg_11_1 == 1:
		...
		for iter_11_0 in ipairs(arg_11_0.recordFilterIndex):
			arg_11_0.recordFilterIndex[iter_11_0] = arg_11_1 - 1 == iter_11_0

def var_0_0.RecordFilter(arg_12_0):
	...
	_.each(pg.world_collection_record_group.all, function(arg_13_0)
		...
		local var_13_1 = _.reduce(var_13_0.child, 0, function(arg_14_0, arg_14_1)
			...
			if var_14_0 and WorldMediaCollectionRecordDetailLayer.CheckRecordIsUnlock(var_14_0):
				arg_14_0 = arg_14_0 + 1
		...
		if arg_12_0.recordFilterIndex[var_13_0.type]:
