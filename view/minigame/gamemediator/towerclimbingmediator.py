...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.ON_FINISH, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
		...
		if getProxy(MiniGameProxy).GetHubByGameId(MiniGameDataCreator.TowerClimbingGameID).count <= 0:
			return
	...
	if var_1_0 and not var_1_0.GetRuntimeData("isInited"):
		arg_1_0.sendNotification(GAME.SEND_MINI_GAME_OP, {
			hubid = 9,
			cmd = MiniGameOPCommand.CMD_SPECIAL_GAME,
			args1 = {
...
def var_0_0.handleNotification(arg_7_0, arg_7_1):
	...
	elif var_7_0 == GAME.REMOVE_LAYERS and var_7_1.context.mediator == TowerClimbingCollectionMediator:
