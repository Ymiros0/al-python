...
def var_0_0.setLineIndex(arg_2_0, arg_2_1):
	arg_2_0._lineIndex = arg_2_1

def var_0_0.getLineIndex(arg_3_0):
	return arg_3_0._lineIndex

def var_0_0.setIndex(arg_4_0, arg_4_1):
	arg_4_0._index = arg_4_1

def var_0_0.getIndex(arg_5_0):
	return arg_5_0._index

def var_0_0.getPos(arg_6_0):
	return arg_6_0.pos

def var_0_0.active(arg_7_0, arg_7_1):
	setActive(arg_7_0._lineTf, arg_7_1)

def var_0_0.prechar(arg_8_0, arg_8_1):
...
def var_0_0.unPreChar(arg_9_0):
	setActive(arg_9_0.preIcon, False)
	setActive(arg_9_0.select, False)

def var_0_0.inGridWorld(arg_10_0, arg_10_1):
	local var_10_0 = arg_10_0._gridTf.InverseTransformPoint(arg_10_1)

	if var_10_0.x > arg_10_0.minX and var_10_0.x < arg_10_0.maxX and var_10_0.y > arg_10_0.minY and var_10_0.y < arg_10_0.maxY:
		return True

	return False

def var_0_0.setChar(arg_11_0, arg_11_1):
	if arg_11_0.char:
		return

	arg_11_0.char = arg_11_1

def var_0_0.getChar(arg_12_0):
	return arg_12_0.char

def var_0_0.removeChar(arg_13_0):
	arg_13_0.char = None

	setActive(arg_13_0.full, False)

def var_0_0.isEmpty(arg_14_0):
	return arg_14_0.char == None

def var_0_0.start(arg_15_0):
	return

def var_0_0.step(arg_16_0, arg_16_1):
	if arg_16_0.char and arg_16_0.char.getRecycleFlag():
...
def var_0_0.preDistance(arg_18_0):
	setActive(arg_18_0.range, True)

def var_0_0.unPreDistance(arg_19_0):
