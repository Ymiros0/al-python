...
def var_0_0.start(arg_3_0):
	...
	for iter_3_3 = #arg_3_0.bubbles, 1, -1:
	...
	for iter_3_4 = #arg_3_0.booms, 1, -1:
	...
	for iter_3_5 = 1, #CastleGameVo.roundData.boom:
...
def var_0_0.step(arg_4_0):
	for iter_4_0 = #arg_4_0.carriageTime, 1, -1:
		if CastleGameVo.gameStepTime > arg_4_0.carriageTime[iter_4_0]:
			table.remove(arg_4_0.carriageTime, iter_4_0)
			arg_4_0.appearCarriage()

	for iter_4_1 = #arg_4_0.bubbleTime, 1, -1:
		if CastleGameVo.gameStepTime > arg_4_0.bubbleTime[iter_4_1].time:
			local var_4_0 = table.remove(arg_4_0.bubbleTime, iter_4_1)

			arg_4_0.appearBubble(var_4_0.num)

	for iter_4_2 = #arg_4_0.boomTimes, 1, -1:
		local var_4_1 = arg_4_0.boomTimes[iter_4_2]

		if CastleGameVo.gameStepTime > var_4_1.time:
			table.remove(arg_4_0.boomTimes, iter_4_2)
			arg_4_0.appearBoom()

	for iter_4_3 = #arg_4_0.carriages, 1, -1:
		local var_4_2 = arg_4_0.carriages[iter_4_3]

		if var_4_2.ready and var_4_2.ready > 0:
			var_4_2.ready = var_4_2.ready - CastleGameVo.deltaTime

			if var_4_2.ready <= 0:
				var_4_2.ready = 0

				if arg_4_0.itemRemindCallback:
					-- block empty
		else
			...
			if var_4_5.x < var_4_4.x and var_4_6.x > var_4_4.x:
				table.remove(arg_4_0.carriages, iter_4_3)
				setActive(var_4_2.tf, False)
				arg_4_0.returnItem(var_4_2, arg_4_0.carriagePool)
			elif var_4_5.x > var_4_4.x and var_4_6.x < var_4_4.x:
				table.remove(arg_4_0.carriages, iter_4_3)
				setActive(var_4_2.tf, False)
				arg_4_0.returnItem(var_4_2, arg_4_0.carriagePool)

	for iter_4_4 = #arg_4_0.bubbles, 1, -1:
		local var_4_7 = arg_4_0.bubbles[iter_4_4]

		if var_4_7.ready and var_4_7.ready > 0:
		...
		elif var_4_7.brokenTime and var_4_7.brokenTime > 0:
			var_4_7.brokenTime = var_4_7.brokenTime - CastleGameVo.deltaTime

			if not var_4_7.hit and CastleGameVo.bubble_broken_time - var_4_7.brokenTime > 1:
				var_4_7.hit = True

			if var_4_7.brokenTime < 0:
				var_4_7.broken = True
				var_4_7.brokenTime = 0
				var_4_7.hit = False

				if arg_4_0.bubbleBrokenCallback:
	...
	for iter_4_5 = #arg_4_0.stoneDatas, 1, -1:
		if CastleGameVo.gameStepTime > arg_4_0.stoneDatas[iter_4_5].time:
			local var_4_8 = table.remove(arg_4_0.stoneDatas, iter_4_5).indexs

			arg_4_0.appearStone(var_4_8)

	for iter_4_6 = #arg_4_0.stones, 1, -1:
		local var_4_9 = arg_4_0.stones[iter_4_6]

		if var_4_9.ready and var_4_9.ready > 0:
	...
	for iter_4_7 = #arg_4_0.booms, 1, -1:
		...
		for iter_4_8 = 0, var_4_12.Length - 1:
		...
		if var_4_10.ready and var_4_10.ready > 0:
		...
		elif var_4_10.brokenTime and var_4_10.brokenTime > 0:
			var_4_10.brokenTime = var_4_10.brokenTime - CastleGameVo.deltaTime

			if var_4_10.brokenTime < 0:
...
def var_0_0.appearStone(arg_6_0, arg_6_1):
	local var_6_0
	local var_6_1 = {}
	local var_6_2 = arg_6_0.getItemActiveIndex()

	for iter_6_0 = 1, #var_6_2:
		if not table.contains(arg_6_1, var_6_2[iter_6_0]):
			table.insert(var_6_1, var_6_2[iter_6_0])

	if #var_6_1 == 0:
		return

	if #arg_6_0.stonePool > 0:
...
def var_0_0.returnItem(arg_7_0, arg_7_1, arg_7_2):
	if arg_7_0.itemChangeCallback:
		arg_7_0.itemChangeCallback(arg_7_1, False)

	table.insert(arg_7_2, arg_7_1)

def var_0_0.appearBubble(arg_8_0, arg_8_1):
...
def var_0_0.appearBoom(arg_9_0):
	local var_9_0 = {}
	...
	for iter_9_0 = 1, #var_9_1:
		...
		if var_9_2 % CastleGameVo.w_count != CastleGameVo.w_count - 1:
			local var_9_3 = var_9_2 + 1
			local var_9_4 = var_9_2 + CastleGameVo.w_count
			local var_9_5 = var_9_2 + 1 + CastleGameVo.w_count

			if table.contains(var_9_1, var_9_3) and table.contains(var_9_1, var_9_4) and table.contains(var_9_1, var_9_5):
	...
	if arg_9_0.itemChangeCallback:
		arg_9_0.itemChangeCallback(var_9_7, True)

	if arg_9_0.itemRemindCallback:
...
def var_0_0.setFloorBroken(arg_10_0, arg_10_1):
	arg_10_0.floorBrokenCallback = arg_10_1

def var_0_0.setBubbleBroken(arg_11_0, arg_11_1):
	arg_11_0.bubbleBrokenCallback = arg_11_1

def var_0_0.setItemChange(arg_12_0, arg_12_1):
	arg_12_0.itemChangeCallback = arg_12_1

def var_0_0.setFloorIndexs(arg_13_0, arg_13_1):
	arg_13_0.floorIndexs = arg_13_1

def var_0_0.getItemActiveIndex(arg_14_0):
	local var_14_0 = {}
	local var_14_1 = {}

	for iter_14_0 = 1, #arg_14_0.bubbles:
		for iter_14_1, iter_14_2 in ipairs(arg_14_0.bubbles[iter_14_0].useIndex):
			table.insert(var_14_1, iter_14_2)

	for iter_14_3 = 1, #arg_14_0.booms:
		for iter_14_4, iter_14_5 in ipairs(arg_14_0.booms[iter_14_3].useIndex):
			table.insert(var_14_1, iter_14_5)

	for iter_14_6 = 1, #arg_14_0.stones:
		for iter_14_7, iter_14_8 in ipairs(arg_14_0.stones[iter_14_6].useIndex):
			table.insert(var_14_1, iter_14_8)

	for iter_14_9 = 1, #arg_14_0.floorIndexs:
		local var_14_2 = arg_14_0.floorIndexs[iter_14_9]

		if not table.contains(var_14_1, var_14_2):
			table.insert(var_14_0, var_14_2)

	return var_14_0

def var_0_0.appearCarriage(arg_15_0):
	local var_15_0

	if #arg_15_0.carriagePool > 0:
	...
	if #var_15_6 > 0:
		...
		if arg_15_0.itemChangeCallback:
...
def var_0_0.getCarriageRoadlist(arg_16_0):
	local var_16_0 = {}

	for iter_16_0 = 0, CastleGameVo.w_count - 1:
		local var_16_1 = True

		for iter_16_1 = 0, CastleGameVo.h_count - 1:
			local var_16_2 = iter_16_0 + iter_16_1 * CastleGameVo.w_count

			if var_16_1 and not table.contains(arg_16_0.floorIndexs, var_16_2):
				var_16_1 = False
	...
	for iter_16_2 = 0, CastleGameVo.h_count - 1:
		local var_16_3 = True

		for iter_16_3 = 0, CastleGameVo.w_count - 1:
			local var_16_4 = iter_16_3 + iter_16_2 * CastleGameVo.w_count

			if var_16_3 and not table.contains(arg_16_0.floorIndexs, var_16_4):
				var_16_3 = False
...
def var_0_0.setItemRemindCallback(arg_17_0, arg_17_1):
	arg_17_0.itemRemindCallback = arg_17_1

def var_0_0.countSpeed(arg_18_0, arg_18_1, arg_18_2):
...
def var_0_0.changeAnimAction(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4, arg_19_5):
	local var_19_0 = 0

	for iter_19_0 = 1, #arg_19_1:
		local var_19_1 = arg_19_1[iter_19_0]

		var_19_1.SetActionCallBack(None)
		...
		var_19_1.SetActionCallBack(function(arg_20_0)
			if arg_20_0 == "finish":
				...
				if arg_19_5 and var_19_0 == 0:
					var_19_0 = 1

					arg_19_5())

		if arg_19_3 != 1 and arg_19_5 and var_19_0 == 0:
			var_19_0 = 1

			arg_19_5()

def var_0_0.playerInBubble(arg_21_0, arg_21_1, arg_21_2):
	arg_21_1.char = arg_21_2

def var_0_0.getBooms(arg_22_0):
	return arg_22_0.booms

def var_0_0.getBubbles(arg_23_0):
	return arg_23_0.bubbles

def var_0_0.getCarriages(arg_24_0):
	return arg_24_0.carriages

def var_0_0.clear(arg_25_0):
	return
