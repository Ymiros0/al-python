...
def var_0_0.initUI(arg_70_0):
	...
	onButton(arg_70_0, findTF(arg_70_0.menuUI, "rightPanelBg/arrowUp"), function()
		...
		scrollTo(arg_70_0.battleScrollRect, 0, var_77_0), SFX_CANCEL)
	onButton(arg_70_0, findTF(arg_70_0.menuUI, "rightPanelBg/arrowDown"), function()
		...
		scrollTo(arg_70_0.battleScrollRect, 0, var_78_0), SFX_CANCEL)
	...
	for iter_70_0 = 1, 7:
		...
		onButton(arg_70_0, var_70_4, function()
			arg_70_0.emit(BaseUI.ON_DROP, var_70_5), SFX_PANEL)
...
def var_0_0.initGameUI(arg_84_0):
...
def var_0_0.Update(arg_88_0):
	arg_88_0.AddDebugInput()

def var_0_0.AddDebugInput(arg_89_0):
	if arg_89_0.gameStop or arg_89_0.settlementFlag:
		return

	if IsUnityEditor:
		-- block empty

def var_0_0.updateMenuUI(arg_90_0):
	local var_90_0 = arg_90_0.getGameUsedTimes()
	local var_90_1 = arg_90_0.getGameTimes()

	for iter_90_0 = 1, #arg_90_0.battleItems:
		...
		if iter_90_0 <= var_90_0:
		...
		elif iter_90_0 == var_90_0 + 1 and var_90_1 >= 1:
			...
			arg_90_0.dropItems[iter_90_0].anchoredPosition = Vector2(0, 0)
		elif var_90_0 < iter_90_0 and iter_90_0 <= var_90_0 + var_90_1:
...
def var_0_0.CheckGet(arg_91_0):
	setActive(findTF(arg_91_0.menuUI, "got"), False)

	if arg_91_0.getUltimate() and arg_91_0.getUltimate() != 0:
		setActive(findTF(arg_91_0.menuUI, "got"), True)

	if arg_91_0.getUltimate() == 0:
		if arg_91_0.getGameTotalTime() > arg_91_0.getGameUsedTimes():
			return
...
def var_0_0.openMenuUI(arg_92_0):
...
def var_0_0.gameStart(arg_99_0):
	...
	if arg_99_0.boatController:
		arg_99_0.boatController.start()

	if arg_99_0.itemController:
		arg_99_0.itemController.start()

	if arg_99_0.catchController:
		arg_99_0.catchController.start()

	if arg_99_0.charController:
		arg_99_0.charController.start()

	arg_99_0.updateGameUI()
	arg_99_0.timerStart()

def var_0_0.transformColor(arg_100_0, arg_100_1):
...
def var_0_0.addScore(arg_101_0, arg_101_1, arg_101_2):
	if arg_101_1 and arg_101_1 > 0 or arg_101_2 and arg_101_2 > 0:
		pg.CriMgr.GetInstance().PlaySoundEffect_V3(var_0_5)
	elif arg_101_1 and arg_101_1 < 0:
	...
	if arg_101_1:
		...
		for iter_101_0 = 1, #var_0_47:
			if arg_101_1 and arg_101_1 >= var_0_47[iter_101_0].score:
...
def var_0_0.timerStart(arg_104_0):
	if not arg_104_0.timer.running:
		arg_104_0.timer.Start()

def var_0_0.timerStop(arg_105_0):
	if arg_105_0.timer.running:
		arg_105_0.timer.Stop()

def var_0_0.updateGameUI(arg_106_0):
	setText(arg_106_0.scoreTf, arg_106_0.scoreNum)
	setText(arg_106_0.gameTimeS, math.ceil(arg_106_0.gameTime))

def var_0_0.onGameOver(arg_107_0):
...
def var_0_0.showSettlement(arg_109_0):
	...
	if arg_109_0.getGameTimes() and arg_109_0.getGameTimes() > 0:
		arg_109_0.sendSuccessFlag = True

		arg_109_0.SendSuccess(0)

def var_0_0.resumeGame(arg_110_0):
	arg_110_0.gameStop = False

	setActive(arg_110_0.leaveUI, False)
	arg_110_0.timerStart()

def var_0_0.stopGame(arg_111_0):
	arg_111_0.gameStop = True

	arg_111_0.timerStop()

def var_0_0.onBackPressed(arg_112_0):
	if not arg_112_0.gameStartFlag:
		arg_112_0.emit(var_0_0.ON_BACK_PRESSED)
	else
		if arg_112_0.settlementFlag:
			return

		if isActive(arg_112_0.pauseUI):
...
def var_0_0.willExit(arg_113_0):
	...
	if arg_113_0._tf and LeanTween.isTweening(go(arg_113_0._tf)):
		LeanTween.cancel(go(arg_113_0._tf))

	if arg_113_0.timer and arg_113_0.timer.running:
		arg_113_0.timer.Stop()

	Time.timeScale = 1
	arg_113_0.timer = None
