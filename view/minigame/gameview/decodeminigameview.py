...
def var_0_0.PackData(arg_9_0):
	local var_9_0 = arg_9_0.GetMGHubData()
	local var_9_1 = arg_9_0.GetMGData()

	return var_0_0.GetData(var_9_0, var_9_1)

def var_0_0.OnGetAwardDone(arg_10_0, arg_10_1):
	if arg_10_1.cmd == MiniGameOPCommand.CMD_COMPLETE and arg_10_0.onGetAward:
		arg_10_0.onGetAward()

		arg_10_0.onGetAward = None
