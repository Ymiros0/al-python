...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4):
	...
	for iter_1_0 = 1, #Fushun3GameConst.item_instance_data:
...
def var_0_0.setCallback(arg_2_0, arg_2_1):
	arg_2_0._callback = arg_2_1

def var_0_0.start(arg_3_0):
	for iter_3_0 = #arg_3_0.items, 1, -1:
...
def var_0_0.step(arg_4_0):
	...
	for iter_4_0 = #arg_4_0.items, 1, -1:
		local var_4_2 = arg_4_0.items[iter_4_0]

		if var_4_2.collider and var_4_2.data.type != Fushun3GameConst.item_type_damage:
			local var_4_3 = var_4_2.collider.bounds

			if Fushun3GameConst.CheckBoxCollider(var_4_0.min, var_4_3.min, var_4_0.size, var_4_3.size):
				local var_4_4 = table.remove(arg_4_0.items, iter_4_0)

				if var_4_4.data.effect:
					arg_4_0._event.emit(Fushun3GameEvent.add_effect_call, {
						effectName = var_4_4.data.effect,
						targetTf = var_4_4.tf
					})

				if arg_4_0._callback:
...
def var_0_0.removeItem(arg_6_0, arg_6_1):
	for iter_6_0 = #arg_6_0.items, 1, -1:
		if arg_6_1 == arg_6_0.items[iter_6_0]:
...
def var_0_0.createPlatformItem(arg_7_0, arg_7_1, arg_7_2):
	local var_7_0
	...
	if var_7_0:
		...
		for iter_7_0 = #var_7_2, 1, -1:
			local var_7_6 = var_7_2[iter_7_0]

			for iter_7_1, iter_7_2 in ipairs(var_7_6):
				if iter_7_2 and iter_7_2 > 0:
...
def var_0_0.createItemById(arg_8_0, arg_8_1, arg_8_2):
	local var_8_0

	for iter_8_0 = 1, #Fushun3GameConst.item_data:
		if Fushun3GameConst.item_data[iter_8_0].id == arg_8_1:
...
def var_0_0.createItem(arg_9_0, arg_9_1, arg_9_2):
...
def var_0_0.itemFollow(arg_10_0, arg_10_1):
	for iter_10_0 = 1, #arg_10_0.items:
		local var_10_0 = arg_10_0.items[iter_10_0]

		if var_10_0.data.type == Fushun3GameConst.item_type_buff or var_10_0.data.type == Fushun3GameConst.item_type_score:
			local var_10_1 = var_10_0.tf.anchoredPosition

			if math.abs(arg_10_1.x - var_10_1.x) <= 600 and math.abs(arg_10_1.y - var_10_1.y) <= 700:
				...
				if math.abs(arg_10_1.y - var_10_1.y) < 25:
					var_10_4 = 0
...
def var_0_0.getOrCreateItem(arg_11_0, arg_11_1):
	for iter_11_0 = 1, #arg_11_0.itemPools:
		if arg_11_0.itemPools[iter_11_0].data.name == arg_11_1:
			return table.remove(arg_11_0.itemPools, iter_11_0)

	for iter_11_1 = 1, #Fushun3GameConst.item_data:
		local var_11_0 = Clone(Fushun3GameConst.item_data[iter_11_1])

		if var_11_0.name == arg_11_1:
...
def var_0_0.getWeightItemsMap(arg_12_0):
	if arg_12_0.itemTime > 0:
		if math.random(1, arg_12_0.itemTime) == arg_12_0.itemTime:
			arg_12_0.itemTime = var_0_2

			if not arg_12_0.itemsMap:
				arg_12_0.itemsMap = {}

				for iter_12_0 = 1, #arg_12_0.weightItems:
					local var_12_0 = arg_12_0.weightItems[iter_12_0]

					if table.contains(Fushun3GameConst.item_map_ids, var_12_0.map):
	...
	for iter_12_1 = 1, #arg_12_0.weightItems:
		local var_12_2 = arg_12_0.weightItems[iter_12_1]

		if var_12_1 <= var_12_2.weight:
			return var_12_2.map

	return None

def var_0_0.removeOutItems(arg_13_0):
	for iter_13_0 = #arg_13_0.items, 1, -1:
		local var_13_0 = arg_13_0.items[iter_13_0].tf
		local var_13_1 = arg_13_0.items[iter_13_0].data

		if var_13_0.anchoredPosition.x < math.abs(arg_13_0._sceneTf.anchoredPosition.x) - 1500:
			local var_13_2 = table.remove(arg_13_0.items, iter_13_0)

			arg_13_0.returnItemToPool(var_13_2)
		elif var_13_1.type == Fushun3GameConst.item_type_damage and var_13_0.anchoredPosition.x >= math.abs(arg_13_0._sceneTf.anchoredPosition.x) + 2000:
			local var_13_3 = table.remove(arg_13_0.items, iter_13_0)

			arg_13_0.returnItemToPool(var_13_3)
		elif var_13_0.anchoredPosition.x >= math.abs(arg_13_0._sceneTf.anchoredPosition.x) + 5000:
			local var_13_4 = table.remove(arg_13_0.items, iter_13_0)

			arg_13_0.returnItemToPool(var_13_4)

def var_0_0.returnItemToPool(arg_14_0, arg_14_1):
