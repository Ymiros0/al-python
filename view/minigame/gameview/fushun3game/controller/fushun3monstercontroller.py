...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4):
	...
	for iter_1_0 = 1, #Fushun3GameConst.monster_data:
		table.insert(arg_1_0.monsterDatas, Clone(Fushun3GameConst.monster_data[iter_1_0]))

	arg_1_0.monsters = {}
	arg_1_0.monsterPool = {}

def var_0_0.setDiff(arg_2_0, arg_2_1):
	return
...
def var_0_0.step(arg_4_0):
	for iter_4_0 = 1, #arg_4_0.monsters:
		if not arg_4_0.monsters[iter_4_0].damage:
			arg_4_0.monsters[iter_4_0].rect.step()

	arg_4_0.removeOutMonster()

def var_0_0.removeOutMonster(arg_5_0):
	for iter_5_0 = #arg_5_0.monsters, 1, -1:
		if arg_5_0.monsters[iter_5_0].tf.anchoredPosition.x <= math.abs(arg_5_0._sceneTf.anchoredPosition.x) - 1920:
			arg_5_0.returnMonsterToPool(table.remove(arg_5_0.monsters, iter_5_0))

def var_0_0.createMonster(arg_6_0, arg_6_1):
...
def var_0_0.getOrCreateMonster(arg_7_0, arg_7_1):
	local var_7_0

	for iter_7_0 = 1, #arg_7_0.monsterPool:
		if arg_7_0.monsterPool[iter_7_0].data.id == arg_7_1:
	...
	for iter_7_1 = 1, #arg_7_0.monsterDatas:
		if arg_7_0.monsterDatas[iter_7_1].id == arg_7_1:
...
def var_0_0.checkPlayerDamage(arg_9_0, arg_9_1, arg_9_2):
	for iter_9_0 = 1, #arg_9_0.monsters:
		local var_9_0 = arg_9_0.monsters[iter_9_0]

		if var_9_0.tf == arg_9_1 and var_9_0.damage:
			arg_9_2(True)
...
def var_0_0.checkMonsterDamage(arg_10_0, arg_10_1, arg_10_2, arg_10_3):
	local var_10_0 = arg_10_1.bounds

	for iter_10_0 = 1, #arg_10_0.monsters:
		local var_10_1 = arg_10_0.monsters[iter_10_0]
		local var_10_2 = var_10_1.collider.bounds

		if not var_10_1.damage and Fushun3GameConst.CheckBoxCollider(var_10_0.min, var_10_2.min, var_10_0.size, var_10_2.size):
...
def var_0_0.damageMonster(arg_11_0, arg_11_1, arg_11_2, arg_11_3):
	for iter_11_0 = #arg_11_0.monsters, 1, -1:
		if arg_11_0.monsters[iter_11_0].tf == arg_11_1:
			local var_11_0 = arg_11_0.monsters[iter_11_0]

			if not var_11_0.damage:
				var_11_0.damage = True

				if arg_11_2 == Fushun3GameEvent.power_damage_monster_call:
					var_11_0.animator.SetTrigger("dmg_ex")
				elif arg_11_2 == Fushun3GameEvent.shot_damage_monster_call:
					var_11_0.animator.SetTrigger("dmg_la")
				elif arg_11_2 == Fushun3GameEvent.kick_damage_monster_call:
					var_11_0.animator.SetTrigger("dmg_jump")
				elif arg_11_2 == Fushun3GameEvent.attack_damdage_monster_call:
...
def var_0_0.removeMonster(arg_12_0, arg_12_1):
	for iter_12_0 = 1, #arg_12_0.monsters:
		if arg_12_0.monsters[iter_12_0] == arg_12_1:
			arg_12_0.returnMonsterToPool(table.remove(arg_12_0.monsters, iter_12_0))

			return

def var_0_0.returnMonsterToPool(arg_13_0, arg_13_1):
	setActive(arg_13_1.tf, False)
	table.insert(arg_13_0.monsterPool, arg_13_1)

def var_0_0.clearMonster(arg_14_0):
	for iter_14_0 = #arg_14_0.monsters, 1, -1:
