...
def var_0_0.didEnter(arg_3_0):
	...
	arg_3_0.game.SetOnShowResult(function(arg_4_0)
		...
		if arg_4_0 > ((arg_3_0.GetMGData().GetRuntimeData("elements") or {})[1] or 0):
...
def var_0_0.CheckAaward(arg_7_0):
	...
	if var_7_1 == 0 and var_7_3 <= var_7_2:
...
def var_0_0.OnSendMiniGameOPDone(arg_9_0):
	if arg_9_0.game:
		arg_9_0.game.RefreshLevels()

def var_0_0.onBackPressed(arg_10_0):
	if arg_10_0.game and arg_10_0.game.IsStarting():
