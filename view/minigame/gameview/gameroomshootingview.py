...
def var_0_0.changeStartMaskUI(arg_15_0, arg_15_1):
...
def var_0_0.update(arg_18_0):
	...
	if not arg_18_0.isStopped:
		if arg_18_0.isAfterCount and arg_18_0.sightTimeMark:
			if not arg_18_0.moveRect:
...
def var_0_0.resetTime(arg_19_0):
...
def var_0_0.gameStart(arg_20_0):
...
def var_0_0.afterCountDown(arg_23_0):
...
def var_0_0.gameFinish(arg_26_0, arg_26_1):
	if arg_26_0.isAfterCount:
...
def var_0_0.showResultPanel(arg_29_0, arg_29_1, arg_29_2):
	...
	if arg_29_0.score > arg_29_0.bestScore:
...
def var_0_0.updateCount(arg_33_0):
...
def var_0_0.initFireFunc(arg_34_0):
	...
	function arg_34_0._upFunc()
		...
		if var_40_0:
			...
			arg_34_0.cell[var_40_1][var_40_2] = None
	...
	arg_34_0._emptyFunc = None

def var_0_0.setFireLink(arg_47_0, arg_47_1):
	if arg_47_1:
		setButtonEnabled(arg_47_0.fireBtn, True)

		if arg_47_0._downFunc != None:
			arg_47_0.fireBtnDelegate.AddPointDownFunc(function()
				arg_47_0.isDown = True

				if arg_47_0._main_cannon_sound:
...
def var_0_0.flushTarget(arg_51_0, arg_51_1):
	if arg_51_1:
	...
	for iter_51_2, iter_51_3 in ipairs(arg_51_0.targetCount):
		for iter_51_4 = 1, iter_51_3:
			local var_51_1 = math.random(3)
			local var_51_2 = math.random(6)

			while arg_51_0.cell[var_51_1][var_51_2] or arg_51_1 and var_51_0[var_51_1] >= 4:
...
def var_0_0.checkHit(arg_52_0):
	for iter_52_0 = 1, 3:
		for iter_52_1 = 1, 6:
			if arg_52_0.cell[iter_52_0][iter_52_1]:
				...
				if var_52_1.x * var_52_1.x + var_52_1.y * var_52_1.y < arg_52_0.tempConfig.half * arg_52_0.tempConfig.half:
					return True, iter_52_0, iter_52_1

def var_0_0.willExit(arg_53_0):
	return
