...
def var_0_0.updateSDModel(arg_6_0):
...
def var_0_0.updateSelectedList(arg_8_0, arg_8_1):
	arg_8_1 = arg_8_1 or {}

	for iter_8_0 = 1, var_0_0.Order_Num:
...
def var_0_0.updateSnackList(arg_9_0, arg_9_1):
	for iter_9_0 = 1, var_0_0.Snack_Num:
...
def var_0_0.updateSelectedOrderTag(arg_10_0, arg_10_1):
	for iter_10_0, iter_10_1 in pairs(arg_10_0.selectedSnackTFList):
...
def var_0_0.openResultView(arg_11_0):
	arg_11_0.packageData = {
		...
		def onSubmit:(arg_12_0)
			arg_11_0.SendSuccess(arg_11_0.score)

			arg_11_0.score = 0
			arg_11_0.countTime = None
