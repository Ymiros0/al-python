...
def var_0_0.didEnter(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.exitSureBtn, function()
		...
		arg_5_0.enterResultUI(), SFX_PANEL)
	...
	eachChild(arg_5_0.cupContainer, function(arg_12_0)
		onButton(arg_5_0, arg_12_0, function()
			...
			arg_5_0.endRound(arg_5_0.selectIndex == arg_5_0.forkIndex), SFX_PANEL))
...
def var_0_0.initGameData(arg_14_0):
...
def var_0_0.playForkAni(arg_19_0, arg_19_1):
	...
	arg_19_0.managedTween(LeanTween.delayedCall, function()
		arg_19_0.managedTween(LeanTween.moveY, function()
			...
			if arg_19_1:
				arg_19_1(), arg_19_0.fork, -20, var_0_16).setEase(LeanTweenType.linear), 0.5, None)

def var_0_0.startSwap(arg_22_0, arg_22_1):
	if arg_22_1 < 1:
...
def var_0_0.swapCup(arg_24_0, arg_24_1, arg_24_2, arg_24_3):
	...
	arg_24_0.managedTween(LeanTween.moveX, None, arg_24_1, var_24_2.x, var_24_4).setEase(LeanTweenType.linear)
	arg_24_0.managedTween(LeanTween.moveX, function()
		if arg_24_3:
			arg_24_3(), arg_24_2, var_24_3.x, var_24_4).setEase(LeanTweenType.linear)

def var_0_0.startTimer(arg_26_0):
	local var_26_0 = arg_26_0.curTime

	arg_26_0.timer = Timer.New(function()
		arg_26_0.curTime = arg_26_0.curTime - 1

		if arg_26_0.curTime <= 0:
			arg_26_0.endRound(False)

		setText(arg_26_0.curTimeTxt, arg_26_0.curTime), 1, -1)

	arg_26_0.timer.Start()

def var_0_0.stopTimer(arg_28_0):
	if arg_28_0.timer:
		arg_28_0.timer.Stop()

		arg_28_0.timer = None

def var_0_0.pauseGame(arg_29_0):
...
def var_0_0.resumeGame(arg_30_0):
...
def var_0_0.endRound(arg_31_0, arg_31_1):
	arg_31_0.stopTimer()

	if arg_31_0.selectIndex:
		arg_31_0.playManjuuAni(arg_31_1)
	else
		arg_31_0.playTimeOutAni()
		arg_31_0.endGame()

def var_0_0.playManjuuAni(arg_32_0, arg_32_1):
	...
	arg_32_0.manjuuDft.SetEndEvent(function()
		arg_32_0.manjuuDft.SetEndEvent(None)
...
def var_0_0.playResultAni(arg_34_0, arg_34_1):
	...
	if arg_34_1:
		...
		arg_34_0.resultDft.SetEndEvent(function()
			arg_34_0.resultDft.SetEndEvent(None)
...
def var_0_0.showCorrectBar(arg_37_0):
	...
	LeanTween.value(go(arg_37_0.curScoreTxt), arg_37_0.curScore, var_37_3, var_37_1).setOnUpdate(System.Action_float(function(arg_39_0)
		setText(arg_37_0.curScoreTxt, math.ceil(arg_39_0)))).setOnComplete(System.Action(function()
	...
	LeanTween.value(go(arg_37_0.curTimeTxt), arg_37_0.curTime, 0, var_37_1).setOnUpdate(System.Action_float(function(arg_41_0)
		setText(arg_37_0.curTimeTxt, math.ceil(arg_41_0)))).setOnComplete(System.Action(function()
		arg_37_0.curScore = var_37_3
	...
	onButton(arg_37_0, arg_37_0.correctBar, function()
		...
		arg_37_0.startGame(), SFX_PANEL)
	arg_37_0.managedTween(LeanTween.delayedCall, function()
		if isActive(arg_37_0.correctBar):
			triggerButton(arg_37_0.correctBar), var_0_7, None)

def var_0_0.playTimeOutAni(arg_45_0):
	...
	arg_45_0.resultDft.SetEndEvent(function()
		arg_45_0.resultDft.SetEndEvent(None))

def var_0_0.endGame(arg_47_0):
	setActive(arg_47_0.failBar, True)
	onButton(arg_47_0, arg_47_0.failBar, function()
		setActive(arg_47_0.failBar, False)
		arg_47_0.enterResultUI(), SFX_PANEL)
	arg_47_0.managedTween(LeanTween.delayedCall, function()
		if isActive(arg_47_0.failBar):
			triggerButton(arg_47_0.failBar), var_0_7, None)

def var_0_0.enterResultUI(arg_50_0):
	...
	if arg_50_0.GetMGHubData().count > 0:
		arg_50_0.SendSuccess(0)

def var_0_0.OnGetAwardDone(arg_51_0, arg_51_1):
	if arg_51_1.cmd == MiniGameOPCommand.CMD_COMPLETE:
		local var_51_0 = arg_51_0.GetMGHubData()

		if var_51_0.ultimate == 0 and var_51_0.usedtime >= var_51_0.getConfig("reward_need"):
