	...
	local var_1_0 = {
		def Ctor:(arg_2_0)
			...
			PoolMgr.GetInstance().GetSpineChar(var_2_0, True, function(arg_3_0)
				...
				arg_2_0.changeWorkerAction(var_0_20, 0, None))
			...
			if #arg_7_0.selectedGifts >= var_0_16:
				arg_7_0._event.emit(var_0_11, Clone(arg_7_0.selectedGifts), function(arg_8_0, arg_8_1)
					if not arg_8_0:
						...
						arg_7_0.changeWorkerAction(var_0_20, 0, None)
		...
		def moveJiujiu:(arg_11_0, arg_11_1, arg_11_2)
			if arg_11_1 == -1:
				arg_11_0._workerTf.localScale = Vector3.New(-1, 1, 1)

				if arg_11_2 and arg_11_2 > 0:
	...
	local var_13_0 = {
		...
		def createIdol:(arg_15_0, arg_15_1, arg_15_2)
			...
			PoolMgr.GetInstance().GetSpineChar(var_15_0, True, function(arg_16_0)
				...
				arg_15_0.changeCharAction(var_0_19, 0, None)),
		def getFansAmount:(arg_17_0)
			return #arg_17_0.fans,
		def changeCharAction:(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
			if arg_18_0.modelData.actionName == arg_18_1:
				return

			arg_18_0.modelData.actionName = arg_18_1

			arg_18_0.modelData.anim.SetActionCallBack(None)
			...
			if arg_18_2 != 1 and arg_18_3:
				arg_18_3(),
		def createFans:(arg_20_0, arg_20_1)
		...
		def changeFansAction:(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4)
			if not arg_22_1.modelData or arg_22_1.modelData.actionName == arg_22_2:
				return

			arg_22_1.modelData.actionName = arg_22_2

			arg_22_1.modelData.anim.SetActionCallBack(None)
			...
			if arg_22_3 != 1 and arg_22_4:
				arg_22_4(),
		def getWantedGifts:(arg_24_0)
			if #arg_24_0.fans > 0 and arg_24_0.fans[1].gifts and not arg_24_0.fans[1].leave:
				return arg_24_0.fans[1].gifts

			return None,
		def clearFans:(arg_25_0)
			for iter_25_0 = 1, #arg_25_0.fans:
			...
			for iter_27_0 = #arg_27_0.fans, 1, -1:
				...
				if var_27_2.x > (iter_27_0 - 1) * var_0_33:
					...
					if var_27_0.gifts == None:
						...
						arg_27_0.changeFansAction(var_27_0, var_0_25, 0, None)
						arg_27_0.changeCharAction(var_0_18, 1, function()
							arg_27_0.changeCharAction(var_0_19, 0, None))
				elif not var_27_0.leave:
					arg_27_0.changeFansAction(var_27_0, var_0_26, 0, None)

			if #arg_27_0.fans > 0:
				local var_27_4 = arg_27_0.fans[1]

				if var_27_4.time and arg_27_1 > var_27_4.time and not var_27_4.leave:
					var_27_4.leave = True
		...
		def showFansWanted:(arg_30_0, arg_30_1)
			if arg_30_1.leave:
				return
		...
		def checkGifts:(arg_31_0, arg_31_1)
			local var_31_0 = arg_31_0.getWantedGifts()

			if var_31_0:
				for iter_31_0 = 1, #arg_31_1:
					if not table.contains(var_31_0, arg_31_1[iter_31_0]):
						return False

				return True

			return False,
		def getGiftTime:(arg_32_0)
			if #arg_32_0.fans > 0 and arg_32_0.fans[1] and arg_32_0.fans[1].time:
				return arg_32_0.fans[1].time

			return None,
		def finishGift:(arg_33_0)
			if arg_33_0.getWantedGifts():
				...
				arg_33_0.changeCharAction(var_0_17, 1, function()
					arg_33_0.changeCharAction(var_0_19, 0, None)),
		def createWantedGifts:(arg_36_0)
			...
			return var_36_1,
		def fanLeave:(arg_37_0, arg_37_1, arg_37_2, arg_37_3)
			setActive(findTF(arg_37_1.tf, "wanted"), False)

			local var_37_0

			if var_0_29 == arg_37_2:
				var_37_0 = var_0_24
			elif var_0_30:
				var_37_0 = var_0_23
		...
		def reset:(arg_39_0)
			...
			arg_39_0.wantedData = {},
		def destroy:(arg_40_0)
			if arg_40_0.modelData:
...
local function var_0_41(arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	local var_41_0 = {
		...
		def receiveGift:(arg_44_0, arg_44_1, arg_44_2)
			local var_44_0 = False
			local var_44_1
			local var_44_2

			for iter_44_0 = 1, #arg_44_0.groups:
				if arg_44_0.groups[iter_44_0].checkGifts(arg_44_1):
					var_44_0 = True

					if not var_44_1:
						var_44_1 = arg_44_0.groups[iter_44_0]
						var_44_2 = iter_44_0
					elif var_44_1.getGiftTime() > arg_44_0.groups[iter_44_0].getGiftTime():
						var_44_1 = arg_44_0.groups[iter_44_0]
						var_44_2 = iter_44_0
		...
		def getRandomIdols:(arg_45_0)
			...
			for iter_45_0 = #var_45_0 + 1, var_0_31:
				table.insert(var_45_0, table.remove(var_45_1, math.random(1, #var_45_1)))

			local var_45_2 = {}

			for iter_45_1 = 1, var_0_31:
				table.insert(var_45_2, table.remove(var_45_0, math.random(1, #var_45_0)))

			return var_45_2,
		def getApearTime:(arg_46_0)
			if arg_46_0.lastTime and arg_46_0.lastTime > 0:
				for iter_46_0 = 1, #var_0_6:
					if arg_46_0.lastTime < var_0_6[iter_46_0][1]:
						return var_0_6[iter_46_0][2]

			return var_0_6[#var_0_6][2],
		def getFansAmount:(arg_47_0)
			local var_47_0 = 0

			for iter_47_0 = 1, #arg_47_0.groups:
		...
		def start:(arg_48_0)
			...
			for iter_48_1 = 1, #arg_48_0.groups:
				arg_48_0.groups[iter_48_1].start(),
		def step:(arg_49_0, arg_49_1)
			arg_49_0.lastTime = arg_49_0.lastTime - Time.deltaTime

			if not arg_49_0.createFansTime:
				arg_49_0.createFansTime = arg_49_1 + arg_49_0.getApearTime() + math.random() * 1
			elif arg_49_1 > arg_49_0.createFansTime and arg_49_0.getFansAmount() <= 10:
			...
			for iter_49_0 = 1, #arg_49_0.groups:
				arg_49_0.groups[iter_49_0].step(arg_49_1),
		def reset:(arg_50_0)
			for iter_50_0 = 1, #arg_50_0.groups:
				arg_50_0.groups[iter_50_0].reset(),
		def destroy:(arg_51_0)
			for iter_51_0 = 1, #arg_51_0.groups:
...
def var_0_0.getUIName(arg_52_0):
	return "IdolMasterGameUI"

def var_0_0.getBGM(arg_53_0):
	return var_0_1[math.random(1, #var_0_1)]

def var_0_0.didEnter(arg_54_0):
	arg_54_0.initEvent()
	arg_54_0.initData()
	arg_54_0.initUI()
	arg_54_0.initGameUI()
...
def var_0_0.initUI(arg_60_0):
	...
	onButton(arg_60_0, findTF(arg_60_0.settlementUI, "ad/btnOver"), function()
		...
		arg_60_0.openMenuUI(), SFX_CANCEL)
	...
	onButton(arg_60_0, findTF(arg_60_0.menuUI, "rightPanelBg/arrowUp"), function()
		...
		scrollTo(arg_60_0.battleScrollRect, 0, var_67_0), SFX_CANCEL)
	onButton(arg_60_0, findTF(arg_60_0.menuUI, "rightPanelBg/arrowDown"), function()
		...
		scrollTo(arg_60_0.battleScrollRect, 0, var_68_0), SFX_CANCEL)
	onButton(arg_60_0, findTF(arg_60_0.menuUI, "btnBack"), function()
		arg_60_0.closeView(), SFX_CANCEL)
...
def var_0_0.initTextTip(arg_78_0):
...
def var_0_0.Update(arg_79_0):
	arg_79_0.AddDebugInput()

def var_0_0.AddDebugInput(arg_80_0):
	if arg_80_0.gameStop or arg_80_0.settlementFlag:
		return

	if IsUnityEditor:
		-- block empty

def var_0_0.updateMenuUI(arg_81_0):
	local var_81_0 = arg_81_0.getGameUsedTimes()
	local var_81_1 = arg_81_0.getGameTimes()

	for iter_81_0 = 1, #arg_81_0.battleItems:
...
def var_0_0.CheckGet(arg_82_0):
	setActive(findTF(arg_82_0.menuUI, "got"), False)

	if arg_82_0.getUltimate() and arg_82_0.getUltimate() != 0:
		setActive(findTF(arg_82_0.menuUI, "got"), True)

	if arg_82_0.getUltimate() == 0:
		if arg_82_0.getGameTotalTime() > arg_82_0.getGameUsedTimes():
			return
...
def var_0_0.openMenuUI(arg_83_0):
	...
	if arg_83_0.storyIndex and var_0_7[arg_83_0.storyIndex] != "" and arg_83_0.getGameUsedTimes() == arg_83_0.storyIndex:
		pg.NewStoryMgr.GetInstance().Play(var_0_7[arg_83_0.storyIndex], function()
			return, True)

		arg_83_0.storyIndex = None

	arg_83_0.updateMenuUI()

def var_0_0.clearUI(arg_85_0):
...
def var_0_0.readyStart(arg_86_0):
...
def var_0_0.gameStart(arg_87_0):
...
def var_0_0.getGameTimes(arg_88_0):
	return arg_88_0.GetMGHubData().count

def var_0_0.getGameUsedTimes(arg_89_0):
	return arg_89_0.GetMGHubData().usedtime

def var_0_0.getUltimate(arg_90_0):
	return arg_90_0.GetMGHubData().ultimate

def var_0_0.getGameTotalTime(arg_91_0):
	return (arg_91_0.GetMGHubData().getConfig("reward_need"))

def var_0_0.changeSpeed(arg_92_0, arg_92_1):
	return

def var_0_0.onTimer(arg_93_0):
	arg_93_0.gameStep()

def var_0_0.gameStep(arg_94_0):
	arg_94_0.gameTime = arg_94_0.gameTime - Time.deltaTime

	if arg_94_0.gameTime < 0:
		arg_94_0.gameTime = 0

	arg_94_0.gameStepTime = arg_94_0.gameStepTime + Time.deltaTime

	if arg_94_0.idolGroupUI:
...
def var_0_0.timerStart(arg_95_0):
	if not arg_95_0.timer.running:
		arg_95_0.timer.Start()

def var_0_0.timerStop(arg_96_0):
	if arg_96_0.timer.running:
		arg_96_0.timer.Stop()

def var_0_0.updateGameUI(arg_97_0):
	...
	for iter_97_0 = 1, #arg_97_0.heartTfs:
		if iter_97_0 <= arg_97_0.heart:
...
def var_0_0.loseHeart(arg_98_0):
	if arg_98_0.heart <= 0:
		return
...
def var_0_0.addScore(arg_99_0, arg_99_1):
	arg_99_0.scoreNum = arg_99_0.scoreNum + arg_99_1

	if arg_99_0.scoreNum < 0:
		arg_99_0.scoreNum = 0

def var_0_0.onGameOver(arg_100_0):
	if arg_100_0.settlementFlag:
		return
...
def var_0_0.showSettlement(arg_102_0):
...
def var_0_0.stopGame(arg_104_0):
	arg_104_0.gameStop = True

	arg_104_0.timerStop()
	arg_104_0.changeSpeed(0)

def var_0_0.onBackPressed(arg_105_0):
	if not arg_105_0.gameStartFlag:
		arg_105_0.emit(var_0_0.ON_BACK_PRESSED)
	else
		if arg_105_0.settlementFlag:
			return

		if isActive(arg_105_0.pauseUI):
			setActive(arg_105_0.pauseUI, False)

		arg_105_0.stopGame()
		setActive(arg_105_0.leaveUI, True)

def var_0_0.willExit(arg_106_0):
	if arg_106_0.handle:
		UpdateBeat.RemoveListener(arg_106_0.handle)

	if arg_106_0._tf and LeanTween.isTweening(go(arg_106_0._tf)):
		LeanTween.cancel(go(arg_106_0._tf))

	if arg_106_0.timer and arg_106_0.timer.running:
		arg_106_0.timer.Stop()

	Time.timeScale = 1
	arg_106_0.timer = None
