...
def var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5):
	...
	for iter_1_0, iter_1_1 in ipairs(var_0_23):
	...
	arg_1_0.setAmuletL(None)

	arg_1_0.amuletS = None
	arg_1_0.amuletEFs = {}
	arg_1_0.amuletLPool = {}
	arg_1_0.amuletSPool = {}
...
def var_0_0.step(arg_3_0):
	if not arg_3_0.isPlaying:
		if LaunchBallGameVo.joyStickData and LaunchBallGameVo.joyStickData.angle:
	...
	if arg_3_0._amuletFires and #arg_3_0._amuletFires > 0:
		for iter_3_0 = #arg_3_0._amuletFires, 1, -1:
			...
			if var_3_0.effectTime and var_3_0.effectTime > 0:
				var_3_0.effectTime = var_3_0.effectTime - LaunchBallGameVo.deltaTime

				if var_3_0.effectTime <= 0:
					var_3_0.effectTime = var_0_21

					arg_3_0.createEF(var_3_0)

			if math.abs(var_3_1.x) > var_0_20 or math.abs(var_3_1.y) > var_0_20:
				table.remove(arg_3_0._amuletFires, iter_3_0)
				arg_3_0.returnAmulete(var_3_0, arg_3_0.amuletLPool)
			elif var_3_0.removeFlag:
				table.remove(arg_3_0._amuletFires, iter_3_0)
				arg_3_0.returnAmulete(var_3_0, arg_3_0.amuletLPool)
			elif arg_3_0.lifeBound:
				if var_3_1.x >= arg_3_0.max.x or var_3_1.x <= arg_3_0.min.x:
					table.remove(arg_3_0._amuletFires, iter_3_0)
					arg_3_0.returnAmulete(var_3_0, arg_3_0.amuletLPool)
				elif var_3_1.y >= arg_3_0.max.y or var_3_1.y <= arg_3_0.min.y:
					table.remove(arg_3_0._amuletFires, iter_3_0)
					arg_3_0.returnAmulete(var_3_0, arg_3_0.amuletLPool)

	if arg_3_0.butterflys and #arg_3_0.butterflys > 0:
		for iter_3_1 = #arg_3_0.butterflys, 1, -1:
			...
			if math.abs(var_3_3.x) > var_0_20 or math.abs(var_3_3.y) > var_0_20:
				var_3_2.anim = None

				Destroy(var_3_2.tf)
				table.remove(arg_3_0.butterflys, iter_3_1)
			elif var_3_2.removeFlag:
				var_3_2.anim = None

				Destroy(var_3_2.tf)
				table.remove(arg_3_0.butterflys, iter_3_1)
			elif var_3_3.x >= arg_3_0.max.x or var_3_3.x <= arg_3_0.min.x:
				var_3_2.anim = None

				Destroy(var_3_2.tf)
				table.remove(arg_3_0.butterflys, iter_3_1)
			elif var_3_3.y >= arg_3_0.max.y or var_3_3.y <= arg_3_0.min.y:
				var_3_2.anim = None

				Destroy(var_3_2.tf)
				table.remove(arg_3_0.butterflys, iter_3_1)
			elif var_3_2.removeTime and var_3_2.removeTime > 0:
				var_3_2.removeTime = var_3_2.removeTime - LaunchBallGameVo.deltaTime

				if var_3_2.removeTime < 0:
					var_3_2.removeTime = None
					var_3_2.removeFlag = True

	if arg_3_0.amuletEFs and #arg_3_0.amuletEFs > 0:
		for iter_3_2 = #arg_3_0.amuletEFs, 1, -1:
			local var_3_4 = arg_3_0.amuletEFs[iter_3_2]

			if var_3_4.removeTime and var_3_4.removeTime > 0:
				var_3_4.removeTime = var_3_4.removeTime - LaunchBallGameVo.deltaTime

				if var_3_4.removeTime <= 0:
					table.remove(arg_3_0.amuletEFs, iter_3_2)
					arg_3_0.returnAmulete(var_3_4, arg_3_0.amuletEFPool)

def var_0_0.getFireAmulet(arg_4_0):
	return arg_4_0._amuletFires

def var_0_0.removeFireAmulet(arg_5_0, arg_5_1):
	if arg_5_0._amuletFires and #arg_5_0._amuletFires > 0:
		for iter_5_0 = #arg_5_0._amuletFires, 1, -1:
...
def var_0_0.getAmulete(arg_6_0, arg_6_1, arg_6_2):
	local var_6_0
	local var_6_1
	local var_6_2
	local var_6_3
...
def var_0_0.returnAmulete(arg_7_0, arg_7_1, arg_7_2):
	setActive(arg_7_1.tf, False)
	table.insert(arg_7_2, arg_7_1)

def var_0_0.getColor(arg_8_0):
	return arg_8_0.amuletL.color

def var_0_0.fireAmulet(arg_9_0):
	if arg_9_0.amuletL:
		...
		if arg_9_0.concentrateTime:
			arg_9_0.amuletL.concentrate = True
			arg_9_0.concentrateTime = arg_9_0.concentrateTime - 1

			if arg_9_0.concentrateTime <= 0:
				arg_9_0.concentrateTime = None

		table.insert(arg_9_0._amuletFires, arg_9_0.amuletL)
		arg_9_0.setAmuletL(None)

def var_0_0.randomFireAmulet(arg_10_0, arg_10_1):
	pg.CriMgr.GetInstance().PlaySoundEffect_V3(LaunchBallGameVo.SFX_FIRE)
...
def var_0_0.setAmuletL(arg_11_0, arg_11_1):
	arg_11_0.amuletL = arg_11_1
	LaunchBallGameVo.amulet = arg_11_0.amuletL

def var_0_0.createEF(arg_12_0, arg_12_1):
...
def var_0_0.getRandomAmuletType(arg_13_0):
	if not LaunchBallGameVo.enemyColors or #LaunchBallGameVo.enemyColors == 0:
		return var_0_8[math.random(1, #var_0_8)]
	else
		return LaunchBallGameVo.enemyColors[math.random(1, #LaunchBallGameVo.enemyColors)]

def var_0_0.getAnimator(arg_14_0, arg_14_1, arg_14_2):
	local var_14_0

	if arg_14_1 == var_0_10:
		var_14_0 = arg_14_0.amuletLAnimators
	elif arg_14_1 == var_0_9:
		var_14_0 = arg_14_0.amuletSAnimators
	elif arg_14_1 == var_0_11:
		var_14_0 = arg_14_0.amuletEFAnimators

	for iter_14_0 = 1, #var_14_0:
		if var_14_0[iter_14_0].type == arg_14_2:
			return var_14_0[iter_14_0].animator

def var_0_0.getAmuletPos(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.getAngle(arg_16_0):
	return arg_16_0.angle

def var_0_0.eventCall(arg_17_0, arg_17_1, arg_17_2):
	if arg_17_1 == LaunchBallGameScene.PLAYING_CHANGE:
		arg_17_0.isPlaying = arg_17_2
	elif arg_17_1 == LaunchBallGameScene.FIRE_AMULET:
		arg_17_0.fireAmulet()
	elif arg_17_1 == LaunchBallGameScene.RANDOM_FIRE:
		local var_17_0 = arg_17_2.num
		local var_17_1 = arg_17_2.data

		for iter_17_0 = 1, var_17_0:
			arg_17_0.randomFireAmulet(var_17_1)
	elif arg_17_1 == LaunchBallGameScene.CHANGE_AMULET:
		if arg_17_0.changeTime and LaunchBallGameVo.gameStepTime - arg_17_0.changeTime < 1:
			return
		...
		if arg_17_0.amuletL:
			...
			arg_17_0.setAmuletL(None)
	elif arg_17_1 == LaunchBallGameScene.CONCENTRATE_TRIGGER:
		arg_17_0.concentrateTime = arg_17_2.time
	elif arg_17_1 == LaunchBallGameScene.SLEEP_TIME_TRIGGER:
		print("创建一个小蝴蝶")

		local var_17_2 = arg_17_0.createButterfly()

def var_0_0.getButterfly(arg_18_0):
	return arg_18_0.butterflys

def var_0_0.createButterfly(arg_19_0):
