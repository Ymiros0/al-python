...
def var_0_0.stopGame(arg_50_0):
	...
	arg_50_0.managedTween(LeanTween.value, function()
		...
		arg_50_0.managedTween(LeanTween.value, function()
			...
			if arg_50_0.infinite or arg_50_0.timer and arg_50_0.timer.time <= 0:
				if not arg_50_0.infinite:
					arg_50_0.SendSuccess(0)

				if arg_50_0.score > arg_50_0.best:
					arg_50_0.StoreDataToServer({
						arg_50_0.score
					})

			arg_50_0.timer = None, go(arg_50_0.endBtn), 0, 1, var_0_19).setOnUpdate(System.Action_float(function(arg_53_0)
