...
def var_0_0.SetAkashiObject(arg_2_0, arg_2_1):
	arg_2_0.akashiControl = arg_2_1

def var_0_0.AddOreObject(arg_3_0, arg_3_1, arg_3_2):
	arg_3_0.oreMap[arg_3_1] = arg_3_2

def var_0_0.RemoveOreObject(arg_4_0, arg_4_1, arg_4_2):
	arg_4_0.oreMap[arg_4_1] = None

def var_0_0.AddEnemyObject(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	if not arg_5_0.enemyMap[arg_5_1]:
		arg_5_0.enemyMap[arg_5_1] = {}

	arg_5_0.enemyMap[arg_5_1][arg_5_2] = arg_5_3

def var_0_0.RemoveEnemyObject(arg_6_0, arg_6_1, arg_6_2, arg_6_3):
	arg_6_0.enemyMap[arg_6_1][arg_6_2] = None

def var_0_0.Reset(arg_7_0):
	arg_7_0.oreMap = {}
	arg_7_0.enemyMap = {}
	arg_7_0.oreTarget = ""
...
local function var_0_1(arg_8_0, arg_8_1)
	...
	if var_8_3 > var_8_0.x and var_8_4 > var_8_0.y:
		return True
...
def var_0_0.GetCarryOreTarget(arg_14_0):
	local var_14_0
	local var_14_1
	...
	for iter_14_0, iter_14_1 in pairs(arg_14_0.oreMap):
		local var_14_6 = iter_14_1.GetCollisionInfo().pos

		if var_0_2(var_14_4, var_14_5, var_14_6):
			local var_14_7 = Vector2.Distance(var_14_5, var_14_6)

			if var_14_7 <= var_14_3 and (not var_14_1 or var_14_7 <= var_14_1):
				var_14_0, var_14_1 = iter_14_0, var_14_7

	if var_14_0 and var_14_1:
		return var_14_0

	for iter_14_2, iter_14_3 in pairs(arg_14_0.oreMap):
		local var_14_8 = iter_14_3.GetCollisionInfo().pos
		local var_14_9 = Vector2.Distance(var_14_5, var_14_8)

		if var_14_9 <= var_14_2 and (not var_14_1 or var_14_9 <= var_14_1):
			var_14_0, var_14_1 = iter_14_2, var_14_9

	return var_14_0 or ""

def var_0_0.UpdateOreStatus(arg_15_0):
	local var_15_0 = arg_15_0.GetCarryOreTarget()

	if arg_15_0.oreTarget != var_15_0:
...
def var_0_0.UpdateAkashiCollision(arg_16_0):
	if arg_16_0.akashiControl.IsInvincible():
		return

	local var_16_0 = arg_16_0.akashiControl.GetCollisionInfo()

	for iter_16_0, iter_16_1 in pairs(arg_16_0.enemyMap):
		for iter_16_2, iter_16_3 in pairs(iter_16_1):
			local var_16_1 = iter_16_3.GetCollisionInfo()

			if var_0_1(var_16_0, var_16_1):
...
def var_0_0.UpdateEnemyCollision(arg_17_0):
	for iter_17_0, iter_17_1 in pairs(arg_17_0.enemyMap):
		local var_17_0 = {}

		for iter_17_2, iter_17_3 in pairs(iter_17_1):
			if not var_17_0[iter_17_2]:
				var_17_0[iter_17_2] = {}

			local var_17_1 = iter_17_3.GetCollisionInfo()

			for iter_17_4, iter_17_5 in pairs(iter_17_1):
				if not var_17_0[iter_17_4]:
					var_17_0[iter_17_4] = {}

				if iter_17_4 != iter_17_2 and not var_17_0[iter_17_2][iter_17_4] and not var_17_0[iter_17_4][iter_17_2]:
					local var_17_2 = iter_17_5.GetCollisionInfo()

					if var_0_1(var_17_1, var_17_2):
...
def var_0_0.OnTimer(arg_18_0, arg_18_1):
