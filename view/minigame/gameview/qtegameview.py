...
def var_0_0.didEnter(arg_7_0):
	...
	onButton(arg_7_0, arg_7_0.backBtn, function()
		arg_7_0.setGameState(arg_7_0.STATE_BEGIN), SFX_PANEL)
	onButton(arg_7_0, arg_7_0.qBtn, function()
		arg_7_0.emit(var_0_0.ON_BACK), SFX_PANEL)
	...
	onButton(arg_7_0, arg_7_0.startBtn, function()
		...
		parallelAsync({
			...
			arg_7_0.setGameState(arg_7_0.STATE_COUNT)), SFX_PANEL)
...
def var_0_0.setGameState(arg_27_0, arg_27_1):
	if arg_27_1 == arg_27_0.gameState:
		return
	...
	if arg_27_0.gameState == arg_27_0.STATE_BEGIN:
		...
		arg_27_0.managedTween(LeanTween.delayedCall, function()
			...
			arg_27_0.setGameState(arg_27_0.STATE_CLICK), 3, None).setOnUpdate(System.Action_float(function(arg_30_0)
			setText(arg_27_0.countNumTxt, math.ceil(3 - (Time.realtimeSinceStartup - var_27_1)))))
	elif arg_27_0.gameState == arg_27_0.STATE_CLICK:
		var_27_0({
			arg_27_0.content,
			arg_27_0.keyUI,
			arg_27_0.keyBar
		...
		if var_27_3 and #var_27_3 > 0:
			var_27_2 = var_27_3[1]

		if var_27_2 < arg_27_0.score:
...
def var_0_0.fireBlocks(arg_31_0):
	...
	if var_31_3:
		if var_31_1 == arg_31_0.TYPE_A:
			var_31_6 = arg_31_0.aPos
		elif var_31_1 == arg_31_0.TYPE_B:
			var_31_6 = arg_31_0.bPos
		elif var_31_1 == arg_31_0.TYPE_C:
		...
		if var_31_3:
			...
			if var_31_1 == arg_31_0.TYPE_A:
				...
				arg_31_0.managedTween(LeanTween.delayedCall, function()
					arg_31_0.setBucketBAction("attack"), 0.2, None)
			elif var_31_1 == arg_31_0.TYPE_C:
				var_32_0 = 0.3
				var_32_1 = arg_31_0.parabolaMove_center
	...
	arg_31_0.managedTween(LeanTween.delayedCall, function()
		arg_31_0.setGuinuAction("action"), 0.2, None)

def var_0_0.getRandomList(arg_37_0):
	if not arg_37_0.allList:
		arg_37_0.allList = {}

		for iter_37_0 = 1, arg_37_0.typeNum:
			for iter_37_1 = 1, arg_37_0.idNum:
	...
	for iter_37_2 = 1, arg_37_0.limitNum:
	...
	for iter_37_3, iter_37_4 in ipairs(var_37_1):
		local var_37_5 = arg_37_0.getShowBlock(iter_37_4.type, iter_37_4.id)

		if var_37_2:
			var_37_2.nextBlock = var_37_5

		if iter_37_3 >= arg_37_0.limitNum:
			var_37_5.nextBlock = None
...
def var_0_0.hideRandomList(arg_38_0):
...
def var_0_0.countScore(arg_39_0, arg_39_1):
	if arg_39_1:
		local var_39_0

		for iter_39_0, iter_39_1 in ipairs(arg_39_0.comboRange):
			if iter_39_1 > arg_39_0.comboNum:
				var_39_0 = iter_39_0 - 1

				break
			elif iter_39_0 == #arg_39_0.comboRange:
	...
	if arg_39_0.comboNum > arg_39_0.bestComboNum:
...
def var_0_0.getUserResult(arg_40_0):
	local var_40_0 = {}
...
def var_0_0.playArchiveAnim(arg_41_0, arg_41_1, arg_41_2):
...
def var_0_0.checkPlayFinished(arg_42_0):
	if arg_42_0.opIndex >= #arg_42_0.opList and arg_42_0.remainTime > 0:
		arg_42_0.setGameState(arg_42_0.STATE_CLICK)

def var_0_0.checkEnd(arg_43_0, arg_43_1):
	if arg_43_1 >= #arg_43_0.opList and arg_43_0.remainTime <= 0:
		arg_43_0.setGameState(arg_43_0.STATE_END)

def var_0_0.parabolaMove(arg_44_0, arg_44_1, arg_44_2, arg_44_3, arg_44_4):
	arg_44_0.managedTween(LeanTween.rotate, None, arg_44_1, 135, arg_44_2)
	arg_44_0.managedTween(LeanTween.moveX, None, arg_44_1, arg_44_3.x, arg_44_2).setEase(LeanTweenType.linear)
	arg_44_0.managedTween(LeanTween.moveY, function()
		if arg_44_4:
			arg_44_4(), arg_44_1, arg_44_3.y, arg_44_2).setEase(LeanTweenType.easeInQuad)

def var_0_0.parabolaMove_center(arg_46_0, arg_46_1, arg_46_2, arg_46_3, arg_46_4):
	arg_46_0.managedTween(LeanTween.rotate, None, arg_46_1, 135, arg_46_2)
	arg_46_0.managedTween(LeanTween.moveX, None, arg_46_1, arg_46_3.x, arg_46_2).setEase(LeanTweenType.easeOutQuad)
	arg_46_0.managedTween(LeanTween.moveY, function()
		if arg_46_4:
			arg_46_4(), arg_46_1, arg_46_3.y, arg_46_2).setEase(LeanTweenType.linear)

def var_0_0.hitFly(arg_48_0, arg_48_1, arg_48_2, arg_48_3, arg_48_4):
	arg_48_0.managedTween(LeanTween.rotate, None, arg_48_1, 135, arg_48_2)
	arg_48_0.managedTween(LeanTween.moveX, None, arg_48_1, arg_48_3.x, arg_48_2).setEase(LeanTweenType.linear)
	arg_48_0.managedTween(LeanTween.moveY, function()
		if arg_48_4:
			arg_48_4(), arg_48_1, arg_48_3.y, arg_48_2).setEase(LeanTweenType.easeOutQuad)

def var_0_0.loadXGM(arg_50_0, arg_50_1):
	if arg_50_0.xgm:
		arg_50_1()
	else
...
def var_0_0.initXGM(arg_52_0):
	arg_52_0.xgmSpine.SetActionCallBack(function(arg_53_0)
		if arg_53_0 == "FIRE":
			arg_52_0.fireBlocks()
		elif arg_53_0 == "FINISH":
			if arg_52_0.opIndex < #arg_52_0.opList:
...
def var_0_0.loadGuinu(arg_54_0, arg_54_1):
	if arg_54_0.guinu:
		arg_54_1()
	else
...
def var_0_0.initGuinu(arg_56_0):
...
def var_0_0.setXgmAction(arg_58_0, arg_58_1):
	if not arg_58_0.xgm:
		return
...
def var_0_0.setGuinuAction(arg_59_0, arg_59_1):
	if not arg_59_0.guinu:
		return
...
def var_0_0.setBucketAAction(arg_60_0, arg_60_1):
...
def var_0_0.setBucketBAction(arg_61_0, arg_61_1):
...
def var_0_0.showBucketAEffect(arg_62_0):
	...
	local function var_62_0()
		...
		arg_62_0.managedTween(LeanTween.delayedCall, function()
			arg_62_0.recycleBucketAEffect(var_63_0), 2, None)

	if #arg_62_0.aEffectList == 0:
		arg_62_0.autoLoader.LoadPrefab("effect/xinnianyouxi_baozha", None, function(arg_65_0)
...
def var_0_0.recycleBucketAEffect(arg_66_0, arg_66_1):
	for iter_66_0 = #arg_66_0.aEffectUsingList, 1, -1:
		if arg_66_0.aEffectUsingList[iter_66_0] == arg_66_1:
			setActive(arg_66_1, False)

			arg_66_0.aEffectList[#arg_66_0.aEffectList + 1] = table.remove(arg_66_0.aEffectUsingList, iter_66_0)

def var_0_0.getBlock(arg_67_0, arg_67_1, arg_67_2):
	local var_67_0 = arg_67_1 .. "-" .. arg_67_2

	if not arg_67_0.blockPool:
		arg_67_0.blockPool = {}
	...
	if #arg_67_0.blockPool[var_67_0] > 0:
...
def var_0_0.recycleBlock(arg_68_0, arg_68_1):
...
def var_0_0.msHoldBlock(arg_69_0, arg_69_1):
...
def var_0_0.msClearHold(arg_70_0):
	for iter_70_0 = #arg_70_0.msBlockList, 1, -1:
		arg_70_0.removeUsingBlock(table.remove(arg_70_0.msBlockList, iter_70_0))

def var_0_0.addUsingBlock(arg_71_0, arg_71_1):
	arg_71_0.usingBlockList[#arg_71_0.usingBlockList + 1] = arg_71_1

def var_0_0.removeUsingBlock(arg_72_0, arg_72_1):
	for iter_72_0 = #arg_72_0.usingBlockList, 1, -1:
		if arg_72_0.usingBlockList[iter_72_0].uid == arg_72_1.uid:
			arg_72_0.recycleBlock(arg_72_0.usingBlockList[iter_72_0])
			table.remove(arg_72_0.usingBlockList, iter_72_0)

def var_0_0.clearUsingBlock(arg_73_0):
	for iter_73_0 = #arg_73_0.usingBlockList, 1, -1:
		arg_73_0.recycleBlock(arg_73_0.usingBlockList[iter_73_0])
		table.remove(arg_73_0.usingBlockList, iter_73_0)

def var_0_0.getShowBlock(arg_74_0, arg_74_1, arg_74_2):
	...
	if arg_74_0.showBlockDic[var_74_0]:
...
def var_0_0.startGameTimer(arg_79_0):
	...
	local function var_79_0()
		...
		if arg_79_0.remainTime <= 0:
			arg_79_0.remainTimer.Stop()

	if arg_79_0.remainTimer:
...
def var_0_0.startRoundTimer(arg_81_0):
	...
	local function var_81_0()
		...
		if arg_81_0.roundTime <= 0:
			arg_81_0.roundTimer.Stop()

			if not QTEGAME_DEBUG:
				arg_81_0.setGameState(arg_81_0.STATE_SHOW)

	if arg_81_0.roundTimer:
...
def var_0_0.clearTimer(arg_83_0):
	if arg_83_0.remainTimer:
		arg_83_0.remainTimer.Stop()

		arg_83_0.remainTimer = None

	if arg_83_0.roundTimer:
		arg_83_0.roundTimer.Stop()

		arg_83_0.roundTimer = None

def var_0_0.OnSendMiniGameOPDone(arg_84_0, arg_84_1):
	local var_84_0 = arg_84_1.argList

	if arg_84_1.cmd == MiniGameOPCommand.CMD_COMPLETE and var_84_0[1] == 0:
		arg_84_0.SendOperator(MiniGameOPCommand.CMD_SPECIAL_GAME, {
			arg_84_0.GetMGData().GetSimpleValue("shrineGameId"),
			1
		})

def var_0_0.checkHelp(arg_85_0):
	if PlayerPrefs.GetInt("QTEGameGuide", 0) == 0:
		triggerButton(arg_85_0.ruleBtn)
		PlayerPrefs.SetInt("QTEGameGuide", 1)
		PlayerPrefs.Save()

def var_0_0.willExit(arg_86_0):
	arg_86_0.clearTimer()
	...
	arg_86_0.xgm = None
	arg_86_0.xgmSpine = None
	arg_86_0.xgmSklGraphic = None
	arg_86_0.guinu = None
	arg_86_0.guinuSpine = None
	arg_86_0.guinuSklGraphic = None
