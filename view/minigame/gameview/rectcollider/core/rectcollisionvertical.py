...
def var_0_0.DescendSlope(arg_1_0, arg_1_1, arg_1_2):
	...
	local var_1_5, var_1_6 = Physics.Raycast(arg_1_2.bottomLeft, Vector3.down, None, var_1_3, var_1_4)
	local var_1_7, var_1_8 = Physics.Raycast(arg_1_2.bottomRight, Vector3.down, None, var_1_3, var_1_4)

	if var_1_5 or var_1_7:
		local var_1_9 = False

		if var_1_5 and not var_1_7 or not var_1_5 and var_1_7:
			var_1_9 = True
		else
			local var_1_10 = Vector3.Angle(var_1_6.normal, Vector3.up)
			local var_1_11 = Vector3.Angle(var_1_8.normal, Vector3.up)

			if var_1_10 <= arg_1_1.config.maxSlopeAngle and var_1_11 > arg_1_1.config.maxSlopeAngle:
				var_1_9 = True
			elif var_1_10 > arg_1_1.config.maxSlopeAngle and var_1_11 <= arg_1_1.config.maxSlopeAngle:
				var_1_9 = True
	...
	if not arg_1_1.slidingDownMaxSlope:
		local var_1_12 = Mathf.Sign(arg_1_0.x)
		local var_1_13 = var_1_12 == -1 and arg_1_2.bottomRight or arg_1_2.bottomLeft
		local var_1_14, var_1_15 = Physics.Raycast(var_1_13, var_0_0.directDown, None, Mathf.Infinity, var_1_4)

		if var_1_14:
			local var_1_16 = Vector3.Angle(var_1_15.normal, var_0_0.directUp)

			if var_1_16 != 0 and var_1_16 <= arg_1_1.config.maxSlopeAngle and Mathf.Sign(var_1_15.normal.x) == var_1_12 and var_1_15.distance - arg_1_2.skinWidth <= Mathf.Tan(var_1_16 * Mathf.Deg2Rad) * Mathf.Abs(arg_1_0.x):
...
def var_0_0.slideDownMaxSlope(arg_2_0, arg_2_1, arg_2_2):
	if arg_2_0 and arg_2_1.y != 0:
		local var_2_0 = Vector3.Angle(arg_2_0.normal, Vector3.up)

		if var_2_0 > arg_2_2.config.maxSlopeAngle:
			local var_2_1 = Mathf.Sign(arg_2_1.y)

			if Mathf.Abs(arg_2_1.y) > arg_2_2.config.downMaxSlopeSpeed * Time.deltaTime:
...
def var_0_0.VerticalCollisions(arg_3_0, arg_3_1, arg_3_2):
	...
	for iter_3_0 = 1, arg_3_2.verticalRayCount:
		var_3_3.x = var_3_4.x + (arg_3_2.verticalRaySpacing * (iter_3_0 - 1) + arg_3_0.x)
		var_3_3.y = var_3_4.y
		var_3_3.z = var_3_4.z

		local var_3_5, var_3_6 = Physics.Raycast(var_3_3, var_3_1, None, var_3_2, arg_3_1.layerMask)
		local var_3_7 = False
		local var_3_8 = False
		...
		if var_3_6:
			...
			if table.contains(arg_3_1.ignoreLayerMask, go(var_3_9).layer):
				var_3_8 = True

			if var_3_0 == 1 and not arg_3_1.verticalTopTfs[var_3_9]:
				arg_3_1.verticalTopTfs[var_3_9] = var_3_9
			elif var_3_0 == -1 and not arg_3_1.verticalBottomTfs[var_3_9]:
				arg_3_1.verticalBottomTfs[var_3_9] = var_3_9

		if not var_3_8 and var_3_5:
