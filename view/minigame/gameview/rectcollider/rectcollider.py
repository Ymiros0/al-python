...
def var_0_0.start(arg_8_0):
	...
	for iter_8_0, iter_8_1 in ipairs(arg_8_0._scripts):
		iter_8_1.active(False)

def var_0_0.step(arg_9_0):
	if not arg_9_0.initFlag:
		arg_9_0.initFlag = True

		arg_9_0.onInit()

	for iter_9_0, iter_9_1 in ipairs(arg_9_0._scripts):
		iter_9_1.step()
	...
	if arg_9_0._collisionInfo.directionalInput.x != 0 and math.sign(arg_9_0._tf.localScale.x) != arg_9_0._collisionInfo.directionalInput.x:
		arg_9_0._tf.localScale = Vector3(arg_9_0._tf.localScale.x * -1, arg_9_0._tf.localScale.y, arg_9_0._tf.localScale.z)

	for iter_9_2, iter_9_3 in ipairs(arg_9_0._scripts):
		iter_9_3.lateStep()

	if arg_9_0._collisionInfo.script and arg_9_0._collisionInfo.scriptTime:
		arg_9_0._collisionInfo.scriptTime = arg_9_0._collisionInfo.scriptTime - arg_9_0._collisionInfo.frameRate

		if arg_9_0._collisionInfo.scriptTime <= 0:
			arg_9_0._collisionInfo.script.active(False)
			arg_9_0._collisionInfo.removeScript()

def var_0_0.onKeyTrigger(arg_10_0, arg_10_1, arg_10_2):
	for iter_10_0, iter_10_1 in pairs(arg_10_0.scriptList):
		iter_10_1.keyTrigger(arg_10_1, arg_10_2)

def var_0_0.getCollisionInfo(arg_11_0):
	return arg_11_0._collisionInfo

def var_0_0.getScript(arg_12_0, arg_12_1):
	return arg_12_0.scriptList[arg_12_1.__cname] or None
