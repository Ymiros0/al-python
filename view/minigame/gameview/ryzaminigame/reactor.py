...
def var_0_0.InTimeRiver(arg_4_0):
	return False

def var_0_0.Init(arg_5_0, arg_5_1):
	arg_5_0.name = arg_5_1.name

	if arg_5_0.GetBaseOrder() != "floor":
...
def var_0_0.InitUI(arg_6_0, arg_6_1):
	return

def var_0_0.InitRegister(arg_7_0, arg_7_1):
	return

def var_0_0.UpdatePos(arg_8_0, arg_8_1):
...
def var_0_0.UpdatePosition(arg_9_0):
