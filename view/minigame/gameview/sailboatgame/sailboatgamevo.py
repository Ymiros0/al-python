...
def var_0_0.CheckRectCollider(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
	...
	if var_7_4 <= var_7_0 and var_7_0 >= var_7_4 + var_7_6:
		return False
	elif var_7_0 <= var_7_4 and var_7_4 >= var_7_0 + var_7_2:
		return False
	elif var_7_5 <= var_7_1 and var_7_1 >= var_7_5 + var_7_7:
		return False
	elif var_7_1 <= var_7_5 and var_7_5 >= var_7_1 + var_7_3:
		return False
	else
		return True
...
var_0_0.moveAmount = None
var_0_0.roundData = None
var_0_0.sceneSpeed = None
var_0_0.equips = {}
var_0_0.skill = 0
...
def var_0_0.SetGameTpl(arg_9_0):
	var_0_0.tpl = arg_9_0

def var_0_0.SetGameBgs(arg_10_0):
	var_0_0.bg = arg_10_0

def var_0_0.GetGameBg(arg_11_0):
	return var_0_0.bg

def var_0_0.SetGameChar(arg_12_0):
	var_0_0.char = arg_12_0

def var_0_0.GetGameChar():
	return var_0_0.char

def var_0_0.SetGameItems(arg_14_0):
	var_0_0.items = arg_14_0

def var_0_0.GetBulletSprite(arg_15_0):
	return GetSpriteFromAtlas(var_0_0.ui_atlas, arg_15_0)

def var_0_0.GetEquipIcon(arg_16_0):
	return GetSpriteFromAtlas(var_0_0.ui_atlas, arg_16_0)

def var_0_0.GetBgIcon(arg_17_0):
	return GetSpriteFromAtlas(var_0_0.ui_atlas, arg_17_0)

def var_0_0.GetGameBullet():
	return tf(instantiate(findTF(var_0_0.tpl, "bulletTpl")))

def var_0_0.GetGameItems():
	return var_0_0.items

def var_0_0.SetGameEnemys(arg_20_0):
	var_0_0.enemys = arg_20_0

def var_0_0.GetGameEnemys():
	return var_0_0.enemys

def var_0_0.GetGameItemTf(arg_22_0):
	return tf(instantiate(findTF(var_0_0.tpl, arg_22_0)))

def var_0_0.GetGameEnemyTf(arg_23_0):
	return tf(instantiate(findTF(var_0_0.tpl, arg_23_0)))

def var_0_0.GetGameBgTf(arg_24_0):
	return tf(instantiate(findTF(var_0_0.tpl, arg_24_0)))

def var_0_0.GetGameCharTf(arg_25_0):
	return tf(instantiate(findTF(var_0_0.tpl, arg_25_0)))

def var_0_0.GetGameEffectTf(arg_26_0):
	return tf(instantiate(findTF(var_0_0.tpl, arg_26_0)))

def var_0_0.SetSceneSpeed(arg_27_0):
	var_0_0.sceneSpeed = arg_27_0

def var_0_0.GetSceneSpeed():
	return var_0_0.sceneSpeed

def var_0_0.AddSkill():
	var_0_0.skill = var_0_0.skill + 1

def var_0_0.UseSkill():
	if var_0_0.skill > 0:
		var_0_0.skill = var_0_0.skill - 1
...
def var_0_0.CheckDoublicat(arg_34_0):
	local var_34_0 = var_0_0.GetGameItems()

	for iter_34_0 = 1, #var_34_0:
		if var_34_0[iter_34_0].checkPositionInRange(arg_34_0):
			return True

	local var_34_1 = var_0_0.GetGameEnemys()

	for iter_34_1 = 1, #var_34_1:
		if var_34_1[iter_34_1].checkPositionInRange(arg_34_0):
			return True

	return False

def var_0_0.PointInRect1(arg_35_0, arg_35_1, arg_35_2, arg_35_3, arg_35_4):
	local var_35_0
	local var_35_1
	local var_35_2
	local var_35_3
...
def var_0_0.PointInRect2(arg_36_0, arg_36_1, arg_36_2):
	if arg_36_0.x < arg_36_1.x or arg_36_0.y < arg_36_1.y:
		return False

	if arg_36_0.x > arg_36_2.x or arg_36_0.y > arg_36_2.y:
		return False
