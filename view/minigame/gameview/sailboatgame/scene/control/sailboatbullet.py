...
def var_0_0.start(arg_3_0):
	...
	if arg_3_0.getConfig("fire_effect"):
...
def var_0_0.getWorld(arg_4_0):
	return arg_4_0._tf.position

def var_0_0.step(arg_5_0, arg_5_1):
	...
	if arg_5_0._life and arg_5_0._life > 0:
	...
	if math.abs(var_5_0.x) > SailBoatGameVo.scene_width:
		arg_5_0._removeFlag = True
	elif math.abs(var_5_0.y) > SailBoatGameVo.scene_height:
		arg_5_0._removeFlag = True

def var_0_0.getDamage(arg_6_0):
	return {
		num = arg_6_0._weaponData.damage,
		position = arg_6_0._tf.position
	}

def var_0_0.setMove(arg_7_0, arg_7_1):
	arg_7_0._move = arg_7_1

def var_0_0.setPosition(arg_8_0, arg_8_1):
	arg_8_0._tf.anchoredPosition = arg_8_1

def var_0_0.hit(arg_9_0):
	if arg_9_0.getConfig("hit_effect"):
...
def var_0_0.setHitGroup(arg_10_0, arg_10_1):
	arg_10_0._hitGroup = arg_10_1

def var_0_0.getHitGroup(arg_11_0):
	if not arg_11_0._hitGroup:
		arg_11_0._hitGroup = {}

	return arg_11_0._hitGroup

def var_0_0.setSprite(arg_12_0, arg_12_1):
	arg_12_0._img.sprite = arg_12_1

	arg_12_0._img.SetNativeSize()

def var_0_0.getSpeed(arg_13_0):
	return arg_13_0._speed

def var_0_0.setFireData(arg_14_0, arg_14_1):
	arg_14_0._fireData = arg_14_1

def var_0_0.setWeapon(arg_15_0, arg_15_1):
...
def var_0_0.checkPositionInRange(arg_25_0, arg_25_1):
	...
	if var_25_1 < var_25_3.x and var_25_2 < var_25_3.y:
		return True
...
def var_0_0.getConfig(arg_27_0, arg_27_1):
	return arg_27_0._data[arg_27_1]

def var_0_0.getWeaponConfig(arg_28_0, arg_28_1):
