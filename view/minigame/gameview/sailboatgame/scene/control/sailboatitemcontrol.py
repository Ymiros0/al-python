...
def var_0_0.step(arg_3_0, arg_3_1):
	...
	for iter_3_0 = 1, #arg_3_0._rules:
		local var_3_1 = arg_3_0._rules[iter_3_0]
		local var_3_2 = var_3_1.data.create_time

		if var_3_0 > var_3_2[1] and var_3_0 < var_3_2[2] and var_3_1.time and var_3_1.time >= 0:
...
def var_0_0.getOrCreateItem(arg_6_0, arg_6_1, arg_6_2):
	local var_6_0

	if #arg_6_0._itemsPool > 0:
		for iter_6_0 = 1, #arg_6_0._itemsPool:
			if arg_6_0._itemsPool[iter_6_0].getId() == arg_6_1:
...
def var_0_0.returnItem(arg_7_0, arg_7_1):
	arg_7_1.clear()
	table.insert(arg_7_0._itemsPool, arg_7_1)

def var_0_0.clear(arg_8_0):
	for iter_8_0 = #arg_8_0._items, 1, -1:
