...
def var_0_0.initUI(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.bg, function()
		arg_5_0.closeMySelf(), SFX_CANCEL)

def var_0_0.playEnterAni(arg_8_0, arg_8_1, arg_8_2):
	...
	arg_8_0.managedTween(LeanTween.value, None, go(arg_8_0.cloud1), 0, 1, var_8_8).setOnUpdate(System.Action_float(function(arg_9_0)
		...
		arg_8_0.buffListCG.alpha = var_9_2)).setOnComplete(System.Action(function()
