			...
			if not var_10_7:
				onToggle(arg_5_0, arg_10_2, function(arg_11_0)
					if arg_11_0:
						...
						if arg_5_0.onSelectFunc:
							arg_5_0.onSelectFunc(var_10_0)

					arg_5_0.updateConfirmBtn(arg_11_0), SFX_PANEL))

def var_0_0.closeSelf(arg_12_0):
	if arg_12_0.isPlaying:
		return

	if arg_12_0.onCloseFunc:
		arg_12_0.onCloseFunc()

	arg_12_0.playEnterAni(False, function()
		arg_12_0.Destroy())

def var_0_0.updateConfirmBtn(arg_14_0, arg_14_1):
...
def var_0_0.updateCardList(arg_15_0):
	local var_15_0 = 7

	arg_15_0.cardUIItemList.align(var_15_0)

def var_0_0.playEnterAni(arg_16_0, arg_16_1, arg_16_2):
	...
	arg_16_0.managedTween(LeanTween.value, None, go(arg_16_0.panelTF), var_16_0, var_16_1, var_16_2).setOnUpdate(System.Action_float(function(arg_17_0)
		var_16_3.x = arg_17_0

		setAnchoredPosition(arg_16_0.panelTF, var_16_3))).setOnComplete(System.Action(function()
	...
	arg_16_0.managedTween(LeanTween.value, None, go(arg_16_0.tipTF), var_16_4, var_16_5, var_16_2).setOnUpdate(System.Action_float(function(arg_19_0)
		var_16_6.y = arg_19_0

		setAnchoredPosition(arg_16_0.tipTF, var_16_6)))

def var_0_0.isSelected(arg_20_0, arg_20_1):
	local var_20_0 = arg_20_0.shipGameData.GetRuntimeData("kvpElements")[1]

	for iter_20_0, iter_20_1 in ipairs(var_20_0):
		if iter_20_1.value == arg_20_1:
			return True
