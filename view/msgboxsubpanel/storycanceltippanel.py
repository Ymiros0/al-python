...
def var_0_0.OnRefresh(arg_4_0, arg_4_1):
	...
	LeanTween.value(go(var_4_0), var_4_2, 0, var_4_2).setOnUpdate(System.Action_float(function(arg_5_0)
		...
		setText(var_4_1, math.clamp(math.ceil(arg_5_0), 0, var_4_2)))).setOnComplete(System.Action(function()
