...
def var_0_0.SetStudents(arg_2_0, arg_2_1):
	arg_2_0.shipGroups = arg_2_1

def var_0_0.SetCourse(arg_3_0, arg_3_1):
	arg_3_0.course = arg_3_1

def var_0_0.SetClass(arg_4_0, arg_4_1):
	arg_4_0.resClass = arg_4_1

def var_0_0.OnUpdateResField(arg_5_0, arg_5_1):
	if not isa(arg_5_1, ClassResourceField):
		return

	arg_5_0.SetClass(arg_5_1)
	arg_5_0.InitClassInfo()

	if arg_5_0.resFieldPage.GetLoaded() and arg_5_0.resFieldPage.isShowing():
...
def var_0_0.didEnter(arg_7_0):
	onButton(arg_7_0, arg_7_0.backBtn, function()
		arg_7_0.emit(BaseUI.ON_BACK), SFX_CANCEL)
	...
	onButton(arg_7_0, arg_7_0.upgradeBtn, function()
		arg_7_0.resFieldPage.ExecuteAction("Flush", arg_7_0.resClass), SFX_PANEL)
	onButton(arg_7_0, arg_7_0.exp2ProficiencyRatio, function()
		...
		arg_7_0.DisplayChatContent(), SFX_PANEL)
...
def var_0_0.DisplayChatContent(arg_12_0):
	...
	LeanTween.scale(rtf(arg_12_0.chatProficiency), Vector3(1.5, 1.5, 1), 0.3).setFrom(Vector3.zero).setOnComplete(System.Action(function()
		LeanTween.scale(rtf(arg_12_0.chatProficiency), Vector3(0, 0, 0), 0.2).setDelay(2).setOnComplete(System.Action(function()
			if not IsNil(arg_12_0.exp2ProficiencyRatio):
				setButtonEnabled(arg_12_0.exp2ProficiencyRatio, True)
				setActive(arg_12_0.chatProficiency, False)))))

def var_0_0.FilterStudents(arg_15_0):
	local var_15_0 = {}
	local var_15_1 = arg_15_0.course.getConfig("type")

	for iter_15_0, iter_15_1 in pairs(arg_15_0.shipGroups):
		if table.contains(var_15_1, iter_15_1.shipConfig.type):
			table.insert(var_15_0, iter_15_1)

	if #var_15_0 > #arg_15_0.studentSeats:
		shuffle(var_15_0)

	return var_15_0

def var_0_0.InitClassInfo(arg_16_0):
...
def var_0_0.LoadClassRoom(arg_17_0):
	local var_17_0 = {}

	for iter_17_0 = 1, math.min(#arg_17_0.students, #arg_17_0.studentSeats):
...
def var_0_0.AddStudent(arg_23_0, arg_23_1, arg_23_2):
...
def var_0_0.AddTeacher(arg_24_0, arg_24_1, arg_24_2):
...
def var_0_0.willExit(arg_25_0):
	...
	arg_25_0.resFieldPage = None

def var_0_0.LoadChar(arg_26_0, arg_26_1, arg_26_2):
...
def var_0_0.ClearChars(arg_28_0):
	for iter_28_0, iter_28_1 in pairs(arg_28_0.chars):
		PoolMgr.GetInstance().ReturnSpineChar(iter_28_0, iter_28_1)

	arg_28_0.chars = {}

def var_0_0.onBackPressed(arg_29_0):
	if arg_29_0.resFieldPage and arg_29_0.resFieldPage.GetLoaded() and arg_29_0.resFieldPage.isShowing():
