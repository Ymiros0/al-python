...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.confirmBtn, function()
		if not arg_3_0.selLessonId or not arg_3_0.spendTime:
			return

		arg_3_0.student.setLesson(arg_3_0.selLessonId)
		arg_3_0.student.setTime(arg_3_0.spendTime)
		arg_3_0.emit(NewNavalTacticsLayer.ON_LESSON_SELECTED, arg_3_0.student), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.skillPanel, function()
		if not arg_3_0.canBack:
			return

		arg_3_0.emit(NewNavalTacticsLayer.ON_RESEL_SKILL, arg_3_0.student), SFX_PANEL)

def var_0_0.SetHideCallback(arg_7_0, arg_7_1):
...
def var_0_0.Show(arg_8_0, arg_8_1, arg_8_2):
	...
	if arg_8_1 != arg_8_0.student:
		arg_8_0.selLessonId = None
		arg_8_0.spendTime = None
...
def var_0_0.Hide(arg_10_0):
	...
	if arg_10_0.hideCallback:
		arg_10_0.hideCallback()

		arg_10_0.hideCallback = None
...
def var_0_0.GetLessons(arg_12_0):
...
def var_0_0.UpdateLessons(arg_14_0, arg_14_1, arg_14_2):
	...
	for iter_14_1 = #arg_14_0.itemTpls, #var_14_0 + 1, -1:
...
def var_0_0.UpdateLesson(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4):
	...
	if pg.skill_data_template[arg_15_3].type == var_15_0.usage_arg[3]:
	...
	onToggle(arg_15_0, arg_15_1, function(arg_16_0)
		if arg_16_0:
			...
			arg_15_0.UpdateSkill(arg_15_3, var_15_3, arg_15_4), SFX_PANEL)

	local var_15_4 = var_15_2 == 100 and "" or "EXP" .. var_15_2 .. "%"

	setText(arg_15_1.Find("addition"), var_15_4)

def var_0_0.UpdatePosition(arg_17_0, arg_17_1, arg_17_2):
...
def var_0_0.UpdateLessonDesc(arg_18_0, arg_18_1, arg_18_2, arg_18_3):
...
def var_0_0.UpdateSkill(arg_19_0, arg_19_1, arg_19_2, arg_19_3):
