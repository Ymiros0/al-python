...
def var_0_0.SetCancelCallback(arg_3_0, arg_3_1):
	arg_3_0.onCancelCallback = arg_3_1

def var_0_0.SetHideCallback(arg_4_0, arg_4_1):
...
def var_0_0.Hide(arg_10_0):
	...
	if arg_10_0.onHideCallback:
		arg_10_0.onHideCallback()

		arg_10_0.onHideCallback = None

def var_0_0.UpdateSkillList(arg_11_0, arg_11_1):
	...
	for iter_11_1 = var_11_2 + 1, var_11_3:
		var_11_5 = var_11_5 + 1
	...
	if arg_11_0.skillIndex:
		arg_11_0.TriggerDefault(var_11_1)

def var_0_0.TriggerDefault(arg_12_0, arg_12_1):
...
def var_0_0.UpdateSkill(arg_13_0, arg_13_1, arg_13_2):
	...
	onToggle(arg_13_0, var_13_0._tf, function(arg_14_0)
		if arg_14_0:
			...
			arg_13_0.selIndex = arg_13_1, SFX_PANEL)

def var_0_0.ClearShipCards(arg_15_0, arg_15_1, arg_15_2):
	for iter_15_0 = #arg_15_1, arg_15_2 + 1, -1:
		arg_15_1[iter_15_0].Disable()

def var_0_0.UpdateEmptySkill(arg_16_0, arg_16_1, arg_16_2):
...
def var_0_0.ClearEmtptyTpls(arg_17_0, arg_17_1, arg_17_2):
	for iter_17_0 = #arg_17_1, arg_17_2 + 1, -1:
		setActive(arg_17_1[iter_17_0], False)

def var_0_0.OnDestroy(arg_18_0):
	if arg_18_0.isShowing():
		arg_18_0.Hide()

	for iter_18_0, iter_18_1 in ipairs(arg_18_0.skillCards):
		iter_18_1.Dispose()

	arg_18_0.skillCards = None
