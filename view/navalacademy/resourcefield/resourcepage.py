...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.upgradeBtn, function()
		if arg_3_0.CheckUpgrade():
			arg_3_0.OnUpgrade(), SFX_PANEL)
...
def var_0_0.CheckUpgrade(arg_10_0):
	if not arg_10_0.resourceField.CanUpgrade():
		if arg_10_0.resourceField.IsMaxLevel():
			pg.TipsMgr.GetInstance().ShowTips(i18n("class_res_maxlevel_tip"))
		elif not arg_10_0.resourceField.IsReachLevel():
			pg.TipsMgr.GetInstance().ShowTips(i18n("common_limit_level", arg_10_0.resourceField.GetTargetLevel()))
		elif not arg_10_0.resourceField.IsReachRes():
...
def var_0_0.FlushState(arg_13_0):
...
def var_0_0.UpdateResourceFieldAttrs(arg_14_0):
	arg_14_0.attrs = arg_14_0.resourceField.GetEffectAttrs()

	arg_14_0.attrUIlist.align(#arg_14_0.attrs)

def var_0_0.UpdateResourceFieldAttr(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.AddTimer(arg_16_0):
	...
	if var_16_0 > pg.TimeMgr.GetInstance().GetServerTime():
		arg_16_0.timer = Timer.New(function()
			...
			arg_16_0.spendTimeTxt.text = pg.TimeMgr.GetInstance().DescCDTime(var_17_0), 1, -1)
