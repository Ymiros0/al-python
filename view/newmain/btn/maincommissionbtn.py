...
def var_0_0.OnClick(arg_4_0):
	if LeanTween.isTweening(arg_4_0._tf.gameObject):
		return
...
def var_0_0.OnRemoveLayer(arg_6_0, arg_6_1):
	if arg_6_1.mediator == CommissionInfoMediator:
		arg_6_0.ResetCommissionBtn()

def var_0_0.ResetCommissionBtn(arg_7_0):
