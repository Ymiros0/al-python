...
def var_0_0.OnInit(arg_3_0):
	...
	onToggle(arg_3_0, arg_3_0.moveBtn, function(arg_4_0)
		...
		arg_3_0.Move(arg_4_0), SFX_PANEL)
	onButton(arg_3_0, arg_3_0._parentTf, function()
		if var_3_1:
			return

		if arg_3_0.showing and not var_3_0:
			if var_3_1:
...
def var_0_0.SavePostion(arg_14_0):
...
def var_0_0.ResetPostion(arg_16_0):
	...
	if var_16_0 == MainPaintingView.STATE_L2D:
		arg_16_0._bgTf.localScale = var_16_4
		arg_16_0.paintingTF.localScale = var_16_4
	elif var_16_0 == MainPaintingView.STATE_SPINE_PAINTING:
...
def var_0_0.ShowOrHide(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4):
	if arg_17_1:
...
def var_0_0.UpdateBg(arg_18_0, arg_18_1):
	if arg_18_1 == arg_18_0.bgName:
		return
...
def var_0_0.DoLeftAnimation(arg_22_0, arg_22_1, arg_22_2, arg_22_3):
	LeanTween.value(arg_22_0.backBtn.gameObject, arg_22_1, arg_22_2, 0.3).setOnUpdate(System.Action_float(function(arg_23_0)
		arg_22_0.backBtn.anchoredPosition = Vector2(arg_23_0, arg_22_0.backBtn.anchoredPosition.y))).setOnComplete(System.Action(arg_22_3))

def var_0_0.DoBottomAnimation(arg_24_0, arg_24_1, arg_24_2):
