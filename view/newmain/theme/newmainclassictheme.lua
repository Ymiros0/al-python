...
function var_0_0.GetCalibrationBG(arg_6_0)
	return "mainui_calibration"
end

function var_0_0.GetPbList(arg_7_0)
	return {
...
function var_0_0.GetPaintingOffset(arg_8_0, arg_8_1)
