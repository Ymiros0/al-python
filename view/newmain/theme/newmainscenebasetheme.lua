...
function var_0_0.OnDestroy(arg_11_0)
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_0.panels or {}) do
		iter_11_1:Dispose()
	end

	arg_11_0.panels = nil

	if arg_11_0.iconView then
		arg_11_0.iconView:Dispose()

		arg_11_0.iconView = nil
	end

	if arg_11_0.chatRoomView then
		arg_11_0.chatRoomView:Dispose()

		arg_11_0.chatRoomView = nil
	end

	if arg_11_0.bannerView then
		arg_11_0.bannerView:Dispose()

		arg_11_0.bannerView = nil
	end

	if arg_11_0.actBtnView then
		arg_11_0.actBtnView:Dispose()

		arg_11_0.actBtnView = nil
	end

	if arg_11_0.buffView then
		arg_11_0.buffView:Dispose()

		arg_11_0.buffView = nil
	end

	if arg_11_0.tagView then
		arg_11_0.tagView:Dispose()

		arg_11_0.tagView = nil
	end

	if arg_11_0.wordView then
		arg_11_0.wordView:Dispose()

		arg_11_0.wordView = nil
	end

	pg.redDotHelper:Clear()
end

function var_0_0.GetPbList(arg_12_0)
	return {}
end
...
function var_0_0.GetPaintingOffset(arg_14_0, arg_14_1)
...
function var_0_0.ApplyDefaultResUI(arg_15_0)
	return true
end

function var_0_0.GetWordView(arg_16_0)
	assert(false)
end

function var_0_0.GetTagView(arg_17_0)
	assert(false)
end

function var_0_0.GetTopPanel(arg_18_0)
	assert(false)
end

function var_0_0.GetRightPanel(arg_19_0)
	assert(false)
end

function var_0_0.GetLeftPanel(arg_20_0)
	assert(false)
end

function var_0_0.GetBottomPanel(arg_21_0)
	assert(false)
end

function var_0_0.GetIconView(arg_22_0)
	assert(false)
end

function var_0_0.GetChatRoomView(arg_23_0)
	assert(false)
end

function var_0_0.GetBannerView(arg_24_0)
	assert(false)
end

function var_0_0.GetActBtnView(arg_25_0)
	assert(false)
end

function var_0_0.GetBuffView(arg_26_0)
	assert(false)
end

function var_0_0.GetRedDots(arg_27_0)
	return {}
end
