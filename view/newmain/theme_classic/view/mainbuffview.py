...
def var_0_0.CollectBuffs(arg_4_0):
	local var_4_0 = BuffHelper.GetBuffsForMainUI()
	local var_4_1 = import("GameCfg.activity.MainUIVirtualIconData")

	for iter_4_0, iter_4_1 in ipairs(var_4_1.CurrentIconList):
		if var_4_1[iter_4_1].CheckExist():
...
def var_0_0.ShouldFreeUsageSkinTag(arg_7_0):
	local var_7_0 = getProxy(ShipSkinProxy).getRawData()

	for iter_7_0, iter_7_1 in pairs(var_7_0):
		if iter_7_1.isExpireType() and not iter_7_1.isExpired():
			return True

	return False

def var_0_0.UpdateFreeUsageSkinTag(arg_8_0):
	...
	onButton(arg_8_0, var_8_0, function()
		...
		arg_8_0.emit(NewMainScene.ON_SKIN_FREEUSAGE_DESC, var_9_0), SFX_PANEL)

	var_8_0.anchoredPosition = arg_8_0.tagPos

	setActive(arg_8_0.skinFreeUsageTag, True)

def var_0_0.GetFreeUsageSkins(arg_10_0):
	local var_10_0 = {}
	local var_10_1 = getProxy(ShipSkinProxy).getRawData()

	for iter_10_0, iter_10_1 in pairs(var_10_1):
		if iter_10_1.isExpireType() and not iter_10_1.isExpired():
			table.insert(var_10_0, iter_10_1)

	return var_10_0

def var_0_0.GetTpl(arg_11_0, arg_11_1):
	if not arg_11_0.buffs[arg_11_1]:
...
def var_0_0.UpdateBuffs(arg_12_0, arg_12_1):
	for iter_12_0 = #arg_12_0.buffs, #arg_12_1 + 1, -1:
		if arg_12_0.buffs[iter_12_0]:
			setActive(arg_12_0.buffs[iter_12_0], False)

	for iter_12_1, iter_12_2 in ipairs(arg_12_1):
		local var_12_0 = arg_12_0.GetTpl(iter_12_1)

		if iter_12_2.IsVirtualIcon:
...
def var_0_0.UpdateVirtualBuff(arg_13_0, arg_13_1, arg_13_2):
	LoadImageSpriteAtlasAsync("ui/mainui_atlas", arg_13_2.Image, arg_13_1)
	onButton(arg_13_0, arg_13_1, function()
		arg_13_0.emit(NewMainMediator.GO_SINGLE_ACTIVITY, ActivityConst.DOA_PT_ID), SFX_PANEL)
	setActive(arg_13_1, True)

def var_0_0.UpdateBuff(arg_15_0, arg_15_1, arg_15_2):
	...
	onButton(arg_15_0, arg_15_1, function()
		...
		arg_15_0.emit(NewMainScene.ON_BUFF_DESC, arg_15_2, Vector3(var_16_0.x, var_16_0.y - 55, 0)), SFX_PANEL)
	setActive(arg_15_1, True)

def var_0_0.AddEndTimer(arg_17_0, arg_17_1, arg_17_2):
	local var_17_0 = arg_17_2.getLeftTime()

	arg_17_0.timers[arg_17_1] = Timer.New(function()
		setActive(arg_17_1, False), var_17_0, 1)

	arg_17_0.timers[arg_17_1].Start()

def var_0_0.ClearTimers(arg_19_0):
	for iter_19_0, iter_19_1 in pairs(arg_19_0.timers):
		iter_19_1.Stop()

	arg_19_0.timers = {}

def var_0_0.GetDirection(arg_20_0):
	return Vector2(0, 1)

def var_0_0.Dispose(arg_21_0):
	var_0_0.super.Dispose(arg_21_0)

	if arg_21_0.skinFreeUsageTag:
		Destroy(arg_21_0.skinFreeUsageTag.gameObject)

		arg_21_0.skinFreeUsageTag = None
