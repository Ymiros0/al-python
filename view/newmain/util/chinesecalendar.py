...
def var_0_0.DayOfSolarYear(arg_1_0, arg_1_1, arg_1_2):
...
def var_0_0.CalDate(arg_2_0, arg_2_1, arg_2_2):
	local var_2_0 = {
		day = 0,
		month = 0,
		leap = False,
	...
	if arg_2_0 <= var_0_1 or arg_2_0 > var_0_1 + var_0_2 - 1:
		return var_2_0
	...
	while var_2_9 <= 13:
		...
		if bit.band(bit.rshift(var_0_3[var_2_1], 6 + var_2_9), 1) == 1:
			var_2_10 = 30
	...
	if var_2_11 > 0 and var_2_11 < var_2_9:
		var_2_9 = var_2_9 - 1
...
def var_0_0.IsNewYear(arg_3_0, arg_3_1, arg_3_2):
	return arg_3_1 == 1 and arg_3_2 == 1

def var_0_0.IsLunarNewYear(arg_4_0, arg_4_1, arg_4_2):
	local var_4_0 = var_0_0.CalDate(arg_4_0, arg_4_1, arg_4_2 + 1)

	return var_4_0.month == 1 and var_4_0.day == 1

def var_0_0.IsValentineDay(arg_5_0, arg_5_1, arg_5_2):
	return arg_5_1 == 2 and arg_5_2 == 14

def var_0_0.IsMidAutumnFestival(arg_6_0, arg_6_1, arg_6_2):
	local var_6_0 = var_0_0.CalDate(arg_6_0, arg_6_1, arg_6_2)

	return var_6_0.month == 8 and var_6_0.day == 15

def var_0_0.AllHallowsDay(arg_7_0, arg_7_1, arg_7_2):
	return arg_7_1 == 10 and arg_7_2 == 31

def var_0_0.IsChristmas(arg_8_0, arg_8_1, arg_8_2):
	return arg_8_1 == 12 and arg_8_2 == 25

def var_0_0.GetCurrYearMonthDay(arg_9_0):
...
def var_0_0.AnySpecialDay(arg_10_0, arg_10_1, arg_10_2):
