...
def var_0_0.AddNode(arg_3_0, arg_3_1):
	table.insert(arg_3_0.nodes, arg_3_1)
	arg_3_0.redDotMgr.RegisterRedDotNode(arg_3_1)
	arg_3_1.RefreshSelf()

def var_0_0.RemoveNode(arg_4_0, arg_4_1):
	table.removebyvalue(arg_4_0.nodes, arg_4_1)
	arg_4_0.redDotMgr.UnRegisterRedDotNode(arg_4_1)

def var_0_0.Refresh(arg_5_0):
	for iter_5_0, iter_5_1 in ipairs(arg_5_0.nodes):
		if iter_5_1.Resume:
			iter_5_1.Resume()

	arg_5_0._Refresh()

def var_0_0._Refresh(arg_6_0):
	arg_6_0.redDotMgr._NotifyAll()

def var_0_0.Disable(arg_7_0):
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.nodes):
		if iter_7_1.Puase:
			iter_7_1.Puase()

def var_0_0.GetNotifyType(arg_8_0):
	if not arg_8_0.listener or #arg_8_0.listener == 0:
		arg_8_0.listener = {
...
def var_0_0.Notify(arg_9_0, arg_9_1):
	for iter_9_0, iter_9_1 in pairs(arg_9_0.GetNotifyType()):
