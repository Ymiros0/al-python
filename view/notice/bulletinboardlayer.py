...
def var_0_0.setNotices(arg_7_0, arg_7_1):
	local var_7_0 = {}
	local var_7_1 = {}
	...
	for iter_7_0, iter_7_1 in pairs(arg_7_1):
		...
		onToggle(arg_7_0, var_7_2, function(arg_8_0)
			...
			setActive(var_7_2.Find("common_state"), not arg_8_0), SFX_PANEL)

	triggerToggle(arg_7_0._tabList[1], True)
	BulletinBoardMgr.Inst.ClearCache(var_7_0, var_7_1)

def var_0_0.setNoticeDetail(arg_9_0, arg_9_1):
	...
	BulletinBoardMgr.Inst.GetSprite(arg_9_1.id, arg_9_1.version, arg_9_1.titleImage, UnityEngine.Events.UnityAction_UnityEngine_Sprite(function(arg_10_0)
		arg_9_0._loadingFlag[arg_9_1.titleImage] = None
	...
	for iter_9_0 in string.gmatch(arg_9_1.content, "<imgHref>%S-</imgHref>"):
	...
	for iter_9_1, iter_9_2 in ipairs(arg_9_0.loadPic):
		...
		BulletinBoardMgr.Inst.GetSprite(arg_9_1.id, arg_9_1.version, iter_9_2, UnityEngine.Events.UnityAction_UnityEngine_Sprite(function(arg_11_0)
			arg_9_0._loadingFlag[iter_9_2] = None
			...
			if arg_11_0 != None:
				...
				if arg_9_0.loadingCount <= 0:
					setText(arg_9_0._detailContentTxt, SwitchSpecialChar(arg_9_0.realContent, True))))

def var_0_0.clearLoadingPic(arg_12_0):
	for iter_12_0, iter_12_1 in pairs(arg_12_0._loadingFlag):
		BulletinBoardMgr.Inst.StopLoader(iter_12_0)

		arg_12_0._loadingFlag[iter_12_0] = None
