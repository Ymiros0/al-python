...
def var_0_0.GetSlotIndexList():
	...
	if var_0_0.GetEducateCharSlotMaxCnt() > 0:
		table.insert(var_1_2, var_0_0.EDUCATE_CHAR_SLOT_ID)

	return var_1_2

def var_0_0.GetAllUnlockSlotCnt():
	local var_2_0, var_2_1 = var_0_0.GetSlotMaxCnt()

	return var_2_1 + var_0_0.GetEducateCharSlotMaxCnt()

def var_0_0.GetEducateCharSlotMaxCnt():
	if LOCK_EDUCATE_SYSTEM:
		return 0

	if getProxy(PlayerProxy).getRawData().ExistEducateChar() or getProxy(EducateProxy).IsUnlockSecretary():
		return 1
	else
		return 0

def var_0_0.GetSlotMaxCnt():
	...
	for iter_4_0, iter_4_1 in ipairs(var_4_0):
		if getProxy(ChapterProxy).isClear(iter_4_1[1]):
			var_4_2 = iter_4_1[2]
...
def var_0_0.UpdateCard(arg_6_0, arg_6_1):
	local var_6_0 = arg_6_0.cards[var_0_1]

	for iter_6_0, iter_6_1 in ipairs(var_6_0):
		if isActive(iter_6_1._tf) and iter_6_1.displayShip and iter_6_1.displayShip.id == arg_6_1:
			iter_6_1.Refresh()

			break

def var_0_0.UpdateCardPaintingTag(arg_7_0):
	local var_7_0 = arg_7_0.cards[var_0_1]

	for iter_7_0, iter_7_1 in ipairs(var_7_0):
		iter_7_1.updatePaintingTag()

def var_0_0.RefreshShips(arg_8_0):
	arg_8_0.Update()

def var_0_0.OnLoaded(arg_9_0):
...
def var_0_0.OnBeginDragCard(arg_13_0, arg_13_1):
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_0):
		if isActive(iter_13_1._tf):
			arg_13_0.displayCards[iter_13_0] = iter_13_1
			arg_13_0.displayPos[iter_13_0] = iter_13_1._tf.localPosition

	for iter_13_2, iter_13_3 in pairs(arg_13_0.displayCards):
		if iter_13_2 != arg_13_1:
			iter_13_3.DisableDrag()

def var_0_0.OnDragingCard(arg_14_0, arg_14_1):
	local var_14_0 = arg_14_0.displayCards[arg_14_0.dragIndex - 1]
	local var_14_1 = arg_14_0.displayCards[arg_14_0.dragIndex + 1]

	if var_14_0 and arg_14_0.ShouldSwap(arg_14_1, arg_14_0.dragIndex - 1):
		arg_14_0.Swap(arg_14_0.dragIndex, arg_14_0.dragIndex - 1)
	elif var_14_1 and arg_14_0.ShouldSwap(arg_14_1, arg_14_0.dragIndex + 1):
		arg_14_0.Swap(arg_14_0.dragIndex, arg_14_0.dragIndex + 1)

def var_0_0.Swap(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.OnEndDragCard(arg_17_0):
	...
	for iter_17_0, iter_17_1 in pairs(arg_17_0.displayCards):
		iter_17_1.EnableDrag()
		table.insert(var_17_1, iter_17_1.displayShip.id)

		if not var_17_3 and var_17_2.characters[#var_17_1] != iter_17_1.displayShip.id:
			var_17_3 = True

	arg_17_0.dragIndex = None
	arg_17_0.displayCards = None
	arg_17_0.displayPos = None
	arg_17_0.cardContainerCG.blocksRaycasts = False

	if var_17_3:
		arg_17_0.emit(PlayerVitaeMediator.CHANGE_PAINTS, var_17_1, function()
			Timer.New(function()
				if arg_17_0.cardContainerCG:
					arg_17_0.cardContainerCG.blocksRaycasts = True, 0.3, 1).Start())
	else
		arg_17_0.cardContainerCG.blocksRaycasts = True

def var_0_0.OnInit(arg_20_0):
	...
	local function var_20_3()
		...
		if arg_20_0.randomFlag and var_20_0:
	...
	onButton(arg_20_0, arg_20_0.randomBtn, function()
		...
		arg_20_0.emit(PlayerVitaeMediator.ON_SWITCH_RANDOM_FLAG_SHIP_BTN, arg_20_0.randomFlag), SFX_PANEL)
	var_20_3()
	onButton(arg_20_0, arg_20_0.nativeBtn, function()
		arg_20_0.nativeFlag = not arg_20_0.nativeFlag

		var_20_4()
		arg_20_0.SwitchToPage(arg_20_0.nativeFlag and var_0_4 or var_0_5), SFX_PANEL)
	var_20_4()
	onButton(arg_20_0, arg_20_0.educateCharSettingBtn, function()
		...
		setActive(arg_20_0.educateCharSettingList.container, not var_28_0), SFX_PANEL)
...
def var_0_0.Update(arg_30_0):
	local var_30_0 = getProxy(SettingsProxy)
	local var_30_1

	if arg_30_0.randomFlag and arg_30_0.nativeFlag:
		var_30_1 = var_0_4
	else
...
local function var_0_6()
	...
	if getProxy(PlayerProxy).getRawData().ExistEducateChar():
		return var_0_1

	return var_0_2

def var_0_0.UpdateEducateSlot(arg_34_0):
	local var_34_0 = var_0_6()
	local var_34_1

	for iter_34_0, iter_34_1 in pairs(arg_34_0.educateCharCards):
...
def var_0_0.UpdateEducateCharSettings(arg_35_0):
...
def var_0_0.Flush(arg_41_0, arg_41_1, arg_41_2):
...
def var_0_0.UpdateCards(arg_42_0, arg_42_1, arg_42_2, arg_42_3):
	local var_42_0 = {
		0
	}
	local var_42_1 = {}

	for iter_42_0, iter_42_1 in ipairs(arg_42_3):
...
def var_0_0.UpdateTypeCards(arg_44_0, arg_44_1, arg_44_2, arg_44_3, arg_44_4, arg_44_5, arg_44_6):
	local var_44_0 = {}
	...
	for iter_44_1 = #var_44_1, arg_44_4 + 1, -1:
		var_44_1[iter_44_1].Disable()

	seriesAsync(var_44_0, arg_44_6)

def var_0_0.GetUnlockShipCnt(arg_47_0, arg_47_1):
	local var_47_0 = 0
	local var_47_1 = 0
	local var_47_2 = 0
...
def var_0_0.EditCards(arg_48_0, arg_48_1):
	local var_48_0 = {
		var_0_1,
		var_0_2
	}
	...
	for iter_48_0, iter_48_1 in ipairs(var_48_0):
		...
		for iter_48_2, iter_48_3 in ipairs(var_48_1):
			if isActive(iter_48_3._tf):
				iter_48_3.EditCard(arg_48_1)

	arg_48_0.IsOpenEdit = arg_48_1

def var_0_0.EditCardsForRandom(arg_49_0, arg_49_1):
	local var_49_0 = {}
	local var_49_1 = arg_49_0.cards[var_0_1]

	for iter_49_0, iter_49_1 in ipairs(var_49_1):
		if isActive(iter_49_1._tf):
			if not arg_49_1:
	...
	for iter_49_2, iter_49_3 in ipairs(var_49_2):
		if isActive(iter_49_3._tf):
			iter_49_3.EditCard(arg_49_1)

def var_0_0.SaveRandomSettings(arg_50_0, arg_50_1):
	local var_50_0 = getProxy(PlayerProxy).getRawData()

	for iter_50_0 = 1, arg_50_0.max:
		if not arg_50_1[iter_50_0]:
...
def var_0_0.Show(arg_51_0):
	var_0_0.super.Show(arg_51_0)

	Input.multiTouchEnabled = False

def var_0_0.Hide(arg_52_0):
	var_0_0.super.Hide(arg_52_0)

	if arg_52_0.IsOpenEdit:
		triggerButton(arg_52_0.settingBtn)

	if arg_52_0.IsOpenEditForRandom:
...
def var_0_0.OnDestroy(arg_53_0):
	arg_53_0.Hide()

	for iter_53_0, iter_53_1 in pairs(arg_53_0.cards):
		for iter_53_2, iter_53_3 in pairs(iter_53_1):
			iter_53_3.Dispose()
