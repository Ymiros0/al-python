...
def var_0_0.GetBGM(arg_2_0):
	...
	if var_2_0.IsBgmSkin() and var_2_1:
		return var_2_0.GetSkinBgm()
	else
		return "main"

def var_0_0.OnPlayerNameChange(arg_3_0):
	if arg_3_0.detailPage and arg_3_0.detailPage.GetLoaded():
		arg_3_0.detailPage.OnPlayerNameChange(arg_3_0.GetPlayer())

def var_0_0.OnShipSkinChanged(arg_4_0, arg_4_1):
	arg_4_0.UpdatePainting()

	if arg_4_0.shipsPage and arg_4_0.shipsPage.GetLoaded() and arg_4_0.shipsPage.isShowing():
		arg_4_0.shipsPage.UpdateCard(arg_4_1.id)

def var_0_0.ReloadPanting(arg_5_0, arg_5_1):
	if arg_5_0.displaySkinID and arg_5_0.displaySkinID == arg_5_1:
...
def var_0_0.RefreshShips(arg_6_0):
	if arg_6_0.shipsPage and arg_6_0.shipsPage.GetLoaded() and arg_6_0.shipsPage.isShowing():
		arg_6_0.shipsPage.RefreshShips()

def var_0_0.GetPlayer(arg_7_0):
	return getProxy(PlayerProxy).getRawData()

def var_0_0.GetFlagShip(arg_8_0):
...
def var_0_0.didEnter(arg_11_0):
	...
	if arg_11_0.contextData.showSelectCharacters:
		arg_11_0.contextData.showSelectCharacters = None
...
def var_0_0.DoEnterAnimation(arg_18_0):
	local function var_18_0(arg_19_0)
		...
		LeanTween.value(arg_19_0.gameObject, var_19_0.x - 1200, var_19_0.x, 0.2).setOnUpdate(System.Action_float(function(arg_20_0)
			arg_19_0.anchoredPosition3D = Vector3(arg_20_0, var_19_0.y, 0))).setDelay(0.1).setEase(LeanTweenType.easeInOutSine)
	...
	;(function(arg_21_0)
		...
		LeanTween.moveLocalY(arg_21_0.gameObject, var_21_0.y, 0.2).setDelay(0.1).setEase(LeanTweenType.easeInOutSine))(arg_18_0.topFrame)

def var_0_0.ShowOrHideMainView(arg_22_0, arg_22_1):
...
def var_0_0.UpdatePainting(arg_23_0, arg_23_1):
	local var_23_0 = arg_23_0.GetFlagShip()
	local var_23_1 = False
	local var_23_2 = {}

	for iter_23_0, iter_23_1 in ipairs(arg_23_0.btns):
		...
		if var_23_3 and not var_23_1 and iter_23_1.IsOverlap(arg_23_0.detailPosx):
			var_23_1 = True

	if var_23_1:
		for iter_23_2, iter_23_3 in ipairs(var_23_2):
			iter_23_3.SwitchToVecLayout()

	if not arg_23_0.displaySkinID or arg_23_0.displaySkinID != var_23_0.skinId or arg_23_1:
...
def var_0_0.ReturnPainting(arg_24_0):
	if arg_24_0.paintingName:
		retPaintingPrefab(arg_24_0.painting, arg_24_0.paintingName)

	arg_24_0.paintingName = None

def var_0_0.updateSwitchSkinBtnTag(arg_25_0):
...
def var_0_0.onBackPressed(arg_26_0):
	if arg_26_0.shipsPage and arg_26_0.shipsPage.GetLoaded() and arg_26_0.shipsPage.isShowing():
		triggerButton(arg_26_0.backBtn)

		return

	if arg_26_0.contextData.renamePage and arg_26_0.contextData.renamePage.GetLoaded() and arg_26_0.contextData.renamePage.isShowing():
...
def var_0_0.checkShowResetL2dBtn(arg_27_0):
	local var_27_0 = arg_27_0.GetFlagShip()

	if var_27_0 and var_27_0.GetSkinConfig().spine_use_live2d == 1:
		setActive(arg_27_0.btnLive2dReset, False)

		return

	local var_27_1 = "live2d/" .. string.lower(var_27_0.getPainting())
	local var_27_2 = HXSet.autoHxShiftPath(var_27_1, None, True)

	if not checkABExist(var_27_2):
		setActive(arg_27_0.btnLive2dReset, False)
	...
	onButton(arg_27_0, arg_27_0.btnLive2dReset, function()
		if arg_27_0.GetFlagShip():
			local var_28_0 = arg_27_0.GetFlagShip()

			Live2dConst.ClearLive2dSave(var_28_0.skinId, var_28_0.id), SFX_CONFIRM)

def var_0_0.willExit(arg_29_0):
	arg_29_0.ReturnPainting()

	if LeanTween.isTweening(arg_29_0.painting.gameObject):
		LeanTween.cancel(arg_29_0.painting.gameObject)

	for iter_29_0, iter_29_1 in ipairs(arg_29_0.btns):
		iter_29_1.Dispose()

	arg_29_0.btns = None

	if arg_29_0.shipsPage:
		arg_29_0.shipsPage.Destroy()

		arg_29_0.shipsPage = None

	if arg_29_0.detailPage:
		arg_29_0.detailPage.Destroy()

		arg_29_0.detailPage = None

	if arg_29_0.contextData.renamePage:
		arg_29_0.contextData.renamePage.Destroy()

		arg_29_0.contextData.renamePage = None
