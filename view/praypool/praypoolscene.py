...
def var_0_0.willExit(arg_4_0):
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.subViewList):
		iter_4_1.Destroy()

def var_0_0.onBackPressed(arg_5_0):
	local var_5_0

	for iter_5_0, iter_5_1 in ipairs(arg_5_0.subViewList):
...
def var_0_0.initEvents(arg_9_0):
