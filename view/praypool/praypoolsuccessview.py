...
def var_0_0.OnBackPress(arg_4_0):
	if arg_4_0.GetLoaded() and isActive(arg_4_0.boxTF):
...
def var_0_0.initUI(arg_6_0):
	...
	onButton(arg_6_0, arg_6_0.buildBtn, function()
		...
		local function var_7_7(arg_8_0)
			if arg_8_0 > var_7_6 or var_7_1.gold < arg_8_0 * var_7_0.use_gold or var_7_2 < arg_8_0 * var_7_0.number_1:
				return False

			return True

		arg_6_0.buildMsgBox.show(var_7_6, var_7_7, function(arg_9_0)
			arg_6_0.emit(PrayPoolConst.START_BUILD_SHIP_EVENT, var_7_0.id, arg_9_0, 0), function(arg_10_0)
			...
			return i18n("build_ship_tip", arg_10_0, var_7_0.name, var_10_0, var_10_1, var_10_2)), SFX_UI_BUILDING_STARTBUILDING)
...
def var_0_0.updatePaint(arg_12_0, arg_12_1):
	for iter_12_0 = 1, 2:
...
def var_0_0.MsgBox(arg_14_0):
	...
	function var_14_0.init(arg_16_0)
		...
		onButton(arg_16_0, arg_16_0.minusBtn, function()
			if arg_16_0.verifyCount(arg_16_0.count - 1):
				arg_16_0.count = math.max(arg_16_0.count - 1, 1)

				var_14_1(arg_16_0.count, arg_16_0.updateText), SFX_PANEL)
		...
		onButton(arg_16_0, arg_16_0.maxBtn, function()
			if arg_16_0.verifyCount(arg_16_0.max):
	...
	function var_14_0.show(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
		...
		if not arg_26_0.inited:
			arg_26_0.init()

		pg.UIMgr.GetInstance().BlurPanel(arg_26_0._tf)

	function var_14_0.hide(arg_27_0)
		if arg_27_0.isActive():
			arg_27_0.onConfirm = None
			arg_27_0.active = False
			arg_27_0.updateText = None
			arg_27_0.count = 1
			arg_27_0.max = 1
			arg_27_0.verify = None
