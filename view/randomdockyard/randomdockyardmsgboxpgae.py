...
def var_0_0.Flush(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4):
	arg_12_0.Show()
...
def var_0_0.UpdateTitle(arg_13_0, arg_13_1):
	arg_13_0.titleTxt.text = arg_13_1.cn
	arg_13_0.titleEnTxt.text = arg_13_1.en

def var_0_0.UpdateSubTitle(arg_14_0, arg_14_1):
	arg_14_0.subTitleTxt.text = arg_14_1

def var_0_0.UpdateList(arg_15_0, arg_15_1):
...
def var_0_0.Hide(arg_17_0):
	arg_17_0.callback = None
	arg_17_0.shipIds = None

	for iter_17_0, iter_17_1 in pairs(arg_17_0.cards):
		iter_17_1.Dispose()
