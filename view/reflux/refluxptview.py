...
def var_0_0.initUI(arg_6_0):
	...
	for iter_6_0 = 0, var_6_1.childCount - 1:
...
def var_0_0.updateTpl(arg_11_0, arg_11_1, arg_11_2):
	...
	for iter_11_0 = 0, var_11_17.Length - 1:
	...
	if var_11_20:
		onButton(arg_11_0, arg_11_1, function()
			arg_11_0.onStepClick(arg_11_2), SFX_PANEL)
	else
...
def var_0_0.ScrollPt(arg_15_0, arg_15_1, arg_15_2, arg_15_3):
...
def var_0_0.onStepClick(arg_16_0, arg_16_1):
...
def var_0_0.getAwardForShow(arg_18_0, arg_18_1):
	...
	for iter_18_0, iter_18_1 in ipairs(var_18_1):
		...
		if var_18_4 <= var_18_2 and var_18_2 <= var_18_5:
			var_18_3 = iter_18_0
...
def var_0_0.getPTMinAndMax(arg_19_0, arg_19_1):
	local var_19_0
	local var_19_1
