...
def var_0_0.initUI(arg_6_0):
	...
	for iter_6_0 = 0, arg_6_0.totalSignCount - 1:
	...
	arg_6_0.dayUIItemList.make(function(arg_7_0, arg_7_1, arg_7_2)
		if arg_7_0 == UIItemList.EventUpdate:
			...
			for iter_7_0, iter_7_1 in ipairs(var_7_6):
				local var_7_8 = var_7_7[iter_7_0]

				if var_7_8.type != DROP_TYPE_SHIP:
...
def var_0_0.updateOutline(arg_9_0):
	return

def var_0_0.getAllAwardList(arg_10_0):
	local var_10_0 = {}
	local var_10_1 = arg_10_0.refluxProxy.returnLV

	for iter_10_0, iter_10_1 in ipairs(pg.return_sign_template.all):
		...
		for iter_10_2, iter_10_3 in ipairs(var_10_7):
...
def var_0_0.getLevelIndex(arg_11_0, arg_11_1, arg_11_2):
	for iter_11_0, iter_11_1 in ipairs(arg_11_2):
		local var_11_0 = iter_11_1[1]
		local var_11_1 = iter_11_1[2]

		if var_11_0 <= arg_11_1 and arg_11_1 <= var_11_1:
			return iter_11_0

def var_0_0.tryAutoSign(arg_12_0):
	if arg_12_0.refluxProxy.isCanSign():
		pg.m02.sendNotification(GAME.REFLUX_SIGN)

def var_0_0.autoScroll(arg_13_0, arg_13_1):
