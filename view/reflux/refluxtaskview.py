...
def var_0_0.initData(arg_5_0):
	...
	arg_5_0.taskVOList = None
	arg_5_0.taskVOListForShow = None
...
def var_0_0.initUI(arg_6_0):
	...
	for iter_6_0 = 0, arg_6_0.totalDayCount - 1:
	...
	onButton(arg_6_0, arg_6_0.oneStepBtn, function()
		if arg_6_0.isTaskListOverflow():
			...
			for iter_8_0, iter_8_1 in ipairs(var_8_2):
				...
				if var_8_3 == 1 and arg_6_0.isTaskUnlocked(iter_8_1) and not var_8_4:
...
def var_0_0.updateData(arg_9_0):
...
def var_0_0.updateTaskList(arg_13_0):
	arg_13_0.taskUIList.align(#arg_13_0.taskVOListForShow)

def var_0_0.updateTask(arg_14_0, arg_14_1, arg_14_2):
...
def var_0_0.getTaskVOListForShow(arg_22_0):
	local var_22_0 = {}
	local var_22_1 = {}

	for iter_22_0, iter_22_1 in ipairs(arg_22_0.taskVOList):
		if arg_22_0.isTaskUnlocked(iter_22_1):
	...
	for iter_22_2, iter_22_3 in ipairs(var_22_0):
		table.insert(var_22_4, iter_22_3)

	for iter_22_4, iter_22_5 in ipairs(var_22_1):
		table.insert(var_22_4, iter_22_5)

	return var_22_4

def var_0_0.getTaskUnlockSignCount(arg_25_0, arg_25_1):
	local var_25_0 = arg_25_1.id

	return pg.return_task_template[var_25_0].reward_date

def var_0_0.isTaskUnlocked(arg_26_0, arg_26_1):
	return arg_26_0.getTaskUnlockSignCount(arg_26_1) <= arg_26_0.refluxProxy.signCount

def var_0_0.isTaskOverflow(arg_27_0, arg_27_1):
...
def var_0_0.isTaskListOverflow(arg_28_0):
	local var_28_0 = {}
	local var_28_1 = arg_28_0.getTaskVOList()

	for iter_28_0, iter_28_1 in ipairs(var_28_1):
		if iter_28_1.getTaskStatus() == 1 and arg_28_0.isTaskUnlocked(iter_28_1):
	...
	for iter_28_2, iter_28_3 in pairs(var_28_0):
...
def var_0_0.setLastSubmitTask(arg_29_0, arg_29_1):
	arg_29_0.lastSubmitTaskIDList = arg_29_1

def var_0_0.clearLastSubmitTask(arg_30_0):
	arg_30_0.lastSubmitTaskIDList = {}

def var_0_0.calcLastSubmitTaskPT(arg_31_0):
	local var_31_0 = 0
	local var_31_1 = 0

	for iter_31_0, iter_31_1 in ipairs(arg_31_0.lastSubmitTaskIDList):
...
def var_0_0.getTaskAwardForShow(arg_32_0, arg_32_1):
	...
	for iter_32_0, iter_32_1 in ipairs(var_32_2):
		...
		if var_32_5 <= var_32_3 and var_32_3 <= var_32_6:
			var_32_4 = iter_32_0
...
def var_0_0.isAnyTaskCanGetAward():
	local var_33_0 = getProxy(TaskProxy)
	local var_33_1 = getProxy(RefluxProxy)
	local var_33_2 = {}

	for iter_33_0, iter_33_1 in ipairs(pg.return_task_template.all):
	...
	for iter_33_2, iter_33_3 in ipairs(var_33_2):
		if iter_33_3.getTaskStatus() == 1 and var_33_5(iter_33_3):
			return True
