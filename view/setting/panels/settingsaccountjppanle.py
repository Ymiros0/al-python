...
def var_0_0.OnUpdate(arg_17_0):
	arg_17_0.checkAllAccountState()

def var_0_0.checkAllAccountState(arg_18_0):
...
def var_0_0.showTranscode(arg_19_0, arg_19_1):
	arg_19_0.userProxy.saveTranscode(arg_19_1)
	arg_19_0.checkTranscodeView()

def var_0_0.checkTranscodeView(arg_20_0):
	arg_20_0.transcode = pg.SdkMgr.GetInstance().GetYostarTransCode() or ""

	if not arg_20_0.transcode or arg_20_0.transcode == "" or arg_20_0.transcode == "NULL":
...
def var_0_0.checkAccountAppleView(arg_22_0):
...
def var_0_0.checkAccountAmazonView(arg_23_0):
...
def var_0_0.checkAccountYostarView(arg_24_0):
...
def var_0_0.checkAccountGPSView(arg_25_0):
