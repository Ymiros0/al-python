...
def var_0_0.UpdateItem(arg_7_0, arg_7_1, arg_7_2):
	...
	onButton(arg_7_0, arg_7_2, function()
		...
		if not var_8_0:
			...
			for iter_8_0 = #var_8_1, 1, -1:
				if var_8_1[iter_8_0] == var_7_1:
					table.remove(var_8_1, iter_8_0)

		var_7_2.ChangeSetting(var_8_1, function()
			arg_7_0.UpdateBtnsState()), SFX_UI_TAG)

def var_0_0.UpdateBtnsState(arg_11_0):
...
def var_0_0.GetList(arg_15_0):
	...
	for iter_15_0 = #var_15_1, 1, -1:
		local var_15_2 = var_15_1[iter_15_0]

		if not table.contains(var_15_0.LIMITED_OPERATION, var_15_2.key):
