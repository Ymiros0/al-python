...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.OPEN_PROJECT_LIST, function(arg_4_0)
		if arg_1_0.facade.hasMediator(BuildShipDetailMediator.__cname):
			return
...
def var_0_0.handleNotification(arg_17_0, arg_17_1):
	...
	if var_17_0 == PlayerProxy.UPDATED:
		arg_17_0.viewComponent.setPlayer(var_17_1)
	elif var_17_0 == GAME.CONFIRM_GET_SHIP:
		...
		if var_17_1.isBatch:
			...
			for iter_17_0, iter_17_1 in ipairs(var_17_1.ships):
				local var_17_6 = {
					type = DROP_TYPE_SHIP,
		...
		seriesAsync(var_17_4, function()
			if var_17_1.isBatch and var_17_3 > 0:
				NoPosMsgBox(i18n("switch_to_shop_tip_noDockyard"), openDockyardClear, gotoChargeScene, openDockyardIntensify)
			else
				arg_17_0.buildFinishComeback())
	elif var_17_0 == GAME.BUILD_SHIP_DONE:
	...
	elif var_17_0 == BuildShipProxy.ADDED or var_17_0 == BuildShipProxy.REMOVED:
		local var_17_8 = getProxy(BuildShipProxy).getRawData()

		arg_17_0.viewComponent.setStartCount(table.getCount(var_17_8))
	elif var_17_0 == GAME.SUPPORT_SHIP_DONE:
		local var_17_9 = {}

		for iter_17_2, iter_17_3 in ipairs(var_17_1.ships):
			if iter_17_3.virgin or iter_17_3.getRarity() >= 4:
