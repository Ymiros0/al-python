...
def var_0_0.OnInit(arg_3_0):
	onButton(arg_3_0, arg_3_0.shopBtn, function()
		arg_3_0.emit(BuildShipMediator.ON_SUPPORT_SHOP), SFX_PANEL)
...
def var_0_0.Flush(arg_5_0):
	...
	onButton(arg_5_0, arg_5_0.helpBtn, function()
		arg_5_0.contextData.helpWindow.ExecuteAction("Show", var_5_1, "support"), SFX_CANCEL)
	...
	onButton(arg_5_0, arg_5_0.startBtn, function()
		...
		arg_5_0.contextData.msgbox.ExecuteAction("Show", var_7_0), SFX_UI_BUILDING_STARTBUILDING)

def var_0_0.UpdateMedal(arg_9_0):
	setText(arg_9_0.medalCount.Find("Text"), getProxy(BagProxy).getItemCountById(ITEM_ID_SILVER_HOOK))

def var_0_0.UpdateBuildPoolPaiting(arg_10_0):
	local var_10_0 = arg_10_0.contextData.falgShip.getPainting()

	if arg_10_0.painting != var_10_0:
...
def var_0_0.ShowOrHide(arg_12_0, arg_12_1):
	if arg_12_1:
		arg_12_0.Show()
	else
		arg_12_0.Hide()
