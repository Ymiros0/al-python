...
def var_0_0.handleNotification(arg_9_0, arg_9_1):
	...
	if var_9_0 == CollectionProxy.AWARDS_UPDATE:
		arg_9_0.viewComponent.setAwards(var_9_1)
	elif var_9_0 == GAME.COLLECT_GET_AWARD_DONE:
	...
	elif var_9_0 == GAME.BEGIN_STAGE_DONE:
		arg_9_0.sendNotification(GAME.GO_SCENE, SCENE.COMBATLOAD, var_9_1)
	elif var_9_0 == var_0_0.EVENT_OBTAIN_SKIP:
