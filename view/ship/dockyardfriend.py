...
def var_0_0.updateSelected(arg_3_0, arg_3_1):
	...
	elif arg_3_0.selectedTwId:
		LeanTween.cancel(arg_3_0.selectedTwId)

		arg_3_0.selectedTwId = None
...
def var_0_0.flush(arg_4_0):
	if arg_4_0.shipVO:
		...
		for iter_4_0 = var_4_1, var_4_0.star - 1:
			cloneTplTo(arg_4_0.starTF, arg_4_0.starsTF)

		for iter_4_1 = 1, var_4_1:
...
def var_0_0.flushDetail(arg_7_0):
	...
	if var_7_1 and arg_7_0.detailType > var_0_0.DetailType0:
		...
		for iter_7_0 = 1, 6:
			...
			if arg_7_0.detailType == var_0_0.DetailType1:
				if iter_7_0 == 1:
			...
			elif arg_7_0.detailType == var_0_0.DetailType2:
				if iter_7_0 == 6:
...
def var_0_0.clear(arg_8_0):
	if arg_8_0.selectedTwId:
		LeanTween.cancel(arg_8_0.selectedTwId)

		arg_8_0.selectedTwId = None
