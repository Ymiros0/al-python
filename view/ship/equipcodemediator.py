...
def var_0_0.register(arg_1_0):
	...
	for iter_1_0, iter_1_1 in ipairs(getProxy(BayProxy).getEquipsInShips()):
		table.insert(var_1_0, iter_1_1)

	local var_1_1 = underscore.values(getProxy(EquipmentProxy).GetSpWeapons())

	for iter_1_2, iter_1_3 in ipairs(getProxy(BayProxy).GetSpWeaponsInShips()):
...
def var_0_0.initNotificationHandleDic(arg_6_0):
	arg_6_0.handleDic = {
