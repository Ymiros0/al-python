...
def var_0_0.setEquipments(arg_2_0, arg_2_1, arg_2_2):
...
def var_0_0.setShip(arg_3_0, arg_3_1):
	arg_3_0.shipVO = getProxy(BayProxy).getShipById(arg_3_1)
	arg_3_0.shipData = {}

	for iter_3_0, iter_3_1 in ipairs(arg_3_0.shipVO.getAllEquipments()):
		if not iter_3_1:
			arg_3_0.shipData[iter_3_0] = False
		else
			arg_3_0.shipData[iter_3_0] = underscore.detect(arg_3_0.equips, function(arg_4_0)
				return arg_4_0.configId == iter_3_1.configId and arg_4_0.shipId == arg_3_0.shipVO.id and arg_4_0.shipPos == iter_3_0) or False
	...
	if not var_3_0:
		...
		arg_3_0.shipData[6] = underscore.detect(arg_3_0.spWeapons, function(arg_5_0)
			return arg_5_0.configId == var_3_0.configId and arg_5_0.GetShipId() == arg_3_0.shipVO.id) or False

def var_0_0.getEquipShipVO(arg_6_0, arg_6_1):
	local var_6_0 = arg_6_0.shipVO.clone()

	var_6_0.equipments = underscore.first(arg_6_1, 5)
	var_6_0.spWeapon = arg_6_1[6] or None
...
local function var_0_4(arg_10_0, arg_10_1, arg_10_2)
	...
	if not arg_10_1 or not arg_10_2:
		setActive(var_10_0, False)
	elif arg_10_1.configId == arg_10_2.configId:
		setActive(var_10_0, False)
	else
		...
		for iter_10_0, iter_10_1 in ipairs({
			...
			while var_10_2[var_10_3][iter_10_1] > 0:
				var_10_3 = var_10_2[var_10_3][iter_10_1]

				if var_10_3 == arg_10_2.configId:
					var_10_1 = True
...
def var_0_0.onBackPressed(arg_11_0):
	...
	for iter_11_0 = 1, #arg_11_0.shipData:
		if (arg_11_0.shipData[iter_11_0] and arg_11_0.shipData[iter_11_0].configId or 0) != (arg_11_0.equipData[iter_11_0] and arg_11_0.equipData[iter_11_0].configId or 0):
...
def var_0_0.init(arg_14_0):
	...
	onButton(arg_14_0, arg_14_0.btnBack, function()
		arg_14_0.onBackPressed(), SFX_CANCEL)
	...
	onButton(arg_14_0, arg_14_0.rtMainPanel.Find("share/btn_comments"), function()
		arg_14_0.emit(EquipCodeMediator.OPEN_EQUIP_CODE_SHARE, arg_14_0.shipVO.getGroupId()), SFX_PANEL)
	...
	onButton(arg_14_0, arg_14_0.rtCodePanel.Find("btns/btn_withdrawn"), function()
		...
		arg_14_0.updateDispalyPanel(arg_14_0.rtCodePanel, "code"), SFX_CANCEL)
	onButton(arg_14_0, arg_14_0.rtCodePanel.Find("btns/btn_cancel"), function()
		...
		arg_14_0.initQuickPanel(), SFX_CANCEL)
	onToggle(arg_14_0, arg_14_0.rtCodePanel.Find("btns/toggle_quick"), function(arg_24_0)
		...
		arg_14_0.ltID = LeanTween.moveY(arg_14_0.rtCodePanel, arg_24_0 and 420 or 80, math.max(math.abs((arg_24_0 and 420 or 80) - arg_14_0.rtCodePanel.anchoredPosition.y), 0.1) / 2000).setOnComplete(System.Action(function()
			...
			if arg_24_0:
				arg_14_0.initQuickPanel())).uniqueId)
	eachChild(arg_14_0.rtCodePanel.Find("equipments_quick"), function(arg_27_0)
		onToggle(arg_14_0, arg_27_0, function(arg_28_0)
			...
			elif arg_14_0.quickIndex == arg_27_0.GetSiblingIndex() + 1:
				arg_14_0.quickIndex = None

				arg_14_0.updateQuickPanel(), SFX_PANEL)
	...
	onToggle(arg_14_0, arg_14_0.rtQuickPanel.Find("title/equiping"), function(arg_29_0)
		...
		if isActive(arg_14_0.rtQuickPanel):
			arg_14_0.updateQuickPanel(True), SFX_PANEL)
	...
	onButton(arg_14_0, var_14_0, function()
				...
				return setmetatable({
					...
					def callback:(arg_32_0)
						...
						local var_32_0 = underscore(arg_14_0.spweaponIndexDatas).chain().keys().all(function(arg_33_0)
							return arg_14_0.spweaponIndexDatas[arg_33_0] == StoreHouseConst.SPWEAPON_INDEX_COMMON.customPanels[arg_33_0].options[1]).value()
			...
			return setmetatable({
				...
				def callback:(arg_35_0)
					...
					local var_35_0 = underscore(arg_14_0.indexData).chain().keys().all(function(arg_36_0)
						return arg_14_0.indexData[arg_36_0] == StoreHouseConst.EQUIPMENT_INDEX_COMMON.customPanels[arg_36_0].options[1]).value()
		...
		arg_14_0.emit(EquipCodeMediator.OPEN_CUSTOM_INDEX, var_30_0), SFX_PANEL)
	...
	function arg_14_0.comList.onUpdateItem(arg_39_0, arg_39_1)
		...
		if arg_14_0.quickIndex == 6:
			var_0_2(var_39_0, var_39_1, var_39_1 and var_39_1.shipId and getProxy(BayProxy).getShipById(var_39_1.shipId) or None)
			onButton(arg_14_0, var_39_0, function()
				local var_40_0 = {}

				if var_39_1 and PlayerPrefs.GetInt("QUICK_CHANGE_EQUIP", 1) == 1:
				...
				seriesAsync(var_40_0, function()
					...
					var_0_3(var_42_0, var_39_1, var_39_1 and var_39_1.shipId and getProxy(BayProxy).getShipById(var_39_1.shipId) or None)
			...
			var_0_1(var_39_0, var_39_1 and setmetatable({
				...
				__index = var_39_1
			}) or var_39_1, var_39_1 and var_39_1.shipId and getProxy(BayProxy).getShipById(var_39_1.shipId) or None)
			setActive(var_39_0.Find("IconTpl/mask"), var_39_1 and var_39_1.mask)
			onButton(arg_14_0, var_39_0, function()
				if var_39_1 and var_39_1.mask:
					return
				...
				seriesAsync(var_44_0, function()
					...
					var_0_1(var_46_0, var_39_1, var_39_1 and var_39_1.shipId and getProxy(BayProxy).getShipById(var_39_1.shipId) or None)
	...
	setInputText(arg_14_0.rtInputField, arg_14_0.contextData.code or None)
	...
	onButton(arg_14_0, arg_14_0.btnInput, function()
		...
		arg_14_0.updateDispalyPanel(arg_14_0.rtCodePanel, "code"), SFX_CONFIRM)
...
def var_0_0.updateDispalyPanel(arg_49_0, arg_49_1, arg_49_2):
	...
	if arg_49_2 == "main":
		for iter_49_0, iter_49_1 in ipairs(arg_49_0.shipVO.getAllEquipments()):
		...
		for iter_49_2, iter_49_3 in ipairs(parseEquipCode(arg_49_0.code)):
			if iter_49_2 == 6:
				arg_49_0.codeData[iter_49_2] = var_49_0 and var_49_2[iter_49_3] and SpWeapon.New({
					id = iter_49_3
				}) or False

				if arg_49_0.codeData[iter_49_2] and not arg_49_0.getEquipShipVO(arg_49_0.codeData).CanEquipSpWeapon(arg_49_0.codeData[iter_49_2]):
				...
				if arg_49_0.codeData[iter_49_2] and not arg_49_0.getEquipShipVO(arg_49_0.codeData).canEquipAtPos(arg_49_0.codeData[iter_49_2], iter_49_2):
					arg_49_0.codeData[iter_49_2] = False
					var_49_3 = True
		...
		for iter_49_4, iter_49_5 in ipairs(arg_49_0.codeData):
			if iter_49_5 and arg_49_0.shipData[iter_49_4] and iter_49_5.configId == arg_49_0.shipData[iter_49_4].configId:
				arg_49_0.equipData[iter_49_4] = arg_49_0.shipData[iter_49_4]

		for iter_49_6, iter_49_7 in ipairs(arg_49_0.codeData):
			if iter_49_7 and not arg_49_0.equipData[iter_49_6]:
				...
				for iter_49_8, iter_49_9 in ipairs({
					...
					while var_49_4[var_49_6][iter_49_9] > 0:
				...
				if iter_49_6 == 6:
					for iter_49_10, iter_49_11 in ipairs(underscore.filter(arg_49_0.spWeapons, function(arg_50_0)
						...
						if var_49_7 and (not arg_49_0.equipData[iter_49_6] or var_49_7 < table.indexof(var_49_5, arg_49_0.equipData[iter_49_6].configId)):
		...
		for iter_49_14, iter_49_15 in ipairs(arg_49_0.equipData):
			local var_49_9 = arg_49_1.Find("equipments_quick").GetChild(iter_49_14 - 1)

			if iter_49_14 == 6:
				var_0_3(var_49_9, iter_49_15, iter_49_15 and iter_49_15.shipId and getProxy(BayProxy).getShipById(iter_49_15.shipId) or None)
			else
				var_0_1(var_49_9, iter_49_15, iter_49_15 and iter_49_15.shipId and getProxy(BayProxy).getShipById(iter_49_15.shipId) or None)

			var_0_4(var_49_9, arg_49_0.codeData[iter_49_14], iter_49_15)
	else
		assert(False)

def var_0_0.initQuickPanel(arg_53_0):
	eachChild(arg_53_0.rtCodePanel.Find("equipments_quick"), function(arg_54_0)
		if arg_54_0.GetSiblingIndex() + 1 == 6:
...
def var_0_0.updateQuickPanel(arg_55_0):
	if not isActive(arg_55_0.rtQuickPanel):
		return
...
def var_0_0.getFilterEquipments(arg_56_0):
	...
	return underscore(arg_56_0.equips).chain().filter(function(arg_57_0)
		return (not arg_57_0.shipId or arg_56_0.equipingFlag) and arg_57_0.count > underscore.reduce(arg_56_0.equipData, 0, function(arg_58_0, arg_58_1)
			return arg_58_0 + (arg_57_0 == arg_58_1 and 1 or 0)) and not var_56_0.isForbiddenAtPos(arg_57_0, arg_56_0.quickIndex) and IndexConst.filterEquipByType(arg_57_0, arg_56_0.indexData.typeIndex) and IndexConst.filterEquipByProperty(arg_57_0, var_56_1) and IndexConst.filterEquipAmmo1(arg_57_0, arg_56_0.indexData.equipAmmoIndex1) and IndexConst.filterEquipAmmo2(arg_57_0, arg_56_0.indexData.equipAmmoIndex2) and IndexConst.filterEquipByCamp(arg_57_0, arg_56_0.indexData.equipCampIndex) and IndexConst.filterEquipByRarity(arg_57_0, arg_56_0.indexData.rarityIndex) and IndexConst.filterEquipByExtra(arg_57_0, arg_56_0.indexData.extraIndex)).each(function(arg_59_0)
		arg_59_0.mask = not var_56_0.canEquipAtPos(arg_59_0, arg_56_0.quickIndex)).value()

def var_0_0.getFilterSpWeapon(arg_60_0):
