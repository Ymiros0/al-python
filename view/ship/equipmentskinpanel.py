...
def var_0_0.updateAll(arg_7_0, arg_7_1):
	if arg_7_1:
		for iter_7_0, iter_7_1 in ipairs(arg_7_0.equipmentTFs):
			if not not table.contains(ShipEquipView.UNLOCK_EQUIPMENT_SKIN_POS, iter_7_0):
		...
		for iter_7_2, iter_7_3 in ipairs(arg_7_0.equipmentNormalTFs):
			local var_7_1 = arg_7_0.findTF("shadow", iter_7_3)

			if var_7_1:
				setActive(var_7_1, not arg_7_0.inSkinPage)

def var_0_0.updateEquipmentTF(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_0.updateEquipmentPanel(arg_9_0, arg_9_1, arg_9_2):
	...
	if var_9_2:
		...
		onButton(arg_9_0, arg_9_0.equipmentTFs[arg_9_2], function()
			arg_9_0.emit(ShipMainMediator.ON_SELECT_EQUIPMENT_SKIN, arg_9_2), SFX_PANEL)
	else
		onButton(arg_9_0, var_9_3.Find("icon"), function()
			arg_9_0.emit(ShipMainMediator.ON_SELECT_EQUIPMENT_SKIN, arg_9_2), SFX_PANEL)

def var_0_0.updateSkinInfo(arg_12_0, arg_12_1, arg_12_2):
