...
local function var_0_1(arg_2_0)
	...
	function var_2_0.update(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_2:
			...
			for iter_3_0 = var_2_0.stars.childCount + 1, var_3_0:
...
def var_0_0.update(arg_5_0, arg_5_1, arg_5_2, arg_5_3):
	...
	for iter_5_0 = arg_5_0.charContainer.childCount, #var_5_1 - 1:
		cloneTplTo(arg_5_0.charTpl, arg_5_0.charContainer)

	for iter_5_1 = 0, arg_5_0.charContainer.childCount - 1:
	...
	for iter_5_2, iter_5_3 in pairs(var_5_0):
...
def var_0_0.updateBound(arg_6_0):
