...
def var_0_0.getState(arg_3_0):
	if arg_3_0.isLocked:
		return var_0_1
	elif arg_3_0.shipVO:
		return var_0_3
	elif not arg_3_0.isLocked and not arg_3_0.shipVO:
		return var_0_2
...
def var_0_0.updateProps(arg_7_0, arg_7_1):
	for iter_7_0 = 0, 2:
