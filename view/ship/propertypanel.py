...
def var_0_0.initProperty(arg_2_0, arg_2_1, arg_2_2):
...
def var_0_0.initRadar(arg_3_0, arg_3_1):
	local var_3_0 = {}
	local var_3_1 = {}

	table.insert(var_3_0, Vector3(0, 0, 0))

	for iter_3_0, iter_3_1 in ipairs(var_0_2):
...
def var_0_0.getGradeCoordinate1(arg_5_0, arg_5_1, arg_5_2):
	local var_5_0 = 0.66 * var_0_3[arg_5_1]

	if arg_5_2 == var_0_8:
		return Vector3(-var_5_0 * var_0_1, 0, 0)
	elif arg_5_2 == var_0_9:
		return Vector3(var_5_0 * var_0_1, 0, 0)
	else
		local var_5_1 = 60
		...
		if arg_5_2 == var_0_5:
			var_5_4 = -var_5_4
		elif arg_5_2 == var_0_6:
			var_5_4 = -var_5_4
			var_5_3 = -var_5_3
		elif arg_5_2 == var_0_7:
			var_5_3 = -var_5_3

		return Vector3(var_5_4, var_5_3, 0)

def var_0_0.setSpriteTo(arg_6_0, arg_6_1, arg_6_2, arg_6_3):
