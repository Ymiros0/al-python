...
def var_0_0.updateStatistics(arg_5_0):
	...
	for iter_5_0, iter_5_1 in ipairs(var_0_1):
	...
	for iter_5_2 = 1, var_5_14:
		setActive(var_5_15.GetChild(iter_5_2 - 1), True)

	for iter_5_3 = 1, var_5_13:
	...
	local var_5_19, var_5_20, var_5_21 = ShipWordHelper.GetWordAndCV(var_5_0.skinId, ShipWordHelper.WORD_TYPE_UPGRADE, None, None, var_5_18)
	...
	if var_5_24:
		...
		if arg_5_0.designBg and arg_5_0.designName != "raritydesign" .. var_5_23.getRarity():
			PoolMgr.GetInstance().ReturnUI(arg_5_0.designName, arg_5_0.designBg)

			arg_5_0.designBg = None

		if not arg_5_0.designBg:
		...
		if arg_5_0.metaBg and arg_5_0.metaName != "raritymeta" .. var_5_23.getRarity():
			PoolMgr.GetInstance().ReturnUI(arg_5_0.metaName, arg_5_0.metaBg)

			arg_5_0.metaBg = None

		if not arg_5_0.metaBg:
...
def var_0_0.voice(arg_15_0, arg_15_1):
	if not arg_15_1:
		return
...
def var_0_0.stopVoice(arg_16_0):
	if arg_16_0._currentVoice:
		pg.CriMgr.GetInstance().UnloadSoundEffect_V3(arg_16_0._currentVoice)

	arg_16_0._currentVoice = None

def var_0_0.recycleSpineChar(arg_17_0):
	if arg_17_0.shipPrefab and arg_17_0.shipModel:
		PoolMgr.GetInstance().ReturnSpineChar(arg_17_0.shipPrefab, arg_17_0.shipModel)

		arg_17_0.shipPrefab = None
		arg_17_0.shipModel = None

def var_0_0.willExit(arg_18_0):
	if arg_18_0.delayTId:
		LeanTween.cancel(arg_18_0.delayTId)

	arg_18_0.recycleSpineChar()

	if arg_18_0.designBg:
	...
	if arg_18_0.loadedCVBankName:
		pg.CriMgr.UnloadCVBank(arg_18_0.loadedCVBankName)

		arg_18_0.loadedCVBankName = None
