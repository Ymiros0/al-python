...
def var_0_0.onBackPressed(arg_3_0):
	if isActive(arg_3_0.impackPanel):
...
def var_0_0.setShipGroup(arg_11_0, arg_11_1):
	arg_11_0.shipGroup = arg_11_1

def var_0_0.setShowTrans(arg_12_0, arg_12_1):
	arg_12_0.showTrans = arg_12_1

def var_0_0.flushAll(arg_13_0):
	arg_13_0.flushShip()
	arg_13_0.flushHeart()
	arg_13_0.flushEva()

def var_0_0.flushShip(arg_14_0):
	...
	setShipCardFrame(arg_14_0.imageFrame, var_14_2, None)
	...
	for iter_14_0 = arg_14_0.stars.childCount, var_14_4 - 1:
		local var_14_5 = cloneTplTo(arg_14_0.star, arg_14_0.stars)

def var_0_0.flushHeart(arg_15_0):
...
def var_0_0.flushEva(arg_16_0):
	...
	for iter_16_3 = 1, arg_16_0.hotContent.childCount:
		local var_16_12 = arg_16_0.hotContent.GetChild(iter_16_3 - 1)

		if go(var_16_12).name != "tag":
...
def var_0_0.initImpeachPanel(arg_21_0):
	...
	onButton(arg_21_0, arg_21_0.impackPanel.Find("window/top/btnBack"), function()
		arg_21_0.onBackPressed(), SFX_CANCEL)
	...
	onButton(arg_21_0, arg_21_0.impackPanel.Find("window/button_container/button"), function()
		if arg_21_0.impeachOption == "other":
			local var_27_0 = getInputText(var_21_2)

			if string.len(var_27_0) > 0:
		...
		arg_21_0.onBackPressed(), SFX_CONFIRM)

def var_0_0.openImpeachPanel(arg_28_0, arg_28_1):
