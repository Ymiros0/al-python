...
def var_0_0.OnInit(arg_2_0):
	...
	onButton(arg_2_0, arg_2_0._renameConfirmBtn, function()
		...
		arg_2_0.emit(ShipMainMediator.RENAME_SHIP, arg_2_0.GetShipVO().id, var_3_0), SFX_CONFIRM)
	onButton(arg_2_0, arg_2_0._renameRevert, function()
		...
		setInputText(findTF(arg_2_0._renamePanel, "frame/name_field"), var_4_0), SFX_PANEL)
	onButton(arg_2_0, arg_2_0._renameCloseBtn, function()
		arg_2_0.DisplayRenamePanel(False), SFX_PANEL)
	onButton(arg_2_0, arg_2_0._renameCancelBtn, function()
		arg_2_0.DisplayRenamePanel(False), SFX_CANCEL)

def var_0_0.SetShareData(arg_7_0, arg_7_1):
	arg_7_0.shareData = arg_7_1

def var_0_0.GetShipVO(arg_8_0):
	if arg_8_0.shareData and arg_8_0.shareData.shipVO:
		return arg_8_0.shareData.shipVO

	return None

def var_0_0.DisplayRenamePanel(arg_9_0, arg_9_1):
