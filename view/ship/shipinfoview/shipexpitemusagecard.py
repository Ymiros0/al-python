...
def var_0_0.Ctor(arg_1_0, arg_1_1):
	...
	pressPersistTrigger(arg_1_1.Find("m10"), 0.5, function()
		...
		arg_1_0.UpdateValue(True), None, True, True, 0.15, SFX_PANEL)
	pressPersistTrigger(arg_1_1.Find("a10"), 0.5, function()
		arg_1_0.value = arg_1_0.value + 10

		arg_1_0.UpdateValue(), None, True, True, 0.15, SFX_PANEL)
...
def var_0_0.SetCallBack(arg_6_0, arg_6_1):
	arg_6_0.callback = arg_6_1

def var_0_0.GetItem(arg_7_0, arg_7_1):
...
def var_0_0.UpdateValue(arg_9_0, arg_9_1):
...
def var_0_0.ForceUpdateValue(arg_10_0, arg_10_1):
