...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.recomBtn, function()
		...
		for iter_6_0, iter_6_1 in pairs(arg_3_0.cards):
			iter_6_1.value = var_6_0[iter_6_1.item.id] or 0

			iter_6_1.UpdateValue(), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.clearBtn, function()
		for iter_7_0, iter_7_1 in pairs(arg_3_0.cards):
			iter_7_1.value = 0

			iter_7_1.UpdateValue(), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.confirmBtn, function()
		...
		if var_8_4 and (var_8_2.maxLevel == var_8_2.level and var_8_2.exp > 0 or var_8_2.maxLevel < var_8_2.level):
...
def var_0_0.GetItem(arg_13_0, arg_13_1):
...
def var_0_0.Recommand(arg_14_0):
	local var_14_0 = {}
	...
	for iter_14_0, iter_14_1 in ipairs(var_14_2):
		...
		for iter_14_2 = 1, iter_14_1.count:
			if iter_14_0 != #var_14_2 and arg_14_0.PreCalcExpOverFlow(var_14_1, tonumber(var_14_3), tonumber(var_14_4)):
				break
			else
				...
				if var_14_1.maxLevel == var_14_1.level:
					return var_14_0

	return var_14_0

def var_0_0.PreCalcExpOverFlow(arg_17_0, arg_17_1, arg_17_2, arg_17_3):
...
def var_0_0.OnAddItem(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4):
	if arg_26_0.shipVO.maxLevel == arg_26_0.shipVO.level:
	...
	for iter_26_0, iter_26_1 in pairs(arg_26_0.itemCnts):
		if iter_26_0 != arg_26_2:
	...
	if arg_26_4:
		var_26_4 = arg_26_3
	elif var_26_0.level != var_26_0.maxLevel:
		for iter_26_2 = 1, arg_26_3:
			var_26_0.addExp(tonumber(var_26_3))

			var_26_4 = var_26_4 + 1

			if var_26_0.maxLevel == var_26_0.level:
				break

	if arg_26_3 > (arg_26_0.itemCnts[arg_26_2] or 0):
		var_26_4 = math.max(arg_26_0.itemCnts[arg_26_2] or 0, var_26_4)

	if arg_26_3 != var_26_4:
...
def var_0_0.GetTempShipVO(arg_27_0, arg_27_1, arg_27_2):
	if arg_27_2 > 0:
...
def var_0_0.GetAdditionExp(arg_28_0):
	local var_28_0 = 0

	for iter_28_0, iter_28_1 in pairs(arg_28_0.itemCnts):
...
def var_0_0.UpdateLevelInfo(arg_29_0):
...
def var_0_0.OnDestroy(arg_30_0):
	for iter_30_0, iter_30_1 in pairs(arg_30_0.cards):
		iter_30_1.Dispose()
