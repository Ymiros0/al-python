...
def var_0_0.register(arg_1_0):
	...
	if arg_1_0.contextData.selectContextData:
	...
	arg_1_0.bind(var_0_0.ON_SELECT_EQUIPMENT, function(arg_12_0, arg_12_1)
		...
		for iter_12_0, iter_12_1 in ipairs(var_12_0):
			if not var_12_2.isForbiddenAtPos(iter_12_1, arg_12_1):
				table.insert(var_12_3, iter_12_1)

		_.each(var_12_3, function(arg_14_0)
			if not var_12_2.canEquipAtPos(arg_14_0, arg_12_1):
				arg_14_0.mask = True)
		arg_1_0.sendNotification(GAME.GO_SCENE, SCENE.EQUIPSCENE, {
			lock = True,
	...
	arg_1_0.bind(var_0_0.ON_SEL_COMMANDER, function(arg_33_0)
		...
		arg_1_0.sendNotification(GAME.GO_SCENE, SCENE.COMMANDPOST, {
			...
			def onShip:(arg_34_0)
				if arg_34_0.shipId == arg_1_0.contextData.shipId:
					return False, i18n("commander_ship_already_equip")

				return True,
			def onSelected:(arg_35_0)
				if #arg_35_0 == 0:
	...
	if arg_1_0.contextData.selectedId:
		arg_1_0.sendNotification(GAME.COMMANDER_EQUIP_TO_SHIP, {
			shipId = arg_1_0.contextData.shipId,
			commanderId = arg_1_0.contextData.selectedId
		})

		arg_1_0.contextData.selectedId = None
	elif arg_1_0.contextData.unequipCommander:
		arg_1_0.contextData.unequipCommander = None
...
def var_0_0.getEquipmentSkins(arg_42_0, arg_42_1, arg_42_2):
	if not arg_42_1:
		return {}
	...
	for iter_42_0, iter_42_1 in ipairs(var_42_4 or {}):
		table.insert(var_42_5, iter_42_1)

	return var_42_5

def var_0_0.nextPage(arg_45_0, arg_45_1, arg_45_2):
	if #arg_45_0.contextData.shipVOs == 0:
		return
	...
	for iter_45_0 = var_45_0, var_45_1, var_45_2:
	...
	if var_45_3:
		...
		if arg_45_0.contextData.selectContextData:
		...
		if var_45_6 == ShipViewConst.PAGE.UPGRADE:
			arg_45_0.closeUpgrade()
		elif var_45_6 == ShipViewConst.PAGE.INTENSIFY and not arg_45_0.intensifyContext:
			arg_45_0.closeIntensify()
		elif var_45_6 == ShipViewConst.PAGE.EQUIPMENT and arg_45_0.contextData.isInEquipmentSkinPage and var_45_3.hasEquipEquipmentSkin() and not ShipStatus.ShipStatusCheck("onModify", var_45_3):
			-- block empty
...
def var_0_0.openRemould(arg_46_0):
	if getProxy(ContextProxy).getCurrentContext().getContextByMediator(ShipRemouldMediator):
		return
...
def var_0_0.closeRemould(arg_47_0):
...
def var_0_0.openUpgrade(arg_48_0):
	if getProxy(ContextProxy).getCurrentContext().getContextByMediator(ShipUpgradeMediator2):
		return
...
def var_0_0.closeUpgrade(arg_49_0):
...
def var_0_0.openIntensify(arg_50_0):
	if arg_50_0.intensifyContext != None:
		arg_50_0.intensifyContext.data.shipId = arg_50_0.contextData.shipId

		return

	if getProxy(ContextProxy).getCurrentContext().getContextByMediator(ShipModMediator):
		return
	...
	arg_50_0.addSubLayers(arg_50_0.intensifyContext, False, function()
		arg_50_0.intensifyContext = None)

def var_0_0.closeIntensify(arg_52_0):
...
def var_0_0.handleNotification(arg_54_0, arg_54_1):
	...
	if var_54_0 == BayProxy.SHIP_UPDATED:
	...
	elif var_54_0 == ShipSkinProxy.SHIP_SKINS_UPDATE:
	...
	elif var_54_0 == ShipUpgradeMediator2.NEXTSHIP:
		local var_54_4 = arg_54_0.nextPage(var_54_1, 3)
	elif var_54_0 == ShipModMediator.LOADEND:
		arg_54_0.viewComponent.setModPanel(var_54_1)
	elif var_54_0 == GAME.RENAME_SHIP_DONE:
		arg_54_0.viewComponent.DisplayRenamePanel(False)
	elif var_54_0 == GAME.RECORD_SHIP_EQUIPMENT_DONE:
		if var_54_1.shipId == arg_54_0.contextData.shipId and var_54_1.type == 1:
			arg_54_0.viewComponent.updateRecordEquipments(var_54_1.index)
	elif var_54_0 == GAME.SKIN_SHOPPIGN_DONE or var_54_0 == GAME.SKIN_COUPON_SHOPPING_DONE:
		local var_54_5 = pg.shop_template[var_54_1.id]

		if var_54_5 and var_54_5.genre == ShopArgs.SkinShop:
	...
	elif var_54_0 == GAME.UPGRADE_MAX_LEVEL_DONE:
		...
		arg_54_0.viewComponent.doUpgradeMaxLeveAnim(var_54_1.oldShip, var_54_1.newShip, function()
			if arg_54_0.maxLevelCallback:
				arg_54_0.maxLevelCallback()

				arg_54_0.maxLevelCallback = None
	...
	elif var_54_0 == GAME.REMOVE_LAYERS:
		if var_54_1.context.mediator == ProposeMediator:
			arg_54_0.viewComponent.SwitchToDefaultBGM()
	elif var_54_0 == GAME.HIDE_Ship_MAIN_SCENE_WORD:
		arg_54_0.viewComponent.hideShipWord()
	elif var_54_0 == GAME.PROPOSE_SHIP_DONE:
		local var_54_6 = arg_54_0.viewComponent.shipFashionView

		if var_54_6 and var_54_6.GetLoaded():
			var_54_6.UpdateAllFashion(True)
	elif var_54_0 == GAME.USE_ADD_SHIPEXP_ITEM_DONE:
		pg.TipsMgr.GetInstance().ShowTips(i18n("ship_shipModLayer_modSuccess"))
		arg_54_0.viewComponent.RefreshShipExpItemUsagePage()
	elif var_54_0 == EquipmentProxy.EQUIPMENT_UPDATED:
		arg_54_0.viewComponent.equipmentChange()
	elif var_54_0 == GAME.WILL_LOGOUT:
		arg_54_0.viewComponent.OnWillLogout()
	elif var_54_0 == PaintingGroupConst.NotifyPaintingDownloadFinish:
		arg_54_0.viewComponent.updateFashionTag()

def var_0_0.remove(arg_56_0):
	if arg_56_0.maxLevelCallback:
		arg_56_0.maxLevelCallback()

		arg_56_0.maxLevelCallback = None
