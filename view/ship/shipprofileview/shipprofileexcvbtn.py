...
def var_0_0.Init(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5):
	...
	if string.find(var_1_0, ShipWordHelper.WORD_TYPE_MAIN):
		...
		var_1_1, var_1_2 = ShipWordHelper.ExistExCv(arg_1_2.id, var_1_0, None, arg_1_5)

	if arg_1_0.wordData.cvPath and var_1_2:
...
def var_0_0.Update(arg_2_0):
	...
	local var_2_1 = arg_2_0.wordData.textContent == None or arg_2_0.wordData.textContent == "None" or arg_2_0.wordData.textContent == ""
...
def var_0_0.UpdateCvBtn(arg_3_0):
	...
	if not var_3_1:
		onButton(None, arg_3_0._tf, function()
			pg.TipsMgr.GetInstance().ShowTips(var_3_2), SFX_PANEL)

def var_0_0.isEx(arg_5_0):
