...
def var_0_0.UpdateCvBtn(arg_3_0, arg_3_1):
...
def var_0_0.UpdateLang2(arg_4_0):
...
def var_0_0.UpdateLang1(arg_5_0):
...
def var_0_0.OnCvBtn(arg_6_0, arg_6_1):
...
def var_0_0.Update(arg_13_0, arg_13_1, arg_13_2, arg_13_3):
	arg_13_0.Show()
	...
	if isActive(arg_13_0.weddingReview):
...
def var_0_0.Flush(arg_15_0, arg_15_1, arg_15_2):
	if arg_15_0.skin and arg_15_0.skin.id == arg_15_1.id and arg_15_0.isLive2d == arg_15_2:
		return
...
def var_0_0.UpdateProfileInfo(arg_16_0):
	...
	if var_16_4:
		onButton(arg_16_0, arg_16_0.profilePlayBtn, function()
			arg_16_0.cvLoader.PlaySound(var_16_1), SFX_PANEL)

	setActive(arg_16_0.profilePlayBtn, var_16_4)

def var_0_0.SetCvLoader(arg_18_0, arg_18_1):
	arg_18_0.cvLoader = arg_18_1

def var_0_0.SetCallback(arg_19_0, arg_19_1):
	arg_19_0.callback = arg_19_1

def var_0_0.UpdateLanguage(arg_20_0):
	...
	if var_20_2.voice_key_2 >= 0 and var_20_3 == 0:
	...
	if var_20_2.voice_key_2 >= 0 or var_20_2.voice_key_2 == -2:
...
def var_0_0.SetAuthorInfo(arg_21_0):
...
def var_0_0.SetIllustrator(arg_22_0):
	local var_22_0 = arg_22_0.shipGroup.GetNationTxt()

	print(var_22_0)
	arg_22_0.illustrator.SetText(var_22_0)

def var_0_0.GetCvList(arg_23_0, arg_23_1):
	local var_23_0 = {}

	if arg_23_1:
		if pg.ship_skin_template[arg_23_0.skin.id].spine_use_live2d == 1:
...
def var_0_0.UpdateCvList(arg_24_0, arg_24_1):
	...
	for iter_24_0, iter_24_1 in ipairs(arg_24_0.dispalys):
	...
	if var_24_2 < var_24_4:
		for iter_24_2 = var_24_2 + 1, var_24_4:
			arg_24_0.AddMainExBtn(iter_24_2, var_24_0)

			var_24_0 = var_24_0 + 1

def var_0_0.AddMainExBtn(arg_26_0, arg_26_1, arg_26_2):
	...
	onButton(arg_26_0, var_26_0._tf, function()
		if arg_26_0.callback:
			arg_26_0.callback(var_26_0), SFX_PANEL)
...
def var_0_0.AddCvBtn(arg_28_0, arg_28_1):
...
def var_0_0.AddExCvBtn(arg_30_0, arg_30_1):
	...
	onButton(arg_30_0, var_30_0._tf, function()
		if arg_30_0.callback:
			arg_30_0.callback(var_30_0), SFX_PANEL)
...
def var_0_0.DestroyCvBtns(arg_32_0):
	if not arg_32_0.cvBtns:
		return

	for iter_32_0, iter_32_1 in ipairs(arg_32_0.cvBtns):
		iter_32_1.Destroy()
