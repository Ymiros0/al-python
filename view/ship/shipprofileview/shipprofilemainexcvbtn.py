...
def var_0_0.Init(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4):
	...
	if string.find(var_1_10, ShipWordHelper.WORD_TYPE_MAIN):
		local var_1_12 = string.gsub(var_1_10, ShipWordHelper.WORD_TYPE_MAIN, "")

		var_1_7 = tonumber(var_1_12)
		var_1_4, var_1_5, var_1_6 = ShipWordHelper.GetWordAndCV(arg_1_0.skin.id, ShipWordHelper.WORD_TYPE_MAIN, var_1_7, None, var_1_11)
...
def var_0_0.Update(arg_2_0):
	...
	local var_2_2 = arg_2_0.wordData.textContent == None or arg_2_0.wordData.textContent == "None" or arg_2_0.wordData.textContent == ""

	if not arg_2_0.isLive2d:
