...
def var_0_0.handleNotification(arg_11_0, arg_11_1):
	...
	if var_11_0 == GAME.FETCH_EVALUATION_DONE:
	...
	elif var_11_0 == CollectionProxy.GROUP_INFO_UPDATE:
		local var_11_2 = var_11_1

		if arg_11_0.groupId == var_11_2:
	...
	elif var_11_0 == ShipSkinProxy.SHIP_SKINS_UPDATE:
