...
def var_0_0.getShipTranformData(arg_7_0):
	...
	for iter_7_0, iter_7_1 in ipairs(var_7_0.transform_list):
		for iter_7_2, iter_7_3 in ipairs(iter_7_1):
...
def var_0_0.initTranformInfo(arg_9_0):
	arg_9_0.transformIds = arg_9_0.getShipTranformData()
	arg_9_0.grids = {}

	for iter_9_0, iter_9_1 in pairs(arg_9_0.transformIds):
		...
		onToggle(arg_9_0, var_9_0, function(arg_10_0)
			if arg_10_0 and arg_9_0.curtransformId != iter_9_0:
				arg_9_0.updateInfo(iter_9_0), SFX_PANEL)

		arg_9_0.grids[iter_9_0] = var_9_0

	arg_9_0.lineTFs = {}

	for iter_9_2, iter_9_3 in pairs(arg_9_0.transformIds):
	...
	if arg_9_0.contextData.transformId:
...
def var_0_0.initLines(arg_11_0, arg_11_1):
	local var_11_0 = 270
	local var_11_1 = 75
	...
	for iter_11_0, iter_11_1 in pairs(var_11_8):
...
def var_0_0.updateLines(arg_12_0):
	for iter_12_0, iter_12_1 in pairs(arg_12_0.transformIds):
		arg_12_0.updateGridTF(iter_12_0)

		if arg_12_0.canRemould(iter_12_0) or arg_12_0.isFinished(iter_12_0):
			for iter_12_2, iter_12_3 in ipairs(arg_12_0.lineTFs[iter_12_0] or {}):
				iter_12_3.hrz.GetComponent("UIGrayScale").enabled = False
				iter_12_3.vec.GetComponent("UIGrayScale").enabled = False

def var_0_0.getLevelById(arg_13_0, arg_13_1):
	return pg.transform_data_template[arg_13_1].level_limit

def var_0_0.getTransformLevel(arg_14_0, arg_14_1):
	if not arg_14_0.shipVO.transforms[arg_14_1]:
		return 0
	else
...
def var_0_0.getTransformState(arg_15_0, arg_15_1):
	if arg_15_0.getTransformLevel(arg_15_1) == pg.transform_data_template[arg_15_1].max_level:
		return var_0_0.STATE_FINISHED
	elif arg_15_0.canRemould(arg_15_1):
		return var_0_0.STATE_ACTIVE
	else
		return var_0_0.STATE_LOCK

def var_0_0.updateGridTF(arg_16_0, arg_16_1):
	...
	if var_16_3 == var_0_0.STATE_FINISHED:
		setText(var_16_5, var_16_4 .. "/" .. var_16_1.max_level)
	elif var_16_3 == var_0_0.STATE_ACTIVE:
		setText(var_16_5, var_16_4 .. "/" .. var_16_1.max_level)
	elif var_16_3 == var_0_0.STATE_LOCK:
		...
		if var_16_8 and var_16_8[1] == 2:
			setText(var_16_0.Find("tags/lock/lock_level/Text"), var_16_8[2])
		elif var_16_8 and var_16_8[1] == 3:
	...
	if not arg_16_0.posTransId[var_16_9]:
		arg_16_0.posTransId[var_16_9] = arg_16_1
	elif arg_16_0.posTransId[var_16_9] == arg_16_1:
		-- block empty
	elif var_16_3 == var_0_0.STATE_ACTIVE or arg_16_0.getTransformState(arg_16_0.posTransId[var_16_9]) != var_0_0.STATE_ACTIVE and arg_16_1 < arg_16_0.posTransId[var_16_9]:
		if arg_16_0.posTransId[var_16_9] == arg_16_0.curtransformId:
...
def var_0_0.updateInfo(arg_21_0, arg_21_1):
	if arg_21_0.isFinished(arg_21_1):
		arg_21_0.updateFinished(arg_21_1)
	else
		arg_21_0.updateProgress(arg_21_1)

def var_0_0.updateFinished(arg_22_0, arg_22_1):
	...
	_.each(var_22_1.ship_id, function(arg_25_0)
		if arg_25_0[1] == arg_22_0.shipVO.configId:
			var_22_6 = arg_25_0[2]

		if pg.ship_data_template[arg_25_0[1]].group_type == arg_22_0.shipVO.groupId:
	...
	if var_22_7:
		...
		for iter_22_3, iter_22_4 in pairs(var_22_11):
			if var_22_10[iter_22_3]:
		...
		for iter_22_5 = 1, 3:
			if var_22_10["equipment_proficiency_" .. iter_22_5]:
...
def var_0_0.updateProgress(arg_28_0, arg_28_1):
	...
	if var_28_1.use_item[var_28_0]:
		var_28_5 = Clone(var_28_1.use_item[var_28_0])
	else
		var_28_5 = {}

	if var_28_1.use_gold > 0:
	...
	if var_28_1.use_ship != 0:
		...
		onButton(arg_28_0, arg_28_0.shipTF, function()
			if var_28_2:
				...
				pg.TipsMgr.GetInstance().ShowTips(var_28_3), SFX_PANEL)
	else
		arg_28_0.contextData.materialShipIds = None

	setActive(arg_28_0.skillDesc.parent, var_28_1.skill_id != 0)

	if var_28_1.skill_id != 0:
	...
	for iter_28_1 = 1, var_28_9:
		...
		if iter_28_1 <= #var_28_5:
			...
			if var_28_11[1] == id2ItemId(PlayerConst.ResGold):
				...
				if var_28_14 or not ItemTipPanel.CanShowTip(var_28_11[1]):
					RemoveComponent(var_28_10, typeof(Button))
				else
					onButton(arg_28_0, var_28_10, function()
	...
	_.each(var_28_1.ship_id, function(arg_32_0)
		if arg_32_0[1] == arg_28_0.shipVO.configId:
			var_28_15 = arg_32_0[2]

		if pg.ship_data_template[arg_32_0[1]].group_type == arg_28_0.shipVO.groupId:
	...
	if var_28_16:
		...
		for iter_28_2, iter_28_3 in pairs(var_28_19):
			if var_28_4[iter_28_2]:
		...
		for iter_28_4 = 1, 3:
			if var_28_4["equipment_proficiency_" .. iter_28_4]:
	...
	onButton(arg_28_0, arg_28_0.confirmBtn, function()
		...
		if var_28_15:
			...
			var_34_6.contentText.AddListener(function(arg_36_0, arg_36_1)
				if arg_36_0 == "clickDetail":
					arg_28_0.showToolTip(arg_28_1))
		else
			arg_28_0.emit(ShipRemouldMediator.REMOULD_SHIP, arg_28_0.shipVO.id, arg_28_1), SFX_CONFIRM)

	arg_28_0.contextData.transformId = arg_28_1

def var_0_0.isUnlock(arg_37_0, arg_37_1):
	if not arg_37_0.isUnLockPrev(arg_37_1):
		return False

	if arg_37_0.getLevelById(arg_37_1) > arg_37_0.shipVO.level:
		return False

	if not arg_37_0.isReachStar(arg_37_1):
		return False

	return True

def var_0_0.isFinished(arg_38_0, arg_38_1):
	local var_38_0 = pg.transform_data_template[arg_38_1]
	local var_38_1 = arg_38_0.getTransformLevel(arg_38_1)

	if var_38_0.max_level == var_38_1:
		return True

	return False

def var_0_0.isReachStar(arg_39_0, arg_39_1):
	local var_39_0 = pg.transform_data_template[arg_39_1]

	return arg_39_0.shipVO.getStar() >= var_39_0.star_limit

def var_0_0.canRemould(arg_40_0, arg_40_1):
	if not arg_40_0.isUnLockPrev(arg_40_1):
...
def var_0_0.isUnLockPrev(arg_41_0, arg_41_1):
	local var_41_0 = pg.transform_data_template[arg_41_1]

	for iter_41_0, iter_41_1 in pairs(var_41_0.condition_id):
		local var_41_1 = pg.transform_data_template[iter_41_1]

		if not arg_41_0.shipVO.transforms[iter_41_1] or arg_41_0.shipVO.transforms[iter_41_1].level != var_41_1.max_level:
			return False

	return True

def var_0_0.isEnoughResource(arg_42_0, arg_42_1):
	local var_42_0 = pg.transform_data_template[arg_42_1]
	local var_42_1 = arg_42_0.getTransformLevel(arg_42_1) + 1

	for iter_42_0, iter_42_1 in ipairs(var_42_0.use_item[var_42_1] or {}):
		if not arg_42_0.itemsVO[iter_42_1[1]] or arg_42_0.itemsVO[iter_42_1[1]].count < iter_42_1[2]:
			return False, i18n("ship_remould_no_item")

	if arg_42_0.playerVO.gold < var_42_0.use_gold:
		return False, i18n("ship_remould_no_gold")

	if var_42_0.use_ship != 0 and (not arg_42_0.contextData.materialShipIds or #arg_42_0.contextData.materialShipIds != var_42_0.use_ship):
		return False, i18n("ship_remould_no_material")

	return True

def var_0_0.updateAttrTF(arg_43_0, arg_43_1, arg_43_2, arg_43_3):
...
def var_0_0.updateAttrTF_D(arg_44_0, arg_44_1, arg_44_2, arg_44_3):
...
def var_0_0.showToolTip(arg_45_0, arg_45_1):
	if not arg_45_0.shipVO:
		return
	...
	if not var_45_1:
		...
		_.each(var_45_0.ship_id, function(arg_46_0)
			if arg_46_0[1] == arg_45_0.shipVO.configId:
		...
		for iter_45_0, iter_45_1 in ipairs(var_45_4):
			local var_45_7 = {}

			if iter_45_1 == AttributeType.Expend:
		...
		var_45_8.make(function(arg_47_0, arg_47_1, arg_47_2)
			if arg_47_0 == UIItemList.EventUpdate:
				...
				if var_47_0.add and var_47_0.from != var_47_0.to:
					setActive(var_47_1, True)

					if var_47_0.from > var_47_0.to:
						var_47_2 = "#FF3333"
...
def var_0_0.onBackPressed(arg_52_0):
	if isActive(arg_52_0.tooltip):
		arg_52_0.closeTip()
