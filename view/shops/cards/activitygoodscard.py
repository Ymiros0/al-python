...
def var_0_0.update(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4):
	...
	if var_2_1:
		...
		if var_2_3 == "pass":
			...
			onButton(arg_2_0, arg_2_0.mask, function()
				pg.TipsMgr.GetInstance().ShowTips(i18n("eventshop_unlock_hint", var_2_4)), SFX_PANEL)
		elif var_2_3 == 1 or var_2_3 == 2:
	...
	if var_2_0:
		...
		if var_2_7 and not var_2_8:
			setActive(arg_2_0.mask, True)
			setActive(arg_2_0.sellEndTag, True)
			removeOnButton(arg_2_0.mask)
			onButton(arg_2_0, arg_2_0.mask, function()
				if var_2_9:
					pg.TipsMgr.GetInstance().ShowTips(i18n("tip_build_ticket_exchange_expired", var_2_6.getName())), SFX_PANEL)
	...
	if GetComponent(arg_2_0.limitCountTF, typeof(Outline)):
		setOutlineColor(arg_2_0.limitCountTF, arg_2_4)

	if GetComponent(arg_2_0.limitCountLabelTF, typeof(Outline)):
		setOutlineColor(arg_2_0.limitCountLabelTF, arg_2_4)

def var_0_0.setAsLastSibling(arg_6_0):
	arg_6_0.tr.SetAsLastSibling()

def var_0_0.StaticUpdate(arg_7_0, arg_7_1, arg_7_2, arg_7_3):
	...
	if arg_7_1.getConfig("num_limit") == 0:
		var_7_8.text = i18n("common_no_limit")
	else
		local var_7_14 = arg_7_1.getConfig("num_limit")

		if var_7_12.type == DROP_TYPE_SKIN and not var_7_10:
