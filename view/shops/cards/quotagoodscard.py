...
def var_0_0.update(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4):
	...
	onButton(arg_2_0, arg_2_0.mask, function()
		pg.TipsMgr.GetInstance().ShowTips(i18n("quota_shop_limit_error")), SFX_PANEL)
...
def var_0_0.setAsLastSibling(arg_4_0):
	arg_4_0.tr.SetAsLastSibling()

def var_0_0.OnDispose(arg_5_0):
	arg_5_0.goodsVO = None
