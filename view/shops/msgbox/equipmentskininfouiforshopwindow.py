...
def var_0_0.Open(arg_8_0, arg_8_1, arg_8_2):
...
def var_0_0.UpdateSkinView(arg_10_0, arg_10_1):
	...
	onButton(arg_10_0, arg_10_0.playBtn, function()
		arg_10_0.emit(NewShopsMediator.ON_ESKIN_PREVIEW, arg_10_1), SFX_PANEL)
