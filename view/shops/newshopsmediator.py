...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.GO_MALL, function(arg_10_0, arg_10_1)
		...
		if arg_1_0.contextData.fromMediatorName == ChargeMediator.__cname:
	...
	arg_1_0.bind(var_0_0.UR_EXCHANGE_TRACKING, function(arg_20_0, arg_20_1)
		...
		if var_20_0 and not var_20_0.isEnd() and getProxy(ShopsProxy).getActivityShopById(var_20_0.getConfig("config_client").shopId).GetCommodityById(var_20_0.getConfig("config_client").goodsId[1]).getConfig("commodity_id") == arg_20_1:
...
def var_0_0.handleNotification(arg_23_0, arg_23_1):
	...
	if var_23_0 == PlayerProxy.UPDATED:
	...
	elif var_23_0 == ShopsProxy.SHOPPINGSTREET_UPDATE:
		arg_23_0.viewComponent.OnUpdateShop(NewShopsScene.TYPE_SHOP_STREET, var_23_1.shopStreet)
	elif var_23_0 == GAME.SHOPPING_DONE:
		local var_23_2

		if var_23_1.shopType == ShopArgs.ShopStreet:
		...
		elif var_23_1.shopType == ShopArgs.MilitaryShop:
		...
		arg_23_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_23_1.awards)
	elif var_23_0 == ShopsProxy.FRAGMENT_SHOP_UPDATED:
		arg_23_0.viewComponent.OnUpdateShop(NewShopsScene.TYPE_FRAGMENT, var_23_1)
	elif var_23_0 == ShopsProxy.ACTIVITY_SHOP_GOODS_UPDATED:
	...
	elif var_23_0 == ShopsProxy.META_SHOP_GOODS_UPDATED:
		...
		arg_23_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_23_1.awards)
	elif var_23_0 == GAME.MINI_GAME_SHOP_BUY_DONE:
		local var_23_14 = var_23_1.list

		if var_23_14 and #var_23_14 > 0:
