...
def var_0_0.OnInit(arg_3_0):
	onButton(arg_3_0, arg_3_0.refreshBtn, function()
		...
		pg.MsgboxMgr.GetInstance().ShowMsgBox({
			...
			def onYes:()
				if arg_3_0.player.getResource(PlayerConst.ResGuildCoin) < var_4_0:
...
def var_0_0.OnInitItem(arg_10_0, arg_10_1):
	...
	onButton(arg_10_0, var_10_0._go, function()
		if not var_10_0.goods.CanPurchase():
			pg.TipsMgr.GetInstance().ShowTips(i18n("buy_countLimit"))

			return

		arg_10_0.OnCardClick(var_10_0), SFX_PANEL)

	arg_10_0.cards[arg_10_1] = var_10_0

def var_0_0.OnCardClick(arg_12_0, arg_12_1):
	if arg_12_1.goods.Selectable():
		...
		pg.MsgboxMgr.GetInstance().ShowMsgBox({
			...
			def onYes:()
				if not arg_12_1.goods.CanPurchase():
					pg.TipsMgr.GetInstance().ShowTips(i18n("buy_countLimit"))
...
def var_0_0.OnTimeOut(arg_14_0):
