...
def var_0_0.OnInitItem(arg_7_0, arg_7_1):
	...
	onButton(arg_7_0, var_7_0._tf, function()
		arg_7_0.OnClickCard(var_7_0), SFX_PANEL)

	arg_7_0.cards[arg_7_1] = var_7_0

def var_0_0.OnClickCard(arg_9_0, arg_9_1):
	...
	if var_9_0.Selectable():
		arg_9_0.purchasePage.ExecuteAction("Show", var_9_0)
	else
		local var_9_4

		if var_9_0.getConfig("goods_purchase_limit") == 1 or var_9_0.getConfig("type") == 4:
...
def var_0_0.OnUpdateItem(arg_11_0, arg_11_1, arg_11_2):
	if not arg_11_0.cards[arg_11_2]:
...
def var_0_0.FetchShop(arg_12_0, arg_12_1):
...
def var_0_0.SetShop(arg_13_0, arg_13_1):
	arg_13_0.shop = arg_13_1

def var_0_0.Flush(arg_14_0):
	if arg_14_0.shop:
		arg_14_0.Show()
...
def var_0_0.UpdatePageFooters(arg_17_0):
	...
	for iter_17_1 = #var_17_0 + 1, #arg_17_0.pagefooters:
...
def var_0_0.UpdatePageFooter(arg_18_0, arg_18_1, arg_18_2):
	...
	arg_18_0.OnSwitch(arg_18_1, function()
		return arg_18_0.openIndex != arg_18_2, function()
...
def var_0_0.SwitchPhase(arg_24_0, arg_24_1):
...
def var_0_0.Refresh(arg_26_0):
	arg_26_0.SwitchPhase(arg_26_0.openIndex)
	arg_26_0.UpdateRes()

def var_0_0.isPhaseTip(arg_27_0, arg_27_1):
	if not arg_27_0.playerId:
...
def var_0_0.updateLocalRedDotData(arg_28_0, arg_28_1):
	if arg_28_0.isPhaseTip(arg_28_1):
...
def var_0_0.isTip(arg_29_0):
	if not arg_29_0.playerId:
		arg_29_0.playerId = getProxy(PlayerProxy).getData().id

	if PlayerPrefs.GetInt("newserver_shop_first_" .. arg_29_0.playerId) == 0:
		return True

	for iter_29_0, iter_29_1 in pairs(arg_29_0.shop.GetPhases()):
		if arg_29_0.isPhaseTip(iter_29_0):
			return True

	return False

def var_0_0.OnDestroy(arg_30_0):
	arg_30_0.scrollrect.onInitItem = None
	arg_30_0.scrollrect.onUpdateItem = None
	...
	arg_30_0.purchasePage = None

	arg_30_0.multiWindow.Destroy()

	arg_30_0.multiWindow = None

	arg_30_0.singleWindow.Destroy()

	arg_30_0.singleWindow = None
