...
def var_0_0.handleNotification(arg_13_0, arg_13_1):
	...
	if var_13_0 == GAME.SKIN_SHOPPIGN_DONE or var_13_0 == GAME.SKIN_COUPON_SHOPPING_DONE:
		local var_13_3 = pg.shop_template[var_13_1.id]

		if var_13_3 and (var_13_3.genre == ShopArgs.SkinShop or var_13_3.genre == ShopArgs.SkinShopTimeLimit):
	...
	elif var_13_0 == GAME.BUY_FURNITURE_DONE:
		arg_13_0.viewComponent.OnFurnitureUpdate(var_13_2[1])
	elif var_13_0 == GAME.LOAD_LAYERS:
		if var_13_1.context.mediator == NewBackYardShopMediator:
			arg_13_0.sendNotification(PlayerResUI.HIDE)
	elif var_13_0 == GAME.REMOVE_LAYERS and var_13_1.context.mediator == NewBackYardShopMediator:
