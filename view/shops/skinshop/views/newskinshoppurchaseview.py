...
def var_0_0.OnInit(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.confirmBtn, function()
		if arg_3_0.commodity:
			arg_3_0.emit(NewSkinShopMainView.EVT_ON_PURCHASE, arg_3_0.commodity), SFX_PANEL)
...
def var_0_0.GetText(arg_8_0, arg_8_1):
...
def var_0_0.FlushGift(arg_10_0, arg_10_1):
	arg_10_0.dropsList.make(function(arg_11_0, arg_11_1, arg_11_2)
		if arg_11_0 == UIItemList.EventUpdate:
			...
			onButton(arg_10_0, arg_11_2, function()
				arg_10_0.emit(BaseUI.ON_DROP, var_11_1), SFX_PANEL))
