...
def var_0_0.Show(arg_1_0, arg_1_1):
...
def var_0_0.UpdateItem(arg_2_0, arg_2_1, arg_2_2, arg_2_3):
...
def var_0_0.ClickItem(arg_3_0, arg_3_1, arg_3_2):
	if arg_3_0.limitOnePurchase and not arg_3_0.commodity.CanPurchaseSubGoods(arg_3_2):
		return

	var_0_0.super.ClickItem(arg_3_0, arg_3_1, arg_3_2)

def var_0_0.PressAddBtn(arg_4_0, arg_4_1, arg_4_2):
	if arg_4_0.limitOnePurchase and table.contains(arg_4_0.selectedList, arg_4_2):
		return

	var_0_0.super.PressAddBtn(arg_4_0, arg_4_1, arg_4_2)

def var_0_0.OnConfirm(arg_5_0):
