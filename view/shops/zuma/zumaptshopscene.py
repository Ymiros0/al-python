...
def var_0_0.initData(arg_7_0):
	...
	arg_7_0.actShopVO = None
	arg_7_0.goodVOListForShow = None
...
def var_0_0.addListener(arg_9_0):
	...
	arg_9_0.goodUIItemList.make(function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == UIItemList.EventInit:
			arg_9_0.goodTFList[arg_12_1] = arg_12_2

			onButton(arg_9_0, arg_12_2, function()
				if not isActive(arg_9_0.findTF("Mask", arg_12_2)):
					arg_9_0.emit(ZumaPTShopMediator.OPEN_ZUMA_PT_SHOP_BUY_WINDOW, arg_9_0.getGoodVOByIndex(arg_12_1))
				else
					pg.TipsMgr.GetInstance().ShowTips(i18n("launchball_minigame_shop")), SFX_PANEL)
		elif arg_12_0 == UIItemList.EventUpdate:
...
def var_0_0.getGoodVOByIndex(arg_15_0, arg_15_1):
	return arg_15_0.goodVOListForShow[arg_15_1]

def var_0_0.updatePTPanel(arg_16_0):
...
def var_0_0.updateGoodPanel(arg_17_0):
	arg_17_0.goodUIItemList.align(#arg_17_0.goodVOListForShow)

def var_0_0.updateTpl(arg_18_0, arg_18_1, arg_18_2):
...
def var_0_0.updateTplByGoodID(arg_19_0, arg_19_1):
	local var_19_0 = 0

	for iter_19_0, iter_19_1 in ipairs(arg_19_0.goodVOListForShow):
		if iter_19_1.id == arg_19_1:
			var_19_0 = iter_19_0
