...
def var_0_0.update(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5):
	TweenItemAlphaAndWhite(arg_2_0.go)

	local var_2_0 = ShipGroup.getState(arg_2_5, arg_2_2, arg_2_3)

	if arg_2_0.code != arg_2_1 or arg_2_0.shipGroup != arg_2_2 or arg_2_0.showTrans != arg_2_3 or arg_2_0.propose != arg_2_4 or arg_2_0.state != var_2_0:
...
def var_0_0.clear(arg_5_0):
	...
	arg_5_0.shipGroup = None
	arg_5_0.showTrans = None
	arg_5_0.propose = None
	arg_5_0.code = None
