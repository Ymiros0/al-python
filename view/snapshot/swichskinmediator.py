...
def var_0_0.handleNotification(arg_7_0, arg_7_1):
	...
	if var_7_0 == GAME.SKIN_SHOPPIGN_DONE or var_7_0 == GAME.SKIN_COUPON_SHOPPING_DONE:
		local var_7_2 = pg.shop_template[var_7_1.id]

		if var_7_2 and var_7_2.genre == ShopArgs.SkinShop:
	...
	elif var_7_0 == ShipSkinProxy.SHIP_SKINS_UPDATE:
	...
	elif var_7_0 == BayProxy.SHIP_UPDATED and var_7_1.id == arg_7_0.shipVO.id:
