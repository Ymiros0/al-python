...
def var_0_0.addListener(arg_8_0):
	...
	onButton(arg_8_0, arg_8_0.setValueBtn, function()
		if getProxy(ChapterProxy).getActiveChapter(True):
			pg.TipsMgr.GetInstance().ShowTips(i18n("attrset_disable"))
		else
			arg_8_0.emit(AllBuffDetailMediator.OPEN_SET_VALUE_LAYER), SFX_PANEL)

def var_0_0.updateDetail(arg_11_0):
	...
	if arg_11_0.scrollView.rect.height >= 850:
...
def var_0_0.updateBuffList(arg_13_0, arg_13_1, arg_13_2):
	...
	var_13_0.make(function(arg_14_0, arg_14_1, arg_14_2)
		if arg_14_0 == UIItemList.EventUpdate:
			...
			if var_14_4 == var_14_3:
				var_14_5 = "#00FF32FF"
			elif var_14_4 == 0:
				var_14_5 = "#CA5B5BFF"
			elif var_14_4 < var_14_3:
				var_14_5 = "#A5BBD6FF"
