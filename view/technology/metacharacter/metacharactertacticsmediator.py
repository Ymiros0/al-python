...
def var_0_0.handleNotification(arg_3_0, arg_3_1):
	...
	if var_3_0 == GAME.TACTICS_META_INFO_REQUEST_DONE:
	...
	elif var_3_0 == GAME.TACTICS_META_UNLOCK_SKILL_DONE:
	...
	elif var_3_0 == GAME.TACTICS_META_SWITCH_SKILL_DONE:
		...
		arg_3_0.viewComponent.updateSkillTFLearning()
	elif var_3_0 == GAME.TACTICS_META_LEVELUP_SKILL_DONE:
	...
	elif var_3_0 == GAME.META_QUICK_TACTICS_DONE:
		local var_3_8 = var_3_1.skillID
		local var_3_9 = var_3_1.skillExp

		if var_3_1.isLevelUp:
...
def var_0_0.requestTacticsData(arg_6_0):
