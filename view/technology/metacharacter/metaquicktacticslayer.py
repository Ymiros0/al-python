...
def var_0_0.initData(arg_7_0):
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.bookIDList):
...
def var_0_0.addListener(arg_9_0):
	...
	onButton(arg_9_0, arg_9_0.clearBtn, function()
		...
		arg_9_0.updateAfterModifyUseCount(), SFX_PANEL)
	...
	onButton(arg_9_0, arg_9_0.confirmBtn, function()
		...
		for iter_13_0, iter_13_1 in ipairs(arg_9_0.bookIDList):
		...
		if var_13_0 <= 0:
			...
			if var_13_1:
				...
				arg_9_0.emit(MetaQuickTacticsMediator.USE_TACTICS_BOOK, arg_9_0.shipID, arg_9_0.skillID, arg_9_0.useCountDict), SFX_PANEL)

def var_0_0.overlayPanel(arg_14_0, arg_14_1):
	if arg_14_1 and arg_14_0._tf:
...
def var_0_0.initSkillInfoPanel(arg_15_0):
...
def var_0_0.initUIItemList(arg_16_0):
...
def var_0_0.updateUIItemList(arg_18_0):
	arg_18_0.uiitemList.align(#arg_18_0.bookIDList)

def var_0_0.updateTpl(arg_19_0, arg_19_1, arg_19_2):
	...
	onButton(arg_19_0, var_19_2, function()
		...
		arg_19_0.updateAfterModifyUseCount(), SFX_PANEL)
	onButton(arg_19_0, var_19_3, function()
		if not arg_19_0.isMaxLevel() and not arg_19_0.isCanUpMax():
			arg_19_0.tryModifyUseCount(var_19_7, 10)
			arg_19_0.updateAfterModifyUseCount(), SFX_PANEL)
...
def var_0_0.updateAfterModifyUseCount(arg_24_0):
	for iter_24_0, iter_24_1 in ipairs(arg_24_0.bookIDList):
...
def var_0_0.updateAfterUse(arg_25_0):
...
def var_0_0.tryModifyUseCount(arg_28_0, arg_28_1, arg_28_2):
	...
	if arg_28_2 < 0:
		...
		for iter_28_0 = 0, var_28_3:
			local var_28_6 = var_28_5 * var_28_4

			if not arg_28_0.preCalcExpOverFlow(var_28_6, 0):
				var_28_5 = iter_28_0

				if var_28_3 <= var_28_5 or var_28_0 <= var_28_1 + var_28_5:
					break

		arg_28_0.useCountDict[arg_28_1] = var_28_1 + var_28_5

def var_0_0.getLevelTotalExp(arg_29_0, arg_29_1):
...
def var_0_0.calcAwardExp(arg_31_0):
	local var_31_0 = 0

	for iter_31_0, iter_31_1 in ipairs(arg_31_0.bookIDList):
		var_31_0 = var_31_0 + arg_31_0.useCountDict[iter_31_1] * arg_31_0.expDict[iter_31_1]

	return var_31_0

def var_0_0.calcLevelWithAwardExp(arg_32_0, arg_32_1):
...
def var_0_0.isCanUpMax(arg_33_0):
...
def var_0_0.preCalcExpOverFlow(arg_34_0, arg_34_1, arg_34_2):
	...
	if var_34_2 <= var_34_6:
		var_34_5 = var_34_6 - var_34_2

		if arg_34_2 <= var_34_5:
			var_34_4 = True

	return var_34_4, var_34_5

def var_0_0.oneStep(arg_35_0):
	if arg_35_0.isMaxLevel():
		return
	...
	for iter_35_0, iter_35_1 in ipairs(arg_35_0.bookIDList):
		if arg_35_0.getBookItem(iter_35_1).count > 0:
	...
	for iter_35_2, iter_35_3 in ipairs(var_35_0):
		...
		for iter_35_4 = 1, var_35_1.count:
			if iter_35_2 < #var_35_0 and arg_35_0.preCalcExpOverFlow(var_35_2, var_35_3):
				break
			else
				arg_35_0.useCountDict[iter_35_3] = arg_35_0.useCountDict[iter_35_3] + 1

				if arg_35_0.isCanUpMax():
					return

def var_0_0.isMaxLevel(arg_37_0):
