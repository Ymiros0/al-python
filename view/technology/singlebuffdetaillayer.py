...
def var_0_0.updateDetail(arg_10_0):
	...
	if ShipGroup.IsMetaGroup(arg_10_0.groupID) or ShipGroup.IsMotGroup(arg_10_0.groupID):
	...
	if arg_10_0.star >= pg.fleet_tech_ship_template[arg_10_0.groupID].max_star:
		setImageColor(arg_10_0.allStarStatusImg, Color.New(1, 0.9137254901960784, 0.4470588235294118, 1))

	if arg_10_0.maxLV >= TechnologyConst.SHIP_LEVEL_FOR_BUFF:
...
def var_0_0.getSpecialTypeList(arg_14_0, arg_14_1):
