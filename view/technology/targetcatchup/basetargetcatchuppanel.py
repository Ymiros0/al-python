...
def var_0_0.initUI(arg_6_0):
	...
	arg_6_0.selectedImgUIItemList.make(function(arg_7_0, arg_7_1, arg_7_2)
		if arg_7_0 == UIItemList.EventUpdate:
			...
			if arg_7_1 == arg_6_0.curSelectedIndex:
				setImageAlpha(var_7_0, 0)
				arg_6_0.updateProgress(arg_6_0.charIDList[arg_6_0.curSelectedIndex])
				arg_6_0.managedTween(LeanTween.alpha, None, rtf(var_7_0), 1, var_0_0.SELECT_CHAR_LIGHT_FADE_TIME).setFrom(0))
	...
	arg_6_0.charUIItemList.make(function(arg_8_0, arg_8_1, arg_8_2)
		if arg_8_0 == UIItemList.EventUpdate:
			...
			onButton(arg_6_0, arg_8_2, function()
				if arg_8_1 != arg_6_0.curSelectedIndex:
					arg_6_0.curSelectedIndex = arg_8_1

					arg_6_0.selectedImgUIItemList.align(#arg_6_0.charIDList), SFX_PANEL))
	...
	onButton(arg_6_0, arg_6_0.confirmBtn, function()
		if arg_6_0.curSelectedIndex and arg_6_0.curSelectedIndex != 0:
...
def var_0_0.updateShowPanel(arg_15_0):
	...
	onButton(arg_15_0, arg_15_0.selectedImg, function()
		...
		setActive(arg_15_0.findTF("ProgressTitle", arg_15_0.choosePanel), False), SFX_PANEL)

def var_0_0.updateChoosePanel(arg_17_0):
	...
	if arg_17_0.state == TechnologyCatchup.STATE_FINISHED_ALL:
...
def var_0_0.isUR(arg_19_0, arg_19_1):
	for iter_19_0, iter_19_1 in ipairs(arg_19_0.urList):
		if arg_19_1 == iter_19_1:
			return True

	return False

def var_0_0.getMaxNum(arg_20_0, arg_20_1):
...
def var_0_0.getShipBluePrintCurExp(arg_22_0, arg_22_1):
