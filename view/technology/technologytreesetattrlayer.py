...
def var_0_0.initData(arg_6_0):
	...
	arg_6_0.maxAdditionMap = None
	arg_6_0.typeOrderList = None
	arg_6_0.typeAttrOrderListTable = None
...
def var_0_0.initUITips(arg_7_0):
...
def var_0_0.addListener(arg_9_0):
	...
	onButton(arg_9_0, arg_9_0.resetBtn, function()
		for iter_22_0, iter_22_1 in ipairs(arg_9_0.typeAttrOrderListTable[arg_9_0.curType]):
			local var_22_0 = arg_9_0.maxAdditionMap[arg_9_0.curType][iter_22_1]

			arg_9_0.setAttrValue(arg_9_0.curType, iter_22_1, var_22_0)
			arg_9_0.setAttrTFValue(arg_9_0.typeAttrTFTable[arg_9_0.curType][iter_22_1], var_22_0), SFX_PANEL)
	onButton(arg_9_0, arg_9_0.saveBtn, function()
		if arg_9_0.isChanged():
			...
			arg_9_0.save(var_23_0), SFX_PANEL)

def var_0_0.updateTypeTF(arg_25_0, arg_25_1, arg_25_2):
	...
	onToggle(arg_25_0, arg_25_2, function(arg_26_0)
		if arg_26_0 and arg_25_0.curType != var_25_3:
			if arg_25_0.isChanged():
				...
				arg_25_0.updateAttrList(arg_25_0.curType), SFX_PANEL)

	arg_25_0.typeToggleTable[var_25_3] = arg_25_2

def var_0_0.updateTypeList(arg_31_0):
	arg_31_0.typeUIItemList.align(#arg_31_0.typeOrderList)

def var_0_0.updateAttrTF(arg_32_0, arg_32_1, arg_32_2):
	...
	onButton(arg_32_0, var_32_5, function()
		...
		setText(var_32_1, var_35_1), SFX_PANEL)
...
def var_0_0.updateAttrList(arg_37_0, arg_37_1):
...
def var_0_0.setAttrTFValue(arg_38_0, arg_38_1, arg_38_2):
	local var_38_0 = arg_38_0.findTF("Attr/Value/CurValue", arg_38_1)

	setText(var_38_0, arg_38_2)

def var_0_0.openSaveBox(arg_39_0, arg_39_1, arg_39_2, arg_39_3):
...
def var_0_0.getAddValueForShow(arg_40_0, arg_40_1, arg_40_2):
	if arg_40_0.cacheAdditionMap[arg_40_1] and arg_40_0.cacheAdditionMap[arg_40_1][arg_40_2]:
		return arg_40_0.cacheAdditionMap[arg_40_1][arg_40_2]
	elif arg_40_0.curAdditionMap[arg_40_0.curType] and arg_40_0.curAdditionMap[arg_40_0.curType][arg_40_2]:
		return arg_40_0.curAdditionMap[arg_40_1][arg_40_2]
	else
		return arg_40_0.maxAdditionMap[arg_40_1][arg_40_2]

def var_0_0.setAttrValue(arg_41_0, arg_41_1, arg_41_2, arg_41_3):
	if not arg_41_0.cacheAdditionMap[arg_41_1]:
		arg_41_0.cacheAdditionMap[arg_41_1] = {}

	arg_41_0.cacheAdditionMap[arg_41_1][arg_41_2] = arg_41_3

def var_0_0.clearCacheMap(arg_42_0):
	arg_42_0.cacheAdditionMap = {}

def var_0_0.isChanged(arg_43_0):
	for iter_43_0, iter_43_1 in pairs(arg_43_0.cacheAdditionMap):
		for iter_43_2, iter_43_3 in pairs(iter_43_1):
			if iter_43_3 != arg_43_0.tecNationProxy.getSetableAttrAdditionValueByTypeAttr(iter_43_0, iter_43_2):
				return True

	return False

def var_0_0.save(arg_44_0, arg_44_1):
	local var_44_0 = {}

	for iter_44_0, iter_44_1 in pairs(arg_44_0.curAdditionMap):
		if not var_44_0[iter_44_0]:
			var_44_0[iter_44_0] = {}

		for iter_44_2, iter_44_3 in pairs(iter_44_1):
			var_44_0[iter_44_0][iter_44_2] = iter_44_3

	for iter_44_4, iter_44_5 in pairs(arg_44_0.cacheAdditionMap):
		if not var_44_0[iter_44_4]:
			var_44_0[iter_44_4] = {}

		for iter_44_6, iter_44_7 in pairs(iter_44_5):
			var_44_0[iter_44_4][iter_44_6] = iter_44_7

	local var_44_1 = {}

	for iter_44_8, iter_44_9 in pairs(var_44_0):
		for iter_44_10, iter_44_11 in pairs(iter_44_9):
			if iter_44_11 != arg_44_0.maxAdditionMap[iter_44_8][iter_44_10]:
				local var_44_2 = {
					ship_type = iter_44_8,
...
def var_0_0.reset(arg_45_0):
	local var_45_0 = {}

	for iter_45_0, iter_45_1 in pairs(arg_45_0.curAdditionMap):
		if iter_45_0 != arg_45_0.curType:
			if not var_45_0[iter_45_0]:
				var_45_0[iter_45_0] = {}

			for iter_45_2, iter_45_3 in pairs(iter_45_1):
				var_45_0[iter_45_0][iter_45_2] = iter_45_3

	for iter_45_4, iter_45_5 in pairs(arg_45_0.cacheAdditionMap):
		if iter_45_4 != arg_45_0.curType:
			if not var_45_0[iter_45_4]:
				var_45_0[iter_45_4] = {}

			for iter_45_6, iter_45_7 in pairs(iter_45_5):
				var_45_0[iter_45_4][iter_45_6] = iter_45_7

	local var_45_1 = {}

	for iter_45_8, iter_45_9 in pairs(var_45_0):
		for iter_45_10, iter_45_11 in pairs(iter_45_9):
			if iter_45_11 != arg_45_0.maxAdditionMap[iter_45_8][iter_45_10]:
				local var_45_2 = {
					ship_type = iter_45_8,
