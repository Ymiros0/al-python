...
def var_0_0.willExit(arg_4_0):
	...
	if arg_4_0.minusTimer:
		arg_4_0.minusTimer.Stop()

	if arg_4_0.addTimer:
		arg_4_0.addTimer.Stop(0)

def var_0_0.tryPlayGuide(arg_5_0):
...
def var_0_0.initData(arg_6_0):
	...
	arg_6_0.expTaskID = None

	if var_6_2 == ShipBluePrint.TASK_STATE_START:
		arg_6_0.expTaskID = var_6_1[1]
	elif var_6_3 == ShipBluePrint.TASK_STATE_START:
...
def var_0_0.addListener(arg_8_0):
	...
	onButton(arg_8_0, arg_8_0.confirmBtn, function()
		if arg_8_0.curUseNum == 0:
			return

		local var_11_0, var_11_1 = arg_8_0.isExpOverFlow()

		if arg_8_0.isExpOverFlow():
	...
	onButton(arg_8_0, arg_8_0.helpBtn, function()
		if isActive(arg_8_0.helpPanel):
			setActive(arg_8_0.helpPanel, False)
		else
			setActive(arg_8_0.helpPanel, True), SFX_PANEL)
	onButton(arg_8_0, arg_8_0.maxBtn, function()
		if arg_8_0.curUseNum != arg_8_0.maxUseNum:
			arg_8_0.curUseNum = arg_8_0.maxUseNum

			setText(arg_8_0.useCountText, arg_8_0.curUseNum)
			arg_8_0.updateTaskPanel(arg_8_0.curUseNum), SFX_PANEL)
...
def var_0_0.initTaskPanel(arg_23_0):
...
def var_0_0.updateTaskPanel(arg_24_0, arg_24_1):
...
def var_0_0.isExpOverFlow(arg_26_0):
