...
local function var_0_5(arg_2_0, arg_2_1)
	...
	for iter_2_0 = 0, var_2_1:
		...
		if (var_2_2.y <= arg_2_0.y and var_2_3.y - var_0_3 > arg_2_0.y or var_2_3.y <= arg_2_0.y and var_2_2.y - var_0_3 > arg_2_0.y) and (var_2_2.x >= arg_2_0.x or var_2_3.x >= arg_2_0.x) and arg_2_0.x + var_0_3 < var_2_2.x + (arg_2_0.y - var_2_2.y) / (var_2_3.y - var_2_2.y) * (var_2_3.x - var_2_2.x):
			var_2_0 = var_2_0 + 1
...
local function var_0_8(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
	...
	while var_5_0 != arg_5_5:
		local var_5_1 = var_0_4(var_5_0 + 1, #arg_5_3)

		if var_0_1.IsSegamentCross(arg_5_0, arg_5_1, arg_5_2[arg_5_3[var_5_0]], arg_5_2[arg_5_3[var_5_1]]):
			return True
...
local function var_0_9(arg_6_0)
	...
	while #var_6_1 > 2 and #var_6_2 > 0:
		...
		if var_0_1.VectorCross(arg_6_0[var_6_5], arg_6_0[var_6_10], arg_6_0[var_6_9]) > 0 and not var_0_8(arg_6_0[var_6_5], arg_6_0[var_6_10], arg_6_0, var_6_1, var_6_8, var_6_6):
			...
			for iter_6_1 = #var_6_2, 1, -1:
				local var_6_13 = var_6_2[iter_6_1][1]

				if var_6_13 == var_6_9 or var_6_13 == var_6_11:
