...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.dailyTaskGoBtn, function()
		arg_3_0.emit(VoteExchangeMediator.GO_TASK), SFX_PANEL)
...
def var_0_0.UpdateTitle(arg_7_0):
...
def var_0_0.GetActivity(arg_8_0):
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_0):
		if iter_8_1.getConfig("config_id") == arg_8_0.contextData.voteGroup.configId:
			var_8_1 = iter_8_1
...
def var_0_0.UpdateTicket(arg_9_0):
...
def var_0_0.GetTaskList(arg_10_0):
	local var_10_0 = arg_10_0.GetActivity()

	if var_10_0 and var_10_0.data3 >= arg_10_0.contextData.voteGroup.getConfig("ticket_period"):
		return {}
...
def var_0_0.GetDailyTaskList(arg_11_0):
	return (arg_11_0.contextData.voteGroup.getConfig("task_daily"))

def var_0_0.UpdateDailyTask(arg_12_0):
	local var_12_0 = 0
	local var_12_1 = getProxy(TaskProxy)

	for iter_12_0, iter_12_1 in ipairs(arg_12_0.dailyTaskList):
		local var_12_2 = var_12_1.getTaskById(iter_12_1) or var_12_1.getFinishTaskById(iter_12_1)

		if var_12_2 and var_12_2.isFinish() and var_12_2.isReceive():
			var_12_0 = var_12_0 + 1
...
def var_0_0.UpdateTaskCard(arg_15_0, arg_15_1, arg_15_2):
...
def var_0_0.UpdateTaskDesc(arg_17_0, arg_17_1, arg_17_2):
	...
	onButton(arg_17_0, var_17_3, function()
		arg_17_0.emit(VoteExchangeMediator.SKIP_TASK, var_17_0), SFX_PANEL)
	onButton(arg_17_0, var_17_4, function()
		arg_17_0.emit(VoteExchangeMediator.SUBMIT_TASK, var_17_0.id), SFX_PANEL)
