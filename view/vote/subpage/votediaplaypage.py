...
def var_0_0.Open(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5):
...
def var_0_0.Update(arg_6_0, arg_6_1):
	...
	onButton(arg_6_0, arg_6_0.addBtn, function()
		if arg_6_0.value >= arg_6_0.maxValue:
			return

		arg_6_0.value = arg_6_0.value + 1

		arg_6_0.UpdateCnt(), SFX_PANEL)
