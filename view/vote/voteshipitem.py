...
def var_0_0.update(arg_2_0, arg_2_1, arg_2_2):
	...
	if not IsNil(arg_2_0.riseNext):
		setActive(arg_2_0.riseNext, arg_2_2 and arg_2_2.riseFlag)

	if not IsNil(arg_2_0.riseResurgence):
...
def var_0_0.wrapRankTxt(arg_5_0, arg_5_1):
	if arg_5_1 and arg_5_1 <= 3:
