...
def var_0_0.Setup(arg_1_0, arg_1_1):
	for iter_1_0, iter_1_1 in pairs(var_0_0.Listeners):
...
def var_0_0.OnInit(arg_4_0):
	...
	arg_4_0.scrollRect.Make(function(arg_5_0, arg_5_1)
		arg_4_0.OnInitCard(arg_5_0, arg_5_1), function(arg_6_0, arg_6_1)
		arg_4_0.OnPreviewCard(arg_6_0, arg_6_1), function(arg_7_0, arg_7_1)
	...
	onButton(arg_4_0, arg_4_0.refreshBtn, function()
		if arg_4_0.cdTime <= pg.TimeMgr.GetInstance().GetServerTime():
			arg_4_0.worldBossId = None
			...
			pg.TipsMgr.GetInstance().ShowTips(i18n("world_joint_not_refresh_frequently")), SFX_PANEL)
	...
	onToggle(arg_4_0, arg_4_0.findTF("list_panel/frame/filter/toggles/friend"), function(arg_11_0)
		...
		arg_4_0.CheckToggle()
		arg_4_0.UpdateNonProcessList(), SFX_PANEL)
...
def var_0_0.UpdateEmptyCard(arg_13_0):
...
def var_0_0.GetResSuffix(arg_16_0):
	return ""
...
def var_0_0.RotateRefreshBtn(arg_18_0, arg_18_1):
	...
	if arg_18_0.refreshtimer:
		arg_18_0.refreshtimer.Stop()

		arg_18_0.refreshtimer = None

	arg_18_0.refreshtimer = Timer.New(function()
		setActive(arg_18_0.refreshBtnGray, True)
		setActive(arg_18_0.refreshBtnGray, False), arg_18_1, 1)

	arg_18_0.refreshtimer.Start()

def var_0_0.AddListeners(arg_21_0, arg_21_1):
...
def var_0_0.RemoveListeners(arg_22_0, arg_22_1):
...
def var_0_0.OnCacheBossUpdated(arg_23_0):
	arg_23_0.UpdateNonProcessList()

def var_0_0.OnRankListUpdated(arg_24_0, arg_24_1, arg_24_2, arg_24_3):
	if arg_24_0.boss and arg_24_0.boss.id == arg_24_3 and arg_24_0.rankPage.GetLoaded() and arg_24_0.rankPage.isActive():
...
def var_0_0.UpdateNonProcessList(arg_27_0):
	...
	for iter_27_0, iter_27_1 in ipairs(var_27_0):
		if not iter_27_1.isDeath() and not iter_27_1.IsExpired() and var_27_1(iter_27_1) and not iter_27_1.IsFullPeople() and arg_27_0.OnFilterBoss(iter_27_1):
	...
	for iter_27_2, iter_27_3 in ipairs(arg_27_0.displays):
		if iter_27_3.id == arg_27_0.contextData.worldBossId or iter_27_3.id == arg_27_0.worldBossId:
			var_27_2 = iter_27_2

			break

	arg_27_0.contextData.worldBossId = None
	WorldBossScene.inOtherBossBattle = None
...
def var_0_0.OnFilterBoss(arg_32_0, arg_32_1):
	return True

def var_0_0.OnInitCard(arg_33_0, arg_33_1, arg_33_2):
	...
	if var_33_0:
		...
		onButton(arg_33_0, arg_33_1, function()
			arg_33_0.scrollRect.SliceTo(arg_33_1), SFX_PANEL)
...
def var_0_0.UpdateCardStyle(arg_35_0, arg_35_1, arg_35_2):
...
def var_0_0.OnPreviewCard(arg_36_0, arg_36_1, arg_36_2):
	if arg_36_0.prevSelected and arg_36_0.prevSelected.boss:
...
def var_0_0.OnSelectCard(arg_37_0, arg_37_1, arg_37_2):
	local var_37_0 = arg_37_0.displays[arg_37_2 + 1]

	arg_37_0.boss = var_37_0
	arg_37_0.worldBossId = None
...
def var_0_0.UpdateMainView(arg_38_0, arg_38_1, arg_38_2):
	...
	onButton(arg_38_0, arg_38_0.rankBtn, function()
		arg_38_0.rankPage.ExecuteAction("Update", arg_38_0.proxy, arg_38_1.id), SFX_PANEL)
	...
	if var_41_0 - pg.TimeMgr.GetInstance().GetServerTime() >= 0:
		arg_41_0.timer = Timer.New(function()
			...
			if var_42_0 <= 0:
				...
				arg_41_0.expiredTimeTxt.text = pg.TimeMgr.GetInstance().DescCDTime(var_42_0), 1, -1)
...
def var_0_0.removeBattleTimer(arg_43_0):
	if arg_43_0.timer:
		arg_43_0.timer.Stop()

		arg_43_0.timer = None

def var_0_0.OnDestroy(arg_44_0):
	...
	if arg_44_0.refreshtimer:
		arg_44_0.refreshtimer.Stop()

		arg_44_0.refreshtimer = None
