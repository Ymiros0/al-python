...
def var_0_0.AddListeners(arg_3_0, arg_3_1):
...
def var_0_0.RemoveListeners(arg_4_0, arg_4_1):
...
def var_0_0.OnPtUpdated(arg_5_0):
	if arg_5_0.isShowing():
		arg_5_0.OnUpdatePt()

def var_0_0.OnBossProgressUpdate(arg_6_0):
	if arg_6_0.isShowing():
		arg_6_0.OnUpdateRes()
...
def var_0_0.OnInit(arg_8_0):
	...
	if arg_8_0.findTF("title"):
		GetComponent(arg_8_0.findTF("title"), typeof(Image)).SetNativeSize()

def var_0_0.UpdateUseItemStyle(arg_9_0, arg_9_1):
...
def var_0_0.OnUpdate(arg_11_0):
	return

def var_0_0.OnUpdateRes(arg_12_0):
	return

def var_0_0.OnUpdatePt(arg_13_0):
	return
