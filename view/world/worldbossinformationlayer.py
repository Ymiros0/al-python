...
def var_0_0.init(arg_2_0):
	...
	for iter_2_0 = 1, #arg_2_0.attributes:
...
def var_0_0.didEnter(arg_3_0):
	...
	onButton(arg_3_0, arg_3_0.homeBtn, function()
		arg_3_0.quickExitFunc(), SFX_CANCEL)
	onButton(arg_3_0, arg_3_0.startBtn, function()
		arg_3_0.emit(WorldBossInformationMediator.OnOpenSublayer, Context.New({
			...
			arg_3_0.closeView()), SFX_UI_WEIGHANCHOR)
	...
	onButton(arg_3_0, arg_3_0.switchBuffBtn, function()
		...
		arg_3_0.buffListAnimator.Play(var_9_0, -1, 0), SFX_PANEL)
	onButton(arg_3_0, arg_3_0.awardBtn, function()
		arg_3_0.GetAwardPanel().buffer.UpdateView(arg_3_0.GetCurrentAttachment()), SFX_PANEL)
	arg_3_0.updateStageView()
	arg_3_0.loader.LoadPrefab("ui/xuetiao01", "", None, function(arg_11_0)
...
def var_0_0.GetEnemyLevel(arg_15_0, arg_15_1):
	if arg_15_1.difficulty == ys.Battle.BattleConst.Difficulty.WORLD:
...
def var_0_0.UpdateHpbar(arg_16_0):
...
def var_0_0.GetDungeonBossData(arg_18_0, arg_18_1):
...
def var_0_0.GetDungeonFile(arg_21_0, arg_21_1):
	if arg_21_0.dungeonDict[arg_21_1]:
...
def var_0_0.updateStageView(arg_22_0):
	...
	for iter_22_0, iter_22_1 in ipairs(var_22_4.award_display_world):
	...
	setActive(arg_22_0.weaknesstext, var_22_9 != None)
	setActive(arg_22_0.weaknessbg, var_22_9 != None)

	if var_22_9:
		setText(arg_22_0.weaknesstext, i18n("word_weakness") .. ". " .. var_22_9.desc)

	local var_22_10 = var_22_9 == None and var_0_7 or 0
	...
	for iter_22_2 = 1, #arg_22_0.attributes:
		...
		var_22_26.onReleased.AddListener(function()
			if not var_22_28 or Time.realtimeSinceStartup - var_22_28 < 0.3:
	...
	;(function()
		...
		if arg_22_0.bossnameText.preferredWidth > arg_22_0.bossnameText.transform.rect.width:
	...
	if not var_22_34:
		...
		if var_22_36 == 1:
			arg_22_0.loader.GetSprite("enemies/" .. var_22_3.icon, None, arg_22_0.bosssprite)
		elif var_22_36 == 2:
			...
			arg_22_0.loader.GetSpine(var_22_3.icon, function(arg_36_0)
				...
				setParent(arg_36_0, arg_22_0.bosssprite, False), arg_22_0.bosssprite)

def var_0_0.onBackPressed(arg_37_0):
	if arg_37_0.awardPanel and arg_37_0.awardPanel.isShowing():
...
def var_0_0.willExit(arg_38_0):
	...
	if arg_38_0.resPanel:
		arg_38_0.resPanel.exit()

		arg_38_0.resPanel = None

	for iter_38_0, iter_38_1 in pairs(arg_38_0.dungeonDict):
		ys.Battle.BattleDataFunction.ClearDungeonCfg(iter_38_0)

	table.clear(arg_38_0.dungeonDict)
	arg_38_0.loader.Clear()

def var_0_0.GetAwardPanel(arg_39_0):
...
def var_0_0.DestroyAwardPanel(arg_40_0):
	if not arg_40_0.awardPanel:
		return

	arg_40_0.awardPanel.Destroy()

	arg_40_0.awardPanel = None

def var_0_0.TransformColor(arg_41_0):
