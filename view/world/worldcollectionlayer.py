...
def var_0_0.init(arg_2_0):
	...
	function arg_2_0.scrollEntrance.onUpdateItem(arg_3_0, arg_3_1)
		...
		onButton(arg_2_0, var_3_0, function()
			arg_2_0.UpdateAchievement(arg_3_0), SFX_PANEL)
	...
	function arg_2_0.scrollEntrance.onReturnItem(arg_6_0, arg_6_1)
		...
		arg_2_0.entranceOjbecDic[arg_6_0 + 1] = None
	...
	arg_2_0.targetItemList.make(function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == UIItemList.EventUpdate:
			...
			if var_8_7:
				...
				for iter_8_0 = #var_8_6, var_8_10 - 1:
					setActive(var_8_8.GetChild(iter_8_0), False)

				for iter_8_1 = var_8_10, #var_8_6 - 1:
					cloneTplTo(var_8_9, var_8_8)

				for iter_8_2 = 0, #var_8_6 - 1:
...
def var_0_0.onBackPressed(arg_11_0):
	if arg_11_0.subviewAchAward.isShowing():
...
def var_0_0.didEnter(arg_12_0):
	...
	onToggle(arg_12_0, arg_12_0.topToggles.Find("all"), function(arg_14_0)
		if arg_14_0:
			arg_12_0.UpdateEntranceFilter(False), SFX_PANEL)
	...
	onToggle(arg_12_0, arg_12_0.topToggles.Find("unfinish"), function(arg_15_0)
		if arg_15_0:
			arg_12_0.UpdateEntranceFilter(True), SFX_PANEL)
	...
	onButton(arg_12_0, arg_12_0.rtMain.Find("list_bg/jump_icon_left"), function()
		arg_12_0.ScrollAndSelectEntrance(arg_12_0.GetAwardIndex(False)), SFX_PANEL)
	onButton(arg_12_0, arg_12_0.rtMain.Find("list_bg/jump_icon_right"), function()
		arg_12_0.ScrollAndSelectEntrance(arg_12_0.GetAwardIndex(True)), SFX_PANEL)
	onButton(arg_12_0, arg_12_0.btnGetAll, function()
		...
		if #var_18_0 > 0:
			...
			pg.TipsMgr.GetInstance().ShowTips("without any award"), SFX_CONFIRM)
	...
	onButton(arg_12_0, arg_12_0.entrancePanel.Find("page_left"), function()
		arg_12_0.ScrollAndSelectEntrance(arg_12_0.selectedIndex - 1), SFX_PANEL)
	onButton(arg_12_0, arg_12_0.entrancePanel.Find("page_right"), function()
		arg_12_0.ScrollAndSelectEntrance(arg_12_0.selectedIndex + 1), SFX_PANEL)
	onButton(arg_12_0, arg_12_0.overviewBtn, function()
		arg_12_0.emit(WorldCollectionMediator.ON_ACHIEVE_OVERVIEW), SFX_PANEL)
...
def var_0_0.SetAchievementList(arg_25_0, arg_25_1):
	arg_25_0.baseEntranceList = arg_25_1

def var_0_0.BuildEntranceScrollPos(arg_26_0):
	arg_26_0.entrancePos = {}
	arg_26_0.entranceIndexDic = {}

	for iter_26_0, iter_26_1 in ipairs(arg_26_0.achEntranceList):
		...
		if nowWorld().AnyUnachievedAchievement(iter_26_1):
			table.insert(arg_26_0.achAwardIndexList, iter_26_0)

def var_0_0.UpdateEntranceFilter(arg_27_0, arg_27_1):
	if arg_27_1:
...
def var_0_0.UpdateGetAllAwardBtn(arg_29_0):
...
def var_0_0.FlushEntranceItem(arg_30_0, arg_30_1):
	for iter_30_0, iter_30_1 in ipairs(arg_30_1):
		local var_30_0 = arg_30_0.entranceIndexDic[iter_30_1.id]

		if not nowWorld().AnyUnachievedAchievement(arg_30_0.achEntranceList[var_30_0]):
			if arg_30_0.entranceOjbecDic[var_30_0]:
...
def var_0_0.UpdateAchievement(arg_31_0, arg_31_1, arg_31_2):
	if arg_31_2 or arg_31_0.selectedIndex != arg_31_1:
...
def var_0_0.GetAwardIndex(arg_32_0, arg_32_1):
	local var_32_0 = arg_32_0.entrancePos[#arg_32_0.achEntranceList] - 1

	if arg_32_1:
		local var_32_1 = arg_32_0.scrollEntrance.value + var_32_0

		for iter_32_0 = 1, #arg_32_0.achAwardIndexList:
			if var_32_1 < arg_32_0.entrancePos[arg_32_0.achAwardIndexList[iter_32_0]]:
		...
		for iter_32_1 = #arg_32_0.achAwardIndexList, 1, -1:
			if var_32_2 > arg_32_0.entrancePos[arg_32_0.achAwardIndexList[iter_32_1]]:
				return arg_32_0.achAwardIndexList[iter_32_1]

		return None

def var_0_0.ScrollAndSelectEntrance(arg_33_0, arg_33_1):
...
def var_0_0.UpdateJumpBtn(arg_34_0):
...
def var_0_0.FlushAchievement(arg_35_0):
	...
	onButton(arg_35_0, var_35_7, function()
		arg_35_0.showAchAwardPanel(arg_35_0.entrance), SFX_PANEL)
...
def var_0_0.flushAchieveUpdate(arg_37_0, arg_37_1):
	arg_37_0.FlushEntranceItem(arg_37_1)
	arg_37_0.FlushAchievement()

def var_0_0.showAchAwardPanel(arg_38_0, arg_38_1):
