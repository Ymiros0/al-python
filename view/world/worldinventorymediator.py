...
def var_0_0.register(arg_1_0):
	...
	arg_1_0.bind(var_0_0.OnMap, function(arg_3_0, arg_3_1)
		...
		for iter_3_0, iter_3_1 in ipairs(var_3_0.config.teasure_chapter):
			if arg_3_1 == iter_3_1[1]:
				var_3_1 = iter_3_1[2]
...
def var_0_0.handleNotification(arg_8_0, arg_8_1):
	...
	if var_8_0 == EquipmentProxy.EQUIPMENT_UPDATED:
		arg_8_0.viewComponent.setEquipment(var_8_1)
	elif var_8_0 == GAME.USE_ITEM_DONE:
		if table.getCount(var_8_1) != 0:
			arg_8_0.viewComponent.emit(BaseUI.ON_AWARD, {
				animation = True,
				items = var_8_1
			})
	elif var_8_0 == GAME.FRAG_SELL_DONE:
		arg_8_0.viewComponent.emit(BaseUI.ON_ACHIEVE, var_8_1.awards)
	elif var_8_0 == GAME.DESTROY_EQUIPMENTS_DONE:
		if table.getCount(var_8_1) != 0:
			arg_8_0.viewComponent.emit(BaseUI.ON_AWARD, {
				items = var_8_1
			})
	elif var_8_0 == BagProxy.ITEM_UPDATED:
		if arg_8_0.canUpdate:
			local var_8_2 = getProxy(BagProxy).GetItemsByCondition({
				is_world = 1
			})

			arg_8_0.viewComponent.SetMaterials(var_8_2)
	elif var_8_0 == GAME.REVERT_EQUIPMENT_DONE:
		if table.getCount(var_8_1.awards) > 0:
			arg_8_0.viewComponent.emit(BaseUI.ON_AWARD, {
				items = var_8_1.awards
			})
	elif var_8_0 == GAME.TRANSFORM_EQUIPMENT_AWARD_FINISHED:
