...
def var_0_0.init(arg_3_0):
	...
	arg_3_0.entranceItemList.make(function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == UIItemList.EventUpdate:
			if arg_3_0.entranceIds[arg_5_1]:
...
def var_0_0.GetOverviewMark(arg_13_0):
	if arg_13_0.mode == "Task":
		if arg_13_0.isTaskArea:
			return {
				"overview_port"
			}
		else
	...
	elif arg_13_0.mode == "Achievement":
		return {
...
def var_0_0.UpdateTaskPanel(arg_14_0):
	local var_14_0 = nowWorld()
	local var_14_1 = var_14_0.GetTaskProxy().getTaskById(arg_14_0.taskId)

	assert(var_14_1, "without this:ing task. " .. arg_14_0.taskId)
...
def var_0_0.UpdateAchievementPanel(arg_15_0):
	...
	for iter_15_0, iter_15_1 in ipairs(var_15_4):
...
def var_0_0.DisplayAtlasOverall(arg_16_0):
	if arg_16_0.wsAtlasOverall:
		setActive(arg_16_0.wsAtlasOverall.tfEntity.Find("Plane"), False)
		arg_16_0.wsAtlasOverall.ShowOrHide(True)

def var_0_0.HideAtlasOverall(arg_17_0):
	if arg_17_0.wsAtlasOverall:
		arg_17_0.wsAtlasOverall.ShowOrHide(False)

def var_0_0.LoadAtlasOverall(arg_18_0, arg_18_1):
	local var_18_0 = {}

	if not arg_18_0.wsAtlasOverall:
...
def var_0_0.DisposeAtlasOverall(arg_22_0):
	if arg_22_0.wsAtlasOverall:
		arg_22_0.wsAtlasOverall.Dispose()

		arg_22_0.wsAtlasOverall = None
