...
def var_0_0.initNotificationHandleDic(arg_9_0):
	arg_9_0.handleDic = {
...
def var_0_0.CheckTaskNotify(arg_13_0, arg_13_1):
	local var_13_0 = arg_13_1.getTasks()

	for iter_13_0, iter_13_1 in pairs(var_13_0):
		if iter_13_1.getState() == WorldTask.STATE_ONGOING and iter_13_1.config.complete_condition == WorldConst.TaskTypeArrivePort:
